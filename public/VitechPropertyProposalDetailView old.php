...
">
                <div class="description__parameter  hidden-xs">
                  ...
                  </svg><?php echo $displayProposalProperties[0]['numberOfBedrooms']; ?> Bedrooms</div>
                <div class="description__parameter  xs-marl0">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo $displayProposalProperties[0]['numberOfBathrooms']; ?> WC</div>
...
<div class="upload__wrapper  "  style="padding-right:0px;">
   ...
   <div class="flights__container" style="padding-left:0px;">
    ...
    margin-bottom: 0px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:25px; color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                        <div class="card__price" style="color:#f67f00; box-shadow: inset 0 0 0 2px #f67f00;">
                        <div class="card__old hidden">$<?php echo $value['owner_sell_price']; ?></div>
...
">
 <?php  echo $value['longSellingDescription']; ?> </div>
		   ...
		   <div class="card__foot" style="">
				...
				<a href="../propertyProposalInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;">  <button class="button-stroke button-small faq__button changedText fright" fdprocessedid="w46jts" style="margin-top:0px; padding:0px 20px;">View</button></a>
		  </div>
