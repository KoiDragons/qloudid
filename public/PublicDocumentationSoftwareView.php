        ...
        <div class="section faq">
          <div class="faq__center center">
            <div class="faq__top">
              ...
              <h1 class="faq__title h2 ">HR API</h1>
              <div class="faq__info " style="font-size:20px;">This is a documentation on how you can integrate your software to Qloud ID platform and generate digital ID for your employees</div>
              <div class="mobile-show">
                 <select class="select  " style="display: none;" onchange="location = this.options[this.selectedIndex].value;">
                  <option value="PublicDocumentationSoftware/loginApiInfo">Login</option>
                  <option value="PublicDocumentationSoftware/signinApiInfo">Sign in</option>
                  <option value="PublicDocumentationSoftware/paymentApiInfo">Payment</option>
				  <option value="PublicDocumentationSoftware" selected>HR</option>
                  <option value="PublicDocumentationSoftware/qloudidAppApiInfo">App API</option>
                </select> 
              </div>
            </div>
            <div class="faq__row js-tabs">
              <div class="faq__col">
                <div class="faq__nav"><a class="faq__link " href="PublicDocumentationSoftware/loginApiInfo" style="font-size:18px;">
                    <svg class="icon icon-home">
                      <use xlink:href="#icon-home"></use>
                    </svg>Login</a>
					<a class="faq__link   " href="PublicDocumentationSoftware/signinApiInfo" style="font-size:18px;">
                    <svg class="icon icon-circle-and-square">
                      <use xlink:href="#icon-circle-and-square"></use>
                    </svg>Sign in</a>
					<a class="faq__link  " href="PublicDocumentationSoftware/paymentApiInfo" style="font-size:18px;">
                    <svg class="icon icon-lightning">
                      <use xlink:href="#icon-lightning"></use>
                    </svg>Payment</a>
					<a class="faq__link js-tabs-link active" href="PublicDocumentationSoftware" style="font-size:18px;">
                    <svg class="icon icon-lightning">
                      <use xlink:href="#icon-lightning"></use>
                    </svg>HR</a>
					<a class="faq__link  " href="PublicDocumentationSoftware/qloudidAppApiInfo" style="font-size:18px;">
                    <svg class="icon icon-lightning">
                      <use xlink:href="#icon-lightning"></use>
                    </svg>App API</a>
					 </div>
              ...
              <div class="faq__col">
			   <div class="faq__box js-tabs-item" style="display: block;">
                ...
                <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item">
                                      <div class="faq__head">How to connect with HR API</div>
...
<p class="   fsz16" style="font-size:18px; word-wrap: break-word;">User need to use a encrypt decrypt function in his code to encrypt  data when sending information to qloudid.</p>
 <p class="   fsz16" style="font-size:18px; word-wrap: break-word;">This encryption formula will be provided in api php code file encrypt_decrpyt.php</p>

<p class=" padt10  padb0" style="font-size:18px; word-wrap: break-word; padding-bottom:20px;"><strong>For add employee from software user need to send company email and following information to qloudid </strong></p>
<ul class=" fsz16  martb0 padb10 padl20 xs-tall ">
...
<li>$id= $this -> encrypt_decrypt('encrypt',$newData);</li>
<li>This data will be sent to qloudid with url like this (you can send in post as well) </li>
<li>https://www.safeqloud.com/user/index.php/Curl/editEmployee/$id</li>
 </ul>
...
<li>$id= $this -> encrypt_decrypt('encrypt',$newData);</li>
<li>This data will be sent to qloudid with url like this (you can send in post as well) </li>
<li>https://www.safeqloud.com/user/index.php/Curl/ relieveEmployee/$id</li>
 </ul>									
...
<p class=" padt10  padb0" style="font-size:18px; word-wrap: break-word;"><strong>This all information will be sent by curl request.</strong></p> 
