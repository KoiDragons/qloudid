...
<input class="field__input" name="fname" id="fname"    type="text"   style="background:#23262F; color:grey;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="lname" id="lname"    type="text"   style="background:#23262F; color:grey;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="text" name="email" id="email"  value="<?php echo $_POST['email']; ?> " readonly style="background:#23262F; color:grey;">
</div>
</div>
<div class="checkout__row" style="margin-bottom:32px;">
<div class="field">
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"   style="background:#23262F; color:grey;" onfocusout="checkPhoneNumber(this.value);">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="v_code" id="v_code"    type="text"   style="background:#23262F; color:grey;"  >
</div>
</div>
<div class="checkout__fieldset">
