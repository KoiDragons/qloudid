...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Please check details below and confirm if you live there
</div>
...
<div class="field__label changedText" style="color:#787f91;">Property name</div>
<div class="field__wrap">
<input class="field__input"    value="<?php echo $addressDetail['property_nickname']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"    value="<?php echo $addressDetail['address']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"    value="<?php echo $addressDetail['port_number']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"    value="<?php echo $addressDetail['city']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
<div class="upload__col upload__col_w70">
...
<div class="field__wrap">
<input class="field__input"    value="<?php echo $addressDetail['zipcode']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<div class="upload__col upload__col_w30">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Owner first name</div>
<div class="field__wrap">
<input class="field__input"    value="<?php echo $addressDetail['owner_detail']['first_name']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
<div class="upload__col upload__col_w70">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Owner last name</div>
<div class="field__wrap">
<input class="field__input"    value="<?php echo $addressDetail['owner_detail']['last_name']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input" name="email" id="email" value="<?php echo $addressDetail['owner_detail']['email']; ?>"   type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
 
<?php if($requestDetail['is_confirmed']!=1) { ?>
  <div class="checkout__fieldset">
  
<a class="button checkout__button changedText mart35" href="../approveResidence/<?php echo $data['request_id']; ?>"   >Approve</a>
...
<a class="button checkout__button changedText mart35" href="../rejectResidence/<?php echo $data['request_id']; ?>"   >Reject</a>
