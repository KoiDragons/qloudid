			...
			send_data.email=$("#email").val();
					...
					$.ajax({
						...
						if(data1==0)
						{
							...
							$('#changeMargin').removeClass('marb250');
...
<div class="travel__col xs-marb0 marb250" style="padding-right: 0px; max-width:525px;" id="changeMargin">
         <div class="travel__list" style="
            max-width: 450px;
...
<div class="changedText categories__subtitle  txt_f67f00 ">Personal</div>
   ...
   <a class="categories__item  trans_bg " href="../../mannualPaymentCompanyInfo/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent;  border:none;">
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Company</div>
                                      </a>
									  </div>
...
<form class="checkout__item js-tabs-item" action="../../addUserAndUpdatePostJob/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
