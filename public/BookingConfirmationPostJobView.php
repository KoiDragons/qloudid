...
<body class="dark" style="background: #131922;" onload="checkLogin();">
	...
	<div class="header__center center xxs-padrl25"><a class="header__logo xs-fsz20 changedText" href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/LoginAccount" style="
...
<!-- header-->
	...
	<form action="../../../../updateUserInfo/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
...
<div class="checkout__wrapper xs-flexD" >
 <div class="checkout__inner js-tabs wi_40 xs-mart30" >
<div class="checkout__list center xs-margin0  " style="max-width:448px; padding:0px; ">
<div class="checkout__section hidden ">
...
<div class="checkout__section xsi-nobrdt   nobrdt" style="border-top:none; margin-top: 0px; padding-top: 0px;">
...
<div class="receipt xs-margin0 marrla maxwi_100   xs-pad20" style="
...
<form action="../../../../emailSignUpJobRequest/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>" method="POST" id="save_indexing" name="save_indexing" class="subscription subscription_big" style="margin-top: 0px;">
...
<div class="subscription__btn " style="background:#E91E63;" onclick="submitForm();">
