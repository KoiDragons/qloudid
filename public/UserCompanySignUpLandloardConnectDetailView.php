...
function updatePort(id)
{
	...
	else
	{
		...
		send_data.building_id=id;	 
		 ...
		 $.ajax({
		type:"POST",
		url:"../../getPorts/<?php echo $data['checkout_id']; ?>/<?php echo $data['cid']; ?>",
		data:send_data,
		dataType:"text",
...
function updateFloor(id)
{
	...
	else
	{
		...
		send_data.port_id=id;	 
		 ...
		 $.ajax({
		type:"POST",
		url:"../../getFloors/<?php echo $data['checkout_id']; ?>/<?php echo $data['cid']; ?>",
		data:send_data,
		dataType:"text",
		contentType: "application/x-www-form-urlencoded;charset=utf-8",
		success: function(data1){
...
<a class="header__logo xs-fsz20 " href="../../landloardList/<?php echo $data['checkout_id']; ?>" style="
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Connect</h2>
<div class="browse__info info xs-fsz25 changedText">Please provide connection details</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Connection details</div>
...
<form class="checkout__item js-tabs-item" action="../../sendConnectRequest/<?php echo $data['checkout_id']; ?>/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
					   ...
					   <div class="checkout__subtitle">Building inforamtion</div>
                      ...
                      <div class="checkout__fieldset">
                          ...
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Select building</div>
                            <div class="field__wrap">
                               <select class=""   id="building_id" name="building_id" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange="updatePort(this.value);" >
								  <?php echo $buildingList; ?>
								  </select>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Select port</div>
                            <div class="field__wrap">
                              <select class=""   id="port_id" name="port_id" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;"  onchange="updateFloor(this.value);">
						 ...
						 <div class="field">
                            <div class="field__label" style="color:#787f91;">Select floor</div>
                            <div class="field__wrap">
                              <select class=""   id="floor_id" name="floor_id" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
