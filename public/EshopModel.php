<?php
	...
	class EshopModel extends AppModel
	{
		...
		<div class="ovfl_hid padrl10 txt_37404a fsz14 white_bg padt30 xxsi-padrl35  padb20">
			...
			$rowCompany['image_path']=str_replace("../","https://www.safeqloud.com/",$rowCompany['image_path']);
		...
		$url='http://www.safeqloud.com/walk/token.php';
		 ...
		 $curl = curl_init();
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => "https://www.safeqloud.com/walk/token.php",
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://www.safeqloud.com/walk/resource.php",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
