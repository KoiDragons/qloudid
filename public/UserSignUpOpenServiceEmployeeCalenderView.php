...
<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="https://www.safeqloud.com/html/usercontent/css/modulesnewy_bg.css">
			<link rel="stylesheet" type="text/css" media="all" href="https://www.safeqloud.com/html/bookadirect/main.css" />
      <link rel="stylesheet" type="text/css" media="all" href="https://www.safeqloud.com/html/bookadirect/reactloadingbar.css" />
      <link rel="stylesheet" type="text/css" media="all" href="https://www.safeqloud.com/html/bookadirect/web.css" />
	  <link rel="stylesheet" media="all" href="https://www.safeqloud.com/html/fleet/css/app.min.css">
		<link href="https://fonts.googleapis.com/css?family=Audiowide" rel="stylesheet">
		<link href="https://fonts.googleapis.com/css?family=Allerta+Stencil" rel="stylesheet">
		  
        <script src="https://www.safeqloud.com/html/bookadirect/no-pollution.js"></script>
        <script src="https://www.safeqloud.com/html/bookadirect/mobile-detect.min.js"></script>
        <link rel="stylesheet" href="https://www.safeqloud.com/html/bookadirect/react-loading-bar.css" media="all" onload="this.media=&quot;all&quot;">
		...
		<script src="https://www.safeqloud.com/html/usercontent/js/jquery.translate.js"></script>
		...
		function getNewCalender(id)
		{
			...
			$('#date_flag').val(id);
		var send_data={};
		send_data.quantity=$('#quantity').val();
		...
		$.ajax({
            type:"POST",
            url:"../../../../../../../../../../getOpenNewCalender/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/<?php echo $data['employee_id'];?>",
            data:send_data,
            dataType:"text",
...
$(window).on('resize', function() {
  if ($(this).width() !== width) {
	...
	<body class=" ffamily_avenir" onload="getNewCalender(0);">
...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../../../../../../../sharedServiceDetail/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
              ...
              <div class="column_m   zi5  mart60">
               <div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
						...
						<div class="padb0 xxs-padb0 ">		
							<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_70 xxs-lgn_hight_50 padb0   trn ffamily_avenir changedText">Book</h1>
									</div>
									<div class=" xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText">Please select a suitable date and time for you on the calender</a></div>
	 ...
	 <form method='POST' action='../../../../../../../../../../updateBookingTimeInfo/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/<?php echo $data['employee_id']; ?>' id='save_indexing' name="save_indexing" >
		...
		<input type='hidden' id='booking_date' name='booking_date' value="" />
		 ...
		 <input type='hidden' id='shared_type' name='shared_type' value="2" />
...
<script src="https://www.safeqloud.com/html/fleet/js/app.js"></script>
		...
		<script type="text/javascript" src="https://www.safeqloud.com/html/usercontent/js/flipqard.js"></script>
