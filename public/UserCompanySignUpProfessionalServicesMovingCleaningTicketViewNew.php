...
<div class="header__center center xxs-padrl25"><a class="header__logo xs-fsz20 " href="../../../../../../professionalServicesList/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $selectedProfessionalCategoryDetailInfo['md_id']; ?>" style="
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Task</h2>
<div class="browse__info info xs-fsz25 changedText">Describe your request with these questions.</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Your requirements</div>
...
<div class="checkout__section xsi-nobrdt padt32 xsi-padt45" style="margin-top:10px;   padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../../../../../../addProfessionalServiceRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 
<div class="checkout__fieldset">
<div class="checkout__row" style="margin-bottom:32px;">
<div class="field">
<div class="field__label changedText" style="color:#525252;">Start date</div>
<div class="field__wrap">
<input class="field__input" name="start_date" id="start_date"  type="date" min="<?php echo date('Y-m-d'); ?>" style="  height:60px;  ">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#525252;">End date</div>
<div class="field__wrap">
<input class="field__input"  name="end_date" id="end_date"  type="date" min="<?php echo date('Y-m-d'); ?>" style="  height:60px;  ">
</div>
</div>
</div>
<div class="field" style="display:none;">
<div class="field__label changedText" style="color:#525252;">Building type</div>
<div class="field__wrap">
<select  class="nice-select select"  id="property_type_detail" name="property_type_detail" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
				<?php foreach($propertyType as $category => $value) 
												{
													
													
												?> 	
                           <option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg changedText"><?php echo $value['property_type']; ?></option>
												<?php } ?>				 
                          </select>
</div>
</div>
<div class="field"  style="display:none;">
<div class="field__label changedText" style="color:#525252;">Area</div>
<div class="field__wrap">
<input class="field__input"  type="number" name="floor_area" id="floor_area" value="1"  placeholder="Enter the area in square meters" required="" style="background:#F4F5F6; height:60px; border:none;">
</div>
</div>
<div class="field"  style="display:none;">
<div class="field__label changedText" style="color:#525252;">Rooms</div>
<div class="field__wrap">
<input class="field__input" type="number" name="total_rooms" id="total_rooms" value="1" placeholder="How many rooms & kitchens does it apply to?" required="" style="background:#F4F5F6; height:60px; border:none;">
</div>
</div>

<div class="field"  style="display:none;">
<div class="field__label changedText" style="color:#525252;">Bathrooms</div>
<div class="field__wrap">
<input class="field__input" type="number" name="total_bathrooms" id="total_bathrooms" value="1" placeholder="How many bathrooms/toilets does this apply to" required="" style="background:#F4F5F6; height:60px; border:none;">
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Will cleaning materials be available</div>
<div class="field__wrap">
<select  class="nice-select select"  id="material_info_detail" name="material_info_detail" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Will there be furniture left in the home at the time of cleaning</div>
<div class="field__wrap">
<select  class="nice-select select"  id="furniture_info_detail" name="furniture_info_detail" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
...
<div class="field"  style="display:none;">
<div class="field__label changedText" style="color:#525252;">Do you want a fixed price or a price per hour</div>
<div class="field__wrap">
<select  class="nice-select select"  id="price_info" name="price_info" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
				 
                           <option value="1" class="lgtgrey2_bg changedText">Fixed price</option>
						   <option value="2" class="lgtgrey2_bg changedText">Price per hour</option>		 	 
                          </select>
</div>
</div>
 ...
 <div class="checkout__category changedText" style="color:#525252;">Inclusions</div>
 <?php 
...
<input class="checkbox__input" type="checkbox"  id="<?php echo $value['id']; ?>"  onclick="updateInclutionType(<?php echo $value['id']; ?>)"><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text changedText"><?php echo $value['extra_inclusion']; ?></span></span>
</label>
<?php } ?>	
<input type="hidden" id="inclusion_type_detail" name="inclusion_type_detail" />	

<div class="checkout__fieldset" style="padding-top:32px;">
 
<div class="field"  style="display:none;">
<div class="field__label changedText" style="color:#525252;">The assignment must be carried out for</div>
<div class="field__wrap">
<select  class="nice-select select"  id="carried_for" name="carried_for" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
...
<div class="field" style="display:none;">
<div class="field__label changedText" style="color:#525252;">When will the assignment begin</div>
<div class="field__wrap">
<select  class="nice-select select"  id="begin_info" name="begin_info" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
...
<div class="checkout__category changedText" style="color:#525252;">Message the host</div>
<div class="field">
<div class="field__wrap">
<textarea class="field__textarea" id="product_information" name="product_information" placeholder="I will be late about 1 hour, please wait..." required=""></textarea>
</div>
</div>
</div>

  <div id="errorMsg1" class="fsz20 red_txt padtb20 tall"></div>
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="submitform();" >Send your application</a>
</form>
 </div>
</div>
</div>
