...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro3" id="android">
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button hidden" href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro3" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
