...
<a class="header__logo xs-fsz20 " href="../../../../../../professionalServicesList/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $selectedProfessionalCategoryDetailInfo['md_id']; ?>" style="
...
<form class="checkout__item js-tabs-item" action="../../../../../../addProfessionalServiceHomeCleaningRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 
<div class="checkout__fieldset">
 
<div class="field">
<div class="field__label changedText" style="color:#525252; ">What type of cleaning service is desired?</div>
...
<select  class="nice-select select"  id="price_info" name="price_info" style="background:#F4F5F6; height:60px; border:none; 
    ...
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
                           ...
                           <option value="1" class="lgtgrey2_bg changedText">Ongoing house cleaning</option>
						   <option value="2" class="lgtgrey2_bg changedText">A cleaning opportunity</option>		 	 
                          </select>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="number" name="floor_area" id="floor_area" value="1" placeholder="Enter the area in square meters" required="">
</div>
</div>
 

<div class="field">
<div class="field__label changedText" style="color:#525252;">Do you have pets in the home?</div>
<div class="field__wrap">
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Should cleaning materials be included in the quote?</div>
<div class="field__wrap">
...
<div class="checkout__category changedText" style="color:#525252; padding-top:32px;">Additional services</div>
  
 
<label class="checkbox">
<input class="checkbox__input" type="checkbox"  id="a1"  onclick="updateAdditionalServiceType(1)"><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text changedText">Washing clothes</span></span>
</label>

<label class="checkbox">
<input class="checkbox__input" type="checkbox"  id="a2"  onclick="updateAdditionalServiceType(2)"><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text changedText">Ironing</span></span>
</label>

<label class="checkbox">
<input class="checkbox__input" type="checkbox"  id="a3"  onclick="updateAdditionalServiceType(3)"><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text changedText">Change of bed linen</span></span>
</label>
