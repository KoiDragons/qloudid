...
<body class="  ffamily_avenir" style="background:#131922;">
		
		
			<!-- HEADER -->
	 <div class="column_m header   bs_bb trans_bg hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 trans_bg">
		...
		<div class="column_m header hei_60p  bs_bb trans_bg visible-xs">
         <div class="wi_100 hei_60p xs-pos_fix padtb5 padrl10 trans_bg">
	...
	<div class="clear"></div>
		...
		<div class="column_m pos_rel">
			...
			<!-- CONTENT -->
			<div class="column_m talc lgn_hight_22 fsz16  mart100 " id="loginBank" onclick="checkFlag();">
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xs-tall talc fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90  padb0   trn ffamily_avenir white_txt uppercase">Location</h1>
									</div>
									<div class="mart10 marb5 xs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" style="color:#777E90 !important;">Select your location where you want the service.</a></div>
...
<input type="hidden" id="todo_id" name="todo_id" value="QkhHaWQzcnBweFU5MDRIMllxY3IzQT09" />
									 <div class="on_clmn padt10">
											...
											<div class="pos_rel">
												<select id="city" name="city" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select" fdprocessedid="u205l"  style="background:#23262F !important; border-radius:6px; color:grey;">
					 ...
					 <div class="padtb20 xxs-talc talc">
								...
								<button type="button" name="forward" class="forword minhei_55p  fsz18 fntwei_100 bg_333 white_txt brdrad50"  style="background:#0142eb !important;" onclick="submitForm();">Submit</button>
