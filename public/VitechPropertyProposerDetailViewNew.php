...
<html lang="en">
  <head>
	...
	<body class="dark" style="Background: linear-gradient(to right, #101316, #192939)">
...
<div class="work__center center mart80 marb80i" style="
  ...
  <div class="section travel  xs-mar0i" style=" padding-bottom:136px;">
  
<div class="travel__center center xxs-padrl25" style="">
<div class="travel__row visible-xs">
<div class="travel__col " style="margin-bottom:0px;">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel ">
<div class="profile xs-nobrd " style="background: transparent;border:none; border-left: 1px solid #353945;border-radius: 0px;padding-top: 20px;">
                <div class="profile__main" style="margin-bottom:0px;">
                  <div class="profile__avatar xsi-wihi_128p"><img src="<?php echo $imgs; ?>" alt="Avatar"></div>
                  <div class="profile__man changedText" style="
    padding-top: 20px;
"><?php echo $employeeDetail['first_name'].' '.$employeeDetail['last_name']; ?></div>
                </div>
  ...
  <div class="section destinations visible-xs" style="margin-bottom:40px;">
          <div class="destinations__center center"  style="border-bottom:1px solid #23262F; padding-bottom:20px; max-width: 1132px;">
              </div>
        </div>
 <div class="travel__col padr100 xs-padr0  " style="margin-bottom: 20px; padding-right: 75px;">
<div class="travel__list talc" style=" max-width: fit-content;">


<div class="travel__item">


<div class="travel__subtitle fsz50 lgn_hight_55 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
     font-size:60px !important;
    margin-bottom: 15px; line-height:1.2;
     
    color: #fff;
    font-weight: 600;
">Dear <?php echo $clientProposalDetail['user_title']; ?>. <?php echo $clientProposalDetail['last_name']; ?></div>
...
<a class="button main__button   talc     changedText" href="https://www.qloudid.com/public/index.php/VitechProperties/propertyProposalDetail/<?php echo $data['proposal_id']; ?>" style="
     background: #cddd39;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
">Read your proposal</a>
</div>
...
<div class="travel__row hidden-xxs">
 <div class="travel__col padr100 xs-padr0  " style="width:50%; margin-bottom: 20px; padding-top: 0px; padding-right: 75px;">
...
<a class="button main__button xs-tall talc xs-fleft   changedText" href="https://www.qloudid.com/public/index.php/VitechProperties/propertyProposalDetail/<?php echo $data['proposal_id']; ?>" style="
     background: #f67f00;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
...
<a class="header__logo xs-fsz20 hidden  changedText" href="#" style="
 ...
 <div class="travel__col " style="width:50%; ">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel ">
<div class="profile xs-nobrd " style="background: transparent;border:none; border-left: 1px solid #353945;border-radius: 0px;padding-top: 20px;">
                ...
                <div class="profile__body">
                  <div class="profile__parameters xs-padrl0" style="background: #1b2739;">
                    ...
                    <div class="profile__parameter">
                      ...
                      </svg><span class="changedText">Broker</span>
                    </div>
...
function changeDisplay2()
		{
			if($('#qrMenu2').hasClass('hidden'))
			{
				$('#qrMenu2').removeClass('hidden')
				
				$('#qrMenu2').css('display','block');
			}
			else
				{
				$('#qrMenu2').addClass('hidden')
				$('#qrMenu2').css('display','none');
			}
		}
		</script>
...
<div style="margin-top:-0px;">		
			<div class="top_menu frighti padt0 padb0" style="width:150px !important; padding-left:20px; border-left:1px solid #777E90;">
				<ul class="menulist sf-menu  fsz16 ">
					...
					<ol style="margin-right:20px !important;">
						<a href="javascript:void(0);" class="lgn_hight_s1 fsz25 sf-with-ul header__head js-header-head  " onclick="changeDisplay2();"><span class="  fas fa-globe" style="color:#777E90;"></span></a>
						<div class="header__item header__item_language js-header-item margin-left0 active" style="display:block;">
						<div class="header__body js-header-body hidden" id="qrMenu2" style="margin-left: 80px; margin-top: -50px; display: none;">
<div class="header__list">
<a class="header__box active" href="javascript:void(0);" onclick="changeDisplay2();">
<div class="header__category dropdown-item changedText" tolang="en">English</div>
<div class="header__country dropdown-item changedText" tolang="en">United States</div></a>
<a class="header__box" href="javascript:void(0);" onclick="changeDisplay2();">
<div class="header__category dropdown-item changedText" tolang="sv">Sweden</div>
<div class="header__country dropdown-item changedText" tolang="sv">Swedish</div></a>
<a class="header__box" href="javascript:void(0);" onclick="changeDisplay2();">
<div class="header__category dropdown-item changedText" tolang="ru">Russia</div>
...
<header class="header js-header authorization xs-padt24   padtb20 hidden-xxs" style="height:93px;/* border-bottom: 1px solid #e6e8ec; */">
<div class="header__center center xxs-padrl25">
<a class="header__logo xs-fsz20 changedText" href="https://clubtxp.com/public/index.php/Unaoficina" style="
   background-color: #23262F;
   padding: 15px;
   color: #CDDC39;
   border-radius: 5px;
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
 ...
 <!-- outer content-->
<div class="outer__inner">
  <div class="section travel mart50 xs-mar0i" style="padding-bottom: 0px;">
<div class="travel__center center xxs-padrl25" style="">
<div class="travel__row visible-xs">
<div class="categories__head marrla" style="margin-bottom: 0px !important;max-width: 960px;margin-top: 55px;">

<!-- #ff7b48, #eedd44 color for Ideal Investment-->
<div class="categories_info info   xs-tall  changedText" style="margin-top:5px;font-size: 58px;color: #ffffff;text-transform: uppercase;background: linear-gradient(to right, #67b5fb, #eedd44);
    -webkit-text-fill-color: transparent;
    -webkit-background-clip: text;">Ideal Investment
</div><a class="button main_button xs-tall talc xs-fleft  hidden-xxs changedText" href="SelectMemberType" style="
     background: #131922;
     margin-top: 45px;
     /* margin-bottom: 55px; */
     color: #c2c2c2;
">By Kowaken Ghirmai</a>
  ...
  <div class="section destinations visible-xs" style="margin-bottom:40px;">
          <div class="destinations__center center" style="border-bottom:1px solid #23262F;padding-bottom:20px;max-width: 1132px;padding-top: 0px;">
              </div>
        </div>
 <div class="travel__col padr100 xs-padr0  " style="/* margin-bottom: 20px; */padding-right: 75px;">
<div class="travel__list talc" style="max-width: fit-content;margin-bottom: 0px;">
...
<div class="travel__subtitle    xs-tall changedText" style="
     ...
     color: #ffffff;
     font-weight: 500;
">Dear <?php echo $clientProposalDetail['user_title']; ?>. <?php echo $clientProposalDetail['name']; ?></div>
<div class="travel__content     xs-tall changedText" style="
    font-size: 20px;
    line-height: 1.51429;
    color: #777E90;
">I am pleased to present to you our exclusive selection of rental properties prepared for you and Mrs. Jonsson.</div>
</div><div class="profile__head">
                <div class="profile__line" style="justify-content: left;">
                  <div class="profile__avatar"><img src="<?php echo $imgs; ?>" alt="Avatar" style="
    border: 1px solid #23262f; height:75px; width:75px; border-radius:12px;
">
                    
                  </div>
                  <div class="profile__details" style="
    width: 169px;
">
    ...
    padding-top: 25px;
    color: #c2c2c2;
"><?php echo $poposerDetail['first_name'].' '.$poposerDetail['last_name']; ?></div>
...
<a class="button main__button   tall   fleft  changedText" href="https://www.qloudid.com/public/index.php/VitechProperties/propertyProposalDetail/<?php echo $data['proposal_id']; ?>" style="
     background: #ffffff;
     margin-top: 40px;
     /* margin-bottom: 55px; */
     color: black;
...
<div class="travel__row hidden-xxs">
 <div class="travel__col padr100 xs-padr0  " style="margin-bottom: 20px;padding-top: 82px;padding-right: 75px;">
<div class="travel__list" style=" max-width: fit-content;">
...
<div class="travel__subtitle fsz50 lgn_hight_55 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
    ...
    margin-bottom: 15px; line-height:1.71429;
...
<div class="travel__content   xs-talc changedText" style="
    font-size: 20px;
    color: #777E90; line-height:1.71429;
...
<a class="header__logo xs-fsz20 hidden  changedText" href="#" style="
 ...
 <div class="travel__col ">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel  slick-initialized slick-slider">
<div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 0px;"><div class="profile xs-nobrd  slick-slide slick-current slick-active" style="background: transparent; border-top: none; border-right: none; border-bottom: none; border-image: initial; border-left: 1px solid rgb(53, 57, 69); border-radius: 0px; padding-top: 20px; width: 0px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;" data-slick-index="0" aria-hidden="false" tabindex="0">
                <div class="profile__main">
                  <div class="profile__avatar xsi-wihi_128p"><img src="../../../../estorecss/tmp.jpg" alt="Avatar"></div>
                  <div class="profile__man changedText" style="
    padding-top: 20px;
"><?php echo $poposerDetail['first_name'].' '.$poposerDetail['last_name']; ?></div>
                </div>
