...
<button class="header__burger js-header-burger"></button>
	...
	<div class="outer__inner">
	 ...
	 <form action="../listEmployers/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
			<input type="hidden" id="user_signup_info" name="user_signup_info" value="<?php echo $_POST['user_signup_type'] ; ?>" />
			<input type="hidden" id="subscription_info" name="subscription_info" value="<?php echo $_POST['subscription_type'] ; ?>" />
...
<div class="section   mart100 xxs-mart40  xs-padb0" style="border-color: white; " id="loginBank">
...
<h2 class="browse__title h2 changedText" style="
    ...
    line-height: 90px;
">SIGN UP</h2>
<div class="browse__info info changedText">Create an account with your Qloud Id app. If you dont have an account then enter your personal email address</div>
<form action="../emailSignUpRequest/<?php echo $data['domain_id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="subscription subscription_big" style="margin-top: 35px;">
<input class="subscription__input" type="text"   name="email" id="email" placeholder="Add your personal email" required="required">
 <input type="hidden" id="user_signup_type" name="user_signup_type" value="<?php echo $_POST['user_signup_type'] ; ?>" />
 <input type="hidden" id="subscription_type" name="subscription_type" value="<?php echo $_POST['subscription_type'] ; ?>" />
...
<div class="red_txt fsz18 padtb20" id="error_msg_form"></div>
</div>
...
<div class="receipt__free changedText" style="margin-bottom: 5px;font-size: 25px;color: black;">Open Qloud ID app</div>
				
				
				
</div><div class="receipt__foot">
<div class="receipt__free changedText" style="font-size: 15px;color: grey;">Scan QR code with your Qloud ID app. If you dont have one then create an account for free.
</div>
				<a class="button receipt__button    hidden changedText" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro2_xxxx"><span>Shop online</span>
...
<div class="receipt__foot  ">
				...
				<a class="button receipt__button   hidden visible-xs" id="iOS" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro2_xxxx"><span class="changedText">Open Qloud ID App</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
