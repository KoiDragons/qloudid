...
<div class="header__center center"><a class="header__logo xs-fsz20 changedText" href="../../../../../../professionalServicesList/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $selectedProfessionalCategoryDetailInfo['md_id']; ?>" style="
...
<!-- outer content-->
<div class="outer__inner xs-mart65 mart100" style="">
...
<h2 class="browse__title h2 changedText" style="
    ...
    line-height: 90px;
">Rooms</h2>
<div class="browse__info info changedText">Select an room to send the request</div>
</div>
...
<div class="checkout__box">
 <script>
										function updateSubpartType(id)
										{
											 
										 $("#subpart_type_detail").val(id);
										document.getElementById("save_indexing_user").submit();	
										}
										
										</script>
										
										 <form action="../../../../../../homeRepairRequestInfo/<?php echo $data['catg_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
			
			<input type="hidden" id="subpart_type_detail" name="subpart_type_detail" />	
			</form>
 
									 <?php $i=1;
												
												foreach($homeRepairProblemSubCategoryDetail as $category => $value) 
												{
...
<div class="checkout__label changedText">Problem location</div>
<input class="checkout__input js-date-single changedText" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo str_ireplace('&','and',$value['problem_subpart_name']); ?>">
<div class="checkout__controls">
 
<button class="checkout__edit"   onclick="updateSubpartType(<?php echo $value['id']; ?>)">
