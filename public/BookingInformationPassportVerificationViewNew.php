...
<div class="browse__info info changedText">Please update the passport for following children and move to the front desk for remaining adults</div>
</div>
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Front desk Checked-in required</div>
...
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
 ...
 <?php } 
			  foreach($dependentsCheckedInList as $category => $value) 
					{	
							 				?> 	
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Update passport</div>
 
<div class="checkout__controls">
 
<a class="button-stroke receipt__button" href="../childPassportInfo/<?php echo $data['hotel_checkin_id']; ?>/<?php echo $value['enc']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Update</span></span>
</a> 
...
<?php } ?>	
 ...
 <a class="button checkout__button changedText" style="background: #3B71FE;" href="https://dstricts.com/public/index.php/BookingInformation/checkedInDetail/<?php echo $data['checkout_id']; ?>" >Skip</a>
