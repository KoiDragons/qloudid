...
<div class="browse__info info xs-fsz25 changedText">Create an account and start building your brand and win more business.</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Personal details only</div>
...
<form class="checkout__item js-tabs-item" action="../../addUserDetails/<?php echo $data['domain_id']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="field__wrap">
<input class="field__input"  type="text" name="email" id="email"  value="<?php echo $emailRequestReceivedInfo['email']; ?>" placeholder="e. g. xyz@gmail.com" style="color:grey;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"  placeholder="e. g. xxxxxx1234" style="color:grey;">
</div>
</div>
</div>
 </div>
