...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.min.image256.css">
...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../../../../../selectCity/<?php echo $data['domain_id']; ?>" style="
...
<div class="product__head xxs-mart45 mart100" style=" margin-bottom:15px;">
<div class="product__box  " >
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall " style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><?php echo count($getProfessionalServiceCompanies); ?> found</h2>

<div class="browse__info info">Select one of the below listed companies to book
</div>
...
<?php foreach($getProfessionalServiceCompanies as $category => $value) { ?>
<a class="card card_row" href="../../../../../../../bookableServiceList/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $value['enc']; ?>">
<div class="card__preview card__preview_update"><img srcset="<?php echo $value['image_path']; ?>" src="<?php echo $value['image_path']; ?>" alt="London - Kings Cross">
<div class="category card__category" >popular</div>
</div>
<div class="card__body" >
<div class="card__line">
<div class="card__title" style="font-size:20px;"><?php echo $value['company_name']; ?></div>
<div class="card__price" style="color:#000000; box-shadow: inset 0 0 0 2px #000000;">
...
</svg><?php echo substr(html_entity_decode($value['address']),0,15); ?>
</div>
<div class="card__option hidden">
...
<div class="card__cost">$<?php echo $value['price']; ?> total</div>
