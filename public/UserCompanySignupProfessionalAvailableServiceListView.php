...
<div class="header__center center xs-padrl25"><a class="header__logo xs-fsz20 changedText" href="../../../../../../../../companiesList/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>" style="
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="#" class="header__item " onclick="submitUser();"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Menu</button>
...
<div class="browse__head" style="margin-bottom:0px; max-width: 650px;">

<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><?php echo $companyDetail['company_name']; ?></h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;"><?php echo $companyDetail['sd_address'].' '.$companyDetail['i_port_number'].', '.$companyDetail['sd_zip'].', '.$companyDetail['sd_city']; ?></h2>
<div class="comment">
...
<div class="card__flex">
                        ...
                        <div class="card__rating">
                          ...
                          <div class="card__number fsz20i">4.8</div>
                          <div class="card__reviews changedText fsz16">(12 reviews)
                          </div>
                        </div>
                      </div>

<div class="comment__head" style="display: none;">
...
<div class="comment__author changedText" style="
    /* color: black; */
    font-weight: bold;
    font-size: 16px;
...
<div class="comment__content changedText" style="
    /* color: black; */
    font-size: 16px;
...
<div class="comment__time changedText" style="
    color: #b1b5c4;
">about 1 hour ago</div>
<div class="comment__actions">
<button class="comment__action changedText">Like</button>
<button class="comment__action changedText">Reply</button>
</div>
</div>
</div>
</div>
...
<div class="loader"></div><span class="changedText">Loading comment</span>
</button>
</div>
</div>
 
...
<div class="checkout__inner js-tabs" style="padding-right:0px;">
...
<div class="checkout__box">
										 ...
										 function selectService(id)
										   {
											   var getValue=$('#service_list').val();
												if($('#'+id).hasClass('checked'))
												{
													$('#'+id).removeClass('checked');
													getValue = getValue.replace(id+",", "");
													$("#service_list").val(getValue);
													$('#'+id).html('Book');
													if($("#service_list").val()=='')
													{
														$('.receipt__foot').addClass('hidden');
													}
												}
												else
												{
													...
													$("#service_list").val(getValue);
													$('#'+id).html('Remove');
													$('.receipt__foot').removeClass('hidden');
												}
										   }
										 </script>
											...
											<?php $i=1; 
								foreach($getProfessionalBookableServices as $category => $value) 
												{
												...
												?> 	
													...
													<div class="checkout__label changedText"><?php echo $value['dish_name']; ?></div>
													<input class="checkout__input js-date-single changedText" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php if($value['time_required']==1) echo '15 minutes';  else  if($value['time_required']==2) echo '30 minutes';  else  if($value['time_required']==3) echo '45 minutes';  else  if($value['time_required']==4) echo '60 minutes';?>">
													<div class="checkout__controls">
													 <?php if($value['one_shared']==1 || $value['one_shared_type']==2){ ?>
													<a href="javascript:void(0);" onclick="selectService(<?php echo $value['id']; ?>);" ><span class="receipt__cost"><span class="receipt__money changedText" style="color: #f67f00 ;" id="<?php echo $value['id']; ?>">Book</span></span></a>
													 
													 <?php } else { ?>
													 <a href="../../../../../../../../<?php if($value['one_shared']==1 || $value['one_shared_type']==2) echo 'serviceEmployeeList'; else echo 'sharedServiceDetail'; ?>/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
												...
												<form method='POST' action='../../../../../../../../updateSelectedServices/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>' id='save_indexing' name="save_indexing" >
												<input type='hidden' id='service_list' name='service_list' value="" />
												</form>
												
												<div class="receipt__foot hidden" style="padding-top:20px;">
												<a class="button receipt__button" href="javascript:void(0);" onclick="submitForm();" style="background:#F67F00;"><span class="changedText">Book services</span>
