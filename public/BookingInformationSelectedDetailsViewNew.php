...
<body class="font_poppins fsz14 <?php if($bookingInformationDetail['is_premium']==1) echo 'dark'; else echo ''; ?>"  style="background: <?php if($bookingInformationDetail['is_premium']==1) echo '#131922'; else echo 'white'; ?>">
<script style="
    background: #212B3B;
">
...
<a class="header__logo xs-fsz20 " href="../editInvoiceAddressesUser/<?php echo $data['checkout_id']; ?>" style="
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Verify</h2>
<div class="browse__info info changedText">Please verify your payment details and submit</div>
</div>
...
<div class="checkout__category changedText">Summary</div>
...
<div class="checkout__label changedText"><?php echo $verificationInfomation['invoice_address'].' '.$verificationInfomation['invoice_port_number']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $verificationInfomation['invoice_zip'].' , '.$verificationInfomation['invoice_city'].' , '.$verificationInfomation['invoice_country']; ?></div>
 
<div class="checkout__controls">
<a href="../editInvoiceAddressesUser/<?php echo $data['checkout_id']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-edit">
<use xlink:href="#icon-edit" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText"><?php echo $verificationInfomation['name_on_card']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $verificationInfomation['card_number2']; ?></div>
 
<div class="checkout__controls">
<a href="../listCards/<?php echo $data['checkout_id']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-edit">
...
<div class="checkout__fieldset  padt32 xsi-padt45 mart10" >
	<a class="button checkout__button changedText" href="../confirmReservation/<?php echo $data['checkout_id']; ?>"   >Confirm reservation</a>
</div>	
 <div class="checkout__box">
