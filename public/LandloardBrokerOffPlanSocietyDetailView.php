...
<use xlink:href="#icon-user" style="fill:black"></use>
	  ...
	  <div class="product  hidden-xxs">
		 ...
		 <h4 class="description__title h4 changedText  padb20 center visible-xs" style="margin-top:48px;">Proposal</h4>
          ...
          <div class="product__center center">
			 ...
			 <div class="gallery "  >
              <div class="xs-maxheight390">
                <div class="gallery__preview" style="border-radius:6px !important;"><a class="gallery__view xs-maxheight254" href="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardSocietyDetails['imageId']; ?>.jpg" data-caption="Spectacular views of Queenstown" data-fancybox="gallery"><img src="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardSocietyDetails['imageId']; ?>.jpg" alt="Gallery" style="border-radius:6px !important;"></a><a class="button-white button-small gallery__button" href="javascript:void(0);"  class="xs-brdrad10"  >
                     <?php echo count($getLandloardSocietyPhotos)+1; ?> photos</a></div>
					 <?php $i=1; 
								foreach($getLandloardSocietyPhotos as $category => $value) 
										{
										 ?> 
					 <a class="gallery__preview hidden" href="<?php echo $path; ?>estorecss/tmp<?php echo $value['community_photo_path']; ?>.jpg" data-fancybox="gallery"><img src="<?php echo $path; ?>estorecss/tmp<?php echo $value['community_photo_path']; ?>.jpg" alt="Gallery"></a>
								 <?php		} ?>
              </div>
            </div>
        ...
        <div class="section description">
          ...
          <div class="description__center center">
            <div class="description__wrapper">
              ...
              <h4 class="description__title h4 changedText"><?php  echo $getLandloardSocietyDetails['society_name']; ?></h4>
              <div class="description__profile product__rating"><svg class="icon icon-flag">
                        <use xlink:href="#icon-flag" style="fill: #777E90;"></use>
                      </svg><span class="changedText">Phase 4/4</span>
                ...
                <div class="description__name changedText changedText " style="margin-left:15px; color: #777E90; font-size:14px;"><svg class="icon icon-flag">
                        <use xlink:href="#icon-flag" style="fill: #777E90;"></use>
                      </svg><?php  echo $getLandloardSocietyDetails['street_address'].'-'.$getLandloardSocietyDetails['port_number']; ?></div>
              </div>
			  ...
			  <div class="hidden">
                ...
                <div class="description__parameter">
                  ...
                  </svg><span class="changedText">1 bedrooms</span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText">1 WC</span>
                </div>
				 </div>
              </div>
              <div class="description__content">
                <p  class="changedText"> <?php  echo html_entity_decode($getLandloardSocietyDetails['description']); ?></p>
              </div>
            
            </div>
			
			<div class="receipt" style="border: 1px solid #23262f !important; background:transparent; margin:0px !important; border-radius:12px;">
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old hidden">$20000</div>
                    <div class="receipt__actual">Amenities</div>
			  ...
			  <div class="checkout__section center" style="border-color:#131922;">
<div class="checkout__box">
<?php $i=1; 
								foreach($getLandloardSocietyApartmentList as $category => $value) 
										{
										     
										 ?> 
    <h4 class="description__title h4 changedText  padb20" >Block <?php echo $value['block_number']; ?></h4>
	<?php $i=1; 
								foreach($value['apartment_details'] as $category => $value1) 
										{
										     
										 ?> 
 <div class="card card_row" style="margin-bottom:24px; border: 1px solid #23262f !important;  border-radius:12px; ">
	 
					 
										 
                  <div class="card__body" style=" background:#131922; margin:0px !important;">
				   
                    <div class="card__line" style="
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#777E90; margin-bottom: 0px; min-width:200px;">  <?php echo $value1['bedroom_count']; ?> bedrooms</div>
				   <div class="description__parameters hidden-xxs" style="border-top:none;   margin-bottom: 0px;    margin-top: 0px;    padding-bottom: 0px;  padding-top: 0px;">
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $value1['sale_price']; ?> kr</div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>Floor <?php echo $value1['floor_number']; ?></div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo $value1['apartment_size']; ?>m2</div>
              </div>
                        
					 <a href="../../proposalSocietyApartmentDetail/<?php echo $data['proposal_id']; ?>/<?php echo $data['sid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value1['enc']; ?>" style="text-decoration:none;">
                    ...
                    <use xlink:href="#icon-arrow-next" style="fill:#f67f00;"></use>
                  </svg></div>
                      </div></a>
