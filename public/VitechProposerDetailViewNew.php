...
<div class="travel__subtitle fsz50 lgn_hight_55 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
    ...
    color: #fff;
    font-weight: 600;
">Dear Mr. <?php echo $clientProposalDetail['name']; ?></div>
...
<a class="button main__button   talc     changedText" href="https://www.qloudid.com/public/index.php/VitechProperties/proposalInformation/<?php echo $data['proposal_id']; ?>" style="
     background: #f67f00;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
...
<a class="button main__button xs-tall talc xs-fleft   changedText" href="https://www.qloudid.com/public/index.php/VitechProperties/proposalInformation/<?php echo $data['proposal_id']; ?>" style="
     background: #f67f00;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
...
<div class="header__center center xxs-padrl25">
<a class="header__logo xs-fsz20 changedText" href="https://gettxp.com/public/index.php/Unaoficina" style="
   background-color: #23262F;
   padding: 15px;
   color: #CDDC39;
   border-radius: 5px;
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="https://gettxp.com/public/index.php/Unaoficina" class="header__item active" s=""></a>
...
<div class="categories_info info   xs-tall  changedText" style="margin-top:5px;font-size: 58px;color: #ffffff;text-transform: uppercase;background: linear-gradient(to right, #ff7b48, #eedd44);
...
<a class="button main__button   tall   fleft  changedText" href="https://www.qloudid.com/public/index.php/VitechProperties/proposalInformation/<?php echo $data['proposal_id']; ?>" style="
     background: #ffffff;
     margin-top: 40px;
     /* margin-bottom: 55px; */
     color: black;
