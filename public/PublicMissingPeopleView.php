 	...
 	function submitForm()
		{
			 ...
			 if($("#f_name").val()==null || $("#f_name").val()=="")
			{
			 ...
			 if($("#l_name").val()==null || $("#l_name").val()=="")
			{
				$("#error_msg_form").removeClass('hidden');
				$("#error_msg_form").html('Please enter last name');
				return false;
			}
			 if($("#ccountry").val()==0 || $("#ccountry").val()=="")
			{
				$("#error_msg_form").removeClass('hidden');
				$("#error_msg_form").html('Please select country');
				return false;
			}
			 	 if($("#uphno").val()==0 || $("#uphno").val()=="")
			{
				$("#error_msg_form").removeClass('hidden');
			...
			{
				$("#error_msg_form").removeClass('hidden');
				$("#error_msg_form").html('Please enter description/information about missing person');
				return false;
			}
			...
			<div class="flag_top_menu flefti padt15 padb10 hidden-xs" style="width: 50px; ">
			 ...
			 <div class="fright xs-dnone sm-dnone padt10 padb10">
					<ul class="mar0 pad0 sf-menu fsz20 nobold">
						...
						<li class="dblock hidden-xs hidden-sm fright pos_rel martb6 "><a href="https://www.safeqloud.com/user/index.php/LoginAccount" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h  lgn_hight_30 black_txt white_txt_h ffamily_avenir" data-en="Logga in" data-sw="Logga in">Logga in</a></li>
					...
					<div class="header_right_inner padrtl35i white_bg padb0">
						...
						<div class="clearfix"></div>
						 <div class="padb0 talc fsz60 padt10"><i class="fab fa-affiliatetheme black_txt fsz80 pad0"></i></div>
									<div class="mart10 xs-mart0 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Register the details of the person who is missing</a></div>
						  
						<form action="PublicMissingPeople/addperson" method="POST" name="save_indexing" id="save_indexing"  accept-charset="ISO-8859-1" autocomplete="off" >
						<div class="clearfix"></div>
						<fieldset >
						 <div class="on_clmn " >
											<div class="thr_clmn wi_50 padr10">
						    <label for="phone"> 
						    <input type="text"  class="wi_100 nobrd   bg_ffc1e04f txt_ff28288f  brd_width_1 talc  xxs-minhei_50p minhei_55p fsz18  ffamily_avenir  marb20" name="f_name" id="f_name" placeholder="Name" autocomplete="off"/>
						    </label>
							</div>
							<div class="thr_clmn padl10 wi_50">
							   <label for="phone"> 
						    <input type="text"  class="wi_100 nobrd   bg_ffc1e04f txt_ff28288f  brd_width_1 talc  xxs-minhei_50p minhei_55p fsz18  ffamily_avenir  marb20" name="l_name" id="l_name" placeholder="Last name" autocomplete="off"/>
						    </label>
						 </div>
						 </div>
						 
						 <label for="email"> 
						    <input type="file" class="wi_100 nobrd   lgtgrey2_bg  brd_width_1 tall  xxs-minhei_60p minhei_65p fsz20  ffamily_avenir  marb20" name="file1" id="file1" onchange="readURL(this);" style="border-bottom: none !important; padding: 15px; border-left: none; border-right: none; border-top: none; border-radius:0px;" />
						    </label>
						 <div class="on_clmn  ">
												
							<div class="thr_clmn  wi_30 "  > 
							 <label for="phone" >  
							<select  name="ccountry1" id="ccountry1" class="default_view wi_100 mart0  lgtgrey2_bg nobrd   brd_width_1 llgrey_txt  fsz18  xxs-minhei_50p minhei_55p     tall  ffamily_avenir marb15" style="text-align-last:center;" >
						    <option value="">Select</option>
												<?php  foreach($resultContry1 as $category => $value) 
															{
						  ...
						  <div class="thr_clmn  wi_70 padl20"  >
						    <label for="email"> 
						    <input type="text" class="wi_100 nobrd   lgtgrey2_bg  brd_width_1 talc  xxs-minhei_50p minhei_55p  fsz20 llgrey_txt ffamily_avenir  marb20" name="ssn" id="ssn" placeholder="Social security number" autocomplete="off" />
						    </label>
						    </div>
							</div>
							...
							<div class="thr_clmn  wi_30 "  > 
							 <label for="phone" > 
							<select  name="ccountry" id="ccountry" class="default_view wi_100 mart0  bg_ffc1e04f txt_ff28288f nobrd   brd_width_1   fsz18  xxs-minhei_50p minhei_55p     tall  ffamily_avenir marb15" style="text-align-last:center;">
						    <option value="">Select</option>
						  ...
						  <div class="thr_clmn  wi_70 padl20"  >
						    <label for="email"> 
						    <input type="text" class="wi_100 nobrd   bg_ffc1e04f txt_ff28288f  brd_width_1 talc  xxs-minhei_50p minhei_55p fsz18  ffamily_avenir  marb20" name="uphno" id="uphno" placeholder="Phone number" autocomplete="off" />
						    </label>
						    </div>
							</div>
						  
						   <label for="phone">  
						    <input type="text"  class="wi_100 nobrd   lgtgrey2_bg  brd_width_1 talc  xxs-minhei_50p minhei_55p  fsz20 llgrey_txt ffamily_avenir marb20" name="email" id="email" placeholder="Email" autocomplete="off"/>
						    </label>
						  
						   <label for="phone"> 
						    <input type="text"  class="wi_100 nobrd   bg_ffc1e04f txt_ff28288f  brd_width_1 talc  xxs-minhei_50p minhei_55p fsz18  ffamily_avenir  marb20" name="description" id="description"  placeholder="Description" autocomplete="off"/>
						    </label>
						 <div class="clear"></div>
