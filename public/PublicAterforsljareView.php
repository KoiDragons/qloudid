       ...
       <a href="#" class="marr5 black_txt">Company </a>
			...
			<div class="column_m scroll-fix-wrap">
				<div class="wrap sub_header_brd_new sub_header_brdclr_dblue dflex justc_sb alit_fe bs_bb padt5 brdt_b">
					...
					<ul class="mar0 pad0">
						...
						<li class="diblock marrl10 padrl5"> <a href="PublicAbout" class=" dblock padb10 brdb brdwi_3 brdclr_trans brdclr_pred2_h brdclr_pred2_a fsz14 fsz14_a grey_txt pred2_txt_a bold_a" data-target="#gratis_popup">Om oss</a> </li>
						...
						<li class="diblock marrl10 padrl5"> <a href="#" class="dblock padb10 brdb brdwi_3 brdclr_trans brdclr_text_topinfo_menu_h brdclr_text_topinfo_menu_a fsz14 fsz14_a  black_txt active" data-target="#gratis_popup">Återförsäljare</a> </li>
		...
		<div class="column_m container zi5 mart40">
			<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
				...
				<!-- Center content -->
					<div class="wi_640p col-xs-12 col-sm-12 fleft pos_rel zi5   fsz14 aftpink_bg brdr padr20">
						
					
						<!-- Install Code -->
						<div class="column_m bs_bb marb5 mart20" id="scroll-section-1" data-offset="55">
						...
						<!-- Set up Events -->
						<div class="column_m bs_bb marb5 mart20">
						...
						<!-- Toborrow -->
						<div class="column_m bs_bb mart20">
					...
					<!-- Marquee -->
					<div class="visible-xs visible-sm martb20 mart20">
					...
					<div class="column_m bs_bb marb5 mart20">
								...
								<div class="clear"></div>
								<div class="column_m bs_bb bsa_bb marb5 mart20" id="scroll-section-1" data-offset="55">
				...
				<div class="bs_bb marb5 mart20">
								...
								<!-- Marquee -->
								<div class="visible-xs visible-sm  mart20">
									<h3 class="padb20 uppercase bold fsz16">KALENDARIUM – vårens seminarier</h3>
									<div class="dflex marb10 padb5 brdb brdclr_grey">
										<div class="wi_90p">
											<img src="<?php echo $path;?>html/usercontent/images/fb.png" width="80" title="Facebook" alt="Facebook" />
