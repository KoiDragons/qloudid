...
<html lang="en">
  ...
  <body class="dark" style="background: #212b39;">
    <script>
    ...
    <div class="outer">
      <!-- header-->
     <div class="column_m header   bs_bb trans_bg " style="border-bottom: 1px solid #F67F00; padding: 22px 0 22px !important;">
...
function readURL2(input) {
            ...
            <div class="checkout__wrapper">
              <div class="checkout__inner js-tabs">
                ...
                <div class="checkout__list">
                  ...
                  <div class="checkout__section" style="border-color: #f67f0066;">
				   <form action="../../saveDetails/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="checkout__item js-tabs-item">
                      ...
                      <div class="checkout__fieldset">
                          ...
                          <select class=""   id="cntry" name="cntry" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: #777E90; border-radius: 12px;
    border: 2px solid #353945; background: none;  width:100%;">
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="fname" id="fname"   />
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="lname" id="lname" />
                            </div>
                          </div>
                        </div>
						...
						<div class="field">
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="phone_number" id="phone_number"   />
                            </div>
                          </div>
							<?php } ?>
                     ...
                     <?php if($signupFieldsInfo['identificator_info']==1) { ?> 
					   ...
					   <div class="checkout__subtitle">Identificator</div>
					     </div>
						...
						<div class="wi_100 xxs-wi_100">
									...
									<div class="wp_columns_upload wp_columns_upload_custom marb20     " style="border-radius: 12px;  ">
										<input type="hidden" name="image-data1" id="image-data1" value="<?php //echo $value_a; ?>" class="hidden-image-data" />
										
										
										<div class="imgwrap nobrd " style="border-radius: 12px;">
								<div class="cropped_image    " style="background-image: <?php //echo $value_a; ?>; border-radius: 12px;  " id="image-data" name="image-data"></div>
						...
						<div class="wi_100 xxs-wi_100">
									...
									<div class="wp_columns_upload wp_columns_upload_custom marb20   " style="border-radius: 12px;">
										...
										<div class="imgwrap nobrd " style="border-radius: 12px;">
								<div class="cropped_image    " style="background-image: <?php //echo $value_b; ?>; border-radius: 12px;  " id="image-data2" name="image-data2"></div>
					 ...
					 <div class="checkout__row margin-bottom32">
                          <div class="field">
										<div class="pos_rel">
											...
											<label class="forword " style="border-radius: 12px; background: #ffffff; color: #777E90;">
										...
										<div class="pos_rel">
										 ...
										 <div class="checkout__fieldset">
										<div class="field">
                          <div class="field__label" style="color:#787f91;">Identificator</div>
                          <div class="field__wrap">
    ...
    border: 2px solid #353945; background: none; width:100%;">
						...
						<div class="field">
                          <div class="field__label" style="color:#787f91;">ID number</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="id_number" id="id_number" />
                          </div>
                        </div>
						
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Issue date</div>
                          <div class="field__wrap">
                            <input class="field__input" type="date" name="issue_date" id="issue_date" />
                          </div>
                        </div>
						
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Expiry date</div>
                          <div class="field__wrap">
                            <input class="field__input" type="date" name="expiry_date" id="expiry_date" />
                          </div>
                        </div>
							</div>	
...
<input type="hidden" name="identificator_info" id="identificator_info"  value="<?php echo $signupFieldsInfo['identificator_info']; ?>" /> 
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row margin-bottom32">
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="port_number" id="port_number"  required>
                            </div>
                          </div>
                        </div>
					...
					<?php } ?>
                     ...
                     <div class="checkout__line borderTop">
                      ...
                      <div class="checkout__fieldset">
                        <div class="field">
                          <div class="field__label" style="color:#787f91;">card number</div>
                          <div class="field__wrap">
                            <input class="field__input" type="number" name="card_number" id="card_number"   required>
                          </div>
                        </div>
                         
                        <div class="checkout__row">
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">EXPIRATION DATE</div>
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="expiry_date" id="expiry_date" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">CVC</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="cvv" id="cvv" required>
                            </div>
                          </div>
                        </div> 
                     ...
                     <div class="checkout__line borderTop">
                        <div class="checkout__subtitle">Pickup detail</div>
                         
                      </div>
                      <div class="checkout__fieldset">
                        <div class="field">
                          <div class="field__label" style="color:#787f91;">Pickup city</div>
                          <div class="field__wrap">
                            <input class="field__input" type="number" name="pickup_city" id="pickup_city"   required>
                          </div>
                        </div>
                          ...
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Pickup zip</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="pickup_zipcode" id="pickup_zipcode" required>
                            </div>
                          </div>
					  ...
					  <div id="error_msg_form" style="font-size:18px; color:red; padding-top:20px;"></div>
					   <input type="hidden" name="delivery_address" id="delivery_address"  value="<?php echo $signupFieldsInfo['delivery_address']; ?>" /> 
									 <input type="hidden" name="invoice_address" id="invoice_address"  value="0" /> 
									...
									<input type="hidden" id="same_name" name="same_name" value="1" />
									 <input type="hidden" id="same_invoice" name="same_invoice" value="<?php if($signupFieldsInfo['delivery_address']==1) { echo 1; } else echo 0; ?>" />
					  <input type="hidden" name="card_detail" id="card_detail"  value="<?php echo $signupFieldsInfo['card_detail']; ?>" /> 
					  <a class="button checkout__button" href="javascript:void(0);" onclick="informEmployee();">Submit</a>
                    </form>
              ...
              <div class="price"  style="border: 1px solid #353945 !important; background: #23262F;">
...
<div class="receipt__subtitle"><?php echo date('M d, Y'); ?> - <?php echo date('M d, Y'); ?></div>
</div>
</div>
</div>
			  <div class="price__description" style="display:none;">
                  <div class="price__item">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo date('M d, Y'); ?> - <?php echo date('M d, Y'); ?></div>
                    </div>
                  </div>
                </div>
