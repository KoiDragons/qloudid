<?php
	...
	class PublicLostandFoundModel extends AppModel
	{
		...
		{
			$url="https://www.safeqloud.com/user/index.php/Activation/activateAccount/" . $data['email'] . "/" . $data['random_hash'];
...
<td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0">
  ...
  <tbody><tr>
    ...
    <td align="left" style="font-size:18px;line-height:22px;font-weight:bold;"><span><a href="https://www.safeqloud.com/user/index.php/Activation/activateAccount/' . $data['email'] . '/' . $data['random_hash'].'" style="border-radius:3px;color:#1976d2;text-decoration:none;background-color:#1976d2;border-top:14px solid #1976d2;border-bottom:14px solid #1976d2;border-left:14px solid #1976d2;border-right:14px solid #1976d2;display:inline-block;border-radius:3px;color:#ffffff" target="_blank" data-saferedirecturl="https://www.safeqloud.com/user/index.php/Activation/activateAccount/' . $data['email'] . '/' . $data['random_hash'].'">Confirm</a></span></td>
