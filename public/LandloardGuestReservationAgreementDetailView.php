   ...
   function submitForm()
			{
				...
				if($("#monthly_fee_applicable").val()==1)
				{
				 if($("#monthly_fee").val()==1)
				{
					$("#error_msg_form").html('Monthly fee cannot be 0');
					return false;
				}
				}
...
<div class="browse__head wi_45  xs-wi_100">
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Complete the fields below to send the agreement to the buyer.</div>
...
<div class="checkout__inner js-tabs wi_55" style="padding-right:0px;">
...
<div class="checkout__list">
 ...
 <input type="hidden" id="monthly_fee_applicable" name="monthly_fee_applicable" value="1"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Monthly fee</div>
                         
                      </div>
                      <div class="setting__content">Monthly fee is <?php if($guestReservationDetail['agreement_detail']['monthly_fee_applicable']==0) echo 'not'; ?> applicable</div>
                    </div>
						  
						   <div class="field margin-bottom24 <?php if($guestReservationDetail['agreement_detail']['monthly_fee_applicable']==0) echo 'hidden'; ?>" id="monthlyFeeInfo">
                            <div class="field__label  changedText" style="color:#787f91;">Total monthly fee</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="monthly_fee" id="monthly_fee" value="<?php echo $guestReservationDetail['agreement_detail']['monthly_fee']; ?>" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" style=" color:grey;"  readonly>
                            </div>
                          </div>
 ...
 <input type="hidden" id="full_payment" name="full_payment" value="1"/>
				   <div class="setting__notification margin-bottom24">
                      <div class="setting__main">
                        <div class="setting__subtitle">Full payment</div>
                         
                      </div>
                      <div class="setting__content">Payment will be paid in <?php if($guestReservationDetail['agreement_detail']['full_payment']==1) echo 'advance'; else echo 'installments'; ?></div>
                    </div>
						  
						  
						  
						  
						  <div class="<?php if($guestReservationDetail['agreement_detail']['full_payment']==1) echo 'hidden'; ?>" id="installmentInfo">
						  <input type="hidden" id="total_installment" name="total_installment" value="<?php echo $guestReservationDetail['fee_detail']['total_installment_allowed']; ?>">
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">How many installments</div>
                            <div class="field__wrap">
							 <select class=""   style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" disabled>
								  <?php for($i=1; $i<=$guestReservationDetail['fee_detail']['total_installment_allowed']; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php if($guestReservationDetail['fee_detail']['total_installment_allowed']==$i) echo 'selected'; ?>><?php echo $i; ?></option>
								  <?php } ?>	 
								  </select>
                               
                            </div>
                          </div>
						  <?php $i=1; foreach($agreementInstallmentDates as $category => $value ) {
										?>
						    <div class="field margin-bottom24">
							<div class="field__label changedText" style="color:#787f91;">Installment<?php echo $i; ?> invoice date</div>
							<div class="field__wrap">
							<input class="field__input"  value="<?php echo $value['emi_date']; ?>"    type="date"   style=" color:grey;"  readonly>
							</div>
							</div>
						  <?php } ?>
						  
						    <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Installment payment terms</div>
                            <div class="field__wrap">
							 <select class="" id="installment_payment_term" name="installment_payment_term" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" disabled>
								  <?php for($i=1; $i<=10; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php if($guestReservationDetail['agreement_detail']['installment_payment_term']==$i) echo 'selected'; ?>><?php echo $i; ?> weeks</option>
								  <?php } ?>	 
								  </select>
						  ...
						  <script>
									function updateDiscountInfo(link)
										   {
											  body = $('body');
											   if($('#discount_allowed').val()==1)
											   {
												    $('#bodyData').addClass('dark');
													 
												    $('#discountInfo').addClass('hidden');
												     $(link).attr('checked',''); 
													$('#discount_allowed').val(0);	
 ...
 <input type="hidden" id="discount_allowed" name="discount_allowed" value="1"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Discount</div>
                         
                      </div>
                      <div class="setting__content">Discount is <?php if($guestReservationDetail['agreement_detail']['discount_allowed']==0) echo 'not'; ?> applicable on early payment</div>
                    </div>
                  
				   <div class="field margin-bottom24 <?php if($guestReservationDetail['agreement_detail']['discount_allowed']==0) echo 'hidden'; ?>" id="discountInfo">
                            <div class="field__label  changedText" style="color:#787f91;">How much</div>
                            <div class="field__wrap">
							 <select class="" id="total_discount" name="total_discount" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" disabled>
								  
									 <?php for($i=1; $i<=100; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php if($guestReservationDetail['agreement_detail']['total_discount']==$i) echo 'selected'; ?>><?php echo $i; ?>%</option>
								  <?php } ?>
 ...
 <input type="hidden" id="late_fee_applicable" name="late_fee_applicable" value="1"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Late fee</div>
                        
                      </div>
                      <div class="setting__content">Late fee is <?php if($guestReservationDetail['agreement_detail']['late_fee_applicable']==0) echo 'not'; ?> applicable on late payment?</div>
                    </div>
                  
				   <div class="field margin-bottom24 <?php if($guestReservationDetail['agreement_detail']['late_fee_applicable']==0) echo 'hidden'; ?> " id="lateFeeInfo">
                            <div class="field__label  changedText" style="color:#787f91;">How much</div>
                            <div class="field__wrap">
							 <select class="" id="total_late_fee" name="total_late_fee" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" disabled>
								  
									 <?php for($i=1; $i<=100; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php if($guestReservationDetail['agreement_detail']['total_late_fee']==$i) echo 'selected'; ?>><?php echo $i; ?>%</option>
								  <?php } ?>
						  ...
						  <div class="field margin-bottom24">
							...
							<div class="field__wrap">
							<input class="field__input"  name="transection_date" id="transection_date" value="<?php echo $guestReservationDetail['agreement_to_be_accepted']; ?>"    type="date"   style=" color:grey;"  readonly>
							</div>
							</div>
...
<div style="background: #131922;
	...
	<?php $i=1; foreach($guestReservationDetail['emi_payment_information'] as $category => $value ) {
										?>
 <a href="../../../../user/index.php/ProposalInvoice/invoiceInformation/<?php echo $data['agreement_id']; ?>/<?php echo $value['enc']; ?>"><div class="card card_row" style="margin-bottom:24px; border:none; ">
...
">
                ...
                <div class="description__parameter" style="margin-left:16px;  margin-top: 0px;">
...
<?php } ?>
  ...
  <?php if($guestReservationDetail['agreement_detail']['is_agreement_approved']==0) { ?>
<a class="button checkout__button changedText" href="../approveAgreement/<?php echo $data['agreement_id']; ?>"  >Approve</a>
 
  <a class="button checkout__button changedText" href="../rejectAgreement/<?php echo $data['agreement_id']; ?>"  >Reject</a>
  <?php } ?>
</div>
