<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path;?>html/fleet/css/app.minRightSideFlex.css">
...
function changeDisplay1()
  ...
  <div class="column_m     bs_bb lgtgrey2_bg visible-xs  " style="height:93px;  position:relative; z-index:10; background-color:  transparent;">
				...
				<div  class="xs-padrl25 xs-pos_fix " style="display:flex; position: relative;">
				 <div>
<a class="header__logo xs-fsz20 changedText" href="../../../../proposalSocietyDetail/<?php echo $data['proposal_id']; ?>/<?php echo $data['sid']; ?>" style="
...
"><?php echo html_entity_decode($employeeDetail[0]['company_name']); ?></button>
...
<use xlink:href="#icon-user" style="fill:black"></use>
	  ...
	  <div class="product  hidden-xxs">
          <div class="product__center center">
            <div class="control" style="margin-bottom:0px;"><a class="button-stroke button-small control__button" href="#">
                <svg class="icon icon-arrow-left">
                  <use xlink:href="#icon-arrow-left"></use>
                </svg><span class="changedText">Go home</span></a>
              <ul class="breadcrumbs" style="list-style-type: none;">
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="#">Proposal</a></li>   
							 
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="#"><?php  echo $getLandloardSocietyDetails['society_name']; ?></a></li>
				 <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="#"><?php  echo $getLandloardApartmentDetailInfo['office_apartment_number']; ?></a></li>						 
		 ...
		 <h4 class="description__title h4 changedText  padb20 center visible-xs" style="margin-top:48px;">Block <?php echo $getLandloardBuildingDetails['block_number']; ?></h4>
          ...
          <div class="product__center center">
			 ...
			 <div class="gallery  " >
              <div class="xs-maxheight390">
                <div  class="gallery__preview" style="border-radius:6px !important;"><a class="gallery__view xs-maxheight254" href="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardApartmentDetailInfo['imageId']; ?>.jpg"   data-caption="Spectacular views of Queenstown" data-fancybox="gallery"><img src="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardApartmentDetailInfo['imageId']; ?>.jpg" alt="Gallery" style="border-radius:6px !important;"></a><a class="button-white button-small gallery__button" href="javascript:void(0);"   class="xs-brdrad10">
                     <?php echo count($getLandloardObjectPhotos)+1; ?> photos</a></div>
					 <?php $i=1; 
								foreach($getLandloardObjectPhotos as $category => $value) 
										{
										 ?> 
					 <a class="gallery__preview hidden" href="<?php echo $path; ?>estorecss/tmp<?php echo $value['apartment_photo_path']; ?>.jpg" data-fancybox="gallery"><img src="<?php echo $path; ?>estorecss/tmp<?php echo $value['apartment_photo_path']; ?>.jpg" alt="Gallery"></a>
								 <?php		} ?>
              </div>
            </div>
        ...
        <div class="section description">
          ...
          <div class="description__center center">
            <div class="description__wrapper">
              ...
              <h4 class="description__title h4 changedText"><?php  echo $getLandloardApartmentDetailInfo['bedroom_count']; ?> bedrooms</h4>
               <div class="description__parameters" style="padding:0px; margin:0px; border:none;">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText"><?php  echo $getLandloardApartmentDetailInfo['bathroom_count']; ?> WC</span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"> Floor <?php echo $getLandloardApartmentDetailInfo['floor_number']; ?></span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php echo $getLandloardApartmentDetailInfo['apartment_size']; ?> m2</span>
                </div>
              </div>
			...
			<div class="receipt" style="border: 1px solid #353945 !important; background:transparent; margin:0px !important;">
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old hidden">$20000</div>
                    <div class="receipt__actual">$<?php echo $getLandloardApartmentDetailInfo['sale_price']; ?></div>
                    <div class="receipt__note changedText hidden">/night</div>
                  </div>
                ...
                <div class="receipt__avatar"><img src="<?php echo $path;?>html/fleet/img/content/avatar-2.jpg" alt="Avatar">
              ...
              <div class="receipt__description receipt__description_flex  " style="background:#23262F;">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Apartment size</div>
                    <div class="receipt__subtitle"><?php echo $getLandloardApartmentDetailInfo['apartment_size']; ?> m2</div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Floor number</div>
                    <div class="receipt__subtitle"><?php echo $getLandloardApartmentDetailInfo['floor_number']; ?></div>
                  </div>
                </div>
 ...
 <div class="profile__parameters xs-padrl0" style="background: #1b2739;">
			 ...
			 <div class="receipt__btns">
                <button class="button-stroke receipt__button changedText" fdprocessedid="ebxsyj"><span>Save</span><span>
                    ...
                    <svg class="icon icon-check">
                      <use xlink:href="#icon-check"></use>
                    </svg></span></button><a class="button receipt__button changedText" href="../../../../reserveSocietyApartment/<?php echo $data['proposal_id']; ?>/<?php echo $data['sid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['aid']; ?>" style="background:#F67F00; color:#000000;"><span>Reserve</span>
              ...
              <div class="receipt__table">
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Sale price</div>
                  <div class="receipt__cell"><?php echo $getLandloardApartmentDetailInfo['sale_price']; ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Terrace</div>
                  <div class="receipt__cell"><?php if($getLandloardApartmentDetailInfo['terrace_available']==0) echo 'Not'; ?> Available</div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Balcony</div>
                  <div class="receipt__cell"><?php if($getLandloardApartmentDetailInfo['balcony_available']==0) echo 'Not'; ?> Available</div>
                </div>
