...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="javascript:void(0);" class="header__item " onclick="submitUser();"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Add company</button>
...
<h2 class="browse__title h2" style="
    ...
    line-height: 90px;
">Employers</h2>
<div class="browse__info info">Select an employer to send the request</div>
</div>
									<script>
										function submitUser()
										{
...
<div class="checkout__label"><?php if($value['is_registered']==0) echo 'Request not registered'; else echo 'Request already registered'; ?></div>
<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo substr(html_entity_decode($value['company_name']),0,20); ?>">
<div class="checkout__controls">
<?php if($value['is_registered']==0){ ?>
...
<?php } else { ?>
<button class="checkout__edit"  onclick="javascript:void(0);">
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button>
