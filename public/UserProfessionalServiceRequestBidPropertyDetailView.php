<html lang="en" style="--vh: 8.02px;"><head>
  ...
  <body>
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../receivedPropertybidList/<?php echo $data['job_id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
		 	...
		 	<div class="column_m   hei_60p bs_bb lgtgrey2_bg visible-xs">
				...
				<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../receivedPropertybidList/<?php echo $data['job_id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left txt_c12219" aria-hidden="true"></i></a>
                     </li>
	...
	<div class="clear"></div> <!-- outer content-->
      <div class="outer__inner">
        <div class="section-mb64 product">
          <div class="product__center center">
            
            <div class="product__head mart40">
              <div class="product__box">
                <h2 class="product__title h2"><?php echo $servicePropertyBidsInfo['property_title']; ?></h2>
                <div class="product__line">
                  ...
                  <div class="product__options">
                    ...
                    <div class="product__option">
                      ...
                      </svg><?php echo $servicePropertyBidsInfo['area_name']; ?>,<?php echo $servicePropertyBidsInfo['city_name']; ?>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="gallery">
              <div class="gallery__list gallery__list_stays">
			   <div class="gallery__preview">
				  <a class="gallery__view" href="<?php echo $servicePropertyBidsInfo['images']['0']['image_path']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown">
				  <img src="<?php echo $servicePropertyBidsInfo['images']['0']['image_path']; ?>" alt="Gallery">
				  </a> 
			   </div>
			   <a class="gallery__preview" href="<?php echo $servicePropertyBidsInfo['images']['1']['image_path']; ?>" data-fancybox="gallery"><img src="<?php echo $servicePropertyBidsInfo['images']['1']['image_path']; ?>" alt="Gallery"></a>
			   <a class="gallery__preview" href="<?php echo $servicePropertyBidsInfo['images']['2']['image_path']; ?>" data-fancybox="gallery"><img src="<?php echo $servicePropertyBidsInfo['images']['2']['image_path']; ?>" alt="Gallery"></a>
			   <a class="gallery__preview" href="<?php echo $servicePropertyBidsInfo['images']['3']['image_path']; ?>" data-fancybox="gallery"><img src="<?php echo $servicePropertyBidsInfo['images']['3']['image_path']; ?>" alt="Gallery"></a>
        ...
        <div class="section description">
          <div class="description__center center">
            <div class="description__wrapper">
              <h4 class="description__title h4"><?php echo $servicePropertyBidsInfo['property_title']; ?></h4>
              <div class="description__profile"><span>Hosted by</span>
                <div class="description__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar.jpg" alt="Avatar"></div>
              ...
              <div class="description__parameters">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $servicePropertyBidsInfo['guest_adult']+$servicePropertyBidsInfo['guest_children']+$servicePropertyBidsInfo['guest_infant']; ?> guests
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo $servicePropertyBidsInfo['bedroom_count']; ?> bedroom
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo $servicePropertyBidsInfo['bathroom_count']; ?> private bath
                </div>
              </div>
			  ...
			  <?php foreach($servicePropertyBidsInfo['check_list']  as $category => $value) { ?>
                <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><?php echo $value['check_name']; ?>
                </div>
				<?php } ?>
              ...
              <div class="description__full">
                ...
                <button class="button-stroke button-small description__button" fdprocessedid="2vthiq" style="display: none;">More detail</button>
              </div>
            </div>
            <div class="receipt">
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old">$<?php echo $servicePropertyBidsInfo['property_price']; ?></div>
                    <div class="receipt__actual">$<?php echo $servicePropertyBidsInfo['property_price']; ?></div>
              ...
              <div class="receipt__description receipt__description_flex">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('Y-m-d',$servicePropertyBidsInfo['start_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('Y-m-d',$servicePropertyBidsInfo['end_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo $servicePropertyBidsInfo['guest_adult']+$servicePropertyBidsInfo['guest_children']+$servicePropertyBidsInfo['guest_infant']; ?> guests</div>
                  </div>
                </div>
              </div> 
              <div class="receipt__btns">
                <button class="button-stroke receipt__button" fdprocessedid="6qwz5"><a href="../../dislikedTheProperty/<?php echo $data['job_id']; ?>/<?php echo $data['bid_id']; ?>"><span>Dont like</span><span>
                    <svg class="icon icon-plus">
                      <use xlink:href="#icon-plus"></use>
                    </svg>
                    <svg class="icon icon-check">
                      <use xlink:href="#icon-check"></use>
                    </svg></span></a></button><a class="button receipt__button" href="../../likedTheProperty/<?php echo $data['job_id']; ?>/<?php echo $data['bid_id']; ?>"><span>Liked</span>
              ...
              <div class="receipt__table">
                <div class="receipt__line">
                  <div class="receipt__cell">$<?php echo $servicePropertyBidsInfo['property_price']; ?> x <?php echo round(($servicePropertyBidsInfo['end_date']-$servicePropertyBidsInfo['start_date']) / (60 * 60 * 24)); ?> nights</div>
                  <div class="receipt__cell">$<?php echo $servicePropertyBidsInfo['property_price']*round(($servicePropertyBidsInfo['end_date']-$servicePropertyBidsInfo['start_date']) / (60 * 60 * 24)); ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell">Cleaning fee</div>
                  <div class="receipt__cell">$<?php echo $servicePropertyBidsInfo['cleaning_fee']; ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell">Deposit fee</div>
                  <div class="receipt__cell">$<?php echo $servicePropertyBidsInfo['deposit_fee']; ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell">Total</div>
                  <div class="receipt__cell">$<?php echo ($servicePropertyBidsInfo['property_price']*round(($servicePropertyBidsInfo['end_date']-$servicePropertyBidsInfo['start_date']) / (60 * 60 * 24)))+$servicePropertyBidsInfo['cleaning_fee']+$servicePropertyBidsInfo['deposit_fee']; ?></div>
                </div>
              </div>
              <div class="receipt__foot">
                <button class="receipt__report" fdprocessedid="8v9z9">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
