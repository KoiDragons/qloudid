         ...
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText " style="
                 color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Enter your card details to activate your subscription and enjoy seamless service
</div> 

<div class="travel__col xs-marb0 marb195" style="padding-right: 0px; max-width:525px;">
         <div class="travel__list" style="
            max-width: 450px;
...
<form class="checkout__item js-tabs-item" action="../../../updateCompanyCardPaymentDetail/<?php echo $data['domain_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['subscription_type']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<input class="field__input" name="card_number" id="card_number" placeholder="e. g. xxxxxxxxxxxxxxxx"   type="text"   style=" color:grey;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="cvv" id="cvv"    type="text"  placeholder="e. g. 121" style=" color:grey;">
</div>
</div>
