...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Pre check-in</h2>
<div class="browse__info info changedText">Please update below tasks to finish Pre check-in.</div>
</div>
...
<div class="checkout__label changedText">Passport</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($getUserActiveStatus['passport']==1) 'Available'; else 'Not available'; ?></div>
 
<div class="checkout__controls">
<?php if($getUserActiveStatus['passport']==1) { ?>
 <button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button> 
<?php }else { ?>
<a class="button-stroke receipt__button" href="../passportInfo/<?php echo $data['hotel_checkin_id']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Update</span></span>
</a>
<?php } ?>
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($getUserActiveStatus['address']==1) 'Available'; else 'Not available'; ?></div>
 
<div class="checkout__controls">
<?php if($getUserActiveStatus['address']==1) { ?>
 <button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
...
<?php }else { ?>
<a class="button-stroke receipt__button" href="../addressInfo/<?php echo $data['hotel_checkin_id']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Update</span></span>
</a>
<?php } ?>
<button class="checkout__edit js-date-close" style="display: none;">
<svg class="icon icon-edit">
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Card</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($getUserActiveStatus['cards']==1) 'Available'; else 'Not available'; ?></div>
 
<div class="checkout__controls">
<?php if($getUserActiveStatus['cards']==1) { ?>
 <button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
...
<?php }else { ?>
<a class="button-stroke receipt__button" href="../cardInfo/<?php echo $data['hotel_checkin_id']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Update</span></span>
</a>
<?php } ?>
<button class="checkout__edit js-date-close" style="display: none;">
<svg class="icon icon-edit">
