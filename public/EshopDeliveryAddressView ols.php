<head>
	...
	function changeHeader()
			{
				window.location.href ="https://www.qloudid.com/public/index.php/Eshop/businessCheckout/<?php echo $data['cid']; ?>";
			}
				...
				<div class="wrap maxwi_100 padrl15 xs-padrl25">
					...
					<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-mart0 xs-marb20 marb35  xxs-tall talc xs-padb15  "> <a href="#" class="black_txt fsz25 xxs-tall xxs-lgn_hight_20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Please fill in your delivery details.</a></div>
									 ...
									 <div class="tab-header mart10 padb10 xs-talc brdb_94cffd darkbluebrdcolor nobrdt nobrdl nobrdr talc">
                                           
											
											   <a href="#" class="dinlblck mar5 padrl30     darkbluergb brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active">Personal</a>  
                                              <a href="../businessCheckout/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" onclick="changeHeader();" >Business</a>
                                        </div> 
							<form action="../addDevilveryAddress/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div class="marb0   padtrl0">		 
										...
										<input type="text" value="Personal details" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_55p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="pos_rel">
											...
											<div class="pos_rel">
												...
												<input type="text" name="p_number" id="p_number" placeholder="Phone number" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['phone_number']; ?>" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_55p fsz20 padl10 black_txt ffamily_avenir floating__input padt25"  onclick="changeColor(this);" /> 
								...
								<div class="on_clmn   mart20 brdb">
										...
										<input type="text" value="Delivery address" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_55p fsz16 black_txt ffamily_avenir" readonly="">
							...
							<div class="on_clmn  mart20  brdb">	
								...
								<div class="pos_rel">											
										...
										<input type="text" value="Invoice address" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_55p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<input type="text" value="Card detail" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_55p fsz16 black_txt ffamily_avenir" readonly="">
									...
									<div class="on_clmn mart20">
										<input type="number" name="exp_month" id="exp_month" value="<?php echo date('m'); ?>" min="<?php echo date('m'); ?>" placeholder="Your card number" class=" white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_55p fsz20 padl10 black_txt ffamily_avenir  floating__input padt25" onclick="changeColor(this);"  >
									 ...
									 <div class="on_clmn mart20">
										<input type="number" name="exp_year" id="exp_year" value="<?php echo date('Y'); ?>"  min="<?php echo date('Y'); ?>" placeholder="Your card number" class=" white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_55p fsz20 padl10 black_txt ffamily_avenir  floating__input padt25" onclick="changeColor(this);">
