			...
			<div class="column_m talc lgn_hight_22 fsz16 mart60 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<div class=" xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText">Please update the passport for following children and move to the front desk for remaining adults</a></div>
					  ...
					  <div class="tab-header martb10 padb10 xs-tall brdb2_3B71FE nobrdt nobrdl nobrdr talc hidden">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text   padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 white_txt changedText"><?php echo $value['name']; ?> </span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  txt_777E90 changedText">Front desk Checked-in required</span>    
									 ...
									 <a href="../childPassportInfo/<?php echo $data['hotel_checkin_id']; ?>/<?php echo $value['enc']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="bg_2F3C4F brdrad5  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text   padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 white_txt changedText"><?php echo $value['name']; ?> </span>
													   <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  txt_777E90 changedText">Update passport</span> 
													   
													  </div>
													 
													 <div class="fright wi_25  padl20 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir txt_777E90 trans_bgi" fdprocessedid="8r6b1">Update</button>
																			</div>
								...
								<a href="../welcomeCheckin/<?php echo $data['checkout_id']; ?>" ><button type="button" name="forward" class="bold forword minhei_55p   fsz16 padrl70 nobold" style="border-radius: 50px; background: #ffffff; color: #777E90;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="changedText">Skip</font></font></button></a>
