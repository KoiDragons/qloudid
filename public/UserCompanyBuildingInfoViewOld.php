    ...
    <div class="outer">
     ...
     <div class="column_m header xs-header xsip-header xsi-header bs_bb " style="padding: 0px !important;">
				...
				<div class="logo marr15 wi_140p xs-wi_130p " style="width: 170px !important;">
					...
					<a href="signUpInfo"><h3 class="marb0 pad0 fsz27 black_txt padt15 padb10 ffamily_avenir bold">Back</h3></a>
            ...
            <div class="checkout__wrapper">
              <div class="checkout__inner js-tabs" >
                ...
                <div class="checkout__list">
                  ...
                  <div class=" ">
				  <form action="addCompanyBuilding" method="POST" id="save_indexing"  name="save_indexing" accept-charset="ISO-8859-1" >
				  <!--hello-->
                      ...
                      <div class="checkout__fieldset ">
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            <div class="field__label">Total ports</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="tports" id="tports" placeholder="Ports" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label">Total floors</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="tfloors" id="tfloors" placeholder="Floors" required>
                            </div>
                          </div>
                        </div>
                      ...
                      <input type="hidden" id="signup_type" name="signup_type"  value="<?php echo $_POST['signup_type']; ?>" />
					    ...
					    <input  type="hidden" name="lname" id="lname" value="<?php echo $_POST['lname']; ?>" />
						<input  type="hidden" name="email" id="email" value="<?php echo $_POST['email']; ?>" />
						<input  type="hidden" name="country" id="country" value="<?php echo $_POST['country']; ?>" />
						<input  type="hidden" name="pnumber" id="pnumber" value="<?php echo $_POST['pnumber']; ?>" />
