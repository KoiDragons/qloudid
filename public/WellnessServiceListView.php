...
<link rel="stylesheet" href="<?php echo $path;?>html/staticCss/3Cc9iV.QythbCez.css" crossorigin="">
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 black_bg ">
				...
				<ul class="menulist sf-menu  fsz25  bold wi_100">
					<li class="padr10 first last wi_100 talc">
						<a href="#"><span class="white_txt pred_txt_h ffamily_avenir"><?php echo substr($Wellnessinfo['center_name'],0,14); ?></span></a>
					</li>
	...
	<div class="clear"></div>
		...
		<div class="padb0 xxs-padb0 hidden">		
									...
									<h1 class="marb0  xxs-tall talc fsz50 xxs-fsz35 lgn_hight_100 xxs-lgn_hight_65 brdb padb10 black_txt trn"  ><span class="red_ff2828_txt">  </span> <?php echo $Wellnessinfo['center_name']; ?></h1>
									</div>
...
<div class="mart0 marb15 xxs-talc talc  xs-padb20 padb20 "> <span class="black_txt fsz25 xsi-fsz20 xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_25 padb10 brdb">Find us : <?php echo $Wellnessinfo['visiting_address']; ?>   <?php if($Wellnessinfo['phone']=='' || $Wellnessinfo['phone']==null) echo ''; else echo '<span class="padrl10 fsz15"><i class="fas fa-circle"></i></span> Call us : <a href="tel: +'.$Wellnessinfo['country_code'].' - '.$Wellnessinfo['phone'].'">+'.$Wellnessinfo['country_code'].' - '.$Wellnessinfo['phone']; ?></a><span></div>
...
<div class="_1HQROFP xxs-mart40" data-test-target="feed">
    ...
    <div class="_1anKb-nl">
      <h2 class="sfviYlff"><span class="kXE6Dm96"><span class="HLvj7Lh5 _2-dmJ6kF">Services</span></span></h2>
   </div>
