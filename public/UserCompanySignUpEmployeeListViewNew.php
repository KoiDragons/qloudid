...
<div class="section-mb80 checkout checkout_tasks" style="
    margin-top: 100px;
">
...
<h2 class="browse__title h2" style="
    font-size: 80px;
    line-height: 90px;
"><?php echo $selectedServiceInfo['dish_name']; ?></h2>
<div class="browse__info info" style="
    color: black;
">By <?php echo $selectedServiceInfo['company_name']; ?>
</div>
<div class="browse__info info" style="
"><?php echo $selectedServiceInfo['dish_detail']; ?>
...
<use xlink:href="#icon-calendar" style="fill:black;"></use>
</svg>
</div>
<div class="price__box">
<div class="price__category" style="color:black;">Duration</div>
...
<div class="price__box">
<div class="price__category" style="color:black;">Guest</div>
<div class="price__subtitle" style="
    color: white;
">1 guest</div>
</div>
...
<div class="receipt__offers" style="
    margin-top: 20px;
">
<div class="receipt__offer hidden">
<div class="receipt__wrap">
<div class="receipt__date">Anyone</div>
<div class="receipt__time">Decided by the company</div>
</div><a class="button-stroke receipt__button" href="../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09"><span class="receipt__cost"><span class="receipt__money" style="color: #e11936 ;">Book</span></span>
</a>
</div>
<?php $i=0;
...
<div class="receipt__offer hidden">
<div class="receipt__wrap">
<div class="receipt__date"><?php echo $value['name']; ?></div>
<div class="receipt__time">Decided by you
</div>
</div><a class="button-stroke receipt__button" href="../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/<?php echo $value['enc']; ?>"><span class="receipt__cost"><span class="receipt__money" style="color: #e11936 ;">Book</span></span>
</a>
</div>
<?php } ?> 
 </div>
...
</svg>Free cancellation</div><a class="button receipt__button" href="../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09"   style="background:#F67F00;"><span>Book service</span>
