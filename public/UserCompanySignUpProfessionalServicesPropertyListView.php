...
function updatebuilding(link,id)
{
	...
	/*var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../getSelectedProperty/<?php echo $data['request_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								$('.category-apps').html('');
								$('.category-apps').html(data1);
							}
						});	*/
...
function getAreaDetail(id)
		...
		function submitForm()
		{
			$('#error_msg_form').html('');
			 if($('#b_id').val()=='')
			{
				$('#error_msg_form').html('please select one property');
				return false;
			}
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../thanksSignup" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
         ...
         <div class="wi_100 hei_60p xs-pos_fix padtb5 padrl10 lgtgrey2_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../thanksSignup" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left txt_c12219" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xs-tall talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir">Property</h1>
									</div>
									<div class="mart10 marb5 xs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Select on of your properties or add a new property.</a></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Properties" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										 
									</div>
									 </div>
									 <form action="../updatePropertyDetail/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									...
									<?php 
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20">
														<a href="javascript:void(0);" onclick="updatebuilding(this,<?php echo $value['id']; ?>)"><input data-testid="test-checkbox-Walls" name="property_type" type="radio" class="css-radio-1lgzhz8"></a>
														</div>
											<label for="oven" class="css-14q70q1"><?php echo $value['address']; ?></label></div>
					 ...
					 <div class="padtb20 xxs-talc talc">
								...
								<button type="button" name="forward" class="forword minhei_55p  fsz18 fntwei_100 bg_333 white_txt brdrad50" onclick="submitForm();">Submit</button>
							 ...
							 <div class="padtb20 xxs-talc talc">
								...
								<a href="../addUserPropertyInfo/<?php echo $data['request_id']; ?>"><button type="button" name="forward" class="forword minhei_55p  fsz18 brdrad50 fntwei_100 bg_333 white_txt" >Add property</button></a>
