...
">Task</h2>
<div class="browse__info info xs-fsz25">Describe your request with these questions.</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category">Your requirements</div>
...
<form class="checkout__item js-tabs-item" action="../../../../../../addCommonProfessionalServiceRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 
<div class="checkout__fieldset">
 
 
<div class="field" style="display:none;">
<div class="field__label" style="color:#525252;">Building type</div>
...
<select  class="nice-select select"  id="property_type_detail" name="property_type_detail" style="height: 48px;
    ...
    border: 2px solid #E6E8EC; background: none;  width:100%;" fdprocessedid="8mc52">
				<?php foreach($propertyType as $category => $value) 
												...
												?> 	
                           <option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg"><?php echo $value['property_type']; ?></option>
												<?php } ?>				 
                          </select>
</div>
</div>
...
<div class="field">
<div class="field__label" style="color:#525252;">The assignment must be carried out for</div>
<div class="field__wrap">
...
<div class="field" style="display:none;">
<div class="field__label" style="color:#525252;">When will the assignment begin</div>
<div class="field__wrap">
<select  class="nice-select select"  id="begin_info" name="begin_info" style="height: 48px;
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
    border: 2px solid #E6E8EC; background: none;  width:100%;" fdprocessedid="8mc52">
...
<div class="checkout__category" style="color:#525252;">Message the host</div>
<div class="field">
<div class="field__wrap">
...
<a class="button checkout__button" href="javascript:void(0);"  onclick="submitform();">Send your application</a>
</form>
 </div>
</div>
</div>
