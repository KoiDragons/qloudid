...
<body class="<?php if($bookingInformationDetail['is_premium']==1) echo 'dark'; else echo ''; ?>"  style="background: <?php if($bookingInformationDetail['is_premium']==1) echo '#131922'; else echo 'white'; ?>">
  <script>
	  ...
	  function submitform()
		{
			...
			if($("#account_number").val()=="" || $("#account_number").val()=="")
			{
				
				$("#errorMsg1").html('Please enter account number ');
				return false;
			}
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Confirm</h2>
<div class="browse__info info xs-fsz25 changedText">Please confirm your reservation before it expires or get blocked</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Reservation details</div>
...
<div class="checkout__section xsi-nobrdt padt32 xsi-padt45" style="margin-top:10px;   padding-bottom:136px; ">
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="first_name" id="first_name"  value="<?php echo $userSummary['first_name']; ?>" readonly style="background:#23262F; color:grey;" />
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="last_name" id="last_name" value="<?php echo $userSummary['last_name']; ?>" readonly style="background:#23262F; color:grey;" />
                            </div>
                          </div>
                        </div>
						 <div class="checkout__row margin-bottom32">
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Check-in date</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email"  value="<?php echo date('Y-m-d',$bookingInformationDetail['checkin_booking_date']); ?>" readonly style="background:#23262F; color:grey;" />
                          </div>
                        </div>
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Check-out date</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email1" id="email1"  value="<?php echo date('Y-m-d',$bookingInformationDetail['checkout_booking_date']); ?>" readonly style="background:#23262F; color:grey;" />
                          </div>
                        </div>
                         </div>
						  ...
						  <div class="checkout__row margin-bottom32">
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Adults</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email"  value="<?php echo $bookingInformationDetail['guest_adult']; ?>" readonly style="background:#23262F; color:grey;" />
                          </div>
                        </div>
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Children</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email1" id="email1"  value="<?php echo $bookingInformationDetail['guest_children']; ?>" readonly style="background:#23262F; color:grey;" />
                          </div>
                        </div>
                         </div>
 ...
 <div class="checkout__fieldset  padt32 xsi-padt45 mart10" style="border-top: 1px solid #23262F;">
...
<a class="button checkout__button changedText" href="<?php if($bookingInformationDetail['card_id']==null || $bookingInformationDetail['card_id']=='') echo '../invoiceAddressesUser'; else echo '../checkYourDetails'; ?>/<?php echo $data['checkout_id']; ?>"   >Confirm</a>
