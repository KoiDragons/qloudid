			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40   "  >
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  >Home</h1>
									</div>
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="../../../../../../addProfessionalServiceHomeCleaningRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
								...
								<div id="profile1" class=" " style="display:block;">	
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Type</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">What type of cleaning service is desired?</span> 
													 </div>
									...
									<div data-testid="Walls-amenity-item" class="css-39yi7y lgtgrey_bg">
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Ongoing house cleaning</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">A cleaning opportunity</label></div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">How Often</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">How often do you want the cleaning?</span> 
													 </div>
									 ...
									 <div class="clear"></div>
									  <div data-testid="Walls-amenity-item" class="css-39yi7y lgtgrey_bg">
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Daily</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Every three weeks</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Biweekly</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Once a week</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Monthly</label></div>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Pets</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Do you have pets in the home?</span> 
													 </div>
									...
									<?php 
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText"><?php echo str_ireplace('&','and',$value['extra_inclusion']); ?></label></div>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Materials</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Should cleaning materials be included in the quote?</span> 
													 </div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Additional services </span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">What additional services do you want?</span> 
													 </div>
									...
									<div class="clear"></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Washing clothes</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Ironing</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Change of bed linen</label></div>
