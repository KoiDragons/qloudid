<head>
  ...
  "><a class="header__logo xs-fsz20 " href="#" style="
	...
	<div class="clear"></div>
		...
		<form action="../emailIinviteAdultForCheckin/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="UTF-8">
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="text" name="email" id="email" placeholder="First name" class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25" fdprocessedid="x4hy36"  > 
												
											 <label for="email" class="floating__label tall nobold padl10  " data-content="Owner email">
