			...
			<div class="column_m talc lgn_hight_22 fsz16 mart60 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
							...
							<form action="../addPhoneAccountInformation/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div id="profile" class=" " style="display:block;">	
										...
										<select id="pcountry" name="pcountry" class="wi_100 bg_2F3C4F nobrd padt25 tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir"    disabled />
											...
											<div class="pos_rel">
												...
												<input type="text" name="p_number" id="p_number" placeholder="Phone number"   class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25"  value="<?php echo $adultInvitationDetail['phone_number']; ?>"  readonly /> 
