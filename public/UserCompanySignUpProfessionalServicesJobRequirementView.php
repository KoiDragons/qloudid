	  ...
	  function submitform()
		{
			...
			if($("#experience_info_detail").val()==1)
			{
				if(isNaN($("#total_exp").val()))
				{
					
					$("#errorMsg1").html('Experience must be a numeric value');
					return false;
				}
				if($('#total_exp').val()==0)
				{
				$("#errorMsg1").html('Experience cant be 0');
				return false;	
				}
				
			}
			
			if(isNaN($("#total_age").val()))
				{
					
					$("#errorMsg1").html('Age must be a numeric value');
					return false;
				}
				if($('#total_age').val()<18)
				{
				$("#errorMsg1").html('Age cant be below 18');
				return false;	
				}
			...
			if($("#hours_per_week").val()==null || $("#hours_per_week").val()=="")
			{
				
				$("#errorMsg1").html('Please enter hours per week');
				return false;
			}
			
			if($("#hours_per_week").val()==0)
			{
				
				$("#errorMsg1").html('Hours per week cant be 0');
				return false;
			}
			
			if(isNaN($("#hours_per_week").val()))
			{
				
				$("#errorMsg1").html('Hours per week must be a numeric value');
				return false;
			}
			
			if($("#price_per_hour").val()==null || $("#price_per_hour").val()=="")
			{
			...
			if($("#price_per_hour").val()==0)
			{
				...
				$("#errorMsg1").html('Price per hour cant be 0');
				return false;
			}
			...
			if(isNaN($("#price_per_hour").val()))
			{
				...
				$("#errorMsg1").html('Price per hour must be a numeric value');
				return false;
			}
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 "    >
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  >Job</h1>
									</div>
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Please tell us about your job requirements</a></div>
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="../postJobRequirementInfo/<?php echo $data['domain_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
									  
									  <input type="hidden" name="came_from" id="came_from" value="8"/> 
									 	<div class="marrl0 padb15 brdb fsz16 white_bg tall padt35">
								<a href="#profile1" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active" style="background-color: #c12219 !important;"><span class="changedText">Your abilities</span>
						...
						<div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
									...
									<div class="wp_columns_upload wp_columns_upload_custom marb20 brd brdclr_white ">
										...
										<div class="imgwrap nobrd  ">
											<div class="cropped_image   grey_brd5  " style="background-image: ../../usercontent/images/default-profile-pic.jpg;" id="image-data" name="image-data"></div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Service</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Please select services you offer</span> 
													 </div>
               ...
               <div class="category-apps email-collab marrbl-2 uppercase fsz12">
			    <?php 
												...
												?> 	
											  <a href="javascript:void(0);" class="wi_33 dblock fleft pos_rel zi3_h padt30 brdb brdb_green_h lgtgrey_bg brdr black_txt connect" onclick="updateCategoryType(<?php echo $value['id']; ?>)" id="c<?php echo $value['id']; ?>"><div class="mart40 changedText"><?php echo $value['category_name']; ?></div></a>
												 
											  <?php } ?>	
										   </div>
										</div>
									
										<input type="hidden" id="category_detail" name="category_detail" />				
										</div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Experience</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Do you have any experience?</span> 
													 </div>
									...
									<div data-testid="Walls-amenity-item" class="css-39yi7y lgtgrey_bg">
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20">
														<a href="javascript:void(0);" onclick="updateExpType(1)"><input data-testid="test-checkbox-Walls" name="exp_info" type="radio" class="css-radio-1lgzhz8"></a>
														</div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20">
														<a href="javascript:void(0);" onclick="updateExpType(0)"><input data-testid="test-checkbox-Walls" name="exp_info" type="radio" class="css-radio-1lgzhz8" checked></a>
														</div>
											<label for="oven" class="css-14q70q1 changedText">No</label></div>
															
															</div>	
										<input type="hidden" id="experience_info_detail" name="experience_info_detail" value="0" />
															
										</div>
										 <div class="clear"></div>
										<div id="expDetail" class="padt10 hidden">
										<div class="column_m container fsz14 dark_grey_txt">
												<div class="white_bg  bg_fffbcc_a ">
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt&nbsp;padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Total experience</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">How many year experience do you have?</span> 
													 </div>
										...
										<div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="number" name="total_exp" id="total_exp" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" min="0" value="0" fdprocessedid="x4hy36"> 
												
											 <label for="total_exp" class="floating__label tall nobold padl10" data-content="Total experience">
									 ...
									 <div class="clear"></div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt&nbsp;padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Age</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Let us know how old you are?</span> 
													 </div>
										...
										<div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="number" name="total_age" id="total_age" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" min="0" value="0" fdprocessedid="x4hy36"> 
												
											 <label for="total_age" class="floating__label tall nobold padl10" data-content="Age">
											<span class="hidden--visually">
											  First name</span></label>
											</div>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Location</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Please select area where you can work?</span> 
													 </div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Language</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Languages you speak?</span> 
													 </div>
               ...
               <div class="category-apps email-collab marrbl-2 uppercase fsz12">
			    <?php 
												...
												?> 	
											  <a href="javascript:void(0);" class="wi_33 dblock fleft pos_rel zi3_h padt30 brdb brdb_green_h lgtgrey_bg brdr black_txt connect"onclick="updateInclutionType(<?php echo $value['id']; ?>)" id="<?php echo $value['id']; ?>"><div class="mart40 changedText"><?php echo $value['language_name']; ?></div></a>
									...
									<div class="clear"></div>							
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Time</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">How many hours per week can you work</span> 
													 </div>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="number" name="hours_per_week" id="hours_per_week" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
												
											 <label for="hours_per_week" class="floating__label tall nobold padl10" data-content="Total time">
											<span class="hidden--visually">
											  First name</span></label>
											</div>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Price</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">How much do you desire per hour?</span> 
													 </div>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="number" name="price_per_hour" id="price_per_hour" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Autonomo</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Do you have autonomo?</span> 
													 </div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Vehicle</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Do have a car?</span> 
													 </div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Driving license</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Do you have driving license?</span> 
													 </div>
									...
									<div data-testid="Walls-amenity-item" class="css-39yi7y lgtgrey_bg">
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20">
														<a href="javascript:void(0);" onclick="updatePriceType(0)"><input data-testid="test-checkbox-Walls" name="price_info" type="radio" class="css-radio-1lgzhz8"></a>
														</div>
											<label for="oven" class="css-14q70q1 changedText">No</label></div>
