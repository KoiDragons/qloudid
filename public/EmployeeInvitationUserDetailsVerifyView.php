	   ...
	   function updateInclutionType(id)
	   {
	    ...
	    function submitform()
		{
			...
			var send_data={};
					...
					send_data.pemail=$("#pemail").val();
					
					if(email==pemail)
					{
						
						$("#errorMsg1").html('Invitaion email and new email should not be same');
						return false;
					}
					
					$.ajax({
						type:"POST",
						url:"../verifyNewEmailDetail/<?php echo $data['a_id']; ?>",
						data:send_data,
						dataType:"text",
						...
						success: function(data1){
							...
							if(data1>0)
							{
								$("#errorMsg1").html('You are already an employee with given personal email');
								return false;
							}
							else
							{
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="
            max-width: 425px;
            ">
            <div class="travel__item xs-marb40 marb250">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Complete the fields below to validate your employee invitation.
</div>
...
<form class="checkout__item js-tabs-item" action="../verifyOtp/<?php echo $data['a_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<input class="field__input" type="text" name="email" id="email" placeholder="e. g. kowaken.ghirmai@gmail.com" value="<?php echo $invationInformation['employee_email'];?>" readonly>
</div>
</div>
...
<div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle"><?php echo $invationInformation['employee_email'];?></div>
                        <label class="switch">
...
<div class="field__wrap">
<input class="field__input" type="text" name="pemail" id="pemail" placeholder="e. g. xyz@gmail.com" value="" style="border: 2px solid #f67f00;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input" name="first_name" id="first_name"  value="<?php echo $invationInformation['first_name'];?>"  type="text" placeholder="e. g. XYZ"  style="color:grey; background:#282D34; border:none;" >
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="last_name" id="last_name"    type="text" placeholder="e. g. XYZ"  style="color:grey;  background:#282D34;  border:none;" value="<?php echo $invationInformation['last_name'];?>">
</div>
</div>
</div>

  
 <input class="field__input" type="hidden" name="user_id" id="user_id" placeholder="e. g. 7222233554" value="<?php echo $invationInformation['user_id'];?>" >
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"  placeholder="e. g. xxxxxx1234" style="color:grey;  background:#282D34;  border:none;" value="<?php echo $invationInformation['phone_number'];?>">
</div>
</div>
</div>
 </div>
