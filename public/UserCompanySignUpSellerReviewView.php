...
<div class="checkout__list">
 ...
 <div class="upload__head" style="margin-bottom:0px;">
                  <h2 class="upload__title h2">Review</h2>  
				  
                </div>
				<div class="browse__info info changedText padb40" style="border-bottom: 2px solid #353945;">Complete the form below to provide your experience with us
</div>
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
						<div class="upload__item">
                          ...
                          <div class="upload__col upload__col_w70">
                            <div class="upload__label">Sell price</div>
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="number" name="sell_price" id="sell_price" value="<?php echo $propertyReservationDetail['selling_price']; ?>" placeholder="e. g. 180" readonly>
                                  </div>
                                </div>
                              </div>
                              <div class="upload__cell">
      ...
      background: white; width:100%;" disabled>
						  ...
						  <div class="upload__col upload__col_w30" id="status_info">
                            ...
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="date" name="sold_on" id="sold_on" value='<?php echo date('Y-m-d',strtotime($propertyReservationDetail['paid_on']));?>'  style=" color:grey;"  readonly>
                                  </div>
                                </div>
                              </div>
							...
							<select  class="   "  name="payment_option" id="payment_option" style="height: 48px;
								...
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52" disabled>
											   ...
											   <option value="1" class="lgtgrey2_bg changedText" <?php if($propertyReservationDetail['payment_option']==1) echo 'selected'; ?>>Cash</option>
												<option value="2" class="lgtgrey2_bg changedText" <?php if($propertyReservationDetail['payment_option']==2) echo 'selected'; ?>>Credit/Debit Card</option>	
												<option value="3" class="lgtgrey2_bg changedText" <?php if($propertyReservationDetail['payment_option']==3) echo 'selected'; ?>>Netbanking</option>
                        ...
                        <div class="upload__col upload__col_w50">
						  <div class="field"   >
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="reservation_fee" id="reservation_fee" value="<?php echo $propertyReservationDetail['selling_price']; ?>" readonly  placeholder="e. g. 100" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						  </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="move_out_date" id="move_out_date" value="<?php echo date('Y-m-d',strtotime($propertyReservationDetail['move_out_date'])); ?>" readonly style=" color:grey;"  >
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="move_in_date" id="move_in_date" value="<?php echo date('Y-m-d',strtotime($propertyReservationDetail['move_in_date'])); ?>" style=" color:grey;"  readonly >
                            </div>
                          </div>
						  </div>
						   ...
						   <div class="checkout__row  " style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                              <select  class="   "  name="satisfection_level" id="satisfection_level" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
											   
											   <option value="1" class="lgtgrey2_bg changedText"  >1</option>
												<option value="2" class="lgtgrey2_bg changedText"  >2</option>	
												<option value="3" class="lgtgrey2_bg changedText"  >3</option>	
												<option value="4" class="lgtgrey2_bg changedText"  >4</option>	
												<option value="5" class="lgtgrey2_bg changedText"  >5</option>													
                       ...
                       <div class="field">
                            ...
                            <div class="field__wrap">
                            <select  class="   "  name="broker_attention" id="broker_attention" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
						 ...
						 <div class="checkout__row  " style="margin-bottom:24px;">
						  ...
						  <div class="field"  >
                            ...
                            <div class="field__wrap">
                              <select  class="   "  name="broker_energy" id="broker_energy" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
						   ...
						   <div class="field"  >
                            ...
                            <div class="field__wrap">
                              <select  class="   "  name="broker_engaged" id="broker_engaged" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
						  ...
						  <div class="checkout__row  " style="margin-bottom:24px;">
						  <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Can you recommend broker to other home sellers</div>
                            <div class="field__wrap">
                            <select  class="   "  name="broker_recommendation" id="broker_recommendation" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
						   ...
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">The broker fee was reasonable given the effort and result</div>
                            <div class="field__wrap">
                            <select  class="   "  name="broker_fee_reasonable" id="broker_fee_reasonable" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
						    ...
						    <div class="checkout__row  " style="margin-bottom:24px;">
						  <div class="field"  >
                            <div class="field__label  changedText" style="color:#787f91;">The ad and sales material were selling</div>
                            <div class="field__wrap">
                              <select  class="   "  name="broker_material" id="broker_material" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
                        ...
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">The broker presented how sales should go and keep me updated</div>
                            <div class="field__wrap">
                            <select  class="   "  name="broker_presentation" id="broker_presentation" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
						  ...
						  <div class="checkout__row  " style="margin-bottom:24px;">
						  <div class="field"  >
                            <div class="field__label  changedText" style="color:#787f91;">The broker knew the local market and the range of services well</div>
                            <div class="field__wrap">
                              <select  class="   "  name="broker_knowledge" id="broker_knowledge" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
                        ...
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Did you take the help of Hittamaklare in your choice of broker</div>
                            <div class="field__wrap">
                            <select  class="   "  name="broker_choice_help" id="broker_choice_help" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
...
<div class="upload__preview js-upload-preview">
                <div class="upload__wrap" style="background:transparent;">
				  ...
				  <a class="card" href="#" style="background:transparent;">
                    <div class="card__preview"><img srcset="<?php echo $fetchPropertiesImages['image_path1']; ?>" src="<?php echo $fetchPropertiesImages['image_path1']; ?>" alt="Entire serviced classy moutain house">
                      <div class="category card__category">Sold</div>
                    </div>
                    <div class="card__body" style="background:transparent;">
                      ...
                      <div class="card__options">
                        <div class="card__option">
                          ...
                          </svg><?php  echo $fetchPropertiesInterior['maxNumberOfBedrooms']; ?> bedrooms
                        </div>
                        <div class="card__option">
                      ...
                      <div class="card__foot">
                        <div class="card__flex">
                          <div class="card__cost">$<?php  echo $propertyReservationDetail['selling_price']; ?></div>
