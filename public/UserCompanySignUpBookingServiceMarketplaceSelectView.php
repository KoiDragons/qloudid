...
<div class="browse__info info" style="
    margin-top: 6px;
">Select marketplace to book a service</div>
</div>
...
<div class="checkout__box">
												 ...
												 <?php $i=1;
													...
													<div class="checkout__label">Marketplace</div>
													<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $value['marketplace_name']; ?>">
													<div class="checkout__controls">
													<a href="../generateTicketandBook/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit">
