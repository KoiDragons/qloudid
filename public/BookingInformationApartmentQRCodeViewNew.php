  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		function submitform()
										...
										window.location.href ="https://www.safeqloud.com/public/index.php/BookingInformation/precheckedPersons/"+data2;
										}
										}
										});	
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=verify_checkin/2/<?php echo $data['apartment_id']; ?>" class="" style="width: 125px;height: 125px;"></div>
</div>
...
<form action="#" method="POST" id="save_indexing" name="save_indexing" class="subscription subscription_big" style="margin-top: 0px;">
<input class="subscription__input" type="text" name="vcode" id="vcode" placeholder="Add your verification code here" required="required" style="
    background: white; color:black;
">
 
<a href="#" class="subscription__btn" style="background:#E91E63;" onclick="submitform();">
