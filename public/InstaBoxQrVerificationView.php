    ...
    ios = /iphone|ipod|ipad/.test( userAgent );
		...
		function ajaxSend()
			...
			send_data1.loginType=1;
				$.ajax({
					type:"POST",
					url:"../../../../user/index.php/QloudidApp/checkEmployeeReference",
					data:send_data1,
					dataType:"text",
					...
					success: function(data2){
						...
						if(data2!=2)
						{
							...
							else if(data2==1)
							{
								...
								$("#errorMsg").html("Please select the insta box for respective booking id");
								return false;
							}
...
"toolbar=0,menubar=0,width=900,height=280,top=0,left=0,scrollbars=1,resizable=yes" ,"_blank");
	...
	<div class="clear" id=""></div>
		...
		<div class="column_m pos_rel">
			...
			<form action="../addKeyToBox/<?php echo $data['hid']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						<div class="padb0 xxs-padb0 ">		
							<div class="padb0 talc fsz60 padt20"><i class="fas fa-first-aid red_ff2828_txt"></i></div>
									...
									<div class="mart20 marb35 xxs-talc talc   xs-marb20 xs-mart0"> <a href="#" class="black_txt fsz18  xs-fsz16 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Start your Worq app and scan the QR code below to verify yourself.</a></div>
						...
						<div class="padtb0 brdrad3 ">
							...
							<div class="padb10  talc padt20">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/<?php echo $data['hid']; ?>/verify_hotel_staff" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
