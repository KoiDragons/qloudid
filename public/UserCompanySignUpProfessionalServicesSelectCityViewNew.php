...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.minPannelUp.css">
...
<div class="main__center center">
			...
			<?php } ?>
              <div class="main__wrap">
                <h1 class="main__title hero changedText" style="color:white;"><?php echo $selectedMarketplaceDetail['heading_info']; ?></h1>
                <div class="main__info info changedText" style="color:white; font-size:25px;"><?php echo $selectedMarketplaceDetail['subheading_info']; ?></div> 
              </div>
            </div>
            <div class="panel panel_stays">
			  ...
			  <?php if($selectedMarketplaceDetail['booking_signup_type']==3)
				{
				  ?>
              <div class="panel__nav"><a class="panel__link active changedText" href="Javascript:void(0);" style="color:#f67f00">Book online</a><a class="panel__link changedText" href="../selectProposalCity/<?php echo $data['domain_id']; ?>">Price comparison</a></div>
		<?php } ?>
