	   ...
	   function submitForm()
		{
			...
			$("#errorMsg1").html('');
			 if($("#tports").val()=="" || $("#tports").val()==null || $("#tports").val()==0)
			{
				
				$("#errorMsg1").html('Please enter ports');
				return false;
			}
			if(isNaN($("#tports").val()))
			{
				$("#errorMsg1").html('Please enter numeric value for ports');
				return false;
			}
			 if($("#tfloors").val()=="" || $("#tfloors").val()=="")
			{
				
				$("#errorMsg1").html('Please enter total floors');
				return false;
			}
			
			if(isNaN($("#tfloors").val()))
			{
				$("#errorMsg1").html('Please enter numeric value for ports');
				return false;
			}
...
<div class="checkout__category changedText">Your business detail</div>
...
<form class="checkout__item js-tabs-item" action="../addCompanyBuilding/<?php echo $data['checkout_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
  <input type="hidden" id="signup_type" name="signup_type"  value="<?php echo $_POST['signup_type']; ?>" />
                        <input  type="hidden" name="fname" id="fname" value="<?php echo $userDetailInfo['first_name']; ?>" />
					    <input  type="hidden" name="lname" id="lname" value="<?php echo $userDetailInfo['last_name']; ?>" />
						<input  type="hidden" name="email" id="email" value="<?php echo $userDetailInfo['email']; ?>" />
						<input  type="hidden" name="country" id="country" value="<?php echo $userDetailInfo['country_of_residence']; ?>" />
						<input  type="hidden" name="pnumber" id="pnumber" value="<?php echo $userDetailInfo['phone_number']; ?>" />
						<input  type="hidden" name="company_name" id="company_name" value="<?php echo $_POST['company_name']; ?>" />
						<input  type="hidden" name="cid" id="cid" value="<?php echo $_POST['cid']; ?>" />
						<input  type="hidden" name="company_type" id="company_type" value="<?php echo $_POST['company_type']; ?>" />
						<input  type="hidden" name="company_email" id="company_email" value="<?php echo $_POST['company_email']; ?>" />
						<input  type="hidden" name="daddress" id="daddress" value="<?php echo $_POST['daddress']; ?>" />
						<input  type="hidden" name="d_port_number" id="d_port_number" value="<?php echo $_POST['d_port_number']; ?>" />
						<input  type="hidden" name="dzip" id="dzip" value="<?php echo $_POST['dzip']; ?>" />
						<input  type="hidden" name="dcity" id="dcity" value="<?php echo $_POST['dcity']; ?>" />
					   
<input type="hidden" name="came_from" id="came_from" value="7"/> 
<div class="field"  >
<div class="field__label changedText" style="color:#787f91;">Total ports</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="tports" id="tports"   required="" style="background:#23262F; color:grey;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="text" name="tfloors" id="tfloors"    required="" style="background:#23262F; color:grey;">
</div>
</div>
