		...
		function checkEmailInfo(id)
		{
			...
			send_data.email=$("#email").val();
					...
					$.ajax({
						...
						$('#changeMargin').removeClass('marb687');
							$('#changeMargin').addClass('marb887');
						$('#user_id').val(data1);
						if(data1==0)
						{
							$("#user_id").val(data1);
						...
						{
							$('#changeMargin').removeClass('marb887');
							$('#changeMargin').addClass('marb687');
							$("#user_id").val(data1);
...
<div class="travel__col xs-marb0 marb275" style="padding-right: 0px; max-width:525px;" id="changeMargin">
         <div class="travel__list" style="
            max-width: 450px;
...
<form class="checkout__item js-tabs-item" action="../../updateBrokerCompanyDetail/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<input class="field__input"  name="v_code" id="v_code"    type="text"   style=" color:grey;"  >
 ...
 <div class="checkout__fieldset hidden" id="CompanyDetails" style="border-top: 2px solid #353945; padding-top:24px;">
<div class="field" style="margin-bottom:24px;" >
