											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Available services</span> 
													 </div>
            ...
            <div class="wi_100 maxwi_500p ovfl_hid padt0 marb25">
			   ...
			   <?php $i=0;
					...
					foreach($professionalCategoryDetail as $category => $value) 
					{
						...
						if($value['category_completed']==0) break;
						if($value['id']!=9)
						{
					?> 
                  <a href="../../../professionalSubcategoryList/<?php echo $value['enc']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>" class="wi_33 dblock fleft pos_rel zi3_h padt30 brdb brdb_green_h lgtgrey_bg brdr black_txt connect" ><div class="mart40 changedText"><?php echo $value['category_name']; ?></div></a>
					<?php } else { ?>
					 <a href="../../../professionalHomeRepairCategoryList/<?php echo $value['enc']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['whom_id']; ?>" class="wi_33 dblock fleft pos_rel zi3_h padt30 brdb brdb_green_h lgtgrey_bg brdr black_txt connect" ><div class="mart40 changedText"><?php echo $value['category_name']; ?></div></a>
					<?php } } ?>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Coming soon</span> 
													 </div>
            ...
            <div class="wi_100 maxwi_500p ovfl_hid padt0 brdb">
			   ...
			   <?php $i=0;
					...
					foreach($professionalCategoryDetail as $category => $value) 
					{
						...
						if($value['category_completed']==1) continue;							
					?> 
                  <a href="../../../professionalSubcategoryList/<?php echo $value['enc']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>" class="wi_33 dblock fleft pos_rel zi3_h padt30 brdb brdb_green_h lgtgrey_bg brdr black_txt connect"><div class="mart40 changedText"><?php echo $value['category_name']; ?></div></a>
                  <?php } ?>
                  <div class="wi_100 hei_1p fleft pos_rel zi2 mart-1 white_bg xs-bg_fa"></div>
