...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.min.pannelNew.css">
...
<a class="header__logo xs-fsz20 changedText" href="../../../../../professionalDomainsList/<?php echo $data['domain_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['todo_id']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
	...
	<div class="outer__inner  xs-padrl25 ">
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><?php echo $professionalSelectedDomainDetail['marketplace_domain_type']; ?></h2>
...
<div class="sorting__line" style="
    ...
    margin-bottom: 24px;
">
                    <div class="sorting__sale" style="
    font-size: 20px;
    font-weight: 100;
    background: #131922;
    color: grey;
    /* border: 2px; */
   box-shadow: inset 0 0 0 2px #ffffff; text-transform:none;
"><?php echo $selectedCityDetail['city_name']; ?></div>
                    <div class="sorting__details" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Select one of the below services
</div>
</div></div></div>

 
<div class="product__box center " style="  margin-top: 20px;">
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
			   ...
			   <?php $i=0; foreach($professionalCategoryDetail as $category => $value)
			   {
				  
				   ?>
			    
				<a class="categories__item <?php if($i==0) echo 'black_bg'; else echo 'bg_E7E7E7'; ?>" href="#" style="padding: 20px; font-size:14px; border-radius:6px; " onclick="submitForm(<?php echo $value['id']; ?>)">
                                       
                                      <div class="changedText categories__subtitle <?php if($i==0) echo 'txt_f67f00'; else echo 'txt_787f91'; ?>"><?php echo $value['category_name']; ?></div>
                                      </a>
			    <?php $i++; } ?>			   
 ...
 <form action="../../../../../professionalServicesList/<?php echo $data['domain_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['md_id']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">

<input type="hidden" id="catg_id" name="catg_id" value="" />

 </form>
</div>
</div>

<?php if($data['design_template']==1) { ?>
<div class="section catalog">
           <div class="catalog__body">
            <div class="catalog__center center">
              <div class="catalog__cards"  style="margin:0px;">
			  <?php $i=0; if($data['catgory_id']==9) { 		
			  ...
			  <?php } } } else { foreach($professionalSubCategoryDetailCityBased as $category => $value)
			   {
				    if($value['ticket_request_link']=='#'){
				   ?>
			  <a class="card  " href="../../../../../commonTicketRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $value['enc']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['todo_id']; ?>" style=" border-radius: 12px; <?php if($i%3==0) echo 'margin: 32px 16px 0px 0px !important;'; ?>">
                  <div class="card__preview"><img srcset="<?php echo $value['subcategory_image']; ?>" src="<?php echo $value['subcategory_image']; ?>" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category changedText" style="background: white; color:black; display:<?php if($value['display_name_allowed']==1) echo 'block;'; else echo 'none'; ?>"><?php echo $value['subcategory_name']; ?></div>
                  </div>
                  </a>
			   <?php } else { ?>
			    <a class="card  " href="../../../../../<?php echo $value['ticket_request_link']; ?>/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $value['enc']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['todo_id']; ?>" style="border-radius: 12px; <?php if($i%3==0) echo 'margin: 32px 16px 0px 0px !important;'; ?>">
                  <div class="card__preview"><img srcset="<?php echo $value['subcategory_image']; ?>" src="<?php echo $value['subcategory_image']; ?>" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category changedText"  style="background: white; color:black; display:<?php if($value['display_name_allowed']==1) echo 'block;'; else echo 'none'; ?>"><?php echo $value['subcategory_name']; ?></div>
                  </div>
                  </a>
...
<div class="section brands xsi-mart60 mart40" style="    /* margin-top: 60px; */">
...
<div class="brands__list" style="display:flex;">
			<?php  	$i=0; if($data['catgory_id']==9) { 		
					foreach($homeRepairProblemCategoryDetail as $category => $value) 
					{
						...
						if($value['id']==1 || $value['id']==6) {	
												 ?>		
<div class="brands__item" style=""><a href="../../../../../professionalHomeRepairSubCategoryList/<?php echo $data['catg_id']; ?>/<?php echo $value['enc']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['todo_id']; ?>"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><?php echo $value['ticket_title']; ?></div></a></div>
 	<?php } else { ?>
	<div class="brands__item" style=""><a href="../../../../../homeRepairRequestInfo/<?php echo $data['catg_id']; ?>/<?php echo $value['enc']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['todo_id']; ?>"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><?php echo $value['ticket_title']; ?></div></a></div>
			<?php } } }  
			 else { foreach($professionalSubCategoryDetailCityBased as $category => $value)
			   {
				    if($value['ticket_request_link']=='#'){
				   ?>
				   
				   
				   <div class="brands__item" style=""><a href="../../../../../commonTicketRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $value['enc']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['todo_id']; ?>"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><?php echo $value['subcategory_name']; ?></div></a></div>
			  
			   <?php } else { ?>
			   
			    <div class="brands__item" style=""><a href="../../../../../<?php echo $value['ticket_request_link']; ?>/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $value['enc']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['todo_id']; ?>"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><?php echo $value['subcategory_image']; ?></div></a></div>
