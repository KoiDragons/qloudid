<head>
	...
	{
	window.location.href='https://www.qloudid.com/public/index.php/UserCompanySignUp/pricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['catg_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>';
	}
