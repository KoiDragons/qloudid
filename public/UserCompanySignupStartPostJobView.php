...
<body class="dark" style="background: #212b39;" onload="checkLogin();">
...
<!-- header-->
	<header class="header js-header authorization xs-padding032" style="padding:24px 0px !important; ">
...
<div class="receipt xs-margin0" style="border: none;   background-color:#1b2738; padding:0; margin:0; width:100%;">
...
<div class="section description mart80 xxs-mart40  xs-padb0"  id="loginBank">
...
">Qloud ID</h4>
 ...
 <div class="description__content hidde hidden-xxs" style="
    margin-bottom: 24px;
    
">

<p class="fsz35 lgn_hight_45 fsz35 xs-lgn_hight_25 xs-fsz20 xs-talc ">Please provide email address for sign up or you can login with your Qloud ID app</p>


</div>
<div class="description__group">
<div class="description__section hidden-xxs" style="
    margin-top: 24px;
    padding-top: 24px;
">
<div class="clear"></div>
<form action="../../emailSignUpJobRequest/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="checkout__item js-tabs-item" style="display: block;">
<div class="field">
                          <div class="field__label" style="color:#787f91;">Email</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email" fdprocessedid="9oxs5s">
                          </div>
                        </div>
		...
		<a class="button checkout__button martb20" href="javascript:void(0);" onclick="submitForm();">Sign up</a>
 </form>
...
<p class="hidden-xxs" style="/* align-items: center; */width: 445px;text-align: left;padding-left: 0px;"><a href="https://apps.apple.com/se/app/swish-betalningar/id563204724">
...
</div><div class="receipt__foot hidden">
...
<a class="visible-xs hidden" style="text-decoration:none !important;" href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android">
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="iOS">
<div class="receipt__description talc marrla " style="
    background: #101010;
    border-radius: 50px;
    width: 230px;
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button hidden" href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
