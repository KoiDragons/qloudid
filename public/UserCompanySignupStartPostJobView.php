...
<a class="visible-xs hidden" style="text-decoration:none !important;" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android">
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button hidden" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
