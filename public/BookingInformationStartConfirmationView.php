...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
<div class="outer__inner xs-bottom_aligned">


<div class="section travel" style="
    margin-top: 277px;
">
<div class="travel__center center xs-padlr25" style="
">

<div class="travel__row">
<div class="travel__col" style="
    /* padding-right: 100px; */
    margin-bottom: 50px;
">
...
<div class="travel__subtitle" style="
    ...
    color: #fff;
    font-weight: 800;
">Mr. <?php echo $userSummary['last_name']; ?></div><div class="travel__content" style="
    font-size: 25px;
    color: #777E90;
    line-height: 35px;
">Please confirm your reservation</div>
</div>
</div><a class="header__logo xs-fsz20 " href="../verifyBookingDetail/<?php echo  $data['checkout_id']; ?>" style="
...
<script src="../../../../html/fleet/js/app.js"></script><!-- svg sprite-->
