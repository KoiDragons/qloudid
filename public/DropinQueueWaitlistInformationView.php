...
<html>
	...
	<head>
		<meta charset="utf-8">
		<meta http-equiv="refresh" content="15;https://www.safeqloud.com/public/index.php/DropinQueue/waitingInformation/<?php echo $data['lid']; ?>/<?php echo $data['id']; ?>" />
				...
				<div class="padrl10 xs-padrl15">
					...
					<div class="wi_400p xsi-wi_360p maxwi_100   pos_rel zi5 marrla pad30  xs-pad0   brdrad5  " >
							...
							<div class="marb30 padt10 xsi-marb30">
									...
									<p class=" padt0  xsi-padb20 xs-padb20 talc fsz20 xs-fsz20  xsi-fsz23 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 black_txt trn" style="color:<?php if($corporateColor['f_color']=="" || $corporateColor['f_color']==null) echo "#f5f5f5"; else echo $corporateColor['f_color']; ?>">You are #<?php echo $waitlistCount; ?> in line on queue <?php echo $queueInfo['queue_name']; ?> at <?php echo $queueInfo['visiting_address']; ?></p>
								</div>
								
								
								<table class="wi_100 padb30">
								<tr>
								<td class="wi_50 fleft black_txt">
								Name
								</td>
								<td class="wi_50 fright black_txt">
								<?php echo $waitlistGuest['guest_name']; ?>
								</td>
								</tr>
								</table>
						 
						<div class="padb10 xs-padrl10"> <a href="#" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn ">View waitlist</a> </div>
						 
						<div class="padb10 xs-padrl10"> <a href="../../deleteFromQueue/<?php echo $data['lid']; ?>/<?php echo $data['id']; ?>" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn"  >Remove me from the waitlist</a> </div>
