...
<a class="header__logo xs-fsz20 " href="../selectCity/<?php echo $data['domain_id']; ?>" style="
   ...
   "><?php echo $selectedMarketplaceDetail['marketplace_name']; ?></a>
...
<a class="header__link  " href="../selectSubscriptionSignup/<?php echo $data['domain_id']; ?>" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
	...
	<div class="header__item header__item_dropdown js-header-item hidden-xs">
              <button class="header__head js-header-head " fdprocessedid="vkjigu"><span class='changedText'>Menu</span >
              ...
              <div class="header__body js-header-body" style="z-index:1;">
                <div class="header__menu"><a class="header__link active" href="https://www.qloudid.com/public/index.php/UserCompanySignUp/selectCity/<?php echo $data['domain_id']; ?>">
					...
					<a class="header__link" href="../selectSubscriptionSignup/<?php echo $data['domain_id']; ?>">
                    <svg class="icon icon-email">
                      <use xlink:href="#icon-email"></use>
                    </svg><span class='changedText'>Pricing</span ></a>
...
<form action="../selectSubscriptionSignup/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing1" id="save_indexing1" accept-charset="ISO-8859-1" autocomplete="off">
			
			<input type="hidden" name="subscription_type" id="subscription_type" value="2">
			</form>
<!-- outer content-->
<div class="outer__inner" style="margin-top: 45px;">
<div class="section main main_stays hidden">
<div class="main__center center" style="
">
<div class="main__preview xxs-padrl8">
<picture>
<source media="(max-width: 767px)" srcset="https://dstricts.com/html/usercontent/images/bg/pexels.jpeg"><img src="https://dstricts.com/html/usercontent/images/bg/pexels.jpeg" alt="Main">
</picture>
...
<h1 class="main__title hero xs-tall talc pad30 fsz90 xs-fsz35 changedText" style="
    ...
    max-width: 1600px;
    padding-bottom: 0px;
">Join us on a unique journey</h1>
<div class="main_info info talc hidden changedText" style="max-width: 1600px;background: #0e0e0d73;color: white;padding-bottom: 15px;margin-bottom: 15px;font-size: 90px;margin-top: 0px;padding: 0px 30px 30px 30px;border-radius: 0px 0px 10px 10px;font-family: 'DM Sans', sans-serif;">JOIN US
</div></div>
</div>
</div></div>


 <div class="section travel" style="margin-top: 50px; margin-bottom:80px;">
<div class="travel__center center xxs-padrl25" style="padding-bottom:80px; border-bottom:1px solid #353945;">

<div class="travel__row">
<div class="travel__col padr100 xs-padr0" style="margin-bottom: 20px;">
<div class="travel__list" style=" max-width: fit-content;">


<div class="travel__item">

<div class="travel__subtitle fsz60 lgn_hight_65 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
...
<div class="travel__subtitle fsz60 lgn_hight_65 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
    ...
    font-weight: 600;
">4 YOUR PROJECT</div>
<div class="travel__content fsz30 lgn_hight_40 xs-fsz25 xs-lgn_hight_35 xs-talc changedText" style="
    font-size: 30px;
    color: #777E90;
    
">We help home sellers in choosing a broker completely for free.</div>
</div>
</div>
<a class="header__logo xs-fsz20 hidden-xs changedText" href="../selectCity/<?php echo $data['domain_id']; ?>" style="
...
<div class="section main main_flights" style="margin-bottom:0px;">

<div class="product__head xs-mart65 mart100" style=" margin-bottom:0px;">
<div class="product__box center " style=" margin-top:0px;">
<h2 class="product__title h2 xs-fsz45 talc   fsz60   changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">How it works</h2>


<div class="sorting__line talc" style="
    padding-bottom: 20px;
    margin-bottom: 24px;
display:block;">
                  
                    <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100; margin-top: 12px;">This is a demo page for agents to demonstrate</div>
</div></div></div>
 ...
 <div class="work__body" style="padding-bottom:80px; border-bottom:1px solid #353945;">
              ...
              <div class="work__list">
                <div class="work__item">
                  ...
                  <div class="work__subtitle changedText">Fill in the form</div>
                  <div class="work__content changedText" style="font-size:16px;">Start by filling out the form - it only takes 2 minutes!</div>
                ...
                <div class="work__item">
                  ...
                  <div class="work__subtitle changedText">We match you</div>
                  <div class="work__content changedText" style="font-size:16px;">We match you with the top three brokers based on recommendations and past sales.</div>
                ...
                <div class="work__item">
                  ...
                  <div class="work__subtitle changedText">You compare agents</div>
                  <div class="work__content changedText" style="font-size:16px;">You choose which broker, if any, you want to proceed with.</div>
 ...
 <div class="section browse  visible-xs" style="margin-top: 80px; ">
          <div class="browse__center center" style=" border-bottom:1px solid #353945;">
            <div class="browse__inner">
              <div class="places__head">
                <h2 class="places__title h2 xs-tall">Discover Findabroker.com</h2>
                <div class="places__info info xs-tall">Simplifying the Search for Your Perfect Broker</div>
              </div>
              <div class="browse__wrapper">
                <div class="browse__slider js-slider-browse">
				<a class="browse__card" href="#" style="width: 292px; border-radius:24px;">
                                      <div class="browse__preview hidden" style="height: 370px;border-radius: 6px 6px 0px 0px;margin-bottom: 0px;"><img srcSet="https://dstricts.com/html/usercontent/images/lifestyle/1.jpg" src="https://dstricts.com/html/usercontent/images/lifestyle/1.jpg" alt="Card" style="width:auto;left: -86px;  filter: grayscale(100%);">
                                         
                                      </div>
                                      <div class="browse__subtitle" style="
										font-size: 20px;
									...
									">Discover Findabroker.com </div>
									<div class="browse__content" style="
										font-size: 16px;
										font-weight: 100;
										line-height: 25px;
										padding: 20px;
										...
										background: #23262F;
									">Findabroker.com is a cutting-edge marketplace and broker directory that brings together all of Spain's brokers under one roof. With brokers specializing in various aspects of real estate, finding the perfect match to sell your property can often be challenging and time-consuming. That's where we step in to simplify the process!

									</div></a>
					
							<a class="browse__card" href="#" style="width: 292px; border-radius:24px;">
                                      <div class="browse__preview hidden" style="height: 370px;border-radius: 6px 6px 0px 0px;margin-bottom: 0px;"><img srcSet="https://dstricts.com/html/usercontent/images/lifestyle/2.jpg" src="https://dstricts.com/html/usercontent/images/lifestyle/2.jpg" alt="Card" style="width:auto;left: -250px;  filter: grayscale(100%);">
                                     ...
                                     <div class="browse__subtitle" style="
										...
										background: #23262F;
										border-radius: 24px 24px 0px 0px;
									">Effortless Broker Discovery</div>
									<div class="browse__content" style="
										font-size: 16px;
										font-weight: 100;
										line-height: 25px;
										...
										border-radius: 0px 0px 24px 24px;
										background: #23262F;
									">Our service is hassle-free and has been assisting tens of thousands of home sellers in finding their ideal broker. With Findabroker.com, you can easily compare sales data, final prices, reviews, and browse brokers' profiles. When it's time to sell, we leverage extensive statistics to match you with local brokers perfectly suited to your needs.</div></a>
...
<div class="section places hidden-xs" style="margin-top: 80px;  ">
<div class="places__center center" style="padding-bottom:80px; border-bottom:1px solid #353945;">
<div class="places__inner padb0" style="background: transparent; box-shadow:none;  padding-bottom:0px !important;   padding-top:0px !important;">
<div class="places__head ">
<h2 class="places__title h2 xs-fsz45 talc   fsz60   changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Discover Findabroker.com</h2>
...
display:block;">
                    ...
                    <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100; margin-top: 12px;">Simplifying the Search for Your Perfect Broker</div>
</div>
...
<div class="places__slider js-slider-places js-slider-resize" style="visibility: visible;">
...
<a class="places__item places_item_update" href="javascript:void(0);" tabindex="0" style="" aria-hidden="true">
<div class="status-gray places__number hidden">1480</div>

<div class="places__subtitle xs-tall tall fsz32i changedText">Discover Findabroker.com  </div>
<div class="places__time  xs-tall tall fsz16 changedText" style="    line-height: 1.33333;">Findabroker.com is a cutting-edge marketplace and broker directory that brings together all of Spain's brokers under one roof. With brokers specializing in various aspects of real estate, finding the perfect match to sell your property can often be challenging and time-consuming. That's where we step in to simplify the process!</div></a>

<a class="places__item places_item_update xs-mart25" href="javascript:void(0);" tabindex="0" style="" aria-hidden="true">
<div class="status-gray places__number hidden">1480</div>

<div class="places__subtitle xs-tall tall fsz32i changedText">Effortless Broker Discovery</div>
<div class="places__time xs-tall tall fsz16 changedText" style="    line-height: 1.33333;">Our service is hassle-free and has been assisting tens of thousands of home sellers in finding their ideal broker. With Findabroker.com, you can easily compare sales data, final prices, reviews, and browse brokers' profiles. When it's time to sell, we leverage extensive statistics to match you with local brokers perfectly suited to your needs.</div></a></div>
</div>
</div>
</div>
</div>
...
<div class="section categories" style=" margin-bottom: 80px;">
<div class="categories__center center" style="padding-bottom:80px; border-bottom:1px solid #353945;">
<div class="categories__inner">

<div class="places__head ">
<h2 class="places__title h2 xs-fsz45 talc   fsz60   changedText xs-tall" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Why users prefer us over an agency</h2>

<div class="sorting__line talc xs-tall" style="
    padding-bottom: 20px;
    margin-bottom: 24px;
display:block;">
                  
                    <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100; margin-top: 12px;">This comprehensive overview highlights the myriad reasons why users may trust platforms like hittamäklare.se over individual agencies:</div>
</div>
...
<div class="categories__slider js-slider-categories " style="padding-bottom:0px;">
<a class="categories__item " href="#" >
 
<div class="categories__subtitle changedText" style="
    font-size: 22px;
    color: #EE8E8C;
    font-weight: 800;
">Independence in Agent Selection:</div>
<div class="categories__content changedText" style="
    font-size: 16px;
    /* color: black; */
">
Users appreciate the freedom to explore and choose from a diverse range of agents without being limited to a single agency, ensuring they find the best fit for their needs and preferences.
</div></a>
<a class="categories__item " href="#" >
...
<div class="categories__subtitle changedText" style="
    ...
    color: #EFAB0E;
    font-weight: 800;
">Qualification Efforts:</div>
<div class="categories__content changedText" style="
    font-size: 16px;
    /* color: black; */
">
The platform's rigorous vetting process ensures that only reputable and reliable professionals are featured, instilling confidence in users that they are dealing with trustworthy agents.
</div></a>
<a class="categories__item" href="#">
...
<div class="categories__subtitle changedText" style="
    ...
    color: #A6CFB0;
    font-weight: 800;
">Free Accessibility:</div>
<div class="categories__content changedText" style="
    font-size: 16px;
    /* color: black; */
">
The fact that these platforms offer their services for free removes financial barriers and encourages users to take advantage of the platform to find the best possible agent for their needs.
</div></a>
<a class="categories__item " href="#">
...
<div class="categories__subtitle changedText" style="
    ...
    color: white;
    font-weight: 800;
">Additional Support and Assistance:</div>
<div class="categories__content changedText" style="
    font-size: 16px;
    /* color: black; */
">
Brands like Findabroker.com offer users additional support and assistance in case of issues or disputes with brokers found through their platform, providing mediation services and access to customer support channels.</div></a>
 <a class="categories__item " href="#">
...
<div class="categories__subtitle changedText" style="
    ...
    color: red;
    font-weight: 800;
">Enforcement of Standards:</div>
<div class="categories__content changedText" style="
    font-size: 16px;
    /* color: black; */
">
These platforms have significant influence over the brokers listed on their platform and can enforce compliance with their terms and conditions, ensuring quality control and maintaining user trust.</div></a>
 ...
 <div class="section travel" style="margin-top: 80px;">
          <div class="travel__center center" style="padding-bottom:80px; border-bottom:1px solid #353945;">
		  <div class="places__head ">
<h2 class="places__title h2 xs-fsz45 talc   fsz60   changedText xs-tall" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Discover Your Perfect Broker</h2>
...
display:block;">
                    ...
                    <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100; margin-top: 12px;">Tailored Matches for Your Property Sale</div>
</div>
            ...
            <div class="travel__row">
              <div class="travel__col">
                <div class="travel__list">
                  <div class="travel__item">
                    ...
                    <div class="travel__subtitle changedText">The right broker for your home</div>
                    <div class="travel__content fsz16 changedText" style="color: #777E90;">Brokers are good at different things and we can find them with the right characteristics for your particular sale.</div>
                  </div>
                  <div class="travel__item">
                    <div class="travel__number" style="background-color: #92A5EF;">02</div>
                    <div class="travel__subtitle changedText">Look at statistics</div>
                    <div class="travel__content fsz16 changedText" style="color: #777E90;">It can be profitable to compare and costly not to. We collect the statistics that make it easier for you.</div>
                  </div>
                  <div class="travel__item">
                    <div class="travel__number" style="background-color: #58C27D;">03</div>
                    <div class="travel__subtitle changedText">Find sellers' favorites </div>
                    <div class="travel__content fsz16 changedText" style="color: #777E90;">We keep track of which brokers are often recommended by other home sellers.</div>
                  </div>
              ...
              <div class="travel__col">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel">
                      <div class="upload__preview js-upload-preview xs-pad0">
<div class="profile" >
                <div class="profile__main">
                  <div class="profile__avatar xsi-wihi_128p"><img src="https://www.dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar"></div><a class="profile__update js-popup-open" href="#popup-avatars" data-effect="mfp-zoom-in">
                    <svg class="icon icon-pencil">
                      <use xlink:href="#icon-pencil"></use>
                    </svg><span class="changedText">Update avatar</span></a>
                  <div class="profile__man changedText">Adam Bay</div>
                </div>
                <div class="profile__body">
                  <div class="profile__parameters" style="background:#131922 ;">
                  ...
                  <div class="profile__control"><a class="button-stroke button-small profile__button changedText" href="#">Contact</a>
                    <div class="actions js-actions">
                      <div class="actions__item actions__item_share js-actions-item">
                        <button class="button-circle-stroke button-small actions__button js-actions-button" fdprocessedid="2orxn">
                          <svg class="icon icon-share">
                            <use xlink:href="#icon-share"></use>
                          </svg>
                        </button>
                        <div class="actions__body actions__body_up js-actions-body">
                          <div class="actions__title changedText">Share link to this page</div>
                  ...
                  <div class="profile__socials"><a class="profile__social" href="javascript:void(0);"  >
                      <svg class="icon icon-twitter">
                        <use xlink:href="#icon-twitter"></use>
                      </svg></a><a class="profile__social" href="javascript:void(0);" >
                  ...
                  <div class="profile__note changedText">Member since Mar 15, 2021</div>
...
<div class="section-mb80 checkout checkout_stays hidden" style="margin-top: 80px;">
<div class="checkout__center center" style="padding-bottom:80px; border-bottom:1px solid #353945;">

<div class="checkout__wrapper  xs-flexD">
<div class="checkout__inner js-tabs wi_50">
<div class="browse__head" style="padding-right:0px;">
<h2 class="browse__title h2 changedText fsz60 xs-fsz45 changedText"  >Why it works</h2>
<div class="browse__info info changedText  " >Here are 3 strong reasons to why you should post your job with us</div>
</div>
...
<div class="card__title changedText  " style="font-size:25px; line-height: 1.2667">We match you with the right broker
</div>
 
</div>
<div class="card__options">
 
<div class="card__option changedText" style="font-size:16px; line-height:1.26667;">
We do the heavy lifting by matching you with the best brokers for your sale. We start from your home and look for brokers with similar sales and satisfied customers - completely free of charge, of course.
...
<div class="card__body pad2435 xs-pad24" style="background: #131922; ">
<div class="card__line">
<div class="card__title changedText" style="font-size:25px; line-height: 1.2667">Transparent information
</div>
...
<div class="card__option changedText" style="font-size:16px;  line-height:1.26667;">
We run with open cards. We have a lot of statistics on brokers and make sure you have the information you need to be able to choose the right one for your particular sale.
...
<div class="card__body pad2435 xs-pad24" style="background: #131922; ">
<div class="card__line">
<div class="card__title changedText" style="font-size:25px; line-height: 1.2667">Sellers' favourites
</div>
...
<div class="card__option changedText" style="font-size:16px; line-height:1.26667;">
It's more than just numbers that count. We know which brokers former sellers are most satisfied with. Our seller favorite award shows the way.
</div>
...
<div class="section-mb80 checkout checkout_stays hidden">
<div class="checkout__center center xs-padrl25" style="padding-bottom:80px; border-bottom:1px solid #353945;">

<div class="checkout__wrapper  xs-flexD">
<div class="browse__head wi_50  xs-wi_100">
<h2 class="browse__title h2 changedText   tall   fsz60 xs-fsz45 xs-tall  ">Agents proposed</h2>
<div class="browse__info info changedText">We will find you the best broker to sell your property</div>
</div>
...
<a class="card card_row " style="border: 2px solid #353945;border-radius: 20px;margin-bottom: 20px;" href="#">
  
 <div class="card__preview width200 xs-wi_100" style="background: #131922; padding: 30px;"><img srcset="https://www.dstricts.com/html/usercontent/images/review/1.jpg" src="https://www.dstricts.com/html/usercontent/images/review/1.jpg" alt="London - Kings Cross" style="
    padding: 20px;
    border-radius: 30px;
">
...
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 20px;line-height: 1.2667">Adham Baldanbaev
</div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class='changedText'>35 units</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>23 likes</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>$5000k</span></div>
              </div>
			  
			 <div class="card__foot">
					<div class="card__line hidden">
                      <div class="flight__title changedText" style="font-size:20px; color:white;">Review</div>
 ...
 <div class="card__preview width200 xs-wi_100" style=" background: #131922; padding: 30px;"><img srcset="https://www.qloudid.com/estorecss/tmpnew0.99757700%201713352690.jpg" src="https://www.qloudid.com/estorecss/tmpnew0.99757700%201713352690.jpg" alt="London - Kings Cross" style="
    padding: 20px;
    border-radius: 30px;
">
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 20px;line-height: 1.2667">Jessica Palm</div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class='changedText'>30 units</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>43 likes</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>$6000k</span></div>
              </div>
...
<div class="card__foot">
 ...
 <div class="card__preview width200 xs-wi_100" style=" background: #131922; padding: 30px;"><img srcset="https://www.dstricts.com/html/usercontent/images/review/3.jpg" src="https://www.dstricts.com/html/usercontent/images/review/3.jpg" alt="London - Kings Cross" style="
    padding: 20px;
    border-radius: 30px;
">
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 20px;line-height: 1.2667">Victoria Dawn
</div>
...
">
                ...
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>70 likes</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>$3000k</span></div>
              </div>
			  </div></a>
 ...
 <div class="card__preview width200 xs-wi_100" style=" background: #131922; padding: 30px;"><img srcset="https://www.dstricts.com/html/usercontent/images/review/4.jpg" src="https://www.dstricts.com/html/usercontent/images/review/4.jpg" alt="London - Kings Cross" style="
    padding: 20px;
    border-radius: 30px;
">
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 20px;line-height: 1.2667">Robert Ghirmai
</div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class='changedText'>25 units</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>20 likes</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag"> 
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>$1000k</span></div>
              </div>
			  </div></a>
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 20px;line-height: 1.2667">Anka Eriksson
</div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class='changedText'>15 units</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>13 likes</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>$6000k</span></div>
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 20px;line-height: 1.2667">Fredrik Petersson</div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class='changedText'>75 units</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>21 likes</span ></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class='changedText'>$2000k</span></div>
              </div>
			  </div></a>
...
<div class="section categories hidden" style=" margin-bottom: 80px;">
<div class="categories__center center" style="padding-bottom:80px; border-bottom:1px solid #353945;">
<div class="categories__inner">
<div class="categories__head xs-padrl25 xs-tall" style="
    margin-bottom: 75px;
">
<h2 class="categories__title h2 fsz60 xs-fsz4 changedText" >How it works</h2>
<div class="categories__info info xs-fsz25 fsz30 changedText">4 easy steps that takes less than 5 min to find the best and right agent for your project</div>
</div>
<div class="categories__wrapper">
<div class="categories__slider js-slider-categories " style="padding-bottom:0px;">
<a class="categories__item " href="#" >
...
<div class="categories__subtitle changedText" style="
    ...
    color: #EE8E8C;
    font-weight: 800;
">Hire the right person!</div>
<div class="categories__content changedText" style="
    font-size: 16px;
    /* color: black; */
">
The service is free and you pay us nothing, good luck with your sale!</div></a>
 </div>
</div>
</div>
</div>
...
<div class="section places hidden-xxs" style="margin-bottom: 80px;">
<div class="places__center center" style="padding-bottom:80px; border-bottom:1px solid #353945;">
<div class="places__inner padb0" style="background: transparent; box-shadow:none;  padding-bottom:0px !important; padding-top:0px !important;">
<div class="places__head ">
<h2 class="places__title h2 xs-tall  changedText ">What our users think.</h2>
 <h2 class="product__title h2 talc  xs-padrl0 fsz35 xs-fsz25 xs-tall talc changedText" style="font-family: 'Poppins', sans-serif;font-weight: 100;color: #787f91;max-width: 100%;font-size: 24px;line-height: 1.33333;">Good reasons
</h2>
...
<div class="places__subtitle xs-tall tall fsz24i changedText">David Jonsson </div>
<div class="places__time  xs-tall tall fsz18i changedText" style="
    line-height: 1.33333;
">"I am very satisfied with the help I received from Hittamäklare. I had not sold a home before and received good advice and several brokers to choose from. The brokers got in touch and after comparing them all I chose the one I liked best and he did also a great job with the sale."</div></a><a class="places__item places_item_update xs-mart25" href="javascript:void(0);" tabindex="0" style="" aria-hidden="true">
<div class="status-gray places__number hidden">1480</div>

<div class="places__subtitle xs-tall tall fsz24i changedText">Emilia Sjögren </div>
<div class="places__time xs-tall tall fsz18i changedText" style="
    line-height: 1.33333;
">"I received suggestions for several brokers and chose the one that had sold the most where I live. The statistics on the brokers' sales helped me choose and I was very happy with the final price."</div></a> <a class="places__item places_item_update xs-mart25" href="javascript:void(0);" tabindex="0" style="" aria-hidden="true">
<div class="status-gray places__number hidden">1480</div>

<div class="places__subtitle xs-tall tall fsz24i changedText">Patrik Sveh</div>
<div class="places__time xs-tall tall fsz18i changedText" style="
    line-height: 1.33333;
">"I needed to choose a broker quickly because I just bought a new home and I got help with that. I will use the service again the next time I'm selling."</div></a></div>
</div>
</div>
</div>
</div>
...
<div style="margin-bottom: 80px;" class="section-mb64 xs-marb0 hidden">
<div class="product__center center" style="padding-bottom:80px; border-bottom:1px solid #353945;">

<div class="product__head ">
<div class="product__box" style="
    padding-right: 0px;
">
<h2 class="product__title h2 xs-fsz50 talc xs-tall changedText" style="font-family: 'DM Sans', sans-serif;font-weight: 700;max-width: 100%;">Why use us

</h2>

<h2 class="product__title h2 talc   xs-padrl0 fsz35 xs-fsz25 xs-tall talc changedText" style="font-family: 'Poppins', sans-serif;font-weight: 100;color: #787f91;max-width: 100%;font-size: 24px;line-height: 1.33333;">We are the only one with a records of the best agents in your area
</h2></div>

</div>
<div class="work__body" style="
    margin-bottom: 40px;
">

<div class="work__list" style="margin: 0px; max-width:100%;">
<div class="work__item brdrad20 work__itemM" style="
 text-align: left;
  background: #131922;
 padding: 25px;
 ...
 flex: 0 0 468px;
">
<div class="work__preview"></div>
<div class="work__subtitle changedText" style=" 
    font-size: 20px;
...
">
<div class="work__preview"></div>
<div class="work__subtitle changedText" style="font-size: 20px;
    color: #f67f00;
">Quality assured and authorized brokers</div>

</div>

</div>
</div>
<div class="work__body" style="margin-bottom: 40px;">
...
<div class="work__subtitle changedText"  style=" 
    font-size: 20px;
     ">Unique information about the brokers' assignments</div>
...
<div class="work__item brdrad20 work__itemM" style="
 ...
 background: #131922;
 padding: 25px;
 border: 1px solid #8196b4;
 flex: 0 0 468px;
">
<div class="work__preview"></div>
<div class="work__subtitle changedText"  style=" 
    font-size: 20px;
     ">You choose yourself whether you want to hire one of the brokers.</div>
</div>
</div>
</div>
<div class="work__body"  style="margin-bottom: 40px;">
...
<div class="work__subtitle changedText"  style=" 
    font-size: 20px;
     ">See who sold the most, fastest or most items in your area</div>
...
<div class="work__subtitle changedText"  style=" 
    font-size: 20px;
     ">We have Sweden's only register of sales assignments linked to individual brokers.</div>
...
<div class="work__subtitle changedText"  style=" 
    font-size: 20px; color:black;
     ">See final prices, bid history, current homes and previous sellers' recommendations.</div>
...
<div class="checkout__inner js-tabs wi_50">
<div class="browse__head" style="padding-right:0px;">
<h2 class="browse__title h2 changedText" style="
    font-size: 80px;
    line-height: 90px;
">FAQ</h2>
<div class="browse__info info changedText">Here is a list of frequently asked questions</div>
</div>
...
<div class="checkout__inner js-tabs wi_60" style="padding-right:0px;">
 <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item">
                                      <div class="faq__head "><span class="changedText">Does the service cost anything or do I commit to something?</span></span></div>
                                      <div class="faq__body" style="display: none;">
                                        <div class="faq__content  "><span class="changedText">Using our service is completely free of charge for you as a seller. Instead, we charge a fixed one-off fee from the brokers that we recommend and who in turn are interested in getting your sale. You do not commit to anything and you choose for yourself whether you want to hire one of the brokers.</span></div>
                                        <button class="button-stroke button-small faq__button changedText" fdprocessedid="0f40xc">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">Do I have to choose my broker through you?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">No, our help is voluntary and registering with us entails no obligations. We want you to be satisfied with the selection you receive, but you decide for yourself whether you want to hire one of the brokers.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">Will you resell my contact details?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">Your data is treated confidentially and can only be retrieved by up to three brokers. Your information is never disclosed publicly or to another party.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">Do I have to be contacted by phone?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">The brokers will contact you personally by phone, so that you get as complete a first impression as possible. Gut feeling is important and the image you get of the broker is probably the same as potential buyers will get. Price proposals and reliable reasoning regarding valuation and the sales process usually require the broker to see your home. We therefore recommend that you book personal meetings with the brokers you find interesting, so that your comparison is as good as possible.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">Which brokers use Find-A-Broker?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">All brokers who are registered with the Real Estate Agency have the opportunity to use our service.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
									
									 <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">Do you guarantee that your selection of brokers is the best?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">What distinguishes the "best" broker is individual, so we cannot guarantee that our selection is the best for you. Our selections are based on actual sales statistics, we look at, among other things, the broker's activity in the local area, similar homes and recommendations from previous sellers. You are therefore matched with brokers that we believe are relevant to you and your sales.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
									
									 <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">How many brokers will contact me?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">Up to three brokers will contact you. If you wish to have fewer broker contacts, you can indicate this in your registration.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
									
									 <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">Do you guarantee that three brokers will contact me?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">We are keen for you to get in touch with brokers who are relevant to you and your sales. Our ambition is of course for you to come into contact with three brokers. We guarantee that we will do our best to match you with relevant brokers, but we cannot make any guarantees that these brokers will be available for your particular sale.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
									
									 <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">Is the service associated with any costs?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">No. It is free of charge to use our matching service.</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
									
									 <div class="faq__item">
                                      <div class="faq__head  "><span class="changedText">I am a broker. How do I join your service?</span></div>
                                      <div class="faq__body">
                                        <div class="faq__content  "><span class="changedText">All brokers who are registered with the Real Estate Agency have the opportunity to use our service. Contact us at hello@findabroker.com and we will help you!</span></div>
                                        <button class="button-stroke button-small faq__button changedText">Learn more</button>
                                      </div>
                                    </div>
                </div>
