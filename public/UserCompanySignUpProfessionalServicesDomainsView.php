...
<a class="header__logo xs-fsz20 changedText" href="../../../../selectCity/<?php echo $data['domain_id']; ?>" style="
...
<a class="button button-small header__button   xxs-mart10 changedText hidden-xxs   " href="#" style="margin-left:35px; min-width:112px; background:transparent; color:#777E90; font-size: 16px;">Menu</a>
...
<button class="header__burger js-header-burger"></button>
      ...
      <div class="outer__inner"   >
        <div class="section browse">
          <div class="browse__center center xs-padrl25">
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Book today</h2>
...
">
                    ...
                    <div class="sorting__details" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Select one of these categories to book
</div>
</div></div>
              ...
              <div class="browse__wrapper" style=" margin-top: 20px;">
                <div class="browse__slider js-slider-browse">
				<?php $i=1; 
								foreach($marketplaceSelectedDomainList as $category => $value) 
												{
												 													
												?> 
				<a class="browse__card" href="../../../../professionalServicesList/<?php echo $data['domain_id']; ?>/<?php echo $data['city_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $value['enc']; ?>">
                                      <div class="browse__preview"><img srcSet="<?php echo $value['marketplace_domain_image']; ?>" src="<?php echo $value['marketplace_domain_image']; ?>" alt="Card" style="width: auto;">
                                        <div class="status-black browse__category changedText"><?php echo $value['marketplace_domain_type']; ?></div>
                                      </div>
                                      <div class="browse__subtitle hidden"><?php echo $value['marketplace_domain_type']; ?>
</div>
                                      </a>
												<?php   } ?>
