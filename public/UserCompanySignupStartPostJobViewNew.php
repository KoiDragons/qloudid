...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button visible-xs hidden" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android"><span>Open Qloud ID App</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
