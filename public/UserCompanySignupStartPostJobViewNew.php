...
<div class="section description mart100 xxs-mart40  xs-padb0" style="background: #ffffff;border-color: white; " id="loginBank">
<div class="description__center center xxs-padrl25">
<div class="browse__head">
<h2 class="browse__title h2" style="
    font-size: 80px;
    line-height: 90px;
">SIGN UP</h2>
<div class="browse__info info">Create an account with your Qloud Id app. If you dont have an account then enter your personal email address</div>
<form action="../../emailSignUpJobRequest/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="subscription subscription_big" style="margin-top: 35px;">
...
<div class="receipt__free" style="margin-bottom: 5px;font-size: 25px;color: black;">Open Qloud ID app</div>
				
				
				
</div><div class="receipt__foot">
<div class="receipt__free" style="font-size: 15px;color: grey;">Scan QR code with your Qloud ID app. If you dont have one then create an account for free.
</div>
...
<div class="receipt__subtitle" style="color:white !important;">Create account</div>
</div>
</div>
</div></a>
<div class="receipt__foot  ">
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button visible-xs hidden" href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android"><span>Open Qloud ID App</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
