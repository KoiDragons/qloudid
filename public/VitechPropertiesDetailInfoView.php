...
<div class="column_m     bs_bb lgtgrey2_bg visible-xs  " style="height:93px; background-color: transparent;">
				<div class="wi_100   xs-pos_fix padtb5 xs-padrl25  " style="height:93px;  padding: 41px 0 24px; background-color:  transparent; display:flex">
...
<div class="header__country dropdown-item changedText" tolang="uk">Ukrainian</div></a>
 ...
 <div class="column_m     bs_bb trans_bg hidden-xxs" style="height:93px;  padding: 0px 0 22px !important;">
 	<header class="header js-header authorization xs-padt24   padtb20 xs-bg0e1116" style="height:93px;/* border-bottom: 1px solid #e6e8ec; */">
<div class="header__center center xxs-padrl25">
<a class="header__logo xs-fsz20 changedText" href="../../proposalInformation/<?php echo $data['proposal_id']; ?>" style="
   background-color: #23262F;
   padding: 15px;
   color: #f67f00;
   border-radius: 5px;
...
<a href="#" class="header__item " style="box-shadow:none; margin-left:40px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important; margin-left:0px;">
...
<a href="#" class="header__item " style="box-shadow:none; margin-left:40px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important; margin-left:0px;">
<button class="header__head js-header-head   hidden-xs changedText">Contact us</button>

</div></a>
<a href="#" class="header__item  " style="box-shadow:none; margin-left:20px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;  margin-left:20px;">
<button class="header__head js-header-head   hidden-xs changedText">+34 603 14 72 90</button>
...
<use xlink:href="#icon-user" style="fill:black"></use>
	  ...
	  <div class="product  ">
          <div class="product__center center">
            <div class="control" style="margin-bottom:0px;"><a class="button-stroke button-small control__button" href="../../proposerDetail/<?php echo $data['proposal_id']; ?>">
                <svg class="icon icon-arrow-left">
                  <use xlink:href="#icon-arrow-left"></use>
                </svg><span class="changedText">Go home</span></a>
              <ul class="breadcrumbs" style="list-style-type: none;">
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="../../proposalInformation/<?php echo $data['proposal_id']; ?>">Proposal</a></li>  <?php $i=1; 
								foreach($displayProposalProperties as $category => $value)   
										{
											if($value['enc']!=$data['selected_wishlist_id'])
												continue;
										 ?>
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="#"><?php echo $value['sellPhrase']; ?></a></li>
										<?php } ?>
          ...
          <div class="description__center center">
            <div class="description__wrapper">
              ...
              <div class="description__profile product__rating"><svg class="icon icon-star">
                ...
                <div class="description__name    " style="margin-left:15px; color: #777E90; font-size:14px;"><svg class="icon icon-flag">
                        <use xlink:href="#icon-flag" style="fill: #777E90;"></use>
                      </svg><span class="changedText"><?php if($getPropertyDetailInfo['streetAddress']!=null || $getPropertyDetailInfo['streetAddress']!='') echo $getPropertyDetailInfo['streetAddress'].' , '; if($getPropertyDetailInfo['city']!=null || $getPropertyDetailInfo['city']!='') echo $getPropertyDetailInfo['city'].' , '; if($getPropertyDetailInfo['country']!=null || $getPropertyDetailInfo['country']!='') echo $getPropertyDetailInfo['country']; ?></span></div>
              </div>
			...
			<div class="receipt" style="border: 1px solid #353945 !important; background:transparent;">
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old hidden">$<?php echo $getPropertyDetailInfo['broker_price_per_night']; ?></div>
                    <div class="receipt__actual">$<?php echo $getPropertyDetailInfo['broker_price_per_night']; ?></div>
                ...
                <div class="receipt__avatar"><img src="https://dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar">
              ...
              <div class="receipt__description receipt__description_flex" style="background:#23262F;">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('M d, Y',$getPropertyDetailInfo['checkin_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('M d, Y',$getPropertyDetailInfo['checkout_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle changedText"><?php echo  $getPropertyDetailInfo['adult_guest']+$getPropertyDetailInfo['adult_child']; ?> guests</div>
                  </div>
                </div>
              </div>
              <div class="receipt__btns">
                <button class="button-stroke receipt__button changedText" fdprocessedid="ebxsyj"><span>Save</span><span>
                    ...
                    <svg class="icon icon-check">
                      <use xlink:href="#icon-check"></use>
                    </svg></span></button><a class="button receipt__button changedText" href="../../availabilityCheck/<?php echo $data['proposal_id']; ?>/<?php echo $data['selected_wishlist_id']; ?>" style="background:#F67F00; color:#000000;"><span>Reserve</span>
              ...
              <div class="receipt__table">
                <div class="receipt__line">
                  <div class="receipt__cell changedText">$<?php echo  $getPropertyDetailInfo['broker_price_per_night']; ?> x <?php echo  ($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400; ?> days</div>
                  <div class="receipt__cell">$<?php echo $getPropertyDetailInfo['broker_price_per_night']*(($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400); ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText"><?php echo $getPropertyDetailInfo['tourist_tax']; ?>% tourist tax</div>
                  <div class="receipt__cell">$<?php echo   ($getPropertyDetailInfo['broker_price_per_night']*(($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400))*($getPropertyDetailInfo['tourist_tax']/100);  ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Cleaning fee</div>
                  <div class="receipt__cell">$<?php echo $getPropertyDetailInfo['owner_cleaning_fee']; ?></div>
                </div>
				 <div class="receipt__line hidden">
                  <div class="receipt__cell changedText">Late arrival fee</div>
                  <div class="receipt__cell">$<?php echo $getPropertyDetailInfo['late_arrival_fee']; ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Total</div>
                  <div class="receipt__cell">$<?php echo ($getPropertyDetailInfo['broker_price_per_night']*(($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400))+$getPropertyDetailInfo['owner_cleaning_fee']+($getPropertyDetailInfo['broker_price_per_night']*(($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400))*($getPropertyDetailInfo['tourist_tax']/100); ?></div>
                </div>
              </div>
			  ...
			  <div class="description__parameters">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText ">deposit fee - €<?php echo $getPropertyDetailInfo['owner_deposit_fee']; ?></span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText">If late - €<?php echo $getPropertyDetailInfo['late_arrival_fee']; ?></span>
                </div>
