...
<div class="browse__info info changedText">Here is the list of all eligible bookings for Pre Check-in</div>
</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
	foreach($apartmentPrecheckinRequiredList as $category => $value) 
	{
	?> 	
...
<a href="../precheckedinInfo/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
