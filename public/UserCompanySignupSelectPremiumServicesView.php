...
<h2 class="browse__title h2 changedText xs-fsz60 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >PRICING PLANS
</h2>
<div class="browse__info info changedText">Speed up sign up process. Choose the best plan for your company</div>
</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   bg_E7E7E7  " href="../selectSubscriptionSignup/<?php echo $data['domain_id']; ?>#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91  ">Free</div>
                                      </a>
									  
												<?php }  if($selectedMarketplaceDetail['charge_on_buyers']==1) { ?>
				<a class="categories__item   bg_E7E7E7  " href="../selectSubscriptionGoldSignup/<?php echo $data['domain_id']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91  ">Introduction</div>
                                      </a>
...
<form action="../signUpEmailInfo/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1" autocomplete="off">
			...
			<input type="hidden" name="subscription_type" id="subscription_type" value="3">
			</form>
			
			 <div class="checkout__line  " style="margin-bottom:10px; margin-top:20px; padding-bottom:10px; border-bottom:1px solid #353945;">
					   <div class="checkout__subtitle"><?php echo $selectedMarketplaceDetail['premium_account_subscription_fee']; ?> euro</div>
...
<div class="checkout__box">
 <?php $i=1; 
	...
	<a class="card card_row " style="border: 2px solid #353945;border-radius: 20px;margin-bottom: 20px;" href="javascript:void(0);">
