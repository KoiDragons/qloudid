...
<!-- outer content-->
<div class="outer__inner mart80 xxs-mart65" >
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="
            max-width: 425px;
            ">
            <div class="travel__item xs-marb40 marb175">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">We have invested in smart tech in your new employee portal to simplify your work and boost your efficiency and success.
</div>
...
<form class="checkout__item js-tabs-item" action="../addEmployeeDetails/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<input class="field__input" name="fname" id="fname"    type="text" placeholder="e. g. Kowaken" value="<?php echo $invitationDetail['name']; ?>" style="color:grey; background:#282D34;  border:none;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="lname" id="lname"    type="text" placeholder="e. g. Ghirmai" value="<?php echo $invitationDetail['last_name']; ?>" style="color:grey; background:#282D34;  border:none;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="text" name="email" id="email"  value="<?php echo $invitationDetail['email']; ?>" placeholder="e. g. xyz@gmail.com" style="color:grey; background:#282D34;  border:none;">
</div>
</div>
...
<select  class=" "  name="country" id="country" style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background:#282D34;  border:none; width:100%;" fdprocessedid="8mc52">
				  <?php  foreach($countryOptions as $category => $value) 
															{
																$category = htmlspecialchars($category); 
															?>
															
															<option value="<?php echo $value['id']; ?>"  class="lgtgrey2_bg changedText" <?php if($invitationDetail['phone_country_id_invite']==$value['id']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
														<?php 	}	?>
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"  placeholder="e. g. xxxxxx1234" value="<?php echo $invitationDetail['phone']; ?>" style="color:grey; background:#282D34;  border:none;">
</div>
</div>
</div>
 </div>
