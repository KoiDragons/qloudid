...
<body class="dark" style="background-color:#131922">
 ...
 var issueM="<?php echo date('m'); ?>";
		...
		$.ajax({
		type:"POST",
		url:"../checkPassportInfo/<?php echo $data['hotel_checkin_id']; ?>",
		data:send_data,
		dataType:"text",
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Passport</h2>
<div class="browse__info info xs-fsz25 changedText">Please provide your passport information below</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<form class="checkout__item js-tabs-item" action="../addPassportInformation/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
