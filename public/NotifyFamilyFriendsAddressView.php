               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.safeqloud.com/public/index.php/NotifyFamilyFriends" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<form action="../updateAddress/<?php echo $data['id']; ?>" method="POST" id="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">
								...
								<button type="button" name="forward" class="forword hei_55p bg_ff5bad fsz18 trn ffamily_avenir" onclick="submitForm();">Next</button>
									...
									<a href="../addImage/<?php echo $data['id']; ?>" class="mart10 ffamily_avenir">I cant tell the address</a>
									</div>
									</form>
