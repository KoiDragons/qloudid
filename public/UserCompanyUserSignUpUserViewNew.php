...
">Add</h2>
<div class="browse__info info xs-fsz25 changedText">Describe your self and your business with these questions.</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Details</div>
...
<div class="checkout__line  " style="margin-bottom:0px; margin-top:30px;">
					   <div class="checkout__subtitle">Personal details</div>
...
<input class="field__input" name="first_name" id="first_name"    type="text"   style="background:#23262F; color:grey; border:none;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="last_name" id="last_name"    type="text"   style="background:#23262F; color:grey; border:none;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="text" name="email" id="email"   value="<?php echo $emailRequestReceivedInfo['email']; ?>" readonly style="background:#23262F; color:grey; border:none;">
</div>
</div>
<div class="checkout__row" style="margin-bottom:32px;">
<div class="field">
...
<select  class=""  name="pcountry" id="pcountry" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: #23262F; width:100%;" fdprocessedid="8mc52">
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"   style="background:#23262F; color:grey; border:none;">
</div>
</div>
</div>

<div class="checkout__line  ">
					   <div class="checkout__subtitle">Business details</div>
                       
                      </div>
<div class="field"  >
<div class="field__label changedText" style="color:#787f91;">Company name</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="company_name" id="company_name"   required="" style="background:#23262F; color:grey; border:none;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="text" name="cid" id="cid"    required="" style="background:#23262F; color:grey; border:none;">
</div>
</div>
...
<input type="hidden" id="user_signup_info" name="user_signup_info"  value="2" />
...
<div class="field__wrap">
<input class="field__input" name="daddress" id="daddress"    type="text"   style="background:#23262F; color:grey; border:none;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Port number</div>
<div class="field__wrap">
<input class="field__input"  name="d_port_number" id="d_port_number"    type="text"   style="background:#23262F; color:grey; border:none;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input" name="dzip" id="dzip"    type="text"   style="background:#23262F; color:grey; border:none;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">City</div>
<div class="field__wrap">
<input class="field__input"  name="dcity" id="dcity"    type="text"   style="background:#23262F; color:grey; border:none;">
</div>
</div>
</div>
...
<div class="checkout__line  ">
					   <div class="checkout__subtitle">Refrence detail</div>
                       
                      </div>
 <div class="field"  >
<div class="field__label changedText" style="color:#787f91;">Refrence name</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="refrence_name" id="refrence_name"   required="" style="background:#23262F; color:grey; border:none;">
</div>
</div>
