...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">PROPERTIES Available </h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Proposal created by <?php echo $poposerDetail['first_name'].' '.substr($poposerDetail['last_name'],0,1); ?>
</div>
</div></div>
 ...
 <div class="categories__wrapper">
		...
		<div class="section flights">
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
              ...
              <button class="button-stroke flights__button active changedText hidden">Advanced filter</button>
            </div>
    ...
    margin-bottom: 0px;
">
                   <a href="../propertyInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px; color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                        <div class="card__price" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099;">
                        <div class="card__old">$<?php echo $value['broker_price_per_night']; ?></div>
                        <div class="card__actual">$<?php echo $value['broker_price_per_night']; ?></div>
                      </div>
                    </div>
