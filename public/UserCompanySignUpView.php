...
<html lang="en">
  ...
  <body class="font_poppins">
    ...
    <!-- outer-->
    <div class="outer">
	<div class="column_m header xs-header xsip-header xsi-header bs_bb " style="padding: 0px !important;">
				<div class="wi_100 hei_65p xs-pos_fix padtb5 padrl10 white_bg  xs-lgtgrey_bg">
				
				<div class="logo marr15 wi_140p xs-wi_130p " style="width: 170px !important;">
				
					<a href="#"><h3 class="marb0 pad0 fsz27 black_txt padt15 padb10 ffamily_avenir bold">Tenant XP</h3></a>
...
">Sign up</a></li>
	<li class="dblock hidden-xs hidden-sm fright pos_rel padr20"><a href="https://www.qloudid.com/user/index.php/CreateAccount" id="usermenu_singin" class="translate hei_30pi dblock padrl25 lgn_hight_30 black_txt ffamily_avenir padt5">Security</a></li>
	...
	<li class="dblock hidden-xs hidden-sm fright pos_rel   last"><a href="http://www.qricis.com/servicestore.html" id="usermenu_singin" class="translate hei_30pi dblock padrl25    lgn_hight_30 black_txt   ffamily_avenir padt5">ServiceStore</a></li>
      ...
      <!-- header 
       <header class="header js-header authorization">
        <div class="header__center center"><a class="header__logo" href="javascript:void(0);"><img class="some-icon" src="<?php echo $path; ?>/html/fleet/img/logo-dark.svg" alt="Fleet"><img class="some-icon-dark" src="<?php echo $path; ?>/html/fleet/img/logo-light.svg" alt="Fleet"></a>
          <div class="header__wrapper js-header-wrapper">
           ...
           <a href='#' class="header__item"> <div class=" header__item_language js-header-item " style="border-left: 0px solid !important;">
			...
			<a class="button button-stroke button-small header__button" href="javascript:void(0);">List your property</a>
			<a class="button button-stroke button-small header__button margin-top20" href="javascript:void(0);" style="background: #58C27D; box-shadow: 0 0 0 2px #58c27d inset;">Login</a>
          </div>
		   ...
		   <div class="header__item header__item_user js-header-item">
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
                <div class="header__menu"><a class="header__link" href="javascript:void(0);">
                    <svg class="icon icon-comment">
                      <use xlink:href="#icon-comment"></use>
                    </svg>Messages</a><a class="header__link" href="javascript:void(0);">
                    <svg class="icon icon-home">
                      <use xlink:href="#icon-home"></use>
                    </svg>Bookings</a><a class="header__link" href="javascript:void(0);">
                ...
                <div class="header__menu"><a class="header__link" href="javascript:void(0);">
                    ...
                    </svg>List your property</a><a class="header__link" href="javascript:void(0);">
                    <svg class="icon icon-flag">
                      <use xlink:href="#icon-flag"></use>
                    </svg>Host an experience</a></div>
              </div>
              <div class="header__btns"><a class="button button-small header__button" href="javascript:void(0);">Account</a>
  ...
  <script>
	  function submitForm()
		{
			...
			else if($("#company_name").val()=="" || $("#company_name").val()=="")
			{
			 ...
			 if($("#company_email").val()=="" || $("#company_email").val()=="")
			{
				
				$("#errorMsg1").html('Please enter company email address ');
				return false;
			}
					...
					$.ajax({
						...
						success: function(data1){
							...
							else if(data1==2)
							{
								...
								$("#errorMsg1").html('Please enter unique Company email');
								return false;
							}
							else
							{
      ...
      <div class="outer__inner">
        <div class="section-mb80 checkout checkout_stays">
          <div class="checkout__center center">
            <div class="control"><a class="button-stroke button-small control__button" href="#">
                <svg class="icon icon-arrow-left">
                  <use xlink:href="#icon-arrow-left"></use>
                </svg><span>Go home</span></a>
              <ul class="breadcrumbs">
                <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="#">Sign up</a></li>
                <li class="breadcrumbs__item">Add company</li>
              </ul>
            </div>
            <div class="checkout__wrapper">
              <div class="checkout__inner js-tabs" >
                <h2 class="checkout__title h2">Register your community</h2>
                <div class="checkout__list">
                    <div class="checkout__section" style="display:none; border-top: 0px !important;">
				  <a class="button checkout__button margin-bottom24" href="#" >Sign up</a>
                      ...
                      <div class="checkout__data checkout__data_flex">
                        <div class="checkout__el">
                          <div class="checkout__datepicker">
                            ...
                            <input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly value="">
                    ...
                    <div class="checkout__box">
                      <div class="checkout__top">
                        ...
                        <div class="nav"><a class="nav__link js-tabs-link" href="#">Credit Card</a> </div>
                      </div>
                      <div class="field">
                  ...
                  <div class=" ">
				  <form action="addBuildingDetails" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
				  
                      <div class="checkout__line">
                        <div class="checkout__subtitle">Tell us about you!</div>
                      ...
                      <div class="checkout__fieldset">
                        <input type="hidden" name="signup_type" id="signup_type" value="<?php echo $data['signup_type']; ?>" />
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            <div class="field__label">Name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="fname" id="fname" placeholder="First name" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="lname" id="lname" placeholder="Last name" required>
                            </div>
                          </div>
                        </div>
						...
						<div class="field">
                          ...
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email" placeholder="XXX@XYZ.com" required>
                          </div>
                        </div>
                       <div class="checkout__row margin-bottom32">
                          <div class="field">
                           ...
                           <div class="field__wrap">
                          <select  name="country" id="country" style="background: #ffffff !important; color: #141416; box-shadow: inset 0 0 0 2px #E6E8EC;
    -webkit-appearance: none; float: none;
    width: 100%;
    height: 48px;
    ...
    line-height: 48px; ">
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" id="pnumber" placeholder="Phone number" required>
                            </div>
                          </div>
                        </div>
                      </div>
					   ...
					   <div class="checkout__subtitle">Community details</div>
                      ...
                      <div class="checkout__fieldset">
						...
						<div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="company_name" id="company_name" placeholder="Company name" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label">Company identification</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="cid" id="cid" placeholder="Company identification" required>
                            </div>
                          </div>
                        </div>
						...
						<div class="checkout__row margin-bottom32">
						<div class="field">
                            <div class="field__label">Company type</div>
                            <div class="field__wrap">
                             <select class="select" name="company_type" id="company_type" style="display: none;">
                          ...
                          <div class="field">
                            <div class="field__label">Company email</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="company_email" id="company_email" placeholder="Company email" required>
                            </div>
                          </div>
                        </div>
						<div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="daddress" id="daddress" placeholder="Delivery address" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="d_port_number" id="d_port_number" placeholder="Port number" required>
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="checkout__row margin-bottom32">
                          <div class="field">
                            <div class="field__label">Zipcode</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dzip" id="dzip" placeholder="Zipcode" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label">City</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dcity" id="dcity" placeholder="City" required>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="margin-bottom32">
                          <div class="field">
                            <div class="field__label"><?php if($data['signup_type']==1){ ?> Object type <?php } else { ?>Category<?php } ?></div>
                           <div class="field__wrap">
                          <select  name="objectType" id="objectType" style=" background: #ffffff !important; color: #141416; box-shadow: inset 0 0 0 2px #E6E8EC;
    -webkit-appearance: none; float: none;
    width: 100%;
    height: 48px;
    padding: 0 48px 0 16px;
    ...
    font-weight: 500;
    line-height: 48px; ">
                         <?php if($data['signup_type']==1){ ?>
                           <option value="1" class="lgtgrey2_bg">Building</option>
						  <?php } else { foreach($professionalCategoryDetail as $category => $value) 
												{ ?> 
								<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg"><?php echo $value['category_name']; ?></option>	
												<?php } } ?> 	
                          </select>
						  ...
						  <div class="field">
						  <div id="errorMsg1" style="font-size:16px; color:red; "></div>
                       </div>
                       <a class="button checkout__button" href="javascript:void(0);" onclick="submitForm();">Sign up</a>
                    </form>
              ...
              <div class="price">
                <div class="price__head">
                  <div class="price__preview"><img src="<?php echo $path.'/html/fleet/img/content/photo-1.1.jpg';  ?>" alt="Price"></div>
                ...
                <div class="price__description price__description_flex">
                  <div class="price__item">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo date('M d, Y'); ?></div>
                    </div>
                  </div>
                  <div class="price__item">
                    <div class="price__icon">
                ...
                <div class="price__body">
                  ...
                  <div class="price__table">
                    <div class="price__row">
                      <div class="price__cell">$100 x 3 nights</div>
                      <div class="price__cell">$300</div>
                    </div>
                    <div class="price__row">
                      <div class="price__cell">0% campaign discount</div>
