<html lang="en" style="--vh:6.01px;"><head>
    <meta charset="utf-8">
    <title>Fleet</title>
...
<script>
		...
		{
			$("#save_indexing").attr('action','searchDetail');
			if($('#city').val()==0)
			{
				alert('please enter city'); return false;
			}
			if($('.js-date-from').val()=='' || $('.js-date-from').val()==0)
			{
				alert('please select checkin date');
				return false;
			}
			if($('.js-date-to').val()=='' || $('.js-date-to').val()==0)
			{
	 ...
	 function updateWidth()
	 {
		 var width = $(window).width();
			...
			if(width>1200)
				{
					$('.browse__wrapper').attr('style','width:1216px');
				}
	...
	function getVal(id)
	{
	var getData=$(id).find('.noUi-tooltip').html();
	$('#priceStart').val(getData);
	getProperties();
	}
...
<div class="outer">
<!-- header-->
	<header class="js-header authorization xs-padding032" style=" padding:24px 0px !important; border-bottom: 1px solid #F67F00;">
<div class="header__center center"><a class="header__logo xs-fsz20 " href="#" style="
   /* background-color: #E91E63;*/
    ...
    line-height:25px !important;
	 border: 2px solid #798092;

    ">Dstricts</a>


		<div class="header__wrapper js-header-wrapper" style="background: #212b39;">
		<div class="header__item header__item_dropdown js-header-item">

<div class="header__body js-header-body">
<div class="header__menu"><a class="header__link active" href="#" style="color:#F67F00; box-shadow: none;">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg>DIY Booking platform</a><a class="header__link" href="../findExclusive/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Exclusive Concierge</a><a class="header__link" href="../selectBrand/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09">
<svg class="icon icon-home">
<use xlink:href="#icon-home"></use>
</svg>Business</a><a class="header__link" href="../findMembers/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Join</a></div>
</div>
...
<div class="header__body js-header-body">
<div class="header__list"><a class="header__box active" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="en">English</div>
<div class="header__country dropdown-item changedText" tolang="en">United States</div></a><a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="sv">Sweden</div>
<div class="header__country dropdown-item changedText" tolang="sv">Swedish</div></a>
					<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="ru">Russia</div>
<div class="header__country dropdown-item changedText" tolang="ru">Russian</div></a></div>
</div>
</div>

			

<a href="#" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
...
<a href="#" class="header_item hidden-xxs" style="margin-left:10px;"><div class="header_item_language js-header-item" style="border-left: 0px solid !important; ">
<button class="header__head js-header-head fsz14   changedText " fdprocessedid="hudfia" style=" font-weight:700;
    color: #f67f00;
">DIY Booking platform</button>

</div></a>

<a href="../findExclusive/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" class="header_item hidden-xxs" style="margin-left:40px;"><div class="header_item_language js-header-item" style="border-left: 0px solid !important; ">
<button class="header__head js-header-head fsz14   changedText" fdprocessedid="hudfia" style="font-weight:700;
    color: #7a8294;
">Exclusive Concierge</button>

</div></a>
<a href="../selectBrand/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" class="header_item hidden-xxs" style="margin-left:40px;"><div class="header_item_language js-header-item" style="border-left: 0px solid !important; ">
<button class="header__head js-header-head fsz14  changedText" fdprocessedid="hudfia" style="font-weight:700;
    color: #7b8395;
">Business</button>

</div></a>
<a class="button button-stroke button-small header__button fsz14 xxs-mart10 changedText hidden-xxs" href="../findMembers/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style=" border: 1px solid #333;color: #7c8496;">Join</a>
...
<div class="outer__inner" style="margin-top:70px;">


<div class="section faq">
<div class="faq__center center">
<div class="faq__top">
<div class="faq__stage">Introduktion</div>
<h1 class="faq__title h2" style="color:white;">Terms Exclusive Concierge</h1>
<div class="faq__info" style="font-size:20px;color: #787f91;">These Conditions apply to all services ordered
from or provided to you by Dstricts and by requesting services from Dstricts
you agree that these conditions shall apply to those services and your order.</div>
<div class="mobile-show">
<select class="select  " style="display: none;" onchange="location = this.options[this.selectedIndex].value;">
<option value="loginApiInfo" selected="">Login</option>
<option value="signinApiInfo">Sign in</option>
<option value="paymentApiInfo">Payment</option>
<option value="../PublicDocumentationSoftware">HR</option>
				<option value="qloudidAppApiInfo">App API</option>
</select><div class="nice-select select" tabindex="0"><span class="current">Login</span><ul class="list"><li data-value="loginApiInfo" class="option selected">Login</li><li data-value="signinApiInfo" class="option">Sign in</li><li data-value="paymentApiInfo" class="option">Payment</li><li data-value="../PublicDocumentationSoftware" class="option">HR</li><li data-value="qloudidAppApiInfo" class="option">App API</li></ul></div>
</div>
</div>
...
<use xlink:href="#icon-home"></use>
					...
					<a class="faq__link  active" href="#" style="font-size:18px;">
...
<use xlink:href="#icon-lightning"></use>
					...
					<a class="faq__link  " href="https://www.qloudid.com/public/index.php/PublicDocumentationSoftware/codeofConduct" style="font-size:18px;">
<svg class="icon icon-lightning">
<use xlink:href="#icon-lightning"></use>
...
<div class="faq__col">
<div class="faq__box " style="display: block; font-family: 'Poppins', sans-serif; color: #787f91; font-size:16px;">
<div class="faq__item">
<div class="faq__head" style="color:white;">Terms of use</div>
...
DEFINITIONS AND INTERPRETATION<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoListParagraphCxSpFirst" style="margin-left:18.0pt;mso-add-space:
auto;text-indent:-18.0pt;mso-list:l0 level2 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">In these Conditions, the following
definitions apply:<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.1<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Benefits: means the benefits made
available to Members by Suppliers.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.2<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Conditions: these terms and
conditions as amended from time to time in accordance with clause 10.5.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.3<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Joining Fee: means the Fee payable
by the Member to Dstricts upon acceptance of a Membership application, in
accordance with clause 3.1.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.4<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Member: a person registered as a
member of the Membership Club.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.5<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Membership: means membership of the
Membership Club.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.6<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Membership Card: means the card
issued to Members by Dstricts upon acceptance of a Membership application in
accordance with clause 2.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.7<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Membership Club: means the Dstricts
Lifestyle Membership Club owned by Dstricts (UK) Limited.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.8<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Membership Fees: means the fees
payable in respect of Membership notified to Members upon application for and
prior to renewal of Membership.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.9<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Payment Card: has the meaning given
in Clause 3.7.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.10<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Website: means the website located
at </span><a href="http://www.quintessentially.com"><span lang="EN-US" style="mso-ansi-language:EN-US">www.Dstricts.com</span></a><span lang="EN-US" style="mso-ansi-language:EN-US">.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.11<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Request: means a request placed by a
Member with Dstricts for Dstricts to arrange the supply of goods and/or
services from a third party on the Member's behalf.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpMiddle" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.12<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Services: means the concierge and
lifestyle management services provided by Dstricts to its Members as part of
their Membership.<o:p></o:p></span></p>

<p class="MsoListParagraphCxSpLast" style="text-indent:-36.0pt;mso-list:l0 level3 lfo1"><!--[if !supportLists]--><span lang="EN-US" style="mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
mso-ansi-language:EN-US"><span style="mso-list:Ignore">1.1.13<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp; </span></span></span><!--[endif]--><span lang="EN-US" style="mso-ansi-language:EN-US">Supplier means a supplier engaged by
Dstricts on behalf of and as agent for a Member to provide goods and/or
services to that Member.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">1.2 In
these Conditions, the following rules apply:<o:p></o:p></span></p>

<p class="MsoNormal" style="text-indent:65.2pt"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) a person includes a natural person,
corporate or unincorporated body (whether or not having separate legal
personality);<o:p></o:p></span></p>

<p class="MsoNormal" style="text-indent:65.2pt"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) a reference to a party includes its
personal representatives, successors or<o:p></o:p></span></p>

<p class="MsoNormal" style="text-indent:65.2pt"><span lang="EN-US" style="mso-ansi-language:EN-US">permitted assigns;<o:p></o:p></span></p>

<p class="MsoNormal" style="margin-left:65.2pt"><span lang="EN-US" style="mso-ansi-language:EN-US">(c) a reference to a statute or statutory
provision is a reference to such statute or statutory provision as amended or
...
amended or re-enacted;<o:p></o:p></span></p>

<p class="MsoNormal" style="margin-left:65.2pt"><span lang="EN-US" style="mso-ansi-language:EN-US">(d) any phrase introduced by the terms
...
<p class="MsoNormal" style="text-indent:65.2pt"><span lang="EN-US" style="mso-ansi-language:EN-US">(e) a reference to writing or written includes
e-mails.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">2. MEMBERSHIP APPLICATIONS AND YOUR MEMBERSHIP
CARD<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.1 All
Membership applications are subject to acceptance by Dstricts at its sole
discretion. Dstricts shall notify applicants in the event that his or her
Membership application has been accepted. Dstricts is under no duty to disclose
its reasons for rejecting any Membership application.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.2 You are
obliged to provide correct personal details when you apply for Membership.
Failure to do so may invalidate your Membership and any subsequent
transactions. Your responsibility to provide accurate information is a
continuing obligation and you must notify Dstricts promptly in the event that
any information provided by you in connection with your Membership changes.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.3 Dstricts
operates offices in a number of territories worldwide. Dstricts encourages
Members with residences in multiple territories to register for Membership with
the Dstricts office in the territory where their primary residence is located
in the first instance.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.4 Dstricts
will issue you with a Membership Card together with associated Membership
documentation as soon as possible following receipt of your Joining Fee and
Membership Fee.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.5 Your
Membership is personal to you. You are responsible for ensuring that no one
(other than your personal assistant on your behalf, where applicable) uses your
Membership.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.6 Access
to and use of your personalized Membership section of the Website is through a
combination of user name and password. You are solely responsible for
maintaining the confidentiality of your user name and password and you agree to
notify Dstricts immediately if you believe that there has been any breach of
security, including the unauthorized use of your name and password.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.7 We will
take all steps reasonably necessary to ensure that your data is treated
securely and in accordance with the Dstricts privacy policy, further details of
which are set out in Clause 10.1. Please note that all information you provide
to us is stored on our secure servers. Any payment transactions carried out by
us or our chosen third-party provider of payment processing services will be
encrypted using Secured Sockets Layer technology.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">2.8 You
must notify Dstricts immediately by e-mail at AskQ@Dstricts.com if your
Membership Card is lost or stolen.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">3. MEMBERSHIP FEES, UPGRADES, CANCELLATIONS AND
RENEWALS<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.1 For the
first year of your Membership, Membership Fees and the Joining Fees payable
shall be confirmed to you prior to acceptance of your Membership application.
The Joining Fee shall be payable in full upon acceptance of your Membership
application. Any increase or decrease to the Membership Fees for subsequent
years of Membership will be notified to all Members in advance or their Renewal
Dates.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.2 You
acknowledge that your payment of the Joining Fee constitutes your express
request for us to begin to supply you with the Services.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.3 Subject
to Clauses 3.5, 3.6 and 3.12, Membership Fees are non-refundable. Your Joining Fee
covers our costs in setting up your Membership and is non-refundable in all
circumstances.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.4 You
have the right to cancel your Membership until the end of 14 days after the day
on which we accept your Membership application ("Cancellation
Period") and we would ask that you inform us of your decision in writing.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.5 If you
cancel your Membership within the Cancellation Period, you will be reimbursed
for your Membership Fee, less deductions for the Services we have performed up
until you informed us of your decision to cancel.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.6 Dstricts
reserves the absolute right to cancel or suspend your Membership where it has
reason to do so. If Dstricts cancels your Membership, where it is reasonable to
do so Dstricts shall refund the balance of the current annual Membership Fee on
a pro rata basis in respect of the unexpired period to which the annual <o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">Membership
Fee relates.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.7
Membership Fees are due on acceptance of your Membership application and
annually thereafter (the "Renewal Date"), and full payment will be
taken by Dstricts annually in advance by direct debit or payment by a credit or
debit card which you have authorized us to deduct such payment from
("Payment Card") in accordance with the relevant invoice.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.8 Where
you have provided us with details of a Payment Card or have authorized a direct
debit mandate, you hereby expressly authorize Dstricts to deduct collect
renewal Membership Fees up to 28 days prior to or on your Renewal Date. Alternatively,
you will be contacted directly in order to renew your Membership.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.9 If you
do not wish to renew your Membership you must notify us at least 30 days prior
to your Renewal Date.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.10 If you
do not notify us in accordance with Clause 3.9, Dstricts reserves the right to
recharge the then current Membership Fee in order to renew the Membership.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.11 Dstricts
(and its affiliated international offices) reserve the right to refuse to
provide the Services should any payment due under these Conditions not be
received.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.12 If,
during the course of your current Membership, you wish to upgrade your
Membership to a higher level of Membership or Dstricts reasonably requests you
to upgrade your Membership based on your usage of the Services, the difference
in price between the two categories of Membership will be payable on a pro rata
basis. If you do not accept Dstricts's request for you to upgrade your
Membership then Dstricts reserves the right to cancel your existing Membership
with immediate effect in which case you will be entitled to a pro-rata refund
in respect of the period from the date of cancellation until the end of the
relevant Membership year for which you have paid Membership Fees.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">3.13 Dstricts
may at your request purchase goods or services on your behalf. In the event
that we act as a credit agent in this regard, you hereby authorize Dstricts to
deduct the credit sum from your Payment Card immediately.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">4. SUPPLY OF SERVICES<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.1 Dstricts
shall supply the Services to the Member during the Membership in accordance
with the Member's particular Requests, provided that Dstricts shall not be
required to provide or facilitate the supply of goods and/or services that it
deems at its sole discretion may violate applicable laws, standards and/or
regulations or may offend taste and decency in the relevant jurisdiction.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.2 Dstricts
shall use its reasonable endeavors to meet any performance dates specified, but
any such dates shall be estimates only and time shall not be of the essence for
performance of any Services.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.3 Dstricts
...
materially affect the nature or quality of the Services, and Dstricts shall
notify the Member in any such event.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.4
Services will be provided in English (and in other languages depending on the
location of the Dstricts office during normal business hours).<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.5 Outside
normal business hours (or as may otherwise be required from time to time),
Member queries and/or Requests may be routed to an alternative Dstricts office
for assistance. At such times, services will be provided in the English
language.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.6 You
acknowledge that Dstricts reserves the right to accept commissions upon the
supply of products or performance of services by any Supplier.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.7
Telephone calls to Dstricts may be monitored or recorded for training and
quality control purposes.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.8 Dstricts
shall provide the Services using reasonable care and skill and, as far as
reasonably possible, in accordance with your Requests and reasonable
instructions from time to time.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.9
Restaurants and clubs:<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) When
you use the restaurant booking service you hereby authorize us to debit your
Payment Card for any deposit paid by us on your behalf to the restaurant which
is forfeited as a result of your cancellation of the booking.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) When
you use the restaurant booking service you agree that where you cancel a
restaurant booking within 24 hours of the time the restaurant reservation is
made you shall not be entitled to any refund of any monies paid to secure the
booking including the return of any booking deposit.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(c) Dstricts
reserves the right to deny restaurant requests from Members if Members
repeatedly fail to honor their bookings or continuously violate cancellation
policies.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(d)
Admission of Members to any club premises is at all times at the sole
discretion of the club Supplier and Dstricts shall have no liability where a
Member is refused admission to a club.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">4.10
Tickets:<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) Dstricts
may be able to obtain "best tickets" for you in relation to sold out
events through one of its ticket agent partners. Please note that by
instructing Dstricts to obtain such tickets on your behalf you are agreeing to
purchase tickets above face value and the total cost may include a service
charge to Dstricts in respect of our provision of services to obtain the seats
for you. Dstricts is not the seller of the tickets and is not responsible for
fulfilment of your order.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) All
such tickets and ticket agent partners (who shall be the seller in respect of
the transaction) shall have their own terms and conditions (which we suggest
you should read). Such terms and conditions are likely to include terms which
state that sales of tickets are final and no refunds shall be issued after the
purchase has been made. Dstricts shall <o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">not be able
to provide you with any refund or obtain any such refund on your behalf.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(c) In the
event of a show being cancelled directly by the artist/promoter, it may be
possible to obtain a refund of the face value of the relevant tickets.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(d) Dstricts
or its ticket agent partner will dispatch your tickets through delivery agents
at standard rates. Please note that Dstricts shall not be liable for any
failure by delivery agents to deliver your tickets.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">5. PLACING A REQUEST<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">5.1 Members
may place Requests by telephone (which does not include text messages), e-mail
or through the Members' section of the Website.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">5.2 Members
should always contact their primary office in the first instance to manage all
Requests (including international Requests).<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">5.3 Dstricts,
acting reasonably, reserves the right to withdraw any of the Services and/or to
refuse to accept any Requests at its sole discretion.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">5.4 If Dstricts
is unable or not obliged to deal with any Request, it will inform the Member as
soon as reasonably practicable.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">5.5 You
undertake that all details you provide to us for the purpose of booking,
ordering or purchasing products or services are correct, that the debit, credit
and/or Payment Card you use from time to time is your own and that you have
sufficient funds to cover the cost of the product or service.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">5.6 From
time to time the procurement or provision of certain services, products or
benefits may incur a Dstricts services fee or handling charge (of which you
will be notified in advance, and which may vary between Dstricts offices) and
in such event you hereby authorize Dstricts to debit your Payment Card with any
such handling charges or, alternatively, to invoice you in respect of such fees
or charges.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">6. CANCELLATIONS, REFUNDS AND RETURNS<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.1 The
Member acknowledges that the sales contract for the supply of goods and/or
services made as a result of a Request is between the Member and the relevant
Supplier and that Dstricts is not a party to such contract. Cancellation of
contracts with Suppliers should be addressed with the Supplier directly and
will be subject to the relevant Supplier's policies.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.2 If a
Request for a specific product or service is not available, Dstricts may offer
you substitute products or services of a similar description and standard. You
may at your sole discretion refuse acceptance of such substitute products
and/or services and request a full refund in the event that payment has already
been made to the Supplier for the unavailable product or service.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.3 All
descriptions of any products, services or Benefits on the Website have been
approved by the relevant Supplier. Dstricts shall not be liable for inaccurate
or misleading descriptions.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.4 Payment
for all products and services shall be due immediately upon acceptance of the
order by the relevant Supplier.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.5 The
Member further acknowledges that for goods purchased on his or her behalf by Dstricts
directly from a Supplier, returns and exchanges will be subject to the terms
and conditions of that Supplier and returns or exchange of goods purchased may
not always be permitted. In circumstances where Dstricts is asked to source a
specific item for a Member, Dstricts shall inform the Member of the refund and
exchange policy of that Supplier in advance. Dstricts shall not be liable to
the Member where a Supplier does not accept the return or exchange of an item.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.6 It
shall be the Member's sole responsibility to retain all proof of return of
goods to a Supplier, we recommend returning the goods by registered delivery,
or by any other similar means of ascertaining the date of the return dispatch
and tracking the return.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.7 We will
inform you when we become aware that a refund of an order has been processed by
a Supplier.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.8 Where
orders are delivered outside the EU, any applicable customs duties and sales
taxes shall not be refundable through Dstricts. It shall be the Member's sole
responsibility to recover such monies. Dstricts shall have no liability for any
items held by any customs or border agency.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">6.9 In the
case of premium courier services, if the Member is not at the specified
Delivery address to receive their Order at the scheduled time, the Member may
incur further charges for subsequent attempts to re-deliver the goods.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">7. SUPPLIERS<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">7.1
Suppliers are responsible for providing you with the services, products and
Benefits you Request us to order on your behalf from time to time. Dstricts
shall communicate with Suppliers on your behalf unless it is more appropriate
for you to contact the Supplier directly.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">7.2
Suppliers may impose their own terms and conditions which, in every case apply
to the supply of goods and/or services by that Supplier to you, and such terms
and conditions shall be binding upon you at the time of order.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">7.3 When
ordering a product or service or accessing a Benefit, you may be required to
provide your Payment Card details. If you request and authorize Dstricts to use
your Payment Card in order to pay a Supplier for products or services, you
acknowledge and agree that Dstricts shall have no liability or be responsible
in any way whatsoever in respect of the use of your Payment Card provided that Dstricts
acts in accordance with the instructions issued by you in relation thereof.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">7.4 You
acknowledge that the Benefits are subject to availability and may change from
time to time without notice.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">7.5 If Dstricts's
performance of any of its obligations under these Conditions is prevented or
delayed by any act or omission by the Member or failure by the Member to
perform any relevant obligation (Member Default):<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) Dstricts
shall without limiting its other rights or remedies have the right to suspend
performance of the Services until the Member remedies the Member Default, and
to rely on the Member Default to relieve it from the performance of any of its
obligations to the extent the Member Default prevents or delays Dstricts's
performance of any of its obligations;<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) Dstricts
shall not be liable for any costs or losses sustained or incurred by the Member
arising directly or indirectly from Dstricts's failure or delay to perform any
of its obligations as set out in this clause 7.5; and<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(c) the
Member shall reimburse Dstricts on written demand for any costs or losses
sustained or incurred by Dstricts arising directly or indirectly from the
Member Default.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">8. LIMITATION OF LIABILITY<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.1 Nothing
in these Conditions shall limit or exclude Dstricts's liability for:<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) death
or personal injury caused by its negligence, or the negligence of its
employees, agents or subcontractors;<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) fraud
or fraudulent misrepresentation; or<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(c) breach
of the terms implied by section 2 of the Supply of Goods and Services Act 1982 (title
and quiet possession).<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.2 Subject
to clause 8.1:<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) Dstricts
shall not be liable to the Member, whether in contract, tort (including
negligence), breach of statutory duty, or otherwise, for any loss of profits,
loss of business, depletion of goodwill and/or similar losses, loss of
anticipated savings, loss of goods; or, loss of contract, or loss of use or,
loss of corruption of data or information whether direct or indirect or, any
special, indirect, consequential or pure economic loss, costs, damages, charges
or expenses arising under or in connection with their Membership; and<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) Dstricts's
total liability to the Member in respect of all other losses arising under or
in connection with their Membership, whether in contract, tort (including negligence),
breach of statutory duty, or otherwise, shall be limited to the total value of
the Member's annual Membership Fee.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.3 Your
contract for the supply of products or services is made with the relevant
Supplier only. Dstricts acts as an agent for the Supplier and, unless expressly
provided otherwise, all your rights and remedies are against the Supplier.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.4 You
acknowledge that any contract entered into by you with any Supplier is an
independent contract. Dstricts hereby disclaims any and all liability for any
act or omission of any Supplier or any loss incurred by you as a result of any
act or omission of a Supplier whether or not arranged through the Dstricts.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.5 Dstricts
shall have no liability to you for any loss, damage, costs, expenses or other
claims for compensation arising from Requests or any instructions supplied by
you which are incomplete, incorrect or inaccurate or arising from their late
arrival or non-arrival, or any Member Default.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.6 Dstricts
shall not be liable to you or be deemed to be in breach of these Conditions by
reason of any delay in performing, or any failure to perform, any of Dstricts's
obligations in relation to the Services, if the delay or failure was due to any
cause beyond Dstricts's reasonable control.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.7 Except
as expressly set out in these Conditions, all warranties, conditions and other
terms implied by statute or common law are, to the fullest extent permitted by
law, excluded from these Conditions.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">8.8 This
clause 8 shall survive termination of these Conditions.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">9. COMMENCEMENT AND TERMINATION<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">9.1 These
Conditions shall take effect and be binding upon the Member and Dstricts (UK)
Limited upon acceptance by Dstricts of your Membership application. These
Conditions shall be applicable for the duration of your Membership and shall
...
Dstricts (UK) Limited and no other entity.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><span lang="EN-US" style="mso-ansi-language:EN-US">10. GENERAL<o:p></o:p></span></b></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.1
Privacy and Data Protection<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">The
Services and your Membership are subject to the Dstricts privacy policy,
incorporated into these Conditions by reference and set out at the following
web address: Privacy Policy which applies at all times in relation to any data
that we collect from you.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.2
Assignment and subcontracting:<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) Dstricts
may at any time assign, transfer, charge, subcontract or deal in any other
manner with all or any of its rights under these Conditions and may subcontract
or delegate in any manner any or all of its obligations under these Conditions
to any third party or agent.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) The
Member shall not, without the prior written consent of Dstricts, assign,
transfer, charge, subcontract or deal in any other manner with all or any of
its rights or obligations under these Conditions.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.3
Waiver:<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) A
waiver of any right under these Conditions is only effective if it is in
...
these Conditions or by law shall constitute a waiver of that or any other right
or remedy, nor preclude or restrict its further exercise. No single or partial
exercise of such right or remedy shall preclude or restrict the further
exercise of that or any other right or remedy.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) Unless
specifically provided otherwise, rights arising under these Conditions are
cumulative and do not exclude rights provided by law.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.4
Severance:<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(a) If a
court or any other competent authority finds that any provision of these
...
Conditions shall not be affected.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">(b) If any
invalid, unenforceable or illegal provision of these Conditions would be valid,
...
<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.5
Variation: Dstricts may vary these Conditions from time to time and will notify
you of any changes in a timely manner. Notification will be by some or all of
the following: Dstricts Newsletter, the Website, by Email or by phone. Your
continued use of your Membership constitutes acceptance of such variations to
these Conditions.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.6 No
partnership: Nothing in these Conditions is intended to, or shall be deemed to,
...
<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.7 Third
parties: A person who is not a party to these Conditions shall not have any
rights under or in connection with it.<o:p></o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US"><o:p>&nbsp;</o:p></span></p>

<p class="MsoNormal"><span lang="EN-US" style="mso-ansi-language:EN-US">10.8 Governing
law and jurisdiction: These Conditions, and any dispute or claim arising out of
...
exclusive jurisdiction of the courts of England and Wales.<o:p></o:p></span></p>
...
<!-- scripts-->
<script src="../../../..//html/fleet/js/lib/jquery.min.js"></script>
<script src="../../../..//html/fleet/js/lib/slick.min.js"></script>
<script src="../../../..//html/fleet/js/lib/jquery.nice-select.min.js"></script>
<script src="../../../..//html/fleet/js/lib/share-buttons.js"></script>
<script src="../../../..//html/fleet/js/lib/jquery.fancybox.min.js"></script>
<script src="../../../..//html/fleet/js/lib/jquery.rateyo.min.js"></script>
<script src="../../../..//html/fleet/js/lib/nouislider.min.js"></script>
<script src="../../../..//html/fleet/js/lib/wNumb.js"></script>
<script src="../../../..//html/fleet/js/lib/jquery.magnific-popup.min.js"></script>
<script src="../../../..//html/fleet/js/lib/moment.min.js"></script>
<script src="../../../..//html/fleet/js/lib/jquery.daterangepicker.min.js"></script>
<script src="../../../..//html/fleet/js/lib/simpleParallax.min.js"></script>
<script src="../../../..//html/fleet/js/demo.js"></script>
<script src="../../../..//html/fleet/js/app.js"></script>
<!-- svg sprite-->
...
<bugherd-sidebar></bugherd-sidebar></body>
  <div class="popup popup_login mfp-hide" id="popup-login">
      <div class="login">
        <div class="login__item">
          <div class="login__title h3">Sign up on Fleet</div>
