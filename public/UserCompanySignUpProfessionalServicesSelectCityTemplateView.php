<html class="js" lang="en"><head>
 ...
 <link rel="shortcut icon" type="image/x-icon" href="<?php echo $path;?>html/usercontent/images/favicon.ico">
    ...
    <link rel="stylesheet" href="https://dstricts.com/html/registerguest/css/styles.css">
 <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.mintemplate3.css">
    <!-- favicons
    ================================================== -->
...
<body id="top" class="theme-static ss-loaded ss-show">
    ...
    <section id="intro" class="s-intro">
        ...
        <div class="s-intro__bg" style="background-image: url(<?php if($selectedMarketplaceDetail['background_image']!=null || $selectedMarketplaceDetail['background_image']!=''){   echo str_replace(" ","%20", $selectedMarketplaceDetail['background_image']); }  else echo 'https://dstricts.com/html/usercontent/images/bg/staticbg.jpg'; ?>);"></div>
  ...
  <!-- s-intro__header -->
        ...
        <div class="row s-intro__content">
            <div class="column">
               ...
               <h1 class="text-huge-title" style="max-width:600px;">
                
               <?php echo $selectedMarketplaceDetail['heading_info']; ?><br>
...
<input type="hidden" id="todo_id" name="todo_id" value="T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09" />
                     <div class="panel panel_stays panel_width" style="  margin:-40px 0px 0; padding: 20px;">
...
<input class="location__input js-location-input changedText" type="text" name="city" id="city" autocomplete="off" placeholder="Location" style="border:none; color:white;">
<div class="location__description changedText location__description_top" style="bottom:0px; left: 0px; ">Where are you from?</div>
...
<div class="s-intro__notify">
 	  <a href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/howItWorks/<?php echo $data['domain_id']; ?>">   <button type="button" class="btn--stroke btn--small" fdprocessedid="0adb7c" style="padding:0px 20px; 0px;">
              How it works
            </button></a>
			
			 
			
			 <a href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/brokers/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09">   <button type="button" class="btn--stroke btn--small" fdprocessedid="0adb7c" style="padding:0px 20px; 0px;">
              For brokers</button></a>
			  
			  			 <a href="https://www.safeqloud.com/user/index.php/LoginAccount/emailLogin">   <button type="button" class="btn--stroke btn--small" fdprocessedid="0adb7c" style="padding:0px 20px; 0px;">
             Sign in</button></a>
        </div>
    ...
    <!-- details
    ================================================== -->
    <section id="details" class="s-details" style="bottom: -918px; --overlay-opacity:1;">

        <div class="row">
            <div class="column">

                <h1 class="text-huge-title text-center">
                    Hi, We Are Register Guest.
                </h1>
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-about" class="tab-content__item" role="tabpanel" aria-hidden="false" aria-labelledby="tab-link-0" data-tab-active="">
                        ...
                        <div class="row">
                            <div class="column">
                                <p class="lead">
                                Register Guest is a proptech company founded in 2016 with the ambition to lead the development towards smarter and more sustainable&nbsp;holiday&nbsp;homes.
                                </p>

                                <p>
                                Our app and digital platform simplify life by meeting people's needs and putting sustainability in focus. Digitizing properties and the rental of the properties creates added value and benefit for&nbsp;home&nbsp;owners.
                                </p>
                    ...
                    <div id="tab-services" class="tab-content__item" role="tabpanel" aria-hidden="true" aria-labelledby="tab-link-1">
                        ...
                        <div class="row">
                            <div class="column">
							 <p class="lead">
                               RegisterGuest takes care of your legal obligations surrounding guest registration and record keeping. RegisterGuest securely stores all your guests’ data and makes it readily available in the case of an inspection or&nbsp;an&nbsp;emergency.
                                </p>
                                <p>
                                This platform is especially useful for renters of multiple properties because maintaining all this information can become complicated, and RegisterGuest has the capability to display guest information based on which property&nbsp;they&nbsp;rented.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title">Guest Report</h4>
                                    <p>
                                  RegisterGuest takes care of your legal obligations surrounding guest registration within 24 hours&nbsp;to&nbsp;the&nbsp;police
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title">Guest Book</h4>
                                    <p>
                                   RegisterGuest securely stores all your guests’ data and makes it readily available in the case of an inspection or&nbsp;an&nbsp;emergency.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title">Rental license</h4>
                                    <p>
                                    With RegisterGuest you can easily apply for rental license from your smartphone and await&nbsp;your&nbsp;license.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="column">
                                ...
                                <div class="row">
                                    <div class="column lg-6 tab-12">
                                        ...
                                        <p>
                                        Urbanization de la Pau 3, <br>
                                        Ctra. de Villamartín, <br>
										3C, 03189 La Zenia, <br>
                                       Alicante,&nbsp;Spain
                                        </p>
                                ...
                                <p class="tab-content__item-bottom">
                                    <a href="mailto:#0" class="contact-email">hello@registerguest.online</a>
                                    <span class="contact-number"> 
                                        <a href="tel:46-76207-2192">+46 76 207&nbsp;21&nbsp;92</a> 
                                        <span>/</span>
                                        <a href="tel:46-76207-2192">+46 76 207&nbsp;21&nbsp;92</a>
                                    </span>
                                </p>
                ...
                <footer>
                    <div class="ss-copyright">
                        <span>© Copyright Register Guest 2021</span> 
                        <span>Design by <a href="http://www.registerguest.online/">RegisterGuest</a></span>
                    </div>
                </footer>
