 	...
 	function changeClass(link)
		...
		function submitform()
		{
			...
			else if($("#objectType").val()==0)
			{
				...
				$("#errorMsg1").html('Please select the service your company provide');
				return false;
			}
...
<div class="upload__head">
                  <h2 class="upload__title h2 changedText">Register your company</h2>
                </div>
					   ...
					   <div class="checkout__row margin-bottom32">
                        <div class="field">
						   ...
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">PERSONAL EMAIL - (NOT WORK EMAIL)</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="email" id="email" placeholder="e. g. xyz@gmail.com" value="<?php echo $emailRequestReceivedInfo['email']; ?>" style=" color:grey;"  >
                            </div>
                          </div>
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
								 <?php  foreach($countryOptions as $category => $value) 
															...
															<option value="<?php echo $value['id']; ?>"  class="lgtgrey2_bg changedText"><?php echo $value['country_name']; ?></option>
														<?php 	}	?>
								  </select>
                            </div>
                          </div>
						  ...
						  <div class="upload__col upload__col_w70">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" id="pnumber" placeholder="e. g. 7222233554" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						  </div>
