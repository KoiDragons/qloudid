						...
						<div class="dflex xs-fxwrap_w alit_c">
							...
							<div class="wi_50 xs-wi_100 flex_1 order_2 xs-order_1 xs-tall tall  brdrad5 talc padl50 xs-padl0">
								...
								<img src="<?php echo $imgs; ?>" class="maxwi_100 hei_auto brd brdrad5" height="125" width="125" >
									...
									<h3 class="fsz25 xs-fsz20 padb10 padt10 xs-padt0 brdb_new tall  lgn_hight_30 xs-talc"><?php echo $requestDetail['first_name']." ".$requestDetail['last_name']; ?> vill meddela dig om att du står som hennes närmaste anhörig att bli meddelad vid olycka eller fara. Verification code :- <?php echo $requestKeenDetail['unique_code']; ?></h3>
