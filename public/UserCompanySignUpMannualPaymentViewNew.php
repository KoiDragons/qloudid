...
<a href="../../bookingInvoicePayment/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $bookingServiceInvoiceDetail; ?>" class="header__item  " style="margin-left:10px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important; ">
...
<form class="checkout__item js-tabs-item" action="../../updatePaymentDetail/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
