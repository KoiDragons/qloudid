...
class ForgotPswdModel extends AppModel
{
    function checkmail() {
    ...
    function sendForgotPswdEmail($data)
    {
        
        $to      = $data['email'];
        $subject = "Qloud ID - Rest your password.";
        $url='https://www.qloudid.com/user/index.php/RecoverPassword/resetPassword/' . $data['email'] . '/' . $data['rand_hash'];
                                                         ...
                                                         <tr>
                                                            <td align="left" style="padding-top:25px;padding-bottom:0px;padding-left:40px;padding-right:40px;background-color:#ffffff;width:100%;text-align:center">
                                                               <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                                  <tbody>
                                                                     <tr>
                                                                        <td align="left" style="font-size:18px;line-height:22px;font-weight:bold; text-align:center; padding-bottom:15px;"><span><a href="https://www.qloudid.com/user/index.php/RecoverPassword/resetPassword/' . $data['email'] . '/' . $data['rand_hash'] . '" style="border-radius:3px;color:#ff2828;text-decoration:none;background-color:#ff2828;border-top:14px solid #ff2828;border-bottom:14px solid #ff2828;border-left:14px solid #ff2828;border-right:14px solid #ff2828;display:inline-block;border-radius:3px;color:#ffffff; padding-left:25px; padding-right:25px; font-weight:normal;" target="_blank" data-saferedirecturl="https://www.qloudid.com/user/index.php/RecoverPassword/resetPassword/' . $data['email'] . '/' . $data['rand_hash'] . '">Click here</a></span></td>
                                                                     </tr>
