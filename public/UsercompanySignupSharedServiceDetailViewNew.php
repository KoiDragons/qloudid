...
<div class="header__center center  xs-padrl25">

<a class="header__logo xs-fsz20 changedText" href="../../../../../../../../../bookableServiceList/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>" style="
...
</div><a class="button button-small header__button   xxs-mart10 changedText hidden-xxs   " href="#" style="margin-left:35px; min-width:112px; background:transparent; color:#777E90; font-size: 16px;">Menu</a>
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><?php echo $selectedServiceInfo['dish_name']; ?></h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">By <?php echo $selectedServiceInfo['company_name']; ?>
</h2>
...
<div class="receipt__actual">$<?php echo $selectedServiceInfo['dish_price']; ?></div>
<div class="receipt__note changedText">/person</div>
</div>
...
<div class="price__description price__description_flex" style="
    background: #131922;
">
<div class="price__item">
<div class="price__icon">
<svg class="icon icon-calendar">
<use xlink:href="#icon-calendar" style="fill:grey;"></use>
</svg>
</div>
<div class="price__box">
<div class="price__category changedText" style="color:grey;">Duration</div>
<div class="price__subtitle changedText" style="
    color: white;
"><?php if($selectedServiceInfo['time_required']==1) echo '15 mins';  else  if($selectedServiceInfo['time_required']==2) echo '30 mins';  else  if($selectedServiceInfo['time_required']==3) echo '45 mins';  else  if($selectedServiceInfo['time_required']==4) echo '60 mins';?> </div>
</div>
</div>
<div class="price__item">
<div class="price__icon">
<svg class="icon icon-user">
<use xlink:href="#icon-user" style="fill:grey;"></use>
</svg>
</div>
<div class="price__box">
<div class="price__category changedText" style="color:grey;">Guest</div>
<div class="price__subtitle changedText" style="
    color: white;
">1 guest</div>
</div>
...
<form class="cart" action="../../../../../../../../../getPublicEmployeeCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" method="post" id="save_indexing" name="save_indexing" enctype='multipart/form-data'>
			<input type="hidden" id="shared_type" name="shared_type" value="<?php echo $selectedServiceInfo['one_shared']; ?>" />
			<input type="hidden" id="shared_type_private" name="shared_type_private" value="1" />
			<input type="hidden" id="dish_detail" name="dish_detail" value="<?php echo $selectedServiceInfo['dish_detail']; ?>" />
			<input type="hidden" id="dish_name" name="dish_name" value="<?php echo $selectedServiceInfo['dish_name']; ?>" />
			<input type="hidden" id="dish_image" name="dish_image" value="<?php echo $selectedServiceInfo['dish_image']; ?>" />
			<input type="hidden" id="price" name="price" value="<?php echo $selectedServiceInfo['open_price_per_person']; ?>" />
			<input type="hidden" id="private_price" name="private_price" value="<?php echo $selectedServiceInfo['private_price']; ?>" />
			<input type="hidden" id="event_date" name="event_date" value="0" />
			<input type="hidden" id="event_time" name="event_time" value="0" />
<div class="receipt__stage" style=" margin-top: 36px;
   "><?php if($selectedServiceInfo['one_shared_type']==3) echo 'Public/Private event'; else echo 'Public event'; ?></div>
<script>
function decrementGPS(id)
{
if($('#extra_inclusions').val()==0)
{
	return false;
}	
else
{
	var tFee=parseInt($('#total_fee').val())-id;
	$('#total_fee').val(tFee);
...
<div class="receipt__setting" style="display: <?php if($selectedServiceInfo['one_shared_type']==3) echo 'flex'; else echo 'None'; ?>">
<div class="receipt__wrap">
<div class="receipt__subtitle changedText">Booking type</div>
<div class="receipt__content changedText">Select preferred booking type</div>
</div>
...
<div class="field">
                              ...
                              <div class="field__wrap">
                                <select class="select" style="display: block;" onchange="updateShared(this.value);">
	  ...
	  function submitForm()
		{
		 ...
		 var privateAction='../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09';
		 var puplicAction='../../../../../../../../../getPublicEmployeeCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09';
		function updateShared(id)
		{
			if(id=='Public')
			{
			$('#shared_type_private').val(1);
			$('.brk-quantity').attr('style','display:block');
			$('#quantity').val(1); 

			$('.priceo').html('$'+$('#price').val());
			$('.priceto').html('$'+$('#price').val());	
			var priceVal=$('#price').val();
			$('#total_fee').val(priceVal);
			$('#save_indexing').attr('action',puplicAction); 
			}
			else
			{
			 
			$('#shared_type_private').val(2);
			$('.brk-quantity').attr('style','display:none');
			$('#quantity').val(1);
			$('.priceo').html('$'+$('#private_price').val());
			$('.priceto').html('$'+$('#private_price').val());	
			var priceVal=$('#private_price').val();
			$('#total_fee').val(priceVal);
			$('#save_indexing').attr('action',privateAction);
			}
		}
		function updatePrice(id)
		{
			priceVal=parseInt($('#total_fee').val())*id;
			$('.priceto').html('$'+priceVal);
			//$('#total_fee').val(priceVal);			
		}
	  </script>
<div class="receipt__setting" style="display: flex;">
<div class="receipt__wrap">
<div class="receipt__subtitle changedText">Total person</div>
<div class="receipt__content changedText">Who will join the event</div>
</div>

 <div class="field">
                              
                              <div class="field__wrap">
                                <select class="select" style="display: none;" id="quantity" name="quantity" onchange="updatePrice(this.value);">
								<?php for($i=1; $i<=$selectedServiceInfo['open_total_person']; $i++) { ?>
...
<div class="receipt__stage changedText">Price details</div>
<div class="receipt__table">
<div class="receipt__line">
<div class="receipt__cell changedText">Price</div>
<div class="receipt__cell priceo">$<?php echo $selectedServiceInfo['dish_price']; ?></div>
</div>
 
 
<div class="receipt__line">
<div class="receipt__cell changedText">Service fee</div>
<div class="receipt__cell">$0</div>
</div>
<div class="receipt__line">
<div class="receipt__cell changedText">Total</div>
<div class="receipt__cell priceto">$<?php echo $selectedServiceInfo['dish_price']; ?></div>
</div>
</div>

<input type="hidden" name="total_fee" id="total_fee" value="<?php echo $selectedServiceInfo['dish_price']; ?>">
<div class="receipt__foot">
 <a class="button receipt__button changedText" href="javascript:void(0);" onclick="submitForm();" style="background:#F67F00; color:black"><span>Book service</span>
...
</svg><span class="changedText">Free cancellation until 3:00 PM on May 15, 2021</span>
</div>
</div>
</div>
</div>
...
<!-- scripts-->
<script src="https://dstricts.com/html/fleet/js/lib/jquery.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/slick.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/jquery.nice-select.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/share-buttons.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/jquery.fancybox.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/jquery.rateyo.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/nouislider.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/wNumb.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/jquery.magnific-popup.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/moment.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/jquery.daterangepicker.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/lib/simpleParallax.min.js"></script>
<script src="https://dstricts.com/html/fleet/js/demo.js"></script>
<script src="https://dstricts.com/html/fleet/js/app.js"></script>
<!-- svg sprite-->
