	...
	<meta charset="utf-8">
		...
		<script>
			...
			function checkOtp()
			{
				...
				$.ajax({
					type:"POST",
					url:"../../verifyPhoneOtp/<?php echo $data['id']; ?>/<?php echo $data['domain_id']; ?>",
					data:send_data,
					dataType:"text",
...
<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart20 xs-pad0 xs-mart0">
					...
					<h1 class="padl0 padb5 talc fsz50 xs-fsz25 black_txt hidden-xs"><span >Verify phone</span></h1>
					 
						<p class="mart20 lgtgrey2_bg padt10 talc fsz18 xs-padb10 padb20 wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xxxs-marb35 dark_grey_txt">Signera med lösenordet du har fått per phone.</p>
					</div>
 
			 
		
		<form method="POST" action="../../verifyPhoneDetails/<?php echo $data['id']; ?>/<?php echo $data['domain_id']; ?>" id="save_indexing_otp" name="save_indexing_otp" accept-charset="ISO-8859-1">
