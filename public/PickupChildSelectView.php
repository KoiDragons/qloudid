...
var dict = {
			...
			function sendInformation()
			{
				...
				if($("#selected_child").val() == "")
				{
					...
					$("#error_msg_form").html('There is no child present you can pick up.');
					return false;
				}
	...
	<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Select and check out the child that you are going to pick up from daycare.</a></div>
							...
							<div class="container   fsz14 dark_grey_txt">
								...
								<div class="tab-content padt5 xs-padt5 active" id="tab_total1" style="display:block;">
									...
									<div class="tab_container mart20 padt10">
									 <?php 
									...
									<form action="../sendPickupInfo/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing">
