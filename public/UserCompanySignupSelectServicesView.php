...
<a class="header__logo xs-fsz20 " href="../brokers/<?php echo $data['domain_id']; ?>" style="
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
	...
	<div class="header__item header__item_dropdown js-header-item hidden-xs <?php if($data['domain_id']=='MGtXNzBKdUdWTU82VW5YUHg4RnQ4UT09') echo 'hidden'; ?>">
...
<h2 class="browse__title h2 changedText xxs-fsz35 tall   fsz80 lgn_hight_90 xxs-lgn_hight_50 xs-tall" >UNLOCK YOUR AGENCY'S POTENTIAL
</h2>
               ...
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg  " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle   txt_f67f00   ">Free</div>
												...
												<?php }   else if($data['subscription_selected']==2) { ?>
				<a class="categories__item  black_bg  " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_f67f00   ">Introduction</div>
                                      </a>
									  
												<?php }  else if($data['subscription_selected']==3) { ?>
				<a class="categories__item  black_bg  " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_f67f00   ">Premium</div>
                                      </a>
              ...
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old">$499</div>
                    <div class="receipt__actual changedText"><?php if($data['subscription_selected']==1) { echo 'Free'; } else if($data['subscription_selected']==2) { echo $selectedMarketplaceDetail['gold_account_subscription_fee'].' euro'; } else if($data['subscription_selected']==3) { echo $selectedMarketplaceDetail['premium_account_subscription_fee'].' euro'; } ?></div>
              ...
              <div class="receipt__description  " >
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText"><?php if($data['subscription_selected']==1) { echo 'Free'; } else if($data['subscription_selected']==2) { echo 'Introduction'; } else if($data['subscription_selected']==3) { echo 'Premium'; } ?></div>
