...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.minPannel294.css">
...
<body class="dark" style="background-color:#<?php echo $selectedMarketplaceDetail['bg_color_info']; ?>">
<script>
	function submitForm()
	{
		 if($('#city').val()=='')
...
<a class="header__logo xs-fsz20 " href="http://gettxp.com/public/index.php/Unaoficina" style="
...
<div class="header__menu"><a class="header__link " href="AboutUs" style="box-shadow:none;">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg><span class='changedText'>About us</span></a>
<a class="header__link   active" href="ForDevelopers" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg><span class='changedText'>Services</span></a>
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="http://gettxp.com/public/index.php/AboutUs" class="header__item " s=""><div class="header__item_language js-header-item" style="border-left: 0px solid !important; margin-left:0px;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">About us</button>

</div></a>
 <a href="http://gettxp.com/public/index.php/ForDevelopers" class="header__item active" style="box-shadow:none; margin-left:20px;"><div class="header__item_language js-header-item active" style="border-left: 0px solid !important; margin-left:0px;" >
<button class="header__head js-header-head fsz16 hidden-xs changedText">Services</button>

</div></a>
 
<a href="#" class="header__item hidden" style="margin-left:0px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;  margin-left:20px;" >
<button class="header__head js-header-head fsz16 hidden-xs changedText">Career</button>
 ...
 <div class="hidden-xs">
		  <div class="header__item header__item_user js-header-item" style="display:block;">
            <button class="header__head js-header-head" fdprocessedid="0sxouf" style="margin-right:0px;"><a class="header__login " href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/LoginAccount/emailLogin" data-effect="mfp-zoom-in" style="display:block; background:#f67f00; margin-left:0px;">
            <svg class="icon icon-user padtb5" style="width:35px; height:35px;">
...
<a class="header__login js-popup-open" href="#popup-login" data-effect="mfp-zoom-in" style="display:none; background:#f67f00;">
 ...
 <!-- outer content-->
	 <form action="../addApartmentRequest/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">
<input type="hidden" id="whom_id" name="whom_id" value="T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09" />
<input type="hidden" id="todo_id" name="todo_id" value="T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09" />
...
<div class="main__center center">
			...
			<?php if($selectedMarketplaceDetail['background_image']!=null || $selectedMarketplaceDetail['background_image']!=''){ ?>
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo $selectedMarketplaceDetail['background_image']; ?>"><img src="<?php echo $selectedMarketplaceDetail['background_image']; ?>" alt="Main" class="imageBorder5">
              </picture>
			<?php } ?>
              <div class="main__wrap">
                <h1 class="main__title hero changedText" style="color:black; max-width:480px;">Find, Markup & Earn</h1>
                <div class="main__info info changedText" style="color:black; font-size:25px; max-width:480px;">Find rental properties, set your price, and earn from each transaction</div> 
              </div>
            </div>
            <div class="panel panel_stays">
              <div class="panel__background"></div>
			  <div class="panel__nav"><a class="panel__link active" href="#">Apartments</a><a class="panel__link" href="#">Villas</a></div>
		...
		<div class="panel__body">
                <div class="panel__row">
                    ...
                    <div class="location__head js-location-head">
                      <div class="location__icon">
                        <svg class="icon icon-location">
                          <use xlink:href="#icon-location" style="fill:#f67f00;"></use>
                        </svg>
                      </div>
                      <input class="location__input js-location-input" type="text" name="location" autocomplete="off" placeholder="Location" fdprocessedid="7fjui">
                      ...
                      <button class="location__clear js-location-clear">
                        <svg class="icon icon-close-circle">
                          <use xlink:href="#icon-close-circle" style="fill:#f67f00;"></use>
                        </svg>
                      </button>
                    </div>
                    <div class="location__body js-location-body">
                      <div class="location__list">
					  <a class="location__item js-location-item" href="#">Uklana Mandi</a><?php $i=1; 
                  ...
                  <div class="datepicker js-date-range" data-format="MMM DD, YYYY" data-container=".datepicker">
                    <div class="datepicker__list">
                      <div class="datepicker__item">
                        <input class="datepicker__input js-date-from" type="text" id="check_in" name="check_in" placeholder="Check in" readonly="readonly" fdprocessedid="3bvcpe">
                        <div class="datepicker__icon">
                          <svg class="icon icon-calendar">
                            <use xlink:href="#icon-calendar" style="fill:#f67f00;"></use>
                          </svg>
                        </div>
                        <div class="datepicker__description">Add date</div>
                      </div>
                      <div class="datepicker__item">
                        <input class="datepicker__input js-date-to" type="text" id="check_out" name="check_out" placeholder="Check out" readonly="readonly" fdprocessedid="x2hrjl">
                        <div class="datepicker__icon">
                          <svg class="icon icon-calendar">
                            <use xlink:href="#icon-calendar" style="fill:#f67f00;"></use>
                          </svg>
                  ...
                  <div class="date-picker-wrapper no-shortcuts  no-topbar no-gap two-months" unselectable="on" style="display: none; top: 100px; left: 0px; user-select: none;"><div class="month-wrapper" style="width: 35px;">   <table class="month1" cellspacing="0" border="0" cellpadding="0">       <thead>           <tr class="caption">               <th>                   <span class="prev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M14.207 7.793a1 1 0 0 1 0 1.414L11.414 12l2.793 2.793a1 1 0 0 1-1.414 1.414l-3.5-3.5a1 1 0 0 1 0-1.414l3.5-3.5a1 1 0 0 1 1.414 0z" fill="#777e91"></path></svg>                   </span>               </th>               <th colspan="5" class="month-name"><div class="month-element">june</div> <div class="month-element">2024</div></th>               <th>               </th>           </tr>           <tr class="week-name"><th>su</th><th>mo</th><th>tu</th><th>we</th><th>th</th><th>fr</th><th>sa</th>       </tr></thead>       <tbody><tr><td><div time="1716693787378" data-tooltip="" class="day lastMonth  valid ">26</div></td><td><div time="1716780187378" data-tooltip="" class="day lastMonth  valid ">27</div></td><td><div time="1716866587378" data-tooltip="" class="day lastMonth  valid ">28</div></td><td><div time="1716952987378" data-tooltip="" class="day lastMonth  valid ">29</div></td><td><div time="1717039387378" data-tooltip="" class="day lastMonth  valid ">30</div></td><td><div time="1717125787378" data-tooltip="" class="day lastMonth  valid ">31</div></td><td><div time="1717212187378" data-tooltip="" class="day toMonth  valid ">1</div></td></tr><tr><td><div time="1717298587378" data-tooltip="" class="day toMonth  valid ">2</div></td><td><div time="1717384987378" data-tooltip="" class="day toMonth  valid ">3</div></td><td><div time="1717471387378" data-tooltip="" class="day toMonth  valid ">4</div></td><td><div time="1717557787378" data-tooltip="" class="day toMonth  valid ">5</div></td><td><div time="1717644187378" data-tooltip="" class="day toMonth  valid ">6</div></td><td><div time="1717730587378" data-tooltip="" class="day toMonth  valid ">7</div></td><td><div time="1717816987378" data-tooltip="" class="day toMonth  valid ">8</div></td></tr><tr><td><div time="1717903387378" data-tooltip="" class="day toMonth  valid ">9</div></td><td><div time="1717989787378" data-tooltip="" class="day toMonth  valid ">10</div></td><td><div time="1718076187378" data-tooltip="" class="day toMonth  valid ">11</div></td><td><div time="1718162587378" data-tooltip="" class="day toMonth  valid ">12</div></td><td><div time="1718248987378" data-tooltip="" class="day toMonth  valid ">13</div></td><td><div time="1718335387378" data-tooltip="" class="day toMonth  valid ">14</div></td><td><div time="1718421787378" data-tooltip="" class="day toMonth  valid ">15</div></td></tr><tr><td><div time="1718508187378" data-tooltip="" class="day toMonth  valid ">16</div></td><td><div time="1718594587378" data-tooltip="" class="day toMonth  valid ">17</div></td><td><div time="1718680987378" data-tooltip="" class="day toMonth  valid ">18</div></td><td><div time="1718767387378" data-tooltip="" class="day toMonth  valid ">19</div></td><td><div time="1718853787378" data-tooltip="" class="day toMonth  valid ">20</div></td><td><div time="1718940187378" data-tooltip="" class="day toMonth  valid ">21</div></td><td><div time="1719026587378" data-tooltip="" class="day toMonth  valid ">22</div></td></tr><tr><td><div time="1719112987378" data-tooltip="" class="day toMonth  valid ">23</div></td><td><div time="1719199387378" data-tooltip="" class="day toMonth  valid real-today">24</div></td><td><div time="1719285787378" data-tooltip="" class="day toMonth  valid ">25</div></td><td><div time="1719372187378" data-tooltip="" class="day toMonth  valid ">26</div></td><td><div time="1719458587378" data-tooltip="" class="day toMonth  valid ">27</div></td><td><div time="1719544987378" data-tooltip="" class="day toMonth  valid ">28</div></td><td><div time="1719631387378" data-tooltip="" class="day toMonth  valid ">29</div></td></tr><tr><td><div time="1719717787378" data-tooltip="" class="day toMonth  valid ">30</div></td><td><div time="1719804187378" data-tooltip="" class="day nextMonth  valid ">1</div></td><td><div time="1719890587378" data-tooltip="" class="day nextMonth  valid ">2</div></td><td><div time="1719976987378" data-tooltip="" class="day nextMonth  valid ">3</div></td><td><div time="1720063387378" data-tooltip="" class="day nextMonth  valid ">4</div></td><td><div time="1720149787378" data-tooltip="" class="day nextMonth  valid ">5</div></td><td><div time="1720236187378" data-tooltip="" class="day nextMonth  valid ">6</div></td></tr></tbody>   </table><div class="gap" style="visibility: hidden; height: 10px;"><div class="gap-top-mask"></div><div class="gap-bottom-mask"></div><div class="gap-lines"><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div></div></div><table class="month2" cellspacing="0" border="0" cellpadding="0">   <thead>   <tr class="caption">       <th>       </th>       <th colspan="5" class="month-name"><div class="month-element">july</div> <div class="month-element">2024</div></th>       <th>           <span class="next"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.793 7.793a1 1 0 0 0 0 1.414L12.586 12l-2.793 2.793a1 1 0 0 0 1.414 1.414l3.5-3.5a1 1 0 0 0 0-1.414l-3.5-3.5a1 1 0 0 0-1.414 0z" fill="#777e91"></path></svg></span>       </th>   </tr>   <tr class="week-name"><th>su</th><th>mo</th><th>tu</th><th>we</th><th>th</th><th>fr</th><th>sa</th>   </tr></thead>   <tbody><tr><td><div time="1719717787378" data-tooltip="" class="day lastMonth  valid ">30</div></td><td><div time="1719804187378" data-tooltip="" class="day toMonth  valid ">1</div></td><td><div time="1719890587378" data-tooltip="" class="day toMonth  valid ">2</div></td><td><div time="1719976987378" data-tooltip="" class="day toMonth  valid ">3</div></td><td><div time="1720063387378" data-tooltip="" class="day toMonth  valid ">4</div></td><td><div time="1720149787378" data-tooltip="" class="day toMonth  valid ">5</div></td><td><div time="1720236187378" data-tooltip="" class="day toMonth  valid ">6</div></td></tr><tr><td><div time="1720322587378" data-tooltip="" class="day toMonth  valid ">7</div></td><td><div time="1720408987378" data-tooltip="" class="day toMonth  valid ">8</div></td><td><div time="1720495387378" data-tooltip="" class="day toMonth  valid ">9</div></td><td><div time="1720581787378" data-tooltip="" class="day toMonth  valid ">10</div></td><td><div time="1720668187378" data-tooltip="" class="day toMonth  valid ">11</div></td><td><div time="1720754587378" data-tooltip="" class="day toMonth  valid ">12</div></td><td><div time="1720840987378" data-tooltip="" class="day toMonth  valid ">13</div></td></tr><tr><td><div time="1720927387378" data-tooltip="" class="day toMonth  valid ">14</div></td><td><div time="1721013787378" data-tooltip="" class="day toMonth  valid ">15</div></td><td><div time="1721100187378" data-tooltip="" class="day toMonth  valid ">16</div></td><td><div time="1721186587378" data-tooltip="" class="day toMonth  valid ">17</div></td><td><div time="1721272987378" data-tooltip="" class="day toMonth  valid ">18</div></td><td><div time="1721359387378" data-tooltip="" class="day toMonth  valid ">19</div></td><td><div time="1721445787378" data-tooltip="" class="day toMonth  valid ">20</div></td></tr><tr><td><div time="1721532187378" data-tooltip="" class="day toMonth  valid ">21</div></td><td><div time="1721618587378" data-tooltip="" class="day toMonth  valid ">22</div></td><td><div time="1721704987378" data-tooltip="" class="day toMonth  valid ">23</div></td><td><div time="1721791387378" data-tooltip="" class="day toMonth  valid ">24</div></td><td><div time="1721877787378" data-tooltip="" class="day toMonth  valid ">25</div></td><td><div time="1721964187378" data-tooltip="" class="day toMonth  valid ">26</div></td><td><div time="1722050587378" data-tooltip="" class="day toMonth  valid ">27</div></td></tr><tr><td><div time="1722136987378" data-tooltip="" class="day toMonth  valid ">28</div></td><td><div time="1722223387378" data-tooltip="" class="day toMonth  valid ">29</div></td><td><div time="1722309787378" data-tooltip="" class="day toMonth  valid ">30</div></td><td><div time="1722396187378" data-tooltip="" class="day toMonth  valid ">31</div></td><td><div time="1722482587378" data-tooltip="" class="day nextMonth  valid ">1</div></td><td><div time="1722568987378" data-tooltip="" class="day nextMonth  valid ">2</div></td><td><div time="1722655387378" data-tooltip="" class="day nextMonth  valid ">3</div></td></tr></tbody></table><div class="dp-clearfix"></div><div class="time"><div class="time1"></div><div class="time2"></div></div><div class="dp-clearfix"></div></div><div class="footer"></div><div class="date-range-length-tip"></div></div></div>
                  <div class="travelers js-travelers">
                    <div class="travelers__head js-travelers-head">
                      <div class="travelers__icon">
                        <svg class="icon icon-user">
                          <use xlink:href="#icon-user" style="fill:#f67f00;"></use>
                        </svg>
                      </div>
                        ...
                        <div class="counter js-counter" data-min="0">
                          <button class="counter__button js-counter-button js-counter-minus disabled" type="button">
                            <svg class="icon icon-minus-circle">
                              <use xlink:href="#icon-minus-circle" style="fill:#f67f00;"></use>
                            </svg>
                          </button>
                          ...
                          <button class="counter__button js-counter-button js-counter-plus" type="button">
                            <svg class="icon icon-plus-circle">
                              <use xlink:href="#icon-plus-circle" style="fill:#f67f00;"></use>
                            </svg>
                          </button>
                          <input class="js-counter-input js-counter-result js-counter-adults" id="guest_adult" name="guest_adult" type="hidden" value="0">
                        </div>
                      </div>
                      <div class="travelers__item">
                        <div class="travelers__details">
                        ...
                        <div class="counter js-counter" data-min="0">
                          ...
                          <input class="js-counter-input js-counter-result js-counter-children" id="guest_child" name="guest_child" type="hidden" value="0">
                        </div>
                      </div>
                      <div class="travelers__item">
                        <div class="travelers__details">
                        ...
                        <div class="counter js-counter" data-min="0">
                          ...
                          <input class="js-counter-input js-counter-result js-counter-babies" id="guest_infant" name="guest_infant" type="hidden" value="0">
                        </div>
                      </div>
                    </div>
                  </div>
				 <a class="panel__search" href="javascript:void(0)" onclick="submitForm();" style="background-color:#f67f00;">
	...
	<div class="travel__center center   padb136 xs-padrl25" style=" max-width: 1132px;    padding-right: 0px;    padding-left: 0px;">
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Brokers BNB Platform Workflow for Seamless Broker-to-Broker Interaction</div>
...
<div class="section destinations xs-padrl25" style="margin-bottom:80px;">
          <div class="destinations__center center"  style="border-bottom:2px solid #ffffff; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
<div class="travel__center center   padb136 xs-padrl25" style=" max-width: 1132px;    padding-right: 0px;    padding-left: 0px;">
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Brokers conduct property searches based on client requirements.</div>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="section destinations xs-padrl25" style="margin-bottom:80px;">
          <div class="destinations__center center"  style="border-bottom:2px solid #23262F; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
 <div class="travel__center center   padb136  xs-padrl25 mart80 xs-mart25i" style="   max-width: 1132px;    padding-right: 0px; padding-left: 0px;">
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Identify and select suitable properties from available listings.
</div>
            </div>
         </div>
      </div>
  ...
  <div class="travel__center center   padb136  xs-padrl25 mart80 xs-mart25i" style="    max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Set pricing that includes any applicable commissions or markups.</div>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Generate and send detailed proposals to clients, including the final pricing tailored to their needs and preferences.</div>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Both brokers receive their respective payments promptly through the platform upon acceptance.</div>
            </div>
         </div>
      </div>
   </div>
 ...
 <div class="  flights xs-padrl25">
          <div class="flights__center    center xs-padrl0" style=" ">
		  
          
            <div class="checkout__inner js-tabs" style="padding-right:0px;/* padding-left: 200px; */">
...
<div class="brands__list" style="display:flex;">
				<div class="brands__item wi_70" style="width:70%; flex: 0 0 70%;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px; font-weight:bold;">Features</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;  padding:0px 10px;  font-weight:bold;">Developer Hub</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;  font-weight:bold;">Traditional Methods</div></a></div>
		<div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Comprehensive project database

</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
                  </svg></div></a></div>
				  
				  
				  <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Instant notifications
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Online booking and sales platform

</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
                  </svg></div></a></div>
				  
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Targeted advertising and reduced marketing costs
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
				    ...
				    <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Sales tools and downloadable client materials
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Commission transparency and showroom bookings
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">WhatsApp community
  ...
  <div class="section destinations xs-padrl25" style="margin-bottom:80px;">
		...
		<div class="section-mb80 checkout checkout_stays xs-padrl25">
<div class="checkout__center center xs-padrl0">

<div class="checkout__wrapper  xs-flexD">
<div class="checkout__inner js-tabs wi_50 xs-wi_100">
...
">Learn More</h2>
<div class="browse__info info changedText">Key Benefits of Brokers BNB for Brokers (up-window)</div>
</div>
...
<div class="checkout__inner js-tabs wi_60 xs-wi_100" style="padding-right:0px;">
 <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item"  >
                                      <div class="faq__head changedText">How can I list my properties on Brokers BNB?</div>
                                      <div class="faq__body" id='1'>
                                        <div class="faq__content changedText">You can easily list your properties by signing up on the platform, providing detailed information about your properties, and uploading high-quality images.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">What are the benefits of using Brokers BNB over traditional methods?</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Brokers BNB uniquely allows interaction between brokers for commission agreements and secure arrangements. Unlike traditional methods, clients see only the final price, ensuring transparency and simplicity.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">How do I interact with other brokers on the platform?</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">The platform facilitates seamless interaction between brokers, allowing you to collaborate on listings, share pricing strategies, and manage bookings efficiently.</div>
                                         
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">How does the payment system work?</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Brokers BNB ensures both brokers receive their respective payments promptly through a secure payment system once the booking is accepted.</div>
                                         
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Can I add my own pricing?</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Yes, brokers can add their own pricing to the listings, allowing flexibility and the opportunity to include commissions or markups.</div>
                                       
                                      </div>
                                    </div>
									
									<div class="faq__item">
                                      <div class="faq__head changedText">Is there a community for brokers?</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Yes, Brokers BNB provides a WhatsApp chat community for brokers to connect, share insights, and support each other.</div>
...
<footer class="footer" style="background: #131922;">
