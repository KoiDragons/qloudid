...
{		
		...
		else
		{
			...
			header('location:https://www.qloudid.com/user/index.php/LoginAccount/emailLogin'); die;
		}
		}
		...
		$data=array();
			...
			if($data['user_signup_type']==3)
			{
				if($isAlreadyUser==1)
				{
					...
					{
					header('location:https://www.qloudid.com/public/index.php/UserCompanySignUp/thanksUserCompanySignUp/'.$data['domain_id']); die;	
					}
					else
					{
						header('location:https://www.qloudid.com/user/index.php/LoginAccount/emailLogin'); die;
				...
				{
					header('location:https://www.qloudid.com/public/index.php/UserCompanySignUp/thanksUserSignUp/'.$data['domain_id']); die;
				}
			}
		...
		public static function addUserDetails($a=null)
		{
			...
			$data['user_id']=$result;
			$userSignupMarketplaces    = $model1->userSignupMarketplaces($data);
			header('location:https://www.qloudid.com/user/index.php/ShareMonitor/shareMonitorRequestList');
		}
