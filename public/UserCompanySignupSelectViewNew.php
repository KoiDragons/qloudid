...
<h2 class="browse__title h2 changedText" style="
    ...
    line-height: 90px;
">Sign up</h2>
<div class="browse__info info changedText">Create an accout flow is fast and easy</div>
</div>
 <form action="../signUpEmailInfo/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1" autocomplete="off">
			...
			<input type="hidden" name="user_signup_type" id="user_signup_type" value="">
			 
			</form>
			
			
			
			<form action="../brokers/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing1" id="save_indexing1" accept-charset="ISO-8859-1" autocomplete="off">
...
<div class="checkout__label changedText">Delivery address</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($value==1) echo 'User'; else if($value==3) echo 'User company'; else echo 'Partner company'; ?></div>
 
<div class="checkout__controls">
<?php if($value==2) { ?>
<button class="checkout__edit" onclick="submitPartner(<?php echo $value; ?>);" >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button>
<?php }else { ?>
<button class="checkout__edit"  onclick="submitForm(<?php echo $value; ?>);">
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button>
