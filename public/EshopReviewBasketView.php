				...
				<div class="wrap maxwi_100 padrl15 xxs-padrl30 md-padrl0 lg-padrl0">
					...
					<div class="tab-header martb10 padb10 xs-talc  brdb_94cffd darkbluebrdcolor nobrdt nobrdl nobrdr talc hidden-xs">
								...
								<div class="thr_clmn  wi_30  "  >
									...
									<div class="talc padtb20 ffamily_avenir  mart35"> <a href="https://www.qloudid.com/user/index.php/LoginAccount/loginPurchase/<?php echo $data['cid']; ?>"  ><input type="button" value="Pay with Qloud ID" class="forword minhei_55p bluergb_bg fsz18 padrl80"  ></a> </div> 
