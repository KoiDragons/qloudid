				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
								 ...
								 <div class=" xxs-tall talc   ffamily_avenir"> <a href="#" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText">Please add your details to create your account.</a></div>
									...
									<a href="https://www.safeqloud.com/user/index.php/LoginAccount/loginPurchaseVerify?response_type=code&client_id=YzhzVmorMTJWNVBsbHJIQkVYTTRva3JRbTdxcG9aQi9HejFaTGpLT3dvZz0=&state=xyz&purchase=1&total=0" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText" >Please click here to use Qloud ID app to complete the purchase.</a></div>
									<?php } ?>
