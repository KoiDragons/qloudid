...
<a class="header__logo xs-fsz20 " href="https://www.qloudid.com/public/index.php/UserCompanySignUp/selectProposalCity/<?php echo $data['domain_id']; ?>" style="
...
<h2 class="browse__title h2 changedText xs-fsz60 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" >Select Your City</h2>
<div class="browse__info info changedText">To ensure we match you with the most suitable agents in your area, please select the city where your property is located</div>
</div>
...
<?php 
foreach($vitechCityList as $category => $value) 
{
?> 
 <div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText hidden">Select city</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo  $value['city_name']; ?></div>
 
<div class="checkout__controls">
 
<a href="javascript:void(0);"><button class="checkout__edit"  onclick="submitForm('<?php echo  $value['city_name']; ?>');">
