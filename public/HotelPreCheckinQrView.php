					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						<div class="padb0 xxs-padb0 ">		
							<div class="padb0 talc fsz60 padt20"><i class="fas fa-first-aid red_ff2828_txt"></i></div>
									<h1 class="marb0  mart20 xxs-talc talc fsz25 xs-fsz20  padb0 black_txt trn ffamily_avenir"  >Pre-checkin</h1>
									</div>
									<div class="mart20 marb35 xxs-talc talc   xs-marb20 xs-mart0"> <a href="#" class="black_txt fsz18  xs-fsz16 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Scan QR code to complete pre-Checkin</a></div>
							...
							<div class="wi_400p maxwi_100   pos_rel zi5 marrla    padrl10  brdrad3 padb80">
						     ...
						     <div class="padt20 xxs-talc talc visible-xs  hidden" id="iOS">
								...
								<a href="QloudidUrl://ip/precheckin/<?php echo $data['id']; ?>"><button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80" >Pre checkin</button></a>
						...
						<div class="padtb0 brdrad3 ">
							...
							<div class="padb10  talc padt20">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=precheckin/<?php echo $data['id']; ?>" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
