...
<script>
 var emcode='<?php echo $codeInfo['email_otp']; ?>';
 var phcode='<?php echo $codeInfo['phone_otp']; ?>';
	    function submitform()
		{
...
<div class="outer" >
<!-- header-->
<header class="header js-header authorization xs-padt24 changedText" style="height:93px;  padding: 22px 0 22px !important;/* border-bottom: 1px solid #e6e8ec; */">
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Verify</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Verify your email and phone number to complete the payment
</h2>
...
<div class="checkout__category changedText">Add code received in email and phone number</div>
...
<form class="checkout__item js-tabs-item" action="../../../../../../verifyPaymentDetail/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>/<?php echo $data['invoice_id']; ?>/<?php echo $data['verification_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
<div class="checkout__fieldset">

<div class="field"  >
<div class="field__label changedText" style="color:#525252;">Email code</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="ecode" id="ecode"  style="background:#F4F5F6; height:60px; border:none; color:black;"  >
</div>
</div>
 
 
 <div class="field"  >
<div class="field__label changedText" style="color:#525252;">Phone code</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="pcode" id="pcode"  style="background:#F4F5F6; height:60px; border:none; color:black;"  >
</div>
</div>
