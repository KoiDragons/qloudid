...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Check-in</h2>
<div class="browse__info info changedText">Pre-checked guest will turn green can get checked-in succesfully.</div>
</div>
...
<div class="checkout__list padt20" style="">

<div class="checkout__section ">
<div class="checkout__box">
<div class="checkout__category changedText">Check-in</div>
...
<div class="checkout__section" style="margin-top:10px; padding-top:0px;">
<div class="checkout__box">
...
<div class="checkout__label changedText"><?php echo $value['name']; ?> </div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Has checked-in</div>
 
<div class="checkout__controls">
 
<a href="https://dstricts.com/public/index.php/BookingInformation/checkedInDetail/<?php echo $data['hotel_checkin_id']; ?>"><button class="checkout__edit"  >
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Adult <?php echo $i; ?>  </div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($value['checked_in']==0) echo 'Pre checked-in'; else echo 'Checked-in'; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Adult <?php echo ' '.$i; ?> - Invitation sent   </div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Adult <?php echo ' '.$i; ?> has not checked in yet</div>
 
<div class="checkout__controls">
 
<a href="#" onclick="checkinAdult(<?php echo $value['id']; ?>);"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<use xlink:href="#icon-edit"></use>
	...
	<?php } } $i++; } for($i=1;$i<=$updatePreCheckinStatus['guest_adult_left'];$i++) 
												{
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Invite adult</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">No adult has been invited yet</div>
 
<div class="checkout__controls">
 
<a class="button-stroke receipt__button" href="../../PrecheckinInformation/selectInvitationType/<?php echo $data['hotel_checkin_id']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Invite</span></span>
</a> 
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Checked-in</div>
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Pre checked-in</div>
...
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
					...
					<?php } $i++; } for($i=1;$i<=$updatePreCheckinStatus['guest_children_left'];$i++) 
												{
													 ?>	
<div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Invite Child</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">No child has been invited yet</div>
 
<div class="checkout__controls">
 
<a class="button-stroke receipt__button" href="../../PrecheckinInformation/dependentsList/<?php echo $data['hotel_checkin_id']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Invite</span></span>
</a> 
...
<form action="../checkinGuests/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
 ...
 <div class="checkout__box padt30">
 <a class="button checkout__button changedText" style="background: #3B71FE;" href="#" onclick="submitform();">Proceed to check-in</a>
