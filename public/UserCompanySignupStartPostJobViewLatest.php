...
"toolbar=0,menubar=0,width=900,height=280,top=0,left=0,scrollbars=1,resizable=yes" ,"_blank");
			...
			function updateProfile(id)
			{
				...
				if(id==2)
				{
					window.location.href='https://www.safeqloud.com/public/index.php/UserCompanySignUp/mannualPaymentCompanyInfo/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>';
				}
			}
...
<body class="dark" style="background: #131922;" onload="checkLogin();">
	...
	<div class="header__center center xxs-padrl25"><a class="header__logo xs-fsz20 changedText" href="#" style="
...
<h2 class="product__title h2  tall      xs-tall uppercase changedText" style="font-size:60px; line-height: 70px; font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Welcome to <?php echo $selectedMarketplaceDetail['marketplace_name']; ?>
</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Get started on your journey of finding the perfect broker for your project..
</h2>
 ...
 <div class="checkout__inner js-tabs wi_50  " >
 <div class="section categories  marl6  padb20" style="margin-bottom: 0px; border-bottom: 1px solid #23262F; ">
...
<div class="changedText categories__subtitle  txt_f67f00 ">User</div>
  </a>
   ...
   <a class="categories__item  trans_bg " href="../../signUpJobEmailInfo/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent; border:none;">
                                      ...
                                      <div class="changedText categories__subtitle txt_787f91">New</div>
                                      </a>
									  </div>
</div>
</div>
...
<div class="checkout__list   xs-margin0  padt32" style="max-width:448px;   margin-top:10px;">
 
<div class="checkout__section xsi-nobrdt   nobrdt hidden" style="border-top:none; margin-top: 0px; padding-top: 0px;">
...
<div class="description__center   xxs-padrl25">
...
<div class="receipt xs-margin0   maxwi_100   xs-pad20" style="
...
<form action="../../emailSignUpJobRequest/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="subscription subscription_big" style="margin-top: 0px; display:none;">
...
<a href="javascript:void(0);" class="subscription__btn" style="background:#E91E63;" onclick="submitForm();">
<svg class="icon icon-search mar10">
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button visible-xs hidden " href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android"><span class="changedText">Open Qloud ID App</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
