...
function readURL2(input) {
    if (input.files && input.files[0]) {
	 ...
	 var issueM="<?php echo date('m'); ?>";
		...
		function submitform()
		{
			...
			{
				$("#error_msg_form").html('Please enter a valid DL number');
                 submitFlag = 0;
                 return false;
			}
          ...
          <div class="checkout__center center">
            ...
            <div class="checkout__wrapper">
              <div class="checkout__inner js-tabs">
                <h2 class="checkout__title h2">Update Driving licence</h2>
                <div class="checkout__list">
                  ...
                  <div class="checkout__section" style="border-color: #f67f0066;">
				   <form action="../updateUserDrivingDetails/<?php echo $data['id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="checkout__item js-tabs-item">
				   
                      
					      <div class="checkout__line">
                        <div class="checkout__subtitle">Driving licence</div>
    ...
    border: 2px solid #353945; background: none; width:100%;">
						...
						<div class="field">
                          <div class="field__label" style="color:#787f91;">DL number</div>
                          <div class="field__wrap">
						...
						<div class="field">
                          ...
                          <div class="field__wrap">
                             <select class=""   id="issue_year" name="issue_year" style="height: 48px;
									padding: 0 14px; border-color: #353945;
									color: #777E90; border-radius: 12px;
									border: 2px solid #353945; background: none; width:100%;" onchange='updateMonth(this.value);'>
						...
						<div class="field">
                          ...
                          <div class="field__wrap">
                             <select class=""   id="expiry_year" name="expiry_year" style="height: 48px;
									padding: 0 14px; border-color: #353945;
									color: #777E90; border-radius: 12px;
									border: 2px solid #353945; background: none; width:100%;" onchange='updateExpiryMonth(this.value);'>
					 ...
					 <div class="checkout__row margin-bottom32">
					  ...
					  <a class="button  " href="javascript:void(0);" onclick="submitform();">Proceed for update</a>
                    </form>
