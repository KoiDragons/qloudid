...
function changeDisplay1()
	   ...
	   function updateInclutionType(id)
	   {
	   	...
	   	function submitform()
			...
			/*if($("#vcity").val()==0)
			{
				$('#error_msg_form').html('Please select vitech city');
				return false;
			...
			if($("#varea").val()==0)
			{
				...
				$('#error_msg_form').html('Please select vitech area');
				return false;
			}*/
			
			if($("#total_floors").val()==null || $("#total_floors").val()=="")
			{
				
				$("#error_msg_form").html('Please enter total floor');
				return false;
			}
			...
			if($("#total_floors").val()==0)
			{
				...
				$("#error_msg_form").html('Total floor cant be 0');
				return false;
			}
			
			if(isNaN($("#total_floors").val()))
			{
				
				$("#error_msg_form").html('Total floor must be a numeric value');
				return false;
			}
			
			if($("#total_bedrooms").val()==null || $("#total_bedrooms").val()=="")
			{
			...
			if($("#total_bedrooms").val()==0)
			{
				
				$("#error_msg_form").html('Total bedrooms cant be 0');
				return false;
			}
			
			if(isNaN($("#total_bedrooms").val()))
			{
				
				$("#error_msg_form").html('Total bedrooms must be a numeric value');
				return false;
			}
			...
			if($("#total_bathrooms").val()==0)
			{
				...
				$("#error_msg_form").html('Total bathrooms cant be 0');
				return false;
			}
			...
			if(isNaN($("#total_bathrooms").val()))
			{
				...
				$("#error_msg_form").html('Total bathrooms must be a numeric value');
				return false;
			}
...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 changedText" href="#" style="
   ...
   "><?php echo $userProffesionalRequest['marketplace_name']; ?></a>
...
<div class="upload__head" style="margin-bottom:0px;">
                  <h2 class="upload__title h2">Get Matched with Top Agents</h2>
				   
                </div>
				<div class="browse__info info changedText padb40" style="border-bottom: 2px solid #353945;">Register your property for personalized broker matches
</div>
<form class="checkout__item js-tabs-item" action="../addProfessionalProperty/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
<div class="checkout__fieldset mart40">
<div class="field margin-bottom24" style="">
<div class="field__label changedText" style="color:#787f91;">Building type</div>
<div class="field__wrap">
<select class=" " id="property_type_detail" name="property_type_detail" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52">
				 	
                           <option value="1" class="lgtgrey2_bg changedText">House</option>
												 	
                           <option value="2" class="lgtgrey2_bg changedText">Apartment</option>
												 	
                           <option value="3" class="lgtgrey2_bg changedText">Lodge</option>
												 	
                           <option value="4" class="lgtgrey2_bg changedText ">Cottage</option>
												 	
                           <option value="5" class="lgtgrey2_bg changedText">Cabin</option>
												 	
                           <option value="6" class="lgtgrey2_bg changedText">Chalet</option>
												 	
                           <option value="7" class="lgtgrey2_bg changedText">Wigwam</option>
												 	
                           <option value="8" class="lgtgrey2_bg changedText">Barn</option>
																 
                          </select> 
</div>
</div>
<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Name on the door</div>
<div class="field__wrap">
<input class="field__input" name="flname" id="flname"    type="text"  placeholder="e. g. Kowaken" style=" color:grey;">
</div>
</div>
...
<div class="upload__row">
                        ...
                        <div class="field  ">
                            <div class="field__label  changedText" style="color:#787f91;">Delivery address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="addrs" id="addrs" placeholder="e. g. Queenstown, Otago, New Zealand" style=" color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" id="pnumber" placeholder="e. g. 121" style=" color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
 ...
 <div class="upload__row">
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dzip" id="dzip" placeholder="e. g. 120001" style=" color:grey;" fdprocessedid="ykfd2j">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w70">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dcity" id="dcity" placeholder="e. g. Stockholam" style=" color:grey;" fdprocessedid="3ewtc">
                            </div>
                          </div>
						  </div>
						   </div>
...
<div class="field margin-bottom24"  >
<div class="field__label changedText" style="color:#787f91;">Entry code</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="entry_code" id="entry_code" placeholder="e. g. callme" style=" color:grey;">
</div>
</div>
<div class="upload__row margin-bottom24">
...
<div class="field__wrap">
<input class="field__input"  type="number" name="total_floors" id="total_floors"  placeholder="e. g. 1" required="" style=" color:grey;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="number" name="total_bedrooms" id="total_bedrooms" placeholder="e. g. 1"   required="" style=" color:grey;">
</div>
</div>

<div class="field" style="flex: 0 0 calc(34% - 16px);    width: calc(34% - 16px);    margin: 0 8px 24px 8px;" >
<div class="field__label changedText" style="color:#787f91;">Total bathrooms</div>
<div class="field__wrap">
<input class="field__input"  type="number" name="total_bathrooms" id="total_bathrooms"  placeholder="e. g. 1"  required="" style=" color:grey;">
</div>
</div>
</div>
<input type="hidden" id="same_name" name="same_name" value="0" />
...
<div class="profile" style="background:#23262f;">
                <div class="profile__main">
                  <div class="profile__avatar xsi-wihi_128p"><img src="https://www.dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar"></div> 
                  <div class="profile__man">Adam Bay</div>
				  
				  <div class="receipt__rating  padrl69i padrl120i">
                ...
                <div class="profile__body">
                  ...
                  <div class="profile__control"><a class="button-stroke button-small profile__button" href="#" tabindex="0">Contact</a>
                    <div class="actions js-actions">
                      <div class="actions__item actions__item_share js-actions-item">
                        ...
                        <div class="actions__body actions__body_up js-actions-body">
                          ...
                          <div class="actions__list share-btn" data-url="https://ui8.net"><a class="actions__link btn-twitter" data-id="tw" tabindex="0"><span>
                  ...
                  <div class="profile__socials"><a class="profile__social" href="https://twitter.com/ui8" target="_blank" tabindex="0">
                      <svg class="icon icon-twitter">
                        <use xlink:href="#icon-twitter"></use>
                      </svg></a><a class="profile__social" href="https://www.instagram.com/ui8net/" target="_blank" tabindex="0">
                      <svg class="icon icon-instagram">
                        <use xlink:href="#icon-instagram"></use>
                      </svg></a><a class="profile__social" href="https://www.facebook.com/ui8.net/" target="_blank" tabindex="0">
                      <svg class="icon icon-facebook">
                        <use xlink:href="#icon-facebook"></use>
                      </svg></a></div>
