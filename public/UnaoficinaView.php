...
<div class="section work hidden">
 ...
 <div class="section destinations">
          <div class="destinations__center center">
            ...
            <div class="destinations__list"><a class="destinations__item" href="BrokersHub">
                                  <div class="destinations__preview"><img srcset="<?php echo $path; ?>html/fleet/img/content/city-pic-1@2x.jpg 2x" src="<?php echo $path; ?>html/fleet/img/content/city-pic-1.jpg" alt="City">
                                    
                                  </div>
                                  <div class="destinations__subtitle">Brokers Hub</div>
                                  <div class="destinations__content hidden">Car rentals in 86 pickup locations</div></a>
								  <a class="destinations__item" href="DevelopersHub">
                                  <div class="destinations__preview"><img srcset="<?php echo $path; ?>html/fleet/img/content/city-pic-2@2x.jpg 2x" src="<?php echo $path; ?>html/fleet/img/content/city-pic-2.jpg" alt="City">
                                  </div>
                                  <div class="destinations__subtitle">Developers Hub</div>
                                  <div class="destinations__content hidden">Car rentals in 86 pickup locations</div></a>
								  <a class="destinations__item" href="GlobalBrokersCenter">
                                  <div class="destinations__preview"><img srcset="<?php echo $path; ?>html/fleet/img/content/city-pic-3@2x.jpg 2x" src="<?php echo $path; ?>html/fleet/img/content/city-pic-3.jpg" alt="City">
                                     
                                  </div>
                                  <div class="destinations__subtitle">Global Brokers Center</div>
                                  <div class="destinations__content hidden">Car rentals in 86 pickup locations</div></a>
