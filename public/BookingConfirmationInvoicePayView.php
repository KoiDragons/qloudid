...
<a href="../../../../../mannualPaymentInfo/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>/<?php echo $data['invoice_id']; ?>" class="header__item  " style="margin-left:10px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important; ">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Pay mannually</button>
...
<div class="section work xs-padrl25 marb80i xs-marb25i hidde hidden-xs" style=" ">
	...
	<form action="../../../../../updateUserPayInfo/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>/<?php echo $data['invoice_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
...
<div class="checkout__section xsi-nobrdt xs-pad0 padrl75  nobrdt" style="border-top:none; margin-top: 0px;  ">
...
<div class="description__center   xs-pad0">
