...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
      border-bottom: none;
">Invite</h2>
<div class="browse__info info xs-fsz25 changedText">Please invite the guest using their personal phone number</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Invite</div>
...
<form class="checkout__item js-tabs-item" action="../phoneIinviteAdultForCheckin/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
...
<div class="checkout__row margin-bottom32">
    ...
    color: grey; border-radius: 12px;
      background: #23262F; max-width:100%;" fdprocessedid="iur0t">
	 <option value="0" class="lgtgrey2_bg changedText">Select</option>
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="phone_number" id="phone_number" style="background:#23262F; color:grey;" fdprocessedid="2bl5m">
                            </div>
                          </div>
                        </div>
...
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="submitform();" >Send your invitation</a>
</form>
 </div>
</div>
</div>
