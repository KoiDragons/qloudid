...
<script>
	    ...
	    function submitform()
		{
			...
			if($("#otp1").val()=="" || $("#otp1").val()==null)
			{
				...
				$("#errorMsg1").html('Please enter OTP received on your email');
				return false;
			}
			...
			var emcode1=$("#otp1").val()+$("#otp2").val()+$("#otp3").val()+$("#otp4").val();
			 if(emcode1!=emcode)
			{
				
				$("#errorMsg1").html('Please enter correct email otp');
				return false;
			}
			
			
			
			if($("#otp5").val()=="" || $("#otp5").val()==null)
			{
			...
			if($("#otp8").val()=="" || $("#otp8").val()==null)
			{
				
				$("#errorMsg1").html('Please enter OTP received on your phone');
				return false;
			}
			var phcode1=$("#otp5").val()+$("#otp6").val()+$("#otp7").val()+$("#otp8").val();
			 if(phcode1!=phcode)
			{
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Share your experience of the broker who sold your property</div>
...
function getStar(id)
{
	...
	for(i=1;i<=id;i++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStar('+i+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	
	
	for(j=i;j<=5;j++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStar('+j+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	$('#satisfection_level').val(id);
	$('.brokerPerformance').html('');
	$('.brokerPerformance').html(dataStar);
}


function getStarAttentive(id)
{
	 
	var dataStar='';
	for(i=1;i<=id;i++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStarAttentive('+i+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	
	
	for(j=i;j<=5;j++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStarAttentive('+j+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	$('#broker_attention').val(id);
	$('.brokerAttention').html('');
	$('.brokerAttention').html(dataStar);
}

function getStarEnergy(id)
{
	 
	var dataStar='';
	for(i=1;i<=id;i++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStarEnergy('+i+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	
	
	for(j=i;j<=5;j++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStarEnergy('+j+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	$('#broker_energy').val(id);
	$('.brokerEnergy').html('');
	$('.brokerEnergy').html(dataStar);
}


function getStarEngaged(id)
{
	 
	var dataStar='';
	for(i=1;i<=id;i++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStarEngaged('+i+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	
	
	for(j=i;j<=5;j++)
	{
		dataStar=dataStar+'<div class="login__number" style="width: 16px !important;" onclick="getStarEngaged('+j+');"><svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg></div>';
	}
	$('#broker_engaged').val(id);
	$('.brokerEngaged').html('');
	$('.brokerEngaged').html(dataStar);
}
...
<form class="checkout__item js-tabs-item" action="../updateSellerReview/<?php echo $data['verification_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 
<div class="checkout__fieldset">
<div class="field__label changedText" style="color:#787f91;">How satisfied were you with broker performance</div>
<input  type="hidden"  name="satisfection_level" id="satisfection_level" value="1" />
<div class="login__code brokerPerformance" style="margin-bottom:48px; justify-content: left;">

              <div class="login__number" style="width: 16px !important;" onclick="getStar(1);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStar(2);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStar(3);">
                 <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStar(4);">
               <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
			   <div class="login__number" style="width: 16px !important;" onclick="getStar(5);">
              <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4" style="margin-left: 4px;"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
            </div>

			
<div class="field__label changedText" style="color:#787f91;">Broker was attentive and toom the time to answer questions</div>
<input  type="hidden"  name="broker_attention" id="broker_attention" value="1" />
<div class="login__code brokerAttention" style="margin-bottom:48px; justify-content: left;">

              <div class="login__number" style="width: 16px !important;" onclick="getStarAttentive(1);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarAttentive(2);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarAttentive(3);">
                 <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarAttentive(4);">
               <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
			   <div class="login__number" style="width: 16px !important;" onclick="getStarAttentive(5);">
              <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4" style="margin-left: 4px;"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
            </div>
			
			
			<div class="field__label changedText" style="color:#787f91;">Broker had high energy</div>
<input  type="hidden"  name="broker_energy" id="broker_energy" value="1" />
<div class="login__code brokerEnergy" style="margin-bottom:48px; justify-content: left;">

              <div class="login__number" style="width: 16px !important;" onclick="getStarEnergy(1);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarEnergy(2);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarEnergy(3);">
                 <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarEnergy(4);">
               <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
			   <div class="login__number" style="width: 16px !important;" onclick="getStarEnergy(5);">
              <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4" style="margin-left: 4px;"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
            </div>
							
<div class="field__label changedText" style="color:#787f91;">Broker was well prepared and easy to get hold off</div>
<input  type="hidden"  name="broker_engaged" id="broker_engaged" value="1" />
<div class="login__code brokerEngaged" style="margin-bottom:48px; justify-content: left;">

              <div class="login__number" style="width: 16px !important;" onclick="getStarEngaged(1);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#FFD166"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarEngaged(2);">
                <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarEngaged(3);">
                 <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
              <div class="login__number" style="width: 16px !important;" onclick="getStarEngaged(4);">
               <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
			   <div class="login__number" style="width: 16px !important;" onclick="getStarEngaged(5);">
              <svg width="28px" height="28px" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" fill="#B1B5C4" style="margin-left: 4px;"><path d="M6.49075 5.87586L9.19442 0.468508C9.29094 0.275471 9.56642 0.275471 9.66293 0.468508L12.3666 5.87586C12.4054 5.95351 12.4802 6.00687 12.5663 6.01834L18.3319 6.7871C18.547 6.81577 18.6359 7.07849 18.4825 7.2319L14.2421 11.4723C14.1802 11.5342 14.1533 11.623 14.1705 11.7089L15.3237 17.4749C15.3664 17.6886 15.1446 17.858 14.9497 17.7605L9.54581 15.0586C9.47207 15.0217 9.38529 15.0217 9.31155 15.0586L3.90765 17.7605C3.71271 17.858 3.49096 17.6886 3.5337 17.4749L4.6869 11.7089C4.70408 11.623 4.6772 11.5342 4.61528 11.4723L0.374865 7.2319C0.221458 7.07849 0.310398 6.81577 0.525446 6.7871L6.29111 6.01834C6.37715 6.00687 6.45193 5.95351 6.49075 5.87586Z" fill-opacity="1"></path></svg>
              </div>
            </div>							
							...
							<script>
										function brokerRecomended(link)
										   {
											  body = $('body');
											   if($('#broker_recommendation').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												   
												     $(link).attr('checked',''); 
													$('#broker_recommendation').val(0);													 
											   }
											   else
												   {
													 ...
													 $('#broker_recommendation').val(1);	
												   }
												   
												   body.addClass('dark');
										   }
										</script>
 <input type="hidden" id="broker_recommendation" name="broker_recommendation" value="1"/>
 <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Broker recommended</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"   onclick='brokerRecomended(this);' checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Can you recommend broker to other home sellers</div>
                    </div>
					
					
					
						<script>
										function brokerReasonable(link)
										   {
											  body = $('body');
											   if($('#broker_fee_reasonable').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												   
												     $(link).attr('checked',''); 
													$('#broker_fee_reasonable').val(0);													 
											   }
											   else
												   {
												     ...
												     $('#bodyData').addClass('dark');
												     $(link).attr('checked','checked');  
													 $('#broker_fee_reasonable').val(1);	
												   }
												   
												   body.addClass('dark');
										   }
										</script>
 <input type="hidden" id="broker_fee_reasonable" name="broker_fee_reasonable" value="1"/>
 <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Reasonable</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"   onclick='brokerReasonable(this);' checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">The broker fee was reasonable given the effort and result</div>
                    </div>
					
					
					
					<script>
										function brokerMaterial(link)
										   {
											  body = $('body');
											   if($('#broker_material').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												   
												     $(link).attr('checked',''); 
													$('#broker_material').val(0);													 
											   }
											   else
												   {
												     ...
												     $('#bodyData').addClass('dark');
												     $(link).attr('checked','checked');  
													 $('#broker_material').val(1);	
												   }
												   
												   body.addClass('dark');
										   }
										</script>
 <input type="hidden" id="broker_material" name="broker_material" value="1"/>
 <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Material</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"   onclick='brokerMaterial(this);' checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">The ad and sales material were selling</div>
                    </div>
	
	
	<script>
										function brokerPresentation(link)
										   {
											  body = $('body');
											   if($('#broker_material').val()==1)
											   {
											   ...
											   else
												   {
												     ...
												     $('#bodyData').addClass('dark');
												     $(link).attr('checked','checked');  
													 $('#broker_presentation').val(1);	
												   }
												   
												   body.addClass('dark');
										   }
										</script>
 <input type="hidden" id="broker_presentation" name="broker_presentation" value="1"/>
 <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Presentation</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"   onclick='brokerPresentation(this);' checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">The broker presented how sales should go and keep me updated</div>
                    </div>
 	<script>
										function brokerKnowledge(link)
										   {
											  body = $('body');
											   if($('#broker_knowledge').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												   
												     $(link).attr('checked',''); 
													$('#broker_knowledge').val(0);													 
											   }
											   else
												   {
												     ...
												     $('#bodyData').addClass('dark');
												     $(link).attr('checked','checked');  
													 $('#broker_knowledge').val(1);	
												   }
												   
												   body.addClass('dark');
										   }
										</script>
 <input type="hidden" id="broker_knowledge" name="broker_knowledge" value="1"/>
 <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Knowledge</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"   onclick='brokerKnowledge(this);' checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">The broker knew the local market and the range of services well</div>
                    </div>
 <script>
										function brokerChoiceHelp(link)
										   {
											  body = $('body');
											   if($('#broker_choice_help').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												   
												     $(link).attr('checked',''); 
													$('#broker_choice_help').val(0);													 
											   }
											   else
												   {
 ...
 <input type="hidden" id="broker_choice_help" name="broker_choice_help" value="1"/>
 <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Hittamaklare</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"   onclick='brokerChoiceHelp(this);' checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Did you take the help of Hittamaklare in your choice of broker</div>
                    </div>
					
					 <div class="field" style="margin-bottom:24px;">
                          <div class="field__label">Review</div>
                          <div class="field__wrap">
                            <textarea class="field__textarea" name="description" id="description" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" required=""></textarea>
                          </div>
                        </div>
