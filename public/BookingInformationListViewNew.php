...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Bookings</h2>
<div class="browse__info info changedText">Here is the list of all reservations that require your attention</div>
</div>
...
<div class="checkout__category changedText">List</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
	foreach($reservationConfermationRequiredList as $category => $value) 
	{
	?> 	
<div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText"><?php echo $value['property_nickname']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['duration'].' , '.$value['guest']; ?></div>
 
<div class="checkout__controls">
<a href="../verifyBookingDetail/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
