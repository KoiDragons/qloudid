...
<div class="categories__center center  xs-padrl0 hidden" style="
    padding: 0 0px;
">
<div class="categories__inner padding150_80 xs-padding160_40 xs-padrl25 xxs-brdrad0" style="
    background: #0e1116;
    
    border-radius: 12px;
">
<div class="categories__head marrla" style="margin-bottom: 0px !important; max-width: 960px;">
<h2 class="categories__title h2 fsz70 xs-fsz45 xs-lgn_hight_55 xs-tall xs-marb15" style="color: #ffffff;">Innovate and Expand with TXP</h2>

<div class="categories__info info   xs-lgn_hight_35 xs-tall  " style="margin-top:5px; font-size:25px;">Access Exclusive Tools, Insights, and Support to Drive Your Development Projects</div>
<a class="button main__button xs-tall talc xs-fleft  hidden-xxs" href="SelectMemberType" style="
     background: #cddd39;
     margin-top: 45px;
     /* margin-bottom: 55px; */
     color: black;
...
<picture>
<source media="(max-width: 767px)" srcset="<?php echo $path; ?>html/usercontent/images/dstricts/bgimage7.jpeg"><img src="<?php echo $path; ?>html/usercontent/images/dstricts/bgimage7.jpeg" alt="Main" class=" " style="padding: 0px !important; border-radius:12px;">
</picture>
...
<div class="  visible-xs padrl25 padt30">
              <div class="  gallery__list_stays">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view" href="<?php echo $path; ?>html/usercontent/images/dstricts/boximage13.jpeg" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="<?php echo $path; ?>html/usercontent/images/dstricts/boximage13.jpeg" alt="Gallery" style="border-radius:8px;"></a></div>
...
<h2 class="categories__title h2 fsz90 xs-fsz45 xs-lgn_hight_55 xs-tall xs-marb15 changedText hidden-xs uppercase" style="color: #ffffff; font-size:90px; ">SAVE ON HOTEL & DINING</h2>
<div class="categories_info info   xs-tall   changedText visible-xs uppercase" style="
                  line-height: 1.2;
                  font-size: 60px;
                  
				  font-weight:100;
                   color: #ffffff;">SAVE ON HOTEL & DINING
</div>
...
<div class="xxs-padrl25" <?php if($i>1) echo 'style="margin-top:40px;"'; ?>>
	 <div class="center xs-pad0 xs-brdrad12 xxs-bg_trans xs-nobrd" style="padding:50px;border-radius: 10px;max-width: 1132px; border:1px solid #23262f; ">
		...
		<div class="travel__center   " style="">
		 <div class="receipt__description receipt__description_flex mart0 visible-xs" style="  margin-bottom: 20px; background: #23262F; border-radius:6px;">
                <div class="receipt__item" style="flex: 0 0 33%;">
                  <div class="receipt__icon hidden-xxs">
                    <svg class="icon icon-calendar">
                      <use xlink:href="#icon-calendar"></use>
                    </svg>
                  </div>
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Check-in</div>
                    <div class="receipt__subtitle" style="font-size:16px;"><?php echo date('M d',$value['checkin_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item" style="flex: 0 0 33%;">
                  <div class="receipt__icon  hidden-xxs">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Check-out</div>
                    <div class="receipt__subtitle" style="font-size:16px;"><?php echo date('M d',$value['checkout_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item" style="flex: 0 0 33%;">
                  <div class="receipt__icon  hidden-xxs">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Guest</div>
                    <div class="receipt__subtitle changedText" style="font-size:16px;"><?php echo ($value['adult_guest']+$value['adult_child']); ?> guests</div>
                  </div>
                </div>
              </div>
...
">
                ...
                <div class="description__parameter  xs-mart0 ">
                  <svg class="icon icon-flag hidden-xs">
                    <use xlink:href="#icon-flag"></use>
...
<div class="setting__text padb25 hidden-xxs" style="
			   ...
			   <div class="receipt__description receipt__description_flex mart20 hidden-xxs" style="  margin-bottom: 20px; background: #23262F; border-radius:16px;">
                <div class="receipt__item" style="flex: 0 0 33%;">
                  <div class="receipt__icon hidden-xxs">
                    <svg class="icon icon-calendar">
                      <use xlink:href="#icon-calendar"></use>
                ...
                <div class="receipt__item" style="flex: 0 0 33%;">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle changedText" style="font-size:16px;"><?php echo ($value['adult_guest']+$value['adult_child']); ?> guests</div>
                      ...
                      <a href="../propertyInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>"><button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts">View</button></a>
				  ...
				  <div class="travel__gallery">
                    ...
                    <div class="profile__parameter">
					 ...
					 <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg>7 327 <span class="changedText">shared</span>
                    </div>
                  </div>
						<?php } else if($i%3==0){ ?>
				   <div class="profile__parameters xs-padrl0 mart20 marrla hidden-xxs" style="background: #1b2739; margin-bottom:0px;  max-width:365px;">
                    ...
                    <div class="profile__parameter">
					 ...
					 <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg>5 323 <span class="changedText">shared</span>
                    </div>
                  </div>
				  <?php } else{ ?>
				  ...
				  <div class="profile__parameters xs-padrl0 mart20 marrla hidden-xxs" style="background: #1b2739; margin-bottom:0px;  max-width:365px;">
                    ...
                    <div class="profile__parameter">
					 ...
					 <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg>6 363 <span class="changedText">shared</span>
                    </div>
                  </div>
				  <?php }?>
   ...
   <div class="travel__row " style="">
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:525px; ">
         <div class="travel__list" style="margin-bottom:0px;
			...
			<div class="section destinations <?php if($poposalDetail ['team_available']==0) echo 'hidden'; ?>" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom:1px solid #23262F; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
		<div class="  browse <?php if($poposalDetail ['team_available']==0) echo 'hidden'; ?>">
...
">About us</div>
            ...
            <div class="browse__wrapper">
                <div class="browse__slider js-slider-browse">
				 <?php $i=1; 
								foreach($teamMemberRentListing as $category => $value) 
										{
										 ?>
				<a class="browse__card bg10161d" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px; background:white;">
									 ...
									 <!-- <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="<?php echo $path; ?>html/usercontent/images/gettxp/5.jpeg" src="<?php echo $path; ?>html/usercontent/images/gettxp/5.jpeg" alt="Card">
									  ...
									  <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="<?php echo $path; ?>html/usercontent/images/gettxp/6.jpeg" src="<?php echo $path; ?>html/usercontent/images/gettxp/6.jpeg" alt="Card">
									  ...
									  <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="<?php echo $path; ?>html/usercontent/images/gettxp/7.jpeg" src="<?php echo $path; ?>html/usercontent/images/gettxp/7.jpeg" alt="Card">
            ...
            <div class="destinations__inner">
              ...
              <div class="destinations__wrapper">
				...
				<div class="destinations__item" style="margin-right: 20px; border-radius: 6px; border: 1px solid rgb(35, 38, 47); padding: 30px; width: 364px;"  >
                                      <div class="destinations__preview" style="border-radius:6px;"><img srcset="<?php echo $path; ?>html/usercontent/images/gettxp/8.jpeg" src="<?php echo $path; ?>html/usercontent/images/gettxp/8.jpeg">
									...
									<div class="destinations__item" style="margin-right: 20px; border-radius: 6px; border: 1px solid rgb(35, 38, 47); padding: 30px; width: 364px;"  >
                                      <div class="destinations__preview" style="border-radius:6px;"><img srcset="<?php echo $path; ?>html/usercontent/images/gettxp/10.jpeg" src="<?php echo $path; ?>html/usercontent/images/gettxp/10.jpeg">
                                      </div>
									...
									<div class="destinations__content changedText" style=" color: #787f91; font-size: 18px;">Century 21</div>
									  ...
									  <div class="destinations__item" style="margin-right: 20px; border-radius: 6px; border: 1px solid rgb(35, 38, 47); padding: 30px; width: 364px;"  >
                                      <div class="destinations__preview" style="border-radius:6px;"><img srcset="<?php echo $path; ?>html/usercontent/images/gettxp/9.jpeg" src="<?php echo $path; ?>html/usercontent/images/gettxp/9.jpeg">
...
<div class="section destinations xxs-padrl25 hidden" style="margin-bottom:80px;">
	  ...
	  <div class="center xxs-pad25 xs-brdrad12" style="padding:50px;   border-radius:25px; max-width: 1132px; background-color:#1e1f2c;">
		...
		<div class="travel__center   " style="">
<div class="destinations__head xs-marb48 marb96" style="padding-right:0px;">
                <h2 class="destinations__title h2 talc xs-tall changedText" style="margin-bottom: 16px;">Rent out</h2>
		...
		<div class="setting__box">
                ...
                <h2 class="destinations__title h2   changedText" style="margin-bottom: 16px; font-size:32px;">Ai News</h2>
			  ...
			  <div class="travel__col" style="padding:0px; widht:100%">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel">
				  <div class="travel__gallery">
                      <div class="travel__bg" style="border-radius: 12px;"><img srcset="<?php echo $path; ?>html/usercontent/images/dstricts/boximage3.jpeg" src="<?php echo $path; ?>html/usercontent/images/dstricts/boximage3.jpeg" alt="Travel"></div>
	...
	<div class="section destinations xxs-padrl25 hidden" style="margin-bottom:80px;">
	 ...
	 <div class="xxs-padrl25 hidden">
	  <div class="center xxs-pad25 xs-brdrad12" style="padding:50px;   border-radius:25px; max-width: 1132px; background-color:#1e1f2c;">
		...
		<div class="travel__center   " style="">
<div class="destinations__head xs-marb48 marb96" style="padding-right:0px;">
                <h2 class="destinations__title h2 talc xs-tall changedText" style="margin-bottom: 16px;">Exclusive Contracts</h2>
				<div class="travel__subtitle   changedText talc  xs-tall" style="
                     color: #787f91; font-size:25px; line-height:1.4;
                  ">We specialize in elevating tenant experience
</div>
		...
		<div class="setting__box">
                    ...
                    <div class="setting__line">
                      <div class="setting__element" style="display:block; border:none; ">
                        <div class="setting__details"> 
                         <div class="destinations__head    xs-marb25" style="padding:0px; margin-bottom:32px; ">
                <h2 class="destinations__title h2  changedText " style="margin-bottom: 16px; font-size:32px;">Una Qasa</h2>
