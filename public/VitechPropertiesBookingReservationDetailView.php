 ...
 var expiryM="<?php echo date('m'); ?>";
	...
	function updateExpiryMonth(id)
	    ...
	    function submitform()
		{
			...
			if($("#user_exist").val()==1)
			{
			$("#errorMsg1").html("please enter another email address !!!");
		...
		function checkEmailInfo(id)
		{
			...
			send_data.email=$("#email").val();
					...
					$.ajax({
						...
						if(data1==0)
						{
						$("#errorMsg1").html('Another user with same email already exist');
						$('#user_exist').val(1);
						return false;
...
<div class="checkout__wrapper">
              <div class="checkout__inner js-tabs">
                <h2 class="checkout__title h2 uppercase" style="border-color: #f67f00;">Confirm and pay</h2>
                <div class="checkout__list">
                  
                  <div class="checkout__section">
                   <form class="checkout__item js-tabs-item" action="../../../updateReservationDetail/<?php echo $data['proposal_id']; ?>/<?php echo $data['selected_wishlist_id']; ?>/<?php echo $data['booking_type']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
					
					 <div class="checkout__line">
                        <div class="checkout__subtitle">Buyer detail</div>
                         
                      </div>
					
					  <div class="checkout__fieldset">
					<div class="<?php if(!empty($poposalUserDetail)) echo 'hidden'; ?>" id="userDetail">
<div class="field" style="margin-bottom:24px;" >
<div class="field__label changedText" style="color:#787f91;">Email address</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="email" id="email" value="<?php if(!empty($poposalUserDetail)) echo $poposalUserDetail['email'];?>" style="border-color:#f67f00; color:grey;" onfocusout="checkEmailInfo(this.value);">
</div>
</div>
<input    name="user_id" id="user_id"    type="hidden"  value="<?php if(!empty($poposalUserDetail)) echo $poposalUserDetail['id']; else echo 0; ?>" style="color:grey;">
<input    name="user_exist" id="user_exist"    type="hidden"  value="0" style="color:grey;">
<div class="checkout__row" style="margin-bottom:24px;">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">First name</div>
<div class="field__wrap">
<input class="field__input" name="fname" id="fname"    type="text"   style=" color:grey;" value="<?php if(!empty($poposalUserDetail)) echo $poposalUserDetail['first_name']; ?>">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="lname" id="lname"    type="text"   style=" color:grey;" value="<?php if(!empty($poposalUserDetail)) echo $poposalUserDetail['last_name']; ?>">
</div>
</div>
</div>
...
<div class="checkout__row" style="margin-bottom:24px;">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Code</div>
<div class="field__wrap">
 
<select  class="   "  name="country" id="country" style=" 
    height: 48px;
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52" disabled>
				 <?php foreach($countryOptions as $category => $value) 
										{ ?>
                         	<option value="<?php echo $value['id']; ?>" <?php if($value['id']==$poposalDetail['country_id']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
										<?php } ?>																			
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text" value="<?php echo $poposalDetail['phone_number']; ?>"  readonly style=" color:grey;"  >
</div>
</div>
</div>
</div>
					...
					<div class="checkout__section">
                      ...
                      <div class="checkout__fieldset">
                        <div class="field  margin-bottom24">
                          ...
                          <div class="field__wrap">
                            <input class="field__input" type="text" id="card_number" name="card_number" placeholder="XXXX XXXX XXXX XXXX" required="" fdprocessedid="c8bxtw">
                          </div>
                        </div>
...
<div class="field__wrap">
<input class="field__input"  name="cvv" id="cvv"    type="text"  placeholder='CVC' style="color:grey;">
</div>
</div>
                      </div>
                      </div>
					  
					  <div id="errorMsg1" class="red_txt padtb20 fsz18"></div>
					  
                      <a class="button checkout__button" href="javascript:void(0);"  onclick="submitform();">Confirm and pay</a>
                    </form>
              ...
              <div class="price hidden-xs">
                <div class="price__head">
                  <div class="price__preview"><img src="../<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" alt="Price"></div>
                  <div class="price__details">
                    ...
                    <div class="price__parameters">
                      <div class="price__parameter"><?php echo $getPropertyDetailInfo['numberOfBathrooms']; ?> private bath</div>
                      <div class="price__parameter"><?php echo $getPropertyDetailInfo['numberOfBedrooms']; ?>  bedroom</div>
                    </div>
                ...
                <div class="price__description price__description_flex">
                  <div class="price__item">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo date('M d, Y',$getPropertyDetailInfo['checkin_date']); ?></div>
                    </div>
                  </div>
                  <div class="price__item">
                    <div class="price__icon">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo date('M d, Y',$getPropertyDetailInfo['checkout_date']); ?></div>
                    </div>
                  </div>
                  <div class="price__item">
                    <div class="price__icon">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo  $getPropertyDetailInfo['adult_guest']+$getPropertyDetailInfo['adult_child']; ?> guest</div>
                    </div>
                  </div>
                </div>
                <div class="price__body">
                  ...
                  <div class="price__table">
                    <div class="price__row">
                      <div class="price__cell">$<?php echo  $getPropertyDetailInfo['broker_price_per_night']; ?> x <?php echo  ($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400; ?> nights</div>
                      <div class="price__cell">$<?php echo $getPropertyDetailInfo['broker_price_per_night']*(($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400); ?></div>
                    </div>
                    <div class="price__row">
                    ...
                    <div class="price__row" style="background:#f67f00;">
                      <div class="price__cell" style="color:#000000;">Total (USD)</div>
                      <div class="price__cell" style="color:#000000;">$<?php echo $getPropertyDetailInfo['broker_price_per_night']*(($getPropertyDetailInfo['checkout_date']-$getPropertyDetailInfo['checkin_date'])/86400); ?></div>
                    </div>
                  </div>
                </div>
