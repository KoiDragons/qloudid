...
function readURL2(input) {
    ...
    font-family: Avenir;
    font-size: 20PX;
    line-height:25px !important"><?php echo $bookingDetail['car_model']; ?></a>
</div>
      </div>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart60 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_70 xxs-lgn_hight_50 padb0 white_txt trn ffamily_avenir changedText">Driving licence</h1>
									</div>
									<div class=" xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText">Please provide DL information for your booking</a></div>
									
								 
								 
									
							<form action="../updateUserDrivingDetails/<?php echo $data['id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<a href="#profile3" class="expander-toggler white_txt xs-fsz16 tall bg_2F3C4F padrl30 padtb10 brdrad5 active">Driving licence 
								...
								<div id="profile3" class=" " style="display:block;">	
											...
											<label for="id_number" class="floating__label tall nobold padl10" data-content="Licence number">
                     ...
                     <div class="on_clmn padt10">
                              ...
                              <select id="expiry_month" name="expiry_month" class="wi_100 bg_2F3C4F nobrd padt25 tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir"  >
							    ...
							    <label for="expiry_month" class="floating__label tall nobold padl10" data-content="Expiry month">
									...
									<div class="clear"></div>
											 ...
											 <div class="marrl0 padb15 brdb fsz16 bg_212b3a tall padt35">
								<a href="#profile4" class="expander-toggler white_txt xs-fsz16 tall bg_2F3C4F padrl30 padtb10 brdrad5 active">DL copies
								<span class="dnone_pa fa fa-chevron-down fright dark_grey_txt"></span><span class="dark_grey_txt dnone diblock_pa fa fa-chevron-up padr15 fright"></span></a></div>
						...
						<div class="on_clmn mart10 ">
							...
							<div class="padt20 xxs-talc talc padb50 mart35">
								...
								<a href="#" onclick="submitform();"><button type="button" name="forward" class="bold forword minhei_55p   fsz16 padrl70 nobold" style="border-radius: 50px; background: #ffffff; color: #777E90;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="changedText">Proceed for update</font></font></button></a>
