...
<form class="checkout__item js-tabs-item" action="../../../../../../addProfessionalServiceWindowCleaningRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 
<div class="checkout__fieldset">
 
 
<div class="field" style="display:none;">
<div class="field__label changedText">Building type</div>
<div class="field__wrap">
<select  class="nice-select select"  id="property_type_detail" name="property_type_detail" style="height: 48px;
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
    border: 2px solid #E6E8EC; background: none;  width:100%;" fdprocessedid="8mc52">
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">What type of window does it apply to?</div>
<div class="field__wrap">
<select  class="nice-select select"  id="furniture_info_detail" name="furniture_info_detail" style="background:#F4F5F6; height:60px; border:none; 
    ...
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
                           ...
                           <option value="1" class="lgtgrey2_bg changedText">Default window</option>
						   <option value="2" class="lgtgrey2_bg changedText">Paned windows</option>		 	 
                          </select>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">How many windows does it apply to?</div>
<div class="field__wrap">
<input class="field__input"  type="number" name="total_window" id="total_window"  placeholder="Total windows" required="" style="  height:60px;   ">
</div>
</div>
...
<div class="field__label changedText" style="color:#525252;">What type of window does it apply to?</div>
<div class="field__wrap">
<select  class="nice-select select "  id="pages_info_detail" name="pages_info_detail" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
				 
                           <option value="2" class="lgtgrey2_bg changedText">2 Pages</option>
						   <option value="4" class="lgtgrey2_bg changedText">4 Pages</option>		
							<option value="6" class="lgtgrey2_bg changedText">6 Pages</option>								   
                          </select>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Should window frames be cleaned and dried?</div>
<div class="field__wrap">
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Have the windows been exposed to paint, soot or other hard dirt and need special washing?</div>
<div class="field__wrap">
<select  class="nice-select select"  id="exposure_info_detail" name="exposure_info_detail" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
                           ...
                           <option value="1" class="lgtgrey2_bg changedText">Yes</option>
						   <option value="0" class="lgtgrey2_bg changedText">No</option>		
							 <option value="2" class="lgtgrey2_bg changedText">Dont know</option>	
                          </select>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Are the windows hard to reach so that a ladder is needed?</div>
<div class="field__wrap">
<select  class="nice-select select"  id="exposure_info_detail" name="exposure_info_detail" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
    color: #777E90; border-radius: 12px;
       width:100%;" fdprocessedid="8mc52">
						   ...
						   <option value="0" class="lgtgrey2_bg changedText">No</option>		
							 <option value="2" class="lgtgrey2_bg changedText">Dont know</option>	
							  <option value="3" class="lgtgrey2_bg changedText">I am not sure</option>
                          </select>
</div>
</div>
