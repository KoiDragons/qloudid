						...
						<div class="on_clmn brdb marb5">
								...
								foreach($serviceBidsList as $category => $value) 
								 ...
								 <div class="column_m container  marb5  mart5 fsz14 dark_grey_txt brd">
												<div class=" <?php if($value['bid_accepted']==0) { echo 'lgtgrey_bg'; } else if($value['bid_accepted']==1) { echo 'green_bg_00ff9996'; } else { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText"><?php echo $value['company_name']; ?></span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs changedText">Price per hour - <?php echo $value['per_hour_fee']; ?> SEK</span> 
													<span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs changedText">Project fee - <?php echo $value['project_fee']; ?></span>
													 </div>
													 <?php if($value['bid_accepted']==0) { ?>
													<div class="xxxs-wi_25 fleft wi_25  marr30 xs-mar0 ">
													
													<a href="../receivedbidProfileInfo/<?php echo $data['job_id']; ?>/<?php echo $value['enc']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl20 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi changedText">Accept</button>
																			</div> 
																			</a>
													   </div>
