...
<div class="checkout__section xsi-nobrdt " style="margin-top:10px; padding-top:0px;   padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../addAccountInformation/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
                      ...
                      <div class="checkout__fieldset mart30">
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="email" id="email" value="<?php echo $adultInvitationDetail['email']; ?>"  readonly  style="background:#23262F; color:grey;" fdprocessedid="cqhzif">
                            </div>
                          </div>
