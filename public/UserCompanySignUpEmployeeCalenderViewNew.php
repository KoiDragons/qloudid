...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo $path; ?>html/bookadirect/main.css" />
      ...
      <link rel="stylesheet" type="text/css" media="all" href="<?php echo $path; ?>html/bookadirect/web.css" />
    ...
    <script>
      ...
      if (viewportmeta) {
		...
		function getNewCalender(id)
		{
			...
			$('#date_flag').val(id);
		var send_data={};
		send_data.w_width=$(window).width();
		send_data.date_flag=id;
		send_data.employee_id=$('#employee_id').val();
		send_data.message=id;
		$.ajax({
            type:"POST",
            url:"../../../../../../../../../../getNewCalender/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/<?php echo $data['employee_id'];?>",
            data:send_data,
            dataType:"text",
...
$(window).on('resize', function() {
  if ($(this).width() !== width) {
    ...
    if(width>700)
	{
		$('.slick-track').attr('width',550);
	}
	else
	{	
		width=width-50;
		$('.slick-track').attr('width',width);
	}
  }
});
  ...
  <body class="dark" style="background: #131922" onload="getNewCalender(0);">
<script>
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Book</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Please select a suitable date and time combination
</h2>
 ...
 <?php if($selectedServiceInfo['one_shared']==1) { ?>
 <div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText"><?php if($data['employee_id']=='bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09') echo 'Selected'; ?> Employee</div>
<input class="checkout__input js-date-single changedText" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="Anyone">
<div class="checkout__controls">
 
<a href="../../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
foreach($professionalCompanyEmployeeList as $category => $value) 
		{
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText"><?php if($value['enc']==$data['employee_id']) echo 'Selected'; ?>  Employee</div>
<input class="checkout__input js-date-single changedText" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo substr(html_entity_decode($value['name']),0,20); ?>">
<div class="checkout__controls">
 
<a href="../../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__inner js-tabs xs-mart20">
<div id='calenderinfo'>
 ...
 <form method='POST' action='../../../../../../../../../../updateBookingTimeInfo/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/<?php echo $data['employee_id']; ?>' id='save_indexing' name="save_indexing" >
		<input type='hidden' id='booking_employee_id' name='booking_employee_id' value="" />							
		<input type='hidden' id='date_flag' name='date_flag' value="0" />
		<input type='hidden' id='employee_id' name='employee_id' value="<?php if(isset($_POST['employee_id'])) echo $_POST['employee_id']; else echo 0; ?>" />
		<input type="hidden" id="user_id" name="user_name" value="<?php echo $serviceBidsInfo['user_id']; ?>" />
		 <input type='hidden' id='booking_date' name='booking_date' value="" />
		 <input type='hidden' id='booking_time' name='booking_time' value="" />
		 <input type='hidden' id='total_booking_time' name='total_booking_time' value="" />
		<input type='hidden' id='shared_type' name='shared_type' value="1" />
