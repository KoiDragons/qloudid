...
function checkEmailInfo(id)
		{
			...
			send_data.email=$("#email").val();
					...
					$.ajax({
						type:"POST",
						url:"../verifyEmail/<?php echo $data['a_id']; ?>",
						data:send_data,
						dataType:"text",
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Complete the fields below to validate your reservation.</div>
...
<input class="field__input" type="text" name="email" id="email" placeholder="e. g. xyz@gmail.com" value="" style="border: 2px solid #f67f00;" onfocusout="checkEmailInfo(this.value);">
</div>
...
<div class="field__wrap">
<input class="field__input" name="first_name" id="first_name"  value=""  type="text" placeholder="e. g. XYZ"  style="color:grey; background:#282D34; border:none;" >
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="last_name" id="last_name"    type="text" placeholder="e. g. XYZ"  style="color:grey;  background:#282D34;  border:none;" value="">
</div>
</div>
</div>

  
 <input class="field__input" type="hidden" name="user_id" id="user_id" placeholder="e. g. 7222233554" value="" >
    ...
    color: grey; border-radius: 12px;
      background:#282D34; width:100%;  border:none;" fdprocessedid="8mc52">
				  <?php  foreach($countryOptions as $category => $value) 
															...
															<option value="<?php echo $value['id']; ?>"  <?php if($value['id']==$userSignupInformation['country_id']) echo 'selected'; ?> class="lgtgrey2_bg changedText"><?php echo $value['country_name']; ?></option>
														<?php 	}	?>
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"  value="<?php echo $userSignupInformation['phone_number']; ?>"  type="text"  placeholder="e. g. xxxxxx1234" style="color:grey;  background:#282D34;  border:none;" value="">
</div>
</div>
</div>
 </div>
