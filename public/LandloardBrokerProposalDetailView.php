...
<div class="column_m     bs_bb lgtgrey2_bg visible-xs  " style="height:93px;  position:relative; z-index:10; background-color:  transparent;">
				...
				<div  class="xs-padrl25 xs-pos_fix " style="display:flex; position: relative;">
				 <div>
<a class="header__logo xs-fsz20 changedText" href="../proposerDetail/<?php echo $data['proposal_id']; ?>" style="
...
<div class="destinations__center center" style=" display: flex !important;
...
<div class="setting__element" style="display:block; border:none; ">
                ...
                <h2 class="destinations__title h2   changedText" style="margin-bottom: 10px;font-size: 32px;"><?php echo $value['society_name']; ?></h2>
...
">
                <div class="description__parameter  xs-mart0" style="">
                  ...
                  </svg><span class="changedText"><?php  echo $value['street_address']; ?></span></div>
                <div class="description__parameter  xs-mart0">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['city']; ?></span></div>
                <div class="description__parameter  xs-mart0 hidden-xxs">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['zipcode']; ?></span></div>
              </div>
<div class="setting__text padb25 hidden-xxs" style="
                  color: #787f91;
                  font-size: 16px;
                  padding-bottom: 0px; line-height:1.71429;
                  "><?php  echo substr(html_entity_decode($value['description']),0,250); ?></div>
                  ...
                  "><?php  echo substr(html_entity_decode($value['description']),0,250); ?>  </div>
                      ...
                      <a href="../proposalSocietyDetail/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>"><button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts" style="border-radius: 6px !important;">Read more</button></a>
...
<div class="profile__parameters xs-padrl0 mart25 hidden" style="background: #1b2739;  max-width:365px;">
...
<div class="section destinations  xs-padrl25 <?php if($poposerEmployeeDetail['about_is_active']==0) echo 'hidden';?>" style="margin-bottom:80px;">
   ...
   <div class="travel__row " style="">
	...
	<div class="section destinations   <?php if($clientProposalDetail ['team_available']==0) echo 'hidden'; ?>" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom:1px solid #23262F; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
		<div class="  browse    <?php if($clientProposalDetail ['team_available']==0) echo 'hidden'; ?>">
