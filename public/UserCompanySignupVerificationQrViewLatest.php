<html lang="en" style="--vh: 6.75px;"><head>
<meta charset="utf-8">
...
<link rel="stylesheet" media="all" href="<?php echo $path;?>html/fleet/css/app.min.css">
	<script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script type="text/javascript" src="<?php echo $path;?>html/usercontent/js/jquery.js"></script>
...
<button class="header__burger js-header-burger"></button>
	...
	<div class="outer__inner">
	 <form action="../verifyUserRequestInfo/<?php echo $data['domain_id']; ?>/<?php echo $data['cid']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
			...
			<input type="hidden" id="user_signup_info" name="user_signup_info" value="<?php echo $data['user_signup_info'] ; ?>" />
			</form>
...
<div class="receipt xs-margin0" style="border: none;    background: #141416; padding:0; margin:0; width:100%;">
...
<div class="section description mart80 xxs-mart40  xs-padb0" style="background: #ffffff;border-color: white;margin-top: 50px;" id="loginBank">
<div class="description__center center xxs-padrl25">
<div class="description__wrapper xs-pad0 padrt50 xxs-marb10 hidden" style="
    padding-right: 90px;
    padding-top: 20px;
">
<h4 class="description__title h4 fsz50 xs-talc xs-fsz35  marb0 xs-nobold hidden" style="
     letter-spacing: 0;
     /* line-height: 1.1; */
     color: black;
">Qloud ID Private</h4>

<div class="description__list" style="display:none;">
...
<div class="description__content hidde hidden-xs" style="
    margin-bottom: 24px;

">

<p class="fsz35 lgn_hight_45 fsz35 xs-lgn_hight_25 xs-fsz20 xs-talc " style="
">Your 60 seconds are up. Try again by scaning the QR code with your Qloud ID app</p>


</div>
<div class="description__group">
<div class="description__section hidden-xs" style="
    margin-top: 24px;
    padding-top: 24px;
    font-size: 20px;
    line-height: 25px;
...
<div class="description__content" style="
    margin-bottom: 32px;
">
<h4 style="display:none;">Activity</h4>
<p class="fsz35 lgn_hight_45 fsz35 xs-lgn_hight_25 xs-fsz20 xs-talc" style="
    font-size: 20px;
    line-height: 25px;
">If you dont have a Qloud ID account then you can download it for free on Appstore or Android marketplace</p>


</div>
</div>
<p class="hidden-xs" style="/* align-items: center; */width: 445px;text-align: left;padding-left: 0px;"><a href="https://apps.apple.com/se/app/swish-betalningar/id563204724">
...
<div class="description__content description__content_hide" style="display: block;">
...
<div class="receipt__head hidden-xs" style="padding:0px;display:block;text-align:center;margin-top: 32px;">
<div class="receipt__details">
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>" class="" style="width: 150px;height: 150px;"></div>
</div>

</div>
<div class="receipt__foot">
<div class="receipt__free changedText" style="margin-bottom: 5px;font-size: 25px;color: black;">Verification</div>
				
				
				
</div> 
<div class="receipt__foot">
<div class="receipt__free changedText" style="font-size: 15px;color: grey;">Open your Qloud ID app and scan the QR code above to verify your requet.
...
<a class="hidden visible-xs " style="text-decoration:none !important; " href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro3_xxxx" id="iOS">
...
<div class="receipt__subtitle changedText" style="color:white !important;">Open Qloud ID App</div>
</div>
</div>
</div></a>
...
<div class="receipt__free" style="margin-bottom:10px;">
<svg class="icon icon-coin">

</svg><span class="changedText">You can download Qloud ID on Appstore or Android marketplace</span>
</div>
				<a class="button receipt__button   hidden" href="QloudidUrl://NDF4cFUxVHZ1T1c4UG5rSWI2bUZVQT09"><span>Shop online</span>
...
<div class="description__wrapper xs-pad0 padrt50 visible-xs">
...
<div class="section travel hidden" style="
    padding-bottom: 80px;
">
...
<div class="travel__slider js-slider-travel slick-initialized slick-slider"><button type="button" class="slick-prev slick-arrow" style=""><svg xmlns="http://www.w3.org/2000/svg" width="14" height="9" fill="none" viewBox="0 0 14 9"><path fill-rule="evenodd" d="M4.909.265a1 1 0 0 0-1.413.057l-3.231 3.5a1 1 0 0 0 0 1.357l3.231 3.5a1 1 0 0 0 1.47-1.357L3.284 5.5H13a1 1 0 1 0 0-2H3.284l1.682-1.822A1 1 0 0 0 4.909.265z" fill="#777e91"></path></svg></button>
<div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 908px;"><div class="travel__gallery slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 454px;position: relative;left: 0px;top: 0px;z-index: 999;opacity: 1;image-rendering: url(https://ui8-fleet-html.herokuapp.com/img/content/travel-pic-1@2x.jpg);" tabindex="0">
<div class="travel__bg"><img srcset="https://ui8-fleet-html.herokuapp.com/img/content/travel-pic-1@2x.jpg 2x" src="img/content/travel-pic-1.jpg 2x" alt="Travel"></div>
<div class="travel__group">
<div class="travel__preview"><img class="some-icon" srcset="img/content/appraisal-pic-1@2x.png 2x" src="img/content/appraisal-pic-1.png" alt="Appraisal"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/appraisal-pic-1@2x.png 2x" src="img/content/appraisal-pic-dark-1.png" alt="Appraisal"></div>
<div class="travel__preview"><img class="some-icon" srcset="img/content/appraisal-pic-1@2x.png 2x" src="img/content/appraisal-pic-1.png" alt="Appraisal"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/appraisal-pic-1@2x.png 2x" src="img/content/appraisal-pic-dark-1.png" alt="Appraisal"></div>
<div class="travel__preview" style="
"><img class="some-icon" src="https://ui8-fleet-html.herokuapp.com/img/content/travel-pic-1@2x.jpg" alt="Appraisal"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/appraisal-pic-1@2x.png 2x" src="img/content/appraisal-pic-dark-1.png" alt="Appraisal"></div>
</div>
</div><div class="travel__gallery slick-slide" data-slick-index="1" aria-hidden="true" style="width: 454px; position: relative; left: -454px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">
