...
<html>
	...
	<div class="clear"></div>
		...
		<!-- NEW BANNER -->
		<div class="column_m pos_rel white_bg marb40 " onclick="closePopup();">
...
">Samtycke</h3>
    ...
    font-family: Avenir;
">Samtyckesplattformen styr du din information och kan dela med dig till din arbetsgivare, skola, bostadsrätt eller de företag och privatpersoner som du vill ska ha tillgång. Du kan när som helst återkalla ett samtycke när du inte längre anser det ligger i dit intresse att dela med dig.</h3></a>
...
<div class="talc padtb20 xs-padt20  ffamily_avenir xxs-nofloat"><a href="#" class="_3S6pHEQs"> </a><a href="#"><input type="button" value="Läs mer" class="forword minhei_55p  fsz18 bg_green_rgb white_txt  ffamily_avenir"></a> </div>
		...
		<div class="hidden mart0 xs-mart50 talc">
			...
			<div class="column_m padb40  xs-padtb10 talc lgn_hight_22 fsz16  lgtgrey2_bg">
				...
				<div class="wrap maxwi_100  xs-padb30  padt0 lgtgrey2_bg  ">
			 		<div class="dflex xs-dblock justc_c alit_c fsz20 xs-fsz18 darkgrey_txt pad30 padrl50 marrl50i xxs-marrl0 xxs-padtb20 brdb_e2e2e2   xs-padrl10i lgtgrey2_bg">
						<div class="wi_25  fsz50 green_txt hidden-xs">
							<img class="block center no-margin-top" src="https://developer.apple.com/assets/elements/icons/testflight/testflight-128x128.png" width="128" height="128" alt="">
						</div>
						<div class="wi_75 xs-wi_100 bs_bb padl40 xs-padrl10i tall">
							
							<h2 class="padb15 bold fsz30 xs-fsz20 black_txt lgn_hight_40">Allt på ett ställe  </h2>
							<div class="textFontApple lgtgrey2_bg">ISamtyckesplattformen styr du din information och kan dela med dig till din arbetsgivare, skola, bostadsrätt eller de företag och privatpersoner som du vill ska ha tillgång. Du kan när som helst återkalla ett samtycke när du inte längre anser det ligger i dit intresse att dela med dig.  </div>
				...
				<div class="dflex xs-dblock justc_c alit_c fsz20 xs-fsz18 darkgrey_txt pad30 padrl50 marrl50i xxs-marrl0 xxs-padtb20 brdb_e2e2e2   xs-padrl10i lgtgrey2_bg">
						...
						<div class="wi_75 xs-wi_100 bs_bb padl40 xs-padrl10i tall">
							...
							<h2 class="padb15 bold fsz30 xs-fsz20 black_txt lgn_hight_40">Skicka och ta emot förfrågan   </h2>
							<div class="textFontApple lgtgrey2_bg">När du är osäker på annan part på nätet, begär samtycke för att få tillgång till motpartens Qloud ID. När någon vill ha tillgång till information om dig, ge samtycke till delning av ditt Qloud ID.  </div>
					...
					<div class="dflex xs-dblock justc_c alit_c fsz20 xs-fsz18 darkgrey_txt pad30 padrl50 marrl50i xxs-marrl0 xxs-padtb20 brdb_e2e2e2   xs-padrl10i lgtgrey2_bg">
						...
						<div class="wi_75 xs-wi_100 bs_bb padl40 xs-padrl10i tall">
							...
							<h2 class="padb15 bold fsz30 xs-fsz20 black_txt lgn_hight_40">Samlade samtycken </h2>
							<div class="textFontApple lgtgrey2_bg">Alla dina skickade, mottagna och godkända förfrågningar om samtycke finns samlade på ett ställe vilket ger dig ditt egna GDPR- anpassade verktyg. Du har en överblick och kan styra till vilka du väljer att dela löpande eller vid enstaka tillfällen.  </div>
					...
					<div class="dflex xs-dblock justc_c alit_c fsz20 xs-fsz18 darkgrey_txt pad30 padrl50 marrl50i xxs-marrl0 xxs-padtb20 brdb_e2e2e2   xs-padrl10i lgtgrey2_bg">
						...
						<div class="wi_75 xs-wi_100 bs_bb padl40 xs-padrl10i tall">
							...
							<h2 class="padb15 bold fsz30 xs-fsz20 black_txt lgn_hight_40">Historik och status   </h2>
							<div class="textFontApple lgtgrey2_bg">Du får statusrapportering på alla dina skickade och mottagna förfrågningar. Du kan följa om en säljande part undvikit att identifiera sig innan köp, eller om du har obesvarade förfrågningar att hantera. </div>
					...
					<div class="dflex xs-dblock justc_c alit_c fsz20 xs-fsz18 darkgrey_txt pad30 padrl50 marrl50i xxs-marrl0 xxs-padtb20 brdb_e2e2e2   xs-padrl10i lgtgrey2_bg">
						...
						<div class="wi_75 xs-wi_100 bs_bb padl40 xs-padrl10i tall">
							...
							<h2 class="padb15 bold fsz30 xs-fsz20 black_txt lgn_hight_40">Begär verifiering   </h2>
							<div class="textFontApple lgtgrey2_bg">När du ska göra en transaktion med en okänd part på nätet kan du be om verifiering. När motparten har verifierat sig (efter samtycke) så kan du försäkra dig om att det är en äkta identitet du handskas med.  </div>
