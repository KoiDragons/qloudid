...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=verify_checkin/2/<?php echo $data['apartment_id']; ?>" class="white_brd brdrad5" style="width: 150px;height: 150px;"></div>
</div>
...
<div class="receipt__free" style="font-size: 15px;">
                  Scan and checkin to your apartment</div>
