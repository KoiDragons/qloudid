...
<body class="dark" style="background: #<?php echo $selectedMarketplaceDetail['bg_color_info']; ?>;">
<script style="
    background: #212B3B;
">
...
<!-- outer content-->
<div class="outer__inner" style="margin-top: 100px;">
...
<h2 class="product__title h2 xs-fsz70 talc   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">DEMO</h2>
...
display:block;">
                    ...
                    <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">This is a demo page for agents to demonstrate</div>
</div></div></div>
 ...
 <div class="work__body" style="padding-bottom:120px;">
              ...
              <div class="work__list">
                <div class="work__item">
                  ...
                  <div class="work__subtitle changedText">Customer App</div>
                  <div class="work__content changedText">We realize ideas from simple to complex, everything becomes easy to use.</div>
				  
				 
				 
				 <a class="button checkout__button changedText mart20" href="https://dstricts.com/public/index.php/BookingInformation/checkedInDetail/bGRHSW1rdXMxRVFkVHl4WUhhdkVtdz09"  >Try it out</a>
                ...
                <div class="work__item">
                  ...
                  <div class="work__subtitle changedText">Home & Guest App</div>
                  <div class="work__content changedText">We realize ideas from simple to complex, everything becomes easy to use.</div>
				    
				   
				   <a class="button checkout__button changedText mart20" href="https://dstricts.com/public/index.php/BookingInformation/checkedInDetail/bHRpWWxsb1pSa2dyR0ZWeHdST3plZz09"  >Try it out</a>
                </div>
                <div class="work__item">
                  ...
                  <div class="work__subtitle changedText">Agency App</div>
                  <div class="work__content changedText">We realize ideas from simple to complex, everything becomes easy to use.</div>
				 
				  
				  
				  <a class="button checkout__button changedText mart20" href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/LoginAccount/emailLogin"  >Try it out</a>
                </div>
              </div>
            </div>
