					...
					<div class="padb0 xxs-padb0 ">		
								...
								<div class="pos_rel">											
									...
									<div class="pos_rel"  >
												...
												<input type="text" name="entry_code" id="entry_code"   class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="pb0p6q"> 
