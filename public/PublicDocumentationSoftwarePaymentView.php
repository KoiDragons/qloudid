...
<a href="#" class="header__item " style="margin-left:10px;"><div class=" header__item_language js-header-item " style="border-left: 0px solid !important; ">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Developer</button>

</div></a>

<a class="button button-stroke button-small header__button    fsz16 visible-xs   changedText" href="https://www.safeqloud.com/public/index.php/ExploreQloudID" style="border:2px solid #333; padding-top:10px;">Start</a>
<a class="button button-stroke button-small header__button fsz16 xxs-mart10 changedText visible-xs" href="https://www.safeqloud.com/public/index.php/CorporateServicesEng" style="margin-top:10px; border:2px solid #333; box-shadow: 0 0 0 0;">Business</a>
<a class="button button-stroke button-small header__button fsz16 xxs-mart10 changedText visible-xs" href="#" style="margin-top:10px; border:2px solid #333; box-shadow: 0 0 0 0;">Developer</a>
			...
			<a class="button button-stroke button-small header__button fsz16 xxs-mart10 changedText" href="https://www.safeqloud.com/user/index.php/LoginAccount/loginapp" style="margin-top:10px; border:2px solid #333; box-shadow: 0 0 0 0;">Sign in</a>
 ...
 <div class="outer__inner" style="margin-top:70px;">
        ...
        <div class="section faq">
          <div class="faq__center center">
            <div class="faq__top xs-tall">
              <div class="faq__stage">learn how to get started</div>
              <h1 class="faq__title h2 fsz60 xs-fsz45">Payment API</h1>
              <div class="faq__info fsz30 xs-fsz25"  >This is a documentation on how you can integrate your software to Qloud ID platform and generate digital ID for your domain <a href="#">Contact Support</a></div>
              <div class="mobile-show">
                 <select class="select  " style="display: none;" onchange="location = this.options[this.selectedIndex].value;">
                  <option value="loginApiInfo">Login</option>
                  <option value="signinApiInfo">Sign in</option>
                  <option value="paymentApiInfo" selected>Payment</option>
            ...
            <div class="faq__row js-tabs">
              <div class="faq__col">
                <div class="faq__nav"><a class="faq__link " href="loginApiInfo" style="font-size:18px;">
                    <svg class="icon icon-home">
                      <use xlink:href="#icon-home"></use>
                    </svg>Login</a>
					<a class="faq__link   " href="signinApiInfo" style="font-size:18px;">
                    <svg class="icon icon-circle-and-square">
                      <use xlink:href="#icon-circle-and-square"></use>
                    </svg>Sign in</a>
					<a class="faq__link js-tabs-link active" href="paymentApiInfo" style="font-size:18px;">
                    <svg class="icon icon-lightning">
                      <use xlink:href="#icon-lightning"></use>
                    </svg>Payment</a>
					<a class="faq__link  " href="../PublicDocumentationSoftware" style="font-size:18px;">
                    <svg class="icon icon-lightning">
                      <use xlink:href="#icon-lightning"></use>
                    </svg>HR</a>
					<a class="faq__link  " href="qloudidAppApiInfo" style="font-size:18px;">
                    <svg class="icon icon-lightning">
                      <use xlink:href="#icon-lightning"></use>
                    </svg>App API</a>
					 </div>
              ...
              <div class="faq__col">
			   <div class="faq__box js-tabs-item" style="display: block;">
                ...
                <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item">
                                      <div class="faq__head">How to connect with payment API</div>
...
<p class="    fsz16" style="font-size:18px; word-wrap: break-word;">First of developer need a user account on Qloudid and he must be a employee of the company on Qloudid for the company he want to generate API URL. Then he needs to go to </p>
 <p class="    fsz16" style="font-size:18px; word-wrap: break-word;">https://www.safeqloud.com/company/index.php/AppsList/appsAccount/"company_id" </p>
...
<li>https://www.safeqloud.com/company/index.php/CreateApps/appsAccount/"company_id" </li>
...
<li>User need to invoice address for purchased items after selecting delivery address</li>
...
</li><li> As soon as access tokan is received on qmatchup side they need to send the same to https://www.safeqloud.com/walk/resource_purchase.php?purchase=1 using curl request</li>
...
<li>This is two way handshaking process used on Qmatchup and Qloudid domain. So they can verify user login securely. Other domains using our API can work as per their requirement they can use two way handshaking or can make user logged in directly after receiving data from Qloudid.</li>
 ...
 {"user":"0","card_number":"414....","card_cvv":"111","exp_month":"10","exp_year":"20**",
 "name_on_card":"XYZ","company":"0","name_on_house":"XYZ","address":"abc","city":"abc",
 "zipcode":"12****","port_number":"1**","customer_id":"cu****","transection_id":"tran****"}</li>
 
 <li>Here if user is 0 then this provide info that user have purchased this for himself, if user value is one then purchase is done for company.  </li>
 <li class="last">Here if company is 0 then this provide info that invoice will be sent to user and card is also used from user for purchase, Here if company is 1 then this provide info that invoice will be sent to company and card is also used from company for purchase.  </li>
