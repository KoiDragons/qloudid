			...
			if(document.getElementById('file1').value != '')
				{
						...
						{
							$("#errorMsg1").html("File size should not be more than 10Mb.");
							return false;
				...
				{
					$("#errorMsg1").html('Please select file !');
					return false;
				}
...
<div class="checkout__list">
 ...
 <div class="upload__head" style="margin-bottom:0px;">
                  <h2 class="upload__title h2 changedText">Upload</h2>  
				  
                </div>
				<div class="browse__info info changedText padb40" style="border-bottom: 2px solid #353945;">Please upload your file so we can create your profile</div>
<form action="uploadFileDetails" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" enctype="multipart/form-data">
 
  
						 
  
 
							<div class="upload__item mart40" style="margin-bottom:24px;">
                      <div class="upload__category changedText">Upload file</div>
                      ...
                      <div class="upload__file upload__filer"  style="  background-image: ../../usercontent/images/default-profile-pic.jpg;" >
                        <input class="upload__input" type="file" name="file1" id="file1"  >
                        <div class="upload__icon">
                          <svg class="icon icon-upload-file">
                            <use xlink:href="#icon-upload-file"></use>
                          </svg>
                        </div>
                        <div class="upload__format">Max 10Mb.</div>
                      </div>
                    </div>
