...
<a href="#" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="#" class="header__item " s=""><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Start</button>
		...
		<div class="header__item header__item_notification js-header-item">
		  ...
		  <div class="header__item header__item_user js-header-item" style="display:block;">
            <button class="header__head js-header-head" fdprocessedid="0sxouf" style="margin-right:0px;"><a class="header__login js-popup-open" href="#" data-effect="mfp-zoom-in" style="display:block; background:#f67f00; margin-left:0px;">
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
                <div class="header__menu"><a class="header__link" href="#">
                    ...
                    </svg><span class="changedText">Setup</span></a><a class="header__link" href="#">
                    <svg class="icon icon-home">
                      <use xlink:href="#icon-home"></use>
                    </svg><span class="changedText">Integration</span></a>
				...
				<a class="header__link" href="#">
                    ...
                    </svg><span class="changedText">List your property</span></a><a class="header__link" href="#">
                    <svg class="icon icon-flag">
                      <use xlink:href="#icon-flag"></use>
                    </svg><span class="changedText">Host an experience</span></a></div>
              </div>
              <div class="header__btns"> 
			  <a class="button-stroke button-small header__button changedText" href="#" style="background: #3B71FE; box-shadow: none;">Account</a>
                <a href="#" class="button-stroke button-small header__button changedText">Log out</a>
              </div>
            </div>
          </div>
...
<div class="outer__inner">
  <div class="section travel" style="margin-top: 50px;">
...
<div class="travel__subtitle fsz60 lgn_hight_65 xs-fsz40 xs-lgn_hight_45 xs-talc" style="
    
    margin-bottom: 10px;
    
    font-weight: 100;
    color: #fff;
">Master Spanish Off-Plan Market</div>
 
<div class="travel__content fsz30 lgn_hight_40 xs-fsz25 xs-lgn_hight_35 xs-talc" style="
    font-size: 30px;
    color: #777E90;
    
">The Ultimate Broker's Platform!</div>
</div>
</div>
<a class="header__logo xs-fsz20 hidden-xs" href="#" style="
...
<div class="travel__preview"><img class="some-icon" srcset="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-1@2x.png 2x" src="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-1.png" alt="Appraisal"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/appraisal-pic-1@2x.png" src="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-dark-1.png" alt="Appraisal"></div>
  ...
  <div class="travel__center center   padb136 hidden-xxs">
   
   <div class="travel__row " >
      <div class="travel__col" style="padding-right: 0px; max-width:595px;">
         <div class="travel__list" style="
            max-width: 450px; 
            ">
            <div class="travel__item">
               
               <div class="travel__subtitle" style="
                  line-height: 1.1; font-size: 40px;
                  ">Network with Certified Brokers and Spain's Developers
</div>
               <div class="travel__content" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Join the largest network of brokers and developers at Developer Hub, where innovation meets opportunity.
      ...
      <div class="travel__col" style="padding-right: 0px; width:525px;">
         <div class="travel__wrapper">
            <div class="travel__col" style="padding-right: 0px;">
               <div class="travel__wrapper">
                  <a class="browse__card marrl8" href="#" style="width: 525px;padding: 24px;">
                     <div class="browse__preview" style="/* height: 370px; */border-radius: 12px;margin-bottom: 0px;   "><img srcset="https://www.safeqloud.com/html/usercontent/images/dstricts/1.avif" src="https://www.safeqloud.com/html/usercontent/images/dstricts/1.avif" alt="Card" style=" height:auto;">
                     </div>
                  </a>
               </div>
            </div>
    ...
    <div class="travel__col" style="padding-right: 0px; width:525px;">
         <div class="travel__wrapper">
            <div class="travel__col" style="padding-right: 0px;">
               <div class="travel__wrapper">
                  <a class="browse__card marrl8" href="#" style="width: 525px;padding: 24px;">
                     <div class="browse__preview" style="/* height: 370px; */border-radius: 12px;margin-bottom: 0px;   "><img srcset="https://www.safeqloud.com/html/usercontent/images/dstricts/2.avif" src="https://www.safeqloud.com/html/usercontent/images/dstricts/2.avif" alt="Card" style=" height:auto;">
                     </div>
                  </a>
               </div>
            </div>
         ...
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               ...
               <div class="travel__content" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Browse a photo carousel of our platform to see how we can help you manage projects, seize new opportunities, and boost sales.
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:595px;">
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               ...
               <div class="travel__subtitle" style="
                  line-height: 1.1; font-size: 40px;
                  ">Connecting Brokers Worldwide with Spain's Developers
</div>
               <div class="travel__content" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Are you a broker looking to sell off-plan properties in Spain online? Our platform helps you streamline the process. Developer Hub provides all current information from Spanish developers about off-plan projects in one place. Increase your sales, download materials for clients, ensure commission transparency, book showrooms, and access marketing materials. Join today. It's free.
      ...
      <div class="travel__col" style="padding-right: 0px; width:525px;">
         <div class="travel__wrapper">
            <div class="travel__col" style="padding-right: 0px;">
               <div class="travel__wrapper">
                  <a class="browse__card marrl8" href="#" style="width: 525px;padding: 24px;">
                     <div class="browse__preview" style="/* height: 370px; */border-radius: 12px;margin-bottom: 0px;   "><img srcset="https://www.safeqloud.com/html/usercontent/images/dstricts/3.avif" src="https://www.safeqloud.com/html/usercontent/images/dstricts/3.avif" alt="Card" style=" height:auto;">
                     </div>
                  </a>
               </div>
            </div>
          ...
          <div class="flights__center center xs-padrl25">
           ...
           <div class="sorting" style="margin-bottom:0px;">
            <div class="sorting__center ">
              ...
              <div class="sorting" style="margin-bottom:0px; ">
<div class="sorting__center center" style="padding:0px;">
<div class="product__head xs-mart65 mart100" style=" margin-bottom:0px;">
<div class="product__box  " style=" margin-top:0px;">
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">Why Dev Hub Excels for Real Estate Developers</span>  </h2>
...
<div class="travel__center center   padb136 hidden-xxs">
   ...
   <div class="travel__row " >
      <div class="travel__col" style="padding-right: 0px; width:70%;">
<div class="section flights">
          <div class="flights__center center xs-padrl25" style="padding-left:0px;">
		  
          
            <div class="checkout__inner js-tabs" style="padding-right:0px;/* padding-left: 200px; */">
<div class="section brands xsi-mart60" style="
    /* margin-top: 60px; */
">
...
<div class="brands__list" style="display:flex;">
		...
		<div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Instant notification of global brokers about project news

</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				  ...
				  <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Comprehensive database of projects and competitors in Spain
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Integration with project management systems

</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
                  </svg></div></a></div>
				  
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Targeted advertising campaigns
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
				    ...
				    <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Reduced marketing costs
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Online platform for booking and selling projects
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
				  	   ...
				  	   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Tools for resellers</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
				    	   ...
				    	   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">No additional commissions</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
				    ...
				    <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Professional brokers and agencies with certification</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				  ...
				  <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Broker Application Management</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				  ...
				  <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Showroom Bookings</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
...
<div class="travel__col" style="padding-right: 0px; width:30%;">
         <div class="travel__wrapper">
            <div class="travel__col" style="padding-right: 0px;">
               <div class="travel__wrapper">
                  <a class="browse__card marrl8" href="#" style="width: 525px;padding: 24px;">
                     <div class="browse__preview" style="/* height: 370px; */border-radius: 12px;margin-bottom: 0px;   "><img srcset="https://www.safeqloud.com/html/usercontent/images/dstricts/4.avif" src="https://www.safeqloud.com/html/usercontent/images/dstricts/4.avif" alt="Card" style=" height:auto;">
                     </div>
                  </a>
               </div>
            </div>
 ...
 <div class="section faq">
          <div class="faq__center center">
            <div class="faq__top">
              ...
              <h1 class="faq__title h2">Key Benefits of Developer Hub for Spanish Developers</h1>
              ...
              <div class="faq__col" style="width:100%; padding-left:0px;">
                <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item"  >
                                      <div class="faq__head">Localized Insights</div>
                                      <div class="faq__body" id='1'>
                                        <div class="faq__content">Developer Hub offers tailored information and data specific to the Spanish real estate market, enabling developers to make informed decisions based on current trends and regional dynamics.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Global Networking Opportunities</div>
                                      <div class="faq__body">
                                        <div class="faq__content">The platform connects Spanish developers with brokers worldwide, expanding their market reach and opening up international collaboration and investment opportunities.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Streamlined Project Management</div>
                                      <div class="faq__body">
                                        <div class="faq__content">Integrating with various project management systems, Developer Hub simplifies the process of managing real estate projects from start to finish, ensuring efficiency and reducing overhead costs.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Access to Cutting-Edge Tools</div>
                                      <div class="faq__body">
                                        <div class="faq__content">Developer Hub provides advanced tools designed for the real estate industry, including CRM systems, marketing tools, and analytics platforms that are specifically tailored to enhance the operations of developers.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Effective Marketing Strategies</div>
                                      <div class="faq__body">
                                        <div class="faq__content">With targeted advertising campaigns and promotional strategies, developers can effectively market their projects to the right audience, increasing sales and visibility.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                 
                                    <div class="faq__item">
                                      <div class="faq__head">Certified Professional Network</div>
                                      <div class="faq__body">
                                        <div class="faq__content">The platform ensures that all brokers and agencies are certified, providing a trustworthy and professional network for developers to engage with.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Cost Efficiency</div>
                                      <div class="faq__body">
                                        <div class="faq__content">By reducing marketing costs and eliminating additional commissions, Developer Hub makes it more economical for developers to manage their properties and increase their profit margins.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Real-Time Updates</div>
                                      <div class="faq__body">
                                        <div class="faq__content">Instant notifications about global market changes, new projects, and updates ensure that developers are always equipped with the most current information, giving them a competitive edge.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Ease of Use</div>
                                      <div class="faq__body">
                                        <div class="faq__content">Developer Hub is known for its user-friendly interface, making it accessible for developers of all technological skill levels to effectively use the platform.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head">Support and Community</div>
                                      <div class="faq__body">
                                        <div class="faq__content">The platform not only provides technical support but also fosters a community through features like the WhatsApp group, where developers can exchange ideas, seek advice, and share experiences.</div>
                                        <button class="button-stroke button-small faq__button">Learn more</button>
                                      </div>
                                    </div>
                                    <div class="faq__item">
