	...
	function submitForm()
{
			...
			<div class="s-intro__content-bottom">
                    ...
                    <div class="s-intro__content-bottom-block" style="padding-left:10px;">
                       <h5 class="bold" style="font-weight:bold; color:white;"><?php echo $selectedMarketplaceDetail['subheading_info']; ?></h5>
                        ...
                        <div class="counter">
						<a href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/selectLocation/<?php echo $data['domain_id']; ?>">  <div class="counter__time " style="padding-right:30px;">
    ...
    color: var(--color-btn-stroke-text); padding: 5px 3.6rem; display: flex;
											...
											color: white; margin-left:0px;">Start here</span>
...
<div class="s-intro__notify">
 	  <a href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/howItWorks/<?php echo $data['domain_id']; ?>">   <button type="button" class="btn--stroke btn--small" fdprocessedid="0adb7c" style="padding:0px 20px; 0px;">
			 ...
			 <a href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/brokers/<?php echo $data['domain_id']; ?>">   <button type="button" class="btn--stroke btn--small" fdprocessedid="0adb7c" style="padding:0px 20px; 0px;">
            ...
            <div class="column">
                        ...
                        <div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title">We match you with the right broker</h4>
                                    <p>
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title">Transparent information</h4>
                                    <p>
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title">Sellers' favourites</h4>
                                    <p>
                        ...
                        <div class="row">
                            <div class="column">
                                ...
                                <p class="tab-content__item-bottom">
                                    <a href="mailto:#0" class="contact-email">hello@findabroker.com</a>
                                    <span class="contact-number"> 
                                        <a href="tel:34 603 14 72 90">+34 603 14 72 90 </a> 
                                        <span>/</span>
                                        <a href="tel:+1 646 96 07 257">+1 646 96 07 257</a>
                                    </span>
                                </p>
                ...
                <footer>
                    <div class="ss-copyright">
                        <span>© Copyright Find A Broker 2023</span> 
                        <span>Design by <a href="javascript:void(0);">Find A Broker</a></span>
                    </div>
                </footer>
