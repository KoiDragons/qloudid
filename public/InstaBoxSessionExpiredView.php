		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
						 ...
						 <img src="https://media.giphy.com/media/3oz8xKaR836UJOYeOc/giphy.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
						 
							</div>
							 
							<div class="padb20 xxs-padb0  ">		
							
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir">Session expired</h1>
									</div>
							...
							<a href="../welcome/<?php echo $data['hid']; ?>">	<button type="button" name="forward" class="forword minhei_55p t_67cff7_bg fsz18">Close</button></a>
