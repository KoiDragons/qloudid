...
<div class="outer">
<!-- header-->
<header class="header js-header authorization xs-padt24" style="
    box-shadow: inset 0 -1px 0 0 #e6e8ec;
">
<div class="header__center center"><a class="header__logo xs-fsz20 " href="../../listRequests/<?php echo $serviceBidsInfo['uid']; ?>" style="background-color: #c12219 !important; padding: 10px;
    color: white;
    border-radius: 5px;
    ...
    line-height:25px !important">Back</a>
		...
		<div class="header__wrapper js-header-wrapper" style="padding-left:0px;">
...
<h2 class="checkout__title h2 changedText" style="
...
<h2 class="checkout__title h2 changedText" style="
    font-size: 25px;
    font-weight: normal;
">Call supplier and arrange a meeting</h2>
<div class="checkout__list">
<div class="checkout__section">
<div class="checkout__box">
<div class="checkout__category changedText">Supplier phone</div>
<div class="checkout__data checkout__data_flex">
<div class="checkout__el" style="
    flex: 0 0 calc(40% - 16px);
    width: calc(40% - 16px);
">
<div class="checkout__datepicker" style="
    background: #ffdae1;
">
<div class="checkout__label changedText">Country</div>
<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $serviceBidsInfo['country_name']; ?>" fdprocessedid="3wftzc">
...
<div class="travelers__top" style="
    background: #ffdae1;
">
<div class="travelers__label changedText">Phone</div>
<div class="travelers__value js-travelers-content"><?php echo $serviceBidsInfo['phone']; ?></div>
...
<div class="checkout__category changedText">Clients location</div>
...
<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $userSummary['name']; ?>">
<div class="checkout__controls">
...
<div class="date-picker-wrapper no-shortcuts  no-topbar no-gap single-month" unselectable="on" style="display: none; top: 56px; left: 16px; user-select: none;"><div class="month-wrapper"><table class="month1" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th><span class="prev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M14.207 7.793a1 1 0 0 1 0 1.414L11.414 12l2.793 2.793a1 1 0 0 1-1.414 1.414l-3.5-3.5a1 1 0 0 1 0-1.414l3.5-3.5a1 1 0 0 1 1.414 0z" fill="#777e91"></path></svg></span></th><th colspan="5" class="month-name"><div class="month-element">june</div><div class="month-element">2023</div></th><th><span class="next"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.793 7.793a1 1 0 0 0 0 1.414L12.586 12l-2.793 2.793a1 1 0 0 0 1.414 1.414l3.5-3.5a1 1 0 0 0 0-1.414l-3.5-3.5a1 1 0 0 0-1.414 0z" fill="#777e91"></path></svg></span></th></tr><tr class="week-name"><th>su</th><th>mo</th><th>tu</th><th>we</th><th>th</th><th>fr</th><th>sa</th></tr></thead><tbody><tr><td><div time="1685272763223" data-tooltip="" class="day lastMonth  valid ">28</div></td><td><div time="1685359163223" data-tooltip="" class="day lastMonth  valid ">29</div></td><td><div time="1685445563223" data-tooltip="" class="day lastMonth  valid ">30</div></td><td><div time="1685531963223" data-tooltip="" class="day lastMonth  valid ">31</div></td><td><div time="1685618363223" data-tooltip="" class="day toMonth  valid ">1</div></td><td><div time="1685704763223" data-tooltip="" class="day toMonth  valid ">2</div></td><td><div time="1685791163223" data-tooltip="" class="day toMonth  valid ">3</div></td></tr><tr><td><div time="1685877563223" data-tooltip="" class="day toMonth  valid ">4</div></td><td><div time="1685963963223" data-tooltip="" class="day toMonth  valid ">5</div></td><td><div time="1686050363223" data-tooltip="" class="day toMonth  valid ">6</div></td><td><div time="1686136763223" data-tooltip="" class="day toMonth  valid ">7</div></td><td><div time="1686223163223" data-tooltip="" class="day toMonth  valid ">8</div></td><td><div time="1686309563223" data-tooltip="" class="day toMonth  valid real-today">9</div></td><td><div time="1686395963223" data-tooltip="" class="day toMonth  valid ">10</div></td></tr><tr><td><div time="1686482363223" data-tooltip="" class="day toMonth  valid ">11</div></td><td><div time="1686568763223" data-tooltip="" class="day toMonth  valid ">12</div></td><td><div time="1686655163223" data-tooltip="" class="day toMonth  valid ">13</div></td><td><div time="1686741563223" data-tooltip="" class="day toMonth  valid ">14</div></td><td><div time="1686827963223" data-tooltip="" class="day toMonth  valid ">15</div></td><td><div time="1686914363223" data-tooltip="" class="day toMonth  valid ">16</div></td><td><div time="1687000763223" data-tooltip="" class="day toMonth  valid ">17</div></td></tr><tr><td><div time="1687087163223" data-tooltip="" class="day toMonth  valid ">18</div></td><td><div time="1687173563223" data-tooltip="" class="day toMonth  valid ">19</div></td><td><div time="1687259963223" data-tooltip="" class="day toMonth  valid ">20</div></td><td><div time="1687346363223" data-tooltip="" class="day toMonth  valid ">21</div></td><td><div time="1687432763223" data-tooltip="" class="day toMonth  valid ">22</div></td><td><div time="1687519163223" data-tooltip="" class="day toMonth  valid ">23</div></td><td><div time="1687605563223" data-tooltip="" class="day toMonth  valid ">24</div></td></tr><tr><td><div time="1687691963223" data-tooltip="" class="day toMonth  valid ">25</div></td><td><div time="1687778363223" data-tooltip="" class="day toMonth  valid ">26</div></td><td><div time="1687864763223" data-tooltip="" class="day toMonth  valid ">27</div></td><td><div time="1687951163223" data-tooltip="" class="day toMonth  valid ">28</div></td><td><div time="1688037563223" data-tooltip="" class="day toMonth  valid ">29</div></td><td><div time="1688123963223" data-tooltip="" class="day toMonth  valid ">30</div></td><td><div time="1688210363223" data-tooltip="" class="day nextMonth  valid ">1</div></td></tr></tbody></table><div class="dp-clearfix"></div><div class="time"><div class="time1"></div><div class="time2"></div></div><div class="dp-clearfix"></div></div><div class="footer"></div><div class="date-range-length-tip"></div></div></div>
</div>
...
<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $userSummary['address']; ?>">
...
<div class="travelers__label changedText">Port</div>
<div class="travelers__value js-travelers-content"><?php echo $userSummary['port_number']; ?></div>
...
<input class="js-counter-input js-counter-result js-counter-adults" type="hidden" value="1">
</div>
</div>
<div class="travelers__item">
<div class="travelers__details">
...
</div><div class="checkout__data checkout__data_flex">
<div class="checkout__el" style="
    flex: 0 0 calc(30% - 16px);
    width: calc(30% - 16px);
">
<div class="checkout__datepicker">
<div class="checkout__label changedText">Zip code</div>
<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $userSummary['zipcode']; ?>">
...
<div class="travelers travelers_down js-travelers">
<div class="travelers__top">
<div class="travelers__label changedText">City</div>
<div class="travelers__value js-travelers-content"><?php echo $userSummary['city']; ?></div>
...
<div class="checkout__datepicker">
<div class="checkout__label changedText">Country</div>
<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $userSummary['country_name']; ?>">
...
<div class="price__title"><?php echo $serviceBidsInfo['company_name']; ?></div>
<div class="price__author">
<div class="price__text"><?php echo $serviceBidsInfo['c_address']; ?></div>


</div>
<div class="price__parameters">
<div class="price__parameter">xxx xx</div>
<div class="price__parameter"><?php if($serviceBidsInfo['c_city']=='' || $serviceBidsInfo['c_city']==null) echo $serviceBidsInfo['country_name']; else echo $serviceBidsInfo['c_city']; ?></div>
</div>
...
<div class="price__category changedText">Phone</div>
<div class="price__subtitle" style="
    color: white;
">+<?php echo $serviceBidsInfo['country_code']; ?> <?php echo $serviceBidsInfo['phone']; ?></div>
</div>
</div>
...
<div class="price__box">
<div class="price__category changedText">Email</div>
<div class="price__subtitle" style="
    color: white;
"><?php echo $serviceBidsInfo['company_email']; ?></div>
</div>
</div>
</div>
<div class="price__body">
<div class="price__stage changedText">Service</div>
<div class="price__table">
<div class="price__row">
<div class="price__cell"><?php echo $serviceBidsInfo['subcategory_name']; ?></div>
<div class="price__cell">$<?php echo $serviceBidsInfo['project_fee']; ?></div>
</div>
 
<div class="price__row">
<div class="price__cell changedText">Total (USD)</div>
<div class="price__cell">$<?php echo $serviceBidsInfo['project_fee']; ?></div>
</div>
</div>
</div>
