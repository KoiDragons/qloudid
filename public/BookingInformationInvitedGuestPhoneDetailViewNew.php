...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Check-in</h2>
<div class="browse__info info xs-fsz25 changedText">Please verify your check-in details</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Verify</div>
...
<div class="checkout__section " style="margin-top:10px;   padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../addPhoneAccountInformation/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
  
                      <div class="checkout__fieldset mart30">
    ...
    color: grey; border-radius: 12px;
      background: #23262F; max-width:100%;" fdprocessedid="v23gst" disabled>
	  ...
	  <?php foreach($countryCode as $category =>$value){ ?>													
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="p_number" id="p_number" value="<?php echo $adultInvitationDetail['phone_number']; ?>"  readonly  style="background:#23262F; color:grey;" fdprocessedid="cqhzif">
                            </div>
                          </div>
                        </div>
						<div class="field">
                            <div class="field__label changedText" style="color:#787f91;">Do you want to add tenant information?</div>
                            <div class="field__wrap">
                             <select class=""   id="tenant_available" name="tenant_available" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
...
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="submitform();">Continue</a>
</form>
 </div>
</div>
</div>
