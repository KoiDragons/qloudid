...
<a class="button button-stroke button-small header__button    fsz16 visible-xs hidden changedText" href="#" style="border:2px solid #333; padding-top:10px;">Vacant position</a>
			...
			<a class="button button-stroke button-small header__button fsz16 xxs-mart10 changedText" href="https://www.safeqloud.com/user/index.php/LoginAccount/loginapp" style=" border:2px solid #333; box-shadow: 0 0 0 0;">Sign in</a>
        ...
        <div class="section faq">
          <div class="faq__center center">
            <div class="faq__top">
              ...
              <h1 class="faq__title h2 ">Sign Agreement API</h1>
              <div class="faq__info" style="font-size:20px;">This is a documentation on how you can integrate your software to Qloud ID platform and generate digital ID for your domain</div>
              <div class="mobile-show">
                <select class="select " style="display: none;" onchange="location = this.options[this.selectedIndex].value;">
                  ...
                  <option value="signinApiInfo" selected>Sign in</option>
            ...
            <div class="faq__row js-tabs">
              <div class="faq__col">
                <div class="faq__nav"><a class="faq__link " href="loginApiInfo" style="font-size:18px;">
					...
					<a class="faq__link  " href="paymentApiInfo" style="font-size:18px;">
              ...
              <div class="faq__col">
			   <div class="faq__box js-tabs-item" style="display: block;">
                ...
                <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item">
                                      <div class="faq__head">How to connect with sign in API</div>
...
<li>Here he can select which API URL he wants to generate. App name here must be unique i.e. not used by other user or company. Redirect URL is the one where developer wants to redirect after sign in that he have selected will be completed.</li>
...
<li>When a user want to signin on their web using Qloud ID they click on sign in button. Here user need to provide the API generated for the sign in work</li>
<li>https://www.safeqloud.com/walk/authorize.php?response_type=code&amp;client_id='.$client_id.'&amp;state=xyz&amp;signin=1</li>
<li>On this link user need to add client id</li>
<li>User need to scan the QR code by api on this page and provide his consent for the sign in</li>
 
<li>After successful submission of consent user is redirected to added URL</li>
<li>On qmathup for now we are redirecting on : https://www.qmatchup.com/applyjob/SignInDemo.php </li>
...
</li><li> As soon as access tokan is received on qmatchup side they need to send the same to https://www.safeqloud.com/walk/resource_signin.php?signin=1 using curl request</li>
...
<li>This is two way handshaking process used on Qmatchup and Qloudid domain. So they can verify user login securely. Other domains using our API can work as per their requirement they can use two way handshaking or can make user logged in directly after receiving data from Qloudid.</li>
 ...
 {"type":"signin","first_name":"Ram","last_name":"kumar","email":"x@x.com",
 "country_of_residence":"100","seller_company_id":1, "user":1}</li>
  
<li class="last">Note:- Sign in API is in demo mode for now from Qmatchup to test the API we use url:  https://www.qmatchup.com/applyjob/SignInDemo.php</li>
 </ul>
