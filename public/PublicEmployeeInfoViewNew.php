...
</svg>Save to Flipbook
</a>
<a class="header__link  " href="../listQuardInformation/<?php echo $data['eid']; ?>" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Flibook directory</a>

<a class="header__link  " href="#" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Flip-Book Colleagues
</a>
</div>
</div>
</div>
	...
	<div class="header__item header__item_dropdown js-header-item hidden-xs">
              ...
              <div class="header__body js-header-body" style="z-index:1;">
                <div class="header__menu"> 
                    ...
                    <svg class="icon icon-home">
                      <use xlink:href="#icon-home"></use>
                    </svg>Save to Flipbook</a>
					<a class="header__link" href="../listQuardInformation/<?php echo $data['eid']; ?>">
                    <svg class="icon icon-email">
                      <use xlink:href="#icon-email"></use>
                    </svg>Flibook directory</a>
					<a class="header__link" href="#">
...
<div class="travel__col padr100 xs-padr0 hidden-xs" style="margin-bottom: 20px;">
