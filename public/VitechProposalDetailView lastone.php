...
">
                <div class="description__parameter  hidden-xs">
                  ...
                  </svg><?php echo date('d',$displayProposalProperties[0]['checkin_date']).' - '.date('M d',$displayProposalProperties[0]['checkout_date']); ?></div>
                <div class="description__parameter  xs-marl0">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo ($displayProposalProperties[0]['adult_guest']+$displayProposalProperties[0]['adult_child']); ?> guests</div>
...
<div class="upload__wrapper  "  style="padding-right:0px;">
   ...
   <div class="flights__container" style="padding-left:0px;">
    ...
    margin-bottom: 0px;
">
                   <a href="../propertyInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:25px; color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                        <div class="card__price" style="color:#f67f00; box-shadow: inset 0 0 0 2px #f67f00;">
                        <div class="card__old hidden">$<?php echo $value['broker_price_per_night']*(($value['checkout_date']-$value['checkin_date'])/86400); ?></div>
                        <div class="card__actual ">$<?php echo $value['broker_price_per_night']*(($value['checkout_date']-$value['checkin_date'])/86400); ?></div>
                      </div>
                    </div>
...
">
                ...
                <div class="description__parameter  hidden-xs">
                  <svg class="icon icon-flag">
                    ...
                    <div class="card__foot" style=" border-bottom: 1px solid #23262f;  ">
					
                      <div class="card__comment hidden" style=" border-bottom: 1px solid #23262f;    padding-bottom: 20px;">
...
">
 <?php  echo $value['longSellingDescription']; ?> </div>
					   ...
					   <div class="receipt__description receipt__description_flex" style="  margin-bottom: 20px; background: #23262F; border-radius:16px;">
                ...
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle" style="font-size:16px;"><?php echo ($value['adult_guest']+$value['adult_child']); ?> guests</div>
                  </div>
                </div>
              </div>
		   ...
		   <div class="card__foot" style="">
				...
				<a href="../propertyInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;">  <button class="button-stroke button-small faq__button changedText fright" fdprocessedid="w46jts" style="margin-top:0px; padding:0px 20px;">View</button></a>
		  </div>
