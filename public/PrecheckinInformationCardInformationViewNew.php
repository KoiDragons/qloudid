...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Payment</h2>
<div class="browse__info info xs-fsz25 changedText">Please provide payment information below</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Card information</div>
...
<form class="checkout__item js-tabs-item" action="../updateUserPaymentInfo/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
					   ...
					   <div class="checkout__subtitle">Card</div>
                       
                      </div>
                      <div class="checkout__fieldset">
                        <div class="field">
                            <div class="field__label" style="color:#787f91;">Name on card</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="name_on_card" id="name_on_card" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="card_number" id="card_number" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                       ...
                       <div class="checkout__row margin-bottom32">
						...
						<div class="field">
                            <div class="field__label" style="color:#787f91;">CVV</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="cvv_number" id="cvv_number" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
