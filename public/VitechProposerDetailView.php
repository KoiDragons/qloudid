			...
			<div class="s-intro__content-bottom" style="margin-top:30px;">
                    ...
                    <div class="s-intro__content-bottom-block" style="padding-left:10px;">
                       <h5 class="bold" style="font-weight:normal; font-size:30px; color:white; margin-bottom:30px;">Handpicked Rentals for an Unforgettable Stay</h5>
                        ...
                        <div class="counter">
						<a href="https://www.safeqloud.com/public/index.php/VitechProperties/proposalInformation/<?php echo $data['proposal_id']; ?>">  <div class="counter__time " style="padding-right:30px;">
            ...
            <div class="column">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-about" class="tab-content__item" role="tabpanel" aria-hidden="false" aria-labelledby="tab-link-0" data-tab-active="">
                        ...
                        <div class="row">
                            <div class="column">
                               ...
                               Discovering a broker may seem simple; you likely have a handful in mind from your local area. Perhaps a family member or friend has suggested one they trust. Yet, discerning which broker possesses the precise expertise for your needs can be challenging. Enter Find-A-Broker, your solution to this dilemma. </p>
								<p style="color:#777E90;">The choice of broker can make a big difference to the outcome of your housing transaction and we know that it can feel difficult to choose the right one. That is precisely why we exist, Findabroker. We collect information about all of Spain's registered brokers and their housing sales so that you can easily get started with your sales and make the right decision in the housing market.</p>
								<p style="color:#777E90;">Best of all, you don't have to do the comparison yourself, because with the help of our free matching service, we can help you all the way. You fill in a few simple details about your home and then we match you with the best realtors in your area, using data on home sales from Booli and reviews from previous sellers. </p>
                                <div class="row" style="display:none;">
                                    <div class="column lg-6 tab-12">
                                        <h4 style="color:#777E90;">More About Us.</h4>
                                    ...
                                    <div class="column lg-6 tab-12">
                                        <h4 style="color:#777E90;">Need Web Hosting?</h4>
                                        <p style="color:#777E90;">
                                        ...
                                        <a href="https://www.dreamhost.com/r.cgi?287326" class="btn btn--stroke u-fullwidth" style="color:#777E90;">Get Started Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tab-services" class="tab-content__item" role="tabpanel" aria-hidden="true" aria-labelledby="tab-link-1">
                        ...
                        <div class="row">
                            <div class="column">
							 <p class="lead" style="color:#777E90;">
                               Since 2023, Find-A-Broker has helped tthousands of home sellers in choosing a broker. We find the local brokers who best match your sales. Completely free of charge of course
                                </p>
                                <p style="color:#777E90;">
                               We are part of TXP safe and simple services for buying, selling or living.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">We match you with the right broker</h4>
                                    <p style="color:#777E90;">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Transparent information</h4>
                                    <p style="color:#777E90;">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Sellers' favourites</h4>
                                    <p style="color:#777E90;">
                            ...
                            <div class="column services-list__item" style="display:none;">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:#777E90;">Product Strategy</h4>
                                    <p style="color:#777E90;">
                            ...
                            <div class="column services-list__item" style="display:none;">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:#777E90;">UI/UX Design</h4>
                                    <p style="color:#777E90;">
                                    Sit ut cum molestiae. Dolore ducimus qui quasi. Fugiat consequatur sit vel illum vel et 
                                    a delectus. Vel sequi vitae voluptatem perspiciatis eligendi. Voluptatibus optio natus 
                                    asperiores est commodi amet quia architecto. Dolores necessitatibus et.
                            ...
                            <div class="column services-list__item" style="display:none;">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:#777E90;">E-Commerce</h4>
                                    <p style="color:#777E90;">
                                    Sit ut cum molestiae. Dolore ducimus qui quasi. Fugiat consequatur sit vel illum vel et 
                                    a delectus. Vel sequi vitae voluptatem perspiciatis eligendi. Voluptatibus optio natus 
                                    asperiores est commodi amet quia architecto. Dolores necessitatibus et.
                    ...
                    <div id="tab-contact" class="tab-content__item" role="tabpanel" aria-hidden="true" aria-labelledby="tab-link-2">
                        ...
                        <div class="row">
                            <div class="column">
                                ...
                                <p class="lead" style="color:#777E90;">
                                If you have any questions or queries a member of the staff will always be happy to help. Feel free to contact us by telephone or email and we will be sure to get back to you as soon&nbsp;as&nbsp;possible.
                                </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="column lg-6 tab-12">
                                        ...
                                        <ul class="link-list">
                                            <li><a href="#0" style="color:#777E90;">Facebook</a></li>
                                            <li><a href="#0" style="color:#777E90;">Twitter</a></li>
                                            <li><a href="#0" style="color:#777E90;">Instagram</a></li>
                                        </ul>
                                ...
                                <p class="tab-content__item-bottom">
                                    ...
                                    <span class="contact-number"> 
                                        <a href="tel:34 603 14 72 90" style="color:#777E90;">+34 603 14 72 90 </a> 
                                        <span>/</span>
                                        <a href="tel:+1 646 96 07 257" style="color:#777E90;">+1 646 96 07 257</a>
                                    </span>
                                </p>
                ...
                <footer>
                    <div class="ss-copyright">
                        <span style="color:#777E90;">© Copyright Find A Broker 2023</span> 
                        <span style="color:#777E90;">Design by <a href="javascript:void(0);" style="color:#777E90;">Find A Broker</a></span>
                    </div>
                </footer>
