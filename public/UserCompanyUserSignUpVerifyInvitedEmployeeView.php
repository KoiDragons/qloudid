...
<script>
 var emcode='<?php echo $invitationVerifyUserDetail['email_otp']; ?>';
 var phcode='<?php echo $invitationVerifyUserDetail['phone_otp']; ?>';
 //var uniqueID='<?php echo $invitationDetail['unique_id']; ?>';
	    function submitform()
		{
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Confirm your email and phone number</div>
...
<?php if(isset($_POST['personal_account'])) { ?>
<form class="checkout__item js-tabs-item" action="../approveInvitation/<?php echo $data['a_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">

 <input type="hidden" name="personal_account" id="personal_account" value="<?php echo $_POST['personal_account']; ?>" />
<?php } else { ?>
<form class="checkout__item js-tabs-item" action="../verifyEmployeeDetailCreateAccount/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
<?php } ?>
 
<div class="checkout__fieldset">
<div class="field__label changedText" style="color:#787f91;">Add Email code</div>
...
<div class="field__label changedText" style="color:#787f91;">Add SMS code</div>
 <div class="login__code" style="margin-bottom:32px; justify-content: left;">

              <div class="login__number" >
                <input type="text" name="otp5" id="otp5" min="1" max="9">
              </div>
              <div class="login__number" >
                 <input type="text" name="otp6" id="otp6" min="1" max="9">
              </div>
              <div class="login__number" >
                 <input type="text" name="otp7" id="otp7" min="1" max="9">
              </div>
              <div class="login__number" >
               <input type="text" name="otp8" id="otp8" min="1" max="9">
              </div>
