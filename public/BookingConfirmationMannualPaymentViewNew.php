	...
	function updateExpiryMonth(id)
	   ...
	   function checkEmail(id) {
				...
				if (!filter.test(email.value)) {
					$("#errorMsg1").html('Please enter correct email format');
					email.focus();
					return false;
				}
				else
	    ...
	    function submitform()
		{
		 ...
		 if(isNaN($("#cvv").val()))
				...
				$("#errorMsg1").html("please enter expiry date !!!");
			...
			send_data.email=$("#email").val();
					...
					$.ajax({
						...
						if(data1==0)
						{
							...
							$('#changeMargin').addClass('marb475');
							$('#changeMargin').removeClass('marb300');
							$('#changeMargin').removeClass('marb275');
							$("#user_id").val(data1);
						...
						{
							$('#changeMargin').addClass('marb275');
							$('#changeMargin').removeClass('marb300');
							$('#changeMargin').removeClass('marb475');
							$("#user_id").val(data1);
...
<a href="../../../../../bookingInvoicePayment/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>/<?php echo $data['invoice_id']; ?>" class="header__item  " style="margin-left:10px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important; ">
...
<div class="travel__col xs-marb0 marb300" style="padding-right: 0px; max-width:525px;" id="changeMargin">
         <div class="travel__list" style="
            max-width: 450px;
...
<div class="changedText categories__subtitle  txt_f67f00 ">Personal</div>
  </a>
...
<form class="checkout__item js-tabs-item" action="../../../../../updatePaymentDetail/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>/<?php echo $data['invoice_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"  placeholder="e. g. 7012356782"  style=" color:grey;" onfocusout="checkPhoneNumber(this.value);">
</div>
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input" name="card_number" id="card_number"  readonly  type="text"   style="color:grey;">
</div>
</div>
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                               <select class=""   id="expiry_year" name="expiry_year" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" onchange='updateExpiryMonth(this.value);' >
                              ...
                              <select class=""   id="expiry_month" name="expiry_month" style="height: 48px;
								...
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" >
								    <?php $dateM=date('m');  for($i=$dateM; $i<=12;$i++) { ?>
                                 <option value="<?php echo $i; ?>" class="lgtgrey2_bg"><?php echo $i; ?></option>
								  <?php }  ?>
								  </select>
                            </div>
...
<div class="field__wrap">
<input class="field__input"  name="cvv" id="cvv"    type="text"  readonly style="color:grey;">
</div>
</div>
