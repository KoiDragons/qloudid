...
<html>
	...
	<div class="clear" id=""></div>
		...
		<div class="column_m pos_rel">
			...
			<form action="#" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank"   >
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						<div class="padb0 xxs-padb0 ">		
							<div class="padb0 talc fsz60 padt20"><i class="fas fa-first-aid red_ff2828_txt"></i></div>
									<h1 class="marb0  mart20 xxs-talc talc fsz25 xs-fsz20  padb0 black_txt trn ffamily_avenir"  >Welcome</h1>
									</div>
									<div class="mart20 marb35 xxs-talc talc   xs-marb20 xs-mart0"> <a href="#" class="black_txt fsz18  xs-fsz16 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Please scan the Qr code below with Dstrict app to inform your presence.</a></div>
							...
							<div class="wi_400p maxwi_100   pos_rel zi5 marrla    padrl10  brdrad3 padb80">
							 ...
							 <div class="padt20 xxs-talc talc  visible-xs  hidden" id="android">
								...
								<a href="https://DstrictsApp.com/session/1/verify_visitor/<?php echo $data['lid']; ?>" target='blank'><button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
						    
						     <div class="padt20 xxs-talc talc   visible-xs hidden" id="iOS">
								
								<a href="DstrictsAppUrl://session/1/verify_visitor/<?php echo $data['lid']; ?>"  target='blank'><button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
						<div class="padtb0 brdrad3 hidden-xs" id="laptop">
						
							<div class="padb10  talc padt20">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=verify_visitor/1/<?php echo $data['lid']; ?>" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
				...
				<label class="dblock fsz12 fleft">
				 <a href="https://www.qloudid.com/company/index.php/Company/visitors/<?php echo $data['cid']; ?>/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09"> <span class="marl5 fsz16 xs-fsz16 valm ">Mannually</span> </a></label>
				</div>
