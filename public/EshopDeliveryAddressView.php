...
">Thank you</h1>
					  ...
					  <div class="tab-header mart10 padb10 xs-tall brdb_94cffd darkbluebrdcolor nobrdt nobrdl nobrdr tall">
                                            <a href="#" class="dinlblck mar5 padrl30     darkbluergb brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active">Personal</a>
											 <a href="#" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" onclick="changeHeader();">Business</a>
							...
							<form action="../addDevilveryAddress/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div class="marb0   padtrl0 white_bg">		 
										...
										<input type="text" value="Personal details" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_55p fsz16 black_txt ffamily_avenir bold" readonly="">
