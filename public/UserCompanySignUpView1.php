          ...
          <div class="checkout__center center">
            ...
            <div class="checkout__wrapper">
              <div class="checkout__inner js-tabs">
                <h2 class="checkout__title h2">Sign up</h2>
				   ...
				   <form class="checkout__item js-tabs-item">
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="fname" placeholder="First name" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="lname" placeholder="Last name" required>
                            </div>
                          </div>
                        </div>
						...
						<div class="field">
                          ...
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" placeholder="XXX@XYZ.com" required>
                          </div>
                        </div>
                       <div class="checkout__row margin-bottom32">
                          <div class="field">
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" placeholder="Phone number" required>
                            </div>
                          </div>
                        </div>
                      </div>
                      
                      <div class="checkout__message margin-bottom24">
                        <div class="checkout__category">Special wishes</div>
                        <div class="field">
                          <div class="field__wrap">
                      ...
                      <div class="checkout__fieldset">
                       ...
                       <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" placeholder="Zipcode" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label">City</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" placeholder="City" required>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="price">
                <div class="price__head">
                  <div class="price__preview"><img src="<?php if(empty($hotelImages))echo $path.'/html/fleet/img/content/photo-1.1.jpg'; else echo 'https://www.'.$hotelImages[0]['image_path1']; ?>" alt="Price"></div>
                  <div class="price__details">
                    <div class="price__title"><?php echo $hotelDetail['hotel_name']; ?></div>
                ...
                <div class="price__description price__description_flex">
                  <div class="price__item">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo date('M d, Y',$_GET['checkin']); ?></div>
                    </div>
                  </div>
                  <div class="price__item">
                    <div class="price__icon">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo date('M d, Y',$_GET['checkout']); ?></div>
                    </div>
                  </div>
                  <div class="price__item">
                    <div class="price__icon">
                    ...
                    <div class="price__box">
                      ...
                      <div class="price__subtitle"><?php echo $t; ?> guest</div>
                    </div>
                  </div>
                </div>
                <div class="price__body">
                  ...
                  <div class="price__table">
                    <div class="price__row">
                      <div class="price__cell">$<?php echo $hotelDetail['room_price']; ?> x <?php echo ($_GET['checkout']-$_GET['checkin'])/86400; ?> nights</div>
                      <div class="price__cell">$<?php echo $hotelDetail['room_price']*(($_GET['checkout']-$_GET['checkin'])/86400); ?></div>
                    </div>
                    <div class="price__row">
