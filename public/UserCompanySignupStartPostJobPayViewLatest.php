...
<body class="dark" style="background: #131922;" onload="checkLogin();">
	...
	<div class="header__center center xxs-padrl25"><a class="header__logo xs-fsz20 changedText" href="https://www.safeqloud.com/user/index.php/LoginAccount" style="
...
<!-- header-->
	...
	<form action="../../../updateUserPayInfo/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['invoice_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
...
<div class="checkout__inner js-tabs wi_60 padr160 xs-padr0">
...
<div class="checkout__label changedText">Pay with</div>
...
<div class="checkout__list  xs-margin0  " style=" ">
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/Invoicepayment/<?php echo $data['invoice_id']; ?>" class="" style="width: 125px;height: 125px;"></div>
</div>
