         ...
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText " style="
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">To grant you access to the corporate employee portal. You need to create your account and connect with us.
</div> 
...
<div class=" " id="userDetail" style="margin-bottom:32px;">
...
<select  class="   "  name="country" id="country" style="height: 48px;
                         	  ...
                         	  <?php foreach($countryOptions as $category => $value) { ?>
											<option value="<?php echo $value['id']; ?>" class="changedText" <?php if($invitationDetail['phone_country_id_invite']==$value['id']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
											 <?php } ?>
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"  placeholder="e. g. 7012356782"  value="<?php echo $invitationDetail['phone']; ?>" style=" color:grey;  background:#282D34;  border:none;" >
</div>
</div>
</div>
</div>
