...
<a class="header__logo xs-fsz20 " href="k" style="
...
<div class="section work xs-padrl25 marb80i xs-marb25i hidde hidden-xs" style=" ">
    ...
    ">
            <div class="work__head tall hidden">
              <h2 class="work__title h2 uppercase" style="font-size:80px;">Empowering Spanish developers by connecting them with global brokers to boost sales, optimize project management, and enhance profitability with cutting-edge tools. Our platform drives collaboration and innovation for greater success.</h2>
              <div class="work__info info">At Developer Hub, our mission is to connect global brokers with Spanish developers, enhancing real estate transactions with innovative, efficient tools for success.</div>
            </div>
             </div>
        </div>
   ...
   <div class="travel__row " style="margin-bottom:40px;">
      <div class="travel__col" style="padding-right: 0px; max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText xs-padb30i xs-brdrbf67f00" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Simply start by enter your personal email address to get started
</div>
...
<input class="subscription__input xs-brdrad6" type="text" name="email" id="email" placeholder="Simply enter personal email" required="required" personal="">
...
<div class="subscription__btn xs-brdradp20" style="background: #f67f00;" onclick="submitForm();">
...
<use xlink:href="#icon-search"></use>
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:525px;">
         <div class="travel__list" style="
            max-width: 450px; 
            ">
            <div class="travel__item" style=" padding: 30px;
    border-radius: 25px;
    background: #0e1116;">
            ...
            <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 16px;
                  ">Qloud ID is a cyber security company. We, as many thousands companies, use Qloud ID for secure account creation because they are experts in privacy management and compliance. Their robust solutions ensure your data is protected and compliant with GDPR and CCPA regulations.
