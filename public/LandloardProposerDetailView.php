  ...
  <!-- s-intro__header -->
        ...
        <div class="row s-intro__content">
            <div class="column">
             ...
             Your Investment Opportunity<br>
			...
			<div class="s-intro__content-bottom" style="margin-top:30px;">
                    ...
                    <div class="s-intro__content-bottom-block" style="padding-left:10px;">
                       <h5 class="bold" style="font-weight:normal; font-size:30px; color:white; margin-bottom:30px;">Pre-Construction Real Estate in Spain</h5>
            
                        <div class="counter">
						<a href="../proposalInformation/<?php echo $data['proposal_id']; ?>">  <div class="counter__time " style="padding-right:30px;">
    ...
    color: black; padding: 5px 3.6rem; display: flex;
											...
											line-height: var(--vspace-1_25);
											  margin-left:0px;">View objects</span>
            ...
            <div class="column">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-about" class="tab-content__item" role="tabpanel" aria-hidden="false" aria-labelledby="tab-link-0" data-tab-active="">
                        ...
                        <div class="row">
                            <div class="column">
                                ...
                                A success and leadership that is marked mainly by the application of its exclusive work system, through which both the associates and the clients themselves acquire the greatest benefits in the real estate market. </p>
                    ...
                    <div id="tab-services" class="tab-content__item" role="tabpanel" aria-hidden="true" aria-labelledby="tab-link-1">
                        ...
                        <div class="row">
                            <div class="column">
							 <p class="lead" style="color:#777E90;">
                               REMAX is the international network of leading real estate franchises in sales in the world.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Name</h4>
                                    <p style="color:#777E90;">
                                 With decades of success to bolster our reputation, the RE/MAX brand means trust – your trust in us to get the job done.
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Network</h4>
                                    <p style="color:#777E90;">
                                   With more than 2,000 agents across Spain, no one sells more real estate than we do. So you can rely on us to help you achieve your goals.
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Support</h4>
                                    <p style="color:#777E90;">
                                   We pioneer new techniques and advanced training that give our agents the freedom and flexibility to focus on customers’ needs first.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="column">
                                ...
                                <p class="tab-content__item-bottom">
                                    <a href="mailto:#0" class="contact-email" style="color:white;">hello@remax.com</a>
                                    <span class="contact-number"> 
                                        <a href="tel:34 604 28 67 89" style="color:#777E90;">+34 604 28 67 89</a> 
                                        </span> <span>
                ...
                <footer>
                    <div class="ss-copyright">
                        <span style="color:#777E90;">© Copyright REMAX 2023</span> 
