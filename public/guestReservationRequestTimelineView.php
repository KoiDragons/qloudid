...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">Reservation fee received</div>
...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
				  ...
				  <?php if($guestReservationDetail['is_accepted']==1 && $guestReservationDetail['reservation_detail']['paid_method']==1) { ?>
				  <div class="card card_row" style="margin-bottom:24px;  ">
