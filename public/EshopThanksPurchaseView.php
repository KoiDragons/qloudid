  ...
  <body class="dark" >
    ...
    <div class="outer">
      ...
      <header class="header js-header header_border bgcolor_F4B400 xs-padding2424">
        <div class="header__center center"><a class="header__logo" href="#" ><button class="button button-stroke button-small header__button" style="border-color:#ff0000; background-color:#ff0000; box-shadow: 0 0 0 2px #ff0000 inset; font-size:18px; min-width: 5em !important;">Close</button></a>
      ...
      <div class="outer__inner">
        ...
        <div class="section description" style="margin-top:80px;">
          <div class="description__center center">
            <div class="description__wrapper">
                 <div class="description__content">
				 <h4 class="fsz45" style="line-height:50px;"> Thank you</h4>
                    <h4 style="font-size:25px;">Your agreement is successfully signed</h4>
                    <p>On right side is the information you have cared to share with the company. </p>
                    <p>Make sure that the information is correct. If not then you need to update your information on Qloud ID under settings. </p>
                    <p>Any support on Qloud ID has to done on their website.</p>
                  </div>
				  
				  <button class="button-stroke button-small description__button">Show more</button>
            </div>
            <div class="receipt">
			<div class="receipt__stage">Delivered</div>
			<div class="receipt__table">
                <div class="receipt__line">
                  <div class="receipt__cell">Full name</div>
                  <div class="receipt__cell">Kowaken Ghirmai</div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell">Email</div>
                  <div class="receipt__cell">kowaken.ghirmai@gmail.com</div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell">Mobile phone</div>
                  <div class="receipt__cell">+46762072192</div>
                </div>
				 <div class="receipt__line">
                  <div class="receipt__cell">Street address</div>
                  <div class="receipt__cell">majorbaken</div>
                </div>
				 <div class="receipt__line">
                  <div class="receipt__cell">Port number</div>
                  <div class="receipt__cell">123B</div>
                </div>
				 <div class="receipt__line">
                  <div class="receipt__cell">City</div>
                  <div class="receipt__cell">Stockholam</div>
                </div>
				 <div class="receipt__line">
                  <div class="receipt__cell">Zipcode</div>
                  <div class="receipt__cell">10005</div>
                </div>
				 <div class="receipt__line">
                  <div class="receipt__cell">Name on card</div>
                  <div class="receipt__cell">Kowaken Ghirmai</div>
                </div>
				 <div class="receipt__line">
                  <div class="receipt__cell">Card number</div>
                  <div class="receipt__cell">**** 4242</div>
                </div>
               ...
               <div class="receipt__foot">
                <div class="receipt__free" style="margin-bottom:10px;">
                  ...
                  </svg>Above information is provided by you
                </div>
				 
				  
				  <a class="button receipt__button " href="#" ><span>Check this 15 second video</span>
