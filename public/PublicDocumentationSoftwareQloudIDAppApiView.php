        ...
        <div class="section faq">
          <div class="faq__center center">
            <div class="faq__top">
              ...
              <h1 class="faq__title h2 ">API</h1>
              <div class="faq__info " style="font-size:20px;">This is a documentation on how you can integrate your software to Qloud ID app for login</div>
              <div class="mobile-show">
                 <select class="select  " style="display: none;" onchange="location = this.options[this.selectedIndex].value;">
				  ...
				  <option value="qloudidAppApiInfo" selected>App API</option>
                </select> 
              </div>
            </div>
            <div class="faq__row js-tabs">
              <div class="faq__col">
               <div class="faq__nav"><a class="faq__link " href="loginApiInfo" style="font-size:18px;">
					...
					<a class="faq__link js-tabs-link active " href="qloudidAppApiInfo" style="font-size:18px;">
                    <svg class="icon icon-lightning">
                      <use xlink:href="#icon-lightning"></use>
                    </svg>App API</a>
              ...
              <div class="faq__col">
			   ...
			   <div class="faq__box js-tabs-item" style="display: block;">
                ...
                <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item">
                                      <div class="faq__head">How to connect with API</div>
...
<li class="first">Now on Qloud ID user is asked to enter password and verify him self (for completing this step user must be connected to a valid certificate on Qloud ID app).</li>
...
<li class="last">If session is a valid session we receive a json with values {"user_id":1,"result":1}</li>
</ul>
<ul>
<p class="   bold fsz16" style="font-size:18px; word-wrap: break-word; padding-bottom:20px;">Note:-</p>
...
<li class="last">Right now API is sending desired information for WORQ only we can make changes on API or provide a different API for  each app based on their data requirements.</li>
