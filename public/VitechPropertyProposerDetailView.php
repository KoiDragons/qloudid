<html class="js" lang="en"><head>
 ...
 <link rel="shortcut icon" type="image/x-icon" href="<?php echo $path;?>html/usercontent/images/favicon.ico">
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="https://dstricts.com/html/registerguest/css/vendor.css">
    <link rel="stylesheet" href="https://dstricts.com/html/registerguest/css/stylesnew.css">
  
    <!-- favicons
    ================================================== -->
    <link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png">
    <link rel="icon" type="https://dstricts.com/html/registerguest/image/png" sizes="32x32" href="favicon-32x32.png">
    <link rel="icon" type="https://dstricts.com/html/registerguest/image/png" sizes="16x16" href="favicon-16x16.png">
...
<body id="top" class="theme-static ss-loaded ss-show">
  ...
  <!-- s-intro__header -->
        ...
        <div class="row s-intro__content">
            <div class="column">
                ...
                <div class="text-pretitle" style="padding-left:10px;">
                    Welcome to
                </div>

               <h1 class="text-huge-title" style="max-width:810px; --text-huge: 15.2rem;">
                
             Your Vacation Apartment<br>
                 
                </h1>
				 
				
			<div class="s-intro__content-bottom" style="margin-top:30px;">

                    <div class="s-intro__content-bottom-block" style="padding-left:10px;">
                       <h5 class="bold" style="font-weight:normal; font-size:30px; color:white; margin-bottom:30px;">Handpicked Rentals for an Unforgettable Stay</h5>
                        ...
                        <div class="counter">
						<a href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/VitechProperties/propertyProposalDetail/<?php echo $data['proposal_id']; ?>">  <div class="counter__time " style="padding-right:30px;">
                                <span style="background: #f67f00;
    border: none;
	border-radius:3px; font-weight:bold;
    color: black; padding: 5px 3.6rem; display: flex;
											font-family: var(--font-2);
											 
											font-size: calc(var(--text-size) * 0.9);
											line-height: var(--vspace-1_25);
											  margin-left:0px;">View proposal</span>
                                 
                            </div></a>
                           <a href="#" style="display:none;"> 
						   <div class="counter__time " style="padding-right:30px;">
                                 <span style="background: black;
    border: 1px solid #ffffff;
	border-radius:3px;
    color: var(--color-btn-stroke-text); padding: 5px 3.6rem; display: flex;
											font-family: var(--font-2);
											font-weight: 300;
											font-size: calc(var(--text-size) * 0.9);
											line-height: var(--vspace-1_25);
											color: white;">Brokers</span>
    ...
    <!-- details
    ================================================== -->
    <section id="details" class="s-details" style="bottom: -918px; --overlay-opacity:1; background: #131922;">

        <div class="row">
            <div class="column">

                <h1 class="text-huge-title text-center" style="color:white;">
                    Hi, We Are <?php echo $employeeDetail['company_name']; ?>
                </h1>

                <nav class="tab-nav">
                    <ul class="tab-nav__list" role="tablist"> 
                        <li class="active" data-id="tab-about" role="presentation" data-tab-active="">
                            <a href="#0" id="tab-link-0" role="tab" tabindex="0" aria-selected="true" aria-controls="0" data-tab-active="">
                                <span style="color:#f67f00;">Client Address</span>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#tab-services" id="tab-link-1" role="tab" tabindex="-1" aria-selected="false" aria-controls="tab-services">
                                <span style="color:#f67f00;">Broker Info</span>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#tab-contact" id="tab-link-2" role="tab" tabindex="-1" aria-selected="false" aria-controls="tab-contact">
                                <span style="color:#f67f00;">Company Info</span>
                            </a>
                        </li>
                    </ul>
                </nav> <!-- end tab-nav -->
                ...
                <div class="tab-content">
                    ...
                    <!-- 01 - tab about -->
                    <div id="tab-about" class="tab-content__item" role="tabpanel" aria-hidden="false" aria-labelledby="tab-link-0" data-tab-active="">

                        <div class="row tab-content__item-header">
                            <div class="column">
                                <h2 style="color:white;">Dear <?php echo $clientProposalDetail['first_name'].' '.$clientProposalDetail['last_name']; ?></h2>
                            </div>
                        </div>

                        <div class="row">
                            <div class="column">
                                <p class="lead " style="color:#777E90;">
                               I am pleased to present to you our exclusive selection of real estate properties that, in my opinion, perfectly match your requests and requirements. </p>
						 ...
						 <div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Your Request</h4>
                                    <p style="color:#777E90;">
                                 You were looking for properties on the secondary market in Marbella, with a sea view, 2 bedrooms, 2 bathrooms, recently renovated, ready for immediate move-in, and within a budget of up to 700,000 euros.
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Conclusion</h4>
                                    <p style="color:#777E90;">
                                   I am confident that one of the proposed properties will be an excellent choice for you. If you have any questions or would like to schedule a viewing, please contact me at the provided contact details.
						 ...
						 <div class="row">
                                    <div class="column lg-6 tab-12">
                                        <h4 style="color:white;">Sincerely</h4>
                
                                        <p style="color:#777E90;">
                                      <?php echo $employeeDetail['first_name']." ".$employeeDetail['last_name']; ?> <br>
                                       Employee, <br>
                                       <?php echo $employeeDetail['user_phone']; ?>
                                        </p>
                    ...
                    <!-- 02 - tab services -->
                    <div id="tab-services" class="tab-content__item" role="tabpanel" aria-hidden="true" aria-labelledby="tab-link-1">

                        <div class="row tab-content__item-header">
                            <div class="column">
                                <h2 style="color:white;"><?php echo $employeeDetail['first_name']." ".$employeeDetail['last_name']; ?></h2>
                            </div>
                        </div>
						<div class="row">
                            <div class="column">
						...
						<div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Full Support</h4>
                                    <p style="color:#777E90;">
                                I provide comprehensive assistance throughout the purchase process, from property selection to document signing.
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Personalized Service</h4>
                                    <p style="color:#777E90;">
                                  I consider all your wishes and requirements to offer the best options.
							 ...
							 <div class="column services-list__item">
                                <div class="services-list__item-content">
                                    <h4 class="item-title" style="color:white;">Expert Consultations</h4>
                                    <p style="color:#777E90;">
                                 I am always ready to answer any questions and help solve any issues.
                        ...
                        <div class="row">
                                    <div class="column lg-6 tab-12">
                                        ...
                                        <p style="color:#777E90;"> 
                                       <?php echo '+'.$employeeDetail['country_code'].$employeeDetail['user_phone']; ?>, <br>
                                      <?php echo $employeeDetail['email']; ?>, <br>
                                       <?php echo $employeeDetail['location']; ?>
                                        </p>
                                    ...
                                    <div class="column lg-6 tab-12">
                                        ...
                                        <ul class="link-list">
                                            <li><a href="<?php echo $employeeDetail['facebook']; ?>" style="color:#777E90;">Facebook</a></li>
                                            <li><a href="<?php echo $employeeDetail['twitter']; ?>" style="color:#777E90;">Twitter</a></li>
                                            <li><a href="#" style="color:#777E90;">Instagram</a></li>
                                        </ul>
                    ...
                    <!-- 03 - tab contact -->
                    <div id="tab-contact" class="tab-content__item" role="tabpanel" aria-hidden="true" aria-labelledby="tab-link-2">

                        <div class="row tab-content__item-header">
                            <div class="column">
                                <h2 style="color:white;"><?php echo $employeeDetail['company_name']; ?></h2>
                            </div>
                        </div>
                        ...
                        <div class="row">
						 <div class="column">
                            ...
                            <div class="column">
                                ...
                                <p class="lead" style="color:#777E90;">
                                <?php echo $employeeDetail['company_name']; ?> is a leading real estate company, offering a wide range of services for buying, selling, and renting properties. Our team of professionals has extensive experience and market knowledge, ensuring the best offers and high-quality service for our clients.

                                </p>
								
								 <p class="lead" style="color:#777E90;">
                                We deal with various types of real estate, including residential and commercial, and are ready to assist you at every stage of the transaction. Our mission is to make the process of buying or renting real estate as simple and comfortable as possible for our clients.
                                ...
                                <div class="row">
                                    <div class="column lg-6 tab-12">
                                        ...
                                        <p style="color:#777E90;"> 
										<?php if($employeeDetail['cphone']!=''){   echo $employeeDetail['cphone']; ?>, <br> <?php } ?>
                                       <?php echo $employeeDetail['company_email']; ?>, <br>
                                      <?php echo $employeeDetail['location']; ?><br>
                                    ...
                                    <div class="column lg-6 tab-12">
                                        ...
                                        <ul class="link-list">
                                           <li><a href="<?php echo $employeeDetail['fb']; ?>" style="color:#777E90;">Facebook</a></li>
                                            <li><a href="<?php echo $employeeDetail['tw']; ?>" style="color:#777E90;">Twitter</a></li>
                                            <li><a href="<?php echo $employeeDetail['insta']; ?>" style="color:#777E90;">Instagram</a></li>
                                        </ul>
                                ...
                                <p class="tab-content__item-bottom">
                                    <a href="mailto:#0" class="contact-email" style="color:white;">hello@findabroker.com</a>
                                    <span class="contact-number"> 
                                        <a href="tel:<?php echo '+'.$employeeDetail['mobile_country_code'].''.$employeeDetail['mobile']; ?>" style="color:#777E90;"><?php echo '+'.$employeeDetail['mobile_country_code'].''.$employeeDetail['mobile']; ?> </a> 
                                        <span>/</span>
                                        <a href="tel:<?php echo '+'.$employeeDetail['mobile_country_code'].''.$employeeDetail['cphone']; ?>" style="color:#777E90;"><?php echo '+'.$employeeDetail['mobile_country_code'].''.$employeeDetail['cphone']; ?></a>
                                    </span>
                                </p>
                ...
                <footer>
                    <div class="ss-copyright">
                        <span style="color:#777E90;">© Copyright <?php echo $employeeDetail['company_name']; ?> 2023</span> 
                        <span style="color:#777E90;">Design by <a href="javascript:void(0);" style="color:#777E90;"><?php echo $employeeDetail['company_name']; ?></a></span>
                    </div>
                </footer>
        ...
        <div class="ss-go-top">
            <a class="smoothscroll" title="Back to Top" href="#top">
                <span style="color:#777E90;">Back to Top</span>
    ...
    <!-- Java Script
    ================================================== -->
    <script src="https://dstricts.com/html/registerguest/js/plugins.js"></script>
    <script src="https://dstricts.com/html/registerguest/js/main.js"></script>
