			...
			<div class="s-intro__content-bottom" style="margin-top:30px;">
                    ...
                    <div class="s-intro__content-bottom-block" style="padding-left:10px;">
                       <h5 class="bold" style="font-weight:normal; font-size:30px; color:white; margin-bottom:30px;">Handpicked Rentals for an Unforgettable Stay</h5>
                        ...
                        <div class="counter">
						<a href="https://www.qloudid.com/public/index.php/VitechProperties/propertyProposalDetail/<?php echo $data['proposal_id']; ?>">  <div class="counter__time " style="padding-right:30px;">
