...
<a class="header__logo xs-fsz20 " href="../invoiceAddressesUser/<?php echo $data['checkout_id']; ?>" style="
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Pay</h2>
<div class="browse__info info changedText">Please select card for payment</div>
</div>
  
<div class="checkout__inner js-tabs wi_50">
<div class="checkout__section ">
<div class="checkout__box">
<div class="checkout__category changedText">Card</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
	foreach($cardsList as $category => $value) 
	{
	?> 	
<div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText"><?php echo $value['name_on_card']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['card_number2']; ?></div>
 
<div class="checkout__controls">
<a href="../updateCardDetail/<?php echo $data['checkout_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
