...
<a href="../../bookingInvoicePayment/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $bookingServiceInvoiceDetail; ?>"><button class="checkout__edit"  >
...
<input class="field__input"  type="text" name="email" id="email"  style="border-color:#f67f00; color:grey;" onfocusout="checkEmailInfo(this.value);">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input" name="fname" id="fname"    type="text"   style=" color:grey;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="lname" id="lname"    type="text"   style=" color:grey;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"   style=" color:grey;" onfocusout="checkPhoneNumber(this.value);">
</div>
</div>
...
<a class="button checkout__button changedText mart40" href="javascript:void(0);"  onclick="submitform();" >Submit</a>
