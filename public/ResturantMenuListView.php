...
<link rel="stylesheet" href="<?php echo $path;?>html/staticCss/3Cc9iV.QythbCez.css" crossorigin="">
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 black_bg ">
				...
				<ul class="menulist sf-menu  fsz25  bold wi_100">
					<li class="padr10 first last wi_100 talc">
						<a href="#"><span class="white_txt pred_txt_h ffamily_avenir"><?php echo substr($resturantinfo['resturant_name'],0,14); ?></span></a>
					</li>
				 	 
       			 	</ul>
			</div> 
			<div class="visible-xs visible-sm fright marr0 padt2 "> <a href="#" class="diblock padr10 brdrad3 fsz30 white_txt padt5"><i class="fas fa-search" aria-hidden="true"></i></a> </div>		
                <div class="clear"></div>
	...
	<div class="clear"></div>
		...
		<div class="column_m pos_rel ">
			...
			<!-- CONTENT -->
			<div class="column_m container zi5 mart40 xsi-mart0 xs-mart0 white_bg">
		...
		<div class="padb0 xxs-padb0 hidden">		
									...
									<h1 class="marb0  xxs-tall talc fsz50 xxs-fsz35 lgn_hight_100 xxs-lgn_hight_65 brdb padb10 black_txt trn"  ><span class="red_ff2828_txt">  </span> <?php echo $resturantinfo['resturant_name']; ?></h1>
									</div>	
<div class="_1anKb-nl hidden-xs padb0"><div data-test-target="main_h1" class="LZSItUvx"><h1 class="HLvj7Lh5 jObdbvmD fsz75 xsi-fsz55 nobold xs-fsz25 talc   ffamily_avenir black_txt"><span>  <span class="{geoClass}"><?php if($businessImageDetail['heading_type']==0) echo $companyDetail['company_name']; else if($businessImageDetail['heading_type']==1) echo '<img src="../../../'.$companyDetail['image_path'].'" class="hei_195p xsi-hei_95p">'; else echo $businessImageDetail['free_text']; ?></span></span></h1></div></div>									
<div class="mart10 marb5 xxs-talc talc padb20 hidden"> <a href="#" class="black_txt fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Breakfast - <?php $day=strtolower(date('D')); if($resturantWorkInfo['breakfast_available']==0) echo 'Not Available'; else { if($resturantWorkInfo['breakfast_'.$day.'_open']==0) echo 'Not Available today'; else echo $resturantWorkInfo['breakfast_'.$day.'_open_time'].' to '.$resturantWorkInfo['breakfast_'.$day.'_close_time']; } ?> . Brunch - <?php if($resturantWorkInfo['brunch_available']==0) echo 'Not Available'; else { if($resturantWorkInfo['brunch_'.$day.'_open']==0) echo 'Not Available today'; else echo $resturantWorkInfo['brunch_'.$day.'_open_time'].' to '.$resturantWorkInfo['brunch_'.$day.'_close_time']; } ?> . Lunch - <?php if($resturantWorkInfo['lunch_available']==0) echo 'Not Available'; else { if($resturantWorkInfo['lunch_'.$day.'_open']==0) echo 'Not Available today'; else echo $resturantWorkInfo['lunch_'.$day.'_open_time'].' to '.$resturantWorkInfo['lunch_'.$day.'_close_time']; } ?> . Dinner - <?php if($resturantWorkInfo['dinner_available']==0) echo 'Not Available'; else { if($resturantWorkInfo['dinner_'.$day.'_open']==0) echo 'Not Available today'; else echo $resturantWorkInfo['dinner_'.$day.'_open_time'].' to '.$resturantWorkInfo['dinner_'.$day.'_close_time']; } ?> . Beverage - <?php if($resturantWorkInfo['alcohol_available']==0) echo 'Not Available'; else { if($resturantWorkInfo['alcohol_'.$day.'_open']==0) echo 'Not Available today'; else echo $resturantWorkInfo['alcohol_'.$day.'_open_time'].' to '.$resturantWorkInfo['alcohol_'.$day.'_close_time']; } ?></a></div>

<div class="mart0 marb15 xxs-talc talc  xs-padb20 padb20 "> <span class="black_txt fsz25 xs-fsz20 xsi-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_25 padb10 brdb">Find us : <?php echo $resturantinfo['visiting_address']; ?>   <?php if($resturantinfo['phone']=='' || $resturantinfo['phone']==null) echo ''; else echo '<span class="padrl10 fsz15"><i class="fas fa-circle"></i></span> Call us : <a href="tel: +'.$resturantinfo['country_code'].' - '.$resturantinfo['phone'].'">+'.$resturantinfo['country_code'].' - '.$resturantinfo['phone']; ?></a><span></div>
...
<div class="ZVAUHZqh" style="background-image: url(&quot;<?php echo '../../../'.$businessImageDetail['big_image_path']; ?>&quot;); background-size: cover; height: 100%; width: 100%;">
</div>
</button>
</div>
<div class="_2zxhF-Tt">
<div class="OI7TZU7N">
<button class="_1iw-atL9" aria-label="Visa alla bilder">
<div class="ZVAUHZqh" style="background-image: url(&quot;<?php echo '../../../'.$businessImageDetail['small_image1_path']; ?>&quot;); background-size: cover; height: 100%; width: 100%;">
</div>
</button>
</div>
<div class="_2busJ7MM">
<button class="_1iw-atL9" aria-label="Visa alla bilder">
<div class="ZVAUHZqh" style="background-image: url(&quot;<?php echo '../../../'.$businessImageDetail['small_image2_path']; ?>&quot;); background-size: cover; height: 100%; width: 100%;">
</div>
</button>
</div>
</div>
...
<div class="_1HQROFP xxs-mart40" data-test-target="feed">
  <?php  foreach($completeMenu as $category => $value) 
														...
														?>
    <div class="_1anKb-nl">
      <h2 class="sfviYlff"><span class="kXE6Dm96"><span class="HLvj7Lh5 _2-dmJ6kF"><?php if($value['serve_type']==1) echo 'Breakfast'; else if($value['serve_type']==2) echo 'Brunch'; else if($value['serve_type']==3) echo 'Lunch'; else if($value['serve_type']==4) echo 'Dinner'; else if($value['serve_type']==5) echo 'Beverage'; ?></span></span></h2>
   </div>
      ...
      <div class="_2_LiTKhk">
         <div class="WPbAbZxq xs-talc">
            <div class="_1v3jh4G8 xs-marb0">
               <h3 class="HLvj7Lh5 _3hVaBz-q xs-fsz20 xs-padb0"><?php   echo $value1['food_category']; ?></h3>
            </div>
            <div class="_29jwtiy-">
               <div class="HLvj7Lh5 pUrhFFvK xs-fsz16">Platser att se, sätt att vandra på och unika upplevelser som utmärker Paris.</div>
            </div>
         </div>
         <div class="_2JGsjxnm">
            <div class="Ffh78ncj _1JCEdqUg _3auwW4vL _3XQY3qGv">
                  ...
                  <div class="_18nJZLOU">
                     <ul class="_2aDyanzw">
					  <?php $i=1; foreach($value1['dishes'] as $category => $value2) 
														...
														?>
                        <li class="_19hUB53v mySlides<?php echo $value['serve_type'].''.$value1['category_food']; ?> fade xxs-marl24">
                           <div class="_1lp0l90B">
                                    ...
                                    <div class="gZ95jyA4 _3w8eCCad">
                                       <div class="eS-OaSz0 _2pegydha _1z7GhJXI _18B0pXv7">
                                          ...
                                          <div class="_1tZwxF4- _3Wt7gged">
                                             <div class="ZVAUHZqh" style="background-image: url(&quot; <?php echo $value2['dish_image']; ?>&quot;); background-size: cover; height: 100%; width: 100%;"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
               ...
               <div class="_1KB7D5C1 _3n93WwqC" style="display:block;">
                  <div class="jOxjYW1k"><span class="fhoh290_"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Föregående"  onclick="plusSlides(-1,<?php echo $value['serve_type'].''.$value1['category_food']; ?>);"><span class="padt3" style="font-size: 20px;"><i class="fas fa-long-arrow-alt-left"></i></span></button></span></div>
               </div>
               <div class="_1KB7D5C1 _2bfEA-AB" style="display:block;">
                  <div class="jOxjYW1k"><span class="fhoh290_"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Nästa" onclick="plusSlides(1,<?php echo $value['serve_type'].''.$value1['category_food']; ?>);"><span class="padt3" style="font-size: 20px;"><i class="fas fa-long-arrow-alt-right"></i></span></button></span></div>
               </div>
            </div>
         </div>
      </div>
 ...
 var startIndex=3; 
  ...
  for (i = 0; i < n; i++) {
   ...
   showSlidesStart(startIndex,<?php echo $value['serve_type'].''.$value1['category_food']; ?>);
