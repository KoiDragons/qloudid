...
<button class="header__burger js-header-burger"></button>
 ...
 <form action="../signUpEmailInfo/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1" autocomplete="off">
			...
			<input type="hidden" name="user_signup_type" id="user_signup_type" value="<?php echo $_POST['user_signup_type']; ?>">
			<input type="hidden" name="subscription_type" id="subscription_type" value="">
			</form>
...
<h1 class="main__title hero xs-tall talc pad30 fsz90 xs-fsz35" style="
    background: #0e0e0d73;
    margin-bottom: 0px;
    color: white;
...
<div class="main_info info talc hidden" style="max-width: 1600px;background: #0e0e0d73;color: white;padding-bottom: 15px;margin-bottom: 15px;font-size: 90px;margin-top: 0px;padding: 0px 30px 30px 30px;border-radius: 0px 0px 10px 10px;font-family: 'DM Sans', sans-serif;">JOIN US
</div></div>
</div>
</div></div>
...
<h2 class="main__info info  tall  padb20 xs-padt20" style="font-weight: 100;color: #777E90; max-width: 100%; font-size: 24px;">Select one of these plan to book</h2></div>
              ...
              <div class="browse__wrapper">
				...
				<a class="browse__card" href="#"  onclick="submitForm(1);">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/account/1.jpg" src="https://www.qloudid.com/html/usercontent/images/account/1.jpg" alt="Card" style="width: auto;">
				...
				<a class="browse__card" href="#"  onclick="submitForm(2);">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/account/2.jpeg" src="https://www.qloudid.com/html/usercontent/images/account/2.jpeg" alt="Card" style="width: auto;">
...
<div class="profile__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar.jpg" alt="Avatar">
...
<button class="profile__report" fdprocessedid="4jxe0n">
...
<button class="comment__action" fdprocessedid="9rxnsl">Like</button>
<button class="comment__action" fdprocessedid="9h3d8">Reply</button>
</div>
</div>
</div>
</div>
...
<div class="comment__actions">
<button class="comment__action" fdprocessedid="03n78p">Like</button>
<button class="comment__action" fdprocessedid="nwmkr">Reply</button>
</div>
</div>
</div>
</div>
...
">1 day ago</div>
<div class="comment__actions">
<button class="comment__action" fdprocessedid="28b86b">Like</button>
<button class="comment__action" fdprocessedid="fy33l8">Reply</button>
</div>
</div>
</div>
</div>
...
<button class="button-stroke button-small comment__button" fdprocessedid="oc9qnl">
