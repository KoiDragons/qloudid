<head>
	...
	{
	window.location.href='https://www.safeqloud.com/public/index.php/UserCompanySignUp/pricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['catg_id']; ?>/<?php echo $data['subcatg_id']; ?>';
	}
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Here are category of professional services</a></div>
