...
<a href="../addUserPropertyInfo/<?php echo $data['request_id']; ?>" class="header__item " onclick="submitUser();"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
...
<h2 class="browse__title h2 changedText" style="
    font-size: 70px;
    line-height: 80px;
">SELECT ONE PROPERTY</h2>
<div class="browse__info info changedText">To ensure we match you with the most suitable agents in your area.</div>
</div>
</div>							 
...
<div class="checkout__box">
									<script>
										...
										document.getElementById("save_indexing_user").submit();	
										 ...
										 <form action="../updatePropertyDetail/<?php echo $data['request_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
			...
			<input type="hidden" name="b_id" id="b_id" value="">
									 ...
									 <?php $i=1;
												...
												foreach($userProperty as $category => $value) 
												{
												...
												?>  	
													...
													<div class="checkout__label changedText">Personal address</div>
													<input class="checkout__input js-date-single changedText" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $value['address']; ?>">
													<div class="checkout__controls">
													 
													<button class="checkout__edit"  onclick="submitForm('<?php echo $value['id']; ?>');">
