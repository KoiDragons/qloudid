...
<!-- outer-->
<div class="outer" style="background: #131922;">
<!-- header-->
<header class="header js-header authorization xs-padt24" style="/* border-bottom: 1px solid #e6e8ec; */">
<div class="header__center center"><a class="header__logo xs-fsz20 " href="https://dstricts.com/public/index.php/VisitorSelectSearch/selectYourRole/<?php echo $data['apartment_id']; ?>" style="
...
<div class="section description   xxs-mart40  xs-padb0" style="background: #131922;border-bottom: none;;margin-top: 30px;" id="loginBank">
<div class="description__center center xxs-padrl25">
 
		<div class="receipt xs-margin0 marrla maxwi_375 xs-pad20" style="
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=verify_checkin/2/<?php echo $data['apartment_id']; ?>" class="" style="width: 150px;height: 150px;"></div>
</div>

</div>
<div class="receipt__foot">
<div class="receipt__free" style="margin-bottom: 5px;font-size: 25px;color: white;">Scan QR code</div>
				
				
				
</div><div class="receipt__foot">
<div class="receipt__free" style="font-size: 16px;color: grey;">Scan and sign in with your Qloud ID app or use your booking code
</div>
...
<div class="description__wrapper xs-pad0 maxwi_375p  marrla  " style="padding:0px;" >
...
<div class="description__group" style="
    ...
    /* padding-left: 25px; */
">
<div class="description__section maxwi_200p marrla" style="
    margin-top: 24px;
    padding-top: 24px;
    border-color: #353945; 
...
<input class="subscription__input" type="text" name="vcode" id="vcode" placeholder="Add booking code" required="required" style="
    background: #23262F;
    color: grey;
    font-size: 16px;
">

<a href="javascript:void(0);" class="subscription__btn" style="background: #f67f00;" onclick="submitform();">
<svg class="icon icon-arrow-next  mar10" style="
    fill: black;
">
