...
<body class="dark" style="background-color:#131922">
  <script>
    ...
    if (input.files && input.files[0]) {
	   ...
	   function updateExpType(id)
	   {
		 $('#experience_info_detail').val(id);
		 if(id==1)
		 {
			 $('#expDetail').removeClass('hidden');
			 $('#total_exp').val(0);
		 }
		 else
		 {
			 $('#expDetail').addClass('hidden'); 
			 $('#total_exp').val(0);
		 }
	   }
...
function changeDisplay1()
	   ...
	   {
		 var getValue=$('#category_detail').val();
			if($('#c'+id).hasClass('green_bg'))
			{
				$('#c'+id).removeClass('green_bg');
				$('#c'+id).addClass('lgtgrey_bg');
				getValue = getValue.replace(id+",", "");
				$("#category_detail").val(getValue);
			}
			else
			{
				$('#c'+id).addClass('green_bg');
				$('#c'+id).removeClass('lgtgrey_bg');
	  ...
	  function submitform()
		{
			...
			if($("#category_detail").val()=="" || $("#category_detail").val()==0)
			{
				
				$("#errorMsg1").html('Please select atleast one service');
				return false;
			}
				...
				if($('#total_age').val()=="" || $("#total_age").val()==0)
				{
				$("#errorMsg1").html('Please select date of birth');
				return false;	
				}
				
			 
			if($("#inclusion_type_detail").val()=="" || $("#inclusion_type_detail").val()==0)
			{
			 ...
			 if($("#email").val()=="" || $("#email").val()=="")
			{
			 ...
			 if($("#p_country").val()==0 || $("#p_country").val()=="")
			{
			...
			if(isNaN($("#p_number").val()))
			{
			 ...
			 if($('#address').val()=='' || $('#address').val()==null)
					  ...
					  if($('#port_number').val()=='' || $('#port_number').val()==null)
					  {
						  $("#errorMsg1").html('Please enter port number');
						  return false;
					  }
					  
					  if($('#zipcode').val()=='' || $('#zipcode').val()==null)
					  {
						  $("#errorMsg1").html('Please enter zip code');
						  return false;
					  }
					  
					  if($('#city').val()=='' || $('#city').val()==null)
					  {
						  $("#errorMsg1").html('Please enter city');
						  return false;
					  }
			...
			if($("#category_detail").val()==0 || $("#category_detail").val()=="")
			{
				
				$("#errorMsg1").html('Please select service you provide');
				return false;
			}
			
			if($("#price_info").val()==0 || $("#price_info").val()=="")
			{
				
				$("#errorMsg1").html('Please select driving license info');
				return false;
			}
		
			if($("#linkdn_profile").val()=="" || $("#linkdn_profile").val()=="")
			{
				
				$("#errorMsg1").html('Please enter linkdn profile info');
				return false;
			}
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    padding-bottom: 0px;
    margin-bottom: 0px;
     border-bottom: none;
">Job Application Process
</h2>
<div class="browse__info info xs-fsz25 changedText">Steps to apply for the position of Premium Supplier Sales Agent (Remote/Field)</div>
</div>
<div class="checkout__inner js-tabs wi_50" style="padding-right:0px;">

<div class="checkout__list">
 


<div class="upload__head hidden-xs">
                  <h2 class="upload__title h2">Add your details</h2> 
                </div>

<div class="checkout__section xsi-nobrdt  " style="padding-top:0px; margin-top:0px;   padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../postJobRequirementInfo/<?php echo $data['domain_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
 
 <div class="upload__item">
                      <div class="upload__category" style="margin-bottom:0px;">Upload photos</div>
                      <div class="upload__note">Drag or choose your file to upload</div>
                      <div class="upload__file"  style="  background-image: ../../usercontent/images/default-profile-pic.jpg;" >
                        <input class="upload__input" type="file" name="file1" id="file1" onchange="readURL(this);">
                        <div class="upload__icon">
                          <svg class="icon icon-upload-file">
                            <use xlink:href="#icon-upload-file"></use>
                          </svg>
                        </div>
                        <div class="upload__format">PNG, GIF, WEBP, MP4. Max 500Mb.</div>
                      </div>
                    </div>
 <div class="on_clmn mart20 marb35 hidden">
						<div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
									...
									<div class="wp_columns_upload wp_columns_upload_custom marb20 brd brdclr_white ">
										...
										<div class="imgwrap nobrd  "  >
											<div class="cropped_image   grey_brd5  " style="object-fit: cover;  background-image: ../../usercontent/images/default-profile-pic.jpg;" id="image-data" name="image-data"></div>
...
<div class="field"  >
<div class="field__label changedText" style="color:#787f91;">Let us know how old you are</div>
<div class="field__wrap">
<input class="field__input"  type="date" name="total_age" id="total_age" value="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d'); ?>" style=" color:grey;" required="">
</div>
</div>
 ...
 <div class="upload__item">
<div class="checkout__line margin-bottom24" >
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row  margin-bottom24">
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="first_name" id="first_name"   style=" color:grey;" />
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="last_name" id="last_name" style=" color:grey;" />
                            </div>
                          </div>
                        </div>
						
						<div class="field margin-bottom24">
                          <div class="field__label" style="color:#787f91;">Email</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email" style=" color:grey;" />
                          </div>
                        </div>
                       <div class="checkout__row  ">
                           <div class="field">
                            <div class="field__label" style="color:#787f91;">Country</div>
                           <div class="field__wrap">
                          <select class=" "   id="p_country" name="p_country"   style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
	 <option value="0" class="lgtgrey2_bg">Select</option>
                           <option value="2" class="lgtgrey2_bg">Afghanistan</option>
																													
															<option value="5" class="lgtgrey2_bg">Albania</option>
																													
															<option value="62" class="lgtgrey2_bg">Algeria</option>
																													
															<option value="11" class="lgtgrey2_bg">American Samoa</option>
																													
															<option value="6" class="lgtgrey2_bg">Andorra</option>
																													
															<option value="3" class="lgtgrey2_bg">Angola</option>
																													
															<option value="4" class="lgtgrey2_bg">Anguilla</option>
																													
															<option value="12" class="lgtgrey2_bg">Antarctica</option>
																													
															<option value="14" class="lgtgrey2_bg">Antigua and Barbuda</option>
																													
															<option value="9" class="lgtgrey2_bg">Argentina</option>
																													
															<option value="10" class="lgtgrey2_bg">Armenia</option>
																													
															<option value="1" class="lgtgrey2_bg">Aruba</option>
																													
															<option value="15" class="lgtgrey2_bg">Australia</option>
																													
															<option value="16" class="lgtgrey2_bg">Austria</option>
																													
															<option value="17" class="lgtgrey2_bg">Azerbaijan</option>
																													
															<option value="25" class="lgtgrey2_bg">Bahamas</option>
																													
															<option value="24" class="lgtgrey2_bg">Bahrain</option>
																													
															<option value="22" class="lgtgrey2_bg">Bangladesh</option>
																													
															<option value="32" class="lgtgrey2_bg">Barbados</option>
																													
															<option value="27" class="lgtgrey2_bg">Belarus</option>
																													
															<option value="19" class="lgtgrey2_bg">Belgium</option>
																													
															<option value="28" class="lgtgrey2_bg">Belize</option>
																													
															<option value="20" class="lgtgrey2_bg">Benin</option>
																													
															<option value="29" class="lgtgrey2_bg">Bermuda</option>
																													
															<option value="34" class="lgtgrey2_bg">Bhutan</option>
																													
															<option value="30" class="lgtgrey2_bg">Bolivia</option>
																													
															<option value="26" class="lgtgrey2_bg">Bosnia and Herzegovina</option>
																													
															<option value="36" class="lgtgrey2_bg">Botswana</option>
																													
															<option value="35" class="lgtgrey2_bg">Bouvet Island</option>
																													
															<option value="31" class="lgtgrey2_bg">Brazil</option>
																													
															<option value="101" class="lgtgrey2_bg">British Indian Ocean Territory</option>
																													
															<option value="33" class="lgtgrey2_bg">Brunei</option>
																													
															<option value="23" class="lgtgrey2_bg">Bulgaria</option>
																													
															<option value="21" class="lgtgrey2_bg">Burkina Faso</option>
																													
															<option value="18" class="lgtgrey2_bg">Burundi</option>
																													
															<option value="114" class="lgtgrey2_bg">Cambodia</option>
																													
															<option value="44" class="lgtgrey2_bg">Cameroon</option>
																													
															<option value="38" class="lgtgrey2_bg">Canada</option>
																													
															<option value="50" class="lgtgrey2_bg">Cape Verde</option>
																													
															<option value="54" class="lgtgrey2_bg">Cayman Islands</option>
																													
															<option value="37" class="lgtgrey2_bg">Central African Republic</option>
																													
															<option value="206" class="lgtgrey2_bg">Chad</option>
																													
															<option value="41" class="lgtgrey2_bg">Chile</option>
																													
															<option value="42" class="lgtgrey2_bg">China</option>
																													
															<option value="53" class="lgtgrey2_bg">Christmas Island</option>
																													
															<option value="39" class="lgtgrey2_bg">Cocos (Keeling) Islands</option>
																													
															<option value="48" class="lgtgrey2_bg">Colombia</option>
																													
															<option value="49" class="lgtgrey2_bg">Comoros</option>
																													
															<option value="46" class="lgtgrey2_bg">Congo</option>
																													
															<option value="45" class="lgtgrey2_bg">Congo, The Democratic Republic</option>
																													
															<option value="47" class="lgtgrey2_bg">Cook Islands</option>
																													
															<option value="51" class="lgtgrey2_bg">Costa Rica</option>
																													
															<option value="43" class="lgtgrey2_bg">Cote d'Ivoire</option>
																													
															<option value="96" class="lgtgrey2_bg">Croatia</option>
																													
															<option value="52" class="lgtgrey2_bg">Cuba</option>
																													
															<option value="55" class="lgtgrey2_bg">Cyprus</option>
																													
															<option value="56" class="lgtgrey2_bg">Czech Republic</option>
																													
															<option value="60" class="lgtgrey2_bg">Denmark</option>
																													
															<option value="58" class="lgtgrey2_bg">Djibouti</option>
																													
															<option value="59" class="lgtgrey2_bg">Dominica</option>
																													
															<option value="61" class="lgtgrey2_bg">Dominican Republic</option>
																													
															<option value="212" class="lgtgrey2_bg">East Timor</option>
																													
															<option value="63" class="lgtgrey2_bg">Ecuador</option>
																													
															<option value="64" class="lgtgrey2_bg">Egypt</option>
																													
															<option value="193" class="lgtgrey2_bg">El Salvador</option>
																													
															<option value="85" class="lgtgrey2_bg">Equatorial Guinea</option>
																													
															<option value="65" class="lgtgrey2_bg">Eritrea</option>
																													
															<option value="68" class="lgtgrey2_bg">Estonia</option>
																													
															<option value="69" class="lgtgrey2_bg">Ethiopia</option>
																													
															<option value="72" class="lgtgrey2_bg">Falkland Islands</option>
																													
															<option value="74" class="lgtgrey2_bg">Faroe Islands</option>
																													
															<option value="71" class="lgtgrey2_bg">Fiji Islands</option>
																													
															<option value="70" class="lgtgrey2_bg">Finland</option>
																													
															<option value="73" class="lgtgrey2_bg">France</option>
																													
															<option value="90" class="lgtgrey2_bg">French Guiana</option>
																													
															<option value="178" class="lgtgrey2_bg">French Polynesia</option>
																													
															<option value="13" class="lgtgrey2_bg">French Southern territories</option>
																													
															<option value="76" class="lgtgrey2_bg">Gabon</option>
																													
															<option value="83" class="lgtgrey2_bg">Gambia</option>
																													
															<option value="78" class="lgtgrey2_bg">Georgia</option>
																													
															<option value="57" class="lgtgrey2_bg">Germany</option>
																													
															<option value="79" class="lgtgrey2_bg">Ghana</option>
																													
															<option value="80" class="lgtgrey2_bg">Gibraltar</option>
																													
															<option value="86" class="lgtgrey2_bg">Greece</option>
																													
															<option value="88" class="lgtgrey2_bg">Greenland</option>
																													
															<option value="87" class="lgtgrey2_bg">Grenada</option>
																													
															<option value="82" class="lgtgrey2_bg">Guadeloupe</option>
																													
															<option value="91" class="lgtgrey2_bg">Guam</option>
																													
															<option value="89" class="lgtgrey2_bg">Guatemala</option>
																													
															<option value="81" class="lgtgrey2_bg">Guinea</option>
																													
															<option value="84" class="lgtgrey2_bg">Guinea-Bissau</option>
																													
															<option value="92" class="lgtgrey2_bg">Guyana</option>
																													
															<option value="97" class="lgtgrey2_bg">Haiti</option>
																													
															<option value="94" class="lgtgrey2_bg">Heard Island and McDonald Isla</option>
																													
															<option value="226" class="lgtgrey2_bg">Holy See (Vatican City State)</option>
																													
															<option value="95" class="lgtgrey2_bg">Honduras</option>
																													
															<option value="93" class="lgtgrey2_bg">Hong Kong</option>
																													
															<option value="98" class="lgtgrey2_bg">Hungary</option>
																													
															<option value="105" class="lgtgrey2_bg">Iceland</option>
																													
															<option value="100" class="lgtgrey2_bg">India</option>
																													
															<option value="99" class="lgtgrey2_bg">Indonesia</option>
																													
															<option value="103" class="lgtgrey2_bg">Iran</option>
																													
															<option value="104" class="lgtgrey2_bg">Iraq</option>
																													
															<option value="102" class="lgtgrey2_bg">Ireland</option>
																													
															<option value="106" class="lgtgrey2_bg">Israel</option>
																													
															<option value="107" class="lgtgrey2_bg">Italy</option>
																													
															<option value="108" class="lgtgrey2_bg">Jamaica</option>
																													
															<option value="110" class="lgtgrey2_bg">Japan</option>
																													
															<option value="109" class="lgtgrey2_bg">Jordan</option>
																													
															<option value="111" class="lgtgrey2_bg">Kazakstan</option>
																													
															<option value="112" class="lgtgrey2_bg">Kenya</option>
																													
															<option value="115" class="lgtgrey2_bg">Kiribati</option>
																													
															<option value="118" class="lgtgrey2_bg">Kuwait</option>
																													
															<option value="113" class="lgtgrey2_bg">Kyrgyzstan</option>
																													
															<option value="119" class="lgtgrey2_bg">Laos</option>
																													
															<option value="129" class="lgtgrey2_bg">Latvia</option>
																													
															<option value="120" class="lgtgrey2_bg">Lebanon</option>
																													
															<option value="126" class="lgtgrey2_bg">Lesotho</option>
																													
															<option value="121" class="lgtgrey2_bg">Liberia</option>
																													
															<option value="122" class="lgtgrey2_bg">Libyan Arab Jamahiriya</option>
																													
															<option value="124" class="lgtgrey2_bg">Liechtenstein</option>
																													
															<option value="127" class="lgtgrey2_bg">Lithuania</option>
																													
															<option value="128" class="lgtgrey2_bg">Luxembourg</option>
																													
															<option value="130" class="lgtgrey2_bg">Macao</option>
																													
															<option value="138" class="lgtgrey2_bg">Macedonia</option>
																													
															<option value="134" class="lgtgrey2_bg">Madagascar</option>
																													
															<option value="149" class="lgtgrey2_bg">Malawi</option>
																													
															<option value="150" class="lgtgrey2_bg">Malaysia</option>
																													
															<option value="135" class="lgtgrey2_bg">Maldives</option>
																													
															<option value="139" class="lgtgrey2_bg">Mali</option>
																													
															<option value="140" class="lgtgrey2_bg">Malta</option>
																													
															<option value="137" class="lgtgrey2_bg">Marshall Islands</option>
																													
															<option value="147" class="lgtgrey2_bg">Martinique</option>
																													
															<option value="145" class="lgtgrey2_bg">Mauritania</option>
																													
															<option value="148" class="lgtgrey2_bg">Mauritius</option>
																													
															<option value="151" class="lgtgrey2_bg">Mayotte</option>
																													
															<option value="136" class="lgtgrey2_bg">Mexico</option>
																													
															<option value="75" class="lgtgrey2_bg">Micronesia, Federated States o</option>
																													
															<option value="133" class="lgtgrey2_bg">Moldova</option>
																													
															<option value="132" class="lgtgrey2_bg">Monaco</option>
																													
															<option value="142" class="lgtgrey2_bg">Mongolia</option>
																													
															<option value="146" class="lgtgrey2_bg">Montserrat</option>
																													
															<option value="131" class="lgtgrey2_bg">Morocco</option>
																													
															<option value="144" class="lgtgrey2_bg">Mozambique</option>
																													
															<option value="141" class="lgtgrey2_bg">Myanmar</option>
																													
															<option value="152" class="lgtgrey2_bg">Namibia</option>
																													
															<option value="162" class="lgtgrey2_bg">Nauru</option>
																													
															<option value="161" class="lgtgrey2_bg">Nepal</option>
																													
															<option value="159" class="lgtgrey2_bg">Netherlands</option>
																													
															<option value="7" class="lgtgrey2_bg">Netherlands Antilles</option>
																													
															<option value="153" class="lgtgrey2_bg">New Caledonia</option>
																													
															<option value="163" class="lgtgrey2_bg">New Zealand</option>
																													
															<option value="157" class="lgtgrey2_bg">Nicaragua</option>
																													
															<option value="154" class="lgtgrey2_bg">Niger</option>
																													
															<option value="156" class="lgtgrey2_bg">Nigeria</option>
																													
															<option value="158" class="lgtgrey2_bg">Niue</option>
																													
															<option value="155" class="lgtgrey2_bg">Norfolk Island</option>
																													
															<option value="174" class="lgtgrey2_bg">North Korea</option>
																													
															<option value="143" class="lgtgrey2_bg">Northern Mariana Islands</option>
																													
															<option value="160" class="lgtgrey2_bg">Norway</option>
																													
															<option value="164" class="lgtgrey2_bg">Oman</option>
																													
															<option value="165" class="lgtgrey2_bg">Pakistan</option>
																													
															<option value="170" class="lgtgrey2_bg">Palau</option>
																													
															<option value="177" class="lgtgrey2_bg">Palestine</option>
																													
															<option value="166" class="lgtgrey2_bg">Panama</option>
																													
															<option value="171" class="lgtgrey2_bg">Papua New Guinea</option>
																													
															<option value="176" class="lgtgrey2_bg">Paraguay</option>
																													
															<option value="168" class="lgtgrey2_bg">Peru</option>
																													
															<option value="169" class="lgtgrey2_bg">Philippines</option>
																													
															<option value="167" class="lgtgrey2_bg">Pitcairn</option>
																													
															<option value="172" class="lgtgrey2_bg">Poland</option>
																													
															<option value="175" class="lgtgrey2_bg">Portugal</option>
																													
															<option value="173" class="lgtgrey2_bg">Puerto Rico</option>
																													
															<option value="179" class="lgtgrey2_bg">Qatar</option>
																													
															<option value="180" class="lgtgrey2_bg">R&amp;ering;union</option>
																													
															<option value="181" class="lgtgrey2_bg">Romania</option>
																													
															<option value="182" class="lgtgrey2_bg">Russian Federation</option>
																													
															<option value="183" class="lgtgrey2_bg">Rwanda</option>
																													
															<option value="189" class="lgtgrey2_bg">Saint Helena</option>
																													
															<option value="116" class="lgtgrey2_bg">Saint Kitts and Nevis</option>
																													
															<option value="123" class="lgtgrey2_bg">Saint Lucia</option>
																													
															<option value="196" class="lgtgrey2_bg">Saint Pierre and Miquelon</option>
																													
															<option value="227" class="lgtgrey2_bg">Saint Vincent and the Grenadin</option>
																													
															<option value="234" class="lgtgrey2_bg">Samoa</option>
																													
															<option value="194" class="lgtgrey2_bg">San Marino</option>
																													
															<option value="197" class="lgtgrey2_bg">Sao Tome and Principe</option>
																													
															<option value="184" class="lgtgrey2_bg">Saudi Arabia</option>
																													
															<option value="186" class="lgtgrey2_bg">Senegal</option>
																													
															<option value="203" class="lgtgrey2_bg">Seychelles</option>
																													
															<option value="192" class="lgtgrey2_bg">Sierra Leone</option>
																													
															<option value="187" class="lgtgrey2_bg">Singapore</option>
																													
															<option value="199" class="lgtgrey2_bg">Slovakia</option>
																													
															<option value="200" class="lgtgrey2_bg">Slovenia</option>
																													
															<option value="191" class="lgtgrey2_bg">Solomon Islands</option>
																													
															<option value="195" class="lgtgrey2_bg">Somalia</option>
																													
															<option value="237" class="lgtgrey2_bg">South Africa</option>
																													
															<option value="188" class="lgtgrey2_bg">South Georgia and the South Sa</option>
																													
															<option value="117" class="lgtgrey2_bg">South Korea</option>
																													
															<option value="67" class="lgtgrey2_bg">Spain</option>
																													
															<option value="125" class="lgtgrey2_bg">Sri Lanka</option>
																													
															<option value="185" class="lgtgrey2_bg">Sudan</option>
																													
															<option value="198" class="lgtgrey2_bg">Suriname</option>
																													
															<option value="190" class="lgtgrey2_bg">Svalbard and Jan Mayen</option>
																													
															<option value="202" class="lgtgrey2_bg">Swaziland</option>
																													
															<option value="201" class="lgtgrey2_bg">Sweden</option>
																													
															<option value="40" class="lgtgrey2_bg">Switzerland</option>
																													
															<option value="204" class="lgtgrey2_bg">Syria</option>
																													
															<option value="218" class="lgtgrey2_bg">Taiwan</option>
																													
															<option value="209" class="lgtgrey2_bg">Tajikistan</option>
																													
															<option value="219" class="lgtgrey2_bg">Tanzania</option>
																													
															<option value="208" class="lgtgrey2_bg">Thailand</option>
																													
															<option value="207" class="lgtgrey2_bg">Togo</option>
																													
															<option value="210" class="lgtgrey2_bg">Tokelau</option>
																													
															<option value="213" class="lgtgrey2_bg">Tonga</option>
																													
															<option value="214" class="lgtgrey2_bg">Trinidad and Tobago</option>
																													
															<option value="215" class="lgtgrey2_bg">Tunisia</option>
																													
															<option value="216" class="lgtgrey2_bg">Turkey</option>
																													
															<option value="211" class="lgtgrey2_bg">Turkmenistan</option>
																													
															<option value="205" class="lgtgrey2_bg">Turks and Caicos Islands</option>
																													
															<option value="217" class="lgtgrey2_bg">Tuvalu</option>
																													
															<option value="220" class="lgtgrey2_bg">Uganda</option>
																													
															<option value="221" class="lgtgrey2_bg">Ukraine</option>
																													
															<option value="8" class="lgtgrey2_bg">United Arab Emirates</option>
																													
															<option value="77" class="lgtgrey2_bg">United Kingdom</option>
																													
															<option value="224" class="lgtgrey2_bg">United States</option>
																													
															<option value="222" class="lgtgrey2_bg">United States Minor Outlying I</option>
																													
															<option value="223" class="lgtgrey2_bg">Uruguay</option>
																													
															<option value="225" class="lgtgrey2_bg">Uzbekistan</option>
																													
															<option value="232" class="lgtgrey2_bg">Vanuatu</option>
																													
															<option value="228" class="lgtgrey2_bg">Venezuela</option>
																													
															<option value="231" class="lgtgrey2_bg">Vietnam</option>
																													
															<option value="229" class="lgtgrey2_bg">Virgin Islands, British</option>
																													
															<option value="230" class="lgtgrey2_bg">Virgin Islands, U.S.</option>
																													
															<option value="233" class="lgtgrey2_bg">Wallis and Futuna</option>
																													
															<option value="66" class="lgtgrey2_bg">Western Sahara</option>
																													
															<option value="235" class="lgtgrey2_bg">Yemen</option>
																													
															<option value="236" class="lgtgrey2_bg">Yugoslavia</option>
																													
															<option value="238" class="lgtgrey2_bg">Zambia</option>
																													
															<option value="239" class="lgtgrey2_bg">Zimbabwe</option>
                          </select>
                          ...
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Phone number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="p_number" id="p_number"  style=" color:grey;" />
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row  margin-bottom24">
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Street address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="address" id="address" style=" color:grey;"  required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="port_number" id="port_number" style=" color:grey;" required>
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="checkout__row  margin-bottom24">
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Zipcode</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="zipcode" id="zipcode" style=" color:grey;" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">City</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="city" id="city" style=" color:grey;" required>
                            </div>
                          </div>
                        </div>  
                      </div>
                      </div>
 <div class="checkout__line  hidden" >
                        <div class="checkout__subtitle">Bank account</div>
                      
                      </div>
                      <div class="checkout__fieldset hidden">
                        
                         
						
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Crypto wallet transfer address</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="account_number" id="account_number" style=" color:grey;" />
                          </div>
                        </div>
						
						<div class="field hidden">
                          <div class="field__label" style="color:#787f91;">IFSC Code</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="ifsc_code" id="ifsc_code" />
                          </div>
                        </div>
 </div>
  ...
  <div class="upload__item">
  <div class="checkout__line   margin-bottom24" >
                        <div class="checkout__subtitle">Other detail</div>
                      
                      </div>
 <div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Service you offer</div>
<div class="field__wrap">
<select  class="select"  id="category_detail" name="category_detail"   fdprocessedid="8mc52">
	    <option value="0" class="lgtgrey2_bg">Select</option>
				  <?php 
 foreach($professionalCategoryDetail as $category => $value) 
			...
			?> 	
                           <option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg changedText"><?php echo $value['category_name']; ?></option>
				<?php } ?>	 	 
                          </select>
</div>
</div>
...
<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Do you have driving license?</div>
<div class="field__wrap">
<select  class="select"  id="price_info" name="price_info"   fdprocessedid="8mc52">
				  <option value="0" class="lgtgrey2_bg">Select</option>
                           <option value="1" class="lgtgrey2_bg changedText">Yes</option>
						   <option value="0" class="lgtgrey2_bg changedText">No</option>		 	 
                          </select>
</div>
</div>
...
<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Gender</div>
<div class="field__wrap">
<select  class="select"  id="gender_info" name="gender_info"   fdprocessedid="8mc52">
				   
                           <option value="1" class="lgtgrey2_bg changedText">Male</option>
						   <option value="2" class="lgtgrey2_bg changedText">Female</option>		 	 
                          </select>
</div>
</div>
...
<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">English profiency level</div>
<div class="field__wrap">
<select  class="select"  id="english_profiency_level" name="english_profiency_level"   fdprocessedid="8mc52">
				   
                           <option value="A1: Beginner + Elementary" class="lgtgrey2_bg changedText">A1: Beginner + Elementary</option>
						   <option value="A2: Pre-Intermediate" class="lgtgrey2_bg changedText">A2: Pre-Intermediate</option>	
							<option value="B1: Intermediate" class="lgtgrey2_bg changedText">B1: Intermediate</option>
						   <option value="B2: Upper-Intermediate" class="lgtgrey2_bg changedText">B2: Upper-Intermediate</option>
							<option value="C1: Advanced" class="lgtgrey2_bg changedText">C1: Advanced</option>
						  <option value="C2: Proficient" class="lgtgrey2_bg changedText">C2: Proficient</option>  					   
                          </select>
</div>
</div> 
...
<div class="field margin-bottom24">
                          <div class="field__label" style="color:#787f91;">Linkedin</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="linkdn_profile" id="linkdn_profile" />
                          </div>
                        </div>
...
<div class="field margin-bottom24">
                          ...
                          <div class="field__wrap">
                            <textarea class="field__textarea" name="experience_info" id="experience_info" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" required=""></textarea>
                          </div>
                        </div>
						
						
			<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">When can you start</div>
<div class="field__wrap">
<select  class="select"  id="start_time" name="start_time"   fdprocessedid="8mc52">
				   
                           <option value="Now" class="lgtgrey2_bg changedText">Now</option>
						   <option value="Within 1 month" class="lgtgrey2_bg changedText">Within 1 month</option>	
							<option value="After 2 months" class="lgtgrey2_bg changedText">After 2 months</option>
						   <option value="After 3 months" class="lgtgrey2_bg changedText">After 3 months</option>
...
<div class="checkout__line  margin-bottom24">
					   <div class="checkout__subtitle">Other languages you speak</div>
                       
                      </div>
 <?php 
 foreach($languageList as $category => $value) 
				{
...
<input class="checkbox__input" type="checkbox"  onclick="updateInclutionType(<?php echo $value['id']; ?>)" id="<?php echo $value['id']; ?>"><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text changedText"><?php echo $value['language_name']; ?></span></span>
</label>
<?php } ?>	
...
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="submitform();">Send</a>
</form>
 </div>
</div>
</div>
