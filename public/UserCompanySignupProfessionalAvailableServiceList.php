...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../../../../../../companiesList/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>" style="
		...
		<div class="section flights">
          <div class="flights__center center">
           ...
           <div class="sorting" style="margin-bottom:15px;">
            <div class="sorting__center margin-bottom24">
              
              
              <div class="product__head xs-mart65 mart100" style=" margin-bottom:15px;">
<div class="product__box  " >
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><?php echo count($getProfessionalBookableServices); ?> services available</h2>

<h2 class="main__info info  tall  brdb xs-nobrd padb20 xs-padt20" style="font-weight: 100;color: #00000;max-width: 100%;">Select a service to book
</h2></div>

</div>
           
			   <script>
				 function getCarTypes(id1,id)
				  {
					  
					var getValue=$('#car_body_type').val();
            ...
            <div class="flights__row">
              <div class="flights__filters">
                <div class="flights__group">
				  ...
				  <script>
				  function getSharedTypes(id1,id)
				  {
					  var getValue=$('#one_shared').val();
					   var getValue1=$('#one_shared_type').val();
					  if($(id1).hasClass('checked'))
					  {
						$(id1).removeClass('checked');
						if(id==1)
						{
						getValue = getValue.replace(id+",", "");  	
						$('#one_one_updated').val(0);
						}
						else
						{
							var oneType=id-1;
							getValue1 = getValue1.replace(oneType+",", "");  
							if(getValue1=='')
							{
								getValue = getValue.replace("2,", "");  
								$('#one_shared_updated').val(0);
							}
						}
					  ...
					  else
					  {
						...
						$('#one_one_updated').val(1);
						}
						else
						{
							var oneType=id-1;
							var oneType2=2;
							getValue1=getValue1+oneType+',';
							if($('#one_shared_updated').val()==0)
							{
								getValue=getValue+oneType2+',';
								$('#one_shared_updated').val(1);
							}
					  ...
					  $('#one_shared').val(getValue);
					  $('#one_shared_type').val(getValue1);
					 getServiceListing();
				  }
				 ...
				 <div class="range__label">Service category</div>
                    <div class="flights__variants">
					 <label class="checkbox">
                        <input class="checkbox__input" type="checkbox"  id="1"  ><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text">One to one</span></span></span>
                      </label>
					   <label class="checkbox">
                        <input class="checkbox__input" type="checkbox" id="2"  ><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text">Public</span></span></span>
                      </label>
					   <label class="checkbox">
                        <input class="checkbox__input" type="checkbox" id="3"  ><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text">Private</span></span></span>
                      </label>
					   <label class="checkbox">
                        <input class="checkbox__input" type="checkbox" id="4"  ><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text">Shared public/private</span></span></span>
                      </label>
					   
                       
                    </div>
                  </div>
				 <input type="hidden" name="one_one_updated" id="one_one_updated" value="0" /> 
				  <input type="hidden" name="one_shared_updated" id="one_shared_updated" value="0" /> 
				   <input type="hidden" name="one_shared" id="one_shared" value="" /> 
				  
				  <input type="hidden" name="one_shared_type" id="one_shared_type" value="" />
				 ...
				 function getServiceListing()
				  {
					...
					var send_data={};
					send_data.one_shared_updated=$("#one_shared_updated").val(); 
					send_data.one_shared=$("#one_shared").val();
					send_data.one_one_updated=$("#one_one_updated").val();
					send_data.one_shared_type=$("#one_shared_type").val();
					send_data.category='<?php echo $_GET['category']; ?>'; 
					send_data.city='<?php echo $_GET['city']; ?>';  
					$.ajax({
						type:"POST",
						url:"../../../getProfessionalBookingFilteredServices/<?php echo $data['checkout_id']; ?>/<?php echo $data['professional_subcategory_id']; ?>/<?php echo $data['company_id']; ?>",
						data:send_data,
						dataType:"text",
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
				  ...
				  <a class="card card_row" href="../../../../../../../../<?php if($value['one_shared']==1 || $value['one_shared_type']==2) echo 'serviceEmployeeList'; else echo 'sharedServiceDetail'; ?>/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="margin-bottom:24px;">
                  <div class="card__preview"><img srcset="<?php echo $value['dish_image']; ?>" src="<?php echo $value['dish_image']; ?>" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category" style="background:#E8681F !important;">best selling</div>
                  </div>
                  <div class="card__body" >
                    <div class="card__line">
                      <div class="flight__title" style="font-size:30px;"><?php echo $value['dish_name']; ?></div>
                      <div class="card__price" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099;">
                        <div class="card__old">$<?php echo $value['dish_price']; ?></div>
                        <div class="card__actual">$<?php echo $value['dish_price']; ?></div>
                      </div>
                    </div>
                    ...
                    <div class="card__foot">
                      <div class="card__comment">
                        ...
                        <div class="card__text  fsz14"><?php echo $value['dish_detail']; ?> </div>
                      </div>
                      <div class="card__flex">
                        <div class="card__cost fsz16" >$<?php echo $value['dish_price']; ?> total</div>
