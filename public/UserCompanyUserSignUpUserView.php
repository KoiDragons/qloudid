				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="../../addUserDetails/<?php echo $data['domain_id']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
								...
								<div id="profile" class=" " style="display:block;">	
											...
											<div class="pos_rel">
												...
												<input type="text" name="email" id="email" placeholder="Email address" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="qc7t4r" value="<?php echo $emailRequestReceivedInfo['email']; ?>" readonly> 
