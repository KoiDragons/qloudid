				...
				$.ajax({
					...
					success: function(data1){
						...
						else 
						{
							...
							window.location.href ="https://www.safeqloud.com/public/index.php/NotifyFamilyFriends/thanksForTheInformation";
						}
					}
				});
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.safeqloud.com/public/index.php/NotifyFamilyFriends/addImage/<?php echo $data['id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
