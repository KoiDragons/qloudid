...
<div class="product__head  xs-mart45" style="margin-top:65px; margin-bottom:55px;">
<div class="product__box " >
<h2 class="product__title padrl120 xs-padrl0 h2 xs-fsz70 talc xs-tall   fsz80 lgn_hight_90 xs-lgn_hight_75" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">HAVE IT DONE</h2>

<h2 class="main__info info padrl120 xs-padrl0 xs-tall talc" style="font-weight: 100;color: black;max-width: 100%;">65,411 professionals available for your project.
</h2></div>

</div>
<div class="main__center center marrla mart65 xs-mart25" style="    max-width: 1180px;">

 
 <!--<div class="section categories  marl6 " style="margin-bottom: 16px; ">
<div class="categories__center center1" style="padding-bottom:0px !important; border-bottom:none;" >
<div class="categories__inner">

 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			   <?php $i=0; foreach($marketplaceSelectedDomainList  as $category => $value) { ?>
				<a class="categories__item <?php if($i==0) echo 'black_bg'; else echo 'bg_E7E7E7'; ?>" href="#" style="padding: 20px; font-size:14px; border-radius:6px; " onclick="submitTab(<?php echo $value['id']; ?>)">
                                       
                                      <div class="categories__subtitle <?php if($i==0) echo 'white_txt'; else echo 'txt_787f91'; ?>"><?php echo $value['marketplace_domain_type']; ?></div>
                                      </a>
			   <?php $i++;} ?>
 ...
 <form action="../selectProposalCity/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing1" id="save_indexing1" accept-charset="ISO-8859-1">

<input type="hidden" id="md_id" name="md_id" value="" />
...
<div class="panel panel_stays  " style="margin: 0px 0px 0px 0px;">
...
<?php if($selectedMarketplaceDetail['booking_signup_type']==3)
		{
		  ?>
<a href="../selectCity/<?php echo $data['domain_id']; ?>" class="button-stroke button-small panel__button ">Book a pro</a>
		
<a href="javascript:void(0);" class="button-stroke button-small panel__button active" style="background: #FCFCFD;
    color: #23262F;">Compare prices</a>
		<?php } ?>
</div>
<div class="panel__body" style="margin-top:10px">
<div class="panel__row">
<div class="location js-location wi_80" style="flex:0 0 250px;">
<div class="location__head js-location-head">
<div class="location__icon">
<svg class="icon icon-location" style="fill:#e11936 ;">
...
<div class="location__list"><?php echo $vitechCityList; ?></div>
</div>
</div>
</form>
<a class="panel__search" href="#" onclick="submitForm();" style="background:#e11936   !important;">
<svg class="icon icon-search">
<use xlink:href="#icon-search" style="fill:white;"></use>
</svg></a>
</div>
</div>
</div>
