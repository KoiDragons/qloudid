...
//print_r($data); die;
  ...
  <body class="font_poppins fsz14  dark "   style="background: #131922;">
<script>
...
function changeDisplay1()
    ...
    <div class="column_m     bs_bb lgtgrey2_bg visible-xs  " style="height:93px;  position:relative; z-index:10; background-color:  transparent;">
				...
				<div  class="xs-padrl25 xs-pos_fix " style="display:flex; position: relative;">
				 <div>
<a class="header__logo xs-fsz20 changedText" href="../../propertyProposalDetail/<?php echo $data['proposal_id']; ?>" style="
...
"><?php echo $employeeDetail['company_name']; ?></button>
...
<button class="header__head js-header-head   hidden-xxs changedText" style="
...
<use xlink:href="#icon-user" style="fill:black"></use>
	  ...
	  <div class="product  ">
          <div class="product__center center">
            <div class="control" style="margin-bottom:0px;"><a class="button-stroke button-small control__button" href="../../propertyProposalDetail/<?php echo $data['proposal_id']; ?>">
                <svg class="icon icon-arrow-left">
                  <use xlink:href="#icon-arrow-left"></use>
                </svg><span class="changedText">Go home</span></a>
              <ul class="breadcrumbs" style="list-style-type: none;">
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="../../propertyProposalDetail/<?php echo $data['proposal_id']; ?>">Proposal</a></li>  <?php $i=1; 
								foreach($displayProposalProperties as $category => $value) 
										{
											if($value['enc']!=$data['selected_property_id'])
												continue;
										 ?>
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="../../propertyProposalInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>"><?php echo $value['sellPhrase']; ?></a></li>
										<?php } ?>
...
<div class="destinations__center center" style="border-bottom: 1px solid #23262F;padding-bottom: 15px;max-width: 1132px;">
</div>
</div>
        <div class="section-mb64 product" style="padding-top:0px;">
          <div class="product__center center">
             
            <div class="product__head" style="display:none;">
              <div class="product__box">
                <h2 class="product__title h2 changedText"><?php if($getPropertyDetailInfo['sellPhrase']=='' || $getPropertyDetailInfo['sellPhrase']==null) echo 'Spectacular views of Queenstown'; else echo $getPropertyDetailInfo['sellPhrase']; ?></h2>
                <div class="product__line">
                  <div class="product__avatar hidden"><img src="https://dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar"></div>
                  <div class="product__rating">
                    <svg class="icon icon-star">
                      <use xlink:href="#icon-star"></use>
                    </svg>
                    <div class="product__number">4.8</div>
                    <div class="product__reviews changedText">(256 reviews)</div>
                  </div>
                  <div class="product__options">
                    ...
                    <div class="product__option">
                      ...
                      </svg><span class="changedText"><?php if($getPropertyDetailInfo['streetAddress']!=null || $getPropertyDetailInfo['streetAddress']!='') echo $getPropertyDetailInfo['streetAddress'].' , '; if($getPropertyDetailInfo['city']!=null || $getPropertyDetailInfo['city']!='') echo $getPropertyDetailInfo['city'].' , '; if($getPropertyDetailInfo['country']!=null || $getPropertyDetailInfo['country']!='') echo $getPropertyDetailInfo['country']; ?></span>
                    </div>
                  </div>
                </div>
              </div>
			  ...
			  <div class="actions js-actions">
                <div class="actions__list">
                  <div class="actions__item actions__item_map js-actions-item">
                    <button class="button-circle-stroke button-small actions__button js-actions-button" fdprocessedid="1lkjnd">
                  ...
                  <div class="actions__item actions__item_share js-actions-item">
                    <button class="button-circle-stroke button-small actions__button js-actions-button" fdprocessedid="13lpss">
                  ...
                  <div class="actions__item">
                    <button class="button-circle-stroke button-small actions__favorite js-actions-favorite" fdprocessedid="zvzjep">
                  ...
                  <div class="actions__item"><a class="button-circle-stroke button-small actions__button" href="#">
			 ...
			 <div class="gallery imageBorder"  style="border-radius: 12px;">
              <div class="xs-maxheight390">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view xs-maxheight254" href="<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#" class="xs-brdrad10">
                     </a></div>
        ...
        <div class="section description">
          ...
          <div class="description__center center">
            <div class="description__wrapper">
              ...
              <h4 class="description__title h4 changedText"><?php if($getPropertyDetailInfo['sellPhrase']=='' || $getPropertyDetailInfo['sellPhrase']==null) echo 'Spectacular views of Queenstown'; else echo $getPropertyDetailInfo['sellPhrase']; ?></h4>
              <div class="description__profile product__rating"><svg class="icon icon-star">
                      <use xlink:href="#icon-star"></use>
                    </svg><span class="changedText">4.8 (256 reviews)</span>
                <div class="description__avatar hidden"><img src="https://dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar"></div>
                <div class="description__name changedText changedText " style="margin-left:15px; color: #777E90; font-size:14px;"><svg class="icon icon-flag">
                        <use xlink:href="#icon-flag" style="fill: #777E90;"></use>
                      </svg><?php if($getPropertyDetailInfo['streetAddress']!=null || $getPropertyDetailInfo['streetAddress']!='') echo $getPropertyDetailInfo['streetAddress'].' , '; if($getPropertyDetailInfo['city']!=null || $getPropertyDetailInfo['city']!='') echo $getPropertyDetailInfo['city'].' , '; if($getPropertyDetailInfo['country']!=null || $getPropertyDetailInfo['country']!='') echo $getPropertyDetailInfo['country']; ?></div>
              </div>
              <div class="description__parameters">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText">2 guests</span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php echo $getPropertyDetailInfo['numberOfBedrooms']; ?> bedrooms</span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php echo $getPropertyDetailInfo['numberOfBathrooms']; ?> WC</span>
                </div>
              </div>
              <div class="description__content">
                <p  class="changedText"><?php if($getPropertyDetailInfo['longSellingDescription']=='' || $getPropertyDetailInfo['longSellingDescription']==null) echo 'Described by Queenstown House & Garden magazine as having one of the best views we have ever seen you will love relaxing in this newly built, architectural house sitting proudly on Queenstown Hill. Enjoy breathtaking 180 views of Lake Wakatipu from your well appointed & privately accessed bedroom with modern en suite and floor-to-ceiling windows.Your private patio takes in the afternoon sun, letting you soak up unparalleled lake and mountain views by day and the stars & city lights by night.'; else echo $getPropertyDetailInfo['longSellingDescription']; ?></p>
              </div>
              <div class="description__info changedText">Amenities</div>
              <div class="description__options">
			  <?php if($getPropertyDetailInfo['pool']==1) { ?>
                <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Pool</span>
                </div>
			  <?php } if($getPropertyDetailInfo['terrace']==1) { ?>
                <div class="description__option">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-toilet-paper"></use>
                  </svg><span class="changedText">Terrace</span>
                </div>
				<?php } if($getPropertyDetailInfo['balcony']==1) { ?>
                <div class="description__option">
                  <svg class="icon icon-monitor">
                    <use xlink:href="#icon-monitor"></use>
                  </svg><span class="changedText">Balcony</span>
                </div>
				<?php } if($getPropertyDetailInfo['elevator']=='Yes') { ?>
                <div class="description__option">
                  <svg class="icon icon-burger">
                    <use xlink:href="#icon-burger"></use>
                  </svg><span class="changedText">Elevator</span>
                </div> 
				<?php } if($getPropertyDetailInfo['private_entrance']=='Yes') { ?>
                <div class="description__option">
                  <svg class="icon icon-medical-case">
                    <use xlink:href="#icon-medical-case"></use>
                  </svg><span class="changedText">Private entrance</span>
                </div>
				<?php } ?>
                 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Resturant</span>
                </div>
				
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Bar</span>
                </div>
				
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Jacuzzi</span>
                </div>
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Wi-Fi</span>
                </div>
				
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Parking</span>
                </div>
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Garden</span>
                </div>
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Play area</span>
                </div>
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Pick-up & Drop</span>
                </div>
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Cafe</span>
                </div>
				 <div class="description__option">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg><span class="changedText">Bonefire</span>
                </div>
              </div>
             
            </div>
			
			<div class="receipt" style="border: 1px solid #353945 !important; background:transparent;">
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old hidden">$20000</div>
                    <div class="receipt__actual">$20000</div>
                    <div class="receipt__note changedText">/night</div>
                  </div>
                  <div class="receipt__rating">
                    ...
                    <div class="receipt__reviews changedText">(256 reviews)</div>
                  </div>
                </div>
                <div class="receipt__avatar"><img src="<?php echo $imgs; ?>" alt="Avatar">
              ...
              <div class="receipt__description receipt__description_flex  " style="background:#23262F;">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Building class</div>
                    <div class="receipt__subtitle"><?php echo $getPropertyDetailInfo['building_class']; ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Property type</div>
                    <div class="receipt__subtitle"><?php echo $getPropertyDetailInfo['propertyType']; ?></div>
                  </div>
                </div>
 ...
 <div class="profile__parameters xs-padrl0" style="background: #1b2739;">
			 ...
			 <div class="receipt__btns">
                <button class="button-stroke receipt__button changedText" fdprocessedid="ebxsyj"><span>Save</span><span>
                    <svg class="icon icon-plus">
                      <use xlink:href="#icon-plus"></use>
                    </svg>
                    <svg class="icon icon-check">
                      <use xlink:href="#icon-check"></use>
                    </svg></span></button><a class="button receipt__button changedText" href="#" style="background:#F67F00; color:#000000;"><span>Connect</span>
              ...
              <div class="receipt__table">
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Property view</div>
                  <div class="receipt__cell"><?php echo $getPropertyDetailInfo['property_view']; ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Property condition</div>
                  <div class="receipt__cell"><?php echo $getPropertyDetailInfo['property_condition']; ?></div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Property availability</div>
                  <div class="receipt__cell"><?php echo $getPropertyDetailInfo['property_availability']; ?></div>
                </div>
				 <div class="receipt__line hidden">
                  <div class="receipt__cell changedText">Building class</div>
                  <div class="receipt__cell"><?php echo $getPropertyDetailInfo['building_class']; ?></div>
                </div>
                <div class="receipt__line" style="background: transparent;">
                  <div class="receipt__cell changedText" style="color: #777E90;">Property furnishings</div>
                  <div class="receipt__cell"><?php echo $getPropertyDetailInfo['property_furnishings']; ?></div>
                </div>
				<div class="receipt__line" style="background: transparent;">
                  <div class="receipt__cell changedText" style="color: #777E90;">Short term rental</div>
                  <div class="receipt__cell"><?php if($getPropertyDetailInfo['short_term_rental']==1) echo $getPropertyDetailInfo['short_term_commision_fee']; ?></div>
                </div>
				<div class="receipt__line" style="background: transparent;">
                  <div class="receipt__cell changedText" style="color: #777E90;">Long term rental</div>
                  <div class="receipt__cell"><?php if($getPropertyDetailInfo['long_term_rental']==1) echo $getPropertyDetailInfo['long_term_commision_fee']; ?></div>
                </div>
				<div class="receipt__line" style="background: transparent;">
                  <div class="receipt__cell changedText" style="color: #777E90;">Annual community fee</div>
                  <div class="receipt__cell"><?php echo $getPropertyDetailInfo['annual_community_fee']; ?></div>
                </div>
              </div>
			   ...
			   <div class="travel__wrapper hidden">
                  <div class="travel__slider js-slider-travel">
                      <div class="upload__preview bg_131922 js-upload-preview xs-pad0">
<div class="profile xs-nobrd " style="background: #131922;">
                <div class="profile__main">
                  <div class="profile__avatar xsi-wihi_128p"><img src="<?php echo $imgs; ?>" alt="Avatar"></div><a class="profile__update js-popup-open" href="#popup-avatars" data-effect="mfp-zoom-in" tabindex="0">
                    <svg class="icon icon-pencil">
                      <use xlink:href="#icon-pencil"></use>
                    </svg><span class="changedText">Update avatar</span></a>
                  <div class="profile__man changedText"><?php echo $employeeDetail['first_name']." ".$employeeDetail['last_name']; ?></div>
                </div>
                <div class="profile__body">
                  ...
                  <div class="profile__socials"><a class="profile__social" href="javascript:void(0);" tabindex="0">
                      <svg class="icon icon-apple">
                        <use xlink:href="#icon-apple" style="fill:<?php if(($employeeDetail['phone']=="" || $employeeDetail['phone']==null) && ($employeeDetail['mobile']=="" || $employeeDetail['mobile']==null) && ($employeeDetail['cphone']=="" || $employeeDetail['cphone']==null || $employeeDetail['cphone']=='-')) echo 'red'; else { if($employeeDetail['f_color']=="" || $employeeDetail['f_color']==null) echo "#000000"; else echo '#'.$employeeDetail['f_color']; } ?>"></use>
                      </svg></a><a class="profile__social" href="<?php if($employeeDetail['mobile']==null || $employeeDetail['mobile']=='') echo'#'; else echo 'sms:+'.$employeeDetail['mobile_country_code'].''.$employeeDetail['mobile']; ?>" tabindex="0">
                      <svg class="icon icon-comment">
                        <use xlink:href="#icon-comment" style="fill: <?php if($employeeDetail['mobile']==null || $employeeDetail['mobile']=='') echo'red'; else { if($employeeDetail['f_color']=="" || $employeeDetail['f_color']==null) echo "#000000"; else echo '#'.$employeeDetail['f_color']; } ?>"></use>
                      </svg></a>
					  <a class="profile__social" href="<?php if($employeeDetail['work_email']==null || $employeeDetail['work_email']=='') echo'#'; else echo 'mailto:'.$employeeDetail['work_email']; ?>" tabindex="0">
                      <svg class="icon icon-email">
                        <use xlink:href="#icon-email" style="fill: <?php if($employeeDetail['work_email']==null || $employeeDetail['work_email']=='') echo'red'; else { if($employeeDetail['f_color']=="" || $employeeDetail['f_color']==null) echo "#000000"; else echo '#'.$employeeDetail['f_color']; } ?>"></use>
                      </svg></a>
					   <a class="profile__social" href="https://maps.google.com/?q=<?php echo  $employeeDetail['location']; ?>" tabindex="0">
                      <svg class="icon icon-home">
                        <use xlink:href="#icon-home"  style="fill: <?php if($employeeDetail['f_color']=="" || $employeeDetail['f_color']==null) echo "#000000"; else echo '#'.$employeeDetail['f_color'];  ?>"></use>
                      </svg></a>
					  </div>
                  <div class="profile__note changedText">Employee at <?php echo substr(html_entity_decode($employeeDetail['company_name']),0,15); ?></div>
