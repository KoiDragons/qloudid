...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Invite</h2>
<div class="browse__info info changedText">Please select an option and invite guest</div>
</div>
...
<div class="checkout__label changedText">Invitation</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">By Email</div>
 
<div class="checkout__controls">
<a href="../emailInvitaionInfo/<?php echo $data['hotel_checkin_id']; ?>">	<button class="checkout__edit"  >
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">By phone</div>
 
<div class="checkout__controls">
<a href="../phoneInvitaionInfo/<?php echo $data['hotel_checkin_id']; ?>">	<button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
