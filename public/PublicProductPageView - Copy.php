	...
	<body class="fsz14 white_bg">
		...
		<div class="fright xs-dnone sm-dnone padt10 padb10">
					<ul class="menulist sf-menu fsz16 black_txt">
							<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue first"><a href="https://www.qloudid.com" class="translate hei_30pi dblock padrl10 blue_bg_h  lgn_hight_30 black_txt white_txt_h">Privat</a></li>
							<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue"> <a href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/CorporateServices" id="usermenu_singin" class="translate hei_30pi dblock padrl10 blue_bg_h  lgn_hight_30 black_txt white_txt_h" data-en="Företag" data-sw="Företag">Företag</a> </li>
							...
							<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue ">
										...
										<div class="lgtgrey_txt fsz13 padrl15">Du har 6 språk att välja emellan</div>
											<ol>
												...
												<li class="fsz14 valm padb10 ">
													...
													<div class="padl20 padtb10 brdb_new"> <a href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/PublicNews" class="fsz16 black_txt"  >  Våra partners</a> </div>
												</li>
												<li>
													
													<div class="padl20 padtb10 valm"> <a href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/InformRelatives" class="fsz16 black_txt" data-value="en" >  Kalender </a> </div>
												</li>
												</ol>
								...
								<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue hidden"> <a href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/InformRelatives" id="usermenu_singin" class="translate hei_30pi dblock padrl10 blue_bg_h  lgn_hight_30 black_txt white_txt_h" data-en="sos" data-sw="sos">NOTIFY <span class="fa fa-heart red_txt"></span> F&F </a> </li>
		...
		<div class="column_m container zi5 mart40 xs-mart20 white_bg" onclick="checkFlag();">
			...
			<div class="wi_240p fleft pos_rel zi50">
								...
								<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03  brdr_new fsz14" id="scroll_menu">
									<div class="column_m padb10 ">
										<div class="padl10">
											<div class="sidebar_prdt_bx marr20 brdb_b padb10">
												...
												<!-- Logo -->
												<div class="pad20 wi_100 xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz95 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey2_bg black_txt" style="
													background-repeat: no-repeat;
													background-position: 50%;
													border-radius: 2%;
													" id="aa_1227620">A</div><a href="#" class="black_txt fsz45 xs-fsz30 sm-fsz30 ">
														<!-- Meta -->
														<div class="padtr10 fsz15"> <span><?php echo $getAppsPermissionDetail['app_name']; ?></span>  </div>
													</a></div>
											</div>		
											<div class="clear"></div>
										</div>
									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock padb10 padl8">
											<a href="#" class="active lgtgrey_bg hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
												<span class="valm trn fsz14">Produkt info</span>
					...
					<!-- Center content -->
					<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xs-padl5">
				<div class="dflex xs-dblock justc_c alit_c fsz22 xs-fsz18 darkgrey_txt padrl0 padb10 brdb_new  xs-padrl0 hidden">
					<div class="wi_20 xs-wi_20">
					 <div class="hei_120p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz75 xs-fsz45 brdrad1000 yellow_bg_a lgtgrey_bg" style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%; "> <?php echo substr($getAppsPermissionDetail['app_name'],0,1);  ?> </div> 
						<div class="talc fsz75 green_txt hidden"> <span class="fas fa-mail-bulk"></span></div>
					</div>
					<div class="wi_80 xs-wi_100 bs_bb padl40 xs-padl0 tall xs-talc">
						
						<h2 class=" bold fsz24 xs-fsz22 black_txt"><?php echo $getAppsPermissionDetail['app_name']; ?>   </h2>
						...
						<div class="mart0 talc">
													<a href="../../downloadApp/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>"><input type="button" value="Download" class="wi_25 maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp fleft talc xxs-nofloati"  ></a>
				...
				<div class="column_m container zi1 padb5">
								...
								<div class="white_bg tall">
									...
									<!-- Logo -->
									<h1 class="fsz25 bold"><?php echo $getAppsPermissionDetail['app_name']; ?> </h1>
									<!-- Logo -->
									<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text jain_drop_company">Company apps info.</a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
										<!-- Meta -->
								...
								<?php if($getAppsPermissionDetail['is_downloaded']==0) { ?>
										<div class=" padrl10">
									<a href="../../downloadApp/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>" class="diblock padrl20 brd brdrad3 panlyellow_bg ws_now lgn_hight_29 fsz14 black_txt ">
				...
				<!-- BEST SCREENSHOT -->
		<div class="column_m padb20  xs-padtb10 talc lgn_hight_22 fsz16 white_bg <?php if($getAppsPermissionDetail['app_id']==1 || $getAppsPermissionDetail['app_id']==2 || $getAppsPermissionDetail['app_id']==3 || $getAppsPermissionDetail['app_id']==6  || $getAppsPermissionDetail['app_id']==12 || $getAppsPermissionDetail['app_id']==13) echo 'hidden'; ?>" onclick="checkFlag();">
			
			<div class="wrap maxwi_100  xs-padr25 xs-padl10 padt40 xs-padt0  white_bg">
		...
		<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 white_bg <?php if($getAppsPermissionDetail['app_id']>3 && $getAppsPermissionDetail['app_id']<12) echo 'hidden'; if($getAppsPermissionDetail['app_id']>13) echo 'hidden';   ?>" onclick="checkFlag();">
			
			<div class="wrap maxwi_100  xs-padr25 xs-padl10  padt20 xs-padt0 white_bg  brdb_new tall">
				
				<img src="<?php echo $getAppsPermissionDetail['image_path']; ?>"  class="image_dimensions xs-image_dimensions bxsh_0220_0_14_031-2_0_2_0150_0_12 bxsh_0_trans_0_trans_02150_0_3 bxsh_0004_6f_sibc" />
		...
		<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 white_bg <?php if($getAppsPermissionDetail['app_id']!=6) echo 'hidden'; ?>" onclick="checkFlag();">
			
			<div class="wrap maxwi_100  xs-padr25 xs-padl10  padt20 xs-padt0 white_bg  brdb_new tall">
				
				<img src="http://fabrikbrands.com/wp-content/uploads/Brand-Loyalty.gif"  class="image_dimensions xs-image_dimensions bxsh_0220_0_14_031-2_0_2_0150_0_12 bxsh_0_trans_0_trans_02150_0_3 bxsh_0004_6f_sibc" />
				...
				<section class=" section  whats-new xs-padt0">
					...
					<div class="l-row whats-new__content">
						...
						<div class="l-column small-12 medium-9 large-8a small-valign-top">
							<div id="ember239" class="we-truncate we-truncate--multi-line we-truncate--interactive ember-view fsz14">    
								
								  <?php echo html_entity_decode($getAppsPermissionDetail['presentation']); ?>
