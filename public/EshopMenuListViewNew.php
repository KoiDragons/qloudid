    ...
    <div class="outer">
     <header class="header js-header header_border bgcolor_F4B400 xs-padding2424">
      ...
      <div class="outer__inner">
	   <div class="section-mb64 product " style="margin-top:80px;">
          <div class="product__center center">
            
            <div class="product__head" style="margin-bottom:20px;">
              <div class="product__box">
                <h2 class="product__title h2">Shop online</h2>
                <div class="product__line">
                  ...
                  <div class="product__options">
                    ...
                    <div class="product__option">
                      ...
                      </svg><?php echo $companyDetail['address']; ?>
                    </div>
                  </div>
                </div>
              </div>
			...
			<div class="gallery">
              <div class="gallery__list gallery__list_stays">
                <div class="gallery__preview"><a class="gallery__view" href="../../../<?php echo $displayPhotos[0]['image_path1']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="../../../<?php echo $displayPhotos[0]['image_path1']; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#">
                    <svg class="icon icon-image">
                      <use xlink:href="#icon-image"></use>
                    </svg><span>Show all photos</span></a></div>
					<?php  $i=1; foreach($displayPhotos as $category => $value)
												{
													if($i==1){ $i++; continue;}
												if($i>4) { $display='none'; } else { $display='block'; } ?>
					<a class="gallery__preview" href="../../../<?php echo $value['image_path1']; ?>" data-fancybox="gallery"><img src="../../../<?php echo $value['image_path1']; ?>" alt="Gallery" style="display:<?php echo $display; ?>"></a> 
												<?php $i++; } ?>
              </div>
            </div>
		...
		<div class="description" style="padding-bottom: 30px; margin-bottom:60px; display:none;">
          <div class="description__center center">
            <div class="description__wrapper">
              <h4 class="description__title h4 xs-fsz32 fsz48 margin-bottom16"><?php if($businessImageDetail['free_text']=='' || $businessImageDetail['free_text']==null) echo $companyDetail['company_name']; else  echo substr($businessImageDetail['free_text'],0,12); ?></h4>
			...
			<div class="sorting__location" style="margin-left: 448px !important;">
             <div class="sorting__map_update js-sorting-map show" style="visibility: visible; opacity:1; width:448px; border-radius: 24px 24px 24px 24px !important;">
		...
		<!--<div class="description" style="padding-bottom: 30px; margin-bottom:30px;">
          <div class="description__center center">
            <div class="description__wrapper">
              <h4 class="description__title h4">Short about <?php echo $resturantInfo['property_nickname']; ?></h4>
              ...
              <div class="description__content">
                <p><?php echo html_entity_decode($resturantInfo['description']); ?></p>
			...
			<div class="sorting__location" style="margin-left: 440px !important;">
             <div class="sorting__map_update js-sorting-map show" style="visibility: visible; opacity:1;">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63817.0803287881!2d168.63234961382247!3d-45.04173987887954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa9d51df1d7a8de5f%3A0x500ef868479a600!2z0JrRg9C40L3RgdGC0LDRg9C9LCDQndC-0LLQsNGPINCX0LXQu9Cw0L3QtNC40Y8!5e0!3m2!1sru!2sua!4v1624887132616!5m2!1sru!2sua" width="460" height="290" style="border-radius:10px;" loading="lazy"></iframe>
                  </div>
				   </div>
	  ...
	  <?php foreach($completeServiceInfo as $category => $value) 
												{ ?>
         <div class="section browse">
          <div class="browse__center center">
            <div class="browse__inner">
              <div class="browse__head">
                <h2 class="browse__title h2"><?php   echo $value['category_name']; ?></h2>
              ...
              <div class="browse__wrapper">
				...
				<a class="browse__card" href="../productInformation/<?php echo $data['cid']; ?>/<?php echo $value2['enc']; ?>">
                                      ...
                                      <div class="browse__content">
                                        <svg class="icon icon-home">
                                          <use xlink:href="#icon-home"></use>
                                        </svg><?php echo $value2['dish_price'];?> kr
                                      </div></a> 
												<?php } ?>
                </div>
              </div>
