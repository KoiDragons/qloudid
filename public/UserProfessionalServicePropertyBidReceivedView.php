               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../listRequests/<?php echo $serviceRequestDetailInfo['uid']; ?>/<?php echo $data['domain_id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
		 	...
		 	<div class="column_m header hei_60p bs_bb lgtgrey2_bg visible-xs">
				...
				<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../listRequests/<?php echo $serviceRequestDetailInfo['uid']; ?>/<?php echo $data['domain_id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left txt_c12219" aria-hidden="true"></i></a>
                     </li>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  >Bids</h1>
									</div>
									<div class="mart10 marb5 xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Here is the list of companies that are interested in your request</a></div>
						...
						<div class="on_clmn brdb marb5">
									 ...
									 <div class="clear"></div>
								<?php 
								foreach($serviceBidsList as $category => $value) 
												{
												?> 
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_45 xs-mar0 xs-padt10">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText"><?php echo $value['property_title']; ?></span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs changedText">Price - <?php echo $value['property_price']; ?> SEK</span> 
													<span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs changedText">Bedroom - <?php echo $value['bedroom_count']; ?></span>
													 </div>
													 <?php if($value['liked_the_property']==0) { ?> 
													<div class="xxxs-wi_25 fleft wi_25  marr30 xs-mar0 ">
													
													<a href="../receivedbidPropertyInfo/<?php echo $data['job_id']; ?>/<?php echo $value['enc']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl20 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi changedText">Read</button>
																			</div> 
																			</a>
													   </div>
