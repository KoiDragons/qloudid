...
<a class="header__logo xs-fsz20 changedText" href="Unaoficina" style="
...
<picture>
<source media="(max-width: 767px)" srcset="https://safeqloud-228cbc38a2be.herokuapp.com/html/usercontent/images/dstricts/bgimage6.jpeg"><img src="https://safeqloud-228cbc38a2be.herokuapp.com/html/usercontent/images/dstricts/bgimage6.jpeg" alt="Main" class="imageBorder5">
</picture>
...
">Global Broker Hub</h1>
 </div>
</div>
</div></div>
<div class="section main main_stays hidden" style="margin-top: 50px;">
          <div class="main__center center">
            <div class="main__preview">
              ...
              <div class="main__wrap">
                ...
                <div class="main__info info">Master Spanish Off-Plan Market</div><a class="button main__button" href="#">Register Now for Free</a>
              </div>
            </div>
...
<div class="travel__center center   padb136 xs-padrl25" style=" max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
   
   <div class="travel__row " style="margin-bottom:40px;">
         ...
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               ...
               <div class="travel__subtitle changedText" style="
                  line-height: 1.1; font-size: 40px; color:white;
                  ">Mission
</div>
         ...
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">To unite brokers worldwide for selling off-plan and secondary real estate, as well as renting properties in Spain. We provide convenient services to optimize processes, manage sales, simplify commissions, and enhance communication between brokers, developers, and clients, while ensuring access to up-to-date project information.
				 
 </div>
 
 <button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts" onclick="submitForm();">Join for free</button>
            </div>
         </div>
      </div>
   </div>
...
<div class="section work hidden">
          <div class="work__center center">
            <div class="work__head">
              <h2 class="work__title h2 changedText">How it work</h2>
              <div class="work__info info changedText">Keep calm &amp; travel on</div>
            </div>
...
<div class="section work marb80i xs-marb25i xs-padrl25">
          <div class="work__center center" style="border-bottom:2px solid #ffffff; max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
            <div class="work__head tall hidden">
              <h2 class="work__title h2 uppercase changedText" style="font-size:80px;">Lead. Connect. Succeed.</h2>
              <div class="work__info info changedText">At Broker Hub, our mission is to connect global brokers with Spanish developers, enhancing real estate transactions with innovative, efficient tools for success.</div>
            </div>
             </div>
        </div>
<div class="travel__center center   padb136  xs-padrl25" style="border-bottom:1px solid #23262F; max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
         ...
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Join a robust network designed to enhance your sales capabilities, streamline processes, and provide the latest market information. Our platform offers tools to help you lead the market with confidence.
 </div>
            </div>
         </div>
      </div>
 ...
 <div class="travel__center center   padb136 xs-padrl25 mart80 xs-mart25i " style="border-bottom:1px solid #23262F;   max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:525px;">
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               <div class="travel__subtitle xs-fsz_lnhe25_1_1 fsz_lnhe32_1_1 changedText" style="
                    color: #787f91;
                  ">Global Broker Network</div>
                
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Facilitate seamless communication and collaboration with brokers, developers, and clients worldwide. Leverage our network to stay informed and connected, ensuring smooth transactions and interactions.
         ...
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Utilize comprehensive services to manage sales, rentals, and property listings efficiently. Our platform simplifies commissions, enhances transparency, and integrates essential services to help you succeed in your real estate endeavors.
  ...
  <div class="section work xs-padrl25 marb80i xs-marb25i"> 
          <div class="work__center center" style="border-bottom:2px solid #ffffff; max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
            <div class="work__head tall hidden">
              <h2 class="work__title h2 uppercase changedText" style="font-size:80px;">Register Now for Free</h2>
              <div class="work__info info changedText">Why Brokers Join BroHub</div>
            </div>
             </div>
        </div>
  
   
 <div class="section flights xs-padrl25">
...
<div class="section brands  " style="
    /* margin-top: 60px; */
">
...
<div class="brands__list" style="display:flex;">
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;  padding:0px 10px;  font-weight:bold;">Global Brokers Hub</div></a></div>
		...
		<div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Comprehensive project database of off-plan properties in Spain (updated regularly)
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				  ...
				  <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Complete listing of secondary market properties in Spain</div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                    <use xlink:href="#icon-tick" style="fill:#8BC34A"></use>
                  </svg></div></a></div>
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Online platform for booking, selling, and showroom reservations
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Broker reseller status from developers
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
				    ...
				    <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Exclusive property listings from clients
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Client interaction via platform with private property showing link
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
				   ...
				   <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Commission transparency and management
		...
		<div class="brands__item wi_15" style="width:15%; flex: 0 0 15%; height:80px;"><a href="#"><div class="browse_info info fsz24 talc xxs-pad5   description__parameter" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><svg class="icon icon-home">
                   <use xlink:href="#icon-close"  style="fill:#ff4501"></use>
				    ...
				    <div class="brands__item wi_70" style="justify-content: left; width:70%; flex: 0 0 70%; height:80px;"><a href="#"><div class="browse_info info fsz24 tall xxs-pad5 changedText " style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Community and support network (including WhatsApp)
  ...
  <div class="section work xs-padrl25 marb80i xs-marb25i">
    ...
    padding-left: 0px;">
            <div class="work__head tall hidden">
              <h2 class="work__title h2 uppercase changedText" style="font-size:80px;">Grow With Us</h2>
              <div class="work__info info changedText">Join our community today. Register now for free and start selling Spanish real estate to your clients worldwide</div>
            </div>
             </div>
        </div>
...
">Learn More</h2>
<div class="browse__info info changedText">Key Benefits of Global Brokers Hub for Brokers Worldwide</div>
</div>
...
<div class="checkout__inner js-tabs wi_60" style="padding-right:0px;">
 <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item"  >
                                      <div class="faq__head changedText" style="color:white;">Enhance Communication with Global Broker Network</div>
                                      <div class="faq__body" id='1'>
                                        <div class="faq__content changedText">We empower brokers worldwide by creating a robust network and communication platform, facilitating information exchange and providing seamless services for optimized project management.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Infrastructure for Selling Off-Plan Properties in Spain</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Our platform provides the necessary infrastructure for brokers to sell off-plan properties in Spain, including developer approval, current project information, commission transparency, client booking and registration, showroom reservations, and personalized property showings. The apply, accept, and reject reseller flow ensures that only qualified brokers are approved to sell developer properties.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Client-Broker Matching</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Enable clients to find and select brokers using specific filters. This feature allows brokers to secure exclusive contracts by connecting with clients who want to buy or sell properties.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Comprehensive Property Listings</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Publish listings for sale, purchase, and rental properties all on one unified platform, simplifying the process for brokers and clients alike.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Manage Rentals</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Manage all aspects of property rentals, including booking management, property maintenance, cleaning, technical support, guest registration with local authorities, check-in/check-out processes, and property inspections.</div>
                                        
                                      </div>
                                    </div>
									
									 <div class="faq__item">
                                      <div class="faq__head changedText">Integration with Other Services</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Our platform integrates with various additional services to enhance the broker's toolkit, including Una Qasa, Communify, Find-A-Lawyer, Home-Repair, Home Services, and Rent-A-Car.</div>
...
<!-- footer-->
 ...
 <footer class="footer" style="background: #131922;">
   ...
   line-height:25px !important;
   border: 2px solid #f67f00;
   ">Global Brokers Center</a>
                  
            </div>
            <div class="footer__col">
              <div class="footer__menu tall"><a class="footer__link changedText" href="#">Paseo de la Castellana 77 Madrid, M 28046</a><a class="footer__link" href="#">+34 604 28 67 89</a><a class="footer__link changedText" href="#">Privacy</a> </div>
            </div>
