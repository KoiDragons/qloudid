				...
				<div class="fright xs-dnone sm-dnone">
					<ul class="mar0 pad0">
						<div class="hidden-xs hidden-sm padtrl10">
							<a href="https://www.qloudid.com/user/index.php/LoginAccount" class="diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
			...
			<div class="column_m container zi5  mart40 xs-mart20">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0  ">
						...
						<div class="padb10 ">
							<h1 class="padb5 talc fsz65 xs-fsz25 bold ">Perfekt !</h1>
							<p class="pad0 xs-padb10 talc fsz25 xs-fsz16 padb0 wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 xs-brdb_b">Tack för ditt tålamod. Vi önskar dig en trevlig fortsättning.</p>
						</div>
						
						<div class="mart20 talc">
							<input type="button" value="Yes" class="wi_320p maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" >
							
						</div>
						
						<div class="mart20 talc">
							<input type="button" value="No" class="wi_320p maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" >
