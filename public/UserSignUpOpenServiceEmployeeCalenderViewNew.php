...
$(window).on('resize', function() {
  ...
  <body class="dark" style="background: #212b39;" onload="getNewCalender(0);">
<script>
...
<a class="header__logo xs-fsz20 " href="../../../../../../../../../../sharedServiceDetail/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>" style="
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Book</h2>

<h2 class="main__info info  tall  padb20 xs-padt20" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Please select a suitable date and time combination
</h2>
