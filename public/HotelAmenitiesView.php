            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 black_bg ">
				...
				<ul class="menulist sf-menu  fsz25  bold wi_100">
					<li class="padr10 first last wi_100 talc">
						<a href="#"><span class="white_txt pred_txt_h ffamily_avenir"><?php echo substr($hotelDetail['hotel_name'],0,14); ?></span></a>
					</li>
...
<div class="mart0 marb15 xxs-talc talc  xs-padb20 padb20 "> <span class="black_txt fsz25 xs-fsz20 xsi-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_25 padb10 brdb">Find us : <?php echo $hotelDetail['visiting_address']; ?>   <?php if($hotelDetail['phone']=='' || $hotelDetail['phone']==null) echo ''; else echo '<span class="padrl10 fsz15"><i class="fas fa-circle"></i></span> Call us : <a href="tel: +'.$hotelDetail['country_code'].' - '.$hotelDetail['phone'].'">+'.$hotelDetail['country_code'].' - '.$hotelDetail['phone']; ?></a><span></div>									
...
<div class="_1HQROFP" data-test-target="feed">
   ...
   <div class="_1anKb-nl">
      <h2 class="sfviYlff"><span class="kXE6Dm96"><span class="HLvj7Lh5 _2-dmJ6kF">Explore <?php echo $hotelDetail['hotel_name']; ?></span></span></h2>
   </div>
   <div class="_1anKb-nl">
      <div class="_2_LiTKhk">
         <div class="WPbAbZxq">
         ...
         <div class="_2JGsjxnm">
            <div class="Ffh78ncj _1JCEdqUg _3auwW4vL _3XQY3qGv">
               ...
               <div class="_1KB7D5C1 _3n93WwqC" style="display:block;">
                  <div class="jOxjYW1k"><span class="fhoh290_"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Föregående"   ><span class="padt3" style="font-size: 20px;"><i class="fas fa-long-arrow-alt-left"></i></span></button></span></div>
               </div>
               <div class="_1KB7D5C1 _2bfEA-AB" style="display:block;">
                  <div class="jOxjYW1k"><span class="fhoh290_"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Nästa"  ><span class="padt3" style="font-size: 20px;"><i class="fas fa-long-arrow-alt-right"></i></span></button></span></div>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="_2JGsjxnm">
            <div class="Ffh78ncj _1JCEdqUg _3auwW4vL _3XQY3qGv">
               ...
               <div class="_1KB7D5C1 _3n93WwqC">
                  <div class="jOxjYW1k"><span class="fhoh290_ _1QK5bZ71 _1RnyYBrx"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Föregående" disabled=""><span class="padt3" style="font-size: 20px;"><i class="fas fa-long-arrow-alt-left"></i></span></button></span></div>
               </div>
               <div class="_1KB7D5C1 _2bfEA-AB">
                  <div class="jOxjYW1k"><span class="fhoh290_"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Nästa"><span class="padt3" style="font-size: 20px;"></span></button></span></div>
               </div>
            </div>
         </div>
      </div>
