...
var timeout=0;
			...
			function verifyCode()
			{
				...
				if($("#ecode").val().length<8 || $("#ecode").val().length>8) 
				{
					$("#error_msg_form").html('Code must be eight digit long');
					return false;
				}
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40   xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45  padb10 black_txt trn">Hi</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Please enter the code received in email to checkin.</a></div>
									
								 
									<form action="../verifyCheckinCode/<?php echo $data['id']; ?>" method="POST" name="updateform" id="updateform">
									
									<div class="on_clmn mart10 xxs-mart10 marb35">
											 
												<input type="number" name="ecode"  placeholder="Checkin code " id="ecode"  class="txtind10 fsz18 nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828  wi_100 trans_bg required minhei_65p xxs-minhei_60p  talc  ffamily_avenir" >
							...
							<div class="padtb20 xxs-talc talc">
								...
								<button type="button" name="forward" class="forword hei_55p fsz18  t_67cff7_bg ffamily_avenir" onclick="verifyCode();">Submit</button>
