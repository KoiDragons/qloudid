...
<a class="header__logo xs-fsz20 " href="https://gettxp.com/public/index.php/SelectMemberType" style="
...
<!-- outer content-->
<div class="outer__inner xs-mart45 mart100" >
...
<div class="browse__head wi_65  xs-wi_100">
<h2 class="browse__title h2 changedText xxs-fsz35 tall   fsz80 lgn_hight_90 xxs-lgn_hight_50 xs-tall" >UNLOCK EXCLUSIVE ACCESS
</h2>
<div class="browse__info info changedText xxs-fsz20">Congratulations on taking the first step towards unlocking the full potential of your real estate agency with <?php echo $selectedMarketplaceDetail['marketplace_name']; ?>! 
</div>
<div class="browse__info info changedText xxs-fsz20" style="margin-top:20px;">You're just one step away from joining our thriving community of successful agencies and gaining access to exclusive benefits.
</div>
</div>
  
<div class="checkout__inner js-tabs wi_35 xs-wi_100" style="padding-right:0px;">
<div class="section categories  marl6 " style="margin-bottom: 0px; ">
<div class="categories__center center1 xsi-nobrdb xsi-padb0 hidden"  >
<div class="categories__inner">

 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			    
			     <?php if($data['subscription_selected']==1) { ?>
				<a class="categories__item  black_bg  " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_f67f00   ">Free</div>
                                      </a>
...
<form action="../signUpEmailInfo/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1" autocomplete="off">
			
			<input type="hidden" name="user_signup_type" id="user_signup_type" value="2">
			<input type="hidden" name="subscription_type" id="subscription_type" value="1">
			</form>
			
	 <div class="checkout__line  hidden" style="margin-bottom:10px; margin-top:20px; padding-bottom:10px; border-bottom:1px solid #353945;">
					   <div class="checkout__subtitle"><?php if($data['subscription_selected']==1) { echo 'Free'; } else if($data['subscription_selected']==2) { echo $selectedMarketplaceDetail['gold_account_subscription_fee'].' euro'; } else if($data['subscription_selected']==3) { echo $selectedMarketplaceDetail['premium_account_subscription_fee'].' euro'; } ?> </div>
                       
                      </div>	


<div class="receipt xs-brdrad12_12" style="border:none; margin-bottom:0px; margin-top:0px; border-radius:24px 24px 0px 0px; padding-bottom:10px; width:100%; margin-left:0px;">
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old" style="text-decoration:none;">$49</div>
                    <div class="receipt__actual changedText"><?php if($data['subscription_selected']==1) { echo 'Free trial'; } else if($data['subscription_selected']==2) { echo $selectedMarketplaceDetail['gold_account_subscription_fee'].' euro'; } else if($data['subscription_selected']==3) { echo $selectedMarketplaceDetail['premium_account_subscription_fee'].' euro'; } ?></div>
                ...
                <div class="receipt__avatar"><img src="<?php echo $path; ?>html/usercontent/images/account/logo.png" alt="Avatar">
                  <div class="receipt__check hidden">
              ...
              <div class="receipt__description  " >
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText"><?php if($data['subscription_selected']==1) { echo 'Free - One month trial'; } else if($data['subscription_selected']==2) { echo 'Introduction'; } else if($data['subscription_selected']==3) { echo 'Premium'; } ?></div>
					<div class="price__subtitle changedText">Intro offer</div>
			...
			<script>
			function updateLicenceNumber(id,id1,id2)
			{
...
<div class="checkout__box">
 <?php $i=1; 
								foreach($selectedMarketplaceFeeAccountDetail as $category => $value) 
												{
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo  html_entity_decode($value['subcategory_name']); ?></div>
 
</div>
<div class="card__options  " style="display:block;">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo  substr(html_entity_decode(strip_tags($value['professional_description'])),0,350); ?>
</div>
</div>
  
 
<div class="field">
<div class="field__label changedText <?php if($value['user_licence_required']==0) echo 'hidden'; ?>" style="color:#787f91;">$<?php echo $value['service_price']; ?>/Licence</div>
<div class="field__wrap">
<input class="field__input <?php if($value['user_licence_required']==0) echo 'hidden'; ?>" type="number" name="licence<?php echo $value['professional_subcategory_id']; ?>" id="licence<?php echo $value['professional_subcategory_id']; ?>"  min='1' value='1' style="background:#131922; color:grey; border:none;" fdprocessedid="1qwb0h" <?php if($value['user_licence_required']==0) echo 'readonly'; ?> onfocusout='updateLicenceNumber(this.value,"<?php echo 'licence'.$value['professional_subcategory_id']; ?>",<?php echo $value['professional_subcategory_id']; ?>);'>
</div>
</div>
 ...
 <div class="section destinations xs-padrl25" style="margin-bottom:80px;">
		...
		<div class="section-mb80 checkout checkout_stays xs-padrl0">
<div class="checkout__center center xs-padrl0" style="padding:0px;">
...
">Learn More</h2>
<div class="browse__info info changedText">Key Benefits of Dev Hub for Spanish Developers</div>
</div>
...
<div class="checkout__inner js-tabs wi_60" style="padding-right:0px;">
 <div class="faq__box js-tabs-item" style="display: block;">
                                    <div class="faq__item"  >
                                      <div class="faq__head changedText">Market Insights & Networking</div>
                                      <div class="faq__body" id='1'>
                                        <div class="faq__content changedText">Gain tailored data and trends for informed decisions in Spain, and connect with international brokers to expand your market reach.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Project Efficiency</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Enhance efficiency, reduce costs, and manage projects seamlessly with our integrated tools.</div>
                                        
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Advanced Tools</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Access CRM, marketing tools, and targeted advertising strategies to boost sales and visibility.</div>
                                         
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Certified Network</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Collaborate with certified brokers, ensuring a trustworthy professional environment.</div>
                                         
                                      </div>
                                    </div>
                                    <div class="faq__item">
                                      <div class="faq__head changedText">Cost Savings & Community Support</div>
                                      <div class="faq__body">
                                        <div class="faq__content changedText">Reduce marketing expenses, eliminate extra commissions, and receive instant updates and ongoing support via WhatsApp and our community.</div>
