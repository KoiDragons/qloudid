  ...
  <body class="dark">
    ...
    <div class="outer">
      ...
      <header class="header js-header header_border bgcolor_F4B400 xs-padding2424">
        <div class="header__center center"><a class="header__logo" href="../itemInformation/<?php echo $data['cid']; ?>" ><button class="button button-stroke button-small header__button" style="border-color:#ff0000; background-color:#ff0000; box-shadow: 0 0 0 2px #ff0000 inset; font-size:18px; min-width: 5em !important;">Add more</button></a>
      ...
      <div class="outer__inner">
        ...
        <div class="section catalog"  style="margin-top:80px;">
          <div class="sorting" style="margin:0;">
            <div class="sorting__center center">
               
              <div class="sorting__body" style="border:none; padding:0;">
                <div class="sorting__box">
                  <h2 class="sorting__title h2"><?php echo $selectedProductsPrice['total_amount']; ?> SEK</h2>
                  <div class="wishlists__counter">You added <?php echo count($selectedProducts); ?> items to wishlists</div>
                </div>
                <div class="sorting__location">
                 <a href="https://www.qloudid.com/user/index.php/LoginAccount/loginPurchase/<?php echo $data['cid']; ?>"> <button class="button-stroke sorting__button js-sorting-button"><span>Pay with Qloud ID</span>
          ...
          <div class="catalog__body">
            <div class="catalog__center center">
			  ...
			  <div class="card"  >
                    <div class="card__preview"><img srcset="<?php echo $value['image_path']; ?>" src="<?php echo $value['image_path']; ?>" alt="Entire serviced classy moutain house">
                      <div class="category card__category">superhost</div>
                    </div>
                    <div class="card__body">
                      <div class="card__line">
                        <div class="card__title"><?php echo $value['dish_name'].$value['sub_variantions']; ?></div>
                       <a href="../deleteSelectedItem/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"> <div class="card__price">
                           
                          <div class="card__actual">Remove</div>
                        </div></a>
                      </div>
                  ...
                  <div class="price__table">
                    <div class="price__row">
                      <div class="price__cell"><?php  $price=$value['total_price']/$value['number_of_products']; echo $price; ?> SEK x <?php echo $value['number_of_products']; ?> </div>
                      <div class="price__cell"><?php echo $value['total_price']; ?> SEK</div>
                    </div>
                    <div class="price__row">
                      <div class="price__cell">10% campaign discount</div>
                      <div class="price__cell">-0 SEK</div>
                    </div>
                    
                    
                    <div class="price__row">
                      <div class="price__cell">Total (SEK)</div>
                      <div class="price__cell"><?php echo $value['total_price']; ?></div>
                    </div>
                  </div>
                </div>
					...
					<a class="button receipt__button " href="https://www.qloudid.com/user/index.php/LoginAccount/loginPurchase/<?php echo $data['cid']; ?>"  ><span>Pay with Qloud ID</span>
                  </a>
				  </div>
              </div>
