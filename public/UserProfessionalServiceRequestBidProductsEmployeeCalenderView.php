...
<head>
	  ...
	  <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.min.css">
		...
		$.ajax({
            type:"POST",
            url:"../../../../getNewCalender/<?php echo $data['job_id'];?>/<?php echo $data['bid_id'];?>/<?php echo $data['bookable_service_id'];?>/<?php echo $data['employee_id'];?>",
            data:send_data,
            dataType:"text",
...
$(window).on('resize', function() {
  if ($(this).width() !== width) {
	...
	<body class="white_bg ffamily_avenir" onload="getNewCalender(0);">
	<header class="header js-header authorization xs-padt24" style="border-bottom: 1px solid #e6e8ec; height:93px;">
        <div class="header__center center"><a class="header__logo xs-fsz20 " href="../../listRequests/NWJ5ZGFMY3EwL1JUWE50U1FQdUtQdz09" style="background-color: #c12219 !important; padding: 10px;
    color: white;
    border-radius: 5px;
    ...
    line-height:25px !important">Start</a>
		   ...
		   <div class="header__wrapper js-header-wrapper" style="padding-left:0px;">
            <div class="header__item header__item_language js-header-item  ">
              <button class="header__head js-header-head fsz16 " fdprocessedid="i2np2">
              ...
              <div class="column_m   zi5  mart40">
                <div class="wrap maxwi_100 padrl15 xs-padrl25">
						...
						<div class="padb0 xxs-padb0 ">		
							<h1 class="marb0  xxs-talc talc fsz45  xs-fsz25 lgn_hight_65 xxs-lgn_hight_25 padb0 black_txt trn">Select date & time</h1>
									</div>
									<div class="hidden mart10 marb5 xxs-talc talc   xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please select a suitable date and time combination</a></div>
	 ...
	 <form method='POST' action='../../../../updateBookingTimeInfo/<?php echo $data['job_id']; ?>/<?php echo $data['bid_id']; ?>/<?php echo $data['bookable_service_id']; ?>' id='save_indexing' name="save_indexing" >
