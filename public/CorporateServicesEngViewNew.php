...
<div class="outer">
<!-- header-->
<header class="header js-header authorization xs-padding032" style="border-bottom: 1px solid #dbdcdd;/* box-shadow: inset 0 -1px 0 0 #23262F; */">
<div class="header__center center"><a class="header__logo xs-fsz20 " href="https://www.safeqloud.com/user/index.php/LoginAccount/loginapp" style="
...
<header class=" js-header header_border bgcolor_F4B400 xs-padding2424 hidden" style="
...
<div class="section categories mart95 xs-mart65 xs-mart65"  >
<div class="categories__center center">
<div class="categories__inner">
<div class="categories__head" style="margin-bottom:55px !important;">
<h2 class="categories__title h2 fsz85 xs-fsz45 xs-lgn_hight_50 xs-tall" style="color: #2c3e50;">With Qloud ID Business, You are in charge.

</h2>
<div class="categories__info info fsz30 xs-fsz20 xs-lgn_hight_25 xs-tall" style="margin-top:5px; font-size:30px;">Manage your data, integrate with other smart softwares, provide your employees with the best of tools to acheive great resuts.

</div>
<a class="button main__button xs-tall talc xs-fleft" href="#" style="
...
<h2 class="travel__title h2 fsz60 xs-fsz45" >Update data</h2>
<div class="travel__info info fsz30 xs-fsz25" >Update company data from one single location</div>
</div>
...
<div class="travel__subtitle">Company data</div>
<div class="travel__content">One single place to update company data, images, opening hours, offices and more</div>
</div>
<div class="travel__item">
<div class="travel__number" style="background-color: #92A5EF;">02</div>
<div class="travel__subtitle">Employees data</div>
<div class="travel__content">Easy access to stored and realtime update information regarding your employees</div>
</div>
<div class="travel__item">
<div class="travel__number" style="background-color: #58C27D;">03</div>
<div class="travel__subtitle">Products &amp; Services data</div>
<div class="travel__content">Manage and update your products and services portfolio from a single place</div>
</div>
</div><a class="button travel__button" href="stays-category.html">More about company data</a>
</div>
<div class="travel__col">
...
<div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 908px;"><div class="travel__gallery slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 454px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;" tabindex="0">
<div class="travel__bg"><img srcset="https://www.safeqloud.com/html/fleet/img/content/travel-pic-1@2x.jpg" src="https://www.safeqloud.com/html/fleet/img/content/travel-pic-1.jpg" alt="Travel"></div>
<div class="travel__group">
<div class="travel__preview"><img class="some-icon" srcset="http://www.qricis.com/html/smartappcss/images/websiteimages/wifi.jpg" src="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-1.png" alt="Appraisal"><img class="some-icon-dark" srcset="http://www.qricis.com/html/smartappcss/images/websiteimages/wifi.jpg" src="http://www.qricis.com/html/smartappcss/images/websiteimages/wifi.jpg" alt="Appraisal"></div>
<div class="travel__preview"><img class="some-icon" srcset="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-1@2x.png" src="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-1.png" alt="Appraisal"><img class="some-icon-dark" srcset="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-dark-1@2x.png" src="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-dark-1.png" alt="Appraisal"></div>
<div class="travel__preview"><img class="some-icon" srcset="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-1@2x.png" src="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-1.png" alt="Appraisal"><img class="some-icon-dark" srcset="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-dark-1@2x.png" src="https://www.safeqloud.com/html/fleet/img/content/appraisal-pic-dark-1.png" alt="Appraisal"></div>
</div>
...
<div class="adventure__head xs-padrl25 xs-tall">
<h2 class="adventure__title h2 fsz60 xs-fsz45">Follow GDPR</h2>
<div class="adventure__info info fsz30 xs-fsz25"  >Be GDPR complaint by applying consent technology</div>
</div>
<div class="testimonials__center center js-tabs">
<div class="testimonials__container">
<div class="testimonials__item js-tabs-item" style="">
<div class="testimonials__row">
<div class="testimonials__col">
<div class="testimonials__logo"><img src="https://ui8-fleet-html.herokuapp.com/img/content/goldlines.svg" alt="Logo"></div>
...
<div class="testimonials__col">
<div class="testimonials__preview"><img srcset="https://ui8-fleet-html.herokuapp.com/img/content/testimonials-pic@2x.jpg" src="img/content/testimonials-pic.jpg" alt="Testimonials">
...
<div class="testimonials__col">
<div class="testimonials__preview"><img srcset="img/content/testimonials-pic@2x.jpg" src="img/content/testimonials-pic.jpg" alt="Testimonials">
<button class="play play_small">
<svg class="icon icon-play">
<use xlink:href="#icon-play"></use>
</svg>
...
<div class="testimonials__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
...
<div class="testimonials__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-5.jpg" alt="Avatar"></div>
<div class="testimonials__group">
<div class="testimonials__man">Kaylah Botsford</div>
<div class="testimonials__position">Web Designer</div>
</div></a><a class="testimonials__link js-tabs-link" href="#" data-aos="animation-opacity">
<div class="testimonials__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-2.jpg" alt="Avatar"></div>
<div class="testimonials__group">
<div class="testimonials__man">Reinhold Ullrich</div>
<div class="testimonials__position">Web Designer</div>
</div></a><a class="testimonials__link js-tabs-link" href="#" data-aos="animation-opacity">
<div class="testimonials__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-3.jpg" alt="Avatar"></div>
<div class="testimonials__group">
...
<div class="places__inner" style="
    background: #e6e8ec;
">
<div class="places__head xs-padrl25 xs-tall">
<h2 class="places__title h2 fsz60 xs-fsz45" style="
    color: black;
    
">Get results</h2>
<div class="places__info info fsz30 xs-fsz25 " >Grant employees access to powerful business apps</div>
</div>
<div class="places__wrapper">
<div class="places__slider js-slider-places js-slider-resize">
<a class="places__item" href="stays-product.html" style="" tabindex="0">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-1.jpg" alt="Place"></div>
<div class="places__subtitle">EDI</div>
<div class="places__time">Digital Employee ID</div></a><a class="places__item" href="stays-product.html" style="" tabindex="0">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img alt="Place" https:="" ui8-fleet-html.herokuapp.com="" img="" content="" places-pic-2.jpg=""></div>
<div class="places__subtitle">HR</div>
<div class="places__time">Human resource portal</div></a><a class="places__item" href="stays-product.html" style="" tabindex="-1">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-3.jpg" alt="Place"></div>
<div class="places__subtitle">Verify ID</div>
<div class="places__time">EDI verification </div></a><a class="places__item" href="stays-product.html" style="" tabindex="-1">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-4.jpg" alt="Place"></div>
<div class="places__subtitle">The receptionist</div>
<div class="places__time">Visitor management system</div></a><a class="places__item" href="stays-product.html" style="" tabindex="-1">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-5.jpg" alt="Place"></div>
<div class="places__subtitle">Parrking</div>
<div class="places__time">Visit parking system</div></a><a class="places__item" href="stays-product.html" style="" tabindex="-1">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-6.jpg" alt="Place"></div>
<div class="places__subtitle">Delivery</div>
<div class="places__time">Parcel delivery system</div></a><a class="places__item" href="stays-product.html" style="" tabindex="-1">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-7.jpg" alt="Place"></div>
<div class="places__subtitle">L &amp; F</div>
<div class="places__time">Lost &amp; Found</div></a><a class="places__item" href="stays-product.html" style="" tabindex="-1">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-8.jpg" alt="Place"></div>
<div class="places__subtitle">Noffa</div>
<div class="places__time">Notify Family &amp; Friends</div></a><a class="places__item" href="stays-product.html" style="" tabindex="-1">
<div class="status-gray places__number">1480</div>
<div class="places__preview"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-9.jpg" alt="Place"></div>
<div class="places__subtitle">Eat &amp; Drink</div>
<div class="places__time">For places serving food or drink</div></a></div>
</div>
</div>
</div>
</div>
