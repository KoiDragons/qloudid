...
<div class="header__center center"><a class="header__logo xs-fsz20 changedText" href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/LoginAccount" style="
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="../../addUserPropertyInfo/<?php echo $data['checkout_id']; ?>/<?php echo $data['request_id']; ?>" class="header__item " onclick="submitUser();"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
...
<h2 class="browse__title h2 changedText" style="
    ...
    line-height: 90px;
">Properties</h2>
<div class="browse__info info changedText">Select a property for your request</div>
</div>
...
<div class="checkout__box">
									<script>
										...
										document.getElementById("save_indexing_user").submit();	
										 ...
										 <form action="../../updatePropertyDetail/<?php echo $data['checkout_id']; ?>/<?php echo $data['request_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
			...
			<input type="hidden" name="b_id" id="b_id" value="">
									 ...
									 <?php $i=1;
												...
												?>  	
													...
													<button class="checkout__edit"  onclick="submitForm('<?php echo $value['enc']; ?>');">
