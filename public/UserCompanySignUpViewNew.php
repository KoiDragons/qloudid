         ...
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg">
			...
			<div class="top_menu frighti padt20 padb10 hidden-xs">
				<ul class="menulist sf-menu  fsz16  sf-js-enabled sf-arrows">  
					<li class="last">
						<a href="javascript:void(0);" class="lgn_hight_s1 fsz18" onclick="changeDisplay();"><span class="fa fa-qrcode black_txt" aria-hidden="true"></span></a>
			...
			<div class="top_menu frighti padt10 padb10" style="width:150px !important;">
				<ul class="menulist sf-menu  fsz16 ">
					...
					<li style="margin-right:20px !important;">
						<a href="javascript:void(0);" class="lgn_hight_s1 fsz25 sf-with-ul" onclick="changeDisplay1();"><span class="black_txt fa fa-qrcode"></span></a>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 "    >
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  >Sign up</h1>
									</div>
									<div class="mart10 marb5 xs-marb20 xs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" ><?php if($data['signup_type']==1){ ?> Register your community <?php } else { ?>Fill in all details below and apply to become one of our suppliers.<?php } ?></a></div>
					 ...
					 <div class="clear"></div>
									  ...
									  <input type='hidden' id="domain_id" name="domain_id" value="<?php if(isset($data['domain_id'])) echo $data['domain_id']; else echo 'bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09'; ?>" />
									  <input type="hidden" id="user_signup_type" name="user_signup_type" value="<?php echo $emailRequestReceivedInfo['user_signup_info']; ?>" />
									 	 <div class="marrl0 padb15 brdb fsz16 white_bg tall padt35">
								<a href="#profile" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active" style="background-color: #c12219 !important;"><span class="changedText">About you</span>
								...
								<div id="profile" class=" " style="display:block;">	
											...
											<div class="pos_rel">
												...
												<input type="text" name="fname" id="fname" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
											...
											<div class="pos_rel">
												...
												<input type="text" name="lname" id="lname" placeholder="Last name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="p7xzrb"> 
											...
											<div class="pos_rel">
												...
												<input type="text" name="email" id="email" placeholder="Email address" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="qc7t4r" <?php echo $emailRequestReceivedInfo['email']; ?> <?php if (isset($data['request_id'])) echo 'readonly'; ?>> 
										...
										<div class="pos_rel">
										<select id="country" name="country" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select" fdprocessedid="qh9hm">
											...
											<div class="pos_rel">
												...
												<input type="text" name="pnumber" id="pnumber" placeholder="Phone number" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="pb0p6q"> 
												 <label for="pnumber" class="floating__label tall nobold padl10" data-content="Mobile">
											<span class="hidden--visually">
											 Mobile</span></label> 
								...
								<a href="#profile2" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active" style="background-color: #c12219 !important;"><span class="changedText">About your company</span>
								<span class="dnone_pa fa fa-chevron-down fright dark_grey_txt "></span><span class="dnone diblock_pa fa fa-chevron-up padr15 fright dark_grey_txt "></span></a></div>
								...
								<div id="profile2" class=" " style="display:block;">	
										 ...
										 <div class="on_clmn padt10">
											...
											<div class="pos_rel">
												...
												<input type="text" name="company_name" id="company_name" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
										  ...
										  <div class="pos_rel">
												...
												<input type="text" name="cid" id="cid" placeholder="Last name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="p7xzrb"> 
												 <label for="cid" class="floating__label tall nobold padl10" data-content="Company identification">
											<span class="hidden--visually">
											  Company identification</span></label>
											 ...
											 <div class="on_clmn padt10 hidden">
											  <div class="thr_clmn  wi_50 padr5 hidden"> 
											<div class="pos_rel">
												
												<select id="company_type" name="company_type" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select" fdprocessedid="u205l">
														
														<option value="1" class="changedText">Company</option>
														<option value="2" class="changedText">Community</option>
														<option value="3" class="changedText">Goverment</option>
														</select>
												 <label for="company_type" class="floating__label tall nobold padl10" data-content="Company type">
											<span class="hidden--visually">
											  Company type</span></label>
										  ...
										  <div class="pos_rel">
												...
												<input type="text" name="company_email" id="company_email" placeholder="Last name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="p7xzrb"> 
												 <label for="company_email" class="floating__label tall nobold padl10" data-content="Company email">
											<span class="hidden--visually">
											 Company email</span></label>
											...
											<div class="pos_rel">
												...
												<input type="text" name="daddress" id="daddress" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
												
											 <label for="daddress" class="floating__label tall nobold padl10" data-content="Street address">
											<span class="hidden--visually">
										  ...
										  <div class="pos_rel">
												...
												<input type="text" name="d_port_number" id="d_port_number" placeholder="Last name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="p7xzrb"> 
												 <label for="d_port_number" class="floating__label tall nobold padl10" data-content="Port">
											<span class="hidden--visually">
											 Port number</span></label>
										 	...
										 	<div class="on_clmn padt10">
											  <div class="thr_clmn  wi_30 padr5"> 
											<div class="pos_rel">
												
												<input type="text" name="dzip" id="dzip" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
												
											 <label for="dzip" class="floating__label tall nobold padl10" data-content="Zip code">
											<span class="hidden--visually">
											  Zipcode</span></label>
											</div>
											  ...
											  <div class="thr_clmn  wi_70 padl5"> 
											 
										  <div class="pos_rel">
												
												<input type="text" name="dcity" id="dcity" placeholder="Last name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="p7xzrb"> 
											...
											<div class="pos_rel">
												...
												<select id="objectType" name="objectType" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select" fdprocessedid="u205l">
						  ...
						  <?php } else { foreach($professionalCategoryDetail as $category => $value) 
												{ ?> 
								<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg changedText"><?php echo str_ireplace('&','and',html_entity_decode($value['category_name'])); ?></option>	
												<?php } } ?> 	
												 
														 
														</select>
												 <label for="objectType" class="floating__label tall nobold padl10" data-content="<?php if($data['signup_type']==1){ ?> Object type <?php } else { ?>Category<?php } ?>">
											<span class="hidden--visually">
											  Category</span></label>
					 ...
					 <div class="padt20 xxs-talc talc padb50">
								...
								<a href="javascript:void(0);" onclick="submitform();"><button type="button" name="forward" class="bold forword minhei_55p   fsz16 padrl70 nobold bg_333 white_txt" style="border-radius: 50px; background: #000000;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="changedText">Send your application</font></font></button></a>
