	...
	function togglePopup()
	{
		...
		else
		{
			...
			function verifyemail()
			{
				...
				if(x == "")
				{
					$('#errorMsg1').html("Please enter your email address");
					$("#fpass").css("background-color","#FF9494");
					return false;
				}
				var atpos=x.indexOf("@");
				...
				var send_data={};
				send_data.email=$("#fpass").val();
				$.ajax({
					type:"POST",
					url:"ForgotPswd/checkmail",
					data:send_data,
					dataType:"text",
					...
					success: function(data1){
						...
						if(data1==0)
						{
							$('#errorMsg1').html("Email is not registered with us");
							return false;	
						}
						else
						{
...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<!-- Center content -->
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla   xs-pad0">
					<div class="marb30 padt0 xs-padt0">
						 
								<img src="https://i.gifer.com/QAWw.gif" class="maxwi_100 hei_auto  brdrad5"   width="400" >
							 
								
							</div>
								 
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >If you have forgotten your password, it is only for you to enter your e-mail address and follow instructions.</a></div>
								
				<div class="container padrl15 xs-padrl0">
						
						<div class="marrla xs-wi_100">
					<form action="ForgotPswd/forgotPasswordAccount" method="POST" name="fpassword" id="fpassword" > 
					
						<div class="marb35 padb10 ">
				...
				<div class="pos_rel">
									<input type="text"  name="fpass" id="fpass" placeholder="Your email address" class="wi_100 rbrdr pad10 mart5 brdb talc  minhei_65p fsz18 llgrey_txt" /> </div>
									<div class="clear"></div>
								</div>
							...
							<div class="talc  padtb20 "><a href="#" onclick="verifyemail();"><input type="button" value="Submit" class="forword button_bg_color minhei_55p"  /></a>
