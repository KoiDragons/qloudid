		  ...
		  <div class="header__item header__item_user js-header-item" style="display:block;">
            ...
            <div class="header__body js-header-body">
			  ...
			  <a class="button-stroke button-small header__button changedText" href="#" style="background: #3B71FE; box-shadow: none;">Account</a>
                <a href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/ProfileLogout?action=logout" class="button-stroke button-small header__button changedText">Log out</a>
              </div>
            </div>
          </div>
         ...
         <div class="travel__list" style="
            ...
            <div class="travel__item">
               ...
               <div class="travel__subtitle changedText" style="
				  ...
				  font-weight:100
                  "><?php if($emailRequestReceivedInfo['user_id']==0) echo 'Complete Registration'; else echo 'Verified Successfully!'; ?>
</div>
            ...
            <div class="travel__content changedText" style="
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  "><?php if($emailRequestReceivedInfo['user_id']==0) echo 'Tell us a bit about yourself and your company to get started.'; else echo 'Now, let us add your company details to complete your account setup.'; ?>
</div> 

<div class="travel__col xs-marb0  <?php if($emailRequestReceivedInfo['user_id']==0) echo 'marb687'; ?>" style="<?php if($emailRequestReceivedInfo['user_id']>0) echo 'margin-bottom:400px;'; ?> padding-right: 0px; max-width:525px;">
         <div class="travel__list" style="
            max-width: 450px;
...
<form class="checkout__item js-tabs-item" action="../../addCompanyDetails/<?php echo $data['domain_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"> 
 
   
                     
					 <div class="upload__item <?php if($emailRequestReceivedInfo['user_id']>0) echo 'hidden';?>">
					    <div class="checkout__line  margin-bottom24 ">
					   <div class="checkout__subtitle uppercase changedText">PERSONAL DETAILS ONLY</div>
					   ...
					   <div class="checkout__row margin-bottom32  ">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="first_name" id="first_name" placeholder="e. g. Kowaken" value="<?php echo $emailRequestReceivedInfo['first_name'];?>" style=" color:grey;" <?php if($emailRequestReceivedInfo['user_id']>0) echo 'readonly';?>>
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="last_name" id="last_name" value="<?php echo $emailRequestReceivedInfo['last_name'];?>" placeholder="e. g. Ghirmai" style=" color:grey;" <?php if($emailRequestReceivedInfo['user_id']>0) echo 'readonly';?>>
                            </div>
                          </div>
						  </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <select class=" "   id="pcountry" name="pcountry" style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
								 <?php  foreach($countryOptions as $category => $value) 
															...
															<option value="<?php echo $value['id']; ?>"  <?php if($emailRequestReceivedInfo['country']==$value['id']) echo 'selected';?> class="lgtgrey2_bg  "><?php echo $value['country_name']; ?></option>
														<?php 	}	?>
								  </select>
                            </div>
                          </div>
						  ...
						  <div class="upload__col upload__col_w70">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">PERSONAL MOBILE - (NOT WORK PHONE)</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" id="pnumber" placeholder="e. g. 7222233554" value="<?php echo $emailRequestReceivedInfo['phone_number'];?>" style=" color:grey;" <?php if($emailRequestReceivedInfo['user_id']>0) echo 'readonly';?>>
                            </div>
                          </div>
						  </div>
						  </div>
						   ...
						   <input class="field__input" type="hidden" name="email" id="email" placeholder="e. g. 7222233554" value="<?php echo $emailRequestReceivedInfo['email'];?>" >
					   ...
					   <div class="checkout__subtitle uppercase changedText">Business details</div>
						  ...
						  <div class="field  margin-bottom24">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="company_name" id="company_name" placeholder="e. g. Qloud ID" style=" color:grey;">
                            </div>
                          </div>
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="cid" id="cid" placeholder="e. g. 123456789" style=" color:grey;">
                            </div>
                          </div>
  <input type="hidden" id="company_type" name="company_type" value="1" />
<input type="hidden" id="company_email" name="company_email" value="" />
 
<input type="hidden" id="signup_type" name="signup_type"  value="<?php echo $data['signup_type']; ?>" />
<input type="hidden" id="user_signup_info" name="user_signup_info"  value="<?php echo $emailRequestReceivedInfo['user_signup_info']; ?>" />
<input type="hidden" id="subscription_type" name="subscription_type"  value="<?php echo $emailRequestReceivedInfo['subscription_type']; ?>" />
<div class="upload__row">
                          <div class="upload__col upload__col_w70">
                        <div class="field  ">
                            <div class="field__label  changedText" style="color:#787f91;">Visiting address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="daddress" id="daddress" placeholder="e. g. Queenstown, Otago, New Zealand" style=" color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="d_port_number" id="d_port_number" placeholder="e. g. 121" style=" color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<div class="field__wrap">
<input class="field__input" name="dzip" id="dzip" type="text" placeholder="e. g. 111111" style=" color:grey;">
</div>
</div>
</div>
 <div class="upload__col upload__col_w70">
...
<div class="margin-bottom24">
                          <div class="field">
                            <div class="field__label">Select service you will provide</div>
                           <div class="field__wrap">
						   <select class=" "   id="objectType" name="objectType" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
                           
                           <option value="0" class="lgtgrey2_bg">Select</option>	
						  <?php  foreach($professionalCategoryDetail as $category => $value) 
												{ ?> 
								<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg"><?php echo $value['subcategory_name']; ?></option>	
												<?php }  ?> 	
                          </select>
...
<div class="field__wrap">
<input class="field__input" type="text" name="refrence_name" id="refrence_name" placeholder="e. g. Ghirmai" required="" style=" color:grey;">
</div>
</div>
