			...
			<div class="column_m talc lgn_hight_22 fsz16 mart60 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
							...
							<form action="../updateGuestPassportDetails/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div id="profile" class=" " style="display:block;">	
											...
											<div class="pos_rel">
												...
												<input type="text" name="first_name" id="first_name" placeholder="First name" class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25"> 
											...
											<div class="pos_rel">
												...
												<input type="text" name="last_name" id="last_name" placeholder="Last name" class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25"  > 
											...
											<div class="pos_rel">
												...
												<input type="text" name="email" id="email" placeholder="Email address" class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25"   /> 
										...
										<div class="pos_rel">
										<select id="pcountry" name="pcountry" class="wi_100 bg_2F3C4F nobrd padt25 tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir" />
											...
											<div class="pos_rel">
												...
												<input type="text" name="p_number" id="p_number" placeholder="Phone number"   class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25" value="<?php if($_POST['tenant_available']==1) echo $adultInvitationDetail['phone_number']; ?>" <?php if($_POST['tenant_available']==1) echo 'readonly'; ?> > 
								...
								<div id="profile3" class=" " style="display:block;">	
											...
											<div class="pos_rel">
												...
												<input type="text" name="id_number" id="id_number" placeholder=" Passport number" class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25"  /> 
