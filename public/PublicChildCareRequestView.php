...
<div class="column_m   xs-hei_55p bs_bb hidden">
				<div class="wi_100 minhei_65p xs-hei_55p xs-pos_fix padtb5 padrl10 " >
		...
		<div class="column_m header   bs_bb   hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 header_blue_67cff738 ">
            <div class="fleft padrl0   padtbz10 header_button_blue_67cff7a3">
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="#" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left header_arrow_blue_1e96c3" aria-hidden="true"  ></i></a>
                     </li>
                  </ul>
               </div>
            </div>
	...
	================================================== -->
	<div class="white_bg">
		<div class="wi_1200p maxwi_100 container xs-wi_100 white_bg">
			<div class="wi_1200p maxwi_100 twenty columns header_container xs-wi_100 white_bg">
				<div class="wi_760p xsi-wi_100 columns header_left alpha padt90 xs-padt0 xs-talc maxwi_100">
					<div class="header_left_inner">
						...
						<h2 class="black_txt fsz90 ffamily_avenir nobold xxs-fsz54 lgn_hight_100 xs-lgn_hight_55">Keep our
</h2>
<h2 class="black_txt bold fsz100 ffamily_avenir bold xxs-fsz54 lgn_hight_80 xs-lgn_hight_55">Children safe
</h2>	
	
						<h3 class="header_text ffamily_avenir lgn_hight_35 xs-lgn_hight_30 fsz30 xs-fsz20 black_txt padt10">
							<?php echo $requestDetail['company_name']; ?> har införskaffat SafeQid säkerhetssystem. SafeQid är en kombination av hämta/lämna system med inbyggt larm, evakuering vid fara och kommunikationssystem.
						</h3>	
			...
			<div class="seven columns header_right white_bg maxwi_375p omega xs-wi_100 box_shadow_00000070 mart40 marb40">
					<div class="header_right_inner padrtl35i white_bg padb0 ">
						...
						<fieldset   >
							 <label for="phone" >  
							<select  name="cntry" id="cntry" class="default_view wi_100 mart0  bg_ffde0054 nobrd   brd_width_1 txt_9a8815 fsz18  xxs-minhei_50p minhei_55p     tall  ffamily_avenir marb15" style="text-align-last:center;">
						    ...
						    <label for="email">
						    <input type="email" class="wi_100 nobrd bg_ffde0054  talc  xxs-minhei_50p minhei_55p fsz18 txt_9a8815 ffamily_avenir  marb15" placeholder="E-post adress" name="email" id="email" autocomplete="off" />
						    </label>
						    
						   
						    <label for="phone"> 
						    <input type="password"  class="wi_100 nobrd bg_ffde0054   talc  xxs-minhei_50p minhei_55p fsz18 txt_9a8815 ffamily_avenir marb15" placeholder="V&auml;lj lösenord" name="password" id="password"  autocomplete="off"/>
						    </label>
