...
<html>
	...
	<body class="lgtgrey2_bg">
		...
		<div class="column_m pos_rel" onclick="checkFlag();">
			...
			<!-- CONTENT -->
			<div class="column_m container zi5  mart10 xs-mart20" onclick="removeActive();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0  ">
						...
						<div class="talc fsz75 green_txt"> <span class="fas fa-check-circle"></span></div>
							<div class="padb10 ">
									<h1 class="padb5 talc fsz65 xs-fsz25 bold ">Hi Friend!</h1>
									<p class="pad0 xs-padb10 talc fsz25 xs-fsz16 padb0 wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 xs-brdb_b"><?php echo $requestDetail['first_name']." ".$requestDetail['last_name']; ?> has added you to NOFF, as a close relative. <?php echo $requestDetail['first_name']." ".$requestDetail['last_name']; ?> wish for you to be informed if something happens to him for any reason. However, we noticed that this mobile number is not registered. </p>
									<p class="pad0 xs-padb10 talc fsz25 xs-fsz16 padb0 wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 xs-brdb_b">If you wish for <?php echo $requestDetail['first_name']." ".$requestDetail['last_name']; ?> to be informed in case you have any type of accident. Pls create an account.</p>
						...
						<a href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/LoginAccount"><input type="button" value="Logga in" class="wi_320p maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" ></a>
