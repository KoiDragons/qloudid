...
<html>
	...
	<head>
		<meta charset="utf-8">
		<meta http-equiv="refresh" content="60;https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/DropinQueue/welcomeGuest/<?php echo $data['lid']; ?>" />
		...
		<div class="column_m header xs-header xsip-header xsi-header bs_bb " style="background-color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#f9f9f9"; else echo $corporateColor['bg_color']; ?>">
			...
			<div class="fright xs-dnone sm-dnone padt10 padb10">
					<ul class="mar0 pad0 sf-menu fsz14">
						...
						<li class="dblock hidden-xs hidden-sm fleft pos_rel brd2 brdclr_black brdrad5 marl20"> <a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl20  uppercase lgn_hight_25  black_txt_h" data-en="I´m expected" data-sw="I´m expected" style="color:<?php if($corporateColor['f_color']=="" || $corporateColor['f_color']==null) echo "#f5f5f5"; else echo $corporateColor['f_color']; ?>">I´m expected</a> </li>
				...
				<div class="padrl10 xs-padrl15">
					...
					<div class="wi_400p xsi-wi_360p maxwi_100   pos_rel zi5 marrla pad30  xs-pad0   brdrad5  " >
							...
							<div class="marb30 padt10 xsi-marb30">
									...
									<p class=" padt0  xsi-padb20 xs-padb20 talc fsz20 xs-fsz20  xsi-fsz23 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 black_txt trn" style="color:<?php if($corporateColor['f_color']=="" || $corporateColor['f_color']==null) echo "#f5f5f5"; else echo $corporateColor['f_color']; ?>">You have been added to waitlist</p>
								</div>
						 
					<div class="mart20 marb35  xxs-talc talc "> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc edit-text jain_drop_company black_txt talc ffamily_avenir" ><span class="trn">We will inform you whn its your turn on the queue. You will be directed to start page in few seconds.</span>
												</a></div>
