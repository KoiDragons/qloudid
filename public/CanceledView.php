				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0  ">
						...
						<div class="talc fsz75 red_txt"> <span class="fas fa-minus-circle"></span></div>
							<div class="padb10 ">
									<h1 class="padb5 talc fsz65 xs-fsz25 bold ">Avbruten !</h1>
									<p class="pad0 xs-padb10 talc fsz25 xs-fsz16 padb0 wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 xs-brdb_b">Något gick fel längs vägen. Pröva gärna en gång till.</p>
								</div>
						
						<div class="mart20 talc">
						<input type="button" value="Pröva igen" class="wi_320p maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" >
