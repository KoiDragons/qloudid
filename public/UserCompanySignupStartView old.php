...
">
<div class="clear"></div>
<form action="../emailSignUpRequest/<?php echo $data['domain_id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="checkout__item js-tabs-item" style="display: block;">
<div class="field">
...
<div class="receipt__free" style="font-size: 15px;">
				...
				<a class="button receipt__button    hidden" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro2_xxxx"><span>Shop online</span>
...
<a class="visible-xs hidden" style="text-decoration:none !important;" href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro2_xxxx" id="android">
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro2_xxxx" id="iOS">
<div class="receipt__description talc marrla " style="
    background: #101010;
    border-radius: 50px;
    width: 230px;
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button hidden" href="https://safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro2_xxxx" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
