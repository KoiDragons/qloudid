         ...
         <div class="wi_100 hei_75p xs-pos_fix padtb0 padr10 bg_212b3a brdb353945">
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../precheckedinInfo/<?php echo $data['hotel_checkin_id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
			...
			<div class="top_menu frighti padt20 padb10 hidden-xs">
				<ul class="menulist sf-menu  fsz16">  
					<li class="last first">
						<a href="../dependentsDetailinfo/<?php echo $data['hotel_checkin_id']; ?>" class="lgn_hight_s1 fsz18 sf-with-ul" ><span class="fas fa-plus white_txt" aria-hidden="true"></span></a>
			...
			<div class="top_menu frighti padt10 padb10" style="width:150px !important;">
				<ul class="menulist sf-menu  fsz16  sf-js-enabled sf-arrows">
					<li style="margin-right:20px !important;" class="first last">
						<a href="../dependentsDetailinfo/<?php echo $data['hotel_checkin_id']; ?>" class="lgn_hight_s1 fsz25" ><span class="white_txt fas fa-plus"></span></a>
					 </li>
				</ul>
			</div>
			<div class="clear"></div>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart60 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<div class=" xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText">Add your child as a guest</a></div>
									
									 <div class="tab-header martb10 padb10 xs-tall brdb2_3B71FE nobrdt nobrdl nobrdr talc">
									   <a href="#" class="dinlblck marni5 padrl30  xs-marl0  nobrd  bg_3B71FE brdrad40 xxs-brdrad10 lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active" >Invite</a></div>
									 ...
									 <a href="../addDependentChekin/<?php echo $data['hotel_checkin_id']; ?>/<?php echo $value['enc']; ?>">	
