...
<a class="header__logo xs-fsz20 " href="../checkedInDetail/<?php echo $data['hotel_checkin_id']; ?>" style="
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="../homeRepairLocationList/<?php echo $data['hotel_checkin_id']; ?>" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Home repair</h2>
<div class="browse__info info changedText">Here are tickets added for home repair issues</div>
</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
												foreach($userApartmentTicketList as $category => $value) 
												{
...
<div class="checkout__label changedText"><?php echo $value['ticket_title']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['ticket_subtitle']; ?></div>
 
<div class="checkout__controls">
<?php if($bookingInformationDetail['hotel_property_type']==3){ ?>
<a href="../homeRepairServiceCompanyList/<?php echo $data['checkout_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
