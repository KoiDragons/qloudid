					...
					$.ajax({
						...
						success: function(data1){
							...
							else 
							{
								...
								window.location.href ="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/InformRelatives";
							}
						}
					});
				...
				<div class="wi_100 xs-hei_40p hei_65p pos_fix padtb5 padrl10 bxsh_0220_0_14_031-2_0_2_0150_0_12 bxsh_0_trans_0_trans_02150_0_3_ph opbxsh_0004_6f_sibc white_bg">
					...
					<div class="fright xs-dnone sm-dnone padt10 padb10">
						<ul class="mar0 pad0 sf-menu fsz14 sf-js-enabled sf-arrows">
							...
							<li class="dblock hidden-xs hidden-sm fright pos_rel  brdclr_dblue marl20 last"> <a href="https://safeqloud-228cbc38a2be.herokuapp.com/user/index.php/LoginAccountEng" id="usermenu_singin" class="translate hei_30pi dblock padrl20 blue_bg_h uppercase lgn_hight_30 black_txt  white_txt_h  brdl" data-en="Logga In" data-sw="Logga In">Logga In</a> </li>
						</ul>
					</div>
