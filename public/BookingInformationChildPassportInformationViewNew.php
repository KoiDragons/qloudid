...
<body class="dark" style="background-color:#131922">
 ...
 var issueM="<?php echo date('m'); ?>";
		...
		$.ajax({
		type:"POST",
		url:"../../checkUsedIdentificator/<?php echo $data['hotel_checkin_id']; ?>/<?php echo $data['child_invitation_id']; ?>",
		data:send_data,
		dataType:"text",
		...
		if(data1!=0)
		{
		$("#error_msg_form").html('Passport already in use by other child');
		submitFlag = 0;
		return false;	
		}
		else
...
<a class="header__logo xs-fsz20 " href="../../precheckedPersons/<?php echo $data['hotel_checkin_id']; ?>" style="
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Passport</h2>
<div class="browse__info info xs-fsz25 changedText">Please provide child passport information below</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<form class="checkout__item js-tabs-item" action="../../updateChildPassport/<?php echo $data['hotel_checkin_id']; ?>/<?php echo $data['child_invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
