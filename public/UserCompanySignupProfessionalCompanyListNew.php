...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 changedText" href="../../../../../../../selectCity/<?php echo $data['domain_id']; ?>" style="
...
</div><a class="button button-small header__button   xxs-mart10 changedText hidden-xs   " href="#" style="margin-left:35px; min-width:112px; background:transparent; color:#777E90; font-size: 16px;">Menu</a>
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><?php echo count($getProfessionalServiceCompanies); ?> found</h2>


<div class="sorting__line" style="
    padding-bottom: 20px;
    margin-bottom: 24px;
">
                   
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Select one of the companies below to book
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">Companies</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active changedText" href="#">Objects for sale</a> <a class="nav__link changedText" href="#">Connected</a> <a class="nav__link changedText" href="#">Pending</a></div>
                 
                   <div class="sorting__select">
               <a href="#">  <button class="button-stroke catalog__button">
                  <span class="changedText">Companies</span>
                </button></a>
                </div>
              </div>
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
								foreach($getProfessionalServiceCompanies as $category => $value) 
												{
												if($value['selected_subscription']==3){	 
												?> 
               
				  
				  <a class="card card_row" href="../../../../../../../bookableServiceList/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $value['enc']; ?>" style="margin-bottom:24px;">
                  <div class="card__preview"><img srcset="<?php echo $value['images'][0]['profile_pic']; ?>" src="<?php echo $value['images'][0]['profile_pic']; ?>" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category" style="background:white !important; color:black;"><?php echo count($value['images']); ?> images</div>
                  </div>
                  <div class="card__body" style="background: #131922;">
                    <div class="card__line">
                      <div class="flight__title" style="font-size:30px;"><?php echo $value['company_name']; ?></div>
                    ...
                    <div class="card__options">
                      <div class="card__option">
                        ...
                        </svg><?php echo substr(html_entity_decode($value['address'], ENT_QUOTES, "UTF-8"),0,60); ?>
                      </div>
                      <div class="card__option">
					...
					<div class="card__line">
                      <div class="flight__title" style="font-size:20px; color:white;">Review</div>
                       
                    </div>
                      <div class="card__comment">
                        <div class="card__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar-2.jpg" alt="Avatar"></div>
                        <div class="card__text">The best 16 passenger small group, intimate and unique, Milford Sound...</div>
                      </div>
                      <div class="card__flex">
                        <div class="card__cost fsz16">From $<?php echo $value['price']; ?> total</div>
                        <div class="card__rating">
                          <svg class="icon icon-star">
                            <use xlink:href="#icon-star"></use>
                          </svg>
                          <div class="card__number fsz16">4.8</div>
                          <div class="card__reviews">(12 reviews)
												...
												<?php } else if($value['selected_subscription']==2){	  ?>
                  ...
                  <div class="card__body" style="background: #131922;">
                    ...
                    <div class="card__options">
                      <div class="card__option">
                        <svg class="icon icon-clock">
                          <use xlink:href="#icon-clock"></use>
                        </svg><?php echo substr(html_entity_decode($value['address']),0,60); ?>
                      </div>
                      <div class="card__option">
                        <svg class="icon icon-user">
                          <use xlink:href="#icon-user"></use>
				  ...
				  <a class="card card_row" href="../../../../../../../bookableServiceList/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $value['enc']; ?>" style="margin-bottom:24px; background: transparent;">
                 
                  <div class="card__body" style="background: transparent;">
                    <div class="card__line">
                      <div class="flight__title changedText" style="font-size:30px;"><?php echo $value['company_name']; ?></div>
                      <div class="card__price" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099; display:none;">
                        <div class="card__old">$<?php echo $value['price']; ?></div>
                        <div class="card__actual">$<?php echo $value['price']; ?></div>
                      </div>
                    </div>
                    <div class="card__options">
                      <div class="card__option">
                        <svg class="icon icon-clock">
                          <use xlink:href="#icon-clock"></use>
                        </svg><span class="changedText">Service</span>
                      </div>
                      <div class="card__option">
                        <svg class="icon icon-user">
                          <use xlink:href="#icon-user"></use>
                        </svg><span class="changedText">Bookable</span>
                      </div>
                    </div>
                    <div class="card__foot">
                      <div class="card__comment">
                        
                        <div class="card__text  fsz14 changedText"><?php echo substr(html_entity_decode($value['address']),0,60); ?></div>
                      </div>
                      <div class="card__flex">
                        <div class="card__cost fsz16">From $<?php echo $value['price']; ?> total</div>
