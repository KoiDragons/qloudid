...
"toolbar=0,menubar=0,width=900,height=280,top=0,left=0,scrollbars=1,resizable=yes" ,"_blank");
			...
			function submitForm()
			{
				...
				if($('#carried_for1').val()==0)
					{
						alert('please select for whom job is posted');
					submitForm = false;
					return false;
					}
				if(submitForm==true)
...
<body class="dark" style="background: #131922;" onload="checkLogin();">
...
<!-- header-->
	...
	<form action="../../updateUserInfo/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
	<input type="hidden" id="carried_for" name="carried_for" value="1">
			<input type="hidden" id="user_signup_info" name="user_signup_info" value="1">
			<input type="hidden" name="ip" id="ip" value="<?php echo $verifyIP; ?>">
			</form>
	
	
	<div class="column_m talc lgn_hight_22 fsz16 mart175" id="loginBankMsg" style="display:none">
<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
		<div class="wi_720p maxwi_100 pos_rel zi5 marrla ">
<div class="receipt xs-margin0" style="border: none;    padding:0; margin:0; width:100%;">
<h1 class="hero margin-bottom16 changedText" style="font-size:80px;">Open Qloud ID App</h1>
<div class="main__info info margin-bottom16 white_txt changedText">Then type your security code for verification.</div>
</div>
</div>
</div>
</div>
<div class="section   mart100 xxs-mart40  xs-padb0" style="border-color: white;margin-top: 70px;" id="loginBank">

<div class="checkout__center center xs-padrl25">
<div class="checkout__wrapper xs-flexD" >
<div class="checkout__inner js-tabs">
<div class="browse__head" style="margin-bottom:0px;  padding-right: 0px;">

<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">TO PAY</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Select payment option to pay
</h2>
...
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Verify with</div>
<input class="checkout__input js-date-single changedText" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="Qloud ID">
...
<?php if($serviceSelected['num']>0)
{
	?>
<div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px; background:transparent; border:1px solid #23262f;">
<div class="checkout__label changedText">Pay</div>
<input class="checkout__input js-date-single changedText" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="Manually">
<div class="checkout__controls">
 
<a href="../../mannualPaymentInfo/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#f67f00;"></use>
</svg>
</button></a>
...
<div class="checkout__inner js-tabs">
<div class="checkout__list marrla" style="max-width: 375px;">
<div class="checkout__section hidden-xs">
<div class="checkout__box">
<div class="checkout__category changedText" style="
    font-size: 30px;
">POST YOUR JOB</div>
...
<div class="checkout__section xsi-nobrdt padt32 xsi-padt45 nobrdt" style="margin-top: 0px; padding-top: 10px;">
...
<select class="nice-select select" id="price_info" name="price_info" style="background: rgb(244, 245, 246); height: 60px; border: none; padding: 0px 14px; color: rgb(119, 126, 144); border-radius: 12px; width: 100%;  " fdprocessedid="8mc52" onchange="updateProfile(this.value);">
	 			
<option value="1" class="lgtgrey2_bg changedText">Private user</option>
<option value="2" class="lgtgrey2_bg changedText">Company</option>			
</select> 
</div>
</div>
...
<div class="description__center center xxs-padrl25">
...
<div class="receipt xs-margin0 marrla maxwi_100 wi_375p xs-pad20" style="
    
box-shadow: 0 0 0 0;
">
			
<div class="header__center center" style="
    padding: 0 0px;
"><a class="header__logo xs-fsz20 changedText" href="https://www.qloudid.com/user/index.php/LoginAccount" style="
...
<div class="receipt__head hidden-xs" style="padding:0px;display:block;text-align:center;margin-top: 44px;">
<div class="receipt__details">
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>" class="" style="width: 125px;height: 125px;"></div>
</div>

</div>
<div class="receipt__foot">
<div class="receipt__free changedText" style="margin-bottom: 5px;font-size: 22px;color: white;">Scan With Qloud ID</div>
				
				
				
</div><div class="receipt__foot" style="
">
<div class="receipt__free changedText" style="font-size: 15px;color: grey;margin-bottom: 20px;">If you dont have one then create an account for free.
</div>

				<a class="button receipt__button    hidden" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>"><span>Shop online</span>
...
<form action="../../emailSignUpJobRequest/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>" method="POST" id="save_indexing" name="save_indexing" class="subscription subscription_big" style="margin-top: 0px;">
<input class="subscription__input" type="text" name="email" id="email" placeholder="Add your personal email" required="required" style="
    background: white;
">
<input type="hidden" id="carried_for1" name="carried_for1" value="1">
<input type="hidden" id="user_id" name="user_id" value="0">
			<input type="hidden" id="user_signup_type" name="user_signup_type" value="1">
<button class="subscription__btn" style="background:#E91E63;" onclick="submitForm();">
...
<div class="receipt__description talc marrla hidden" style="
    ...
    margin-bottom: 20px;
">
<div class="receipt__item talc" style="justify-content: center;padding: 8px;height: 40px;">

<div class="receipt__box">
<div class="receipt__subtitle changedText" style="color:white !important;">Create account</div>
</div>
</div>
</div></a>
<div class="receipt__foot  " style="padding-top:20px;">

				<a class="button receipt__button   hidden visible-xs " id="iOS" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>"><span >Open Qloud ID App</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
				
				<a class="button receipt__button visible-xs hidden " href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro4_<?php echo $data['job_id']; ?>" id="android"><span class="changedText">Open Qloud ID App</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
...
<div class="description__wrapper xs-pad0 padrt50 visible-xs marrla" style="    /* max-width: 375px; */">


<div class="description__group" style="
    padding-right: 25px;
    padding-left: 25px;
">
<div class="description__section" style="
    margin-top: 24px;
    padding-top: 24px;
    border-color: #E6E8EC;
">
<div class="description__content" style="
    margin-bottom: 32px;
">
<h4 style="display:none;" class="changedText">Activity</h4>
<p class="fsz35 lgn_hight_45 fsz35 xs-lgn_hight_25 xs-fsz20 xs-talc changedText" style="
    font-size: 18px;
    line-height: 24px;
">You can download it for free on Appstore or Android marketplace</p>


</div>
</div>
<p style="/* align-items: center; */width: 325px;text-align: left;padding-left: 0px;"><a href="https://apps.apple.com/se/app/swish-betalningar/id563204724">
<img src="//images.ctfassets.net/zrqoyh8r449h/7u6ZACFdyiHvwhSDfk5b9L/7720758e21118d44b428b8d2393f5bd9/Download_on_the_App_Store_Badge_SE_RGB_blk_100317_1.png" alt="Ladda ner på App Store" class="app-badge talc" width="149px" height="50px"></a><a href="https://play.google.com/store/apps/details?id=se.bankgirot.swish&amp;hl=sv" style="
    padding-left: 15px;
"><img src="//images.ctfassets.net/zrqoyh8r449h/2gFPf1iMroNM0X6p37skvP/18ab9ee3a06d24713baa0cc2ec3c756b/Frame.png" alt="Ladda ner på Google Play" width="149px" height="50px" class="app-badge" style="
    padding-left: 0px;
"></a>
</p>
<div class="description__section" style="display:none;">
...
<div class="description_content description_content_hide" style="display: block;">
...
<button class="button-stroke button-small description__button" style="display: none;">Show more</button>
</div>
</div>
</div>
</div>
