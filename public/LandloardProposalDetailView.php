...
<html lang="en">
 ...
 <body class="dark" style="background: #131922;"  >
    <!-- outer-->
    <div class="outer" onclick="closePoup();">
      <!-- header-->
...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../proposerDetail/<?php echo $data['proposal_id']; ?>" style="
...
<div class="header__country dropdown-item changedText" tolang="uk">Ukrainian</div></a></div>
</div>
</div>
...
<div class="product__box  " style=" margin-top:0px; border-bottom:1px solid #f67f00; margin-bottom:24px;">
...
">
 ...
 <div class="description__parameters" style="
    ...
    padding-top: 0px;
">
                <div class="description__parameter  hidden-xs">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>16 June</div>
                <div class="description__parameter  xs-marl0">
                ...
                <div class="description__parameter ">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>Ana Tikhonova</div>
				   <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>+34 604 28 67 89</div>
              </div>
</div>
...
<div class="upload__preview js-upload-preview">
                ...
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card" style="fill:#f67f00;"></use>
                </svg><span style="color:#f67f00">Proposal</span></a>
				<a class="setting__link js-tabs-link  " href="#">
                <svg class="icon icon-credit-card">
...
<div class="upload__wrapper  "  style="padding-right:0px;">
   ...
   <div class="flights__container" style="padding-left:0px;">
                <div class="flights__list">
				  ...
				  <div class="photo-wall__tiles" id="allPhotos">
					 ...
					 <div class="card card_row"   style="margin-bottom:24px;">
										...
										<div class="card__preview"><img srcset="https://safeqloud-228cbc38a2be.herokuapp.com/estorecss/tmp<?php echo str_replace(' ','%20',$value['imageId']); ?>.jpg" src="https://safeqloud-228cbc38a2be.herokuapp.com/estorecss/tmp<?php echo str_replace(' ','%20',$value['imageId']); ?>.jpg" alt="Premium milford sound tour ex Queenstown">
    ...
    margin-bottom: 0px;
">
                   <a href="../proposalApartmentInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['property_id']; ?>" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:25px; color:white;"><?php echo $value['building_name']; ?></div></a>
...
">
                <div class="description__parameter" style="">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText"><?php  echo $value['bedroom_count']; ?> Bedrooms</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['bathroom_count']; ?> Bathrooms</span></div>
                <div class="description__parameter  hidden-xs">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                    ...
                    <div class="card__foot"  >
                      ...
                      <div class="card__comment  " style="      padding-bottom: 0px;">
                        
                        <div class="card__text changedText" style="
    font-size: 14px;
    line-height: 20px;
">
 <?php  echo $value['long_selling_description']; ?> </div>
                      </div>
...
">
		   ...
		   <div class="card__foot" style="">
				...
				<a href="../proposalApartmentInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['property_id']; ?>" style="text-decoration:none;">  <button class="button-stroke button-small faq__button changedText fright" fdprocessedid="w46jts" style="margin-top:0px; padding:0px 20px;">View</button></a>
		  </div>
   ...
   <div class="popup_modal wi_500p maxwi_90 opa0 opa1_a pos_fix pos_cen zi50 bs_bb white_bg fsz14 gratis_popup_company_searched brd brdrad10 " id="gratis_popup_error" style="display: none;">
			<div class="modal-content pad25 brd brdrad10">
				...
				<div class="lightbox__img-content"><a class="lightbox__img-nav false"></a><img class="lightbox__img" src="https://safeqloud-228cbc38a2be.herokuapp.com/estorecss/tmpnew0.28547600 1710074969.jpg"></div>
