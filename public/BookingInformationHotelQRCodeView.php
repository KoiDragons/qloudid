...
<div class="header__center center"><a class="header__logo xs-fsz20 " href="#" style="
    ...
    "><?php echo substr($hotelInformation['hotel_name'],0,10); ?></a>
...
<p class="fsz35 lgn_hight_45 fsz35 xs-lgn_hight_25 xs-fsz20 xs-talc ">Scan and sign with QR Code reader to checkin to the apartment</p>
...
<div class="description__content" style="
    margin-bottom: 32px;
">
<h4 style="display:none;">Welcome</h4>
<p class="fsz20 lgn_hight_25 xs-lgn_hight_25 xs-fsz20 xs-talc">We are very hapy to see you here. Kindly rate your stay on chekout.</p>
...
<button class="button-stroke button-small description__button" style="display: none;">Show more</button>
		...
		<div class="receipt xs-margin0 marl60 xxs-wi_325p wi_375p xs-pad20" style="
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/BookingInformation/verifyHotelCheckinCode/<?php echo $data['hotel_id']; ?>" class="white_brd brdrad5" style="width: 150px;height: 150px;"></div>
</div>
...
<div class="receipt__free" style="font-size: 15px;">
                  Scan and checkin to your hotel</div>
