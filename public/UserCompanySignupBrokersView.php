...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
	...
	<div class="header__item header__item_dropdown js-header-item hidden-xs">
              <button class="header__head js-header-head " fdprocessedid="vkjigu">Menu
...
<div class="outer__inner">
  <div class="section travel" style="margin-top: 50px; padding-bottom:136px;">
...
<div class="travel__subtitle fsz52i lgn_hight_55 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
    
    margin-bottom: 10px;
    
    font-weight: 100;
    color: #fff;
">BUILD YOUR BRAND</div>
<div class="travel__subtitle fsz52i lgn_hight_55 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
    ...
    color: #fff;
    font-weight: 600;
">WIN MORE BUSINESS</div>
<div class="travel__content fsz30 lgn_hight_40 xs-fsz25 xs-lgn_hight_35 xs-talc changedText" style="
    font-size: 30px;
    color: #777E90;
    
">Uncover the potential of Spain premier digital marketplace for the real estate sector.</div>
</div>
</div>
...
<div class="profile">
                <div class="profile__main">
                  <div class="profile__avatar xsi-wihi_128p"><img src="https://www.dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar"></div><a class="profile__update js-popup-open" href="#popup-avatars" data-effect="mfp-zoom-in" tabindex="0">
                ...
                <div class="profile__body">
                  ...
                  <div class="profile__control"><a class="button-stroke button-small profile__button changedText" href="#" tabindex="0">Contact</a>
                    <div class="actions js-actions">
                      <div class="actions__item actions__item_share js-actions-item">
                        <button class="button-circle-stroke button-small actions__button js-actions-button" fdprocessedid="2orxn" tabindex="0">
                        ...
                        <div class="actions__body actions__body_up js-actions-body">
                          ...
                          <div class="actions__list share-btn" data-url="#"><a class="actions__link btn-twitter" data-id="tw" tabindex="0"><span>
                                <svg class="icon icon-twitter">
                                  <use xlink:href="#icon-twitter"></use>
                                </svg></span></a><a class="actions__link btn-facebook" data-id="fb" tabindex="0"><span>
                  ...
                  <div class="profile__socials"><a class="profile__social" href="javascript:void(0);" tabindex="0">
                      <svg class="icon icon-twitter">
                        <use xlink:href="#icon-twitter"></use>
                      </svg></a><a class="profile__social" href="javascript:void(0);" tabindex="0">
...
<div class="section browse  visible-xs" style="  ">
          <div class="browse__center center">
            <div class="browse__inner">
              <div class="places__head">
                <h2 class="places__title h2 xs-tall">Maximize Your Real Estate Reach</h2>
                <div class="places__info info xs-tall">Expand Your Reach and Access Qualified Leads in the Real Estate Market</div>
              </div>
              <div class="browse__wrapper">
				...
				<a class="browse__card" href="#" style="width: 292px; border-radius:24px;">
									...
									<div class="browse__content" style="
										...
										background: #23262F;
									">By joining a marketplace like findabroker.com, the real estate service can significantly expand its visibility to a larger audience actively seeking real estate services, thereby increasing its chances of attracting potential clients.
							...
							<a class="browse__card" href="#" style="width: 292px; border-radius:24px;">
									...
									<div class="browse__content" style="
										...
										border-radius: 0px 0px 24px 24px;
										background: #23262F;
									">Being listed on findabroker.com provides access to a pool of pre-qualified leads who are already interested in real estate transactions, increasing the likelihood of converting these leads into clients and growing the service's business.</div></a>
...
<div class="section places hidden-xs">
...
<div class="places__head ">
<h2 class="places__title h2 xs-tall   ">Maximize Your Real Estate Reach</h2>
<h2 class="product__title h2 talc  xs-padrl0 fsz35 xs-fsz25 xs-tall talc" style="font-family: 'Poppins', sans-serif;font-weight: 100;color: #787f91;max-width: 100%;font-size: 24px;line-height: 1.33333;">Expand Your Reach and Access Qualified Leads in the Real Estate Market</h2>
...
<div class="places__subtitle xs-tall tall fsz32i">Increased Visibility </div>
<div class="places__time  xs-tall tall fsz20i" style="    line-height: 1.33333;">By joining a marketplace like findabroker.com, the real estate service can significantly expand its visibility to a larger audience actively seeking real estate services, thereby increasing its chances of attracting potential clients</div></a>

<a class="places__item places_item_update xs-mart25" href="javascript:void(0);" tabindex="0" style="" aria-hidden="true">
<div class="status-gray places__number hidden">1480</div>

<div class="places__subtitle xs-tall tall fsz32i">Access to Qualified Leads</div>
<div class="places__time xs-tall tall fsz20i" style="    line-height: 1.33333;">Being listed on findabroker.com provides access to a pool of pre-qualified leads who are already interested in real estate transactions, increasing the likelihood of converting these leads into clients and growing the service's business.</div></a></div>
</div>
</div>
</div>
</div>
 ...
 <div class="section adventure hidden" style="margin-top: 150px; ">
          <div class="adventure__center center">
            <div class="adventure__head">
              <h2 class="adventure__title h2">This is how it works</h2>
              <div class="adventure__info info">3 simple steps to get started.</div>
            </div>
            <div class="adventure__wrapper">
              <div class="adventure__slider js-slider-adventure">
                                <div class="adventure__item">
                                  <div class="adventure__preview"><img src="https://www.safeqloud.com/html/usercontent/images/how%20it%20works/3.jpg" alt="Adventure"></div>
                                ...
                                <div class="adventure__item">
                                  <div class="adventure__preview"><img src="https://www.safeqloud.com/html/usercontent/images/how%20it%20works/4.jpg" alt="Adventure"></div>
                                  <div class="adventure__details">
                                    <div class="adventure__subtitle">Then add your agents</div><a class="status adventure__places" href="#">12,326 places</a>
                                  </div>
                                </div>
                                <div class="adventure__item">
                                  <div class="adventure__preview"><img src="https://www.safeqloud.com/html/usercontent/images/how%20it%20works/6.jpg" alt="Adventure"style="border-radius:100%"></div>
                                  <div class="adventure__details">
  ...
  <div class="section categories  " style="margin-top: 150px;">
<div class="categories__center center">
<div class="categories__inner">


<div class="places__head ">
<h2 class="places__title h2 xs-tall   ">Streamline Your Transactions</h2>
<h2 class="product__title h2 talc  xs-padrl0 fsz35 xs-fsz25 xs-tall talc" style="font-family: 'Poppins', sans-serif;font-weight: 100;color: #787f91;max-width: 100%;font-size: 24px;line-height: 1.33333;">Effortlessly Manage Orders, Inquiries, Clients, and Buyers/Sellers</h2>
 
</div>

<div class="categories__head xs-padrl25 xs-tall hidden"  style="
    margin-bottom: 75px;
">
<h2 class="categories__title h2 fsz60 xs-fsz45" >Streamline Your Transactions</h2>
<div class="categories__info info xs-fsz25 fsz30">Effortlessly Manage Orders, Inquiries, Clients, and Buyers/Sellers</div>
</div>
<div class="categories__wrapper">
<div class="categories__slider js-slider-categories ">
  <?php  foreach($selectedMarketplaceSubscriptionServicesDetail as $category => $value) 
															{
...
<div class="categories__subtitle" style="
    font-size: 30px;
    color: #EE8E8C;
    font-weight: 800;
"><?php echo $value['subcategory_name']; ?></div>
<div class="categories__content" style="
    font-size: 16px;
    /* */
"><?php echo substr(strip_tags($value['professional_description']),0,300); ?></div></a>
															<?php } ?>
...
<div style=" margin-top: 150px;" class="section-mb64 xs-marb0 padt136 hidden">
<div class="product__center center">

<div class="product__head" style="
...
<div class="product__box" style="
	...
	padding-bottom: 0px; 
">
<h2 class="product__title h2 xs-fsz50 talc xs-tall" style="font-family: avenir;font-weight: 700; max-width: 100%;">Our services</h2>

<h2 class="product__title h2 talc padrl120 xs-padrl0 fsz35 xs-fsz25 xs-tall talc" style="font-family: avenir;font-weight: 100; color: #787f91; max-width: 100%;">Will satisfy your demands, wishes and needs.
</h2></div>
...
<div class="section browse  hidden" style=" margin-top: 0px; ">
          <div class="browse__center center">
            <div class="browse__inner">
             
              <div class="browse__wrapper">
                <div class="browse__slider js-slider-browse">
				<a class="browse__card" href="https://dstricts.com/public/index.php/StartExploring/lifestyle/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style="width: 292px;">
                                      <div class="browse__preview" style="height: 370px;border-radius: 6px 6px 0px 0px;margin-bottom: 0px;"><img srcSet="https://dstricts.com/html/usercontent/images/lifestyle/1.jpg" src="https://dstricts.com/html/usercontent/images/lifestyle/1.jpg" alt="Card" style="width:auto;left: -86px;  filter: grayscale(100%);">
									...
									<div class="browse__content" style="
										...
										background: #2c3544;
									">Dstricts Lifestyle Team takes care of the mundane tasks that often hinder members' ability to fully embrace the finer things in life. 
									</div></a>
									
									<a class="browse__card" href="https://dstricts.com/public/index.php/StartExploring/travel/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style="width: 292px;">
                                      <div class="browse__preview" style="height: 370px;border-radius: 6px 6px 0px 0px;margin-bottom: 0px;"><img srcSet="https://dstricts.com/html/usercontent/images/lifestyle/2.jpg" src="https://dstricts.com/html/usercontent/images/lifestyle/2.jpg" alt="Card" style="width:auto;left: -250px;  filter: grayscale(100%);">
									...
									<div class="browse__content" style="
										...
										border-radius: 0px 0px 6px 6px;
										background: #2c3544;
									">Dstricts Travel Team elevates travel experiences by seamlessly managing all aspects of the journey in a perfectly synchronized way.</div></a>
									
									<a class="browse__card" href="https://dstricts.com/public/index.php/StartExploring/events/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style="width: 292px;">
                                      <div class="browse__preview" style="height: 370px;border-radius: 6px 6px 0px 0px;margin-bottom: 0px;"><img srcSet="https://dstricts.com/html/usercontent/images/lifestyle/3.jpg" src="https://dstricts.com/html/usercontent/images/lifestyle/3.jpg" alt="Card" style="width:auto; left: -0px;  filter: grayscale(100%);">
                                      ...
                                      <div class="browse__subtitle" style="
										...
										<div class="browse__content" style="
											...
											border-radius: 0px 0px 6px 6px;
											background: #2c3544;
										">Districts Dining & Nightlife Team is your personal concierge to the world's most exclusive culinary and entertainment experiences.</div></a>
										
										
										<a class="browse__card" href="https://dstricts.com/public/index.php/StartExploring/events/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style="width: 292px;">
                                      <div class="browse__preview" style="height: 370px;border-radius: 6px 6px 0px 0px;margin-bottom: 0px;"><img srcSet="https://dstricts.com/html/usercontent/images/lifestyle/4.jpg" src="https://dstricts.com/html/usercontent/images/lifestyle/4.jpg" alt="Card" style="width:auto; left: -150px;  filter: grayscale(100%);">
                                      ...
                                      <div class="browse__subtitle" style="
										...
										<div class="browse__content" style="
											...
											border-radius: 0px 0px 6px 6px;
											background: #2c3544;
										">Dstricts Experience Team grants members access to a world of unparalleled experiences, tailored to their refined tastes and preferences.</div></a>
...
<div class="section-mb64 xs-marb0  " style="  margin-bottom: 0px;  /* margin-top: 136px; */ padding-bottom: 40px; margin-top: 150px;">
<div class="product__center center">


<div class="places__head ">
<h2 class="places__title h2 xs-tall   ">Join Our Broker Network</h2>
<h2 class="product__title h2 talc  xs-padrl0 fsz35 xs-fsz25 xs-tall talc" style="font-family: 'Poppins', sans-serif;font-weight: 100;color: #787f91;max-width: 100%;font-size: 24px;line-height: 1.33333;">Exclusive Launch Offer: Special Discounted Pricing for Agencies</h2>

</div>

 
<div class="product__center center hidden" style="    padding-left: 0px;    padding-right: 0px;">

<div class="gallery marb30">
<div class="gallery__list gallery__list_tour">
<div class="gallery__preview"><a class="gallery__view" href="https://dstricts.com/html/usercontent/images/lifestyle/5.jpeg" data-fancybox="gallery1" data-caption="Spectacular views of Queenstown"><img src="https://dstricts.com/html/usercontent/images/lifestyle/5.jpeg" alt="Gallery" style="filter: grayscale(100%);"></a><a class="button-white button-small gallery__button" href="#">
<svg class="icon icon-image">
<use xlink:href="#icon-image"></use>
</svg><span>Barcelona</span></a></div><a class="gallery__preview" href="https://dstricts.com/html/usercontent/images/convendum/1672738042514.jpeg" data-fancybox="gallery1"><img src="https://dstricts.com/html/usercontent/images/convendum/1672738042514.jpeg" alt="Gallery" style="filter: grayscale(100%);"></a><a class="gallery__preview" href="https://dstricts.com/html/usercontent/images/convendum/Belisa-Mak.webp" data-fancybox="gallery1" style="filter: grayscale(100%);"><img src="https://dstricts.com/html/usercontent/images/convendum/Belisa-Mak.webp" alt="Gallery" style="filter: grayscale(100%);"></a><a class="gallery__preview" href="https://dstricts.com/html/usercontent/images/convendum/BG29.jpg" data-fancybox="gallery1"><img src="https://dstricts.com/html/usercontent/images/convendum/BG29.jpg" alt="Gallery" style="filter: grayscale(100%);"></a>
<a class="gallery__preview" href="https://dstricts.com/html/usercontent/images/convendum/Office-Management-1-2048x1366.jpg" data-fancybox="gallery1"><img src="https://dstricts.com/html/usercontent/images/convendum/Office-Management-1-2048x1366.jpg" alt="Gallery" style="filter: grayscale(100%);"></a>
</div>
</div>

<div class="center talc hidden">
<div class="button travel__button  " style="background: transparent;color: #f67f00;border:1px solid #f67f00;border-radius: 6px;Font-size:24px;
Max-width: 500px;
Height: 80px; padding: 0 40px;
" onclick="submitPartner(2);">Get started</div>
</div>
</div>
...
<div class="checkout__inner js-tabs wi_35 xs-wi_100" style="padding-right: 25px; max-width:368.34px;">
<div class="section categories  marl6 " style="margin-bottom: 0px; ">
  

<div class="receipt" style="border:none; margin-bottom:0px; margin-top:0px; border-radius:24px 24px 0px 0px; padding-bottom:10px; width:100%; margin-left:0px;">
<div class="receipt__head">
<div class="receipt__details">
<div class="receipt__cost">

<div class="receipt__actual">Agent</div>
<div class="receipt__note hidden">/night</div>
</div>
<div class="receipt__rating">


<div class="receipt__reviews" style="
    margin-left: 0px;
">Free</div>
</div>
</div>
...
<div class="receipt__description  " style="
    background: #b73360;
">
...
<div class="receipt__box">
					...
					<div class="price__subtitle" style="
    font-size: 24px;
">$0</div>
...
<div style="border-bottom: 1px solid #353945;">
			</div>
...
<div class="checkout__box">
	...
	<div class="card card_row " style="border:none; border-bottom: 1px solid #353945; border-radius:0px;  ">
												
<div class="card__body pad2435 xs-pad24" style="background: #23262F;padding-left: 0px;">
<div class="card__line  " style="display:block;">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Properties 4 Sale Program</div>

</div>
<div class="card__options  " style="display:block;">

<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;">




<p>List your properties for sale and gain visibility through private listings on our partner portal.</p>
...
<div class="card__body pad2435 xs-pad24" style="background: #23262F;padding-left: 0px;">
<div class="card__line  " style="display:block;">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Sold Property Programs</div>
...
<p>Seize a unique, one-time opportunity to inform all homeowners in the community about your successful sale.</p>
</div>
</div>
...
<div class="receipt__actual">Agent Pro</div>
<div class="receipt__note hidden">/night</div>
</div>
<div class="receipt__rating">
...
<div class="receipt__reviews">Recommended</div>
</div>
</div>
...
<div class="receipt__box">
					...
					<div class="price__subtitle" style="
    font-size: 25px;
">$<?php echo $selectedMarketplaceDetail['gold_account_subscription_fee']; ?></div>
...
<div class="card__body pad2435 xs-pad24" style="background: #23262F;padding-left: 0px;">
<div class="card__line  " style="display:block;">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Fast track</div>
...
<p>With our Fast Track option, agencies can bypass lengthy wait times, gaining immediate exposure for their listings.</p>
...
<div class="receipt__actual">Leads</div>
<div class="receipt__note hidden">/night</div>
</div>
<div class="receipt__rating">
...
<div class="receipt__box">
					...
					<div class="price__subtitle" style="
    font-size: 25px;
">$<?php echo $selectedMarketplaceDetail['premium_account_subscription_fee']; ?></div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">$99/Licence</div>
<div class="field__wrap">
<input class="field__input hidden" type="number" name="licence443" id="licence443" min="1" value="1" style="background:#131922; color:grey; border:none;" fdprocessedid="1qwb0h" readonly=""  >
</div>
</div>
...
<div class="card__body pad2435 xs-pad24" style="background: #23262F;padding-left: 0px;">
<div class="card__line  " style="display:block;">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">File import</div>
...
<p>File import of employees and properties involves uploading a file with employee and property information directly into the system. It's advantageous as it saves time, reduces errors, and allows for bulk data entry.</p>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">$0/Licence</div>
<div class="field__wrap">
<input class="field__input hidden" type="number" name="licence466" id="licence466" min="1" value="1" style="background:#131922; color:grey; border:none;" fdprocessedid="1qwb0h" readonly="" onfocusout="updateLicenceNumber(this.value,&quot;licence466&quot;,466);">
</div>
</div>
...
<form action="../selectSubscriptionSignup/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing1" id="save_indexing1" accept-charset="ISO-8859-1" autocomplete="off">
			...
			<input type="hidden" name="subscription_selected" id="subscription_selected" value="1">
			</form>
			<div class="talc  " style="padding-bottom:100px;"><a class="header__logo xs-fsz20 hidden-xs changedText" href="javascript:void(0);" style="
    ...
    padding-left: 35px;
    padding-right: 35px;
    " onclick="submitPartner(2);">Submit</a></div>
			 
<div class="section services hidden">
<div class="services__center center">


 <div class="adventure__head hidden">
              <h2 class="adventure__title h2">Our prices</h2>
              <div class="adventure__info info">To get started you need to select the plan that fits you</div>
            </div>
 
<div class="services__list xs-mar0i">
<?php    if($selectedMarketplaceDetail['charge_on_companies']==1) { ?>
 <div class="services__item" style=" background-color:transparent;
    border: 3px solid white; 
"  onclick="submitPartner(1);">

<div class="services__subtitle" style="
...
<div class="services__subtitle" style="
      font-size: 25px;
">Free</div><div class="services__content" style="
    
">This account is completely free of cost
</div>
</div> 
<?php }  if($selectedMarketplaceDetail['charge_on_buyers']==1) { ?>
 <div class="services__item" style=" background-color:transparent;
...
<div class="services__subtitle" style="
    font-size: 25px;
">Introduction</div><div class="services__content" style="
    ">The fee is per occassion</div>
</div> 
<?php } if($selectedMarketplaceDetail['charge_on_partners']==1) { ?>
 <div class="services__item" style=" background-color:transparent;
    /* background: #a3eabc; */
    border: 3px solid white;  
"  onclick="submitPartner(3);">
...
<div class="services__subtitle" style="
     font-size: 25px;
">Premium</div><div class="services__content" style="
    ">The fee is per occassion</div>
</div> 
<?php } ?>
</div>
...
<div class="checkout__center center" style="padding-bottom:80px; ">

<div class="checkout__wrapper  xs-flexD">
<div class="checkout__inner js-tabs wi_50">
<div class="browse__head" style="padding-right:0px;">
<h2 class="browse__title h2 changedText fsz60 xs-fsz45"  >How it works</h2>
<div class="browse__info info changedText">4 easy steps that takes less than 5 min to find the best and right agent for your project</div>
</div>
...
<div class="card__title changedText" style="font-size:30px; line-height: 1.2667">Fill in the form</div>
 
</div>
<div class="card__options">
 
<div class="card__option changedText" style="font-size:20px; line-height:1.26667;">
...
<div class="card__body pad2435 xs-pad24" style="background: #131922; ">
<div class="card__line">
<div class="card__title changedText" style="font-size:30px; line-height: 1.2667">We match you</div>
...
<div class="card__body pad2435 xs-pad24" style="background: #131922; ">
<div class="card__line">
<div class="card__title changedText" style="font-size:30px; line-height: 1.2667">You compare agents</div>
...
<div class="card__body pad2435 xs-pad24" style="background: #131922; ">
<div class="card__line">
<div class="card__title changedText" style="font-size:30px; line-height: 1.2667">Hire the right person!</div>
 
</div>
<div class="card__options">
 
<div class="card__option changedText" style="font-size:20px; line-height:1.26667;">
The service is free and you pay us nothing, good luck with your sale!
</div>
...
<div class="section comments hidden">
<div class="comments__center center xxs-padrl25">
<div class="profile xs-marrl0i" style="
    background: #1b2738;
    border: 5px solid white;
">
<div class="profile__head">
<div class="profile__line">
<div class="profile__avatar"><img src="<?php echo $path; ?>html/usercontent/images/people/5.jpg" alt="Avatar">
...
<div class="profile__number" style="
   
">4.8</div>
<div class="profile__reviews" style="
...
<div class="profile__body">
<div class="profile__parameters" style="background:#131922;">
<div class="profile__parameter" style="
    color: white;
">
<svg class="icon icon-home" style="
    color: white;
">
<use xlink:href="#icon-home"></use>
</svg>Golden Partner</div>
<div class="profile__parameter" style="
    color: white;
">
<svg class="icon icon-star-outline">
...
<div class="profile__info" style="
   
">Safe Keys is a Pickapro certified golden partner. Safe Keys is a security company that offers keyholding services to home owners in Spain</div><a class="profile__site" href="https://ui8.net" target="_blank" style="
    color: #3b71fe;
">
<svg class="icon icon-globe">
<use xlink:href="#icon-globe"></use>
</svg>https://ui8.net</a>
<div class="profile__control"><a class="button-stroke button-small profile__button" href="message-center.html" style="
    background: black;
">Contact</a>
<div class="actions js-actions">
<div class="actions__item actions__item_share js-actions-item">
<button class="button-circle-stroke button-small actions__button js-actions-button" style="
">
<svg class="icon icon-share">
<use xlink:href="#icon-share"></use>
</svg>
...
<div class="comment__item" style="
    border-color: white;
">
<div class="comment__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-2.jpg" alt="Avatar"></div>
<div class="comment__details">
<div class="comment__top">
<div class="comment__author" style="
...
<div class="comment__content" style="
    ...
    font-size: 16px;
">Stunning views of Queenstown. Very peaceful. Love it so much. Definitely gonna come back and visit.</div>
<div class="comment__foot">
<div class="comment__time" style="
   
">about 5 hour ago</div>
<div class="comment__actions">
<button class="comment__action">Like</button>
<button class="comment__action">Reply</button>
</div>
...
<div class="comment__item" style="
    border-color: white;
">
<div class="comment__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-3.jpg" alt="Avatar"></div>
<div class="comment__details">
<div class="comment__top">
<div class="comment__author" style="
...
<div class="comment__content" style="
    ...
    font-size: 16px;
">Best place I stayed in all of NZ. 🙌🎉😎</div>
<div class="comment__foot">
<div class="comment__time" style="
