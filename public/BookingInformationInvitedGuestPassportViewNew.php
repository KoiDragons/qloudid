...
<div class="checkout__line " >
                      ...
                      <div class="checkout__fieldset">
						...
						<div class="field">
                          ...
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email" style="background:#23262F; color:grey;" fdprocessedid="b3ewp"  value="<?php if($_POST['tenant_available']==1) echo $adultInvitationDetail['email']; ?>" <?php if($_POST['tenant_available']==1) echo 'readonly'; ?> >
                          </div>
                        </div>
	...
	<?php foreach($countryCode as $category =>$value){ ?>													
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="p_number" id="p_number" style="background:#23262F; color:grey;" fdprocessedid="cqhzif" >
                            </div>
                          </div>
                        </div>
