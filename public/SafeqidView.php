...
<div class="column_m header xs-hei_55p bs_bb bg_ffec81">
				<div class="wi_100 hei_65p xs-hei_55p xs-pos_fix padtb5 padrl10 bg_ffec81">
				
				<div class="logo marr15 wi_130p xs-wi_130p ">
				
					<a href="#"> <h3 class="marb0 pad0 fsz30 bold black_txt padt10 xs-padt5 padb10" style="font-family: Avenir;">SafeQid</h3> </a>
			...
			<div class="flag_top_menu flefti padt10 padb10 hidden-xs" style="width: 50px; ">
			 ...
			 <div class="fright xs-dnone sm-dnone padt10 padb10">
					<ul class="mar0 pad0 sf-menu fsz20 nobold">
						...
						<li class="dblock hidden-xs hidden-sm fright pos_rel  "><a href="https://www.safeqloud.com/user/index.php/LoginAccount" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h  lgn_hight_30 black_txt white_txt_h ffamily_avenir" data-en="Logga in" data-sw="Logga in">Logga in</a></li>
	<li class="dblock hidden-xs hidden-sm fright pos_rel  hidden"><a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h  lgn_hight_30 black_txt white_txt_h ffamily_avenir" data-en="Help seeker" data-sw="Help seeker">Help seeker</a></li>
			...
			<div class="wi_1200p maxwi_100 twenty columns header_container xs-wi_100 bg_ffec81">
				<div class="wi_760p xsi-wi_100 columns header_left alpha padt90 xs-padt0 xs-talc maxwi_100">
					<div class="header_left_inner">
						...
						<h2 class="black_txt fsz90 ffamily_avenir nobold xxs-fsz54 lgn_hight_100 xs-lgn_hight_55">Children
</h2>
<h2 class="black_txt bold fsz100 ffamily_avenir bold xxs-fsz54 lgn_hight_80 xs-lgn_hight_55">Safety solution 
</h2>	
	
						<h3 class="header_text ffamily_avenir lgn_hight_35 xs-lgn_hight_30 fsz30 xs-fsz20 black_txt padt10">
							SafeQid is a safety solution for daycare centers, preschools after-school activity centers. It comes with a complete set of tools to ensure the safety and security of their enrolled children.
						</h3>	
					...
					<div class="dflex fxwrap_w xxs-justc_c   marl-10 xxs-marl-15 hidden">
							<a href="#" class="wi_200p hei_45p dflex alit_c justc_c pos_rel zi1 mart15 marl15 brdrad50 txtdec_n xs-padrl15  bold fsz16 xs-fsz16 black_txt " target="_blank" tabindex="0">
			...
			<div class="seven columns header_right white_bg maxwi_375p omega xs-wi_100 box_shadow_00000070 mart40 marb40">
				...
				<input type="checkbox" name="terms" id="terms" /> <span class="marl5 fsz16 xs-fsz16 valm trn">Accept our terms</label>
						 ...
						 <div class="padtb20 xxs-talc talc">
								...
								<button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80"  >Logga in</button>
...
<div class="wi_1200p maxwi_100 dflex xs-fxwrap_w alit_c padt30 xs-padt10 marb0 lgtblue2_bg marrla ">
						...
						<div class="wi_50 xs-wi_100 flex_1 order_2 xs-order_2 xs-tall tall  padl0 padr40 xxs-brdb_new talc xs-padrl20">
							...
							<div class="wi_100 xs-wi_100 bs_bb pad40 tall padrl0 xs-padrl0 xs-pad20">
								...
								<h2 class=" padtb20 xs-padt0 tall bold fsz32 xs-fsz25 ffamily_avenir"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">We put children safety first </font></font></h2>
								<div class="padrbl0 lgn_hight_s1_5 tall fsz18 black_txt ffamily_avenir"><font style="vertical-align: inherit;">SafeQid is a safety solution for daycare centers, preschools after-school activity centers. It comes with a complete set of tools to ensure the safety and security of their enrolled children. </br>SafeQid is an integrity friendly solution. 
 <p class="padt10 ">The system registers when and who dropped off or picked up a child in real-time. SafeQid´s solutions increase the security and simplicity for everyone at a daycare center as well as for the parents.   </p>
</font></div>
						...
						<div class="wi_50 xs-wi_100 flex_1 order_2 xs-order_2 xs-tall tall xs-padrl20 padl40 brdrad5 talc ">
							...
							<div class="wi_100 xs-wi_100 bs_bb pad40 tall padrl0 xs-padrl0 xs-pad20">
								...
								<h2 class=" padtb20 xs-padt0 tall bold fsz32 xs-fsz25 ffamily_avenir"><font style="vertical-align: inherit;">With the respect of integrity</font></h2>
								<div class="padrbl0 lgn_hight_s1_5 tall fsz18 black_txt ffamily_avenir"><font style="vertical-align: inherit;">Safeqid enables parents to plan future attendance and invite next of kin to join their pick up schedule with verified identities. Everything is collected in one place; no information is lost on the road and more time and focus is available to the children.
								
								<p class="padt10 ">We offer parents better control over their child’s safety, staff better tools to manage their work, all in a platform built on consent with the respect of everyone’s integrity. </p>
</font></div>
				...
				<div class="hide-base padt15 sm-padt30 md-padt45 lg-padt55 txt_708198">
						<div class="marb12 bxsh_00150_2430110009 brdrad5 bg_f">
							<a href="#" class="expander-toggler wi_100 minhei_48p dflex alit_c pos_rel padtb10 padr50 padl20 brdrad5 bg_f black_bg_a fntwei_600 fsz18 sm-fsz17 txt_516074 txt_a549e9_h txt_f_ai trans_all2" data-target="#faq-1" data-hide="all" data-hide-base=".hide-base">
								<span class="ffamily_avenir">What is SafeQid daycare safety solution? </span>
							...
							<div class="dnone brdrad5 bg_f" id="faq-1" style="display: none;">
								<div class="padtbl20 padr26">
									...
									<font style="vertical-align: inherit;">	SafeQid is a turnkey daycare safety solution for daycare centers, preschools after-school activities etc. It provides daycare centers with a complete set of tools to ensure the safety and security of their enrolled children.</br>

It provides daycare centers with a crisis management system combined with alarm system and evacuation list to be prepared in case of an emergency. </br>

It registers when and who dropped off or picked up the child in real time lets parents plan future attendance. </br>

SafeQid´s solutions increase the security and simplicity for everyone at daycare center. 
The information helps to facilitate staff in their work. Everything is collected in one place; no information is lost on the road and more time and focus is available to the children.
						...
						<div class="marb12 bxsh_00150_2430110009 brdrad5 bg_f">
							<a href="#" class="expander-toggler wi_100 minhei_48p dflex alit_c pos_rel padtb10 padr50 padl20 brdrad5 bg_f black_bg_a fntwei_600 fsz18 sm-fsz17 txt_516074 txt_a549e9_h txt_f_ai trans_all2" data-target="#faq-2" data-hide="all" data-hide-base=".hide-base">
								<span class="ffamily_avenir">What hardware should we use?</span>
								<div class="wi_24p hei_24p dflex alit_c justc_c opa0_pa pos_abs zi1 pos_cenY right20p brdrad100 bg_dee1e5 fsz12 txt_1246b8"><span class="padl1 icofont icofont-plus"></span></div>
								<div class="wi_24p hei_24p dflex alit_c justc_c opa0 opa1_pa pos_abs zi2 pos_cenY right20p brdrad100 bg_f fsz12 txt_a549e9"><span class="padl1 icofont icofont-minus"></span></div>
							</a>
							<div class="dnone brdrad5 bg_f" id="faq-2">
								<div class="padtbl20 padr26">
									<div class="custom-scroll hei_150p ovfl_auto padr20 lgn_hight_s1_5  fsz18 black_txt ffamily_avenir tall">
								<font style="vertical-align: inherit;">SafeQid is not a hardware-intensive solution. The only requirement is a good internet connection. Once you buy our solution, our Get-started-coach will help you configure SafeQid for your daycare center using devices you already have.
				...
				<div class="marb12 bxsh_00150_2430110009 brdrad5 bg_f">
						...
						<div class="marb12 bxsh_00150_2430110009 brdrad5 bg_f">
							...
							<div class="dnone brdrad5 bg_f" id="faq-5">
								<div class="padtbl20 padr26">
									<div class="custom-scroll hei_150p ovfl_auto padr20 lgn_hight_s1_5  fsz18 black_txt ffamily_avenir tall">
									<font style="vertical-align: inherit;">SafeQid serves all private, and public daycare centers, pre-schools and after-school programs. This is a secure, smart and complete safety solution for those looking to increase the safety of their enrolled children.  
   </font>
									</div>
								</div>
							</div>
