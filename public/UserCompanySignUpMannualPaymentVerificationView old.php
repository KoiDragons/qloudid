...
<a class="header__logo xs-fsz20  changedText" href="#" style="
   ...
   "><?php if($domain_id==0) echo 'Book a pro'; else echo $selectedMarketplaceDetail['marketplace_name']; ?></a>
...
<form class="checkout__item js-tabs-item" action="../../../verifyPaymentDetail/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['verification_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
<div class="checkout__fieldset">

<div class="field"  >
<div class="field__label changedText" style="color:#787f91;">Email code</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="ecode" id="ecode"  style="color:grey;"  >
</div>
</div>
 
 
 <div class="field"  >
<div class="field__label changedText" style="color:#787f91;">Phone code</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="pcode" id="pcode"  style="color:grey;"  >
</div>
</div>
