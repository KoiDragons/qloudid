 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
			     ...
			     <a class="categories__item  bg_E7E7E7 " href="https://www.safeqloud.com/public/index.php/BookingInformation/invoiceAddressesBusiness/<?php echo $data['checkout_id']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
