...
<a class="header__logo xs-fsz20 " href="../listBookings/<?php echo $data['uid'];?>" style="
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Invoice</h2>
<div class="browse__info info changedText">Please select a invoice address</div>
</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
			     ...
			     <a class="categories__item  bg_E7E7E7 " href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/BookingInformation/invoiceAddressesBusiness/<?php echo $data['checkout_id']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Business</div>
                                      </a>
...
<div class="checkout__box">
 ...
 <?php $i=0;
												foreach($invoiceAddressesUser as $category => $value) 
												{
...
<div class="checkout__label changedText"><?php echo $value['invoice_address'].' '.$value['invoice_port_number']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['invoice_zip'].' , '.$value['invoice_city'].' , '.$value['invoice_country']; ?></div>
 
<div class="checkout__controls">
<a href="../updateUserAddress/<?php echo $data['checkout_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-plus" style="fill:#E91E63;"></use>
</svg>
</button></a>
