...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" media="all" href="https://www.qloudid.com/html/fleet/css/app.minblack.css">
...
<script>
	...
	{
		if($('#dropMenuHeader').hasClass('visible'))
			{
				$('#dropMenuHeader').removeClass('visible')
				
				 
			}
			else
				{
				$('#dropMenuHeader').addClass('visible')
...
<div class="column_m     bs_bb lgtgrey2_bg visible-xs  " style="height:93px;  position:relative; z-index:10; background-color:  transparent;">
				<div class="wi_100   xs-pos_fix padtb5   " style="position:relative; height:93px;  padding: 41px 0 24px; background-color:  transparent; display:flex">
				<div  class="xs-padrl25 xs-pos_fix " style="display:flex; position: relative;">
				 <div>
<a class="header__logo xs-fsz20 changedText" href="../propertyProposerDetail/<?php echo $data['proposal_id']; ?>" style="
...
<div style="margin-top:-0px;">		
			<div class="top_menu frighti padt0 padb0" style="width:150px !important; padding-left:20px; border-left:1px solid #777E90;">
				<ul class="menulist sf-menu  fsz16 ">
					 
       			
					<ol style="margin-right:20px !important;">
						<a href="javascript:void(0);" class="lgn_hight_s1 fsz25 sf-with-ul header__head js-header-head  " onclick="changeDisplay1();"><span class="  fas fa-globe" style="color:#777E90;"></span></a>
						<div class="header__item header__item_language js-header-item margin-left0 active" style="display:block;">
						<div class="header__body js-header-body hidden" id="qrMenu1" style="z-index:10 display: none; margin-left:80px; margin-top:-50px;">
<div class="header__list">
<a class="header__box active" href="javascript:void(0);" onclick="changeDisplay1();">
...
<a class="header__box" href="javascript:void(0);" onclick="changeDisplay1();">
...
<header class="header js-header authorization xs-padt24   padtb20 xs-bg0e1116 hidden-xxs" style="height:93px;/* border-bottom: 1px solid #e6e8ec; */">
...
<div class="header__menu"><a class="header__link" href="https://clubtxp.com/public/index.php/Unaoficina">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg><span class="changedText">Home</span></a>
 
<a class="header__link " href="https://clubtxp.com/public/index.php/JoinTXP" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg><span class="changedText">Club TXP</span></a>
<a class="header__link  active" href="https://clubtxp.com/public/index.php/ForDevelopers" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg><span class="changedText">TXP Platform</span></a>
<a class="header__link" href="https://clubtxp.com/public/index.php/DevelopersHub">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg><span class="changedText">- Developers</span></a>
<a class="header__link" href="https://clubtxp.com/public/index.php/GlobalBrokersCenter">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg><span class="changedText">- Brokers</span></a>
<a class="header__link  " href="https://clubtxp.com/public/index.php/Awards">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg><span class="changedText">TXP Awards</span></a>
<a class="header__link" href="https://clubtxp.com/public/index.php/Customers">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg><span class="changedText">Testimonials</span></a>

</div>
</div>
</div>		
<div class="header__item header__item_language js-header-item margin-left0">
<button class="header__head js-header-head  " fdprocessedid="9xxkue">
<svg class="icon icon-globe">
<use xlink:href="#icon-globe" style="
    fill:#777E90;
"></use>
</svg><h4 class="changedText" style="font-size:16px;">Language</h4>
</button>
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
		...
		<a href="https://clubtxp.com/public/index.php/Unaoficina" class="header__item active" s=""></a>
<a href="https://clubtxp.com/public/index.php/Unaoficina" class="header__item " style="box-shadow:none; margin-left:40px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important; margin-left:0px;">
<button class="header__head js-header-head   hidden-xs changedText" style="
    color: #f67f00; font-size:16px;
"><?php echo $poposerEmployeeDetail['company_name']; ?></button>

</div></a>

<a href="https://clubtxp.com/public/index.php/Customers" class="header_item  " style="box-shadow:none; margin-left:20px;"><div class="header_item_language js-header-item" style="border-left: 0px solid !important;  margin-left:20px;">
<button class="header__head js-header-head   hidden-xs changedText" style="
 color:#777E90;     font-size:16px; font-weight: 700;
">+34 603 14 72 90</button>
...
<a class="header__login js-popup-open" href="#popup-login" data-effect="mfp-zoom-in" style="display:none; background:#f67f00;">
<svg class="icon icon-user">
<use xlink:href="#icon-user" style="fill:black"></use>
</svg></a>		
...
<div class="outer__inner">
	...
	<div class="section categories mart95 xs-mart0" style="
    margin-bottom: 0px;
">
<div class="categories__center center  xs-padrl0 hidden" style="
    padding: 0 0px;
">
<div class="categories__inner padding100_80 xs-padding160_40 xs-padrl25 xxs-brdrad0" style="
    background: transparent;
    
    border-radius: 12px;
">
<div class="categories__head marrla" style="margin-bottom: 0px !important; max-width: 960px;">
<h2 class="categories__title h2 fsz70 xs-fsz45 xs-lgn_hight_55 xs-tall xs-marb15 changedText" style="color: #ffffff;">Innovate and Expand with TXP</h2>

<div class="categories__info info   xs-lgn_hight_35 xs-tall changedText " style="margin-top:5px; font-size:25px;">Access Exclusive Tools, Insights, and Support to Drive Your Development Projects</div>
<a class="button main__button xs-tall talc xs-fleft  hidden-xxs changedText" href="SelectMemberType" style="
     background: #cddd39;
     margin-top: 45px;
     /* margin-bottom: 55px; */
     color: black;
...
<div class="section main main_stays hidden" style="margin-bottom:80px;">
<div class="main__center center hidden-xs" style="
">
<div class="main__preview xxs-padrl8">
<picture>
<source media="(max-width: 767px)" srcset="https://www.qloudid.com/html/usercontent/images/dstricts/bgimage7.jpeg"><img src="https://www.qloudid.com/html/usercontent/images/dstricts/bgimage7.jpeg" alt="Main" class=" " style="padding: 0px !important; border-radius:12px;">
</picture>
...
<h1 class="main__title hero xs-tall talc pad30 fsz90 xs-fsz35 changedText" style="
    background: #0e0e0d73;
    margin-bottom: 0px;
    color: white;
    border-radius: 10px 10px10px10px;
    line-height: 1.1;
    /* text-transform: uppercase; */
    max-width: 1600px;
    padding-bottom: 0px; border-radius:24px
">Ultimate Developers Hub</h1>
 </div>
</div>
</div>
...
<div class="  visible-xs padrl25 padt30">
              <div class="  gallery__list_stays">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view" href="https://www.qloudid.com/html/usercontent/images/dstricts/boximage13.jpeg" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="https://www.qloudid.com/html/usercontent/images/dstricts/boximage13.jpeg" alt="Gallery" style="border-radius:8px;"></a></div>
...
<div class="outer__inner">
 ...
 <div class="section categories mart95 xs-mart45" style="
    margin-bottom: 0px;
">
<div class="categories__center center  xs-padrl0" style="
    padding: 0 0px;
">
<div class="categories__inner padding100_80 xxs-padb40 xsi-padt0 xs-padrl25 xxs-brdrad0" style="
    background: transparent;
    border-radius: 12px;
">
<div class="categories__head marrla" style="margin-bottom: 0px !important;max-width: 960px;padding: 0px -1px;">
<h2 class="categories__title h2 fsz90 xs-fsz45 xs-lgn_hight_55 xs-tall xs-marb15 changedText hidden-xs uppercase" style="color: #ffffff; font-size:90px; ">Dont Wait To Buy Real Estate</h2>
<div class="categories_info info   xs-tall    changedText visible-xs uppercase" style="
                  line-height: 1.2;
                  font-size: 60px;
                  
				  font-weight:100;
                   color: #ffffff;">Dont Wait To Buy Real Estate
</div>
<div class="categories_info info  xs-fsz30i fsz70 xs-lgn_hight_35 xs-tall  changedText hidden-xs" style="margin-top:5px; color: #c2c2c2;">Buy Real Estate and Wait</div>

<div class="categories_info info    fsz70 xs-lgn_hight_35 xs-tall  changedText  visible-xs " style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4 !important;
                  font-size: 27px !important;
                  ">Buy Real Estate and Wait</div>

<a class="button main_button xs-tall talc xs-fleft  hidden-xxs changedText" href="SelectMemberType" style="
     background: #131922;
     margin-top: 45px;
     /* margin-bottom: 55px; */
     color: #c2c2c2;
">By Kowaken Ghirmai</a>
...
<div class="section destinations  xs-padrl25 xs-wi_50" style="margin-bottom:80px;">
<div class="destinations__center center" style="border-bottom: 4px solid #282D34 !important; display: flex !important;
...
<div class="travel__center center   padb136 xs-padrl25 hidden" style="  max-width: 1132px;    padding-right: 0px;    padding-left: 0px;">
   ...
   <div class="travel__row " style="margin-bottom:0px;">
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:525px;">
         <div class="travel__list" style="margin-bottom:0px;
            max-width: 450px; 
            ">
            <div class="travel__item">
               ...
               <div class="travel__content changedText padb20" style="
                  color: #787f91;
                  font-size: 20px;
                  ">I am pleased to present to you our exclusive selection of real estate properties that, in my opinion, perfectly match your requests and requirements.
</div>
   ...
   <div class="section destinations xs-padrl25  hidden" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom:1px solid #23262F; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
    <div class="sorting" style="margin-bottom:0px;">
            <div class="sorting__center ">
              <div class="sorting" style="margin-bottom:0px; ">
<div class="sorting__center center" style="padding: 0 80px;">
		 ...
		 <?php $i=1; 
								foreach($displayProposalProperties as $category => $value) 
										{
										 ?>
<div class="xxs-padrl25" <?php if($i>1) echo 'style="margin-top:40px;"'; ?>>
	  <div class="center xs-pad0 xs-brdrad12 xxs-bg_trans xs-nobrd" style="padding:50px;border-radius: 10px;max-width: 1132px; border:1px solid #23262f; ">
		
		<div class="travel__center   " style="">
 <div class="travel__col visible-xs" style="padding:0px;  margin-bottom:20px;  widht:100% ">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel">
				  <div class="travel__gallery">
                      <div class="travel__bg" style="border-radius: 6px;"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="Travel"></div>
...
<div class="setting__element" style="display:block; border:none; ">
                        <div class="setting__details"> 
                         <div class="destinations__head    xs-marb5" style="padding:0px;margin-bottom: 0px;">
                <h2 class="destinations__title h2   changedText" style="margin-bottom: 10px;font-size: 32px;"><?php echo $value['sellPhrase']; ?></h2>
				 
                <div class="destinations__info info hidden">Carefully selected brands</div>
              </div>
			  <div class="description__parameters" style="
					...
					color: white;
">
                <div class="description__parameter  xs-mart0" style="">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText"><?php  echo $value['numberOfBedrooms']; ?> Bedrooms</span></div>
                <div class="description__parameter  xs-mart0">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['numberOfBathrooms']; ?> Bathrooms</span></div>
                <div class="description__parameter  xs-mart0 hidden-xxs">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['area']; ?> sqm</span></div>
              </div>
<div class="setting__text padb25 hidden-xxs" style="
                  color: #787f91;
                  font-size: 16px;
                  padding-bottom: 0px; line-height:1.71429;
                  "><?php  echo $value['longSellingDescription']; ?>  </div>
				  
				  
				   <?php if($i%2==0){ ?>
                      <div class="profile__parameters xs-padrl0 mart0 marrla visible-xs marb20" style="background: #1b2739; margin-bottom:0px; max-width:365px; border-radius: 6px;">
                    <div class="profile__parameter">
                      <svg class="icon icon-tick">
                        <use xlink:href="#icon-tick" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">300 viewed</span>
                    </div>
                    <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">82 likes</span>
                    </div>
					 <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">7327 shared</span>
                    </div>
                  </div>
						<?php } else if($i%3==0){ ?>
				  <div class="profile__parameters xs-padrl0 mart0 marrla  visible-xs marb20" style="background: #1b2739; margin-bottom:0px; max-width:365px; border-radius: 6px;">
                    <div class="profile__parameter">
                      <svg class="icon icon-tick">
                        <use xlink:href="#icon-tick" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">265 viewed</span>
                    </div>
                    <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">185 likes</span>
                    </div>
					 <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">5323 shared</span>
                    </div>
                  </div>
				  <?php } else{ ?>
				  ...
				  <div class="profile__parameters xs-padrl0 mart0 marrla  visible-xs marb20" style="background: #1b2739; margin-bottom:0px; max-width:365px; border-radius: 6px;">
                    <div class="profile__parameter">
                      <svg class="icon icon-tick">
                        <use xlink:href="#icon-tick" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">795 viewed</span>
                    </div>
                    <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">816 likes</span>
                    </div>
					 <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">6363 shared</span>
                    </div>
                  </div>
				  <?php }?>
				  ...
				  <div class="setting__text padb25 visible-xs" style="
                  color: #787f91;
                  font-size: 16px;
                  padding-bottom: 0px; line-height:1.71429;
                  "><?php  echo substr($value['longSellingDescription'],0,250); ?>  </div>
			   
			  
			  
                        </div>
                      <a href="../propertyProposalInformation/<?php echo $data['proposal_id']; ?>/<?php echo $value['enc']; ?>"><button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts">View</button></a>
					  
					    <div class="section destinations   visible-xs" style="margin-bottom:40px;">
<div class="destinations__center center" style="border-bottom: 1px solid #23262F;padding-bottom:40px;max-width: 1132px;">
</div>
</div>
                      </div>
					  
					  
                      <div class="setting__element" style="display:block">
                         <div class="setting__details"> 
                         
       
			  <div class="travel__col hidden-xs" style="padding:0px; widht:100%">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel">
				  <div class="travel__gallery">
                      <div class="travel__bg" style="border-radius: 12px;"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="Travel"></div>
						...
						<?php if($i%2==0){ ?>
                      <div class="profile__parameters xs-padrl0 mart20 marrla hidden-xxs" style="background: #1b2739; margin-bottom:0px;  max-width:365px;">
                    <div class="profile__parameter">
                      <svg class="icon icon-tick">
	  ...
	  <div class="section destinations  xs-padrl25 hidden-xxs" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom: 1px solid #f67f00;padding-bottom:80px;max-width: 1132px;">
              </div>
        </div>
		
		<div class="section travel mart50 xs-mar0i" style="
    margin-bottom: 0px;
    margin-top: 0px;
">
<div class="travel__center center xxs-padrl25" style="">

<div class="travel__row">
<div class="travel__col padr100 xs-padr0  hidden-xs" style="padding-top: 60px;padding-right: 100px;">
<div class="travel__list" style=" max-width: fit-content;">


<div class="travel__item">


<div class="travel__subtitle   xs-talc changedText" style="
     margin-bottom: 15px;
     color: #fff;
     font-weight: 600;
     font-size: 32px;
">Presentation</div>
<div class="travel__content  xs-talc changedText" style="
    font-size: 20px; Line-height: 1.71429;
    color: #777E90;
">My commitment to you is defined by personal engagement and accessibility. My primary goal is to guide you through the buying process in a professional and secure manner. In my role, I am dedicated and driven, always striving to ensure your complete satisfaction.

</div>
<div class="profile__parameters xs-padrl0 mart25 " style="background: #1b2739;  max-width:365px;">
                    <div class="profile__parameter">
                      <svg class="icon icon-tick">
                        <use xlink:href="#icon-tick" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">35 units</span>
                    </div>
                    <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg><span class="changedText">23 likes</span>
                    </div>
					 <div class="profile__parameter">
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline" style="fill:#f67f0099;"></use>
                      </svg>$2 234<span class="changedText">000</span>
                    </div>
                  </div>
</div>

</div>
<a class="header__logo xs-fsz20 hidden  changedText" href="#" style="
    ...
    padding-left: 35px;
    padding-right: 35px;
    ">Works in 32 countries</a>
</div>

  <div class="travel__col xs-padrl0" style="padding:0px 75px;">
                <div class="travel__wrapper  "  >
                  <div class="travel__slider js-slider-travel ">
                    <div class="travel__gallery" >
                      <div class="travel__bg brdrad50pi xs-brdrad6i xs-border"  ><img srcset="../../../<?php echo $employeeListing[0]['img']; ?>" src="../../../<?php echo $employeeListing[0]['img']; ?>" alt="Travel" width="300" height="300"   ></div>
                       <!--width="454" height="454"-->
                    </div>
                     
                  </div>
				  <div class="profile__man changedText talc xs-tall xxs-fsz20" style="color: #777E90;
    padding-top: 20px;
    font-size: 25px;
"><?php echo $employeeListing[0]['name']; ?></div>
                </div>
              </div>
			  
			  
			  <div class="travel__col padr100 xs-padr0  visible-xs" style="padding-top: 60px;padding-right: 100px;">
<div class="travel__list" style=" max-width: fit-content;">
...
<div class="travel__subtitle   tall changedText" style="
     margin-bottom: 15px;
     color: #fff;
     font-weight: 600;
     font-size: 32px;
">Presentation</div>
<div class="travel__content  xs-tall changedText" style="
    font-size: 20px; Line-height: 1.71429;
    color: #777E90;
">My commitment to you is defined by personal engagement and accessibility. My primary goal is to guide you through the buying process in a professional and secure manner. In my role, I am dedicated and driven, always striving to ensure your complete satisfaction.
...
<div class="section destinations  xs-padrl25 <?php if($poposerEmployeeDetail['about_is_active']==0) echo 'hidden';?>" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom: 1px solid #23262F;padding-bottom:80px;max-width: 1132px;">
              </div>
        </div>
		
		<div class="travel__center center   padb136 xs-padrl25 <?php if($poposerEmployeeDetail['about_is_active']==0) echo 'hidden';?>" style="  max-width: 1132px;    padding-right: 0px;    padding-left: 0px;">
   
   <div class="travel__row " style="">
      <div class="travel__col" style="padding-right: 0px; max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="margin-bottom:0px;
            max-width: 450px; 
            ">
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:525px; ">
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  "><?php    if($poposerEmployeeDetail['about_us']=='') { ?>Welcome to <?php echo $poposerEmployeeDetail['company_name']; ?>, where our mission is to provide exceptional real estate services with a personal touch. With years of experience in the industry, we pride ourselves on our deep knowledge of the market and our unwavering commitment to our clients. <?php } else echo $poposerEmployeeDetail['about_us']; ?></div>
            </div>
         </div>
      </div>
   </div>
	...
	<div class="section destinations   <?php if($poposerDetail ['team_available']==0) echo 'hidden'; ?>" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom:1px solid #23262F; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
		<div class="  browse    <?php if($poposerDetail ['team_available']==0) echo 'hidden'; ?>">
          <div class="browse__center center">
            <div class="browse__inner">
             <div class="travel__subtitle   xs-tall changedText hidden" style="
     margin-bottom: 15px;
     color: #fff;
     font-weight: 600;
     font-size: 32px;
">About us</div>
            ...
            <div class="browse__wrapper">
                <div class="browse__slider js-slider-browse">
				 <?php $i=1; 
								foreach($teamMemberListing as $category => $value) 
										{
										 ?>
				<a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px; background:white;">
                                      <div class="browse__preview" style=" border-radius: 12px;"><img srcSet="../../../<?php echo $value['img']; ?>" src="../../../<?php echo $value['img']; ?>" alt="Card" style="border-radius: 50%; padding: 20px 20px;">
                                        <div class="status-black browse__category hidden">20% off</div>
                                      </div>
                                      <div class="browse__subtitle changedText black_txt"><?php echo $value['first_name'].' '.$value['last_name']; ?></div>
                                      <div class="browse__content changedText">
                                        Broker
                                      </div></a>
									  
										<?php } ?>
									 <!-- <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/gettxp/5.jpeg" src="https://www.qloudid.com/html/usercontent/images/gettxp/5.jpeg" alt="Card">
									  ...
									  <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/gettxp/6.jpeg" src="https://www.qloudid.com/html/usercontent/images/gettxp/6.jpeg" alt="Card">
									  ...
									  <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/gettxp/7.jpeg" src="https://www.qloudid.com/html/usercontent/images/gettxp/7.jpeg" alt="Card">
	...
	<div class="  browse hidden">
          <div class="browse__center center">
            <div class="browse__inner">
             <div class="travel__subtitle   xs-tall changedText" style="
     margin-bottom: 15px;
     color: #fff;
     font-weight: 600;
     font-size: 32px;
">About us</div>
			  <div class="travel__center center   padb136 " style="  max-width: 1132px;    padding-right: 0px;    padding-left: 0px;">
   ...
   <div class="travel__row " style="">
      <div class="travel__col" style="padding-right: 0px; max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="margin-bottom:0px;
            ...
            ">
            <div class="travel__item">
            <?php    if($poposerEmployeeDetail['about_us']=='') { ?>
			<div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Welcome to <?php echo $poposerEmployeeDetail['company_name']; ?>, where our mission is to provide exceptional real estate services with a personal touch. With years of experience in the industry, we pride ourselves on our deep knowledge of the market and our unwavering commitment to our clients.
 </div>
			<?php } else { ?>
                <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  "><?php echo $poposerEmployeeDetail['about_us']; ?>
 </div>
			<?php } ?>
      ...
      <div class="travel__col hidden-xs" style="padding-right: 0px; max-width:525px; ">
         <div class="travel__list" style="margin-bottom:0px;
            max-width: 450px; 
            ">
            <div class="travel__item">
               
                 <?php    if($poposerEmployeeDetail['who_we_are']=='') { ?>
			<div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">We offer a wide range of real estate services, including residential and commercial sales, property management, and investment consultation. Our professionals ensure you receive the highest level of service and expertise, whether buying, selling, or investing.
 </div>
			<?php } else { ?>
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  "><?php echo $poposerEmployeeDetail['who_we_are']; ?></div>
				  <?php } ?>
            </div>
         </div>
      </div>
			...
			<div class="section destinations " style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom:1px solid #23262F; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
            ...
            <div class="browse__wrapper">
                <div class="browse__slider js-slider-browse">
				 <?php $i=1; 
								foreach($employeeListing as $category => $value) 
										{
										 ?>
				<a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview" style=" border-radius: 12px;"><img srcSet="../../../<?php echo $value['img']; ?>" src="../../../<?php echo $value['img']; ?>" alt="Card">
                                        <div class="status-black browse__category hidden">20% off</div>
                                      </div>
                                      <div class="browse__subtitle changedText"><?php echo $value['name']; ?></div>
                                      <div class="browse__content changedText">
                                        Broker
                                      </div></a>
										...
										<?php } ?>
									 <!-- <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/clubtxp/5.jpeg" src="https://www.qloudid.com/html/usercontent/images/clubtxp/5.jpeg" alt="Card">
                                        <div class="status-black browse__category hidden">from $230</div>
                                      </div>
                                      <div class="browse__subtitle">Robert Ghirmai</div>
                                      <div class="browse__content">
									  ...
									  <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/clubtxp/6.jpeg" src="https://www.qloudid.com/html/usercontent/images/clubtxp/6.jpeg" alt="Card">
                                        <div class="status-black browse__category hidden">30% off</div>
                                      </div>
                                      <div class="browse__subtitle">Katerina Zelinksky</div>
                                      <div class="browse__content">
									  ...
									  <a class="browse__card" href="#" style="padding:15px; border:1px solid #23262F; border-radius: 12px;">
                                      <div class="browse__preview"><img srcSet="https://www.qloudid.com/html/usercontent/images/clubtxp/7.jpeg" src="https://www.qloudid.com/html/usercontent/images/clubtxp/7.jpeg" alt="Card">
                                        <div class="status-black browse__category hidden">from $190</div>
                                      </div>
                                      <div class="browse__subtitle">Ana Tikhonova</div>
                                      <div class="browse__content">
    ...
    <div class="section destinations xs-padrl25  hidde" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom:1px solid #23262F; padding-bottom:80px; max-width: 1132px;">
              </div>
        </div>
		...
		<div class="catalog__body">
            <div class="catalog__center center xxs-padrl25" style="padding:0px;  max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
               <div class="live__head tall" style="margin-bottom:20px;">
              <h2 class="live__title h2 changedText" style="font-size: 40px;">Ratings &amp; Reviews</h2>
              <div class="live__info info card__rating" style="font-size: 20px"><span style="font-size:80px; font-weight:bold; padding-right:20px;">4.8 </span><div class="card__reviews changedText">(out of 5)</div></div>
            </div>
              <div class="catalog__list">
			  
			  				  
                   
               <a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                   
                  <div class="card__body">
                    
                  
                  <div class="card__foot" style="border:none;">
                     
                      <div class="card__comment">
 
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">With Brokers BNB, I received my commission quickly, clients saw the final price, and the platform is secure and easy to use. It's fantastic!</div>
                      </div><div class="card__flex">
                        
                        <div class="card__rating">
                          <svg class="icon icon-star" style=" fill: #FF5722;">
                            <use xlink:href="#icon-star" style=" fill: #FF5722;"></use>
                          </svg>
                          <div class="card__number">5.0</div>
                          <div class="card__reviews changedText">(12 reviews)
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Brokers BNB made rental management so simple and safe. The transparent pricing and fast commission payouts are a game-changer!</div>
                      </div><div class="card__flex">
				...
				<a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Using Brokers BNB, my clients get clear final prices, I get my commission fast, and it's all very user-friendly and secure. I absolutely love it!</div>
                      </div><div class="card__flex">
                        
                        <div class="card__rating">
                          <svg class="icon icon-star" style=" fill: #ffe600;">
                            <use xlink:href="#icon-star" style=" fill: #ffe600;"></use>
                          </svg>
                          <div class="card__number">5.0</div>
                          <div class="card__reviews changedText">(12 reviews)
                          </div>
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Find Developer is amazing! We can easily create client offers from different developers and send them a custom investment portfolio via a link.</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">I love using Find Developer! It lets us generate and share tailored proposals for clients from various developers, making the process seamless and efficient.</div>
                      </div><div class="card__flex">
				...
				<a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">It's great that with Find Developer, we can get approval for property sales directly within the system.</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Find A Broker is awesome! It helped clients connect with me easily, and I got exclusive contracts. It's boosted my business significantly!</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Using Find A Broker, I've matched with clients perfectly. They chose me because I met their criteria, and their satisfaction is through the roof!</div>
                      </div><div class="card__flex">
				...
				<a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">I love Find A Broker! It simplified client connections, leading to more deals. I got clients who specifically wanted my expertise. It's a fantastic tool!</div>
                      </div><div class="card__flex">
               ...
               <a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Find A Guest is fantastic! It matches our rental properties with suitable tenants quickly and efficiently. It's really boosted our occupancy rates!</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">With Find A Guest, we maximize occupancy and streamline the guest selection process. It's so easy to use and has made our job much simpler!</div>
                      </div><div class="card__flex">
				...
				<a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">I love Find A Guest! It has simplified finding the right tenants for our properties, making management so much easier and hassle-free.</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Brokers Hub keeps us connected with market trends through a dedicated WhatsApp community. Unlike spammy groups, it's all relevant and organized! It’s great to be among experts.</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Networking with other brokers and developers is easy with Brokers Hub. The concise news updates and efficient chat make it a pleasure to be part of this community.</div>
                      </div><div class="card__flex">
				...
				<a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Brokers Hub offers real-time connections and valuable insights through AI News. It's wonderful to have a focused, spam-free community for brokers and developers.</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Developer Hub ensures all our information is up-to-date. No more WhatsApp or email blasts with Dropbox links. Everything is uploaded to the platform, and brokers use it seamlessly. It's incredibly efficient!</div>
                      </div><div class="card__flex">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        ...
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">With Developer Hub, we manage bookings, client data, showroom reservations, and broker approvals all within the system. It's so convenient and transparent.</div>
                      </div><div class="card__flex">
				...
				<a class="card" href="#" style="background:transparent; border-radius: 12px; border: 1px solid #23262F;">
                  ...
                  <div class="card__foot" style="border:none;">
                      ...
                      <div class="card__comment">
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">Developer Hub has simplified our operations. We receive bookings and client info, accept brokers to sell our projects, and everything is centralized and easy to use. It's a game-changer for us!</div>
                      </div><div class="card__flex">
...
<div class="destinations hidden">
          <div class="destinations__center center">
            <div class="destinations__inner">
              <div class="destinations__head xs-marb48 marb96">
                <h2 class="destinations__title h2 changedText" style="margin-bottom: 16px;">Testimonials</h2>
				<div class="travel__subtitle xs-fsz_lnhe25_1_1 fsz_lnhe32_1_1 changedText xs-tall" style="
                     color: #787f91;
                  ">Hear what our customers has to say about us</div>
                <div class="destinations__info info hidden">Carefully selected brands</div>
              </div>
              <div class="destinations__wrapper">
                <div class="destinations__slider js-slider-destinations"> 
				...
				<div class="destinations__item" style="margin-right: 20px; border-radius: 6px; border: 1px solid rgb(35, 38, 47); padding: 30px; width: 364px;"  >
                                      <div class="destinations__preview" style="border-radius:6px;"><img srcset="https://www.qloudid.com/html/usercontent/images/clubtxp/8.jpeg" src="https://www.qloudid.com/html/usercontent/images/clubtxp/8.jpeg">
                                      ...
                                      <div class="destinations__content changedText" style=" color: #787f91; font-size: 18px;">Using Find A Broker, I've matched with clients perfectly. They chose me because I met their criteria, and their satisfaction is through the roof!</div>
									<div class="destinations__content padt20 changedText" style=" color: #787f91; font-size: 18px;">Kirsanov Maksim</div>
									<div class="destinations__content changedText" style=" color: #787f91; font-size: 18px;">Duanes Denia</div>
									  </div>
									  
									  
									<div class="destinations__item" style="margin-right: 20px; border-radius: 6px; border: 1px solid rgb(35, 38, 47); padding: 30px; width: 364px;"  >
                                      <div class="destinations__preview" style="border-radius:6px;"><img srcset="https://www.qloudid.com/html/usercontent/images/clubtxp/10.jpeg" src="https://www.qloudid.com/html/usercontent/images/clubtxp/10.jpeg">
                                      </div>
									  ...
									  <div class="destinations__content padt20 changedText" style=" color: #787f91; font-size: 18px;">Alexandra Yukhanaeva</div>
									<div class="destinations__content changedText" style=" color: #787f91; font-size: 18px;">Century 21</div>
									  </div>
									  <div class="destinations__item" style="margin-right: 20px; border-radius: 6px; border: 1px solid rgb(35, 38, 47); padding: 30px; width: 364px;"  >
                                      <div class="destinations__preview" style="border-radius:6px;"><img srcset="https://www.qloudid.com/html/usercontent/images/clubtxp/9.jpeg" src="https://www.qloudid.com/html/usercontent/images/clubtxp/9.jpeg">
                                      ...
                                      <div class="destinations__content changedText" style=" color: #787f91; font-size: 18px;">It's great that with Find Developer, we can get approval for property sales directly within the system.</div>
									  <div class="destinations__content padt20 changedText" style=" color: #787f91; font-size: 18px;">Victor Valverde</div>
									<div class="destinations__content changedText" style=" color: #787f91; font-size: 18px;">Asten realty</div>
									  </div>
...
<div class="section destinations  xs-padrl25" style="margin-bottom:80px;">
          <div class="destinations__center center" style="border-bottom: 1px solid #CDDC39;padding-bottom:80px;max-width: 1132px;">
              </div>
        </div><div class="xxs-padrl25">
	  <div class="center xxs-pad25 xs-brdrad12" style="padding: 0 0px;/* border-radius:25px; */max-width: 1132px;/* background-color:#272b39; */">
		
		
		<div class="travel__center   " style="">
<div class="destinations__head xs-marb48 marb96" style="padding-right:0px;">
                <h2 class="destinations__title h2 tall xs-tall changedText" style="margin-bottom: 16px;">Contact</h2>
				<div class="travel__subtitle   changedText tall  xs-tall hidden" style="
                     color: #787f91; font-size:25px; line-height:1.4;
		...
		<div class="setting__box">
                    ...
                    <div class="setting__line">
                      <div class="setting__element" style="display:block; border-color: #23262F; ">
                        <div class="setting__details"> 
                         <div class="destinations__head    xs-marb25 " style="padding:0px;: ">
                <h2 class="destinations__title h2  changedText" style="margin-bottom: 16px; font-size:32px;">Broker</h2>
				<div class="travel__subtitle   changedText xs-tall  hidden" style="
                     font-size:20px !important; color: #787f91;  font-weight:normal !important; line-height: 1.4 !important;
                  ">Services to boost international sales, optimize communication with agencies, enhance market presence, streamline project showcases, support community interactions, and more.</div>
                <div class="destinations__info info hidden">Carefully selected brands</div>
              </div>
			   <div class="setting__text padb25 changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Feel free to contact me at any given time. You can find my details below.</div>
			     <div class="description__options" style="display:block;">
                <div class="description__option" style=" font-size: 18px;">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg> <?php echo '+'.$poposerEmployeeDetail['country_code'].' '.$poposerEmployeeDetail['user_phone']; ?></div>
                <div class="description__option" style="padding-left:0px;font-size: 18px;">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-email"></use>
                  </svg><?php echo $poposerEmployeeDetail['email']; ?></div>
                 <div class="description__option" style="padding-left:0px;font-size: 18px;">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-building"></use>
                  </svg><?php echo $poposerEmployeeDetail['location']; ?></div>
					  ...
					  <div class="section destinations    visible-xs" style="margin-bottom:60px;">
          <div class="destinations__center center" style="border-bottom:1px solid #353945; padding-bottom:60px; max-width: 1132px;">
              </div>
        </div>
                      <div class="setting__element" style="display:block">
                         <div class="setting__details"> 
                         <div class="destinations__head    xs-marb25" style="padding:0px;: ">
                <h2 class="destinations__title h2  changedText" style="margin-bottom: 16px; font-size:32px !important;">Company</h2>
				<div class="travel__subtitle  changedText xs-tall hidden " style="
                     color: #787f91; font-size:20px !important; font-weight:normal !important; line-height: 1.4 !important;
                  ">Services to increase sales in the secondary and primary markets, rental support, communication tools between brokers, clients, and developers, property listings, community support, and more.</div>
                <div class="destinations__info info hidden">Carefully selected brands</div>
              </div>
			  <div class="setting__text padb25 changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">These are our company details in case you feel to drop by or give us a quick call</div>
			    
			   
			   
			    <div class="description__options" style="display:block;">
				 <?php if($poposerEmployeeDetail['cphone']!='') { ?>
                <div class="description__option" style=" font-size: 18px;">
                  <svg class="icon icon-modem">
                    <use xlink:href="#icon-modem"></use>
                  </svg> <?php echo '+'.$poposerEmployeeDetail['company_country_code'].' '.$poposerEmployeeDetail['cphone']; ?></div>
				   <?php }  ?>
                <div class="description__option" style="padding-left:0px;font-size:18px;">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-email"></use>
                  </svg><?php echo $poposerEmployeeDetail['company_email']; ?></div>
                 <div class="description__option" style="padding-left:0px;font-size: 18px;">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-building"></use>
                  </svg><?php echo $poposerEmployeeDetail['location']; ?></div>
                <?php if($poposerEmployeeDetail['fb']!='') { ?>
                 <div class="description__option" style="padding-left:0px;font-size: 18px;">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-facebook"></use>
                  </svg><?php echo $poposerEmployeeDetail['fb']; ?></div>
				<?php } if($poposerEmployeeDetail['tw']!='') { ?>
				   <div class="description__option" style="padding-left:0px;font-size:18px;">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-twitter"></use>
                  </svg><?php echo $poposerEmployeeDetail['tw']; ?></div>
				<?php } if($poposerEmployeeDetail['insta']!='') { ?>
				   <div class="description__option" style="padding-left:0px;font-size: 18px;">
                  <svg class="icon icon-toilet-paper">
                    <use xlink:href="#icon-instagram"></use>
                  </svg><?php echo $poposerEmployeeDetail['insta']; ?></div>
				  <?php }  ?>
              </div>
...
<div class="travel__center center   padb136 xs-padrl25 hidden" style=" max-width: 1132px;    padding-right: 0px;    padding-left: 0px;">
   ...
   <div class="travel__row " style="margin-bottom:0px;">
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:100%;">
         <div class="travel__list" style="margin-bottom:0px;
            max-width: 100%; 
            ">
            <div class="travel__item">
               ...
               <div class="travel__content changedText padrl80 xs-padrl0 talc xs-tall" style="
                  color: #787f91;
                  font-size: 25px;
                  ">To boost sales and profitability for Spanish developers through global broker connections, optimized management, and cutting-edge tools.
...
<div class="section destinations xxs-padrl25 hidden" style="margin-bottom:80px;">
          <div class="destinations__center center" style="  max-width: 1132px;">
              </div>
        </div>
		<div class="xxs-padrl25 hidden">
	  <div class="center xxs-pad25 xs-brdrad12" style="padding:50px;   border-radius:25px; max-width: 1132px; background-color:#1e1f2c;">
		
		
		<div class="travel__center   " style="">
<div class="destinations__head xs-marb48 marb96" style="padding-right:0px;">
                <h2 class="destinations__title h2 talc xs-tall" style="margin-bottom: 16px;">Rent out</h2>
				<div class="travel__subtitle   changedText talc  xs-tall" style="
                     color: #787f91; font-size:25px; line-height:1.4;
                  ">We specialize in elevating tenant experience
</div>
		...
		<div class="setting__box">
                    ...
                    <div class="setting__line">
                      <div class="setting__element" style="display:block; border:none; ">
                        <div class="setting__details"> 
                         <div class="destinations__head    xs-marb25" style="padding:0px; margin-bottom:32px; ">
                <h2 class="destinations__title h2   " style="margin-bottom: 16px; font-size:32px;">Ai News</h2>
				 
                <div class="destinations__info info hidden">Carefully selected brands</div>
              </div>
			  <div class="setting__text padb25" style="
                  color: #787f91;
                  font-size: 20px;
                  "> Service for property owners to find suitable guests. Simplify guest selection, maximize occupancy, and enhance rental experiences.</div>
			   
			  
			  
                        </div>
                      <a href="AiNews" class="hidden-xs"><button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts">View</button></a>
                      </div>
			  ...
			  <div class="travel__col" style="padding:0px; widht:100%">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel">
				  <div class="travel__gallery">
                      <div class="travel__bg" style="border-radius: 12px;"><img srcset="https://www.qloudid.com/html/usercontent/images/dstricts/boximage3.jpeg" src="https://www.qloudid.com/html/usercontent/images/dstricts/boximage3.jpeg" alt="Travel"></div>
                       
                   </div>
                    
                  </div>
                </div>
				<a href="AiNews" class="visible-xs"><button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts">View</button></a>
              </div>
	...
	<div class="section destinations xxs-padrl25 hidden" style="margin-bottom:80px;">
	 ...
	 <div class="xxs-padrl25 hidden">
	  <div class="center xxs-pad25 xs-brdrad12" style="padding:50px;   border-radius:25px; max-width: 1132px; background-color:#1e1f2c;">
		...
		<div class="travel__center   " style="">
<div class="destinations__head xs-marb48 marb96" style="padding-right:0px;">
                <h2 class="destinations__title h2 talc xs-tall" style="margin-bottom: 16px;">Exclusive Contracts</h2>
				<div class="travel__subtitle   changedText talc  xs-tall" style="
                     color: #787f91; font-size:25px; line-height:1.4;
                  ">We specialize in elevating tenant experience
</div>
		...
		<div class="setting__box">
                    ...
                    <div class="setting__line">
                      <div class="setting__element" style="display:block; border:none; ">
                        <div class="setting__details"> 
                         <div class="destinations__head    xs-marb25" style="padding:0px; margin-bottom:32px; ">
                <h2 class="destinations__title h2   " style="margin-bottom: 16px; font-size:32px;">Una Qasa</h2>
			  ...
			  <div class="setting__text padb25" style="
                  ...
                  "> Service for property owners to find suitable guests. Simplify guest selection, maximize occupancy, and enhance rental experiences.</div>
                      ...
                      <a href="#" class="hidden-xs"><button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts">Comming soon</button></a>
                      </div>
			  ...
			  <div class="travel__col" style="padding:0px; widht:100%">
				...
				<a href="#" class="visible-xs"><button class="button-stroke button-small faq__button changedText" fdprocessedid="w46jts">Comming soon</button></a>
              </div>
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:525px;">
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
                ...
                <div class="travel__subtitle xs-fsz_lnhe25_1_1 fsz_lnhe32_1_1 changedText" style="
                    color: #787f91;
                  ">Enhance Connections with Global Broker Network
</div>
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">We empower Spanish real estate developers by creating a network and communication tool for brokers worldwide, facilitating information exchange and providing a seamless service for optimized project management. </div>
            </div>
         </div>
      </div>
   </div>
...
<div class="section destinations xs-padrl25 hidden" style="margin-bottom:80px;">
 ...
 <div class="travel__center center   padb136  xs-padrl25 mart80 xs-mart25i hidden" style="    max-width: 1132px;    padding-right: 0px; padding-left: 0px;">
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Our platform facilitates seamless project and knowledge exchange between Spanish developers and global brokers. We offer tailored solutions to enhance workflow, increase sales, and improve profitability.
  ...
  <div class="travel__center center   padb136  xs-padrl25 mart80 xs-mart25i hidden" style="    max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
         ...
         <div class="travel__list" style="margin-bottom:0px;
            ...
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Access a global network with Developer HUB. Our platform automates agreements, commissions, and logistics, accepting brokers as your resellers. This seamless process lets developers engage with more brokers worldwide, boosting sales effortlessly.</div>
            </div>
         </div>
      </div>
   </div>
...
<!-- footer-->
 ...
 <footer class="footer hidden" style="background: #131922;">
        <div class="footer__center center">
          <div class="footer__row">
            <div class="footer__col"><a class="header__logo xs-fsz20 changedText" href="#" style="
   ...
   ">TXP</a>
            ...
            <div class="footer__col">
              <div class="footer__menu tall"><a class="footer__link changedText" href="#">Paseo de la Castellana 77 Madrid, M 28046</a><a class="footer__link" href="#">+34 603 14 72 90</a><a class="footer__link changedText" href="#">Privacy</a> </div>
            </div>
            
          </div>
          <div class="footer__bottom">
            <div class="footer__copyright changedText">Copyright Â© 2021 UI8 LLC. All rights reserved</div>
          </div>
        </div>
      </footer>
