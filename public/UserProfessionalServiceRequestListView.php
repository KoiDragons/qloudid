				...
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Here is the list of all posted premium requests </a></div>
									...
									<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Request list" class="wi_100 rbrdr   tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="" fdprocessedid="vl1vgr">
										 
									</div>
									 </div>
									<?php $i=1;
												
												foreach($postedJobsList as $category => $value) 
												{
													
													
												?> 
											<?php if($value['selected_qualified_companies']!=null) {  if($value['property_info_required']==1) { ?>
											<a href="../../receivedbidList/<?php echo $value['enc']; ?>">	<div class="column_m container mart5 marb5   fsz14 dark_grey_txt">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText"><?php echo $value['subcategory_name']; ?>  </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText"><?php echo $value['address'].'-'.$value['port_number']; ?> </span>  </div>
											...
											<?php } else { ?><a href="../../receivedPropertybidList/<?php echo $value['enc']; ?>">	<div class="column_m container mart5 marb5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
