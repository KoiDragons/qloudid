...
<div class="outer">
<!-- header-->
<header class="header js-header authorization xs-padt24">
    ...
    FONT-SIZE: 20PX;
    line-height:25px !important">Start</a>
		   ...
		   <div class="header__wrapper js-header-wrapper" style="padding-left:0px;">
            <div class="header__item header__item_language js-header-item margin-left0">
              <button class="header__head js-header-head fsz16 ">
                ...
                </svg><h4 class="changedText">Language</h1>
              </button>
           ...
           <a href='#' class="header__item "> <div class=" header__item_language js-header-item " style="border-left: 0px solid !important;">
			...
			<a class="button-stroke button-small header__button fsz16  changedText" href="#" style=" border:2px solid #333; padding: 0 32px !important;">Settings</a>
     ...
     <!-- outer content-->
<div class="outer__inner xsi-mart40">
<div class="section-mb64 hidden-xs product">
...
<div class="section description" style="
border-bottom: 1px solid #fcfcfd;
">
<div class="description__center center">
<div class="description__wrapper" style="
    /* border-right: 1px solid #e6e8ec; */
">
<h2 class="description__title h3 fsz42 changedText"><?php echo $serviceBidsInfo['company_name']; ?></h2>
...
</svg><span class="changedText">Superhost</span>
</div>
<div class="product__option">
<svg class="icon icon-flag">
<use xlink:href="#icon-flag"></use>
</svg><span class="changedText"><?php echo $serviceBidsInfo['c_address'].','.$serviceBidsInfo['c_city']; ?></span>
</div>
</div>
</div>
<div class="description__parameters martb20i">



</div>
<div class="marb10 fsz16">
<p class="txt_777E90 changedText">Described by Queenstown House and Garden magazine as having 'one of the best views we've ever seen' you will love relaxing in this newly built, architectural house sitting proudly on Queenstown Hill.</p>


</div>

<div class="marb10 fsz16">
<p class="txt_777E90 changedText">Described by Queenstown House and Garden magazine as having 'one of the best views we've ever seen'.</p>


</div>
<div class="mart35">
<h4 class="description__title h4" style="
    font-size: 25px;
    margin-bottom: 30px;
    line-height: 30px;
">Price</h4>
...
<div class="setting__label changedText" style="font-size: 16px; color: #777E90;"><?php echo $serviceBidsInfo['subcategory_name']; ?></div>
<div class="setting__text changedText">Apartment</div>
</div>
<button class="button-stroke button-small settings__button changedText" style="padding-left: 25px;padding-right: 25px;">€<?php echo $serviceBidsInfo['project_fee']; ?></button>
</div>
...
<?php if($serviceBidsInfo['bid_accepted']==0) { ?>
<a class="button main__button changedText" href="../../listAddedServiceProducts/<?php echo $data['job_id']; ?>/<?php echo $data['bid_id']; ?>">Accepting this proposal</a>
<?php } ?>
</div>

<div class="faq__col xsip-padrl15 padrl50" style="
    background: #f4f4f4;
     
">
<div class="comment__head xs-padt30" style="
    margin-top: 32px;
    margin-bottom: 20px;
	display:block;
">
<div class="comment__title changedText">Whats included</div>
 
</div>
<div class="faq__box js-tabs-item" style="display: block;/* background: #f4f4f4; */">
<div class="faq__col xs-wi_280p wi_348p" style="
	display:block;	
     
">
<div class="faq__box js-tabs-item" style="display: block;">
<div class="faq__item active">
<div class="faq__head changedText">Bedroom</div>
<div class="faq__body" style="display: block;">
<div class="faq__nav">
<a class="faq__link js-tabs-link" href="#" style="
    margin-bottom: 20px;
    font-size: 15px;
    font-weight: normal;
...
</svg><span class="changedText">Vacuuming of floors and carpets</span>

</a><a class="faq__link js-tabs-link" href="#" style="
    margin-bottom: 20px;
    font-family: 'Poppins', sans-serif;
    font-weight: normal;
">
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Flat surfaces are dust dried</span>
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">The floors are wet dried</span>
    ...
    font-weight: normal;
">
<svg class="icon icon-circle-and-square" style="
    /* margin-right: 16px; */
">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Stains are wiped from switches, door frames and door handles</span>
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Mirrors and glass surfaces are washed (with the exception of windows)</span>
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">If the cleaners get access to a garbage area, they also throw away the garbage</span>
...
<div class="faq__item">
<div class="faq__head changedText">Kitchen</div>
<div class="faq__body">
<div class="faq__nav">
<a class="faq__link js-tabs-link" href="#" style="
    margin-bottom: 20px;
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Stove, sink and the outside of the fan will be cleaned</span>
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Stains are wiped off the fridge, freezer, microwave and dishwasher</span>
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Coffee makers, blenders, toasters and the like are also wiped down</span>
...
<div class="faq__item">
<div class="faq__head changedText">Bathroom</div>
<div class="faq__body">
<div class="faq__nav">
<a class="faq__link js-tabs-link" href="#" style="
    margin-bottom: 20px;
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Cleaning and stain removal on toilet seats, wash basins and bathtubs</span>
...
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg><span class="changedText">Washing of shower and glass walls if there is in the shower</span>
 ...
 <div class="comment__head" style="
    margin-top: 32px;
    margin-bottom: 20px; display:block;
">
<div class="comment__title changedText">What is not included</div>
...
<div class="faq__item">
<div class="faq__head changedText">Not included</div>
<div class="faq__body">
<div class="faq__content changedText">There are some services that we do not offer in house cleaning and that includes cleaning of ceilings, walls and surfaces that require aids to be cleaned. Dusting of paintings, cleaning of furniture, difficult stains, floor drain and air vents. We also do not move furniture and heavy household appliances or carry out renovation cleaning.</div>
