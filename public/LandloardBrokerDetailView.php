...
<a class="button main__button   talc     changedText" href="https://www.safeqloud.com/public/index.php/LandloardBroker/proposalInformation/<?php echo $data['proposal_id']; ?>" style="
     background: white;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
...
<a class="button main__button xs-tall talc xs-fleft   changedText" href="https://www.safeqloud.com/public/index.php/LandloardBroker/proposalInformation/<?php echo $data['proposal_id']; ?>" style="
     background: white;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
...
<a class="button main__button   tall   fleft  changedText" href="https://www.safeqloud.com/public/index.php/LandloardBroker/proposalInformation/<?php echo $data['proposal_id']; ?>" style="
     background: #ffffff;
     margin-top: 40px;
     /* margin-bottom: 55px; */
     color: black;
