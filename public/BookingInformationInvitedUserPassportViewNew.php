...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Check-in details</h2>
<div class="browse__info info xs-fsz25 changedText">Please provide your check-in details</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Check-in details</div>
...
<div class="checkout__section xsi-nobrdt " style="margin-top:10px;   padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../updateUserPassportDetails/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
...
<div class="checkout__line " >
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="first_name" id="first_name" value="<?php echo $userSummary['first_name']; ?>" <?php if($userSummary['first_name']==null ||$userSummary['first_name']=='') echo ''; else echo 'readonly'; ?>   style="background:#23262F; color:grey;" />
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="last_name" id="last_name" style="background:#23262F; color:grey;" value="<?php echo $userSummary['last_name']; ?>" <?php if($userSummary['last_name']==null ||$userSummary['last_name']=='') echo ''; else echo 'readonly'; ?> />
                            </div>
                          </div>
                        </div>
						
						<div class="field">
                          <div class="field__label" style="color:#787f91;">Email address</div>
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email" style="background:#23262F; color:grey;" fdprocessedid="b3ewp" value="<?php  echo $adultInvitationDetail['email']; ?>" readonly >
                          </div>
                        </div>
    ...
    color: grey; border-radius: 12px;
      background: #23262F; width:100%;" fdprocessedid="v23gst" disabled>
	<?php foreach($countryCode as $category =>$value){ ?>													
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="p_number" id="p_number" style="background:#23262F; color:grey;" fdprocessedid="cqhzif" value="<?php echo $userSummary['phone_number']; ?>" <?php if($userSummary['phone_number']==null ||$userSummary['phone_number']=='') echo ''; else echo 'readonly'; ?>>
                            </div>
                          </div>
                        </div>
					   ...
					   <div class="checkout__subtitle">Passport</div>
                       
                      </div>
                      <div class="checkout__fieldset">
                        <div class="field">
                            <div class="field__label" style="color:#787f91;">Passport number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="id_number" id="id_number" style="background:#23262F; color:grey;"  value="<?php if(!empty($userPassport)) echo $userPassport['identity_number']; ?>" <?php if($userPassport['identity_number']==null ||$userPassport['identity_number']=='') echo ''; else echo 'readonly'; ?>>
                            </div>
                          </div>
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Issue year</div>
                            <div class="field__wrap">
                               <select class=""   id="issue_year" name="issue_year" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange='updateMonth(this.value);' >
                          ...
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Issue month</div>
                            <div class="field__wrap">
                              <select class=""   id="issue_month" name="issue_month" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" >
                       ...
                       <div class="checkout__row margin-bottom32">
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Expiry year</div>
                            <div class="field__wrap">
                               <select class=""   id="expiry_year" name="expiry_year" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange='updateExpiryMonth(this.value);' >
								   <?php $date=date('Y'); $year=date('Y')+12;  for($i=$date; $i<=$year;$i++) { ?>
                          ...
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Expiry month</div>
                            <div class="field__wrap">
                              <select class=""   id="expiry_month" name="expiry_month" style="height: 48px;
								...
								color: grey; border-radius: 12px;
                                 ...
                                 <option value="<?php echo $i; ?>" class="lgtgrey2_bg" <?php if(!empty($userPassport)){  if($userPassport['expiry_month']==$i) echo 'selected'; } ?>><?php echo $i; ?></option>
								  <?php }  ?>
								  </select>
                            </div>
                          </div>
                      ...
                      <div class="upload__category">Upload front photo</div>
 ...
 <div class="on_clmn mart20 marb35 hidden">
						...
						<div class="upload__item">
                      <div class="upload__category">Upload back photo</div>
                      <div class="upload__note">Drag or choose your file to upload</div>
