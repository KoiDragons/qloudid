...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="../signUpInfo/<?php echo $data['checkout_id']; ?>" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Landloard</h2>
<div class="browse__info info changedText">Please select the landloard to send the connect request</div>
</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
												foreach($companyLandloardList as $category => $value) 
												{
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['company_email']; ?></div>
 
<div class="checkout__controls">
 
<a href="../verifyConnectionInformation/<?php echo $data['checkout_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
