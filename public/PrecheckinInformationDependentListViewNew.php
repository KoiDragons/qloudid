...
<a class="header__logo xs-fsz20 " href=""../precheckedinInfo/<?php echo $data['hotel_checkin_id']; ?>" style="
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="../dependentsDetailinfo/<?php echo $data['hotel_checkin_id']; ?>" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Add</button>
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Child</h2>
<div class="browse__info info changedText">Add your child as a guest</div>
</div>
...
<div class="checkout__category changedText">Select</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
												foreach($dependentsListForCheckin as $category => $value) 
												{
...
<div class="checkout__label changedText">Child</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['name']; ?></div>
 
<div class="checkout__controls">
<a href="../addDependentChekin/<?php echo $data['hotel_checkin_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
