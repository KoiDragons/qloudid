...
function changeDisplay1()
	   ...
	   {
		   var send_data={};
				 send_data.language_id=id;
				 
				 $.ajax({
							type:"POST",
							url:"../../updateLanguageAvailable/<?php echo $data['cid']; ?>",
							data:send_data,
							dataType:"text",
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  >Languages</h1>
									</div>
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Please select languages your company support</a></div>
					 ...
					 <div class="clear"></div>
								...
								<a href="#profile1" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active" style="background-color: #c12219 !important;"><span class="changedText">Languages</span>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Languanges</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Which languages you prefer to work/support with?</span> 
													 </div>
									...
									<?php 
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20" id="<?php echo $value['id']; ?>">
														<a href="javascript:void(0);"   onclick="updateLanguage(<?php echo $value['id']; ?>)"><input data-testid="test-checkbox-Walls" name="Walls" type="checkbox" class="css-1lgzhz8" <?php if($value['is_selected']==1) echo 'checked'; ?> ></a>
														</div>
											<label for="oven" class="css-14q70q1 changedText"><?php echo str_ireplace('&','and',html_entity_decode($value['language_name'])); ?></label></div>
					 ...
					 <div class="padt20 talc padb50">
							...
							<a href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/UserCompanySignUp/updateAreaInformation/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">
