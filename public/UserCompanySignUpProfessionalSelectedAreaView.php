...
function changeDisplay1()
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateArea/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
							$('#service'+id1).html('');
							data1=data1+' areas selected';
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateAllArea/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir changedText"  >Locations</h1>
									</div>
									<div class="mart10 marb5 xs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Please select the city and area where  your company provides services</a></div>
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padr10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Alicante</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs changedText">Update area available for customer service</span> 
													 </div>
