			...
			<div class="column_m talc lgn_hight_22 fsz16 mart60 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_70 xxs-lgn_hight_50 padb0 white_txt trn ffamily_avenir changedText">Checkin in advance</h1>
									</div>
									<div class=" xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText">Avoid long lines or the time consuming check-in process upon arrival</a></div>
														 ...
														 <div tabindex="0" role="button" id="bath-chip" class="css-1w0xfwu" fdprocessedid="29w8s">
															<span class="chip chip_not-selected" style="border: 1px solid #353945 !important;">
															   <span class="chip_content">
																  ...
																  <span class="chip_text txt_777E90">Reserved</span>
															   </span>
															</span>
														 </div>
													  </div></a>
													   ...
													   <div tabindex="0" role="button" id="bath-chip" class="css-1w0xfwu" fdprocessedid="sv8pva">
														  <span class="chip chip_is-selected">
															 <span class="chip_content">
																...
																<span class="chip_text">Pre check-in</span>
															 </span>
														  </span>
													   </div>
													</div></a>
					  ...
					  <div class="tab-header martb10 padb10 xs-tall brdb2_3B71FE nobrdt nobrdl nobrdr talc hidden">
									 ...
									 <a href="../selectInvitationType/<?php echo $data['hotel_checkin_id']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="bg_2F3C4F brdrad5  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
									 ...
									 <a href="../dependentsList/<?php echo $data['hotel_checkin_id']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="bg_2F3C4F brdrad5  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
