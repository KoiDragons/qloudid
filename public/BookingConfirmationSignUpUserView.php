	   ...
	   function updateInclutionType(id)
	   {
	    ...
	    function submitform()
		{
			...
			send_data.country_id=$("#country").val();
					...
					$.ajax({
						type:"POST",
						url:"../../../../verifyCodeInfo/<?php echo $data['job_id']; ?>",
						data:send_data,
						dataType:"text",
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">SIGN UP</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Add your personal and not work details
</h2>
...
<div class="checkout__category changedText">Your personal detail</div>
...
<form class="checkout__item js-tabs-item" action="../../../../addUserAndUpdatePostJob/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="field__wrap">
<input class="field__input"  type="text" name="email" id="email"  value="<?php echo $_POST['email']; ?> " readonly style="background:#F4F5F6; height:60px; border:none; color:black;">
</div>
</div>
<div class="checkout__row" style="margin-bottom:32px;">
<div class="field">
...
<div class="field hidden" id="codeValue">
<div class="field__label changedText" style="color:#525252;">Verification code</div>
<div class="field__wrap">
<input class="field__input"  name="v_code" id="v_code"    type="text"   style="background:#F4F5F6; height:60px; border:none; color:black;"  >
</div>
</div>
<div class="checkout__fieldset">
 <input type="hidden" id="verified_number" name="verified_number"  value="0" /> 
