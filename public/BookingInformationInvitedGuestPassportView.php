							...
							<form action="../updateGuestPassportDetails/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div id="profile" class=" " style="display:block;">	
											...
											<div class="pos_rel">
												...
												<input type="text" name="email" id="email" placeholder="Email address" class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25"  value="<?php if($_POST['tenant_available']==1) echo $adultInvitationDetail['email']; ?>" <?php if($_POST['tenant_available']==1) echo 'readonly'; ?> /> 
										...
										<select id="pcountry" name="pcountry" class="wi_100 bg_2F3C4F nobrd padt25 tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir"     />
											...
											<div class="pos_rel">
												...
												<input type="text" name="p_number" id="p_number" placeholder="Phone number"   class="nobrd tall minhei_65p fsz20 padl10 txt_777E90 ffamily_avenir bg_2F3C4F floating__input padt25"  > 
