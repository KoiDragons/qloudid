<html><head>
	<meta charset="utf-8">
		...
		<script type="text/javascript" src="../../../../html/usercontent/js/translateCombine.js"></script>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText">Signup</h1>
									</div>
									<div class="mart10 marb5 xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText">Select how you want to signup on selcted marketplace for which you want to work for now</a></div>
					 ...
					 <div class="column_m container fsz14 dark_grey_txt brdb marb5">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Signup type</span> 
													 </div>
									 ...
									 <a href="javascript:void(0)" onclick="submitForm(<?php echo $value; ?>);">	
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText"><?php if($value==1) echo 'User'; else if($value==3) echo 'User company'; else echo 'Partner company'; ?></span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Please click to start signup</span>  </div>
