...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Checkin in advance</h2>
<div class="browse__info info changedText">Avoid long lines or the time consuming check-in process upon arrival.</div>
</div>
...
<?php } for($i=1;$i<=$updatePreCheckinStatus['guest_adult_left'];$i++) 
												{
...
<a class="button-stroke receipt__button" href="../selectInvitationType/<?php echo $data['hotel_checkin_id']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Invite</span></span>
</a> 
...
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
					...
					<?php }  for($i=1;$i<=$updatePreCheckinStatus['guest_children_left'];$i++) 
												{
													 ?>	
<div class="checkout__data  ">
<div class="checkout__el">
...
<a class="button-stroke receipt__button" href="../dependentsList/<?php echo $data['hotel_checkin_id']; ?>"><span class="receipt__cost"><span class="receipt__money changedText" style="color: #e11936 ;">Invite</span></span>
</a> 
