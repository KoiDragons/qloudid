...
<div class="header__menu"><a class="header__link " href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/selectCity/<?php echo $data['domain_id']; ?>">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg>Book today</a>
<a class="header__link  active" href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/selectProposalCity/<?php echo $data['domain_id']; ?>" style=" box-shadow: none;">
...
<div class="header__item header__item_dropdown js-header-item hidden-xs">
              ...
              <div class="header__body js-header-body" style="z-index:1;">
                <div class="header__menu"><a class="header__link " href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/selectCity/<?php echo $data['domain_id']; ?>">
					...
					<a class="header__link active" href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/selectProposalCity/<?php echo $data['domain_id']; ?>">
                    <svg class="icon icon-email">
                      <use xlink:href="#icon-email"></use>
                    </svg>Price comparison</a>
					<a class="header__link" href="https://www.safeqloud.com/public/index.php/UserCompanySignUp/signUpEmailInfo/<?php echo $data['domain_id']; ?>">
