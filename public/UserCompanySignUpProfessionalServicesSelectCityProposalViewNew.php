...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.minPannelDown.css">
...
<div class="header__menu"><a class="header__link " href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/UserCompanySignUp/selectCity/<?php echo $data['domain_id']; ?>">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg>Book today</a>
<a class="header__link  active" href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/UserCompanySignUp/selectProposalCity/<?php echo $data['domain_id']; ?>" style=" box-shadow: none;">
...
<div class="header__item header__item_dropdown js-header-item hidden-xs">
              ...
              <div class="header__body js-header-body" style="z-index:1;">
                <div class="header__menu"><a class="header__link " href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/UserCompanySignUp/selectCity/<?php echo $data['domain_id']; ?>">
					...
					<a class="header__link active" href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/UserCompanySignUp/selectProposalCity/<?php echo $data['domain_id']; ?>">
                    <svg class="icon icon-email">
                      <use xlink:href="#icon-email"></use>
                    </svg>Price comparison</a>
					<a class="header__link" href="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/UserCompanySignUp/signUpEmailInfo/<?php echo $data['domain_id']; ?>">
...
<div class="main__center center">
            <div class="main__preview">
             <?php if($selectedMarketplaceDetail['background_image']!=null || $selectedMarketplaceDetail['background_image']!=''){ ?>
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo $selectedMarketplaceDetail['background_image']; ?>"><img src="<?php echo $selectedMarketplaceDetail['background_image']; ?>" alt="Main">
              </picture>
			<?php } ?>
              <div class="main__wrap">
                <h1 class="main__title hero" style="color:white;"><?php echo $selectedMarketplaceDetail['heading_info']; ?></h1>
                <div class="main__info info" style="color:white; font-size:25px;"><?php echo $selectedMarketplaceDetail['subheading_info']; ?></div> 
              </div>
            </div>
            <div class="panel panel_stays">
              <div class="panel__background"></div>
			  <?php if($selectedMarketplaceDetail['booking_signup_type']==3)
				{
				  ?>
              <div class="panel__nav"><a class="panel__link changedText" href="../selectCity/<?php echo $data['domain_id']; ?>" >Book online</a><a class="panel__link active changedText" href="Javascript:void(0);" style="color:#f67f00">Price comparison</a></div>
		<?php } ?>
                ...
                <div class="panel__row">
                  <div class="location js-location xs-wi_80">
                    <div class="location__head js-location-head">
                      ...
                      <input class="location__input js-location-input" type="text" name="city" id="city" autocomplete="off" placeholder="Location">
