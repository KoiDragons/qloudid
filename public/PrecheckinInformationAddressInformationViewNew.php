...
<a class="header__logo xs-fsz20 " href="../userActiveStatus/<?php echo $data['hotel_checkin_id']; ?>" style="
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Address</h2>
<div class="browse__info info xs-fsz25 changedText">Please add your delivery address</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Guest personal Address </div>
...
<form class="checkout__item js-tabs-item" action="../updateUserPersonalAddress/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
					   ...
					   <div class="checkout__subtitle">Address</div>
					  ...
					  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="d_address" id="d_address" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dpo_number" id="dpo_number" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                         </div>
                         <div class="checkout__row margin-bottom32">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dzip" id="dzip" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dcity" id="dcity" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                         </div>
						 <div class="field">
                            <div class="field__label" style="color:#787f91;">Entry code</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="entry_code" id="entry_code" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
						 <script>
						 function updateSameInvoice(id)
						 {
							$('#same_invoice').val(id);
							if(id==1)
							{
								$('#invoiceDetail').addClass('hidden');
								
							}	
							else
							{
								$('#invoiceDetail').removeClass('hidden');
								
							}								
						 }
						 </script>
						<div class="field">
						<div class="field__label changedText" style="color:#787f91;">If Invoice address is same as delivery address?</div>
						<div class="field__wrap">
						<select class="" id="price_info" name="price_info" style="height: 48px;
							padding: 0 14px; border-color: #353945;
							color: grey; border-radius: 12px;
							  background: #23262F; width:100%;" fdprocessedid="8mc52" onchange="updateSameInvoice(this.value);">
					   ...
					   <div id="invoiceDetail" class="hidden">
					    <div class="checkout__line ">
					   <div class="checkout__subtitle">Invoice address</div>
					  ...
					  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label" style="color:#787f91;">Street address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="iaddress" id="iaddress" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                            ...
                            <div class="field__label" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="i_port_number" id="i_port_number" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                         </div>
                         <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label" style="color:#787f91;">Zipcode</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="izip" id="izip" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                            ...
                            <div class="field__label" style="color:#787f91;">City</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="icity" id="icity" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                         </div>
						   </div>
