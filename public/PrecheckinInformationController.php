...
class PrecheckinInformationController
{
    ...
    public static function dependentsList($a=null)
	{
			...
			{
				header('location:https://www.safeqloud.com/public/index.php/PrecheckinInformation/listBookings/'.$data['uid']); die;
			}
	...
	public static function addDependentInformation($a=null)
	{
			...
			$today=strtotime(date('Y-m-d'));
				...
				{
				header('location:https://www.safeqloud.com/public/index.php/BookingInformation/precheckedPersons/'.$data['hotel_checkin_id']); die;	
				}
	...
	public static function precheckedinInfo($a=null)
	{
			...
			if($bookingInformationDetail['checked_in']==1)
				...
				header('location:https://www.safeqloud.com/public/index.php/BookingInformation/checkedInDetail/'.$data['hotel_checkin_id']); die;	
				}	
