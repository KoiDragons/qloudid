<html lang="en" style="--vh:6.01px;"><head>
  ...
  <body class="dark" onload="getValueStart();">
    <script>
 ...
 $(document.body).on('click', '.ui-slider-range .slider-range .ui-slider-handle', function(){
		...
		function checkFlag()
		 ...
		 function getValue()
		 {
			  var price=parseInt($('#real_price').html()); 
			var counter_value=parseInt($('.js-counter-value').html())+1;
			...
			if(counter_value==10)
			{
				$('.js-counter-plus').addClass('disabled');
			}
			
			if(counter_value<10)
			{
				$('.js-counter-plus').removeClass('disabled');
			}
			$("#oil_numbers").val(counter_value);
			t_price=price*counter_value;
			$('#totalPrice').html(t_price);
		 }
		 function getValueStart()
		 {
			  var price=parseInt($('#real_price').html()); 
			var counter_value=parseInt($('.js-counter-value').html());
    ...
    <div class="outer">
      ...
      <div class="outer__inner">
        <div class="section-mb80 checkout checkout_stays" style="margin-top:80px;">
          <div class="checkout__center center">
            
            <div class="checkout__wrapper">
              <div class="checkout__inner js-tabs">
                <h2 class="checkout__title h2"><?php echo $productInfo['dish_name']; ?></h2>
                <div class="checkout__list">
                  <div class="checkout__section">
                    <div class="checkout__box">
					<div class="receipt" style="border: none;    background: #141416; padding:0; margin:0; width:100%;">
					<div class="receipt__stage">How many</div>
					<div class="receipt__settings">
                <div class="receipt__setting">
                  <div class="receipt__wrap">
                    
                    <div class="receipt__content" style="font-size: 14px;">The added amount will be included in the total price below.</div>
                  </div>
                  <div class="counter js-counter" data-min="1">
                    ...
                    <input class="js-counter-input js-counter-result js-counter-babies" type="hidden" value="1">
                  </div>
                </div>
                 </div>
				 <div class="receipt__stage">Price details</div>
				 <div class="receipt__table">
                <div class="receipt__line" style="padding:8px 0px;">
                  <div class="receipt__cell">Gross Amount/piece</div>
                  <div class="receipt__cell"><span id="real_price"><?php echo $productInfo['dish_price']; ?></span>  SEK</div>
                </div>
                
                <div class="receipt__line" style="padding:8px 0px;">
                  <div class="receipt__cell">Service fee</div>
                  <div class="receipt__cell">0  SEK</div>
                </div>
                <div class="receipt__line" >
                  <div class="receipt__cell">Total</div>
                  <div class="receipt__cell"><span id="totalPrice"><?php echo $productInfo['dish_price']; ?></span>  SEK</div>
                </div>
              </div>
                    ...
                    <div class="price__row">
                      <div class="price__cell">Price</div>
                      <div class="price__cell" ><span id="real_price"><?php echo $productInfo['dish_price']; ?></span>  SEK</div>
                    </div>
                  <div class="price__row">
                      <div class="price__cell">Total product</div>
                      <div class="price__cell"><div class="counter js-counter borderIncrementer" data-min="1">
                                  <button class="counter__button js-counter-button js-counter-minus disabled" type="button" onclick="getValueLower();">
                    ...
                    <div class="price__row">
                      <div class="price__cell">Total (price)</div>
                      <div class="price__cell" ><span id="totalPrice"><?php echo $productInfo['dish_price']; ?></span>  SEK</div>
                    </div>
                  </div>-->
...
<a class="button checkout__button" href="javascript:void(0);" onclick="checkProductInfo();" style="margin-top:20px;">Confirm and add</a>
        ...
        <input type="hidden" name="bfil" value="2">
              ...
              <div class="price" style="padding:0 !important;">
                <div class="price__head" style="display: block !important;">
                  <div class="price__preview" style="padding:0px; width:100%; height:100%;"><img src="../../../../<?php echo $productInfo['image_path']; ?>" alt="Price"></div>
