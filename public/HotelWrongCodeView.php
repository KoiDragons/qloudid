...
<html>
	...
	<body class="lgtgrey2_bg">
		...
		<div class="column_m pos_rel"  >
			...
			<!-- CONTENT -->
			<div class="column_m container zi5  mart60 xs-mart40" onclick="removeActive();">
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0  ">
						...
						<div class="talc fsz75 red_txt"> <span class="fas fa-minus-circle"></span></div>
							<div class="padb10 ">
									...
									<p class="pad0 xs-padb10 talc fsz25 xs-fsz16 padb0 wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 xs-brdb_b">You have entered wrong code please try with correct code.</p>
								</div>
						
						<div class="mart20 talc">
						<a href="../verifyCheckin/<?php echo $data['id']; ?>"><input type="button" value="Try again" class="wi_320p maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" ></a>
