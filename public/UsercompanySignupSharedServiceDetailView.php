...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../../../../../../../bookableServiceList/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>" style="
...
<div class="outer__inner xs-paddingTop10" style="padding-top: 65px;">
<div class="section-mb64 product hidden-xs">
<div class="product__center center">

<div class="product__head " >
<div class="product__box">
<h2 class="product__title h2"><?php echo $selectedServiceInfo['dish_name']; ?></h2>
<div class="product__line">
<div class="product__avatar"><img src="https://dstricts.com/html/fleet/img/content/avatar-1.jpg" alt="Avatar"></div>
...
<div class="flights__container" style="padding:0;">
<div class="flights__list">
				...
				<a class="card card_row" href="javascript:void(0);" style="border-radius:0px; border-top:none; border-left:none; border-right:none; border-bottom: 1px solid #353945;">
 
<div class="card__body" style="  padding:0px 0px 24px 0px !important;">
<div class="card__line" style="margin-bottom:0px;">
<div class="flight__title" style="font-size: 48px; margin-bottom:5px;"><?php echo $selectedServiceInfo['dish_name']; ?></div>
 
</div>
<div class="card__options" style="margin-bottom:0px;">
<div class="card__option">
<svg class="icon icon-clock">
<use xlink:href="#icon-clock"></use>
</svg><?php if($selectedServiceInfo['one_shared_type']==3) echo 'Public/Private event'; else echo 'Public event'; ?>  for your comfort</div>
<div class="card__option">
<svg class="icon icon-user">
<use xlink:href="#icon-user"></use>
</svg>Service product
 ...
 <div class="gallery" style="padding-top:20px;">
              <div class="gallery__list gallery__list_stays">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view" href="<?php echo $selectedServiceImages[0]['image_path1']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="<?php echo $selectedServiceImages[0]['image_path1']; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#" class="xs-brdrad10">
                    <svg class="icon icon-image">
                      <use xlink:href="#icon-image"></use>
                    </svg><span>Show all photos</span></a></div>
					<?php  $i=1; foreach($selectedServiceImages as $category => $value)
												{
													if($i==1){ $i++; continue;}
												if($i>4) { break; } ?>
...
<p><?php echo $selectedServiceInfo['dish_detail']; ?></p>
</div>
 
</div>
</div>
</div>
<div class="receipt" style="border: 1px solid #353945 !important;">
 <div class="receipt__head">
                <div class="receipt__details"> 
                  <div class="receipt__cost">
                    <div class="receipt__old" style="text-decoration: none !important;">From</div>
                    <div class="receipt__actual">$<?php echo $selectedServiceInfo['private_price']; ?></div>
                ...
                <div class="receipt__avatar"><img src="<?php echo $path; ?>../html/fleet/img/content/avatar.jpg" alt="Avatar">
...
<div class="receipt__stage"><?php if($selectedServiceInfo['one_shared_type']==3) echo 'Public/Private event'; else echo 'Public event'; ?></div>
<script>
...
<div class="receipt__subtitle">Booking type</div>
<div class="receipt__content">Select preferred booking type</div>
</div>
...
<div class="receipt__wrap">
<div class="receipt__subtitle">Total person</div>
<div class="receipt__content">Who will join the event</div>
</div>
...
<div class="receipt__cell">Price</div>
...
</svg>Free cancellation</div><a class="button receipt__button" href="javascript:void(0);" onclick="submitForm();" style="background:#F67F00;"><span>Book service</span>
