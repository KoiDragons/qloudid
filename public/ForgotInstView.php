				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
							...
							<div class="padb20 xxs-padb0  ">		
							 	...
							 	<div class="talc  padtb20"><a href="../../forgotInstAccount/<?php echo $data['email'];?>/<?php echo $data['rand_hash'];?>" ><input type="button" value="Resend" class="forword minhei_55p t_67cff7_bg fsz18 ffamily_avenir"  /></a>
