...
<li>With your consent, for example where we have obtained your consent to process your information for certain activities (such as the use of cookies for online tracking and analysis). You are free to withdraw your consent at any time by contacting legal@safeqloud.com. If you withdraw your consent, it will not affect the lawfulness of any processing based on your consent before you withdrew it. Where applicable, we may ask for your consent to processing at the point where you provide your information (e.g., cookie banner).</li>
...
<li>You can stop all collection of information by an App by uninstalling that App. You may use the standard uninstall process available as part of your desktop or mobile device or via the mobile application marketplace or network. Uninstalling an App does not delete your Account. To do that, please contact us at support@safeqloud.com. </li>
...
<p class="black_txt padt10  padb0">If you have questions, concerns, or complaints about this Policy or our data collection or processing practices, or if you want to report any security violations, please email legal@safeqloud.com, or write the address below:</p>	
