...
<div class="header__center center xxs-padrl25 changedText"><a class="header__logo xs-fsz20 " href="#" style="
...
">Add</h2>
<div class="browse__info info xs-fsz25 changedText">Describe your property with these questions.</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Your property detail</div>
...
<form class="checkout__item js-tabs-item" action="../../addProfessionalProperty/<?php echo $data['checkout_id']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
<div class="checkout__fieldset">
<div class="field" style="">
<div class="field__label changedText" style="color:#525252;">Building type</div>
<div class="field__wrap">
<select class="nice-select select" id="property_type_detail" name="property_type_detail" style="background: rgb(244, 245, 246); height: 60px; border: none; padding: 0px 14px; color: rgb(119, 126, 144); border-radius: 12px; width: 100%; display: none;" fdprocessedid="8mc52">
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Name on the door</div>
<div class="field__wrap">
<input class="field__input" name="flname" id="flname"    type="text"   style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>
<div class="checkout__row" style="margin-bottom:32px;">
<div class="field">
<div class="field__label changedText" style="color:#525252;">Delivery address</div>
<div class="field__wrap">
<input class="field__input" name="addrs" id="addrs"    type="text"   style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#525252;">Port number</div>
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"   style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>
</div>
...
<div class="checkout__row" style="margin-bottom:32px;">
<div class="field">
<div class="field__label changedText" style="color:#525252;">Zipcode</div>
<div class="field__wrap">
<input class="field__input" name="dzip" id="dzip"    type="text"   style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#525252;">Delivery city</div>
<div class="field__wrap">
<input class="field__input"  name="dcity" id="dcity"    type="text"   style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>
</div>

<div class="field"  >
<div class="field__label changedText" style="color:#525252;">Entry code</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="entry_code" id="entry_code"  style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>
 <div class="field"  >
<div class="field__label changedText" style="color:#525252;">Total floors</div>
<div class="field__wrap">
<input class="field__input"  type="number" name="total_floors" id="total_floors"   required="" style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>

<div class="checkout__fieldset">
<div class="field"  >
<div class="field__label changedText" style="color:#525252;">Total bedrooms</div>
<div class="field__wrap">
<input class="field__input"  type="number" name="total_bedrooms" id="total_bedrooms"    required="" style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>

<div class="field"  >
<div class="field__label changedText" style="color:#525252;">Total bathrooms</div>
<div class="field__wrap">
<input class="field__input"  type="number" name="total_bathrooms" id="total_bathrooms"    required="" style="background:#F4F5F6; color:black; height:60px; border:none;">
</div>
</div>
