...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Child details</h2>
<div class="browse__info info xs-fsz25 changedText">Please provide your child detail</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Add child details</div>
...
<form class="checkout__item js-tabs-item" action="../addDependentInformation/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
 
 <div class="upload__item">
                      <div class="upload__category">Upload photos</div>
...
<div class="checkout__line padt32 xsi-padt45 mart30" style="border-top: 1px solid #23262F;">
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="fname" id="fname"   style="background:#23262F; color:grey;" />
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="lname" id="lname" style="background:#23262F; color:grey;" />
                            </div>
                          </div>
                        </div>
						
						 <div class="checkout__row margin-bottom32">
                          <div class="field" style="flex: 0 0 calc(34% - 16px);  width: calc(34% - 16px);   margin: 0 8px;">
                            <div class="field__label" style="color:#787f91;">Year</div>
                            <div class="field__wrap">
                              <select class=""   id="dob_year" name="dob_year" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange='updateMonths(this.value);' >
								  <?php echo $dobYears; ?> 
								  </select>
                            </div>
                          </div>
                          <div class="field" style="flex: 0 0 calc(33% - 16px);  width: calc(33% - 16px);   margin: 0 8px;">
                            <div class="field__label" style="color:#787f91;">Month</div>
                            <div class="field__wrap">
                             <select class=""   id="dob_month" name="dob_month" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange='updateDays(this.value);' >
						  ...
						  <div class="field" style="flex: 0 0 calc(33% - 16px);  width: calc(33% - 16px);   margin: 0 8px;">
                            <div class="field__label" style="color:#787f91;">Day</div>
                            <div class="field__wrap">
                             <select class=""   id="dob_day" name="dob_day" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
						...
						<div class="field">
                            <div class="field__label" style="color:#787f91;">Does the child have same address as you</div>
                            <div class="field__wrap">
                             <select class=""   id="is_address_same" name="is_address_same" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange='updateInvoice(this.value);' >
								  <option value="1" class="lgtgrey2_bg">Yes</option>
											   <option value="0" class="lgtgrey2_bg">No</option>
								  </select>
                            </div>
                          </div>
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="child_address" id="child_address" style="background:#23262F; color:grey;"  required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="child_port_number" id="child_port_number" style="background:#23262F; color:grey;" required>
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="child_zipcode" id="child_zipcode" style="background:#23262F; color:grey;" required>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">City</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="child_city" id="child_city" style="background:#23262F; color:grey;" required>
                            </div>
                          </div>
                        </div>  
                      </div>
