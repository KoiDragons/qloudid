...
<div class="flights__container" style="padding:0; display:none;">
...
<div class="card__preview" style="display:none;"><img srcset="<?php echo $selectedServiceInfo['dish_image']; ?>" src="<?php echo $selectedServiceInfo['dish_image']; ?>" alt="Premium milford sound tour ex Queenstown">
<div class="category-blue card__category">best selling</div>
</div>
<div class="card__body" style="background: #212b39; padding:0px 0px 24px 0px !important;">
<div class="card__line">
<div class="flight__title" style="font-size: 48px;"><?php echo $selectedServiceInfo['dish_name']; ?></div>
<div class="card__price" style="color:#F67F00; box-shadow: inset 0 0 0 2px #F67F00;">
<div class="card__old">$<?php echo $selectedServiceInfo['dish_price']; ?></div>
<div class="card__actual">$<?php echo $selectedServiceInfo['dish_price']; ?></div>
</div>
</div>
...
<div class="card__text  fsz14">One to one service for your comfort</div>
</div>
<div class="card__flex" style="display:none;">
<div class="card__cost fsz16">$<?php echo $selectedServiceInfo['dish_price']; ?> total</div>
...
<svg class="icon icon-clock">
<use xlink:href="#icon-clock"></use>
</svg>One to one service for your comfort</div>
<div class="card__option">
<svg class="icon icon-user">
<use xlink:href="#icon-user"></use>
</svg>1 Person
...
<div class="receipt__stage">Select Employee</div>
 
<div class="receipt__settings">

<div class="receipt__setting" style="display: flex;">
<div class="receipt__wrap">
<div class="receipt__subtitle">Any one</div>
<div class="receipt__content">Click here to select a general calender</div>
</div>

<div class="counter js-counter" data-min="0" >

<a href="../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style="background-color: transparent !important; color: #b24304;"><div class="counter__value  " style="padding: 0 26px !important;">Select</div></a>
...
foreach($professionalCompanyEmployeeList as $category => $value) 
  ...
  <div class="receipt__setting" style="display: flex;">
<div class="receipt__wrap">
<div class="receipt__subtitle"><?php echo $value['name']; ?></div>
<div class="receipt__content"><?php echo $value['email']; ?></div>
</div>

<div class="counter js-counter" data-min="0"  >

<a href="../../../../../../../../../getGeneralCalander/<?php echo $data['catg_id']; ?>/<?php echo $data['whom_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>/<?php echo $data['todo_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['cid']; ?>/<?php echo $data['service_id']; ?>/<?php echo $value['enc']; ?>" style="background-color: transparent !important; color: #b24304;"><div class="counter__value  " style="padding: 0 26px !important;">Select</div></a>
