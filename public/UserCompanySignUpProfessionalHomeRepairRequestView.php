			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40   "  >
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  ><?php echo $selectedProblemSubpartId['problem_subpart_name']; ?></h1>
									</div>
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Describe the problem you have in your <?php echo $selectedProblemSubpartId['problem_subpart_name']; ?> below</a></div>
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="../../../../../addProfessionalHomeRepairRequest/<?php echo $data['catg_id']; ?>/<?php echo $data['subcatg_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['area_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
									 	<div class="marrl0 padb15 brdb fsz16 white_bg tall padt35">
								<a href="#profile1" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active" style="background-color: #c12219 !important; "><span class="changedText">Problem type</span>
								...
								<div id="profile1" class=" " style="display:block;">	
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Select one</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">What type of problem do you have?</span> 
													 </div>
									...
									<div class="clear"></div>
									 <div class="on_clmn padt10">
											...
											<div class="pos_rel">
												...
												<select id="property_type_detail" name="property_type_detail" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select" fdprocessedid="u205l" onchange="getSubcategoryIssue(this.value);">
												<option value="0" class="changedText">Select</option>
														<?php 
												foreach($selectedCategoryProblemsInfo as $category => $value) 
												{
													
													
												?> 	
														<option value="<?php echo $value['id']; ?>" class="changedText"><?php echo str_ireplace('&','and',$value['subcategory_name']); ?></option>
												<?php } ?>
														</select>
												 <label for="property_type_detail" class="floating__label tall nobold padl10" data-content="Main problem">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Inclusions</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">What do you want to be included in your repair task?</span> 
													 </div>
									...
									<input type="hidden" id="problem_subpart_id" name="problem_subpart_id" value="<?php echo $data['problem_subpart_id']; ?>" />
										<div class="clear"></div>
										<div class="marrl0 padb15 brdb fsz16 white_bg tall padt35">
