...
<form class="checkout__item js-tabs-item" action="../addBuildingDetails/<?php echo $data['checkout_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<input class="field__input"  type="text" name="company_name" id="company_name"   required="" style="background:#23262F; color:grey;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  type="text" name="cid" id="cid"    required="" style="background:#23262F; color:grey;">
</div>
</div>
<input type="hidden" id="company_type" name="company_type" value="1" />
<input type="hidden" id="company_email" name="company_email" value="" />
 
<input type="hidden" id="signup_type" name="signup_type"  value="1" />
<div class="checkout__row " >
<div class="field ">
<div class="field__label changedText" style="color:#787f91;">Street address</div>
<div class="field__wrap">
<input class="field__input" name="daddress" id="daddress"    type="text"   style="background:#23262F; color:grey;">
</div>
</div>
<div class="field margin-bottom32">
<div class="field__label changedText" style="color:#787f91;">Port number</div>
<div class="field__wrap">
<input class="field__input"  name="d_port_number" id="d_port_number"    type="text"   style="background:#23262F; color:grey;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input" name="dzip" id="dzip"    type="text"   style="background:#23262F; color:grey;">
</div>
</div>
<div class="field  ">
<div class="field__label changedText" style="color:#787f91;">City</div>
<div class="field__wrap">
<input class="field__input"  name="dcity" id="dcity"    type="text"   style="background:#23262F; color:grey;">
</div>
</div>
</div>
...
<select  class=""  name="objectType" id="objectType" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: #23262F; width:100%;" fdprocessedid="8mc52">
				 
       <option value="1" class="lgtgrey2_bg changedText" >Building</option>
