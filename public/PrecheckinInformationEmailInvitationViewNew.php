...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
      border-bottom: none;
">Invite</h2>
<div class="browse__info info xs-fsz25 changedText">Please invite the guest using their personal email</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<form class="checkout__item js-tabs-item" action="../emailIinviteAdultForCheckin/<?php echo $data['hotel_checkin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
...
<div class="field">
                          ...
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email" style="background:#23262F; color:grey;" fdprocessedid="wt9r6">
                          </div>
                        </div>
