 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
			     ...
			     <a class="categories__item  bg_E7E7E7 " href="https://www.qloudid.com/public/index.php/BookingInformation/invoiceAddressesUser/<?php echo $data['checkout_id']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
...
<div class="checkout__box">
 ...
 <?php $i=0;
												foreach($invoiceAddressesCompany as $category => $value) 
												{
...
<a href="../updateCompanyAddress/<?php echo $data['checkout_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
