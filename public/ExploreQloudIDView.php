...
">Qloud ID is your digital ID of your real ID &amp; Passport.</div>
</div>
</div>
...
<img srcset="https://www.dropbox.com/scl/fi/j9njehllq1njyc7olsspj/037d85b8-52ab-48e4-bf3d-810d5b216825.jpg?rlkey=3tal32cbskacdipe4n23sn5j1&amp;raw=1" src="img/content/travel-pic-1.jpg" class="hidden-xs" alt="Travel" style="border: 3px solid white;border-radius: 39px; width: 70%;">
...
<div class="categories__head xs-padrl25 xs-tall" style="
    margin-bottom: 75px;
">
<h2 class="categories__title h2 fsz60 xs-fsz45" >Applicable</h2>
<div class="categories__info info xs-fsz25 fsz30">You can use Qloud ID to do following</div>
</div>
<div class="categories__wrapper">
<div class="categories__slider js-slider-categories ">
<a class="categories__item " href="stays-category.html" >
...
<div class="categories__content" style="
    font-size: 16px;
    /* color: black; */
">Our app is an identification system that allows you to identify yourself
</div></a>
<a class="categories__item " href="stays-category.html" >
<div class="status categories__counter">256.356</div>
...
<div class="categories__content" style="
    font-size: 16px;
    /* color: black; */
">A secure way to sign documents online in a legally binding way
</div></a>
<a class="categories__item" href="stays-category.html">
<div class="status categories__counter">256.356</div>
...
<div class="categories__content" style="
    font-size: 16px;
    /* color: black; */
">Check-in &amp; out allows you to check in to your flight, hotel, or other reservation
</div></a>
<a class="categories__item " href="stays-category.html">
<div class="status categories__counter">256.356</div>
...
<div class="categories__content" style="
    font-size: 16px;
    /* color: black; */
">A secure and fast way to shop online with delivery options</div></a>
<a class="categories__item" href="stays-category.html">
<div class="status categories__counter">256.356</div>
...
<h2 class="newsletter__title h2">Works in 32 countries</h2>
<div class="newsletter__info">Qloud ID is premierly based on passport ID which is accepted as an identification method for hotels in more than 32 countries</div>
...
<div class="newsletter__preview"><img class="some-icon" srcset="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-1@2x.png" src="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-1@2x.png" alt="Newsletter"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-1@2x.png" src="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-1@2x.png" alt="Newsletter"></div>
<div class="newsletter__preview"><img class="some-icon" srcset="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-1@2x.png" src="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-1@2x.png" alt="Newsletter"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-2@2x.png" src="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-2@2x.png" alt="Newsletter"></div>
<div class="newsletter__preview"><img class="some-icon" srcset="img/content/newsletter-pic-3@2x.png 2x" src="img/content/newsletter-pic-3.png" alt="Newsletter"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-3@2x.png" src="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-3@2x.png" alt="Newsletter"></div>
<div class="newsletter__preview"><img class="some-icon" srcset="img/content/newsletter-pic-4@2x.png 2x" src="img/content/newsletter-pic-4.png" alt="Newsletter"><img class="some-icon-dark" srcset="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-2@2x.png" src="https://ui8-fleet-html.herokuapp.com/img/content/newsletter-pic-dark-2@2x.png" alt="Newsletter"></div>
</div>
</div>
</div>

<div class="section-pd section-mb0" style="background: #2e415e;">
<div class="testimonials__center center js-tabs">
<div class="testimonials__container">
<div class="testimonials__item  " style="">
...
<div class="testimonials__item " style="display: none;">
<div class="testimonials__row">
<div class="testimonials__col">
<div class="testimonials__logo"><img src="https://ui8-fleet-html.herokuapp.com/img/content/velocity9.svg" alt="Logo"></div>
<div class="testimonials__comment">"Stacks is the cleanest design system I’ve used. It helps a lot of projects done without thinking. Nice Work!"</div>
<div class="testimonials__details">
<div class="testimonials__icon">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
<div class="testimonials__col">
<div class="testimonials__preview"><img srcset="https://ui8-fleet-html.herokuapp.com/img/content/testimonials-pic@2x.jpg 2x" src="https://ui8-fleet-html.herokuapp.com/img/content/testimonials-pic.jpg" alt="Testimonials">
<button class="play play_small">
<svg class="icon icon-play">
<use xlink:href="#icon-play"></use>
</svg>
...
<div class="testimonials__col hidden">
<div class="testimonials__preview"><img srcset="https://ui8-fleet-html.herokuapp.com/img/content/testimonials-pic@2x.jpg 2x" src="https://ui8-fleet-html.herokuapp.com/img/content/testimonials-pic.jpg" alt="Testimonials">
<button class="play play_small">
<svg class="icon icon-play">
<use xlink:href="#icon-play"></use>
...
<div class="testimonials__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-1.jpg" alt="Avatar"></div>
<div class="testimonials__group">
...
<div class="categories__head xs-padrl25 xs-tall" style="margin-bottom: 75px;  margin-top: 150px;">
<h2 class="categories__title h2 fsz60 xs-fsz45" >Appstore</h2>
<div class="categories__info info xs-fsz25 fsz30">Its also seamesly integrated with other smart software</div>
</div>
...
<div class="best__slider js-slider-best js-slider-resize">
<a class="best__item" href="host-profile.html" style="" aria-hidden="true" tabindex="0">
...
<div class="best__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-1.jpg" alt="Avatar">
...
<div class="best__location">Location</div></a><a class="best__item" href="host-profile.html" style="" aria-hidden="true" tabindex="0">
<div class="best__line">
...
<div class="best__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-2.jpg" alt="Avatar">
<div class="best__check">
<svg class="icon icon-check">
<use xlink:href="#icon-check"></use>
</svg>
...
<div class="best__subtitle">Name Name</div>
<div class="best__location">Location</div></a><a class="best__item" href="host-profile.html" style="" aria-hidden="true" tabindex="-1">
<div class="best__line">
...
<div class="best__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-3.jpg" alt="Avatar">
<div class="best__check">
<svg class="icon icon-check">
<use xlink:href="#icon-check"></use>
</svg>
...
<div class="best__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-4.jpg" alt="Avatar">
<div class="best__check">
<svg class="icon icon-check">
<use xlink:href="#icon-check"></use>
</svg>
...
<div class="best__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-5.jpg" alt="Avatar">
<div class="best__check">
<svg class="icon icon-check">
<use xlink:href="#icon-check"></use>
</svg>
...
<div class="best__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-6.jpg" alt="Avatar">
<div class="best__check">
<svg class="icon icon-check">
<use xlink:href="#icon-check"></use>
</svg>
...
<div class="best__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/places-pic-7.jpg" alt="Avatar">
<div class="best__check">
<svg class="icon icon-check">
<use xlink:href="#icon-check"></use>
</svg>
...
<div class="best__subtitle">Name Name</div>
<div class="best__location">Location</div></a></div>
</div>
</div>
</div>
</div>

<div class="section brands" style=" margin-top: 112px;">
<div class="brands__center center">
<div class="brands__wrap">
<div class="brands__list">
<div class="brands__item"><img src="https://ui8-fleet-html.herokuapp.com/img/content/rotashow.svg" alt="Brand"></div>
<div class="brands__item"><img src="https://ui8-fleet-html.herokuapp.com/img/content/waves.png" alt="Brand"></div>
<div class="brands__item"><img src="https://ui8-fleet-html.herokuapp.com/img/content/velocity9.svg" alt="Brand"></div>
<div class="brands__item"><img src="https://ui8-fleet-html.herokuapp.com/img/content/travelers.png" alt="Brand"></div>
<div class="brands__item"><img src="https://ui8-fleet-html.herokuapp.com/img/content/goldlines.svg" alt="Brand"></div>
<div class="brands__item"><img src="https://ui8-fleet-html.herokuapp.com/img/content/rotashow.svg" alt="Brand"></div>
</div>
</div>
</div>
