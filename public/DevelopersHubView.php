...
<button class="header__head js-header-head fsz16 hidden-xs changedText">+34 603 14 72 90</button>
...
<picture>
<source media="(max-width: 767px)" srcset="https://safeqloud-228cbc38a2be.herokuapp.com/html/usercontent/images/dstricts/bgimage4.jpeg"><img src="https://safeqloud-228cbc38a2be.herokuapp.com/html/usercontent/images/dstricts/bgimage4.jpeg" alt="Main" class="imageBorder">
</picture>
          ...
          <div class="main__center center">
            <div class="main__preview">
              ...
              <div class="main__wrap">
                <h1 class="main__title hero changedText">Ultimate Broker's Platform!</h1>
                <div class="main__info info changedText">Master Spanish Off-Plan Market</div><a class="button main__button changedText" href="#">Register Now for Free</a>
              </div>
            </div>
...
<form action="UserCompanySignUp/signUpEmailInfo/dllSSkw4cURDVW94V0o4RENKTVRmdz09" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1" autocomplete="off">
			
			<input type="hidden" name="user_signup_type" id="user_signup_type" value="3">
...
<div class="section work xs-padrl25 marb80i xs-marb25i" style=" ">
          <div class="work__center center" style="border-bottom:2px solid #ffffff; max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
            <div class="work__head tall hidden">
              <h2 class="work__title h2 uppercase changedText" style="font-size:80px;">Empowering Spanish developers by connecting them with global brokers to boost sales, optimize project management, and enhance profitability with cutting-edge tools. Our platform drives collaboration and innovation for greater success.</h2>
              <div class="work__info info changedText">At Developer Hub, our mission is to connect global brokers with Spanish developers, enhancing real estate transactions with innovative, efficient tools for success.</div>
            </div>
             </div>
        </div>
<div class="travel__center center   padb136 xs-padrl25" style="border-bottom:2px solid #23262F; max-width: 1132px;    padding-right: 0px;    padding-left: 0px;">
 ...
 <div class="travel__center center   padb136  xs-padrl25 mart80 xs-mart25i" style="border-bottom:2px solid #23262F;   max-width: 1132px;    padding-right: 0px; padding-left: 0px;">
  ...
  <div class="section work xs-padrl25 marb80i xs-marb25i"  >
    ...
    padding-left: 0px;">
            <div class="work__head tall hidden">
              ...
              <div class="work__info info changedText">Why Developers Join Dev Hub </div>
            </div>
             </div>
        </div>
  ...
  <div class="section work xs-padrl25 marb80i xs-marb25i"  >
    ...
    padding-left: 0px;">
            <div class="work__head tall hidden">
              ...
              <div class="work__info info changedText">Join our community today. Register now for free and start utilizing all the capabilities of DevHub to expand your business </div>
            </div>
             </div>
        </div>
