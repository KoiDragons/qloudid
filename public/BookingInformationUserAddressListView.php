	...
	<meta charset="utf-8">
		...
		<script>
		 function changeHeader()
			{
				window.location.href ="https://safeqloud-228cbc38a2be.herokuapp.com/public/index.php/BookingInformation/invoiceAddressesBusiness/<?php echo $data['checkout_id']; ?>";
			}
		 </script> 
			...
			<div class="top_menu frighti padt10 padb10" style="width:150px !important;">
				<ul class="menulist sf-menu  fsz16  sf-js-enabled sf-arrows">
					...
					<li style="margin-right:20px !important;" class="first last">
						<a href="javascript:void(0);" class="lgn_hight_s1 fsz25" onclick="changeDisplay1();"><span class="white_txt fas fa-globe"></span></a>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart60 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_70 xxs-lgn_hight_50 padb0 white_txt trn ffamily_avenir changedText">Invoice</h1>
									</div>
									<div class=" xxs-tall talc xs-padb20 padb35 ffamily_avenir"> <a href="#" class="txt_777E90 fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_30 changedText">Please select a invoice address</a></div>
									
									  <div class="tab-header martb10 padb10 xs-tall brdb2_3B71FE nobrdt nobrdl nobrdr talc">
									   <a href="#" class="dinlblck marni5 padrl30  xs-marl0  nobrd  bg_3B71FE brdrad40 xxs-brdrad10 lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active" >Personal</a>
                                            <a href="#" class="dinlblck mar5 padrl10  bg_94cffd_a brdrad40 xxs-brdrad10 lgn_hight_36 fsz16 txt_777E90 seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir " onclick="changeHeader();">Business</a>
									 ...
									 <a href="../updateUserAddress/<?php echo $data['checkout_id']; ?>/<?php echo $value['enc']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="bg_2F3C4F  bg_fffbcc_a brdrad5">
										<div class="container   padtb15   fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text   padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 white_txt changedText"><?php echo $value['invoice_address'].' '.$value['invoice_port_number']; ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  txt_777E90 changedText"><?php echo $value['invoice_zip'].' , '.$value['invoice_city']; ?></span> 
													<span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  txt_777E90 changedText"><?php echo $value['invoice_country']; ?></span>
													  </div>
