		...
		function submitform()
		{
		 ...
		 if($("#first_name").val()==null || $("#first_name").val()=="")
			...
			send_data.email=$("#email").val();	  
				 $.ajax({
							type:"POST",
							url:"../checkEmailInfo/<?php echo $data['invitation_id']; ?>",
							data:send_data,
							dataType:"text",
								 ...
								 else
								 {
									  var send_data={};
										...
										send_data.pass_country=$("#pcountry").val();	 
											 $.ajax({
														type:"POST",
														url:"../checkPhoneInfo/<?php echo $data['invitation_id']; ?>",
														data:send_data,
														dataType:"text",
														contentType: "application/x-www-form-urlencoded;charset=utf-8",
														success: function(data1){
															...
															send_data.pass_country=$("#pcountry").val();	 
																 $.ajax({
																			type:"POST",
																			url:"../checkPassportInfo/<?php echo $data['invitation_id']; ?>",
																			data:send_data,
																			dataType:"text",
																			contentType: "application/x-www-form-urlencoded;charset=utf-8",
																			success: function(data1){
...
<form class="checkout__item js-tabs-item" action="../updateGuestPassportDetails/<?php echo $data['invitation_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
...
<div class="checkout__line " >
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="first_name" id="first_name"     style="background:#23262F; color:grey;" />
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label" style="color:#787f91;">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="last_name" id="last_name" style="background:#23262F; color:grey;"   />
                            </div>
                          </div>
                        </div>
						...
						<div class="field">
                          ...
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="email" id="email" style="background:#23262F; color:grey;" fdprocessedid="b3ewp"   >
                          </div>
                        </div>
	...
	<?php foreach($countryCode as $category =>$value){ ?>													
															<option value="<?php echo $value['id']; ?>" <?php if($adultInvitationDetail['country_id']==$value['id']) echo 'selected'; ?>>+<?php echo $value['country_code']; ?></option>
														<?php } ?>
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="p_number" id="p_number" style="background:#23262F; color:grey;" fdprocessedid="cqhzif" value="<?php if($_POST['tenant_available']==1) echo $adultInvitationDetail['phone_number']; ?>" <?php if($_POST['tenant_available']==1) echo 'readonly'; ?>>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="checkout__fieldset">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="id_number" id="id_number" style="background:#23262F; color:grey;"  >
                            </div>
                          </div>
                        <div class="checkout__row margin-bottom32">
                          <div class="field">
