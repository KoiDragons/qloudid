	...
	<meta charset="utf-8">
		...
		<script>
			...
			function checkOtp()
			{
				...
				$.ajax({
					type:"POST",
					url:"../verifyPhoneOtp/<?php echo $data['id']; ?>",
					data:send_data,
					dataType:"text",
...
<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart20 xs-pad0 xs-mart0">
		...
		<form method="POST" action="../verifyPhoneDetails/<?php echo $data['id']; ?>" id="save_indexing_otp" name="save_indexing_otp" accept-charset="ISO-8859-1">
