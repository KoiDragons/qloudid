            ...
            <div class="product__head" style="display:none;">
			 ...
			 <div class="gallery imageBorder"  >
              <div class="  xs-maxheight390 " style="width:100%;">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view  xs-maxheight254" href="https://www.safeqloud.com/estorecss/tmp<?php echo str_replace(' ','%20',$getPropertyDetailInfo['imageId']); ?>.jpg" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="https://www.safeqloud.com/estorecss/tmp<?php echo str_replace(' ','%20',$getPropertyDetailInfo['imageId']); ?>.jpg" alt="Gallery"></a></div>
