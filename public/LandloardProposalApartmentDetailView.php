...
<a class="header__logo xs-fsz20 changedText" href="javascript:void(0);" style="
...
<a href="#" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
		...
		<div class="header__item header__item_notification js-header-item  visible-xs" >
            <button class="header__head js-header-head fsz16 " fdprocessedid="9xxkue">
<svg class="icon icon-globe" style="width: 30px;
    height: 30px;">
<use xlink:href="#icon-globe" style="
    fill:#777E90;
"></use>
...
<a class="header__login js-popup-open" href="#popup-login" data-effect="mfp-zoom-in" style="display:none; background:#f67f00;">
      ...
      <div class="outer__inner mart65 xxs-mart35 "  >
          ...
          <div class="product__center center">
            ...
            <div class="product__head" style="display:none;">
              <div class="product__box">
                <h2 class="product__title h2 changedText"><?php echo $getPropertyDetailInfo['selling_heading']; ?></h2>
                <div class="product__line">
                  ...
                  <div class="product__options">
                    ...
                    <div class="product__option">
                      ...
                      </svg><span class="changedText"><?php if($getLandloardBuildingDetails['street_address']!=null || $getLandloardBuildingDetails['street_address']!='') echo $getLandloardBuildingDetails['street_address'].','; if($getLandloardBuildingDetails['city']!=null || $getLandloardBuildingDetails['city']!='') echo $getLandloardBuildingDetails['city'];  ?></span>
                    </div>
                  </div>
                </div>
              </div>
			 ...
			 <div class="gallery imageBorder"  >
              <div class="  xs-maxheight390 " style="width:100%;">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view  xs-maxheight254" href="https://safeqloud-228cbc38a2be.herokuapp.com/estorecss/tmp<?php echo str_replace(' ','%20',$getPropertyDetailInfo['imageId']); ?>.jpg" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="https://safeqloud-228cbc38a2be.herokuapp.com/estorecss/tmp<?php echo str_replace(' ','%20',$getPropertyDetailInfo['imageId']); ?>.jpg" alt="Gallery"></a></div>
        ...
        <div class="section description">
          ...
          <div class="description__center center">
            <div class="description__wrapper">
              ...
              <h4 class="description__title h4 changedText"><?php echo $getPropertyDetailInfo['selling_heading']; ?></h4>
              <div class="description__profile product__rating"><svg class="icon icon-star">
                      <use xlink:href="#icon-star"></use>
                    </svg><span class="changedText"><?php echo substr($getLandloardBuildingDetails['company_name'],0,16); ?></span>
                ...
                <div class="description__name changedText changedText " style="margin-left:15px; color: #777E90; font-size:14px;"><svg class="icon icon-flag">
                      ...
                      </svg><?php if($getLandloardBuildingDetails['street_address']!=null || $getLandloardBuildingDetails['street_address']!='') echo $getLandloardBuildingDetails['street_address'].','; if($getLandloardBuildingDetails['city']!=null || $getLandloardBuildingDetails['city']!='') echo $getLandloardBuildingDetails['city'];  ?></div>
              </div>
              <div class="description__parameters">
                ...
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php echo $getPropertyDetailInfo['bedroom_count']; ?> bedrooms</span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php echo $getPropertyDetailInfo['bathroom_count']; ?> WC</span>
                </div>
              </div>
			...
			<div class="receipt" style="border: 1px solid #353945 !important; background:transparent;">
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old hidden">$<?php echo $getPropertyDetailInfo['sale_price']; ?></div>
                    <div class="receipt__actual">$<?php echo $getPropertyDetailInfo['sale_price']; ?></div>
              ...
              <div class="receipt__description receipt__description_flex" style="background:#23262F;">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Completion date</div>
                    <div class="receipt__subtitle changedText"><?php if($getLandloardBuildingDetails['building_completed']==2) echo date('M Y',$getLandloardBuildingDetails['expected_end_date']); else echo date('M Y',$getLandloardBuildingDetails['completion_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle changedText"><?php if($getLandloardBuildingDetails['building_type']==1) echo 'Purchase'; else  if($getLandloardBuildingDetails['building_type']==2) echo 'Rental'; else echo 'Shared'; ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Type of Property</div>
                    <div class="receipt__subtitle changedText">Apartment</div>
                  </div>
                </div>
              </div>
              <div class="receipt__btns">
                <button class="button-stroke receipt__button " fdprocessedid="ebxsyj"><span class="changedText">Save</span><span>
                    ...
                    <svg class="icon icon-check">
                      <use xlink:href="#icon-check"></use>
                    </svg></span></button><a class="button receipt__button" href="#" style="background:#F67F00; color:#000000;"><span  class="changedText">Reserve</span>
              ...
              <div class="receipt__table">
                <div class="receipt__line">
                  <div class="receipt__cell changedText">$119 x 7 days</div>
                  <div class="receipt__cell">$833</div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">10% campaign discount</div>
                  <div class="receipt__cell">$125</div>
                </div>
                <div class="receipt__line">
                  <div class="receipt__cell changedText">Cleaning fee</div>
                  <div class="receipt__cell">$10</div>
                </div>
				 <div class="receipt__line">
              ...
              <div class="receipt__foot">
                <button class="receipt__report" fdprocessedid="kflrz">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span  class="changedText">Report this property</span>
                </button>
              </div>
            </div>
