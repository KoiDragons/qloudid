...
<a class="header__logo xs-fsz20 " href="../brokers/V2l1eVdrVFdnKzZTQTgzRy96RXEzQT09" style="
...
<a class="header__link  " href="../selectSubscriptionSignup/V2l1eVdrVFdnKzZTQTgzRy96RXEzQT09" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Pricing</a>
...
<use xlink:href="#icon-home"></use>
					...
					<a class="header__link" href="../selectSubscriptionSignup/V2l1eVdrVFdnKzZTQTgzRy96RXEzQT09">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Pricing</a>
...
<div class="checkout__inner js-tabs wi_35 xs-wi_100" style="padding-right: 25px;">
...
<div class="categories__slider js-slider-categories slick-initialized slick-slider" style="padding-bottom:0px;">
			
							
									
															
									
<div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 0px; transform: translate3d(0px, 0px, 0px);"><a class="categories__item  black_bg slick-slide slick-current slick-active" href="#" style="padding: 20px; font-size: 14px; border-radius: 6px; width: 0px;" tabindex="0" data-slick-index="0" aria-hidden="false">

<div class="changedText categories__subtitle   txt_f67f00   ">Introduction</div>
</a></div></div></div>
</div>
</div>
</div>
<form action="../signUpEmailInfo/V2l1eVdrVFdnKzZTQTgzRy96RXEzQT09" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1" autocomplete="off">
	...
	<div class="checkout__line  hidden" style="margin-bottom:10px; margin-top:20px; padding-bottom:10px; border-bottom:1px solid #353945;">
					<div class="checkout__subtitle">199 euro </div>
...
<div class="categories__slider js-slider-categories slick-initialized slick-slider" style="padding-bottom:0px;">
							...
							<div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 0px; transform: translate3d(0px, 0px, 0px);"><a class="categories__item  black_bg   slick-slide slick-current slick-active" href="#" style="padding: 20px; font-size: 14px; border-radius: 6px; width: 0px;" data-slick-index="0" aria-hidden="false" tabindex="0">
...
</div><div class="checkout__inner js-tabs wi_35 xs-wi_100" style="padding-right: 25px;">
<div class="section categories  marl6 " style="margin-bottom: 0px; ">
<div class="categories__center center1 xsi-nobrdb xsi-padb0 hidden">
<div class="categories__inner">
...
<input class="field__input hidden" type="number" name="licence443" id="licence443" min="1" value="1" style="background:#131922; color:grey; border:none;" fdprocessedid="1qwb0h" readonly="" onfocusout="updateLicenceNumber(this.value,&quot;licence443&quot;,443);">
</div>
</div>
...
</div></div><bugherd-sidebar></bugherd-sidebar><textarea tab-index="-1" aria-hidden="true" style="letter-spacing:normal;line-height:22px;padding-top:4px;padding-bottom:4px;font-family:Inter, sans-serif;font-weight:400;font-size:14px;font-variant:normal;text-rendering:auto;text-transform:none;width:324px;text-indent:0px;padding-left:11px;padding-right:11px;border-width:1px;box-sizing:border-box;word-break:normal;white-space:pre-wrap;
