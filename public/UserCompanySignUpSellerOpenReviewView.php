...
//print_r($data); die;
	...
	if($brokerInformation ['passport_image']!=null) { $filename="../estorecss/".$brokerInformation ['passport_image'].".txt"; if (file_exists($filename)) { $value_a=file_get_contents("../estorecss/".$brokerInformation ['passport_image'].".txt"); $value_a=str_replace('"','',$value_a);  $imgs = base64_to_jpeg( $value_a, '../estorecss/tmp.jpg' );  $imgs='../../../'.$imgs; } else { $value_a="../../../../html/usercontent/images/default-profile-pic.jpg";  $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; } }  else {  $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; $value_a="../../../../html/usercontent/images/default-profile-pic.jpg"; }
...
<a class="header__logo xs-fsz20 changedText" href="https://gettxp.com/public/index.php/Unaoficina" style="
   ...
   padding-left: 20px;
   padding-right: 20px;
   "><?php echo substr($brokerInformation['company_name'],0,13); ?></a>
...
<div class="outer__inner">
  <div class="section travel mart50 xs-mar0i" style=" padding-bottom:136px;">
...
<div class="profile xs-nobrd " style="background: transparent;border:none; border-left: 1px solid #353945;border-radius: 0px;padding-top: 20px;">
    ...
    padding-top: 20px;
"><?php echo $brokerInformation['first_name'].' '.$brokerInformation['last_name']; ?></div>
                </div>
...
<div class="travel__subtitle fsz50 lgn_hight_55 xs-fsz40 xs-lgn_hight_45 xs-talc changedText" style="
    ...
    color: #fff;
    font-weight: 600;
">Dear Mr. <?php echo $propertyReservationDetail['buyer_first_name'] ?></div>
...
<a class="button main__button   talc     changedText" href="https://www.qloudid.com/public/index.php/UserCompanySignUp/sellerReviewInformation/<?php echo $data['verification_id']; ?>" style="
     background: #f67f00;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
...
<a class="button main__button xs-tall talc xs-fleft   changedText" href="https://www.qloudid.com/public/index.php/UserCompanySignUp/sellerReviewInformation/<?php echo $data['verification_id']; ?>" style="
     background: #f67f00;
     margin-top: 3px;
     /* margin-bottom: 55px; */
     color: black;
...
<div class="categories_info info   xs-tall  changedText" style="margin-top:5px;font-size: 58px;color: #ffffff;text-transform: uppercase;background: linear-gradient(to right, #ff7b48, #eedd44);
    ...
    -webkit-background-clip: text;">Leave a review
...
<a class="button main__button   tall   fleft  changedText" href="https://www.qloudid.com/public/index.php/UserCompanySignUp/sellerReviewInformation/<?php echo $data['verification_id']; ?>" style="
     background: #ffffff;
     margin-top: 40px;
     /* margin-bottom: 55px; */
     color: black;
