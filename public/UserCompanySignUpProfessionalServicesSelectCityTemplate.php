...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.minPannelTemplate.css">
...
<body class="dark" style="background-color:#131922;background-image: url(<?php echo str_replace(" ","%20", $selectedMarketplaceDetail['background_image']); ?>);background-size: cover;">
<?php } else { ?>
...
<div class="outer">
<!-- header-->
<div class="column_m     bs_bb trans_bg " style="height:93px;padding: 22px 0 22px !important;background: #00000033;">
...
<use xlink:href="#icon-globe" style="
    fill: #ffffff;
"></use>
</svg><h4 class="changedText" style="
    color: white;
">Language</h4>
</button>
...
<form action="../selectSubscriptionSignup/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing1" id="save_indexing1" accept-charset="ISO-8859-1" autocomplete="off">
	...
	<form action="../updateSelectedCity/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">
...
<div class="main__center center " style="    /* background: #00000070; */">
<div class="main__preview ">
			
			<div class="main__wrap">
<h1 class="main__title hero changedText" style="color: white;text-transform: uppercase;background: #00000070;padding: 20px 20px 160px 20px;border-radius: 24px;"><?php echo $selectedMarketplaceDetail['heading_info']; ?></h1>
<div class="main__info info changedText hidden" style="color: grey;font-size: 40px;/* background: #513412a6; */">Find your professional today</div>
</div>
</div>
<div class="panel panel_stays" style="
    max-width: 600px;
">
...
<div class="location js-location xs-wi_80">
...
<input class="location__input js-location-input changedText" type="text" name="city" id="city" autocomplete="off" placeholder="Location">
<div class="location__description changedText">Where are you from?</div>

</div>
<div class="location__body js-location-body">
<div class="location__list ">
				<?php echo $vitechCityList; ?></div></div>
</div>
</div>
