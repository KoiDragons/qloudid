			...
			send_data.email=$("#email").val();
					...
					$.ajax({
						...
						if(data1==0)
						{
							...
							$('.field__input').addClass('bg_F4F5F6');
						$(".field__input").removeAttr("readonly");
						}
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Pay/Verify</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Select payment option below to pay/verify
</h2>
...
<a href="../../../../../bookingInvoicePayment/<?php echo $data['checkout_id']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['job_id']; ?>/<?php echo $data['booked_from']; ?>/<?php echo $data['invoice_id']; ?>"><button class="checkout__edit"  >
...
<div class="checkout__category changedText">Your personal/card detail</div>
...
<div class="field"  >
<div class="field__label changedText" style="color:#525252;">Email address</div>
<div class="field__wrap">
<input class="field__input"  type="text" name="email" id="email"  style="background:#F4F5F6; height:60px; border:none; color:black;" onfocusout="checkEmailInfo(this.value);">
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">First name</div>
<div class="field__wrap">
<input class="field__input" name="fname" id="fname"    type="text"   style="background:#F4F5F6; height:60px; border:none; color:black;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#525252;">Last name</div>
<div class="field__wrap">
<input class="field__input"  name="lname" id="lname"    type="text"   style="background:#F4F5F6; height:60px; border:none; color:black;">
</div>
</div>
</div>
...
<div class="checkout__row" style="margin-bottom:32px;">
<div class="field">
<div class="field__label changedText" style="color:#525252;">Code</div>
<div class="field__wrap">
 
<select  class="   "  name="country" id="country" style="background:#F4F5F6; height:60px; border:none; 
    padding: 0 14px;  
...
<div class="field">
<div class="field__label changedText" style="color:#525252;">Mobile</div>
<div class="field__wrap">
<input class="field__input"  name="pnumber" id="pnumber"    type="text"   style="background:#F4F5F6; height:60px; border:none; color:black;" onfocusout="checkPhoneNumber(this.value);">
</div>
</div>
...
<div class="field__label changedText" style="color:#525252;">Card number</div>
<div class="field__wrap">
<input class="field__input" name="card_number" id="card_number"  readonly  type="text"   style="height:60px;">
</div>
</div>
...
<div class="checkout__row" style="margin-bottom:32px;">
 <div class="field">
<div class="field__label changedText" style="color:#525252;">Cvv</div>
<div class="field__wrap">
<input class="field__input"  name="cvv" id="cvv"    type="text"  readonly style="height:60px;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#525252;">Expiry date</div>
<div class="field__wrap">
<input class="field__input"  name="exp_date" id="exp_date"  min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" type="date" readonly  style="height:60px;"  >
</div>
</div>
