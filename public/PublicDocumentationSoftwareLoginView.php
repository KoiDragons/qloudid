        ...
        <div class="section faq">
          <div class="faq__center center">
            <div class="faq__top">
              ...
              <h1 class="faq__title h2">Login API</h1>
              <div class="faq__info" style="font-size:20px;">This is a documentation on how you can integrate your software to Qloud ID platform and generate digital ID for your domain</a></div>
            ...
            <div class="faq__row js-tabs">
              <div class="faq__col">
                <div class="faq__nav"><a class="faq__link js-tabs-link" href="#" style="font-size:18px;">
...
</li><li> As soon as access tokan is received on qmatchup side they need to send the same to https://www.safeqloud.com/walk/resource.php?login=1 using curl request</li>
...
<li>Data will be sent in json and if user have selected company he will receive data as : {"type":"login","first_name":"Ram","last_name":"kumar","email":"x@x.com",
"company_name":"company_name","company_email":"x@x.com","emp_uniq_code":"123"} </li>
<li class="last">If user have selected user profile they will receive: {"type":"login","first_name":"Ram","last_name":"kumar","email":"x@x.com","country_of_residence":"100"}</li>
