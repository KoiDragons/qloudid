	...
	<meta charset="utf-8">
		...
		<script type="text/javascript" src="<?php echo $path;?>html/usercontent/js/jquery.js"></script>
		 ...
		 function changeHeader()
			{
				window.location.href ="https://www.safeqloud.com/public/index.php/BookingInformation/invoiceAddressesUser/<?php echo $data['checkout_id']; ?>";
			}
		 </script>
				...
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
					 ...
					 <div class="tab-header martb10 padb10 xs-tall brdb2_3B71FE nobrdt nobrdl nobrdr talc">
                                            <a href="#" class="dinlblck marni5 xs-marl0 padrl10   bg_94cffd_a brdrad40 xxs-brdrad10 lgn_hight_36 fsz16 txt_777E90 seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir " onclick="changeHeader();">Personal</a>
                                            <a href="#" class="dinlblck mar5 padrl30  nobrd  bg_3B71FE brdrad40 xxs-brdrad10 lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active" >Business</a>
