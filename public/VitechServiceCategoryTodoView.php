...
<html>
	...
	<head>
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateCategoryServiceTodo/<?php echo $data['pid']; ?>",
							data:send_data,
							dataType:"text",
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../checkServices/<?php echo $data['pid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
							 ...
							 {
								$('#errorMsg').html('please select atlease one service to approve request'); 
							 }	 
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateCategoryServiceAllTodos/<?php echo $data['pid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		<div class="column_m header xs-hei_55p  bs_bb white_bg visible-xs">
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
                <div class="visible-xs visible-sm fleft padrl0">
						 ...
						 <a href="../listProperties/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="clear"></div>
								 	...
								 	<div id="amenities_info">
										...
										<div class="clear"></div>
										<div class="red_txt fsz16" id="errorMsg"></div>
										<form action="../approveProperty/<?php echo $data['pid']; ?>" method="POST" name="save_indexing" id="save_indexing" >
										</form>
					  <div class="padt20 talc padb50">
								
								<a href="#" onclick="checkServices();">
								<button type="button" name="forward" class="xs-white_bg   bold forword minhei_55p white_txt bg_c12219 brdrad50 fsz16 xs-fsz16 xs-nobold padrl70 xs-padrl50 xs-minhei_65p nobold" style="border-radius: 50px;" fdprocessedid="wotga"><font style="vertical-align: inherit; "><font style="vertical-align: inherit;" class="changedText">Accept property</font></font></button></a>
									</div>
