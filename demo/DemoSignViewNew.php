        ...
        <div class="header__center center"><a class="header__logo" href="https://www.qloudid.com/public/index.php/CorporateServicesEng" ><button class="button button-stroke button-small header__button" style="border-color:#ff0000; background-color:#ff0000; box-shadow: 0 0 0 2px #ff0000 inset; font-size:18px; min-width: 5em !important;">Close</button></a>
          <div class="header__wrapper js-header-wrapper">
            <div class="header__item header__item_dropdown js-header-item">
              <button class="header__head js-header-head" style="color:#000000; font-size:20px;">This is a demo for how to sign an agreement using Qloud ID
...
<div class="main__info info margin-bottom16 white_txt" >Then type your security code for verification.</div>
        ...
        <div class="section description" style="margin-top:80px;" id="loginBank">
          <div class="description__center center">
            <div class="description__wrapper">
              <h4 class="description__title h4 fsz45">Car rental agreement</h4>
		   ...
		   <div class="receipt xs-margin0" >
              ...
              <div class="receipt__head hidden-xs" style="padding:0px; display:block; text-align:center; margin-top:10px;">
                <div class="receipt__details">
                 <div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/signin/1" class="white_brd brdrad5"  style="width:235px; height:235px; "></div>
                </div>
              ...
              <div class="receipt__description talc">
                <div class="receipt__item talc" style="justify-content: center;">
                  ...
                  <div class="receipt__box">
                     <div class="receipt__subtitle">Sign the agreement with Qloud ID</div>
                  </div>
                </div>
              </div>
               <div class="receipt__foot">
				...
				<a class="button receipt__button visible-xs  hidden" href="QloudidUrl://<?php echo $verifyIP; ?>/signin/1" id="iOS"><span>Rent this car</span>
                  <svg class="icon icon-bag">
                    <use xlink:href="#icon-bag"></use>
                  </svg></a>
				  
				  <a class="button receipt__button visible-xs  hidden" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/signin/1" id="android"><span>Rent this car</span>
                  <svg class="icon icon-bag">
                    <use xlink:href="#icon-bag"></use>
                  </svg></a>
              </div>
