...
<head>
<meta charset="utf-8">
<link rel="shortcut icon" type="image/x-icon" href="html/usercss/images/favicon.ico">
<link rel="stylesheet" type="text/css" media="all" href="html/usercss/css/style.css">
<link href="html/usercss/css/jquery-ui-1.10.4.custom.css" rel="stylesheet" media="all">
<title>Qmatchup</title>
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-53bd49126e888a20"></script>
...
<div class="column_m header blue_bg">
  <div class="wrap">
    <div class="logo padt10"><a href="index.php"><img src="html/usercss/images/qmatchup_logo.png" alt="Qmatchup" title="Qmatchup" /></a></div>
   <!-- <div class="usermenu">
      <ul>
        <li class="right"><a href="#">SIGN IN</a></li>
        <li class="right"><a href="#">Explorer our services</a></li>
      </ul>
    </div>-->
    <div class="clear"></div>
  </div>
...
<div class="column_m container">
  <div class="wrap white_bg talc">
    <div class="pad30">
    <div class="padt30">
    <img src="html/usercss/images/shake-hand.jpg" width="300" height="212" alt="Verified" title="Verified" />
    </div>
    <h1 class="fsz44 padb5">Thanks for Registring your Organization</h1>
    
    <div class="line"></div>
    <div class="padt30 talc"><!-- Go to www.addthis.com/dashboard to customize your tools -->
<div class="addthis_native_toolbox center_bx wi_50"></div></div>
    </div>    
    <div class="clear"></div>
  </div>
</div>
...
<script type="text/javascript" src="html/usercss/js/jquery-ui.min.js"></script> 
<script type="text/javascript" src="html/usercss/js/superfish.js"></script> 
<script type="text/javascript" src="html/usercss/js/icheck.js"></script> 
<script type="text/javascript" src="html/usercss/js/jquery.countdown.js"></script> 
<script type="text/javascript" src="html/usercss/js/jquery.selectric.min.js"></script> 
<script type="text/javascript" src="html/usercss/js/jquery.cycle.lite.js"></script> 
