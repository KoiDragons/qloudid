				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40  xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45  padb10 black_txt trn">Identify</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Please add your social security number.</a></div>
									...
									<div class="on_clmn mart10 xxs-mart10 marb35">
										...
										<div class="pos_rel">
													<select id="ccountry" name="ccountry"  class="wi_100 minhei_65p fsz18 fsz18 nobrdt nobrdl nobrdr llgrey_txt brdb  xxs-minhei_60p trans_bg nobold tall padl0 ffamily_avenir"  style="text-align-last:center;" disabled>
														...
														<?php  foreach($resultContry as $category => $value) 
																...
																<option value="<?php echo $value['id']; ?>" <?php if($value['id']==$row_summary['country_of_residence']) echo 'Selected'; ?> class="lgtgrey2_bg" disabled><?php echo $value['country_name']; ?></option>
															<?php 	}	?>
										...
										<div class="pos_rel">
										<input type="text" name="ssn"  placeholder="Personnummer " id="ssn"  class="txtind10 fsz18 nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828   wi_100 trans_bg required minhei_65p xxs-minhei_60p  talc  ffamily_avenir">
									</div>
									</div>
									</div>
							...
							<div class="padtb20 xxs-talc talc">
								...
								<button type="button" name="forward" class="forword minhei_55p t_67cff7_bg fsz18 ffamily_avenir" onclick="informEmployee();">Registrera</button>
