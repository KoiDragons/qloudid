...
<div class="column_m header  bs_bb white_bg">
		...
		<div class="fright xs-dnone sm-dnone padt10 padb10">
					...
					<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue"> <a href="#" class="translate hei_30pi dblock padrl20 blue_bg uppercase lgn_hight_30 white_txt white_txt_h" data-en="Start" data-sw="Start">Start</a> </li>
						<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue"> <a href="SamtyckesPlattform"  class="translate hei_30pi dblock padrl20 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Samtycke" data-sw="Samtycke">Samtycke</a> </li>
						<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue"> <a href="Appstore" class="translate hei_30pi dblock padrl20 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Appstore" data-sw="Appstore">Appstore</a> </li>
						<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue"> <a href="https://www.qloudid.com/user/index.php/CorporateServices" id="usermenu_singin" class="translate hei_30pi dblock padrl20 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Logga In" data-sw="För företag">Företag</a> </li>
						...
						<li class="dblock hidden-xs hidden-sm fright pos_rel  brdclr_dblue marl20"> <a href="https://www.qloudid.com/user/index.php/LoginAccount" id="usermenu_singin" class="translate hei_30pi dblock padrl20 blue_bg_h uppercase lgn_hight_30 black_txt  white_txt_h  brdl" data-en="Logga In" data-sw="Logga In">Logga IN</a> </li>
					</ul>
				</div>
	...
	<div class="clear"></div>
		...
		<!-- NEW BANNER -->
				<div class="dflex xs-dblock justc_fe pos_rel padt80 padb20 xs-pad0 ">
			<div class="wi_100 hei_100 pos_abs xs-pos_sta zi1 top0 left0 bgir_norep bgip_c bgis_cov" style="background-image: url(../../html/usercontent/images/Tryout6.png);">
					<img src="<?php echo $path; ?>html/usercontent/images/Tryout6.png" class="wi_100 hei_auto hide xs-dblock">
				</div>
				<div class="wi_33 xs-wi_100 pos_rel zi5 white_txt">
					
					<div class="pos_rel padr30 xs-padrl20 xs-darkgrey_txt">
						<div class="wi_100 hei_100 xs-dnone opa60 pos_abs zi1 top0 left0 "></div>
						<div class=" maxwi_600p pos_rel zi5">
							<h2 class=" mar0 padt80 bold fsz30 xs-fsz22 black_txt xs-darkgrey_txt uppercase brdb_b">TA KONTROLL ÖVER DIN DIGITALA IDENTITET </h2>
							<ul class="mar0 marb20 padt30 lipos_in  fsz25 xs-fsz15">
								<li class="marb10  black_txt nobold">
									<span class="marl-15 black_txt">Du äger din information</span>
								</li>
								<li class="marb10 pad0 black_txt nobold">
									<span class="marl-15">Du väljer om du vill dela</span>
								</li>
								<li class="marb10 pad0 black_txt nobold">
									<span class="marl-15">Du kräver äkta identiteter</span>
								</li>
								<li class="marb10 pad0 black_txt nobold">
									<span class="marl-15">Du identifierar dig själv</span>
								</li>
								<!--<li class="marb10 pad0">
									<span class="marl-15">Bonus - find out</span>
								</li>-->
							</ul>
							<a href="#" class="minhei_50p dflex justc_c alit_c opa90_h marb10 brdrad3 blue_bg  bold fsz18 xs-fsz16 white_txt trans_all2">Become a Trusteed "Qloud ID User Today"</a>
							<div class="marb10 talc fsz15 black_txt">
			...
			<div class="martb15 padrl10">
					<div class="wrap maxwi_100 dflex fxwrap_w justc_c alit_c ">
					<div class="padrl20 fsz20">
							Vad kan vi hjälper  <a href="#" class="diblock mart15 txt_941900">dig med?</a>
						</div>
						<a href="#" class="diblock  padtb15 padrl20 brd brdwi_2 brdclr_941900 brdrad3 bg_941900 white_bg_h talc fsz20 white_txt txt_941900_h">Fått en inbjudan</a>
						<div class="padrl20 ">
							<a href="#" class="diblock padtb15 padrl20 brd brdwi_2 brdclr_941900 brdrad3 bg_941900 white_bg_h talc fsz20 white_txt txt_941900_h">Ingen inbjudan</a>
						</div>
					</div>
				</div>
					...
					<div class="wrap maxwi_100 padtb30 brdb_new">
						<div class="dflex xs-fxwrap_w alit_c">
							<div class="xs-wi_100 flex_1 xs-talc">
								...
								<p>När mer och mer av din praktiska vardag blir digital, måste du också garantera att du har makten. Du skulle aldrig skrika ut din mest personliga information på en öppen gata, men har du koll på att ingen kommer åt den när du publicerar den på nätet?</p>
								<p>Med ditt Qloud ID, kan kontrollera vad som händer med din data. Du bestämmer till vem du vill dela med dig av din information och du kan när du vill frånta någon rätt till att få tillgång till din information.Du äger dina uppgifter. </p>
							</div>
...
<h4 class="bold fsz18 padt10">Med hela företaget</h4>
			...
			<div class="column_m martb30 xs-padtb10 talc lgn_hight_22 fsz16 white_bg ">
					<div class="wrap maxwi_100 padrl10">
					<div class="dflex xs-fxwrap_w alit_c tall brdb_b">
					<div class="xs-wi_100 flex_1 xs-talc">
						<div class="padb10 fsz20">
							...
							<div class="dflex fxwrap_w alit_s marrl-10 " id="more_boxes">
											...
											<div class="keep-block pos_rel marb20 brdrad2 bg_f trans_bgc1 bxsh_0_trans_0_trans_02150_0_3_ph opbxsh_0004_6f_sibc brdrad2 trans_bxsh1" id="keep-1" data-desktop-settings="{&quot;images&quot;: [&quot;show&quot;]}" data-modal-settings="{&quot;images&quot;: [&quot;show&quot;, &quot;remove&quot;], &quot;list&quot;: [&quot;select&quot;, &quot;remove&quot;]}">
												...
												<a href="#" class="keep-pin dblock pos_abs zi5 top4p right4p pad5">
													<img src="<?php echo $path; ?>html/keepcss/images/icons/newpin.svg" width="80" height="38" class="dblock dnone_pa " alt="Pin note">
													<img src="<?php echo $path; ?>html/keepcss/images/icons/newpin.svg" width="80" height="38" class="dnone dblock_pa" alt="Unpin note">
