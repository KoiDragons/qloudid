		...
		<div class="usermenu">
					<ul>
						<li class="right hei_30p">
							<a href="CreateAccount" class="translate orange_btn bold xs-padrl10i hei_30p " id="usermenu_singin" data-en="Sign Up" data-sw="Sign Up">Sign Up</a>
						</li>
					</ul>
				</div>
				<div class="clear"></div>
			
			<div class="visible-xs visible-sm fright marr10 padr10 brdr brdwi_3"> <a href="https://www.safeqloud.com/user/index.php/CreateAccount" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Login</a> </div>
				<div class="clear"></div>
	...
	<div class="column_m mart0 padtb30 fsz14">
		<div class="wrap maxwi_100">
			...
			<div class="container marb30 padrbl15">
				<div class="grey_bg">
					<div class="dblue_bg wi_66 hei_10p"></div>
				</div>
			</div>
			
			<div class="container padrl15">
				<h1 class="marb10 talc fsz46 xs-fsz32">Nice to have you onboard.</h1>
				<h3 class="marb10 talc fsz26 xs-fsz20">Please check your email for activating your account</h3>
				<div class="marb30 talc">
					<a href="#">2015 Qloud ID</a>
				</div>
			</div>
		</div>
	</div>
