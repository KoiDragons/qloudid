		...
		<div class="column_m pos_rel">
			...
			<div class="column_m container zi5 mart40">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
										...
										<div class="dflex alit_c">
											<div class="flex_1">
												...
												<div class="fsz16 dgrey_txt bold">
													<span class="marr5 valm">Upgrade </span>
											...
											<ul class="mar0 pad0 padt10 fsz14">
												<li class="dflex mart10 brdb padb5">
													<div class="wi_50 ovfl_hid ws_now txtovfl_el">
														<a href="#"><?php if($verificationId==1) echo "A"; else if($verificationId==2) echo "AA"; else if($verificationId==3) echo "AAA"; ?> </a>
													</div>
					...
					<form method="POST" action="../updateGrading/<?php echo $data['uid']; ?>" id="save_indexing" name="save_indexing" >
