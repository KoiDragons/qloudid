...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
		...
		<!-- FORGOT PASS FORM -->
		<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginPhone" onclick="checkFlag();" >
...
<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart20 xs-pad0 xs-mart0">
			...
			<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz80 xxs-fsz45  padb10  black_txt trn ffamily_avenir">Wrong</h1>
									</div>
									<div class="mart10 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" > We did not find your account. Please try again,</a></div>
				...
				<div class="pos_rel">
									<input type="text"  name="fpass" id="fpass" placeholder="Email" class="wi_100 rbrdr pad10 mart5 brdb talc  minhei_65p fsz18 llgrey_txt" /> </div>
									<div class="clear"></div>
								</div>
							...
							<div class="talc  padtb20"><a href="#" onclick="verifyemail();"><input type="button" value="Submit" class="forword minhei_55p t_67cff7_bg fsz18 ffamily_avenir"  /></a>
