...
<div class="marrl0 wi_500p maxwi_100 dflex xs-fxwrap_w talc padt20 padb20   xs-padb0">
						...
						<p class="fsz14  padt5 grey_new_txt">Rehab</p>
						</div>
	 		...
	 		<a href="https://www.safeqloud.com/user/index.php/DayCareRequest/childInformation/<?php echo $data['did']; ?>" class="hidden-xs"><p class="lgn_hight_16 padtb20 talc fsz20   padb0 marb20 xs-padb5 black_txt ">Edit details</p></a>
						</div>
