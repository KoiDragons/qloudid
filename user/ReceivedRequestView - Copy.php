			...
			<div class="  fleft padrl0 hidden">
				...
				<ul class="menulist sf-menu  fsz16   sf-js-enabled sf-arrows wi_100">
					<li class="padr10 first last wi_100 talc">
						<a href="<?php  if(empty($helpAidInfo)) { echo 'CoronaHelp/registerYourself'; } else { if($helpAidInfo['is_active']==0) { echo 'CoronaHelp/activateUser'; }	 else if ($helpAidInfo['is_active']==1) { if($helpAidInfo['is_volunteer']==2) {    if($peopleInNeed>0) { echo 'CoronaHelp/listPeople'; } else if($itemListDelivereyCount['num']>0) {	echo 'CoronaHelp/listItemsDetailVolunteers'; } else echo 'CoronaHelp'; } else {   if($itemListDelivereyCount['num']>0) { echo 'CoronaHelp/listItemsDetailVolunteers'; } else { echo 'CoronaHelp/listItemsDetailRequired'; } } } }?>"><span class="white_txt pred_txt_h ffamily_avenir">Corona app - Get help or help others
		...
		<div class="column_m pos_rel">
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="tab-header mart10 padb10 xs-talc brdb_black nobrdt nobrdl nobrdr talc">
                                            ...
                                            <a href="Dependents/approvedDependents" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Private</a>
                                              <a href="#" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Your children</a>
										...
										<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
											...
											<div class="column_m container  marb0   fsz14 dark_grey_txt">	
											<a href="CoronaHelp">	<div class=" white_bg  mart0 brdb bg_fffbcc_a" style="">
										<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
										...
										<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
											...
											<div class="column_m container  marb0   fsz14 dark_grey_txt">	
											<a href="CoronaHelp/listItemsDetailRequired">	<div class=" white_bg  mart0 brdb bg_fffbcc_a" style="">
										<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_60 xxs-wi_75  xs-mar0 ">
													<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18 bold  black_txt">Corona Care</span>
													
													 <span class="edit-text  fsz14 jain2 dblock  lgn_hight_18 ">Help or ask for help during crisis</span>  
													</div>
