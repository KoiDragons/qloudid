...
function submitform()
			{
				$("#error_msg_form").html('');
				if($("#clear_number").val()=="" ||  $("#clear_number").val()==null ||  $("#clear_number").val()=='-')
				{
					 
					$("#error_msg_form").html('Please enter Clearing Number');
					return false;
				}
				if($("#clear_number").val()!=$("#oclear_number").val())
				{
					 
					$("#cn").val(1);
				} 
				if($("#bank_acc").val()=="" ||  $("#bank_acc").val()==null ||  $("#bank_acc").val()=='-')
				{
					 
					$("#error_msg_form").html('Please enter bank account Number');
					return false;
				}
				if($("#bank_acc").val()!=$("#obank_acc").val())
				{
					 
					$("#bc").val(1);
				} 
				if($("#langu").val()=="" ||  $("#langu").val()==null ||  $("#langu").val()=='-')
				{
					 
					$("#error_msg_form").html('Please enter bank name');
					return false;
				}
				if($("#langu").val()!=$("#olangu").val())
				{
...
<form class="checkout__item js-tabs-item" action="saveUserBankUpdate" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="field__label changedText" style="color:#787f91;">Name of the bank</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="langu" id="langu" value="<?php if($resultOrg1['language']!="" || $resultOrg1['language']!= null) { if($resultOrg1['language']!= '-') echo $resultOrg1['language']; else echo ''; }else echo "";  ?>"  placeholder="e. g. xyz"  type="text"   style=" color:grey; ">
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Clearing number</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="clear_number" id="clear_number" value="<?php if($resultOrg1['clearing_number']!="" || $resultOrg1['clearing_number']!= null ) { if($resultOrg1['clearing_number']!= '-') echo $resultOrg1['clearing_number']; else echo ''; }  else echo "";  ?>"   placeholder="e. g. xyz"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
<div class="upload__col upload__col_w50">
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="bank_acc" id="bank_acc"  value="<?php  if($resultOrg1['bank_account_number']!="" || $resultOrg1['bank_account_number']!= null ) { if($resultOrg1['bank_account_number']!= '-') echo $resultOrg1['bank_account_number']; else echo ''; }   else echo ""; ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
