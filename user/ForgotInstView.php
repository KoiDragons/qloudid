...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
								...
								<img src="https://i.gifer.com/PWF.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir" >Sent</h1>
									</div>
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >We have sent instructions on how to reset your password to your e-mail address.</a></br>
									
									</div>
									 
								  
							 	<div class="talc  padtb20"><a href="../../../ForgotInst/forgotInstAccount/<?php echo $data['email'];?>/<?php echo $data['rand_hash'];?>" ><input type="button" value="Resend" class="forword minhei_55p t_67cff7_bg fsz18 ffamily_avenir"  /></a>
		...
		<div id="popup_fade" class="opa0 opa55_a black_bg"></div>
				...
				<!-- LOGIN FORM -->
				<div class="column_m marb30 mart40 xs-padtb10 talc lgn_hight_22 fsz16 xs-marb0 hidden" id="loginBank1"  onclick="checkFlag();">
				<div class="padrl10 white_bg xs-padrl25">
					<div class="wrap maxwi_100   xs-nobrdb xs-padt15 xs-padb0  xs-mart0">
							...
							<div class="wi_500p maxwi_100  pos_rel zi5 marrla pad30  xs-pad0  ">
								...
								<h1 class="marb0  xxs-talc talc fsz35 xs-fsz25 bold marb5 black_txt trn" >Skickat</h1>
									<div class="padb20 padt10 xxs-talc talc"> <a href="#" class="black_txt fsz20 xs-fsz20 xxs-talc talc edit-text jain_drop_company trn " >Vi har skickat instruktion om återställning av ditt lösenord till din e-post adress.</a>
								</div>
					<div class="container padrl15 xs-padrl0">
							<div class="marrla xs-wi_100">
							
							<div class="talc  padt20"><a href="../../../ForgotInst/forgotInstAccount/<?php echo $data['email'];?>/<?php echo $data['rand_hash'];?>" ><input type="button" value="Skicka om" class="forword button_bg_color minhei_55p"  /></a>
										<input type="hidden" name="login" >
