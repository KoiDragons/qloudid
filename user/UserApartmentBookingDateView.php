...
<html>
	...
	<head>
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../getSidebar/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../getNewCalander/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		var send_data={};
				...
				send_data.updateValue=id;  
				 $.ajax({
							type:"POST",
							url:"../updateNextCalender/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateSelectedCancle/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateSelectedBlock/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateCalenderSelection()
		{
		 ...
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../getRange/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
							...
							$.ajax({
							type:"POST",
							url:"../getRangeCalander/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
