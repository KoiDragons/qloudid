									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class="dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Company Admins</span><span class="counter_position"><?php echo $adminRequestCount['num']; ?></span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="column_m container tab-header  talc dark_grey_txt mart5">
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey_bg">
									...
									<li>
										<a href="#" class="dblock brdradt5 " data-id="tab_total1">
											<span class="count black_txt"><?php echo $adminRequestCount['num']; ?></span>
											<span class="black_txt trn fsz16" >Admin requests</span>
										</a>
									</li>
									<li>
								...
								<select class="tab-header xs-wi_100 maxwi_100 dnone xs-dblock hei_70p pad0 nobrd brdb_new xs-fsz30 pblue2_bg">
									<option value="tab_total" selected class="xs-fsz20"><?php echo $plateCount['num']; ?></option>
									<option value="tab_total1"  class="xs-fsz20">Admin requests</option>
							...
							<div class="tab-content padb25 padt5" id="tab_total1" >
										...
										<tbody id='allAdminRequest'>
											<?php $i=0;
												...
												<tr class="fsz16 xs-fsz16">
													...
													<td class="pad5 brdb_new talr">
														<a href="../approveRequest/<?php echo $value['enc']; ?>/<?php echo $data['cid']; ?>"><div class="padtb5">
															Approve
														</div></a>
													</td>
													<td class="pad5 brdb_new talr">
														<a href="../rejectRequest/<?php echo $value['enc']; ?>/<?php echo $data['cid']; ?>"><div class="padtb5">
															Reject
														</div></a>
													</td>
												</tr>
									...
									<div class="padt20 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" onclick="add_more_request(this);">View More</a>
