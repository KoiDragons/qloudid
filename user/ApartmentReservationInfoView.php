<html class="home"><head>
 ...
 function submitform()
 {
			if($("#guest_adults").val()==0) 
				{
					$("#error_msg_form").html('Minimum one adult required');
					return false;
				}
				if(isNaN($("#guest_adults").val())) 
				{
					$("#error_msg_form").html('Adult guest must be a numeric value');
					return false;
				}
				if(isNaN($("#guest_children").val())) 
				{
					$("#error_msg_form").html('Children guest must be a numeric value');
					return false;
				}
				
				if($("#room_price").val()==0 || $("#room_price").val()=='' || $("#room_price").val()==null) 
				{
					$("#error_msg_form").html('Please enter price per night');
					return false;
				}
				
				if(isNaN($("#room_price").val())) 
				{
					$("#error_msg_form").html('Price per night must be a numeric value');
					return false;
				}
				
				var send_data={};
				 send_data.start_date=$('#checkin_date').val();
				 send_data.end_date=$('#checkout_date').val();
				 $.ajax({
							type:"POST",
							url:"../checkAvailablityDates/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							...
							success: function(data1){
								...
								if(data1==1)
								{
								$("#error_msg_form").html('Please select diffrent dates');
								return false;	
								}
								else if(data1==2)
								{
								$("#error_msg_form").html('End date must be greater then start date');
								return false;	
								}
								else
								{
				...
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
					 <div class="padb0 xxs-padb0 ">		
							...
							<form action="../guestInformation/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									...
									<div class="thr_clmn  wi_50 padr10">
										...
										<div class="pos_rel talc">
												...
												<input type="date" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" name="checkin_date" id="checkin_date" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" style="height: 65px !important;"> 
												<label for="checkin_date" class="floating__label tall nobold padl10" data-content="Check-in date">
											<span class="hidden--visually">
											 Check-in date</span></label> 
										...
										<div class="pos_rel talc">
												...
												<input type="date" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" name="checkout_date" id="checkout_date" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" style="height: 65px !important;"> 
												<label for="checkout_date" class="floating__label tall nobold padl10" data-content="Check-out date">
											<span class="hidden--visually">
									...
									<div class="thr_clmn  wi_50 padr10">
										...
										<div class="pos_rel talc">
												...
												<input type="number" value="1" min="1" name="guest_adults" id="guest_adults" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"> 
												<label for="guest_adults" class="floating__label tall nobold padl10" data-content="Adults">
											<span class="hidden--visually">
											 A</span></label> 
										...
										<div class="pos_rel talc">
												...
												<input type="number" value="0" min="0" name="guest_children" id="guest_children" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"> 
												<label for="guest_children" class="floating__label tall nobold padl10" data-content="Children">
											<span class="hidden--visually">
											 Check-out date</span></label> 
									...
									<div class="thr_clmn  wi_50 padr10">
										...
										<div class="pos_rel talc">
											...
											<select name="is_paid" id="is_paid" class="light_grey_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz18 black_txt ffamily_avenir floating__input padt25 wi_100"  fdprocessedid="p73uye" style="height: 65px !important;"> 
											...
											<option value="3" class="lgtgrey2_bg">Not paid</option>		 
												...
												<label for="is_paid" class="floating__label tall nobold padl10" data-content="Paid">
											<span class="hidden--visually">
											 A</span></label> 
										...
										<div class="pos_rel talc">
												...
												<input type="number" value="0" min="0" name="room_price" id="room_price" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"> 
												<label for="room_price" class="floating__label tall nobold padl10" data-content="Price per night">
											<span class="hidden--visually">
											 Price per night</span></label> 
