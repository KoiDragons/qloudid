...
"toolbar=0,menubar=0,width=900,height=280,top=0,left=0,scrollbars=1,resizable=yes" ,"_blank");
	...
	<form action="loginAppThanks" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
        ...
        <div class="section description" style="margin-top:80px;" id="loginBank">
          <div class="description__center center">
            <div class="description__wrapper">
              <h4 class="description__title h4 fsz45">Identify yourself</h4>
		   ...
		   <div class="receipt xs-margin0" >
              ...
              <div class="receipt__head hidden-xs" style="padding:0px; display:block; text-align:center; margin-top:10px;">
                <div class="receipt__details">
                 <div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>" class="white_brd brdrad5"  style="width:235px; height:235px; "></div>
                </div>
              ...
              <div class="receipt__description talc">
                <div class="receipt__item talc" style="justify-content: center;">
                  ...
                  <div class="receipt__box">
                     <div class="receipt__subtitle">Login using Qloud ID</div>
                  </div>
                </div>
              </div>
