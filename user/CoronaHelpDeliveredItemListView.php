...
<html>
	...
	<head>
		<meta charset="utf-8">
		<!--<meta http-equiv="refresh" content="10;https://www.safeqloud.com/user/index.php/CoronaHelp/listItemsDelivered/<?php echo $data['eid']; ?>" />-->
...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
 ...
 <!-- CONTENT -->
	...
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  padrl30">
								<div class="padb40 talc fsz45"><i class="fas fa-truck txt_07794a"></i></div>
			<div class="padb0 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 txt_07794a trn ffamily_avenir">Delivered</h1>
									</div>
									<div class="mart20 marb10  xxs-talc talc ffamily_avenir"> <a href="#" class="txt_07794a fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">List of deliveries to...</a></div>
                                ...
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_blue1 red_ff2828_brdclr talc visible-xs">
                                            <a href="../listItemsRequired/<?php echo $data['eid']; ?>" class="dinlblck mar5 padrl30 xs-padrl10  brd tb_67cff7_bg_h tb_67cff7_bg_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz16 black_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir"  >Items</a>
                                        ...
                                        <div class="tab_container mart10">
											...
											<?php $i=0;
												...
												foreach($itemListDelivered as $category => $value) 
												{
										...
										<div class="container padrl10 padb20 padt15    brdrad1 fsz18 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padl0 fsz12">
													...
													<div class="hidden">
													<a href="../markUndelivered/<?php echo $value['enc']; ?>/<?php echo $data['eid']; ?>"><div class="fright wi_10 padl0  marl15 fsz40  xs-marl0 xxs-marr20 padb0  hidden">
