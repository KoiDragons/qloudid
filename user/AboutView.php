						...
						<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75">
							<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03 padt5 white_bg fsz14 brdr_new" id="scroll_menu">
													...
													<div class="sidebar_prdt_bx marr20 brdb_b padb20">
														<div class="white_bg tall">
															...
															<!-- Logo -->
																	 ...
																	 <div class="pad20 wi_100  xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz95 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg" style="
																	background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 2%;
																	" id="aa_1227620"> <?php echo substr(html_entity_decode($companySummary['company_name']),0,1); ?> </div> 																<a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
																<!-- Meta -->
																<div class="padtr10 fsz15"> <span><?php echo substr(html_entity_decode($companySummary['company_name']),0,20); ?>, <?php echo $companySummary['country_name']; ?></span>  </div>
															</a></div>
													</div>		
													<div class="clear"></div>
												</div>
								...
								<ul class="marr20 pad0">
									...
									<li class="dblock padrb10 padl8">
												<a href="#" data-id="scroll-section-1" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pred2_h brdclr_pred2_a pred2_bg_h pred2_bg_a black_txt white_txt_h white_txt_a"> <span class="valm trn">Om oss</span>
					...
					<!-- Center content -->
						...
						<div class="wrap maxwi_100 dflex alit_fe justc_sb  pos_rel padb10 brdb_new">
							<div class="white_bg tall">
								...
								<a href="https://www.qmatchup.com/beta/user/index.php/CheckLogin/checkCredentialsLogin?url=/beta/company/index.php/ContentDetail/magazineAccount/&logindetail=<?php echo $empSummaryDetail; ?>" class="diblock padrl20 brd brdrad3 panlyellow_bg  ws_now lgn_hight_29 fsz14 black_txt">
								...
								<?php } else { ?> 
								<div class="hidden-xs hidden-sm padrl10">
								<a href="../../VerifyRequest/updateRequestAccount/<?php echo $data['cid']; ?>" class="diblock padrl20 brd brdrad3 panlyellow_bg  ws_now lgn_hight_29 fsz14 black_txt">
