...
<html>
	...
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
								<div class="padb40 talc fsz45"><i class="fas fa-shipping-fast black_txt"></i></div>
			<div class="padb0 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 black_txt trn ffamily_avenir">Sent</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">You asking to connect.</a></div>
									</div>
                                ...
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_ffde00 talc">
                                            ...
                                            <a href="#" class="dinlblck mar5 padrl30_a padrl10 bg_ffde00 brdrad40 lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h black_txt_a white_txt_ah active" data-id="utab_Advertising">Sent</a>
                                            <a href="rejectedAccount" class="padrl10 padrl30_a fsz18 dark_grey_txt pink_ff5bad_a lgn_hight_36" ><i class="fas fa-trash-alt"></i></a>
                                  ...
                                  <div class="tab_content active" id="utab_Advertising" style="display: block;">
										...
										<div  id="employerRequest">
											<?php $i=0;
												...
												foreach($requestSentDetail as $category => $value) 
												{
										...
										<div class="container  padb20 padt15    brdrad1 fsz18 dark_grey_txt">
											...
											<div class="fleft wi_50     "> <span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 padb0  ffamily_avenir"><?php echo date('Y-m-d',strtotime($value['created_on'])); ?></span>
									...
									<div class="padt20 padb10 talc  ">
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width" value="1" onclick="add_more_employer(this);">View more</a>
