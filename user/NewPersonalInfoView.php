		...
		<div class="column_m pos_rel " >
			...
			<div class="column_m container zi5 mart20  xs-mart0 lgtgrey2_bg xs-white_bg">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0 ">
					...
					<!-- Center content -->
					<div class="wi_500p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla  brdrad3 lgtgrey2_bg xs-white_bg">
...
<div class="marrl0 wi_500p maxwi_100 dflex xs-fxwrap_w talc padt20 padb40   xs-padb0">
						...
						<p class="fsz14  padt5 grey_new_txt">Privat</p>
						</div>
				...
				<?php } ?>
						<span class="fa-stack-info">
																				  <i style="border-radius: 10%;background: #<?php if($checkEmployerAvailable==0) echo 'e4e4e4'; else echo 'e4e4e4'; ?>; color: #<?php if($checkEmployerAvailable==0) echo 'e4e4e4'; else echo 'e4e4e4'; ?>;" aria-hidden="true" class=" fa-circle fa-stack-2x circle_bg_apps2"></i>
																				  <i class="far fa-building fa-stack-1x fab1 bold pad0" aria-hidden="true" style="color:#01b7f2;"></i>
																				</span></a>
						<p class="fsz14  padt5 grey_new_txt">Företag</p>
						</div>
