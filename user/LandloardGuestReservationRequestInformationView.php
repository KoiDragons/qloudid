...
<a class="header__logo xs-fsz25 changedText" href="../guestReservationTimelineInfo/<?php echo $data['rid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">You can find the detail of your reservation request
</div>
...
<div class="field__label changedText" style="color:#787f91;">Seller name</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo $guestReservationDetail['company_details']['company_name']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<select  class="   "  name="c_id" id="c_id" style="height: 48px;
    ...
    border-radius: 0px;" fdprocessedid="8mc52" disabled>
                         	...
                         	<?php foreach($userCountryList as $category => $value ) {
										?>
										<option value="<?php echo $value['id']; ?>" <?php if($guestReservationDetail['company_details']['country_id']==$value['id']) echo 'selected'; ?>>+<?php echo $value['country_code']; ?></option>
										<?php } ?>
...
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php if(!empty($guestReservationDetail['company_contact_details'])) echo $guestReservationDetail['company_contact_details']['sale_phone_number']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input" name="email" id="email" value="<?php echo $guestReservationDetail['company_contact_details']['sale_email']; ?>"   type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
