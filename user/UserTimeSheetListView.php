...
<html>
	...
	<head>
		...
		{
			window.location.href ="https://www.safeqloud.com/user/index.php/UserTimeSheetInfo/taskInformation";
		}	
		</script>
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir"  >Timesheet</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >List of task completed till date</a></div>
					 
					 <div class="tab-header martb0 padb30 xs-talc  nobrd talc">
                                            
                                              <a href="taskInformation" class="dinlblck mar5 padrl10     bg_98cf44 brdrad50  lgn_hight_60 fsz60  white_txt white_txt_ah ffamily_avenir" onclick="changeHeader();">+</a>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Task" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
									  ...
									  <?php  
												...
												foreach($listTimesheet as $category => $value) 
												{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_70 xxs-wi_55  xs-mar0 xs-padt10">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $value['project_title']; ?>(<?php echo $value['task_date']; ?>)</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs "><?php echo $value['project_description']; ?></span> 
													 </div>
													<div class=" fleft wi_20  marr30 xs-mar0 ">
													
													<a href="#" class="xs-padr20">  
													<div class="fright wi_25  padl0 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="<?php echo $value['total_time']; ?>hrs" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi"><?php echo $value['total_time']; ?>hrs</button>
																			</div> 
																			</a>
													   </div>
