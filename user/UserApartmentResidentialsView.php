...
<a class="header__logo xs-fsz25 changedText" href="../apartmentSelectRevisionInfo/<?php echo $data['aid']; ?>" style="
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.safeqloud.com/user/index.php/NewPersonal/addressList">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Residentials</a></li>
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="../listDependentResidentials/<?php echo $data['aid']; ?>">Dependents</a></li>
                </ul>
              </div>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Here is the list of persons living in the apartment</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Persons</div>
                                      </a>
		...
		<div class="sorting__foot">
               ...
               <a href="../addPersonInfo/<?php echo $data['aid']; ?>">  <button class="button-stroke catalog__button" fdprocessedid="j05ju9">
...
box-shadow:none;">
	 ...
	 <div class="travels__list">
				...
				<?php     foreach($residentialsList as $category => $value) 
										{
										
												?> 
               
				  
			 							  <div class="travels__card <?php if($value['is_confirmed']==1) { echo 'white_bg'; } else echo 'bg10161d'; ?>  " <?php if($value['is_confirmed']==1) echo 'style="background:white !important;"'; ?>>
                                  ...
                                  <div class="travels__body">
                                    <div class="travels__line" style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: #777E90;"><?php echo  substr(html_entity_decode($value['name']),0,15); ?></div>
                                        <div class="travels__location" style="color: #777E90;"><?php echo  '+'.$value['country_code'].''.$value['phone_number']; ?></div>
                                      </div>
   ...
   ">Approved</a>
   <?php } if($value['is_confirmed']==2) { ?>
				    <a class="header__logo  changedText fright ButtonWhite" href="#" id="<?php echo $value['id']; ?>" style="
    margin-right:0px;
   padding: 5px;
   ...
   <?php     foreach($dependentList as $category => $value) 
										{
										
												?> 
               
				  
			 							  <div class="travels__card white_bg "  style="background:white !important;">
                                  <div class="travels__preview"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="Card" style="border-radius: 50%; padding: 20px 40px;">
