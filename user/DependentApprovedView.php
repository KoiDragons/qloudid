			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="tab-header martb10 padb10 xs-talc brdb_black nobrdt nobrdl nobrdr talc">
                                            ...
                                            <a href="#" class="dinlblck mar5 padrl30     black_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" >Private</a>
                                              <a href="dependentList" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Your children</a>
												...
												<div class=" white_bg marb0   bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
																		...
																		<div class="fleft wi_50p marr15 "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 lgtgrey_bg   " style="  background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"><i class="fab fa-app-store-ios   brdrad0 fab1 padl0 red_ff2828_txt"></i></div>
																	</div>
																	
																	<div class="fleft wi_70 xxs-wi_75s  xs-mar0 ">
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18  bold  black_txt">Appstore</span>
																	
																	  <span class="edit-text  fsz14  jain2 dblock  lgn_hight_18 ">Explore and visit your apps</span>  
																	</div>
										...
										<div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" lgtgrey_bg marb0   bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	background-position: 50%;
																	border-radius: 10%;"><i class="fas fa-home blue_txt  brdrad0 fab1 padl0 "></i></div>
																	</div>
																	
																	<div class="fleft wi_70 xxs-wi_75s  xs-mar0 ">
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18  bold  black_txt">Home</span>
																	
																	  <span class="edit-text  fsz14  jain2 dblock  lgn_hight_18 ">Access your castle from here</span>  
																	</div>
												...
												<div class=" white_bg marb0   bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
																		...
																		<div class="fleft wi_50p marr15 "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg  " style=" background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"><i class="fas fa-briefcase   brdrad0 fab1 padl0 blue_txt_3691c0"></i></div>
																	</div>
																	
																	<div class="fleft wi_70 xxs-wi_75s  xs-mar0 ">
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18  bold  black_txt">Workplace</span>
																	
																	  <span class="edit-text  fsz14  jain2 dblock  lgn_hight_18 ">Get to work from here... </span>  
																	</div>
												...
												<div class=" lgtgrey_bg marb0   bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
																		...
																		<div class="fleft wi_50p marr15 "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg  " style="   background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"><i class="fas fa-umbrella-beach  brdrad0 fab1 padl0 seggreen_47E2A1_txt"></i></div>
																	</div>
																	
																	<div class="fleft wi_70 xxs-wi_75  xs-mar0 ">
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18  bold  black_txt">Travel</span>
																	
																	  <span class="edit-text  fsz14  jain2 dblock  lgn_hight_18 ">This is your travel app... </span>  
																	</div>
										...
										<?php $i=0;
												...
												?> 
												<a href="<?php if($value['dependent_type']==1) echo 'dependentInfo'; else if($value['dependent_type']==2) echo 'dependentElderInfo'; else if($value['dependent_type']==3) echo 'dependentDisableInfo';?>/<?php echo $value['enc']; ?>" target="blank" class="hidden">
										<div class="column_m container  marb5   fsz14 dark_grey_txt">
										...
										<div class="container padrl10 padb15 padt15    brdrad1 fsz18 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="fleft wi_50p marr15  xs-marr0 "> 
													...
													<div class="fleft wi_50 xxs-wi_60 sm-wi_50 xsip-wi_50   "> <span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 bold padb0  ffamily_avenir"><?php if($value['dependent_type']==1) echo 'Child'; else if($value['dependent_type']==2) echo 'Elder'; else if($value['dependent_type']==3) echo 'Disable'; ?></span>
