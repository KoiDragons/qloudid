				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10   white_bg">
							...
							<div class="padb10 ">
									...
									<p class="pad0 talc fsz18 padb20 brdb wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10">Here you can share your data with your suppliers</p>
								</div>
								...
								<div class="padb15 mart20">
									<h3 class="marb15 pad0 uppercase fsz20 blue_txt">Premium Services</h3>
								...
								<div class="container tab-header  talc dark_grey_txt mart20">
									...
									<select class="tab-header wi_200p maxwi_100 dnone xs-dblock hei_30p pad0 nobrd brdb">
										<option value="tab1_Internal" selected><?php echo $rowP['num']; ?></option>
								...
								<div class="container  white_bg fsz14 dark_grey_txt">
									<!-- Summary -->
									<div class="mart20 brdb">
											<h2 class="fleft mar0 padb5 fsz15">Approved</h2>
									...
									<div class="tab-content active padt5" id="tab_total">
