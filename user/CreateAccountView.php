...
<body>
	...
	<div class="clear"></div>
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				...
				<div class="pos_rel">
				<input type="password" name="password" id="password" placeholder="********" class=" wi_100 rbrdr pad10 mart5 brdb talc  minhei_65p fsz18 llgrey_txt" /> </div>
				</div>	  
		...
		<div class="modal-content nobrdb talc box_shadox brdrad10 lgtgrey2_bg">
			...
			<div class="wi_100 dflex fxwrap_w marrla marb20 tall padrl20">
				...
				<div class="wi_100 marb0 talc">
					...
					<span class="valm fsz16 trn" >Password field cannot be empty</span>
				</div>
