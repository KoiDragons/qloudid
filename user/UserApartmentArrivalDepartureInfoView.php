...
<html>
	...
	<head>
		...
		{
		 var send_data={};
				 send_data.update_id=id;
				 $.ajax({
							type:"POST",
							url:"../updateArrival/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		function updateDeparture(id)
		{
		 var send_data={};
				 send_data.update_id=id;
				 $.ajax({
							type:"POST",
							url:"../updateDeparture/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Arrivals</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">What time can guests arrive at the property from?</span> 
													 </div>
										...
										<a href="javascript:void(0);" onclick="updateArrival(0);"><button color="#444444" data-testid="icon-button--minus" class="merlin-button merlin-button--disabled css-ig30wo" aria-label="" disabled="">
										...
										<span class="value" id="arrival"><?php echo date('H:i',strtotime($resultOrg1['arrival_time'])); ?></span>
									<a href="javascript:void(0);" onclick="updateArrival(1);">	
									<button color="#444444" data-testid="icon-button--plus" class="merlin-button css-mgojn5" aria-label="">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Departures</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">What time should guests leave the property by?</span> 
													 </div>
										 ...
										 <div id="bedroom_count" class="css-151xzu3">
										<a href="javascript:void(0);" onclick="updateDeparture(0);"><button color="#444444" data-testid="icon-button--minus" class="merlin-button merlin-button--disabled css-ig30wo" aria-label="" disabled="">
										<div class="merlin-button__content">
										<div class="css-ibdtyj">
										<div class="css-2llcy8">
										<div data-testid="icon-button--icon-div" class="css-lf4a1m">
										...
										<span class="value" id="departure"><?php echo date('H:i',strtotime($resultOrg1['departure_time'])); ?></span>
									<a href="javascript:void(0);" onclick="updateDeparture(1);">	
									<button color="#444444" data-testid="icon-button--plus" class="merlin-button css-mgojn5" aria-label="">
										<div class="merlin-button__content">
										<div class="css-ibdtyj">
										<div class="css-2llcy8">
