...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Hello, <?php echo $resultOrg['first_name']; ?>
</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Please select the profile detail you want to update.
</div>
...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Profiles</h2> 
                  </div>
...
<div class="checkout__label changedText">Basic details</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">(<?php if($resultOrg['sex']==1) echo 'M'; else echo 'F'; ?>) <?php echo $resultOrg['first_name'].' '.$resultOrg['last_name']; ?>-<?php echo date('d M Y',strtotime($resultOrg['dob_day'].'-'.$resultOrg['dob_month'].'-'.$resultOrg['dob_year'])); ?></div>
 
<div class="checkout__controls">
 
<a href="addUsername"><button class="checkout__edit"  >
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg['email']!="" || $resultOrg['email']!= null) echo $resultOrg['email']; else echo "-"; ?></div>
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg1['phone_number']!="" || $resultOrg1['phone_number']!= null) echo $resultOrg1['phone_number']; else echo '-'; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">Add/List</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Identificator</div>
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg1['address']!="" || $resultOrg1['address']!= null) echo $resultOrg1['address'].'-'.$resultOrg1['port_number']; else echo '-'; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">Bank account number</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg1['bank_account_number']!="" || $resultOrg1['bank_account_number']!= null) echo $resultOrg1['bank_account_number']; else echo '-'; ?></div>
