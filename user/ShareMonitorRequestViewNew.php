...
<h2 class="browse__title h2 changedText xs-fsz60 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Consents</h2>
<div class="browse__info info changedText">These are your private consents, <?php echo $row_summary['first_name']; ?></div>
</div>
...
<div class="checkout__label changedText"><?php echo substr(html_entity_decode($value['address']),0,25); ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo substr(html_entity_decode($value['company_name']),0,25); ?></div>
 
<div class="checkout__controls hidden">
 
<a href="#"><button class="checkout__edit"  onclick="approveMember();">
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Employer</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo substr(html_entity_decode($value['company_name']),0,25); ?></div>
...
<a href="../ConsentProfile/receiveAccount/<?php echo encrypt_decrypt('encrypt',$value['id']); ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Daycare</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo substr(html_entity_decode($value['company_name']),0,25); ?></div>
...
<a href="../ConsentProfileParent/requestAccount/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Parent</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo substr(html_entity_decode($value['name']),0,25); ?></div>
 
<div class="checkout__controls">
 
<a href="../ConsentProfileGuardian/dependentAccount/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Received kin request</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo substr(html_entity_decode($value['name']),0,25); ?></div>
...
<a href="../ConsentKinRequest/kinInformation/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Received tenant request</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo substr(html_entity_decode($value['office_apartment_number']),0,25); ?></div>
 
 
 
 <div class="checkout__controls">
 
<a href="verifyRequest/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-check" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__controls padr40">
    
<a href="unverifyRequest/<?php echo $value['enc']; ?>"><button class="checkout__edit js-date-close padrl0" style="display: block;">
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-close " style="fill:#E91E63;"></use>
</svg>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Contractor</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo substr(html_entity_decode($value['company_name']),0,25); ?></div>
...
<a href="approveContrator/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-check" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<a href="rejectContrator/<?php echo $value['enc']; ?>"><button class="checkout__edit js-date-close padrl0" style="display: block;">
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-close " style="fill:#E91E63;"></use>
</svg>
