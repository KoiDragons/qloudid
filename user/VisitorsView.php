...
if($visitorsBg['image_src']!=null) { $filename="../estorecss/".$visitorsBg['image_src'].".txt"; if (file_exists($filename)) { $value_a=file_get_contents("../estorecss/".$visitorsBg['image_src'].".txt"); $value_a=str_replace('"','',$value_a);  $imgs = base64_to_jpeg( $value_a, '../estorecss/'.$visitorsBg['image_src'].'.jpg' );  $imgs='../../../../'.str_ireplace(' ','%20',$imgs); } else { $value_a="https://www.dropbox.com/s/onhahjpdnz9sa8c/1.jpg?raw=1";  $imgs="https://www.dropbox.com/s/onhahjpdnz9sa8c/1.jpg?raw=1"; } }  else {  $imgs="https://www.dropbox.com/s/onhahjpdnz9sa8c/1.jpg?raw=1"; $value_a="https://www.dropbox.com/s/onhahjpdnz9sa8c/1.jpg?raw=1"; }
...
?>	
	<head>
			...
			function informEmployee(id)
			{
				...
				if($("#uphno").val()=="" || $("#uphno").val()==null)
				{
					...
					$.ajax({
						...
						window.location.href ="https://www.safeqloud.com/user/index.php/Company/visitorsIP/<?php echo $data['cid']; ?>";
						}
					});
				}
		...
		<div class="column_m header xs-header  bs_bb " id="headerData" style="display:<?php if($verifyIP==0) echo 'block'; else echo 'none'; ?>">
			...
			<div class="column_m container zi5  " onclick="checkFlag();" style="display:<?php if($verifyIP==0) echo 'block'; else echo 'none'; ?>">
			...
			<div class="column_m container zi5  " onclick="checkFlag();" style="display:none;" id="processing">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					
					
					<!-- Center content -->
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10 padt100 xs-pad0  valm halm">
						
						<div class="talc fsz75 red_txt"> <image src="<?php echo $path; ?>html/usercontent/images/bg/output_99kjuu1.gif" /></div>
			...
			<div class="column_m xs-padb10 talc lgn_hight_22 fsz16" id="loginBank" onclick="checkFlag();" style="display:<?php if($verifyIP==1) echo 'block'; else echo 'none'; ?> ">
				
						<div class="dflex xs-dblock justc_fe pos_rel padb40 xs-pad0" onclick="checkFlag();">
				<div class="wi_100 hei_100 pos_abs xs-pos_sta zi1 top0 left0 bgir_norep bgip_c bgis_cov" style="background-image: url(https://www.dropbox.com/s/onhahjpdnz9sa8c/1.jpg?raw=1);">
					<img src="https://www.dropbox.com/s/onhahjpdnz9sa8c/1.jpg?raw=1" class="wi_100 hei_auto hide xs-dblock">
				</div>
						...
						<div class="wi_100 hei_100 xs-dnone opa60 pos_abs zi1 top0 left0 brownbrown_bg"></div>
						<div class="maxwi_400p pos_rel zi5">
							<h2 class="mar0 padt100 bold fsz40 xs-fsz22 white_txt xs-darkgrey_txt tall">Du är väntad...</h2>
							<h3 class="fsz25 xs-fsz20 padb10 padt0 xs-padt0  tall  lgn_hight_30 xs-talc white_txt">Meddela din ankomst nedan</h3>
											...
											<div class="on_clmn padtb0">
												...
												<div class="on_clmn mart20 hidden">
													...
													<div class="pos_rel">
														...
														<select name="booked" id="booked" class="default_view wi_100 mart5 rbrdr padrl10  white_bg hei_50p fsz18 llgrey_txt">
															
															
															<option value="Bokat besök" <?php if($getBookId==2) echo 'selected'; ?>>Bokat besök</option>
															
															<option value="Drop in" <?php if($getBookId==1) echo 'selected'; ?>>Drop in</option>
												...
												<div class="on_clmn mart5">
													
													<div class="pos_rel">
														
														<input type="text" name="empname"  placeholder="Namn på den du ska träffa..." class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 white_bg brdrad5" id="collaborators-lookup" >
												...
												<div class="on_clmn mart10">
													<div class="thr_clmn  wi_50 "  >
														...
														<div class="pos_rel">
												<input type="text" name="name" id="name" placeholder="Namn" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt white_bg fsz18 brdrad5"> </div>
												</div>
												...
												<input type="text" name="lname" id="lname" placeholder="Efternamn" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt white_bg fsz18 brdrad5"> </div>
												</div>
												</div>
												<div class="on_clmn mart10">
													
												<input type="text" name="cname" id="cname" placeholder="Ditt företag" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt white_bg fsz18 brdrad5"> </div>
												
												<div class="on_clmn mart10 hidden" >
													
												<input type="text" name="email" id="email" placeholder="Email" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt white_bg fsz18 brdrad5"> </div>
												...
												<div class="on_clmn mart10">
													...
													<div class="thr_clmn  wi_50 "  >
														...
														<div class="pos_rel">
															...
															<select id="cntry" name="cntry" class=" default_view wi_100 mart5 rbrdr padrl10  white_bg hei_50p fsz18 llgrey_txt"  >
																...
																<?php  foreach($resultContry as $category => $value) 
																	...
																	<option value="<?php echo $value['country_name']; ?>" <?php if($value['id']==201) echo 'Selected'; ?> class="white_bg"><?php echo $value['country_name']; ?></option>
																<?php 	}	?>
													...
													<div class="thr_clmn  wi_50 padl10">
														...
														<div class="pos_rel">
															...
															<input type="text" name="uphno" id="uphno" placeholder="Mobil" class=" wi_100 rbrdr padrl10 mart5  white_bg hei_50p fsz18 llgrey_txt">
												...
												<input type="text" name="car_res_num" id="car_res_num" placeholder="Din bils reg nr." class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt white_bg fsz18 brdrad5"> </div>
						...
						<p class=" padt20 xs-padt10 xs-padb20 talc fsz18 xs-fsz16 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10">Bemannad av <?php echo $data['comp_name']; ?></p>
						<?php } ?>
										</div>
				...
				<div class=" dflex justc_sb alit_c padtb10 padrl40 brdt lgn_hight_34 fsz14 txt_787e89 white_bg footer <?php if($verifyIP==0) echo 'hidden'; ?>"  >
					<div>
