							...
							<div class="marb10 brdb">
								...
								<div class="container tab-header padrl10 talc dark_grey_txt">
									<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey2_bg">
										<li>
											<a href="#" class="dblock brdradt5 active" data-id="tab_total">
												<span class="count"><?php echo $resultLatestJobCount['num']; ?></span>
											</a>
										</li>
										<li>
											<a href="#" data-id="tab_inprogress">
												<span class="count"><?php echo $resultScreeningCount['num']+$resultPhoneCount['num']+$resultFaceCount['num']; ?></span>
												<span>In progress</span>
											</a>
										</li>
										<li>
											<a href="#" data-id="tab_offered">
												<span class="count"><?php echo $resultOfferedCount['num']; ?></span>
												<span>Offered</span>
											</a>
										</li>
										<li>
											<a href="#" data-id="tab_background">
												<span class="count">0</span>
												<span>Background</span>
											</a>
										</li>
										<li>
											<a href="#" data-id="tab_hireddeclined">
												<span class="count"><?php echo $resultHiredCount['num']; ?></span>
												<span>Hired / Declined</span>
											</a>
										</li>
									...
									<select class="tab-header wi_200p maxwi_100 dnone xs-dblock hei_30p pad0 nobrd brdb">
										<option value="tab1_Internal" selected><?php echo $resultRecrutingNotPostedCount['num']+$resultRecrutingPostedCount['num']; ?></option>
								...
								<div class="container padrl10 white_bg fsz14 dark_grey_txt">
									...
									<div class="tab-content pad25" id="tab_total">
										...
										<table class="wi_100" cellpadding="0" cellspacing="0">
											...
											<tbody>
												<?php foreach($resultLatestJob as $category => $value) 
													{
													...
													<tr>
														...
														<td class="pad5 brdb tall">
															<div class="padtb5"><?php echo $value['title']; ?></div>
														</td>
														<td class="pad5 brdb tall">
															<div class="padtb5"><?php echo $value['job_status']; ?></div>
														</td>
														<td class="pad5 brdb tall">
															<div class="padtb5"></div>
														</td>
														<td class="pad5 brdb tall">
															<div class="padtb5"><?php echo $value['expiry_date']; ?></div>
														</td>
													</tr>
												<?php } ?>
											</tbody>
									...
									<div class="tab-content pad25" id="tab_inprogress">
										
										<!-- inner tab header -->
										<div class="container">
											<ul class="tab-header dblock mar0 pad0 talc dark_grey_txt">
												<li class="dblock fleft lgtgrey_bg">
													<a href="#" class="dblock pad15 lgtgrey2_bg_h lgtgrey2_bg_a cyanblue_txt active" data-id="tab_internal">
														<span>Screening</span>
													</a>
												</li>
												<li class="dblock fleft lgtgrey_bg">
													<a href="#" class="dblock pad15 lgtgrey2_bg_h lgtgrey2_bg_a cyanblue_txt" data-id="tab_external_agency">
														<span>Phone</span>
													</a>
												</li>
												<li class="dblock fleft lgtgrey_bg">
													<a href="#" class="dblock pad15 lgtgrey2_bg_h lgtgrey2_bg_a cyanblue_txt" data-id="tab_external_network">
										...
										<!-- inner tab content -->
										<div class="container">
											<div class="tab-content" id="tab_internal">
												
												<table class="wi_100" cellpadding="0" cellspacing="0">
													<thead class="lgtgrey2_bg fsz13" style="color: #c6c8ca;">
														<tr>
															<!--<th class="pad5 brdb nobold tall weight_normal" style="color:#c6c8ca;">
																<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
															</th>-->
															<th class="pad5 brdb nobold tall weight_normal" style="color:#c6c8ca;">
																<div class="padtb5">Company</div>
													...
													<?php foreach($resultScreening as $category => $value) 
														{
															$category = htmlspecialchars($category); 
															$encryt=encrypt_decrypt('encrypt',$value['id']);
															$encryt1=encrypt_decrypt('encrypt',$data['user_id']);
														...
														<tr>
															...
															<td class="pad5 brdb tall">
																<div class="padtb5"><a href="https://www.qmatchup.com/beta/job_profile_applied.php?id=<?php echo $encryt;?>&uid=<?php echo $encryt1;?> " class="dblue_btn min_height dblock nobold fsz11">View</a></div>
															</td>
														</tr>
													<?php } ?>
												</tbody>
										...
										<div class="tab-content" id="tab_external_agency">
											<form method="post" action="">
												<table class="wi_100" cellpadding="0" cellspacing="0">
													...
													<tbody>
														...
														<?php foreach($resultPhone as $category => $value) 
															{
																$category = htmlspecialchars($category); 
																$encryt=encrypt_decrypt('encrypt',$value['id']);
																$encryt1=encrypt_decrypt('encrypt',$data['user_id']);
										...
										<div class="tab-content" id="tab_external_network">
											<form method="post" action="">
												<table class="wi_100" cellpadding="0" cellspacing="0">
													<thead class="lgtgrey2_bg fsz13" style="color: #c6c8ca;">
														<tr>
													...
													<tbody>
														...
														<?php foreach($resultFace as $category => $value) 
															{
																$category = htmlspecialchars($category); 
																$encryt=encrypt_decrypt('encrypt',$value['id']);
																$encryt1=encrypt_decrypt('encrypt',$data['user_id']);
								...
								<div class="tab-content pad25" id="tab_offered">
									<form method="post" action="">
										<table class="wi_100" cellpadding="0" cellspacing="0">
											<thead class="fsz13" style="color: #c6c8ca;">
												<tr>
											...
											<tbody>
												<?php foreach($resultOffered as $category => $value) 
													{
														$category = htmlspecialchars($category); 
														$encryt=encrypt_decrypt('encrypt',$value['id']);
													...
													<tr>
														...
														<?php if($value['booked']==1) { ?>
															<td class="pad5 brdb tall">
																<div class="padtb5"><a href="ApplicationStatus/availabilityAccept/<?php echo$encryt;?>/Accept" class="dblue_btn min_height dblock nobold fsz11">Accept</a></div>
															</td>
															
															<td class="pad5 brdb tall">
																<div class="padtb5"><a href="ApplicationStatus/availabilityAccept/<?php echo$encryt;?>/Reject" class="dblue_btn min_height dblock nobold fsz11">Reject</a></div>
															</td>
															<?php } else { ?>
															
															<td class="pad5 brdb tall">
																<div class="padtb5"><a href="#" class="dblue_btn min_height dblock nobold fsz11">Accept</a></div>
															</td>
															
															<td class="pad5 brdb tall">
																<div class="padtb5"><a href="#" class="dblue_btn min_height dblock nobold fsz11">Reject</a></div>
															</td>
								...
								<div class="tab-content pad25" id="tab_background">
									<form method="post" action="">
										<table class="wi_100" cellpadding="0" cellspacing="0">
											<thead class="fsz13" style="color: #c6c8ca;">
												<tr>
								...
								<div class="tab-content pad25" id="tab_hireddeclined">
									<form method="post" action="">
										<table class="wi_100" cellpadding="0" cellspacing="0">
											<thead class="fsz13" style="color: #c6c8ca;">
												<tr>
											...
											<tbody>
												<?php foreach($resultHired as $category => $value) 
													{
														$category = htmlspecialchars($category); 
													?>  
													<tr>
														...
														<td class="pad5 brdb tall">
															<?php if($value['title']=="hired") {  ?>
																<div class="padtb5"><?php if($value['accept_job']=="Accepted") echo "Hired"; else echo "Rejected"; ?></div>
																<?php } else { ?>
																<div class="padtb5"><?php echo "Rejected"; ?></div>
															<?php } ?>
														</td>
														<td class="pad5 brdb tall">
															<div class="padtb5"></div>
