...
<a class="header__logo changedText" href="#" style="
...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">Requests
</span> </h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Check all received request from brokers below
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Requests</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active" href="#">All</a><a class="nav__link" href="#">Sold</a><a class="nav__link" href="#">Manage</a> <a class="nav__link" href="#">Rent</a></div>
    ...
    margin-bottom: 0px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title" style="font-size:30px; color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                        <div class="card__price hidden" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099;">
...
">Requesting company</div>

 

 <a class="header__logo  changedText fright" href="#" style="
   /* background-color: #E91E63;*/
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
   ...
   border: 2px solid #FFEB3B; margin-right:0px;
   "><?php echo $value['company_name']; ?></a>
   
              </div>
			  
			   <div class="card__flex brdt mart10 padt10">
                        <div class="card__cost fsz14 changedText" style="
    padding-top: 10px;  font-weight:100;
">Requesting broker</div>
...
">Update Status</div>
 ...
 <a class="header__logo  changedText fright" href="approveExclusiveRequest/<?php echo $value['request_id']; ?>" style="
   /* background-color: #E91E63;*/
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
...
">Update Status</div>
 ...
 <a class="header__logo  changedText fright" href="rejectExclusiveRequest/<?php echo $value['request_id']; ?>" style="
   /* background-color: #E91E63;*/
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
