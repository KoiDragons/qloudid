...
<html>
	...
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
								<div class="padb40 talc fsz45"><i class="fas fa-question black_txt"></i></div>
								 
			<div class="padb0 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 black_txt trn ffamily_avenir">Recevied</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Sent requests to connect.</a></div>
									</div>
                                ...
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_ffde00 talc">
                                            ...
                                            <a href="#" class="dinlblck mar5 padrl30_a padrl10 bg_ffde00 brdrad40 lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h black_txt_a white_txt_ah active" data-id="utab_Analytics">Request</a>
							...
							<div class="tab_container mart10">
								 ...
								 <div class="tab_content active" id="utab_Analytics" style="display: block;">
										...
										<div class="container  padb20 padt15    brdrad1 fsz18 dark_grey_txt">
											...
											<a href="#" class="show_popup_modal black_txt"  onclick="showUserDetailReceived(<?php echo $value['uid']; ?>,this,'<?php echo $value['enc']; ?>');"><div class="fleft wi_50     "> <span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 padb0  ffamily_avenir">Received request</span>
											<span class="trn fsz18  black_txt ffamily_avenir  "><?php echo $value['name']; ?></span>  </div></a>
													
													<a href="rejectRequest/<?php echo $value['enc']; ?>"><div class="fright wi_10 padl0  marl15 fsz40  xs-marl0 xxs-marr20 padb0  ">
														<span class="far fa-times-circle  red_txt"></span>
													</div></a>
													
												<?php if($row_summary['ssn']=='' || $row_summary['ssn']==null || $row_summary['ssn']==0)
													{
														
														?>

												<a href="updateSSN/<?php echo $value['enc']; ?>"><div class="fright wi_10 padl0  marl15 fsz40    xs-marl0 xxs-marr20 padb0  ">
														<span class="fas fa-check-circle green_txt"></span> 
													</div>	</a>														
													<?php } else { ?>
													<a href="approveRequest/<?php echo $value['enc']; ?>"><div class="fright wi_10 padl0  marl15 fsz40    xs-marl0 xxs-marr20 padb0  ">
														<span class="fas fa-check-circle green_txt"></span> 
													</div>	</a>	
													<?php } ?>
