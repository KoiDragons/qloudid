...
<html>
	...
	<body class="white_bg ffamily_avenir">
		...
		<div class="column_m header hei_55p  bs_bb white_bg visible-xs" id="dHeader" >
			 ...
			 <div class="visible-xs visible-sm fright marr0 padt5 "> <a href="QloudParking/addParking" class=" diblock padl7 padr7 brdrad3 fsz30 seggreen_47E2A1_txt"><i class="fas fa-plus " aria-hidden="true"></i></a> </div>
										...
										<li class=" dblock pos_rel padb10 padt0 brdclr_hgrey ">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  t_67cff7_bg_a black_txt white_txt_h black_txt_a" style="border-radius:0%;"> <span class="valm trn" >Hyr ut din p-plats</span> 
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="column_m container zi1 padb5">
								...
								<div class="white_bg tall">
                                    ...
                                    <!-- Logo -->
                                    <h1 class="blue_67cff7 fsz30 xs-fsz45 xs-talc ffamily_avenir">P-plats</h1>

                                    <div class="marb0 xs-talc"> <a href="#" class="blacka1_txt fsz16  xs-fsz20  talc edit-text jain_drop_company ffamily_avenir">Hyr ut din plats och tjäna pengar.</a></div>
                                    <a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
                                        <!-- Meta -->
									...
									<a href="QloudParking/addParking" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt " >
										
										<span class="valm ffamily_avenir"> Verifiera </span>
							 ...
							 <div class="tab-header mart10 padb10 xs-talc">
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 blue_67cff7_brd_a t_67cff7_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_Popular">Anslutna</a>
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 blue_67cff7_brd_a t_67cff7_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" data-id="utab_Analytics">Mottagna</a>
							 ...
							 <div class="tab_container mart10">
								...
								<div class="tab_content hide" id="utab_Popular" style="display: block;">
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable">
										<thead class="fsz16"  >
											<tr class="white_bg brdb_67cff7">
												<th class="wi_30 pad5 brdb_67cff7 nobold  tall" >
													<a href="#"><div class="padtb5 black_txt">Address</div></a>
												</th>
												<th class="visible-xs brdb_67cff7 visible-xm"></th>
												<th class="pad5 brdb_67cff7 nobold  tall hidden-xs" >
													<div class="padtb5 black_txt trn" >Serial</div>
												</th>
												<th class="pad5 brdb_67cff7 nobold hidden-xs tall" >
										...
										<tbody  id="allRequest">
											<?php 
											foreach($parkingDetail as $category => $value) 
												{
												...
												<tr class="fsz16 xs-fsz16">
													...
													<td class="xs-wi_100  pad5 brdb_new tall cn">
														<div class="padtb5 " ><a href="QloudParking/editParking/<?php echo $value['enc']; ?>"><?php echo $value['address']; ?></a></div>
													</td>
									...
									<div class="padtb20 talc">
										<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt ffamily_avenir   trn xxs-brd_width" value="1" onclick="add_more_all(this);" data-trn-key="Visa fler">Visa fler</a>
								...
								<script>
									function add_more_all(link) {
										...
										$.ajax({
											type:"POST",
											url:"QloudParking/moreParkeringDetail",
											data:send_data,
											dataType:"text",
								...
								<div class="tab_content hide" id="utab_Analytics" style="display: none;">
									...
									<div class="clear" id=""></div>
									<div class="padtb20 talc">
										<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt ffamily_avenir   trn xxs-brd_width" value="1" data-trn-key="Visa fler">Visa fler</a>
