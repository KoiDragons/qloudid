...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Invoices generated from the seller agreement.</div>
...
<div style="background: #131922;
 ...
 <a href="../../../../user/index.php/ProposalInvoice/invoiceInformation/<?php echo $data['agreement_id']; ?>/<?php echo $value['enc']; ?>"><div class="card card_row" style="margin-bottom:24px; border:none; ">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">EMI <?php echo $i; ?></div>
...
">
				 <div class="description__parameter" style="margin-left:26px; margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>OCR: <?php echo $value['deposit_code']; ?></div>
                <div class="description__parameter" style="margin-left:26px; margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                ...
                <div class="description__parameter" style="margin-left:16px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php if($value['is_paid']==0) echo 'Generated'; else if($value['is_paid']==1 && $value['fully_paid']==0) echo 'Partial paid'; else if($value['is_paid']==1 && $value['fully_paid']==1) echo 'Paid'; ?></div>
