	...
	<body class="white_bg">
		...
		<div class="column_m header xs-header  bs_bb white_bg">
			<div class="wi_100 xs-hei_40p hei_65p pos_fix padtb5 padrl10  white_bg">
				...
				<div class="visible-xs visible-sm fright marr0 padr0 "> <a href="#" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Erbjudande</a> </div>
				<div class="clear"></div>
			...
			<div class="column_m container zi5  mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0  ">
						...
						<div class="marb30 ">
							<h1 class="padb5 talc fsz50 xs-fsz40 bold ">  Kommer alledels strax</h1>
							<p class="padt20 xs-padt10 xs-padb20 talc fsz25 xs-fsz20 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10">Hej <?php echo $visitorOnPage['name']; ?>,  Jag har blivit meddelad och kommer ner alldeles strax och möter dig.</p>
						</div>
