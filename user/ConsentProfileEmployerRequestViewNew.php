...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Employer</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Employer request detail
</h2>
...
<div class="checkout__list padt20">
 <a class="card card_row  " style="border:none;  margin-bottom: 20px;" href="jaavscript:void(0);">
	  <div class="card__preview" style="width: 161px;padding: 30px;"><img srcset="<?php echo $imgs; ?>" src="<?php echo $imgs; ?>" alt="London - Kings Cross" style="
												padding: 20px;
												border-radius: 30px;
											">
											 
											</div><div class="card__body pad24i xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $companyDetail['company_name']; ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo html_entity_decode($companyDetail['address']); ?> <?php echo html_entity_decode($companyDetail['city']); ?> ,<?php echo html_entity_decode($companyDetail['country']); ?>,<?php echo html_entity_decode($companyDetail['zip']); ?>
</div>
...
">
                <div class="description__parameter" style="margin-right:16px;">
                  ...
                  </svg>+<?php echo html_entity_decode($companyDetail['country_code']); ?><?php echo html_entity_decode($companyDetail['phone']); ?></div>
                <div class="description__parameter" style="margin-left:0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo html_entity_decode($companyDetail['company_email']); ?></div>
...
<a class="button checkout__button changedText" href="../../ShareMonitor/approveEmployee/<?php echo $data['rid']; ?>" >Accept</a>
 
<a class="button checkout__button changedText" href="../../ShareMonitor/rejectEmployee/<?php echo $data['rid']; ?>" >Reject</a>
 <?php } else if($data['request']==3) { ?>
 <a class="button checkout__button changedText hidden" href="Javascript:void(0);" onclick="setDisconnect();">Disconnect</a>
 <?php } ?>
 </div>
