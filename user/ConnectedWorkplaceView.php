				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart20 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  >Shortcut</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc xs-padb15  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" > Take a shortcut to your prime tools</a></div>
					 
					<div class="tab-header martb10 padb10 xs-talc brd_fcaf17 nobrdt nobrdl nobrdr talc">
                                            <a href="../ReceivedRequest" class="dinlblck mar5 padrl10  nobrd brd_fcaf17_a t_fcaf17_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir" >Private</a>
                                            <a href="Dependents/approvedDependents" class="dinlblck mar5 padrl10    brd_fcaf17_a t_fcaf17_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Family</a>
                                              <a href="#" class="dinlblck mar5 padrl30  brd_b7b7b7 brd_fcaf17_a t_fcaf17_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" >Work</a>
                                             

                                        </div>
										<?php $i=0;
												
												foreach($connectedCompanies as $category => $value) 
												{
													
													
												?> 
											<a href="../../company/index.php/ReceivedChild/verifyRequests/<?php echo $value['enc']; ?>"><div class="column_m container  marb5   fsz14 dark_grey_txt">
									...
									<div class="padtb20 mart20 talc <?php if($connectedCompaniesCount['num']<=5) echo 'hidden'; ?>">
										<a href="javascript:void();" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width" value="1" onclick="add_more_rows_approved_Connections(this);">View more</a>
								...
								<script>
									function add_more_rows_approved_Connections(link) {
										...
										$.ajax({
											type:"POST",
											url:"ConnectedWorkplace/moreWorkplaces",
											data:send_data,
											dataType:"text",
