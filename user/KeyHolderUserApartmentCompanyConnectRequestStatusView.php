...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
						 <?php if($requestStatus['is_approved']==2) { ?>
								<img src="https://media.giphy.com/media/l2SpUoAPo0CBOkyxq/source.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
							 
						 <?php } if($requestStatus['is_approved']==1) { ?>
								<img src=" https://media.giphy.com/media/YKdm91XONLTaw/giphy.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
							 
						 <?php }  else if($requestStatus['is_approved']==0){ ?>
						 <img src="https://media.giphy.com/media/lP4jmO461gq9uLzzYc/giphy.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
						 <?php } ?>
							</div>
							 
							<div class="padb20 xxs-padb0  ">		
							
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir"><?php if($requestStatus['is_approved']==0) echo 'Pending';else if($requestStatus['is_approved']==1) echo 'Approved'; else if($requestStatus['is_approved']==2) echo 'Rejected'; ?></h1>
									</div>
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" ><?php if($requestStatus['is_approved']==0) echo 'Your request for connect apartment with building '.$requestStatus['building_name'].' is pending for verification'; else if($requestStatus['is_approved']==1) echo 'Your request for connect apartment with building '.$requestStatus['building_name'].' is approved by the company';  else if($requestStatus['is_approved']==2) echo 'Your request for connect apartment with building '.$requestStatus['building_name'].' has been rejected by support team'; ?></a></br>
		...
		<?php	 if($requestApartmentConnectRequestOtherCompanyCount['num']==0)
			 { if($requestStatus['is_approved']==2) { ?>
				 	<div class="talc padtb20 ffamily_avenir mart35 "> <a href="../../userApartmentConnectInfo/<?php echo $data['aid']; ?>/<?php echo $data['cid']; ?>" ><button type="button" value="Add" class="forword minhei_55p  fsz18    ffamily_avenir">Resend requst</button></a> </div>
			 <?php  } } ?>
