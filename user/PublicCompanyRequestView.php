			...
			<div class="wi_100 hei_45p xs-hei_55p xs-pos_fix pos_fix  padtb5 padrl10 lgtblue2_bg">
				...
				<div class="visible-xs visible-sm fleft">
					<div class="flag_top_menu flefti  padb10 " style="width: 50px; padding : 5px 0 0 0;">
						<ul class="menulist sf-menu  fsz14">
							...
							<li class="first last" style="margin: 7px 40px 0 0;">
								<a href="javascript:void(0);" class="lgn_hight_s1 padl10 fsz18 sf-with-ul brd brdrad5"><img src="../../../../html/usercontent/images/slide/flag_sw.png" width="35" height="auto" alt="email" title="email" onclick="togglePopup();"></a>
				...
				<div class="fright xs-dnone sm-dnone padt10 padb10">
					<ul class="mar0 pad0 sf-menu fsz14 sf-js-enabled sf-arrows">
						...
						<li class="dblock hidden-xs hidden-sm fright pos_rel  brdclr_dblue marl20 first"> <a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl20 blue_bg uppercase lgn_hight_30 white_txt  white_txt_h  brdl" data-en="Close" data-sw="Close">Close</a> </li>
						<li class="dblock hidden-xs hidden-sm fright pos_rel  brdclr_dblue marl20  last"> <a href="#" class="translate hei_30pi dblock padrl20   lgn_hight_30 black_txt show_popup_modal   " data-target="#om_mina" data-en="Om mina uppgifter" data-sw="Om mina uppgifter">Om mina uppgifter</a> </li>
					</ul>
					
				</div>
				
				<div class="visible-xs visible-sm fright marr0 padt10"> <a href="#" class="diblock padr20 brdrad3 lgn_hight_29 fsz20 bold red_txt">X</a> </div>
...
<div class="column_m xs-padb10 talc lgn_hight_22 fsz16 xs-marb0 xs-mart0  mart40 marb0 xs-padrl10" id="loginBank" onclick="checkFlag();">
	<div class="padrl10 xs-padrl15">
		<div class="wrap maxwi_100   xs-nobrdb  xs-padb0 mart0 xs-mart0">
			
			
			<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla padrbl10  xs-pad0  xs-padt40">	
				...
				<div class="wi_100 xs-wi_100 flex_1 order_1 xs-order_1 xs-tall tall mart0 brdrad5 talc">
					...
					<div class="padb0 xxs-pad0 xxs-padb0">
						...
						<?php } ?>
						<h4 class="bold fsz40 xs-fsz25 padb10 talc xs-talc">
						Bekräfta din identitet</h4>
						<h3 class="fsz20 xs-fsz20 padb10 padt10 xs-padb20 brdb_new tall  lgn_hight_30 xs-talc"><?php echo $getInformation['company_name']; ?> ber dig bekräfta din ID-handling med ditt mobila BankID.</h3>
				...
				<div class="wi_100 xs-wi_100 fxshrink_0 order_2 xs-order_2 martb20 marr30 xs-marr0 talc  xs-padr0 xs-padl0 visible-sm visible-xs">
					...
					<ul class="mart10 pad0 tall fsz18">
						...
						<li class="dblock mar0 marb10 pad0">
							...
							<div class="hide dblock_siba pad15 padb0 lgtgrey2_bg activate">
						...
						<li class="dblock mar0 marb10 pad0 ">
							<a href="javascript:void(0);" class="class-toggler dark_grey_txt" data-classes="active" >
								<span class="fa fa-caret-right wi_10p dnone_pa marr3"></span>
								<span class="fa fa-caret-down wi_10p dnone diblock_pa marr3"></span>
								Varför denna förfrågan
							</a>
