...
<div class="column_m header blue_bg">
  <div class="wrap">
    <div class="logo padt10"><a href="../../LoginAccount"><img src="<?php echo $path; ?>/html/signup/images/qmatchup_logo.png" alt="Qmatchup" title="Qmatchup" /></a></div>
   <!-- <div class="usermenu">
      <ul>
...
<div class="column_m container">
  <div class="wrap white_bg talc">
    ...
    <p class="fsz20 padb30">Please check your email for verification</p>
    <div class="line"></div>
