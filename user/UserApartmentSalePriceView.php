...
<html>
	...
	<head>
			...
			function submitForm()
		{
			...
			if($('#sale_price').val()<10000)
			{
			$('#errorMsg').html('Value cant be less then 10000!!!');	
			return false;
			}
			
			if(isNaN($('#sale_price_per_m').val()))
			{
			$('#errorMsg').html('Price must be a numeric value!!!');	
			return false;
			}
			
			if($('#sale_price_per_m').val()<10)
			{
			$('#errorMsg').html('Value cant be less then 10!!!');	
			return false;
			}
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Property sale price" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										 
									</div>
									 </div>
									<form action="../updateSalePrice/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"> 
								 ...
								 <input type="number" id="sale_price" name="sale_price" class="css-xt766" value="<?php echo (float)$resultOrg1['sale_price']; ?>"  >
									...
									<div class="wi_100 pos_rel">
								 <input type="number" id="sale_price_per_m" name="sale_price_per_m" class="css-xt766" value="<?php echo (float)$resultOrg1['sale_price_per_m']; ?>" >
