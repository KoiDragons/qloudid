...
<head>
	...
	<script type="text/javascript">
			...
			{
				$('#error_msg').html('');
				if($("#unique_id").val()=="" || $("#unique_id").val()==null || $("#unique_id").val()==0)
				{
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
								...
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" > In order to connect with kin please add the code from landing pages.</a></div>
					
					<form action="updateKinInfo" method="POST" name="save_indexing_unique" id="save_indexing_unique">
