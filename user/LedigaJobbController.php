...
class LedigaJobbController
{
	...
	public static function shared($a=null)
	{
	 ...
	 public static function createLedigaJobbAccount($a = null, $b = null, $c = null)
    {
     ...
     $valueNew = checkLogin();
        ...
        $model = new LedigaJobbModel();
            ...
            if (!filter_var($data['website'], FILTER_VALIDATE_URL) === false) {
					$result         = $model->createLedigaJobbAccount($data);
					//echo $result; die;
					
							
							header("location:../../LedigaJobb/companyAccount/".$data['cid']);
