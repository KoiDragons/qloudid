				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40   xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Please update your delivery address here.</a></div>
									
									<form action="../updateDeliveryAddress/<?php echo $data['aid']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($resultOrg1['is_name_same']==1) echo 'checked'; else echo "";  ?>" onclick="updateName(1,this);" >
									...
									<div class="on_clmn mart0 <?php if($resultOrg1['is_name_same']==1) echo 'hidden'; else echo "";  ?>" id="nameInfo">
								...
								<div class="pos_rel">											
									...
									<input type="hidden" id="same_name" name="same_name" value="<?php echo $resultOrg1['is_name_same'];  ?>" />
