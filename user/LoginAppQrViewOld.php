						...
						<div class="padb0 xxs-padb0 ">		
							...
							<div class="wi_400p maxwi_100   pos_rel zi5 marrla    padrl10  brdrad3 padb80">
							 ...
							 <div class="padt20 xxs-talc talc visible-xs  hidden" id="android">
								...
								<a href="https://qloudid.com/ip/<?php echo $verifyIP; ?><?php if(isset($data)) { ?>/<?php echo $data['client']; if(isset($data['apply'])) echo "/apply"; else if(isset($data['purchase'])) echo "/purchase"; else if(isset($data['signin'])) echo "/signin"; else if(isset($data['login'])) echo "/login"; }?>"><button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
						    
						     <div class="padt20 xxs-talc talc visible-xs  hidden" id="iOS">
								
								<a href="QloudidUrl://<?php echo $verifyIP; ?><?php if(isset($data)) { ?>/<?php echo $data['client'];  if(isset($data['apply'])) echo "/apply"; else if(isset($data['purchase'])) echo "/purchase"; else if(isset($data['signin'])) echo "/signin"; else if(isset($data['login'])) echo "/login"; } ?>"><button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80" >Sign in</button></a>
