		...
		<div class="column_m pos_rel">
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank"   >
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						<div class="padb0 xxs-padb0 ">		
							...
							<div class="wi_400p maxwi_100   pos_rel zi5 marrla    padrl10  brdrad3 padb80">
							 ...
							 <div class="padt20 xxs-talc talc visible-xs  hidden" id="android">
								...
								<a href="https://www.safeqloud.com/ip/<?php echo $verifyIP; ?><?php if(isset($data)) { ?>/<?php echo $data['client']; if(isset($data['apply'])) echo "/apply"; else if(isset($data['purchase'])) echo "/purchase"; else if(isset($data['signin'])) echo "/signin"; else if(isset($data['login'])) echo "/login"; }?>"><button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
						    
						     <div class="padt20 xxs-talc talc visible-xs  hidden" id="iOS">
								
								<a href="safeqloudUrl://<?php echo $verifyIP; ?><?php if(isset($data)) { ?>/<?php echo $data['client'];  if(isset($data['apply'])) echo "/apply"; else if(isset($data['purchase'])) echo "/purchase"; else if(isset($data['signin'])) echo "/signin"; else if(isset($data['login'])) echo "/login"; } ?>"><button type="button" name="forward" class="forword minhei_55p red_ff2828_bg fsz18 padrl80" >Sign in</button></a>
						...
						<div class="padtb0 brdrad3 ">
							...
							<div class="padb10  talc padt20">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?><?php if(isset($data)) { ?>/<?php echo $data['client'];  if(isset($data['apply'])) echo "/apply"; else if(isset($data['purchase'])) echo "/purchase"; else if(isset($data['signin'])) echo "/signin"; else if(isset($data['login'])) echo "/login"; } ?>" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
				...
				<label class="dblock fsz12 fleft">
				 <a href="../LoginAccount"> <span class="marl5 fsz16 xs-fsz16 valm ">Login email</span> </a></label>
				</div>
				<div class="tw_clmn padl10 talr lgn_hight_18 fsz16 wi_70"> <a href="loginAppBusiness">Business</a> </div>
				</div>
										<?php } ?>
						</div>
...
<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 xs-marb0 xs-mart65 mart40 xs-mart20 marb0" id="loginBankMsg" style="display:none;">
			<div class="wrap maxwi_100   xs-nobrdb xs-padt15 xs-padb0 mart0 xs-mart0">
				<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						<div class="padb0 xxs-padb0 ">		
							<div class="padb0 talc fsz60 padt20"><img src="https://media.giphy.com/media/26AHONQ79FdWZhAI0/giphy.gif" width="140px;" height="140px;"></i></div>
									<h1 class="marb0  mart20 xxs-talc talc fsz25 xs-fsz20  padb0 black_txt trn ffamily_avenir"  >Qloud ID</h1>
									</div>
									<div class="mart20 marb35 xxs-talc talc   xs-marb20 xs-mart0"> <a href="#" class="black_txt fsz18  xs-fsz16 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" id="errorMsg">Type in your security code in the Qloud ID app.</a></div>
				...
				<div class="tw_clmn padrl0 xs-padrl0 wi_30">
				<label class="dblock fsz12 fleft">
				  <span class="marl5 fsz16 xs-fsz16 valm ">Cancel</span> </label>
				</div>
				<div class="tw_clmn padl10 talr lgn_hight_18 fsz16 wi_70"> <a href="#">Need help?</a> </div>
				</div>
						</div>
...
<div class="popup_modal wi_350p maxwi_90 pos_fix pos_cen zi50 bs_bb  white_bg fsz14 brdrad5" id="gratis_alert" onLoad="this.focus();">
		<div class="modal-content pad25  nobrdb talc brdrad5">
			
			
			
			<h2 class="marb10 pad0 bold fsz24 black_txt">Success!</h2>
			<span></span>
			<div class="wi_100 dflex fxwrap_w marrla marb20 tall">
				...
				<div class="wi_100 marb10 talc">
					...
					<span class="valm fsz16">You have successfully logged in</span>
				</div>
