				...
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
					 ...
					 <div class="tab-header martb10 padb10 xs-tall brdb2_3B71FE nobrdt nobrdl nobrdr talc">
									   <a href="#" class="dinlblck marni5 padrl30  xs-marl0  nobrd  bg_3B71FE brdrad40 xxs-brdrad10 lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active" >Availability</a></div>
									 
								 <form action="../addUserDetailForReservation/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<input type="hidden" name="checkin_date" id="checkin_date" value="<?php echo $_POST['checkin_date']; ?>"/>
									...
									<form action="../addUserForReservation/<?php echo $data['aid']; ?>" method="POST" id="save_indexing1" name="save_indexing1" accept-charset="ISO-8859-1">
								...
								<input type="hidden" name="checkin_date" id="checkin_date" value="<?php echo $_POST['checkin_date']; ?>"/>
									...
									<input type="hidden" name="room_price" id="room_price" value="<?php echo $_POST['room_price']; ?>"/>
									 ...
									 <a href="javascript:void(0);" onclick="submitForm();">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey2_bg brdrad5  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text   padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Guest is at frontdesk</span>
													   
													   
													  </div>
													 
													<div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz30 padt5  padb0 xxs-marr20 ">
									...
									<a href="javascript:void(0);" onclick="submitForm1();">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey2_bg brdrad5  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text   padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Guest is in contact</span>
