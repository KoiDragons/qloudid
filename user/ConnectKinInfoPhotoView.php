			...
			<div class="clear"></div>
				...
				<div class="padrl10 white_bg xs-padrl25">
					<div class="wrap maxwi_100   xs-nobrdb xs-padt15 xs-padb0 mart40 xs-mart0">
							...
							<h1 class="marb0  xxs-talc talc fsz35 xs-fsz25 bold marb5 black_txt trn" >Du är snart klar...</h1>
								<div class="marb20  xxs-talc talc"> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc talc edit-text jain_drop_company" >Please add your kin image here.</a></div>
<form action="../updateKinInfo/<?php echo $data['kin_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
