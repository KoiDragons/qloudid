...
if( ios ) {
   ...
   $('#android').removeClass('hidden');
		...
		function ajaxSend()
			...
			send_data1.payForFood='<?php echo $_GET['payForDishes']; ?>';
			send_data1.booking_id='<?php echo $data['id']; ?>';
			send_data1.serviceType='<?php echo $_GET['serviceType']; ?>';
					...
					success: function(data2){
						...
						if(data2!=2)
						{
							...
							else if(data2==1)
							{
								...
								$("#errorMsg").html("Please verify your self and type in your security code in the Qloud ID app..");
								return false;
							}
							 else if(data2==3)
							{
						...
						<div class="padtb0 brdrad3 ">
						 <div class="padt20 xxs-talc talc visible-xs hidden" id="android">
							...
							<div class="padb10  talc padt20 hidden-xs">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/payForDishes/<?php echo $_GET['payForDishes']; ?>/<?php echo $_GET['client_id']; ?>" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
