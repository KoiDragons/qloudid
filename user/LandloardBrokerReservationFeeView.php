...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Reservation fee required to paid for confirmation
</div>
...
<?php if($guestReservationDetail['reservation_fee_details']['is_paid']==0) { ?>
<a class="button checkout__button changedText" href="../sendInvoceInformation/<?php echo $data['rid']; ?>"  >Handle fee</a>
