...
<link rel="stylesheet" media="all" href="../../../html/fleet/css/app.min.css">
	<script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script type="text/javascript" src="../../../html/usercontent/js/jquery.js"></script>
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		var timeout=0;
			...
			{
				//checkPopup();
				send_data1.orderRef='NDF4cFUxVHZ1T1c4UG5rSWI2bUZVQT09';
...
<!-- outer-->
<div class="outer" style="background: #ffffff;">
<!-- header-->
...
<div class="price__preview "><img src="../../../html/usercontent/images/iconLogoColorGradient.png" class="" style="width: 150px;height: 150px;"></div>
</div>

</div>
<div class="receipt__foot">
<div class="receipt__free" style="margin-bottom: 5px;font-size: 25px;color: black;">Timed out</div>
				
				
				
</div>
<div class="receipt__foot">
<div class="receipt__free" style="font-size: 15px;color: grey;">Your 60 seconds are up. Try again by scaning the QR code with your Qloud ID app

</div>
				<a class="button receipt__button    hidden" href="safeqloudUrl://NDF4cFUxVHZ1T1c4UG5rSWI2bUZVQT09"><span>Shop online</span>
...
<a class=" " style="text-decoration:none !important;visibility: visible;" href="https://www.safeqloud.com/user/index.php/LoginAccount/loginapp" id="iOS">
...
<div class="receipt__subtitle" style="color:white !important;">Try again</div>
</div>
</div>
</div></a>
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button" href="https://www.safeqloud.com/ip/NDF4cFUxVHZ1T1c4UG5rSWI2bUZVQT09" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
