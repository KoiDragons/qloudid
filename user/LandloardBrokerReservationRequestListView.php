...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="#">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg><span>Go home</span></a>
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Reservations</a></li>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Sent requests</div>
                                      </a>
		  ...
		  <div class="flights__sorting hidden-xxs " style="margin-top:0px; border-top:0px !important; margin-bottom:0px;  padding:0 !important;">
            ...
            <div class="flights__row">
               ...
               <div class="flights__container" style="padding-left:0px;">
				...
				<?php $i=1; 
								foreach($reservationRequestList as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;"><?php echo  substr(html_entity_decode($value['company_details']['company_name']),0,25); ?></div>
...
">
			 <div class="description__parameter" style="margin-top: 0px;">
				...
				<div class="description__parameter" style="margin-top: 0px;">
                  ...
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>Apartment no <?php echo  $value['apartment_details']['office_apartment_number']; ?></div>
				  
              </div>
			    
                       
                    
    <a class="header__logo xs-fsz20 changedText fright " href="guestReservationTimelineInfo/<?php echo $value['enc']; ?>" style="
