...
<html>
		...
		if($dependentDetail ['image_path']!=null) { $filename="../estorecss/".$dependentDetail ['image_path'].".txt"; if (file_exists($filename)) { $value_a=file_get_contents("../estorecss/".$dependentDetail ['image_path'].".txt"); $value_a=str_replace('"','',$value_a); $imgs = base64_to_jpeg( $value_a, '../estorecss/tmp.jpg' );  $imgs='../../../'.$imgs; } else { $value_a="../../../../html/usercontent/images/default-profile-pic.jpg";  $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; } }  else { $value_a="../../../../html/usercontent/images/default-profile-pic.jpg"; $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; }
			...
			<div class="column_m container zi5 mart20  xs-mart0 white_bg xs-white_bg">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0 ">
					...
					<div class="wi_500p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla  brdrad3 white_bg xs-white_bg">
						...
						<p class="lgn_hight_16 padt20 talc fsz20   padb0 marb0 xs-padb5 yellow_txt bold"><?php if($dependentDetail['is_approved']==0) echo 'Pending'; else if($dependentDetail['is_approved']==3) echo 'Rejected'; ?></p>
<h1 class="lgn_hight_35 padt10 padb20 xs-padb10 talc fsz35 black_txt"><?php echo $dependentDetail['name']; ?></h1>
						
						<p class="lgn_hight_16 padt10 talc fsz20   padb10 marb0 xs-padb5 grey_new_txt"><?php echo $dependentDetail['ssn']; ?></p>
						 
						
							
						
						<p class="lgn_hight_16 padt0 talc fsz20   padb10 marb20 xs-padb5 xxs-marb100 grey_new_txt"><?php echo date('m/y',strtotime($dependentDetail['created_on']))."      123";?></p>

						<?php  if($dependentDetail['is_approved']==0) { ?>
						<div class="marrl0 wi_500p maxwi_100 dflex xs-fxwrap_w talc padt20 padb40   xs-padb0">
						
						 
						
						 	<div class="wi_25-12p marl123 xxs-mar87">
						<a href="../../Dependents/approveRequest/<?php echo $data['did']; ?>" class="fsz30 ">
				...
				<a href="../../Dependents/rejectRequest/<?php echo $data['did']; ?>" class="fsz30 ">
