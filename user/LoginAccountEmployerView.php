...
<div class="outer" >
<!-- header-->
<div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg hidden" style="padding:0px;">
				<div class="wi_100 hei_45p xs-pos_fix padt0 padrl10 black_bg" style="background:#00000 !important">
				
				 
			<a href="#"> <div class=" talc   padt10 padb0 hei_45p white_txt">
					* Upload ID *
				</div></a>
...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Hello, <?php echo $userDetail['first_name']; ?>
</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Add or choose your workplace to begin your journey.
</div>
...
<?php 
foreach($listEmployers as $category => $value) 
{
?> 
...
<div class="checkout__label changedText"><?php echo $value['company_name']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo  $value['count']; ?> employees</div>
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $value['company_name']; ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo  $value['company_email']; ?></div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo  $value['count']; ?> employees</div>
