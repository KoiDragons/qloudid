...
<div class="_1anKb-nl hidden-xs padb20"><div data-test-target="main_h1" class="LZSItUvx"><h1 class="HLvj7Lh5 jObdbvmD fsz75 nobold xs-fsz25 talc brdb ffamily_avenir black_txt"><span>  <span class="{geoClass}"><?php echo $resturantinfo['resturant_name']; ?></span></span></h1></div></div>									
         ...
         <div class="_2JGsjxnm">
            <div class="Ffh78ncj _1JCEdqUg _3auwW4vL _3XQY3qGv">
               ...
               <div class="_1KB7D5C1 _3n93WwqC" style="display:block;">
                  <div class="jOxjYW1k"><span class="fhoh290_"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Föregående"  onclick="plusSlides(-1,<?php echo $value['serve_type'].''.$value1['category_food']; ?>);"><span class="E0di58-K _2HBN-k68 _3LkX-HIr" style="font-size: 20px;"><i class="fas fa-long-arrow-alt-right"></i></span></button></span></div>
               </div>
               <div class="_1KB7D5C1 _2bfEA-AB" style="display:block;">
                  <div class="jOxjYW1k"><span class="fhoh290_"><button class="_3ghuVozE _2xHyLFC5 Q0-NuII9" type="button" aria-label="Nästa" onclick="plusSlides(1,<?php echo $value['serve_type'].''.$value1['category_food']; ?>);"><span class="UmD9_PK8 _2HBN-k68 _3LkX-HIr" style="font-size: 20px;"><i class="fas fa-long-arrow-alt-right"></i></span></button></span></div>
               </div>
            </div>
         </div>
      </div>
