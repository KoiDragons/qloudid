								...
								<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03  brdr_new fsz14" id="scroll_menu">
									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock padb10 padl8">
											<a href="https://www.qloudid.com/user/index.php/CompanySuppliers/companyAccount/<?php echo $data['cid']; ?>" class="lgtgrey_bg hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
										...
										<li class=" dblock padb10 padl8 ">
											<a href="https://www.qloudid.com/user/index.php/CompanyCustomers/companyAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="https://www.qloudid.com/user/index.php/CompanyConsentPlatform/companyAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Verifiera ID</span><span class="counter_position"><?php echo $verifyIDReceivedCount; ?></span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												...
												<li class="dblock padrb10">
													<a href="https://www.qloudid.com/user/index.php/WhitelistIP/ipAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Besökare</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
												...
												<li class="dblock padrb10">
													<a href="https://www.qloudid.com/user/index.php/Apps/companyAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">API</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
													<a href="https://www.qloudid.com/company/index.php/CompanyUpdates/updateInfo/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Updates</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
													<a href="https://www.qloudid.com/user/index.php/WhitelistIP/statistics/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Statistics</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
													<a href="https://www.qloudid.com/user/index.php/ManagePermissions/manageAdmin/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Company Admins</span><span class="counter_position"><?php echo $adminRequestReceivedCount; ?></span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
									...
									<div class="">
										...
										<div class="tab_container mart5">
											...
											<div class="tab_content hide active" id="utab_Popular" style="display: block;">
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[0]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[0]['is_downloaded']==0) echo 'hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="marb10 padrl20">
																<a href="#" class=" dblock blue_bg talc lgn_hight_40 white_txt" data-target="#pipefy_sliding_modal">Gå till</a>
															</div>
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[0]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												</div>
											
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[1]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[1]['is_downloaded']==0) echo 'hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[1]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												</div>
												
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[10]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[10]['is_downloaded']==0) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[10]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[2]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[2]['is_downloaded']==0) echo 'hidden';  } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[2]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
												...
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[3]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[3]['is_downloaded']==0) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[3]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												</div>
												
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[4]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[4]['is_downloaded']==0) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[4]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												</div>
												...
												<?php if($aboutUsCount==0) { ?>
												
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[5]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[5]['is_downloaded']==0) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															<h3 class="marb15 talc bold fsz16">Medlemskap HR</h3>
															<div class="marb10 padrl20">
																<a href="#" class="show_popup_modal dblock blue_bg talc lgn_hight_40 white_txt" data-target="#gratis_popup_company_search">Branding</a>
															</div>
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[5]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															<h3 class="marb15 talc bold fsz16">Medlemskap HR</h3>
															<div class="marb10 padrl20">
																<a href="#" class="show_popup_modal dblock blue_bg talc lgn_hight_40 white_txt" data-target="#gratis_popup_company_searched">Branding</a>
															</div>
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[5]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[6]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[6]['is_downloaded']==0) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															<h3 class="marb15 talc bold fsz16">Medlemskap HR</h3>
															<div class="marb10 padrl20">
																<a href="https://www.qloudid.com/walk/authorize.php?response_type=code&client_id=eEFnQmlhS29sYjZHZXVZN01QajNVdz09&state=xyz&login=1" class=" dblock blue_bg talc lgn_hight_40 white_txt" >Activate</a>
															</div>
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[6]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[7]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[7]['is_downloaded']==0) echo 'hidden'; } ?>">
															<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															<h3 class="marb15 talc bold fsz16">Medlemskap HR</h3>
															<div class="marb10 padrl20">
																<a href="#" class=" dblock blue_bg talc lgn_hight_40 white_txt" >Activate</a>
															</div>
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[7]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[8]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[8]['is_downloaded']==0) echo 'hidden';  } ?>">
															<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[8]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												
													</div>
														<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[9]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[9]['is_downloaded']==0) echo 'hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
																	...
																	<div class="trf_y-10p_ph trans_all2 padrbl15 padt10">
																		<h3 class="ovfl_hid pad0 txtovfl_el ws_now lgn_hight_24 bold fsz16 segdblue_txt padt10">Receptionist</h3>
																		<span class="dblock marb5 midgrey_txt">Sales</span>
																		<div class="opa0 opa1_ph lgn_hight_15 fsz14 seggreen_txt trans_all2">View details</div>
																	</div>
																</div>
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[9]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Inställningar</a>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[0]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[0]['is_downloaded']==1) echo 'hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[0]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
											
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[1]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[1]['is_downloaded']==1) echo 'hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[1]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
												
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[10]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[10]['is_downloaded']==1) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[10]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[2]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[2]['is_downloaded']==1) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[2]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
												...
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[3]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[3]['is_downloaded']==1) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[3]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
												
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[4]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[4]['is_downloaded']==1) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[4]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[5]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[5]['is_downloaded']==1) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[5]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[6]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[6]['is_downloaded']==1) echo 'hidden'; } ?>">
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[6]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[7]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[7]['is_downloaded']==1) echo 'hidden'; } ?>">
															<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[7]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
													...
													<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[8]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[8]['is_downloaded']==1) echo 'hidden'; } ?>">
															<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[8]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
														...
														<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[9]['is_permission']==0) echo 'hidden'; if($getPermissionDetail[9]['is_downloaded']==1) echo 'hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
																<div class="trf_y-12p_ph trans_all2">
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[9]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
