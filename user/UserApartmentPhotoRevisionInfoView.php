					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
									 ...
									 <div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="<?php if($photoCount==1) { echo 'green_bg_00ff9996'; } else  { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
									...
									<div class="clear"></div>
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="<?php if($resultOrg1['key_updated']==1) { echo 'green_bg_00ff9996'; } else  { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Key available</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Add/update Key info</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
													
													<a href="../apartmentKeyInfo/<?php echo $data['aid']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
									...
									<div class="clear"></div>
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="<?php if($resultOrg1['nickname_updated']==1) { echo 'green_bg_00ff9996'; } else  { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
									...
									<div class="clear"></div>
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="<?php if($resultOrg1['headline_updated']==1) { echo 'green_bg_00ff9996'; } else  { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
									...
									<div class="clear"></div>
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="<?php if($resultOrg1['description_updated']==1) { echo 'green_bg_00ff9996'; } else  { echo 'red_bg_FB757C'; } ?>   bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Availability</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Add/update booking availability</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
