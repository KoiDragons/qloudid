...
<a class="header__logo xs-fsz25 changedText" href="https://www.safeqloud.com/user/index.php/NewPersonal/addressList" style="
...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Add Your Workplace</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Provide employees with the apps to effectively manage their work responsibilities</div>
...
<div class="upload__head hidden">
                  <h2 class="upload__title h2 white_txt changedText" style="font-size:32px;">Business details</h2>
                </div>
					   ...
					   <div class="checkout__subtitle uppercase changedText white_txt">Business details</div>
						   ...
						   <div class="field" style="margin-bottom:24px; border-color:#353945;">
                            ...
                            <div class="field__wrap">
                             <select class=" xs-fieldData" id="company_type" name="company_type" style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"  >
						  ...
						  <div class="field  margin-bottom24" style="border-color:#353945;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="company_name" id="company_name" placeholder="e. g. Qloud ID" style=" border-color:#353945; color:grey;"  >
                            </div>
                          </div>
						  <div class="upload__row margin-bottom24" >
						   ...
						   <div class="upload__col upload__col_w30">
                            ...
                            <div class="field__wrap">
                             <select class=" xs-fieldData"   style="height: 48px;
    padding: 0 14px;  border-color:#353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"  disabled>
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="cid" id="cid" placeholder="e. g. 123456789" style=" border-color:#353945; color:grey;"  >
                            </div>
                          </div>
						   </div>
						   </div>
...
<div class="upload__row">
                        ...
                        <div class="field  " style="border-color:#353945;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="adrs1" id="autocomplete"   placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="port_number" id="port_number" placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
 ...
 <div class="upload__row">
                        ...
                        <div class="field  ">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="daddress" id="daddress"   placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="d_port_number" id="d_port_number" placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="dzip" id="dzip"    type="text" placeholder="e. g. 111111"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
 <div class="upload__col upload__col_w70">
...
<div class="field__wrap">
<input class="field__input xs-fieldData"  name="dcity" id="dcity"    type="text" placeholder="e. g. Stockholam"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
</div>
...
<div class="on_clmn mart20 " style="display:none;">
					...
					<div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                         <div class="setting__subtitle">If Invoice address is same as delivery address?</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick="updateRent(this);" checked><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                        ...
                        <div class="field  ">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="iaddress" id="iaddress"   placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="i_port_number" id="i_port_number" placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<div class="field__label changedText" style="color:#787f91;">Zipcode</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="izip" id="izip"    type="text" placeholder="e. g. 111111"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
 <div class="upload__col upload__col_w70">
...
<div class="field__label changedText" style="color:#787f91;">City</div>
<div class="field__wrap">
<input class="field__input xs-fieldData"  name="icity" id="icity"    type="text" placeholder="e. g. Stockholam"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
</div>
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" name="position_type" id="position_type"    >
						 <option value="0" class="lgtgrey2_bg changedText">Select</option>
														<option value="1" class="lgtgrey2_bg">Vanlig anstalld</option>
													<option value="2" class="lgtgrey2_bg">Chef / Ledare</option>
													<option value="3" class="lgtgrey2_bg">Agare</option>
                                    </select>
                            </div>
                          </div>
