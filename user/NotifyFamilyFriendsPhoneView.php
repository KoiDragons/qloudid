...
<body class="white_bg">
		...
		?>
		<div class="column_m header xs-header xsip-header xsi-header bs_bb hidden-xs" style="background: linear-gradient(134deg, #fab4d1 0%, #f5a 100%);">
				<div class="wi_100 hei_65p xs-pos_fix padtb5 padrl10 " style="background: linear-gradient(134deg, #fab4d1 0%, #f5a 100%);">
				
				<div class="logo marr15 wi_115p ">
				
					<a href="#"> <h3 class="marb0 pad0 fsz27 bold padt10 padb10 fntwei_600" style="font-family: 'Audiowide', sans-serif; color:#ff5bac;">NOFFA</h3> </a>
				...
				<div class="visible-xs visible-sm fleft padl10">
							...
							<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="javascript:void(0);" class="lgn_hight_s1 padl10 fsz30" style="color:#fe7ab5f5;"><i class="fas fa-globe" onclick="togglePopup();"></i></a>
										...
										<li class="last">
											<div class="emailupdate_menu padtb15">
												...
												<ol>
													...
													<li>
														<div class="user_pic padt5"><a href="javascript:void(0);"><img src="https://www.noffalarm.com/html/usercontent/images/slide/flag_gm.png" width="45" height="45" alt="email" title="email"class="lang_selector" data-value="de" onclick="togglePopup();"></a></div>
			...
			<div class="flag_top_menu flefti padt10 padb10 hidden-xs" style="width: 50px; ">
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows">
                  ...
                  <li class="fsz14">
													...
													<li>
														<div class="user_pic padt5"><a href="javascript:void(0);" ><img src="https://www.noffalarm.com/html/usercontent/images/slide/flag_gm.png" width="28" height="28" alt="email" title="email"data-value="de" class="lang_selector" onclick="togglePopup();"></a></div>
														<div class="mail_content padt10 "> <a href="javascript:void(0);" class="fsz14 black_txt lang_selector" data-value="de" onclick="togglePopup();">  German </a> </div>
													</li>
                  <li>
		...
		<div class="fright xs-dnone sm-dnone padt10 padb10">
					<ul class="mar0 pad0 sf-menu fsz14">
						...
						<li class="dblock hidden-xs hidden-sm fleft pos_rel brd2 brdclr_black brdrad5 marl20"> <a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl20  uppercase lgn_hight_25 black_txt black_txt_h" data-en="Skapa konto" data-sw="Skapa konto">Skapa konto</a> </li>
						
						 
						<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_black  marl20 brdl"> <a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl20  uppercase lgn_hight_25 black_txt black_txt_h" data-en="Logga in" data-sw="Logga in">Logga in</a> </li>
						
					</ul>
				</div>
			<div class="hidden fright marr10 padr10 padt10  brdwi_3"> <a href="#" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">About</a> </div>
				<div class="clear"></div>
			</div>
		</div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">	
									...
									<!-- Logo -->
									<div class="martb20  xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Please add/update mobile number.</a></div>
							...
							<div class="padt5 xxs-talc talc">
								...
								<button type="button" name="forward" class="forward hei_55p bg_ff5bad fsz18 ffamily_avenir" onclick="submit_info();">Update</button>
