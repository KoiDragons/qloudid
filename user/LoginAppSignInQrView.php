   ...
   $('#android').removeClass('hidden');
	...
	<div class="clear" id=""></div>
		...
		<div class="column_m pos_rel">
			...
			<form action="loginSignDocument<?php if(isset($data)) { ?>?next=<?php echo $data['client']; if(isset($data['apply'])) echo "&apply=".$data['apply']; else if(isset($data['purchase'])) echo "&purchase=".$data['purchase']; else if(isset($data['signin'])) echo "&purchase=".$data['signin']; else if(isset($data['login'])) echo "&login=".$data['login']; } ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
