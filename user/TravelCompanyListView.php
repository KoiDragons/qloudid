				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart20 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc xs-padb15  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" > Important informaton about <?php echo $travelCountry['country_name']."'s ".$emergencyAppDetail['emergency_name']; ?></a></div>
					...
					<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
									...
									<script>
										function add_more_app_company(link) {
											...
											$.ajax({
												type:"POST",
												url:"../moreTravelAppCompany/<?php echo $data['eid']; ?>",
												data:send_data,
												dataType:"text",
