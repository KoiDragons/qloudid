...
<html>
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.qloudid.com/user/index.php/ConnectKin/welcomeKin" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true" style="color:#e02680;"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
                <div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu  fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="https://www.qloudid.com/user/index.php/ConnectKin/welcomeKin" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
								</li>
					...
					<div class="visible-xs visible-sm fright marr0 padt5 "> <a href="kinInfo" class=" diblock padl7 padr7 brdrad3 fsz30 pink_ff5bad"><i class="fas fa-plus " aria-hidden="true"></i></a> </div>
                <div class="clear"></div>
							...
							<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75" style="height: 381px;">
								...
								<div class="column_m padb10 ">
									...
									<li class=" dblock padr10 padb10 padl8">
											<a href="kinInfo" class=" lgtgrey_bg hei_35p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a" >
	...
	<a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brdb_blue brdclr_pink_ff5bad black_txt  padb10"> <span class="valm trn" style="letter-spacing: 2px;">Emergency book</span> 
	<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>
	...
	<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
				...
				<li class="dblock padrb10">
					<a href="../UserHealthInfo" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Health</span> 
					<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>								
					 ...
					 <div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl20 xs-pad0">
						...
						<div class="padb20 xxs-padb0 ">
							<!-- Charts -->
							 ...
							 <div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 bgclr_pink_ff5bad  " onclick="checkFlag();">
	...
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
			...
			<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 white_txt trn ffamily_avenir">Contact</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="white_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">This is your emergency contact list.</a></div>
									</div>
             ...
             <div class="column_m   talc lgn_hight_22 fsz16 lgtgrey_bg  " >
                        <div class="wrap maxwi_100 xs-padr25 xs-padl10   lgtgrey_bg    tall  ">
                           <div class="wi_auto  hei_65p maxwi_100   pos_rel zi5 marrla    brdrad5  padrl30">
                              <div class="martb15  xxs-talc talc ffamily_avenir"> <a href="connectAccount" class="black_txt fsz18 xs-fsz16  xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Manage your contacts</a></div>
                           </div>
                        </div>
                     </div>     
								 ...
								 <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt brdt_ff5bad  mart20">
                                <div class="container ">
                                    <div class="">
                                  ...
                                  <div class="tab_content active" id="utab_Advertising" style="display: block;">
										...
										<div  id="employerRequest">
											<?php $i=0;
												...
												foreach($requestedContactDetail as $category => $value) 
												{
										...
										<div class="container  padb20 padt15    brdrad1 fsz18 dark_grey_txt">
											...
											<div class="fleft wi_40     "> <span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 padb0  ffamily_avenir"><?php echo date('Y-m-d',strtotime($value['created_on'])); ?></span>
											<span class="trn fsz18  black_txt ffamily_avenir  "><?php echo $value['name']; ?></span>  </div>
													
												<div class="fright wi_20  xs-marr20   "> <span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 padb0  ffamily_avenir">Status</span>
											<span class="trn fsz18  black_txt ffamily_avenir  "><?php if($value['is_approved']==1) echo 'Approved'; else echo 'Pending'; ?></span>  </div>	 
