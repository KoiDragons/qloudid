  ...
  (function() {
    ...
    ios = /iphone|ipod|ipad/.test( userAgent );
		...
		function ajaxSend()
			...
			send_data1.loginType=2;
			send_data1.client_id='-';
				$.ajax({
					type:"POST",
    ...
    <div class="outer">
      ...
      <header class="header js-header header_border bgcolor_F4B400 xs-padding2424">
        <div class="header__center center"><a class="header__logo" href="https://www.safeqloud.com/public/index.php/CorporateServicesEng" ><button class="button button-stroke button-small header__button" style="border-color:#ff0000; background-color:#ff0000; box-shadow: 0 0 0 2px #ff0000 inset; font-size:18px; min-width: 5em !important;">Close</button></a>
          <div class="header__wrapper js-header-wrapper">
            <div class="header__item header__item_dropdown js-header-item">
              <button class="header__head js-header-head" style="color:#000000; font-size:20px;">This is a demo for how to shop online using Qloud ID
	   ...
	   <div class="outer__inner">
         <form action="../../../../public/index.php/Eshop/deliveryAddress/<?php echo $data['cid']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
			
			<input type="hidden" name="ip" id="ip" value="<?php echo $verifyIP; ?>" />
			</form>
	 	<div class="column_m talc lgn_hight_22 fsz16 mart175 " id="loginBankMsg" style="margin-top:80px; display:none;">
...
<div class="main__info info margin-bottom16 white_txt" >Then type your security code for verification.</div>
        ...
        <div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" style="margin-top:80px;">
          <div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
		  <div class="wi_450p maxwi_100 pos_rel zi5 marrla ">
             <div class="receipt xs-margin0">
			  
              <div class="receipt__head hidden-xs"   style="padding:0px; display:block; text-align:center; margin-top:10px;">
                <div class="receipt__details">
                 <div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/<?php echo $data['cid']; ?>/purchase/2" class="white_brd brdrad5"  style="width:235px; height:235px; "></div>
                </div>
                
              </div>
              <div class="receipt__description talc">
                <div class="receipt__item talc" style="justify-content: center;">
                  
                  <div class="receipt__box">
                     <div class="receipt__subtitle">Shop online using Qloud ID</div>
                  </div>
                </div>
              </div>
               <div class="receipt__foot">
				...
				<a class="button receipt__button visible-xs  hidden" href="safeqloudUrl://<?php echo $verifyIP; ?>/<?php echo $data['cid']; ?>/purchase/2" id="iOS"><span>Shop online</span>
                  <svg class="icon icon-bag">
                    <use xlink:href="#icon-bag"></use>
                  </svg></a>
				  
				  <a class="button receipt__button visible-xs  hidden" href="https://www.safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['cid']; ?>/purchase/2" id="android"><span>Shop online</span>
                  <svg class="icon icon-bag">
                    <use xlink:href="#icon-bag"></use>
                  </svg></a>
              </div>
