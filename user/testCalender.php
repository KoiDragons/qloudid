...
<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="../html/bookadirect/main.css">
      <link rel="stylesheet" type="text/css" media="all" href="../html/bookadirect/reactloadingbar.css">
      <link rel="stylesheet" type="text/css" media="all" href="../html/bookadirect/web.css">
		<link href="https://fonts.googleapis.com/css?family=Audiowide" rel="stylesheet">
		<link href="https://fonts.googleapis.com/css?family=Allerta+Stencil" rel="stylesheet">
		 <link rel="stylesheet" id="boka-style" href="https://www.bokadirekt.se/css/web.css?1641301425" media="screen">
        <script src="https://www.bokadirekt.se/js/no-pollution.js"></script>
        <script src="https://www.bokadirekt.se/js/mobile-detect.min.js"></script>
        <link rel="stylesheet" href="https://www.bokadirekt.se/css/react-loading-bar.css" media="all" onload="this.media=&quot;all&quot;">
        <link rel="stylesheet" href="https://www.bokadirekt.se/css/ReactToastify.min.css" media="all" onload="this.media=&quot;all&quot;">
		  <link href="/statichttps://www.bokadirekt.se/css/main.f0ca2b7d.chunk.css" rel="stylesheet">
		    <link type="texthttps://www.bokadirekt.se/css" rel="stylesheet" charset="UTF-8" href="https://translate.googleapis.com/translate_statichttps://www.bokadirekt.se/css/translateelement.css">
		<!-- Scripts -->
		...
		function getNewCalender(id)
		{
			$('#date_flag').val(id);
		var send_data={};
		send_data.date_flag=id;
		send_data.employee_id=$('#employee_id').val();
		send_data.message=id;
		$.ajax({
            type:"POST",
            url:"../../../getNewCalender/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09/WERweGRZUmdXZCs3b0JQRVlWSVgyUT09",
            data:send_data,
            dataType:"text",
            contentType: "application/x-www-form-urlencoded;charset=utf-8",
            success: function(data1){
									$("#calenderinfo").html('');
								$("#calenderinfo").html(data1);
									 
										}
									});
		}
		
		function updateEmployeeTime(id,id1,id2,id3)
		{
		$('#booking_date').val(id);
		$('#booking_time').val(id1);
		$('#total_booking_time').val(id3);
		$('#booking_employee_id').val(id2);
...
<button class="header__head js-header-head fsz16 ">
...
<a class="button button-stroke button-small header__button    fsz16 visible-xs hidden changedText" href="#" style="border:2px solid #333; padding-top:10px;">Vacant position</a>
			...
			<div class="header__item header__item_notification js-header-item visible-xs">
<button class="header__head js-header-head active" fdprocessedid="3i5gzc">
<svg class="icon icon-globe">
<use xlink:href="#icon-globe"></use>
</svg>
</button>
<div class="header__body js-header-body">
<div class="header__title changedText">Language</div>
<div class="header__notifications">
			<a class="header__notification dropdown-item" href="javascript:void(0);" tolang="en">

<div class="header__details">
<div class="header__subtitle changedText">English</div>

<div class="header__status" style="background-color: #3B71FE;"></div>
</div></a>
				<a class="header__notification dropdown-item" href="javascript:void(0);" tolang="sv">

<div class="header__details">
<div class="header__subtitle changedText">Swedish</div>

<div class="header__status" style="background-color: #3B71FE;"></div>
</div></a>
				
				<a class="header__notification dropdown-item" href="javascript:void(0);" tolang="ru">

<div class="header__details">
<div class="header__subtitle changedText">Russian</div>
...
<div class="column_m pos_rel">
              ...
              <div class="column_m container zi5  mart40  xs-mart0">
                <div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
						...
						<div class="padb0 xxs-padb0 ">		
							<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn">Calender</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc   xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please select a suitable date and time combination</a></div>
					...
					<div style="position: relative;">
									...
									<p class="sticky !top-16 z-[100] m-0 flex flex-col items-center justify-center bg-white p-3 uppercase"><span class="font-semibold text-gray-900"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Jun 08 - Jun 14</font></font></span><span class="text-xs text-gray-700"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Week 45</font></font></span></p>
                                        ...
                                        <div class="sticky !top-32 z-[100] bg-white shadow">
                                            <div class="slick-slider slick-calendar slick-initialized">
                                                <div class="slick-list">
                                                    <div class="slick-track" style="width: 700px; opacity: 1; transform: translate3d(0px, 0px, 0px);">
                                                        <div data-index="0" class="slick-slide slick-active slick-current" tabindex="-1" aria-hidden="false" style="outline: none; width: 700px;">
                                                            <div>
                                                                <div class="!flex w-full justify-between" tabindex="-1" style="width: 100%; display: inline-block;">
                                                                     <div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-0 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Thu</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-1 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Fri</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-2 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Sat</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-3 text-gray-300"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Sun</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11</font></font></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-4 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Mon</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-5 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tue</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-6 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Wed</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="absolute left-0 -top-12 z-20"><button class="
  rounded-full
  inline-flex
  items-center
  justify-center
 ...
 <div class="absolute right-0 -top-12 z-20"><button onclick="getNewCalender(1);" class="
  ...
  focus:!ring-2
  duration-300
  transition-colors text-green border-none  X1LqXa1wBWadrQb2cUbq focus:!ring-0" fdprocessedid="wtxw7p"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Later</font></font><span class="flex items-center justify-center ml-2 h-5 w-5"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-3 -rotate-90"><path d="M1.48698 8.81659C1.17469 8.50765 0.999521 8.08836 1 7.65097C1.00048 7.21358 1.17657 6.79392 1.48953 6.4843C1.8025 6.17468 2.2267 6.00047 2.66881 6C3.11093 5.99953 3.53475 6.17282 3.84703 6.48177L11.5056 14.0585L19.1563 6.48967C19.3112 6.3364 19.4951 6.21476 19.6973 6.13169C19.8996 6.04861 20.1164 6.00573 20.3352 6.0055C20.5541 6.00526 20.7708 6.04768 20.9729 6.13032C21.175 6.21296 21.3586 6.33421 21.5132 6.48714C21.6677 6.64007 21.7903 6.8217 21.8738 7.02164C21.9574 7.22159 22.0002 7.43594 22 7.65245C21.9998 7.86897 21.9564 8.08341 21.8724 8.28353C21.7885 8.48366 21.6655 8.66555 21.5106 8.81881L12.7071 17.5282C12.3755 17.8348 11.9377 18.0037 11.4844 17.9999C11.031 17.9961 10.5969 17.8199 10.2721 17.5077L1.48698 8.81659Z" fill="currentColor"></path></svg></span></button></div>
  
  
                                        </div>
                                        <div class="hours sticky">
                                            <div class="flex w-full" style="min-height: 300px;">
                                               <div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"><span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,17,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,18,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,19,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,20,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,21,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,22,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,23,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,24,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,25,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,26,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,27,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,28,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,29,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,30,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,31,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,32,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,33,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,34,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,35,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,36,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,37,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,38,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,39,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,40,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686175200,41,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:00</font></font></span></span>
									
									</div><div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"><span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,20,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,21,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,22,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,23,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,24,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,25,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,26,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,27,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,28,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,29,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,30,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,31,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,32,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,33,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,34,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,35,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,36,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,37,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,38,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,39,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,40,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,41,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,42,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686261600,43,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:00</font></font></span></span>
									
									</div><div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"><span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,15,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">07:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,16,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">07:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,17,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,18,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,19,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,20,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,21,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,22,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,23,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,24,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,25,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,26,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,27,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,28,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,29,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,30,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,31,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,32,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,33,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,34,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,35,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,36,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,37,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,38,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,39,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,40,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,41,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,42,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,43,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,44,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686348000,45,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">22:00</font></font></span></span>
									
									</div><div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"></div><div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"><span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,15,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">07:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,16,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">07:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,17,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,18,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,19,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,20,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,21,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,22,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,23,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,24,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,25,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,26,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,27,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,28,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,29,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,30,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,31,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,32,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,33,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,34,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,35,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,36,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,37,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,38,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,39,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,40,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686520800,41,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:00</font></font></span></span>
									
									</div><div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"><span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,16,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">07:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,17,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,18,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,19,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,20,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,21,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,22,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,23,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,24,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,25,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,26,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,27,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,28,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,29,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,30,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,31,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,32,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,33,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,34,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,35,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,36,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,37,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,38,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,39,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,40,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,41,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,42,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,43,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,44,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686607200,45,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">22:00</font></font></span></span>
									
									</div><div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"><span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,17,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,18,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,19,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,20,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,21,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,22,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,23,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,24,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,25,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,26,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,27,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,28,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,29,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,30,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,31,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,32,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,33,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,34,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,35,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,36,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,37,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,38,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,39,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,40,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,41,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,42,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,43,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686693600,44,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:30</font></font></span></span>
				...
				<div class="column_m bs_bb xs-padrl15">
					...
					<div style="position: relative;">
                                    <div class="calendar week-view">
									<p class="sticky !top-16 z-[100] m-0 flex flex-col items-center justify-center bg-white p-3 uppercase"><span class="font-semibold text-gray-900"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Jun 07 - Jun 13</font></font></span><span class="text-xs text-gray-700"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Week 45</font></font></span></p>
                                                ...
                                                <div class="slick-list">
                                                    <div class="slick-track" style="width: 700px; opacity: 1; transform: translate3d(0px, 0px, 0px);">
                                                        <div data-index="0" class="slick-slide slick-active slick-current" tabindex="-1" aria-hidden="false" style="outline: none; width: 700px;">
                                                            <div>
                                                                <div class="!flex w-full justify-between" tabindex="-1" style="width: 100%; display: inline-block;">
                                                                     <div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-0 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Wed</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">07</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-1 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Thu</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-2 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Fri</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-3 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Sat</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-4 text-gray-300"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Sun</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11</font></font></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-5 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Mon</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div><div class="flex-grow basis-0 border-b-[1px] border-l-[1px] border-gray-200 bg-white text-center last-of-type:border-r-[1px] colIndex-6 text-gray-900"><span class="block pt-2 text-center text-sm capitalize text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tue</font></font></span><span class="relative mx-auto mb-1 block h-11 text-lg font-semibold !leading-[44px] text-inherit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13</font></font><span class="absolute bottom-[2px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full bg-gray-900"></span></span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
 ...
 <div class="absolute right-0 -top-12 z-20"><button onclick="getNewCalender(1);" class="
  ...
  focus:!ring-2
  duration-300
  transition-colors text-green border-none  X1LqXa1wBWadrQb2cUbq focus:!ring-0" fdprocessedid="ks1p8"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Later</font></font><span class="flex items-center justify-center ml-2 h-5 w-5"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-3 -rotate-90"><path d="M1.48698 8.81659C1.17469 8.50765 0.999521 8.08836 1 7.65097C1.00048 7.21358 1.17657 6.79392 1.48953 6.4843C1.8025 6.17468 2.2267 6.00047 2.66881 6C3.11093 5.99953 3.53475 6.17282 3.84703 6.48177L11.5056 14.0585L19.1563 6.48967C19.3112 6.3364 19.4951 6.21476 19.6973 6.13169C19.8996 6.04861 20.1164 6.00573 20.3352 6.0055C20.5541 6.00526 20.7708 6.04768 20.9729 6.13032C21.175 6.21296 21.3586 6.33421 21.5132 6.48714C21.6677 6.64007 21.7903 6.8217 21.8738 7.02164C21.9574 7.22159 22.0002 7.43594 22 7.65245C21.9998 7.86897 21.9564 8.08341 21.8724 8.28353C21.7885 8.48366 21.6655 8.66555 21.5106 8.81881L12.7071 17.5282C12.3755 17.8348 11.9377 18.0037 11.4844 17.9999C11.031 17.9961 10.5969 17.8199 10.2721 17.5077L1.48698 8.81659Z" fill="currentColor"></path></svg></span></button></div>
  
  
                                        </div>
                                        <div class="hours sticky">
                                            <div class="flex w-full" style="min-height: 300px;">
                                               <div class="flex-shrink flex-grow basis-0 border-l-[1px] border-b-[1px] border-gray-100 text-center last-of-type:border-r-[1px]"><span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,17,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,18,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">08:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,19,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,20,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">09:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,21,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,22,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">10:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,23,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,24,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">11:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,25,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,26,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">12:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,27,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,28,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">13:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,29,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,30,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">14:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,31,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,32,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">15:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,33,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,34,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">16:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,35,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,36,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">17:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,37,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,38,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">18:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,39,601903,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,40,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">19:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,41,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,42,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">20:30</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,43,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:00</font></font></span></span>
									
									<span class="mx-1 my-[6px] flex h-auto cursor-pointer flex-col rounded-md border-[1px] border-solid text-center text-xs font-semibold !leading-9 md:m-2   border-green text-green hover:bg-green bg-green-100 hover:text-white" onclick="updateEmployeeTime(1686088800,44,1,1);"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">21:30</font></font></span></span>
