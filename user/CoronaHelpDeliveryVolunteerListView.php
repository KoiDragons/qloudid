...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
 ...
 <!-- CONTENT -->
	...
	<a href="listItemsDetailRequired" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Shopping list</span> 
	<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>
										<li class="dblock padrb10">
	<a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brdb_blue red_ff2828_brdclr  black_txt  padb10"> <span class="valm trn" style="letter-spacing: 2px;">Deliveries</span> 
	<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>
	...
	<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
					  ...
					  <div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xs-padl0">
                        ...
                        <div class="wrap maxwi_100 xs-padr25 xs-padl10 padt10 xs-padt0 red_ff2828_bg  brdb_new tall xs-nobrdb">
						   ...
						   <div class="clear" id=""></div>
                              <div class="padb40 talc marb25 fsz75 xxs-fsz60 white_txt"><?php echo $itemListDelivereyCount['num']; ?></div>
							  <div class="clear" id=""></div>
                              <div class="padb0 xxs-padb0 ">
                                 <p class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 white_txt trn ffamily_avenir">Deliveries</p>
                              </div>
							  <div class="clear" id=""></div>
                              <div class="mart20 marb10  xxs-talc talc ffamily_avenir white_txt fsz20 ffamily_avenir">Manage all your deliveries below</div>
                           </div>
                        </div>
                     </div>
                                ...
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_blue1 red_ff2828_brdclr talc hidden">
                                            <a href="listItemsDetailRequired" class="dinlblck mar5 padrl30 xs-padrl10 brd tb_67cff7_bg_h tb_67cff7_bg_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz14 black_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir"  >Items</a>
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd red_ff2828_bg_h red_ff2828_bg_a brdrad40 red_ff2828_brdclr_h red_ff2828_brdclr_a lgn_hight_36 fsz16 black_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_delivered">Delivered</a>
											 ...
											 <a href="listItemsDetailRejected" class="xs-padrl10 padrl30 fsz18 black_txt blue_67cff7_a lgn_hight_36"  ><i class="fas fa-trash-alt"></i></a>
                                        </div>

                                        <div class="tab_container mart10">

                                             
											 <div class="tab_content active" id="utab_delivered" style="display: block;">
											<?php $i=0;
												
												foreach($itemListDeliveredVolunteerInfo as $category => $value) 
												{
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padl0 fsz12">
												   ...
												   <div class="wi_50p xs-wi_100 hei_50p xs-hei_45p newgrey_bg talc valm padt10" style="border-radius: 10%;"><span class="white_txt fsz30 valm talc" height="45px" width="45px"><i class="xxs-fab fabBox fa-stack-1x  bold padt5 xs-padt0 <?php if($value['severity']==1) echo 'red_ff2828_txt fas fa-thermometer-full'; else if($value['severity']==2) echo 'yellow_txt fas fa-thermometer-half'; else echo 'blue_67cff7 fas fa-thermometer-quarter'; ?>" aria-hidden="true"   ></i></span> </div>
													...
													<div class="fleft wi_40  "> 
													<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 padb0  ffamily_avenir"><?php echo date('Y-m-d',strtotime($value['created_on'])); ?></span>
													<span class="trn fsz18  black_txt ffamily_avenir  "><?php if($value['group_id']==0) echo $value['name']; else echo $value['group_name']; ?></span>  </div>
													
													 <div class="fright wi_10 padl0 xs-wi_30 sm-wi_100 marl15 fsz40  xs-marl0 xxs-marr20 padb0 hidden ">
                                                      <span class="fas fa-arrow-alt-circle-right <?php if($value['severity']==1) echo ' red_ff2828_txt'; else if($value['severity']==2) echo ' yellow_txt '; else echo ' blue_67cff7'; ?>"></span>
                                                   </div>
													<?php if($value['is_completed']==0) { ?>
													<a href="listItemsDetailDelivered/<?php echo $value['enc']; ?>"><div class=" fright wi_10 padl0 xs-wi_30   marr50 fsz40  xs-marl0 xxs-marr80 padb0">
																				<button type="button" name="Manage" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bg"  >Manage</button>
																			</div> </a>
													<?php } else if($value['is_completed']==1) { ?>
													<a href="listItemsDetailReceived/<?php echo $value['enc']; ?>"><div class=" fright wi_10 padl0 xs-wi_30   marr50 fsz40  xs-marl0 xxs-marr80 padb0 padrl35">
																				<button type="button" name="View" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bg"  >View</button>
																			</div> </a>
													<?php } ?>
												</div>
