...
<html>
	...
	<div class="column_m   talc lgn_hight_22 fsz16 xs-marb0 xs-mart20  mart40  padb30">
				...
				<img src="../../../../html/usercontent/images/bg/noMissing.png" />
			</div>
									<h3 class="marb0  xxs-talc fsz35 xs-fsz25 bold padb5 black_txt talc ffamily_avenir"  >No match found </h3>
									
									<div class="clear"></div> 
						<form action="../userDetailAvailability/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
