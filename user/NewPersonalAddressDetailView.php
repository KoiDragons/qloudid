   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list xs-marb0" style="
            max-width: 425px; margin-bottom:160px;
            ">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Please update your home address
</div>
...
<form class="checkout__item js-tabs-item" action="saveUserAddressUpdate" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
   
<div class="checkout__fieldset">

<div class="setting__item  " style="display:block;">
          <script>       function updateName(id)
			{
				if($("#nameInfo").hasClass('hidden'))
				{
					$("#same_name").val(1);
  ...
  <div class="setting__box marb40">
                    <div class="setting__notification" style="border:none; margin-bottom:0px;">
                      <div class="setting__main">
                        <div class="setting__subtitle changedText">If name on the doar is same as yours?</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"  onclick="updateName();" <?php if($resultOrg1['is_name_on_house_same']==1) echo 'checked'; else echo "";  ?> /><span class="switch__inner"><span class="switch__box" ></span></span>
                        </label>
                      </div>
...
<div class="field <?php if($resultOrg1['is_name_on_house_same']==1) echo 'hidden'; else echo "";  ?>" id="nameInfo">
<div class="field__label changedText" style="color:#787f91;">Name on the door</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="flname" id="flname" value="<?php if($resultOrg1['name_on_door']!="" || $resultOrg1['name_on_door']!= null)  { if($resultOrg1['name_on_door']!= '-') echo $resultOrg1['name_on_door']; else echo ''; } else echo "";  ?>"  placeholder="e. g. xyz"  type="text"   style=" color:grey; ">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="addrs" id="addrs" value="<?php if($resultOrg1['address']!="" || $resultOrg1['address']!= null)  { if($resultOrg1['address']!= '-') echo $resultOrg1['address']; else echo ''; } else echo "";  ?>"  placeholder="e. g. xyz"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
<div class="upload__col upload__col_w50">
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="pnumber" id="pnumber"  value="<?php if($resultOrg1['port_number']!="" || $resultOrg1['port_number']!= null)  { if($resultOrg1['port_number']!= '-') echo $resultOrg1['port_number']; else echo ''; } else echo "";  ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="dzip" id="dzip"  value="<?php if($resultOrg1['zipcode']!="" || $resultOrg1['zipcode']!= null)  { if($resultOrg1['zipcode']!= '-') echo $resultOrg1['zipcode']; else echo ''; } else echo "";  ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
<div class="upload__col upload__col_w50">
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="dcity" id="dcity"  value="<?php if($resultOrg1['city']!="" || $resultOrg1['city']!= null)  { if($resultOrg1['city']!= '-') echo $resultOrg1['city']; else echo ''; } else echo "";  ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
  ...
  <div class="setting__item  " style="display:block;">
          <script>       function updateInvoice(id)
			{
				if($("#invoiceSame").hasClass('hidden'))
				{
					$("#same_invoice").val(1);
					$("#invoiceSame").removeClass('hidden');
				}
				else
				{
					$("#same_invoice").val(0);
					$("#invoiceSame").addClass('hidden');
				}
  ...
  <div class="setting__box marb40">
                    <div class="setting__notification" style="border:none; margin-bottom:0px;">
                      <div class="setting__main">
                        <div class="setting__subtitle changedText">If Invoice address is same as delivery address?</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"  onclick="updateInvoice();" <?php if($resultOrg1['is_invoice_same']==1) echo 'checked'; else echo "";  ?> /><span class="switch__inner"><span class="switch__box" ></span></span>
                        </label>
                      </div>
...
<div class="<?php if($resultOrg1['is_invoice_same']==1) echo 'hidden'; else echo "";  ?>" id="invoiceSame">
<div class="upload__row">
  <div class="upload__col upload__col_w50">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Street address</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="iaddress" id="iaddress" value="<?php if($resultOrg1['invoice_address']!="" || $resultOrg1['invoice_address']!= null)  { if($resultOrg1['invoice_address']!= '-') echo $resultOrg1['invoice_address']; else echo ''; } else echo "";  ?>"  placeholder="e. g. xyz"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
<div class="upload__col upload__col_w50">
...
<div class="field__label changedText" style="color:#787f91;">Port number</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="i_port_number" id="i_port_number"  value="<?php if($resultOrg1['invoice_port']!="" || $resultOrg1['invoice_port']!= null)  { if($resultOrg1['invoice_port']!= '-') echo $resultOrg1['invoice_port']; else echo ''; } else echo "";  ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
...
<div class="field__label changedText" style="color:#787f91;">Zipcode</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="izip" id="izip"  value="<?php if($resultOrg1['invoice_zipcode']!="" || $resultOrg1['invoice_zipcode']!= null)  { if($resultOrg1['invoice_zipcode']!= '-') echo $resultOrg1['invoice_zipcode']; else echo ''; } else echo "";  ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
<div class="upload__col upload__col_w50">
...
<div class="field__label changedText" style="color:#787f91;">City</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="icity" id="icity"  value="<?php if($resultOrg1['invoice_city']!="" || $resultOrg1['invoice_city']!= null)  { if($resultOrg1['invoice_city']!= '-') echo $resultOrg1['invoice_city']; else echo ''; } else echo "";  ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="entry_code" id="entry_code"  value="<?php if($resultOrg1['entry_code']!="" || $resultOrg1['entry_code']!= null)  { if($resultOrg1['entry_code']!= '-') echo $resultOrg1['entry_code']; else echo ''; } else echo "";  ?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
