					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						<div class="padb0 xxs-padb0 ">		
							<div class="padb0 talc fsz60 padt20"><i class="fas fa-first-aid red_ff2828_txt"></i></div>
									...
									<div class="mart20 marb35 xxs-talc talc   xs-marb20 xs-mart0"> <a href="#" class="black_txt fsz18  xs-fsz16 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Qloud ID-program could not be started. Check that you have the latest version and a valid Qloud ID certificate.
									</a></div>
						...
						<div class="padtb0 brdrad3 ">
							...
							<div class="padt20 xxs-talc talc">
								<a href="loginPurchase<?php if(isset($data)) { ?>?next=<?php echo $data['client']; if(isset($data['apply'])) echo "&apply=".$data['apply']; else if(isset($data['purchase'])) echo "&purchase=".$data['purchase'];  else if(isset($data['login'])) echo "&login=".$data['login']; } ?>"><input type="button" value="Try again" class="forword button_bg_color minhei_55p"></a>
