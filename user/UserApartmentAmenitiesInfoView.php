...
<html>
	...
	<head>
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateSubcategory/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		function updateAminity(id,id1)
		{
			$('#errorMsg').html('');
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateAminity/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
							if(data1==0)
							{
							$('#errorMsg').html('Minimum three amenities required');	
							 $.ajax({
							type:"POST",
							url:"../updateAminityInfoUpdate/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateCategoryAmenities/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
