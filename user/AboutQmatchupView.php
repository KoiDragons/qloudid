...
<div class="column_m pos_rel zi1">
		...
		<div class="column_m container zi5 padt10">
			<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
						...
						<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75">
							<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03 padt5 white_bg fsz14" id="scroll_menu">
								...
								<ul class="dblock mar0 padl20 fsz13">
									<?php if($empSummary==1) { ?>
									<li class="dblock pos_rel padb20 padl30 brdl brdclr_hgrey ">
										<h4 class="padb5 uppercase ff-sans black_txt trn">Company</h4>
										<ul class="marr20 pad0">
										...
										<div class="wi_26p hei_26p pos_abs top0 left-13p brd talc lgn_hight_26 lgtgrey_bg pblue2_bg_pa  black_txt_pa">0</div>
									</li>
									<li class="dblock pos_rel padb20 padl30 brdl brdclr_hgrey ">
										<h4 class="padb5 uppercase ff-sans black_txt trn">API Developer</h4>
										<ul class="marr20 pad0">
																						
											<li class="dblock padrb10">
												<a href="../../Apps/companyAccount/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Apps</span>
													<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
												</a>
											</li>
											
										</ul>
										<div class="wi_26p hei_26p pos_abs top0 left-13p brd talc lgn_hight_26 lgtgrey_bg pblue2_bg_pa  black_txt_pa">1</div>
									</li>
									<?php } ?>
									<li class="dblock pos_rel padb20 padl30 brdl brdclr_hgrey brdclr_pblue2_a">
										...
										<ul class="mar0 pad0">
											...
											<li class="dblock padrb10">
												<a href="../../AboutQmatchupOmOss" data-id="scroll-section-1" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pred2_h brdclr_pred2_a pred2_bg_h pred2_bg_a black_txt white_txt_h white_txt_a"> <span class="valm trn">Om oss</span>
													<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pred2_bg rotate45"></div>
												</a>
											</li>
											<li class="dblock padrb10">
											...
											<li class="dblock padrb10">
												<a href="#" data-id="scroll-section-1" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pred2_h brdclr_pred2_a pred2_bg_h pred2_bg_a black_txt white_txt_h white_txt_a"> <span class="valm trn">Karriär</span>
													<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pred2_bg rotate45"></div>
												</a>
											</li>
										</ul>
										<div class="wi_26p hei_26p pos_abs top0 left-13p brd talc lgn_hight_26 lgtgrey_bg pred2_bg_pa  white_txt_pa"><?php if($empSummary==1) { echo "2";  } else echo "0";  ?></div>
									</li>
									<li class=" dblock pos_rel padb20 padl30  brdclr_hgrey ">
										<h4 class="padb5 uppercase ff-sans black_txt trn">Partners</h4>
										<ul class="marr20 pad0">
										<li class="dblock padrb10">
												<a href="../../ApplicationStatus" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Aterförsäljare</span>
													<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
												</a>
											</li>
											<li class="dblock padrb10">
												<a href="../../Minkarriar/UserAccount" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Leverantörer</span>
													<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
												</a>
											</li>
										...
										<div class="wi_26p hei_26p pos_abs top0 left-13p brd talc lgn_hight_26 lgtgrey_bg pblue2_bg_pa  black_txt_pa"><?php if($empSummary==1) { echo "3";  } else echo "1";  ?></div>
									</li>
				...
				<!-- Center content -->
				<div class="width_730 col-xs-12 col-sm-12 fleft pos_rel zi5 white_bg xs-white_bg sm-white_bg" >							
						...
						<div class="column_m padb15">
							<div class="padrl10 white_bg">
								<div class="sidebar_prdt_bx">
									...
									<div class="clear"></div>
									<div class="hidden-xs hidden-sm">
							<a href="../../../../user/index.php/QmatchupBizSubscription" class="dblock padrl20 brdrad3 zohoorange_bg ws_now talc lgn_hight_29 fsz14 white_txt">
								<img src="../../../../html/usercontent/images/icons/gift.png" width="20" height="20" class="marr5 valm">
