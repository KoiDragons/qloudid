...
<html>
	...
	<head>
		...
		<script>
			...
			{
				//alert($(".clear_number").text()); return false;
				var send_data = {};
				send_data.user_id=document.getElementById('user_id').value;
				...
				$.ajax({
					url: '../BankAccount/updateDataBank',
					type: 'POST',
					dataType: 'json',
					data: send_data
				})
	...
	<body class="lgtgrey2_bg" >
		...
		<div class="wi_100 hei_40p xs-pos_fix padtb5 padrl10 white_bg brdb" >
			...
			<div class="fright xs-dnone sm-dnone">
				<ul class="mar0 pad0">
					<li class="dblock hidden-xs hidden-sm fright pos_rel  brdclr_dblue"> <a href="../StoreData/userAccount" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg uppercase lgn_hight_30 white_txt white_txt_h" data-en="Close" data-sw="Close">Close</a> </li>
				</ul>
			</div>
			...
			<div class="column_m container zi5 mart40 xs-mart20" onclick="removeActive();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0 ">
								...
								<div class="padb10 ">
									<h1 class="padb5 tall fsz50 xs-fsz25 bold ">Mina bank & kort uppgifter</h1>
									<p class="pad0 xs-padb10 tall fsz18 xs-fsz16 padb0 wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 xs-brdb_b">Nedan finns dina uppgifter att läsa, lagra och uppdatera. Ädnringar på dessa uppgifter kan endast träda i kraft efter signering.</p>
								</div>
							...
							<div class="marb0  mart10">
								<h2 class="fleft mar0 padb5 fsz15">Bank</h2>
						...
						<div class="white_bg mart0  brdrad3" style="">
							<div class="container pad25 padb20 xs-pad10 xs-padt20 xs-padb20  brdrad1 fsz14 dark_grey_txt">
								<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
									...
									<div class="wi_100 xs-wi_100 xs-order_3 xs-padt10 fsz12">
										<div class="container marrl-2 padl15 xs-padl0">
											<div class="fleft wi_25 xs-wi_100 sm-wi_100 marl15 xs-mar0 padb10"> <span class="trn" data-trn-key="Clearing number">Clearing number</span> <span class="editable edit-address dblock brdb brdclr_lgtgrey2 lgtgrey2_bg pad10 mart5 fsz20 hei_50p clear_number"><?php if($resultOrg1['clearing_number']!="" || $resultOrg1['clearing_number']!= null) echo $resultOrg1['clearing_number']; else echo "-"; ?> </span></div>
											
											<div class="fleft wi_25 xs-wi_100 sm-wi_100 marl15 xs-mar0  padb10"> <span class="trn" data-trn-key="Bank account number">Bank account number</span> <span class="editable edit-text jain1 dblock brdb brdclr_lgtgrey2 lgtgrey2_bg pad10 mart5 fsz20 hei_50p bank_acc"><?php if($resultOrg1['bank_account_number']!="" || $resultOrg1['bank_account_number']!= null) echo $resultOrg1['bank_account_number']; else echo "-"; ?></span> </div>
											<div class="fleft wi_25 xs-wi_100 sm-wi_100 marl15 xs-mar0  padb10"> <span class="trn" data-trn-key="Language">Bank name</span> <span class="editable edit-text jain2 dblock brdb brdclr_lgtgrey2 lgtgrey2_bg pad10 mart5 fsz20 hei_50p langu"><?php if($resultOrg1['language']!="" || $resultOrg1['language']!= null) echo $resultOrg1['language']; else echo "-"; ?></span> </div>
								...
								<div class="mart20 talc fsz16  " onclick="checkDataBank();"> <a href="#" class="dblue_btn trn brdrad3 brdrad3" >Update </a> </div>
								<div class="clear"></div>
							</div>
						</div>
