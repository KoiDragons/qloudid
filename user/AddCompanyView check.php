...
<body class="dark" style="background-color:#131922" id="bodyData">
  <script>
...
<div class="upload__head">
                  <h2 class="upload__title h2 white_txt changedText">Register your company</h2>
                </div>
 
<form class="checkout__item js-tabs-item" action="AddCompany/addCompanyDetail" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
<input type="hidden" name="country" id="country" value="<?php echo $userSummary['country_of_residence']; ?>" />
					   ...
					   <div class="checkout__subtitle uppercase changedText white_txt">Business details</div>
                       
                      </div>
						   <div class="field" style="margin-bottom:24px; border-color:#353945;">
                            <div class="field__label  changedText" style="color:#787f91;">Property status</div>
                            <div class="field__wrap">
                             <select class=" " id="company_type" name="company_type" style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"  >
						  ...
						  <div class="field  margin-bottom24" style="border-color:#353945;">
                            <div class="field__label  changedText" style="color:#787f91;">Company name</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="company_name" id="company_name" placeholder="e. g. Qloud ID" style=" border-color:#353945; color:grey;"  >
                            </div>
                          </div>
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"  disabled>
						    ...
						    <div class="upload__col upload__col_w70">
						     <div class="field  " style="border-color:#353945;">
                            <div class="field__label  changedText" style="color:#787f91;">Company identification</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="cid" id="cid" placeholder="e. g. 123456789" style=" border-color:#353945; color:grey;"  >
                            </div>
                          </div>
						   </div>
						   </div>
...
<div class="upload__row">
                        ...
                        <div class="field  " style="border-color:#353945;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="adrs1" id="autocomplete"   placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="port_number" id="port_number" placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
 ...
 <div class="upload__row">
                        ...
                        <div class="field  ">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="daddress" id="daddress"   placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="d_port_number" id="d_port_number" placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<div class="field__wrap">
<input class="field__input" name="dzip" id="dzip"    type="text" placeholder="e. g. 111111"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
 <div class="upload__col upload__col_w70">
...
<div class="field__wrap">
<input class="field__input"  name="dcity" id="dcity"    type="text" placeholder="e. g. Stockholam"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
</div>
...
<div class="on_clmn mart20 " style="display:none;">
			...
			<div class="footer__theme mart30 padb20 uppercase" style="margin-bottom:24px; display:block; border-bottom:1px solid #353945; color:white;"  >
                If Invoice address is same as delivery address?<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateRent(this);'  ><span class="theme__inner"><span class="theme__box"></span></span>
                </label>
              </div>								
                          ...
                          <div class="upload__col upload__col_w70">
                        <div class="field  ">
                            <div class="field__label  changedText" style="color:#787f91;">Invoice address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="iaddress" id="iaddress"   placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="i_port_number" id="i_port_number" placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<div class="field__label changedText" style="color:#787f91;">Zipcode</div>
<div class="field__wrap">
<input class="field__input" name="izip" id="izip"    type="text" placeholder="e. g. 111111"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
 <div class="upload__col upload__col_w70">
...
<div class="field__label changedText" style="color:#787f91;">City</div>
<div class="field__wrap">
<input class="field__input"  name="icity" id="icity"    type="text" placeholder="e. g. Stockholam"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
</div>
                            ...
                            <div class="field__label  changedText" style="color:#787f91;">Your role</div>
                            <div class="field__wrap">
                             <select class=" "   style="height: 48px;
    padding: 0 14px;  border-color:#353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" name="position_type" id="position_type"    >
						 <option value="0" class="lgtgrey2_bg changedText">Select</option>
														<option value="1" class="lgtgrey2_bg">Vanlig anst�lld</option>
...
<div class="profile" style="background: transparent; border-color:#353945;">
                <div class="profile__main">
                  <div class="profile__avatar"><img src="<?php echo $path; ?>html/usercontent/images/account/pinning.jpg" alt="Avatar"></div><a class="profile__update js-popup-open" href="#popup-avatars" data-effect="mfp-zoom-in">
                    
                  <div class="profile__man changedText">Remax</div>
                </div>
                <div class="profile__body">
                  <div class="profile__parameters">
                    <div class="profile__parameter">
                      ...
                      </svg><span class='changedText'>Company verified</span>
                    </div>
                    <div class="profile__parameter"  >
                      <svg class="icon icon-star-outline">
                        <use xlink:href="#icon-star-outline"></use>
                      </svg><span class='changedText'>256 reviews</span>
                    </div>
                  </div><a class="profile__site" href="#" >
                    <svg class="icon icon-globe">
                      <use xlink:href="#icon-globe"></use>
                    </svg><span class="white_txt">https://ui8.net</span></a>
                  <div class="profile__control"><a class="button-stroke button-small profile__button changedText white_txt" href="#"  >Contact</a>
                  ...
                  <button class="profile__report">
                    ...
                    </svg><span class='changedText'>Report this company</span>
                  </button>
                </div>
              </div>
</div>
