		...
		<div class="column_m pos_rel">
			...
			<div class="column_m container zi5 mart40">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb10 ">
						<h1 class="padb5 talc fsz50"><?php echo html_entity_decode($companySummary['company_name']); ?></h1>
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10 lgtgrey2_bg brdrad3">
						<div class="pad15 brdrad3 white_bg">
							...
							<div class="mart15" id="search_data">
								...
								<!--			<div class="result-item padtb20">
									...
									<span class="marr5 valm">Contact by Email</span>
									<span class="wi_10p hei_10p diblock marr5 brdrad10 bg_e18f00 valm" title="Confidence score: 53%"></span>
									<a href="#" class="txt_ca" title="Verify"><span class="fa fa-check"></span></a>
									</div>
									</div>
									...
									<span class="fxshrink_0 marl10">kowaken.ghirmai@qmatchup.com</span>
									</li>
						...
						<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla mart30"> 
							<?php if($data['request_id']==1) { ?>
							<a href="../sendRequest/<?php echo $data['cid']; ?>" class="wi_100 maxwi_500p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 panlyellow_bg fsz18 xs-fsz16 darkgrey_txt trans_all2" >Signera med Mobilt BankId</a> 
							<?php } else if($data['request_id']==2) { ?>
							<a href="../sendRequestCustomer/<?php echo $data['cid']; ?>" class="wi_100 maxwi_500p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 panlyellow_bg fsz18 xs-fsz16 darkgrey_txt trans_all2" >Signera med Mobilt BankId</a> 
						<?php } ?>
