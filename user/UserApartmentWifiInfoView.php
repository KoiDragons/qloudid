				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir">Wifi</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please provide wifi information</a></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Add your wi-fi details" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										 
									</div>
									 </div>
									 <form action="../updateApartmentWifi/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright <?php if($resultOrg1['wifi_available']==1) echo 'checked'; ?>" onclick="updateWifi();" >
									 ...
									 <input type="hidden"  id="wifi_available" name="wifi_available" value="<?php echo $resultOrg1['wifi_available']; ?>" />

										</div>	 
									 
								<div class="clear"></div>
								<div class="on_clmn padt10 <?php if($resultOrg1['wifi_available']==0) echo 'hidden'; ?>" id="wifi_info">
								 ...
								 <input type="text" id="wifi_username" name="wifi_username" class="css-xt766" value="<?php echo $resultOrg1['wifi_username']; ?>">
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="wifi_password" name="wifi_password" class="css-xt766" value="<?php echo $resultOrg1['wifi_password']; ?>">
