...
<html>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-126618362-1"></script>
		...
		<script>
			...
			function submit_value_user()
			{
				...
				if($("#ccountry").val()!=201)
				{
					$("#error_msg_form").html('You are not authorized to login with ssn. Please login with Username and password!!!');
					return false;
				}
				else if($("#user_ssn").val()=="")
				{
				...
				else
				{
					...
					var send_data={};
					send_data.countryname=$("#ccountry").val();
					send_data.user_ssn=$("#user_ssn").val();
					$.ajax({
						type:"POST",
						url:"verifyUserSSN",
						data:send_data,
						...
						success: function(data1){
							...
							if(data1==0)
							{
								$("#error_msg_form").html('Please login with user name and password and verify your details first.');
							}
							else
							{
								$("#headerDetail").hide();
	...
	<body class="white_bg">
	<div id="headerDetail">	
	 <div class="column_m header   bs_bb lgtrey2_bg hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtrey2_bg"  >
...
<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart20 xs-pad0 xs-mart0">
					...
					<h1 class="padl0 padb5 talc fsz50 xs-fsz25 black_txt hidden-xs"><span ><img src="<?php echo $path; ?>html/usercontent/images/random/bankid_high_rgb.png" class="cropped_image   borderr grey_brd5" width="40" height="40" /> </span><span class="lgn_hight_40">Login</span></h1>
					<div class="on_clmn visible-xs">
						<div class="thr_clmn wi_20 padl40">	
							<img src="<?php echo $path; ?>html/usercontent/images/random/bankid_high_rgb.png" class="cropped_image   borderr grey_brd5" width="40" height="40" />  
							</div>
							<div class="thr_clmn wi_80 xs-padt10">	
								<h1 class="padl0 padb5 tall fsz50 xs-fsz25 black_txt xs-pad0 xs-padl20">Login</h1>
							</div>
							</div>
...
<div class="column_m marb30 mart40 xs-mart20 xs-padtb10 talc lgn_hight_22 fsz16 xs-marb0" id="loginBank1"  onclick="checkFlag();">
				<div class="padrl10  xs-padrl25">
					<div class="wrap maxwi_100   xs-nobrdb  xs-padb0  xs-mart0">
							...
							<div class="wi_500p maxwi_100  pos_rel zi5 marrla pad30  xs-pad0  ">
								...
								<div class="mart30 xs-mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Sign-in with social security number</a></div>
								 
									<form action="loginSSNAccount" method="POST" name="updateform" id="updateform">
									
									<div class="on_clmn mart10 xxs-mart10 marb35">
										<div class="thr_clmn wi_30 ">		 
										<div class="pos_rel">
													<select id="ccountry" name="ccountry"  class="input1 wi_100 minhei_65p fsz16 nobrd brdb trans_bg nobold  dropdown-bg xxs-minhei_60p black_txt tall padl0"  style="text-align-last:center;" >
														...
														<?php  foreach($resultContry as $category => $value) 
																...
																<option value="<?php echo $value['id']; ?>" <?php if($value['id']==201) echo 'Selected'; ?> class="lgtgrey2_bg"><?php echo $value['country_name']; ?></option>
															<?php 	}	?>
										...
										<div class="pos_rel">
										<input type="text" name="user_ssn"  placeholder="Social Security number " id="user_ssn"  class="wi_100 rbrdr pad10  brdb talc xxs-minhei_60p minhei_65p fsz18 black_txt fsz16 lgtblue2_bg"  />
									</div>
									</div>
									 </div>
							...
							<div class="talc  padtb20"><a href="#" onclick="submit_value_user();"><input type="button" value="Sign in" class="forword button_bg_color minhei_55p"  /></a>
										 
									
									</div>	 
								
								<div class="marb20 xxs-talc talc fsz14">
								
								If you are the owner of this SSN. You will receive an sms with code once you submit.
