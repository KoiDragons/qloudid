         ...
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Please fill the form below to update residential detail
</div>
...
<form class="checkout__item js-tabs-item" action="../sendInformation/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="pnumber" id="pnumber"  placeholder="e. g. xxxxx12345"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
