...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Consents</h2>
...
">
 ...
 <div class="sorting__details" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">These are your private consents, <?php echo $row_summary['first_name']; ?>
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Request</div>
                                      </a>
			   ...
			   <div class="sorting__foot center">
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php foreach($pendingMemberRequest as $category => $value) 
										{
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo substr(html_entity_decode($value['address']),0,25); ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo substr(html_entity_decode($value['company_name']),0,25); ?>
</div>
...
<div class="description__parameters hidden" style="
    margin-bottom: 0px;
    margin-top: 0px;
">
...
"><a class="header__logo xs-fsz20 changedText fright" href="javascript:void(0);" style="
...
">
   ...
   <?php   } foreach($rowUser as $category => $value) 
										{
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Employer</div>
...
"> </div>
 <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="../ConsentProfile/receiveAccount/<?php echo encrypt_decrypt('encrypt',$value['id']); ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
   ...
   <?php   }   foreach($daycareRequestReceivedDetail as $category => $value) 
										{
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Daycare</div>
...
"> </div>
 <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="../ConsentProfileParent/requestAccount/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
   ...
   <?php   }  foreach($guardianRequestReceived as $category => $value) 
										{
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Parent</div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo substr(html_entity_decode($value['name']),0,25); ?>
</div>
...
"> </div>
 <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="../ConsentProfileGuardian/dependentAccount/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
   ...
   <?php   } foreach($kinRequestReceivedDetail as $category => $value) 
										{
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Received kin request</div>
...
"> </div>
 <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="../ConsentKinRequest/kinInformation/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
   ...
   <?php   } foreach($receivedRequestDetailTenants as $category => $value) 
										{
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Received tenant request</div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo substr(html_entity_decode($value['office_apartment_number']),0,25); ?>
</div>
...
">
			  ...
			  <div class="card__foot">
                      ...
                      <div class="card__flex">
                        <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
"><a class="header__logo xs-fsz20 changedText fright" href="verifyRequest/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
 ...
 <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="unverifyRequest/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
   ...
   <?php   } foreach($receivedContractorInvitation as $category => $value) 
										{
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Contractor</div>
...
">
			  ...
			  <div class="card__foot">
                      ...
                      <div class="card__flex">
                        <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
"><a class="header__logo xs-fsz20 changedText fright" href="approveContrator/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
 ...
 <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="rejectContrator/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
