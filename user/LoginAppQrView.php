...
<button class="header__head js-header-head" style="color:#000000; font-size:20px;">This is a demo for how to login using Qloud ID
	...
	<div class="outer__inner">
	 <form action="loginAppAccount<?php if(isset($data)) { ?>?next=<?php echo $data['client']; if(isset($data['apply'])) echo "&apply=".$data['apply']; else if(isset($data['purchase'])) echo "&purchase=".$data['purchase']; else if(isset($data['signin'])) echo "&signin=".$data['signin']; else if(isset($data['login'])) echo "&login=".$data['login']; } ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?><?php if(isset($data)) { ?>/<?php echo $data['client'];  if(isset($data['apply'])) echo "/apply"; else if(isset($data['purchase'])) echo "/purchase"; else if(isset($data['signin'])) echo "/signin"; else if(isset($data['login'])) echo "/login"; } ?>" class="white_brd brdrad5" style="width: 150px;height: 150px;"></div>
</div>
