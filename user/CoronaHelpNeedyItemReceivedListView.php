...
<html>
	...
	<head>
		<meta charset="utf-8">
		<!--<meta http-equiv="refresh" content="10;https://www.safeqloud.com/user/index.php/CoronaHelp/listItemsDetailReceived" />-->
         ...
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg"  >
			...
			<div class="fright xs-dnone sm-dnone padt10 padb0 hei_45p">
					<ul class="mar0 pad0 sf-menu fsz16">
						<li class="dblock hidden-xs hidden-sm fright pos_rel  "><a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h  lgn_hight_30 white_txt white_txt_h ffamily_avenir" >Close</a></li>
...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
 ...
 <!-- CONTENT -->
	...
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
								<div class="padb40 talc fsz45"><i class="fas fa-check-double txt_07794a"></i></div>
			<div class="padb0 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 txt_07794a trn ffamily_avenir">Delivery </h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="txt_07794a fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Confirmed received delivery by you on the : <?php echo $itemListDeliveredyCheckReceived['modified_on']; ?> </a></div>
									</div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_blue1 red_ff2828_brdclr talc hidden">
                                            ...
                                            <a href="listItemsDetailDelivered" class="dinlblck mar5 padrl30 xs-padrl10 brd tb_67cff7_bg_h tb_67cff7_bg_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz14 black_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir"  >Delivered</a>
											 <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd red_ff2828_bg_h red_ff2828_bg_a brdrad40 red_ff2828_brdclr_h red_ff2828_brdclr_a lgn_hight_36 fsz16 black_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_received">Received</a>
                                        ...
                                        <div class="tab_container mart10">
											...
											<?php $i=0;
												...
												foreach($itemListReceived as $category => $value) 
												{
										...
										<div class="container padrl10  padb20 padt15    brdrad1 fsz18 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<?php } else if($value['is_delivered']==3) { ?>
													...
													<div class="fleft wi_40  "> 
													<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 grey_txt padb0  ffamily_avenir"><?php echo $value['total_packets'].' packets'; ?></span>
											...
											<div class="clear"></div>
                                             ...
                                             <?php } ?>
											  ...
											  <div class="clear"></div>
											 <div class=" padtb20 talc fsz16  marb80"> <a href="#" class="forword hei_55p fsz18  t_67cff7_bg ffamily_avenir" >Close</a> </div>
											 </div>
                                    </div>
                                </div>
