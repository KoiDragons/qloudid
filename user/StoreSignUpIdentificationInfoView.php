			 ...
			 <div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
							...
							<form action="addSigninIndificator" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
						...
						<div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
							  ...
							  <div class="on_clmn   mart10  ">
										...
										<div class="pos_rel">
													...
													<select id="issue_month" name="issue_month" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_55p fsz20 padl10 black_txt ffamily_avenir floating__input padt25"  onclick="changeColor(this);" >
														<option value="0" class="lgtgrey2_bg" >Select</option>
												 ...
												 <label for="pcountry" class="floating__label tall nobold padl10" data-content="Issue month" >
											<span class="hidden--visually">
											...
											<div class="pos_rel">
												...
												<input type="number" name="issue_year" id="issue_year"   value="" min="1950" max="<?php echo date('Y');?>" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_55p fsz20 padl10 black_txt ffamily_avenir floating__input padt25" onclick="changeColor(this);" /> 
												 <label for="issue_year" class="floating__label tall nobold padl10" data-content="Issue year(<?php echo date('Y');?>)"  >
											<span class="hidden--visually">
											 Issue year(<?php echo date('Y');?>)</span></label> 
