...
<html>
	...
	<head>
		...
		<script>
			...
			function updateMonthlyPrice(id)
		{
			$('#errorMsg').html('');
			...
			if(id<100)
			{
			$('#errorMsg').html('Value cant be less then 100!!!');	
			return false;
			}
			$('#wordCount').html(id.length);
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateMonthlyPrice/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		function updateContractLenght(id)
		{
			$('#errorMsg').html('');
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateContractLenght/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
							...
							$('#propertyFloors').html('');
							$('#propertyFloors').html(data1+' Months'); 	  
							}
						});	
		}
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Monthly price</span> 
													 </div>
								 ...
								 <input type="number" id="sale_price" name="sale_price" class="css-xt766" value="<?php echo (float)$resultOrg1['monthly_price']; ?>" onkeyup="updateMonthlyPrice(this.value);">
								  ...
								  <div id="errorMsg" class="red_txt fsz16"> </div>
									...
									<div class="column_m container  marb5   fsz14 dark_grey_txt    ">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Minimum contract length (in months)</span> 
													 </div>
										...
										<a href="javascript:void(0);" onclick="updateContractLenght(0);"><button color="#444444" data-testid="icon-button--minus" class="merlin-button merlin-button--disabled css-ig30wo" aria-label="" disabled="">
										...
										<span class="value" id="propertyFloors"><?php echo $resultOrg1['contract_length']; ?> Months</span>
									<a href="javascript:void(0);" onclick="updateContractLenght(1);">	
