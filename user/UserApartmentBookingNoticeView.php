...
<html>
	...
	<head>
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateBooking/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
									...
									<div class="column_m container  marb5   fsz14 dark_grey_txt   padb10  ">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Guest arrivals</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">How much notice do you need before a guest arrives?</span> 
													 </div>
									 ...
									 <div class="clear"></div>
										<div class="css-zp5g9l mart10 tall marrl0"><div class="css-1jcail2"><div data-testid="did-you-know-pet-friendly" class="css-1miy8fb"><img role="presentation" src="https://www.safeqloud.com/html/usercontent/images/paintbrush-ladder.68ee.svg" class="css-1p436cn"><div class="css-1ai2sgr">Requiring more than three days advance notice can result in fewer bookings.</div></div></div></div> 
