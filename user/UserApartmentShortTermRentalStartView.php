...
<div class="checkout__label changedText">Your rental conditions</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Update rent out details</div>
 
<div class="checkout__controls">
 
<a href="../rentOutRevisionInfo/<?php echo $data['aid']; ?>"><button class="checkout__edit"  >
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">Manage your rentals</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">View and manage your rentals</div>
 
<div class="checkout__controls">
 
<a href="../rentOutPropertyManagerInfo/<?php echo $data['aid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
