...
<html>
	...
	<head>
		...
		function updateCleanByWhom(id)
		{
			$('#errorMsg').html('');
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateCleanByWhom/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateCleening/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		var fee='<?php echo $resultOrg1['cleening_fee']; ?>';
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateFee/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Cleaning fee" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Cleaning fee</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">Do you charge guests a cleaning fee?</span> 
													 </div>
									...
									<div class="column_m container  marb5  mart0 fsz14 dark_grey_txt  brdb_dfe3e6 padb10">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Cleaning by</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">Who will clean your property?</span> 
													 </div>
													 
													<div class="clear"></div>
												
												<div class="css-11e5cyp padt10">
												<select id="Television-amenity-select" data-testid="Television-amenity-select" class="css-bnguuq dropdown-bg" onchange="updateCleanByWhom(this.value);" fdprocessedid="q16hvf">
													<option value="1" <?php if($resultOrg1['cleening_by_whom']==1) echo 'selected'; ?>>Yourself</option>
										<option value="2" <?php if($resultOrg1['cleening_by_whom']==1) echo 'selected'; ?>>Your service provider</option>
										<option value="3" <?php if($resultOrg1['cleening_by_whom']==1) echo 'selected'; ?>>A qualified service provider by us</option>
										</select>
												</div>
									 ...
									 <div class="clear"></div>
										<div class="css-zp5g9l mart10 tall"><div class="css-1jcail2"><div data-testid="did-you-know-pet-friendly" class="css-1miy8fb"><img role="presentation" src="https://www.safeqloud.com/html/usercontent/images/paintbrush-ladder.68ee.svg" class="css-1p436cn"><div class="css-1ai2sgr">We recommend incorporating your cleaning fee into your nightly price. If this isn't possible, try to keep your cleaning fee as low as possible.</div></div></div></div> 
