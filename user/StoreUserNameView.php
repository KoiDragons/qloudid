        ...
        (function() {
     	...
     	function changeClass(link)
			...
			function sendInformation()
			{
				...
				{
					$("#error_msg_form").html('First name cant be blank');
					return false;
				}
				if($('#name').val()!=$('#f_name').val())
				{
					$('#fn').val(1);
				}
				
				if($('#l_name').val()=="" || $('#l_name').val()==null || $('#l_name').val()=='-')
				{
					$("#error_msg_form").html('Last name cant be blank');
					return false;
				}
				if($('#l_name').val()!=$('#last_n').val())
				{
					$('#ln').val(1);
				}
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_550p maxwi_100 pos_rel zi5 marrla pad10  mart40  xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45  padb10 black_text trn ">Name</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Please add your full name here.</a></div>
									...
									<div class="on_clmn mart10 xxs-mart10 marb35">
										...
										<div class="pos_rel">
										<input type="text" name="name"  placeholder="Name " id="name" value="<?php if($resultOrg['first_name']!="" || $resultOrg['first_name']!= null) echo $resultOrg['first_name']; else echo "-"; ?>" class="txtind10 fsz18 nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828   wi_100 trans_bg required minhei_65p xxs-minhei_60p  talc  ffamily_avenir">
									</div>
									</div>
									<div class="thr_clmn  wi_50 padl10"  >
										
										<div class="pos_rel">
										<input type="text" name="l_name"  placeholder="Last name" id="l_name" value="<?php if($resultOrg['last_name']!="" || $resultOrg['last_name']!= null) echo $resultOrg['last_name']; else echo "-"; ?>" class="txtind10 fsz18 nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828   wi_100 trans_bg required minhei_65p xxs-minhei_60p  talc  ffamily_avenir">
									</div>
									</div>
									</div>
									<input type="hidden" id="fn" name="fn" value="0" />
										<input type="hidden" id="ln" name="ln" value="0" />
									<input type="hidden" name="last_n" id="last_n"  value="<?php if($resultOrg['last_name']!="" || $resultOrg['last_name']!= null) echo $resultOrg['last_name']; else echo "-"; ?>" />		
								<input type="hidden" name="f_name" id="f_name"  value="<?php if($resultOrg['first_name']!="" || $resultOrg['first_name']!= null) echo $resultOrg['first_name']; else echo "-"; ?>" /> 
