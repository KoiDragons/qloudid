		...
		<div class="column_m header header_small bs_bb bg_colorn_new" >
			<div class="wi_100 hei_40p xs-pos_fix padtb5 padrl10 bg_colorn_new" >
				...
				<div class="fright xs-dnone sm-dnone">
					<ul class="mar0 pad0">
						<li class="dblock hidden-xs hidden-sm fright pos_rel brdl brdclr_dblue"> <a href="<?php if($companyWebsite==null || $companyWebsite=='') echo '#'; else { $newWeb=explode('/',$companyWebsite ); if($newWeb['0']=='http:') echo $companyWebsite; else echo 'http://'.$companyWebsite; } ?>" id="usermenu_singin" class="translate hei_30pi dblock padrl25  uppercase lgn_hight_30 white_txt white_txt_h bg_f80" data-en="Close" data-sw="Close">Close</a> </li>
					</ul>
				</div>
		...
		<div class="column_m pos_rel">
			...
			<div class="column_m container zi5  mart40 xs-mart20">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
							...
							<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75">
								<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03 padt5 white_bg fsz14" id="scroll_menu">
										...
										<div class="padl10 white_bg">
											<div class="sidebar_prdt_bx padr20">
												<div class="pad10 lgtblue2_bg brdrad3">
													...
													<h3 class="prdt_name padb5 fsz25 h_color"> Qloud ID</h3>
									...
									<ul class="marr20 pad0">
										<li class="dblock padb10 padl8">
											<a href="PublicAboutQmatchup" class="lgtgrey_bg hei_26p dflex alit_c pos_rel padrl10 brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a">
												...
												<span class="valm trn">Nyheter</span>
									...
									<ul class="dblock mar0 padl10 fsz13">
										...
										<!-- Newsfeed -->
										<li class="active dblock pos_rel padb20   brdclr_hgrey brdclr_pblue2_a">
											<h4 class="padb5 uppercase ff-sans black_txt trn">Om Bolaget</h4>
											<ul class="marr20 pad0">
												
												<li class="dblock padrb10">
													<a href="#" data-id="scroll-section-1" class="active  hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Om oss</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class=" dblock padrb10">
													<a href="PublicCareerPage" data-id="scroll-section-1" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Lediga jobb</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
													<li class="dblock padrb10">
													<a href="PublicAterforsljare" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Aterförsäljare</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											</ul>
					...
					<!-- Center content -->
					<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5  fsz14 ">
						...
						<div class=" xs-marrl0 sm-marrl0 white_bg mart20">
