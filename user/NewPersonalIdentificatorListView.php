...
<head>
	...
	<meta charset="utf-8">
       ...
       function changeHeader()
		{
			window.location.href ="https://www.qloudid.com/user/index.php/StoreData/identificatorInfo";
		}
				...
				<div class="wi_240p fleft pos_rel zi50">
					...
					<div class="wi_500p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl0 xs-pad0">
								 ...
								 <div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn">Identificators</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc     xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Here is a list of all your identificators</a></div>
						
					<div class="tab-header martb0 padb10 xs-talc  nobrd talc">
                                            
                                              <a href="#" class="dinlblck mar5 padrl10     bg_98cf44 brdrad50  lgn_hight_60 fsz60  white_txt white_txt_ah ffamily_avenir" <?php if($identificatorInfoListCounts<3) echo 'onclick="changeHeader();"'; ?> >+</a>
										...
										<input type="text" value="Identificators" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php if($value['identification_type']==2) { echo 'ID number'; } else if($value['identification_type']==3) { echo 'Driving Licence'; } else if($value['identification_type']==1) { echo 'Passport'; } ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php echo $value['identity_number']; ?></span>  </div>
													<a href="editDetails/<?php echo $value['enc']; ?>">   <div class="fright wi_10 padl0  marl15 fsz40  padb0 hidden-xs">
