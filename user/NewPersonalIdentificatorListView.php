...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Here is a list of all your identificators
</div>
...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Identificators</h2> 
                  </div>
	...
	foreach($identificatorInfoList as $category => $value) 
		{
...
<div class="checkout__label changedText"><?php if($value['identification_type']==2) { echo 'ID number'; } else if($value['identification_type']==3) { echo 'Driving Licence'; } else if($value['identification_type']==1) { echo 'Passport'; } ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['identity_number']; ?></div>
 
<div class="checkout__controls">
 
<a href="editDetails/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
