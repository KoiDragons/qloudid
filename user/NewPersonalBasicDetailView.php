...
<form class="checkout__item js-tabs-item" action="saveProfileBasicDetails" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<input class="field__input xs-fieldData" name="first_name" id="first_name" value="<?php echo $resultOrg['first_name'];?>"  placeholder="e. g. xyz"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
<div class="upload__col upload__col_w50">
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="last_name" id="last_name" value="<?php echo $resultOrg['last_name'];?>" placeholder="e. g. abc"  type="text"   style=" color:grey; ">
</div>
</div>
</div>
...
<div class="field__wrap">
 <select name="sex" id="sex"  class="xs-fieldData"   style="height: 48px;
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="dob" id="dob"  value="<?php if($resultOrg['dob_day']!='') echo date('Y-m-d',strtotime($resultOrg['dob_day'].'-'.$resultOrg['dob_month'].'-'.$resultOrg['dob_year'])); else echo date('Y-m-d'); ?>" placeholder="e. g. abc"  type="date"   style=" color:grey; ">
</div>
</div>
</div>
