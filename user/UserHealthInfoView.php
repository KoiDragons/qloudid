               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.safeqloud.com/user/index.php/ConnectKin/contactAccount" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true" style="color:#e02680;"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
                <div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu  fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="https://www.safeqloud.com/user/index.php/ConnectKin/contactAccount" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
								</li>
			...
			<!-- CONTENT -->
			  <div class="column_m container zi5  mart40 xs-mart0" onclick="checkFlag();" id="loginBank">
                <div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0  ">
						...
						<div class="padrl10">
							...
							<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75" style="height: 381px;">
								...
								<div class="column_m padb10 ">
									...
									<li class=" dblock padr10 padb10 padl8">
											<a href="../ConnectKin/kinInfo" class=" lgtgrey_bg hei_35p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a" >
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
												<span class="valm trn">+Add kin</span>
												<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg  rotate45"></div>
											</a>
										</li>
										
										<li class=" dblock padr10  padl8">
											<a href="https://www.safeqloud.com/user/index.php/NotifyFamilyFriends" class=" lgtgrey_bg hei_35p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a" >
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
												<span class="valm trn">Notify</span>
												<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg  rotate45"></div>
											</a>
										</li>  
									</ul>
					...
					<a href="../ConnectKin/contactAccount" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Emergency book</span> 
					<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>
										 
							<li class="dblock padrb10">
	<a href="../ConnectKin/noffRelatives" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Relatives</span> 
	<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>			
										 
					<li class="dblock padrb10">
	<a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brdb_blue brdclr_pink_ff5bad black_txt  padb10"> <span class="valm trn" style="letter-spacing: 2px;">Health</span> 
	<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>					
					 ...
					 <div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl20 xs-pad0">
						...
						<div class="padb20 xxs-padb0 ">
							<!-- Charts -->
							 ...
							 <div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 bgclr_pink_ff5bad  ">
	
	<div class="wrap maxwi_100 xs-padr25 xs-padl10 padt10 xs-padt0 bgclr_pink_ff5bad  brdb_new tall xs-nobrdb">
	
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
								<div class="padb40 talc fsz45"><i class="fas fa-first-aid white_txt"></i></div>
			<div class="padb0 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 white_txt trn ffamily_avenir">Health</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="white_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">This is your health information.</a></div>
									</div>
             ...
             <div class="column_m   talc lgn_hight_22 fsz16 lgtgrey_bg  " >
                        <div class="wrap maxwi_100 xs-padr25 xs-padl10   lgtgrey_bg    tall  ">
                           <div class="wi_auto  hei_65p maxwi_100   pos_rel zi5 marrla    brdrad5  padrl30">
                              <div class="martb15  xxs-talc talc ffamily_avenir  fsz18 xs-fsz16">Manage your  <a href="UserHealthInfo/addAllergyDetail" class="black_txt  xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Allergy</a>/<a href="UserHealthInfo/addSicknessDetail" class="black_txt  xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Sickness</a></div>
                           </div>
                        </div>
                     </div>     
								<div class="clear"></div> 
							 <div class="padb0 xxs-padb0 brdb_new red_ff2828_brdclr brd_width_2 mart20">
							
								<div class="container padrl0 xs-padrl0  padb10">
							
							<div class="marrla xs-wi_100">
								
								<form action="UserHealthInfo/addUpdateBloodInfo" name="save_indexing" id="save_indexing" method="POST" >
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn padb10">
											<div class="thr_clmn padl5 wi_70">
												<select name="blood_type" id="blood_type" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl10 hei_50p fsz18 llgrey_txt dropdown-bg" >
															<option value="0">Blood type</option>
											<?php foreach($bloodType as $category => $value)
												
												{
												?>
												<option value="<?php echo $value['id']; ?>"  <?php if($userHealthDetail['blood_group']==$value['id']) echo 'selected'; ?>><?php echo $value['blood_group']; ?></option>
											<?php } ?> 
											</select>	
											...
											<div class="thr_clmn padl5 wi_30">
												<input type="button" value="Add" class="wi_100 mart5 maxwi_100 brdrad3 hei_50p diblock nobrd red_ff2828_bg fsz18 white_txt curp" onclick="submitBloodInfo();">
							...
							<div class="clear"></div>
								 ...
								 <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt   mart0">
                                <div class="container ">
                                    <div class="">
							...
							<div class="tab_container mart10">
                                  ...
                                  <div class="tab_content active" id="utab_Advertising" style="display: block;">
										...
										<div  id="employerRequest">
											<?php  
												...
												foreach($userAllergyDetail as $category => $value) 
												{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_50p marr15  "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz25   brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"><?php echo substr($value['allergy_info'],0,1); ?> </div>
																	</div>
													
													<div class="fleft wi_75   xs-mar0 ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz14 xs-padt0 black_txt">Allergy</span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz18  black_txt"><?php echo $value['allergy_info']; ?></span>  </div>
													 
													<a href="UserHealthInfo/deleteAllergyDetail/<?php echo $value['enc']; ?>"><div class="fright wi_10 padt10 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz25  padb0 xxs-marr20 hidden-xs">
											...
											<?php }  
												...
												foreach($userSicknessDetail as $category => $value) 
												{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_50p marr15  "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz25   brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"><?php echo substr($value['sickness_detail'],0,1); ?> </div>
																	</div>
													
													<div class="fleft wi_75   xs-mar0 ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz14 xs-padt0 black_txt">Sickness</span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz18  black_txt"><?php echo $value['sickness_detail']; ?></span>  </div>
													 
												<a href="UserHealthInfo/deleteSicknessDetail/<?php echo $value['enc']; ?>">	<div class="fright wi_10 padt10 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz25  padb0 xxs-marr20 hidden-xs">
														<span class="fas fa-times-circle red_txt"></span> 
													</div></a>
