...
<html class="white_bg">
	...
	<body class="fsz14 white_bg">
			...
			<div class="column_m header xs-header bs_bb ">
		<div class="wi_100 hei_65p xs-pos_fix padtb5 padrl10 ">
		...
		<div class="fright xs-dnone sm-dnone padt10">
					<ul class="mar0 pad0">
						<li class="dblock hidden-xs hidden-sm fright pos_rel brdl "> <a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Stäng" data-sw="Stäng">Stäng</a> </li>
					</ul>
				</div>
									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock padb10 padl8">
											<a href="#" class="active lgtgrey_bg hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a">
												...
												<span class="valm trn fsz14">Product Page</span>
												<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg  rotate45"></div>
											</a>
										</li>
										<?php if($getAppsPermissionDetail['is_downloaded']==1) { ?>
										<li class=" dblock  padl8 ">
											<a href="../../productPageAccess/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
												<span class="valm trn fsz14">Access</span>
												<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg  rotate45"></div>
											</a>
										</li>
										<?php } ?>
				...
				<div class="dflex xs-dblock justc_c alit_c fsz22 xs-fsz18 darkgrey_txt padrl0 padb10 brdb_new  xs-padrl0">
					...
					<div class="wi_80 xs-wi_100 bs_bb padl40 xs-padl0 tall">
						...
						<div class="mart0 talc">
													<a href="../../downloadApp/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>"><input type="button" value="Download" class="wi_25 maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp fleft talc"  ></a>
					...
					<div class="l-row whats-new__content">
						...
						<div class="l-column small-12 medium-9 large-8a small-valign-top">
							<div id="ember239" class="we-truncate we-truncate--multi-line we-truncate--interactive ember-view">    
								...
								<div data-clamp="" id="ember241" class="we-clamp ember-view">
