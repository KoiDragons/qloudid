               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../listItemsDetailVolunteers" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
...
<div class="column_m header hei_55p  bs_bb white_bg visible-xs" >
 ...
 <!-- CONTENT -->
	...
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
								<div class="padb40 talc marb25 fsz75 xxs-fsz60 black_txt"><?php echo $itemListDeliveredyItemCount; ?></i></div>
			<div class="padb0 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 black_txt trn ffamily_avenir">Item</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Please confirm below that you received these items.</a></div>
									</div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="tab_container mart10">
											...
											<?php $i=0;
												...
												foreach($itemListDeliveredVolunteer as $category => $value) 
												{
										...
										<div class="container padrl10 padb20 padt15    brdrad1 fsz18 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padl0 fsz12">
													...
													<span class="trn fsz18  black_txt ffamily_avenir  "><?php echo substr($value['item_detail'],0,12); ?></span>  </div>
													
													
													
													<a href="../inactivateProduct/<?php echo $value['enc']; ?>/<?php echo $data['aid']; ?>"><div class="fright wi_10 padl0  marl15 fsz40  xs-marl0 xxs-marr20 padb0  ">
												...
												<?php } else if($value['is_delivered']==3) { ?>
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padl0 fsz12">
													...
													<div class="fleft wi_40 grey_txt "> 
													<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2 fsz14 padb0  ffamily_avenir"><?php echo $value['total_packets'].' packets'; ?></span>
													<span class="trn fsz18  grey_txt ffamily_avenir  "><?php echo substr($value['item_detail'],0,12); ?></span>  </div>
													
													
													
													<a href="../activateProduct/<?php echo $value['enc']; ?>/<?php echo $data['aid']; ?>"><div class="fright wi_10 padl0  marl15 fsz40  xs-marl0 xxs-marr20 padb0  ">
														<span class="far fa-times-circle  grey_txt"></span>
													</div></a>
											...
											<div class="clear"></div>
                                                ...
                                                <div class="clear"></div>
												<?php if($itemListDeliveredVolunteerCount>0) { ?>
												<div class=" padtb20 talc fsz16  marb80"> <a href="../receiveProduct/<?php echo $data['aid']; ?>" class="forword hei_55p fsz18  t_67cff7_bg ffamily_avenir" >I hereby confirm </a> </div>
