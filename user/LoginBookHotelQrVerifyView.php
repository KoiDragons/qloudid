...
<link rel="manifest" href="../../../../html/fleet/img/site.webmanifest">
<link rel="mask-icon" href="../../../../html/fleet/img/safari-pinned-tab.svg" color="#5bbad5">
...
<link rel="stylesheet" media="all" href="../../../../html/fleet/css/app.min.css">
	<script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script type="text/javascript" src="../../../../html/usercontent/js/jquery.js"></script>
	<script src="../../../../html/usercontent/js/Duplicate.js"></script>
<script>
...
if( ios ) {
   ...
   $('#android').removeClass('hidden');
		...
		function ajaxSend()
			...
			send_data1.client_id='<?php echo $_GET['client_id']; ?>';
			send_data1.total_price='<?php echo $hotelPrice; ?>';
			send_data1.booking_id='<?php echo $data['id']; ?>';
				$.ajax({
					type:"POST",
					...
					success: function(data2){
						if(data2!=2)
						{
							 ...
							 else if(data2==4)
							{
								...
								$("#errorMsg").html("Please select profile to continue purchase.");
								return false;
							}
						...
						{
							a=setInterval(dataSubmit, timeInterval1);
					//	document.getElementById("save_indexing_user").submit();
...
<body class="dark" onload="checkLogin();">
...
<button class="header__head js-header-head" style="color:#000000; font-size:20px;">This is a demo for how to login using Qloud ID
	...
	<div class="clear" id=""></div>
	 ...
	 <form action="https://www.safeqloud.com/walk/authorize_book.php?response_type=code&client_id=<?php echo $_GET['client_id']; ?>&state=xyz&hotel=1" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
...
<div class="receipt xs-margin0" style="border: none;   background-color:#212b39; padding:0; margin:0; width:100%;">
<h1 class="hero margin-bottom16" style="font-size:70px;">Open Qloud ID App</h1>
<div class="main__info info margin-bottom16 white_txt">Then type your security code for verification.</div>
</div>
</div>
</div>
</div>
<div class="section description mart80 xxs-mart40  xs-padb0" style="background: #212b39;" id="loginBank">
<div class="description__center center xxs-padrl25">
<div class="description__wrapper xs-pad0 padrt50 xxs-marb10">
<h4 class="description__title h4 fsz50 xs-talc xs-fsz35  marb0 xs-nobold" style="
...
<p class="fsz35 lgn_hight_45 fsz35 xs-lgn_hight_25 xs-fsz20 xs-talc ">Scan and sign with Qloud ID app to get access to your account</p>
...
<p class="fsz20 lgn_hight_25 xs-lgn_hight_25 xs-fsz20 xs-talc">If you dont have a Qloud ID account then you can download it for free on Appstore or Android marketplace</p>
...
<button class="button-stroke button-small description__button" style="display: none;">Show more</button>
		...
		<div class="receipt xs-margin0 marl60 maxwi_100 wi_375p xs-pad20" style="
    border: 1px solid #212b3a; background-color:#2F3C4F;
">
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" class="white_brd brdrad5" style="width: 150px;height: 150px;"></div>
</div>

</div>
<div class="receipt__foot">
<div class="receipt__free" style="margin-bottom: 5px;font-size: 25px;color: white;">
                  Scan QR code</div>
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="safeqloudUrl://<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" id="iOS">
<div class="receipt__description talc marrla " style="
    ...
    margin-bottom: 20px;
">
<div class="receipt__item talc" style="justify-content: center;padding: 8px;height: 55px;">

<div class="receipt__box">
<div class="receipt__subtitle" style="color:white !important;">Open Qloud ID App</div>
</div>
</div>
</div></a>

<a class="hidden visible-xs " style="text-decoration:none !important;" href="https://www.safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" id="android">
<div class="receipt__description talc marrla " style="
    background: #101010;
    border-radius: 50px;
    width: 230px;
...
<svg class="icon icon-coin">
				...
				<a class="button receipt__button   hidden" href="safeqloudUrl://<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>"  ><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
				
				<a class="button receipt__button hidden" href="https://www.safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
...
<div class="section travel hidden" style="padding-bottom: 80px;">
...
<div class="section faq" id="loginFaq">
...
<select class="select js-tabs-select" style="display: none;">
<option>General</option>
<option>Support</option>
<option>Bookings</option>
<option>Hosts</option>
</select><div class="nice-select select js-tabs-select" tabindex="0"><span class="current">General</span><ul class="list"><li data-value="General" class="option selected">General</li><li data-value="Support" class="option">Support</li><li data-value="Bookings" class="option">Bookings</li><li data-value="Hosts" class="option">Hosts</li></ul></div>
</div>
</div>
<div class="faq__row js-tabs">
<div class="faq__col">
<div class="faq__nav"><a class="faq__link js-tabs-link active" href="#">
<svg class="icon icon-home">
<use xlink:href="#icon-home"></use>
</svg>General</a><a class="faq__link js-tabs-link" href="#">
<svg class="icon icon-circle-and-square">
<use xlink:href="#icon-circle-and-square"></use>
</svg>Support</a><a class="faq__link js-tabs-link" href="#">
<svg class="icon icon-lightning">
<use xlink:href="#icon-lightning"></use>
</svg>Bookings</a><a class="faq__link js-tabs-link" href="#">
...
<div class="faq__box js-tabs-item" style="display: none;">
<div class="faq__item">
<div class="faq__head">How to start with Stacks</div>
<div class="faq__body">
<div class="faq__content">The Stacks series of products: Stacks: Landing Page Kit, Stacks: Portfolio Kit, Stacks: eCommerce Kit. "Stacks is a production-ready library of stackable content blocks built in React Native. Mix-and-match dozens of responsive elements to quickly configure your favorite landing page layouts or hit the ground running with 10 pre-built templates, all in light or dark mode."</div>
