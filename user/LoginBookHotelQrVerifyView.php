...
<button class="header__head js-header-head" style="color:#000000; font-size:20px;">This is a demo for how to login using Qloud ID
	...
	<div class="clear" id=""></div>
	 ...
	 <form action="https://www.qloudid.com/walk/authorize_book.php?response_type=code&client_id=<?php echo $_GET['client_id']; ?>&state=xyz&hotel=1" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" id="iOS">
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" id="android">
<div class="receipt__description talc marrla " style="
    background: #101010;
    border-radius: 50px;
    width: 230px;
...
<svg class="icon icon-coin">
				...
				<a class="button receipt__button   hidden" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>"  ><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
				
				<a class="button receipt__button hidden" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
