...
function checkFlag()
	...
	<div class="column_m header xs-header xsip-header xsi-header bs_bb lineargrey_bg"  >
			...
			<div class="top_menu frighti padt20 padb10 hidden-xs">
				<ul class="menulist sf-menu  fsz14 ">
					...
					<li class=" brdr padr20">
						<a href="javascript:void(0);" class="lgn_hight_s1 fsz16 sf-with-ul"><span class="black_txt">About Qloud ID</span></a>
						<ul style="display: none;">
							...
							<li>
								<div class="emailupdate_menu padtb15">
								<div class="lgtgrey_txt fsz13 padrl15">About Qloud ID...</div>
									 <ol>
														<li class="fsz14">
														<div class="user_pic padt5"><a href="javascript:void(0);"><img src="<?php echo $path1;?>slide/flag_sw.png" width="28" height="28" alt="email" title="email"data-value="sv" class="" ></a></div>
													...
													<li>
														...
														<div class="mail_content padt10 "> <a href="javascript:void(0);" class="fsz14 black_txt " data-value="de" >  For companies </a> </div>
													</li>
														<li>
														<div class="user_pic padt5"><a href="javascript:void(0);" ><img src="<?php echo $path1;?>slide/germanf.png" width="28" height="28" alt="email" title="email"data-value="de" class="" ></a></div>
														<div class="mail_content padt10 "> <a href="javascript:void(0);" class="fsz14 black_txt " data-value="de" >  For consumers </a> </div>
													</li>
                </ol>
	...
	<li>
			...
			<div class="visible-xs visible-sm fright marr0 padr0 padt10  brdwi_3"> <a href="#" class="diblock padl20 padr10 brdrad3 transbg  lgn_hight_29 fsz14 black_txt">Close</a> </div>
				<div class="clear"></div>
			</div>
		</div>
	<div class="clear"></div>