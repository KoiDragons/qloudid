   ...
   $('#android').removeClass('hidden');
	...
	<div class="clear" id=""></div>
		...
		<div class="column_m pos_rel">
			...
			<!--<input type="hidden" value="Yes" name="authorized" id="authorized" class="wi_100 maxwi_100 brdrad3 hei_50p diblock nobrd trans_bg fsz18 red_txt curp"/>-->
			<!-- <input type="hidden" value="" name="user_id" id="user_id" class="wi_100 maxwi_100 brdrad3 hei_50p diblock nobrd trans_bg fsz18 red_txt curp"/>-->
			</form>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" >
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						...
						<div class="padtb0 brdrad3 ">
						 <div class="padt20 xxs-talc talc visible-xs hidden" id="android">
								...
								<a href="https://www.safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>"><button type="button" name="forward" class="forword minhei_55p bluergb_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
						    
						     <div class="padt20 xxs-talc talc visible-xs  hidden" id="iOS">
								
								<a href="safeqloudUrl://<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>"><button type="button" name="forward" class="forword minhei_55p bluergb_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
							<div class="padb10  talc padt20 hidden-xs">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/hotel/1<?php if(isset($_GET['client_id'])) echo '/'.$_GET['client_id']; ?>" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
				...
				<div class="tw_clmn padl10 talr lgn_hight_18 fsz16 wi_70"> <a href="../LoginAccount">Logga in med email</a> </div>
				</div>
						</div>
