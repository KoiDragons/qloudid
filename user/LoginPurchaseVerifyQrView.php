					...
					success: function(data2){
						...
						else 
						{
							for(var i=1; i<=5; i++)
							{
								...
								setTimeout(document.getElementById("save_indexing_user").submit(), 10000);
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						...
						<div class="padtb0 brdrad3 ">
							...
							<div class="padb10  talc padt20">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/<?php echo $_GET['client_id']; ?>/purchase/1" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
