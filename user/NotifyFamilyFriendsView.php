...
<div class="column_m header xs-hei_55p bs_bb bg_ffc1e0">
				<div class="wi_100 hei_65p xs-hei_55p xs-pos_fix padtb5 padrl10 bg_ffc1e0">
				
				<div class="logo marr15 wi_80p xs-wi_130p ">
				
					<a href="#"> <h3 class="marb0 pad0 fsz30 bold black_txt padt10 xs-padt5 padb10" style="font-family: Avenir;">Noffa</h3> </a>
			...
			<div class="wi_760p xsi-wi_100 columns header_left alpha padt90 xs-padt0 xs-talc maxwi_100">
				...
				<div class="seven columns header_right white_bg maxwi_375p omega xs-wi_100 box_shadow_00000070 mart40 marb40">
					<div class="header_right_inner padrtl35i white_bg padb0">
						...
						<fieldset >
							 <label for="phone" > 
							<select  name="ccountry" id="ccountry" class="default_view wi_100 mart0  bg_ffc1e04f nobrdr nobrdt nobrdl   nobrd txt_ff28288f  fsz18  xxs-minhei_50p minhei_55p     tall  ffamily_avenir marb15" style="text-align-last:center;">
						    ...
						    <label for="email"> 
						    <input type="text" class="wi_100 nobrdt nobrdr nobrdl   bg_ffc1e04f txt_ff28288f nobrd talc  xxs-minhei_50p minhei_55p fsz18  ffamily_avenir  marb20" name="ssecurity1" id="ssecurity1" placeholder="Social security number" autocomplete="off" />
						    </label>
						    
						   <div class="on_clmn " >
											<div class="thr_clmn wi_50 padr10">
						    <label for="phone"> 
						    <input type="text"  class="wi_100 nobrdt nobrdr nobrdl   bg_ffc1e04f  nobrd talc  xxs-minhei_50p minhei_55p fsz18 txt_ff28288f ffamily_avenir marb20" name="f_name" id="f_name" placeholder="Name" autocomplete="off"/>
						    </label>
							</div>
							<div class="thr_clmn padl10 wi_50">
							   <label for="phone"> 
						    <input type="text"  class="wi_100 nobrdt nobrdr nobrdl   bg_ffc1e04f  nobrd talc  xxs-minhei_50p minhei_55p fsz18 txt_ff28288f ffamily_avenir marb20" name="l_name" id="l_name" placeholder="Last name" autocomplete="off"/>
						    </label>
						 </div>
						 </div>
						 <div class="clear"></div>
...
<div class="wi_1200p maxwi_100 dflex xs-fxwrap_w alit_c padt30 xs-padt10 marb0 white_bg marrla ">
