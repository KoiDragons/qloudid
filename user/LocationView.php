...
<html>
	<head>
		...
		<script src="<?php echo $path; ?>html/getstarted/js/he.js"></script>
	...
	if(x == "")
		{
			...
			$("#district").css("background-color","#FF9494");
			return false;
		}
	document.getElementById("save_indexing").submit();
}	
		
		function state_select(country_id)
{
	start=1;
  country = country_id;
  
  var send_data = {};
  send_data.country_id = country_id
//get state list
  $.ajax({
    url: 'Location/selectState/',
    type: 'POST',
  //  dataType: 'text/xml',
    data: send_data, success : function(data){
		 $(".jain").removeClass('hide');
		// alert( htmlD(data));
		//alert(he.decode('&amp;Atilde;&amp;cent;&amp;acirc;&amp;sbquo;&amp;not;&amp;acirc;&amp;euro;&amp;oelig;'));
	 document.getElementById("state").innerHTML =he.decode(data);
...
function city_select(state_id)
{
	start=1;
  state = state_id;
  var send_data = {};
  send_data.state_id = state_id
//get state list
  $.ajax({
    url: 'Location/selectCity/',
    type: 'POST',
    //dataType: 'text/xml',
    data: send_data,
  })
  .done(function(data){
	   $(".jain1").removeClass('hide');
...
function district_select(city_id)
{
	start=1;
  city = city_id;
  var send_data = {};
  send_data.city_id = city_id
$.ajax({
    url: 'Location/selectDistrict/',
    type: 'POST',
    //dataType: 'text/xml',
    data: send_data,
  })
  .done(function(data){
	   $(".jain2").removeClass('hide');
			...
			<div class="sliding-modal-tabs active-base wi_400p hei_100vh pos_abs top0 right-400p right0_a bs_bb white_bg fsz12 dark_grey2_txt trans_all3">
				...
				<div class="sliding-modal-content wi_100 hei_100 overfl_auto pos_abs zi5 top0 left0 white_bg">
					...
					<div class="sliding-modal-tab aero-bold" id="tab-articles">
						<form action="Location/updateLocation" method="post" name="save_indexing" id="save_indexing">
							...
							<div class="form-progress pos_rel zi1">
								...
								<div class="wi_100 hei_180p pos_abs top0 left0 bs_bb padtrl10 lgtgrey2_bg">
									...
									<!-- progress -->
									<div class="progress wi_85 hei_10p ovfl_hid fleft mart5 grey_bg">
										<div class="dblue_bg wi_100 hei_100"></div>
									</div>
									
									<div class="clear padb30"></div>
									
									<!-- title -->
									<h2 class="bold fsz32">Let's start</h2>
									
									<!-- description -->
									<p class="pad0 fsz16">What type of work do you need?</p>
						...
						<div class="mart5 padrl10">
							<div class="select-base padb10">
								<select class="binded-select default wi_100i bs_border pad10 brd brdrad_2 lgtgrey3_txt" onchange="state_select(this.value);"  name="cntry" id="cntry">
					 ...
					 ?>
							...
							<div class="select-base padb10 jain hide">
								<select class="binded-select default wi_100i bs_border pad10 brd brdrad_2 lgtgrey3_txt"  name="state" id="state" onchange="city_select(this.value);"></select>
							</div>
							<div class="select-base padb10 jain1 hide">
								<select class="binded-select default wi_100i bs_border pad10 brd brdrad_2 lgtgrey3_txt"  name="city" id="city"  onchange="district_select(this.value);" ></select>
							</div>
							<div class="select-base padb10 jain2 hide">
								<select class="binded-select default wi_100i bs_border pad10 brd brdrad_2 lgtgrey3_txt"  name="district" id="district" ></select>
							</div>
						</div>
						<div class="padb20">
							<div class="padrl10">
								<button type="button" class="dblue_btn wi_100 bs_border padr0i padl10i blue2_bg dblue2_bg_h tall fsz14" onclick="submit_form();"> <span class="fa fa-share-square-o marr5 valm fsz16i"></span> <span class="valm">Submit</span> </button>
