...
<a class="header__logo " href="https://www.safeqloud.com/user/index.php/NewPersonal/addressList" style="
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Send, approve or reject requests from service providers</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				  ...
				  <a class="categories__item  black_bg " href="javascript:void(0);" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">Requests received</div>
                                      </a>
									  
									  <a class="categories__item    " href="javascript:void(0);" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Requests sent</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active" href="#">All</a><a class="nav__link" href="#">Sell</a><a class="nav__link" href="#">Manage</a> <a class="nav__link" href="#">Rent</a></div>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;"><?php echo $value['company_name']; ?></div>
...
">
                <div class="description__parameter" style="margin-top: 0px;">
                  ...
                  </svg>From <?php echo date('Y-m-d',$value['contract_start_date']); ?></div>
                <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>To <?php echo date('Y-m-d',$value['contract_end_date']); ?></div>
				  
				  <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php if($value['request_type']==1) echo 'For Sell'; else if($value['request_type']==2) echo 'For Sold'; else if($value['request_type']==3) echo 'For Rent'; else echo 'For Others';?></div>
                
              </div>
                         <a href="approveExclusiveRequest/<?php echo $value['request_id']; ?>" style="text-decoration:none;" >
