			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40" id="loginBank">
				<div class="wrap maxwi_100 padrl15 xs-padrl25">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
							...
							<form action="../../updateUserPersonalAddress/<?php echo $data['aid']; ?>/<?php echo $data['booking_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<a href="#profile1" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active">Guest personal Address 
							 ...
							 <div class="clear"></div>
								...
								<div class="marrl0 padb15 brdb fsz16 white_bg tall padt35">
								<a href="#profile2" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active">Guest personal Card 
								<span class="dnone_pa fa fa-chevron-down fright dark_grey_txt"></span><span class="dark_grey_txt dnone diblock_pa fa fa-chevron-up padr15 fright"></span></a></div>
							 ...
							 <div class="clear"></div> 
									...
									<div class="thr_clmn  wi_50   xs-padl20">
										...
										<input type="text" value="If invoice is on company name? " class="wi_100 rbrdr pad10    tall  xxs-minhei_60p minhei_65p fsz18 black_txt ffamily_avenir" readonly="">
