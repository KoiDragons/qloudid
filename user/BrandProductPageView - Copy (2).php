...
<html>
	...
	<body class="font_poppins fsz14">
		...
		<div class="column_m xs-padtb10 zi5 talc lgn_hight_22 fsz16 white_bg " onclick="checkFlag();">
			...
			<div class="wi_240p fleft pos_rel zi50">
									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock padb10 padl8">
											<a href="#" class="active lgtgrey_bg hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a">
												...
												<span class="valm trn">Product Page</span>
					...
					<!-- Center content -->
					<div class="wi_900p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xs-padl0">
