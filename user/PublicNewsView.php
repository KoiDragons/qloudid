	...
	<head>
		...
		<div class="column_m header xs-header  bs_bb white_bg">
			<div class="wi_100 xs-hei_40p hei_65p pos_fix padtb5 padrl10  white_bg">
				...
				<div class="visible-xs visible-sm fright  brdwi_3 "> <a href="https://www.qloudid.com/user/index.php/LoginAccount" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Login</a> </div>
				<div class="clear"></div>
					 	...
					 	<div class="dflex xs-fxwrap_w alit_c mart40 ">
							...
							<div class="wi_50 xs-wi_100 flex_1 order_2 xs-order_1 xs-tall tall mart10 brdrad5 talc white_bg">
								...
								<div class="wi_100 xs-wi_100 bs_bb pad40 tall">
									...
									<div class="mart20 tall"> 
										<a href="https://www.qloudid.com/user/index.php/PublicFastigheter"><input type="button" value="Mer om Besökssysstem" class="padl20 nobrd wi_60 maxwi_500p minhei_50p dflex  alit_c opa90_h brdrad3 panlyellow_bg fsz20 xs-fsz16 darkgrey_txt trans_all2 tall"></a>
									</div>
								</div>
				...
				<div class="wrap maxwi_100 xs-marb30 xs-padb30 xs-padrl20 padt20 padb20 brdb_new bluenew_bg">
					<div class="dflex xs-dblock justc_c alit_c fsz26 xs-fsz18 darkgrey_txt padrl30">
						...
						<div class="wi_50 xs-wi_100 bs_bb padl40 xs-padl0 tall">
							...
							<div class="mart20 tall"> 
								<a href="https://www.qloudid.com/user/index.php/PublicFastigheter"><input type="button" value="Mer om Teknisk partner" class="padl20  nobrd wi_100 maxwi_500p minhei_50p dflex  alit_c opa90_h marrla brdrad3 panlyellow_bg fsz20 xs-fsz16 darkgrey_txt trans_all2 tall"></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wrap maxwi_100 xs-marb30 xs-padb30 xs-padrl20 padt50 padb20 brdb_new">
					<div class="dflex xs-dblock fxdir_rowr justc_c alit_c fsz26 xs-fsz18 darkgrey_txt ">
						<div class="wi_50 xs-wi_100 bs_bb padl40 xs-padl0 tall">
							...
							<div class="mart20 tall"> 
								<a href="https://www.qloudid.com/user/index.php/PublicFastigheter"><input type="button" value="Mer om Farstighetspartners " class="padl20  wi_100 maxwi_500p minhei_50p dflex  alit_c opa90_h marrla brdrad3 brdb_b fsz20 xs-fsz16 darkgrey_txt trans_all2 tall panlyellow_bg nobrd"></a>
							</div>
						</div>
						<div class="wi_50 xs-wi_100">
							<img src="../../html/smartappcss/images/smart/design-2.png" class="wi_80 hei_auto">
