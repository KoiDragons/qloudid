   ...
   $('#android').removeClass('hidden');
	...
	<div class="clear" id=""></div>
		...
		<div class="column_m pos_rel">
			...
			<form action="updateAppAccount" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
			<input type="hidden" name="total_value" id="total_value" value='<?php echo $_POST['total_value']; ?>' />
			<input type="hidden" name="updateSecurity" id="updateSecurity" value="<?php echo $_POST['updateSecurity']; ?>" />
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						...
						<div class="padtb0 brdrad3 ">
							...
							<div class="padb10  talc padt20">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP.'_'.$row_summary['enc']; ?>" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
