         ...
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Sign in and access your Club TXP Account
</div>
...
<form class="checkout__item js-tabs-item" action="verifyEmailOtp<?php if(isset($_GET['redirect'])) echo '?redirect='.$_GET['redirect']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
