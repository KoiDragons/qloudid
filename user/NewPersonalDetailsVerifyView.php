	...
	<head>
		...
		<script>
			function submitDepartment()
			{
				...
				{
				$("#errorMsg").html('please update your name on your personal account and try again');	
				return false;
				}
				if($("#ssn").val()=="" || $("#ssn").val()==null)
				{
				$("#errorMsg").html('please update your ssn on your personal account and try again');	
				return false;
				}
				
				if($("#dob").val()=="" || $("#dob").val()==null)
				{
				$("#errorMsg").html('please update your dob on your personal account and try again');	
				return false;
				}
				
				if($("#phone_number").val()=="" || $("#phone_number").val()==null)
				{
				$("#errorMsg").html('please update your phone number on your personal account and try again');	
				return false;
				}
				...
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc   xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Verify details and  generate certificate</a></div>
							...
							<div class="marrla xs-wi_100">
								...
								<form action="generateCertificate" name="save_indexing" id="save_indexing" method="POST" accept-charset="ISO-8859-1">
									<div class="marb0 padb10 ">
										...
										<input type="text" value="Country"  class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="on_clmn ">
											...
											<div class="pos_rel">
													<select name="country_id" id="country_id"  class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir " disabled> 
											 		<?php  
													
													foreach($countryOpt as $category => $value) 
													{
														
														
													?> 
											<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($value['id']==$row_summary['country_of_residence']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
													<?php } ?>
													</select>
										...
										<input type="text" value="Name" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
									...
									<div class="on_clmn">
											...
											<div class="pos_rel">
													...
													<input type="text" name="f_name" id="f_name" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir"  value="<?php echo $resultOrg['first_name']; echo ' '; echo $resultOrg['last_name']; ?>" readonly />
										...
										<input type="text" value="Social security number" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
											...
											<div class="pos_rel">
													...
													<input type="text" name="ssn" id="ssn" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir"  value="<?php echo $resultOrg1['ssn']; ?>" readonly />
								...
								<div class="on_clmn   mart20  ">
										...
										<input type="text" value="Date of Birth" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
											...
											<div class="pos_rel">
													...
													<input type="date" name="dob" id="dob" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir"  value="<?php echo date('Y-m-d',strtotime($resultOrg['dob_day'].'-'.$resultOrg['dob_month'].'-'.$resultOrg['dob_year'])); ?>" readonly />
										...
										<input type="text" value="Phone number" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
											...
											<div class="pos_rel">
													...
													<input type="number" name="phone_number" id="phone_number" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir"  value="<?php echo $resultOrg1['phone_number']; ?>" readonly />
