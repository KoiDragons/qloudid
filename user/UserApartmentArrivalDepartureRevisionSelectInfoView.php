					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
									...
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="<?php if($resultOrg1['arrival_departure_updated']==1) { echo 'green_bg_00ff9996'; } else  { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Check in and Check-out</span>
									...
									<div class="clear"></div>
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="<?php if($resultOrg1['house_rules_updated']==1) { echo 'green_bg_00ff9996'; } else  { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">House rules</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Add/update house rules details</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
