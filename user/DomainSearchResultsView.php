							...
							<li>
								<div class="setting_menu pad15">
									...
									<ol class="">
										...
										<li><a href="../UserLogout?action=logout" class="trn">Logout</a>
										</li>
									</ol>
									<div class="clear"></div>
								</div>
	...
	<div class="column_m pos_rel">
					...
					<ul class="dflex alit_s justc_c mar0 pad0">
						<!--<li class="dflex alself_fs marrl10 padrl5">
							<div class="minwi_100p pos_rel padr20">
								<img src="<?php echo $path;?>html/usercontent/images/icons/tp-active.png" class="wi_auto hei_75p dblock marrla " alt="">
								<div class="hei_60p pos_abs top0 right0 brdr"></div>
							</div>
						</li>-->
						<li class="dflex alit_s marrl10 padrl5">
							<a href="#" class="minwi_100p dblock padb15 brdb brdwi_3 brdclr_trans brdclr_pred2_h brdclr_pred2_a talc fsz14 fsz15_a txt_f2f1f1 pred2_txt_a">
						...
						<li class="dflex fxwrap_w alit_s pos_rel marrl10 padrl5">
							<a href="#" class="active class-toggler minwi_100p dblock padb15 brdb brdwi_3 brdclr_trans brdclr_pred2_h brdclr_pred2_a talc fsz14 fsz15_a txt_f2f1f1 pred2_txt_a" data-target="#menulist-dropdown2,#menulist-dropdown2" data-classes="active" data-toggle-type="separate">
							...
							<div class="wi_100i top_menu top_menu_custom mar0i nofloati">
							<ul class="menulist">
								<li class="mar0i">
									
									<ul class="dblocki_a top-9pi" id="menulist-dropdown2">
										<li>
											<div class="top_arrow left170pi"></div>
										</li>
										<li>
											<!-- MAIN -->
											<div class="tab-content application_menu pad20" id="tab2-main">
												<ol class="tab-header">
													<li>
														<a href="#" data-id="tab2-per" class="business_prof">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>Personal</a>
													</li>
													<li>
														<a href="#" data-id="tab2-bus" class="swedBank">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>Business</a>
													</li>
												</ol>
											...
											<!-- PERSONAL -->
											<div class="tab-content application_menu pad20" id="tab2-per">
												<ol>
													<li>
												...
												<div class="column_m tab-header"> <a href="#" class="contractor_btn" data-id="tab2-main"><span></span> Back to Business</a> </div>
												<div class="clear"></div>
											</div>
											<!-- BUSINESS -->
											<div class="tab-content application_menu pad20" id="tab2-bus">
												<ol class="tab-header">
													<li>
														<a href="#" data-id="tab2-bus-cld" class="business_prof">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>Cloud ID</a>
													</li>
													<li>
														<a href="#" data-id="tab2-bus-vrf" class="swedBank">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>Verify</a>
													</li>
													<li>
														<a href="#" data-id="tab2-bus-act" class="posted_jobs">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>Activate</a>
													</li>
													<li>
														<a href="#" data-id="tab2-bus-eng" class="proposals">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>Engage </a>
													</li>
												</ol>
												...
												<div class="column_m tab-header"> <a href="#" class="contractor_btn" data-id="tab2-main"><span></span> Back to Qmatchup</a> </div>
												<div class="clear"></div>
											</div>
											<!-- Cloud ID -->
											<div class="tab-content application_menu pad20" id="tab2-bus-cld">
												<ol>
													<li>
														<a href="#" class="business_prof">
												...
												<div class="column_m tab-header"> <a href="#" class="contractor_btn" data-id="tab2-bus"><span></span> Back to Business</a> </div>
												<div class="clear"></div>
											</div>
											<!-- Verify -->
											<div class="tab-content application_menu pad20" id="tab2-bus-vrf">
												<ol>
													<li>
														<a href="#" class="business_prof">
											...
											<!-- Activate -->
											<div class="tab-content application_menu pad20" id="tab2-bus-act">
												<ol class="tab-header">
													<li>
														<a href="#" data-id="tab2-bus-act-org" class="business_prof">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>By organization</a>
													</li>
													<li>
														<a href="#" data-id="tab2-bus-act-ind" class="swedBank">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>By industry</a>
													</li>
													<li>
														<a href="#" data-id="tab2-bus-act-top" class="posted_jobs">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
															</div>By topic</a>
													</li>
												</ol>
											...
											<!-- - by organization -->
											<div class="tab-content application_menu pad20 active" id="tab2-bus-act-org" style="display: block;">
												<ol>
													<li>
														<a href="#" class="business_prof">
												...
												<div class="column_m"> <a href="#" class="contractor_btn" data-id="tab2-bus-act"><span></span> Back to Activate</a> </div>
												<div class="clear"></div>
											</div>
											<!-- - by industry -->
											<div class="tab-content application_menu pad20" id="tab2-bus-act-ind">
												<ol>
													<li>
														<a href="#" class="business_prof">
											...
											<!-- - by topic -->
											<div class="tab-content application_menu pad20" id="tab2-bus-act-top">
												<ol>
													<li>
														<a href="#" class="business_prof">
															<div><img src="<?php echo $path;?>html/usercontent/images/product icons/icon-2.png" width="45" height="45" title="" alt="" />
											...
											<!-- Engage -->
											<div class="tab-content application_menu pad20" id="tab2-bus-eng">
												<ol>
													<li>
														<a href="#" class="business_prof">
															<div><img src="<?php echo $path;?>html/usercontent/images/dropbox icons/folder.png" width="45" height="45" title="" alt="" />
						...
						<li class="dflex alit_s marrl10 padrl5">
							<a href="#" class="minwi_100p dblock padb15 brdb brdwi_3 brdclr_trans brdclr_pred2_h brdclr_pred2_a talc fsz14 fsz15_a txt_f2f1f1 pred2_txt_a">
								<span class="fa fa-building-o hei_35p dflex alit_c justc_c talc fsz20 black_txt pred2_txt_ph pred2_txt_pa"></span>
								<span class="dblock mart10">New Tab</span>
							</a>
						</li>
						<li class="dflex alit_s marrl10 padrl5">
							<a href="#" class="minwi_100p dblock padb15 brdb brdwi_3 brdclr_trans brdclr_pred2_h brdclr_pred2_a talc fsz14 fsz15_a txt_f2f1f1 pred2_txt_a">
								<span class="fa fa-building-o hei_35p dflex alit_c justc_c talc fsz20 black_txt pred2_txt_ph pred2_txt_pa"></span>
								<span class="dblock mart10">New Tab 2</span>
							</a>
						</li>
			...
			<div class="scroll-fix-wrap white_bg">
				<div class="wrap maxwi_100">
					<ul class="mar0 pad0 padb15 talc fsz15">
						<li class="diblock marrl10 padrl5"> <a href="#" class="show_popup_modal dblock padtb15 fsz14 fsz15_a txt_f2f1f1 pred2_txt_h pred2_txt_a bold_a" data-target="#sales_popup"></a> </li>
						<li class="diblock marrl10 padrl5"> <a href="#" class="show_popup_modal dblock padtb15 fsz14 fsz15_a txt_f2f1f1 pred2_txt_h pred2_txt_a bold_a" data-target="#marketing_popup"></a> </li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="column_m container zi5">
			<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
				...
				<div class="padb30">
					<h1 class="padb5 talc fsz50">Hey, Kowaken</h1>
					<p class="pad0 talc fsz16">This is your appstore</p>
				</div>
				
				<!-- Center content -->
				<div class="wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10 lgtgrey2_bg">
					<div class="marb10 pad15 brd brdrad3 white_bg">
						<h2 class="marb15 fsz19">
							Domain Search
							<a href="#" class="opa90 opa1_h padrl5 fsz16 txt_9d"><span class="fa fa-question-circle"></span></a>
						</h2>
						<form action="../DomainSearchResults/domainAccount" method="POST" id="save_indexing" name="save_indexing">
							<div class="dflex alit_s marb15">
								<input type="text" name="search" id="search" class="hei_50p flex_1 padrl15 brd brdrad0 brdradtl3 bg_fe white_bg_f fsz15" placeholder="company.com" value="<?php if(isset($_POST['search']))	{ echo $_POST['search']; } ?>" />
								<input type="button" value="search" onclick="checkSearch();" class="hei_50p padrl30 brd nobrdl brdrad0 brdradrb3 white_bg fsz14 bold curp" />
							</div>
							<div class="dflex alit_c fleft marb15 lgn_hight_16">
								<label class="ovfl_hid dflex alit_c marr15 curp">
									<input type="radio" name="type" value="all" class="default opa0 pos_abs top-20p left-20p">
									<div class="wi_24p dnone dblock_sibc"><span class="fa fa-check wi_16p hei_16p dflex alit_c justc_c brdrad25 bg_d fsz13 pred2_bg white_txt"></span></div>
									<div class="wi_24p dnone_sibc"><span class="wi_16p hei_16p dblock brdrad25 bg_d"></span></div>
									<span>All</span>
								</label>
								<label class="ovfl_hid dflex alit_c marr15 curp">
									<input type="radio" name="type" value="personal" class="default opa0 pos_abs top-20p left-20p">
									<div class="wi_24p dnone dblock_sibc"><span class="fa fa-check wi_16p hei_16p dflex alit_c justc_c brdrad25 bg_d fsz13 pred2_bg white_txt"></span></div>
									<div class="wi_24p dnone_sibc"><span class="wi_16p hei_16p dblock brdrad25 bg_d"></span></div>
									<span>Personal</span>
								</label>
								<label class="ovfl_hid dflex alit_c marr15 curp">
									<input type="radio" name="type" value="generic" class="default opa0 pos_abs top-20p left-20p">
									<div class="wi_24p dnone dblock_sibc"><span class="fa fa-check wi_16p hei_16p dflex alit_c justc_c brdrad25 bg_d fsz13 pred2_bg white_txt"></span></div>
									<div class="wi_24p dnone_sibc"><span class="wi_16p hei_16p dblock brdrad25 bg_d"></span></div>
									<span>Generic</span>
								</label>
							</div>
							<div class="fright lgn_hight_16">
								<span class="marl10">2,851 email addresses</span>
							<!--	<a href="#" class="marl10 underline">Export in CSV</a>-->
							</div>
							<div class="clear"></div>
							<!--<div class="dflex fxwrap_w alit_s mart10">
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>Sales</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">61</span>
								</a>
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>Executive</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">23</span>
								</a>
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>Marketing</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">12</span>
								</a>
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>Management</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">9</span>
								</a>
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>IT/Engineering</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">8</span>
								</a>
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>Finance</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">5</span>
								</a>
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>Communication</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">2</span>
								</a>
								<a href="#" class="dflex alit_c marrb5 padtb5 padrl10 brd brdrad2 white_bg bg_fa_h dark_grey_txt">
									<span>Support</span>
									<span class="diblock marl5 padrl5 brdrad25 bg_9d lgn_hight_16 fsz11 bold white_txt">2</span>
							...
							-->
							<!--<div class="dflex alit_c mart15 padtb10 padrl5 brdb brdwi_2 bg_fa">
								<div class="wi_50 padrl15">
									Most common pattern: <strong>{first}.{last}@volvo.com</strong>
								</div>
								<div class="wi_50 pos_rel padrl15">
									<span class="fa fa-search wi_30p pos_abs top0 left15p talc lgn_hight_36 txt_c"></span>
									<input type="seach" name="pattern" placeholder="Find someone" class="wi_100 hei_36p padtb5 padr10 padl30 brd brdrad3 white_bg txt_5" />
								</div>
							</div>-->
							...
							<?php if(isset($_POST)) { ?>
							<div class="mart-1 padt20 padb5 brdt brdclr_white">
								<a href="#"  onclick="showMore(serc);" class="diblock padtb10 padrl13 brdrad3 bg_ed bg_e6_h talc bold fsz13 txt_5a">Show more</a>
								<input type="hidden" id="resultVal" value="1" />
							</div>
							<?php } ?>
						</form>
					</div>
