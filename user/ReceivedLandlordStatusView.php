...
<html>
	...
	function changeStatus(link,id)
		{
		$('.forword').removeClass('lgtgrey_bg'); 
		$('.forword').removeClass('black_txt');
		...
		if(id=='bi9rQnJTT2VZNmwwNVVBTWkvbzA5Zz09')
		{
		$("#"+id).addClass('red_txt');	
		}
		else
			...
			<div class="flag_top_menu flefti padt10 padb10 hidden-xs" style="width: 50px; ">
				...
				<div class="fright xs-dnone visible-si padt10">
					<ul class="mar0 pad0">
						...
						<li class="dblock hidden-xs visible-si fright pos_rel brdl "> <a href="https://www.qloudid.com/user/index.php/StoreData/userAccount" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Detaljvy" data-sw="Detaljvy">Detaljvy</a> </li>
					</ul>
				</div>
	...
	<div class="clear" id=""></div>
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<!-- Center content -->
					<div class="wi_600p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz60  padb10 black_txt trn">Living</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >How is your living situation currently?</a></div>
						<div class=" wi_33 xxs-wi_50 fleft bs_bb padrb20 talc xs-padr10 " >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p xxs-hei_160p dblock bs_bb pad25 xs-pad15  brdclr_seggreen_h brdrad5  lgtgrey_bg    trans_all2 " onclick="changeStatus(this,'T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09');">
																<div class=" ">
																	<div class="wi_100 hei_75p dflex bs_bb">
																		<span class="fas fa-check grey_txt fsz75 xs-fsz60" id="T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09" aria-hidden="true"></span>
																	</div>
																	
																	<div class="  padb15 padt20 xs-padt0">
																		<h3 class=" tall pad0 txtovfl_el  lgn_hight_24  fsz18 xs-fsz16 segdblue_txt padt0">My own apartment</h3>
												...
												<div class=" wi_33 xxs-wi_50 fleft bs_bb padrb20 talc  xs-padr0 xs-padl10" >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p xxs-hei_160p dblock bs_bb pad25   xs-pad15 brdclr_seggreen_h brdrad5  lgtgrey_bg    trans_all2 " onclick="changeStatus(this,'bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09');">
																<div class=" ">
																	<div class="wi_100 hei_75p dflex bs_bb">
																		<span class="fas fa-check grey_txt fsz75 xs-fsz60" id="bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" aria-hidden="true"></span>
																	</div>
																	
																	<div class="  padb15 padt20 xs-padt0">
																		<h3 class=" tall pad0 txtovfl_el  lgn_hight_24  fsz18 xs-fsz16 segdblue_txt padt0">I rent second hand</h3>
												...
												<div class=" wi_33 xxs-wi_50 fleft bs_bb padrb20 talc  xs-padr10" >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p xxs-hei_160p dblock bs_bb pad25  xs-pad15 brdclr_seggreen_h brdrad5  lgtgrey_bg    trans_all2 " onclick="changeStatus(this,'cXZGMGwveWlTUUI4VDI5MFpNaEZrUT09');">
																<div class=" ">
																	<div class="wi_100 hei_75p dflex bs_bb">
																		<span class="fas fa-check grey_txt fsz75 xs-fsz60" id="cXZGMGwveWlTUUI4VDI5MFpNaEZrUT09" aria-hidden="true"></span>
																	</div>
																	
																	<div class="  padb15 padt20 xs-padt0">
																		<h3 class=" tall pad0 txtovfl_el  lgn_hight_24  fsz18 xs-fsz16 segdblue_txt padt0">With family or friends</h3>
						...
						<form action="updateIsLandlordStatus" method="POST" name="save_indexing" id="save_indexing">
					...
					<div class="padt5 mart20 xxs-talc talc " id="butn" >
								
								<button type="button" name="forward" class="forword hei_55p fsz18 trn lgtgrey_bg black_txt" onclick="submitForm();">Next</button>
								 
							</div>
				<div class="padt20 xxs-talc talc">
							<a href="#" class="fsz16"  onclick="submitForm1('bi9rQnJTT2VZNmwwNVVBTWkvbzA5Zz09');">I dont want to tell.</a>
							</div>
				</div>
