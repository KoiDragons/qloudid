...
<div class="column_m header xs-hei_55p bs_bb lgtgrey2_bg"  >
	...
	<div class="column_m   talc lgn_hight_22 fsz16 xs-marb0 xs-mart20  mart40  padb30" id="loginBank" onclick="checkFlag();">
				...
				<img src="../../../../html/usercontent/images/394180.png" class="maxwi_100 hei_250p">
									...
									<h3 class="marb0  xxs-talc fsz35 xs-fsz25 bold padb5 black_txt talc ffamily_avenir"  ><?php echo $dependentInfo['name']; ?></h3>
									
									<div class="mart20  marb35 xxs-talc talc "> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc edit-text jain_drop_company black_txt talc ffamily_avenir" ><span class="trn">The dependent <?php echo $dependentInfo['name']; ?> is already added. <?php if($dependentGuardianInfo==0) { ?> Please submit request below to become a guardian. <?php } else  { ?> Please click the button to check the profile of the dependent.<?php } ?></span>
												</a></div>
						...
						<div class="padtb20 xxs-talc talc">
								...
								<?php if($dependentGuardianInfo==0) { ?>
								<a href="../sendGuardianRequest/<?php echo $data['did']; ?>"><button type="button" name="forward" class="forword minhei_55p t_67cff7_bg ffamily_avenir marr30 fsz18" >Send request</button></a>
								<?php } else  { ?>
					<a href="../dependentInfo/<?php echo $data['did']; ?>">	<button type="button" name="forward" class="forword minhei_55p t_67cff7_bg ffamily_avenir marr30 fsz18" >Visit profile</button></a>								
								<?php } ?>
								<a href="../dependentList"><button type="button" name="Next" class="forword minhei_55p red_ff2828_bg ffamily_avenir fsz18">Close</button></a>
