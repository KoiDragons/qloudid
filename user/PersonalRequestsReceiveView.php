...
<html>
						...
						$.ajax({
							...
							success: function(data1){
								...
								else
								{
									...
									window.location.href ="https://www.safeqloud.com/user/index.php/NewsfeedDetail";
								}
		...
		<!-- HEADER -->
			...
			<div class="wi_100 hei_40p xs-pos_fix padtb5 padrl10 grey_header_bg" >
				...
				<div class="fright xs-dnone sm-dnone">
					<ul class="mar0 pad0">
						<li class="dblock hidden-xs hidden-sm fright pos_rel "> <a href="https://www.safeqloud.com/user/index.php/PersonalRequests/sentRequests" id="usermenu_singin" class="translate hei_30pi dblock padrl25 red_bg uppercase lgn_hight_30 white_txt white_txt_h brdrad3" data-en="Close" data-sw="Close">Close</a> </li>
					</ul>
				</div>
				...
				<div class="visible-xs visible-sm fright marr10 padr10 brdr brdwi_3"> <a href="https://www.safeqloud.com/user/index.php/PersonalRequests/sentRequests" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 white_txt">Close</a> </div>
				<div class="clear"></div>
			</div>
		</div>
								...
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey2_bg">
									...
									<li>
										<a href="#" class="dblock brdradt5 " data-id="tab_total1">
											...
											<span class="black_txt">Sent requests</span>
										</a>
									</li>
									...
									<li>
										<a href="#" class="dblock brdradt5 show_popup_modal" data-target="#gratis_popup_code">
											<span class="count black_txt">+Add</span>
											<span class="black_txt"></span>
										</a>
									</li>
									<div class="clear"></div>
								</ul>
								<select class="tab-header wi_200p maxwi_100 dnone xs-dblock hei_30p pad0 nobrd brdb">
									<option value="tab_total" selected><?php echo $requestApprovedCount['num']; ?></option>
									<option value="tab_total1">Sent Requests</option>
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable">
										<thead class="fsz16" style="color: #c6c8ca;">
											<tr class="lgtgrey2_bg">
												...
												<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
													<div class="padtb5">User Name</div>
												</th>
											...
											<?php $i=0;
												...
												<tr class="fsz16">
													...
													<td class="pad5 brdb tall sts">
														<div class="padtb5"><a href="../VerifyUserRequest/requestAccount/<?php echo $value['enc']; ?>">Approve</a></div>
													</td>
	...
	<div class="popup_modal wi_350p maxwi_90 opa0 opa1_a pos_fix pos_cen zi50 bs_bb white_bg fsz14 brdrad10 brd" id="gratis_popup_code">
			<div class="modal-content pad25 brd brdrad10">
				<div id="search_new">
					...
					<div class="marb10 ">
						<label for="new-organization-under" class="txt_0"></label>
						<select name="reque" id= "reque" class="wi_100 mart5 padtb10 padrl0 nobrd brdb brdclr_dblue_f font_helvetica lgtgrey2_bg" onchange="selectCode(this.value);" >
					...
					<div id="codeSelect" style="display:none">
						<div class="marb10 padt10"  >
							<label for="new-organization-name" class="sr-only">Code</label>
							<input type="text" id="code_id" name="code_id" class="wi_100 mart5 padtb10 padrl0 nobrd brdb brdclr_dblue_f font_helvetica" placeholder="Enter Code">
						</div>
					</div>
					<div class="mart30 talc">
						...
						<input type="button" value="Submit" class="marl5 pad8 nobrd green_bg uppercase bold fsz14  curp white_txt brdrad5" onclick="searchUser();" />
