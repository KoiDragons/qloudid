...
<form class="checkout__item js-tabs-item" action="<?php if($profileEditDetails['basic_details']==1) echo 'updateUserBasicDetails'; else if($profileEditDetails['address_details']==1) echo 'updateUserAddressDetails'; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
