					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
									 ...
									 <div id="errorMsg" class="fsz20 red_txt padtb20 tall"></div>
										...
										<a href="javascript:void(0);" onclick="deleteBathroom();"><button color="#444444" data-testid="icon-button--minus" class="merlin-button merlin-button--disabled css-ig30wo" aria-label="" disabled="">
