...
<a class="header__logo xs-fsz20 changedText" href="emailLogin<?php if(isset($_GET['redirect'])) echo '?redirect='.$_GET['redirect']; ?>" style="
...
<form class="checkout__item js-tabs-item" action="verifyUserlogin<?php if(isset($_GET['redirect'])) echo '?redirect='.$_GET['redirect']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="login__code" style="margin-bottom:48px; justify-content: left;">
 ...
 <div class="checkout__fieldset">
 <input type="hidden" id="email" name="email"  value="<?php echo $userAccountInfo['email']; ?>" /> 
