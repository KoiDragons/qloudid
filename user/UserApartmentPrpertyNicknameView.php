		...
		function updateNickname(id)
		{
			...
			$('#wordCount').html(id.length);
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateNickname/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Property nickname" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Identifying your property</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">We ask for a property nickname to make it easier for you to identify different properties.</span> 
													 </div>
													 
													<div class="clear"></div>
												
											<div data-testid="property-nickname-input-wrapper">
											<label for="property-nickname-input" class="css-14q70q0">Property nickname</label>
											<div id="spacer" spacing="smaller" class="css-ihl6nu">
											</div>
											<div class="css-zcv01q">
											<input type="text" id="property-nickname-input" label="Property nickname" minlength="1" maxlength="30" class="css-xt766" value="<?php echo $resultOrg1['property_nickname']; ?>" onkeyup="updateNickname(this.value);">
											</div>
											<div id="spacer" spacing="smaller" class="css-ihl6nu"></div>
											<div class="css-ev078v">(minimum 1) <span id="wordCount"><?php echo strlen($resultOrg1['property_nickname']); ?></span>/30</div></div>
