...
<a class="header__logo xs-fsz25 changedText" href="../../../LandloardBroker/guestReservationTimelineInfo/<?php echo $agreementDetailInformation['fee_detail']['rid']; ?>" style="
            ...
            <div class="" style="margin:auto; max-width:500px;">
              <div class="">
                <div class="complete__head">
                  <h2 class="complete__title h2">Invoice</h2>
                  <div class="complete__info">Your invoice detail for</div>
                  <div class="complete__subtitle">Apartment no <?php echo $agreementDetailInformation['apartment_details']['office_apartment_number']; ?></div>
                  <div class="complete__author"><span>Hosted by</span>
                    <div class="complete__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar.jpg" alt="Avatar"></div>
                    <div class="complete__man"><?php echo substr($agreementDetailInformation['landloard_info']['company_name'],0,10); ?></div>
                  </div>
                </div>
                <div class="complete__line">
                  ...
                  <div class="complete__parameters">
                    <div class="complete__parameter"><?php echo $agreementDetailInformation['apartment_details']['bedroom_count']; ?> bedroom</div>
                    <div class="complete__parameter"><?php echo $agreementDetailInformation['apartment_details']['bathroom_count']; ?> private bath</div>
                  </div>
                </div>
                <div class="complete__list">
                  <div class="complete__item">
                    <div class="complete__details">
                      <div class="complete__category">Invoice valid from</div>
                      <div class="complete__value"><?php echo date('M, d',$agreementDetailInformation['emi_payment_information']['invoice_date']); ?> - <?php echo date('M, d Y',$agreementDetailInformation['emi_payment_information']['payment_due_by']); ?></div>
                    </div>
                  </div>
                   
                </div>
				
				<div class="complete__stage">Landloard details</div>
                <div class="complete__table">
                  <div class="complete__flex">
                    ...
                    <div class="complete__cell" style="float:right;"><?php echo substr($agreementDetailInformation['landloard_info']['company_name'],0,10); ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                    ...
                    <div class="complete__cell"><?php echo substr($agreementDetailInformation['landloard_info']['address'],0,10); ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                    ...
                    <div class="complete__cell"><?php echo substr($agreementDetailInformation['landloard_info']['city'],0,10); ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['landloard_info']['zip']; ?></div>
                  </div>
                </div>
				
				<div class="complete__stage">Customer details</div>
                <div class="complete__table">
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-hand-cart">
                    ...
                    <div class="complete__cell" style="float:right;"><?php echo substr($agreementDetailInformation['user_details']['first_name'],0,10); ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-calendar">
                    ...
                    <div class="complete__cell"><?php echo substr($agreementDetailInformation['user_details']['last_name'],0,10); ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo substr($agreementDetailInformation['user_details']['address'],0,10); ?></div>
                  </div>
				  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo substr($agreementDetailInformation['user_details']['city'],0,10); ?></div>
                  </div>
				   <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo substr($agreementDetailInformation['user_details']['state'],0,10); ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-wallet">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['user_details']['zipcode']; ?></div>
                  </div>
                </div>
				
				<div class="complete__stage">Product details</div>
                <div class="complete__table">
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-hand-cart">
                    ...
                    <div class="complete__cell" style="float:right;"><?php echo $agreementDetailInformation['building_info']['building_name']; ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-calendar">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['apartment_details']['floor_number']; ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['apartment_details']['office_apartment_number']; ?></div>
                  </div>
				  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['apartment_details']['sale_price']; ?></div>
                  </div>
                ...
                <div class="complete__stage">Invoice details</div>
                <div class="complete__table">
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-hand-cart">
                    ...
                    <div class="complete__cell" style="float:right;"><?php echo substr($agreementDetailInformation['landloard_info']['company_name'],0,4).'/'.date('Y').'/'.$agreementDetailInformation['emi_payment_information']['id']; ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-calendar">
                    ...
                    <div class="complete__cell"><?php echo date('M, d Y',$agreementDetailInformation['emi_payment_information']['invoice_date']); ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['emi_payment_information']['payment_amount']; ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell">USD</div>
                  </div>
                </div>
				
				 <div class="complete__stage">Bank details</div>
                <div class="complete__table">
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-hand-cart">
                    ...
                    <div class="complete__cell" style="float:right;"><?php echo $agreementDetailInformation['landloard_bank_detail']['account_number']; ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-calendar">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['landloard_bank_detail']['iban']; ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['landloard_bank_detail']['bic']; ?></div>
                  </div>
                  <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                    ...
                    <div class="complete__cell"><?php echo $agreementDetailInformation['landloard_bank_detail']['bank_name']; ?></div>
                  </div>
				   <div class="complete__flex">
                    <div class="complete__cell">
                      <svg class="icon icon-receipt">
                        <use xlink:href="#icon-receipt"></use>
                      </svg>Account holder name:
                    </div>
                    <div class="complete__cell"><?php echo $agreementDetailInformation['landloard_bank_detail']['account_holder_name']; ?></div>
                  </div>
                </div>
				<?php if($agreementDetailInformation['emi_payment_information']['is_handled']==0 && $agreementDetailInformation['emi_payment_information']['is_paid']==0) { ?> 
                <div class="complete__btns"><a class="button complete__button" href="../../handleInvoice/<?php echo $data['agreement_id']; ?>/<?php echo $data['invoice_id']; ?>">Mark as handeled</a></div>
				<?php } else { ?>
				<div class="complete__btns"><a class="button complete__button" href="javascript:void(0);">Handeled</a></div>
				<?php } ?>
              </div>
