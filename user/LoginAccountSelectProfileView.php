...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Welcome Back, <?php echo $userDetail['first_name']; ?>
</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">What would you like to access?</div>
...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Select profile</h2> 
                  </div>
 

 
 <div class="checkout__data  " style="margin-top:0px;">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">Visit</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Personal profile</div>
 
<div class="checkout__controls">
 
<a href="../LandloardBroker/requestList"><button class="checkout__edit"  >
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Business profile</div>
 
<div class="checkout__controls">
 
<a href="selectEmployer"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
