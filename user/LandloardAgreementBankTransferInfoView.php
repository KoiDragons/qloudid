...
function updateMonthlyFee(id,link)
{
	...
	vatUpdate=1;
		...
		function submitForm()
		{
			...
			if($('#object_type').val()=='' || $('#object_type').val()==null)
			{
				$('#error_msg_form').html('please enter transection reference ID');
				return false;
			}
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
									 ...
									 <form action="../updateTransferDetail/<?php echo $data['agreement_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									 
									<div class="on_clmn padt10"> 
											 
											 <div class="pos_rel">
												
												<input type="text" name="object_type" id="object_type" placeholder="Street address" class="white_bg brd_width_2  brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="" > 
												 <label for="object_type" class="floating__label tall nobold padl10" data-content="Transfer refrence">
