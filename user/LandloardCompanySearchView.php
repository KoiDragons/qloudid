			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						...
						<form action="LandloardCompanySearch" method="POST" id="save_indexingcs" name="save_indexingcs" accept-charset="ISO-8859-1">
							<div class="dflex alit_s marb15">
								<input type="message" name="message" id="message" class="minhei_65p flex_1 padrl15 lgtgrey_bg nobrd fsz15 ffamily_avenir" placeholder="Company name" value="">
						...
						<?php if(isset($_POST['message'])) { if($companyListCount==0) { ?>
						 <div class="padtb20 xxs-talc talc">
								
							<a href="LandloardCompanySearch/addLandloardInfo">	<button type="button" name="forward" class="forword minhei_55p t_67cff7_bg fsz18" >Add landloard</button></a>
