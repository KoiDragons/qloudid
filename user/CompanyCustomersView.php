											...
											<thead class="fsz14 lgtgrey_bg" >
												<tr class="">
													...
													<th class="pad5  nobold  tall xs-wi_100" >
														<div class="padtb5 black_txt">Anställda</div>
													</th>
										...
										<table class="wi_100" cellpadding="0" cellspacing="0" id="mytablesentCustomers">
											<thead class="fsz14 lgtgrey_bg">
												<tr class="">
													...
													<th class="pad5  nobold  tall" >
														<div class="padtb5 black_txt">Kunder</div>
													</th>
											...
											<tbody id="pending">
												<?php $i=0;
													...
													<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
														...
														<td class="pad5 brdb_new tall cn">
															<div class="padtb5 " ><a href="#" class="show_popup_modal "  onclick="showUserDetailReceived(<?php echo $value['uid']; ?>,this,'<?php echo $value['enc']; ?>',1);"><?php echo $value['first_name']; ?></a></div>
														</td>
														<td class="pad5 brdb_new tall nm hidden-xs ">
															<div class="padtb5 "><?php echo $value['last_name']; ?></div>
														</td>
											...
											<tbody id="pendingCustomer">
												<?php $i=0;
													...
													<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
														...
														<td class="pad5 brdb_new tall cn">
															<div class="padtb5 " ><a href="#" class="show_popup_modal "  onclick="showUserDetailReceived(<?php echo $value['uid']; ?>,this,'<?php echo $value['enc']; ?>',2);"><?php echo $value['first_name']; ?></a></div>
														</td>
										...
										<table class="wi_100" cellpadding="0" cellspacing="0" id="mytableStudent">
											<thead class="fsz14 lgtgrey_bg">
												<tr class="">
													...
													<th class="pad5  nobold  tall" >
														<div class="padtb5 black_txt">Studenter</div>
													</th>
											...
											<tbody id="pendingStudent">
												<?php $i=0;
													...
													<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
														...
														<td class="pad5 brdb_new tall cn">
															<div class="padtb5 " ><a href="#" class="show_popup_modal "  onclick="showUserDetailReceived(<?php echo $value['uid']; ?>,this,'<?php echo $value['enc']; ?>',3);"><?php echo $value['first_name']; ?></a></div>
														</td>
														<td class="pad5 brdb_new tall nm">
															<div class="padtb5 "><?php echo $value['last_name']; ?></div>
														</td>
										...
										<table class="wi_100" cellpadding="0" cellspacing="0" id="mytableTenant">
											<thead class="fsz14 lgtgrey_bg">
												<tr class="">
													...
													<th class="pad5  nobold  tall" >
														<div class="padtb5 black_txt">Hyresvärd</div>
													</th>
											...
											<tbody id="pendingTenant">
												<?php $i=0;
													...
													<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
														...
														<td class="pad5 brdb_new tall cn">
															<div class="padtb5 " ><a href="#" class="show_popup_modal "  onclick="showUserDetailReceived(<?php echo $value['uid']; ?>,this,'<?php echo $value['enc']; ?>',4);"><?php echo $value['first_name']; ?></a></div>
														</td>
														<td class="pad5 brdb_new tall nm">
															<div class="padtb5 "><?php echo $value['last_name']; ?></div>
														</td>
												...
												<?php $i=0;
													...
													<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
														...
														<td class="pad5 brdb_new talr hidden-xs  cd">
															<a href="https://www.qloudid.com/user/index.php/ManagePermissions/setPermissions/<?php echo $value['enc']; ?>" class="load_more_results  marrl5">Permission</a>
														</td>
