   ...
   <head>
      ...
      <script>
         ...
         function sendInformation() {
             ...
             if ($('#image-data4').val() == "" || $('#image-data4').val() == null) {
         ...
         function readURL2(input) {
             if (input.files && input.files[0]) {
                 ...
                 reader.onload = function(e) {
                     ...
                     $('#image-data4').val(e.target.result);
      ...
      <div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20" id="loginBank" onclick="checkFlag();">
         <div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
            ...
            <div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
               ...
               <div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Write down the passport details of the person to whom you act as guardian for.</a></div>
               <!-- Center content -->
                        ...
                        <div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
                           <div class="wp_columns_upload wp_columns_upload_custom marb20 brd brdclr_white ">
                              <input type="hidden" name="image-data1" id="image-data1" value="<?php //echo $value_a; ?>" class="hidden-image-data" />
							   <input type="hidden" name="image-data4" id="image-data4" value="<?php //echo $value_a; ?>" class="hidden-image-data" />
