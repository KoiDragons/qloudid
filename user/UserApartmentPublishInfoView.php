	...
	<head>
		...
		function updateNone(id)
		{
		 ...
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateNone/<?php echo $data['aid']; ?> ",
		 ...
		 function updateRent(id)
		{
		 ...
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateRentInfo/<?php echo $data['aid']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateSale(id)
		{
		 ...
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateSaleInfo/<?php echo $data['aid']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateLongRent(id)
		{
		 ...
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateLongRent/<?php echo $data['aid']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Where you want to publish property" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
								 	...
								 	<div id="bathroom_info">
										<?php echo $districtPublishDetail; ?>
										</div>
					 
					 <div class="padtb20 xxs-talc talc">
								
							<a href="../apartmentSelectRevisionInfo/<?php echo $data['aid']; ?>">	<button type="button" name="forward" class="forword minhei_55p t_67cff7_bg fsz18" >Proceed</button></a>
							...
							<a href="https://dstricts.com/user/index.php/HotelInfo/verifyApartmentCheckinQr/<?php echo $data['aid']; ?>" target='_blank'>Owner checkin</a>
								
							</div>
							
							<div class="padb20 xxs-talc talc">
								
							<a href="https://dstricts.com/public/index.php/VisitorSelectSearch/selectYourRole/<?php echo $data['aid']; ?>" target='_blank'>Guest Checkin</a>
