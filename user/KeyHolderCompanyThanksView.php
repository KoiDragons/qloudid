...
<body class="lgtgrey2_bg ffamily_avenir">
	...
	<div class="column_m   talc lgn_hight_22 fsz16 xs-marb0 xs-mart20  mart40  padb30" id="loginBank" onclick="checkFlag();">
				...
				<img src="../../../../html/usercontent/images/394180.png" class="maxwi_100 hei_250p">
									...
									<h3 class="marb0  xxs-talc fsz35 xs-fsz25 bold padb5 black_txt talc ffamily_avenir"  >Request sent </h3>
									
									<div class="mart20 marb35  xxs-talc talc "> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc edit-text jain_drop_company black_txt talc ffamily_avenir" ><span class="trn">You have successfully submitted your request. You will be informed when company will respond your request.</span>
												</a></div>

						<div class="padtb20 xxs-talc talc">
								
								<a href="../searchCompanies/<?php echo $data['aid']; ?>"><button type="button"  class="padrl20 forword hei_55p fsz18 trn t_67cff7_bg  ffamily_avenir">Close</button></a>
