		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
								...
								<img src="https://media.giphy.com/media/l0K4mWebWMhofWUQE/giphy.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir">Restricted access</h1>
									</div>
