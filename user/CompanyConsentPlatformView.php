									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock padb10 padl8 ">
											<a href="https://www.qloudid.com/user/index.php/CompanyCustomers/companyAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
												<span class="valm trn">Delade uppgifter  <span class="counter_position"><?php echo $customerRequestReceivedCount; ?></span></span>
												<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg  rotate45"></div>
											</a>
										</li>
										<li class=" dblock  padl8 ">
											<a href="https://www.qloudid.com/user/index.php/Brand/brandAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn"> Verifiera ID</span> <span class="counter_position"><?php echo $verifiedCountConnections['num']; ?></span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 brdb_new">
								<div class="white_bg tall">
									...
									<!-- Logo -->
									<h1 class="fsz25 bold">Tidsbegränsade samtycken</h1>
									<!-- Logo -->
									<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text jain_drop_company">Alla profiler som godkänt för att dela sin data med ert bolag i 24 timmar.  </a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
										<!-- Meta -->
											...
											<a href="https://www.qloudid.com/user/index.php/VerifiyID/verifiyIDAccount/<?php echo $data['cid']; ?>" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt " >
								...
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey_bg">
									<li>
										<a href="#" class="dblock brdradt5 active" data-id="tab_total">
											<span class="count black_txt"><?php echo $approveCountConnections['num']; ?></span>
											<span class="black_txt trn fsz16" data-trn-key="Anslutna ">Anslutna </span>
										</a>
									</li>
									
									<li>
										<a href="#" class="dblock brdradt5 "  data-id="tab_total3">
											<span class="count black_txt"><?php echo $verifiedCountConnections['num']; ?></span>
											<span class="black_txt fsz16">Verifiera ID </span>
										</a>
									</li>
									<li>
										<a href="#" class="dblock brdradt5 " data-id="tab_total1">
											<span class="count black_txt"><?php echo $pendingCountConnections['num']; ?></span>
											<span class="black_txt fsz16">Skickade </span>
										</a>
									</li>
									<li class="bg_f80 ">
										<a href="#" class="dblock brdradt5 bg_f80" data-id="tab_total2">
											<span class="count black_txt"><?php echo $rejectedCountConnections['num']; ?></span>
									...
									<option value="tab_total" selected class="xs-fsz20"><?php echo $approveCountConnections['num']; ?></option>
									
									<option value="tab_total3" class="xs-fsz20">Skickade </option>
							...
							<div class="container   fsz14 dark_grey_txt">
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable1">
										...
										<tbody id="pendingConnections1">
											<?php $i=0;
												...
												foreach($requestVerifiedDetailConnections as $category => $value) 
												{
												...
												<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
													...
													<td class="pad5 brdb_new tall cn">
														<div class="padtb5 " ><a href="#" class="show_popup_modal black_txt"  onclick="showUserDetail('<?php if($value['user_id']==0) echo 'v_'.$value['verified_by']; else echo 'a_'.$value['user_id'] ?>',this);"><?php echo $value['verified_name']; ?></a></div>
													</td>
													<td class="pad5 brdb_new tall nm hidden-xs ">
														<div class="padtb5 "><?php echo $value['ssn']; ?></div>
													</td>
													<td class="pad5 brdb_new tall cd">
														<div class="padtb5 "><?php echo $value['receiver']; ?></div>
													</td>
													<td class="pad5 brdb_new tall cd">
														<div class="padtb5 "><a href="../approveVerification/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">Approve</a></div>
													</td>
													<td class="pad5 brdb_new tall cd">
														<div class="padtb5 "><a href="../rejectVerification/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">Reject</a></div>
													</td>
												</tr>
								...
								<script>
									function add_more_my(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreRequestVerifiedDetailConnections/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
												html1=data1;
												var $tbody = $("#pendingConnections1"),
												html=html1;
												//alert(data1); 
												$tbody
												.append($(html))
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable1">
										...
										<tbody id="pendingConnections">
											<?php $i=0;
												...
												foreach($requestDetailConnections as $category => $value) 
												{
								...
								<script>
									function add_more_my(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreRequestDetailConnections/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
												html1=data1;
												var $tbody = $("#pendingConnections"),
												html=html1;
												//alert(data1); 
												$tbody
												.append($(html))
								...
								<div class="tab-content padt5" id="tab_total2">
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable1">
										...
										<tbody id="rejectedConnections">
											<?php $i=0;
												...
												foreach($requestDetailRejectedConnections as $category => $value) 
												{
									...
									<div class="padt20 talc">
										<a href="#" class="load_more_results  marrl5" value="1" onclick="add_more_rows_rejected_Connectionss(this);">Visa fler</a>
										
									</div>
									
									<script>
									function add_more_rows_rejected_Connectionss(link) {
									//var $tbody = $("#rejected");
									//alert($tbody.html); return false;
									var id_val=parseInt($(link).attr('value'))+1;
									var html1="";
									...
									$.ajax({
										type:"POST",
										url:"../moreRequestDetailRejectedConnections/<?php echo $data['cid']; ?>",
										data:send_data,
										dataType:"text",
										contentType: "application/x-www-form-urlencoded;charset=utf-8",
										success: function(data1){
											html1=data1;
											var $tbody = $("#rejectedConnections"),
											html=html1;
											//alert(data1); 
											$tbody
											.append($(html))
