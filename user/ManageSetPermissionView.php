	...
	<head>
		...
		<script>
				function updateRequest(id,link)
			{
				...
				$.ajax({
					url: '../updateRequest/<?php echo $data['id']; ?>',
					type: 'POST',
					//dataType: 'text/xml',
					data: send_data
					//async:false
						...
						<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
							...
							<div class="container tab-header  talc dark_grey_txt ">
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey2_bg">
									<li>
										<a href="#" class="dblock brdradt5 active" data-id="tab_total">
											<span class="count black_txt">1</span>
											<span></span>
										</a>
									</li>
								...
								<select class="tab-header wi_200p maxwi_100 dnone xs-dblock hei_30p pad0 nobrd brdb">
									<option value="tab_total" selected>1</option>
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable">
										<thead class="fsz16" style="color: #c6c8ca;">
											<tr class="lgtgrey2_bg">
												...
												<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
													<div class="padtb5">Permission</div>
												</th>
										...
										<tbody  id="allRequest">
												...
												<tr class="fsz16">
													...
													<td class="pad5 brdb tall cn">
														<div class="padtb5 " >Employee Permissions Page</div>
													</td>
													
													<td class="pad5 brdb tall">
				<div class="padtb5">
				<div class="boolean-control boolean-control-small boolean-control-green fright <?php echo $checked; ?>" onclick="updateRequest('.$company_id.',this);">
