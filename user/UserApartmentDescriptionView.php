...
<html>
	...
	<head>
		 ...
		 function updateDescription()
		{
			...
			if(id.length<400)
			{
			$('#errorMsg').html('Minimum 400 character required!!!');	
			$('#description-textarea').html(propertyUpdate);
			...
			$('#wordCount').html(id.length);
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateDescription/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		function changeDescription()
		{
			$('#errorMsg').html('');
				 ...
				 $.ajax({
							type:"POST",
							url:"../changeDescription/<?php echo $data['aid']; ?> ",
							 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								$('textarea#description-textarea').val(data1);
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir"  >Description</h1>
									</div>
					 ...
					 <div class="clear"></div>
									  ...
									  <input type="hidden" id="propertyUpdate" value="<?php echo $descriptionInfo['apartment_description']; ?>" />
								   ...
								   <div class="css-ahy16g">
									  <div data-testid="description-page">
										 <div class="css-zp5g9l marrl0">
											<p class="paragraph--b1 paragraph--full css-1680uhd">The description tells guests all about the key features of your property. We need a full description like the one below, however, some channels produce descriptions for you.</p>
											...
											<button color="#444444" label="description-generator" class="merlin-button css-1pn4dx" aria-label="description-generator" onclick="changeDescription();">
											   <div class="merlin-button__content">Generate a new description</div>
											</button>
											<div id="spacer" spacing="standard" class="css-vqlgan"></div>
											...
											<textarea id="description-textarea" data-testid="description-textarea" name="description" minlength="400" maxlength="9000" class="css-13k0qhz" onkeyup="updateDescription();"><?php echo html_entity_decode($descriptionInfo['apartment_description']); ?></textarea></div>
											<div id="spacer" spacing="smaller" class="css-ihl6nu"></div>
											<div data-testid="description-character-length-text" class="css-ev078v">(minimum 400) <span id="wordCount"><?php echo strlen($descriptionInfo['apartment_description']); ?></span>/9000</div>
										 </div>
									  </div>
								   </div>
								</div>
