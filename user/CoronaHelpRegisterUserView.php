	...
	<head>
		...
		function checkFlag()
		 ...
		 function updateValue(id)
		 {
			 if(id==1)
			 {
				 $('.buttton1').addClass('panlyellow_bg');
				 $('.buttton2').removeClass('panlyellow_bg');
			 }
			 else
			 {
			
				 $('.buttton2').addClass('panlyellow_bg');
				 $('.buttton1').removeClass('panlyellow_bg');
		 ...
		 function sendInformation()
		 {
			 ...
			 if($('#ind').val()==0)
			 {
				$('#error_msg_form').html('Please select one option');
				return false;				
			 }
		...
		<body class="bg_ff5bad ffamily_avenir" >
			<div class="column_m header xs-header xsip-header xsi-header bs_bb bg_ff5bad hidden-xs">
			...
			<div class="visible-xs visible-sm fright marr0 padt5 "> <a href="#" class="diblock padl10 padr10 brdrad3 fsz30 bg_ff5bad  white_txt"><i class="fas fa-times " aria-hidden="true"></i></a> </div>
			<div class="clear"></div>
		</div>
		</div>
	
	<div class="column_m header hei_55p  bs_bb bg_ff5bad visible-xs"  >
				<div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 bg_ff5bad"  >
				...
				<div class="padrl10 xs-padrl15">
					...
					<div class="wi_400p xsi-wi_360p maxwi_100   pos_rel zi5 marrla pad30  xs-pad0   brdrad5  " >
							...
							<div class="marb50 padt30 xs-padt30">
								...
								<a href="javascript:void(0);" class="lgn_hight_s1 padl10 fsz150 white_txt"><i class="fas fa-people-carry"></i></a>
							 
								
							</div>
							<div class="marb30 padt10 xsi-marb30">
									<h1 class="padb5 talc fsz35   bold  lgn_hight_48 white_txt trn ffamily_avenir"  >Help</h1>
									<p class=" padt0  xxs-marb30 talc fsz20 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla  white_txt trn ffamily_avenir"  >Why are you here</p>
								</div>
						 <div class="padb20 xs-padrl10">
						<div class="wrap maxwi_100 dflex brdrad3">
						<a href="#" class="wi_80 maxwi_500p xs-maxwi_250p minhei_65p dflex  alit_c opa90_h marrla  white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd nobrdr trn ffamily_avenir brdclr_f tall padl30 buttton1" onclick="updateValue(1);">I am a person in need
						  
						</a> <a href="#" class="wi_20 maxwi_500p xs-maxwi_250p minhei_65p dflex  alit_c opa90_h marrla brdclr_f white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd nobrdl trn ffamily_avenir tall padl30 xs-padl20 buttton1" onclick="updateValue(1);">  
						<span class="fright fsz20  " style="color:#6ebdf7"><i class="fas fa-chevron-right" aria-hidden="true"></i></span>
						 ...
						 <div class="padb20 xs-padrl10">
						<div class="wrap maxwi_100 dflex brdrad3">
						<a href="#" class="wi_80 maxwi_500p xs-maxwi_250p minhei_65p dflex  alit_c opa90_h marrla  white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd nobrdr trn ffamily_avenir brdclr_f tall padl30 buttton2" onclick="updateValue(2);">I would like to be a volunteer
						  
						</a> <a href="#" class="wi_20 maxwi_500p xs-maxwi_250p minhei_65p dflex  alit_c opa90_h marrla brdclr_f white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd nobrdl trn ffamily_avenir tall padl30 xs-padl20 buttton2" onclick="updateValue(2);">  
						<span class="fright fsz20  " style="color:#6ebdf7"><i class="fas fa-chevron-right" aria-hidden="true"></i></span>
						</a> 
						</div>
						</div>
					...
					<form action="addUser" method="POST" id="save_indexing" name="save_indexing" >
					<input type="hidden" id="ind" name="ind" value="0" />
					</form>
					<div class="red_txt fsz20" id="error_msg_form"></div>
						  <div class=" padtb20 talc fsz16  " onclick="sendInformation();"> <a href="#" class="forword hei_55p fsz18  t_67cff7_bg ffamily_avenir" >Register </a> </div>
					<div class="clear"></div>
				</div></div>
