...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo $path; ?>html/search/images/favicon.ico" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo $path; ?>html/search/css/font-awesome.min.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo $path; ?>html/search/css/style.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo $path; ?>html/search/constructor.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo $path; ?>html/search/responsive.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo $path; ?>html/search/css/modules.css" />
	<script type="text/javascript" src="<?php echo $path; ?>html/search/js/jquery.js"></script>
</head>

<body class="white_bg" style="width:1320px;">
	...
	<div class="column_m header header_small bs_bb bg_colorn_new hei_40p " >
      ...
      <div class="fleft">
        <input type="text" name="Search" class="search_fld hi_wi385" style="height:16px;">
      </div>
      <div class="fleft">
        <input type="submit" value="" class="search_btn hi26" style="height:26px;">
      </div>
    </div>
			<div class="fright xs-dnone sm-dnone">
				<ul class="mar0 pad0">
					<li class="dblock hidden-xs hidden-sm fright pos_rel brdl brdclr_dblue"> <a href="https://www.safeqloud.com/user/index.php/LoginAccount" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h uppercase lgn_hight_30 white_txt white_txt_h" data-en="Logga In" data-sw="Logga In">Logga IN</a> </li>
				</ul>
			</div>
	...
	<div class="column_m container zi5">
		<div class="wrap maxwi_100">
			...
			<div class="column_m bs_bb pad15 mart30">
				...
				<h2>Search results: 100 found</h2>
						...
						<div class="flex_1 marrl-10">
								...
								<form>
									<table class="wi_100 fsz16 pad10" cellpadding="10" cellspacing="0">
										...
										<tbody>
											<tr>
												<!--<td class="hidden-xs"><input type="checkbox" class="check toggle-visited" data-target="#business-actions" data-check-all="true" data-closest=".tab-content" /></td>-->
												<td class="brdb"><a href="crm_company.html" class="get-company-info dark_grey_txt" data-id="facebook">Face<span class="bold dblue_txt">book</span></a></td>
												<!--<td class="brdb ws_now"><a href="#">Add to CRM</a></td>-->
											</tr>
											<tr>
												<!--<td class="hidden-xs"><input type="checkbox" class="check toggle-visited" data-target="#business-actions" data-check-all="true" data-closest=".tab-content" /></td>-->
												<td class="brdb">
													<a href="crm_company.html" class="get-company-info dark_grey_txt" data-id="almatv">Almatv</a>
													<div class="mart5">
														<span class="bold dblue_txt">Book</span> your perfect stay with over a million properties worldwide Take your pick from hotels, apartments and more – with tons of great deals...
													</div>
												</td>
												<!--<td class="brdb ws_now"><a href="#">Add to CRM</a>
												</td>-->
											</tr>
											<tr>
												<!--<td class="hidden-xs"><input type="checkbox" class="check toggle-visited" data-target="#business-actions" data-check-all="true" data-closest=".tab-content" /></td>-->
												<td class="brdb">
													<a href="crm_company.html" class="get-company-info dark_grey_txt" data-id="apple">Apple</a>
													<div class="mart5">
														Email: <span class="bold dblue_txt">book</span>@apple.com
													</div>
												</td>
												<!--<td class="brdb ws_now"><a href="#">Add to CRM</a></td>-->
											</tr>
											<tr>
												<!--<td class="hidden-xs"><input type="checkbox" class="check toggle-visited" data-target="#business-actions" data-check-all="true" data-closest=".tab-content" /></td>-->
												<td class="brdb">
													<a href="crm_company.html" class="get-company-info dark_grey_txt" data-id="anglea">Anglea</a>
													<div class="mart5">
														Owner: Cris <span class="bold dblue_txt">Book</span>
													</div>
												</td>
												<!--<td class="brdb ws_now"><a href="#">Add to CRM</a></td>-->
											</tr>
											<tr>
												<!--<td class="hidden-xs"><input type="checkbox" class="check toggle-visited" data-target="#business-actions" data-check-all="true" data-closest=".tab-content" /></td>-->
												<td class="brdb">
													<a href="crm_company.html" class="get-company-info dark_grey_txt" data-id="ario">Ario</a>
													<div class="mart5">
														Invoicing address: 9009 <span class="bold dblue_txt">Book</span> street, Houston, Texas
													</div>
												</td>
												<!--<td class="brdb ws_now"><a href="#">Add to CRM</a></td>-->
											</tr>
				...
				<div class="tab-content" id="tab-reps">
					...
					<script>
						function add_more_rows(link) {
							var $tbody = $(link).closest('form').find('tbody'),
								html = '<tr>  <td class="brdb"><a href="crm_company.html" class="dark_grey_txt">Facebook</a></td>  </tr>';
	...
	<script type="text/javascript" src="<?php echo $path; ?>html/search/js/jquery-ui.min.js"></script>
	<script type="text/javascript" src="<?php echo $path; ?>html/search/js/superfish.js"></script>
	<script type="text/javascript" src="<?php echo $path; ?>html/search/js/icheck.js"></script>
	<script type="text/javascript" src="<?php echo $path; ?>html/search/js/jquery.selectric.js"></script>
	<script type="text/javascript" src="<?php echo $path; ?>html/search/modules.js"></script>
