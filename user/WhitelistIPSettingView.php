				...
				else
				{
					...
					$.ajax({
						...
						success: function(data1){
							...
							{
								window.location.href="https://www.safeqloud.com/user/index.php/WhitelistIP/ipSetting/<?php echo $data['cid']; ?>";
							}
						}
					});
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0 ">
										...
										<div class="padl10">
											<div class="sidebar_prdt_bx marr20 brdb_b padb20">
												...
												<div class="pad20 wi_100 xs-wi_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz95 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey2_bg black_txt" style="
													...
													border-radius: 2%;
													" id="aa_1227620">I</div><a href="#" class="black_txt fsz45 xs-fsz30 sm-fsz30 ">
														<!-- Meta -->
														<div class="padtr10 fsz15"> <span>Inst&auml;llningar</span>  </div>
													</a></div>
											</div>		
											<div class="clear"></div>
										</div>
									...
									<ul class="marr20 pad0">
										<li class=" dblock  padl8 ">
											<a href="#" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												...
												<span class="valm trn">Config</span>
										...
										<li class="dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">IP Whitelisting</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
					...
					<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xs-padl0">
						...
						<div class="wrap maxwi_100 dflex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 ">
								<div class="white_bg tall">
								<h1 class="fsz25 bold">IP-Whitelist</h1>
									
									<div class="marb0">
									<a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text ">Alla profiler som godkänt för att dela sin data med ert bolag i 24 timmar.  </a>
									</div>
									</div>
						...
						<div class="padb0 xxs-padb0 brdb_new ">
							
								<div class="container padrl0 xs-padrl0  padb10">
							
							<div class="marrla xs-wi_100">
								
								<form action="../addCompanyIp/<?php echo $data['cid']; ?>" name="save_indexing" id="save_indexing" method="POST" >
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn padb10">
											...
											<div class="for_clmn padl5">
												<input type="text" name="ipadd" id="ipadd" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl10 hei_50p fsz18 llgrey_txt" placeholder="Add ip address">
											...
											<div class="for_clmn padl5">
												<input type="button" value="Submit" class="wi_100 mart5 maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" onclick="searchIP();">
						...
						<table class="wi_100 padt5" cellpadding="0" cellspacing="0" id="mytable">
										<thead class="fsz14" >
											<tr class="lgtgrey2_bg">
												...
												<th class="pad5 brdb_new nobold  tall" >
													<div class="padtb5 black_txt">Besök</div>
												</th>
												
												<th class="pad5 brdb_new nobold hidden-xs tall" >
													<div class="padtb5 black_txt">IP adress</div>
												</th>
												<th class="pad5 brdb_new nobold hidden-xs tall" >
													<div class="padtb5 black_txt">Status</div>
												</th>
												<th class="pad5 brdb_new nobold hidden-xs tall" >
													<div class="padtb5 black_txt">Redigera</div>
												</th>
											</tr>
										...
										<tbody id="approvedConnections">
											<?php $i=0;
												...
												<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
													...
													<?php if($value['ip_type']==1) { ?>
														<div class="padtb5 " ><a href="../../Company/visitorsIP/<?php echo $data['cid']; ?>">Visit Page</a></div>
													<?php } else {	?>
													<div class="padtb5 " ><a href="../../../../company/index.php/Parkering/plateInfo/<?php echo $data['cid']; ?>">Visit Page</a></div>
													<?php } ?>
													</td>
													...
													<td class="pad5 brdb_new tall nm hidden-xs ">
														<div class="padtb5 "><?php if($value['ip_type']==1) echo 'Besökare'; else echo 'Parkering'; ?></div>
													</td>
													<td class="pad5 brdb_new tall nm hidden-xs ">
								...
								<script>
									function add_more_rows_approved_Connections(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreCompanyIps/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
