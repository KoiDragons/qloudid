...
<html>
	...
	<head>
		...
		<title>Instructions are sent</title>
		<!-- Styles -->
		...
		<div class="usermenu">
					<ul>
						<li class="right hei_30p">
							<a href="LoginAccount" class="translate orange_btn bold xs-padrl10i hei_30p " id="usermenu_singin" data-en="Sign In" data-sw="Logga In">Sign Up</a>
						</li>
					</ul>
				</div>
				<div class="clear"></div>
		...
		<div class="column_m mart0 padtb30 fsz14">
			<div class="wrap maxwi_100">
				...
				<div class="container padrl15">
					<h1 class="marb10 talc fsz46 xs-fsz32">Instructions to restore your password</h1>
					<h3 class="marb10 talc fsz26 xs-fsz20">Have been sent to your email address.</h3>
					<div class="marb30 talc fsz18">
						<a href="../../../ForgotInst/forgotInstAccount/<?php echo $data['email'];?>/<?php echo $data['rand_hash'];?>">Resend email </a>
					</div>
				</div>
			</div>
		</div>
