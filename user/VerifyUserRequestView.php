		...
		<div class="column_m pos_rel">
			...
			<div class="column_m container zi5 mart40">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
									...
									<div class="sources-content dnone" style="display: none;">
										<ul class="mar0 pad0 padt10 fsz14">
											<li class="dflex mart10 brdb padb5">
												...
												<span class="fxshrink_0 marl10"><?php echo $row_summary['ssn']; ?> </span>
											</li>
											<li class="dflex mart10 brdb padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#">Name</a>
												</div>
												<span class="fxshrink_0 marl10"><?php echo $row_summary['first_name']; ?> </span>
											</li>
											<li class="dflex mart10 brdb padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#">Last name</a>
												</div>
												<span class="fxshrink_0 marl10"><?php echo $row_summary['last_name']; ?> </span>
											</li>
											<li class="dflex mart10 brdb padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#">Date of birth</a>
												</div>
												<span class="fxshrink_0 marl10"><?php echo $row_summary['dob_day']."/".$row_summary['dob_month']."/".$row_summary['dob_year']; ?></span>
											</li>
											<li class="dflex mart10">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#">Sex</a>
												</div>
												<span class="fxshrink_0 marl10"><?php if($row_summary['sex']==1) echo "M"; else if($row_summary['sex']==2) echo "F"; else echo "T"; ?></span>
											</li>
										</ul>
									</div>
								</div>
					...
					<form method="POST" action="../../VerifyUserRequest/updateAccount/<?php echo $data['request_id']; ?>" id="save_indexing" name="save_indexing" >
						<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla mart30"> <a href="#" class="wi_100 maxwi_500p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 panlyellow_bg fsz18 xs-fsz16 darkgrey_txt trans_all2" onclick="submit_value();">Signera med Mobilt BankId</a> 
							<input type="hidden" id="total_value" name="total_value" value="1" />
						</div>
					</form>
