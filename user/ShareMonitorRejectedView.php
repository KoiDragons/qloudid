				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="tab-header martb10 padb10 xs-talc brdb2_ffde00 nobrdt nobrdl nobrdr talc">
                                            ...
                                            <a href="shareMonitorShow" class="dinlblck mar5 padrl10  nobrd  bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Active</a>
                                             <a href="shareMonitorSentList" class="dinlblck mar5 padrl10  nobrd  bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h black_txt_a white_txt_ah ffamily_avenir" >Sent</a>
                                              <a href="#" class="padrl30_a padrl10 fsz18 red_ff2828_txt lgn_hight_36 active"  ><i class="fas fa-trash-alt"></i></a>
											...
											<?php $i=0;
												...
												foreach($rejectedMemberRequest as $category => $value) 
												{
												...
												<div  id="memberRequestRejected">
										</div>	
										<div class="clear"></div>
										<div class="padtb20   talc <?php if($rejectedMemberRequestCount['num']<=5) echo 'hide'; ?>">
										
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width"  value="1" onclick="add_more_rejected_member(this);">View more</a>
									</div>
									
										<script>
										function add_more_rejected_member(link) {
											...
											$.ajax({
												type:"POST",
												url:"moreRejectedMemberRequest",
												data:send_data,
												dataType:"text",
												contentType: "application/x-www-form-urlencoded;charset=utf-8",
												success: function(data1){
													html1=data1;
													var $tbody = $("#memberRequestRejected"),
													html=html1;
													//$tbody.html('');
													$tbody
													.append($(html))
											...
											<?php $i=0;
												...
												foreach($requestRejectedDetailTenants as $category => $value) 
												{
												...
												<div  id="RequestLandlord3">
													</div>	
										<div class="clear"></div>
										<div class="padtb20   talc <?php if($requestRejectedCountTenants['num']<=5) echo 'hide'; ?>">
										
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width"  value="1" onclick="add_more_rejected_tenants(this);">View more</a>
									</div>	

										<script>
										function add_more_rejected_tenants(link) {
											//var $tbody = $("#rejected");
											...
											$.ajax({
												type:"POST",
												url:"moreRequestRejectedDetailTenants",
												data:send_data,
												dataType:"text",
												contentType: "application/x-www-form-urlencoded;charset=utf-8",
												success: function(data1){
													html1=data1;
													var $tbody = $("#RequestLandlord3"),
													html=html1;
													//$tbody.html('');
													$tbody
													.append($(html))
											...
											<?php $i=0;
												...
												foreach($requestRejectedDetailStudents as $category => $value) 
												{
												...
												<div  id="RequestSchool3">
													</div>	
										<div class="clear"></div>
										<div class="padtb20   talc  <?php if($requestRejectedCountStudents['num']<=5) echo 'hide'; ?>">
										
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width"  value="1" onclick="add_more_rejected_students(this);">View more</a>
									</div>	
									
									<script>
										function add_more_rejected_students(link) {
											//var $tbody = $("#rejected");
											//alert($tbody.html); return false;
											var id_val=parseInt($(link).attr('value'))+1;
											var html1="";
											...
											$.ajax({
												type:"POST",
												url:"moreRequestRejectedDetailStudents",
												data:send_data,
												dataType:"text",
												contentType: "application/x-www-form-urlencoded;charset=utf-8",
												success: function(data1){
													html1=data1;
													var $tbody = $("#RequestSchool3"),
													html=html1;
													//$tbody.html('');
													$tbody
													.append($(html))
											...
											<?php $i=0;
												...
												foreach($requestRejectedDetailSuppliers as $category => $value) 
												{
												...
												<div  id="RequestSuppliers3">
													</div>	
										<div class="clear"></div>
										<div class="padtb20   talc <?php if($requestRejectedCountSuppliers['num']<=5) echo 'hide'; ?>">
										
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width"  value="1" onclick="add_more_rejected(this);">View more</a>
									</div>
										...
										function add_more_rejected(link) {
											...
											$.ajax({
												type:"POST",
												url:"moreRequestRejectedDetailSuppliers",
												data:send_data,
												dataType:"text",
												contentType: "application/x-www-form-urlencoded;charset=utf-8",
												success: function(data1){
													html1=data1;
													var $tbody = $("#RequestSuppliers3"),
													html=html1;
													//$tbody.html('');
													$tbody
													.append($(html))
									 ...
									 <?php $i=0;
												...
												foreach($daycareRequestRejectedDetail as $category => $value) 
												{
										...
										<div class="clear"></div>
										<div class="padtb20   talc <?php if($requestDaycareRejectedCount['num']<=5) echo 'hidden'; ?>">
										...
										$.ajax({
											type:"POST",
											url:"moreDaycareRejectedRequestDetail",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
									 ...
									 <?php $i=0;
												...
												foreach($guardianRequestRejected as $category => $value) 
												{
												...
												foreach($kinRequestRejectedDetail as $category => $value) 
												{
										...
										<div class="clear"></div>
										<div class="padtb20   talc <?php if($kinRequestRejectedCount['num']<=5) echo 'hidden'; ?>">
										
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width"  value="1" onclick="add_more_kins(this);">View more</a>
									</div>	

										<script>
										function add_more_kins(link) {
										...
										$.ajax({
											type:"POST",
											url:"moreRejectedKinRequestDetail",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
									 ...
									 <?php $i=0;
												...
												foreach($rejectedContractorInvitation as $category => $value) 
												{
