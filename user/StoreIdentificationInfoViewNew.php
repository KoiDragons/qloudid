  ...
  function submitform()
		{
			...
			{
				$("#errorMsg1").html('Please enter a valid passport number');
                 submitFlag = 0;
                 return false;
			}
			 if ($('#image-data1').val() == "" || $('#image-data1').val() == null) {
         
                 $("#errorMsg1").html('Please select front image');
                 submitFlag = 0;
                 return false;
             }
             ...
             if ($('#image-data3').val() == "" || $('#image-data3').val() == null) {
                 ...
                 $("#errorMsg1").html('Please select back image');
                 submitFlag = 0;
                 return false;
             }
...
<form action="addIndificator" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
 ...
 <div class="hidden" id="showDetails">
 <input type="hidden" id="expiry_date" name="expiry_date" value="1" />
 <input type="hidden" id="issue_date" name="issue_date" value="1" />
							<div class="upload__item" style="margin-bottom:24px;">
 ...
 <div class="on_clmn mart20 marb35 hidden">
                        ...
                        <div class="field" style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="id_number" id="id_number" style=" color:grey;"  >
                            </div>
                          </div>
