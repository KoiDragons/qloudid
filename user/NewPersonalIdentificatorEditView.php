 ...
 var issueM="<?php echo date('m'); ?>";
		...
		function submitform()
		{
			...
			var submitFlag=1;
			 ...
			 if($("#identificator").val()==null || $("#identificator").val()=="")
			{
...
<a class="header__logo xs-fsz25 changedText" href="../identificatorsList" style="
...
<h2 class="checkout__title h2 xsi-nobrdb fsz80 xxs-fsz70 xxs-lgn_hight_75 lgn_hight_90 changedText" style="
    ...
    margin-bottom: 0px;
     border-bottom: none;
">Identificator</h2>
<div class="browse__info info xs-fsz25 changedText">Please update you identificator details</div>
</div>
<div class="checkout__inner js-tabs wi_50">

<div class="checkout__list">
 
<div class="checkout__section xsi-nobrdt " style="padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../updateIndificator/<?php echo $data['certi_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
 
                      <div class="checkout__fieldset">
                        <div class="field">
                            <div class="field__label" style="color:#787f91;"><?php if($identificatorDetail['identification_type']==1) echo 'ID'; else if($identificatorDetail['identification_type']==2) echo 'Driving license'; else if($identificatorDetail['identification_type']==3) echo 'Passport'; ?> number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="identificator" id="identificator" value="<?php echo $identificatorDetail['identity_number']; ?>" style="background:transparent; color:grey;"  >
                            </div>
                          </div>
 ...
 <div class="on_clmn mart20 marb35 hidden">
                      ...
                      <div class="upload__note">Drag or choose your file to upload</div>
                      <div class="upload__file upload__filet"  style="  background-image: <?php echo $value_b; ?>;" >
