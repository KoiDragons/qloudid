				...
				<div class="wi_100 xs-hei_40p hei_65p pos_fix padtb5 padrl10  white_bg">
					...
					<div class="fright xs-dnone sm-dnone padt10 padb10">
						<ul class="mar0 pad0 sf-menu fsz16">
							...
							<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue"> <a href="https://www.qloudid.com/user/index.php/CorporateServices"  class="ranslate hei_30pi dblock padrl20 blue_bg_h  lgn_hight_30 black_txt white_txt_h" data-en="Företag" data-sw="Företag">Företag</a> </li>
							...
							<li class="dblock hidden-xs hidden-sm fleft pos_rel  brdclr_dblue hidden"> <a href="https://www.qloudid.com/user/index.php/InformRelatives"   class="translate hei_30pi dblock padrl20 blue_bg_h  lgn_hight_30 black_txt white_txt_h hidden" data-en="sos" data-sw="sos">SOS <span class="fa fa-heart red_txt"></span> F&F </a> </li>
						...
						<div class="dflex xs-fxwrap_w alit_c padt0 marb40">
							...
							<div class="wi_50 xs-wi_100 flex_1 order_2 xs-order_1 xs-tall tall mart10 brdrad5 talc padl20 xs-padr0">
								<div class="wi_100 xs-wi_100 bs_bb pad40 tall white_bg">
									...
									<div class="lgn_hight_30 fsz26 xs-fsz18">Ett webbaserat besökssystem som förenklar hantering av besökare, höjer säkerheten och förmedlar ett professionellt första intryck. </div>
									<div class="mart20 tall"> 
										<a href="https://www.qloudid.com/user/index.php/PublicAboutQmatchup"><input type="button" value="Mer om Krishantering" class="padl20 nobrd wi_60 maxwi_500p minhei_50p dflex  alit_c opa90_h brdrad3 panlyellow_bg fsz20 xs-fsz16 darkgrey_txt trans_all2 tall"></a>
									</div>
								</div>
							</div>
