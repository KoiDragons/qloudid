				...
				<div class="wi_240p fleft pos_rel zi50">
                           ...
                           <ul class="dblock marr20  padl10 fsz16">
							    ...
							    <li class="dblock padrb10">
                                 ...
                                 <a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brdb tb_67cff7_bg brd_width_2 black_txt  padb10">
                                    <span class="valm trn" style="letter-spacing: 2px;">Delivery address</span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>
							  <li class="dblock padrb10 padt5">
                                 <a href="certificateList" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
                                    <span class="valm trn" style="letter-spacing: 2px;">Qloud ID App</span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>	
									 <li class="dblock padrb10">
								...
								<li class="dblock padrb10  ">
                                 <a href="visitingCountryList" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
                                    <span class="valm trn" style="letter-spacing: 2px;">Visiting countries</span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>	

								<li class="dblock padrb10  ">
                                 <a href="currentCountryInfo" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
                                    <span class="valm trn" style="letter-spacing: 2px;">Update residence</span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>		
					...
					<div class="wi_500p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl0 xs-pad0">
								 ...
								 <div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn">Delivery</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc     xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Here is a list of all your address</a></div>
						...
						<div class="tab-header martb0 padb10 xs-talc  nobrd talc">
							  ...
							  <?php  
											$i=0;	
												foreach($addressInfo as $category => $value) 
												{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php echo $value['name_on_house'].','.$value['address'].'-'.$value['port_number']; ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php echo $value['city']. ' - '. $value['zipcode']; ?></span>  </div>
													 
													 
													<a href="<?php if($value['ownership_updated']==1) echo 'apartmentPublishInfo'; else echo 'apartmentOwnershipInfo';?>/<?php echo $value['enc']; ?>"><div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 ">
														  <span class="fas fa-arrow-alt-circle-right txt_cfdbea" aria-hidden="true"></span> 
													</div></a>
													 
													
													<?php if($value['is_personal_address']==1) { ?> 
													 
													<?php } else { ?>
													<a href="editDeliveryAddress/<?php echo $value['enc']; ?>"><div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 ">
