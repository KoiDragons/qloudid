...
<body class="lgtgrey2_bg ffamily_avenir">
	...
	<div class="column_m   talc lgn_hight_22 fsz16 xs-marb0 xs-mart20  mart40  padb30" id="loginBank" onclick="checkFlag();">
				...
				<img src="../../../html/usercontent/images/394180.png" class="maxwi_100 hei_250p">
									...
									<div class="mart20 marb35  xxs-talc talc "> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc edit-text jain_drop_company black_txt talc ffamily_avenir" ><span class="trn">Your personal account is now connected to your phone successfully.</span>
												</a></div>
