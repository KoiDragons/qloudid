...
<button class="button-stroke button-small description__button" style="display: none;">Show more</button>
		...
		<div class="receipt xs-margin0 marrla xxs-wi_325p wi_375p xs-pad20" style="
...
<div class="receipt__free" style="margin-bottom: 5px;font-size: 25px;color: black;">Logged out</div>
				
				
				
</div><div class="receipt__foot">
<div class="receipt__free" style="font-size: 15px;color: grey;">Your have been looged out by free will or due to none-activity
...
<div class="receipt__subtitle" style="color:white !important;">Login again</div>
</div>
</div>
</div></a>
