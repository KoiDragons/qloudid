...
<a class="header__logo xs-fsz25 changedText" href="../listApartmentResidentials/<?php echo $data['aid']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.safeqloud.com/user/index.php/NewPersonal/addressList">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg><span>Go home</span></a>
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Dependents</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Select dependent</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select the dependents that are residential at your apartment.</div>
...
">
 ...
 <script>
										...
										function submitProposalForm()
										{
											...
											{
											$('error_msg_form').html('Please select atleast one dependent');	
											return false;
											}
...
box-shadow:none;">
			   ...
			   <?php $i=1; 
								foreach($residentialDependentList as $category => $value) 
										{
                                  ...
                                  <div class="travels__body">
                                    <div class="travels__line">
                                      <div class="travels__details">
                                        ...
                                        <div class="travels__location" style="color: #777E90;">Dependent</div>
                                      </div>
   ...
   " onclick="selectWishlist(<?php echo $value['id']; ?>);">Select</a>
                ...
                <form class="checkout__item js-tabs-item talc" action="../addDependentResidential/<?php echo $data['aid']; ?>" method="POST" id="save_indexing_proposal" name="save_indexing_proposal" accept-charset="ISO-8859-1" style="display: block;">		
