...
<html>
	...
	<head>
		...
		function updateHeading(id)
		{
			...
			{
			$('#errorMsg').html('Minimum one character is required!!!');	
			$('#property-nickname-input').val(propertyUpdate);
			...
			$('#wordCount').html(id.length);
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateHeading/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Property listing" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10 padb30">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Property title</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">The Property title is what guests see when they search for a place to stay. Use it to showcase your property.</span> 
													 </div>
													 
													<div class="clear"></div>
												<div class="css-1jcail2"><div data-testid="did-you-know-headline-info" class="css-1miy8fb"><img role="presentation" src="https://www.safeqloud.com/html/usercontent/images/paintbrush-ladder.68ee.svg" class="css-1p436cn"><div class="css-1ai2sgr">We can generate a listing headline based on market insight which will help make your property stand out to guests.</div></div></div>
												
											<div data-testid="property-nickname-input-wrapper">
											<button color="#444444" class="merlin-button css-1pn4dx" aria-label="" onclick="changeListing();"><div class="merlin-button__content">Generate new title</div></button>
											<div id="spacer" spacing="smaller" class="css-ihl6nu">
											</div>
											<div class="css-zcv01q">
											<input type="text" id="property-nickname-input" label="Property nickname" minlength="1" maxlength="50" class="css-xt766" value="<?php echo $resultOrg1['property_heading']; ?>" onkeyup="updateHeading(this.value);">
											</div>
											<div id="spacer" spacing="smaller" class="css-ihl6nu"></div>
											<div class="css-ev078v">(minimum 1) <span id="wordCount"><?php echo strlen($resultOrg1['property_heading']); ?></span>/50</div></div>
