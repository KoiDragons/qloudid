   ...
   $('#android').removeClass('hidden');
	...
	<div class="clear" id=""></div>
		...
		<div class="column_m pos_rel">
			...
			<form action="../../../../public/index.php/Hotel/thanksCheckin/<?php echo $data['id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						...
						<div class="padtb0 brdrad3 ">
						 <div class="padt20 xxs-talc talc visible-xs hidden" id="android">
								...
								<a href="https://www.safeqloud.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/checkin/1"><button type="button" name="forward" class="forword minhei_55p bluergb_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
						    
						     <div class="padt20 xxs-talc talc visible-xs  hidden" id="iOS">
								
								<a href="safeqloudUrl://<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/checkin/1"><button type="button" name="forward" class="forword minhei_55p bluergb_bg fsz18 padrl80" >Sign in</button></a>
								
							</div>
							<div class="padb10  talc padt20 hidden-xs">
										<div class="padrl0 ">
											<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>/<?php echo $data['id']; ?>/checkin/1" class="white_brd wi_35 hei_auto xs-wi_60 xsi-wi_45"  >
