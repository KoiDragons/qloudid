...
<html>
	...
	<head>
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateSecurity/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		var fee='<?php echo $resultOrg1['security_fee']; ?>';
		function updateSecurityFee(id)
		{
			$('#errorMsg').html('');
			if($("#fee").val()==0 || $("#fee").val()=="" || $("#fee").val()< 100)
			{
				fee=100;
				$("#fee").val(fee);
			}
			else if($("#fee").val()>1750)
			{
		...
		var send_data={};
				 send_data.update_info=fee;
				 
				 $.ajax({
							type:"POST",
							url:"../updateSecurityFee/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Security Deposit fee" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
									...
									<div class="column_m container  marb5   fsz14 dark_grey_txt   padb10  ">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Security Deposit</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">Do you charge guests a security deposit?</span> 
													 </div>
									 ...
									 <div class="clear"></div>
										<div class="css-zp5g9l mart10 tall"><div class="css-1jcail2"><div data-testid="did-you-know-pet-friendly" class="css-1miy8fb"><img role="presentation" src="https://www.safeqloud.com/html/usercontent/images/paintbrush-ladder.68ee.svg" class="css-1p436cn"><div class="css-1ai2sgr">For extra peace of mind, consider obtaining your own insurance. We recommend Pikl. They provide specialist insurance for vacation rentals.</div></div></div></div> 
