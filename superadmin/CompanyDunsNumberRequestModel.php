...
require_once('../AppModel.php');
	...
	class CompanyDunsNumberRequestModel extends AppModel
	{
	
			function approveCompanyDunsNumberRequest($data)
		{
			$dbCon = AppModel::createConnection();
			$partner_id= $this -> encrypt_decrypt('decrypt',$data['pid']);
			$stmt = $dbCon->prepare("update companies set duns_is_approved=2 where id=?");
			...
			$subject       = "DUNS Verification request Approved!";
...
">
    ...
    margin-left: auto;  z-index: 5; max-width: 100%; width: auto;">
                              ...
                              <div style="margin-top: 20px; font-weight: normal; margin-bottom: 10px; text-align: center; color:white; font-size: 20px;">Your request for DUNS Verification has been approved by superadmin.</div>
                           </div>
                        </div>
                     </div>
                              ...
                              <table style="border-spacing:0;font-family:sans-serif;color:#111111;Margin:0 auto;width:100%;table-layout:fixed">
                                ...
                                <tbody><tr>
                                  ...
                                  <td style="padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;background-color:#ffffff;width:100%;text-align:center">
                                    ...
                                    <p style="Margin-top:0px;line-height:22px;Margin-bottom:0px; fsz14px;">This is sent because your DUNS Number was approved by superadmin,</p>
...
//catch exception
  ...
  $stmt->close();
	...
	return 0;
			...
			function rejectCompanyDunsNumberRequest($data)
		{
			$dbCon = AppModel::createConnection();
			$partner_id= $this -> encrypt_decrypt('decrypt',$data['pid']);
			$stmt = $dbCon->prepare("update companies set duns_is_approved=3 where id=?");
...
">
    ...
    margin-left: auto;  z-index: 5; max-width: 100%; width: auto;">
                              ...
                              <div style="margin-top: 20px; font-weight: normal; margin-bottom: 10px; text-align: center; color:white; font-size: 20px;">Your request for DUNS verification account has been rejected by superadmin. Please contact support for further information.</div>
                           </div>
                        </div>
                     </div>
                              ...
                              <table style="border-spacing:0;font-family:sans-serif;color:#111111;Margin:0 auto;width:100%;table-layout:fixed">
                                ...
                                <tbody><tr>
                                  ...
                                  <td style="padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;background-color:#ffffff;width:100%;text-align:center">
                                    ...
                                    <p style="Margin-top:0px;line-height:22px;Margin-bottom:0px; fsz14px;">This is sent because superadmin have taken action on your DUNS Number verification request,</p>
...
//catch exception
  ...
  $stmt->close();
	...
	return 0;
		...
		function companyDunsNumberRequestCount()
		{
			$dbCon = AppModel::createConnection();
			
			$stmt = $dbCon->prepare("select count(id) as num from companies where duns_is_approved=1");
		...
		function companyDunsNumberRequestDetail()
		{
			$dbCon = AppModel::createConnection();
			
			$org=array();
			
				$stmt = $dbCon->prepare("select id,company_name,duns_number from companies where duns_is_approved=1 limit 0,5");
		...
		function moreCompanyDunsNumberRequestRequest()
		{
			$dbCon = AppModel::createConnection();
			
			$a=$_POST['id']*5+1;
			$b=5;
			$stmt = $dbCon->prepare("select id,company_name,duns_number from companies where duns_is_approved=1  limit ?,? ");
				...
				$org=$org.' <div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz14 bold  black_txt">'.substr(html_entity_decode($row['company_name']),0,18).'</span>
																	
																	 <span class="edit-text  fsz18  jain2 dblock  lgn_hight_18 ">'.$row['duns_number'].'</span>  
																	</div>
			...
			return $org;
		 	...
		 	function companyDunsNumberRequestCountApproved()
		{
			$dbCon = AppModel::createConnection();
			
			$stmt = $dbCon->prepare("select count(id) as num from companies where duns_is_approved=2");
		...
		function companyDunsNumberRequestDetailApproved()
		{
			$dbCon = AppModel::createConnection();
			
			$org=array();
			
				$stmt = $dbCon->prepare("select id,company_name,duns_number from companies where duns_is_approved=2   limit 0,5");
		...
		function moreCompanyDunsNumberRequestApproved()
		{
			$dbCon = AppModel::createConnection();
			
			$a=$_POST['id']*5+1;
			$b=5;
			$stmt = $dbCon->prepare("select id,company_name,duns_number from companies where duns_is_approved=2  limit ?,? ");
		 ...
		 function companyDunsNumberRequestCountRejected()
		{
			$dbCon = AppModel::createConnection();
			
			$stmt = $dbCon->prepare("select count(id) as num from companies where duns_is_approved=3");
		...
		function companyDunsNumberRequestDetailRejected()
		{
			$dbCon = AppModel::createConnection();
			
			$org=array();
			
				$stmt = $dbCon->prepare("select id,company_name,duns_number from companies where duns_is_approved=3   limit 0,5");
		...
		function moreCompanyDunsNumberRequestRejected()
		{
			$dbCon = AppModel::createConnection();
			
			$a=$_POST['id']*5+1;
			$b=5;
			$stmt = $dbCon->prepare("select id,company_name,duns_number from companies where duns_is_approved=3  limit ?,? ");
