...
<html lang="en">
 ...
 <body class="dark" style="background-color:#131922">
  <script>
					...
					function updateServiceCategory(id,id1,id2)
					{
					var send_data={};
					send_data.category_id=id;
					send_data.service_id=id1; 
					send_data.update_info=id2; 
					$.ajax({
						type:"POST",
						url:"../updateServiceCategory/<?php echo $data['app_id']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
							
							 $('#category'+id).html(data1);
...
<a class="header__logo xs-fsz20 changedText " href="../../BusinessAppCenter" style="
  ...
  <!-- outer content-->
      <div class="outer__inner">
        <div class="section setting  ">
          <div class="setting__center center xxs-padrl25">
            <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;  margin-bottom:48px;">
              <select class=" " style="height: 48px;
    padding: 0 10px; border-color: #353945;
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;">
                <option value="#" class="changedText" selected>App services</option>
               
              </select>
            </div>
<div class="checkout__wrapper xs-flexD wi_100">
...
<div class="setting__menu" style="background:transparent; border-right:4px solid #353945; border-radius:0px; border-image: linear-gradient(45deg, rgb(255, 172, 84) 0%, rgb(255, 77, 60) 100%) 1 / 1 / 0 stretch !important;
		...
		<a class="setting__link js-tabs-link active" href="#">
			...
			<h2 class="setting__title h2" style="margin-bottom: 64px;">Services</h2>
			<div class="description__group">
			<?php echo $selectedAppServices; ?>
</div>
  </div>
