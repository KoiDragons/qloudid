			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20" id="loginBank" onclick="checkFlag();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Add pricing plan for <?php echo $appDetail['app_name']; ?>.</a></div>
			 
					 <div class="clear"></div>
							
							<form action="../../addPrice/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div class="marb0 padtrl0">		 
									 ...
									 <div class="thr_clmn  wi_70 padr20">
											<div class="pos_rel">
												...
												<input type="number" name="price" id="price" placeholder="Price" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir"/>
											...
											<select    class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl brdb lgt_grey_txt fsz18  minhei_65p xxs-minhei_60p trans_bg dropdown-bg   tall padl0 ffamily_avenir" style="text-align-last:center;" id="currency_code" name="currency_code"> 
														...
														<option value="SEK" selected>Sweden Krona</option>
									 ...
									 <div class="on_clmn mart20 ">
											...
											<select    class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl brdb lgt_grey_txt fsz18  minhei_65p xxs-minhei_60p trans_bg   tall padl0 ffamily_avenir dropdown-bg " style="text-align-last:center;" id="billing_type" name="billing_type"  onchange="checkRecur(this.value);"> 
														...
														<option value="2" class="lgtgrey2_bg">Recuring</option>
											</select> 
												
											</div>
										</div>
										
									<div class="on_clmn mart20" id="isRecuring" style="display:none;">
								...
								<div class="pos_rel">											
											...
											<option value="1" class="lgtgrey2_bg">Daily </option>
											<option value="2" class="lgtgrey2_bg">Weekly</option>
											<option value="3" class="lgtgrey2_bg">Monthly</option>		
											<option value="4" class="lgtgrey2_bg">Every 3 Month</option>	
											<option value="5" class="lgtgrey2_bg">Every 6 Month</option>	
											<option value="6" class="lgtgrey2_bg">Yearly</option>	
											</select>
											</div>
										 ...
										 <div class="on_clmn mart20 ">
											...
											<select    class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl brdb lgt_grey_txt fsz18  minhei_65p xxs-minhei_60p trans_bg   tall padl0 ffamily_avenir dropdown-bg " style="text-align-last:center;" id="metered" name="metered"  onchange="checkMeter(this.value);"> 
														...
														<option value="1" class="lgtgrey2_bg">Not metered usage</option>
														<option value="2" class="lgtgrey2_bg">Metered Usage</option>
											</select> 
												
											</div>
										</div>
										
										<div class="on_clmn mart20" id="isMeter" style="display:none;">
								...
								<div class="pos_rel">											
											...
											<option value="1" class="lgtgrey2_bg">Sum of usage values during the period </option>
											<option value="2" class="lgtgrey2_bg">Most recent usage value during the period</option>
											<option value="3" class="lgtgrey2_bg">Most recent usage value</option>		
											<option value="4" class="lgtgrey2_bg">Maximum usage value during the period</option>	
									  ...
									  <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="text" name="p_description" id="p_description"  placeholder="Product description" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb  talc xxs-minhei_60p minhei_65p fsz18 lgt_grey_txt ffamily_avenir"    /> 
