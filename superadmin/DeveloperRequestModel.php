...
require_once('../AppModel.php');
	...
	class DeveloperRequestModel extends AppModel
	{
			...
			function approveDeveloper($data)
		{
			...
			$stmt = $dbCon->prepare("update company_developer_account_request set is_approved=1,modified_on=now() where id=?");
			
			/* bind parameters for markers */
			$stmt->bind_param("i", $partner_id);
			$stmt->execute();
			$stmt = $dbCon->prepare("select email from user_logins where id = (select user_id from company_developer_account_request where id=?)");
			/* bind parameters for markers */
			$cont=1;
			$stmt->bind_param("i", $partner_id);
			$stmt->execute();
			...
			$to            = $row['email'];
			$subject       = "Developer request Approved!";
  ...
  $stmt->close();
	...
	return 0;
			...
			function rejectDeveloper($data)
		{
			$dbCon = AppModel::createConnection();
			$partner_id= $this -> encrypt_decrypt('decrypt',$data['pid']);
			$stmt = $dbCon->prepare("update company_developer_account_request set is_approved=2,modified_on=now() where id=?");
			...
			$to            = $row['email'];
			$subject       = "Developer request rejected!";
			$emailContent ='<html><head></head><body><div style="margin-top:0!important;margin-bottom:0!important;margin-right:0!important;margin-left:0!important;padding:0">
  ...
  $stmt->close();
	...
	return 0;
		...
		function developerCount()
		{
			...
			$stmt = $dbCon->prepare("select count(id) as num from company_developer_account_request where is_approved=0");
		...
		function developerDetail()
		{
			...
			$org=array();
				...
				$stmt = $dbCon->prepare("select company_developer_account_request.id,created_on,company_name from company_developer_account_request left join companies on companies.id=company_developer_account_request.company_id where is_approved=0 order by created_on desc limit 0,5");
		...
		function moreDeveloperRequest()
		{
			$dbCon = AppModel::createConnection();
			
			$a=$_POST['id']*5+1;
			$b=5;
			$stmt = $dbCon->prepare("select company_developer_account_request.id,created_on,company_name from company_developer_account_request left join companies on companies.id=company_developer_account_request.company_id where is_approved=0 desc limit ?,? ");
			...
			while($row = $result->fetch_assoc())
			{
				...
				$org=$org.' <div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
														...
														<a href="DeveloperRequest/approveDeveloper/'.$org1.'"><span class="fas fa-check-circle green_txt" aria-hidden="true"></span></a>
													</div>
																			<div class="fright wi_10 padl0 xs-wi_20  marl15 fsz40  xs-marl0 xxs-marr20  padb0 ">
														<a href="DeveloperRequest/rejectDeveloper/'.$org1.'"><span class="fas fa-times-circle red_txt" aria-hidden="true"></span></a>
													</div> 
		...
		function developerCountApproved()
		{
			...
			$stmt = $dbCon->prepare("select count(id) as num from company_developer_account_request where is_approved=1");
		...
		function developerDetailApproved()
		{
			...
			$org=array();
				...
				$stmt = $dbCon->prepare("select company_developer_account_request.id,created_on,company_name from company_developer_account_request left join companies on companies.id=company_developer_account_request.company_id where is_approved=1 order by created_on desc limit 0,5");
		...
		function moreDeveloperRequestApproved()
		{
			...
			$a=$_POST['id']*5+1;
			$b=5;
			$stmt = $dbCon->prepare("select company_developer_account_request.id,created_on,company_name from company_developer_account_request left join companies on companies.id=company_developer_account_request.company_id where is_approved=1 desc limit ?,? ");
		 ...
		 function developerCountRejected()
		{
			...
			$stmt = $dbCon->prepare("select count(id) as num from company_developer_account_request where is_approved=2");
		...
		function developerDetailRejected()
		{
			...
			$org=array();
				...
				$stmt = $dbCon->prepare("select company_developer_account_request.id,created_on,company_name from company_developer_account_request left join companies on companies.id=company_developer_account_request.company_id where is_approved=2 order by created_on desc limit 0,5");
		...
		function moreDeveloperRequestRejected()
		{
			...
			$a=$_POST['id']*5+1;
			$b=5;
			$stmt = $dbCon->prepare("select company_developer_account_request.id,created_on,company_name from company_developer_account_request left join companies on companies.id=company_developer_account_request.company_id where is_approved=2 desc limit ?,? ");
