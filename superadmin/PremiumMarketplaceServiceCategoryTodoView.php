...
function changeDisplay1()
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"<?php if(isset($data['set_object'])) echo '../'; ?>updateCategoryServiceTodo/<?php echo $data['mid']; ?>/<?php echo $data['objectType']; ?>",
							data:send_data,
							dataType:"text",
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"<?php if(isset($data['set_object'])) echo '../'; ?>updateCategoryServiceAllTodos/<?php echo $data['mid']; ?>/<?php echo $data['objectType']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
					 ...
					 <div class="padt20 talc padb50">
								...
								<a href="../marketplaceServicesList/<?php echo $data['mid']; ?>">
