...
<a class="header__logo xs-fsz20 changedText " href="../../appMarket/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
		...
		<div class="section setting js-tabs" style="padding-top:0px;">
          <div class="setting__center center xs-padrl25" >
                ...
                <div class="setting__head visible-xs">
                    <h2 class="setting__title h2 uppercase" style="font-size:45px;">Start price info</h2> 
                  </div>
 ...
 <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;">
    ...
    color: #f67f00; border-radius: 12px;
		...
		<option value="../../productInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>">Content</option>
                 <option value="../../productSubscriptionInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>">Subscription info</option>
				<option value="../../appStartPriceInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>">Start price</option>
              </select>
            </div>
				 ...
				 <a class="setting__link " href="../../productInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" onclick="updateHeader('../../productInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>');">
                <svg class="icon icon-lock">
                  <use xlink:href="#icon-lock"></use>
                </svg>Content</a>
				<a class="setting__link " href="../../productSubscriptionInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" onclick="updateHeader('../../productSubscriptionInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>');">
                <svg class="icon icon-lock">
                  <use xlink:href="#icon-lock"></use>
                </svg>Subscription info</a>
			<a class="setting__link  active" href="../../appStartPriceInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" onclick="updateHeader('../../appStartPriceInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>');">
                <svg class="icon icon-lock">
                  <use xlink:href="#icon-lock" style="fill:#f67f00;"></use>
                </svg>Start price</a>
			...
			<form class="checkout__item js-tabs-item" action="../../updateAppStartPricing/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
  
     
						  
						 
                <div class="setting__item  " style="display:block;">
                <h2 class="setting__title h2">Pricing detail</h2>
                <div class="setting__list">
                  <div class="setting__box">
					...
					<div class="checkout__row  margin-bottom24">
						   ...
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Satrt fee</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" value="<?php echo $appStartFeeDetail['start_fee']; ?>" name="start_fee" id="start_fee" style=" border-color: #353945; color:grey;" fdprocessedid="tqjibs" min="0" value="0">
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Per licence fee</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="licence_fee" value="<?php echo $appStartFeeDetail['licence_fee']; ?>" id="licence_fee" style=" border-color: #353945; color:grey;" fdprocessedid="tqjibs" min="0" value="0">
                            </div>
                          </div>
 ...
 <input type="hidden" id="trial_period" name="trial_period" value="<?php echo $appStartFeeDetail['trial_period']; ?>" />
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Trial available</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateShareCommisionInfo(this);' <?php if($appStartFeeDetail['trial_period']==1) echo 'checked'; ?>/><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you have trial proposals</div>
                    </div>
                  
				   <div class="field margin-bottom24 <?php if($appStartFeeDetail['trial_period']==0) echo 'hidden'; ?>" id="commissionInfo">
                            <div class="field__label  changedText" style="color:#787f91;">How many free proposals</div>
							<div class="field__wrap">
							<input class="field__input" type="number" name="free_proposals" id="free_proposals" style=" border-color: #353945; color:grey;" fdprocessedid="tqjibs" min="0" value="<?php echo $appStartFeeDetail['free_proposals']; ?>">
						   ...
						   <div class="field margin-bottom24 ">
                            <div class="field__label  changedText" style="color:#787f91;">Discount coupon</div>
							<div class="field__wrap">
							<input class="field__input" type="text" name="discount_coupon" id="discount_coupon" value="<?php echo $appStartFeeDetail['discount_coupon']; ?>"  style=" border-color: #353945; color:grey;" fdprocessedid="tqjibs" min="0" value="0">
						   ...
						   <div class="field margin-bottom24 " >
                            <div class="field__label  changedText" style="color:#787f91;">Discount on start fee</div>
                            <div class="field__wrap">
							 <select class="" id="start_fee_discount" name="start_fee_discount" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun">
								   
									<?php for($i=0;$i<=20;$i++) { ?>	
													 <option value="<?php echo $i; ?>" <?php if($appStartFeeDetail['start_fee_discount']==$i) echo 'selected'; ?>><?php echo $i; ?></option><?php } ?> 
						   ...
						   <div class="field margin-bottom24 " >
                            <div class="field__label  changedText" style="color:#787f91;">Discount on licence fee</div>
                            <div class="field__wrap">
							 <select class="" id="licence_fee_discount" name="licence_fee_discount" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun">
								   
									<?php for($i=0;$i<=20;$i++) { ?>	
													 <option value="<?php echo $i; ?>" <?php if($appStartFeeDetail['licence_fee_discount']==$i) echo 'selected'; ?>><?php echo $i; ?></option><?php } ?> 
