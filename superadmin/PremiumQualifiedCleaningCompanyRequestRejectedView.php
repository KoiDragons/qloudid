<head>
   ...
   {
	  window.location.href ="https://www.qloudid.com/superadmin/index.php/PremiumQualifiedCleaningCompany/requestReceived";
   }
					...
					<!-- Center content -->
						...
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="tab-header martb10 padb10   brdb2_ffde00 nobrdt nobrdl nobrdr tall">
											...
											<a href="requestReceived" class="dinlblck mar5 padrl10  bg_ffde00_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir "  onclick="changeHeader();">Request</a>
											<a href="requestapproved" class="dinlblck mar5 padrl10  bg_ffde00_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir " onclick="changeHeader1();" >Approved</a>
                                             <a href="#" class="padrl30_a padrl10 fsz18 red_ff2828_txt lgn_hight_36 active"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>

                                        </div>
					 
							<?php 
															
															foreach($PremiumQualifiedDetailRejected as $category => $value) 
								...
								<div class="column_m container  marb5   fsz14 dark_grey_txt">
										...
										function add_more_rows_unsent(link) {
																...
																$.ajax({
																type:"POST",
																url:"morePremiumQualifiedCleaningCompanyRejected",
																data:send_data,
																dataType:"text",
