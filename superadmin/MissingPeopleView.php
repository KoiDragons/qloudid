				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Missing</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc   brdb_new brd_width_2 xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >List of reported missing people</a></div>
					 		...
					 		<?php $i=0;
												...
												foreach($missingChildrenDetail as $category => $value) 
												{
												?>	
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $value['first_name']; ?>  </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt"><?php if($value['address']!="" || $value['address']!=null) echo $value['address']; else echo '-'; ?></span>  </div>
										...
										<div class="clear"></div>
									<div class="padtb20   talc <?php if($missingChildrenCount['num']<=10) echo "hide"; ?>">
									...
									function add_more_my(link) {
										...
										$.ajax({
											type:"POST",
											url:"MissingPeople/moreMissingChildren",
											data:send_data,
											dataType:"text",
