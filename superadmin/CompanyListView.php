									...
									<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75">
										...
										<div class="padl10">
											...
											<ul class="marr20 pad0">
												...
												<li class=" dblock padb10 padl8">
													<a href="UsersList" class="hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
														<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
														<span class="valm trn">User</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg  rotate45"></div>
													</a>
													</li> 
							...
							<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5 white_bg padl20 xs-padl0">
								...
								<div class="padb20 xxs-padb0 ">
									...
									<div class="container tab-header padt5 talc dark_grey_txt ">
										<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey_bg">
											...
											<li>
												<a href="#" class="dblock brdradt5 active" data-id="tab_total">
													<span class="count black_txt"><?php echo $companyCountVerified['num']; ?></span>
													<span class="black_txt fsz16"> Verified </span>
												</a>
											</li>
											<li>
												<a href="#" class="dblock brdradt5 " data-id="tab_total1">
													<span class="count black_txt "><?php echo $companyCountUnverified['num']; ?></span><span class="black_txt fsz16"> Unverified</span>
												</a>
											</li>
										...
										<select class="tab-header xs-wi_100 maxwi_100 dnone xs-dblock hei_70p pad0 nobrd brdb_new xs-fsz30 pblue2_bg">
											<option value="tab_total" selected class="xs-fsz20"><?php echo $companyCountVerified['num']; ?></option>
										...
										<div class="tab-content padb25 padt5 active xs-padt0" id="tab_total" style="display: block;">
											<form>
												<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable">
													<thead class="fsz14">
														<tr class="lgtgrey2_bg hei_40p">
															...
															<th class="wi_300 pad10  grey_txt nobold tall" >Company name</th>
																	...
																	<div class="wi_100">
																		<div class="dflex alit_c">
																			<h3 class="mar0 pad0 fsz16 xs-fsz16">
																				<a href="#" class=" dark_grey_txt txt_0070e0_sbh" data-id="<?php echo 'a_'.$value['id']; ?>" id="<?php echo 'a_'.$value['id']; ?>"><?php echo $value['company_name']; ?></a>
																			</h3>
												...
												<div class="mart20 talc">
													<a href="javascript:void(0);" class="dblue_btn" value="1" id="new_value" onclick="add_more_company_rows(this,this.value)" > View more </a>
												</div>
									...
									<div class="tab-content padb25 padt5 active xs-padt0" id="tab_total1" >
										<form>
											...
											<div class="mart20 talc">
												<a href="javascript:void(0);" class="dblue_btn" value="1" id="new_value" onclick="add_more_virtual_rows(this,this.value)" >View more</a>
											</div>
								...
								<script>
									...
									function add_more_company_rows(link,id){
										...
										$.ajax({
											type:"POST",
											url:"CompanyList/moreCompanyDetail",
											data:send_data,
											dataType:"text",
									...
									function add_more_virtual_rows(link,id){
										...
										$.ajax({
											type:"POST",
											url:"CompanyList/moreCompanyUnverifiedDetail",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
