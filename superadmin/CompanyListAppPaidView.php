			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart0 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brd_width_2 brd_fcaf17 tb_67cff7_bg  nobrdt nobrdl nobrdr black_txt  padb10"> <span class="valm trn" style="letter-spacing: 2px;">Corporate users</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
												<li class="dblock padrb10 padt5   last">
						<a href="../../../CountryList/productSubscriptionDetailInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Subscription info </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>			 
											</ul>
							...
							<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 t_67cff7_bg     brdrad0" onclick="checkFlag();">
								...
								<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
										...
										<div class="padb0 xxs-padb0 ">		
																...
																<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 white_txt trn ffamily_avenir">Users</h1>
																</div>
																<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="white_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">These users are companies</a></div>
																</div>
								...
								<div class="column_m   talc lgn_hight_22 fsz16 lgtgrey_bg  ">
									 ...
									 <div class="tab-header mart35  padb10 xs-talc  talc  brd_fcaf17 tb_67cff7_bg  nobrdt nobrdl nobrdr ">
                                              <a href="../../appsAccount/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" class="dinlblck mar5 padrl10 padrl30_a nobrd   t_67cff7_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir "  >Free users</a>
                                            <a href="#" class="dinlblck mar5 padrl10  padrl30_a    t_67cff7_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active"  >Paid</a>
									...
									<div class="tab_content active" id="utab_Analytics" style="display: block;">
											...
											<?php $i=0;
												...
												foreach($companyAppsPaidDetail as $category => $value) 
												{
													
													
												?> 
											
												 <a href="../../paymentHistory/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>/<?php echo $value['enc']; ?>"><div class="column_m container  marb5   fsz14 dark_grey_txt">
										...
										<div class="clear"></div>
										<div class="padt20 padb10 talc <?php if($companyAppsDetailPaidCount['num']<=5) echo 'hidden'; ?>">
										...
										$.ajax({
											type:"POST",
											url:"../../moreCompanyAppsPaidDetail/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>",
											data:send_data,
											dataType:"text",
