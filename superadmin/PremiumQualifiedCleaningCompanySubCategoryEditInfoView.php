				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="../../updateProfessionalSubCategory/<?php echo $data['catg_id']; ?>/<?php echo $data['subcatg_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
								...
								<div id="profile1" class=" " style="display:block;">	
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="text" name="category_name" id="category_name" value="<?php echo $selectedProfessionalSubCategoryDetail['subcategory_name']; ?>" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="text" name="flow_url" id="flow_url" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36" value="<?php echo $selectedProfessionalSubCategoryDetail['flow_url']; ?>"> 
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<option value="1" <?php if($selectedProfessionalSubCategoryDetail['display_name_allowed']==1) echo 'selected'; ?>>Yes</option>
												<option value="0"  <?php if($selectedProfessionalSubCategoryDetail['display_name_allowed']==0) echo 'selected'; ?>>No</option>
												</select>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<option value="1" <?php if($selectedProfessionalSubCategoryDetail['user_licence_required']==1) echo 'selected'; ?>>Yes</option>
												<option value="0" <?php if($selectedProfessionalSubCategoryDetail['user_licence_required']==0) echo 'selected'; ?>>No</option>
												</select>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Active</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">If service is active or not?</span> 
													 </div>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<select name="is_service_active" id="is_service_active" placeholder="First name" class="wi_100 white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
												<option value="1"  <?php if($selectedProfessionalSubCategoryDetail['is_service_active']==1) echo 'selected'; ?>>Yes</option>
												<option value="0" <?php if($selectedProfessionalSubCategoryDetail['is_service_active']==0) echo 'selected'; ?>>No</option>
												</select>
											 <label for="category_name" class="floating__label tall nobold padl10  " data-content="Is service active?">
											<span class="hidden--visually ">
											  First name</span></label>
											</div>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<option value="1" <?php if($selectedProfessionalSubCategoryDetail['property_information_required']==1) echo 'selected'; ?>>Yes</option>
												<option value="0" <?php if($selectedProfessionalSubCategoryDetail['property_information_required']==0) echo 'selected'; ?>>No</option>
												</select>
									...
									<div class="clear"></div>
									 	<?php $a=explode(',',$professionalSubCategoryInclusionDetail); ?>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<a href="javascript:void(0);" onclick="updateInclutionType(1)"><input data-testid="test-checkbox-Walls" name="Walls" type="checkbox" class="css-1lgzhz8" <?php if (in_array(1, $a)) echo 'checked';
														 ?>></a>
														</div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20" id="2">
														<a href="javascript:void(0);" onclick="updateInclutionType(2)"><input data-testid="test-checkbox-Walls" name="Walls" type="checkbox" class="css-1lgzhz8" <?php if (in_array(2, $a)) echo 'checked';
														 ?>></a>
														</div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20" id="3">
														<a href="javascript:void(0);" onclick="updateInclutionType(3)"><input data-testid="test-checkbox-Walls" name="Walls" type="checkbox" class="css-1lgzhz8" <?php if (in_array(3, $a)) echo 'checked';
														 ?>></a>
														</div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											<div class="css-1sjqbna padrl20" id="4">
														<a href="javascript:void(0);" onclick="updateInclutionType(4)"><input data-testid="test-checkbox-Walls" name="Walls" type="checkbox" class="css-1lgzhz8" <?php if (in_array(4, $a)) echo 'checked';
														 ?>></a>
														</div>
											<label for="oven" class="css-14q70q1 changedText">Goverment</label></div>
												...
												<input type="hidden" id="inclusion_type_detail" name="inclusion_type_detail" value="<?php echo $professionalSubCategoryInclusionDetail; ?>">				
										</div>
										...
										<div class="on_clmn mart20 ">
											...
											<div class="pos_rel"><textarea class="texteditor "  id="product_information" name="product_information"> <?php echo$selectedProfessionalSubCategoryDetail['professional_description']; ?>
										 </textarea></div>
										</div>
