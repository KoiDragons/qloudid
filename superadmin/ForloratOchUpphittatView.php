										...
										<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03  brdr_new fsz14" id="scroll_menu">
											...
											<ul class="marr20 pad0">
												...
												<li class=" dblock padb10 padl8">
													<a href="ForloratOchUpphittat" class="active hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												...
												<li class=" dblock padb10 padl8">
													<a href="UnregisteredForloratOchUpphittat" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
														<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="column_m container tab-header  talc dark_grey_txt mart5">
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey_bg">
									<li>
										<a href="#" class="dblock brdradt5 active" data-id="tab_total">
											<span class="count black_txt"><?php echo $lostandFoundCount['num']; ?></span>
									...
									<li>
										<a href="#" class="dblock brdradt5 " data-id="tab_total1">
											<span class="count black_txt"><?php echo $forloradCount['num']; ?></span>
											<span class="black_txt trn fsz16">Förlorad</span>
										</a>
									</li>
									<li>
										<a href="#" class="dblock brdradt5 " data-id="tab_total2">
											<span class="count black_txt">0</span>
											<span class="black_txt trn fsz16">Upphittad</span>
										</a>
									</li>
								...
								<select class="tab-header xs-wi_100 maxwi_100 dnone xs-dblock hei_70p pad0 nobrd brdb_new xs-fsz30 pblue2_bg">
									<option value="tab_total" selected class="xs-fsz20"><?php echo $lostandFoundCount['num']; ?></option>
									<option value="tab_total1"  class="xs-fsz20">Förlorad</option>
									<option value="tab_total2"  class="xs-fsz20">Upphittad</option>
										...
										<thead class="fsz14" >
											<th class="pad5 brdb_new nobold  tall" >
												...
												<th class="pad5 brdb_new nobold hidden-xs tall" >
													<div class="padtb5 black_txt">Serial number</div>
												</th>
							...
							<div class="tab-content padb25 padt5" id="tab_total1">
									...
									<div class="padt20 talc">
										<a href="javascript:void(0);" class="load_more_results  marrl5" value="1" onclick="add_more_my_forlorad(this);">Visa fler</a>
