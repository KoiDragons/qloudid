	  ...
	  function submitform()
		{
			...
			if($("#bg_color_info").val().charAt(0)=='#') 
				{
					$("#errorMsg1").html('Color code cant start with #');
					return false;
				}
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40   "  >
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Please add new market place here</a></div>
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="addProfessionalMarketplace" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
						...
						<div class="on_clmn mart10 ">
									...
									<div class="column_m container fsz14 dark_grey_txt">
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Connection type</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">What is the name of new connection?</span> 
													 </div>
									 ...
									 <div class="on_clmn mart20 ">
											<div class="pos_rel">
												...
												<select name="connection_type" id="connection_type" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " fdprocessedid="lyd8d"> 
											  
											<option value="1" class="lgtgrey2_bg">Marketplace</option>
											   
												<option value="2" class="lgtgrey2_bg">Service domain</option>
												 
											   
																							 		 
											 	 
											</select>
											 	<label for="connection_type" class="floating__label tall nobold padl10" data-content="Connection type">
								...
								<div class="clear"></div>
									<div class="column_m container fsz14 dark_grey_txt">
									 ...
									 <div class="on_clmn mart20 ">
											...
											<option value="1" class="lgtgrey2_bg">Template1</option>
											   
												<option value="2" class="lgtgrey2_bg">Template2</option>
												 
											   
													<option value="3" class="lgtgrey2_bg">Template3</option>										 		 
								...
								<div class="clear"></div>
									...
									<div class="clear"></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">User location</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Sellers location</label></div>
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText">Online</label></div>
								...
								<div class="column_m container fsz14 dark_grey_txt">
									 ...
									 function updateSignupType(id,id1)
									 {
										 ...
										 else if(id==2)
										 {
											 if(id1==1)
											 {
												 var dataTextInner='<a href="javascript:void(0);" onclick="updateSignupType(3,0);"><div id="bath-chip" class="css-cedhmb"><div tabindex="0" role="button" id="toilet-chip" class="css-1w0xfwu" fdprocessedid="gfxwmo"><span class="chip chip_is-selected"> <span class="chip_content"><div class="css-utgzrm"></div><span class="chip_text">Supplier</span> </span></span></div></div></a>';
												$('#partnerSignup').html(dataTextInner);
												getValue=getValue+id+',';
											 }
											 else
											 {
												 var dataTextInner='<a href="javascript:void(0);" onclick="updateSignupType(3,1);"><div id="bath-chip" class="css-cedhmb"><div tabindex="0" role="button" id="bath-chip" class="css-1w0xfwu" fdprocessedid="ryexqi"><span class="chip chip_not-selected"><span class="chip_content"><div class="css-ylfimb"></div><span class="chip_text">Supplier</span> </span></span></div> </div></a>';
												 $('#partnerSignup').html(dataTextInner);
												 getValue = getValue.replace(id+",", "");
											 }
										 }
									 ...
									 <div class="column_m container  marb5  mart0 fsz14 dark_grey_txt  ">
												<div class="white_bg  bg_fffbcc_a ">
										<div class="container padb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												 ...
												 <div class="css-1jzh2co marb15">
												   ...
												   <div id="userSignup">
													  <a href="javascript:void(0);" onclick="updateSignupType(1,1);"><div id="bath-chip2" class="css-cedhmb">
													 ...
													 <a href="javascript:void(0);" onclick="updateSignupType(3,1);"><div id="bath-chip1" class="css-cedhmb">
														 <div tabindex="0" role="button" id="bath-chip" class="css-1w0xfwu" fdprocessedid="ryexqi">
															<span class="chip chip_not-selected">
															   <span class="chip_content">
																  <div class="css-ylfimb"></div>
													 ...
													 <a href="javascript:void(0);" onclick="updateSignupType(2,1);"><div id="bath-chip" class="css-cedhmb">
														 <div tabindex="0" role="button" id="bath-chip" class="css-1w0xfwu" fdprocessedid="ryexqi">
															<span class="chip chip_not-selected">
															   <span class="chip_content">
																  <div class="css-ylfimb"></div>
																  <span class="chip_text">Supplier</span>
															   </span>
															</span>
														 </div>
													  </div></a>
									...
									<input type="hidden" name="signup_type_value" id="signup_type_value" value="" />
									 <div class="on_clmn mart20 hidden">
											<div class="pos_rel">
												 
												<select name="signup_type" id="signup_type" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " fdprocessedid="lyd8d"> 
											  
											<option value="1" class="lgtgrey2_bg">User</option>
											<option value="3" class="lgtgrey2_bg">User company</option>   
											<option value="2" class="lgtgrey2_bg">Supplier</option>
												 
											   
																							 		 
											 	 
											</select>
											 	<label for="signup_type" class="floating__label tall nobold padl10" data-content="Sign up type">
											<span class="hidden--visually">
											 Tax</span></label>
											</div>
										 	</div>
								...
								<div class="on_clmn mart20 ">
											...
											<option value="1" class="lgtgrey2_bg">Book a pro</option>
											<option value="2" class="lgtgrey2_bg">Price comparison</option>   
											<option value="3" class="lgtgrey2_bg">Both of them</option>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="text" name="heading_info" id="heading_info" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="text" name="subheading_info" id="subheading_info" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="text" name="bg_color_info" id="bg_color_info" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<input type="text" name="marketplace_review" id="marketplace_review" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" fdprocessedid="x4hy36"> 
										...
										<div class="on_clmn mart20 ">
											...
											<div class="pos_rel"><textarea class="texteditor "  id="marketplace_description" name="marketplace_description">  
										 </textarea></div>
										</div>	  
										 <div class="clear"></div>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updateFood(1);">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updateDayopen(1);">
																<input type="checkbox"  class="default" data-true="" data-false="" >
															</div>
													</div>
											</div>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updateLicence(1);">
																<input type="checkbox"  class="default" data-true="" data-false="" >
															</div>
													</div>
											</div>
										...
										<input type="hidden" id="licence1" name="licence1" value='0' />
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updateDayopen(2);">
																<input type="checkbox"  class="default" data-true="" data-false="" >
															</div>
													</div>
											</div>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updateLicence(2);">
																<input type="checkbox"  class="default" data-true="" data-false="" >
															</div>
													</div>
											</div>
										...
										<input type="hidden" id="licence2" name="licence2" value='0' />
										...
										<div class="on_clmn mart20 ">
											<div class="pos_rel">
											 ...
											 <option value="1" class="lgtgrey2_bg">One time</option>  									 		 
											 <option value="2" class="lgtgrey2_bg">Every month</option>	 
											</select>
											...
											<div class="pos_rel">
												...
												<input type="number" name="subscription_fee2" id="subscription_fee2" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select  " style="appearance: none "   fdprocessedid="lyd8d" /> 
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updateDayopen(3);">
																<input type="checkbox"  class="default" data-true="" data-false="" >
															</div>
													</div>
											</div>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updateLicence(3);">
																<input type="checkbox"  class="default" data-true="" data-false="" >
															</div>
													</div>
											</div>
										...
										<input type="hidden" id="licence3" name="licence3" value='0' />
										...
										<div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="number" name="subscription_fee3" id="subscription_fee3" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select  " style="appearance: none "   fdprocessedid="lyd8d" /> 
