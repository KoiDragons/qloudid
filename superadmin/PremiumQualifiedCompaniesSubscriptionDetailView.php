...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">Subscribers
</span> </h2>

 
<div class="sorting__details changedText" style=" margin-bottom: 24px; color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Here is the list of subscribers and pending payments
</div>
...
<div class="upload__preview js-upload-preview">
                ...
                </svg><span style="color:#f67f00">Subscription</span></a>
   ...
   <div class="flights__container" style="padding-left:0px;">
                <div class="flights__list">
				  ...
				  <div class="photo-wall__tiles" id="allPhotos">
															<?php $i=1; 
								foreach($professionalCompaniesSubscriptionDetail as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 0px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:25px; color:white;"><?php echo $value['company_name']; ?></div></a>
...
">
                <div class="description__parameter" style="">
                  ...
                  </svg><span class="changedText"><?php  echo date('Y-m-d',$value['subscribed_on']); ?></span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo date('Y-m-d',$value['last_payment_date']); ?></span></div>
                <div class="description__parameter  hidden-xs">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo date('Y-m-d',$value['next_payment_date']); ?></span></div>
              </div>
		   ...
		   <div class="card__foot" style="">
                    ...
                    <?php $date=strtotime(date('Y-m-d')); if($value['next_payment_date']<$date) { ?>  
				<a href="#" style="text-decoration:none;">  <button class="button-stroke button-small faq__button changedText fright" fdprocessedid="w46jts" style="margin-top:0px; padding:0px 20px;">Payment due</button></a>
					<?php } else { ?>
						<a href="#" style="text-decoration:none;">  <button class="button-stroke button-small faq__button changedText fright" fdprocessedid="w46jts" style="margin-top:0px; padding:0px 20px;">Paid</button></a>
					<?php } ?>
		  </div>
