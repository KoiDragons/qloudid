<head>
   ...
   {
	  window.location.href ="https://www.qloudid.com/superadmin/index.php/PremiumQualifiedCleaningCompany/requestapproved";
   }
   
   function changeHeader()
   {
	  window.location.href ="https://www.qloudid.com/superadmin/index.php/PremiumQualifiedCleaningCompany/requestRejected";
   }
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<li class="dblock padr10 padb15   ">
						<a href="../PartnerCompany" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space" >Partner</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>
						<li class="dblock padr10 padb15   ">
						...
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
								...
								<li class="dblock padr10 padb15">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space" >Premium</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
						 					
						 	 <li class="dblock padrb10 padt5">
						<a href="../TXPSignup/requestRegistered" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space">TXP Sign up</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>			 
						  	 <li class="dblock padrb10 hidden">
						<a href="jobsPosted" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space">Posted jobs</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>  
					...
					<!-- Center content -->
						...
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc tall fsz55 xxs-fsz65 bold lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Premium</h1>
									</div>
									<div class="mart10 marb5 xxs-talc tall  xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Premium Qualified companies request</a></div>
									<div class="tab-header martb10 padb10 brdb2_ffde00 nobrdt nobrdl nobrdr tall">
                                            
                                            <a href="#" class="dinlblck mar5 padrl30  nobrd  bg_ffde00_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h black_txt_a white_txt_ah ffamily_avenir active">Request</a>
											<a href="#" class="dinlblck mar5 padrl10  bg_ffde00_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir " onclick="changeHeader1();">Approved</a>
                                             
                                              <a href="#" class="padrl30_a padrl10 fsz18 midgrey_txt lgn_hight_36 " onclick="changeHeader();"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>

                                        </div>
					 
							<?php 
															
															foreach($PremiumQualifiedDetail as $category => $value) 
								...
								<div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0  bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18  bold  black_txt">Premium Qualified</span>
																	  ...
																	  <span class="edit-text  fsz14  jain2 dblock  lgn_hight_18 "><?php echo substr($value['company_name'],0,17); ?></span>  
																	</div>
																	
																		<div class="fright wi_10 padl0 xs-wi_20  marl15 fsz40  xs-marl0 xxs-marr20  padb0 ">
														<a href="approvePremiumQualified/<?php echo $value['enc']; ?>"><span class="fas fa-check-circle green_txt" aria-hidden="true"></span></a>
													</div>
																			<div class="fright wi_10 padl0 xs-wi_20  marl15 fsz40  xs-marl0 xxs-marr20  padb0 ">
														<a href="rejectPremiumQualified/<?php echo $value['enc']; ?>"><span class="fas fa-times-circle red_txt" aria-hidden="true"></span></a>
													</div>	 
										...
										function add_more_rows_unsent(link) {
																...
																$.ajax({
																type:"POST",
																url:"morePremiumQualifiedCleaningCompany",
																data:send_data,
																dataType:"text",
