				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="addProfessionalCategory" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
								...
								<div id="profile1" class=" " style="display:block;">	
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												?> 
												<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" ><?php echo html_entity_decode($value['marketplace_domain_type']); ?></option>
												<?php } ?>
												</select>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<option value="1" class="lgtgrey2_bg" >Template with images</option>
												<option value="2" class="lgtgrey2_bg" >Template without images</option>
