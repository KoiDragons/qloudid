	  ...
	  function submitform()
		{
			 ...
			 if($("#category_name").val()==null || $("#category_name").val()=="")
			{
				...
				$("#errorMsg1").html('Please enter category name ');
				return false;
			}
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../categoryList" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
		 	...
		 	<div class="column_m header hei_60p bs_bb lgtgrey2_bg visible-xs">
				...
				<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../categoryList" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left txt_c12219" aria-hidden="true"></i></a>
                     </li>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40   "  >
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Please inform us about your service category</a></div>
					 ...
					 <div class="clear"></div>
									  ...
									  <form action="../updateProfessionalCategory/<?php echo $data['catg_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" class="checkout__item js-tabs-item">
									 	<div class="marrl0 padb15 brdb fsz16 white_bg tall padt35">
								<a href="#profile1" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active" style="background-color: #c12219 !important; "><span class="changedText">Category detail</span>
								...
								<div id="profile1" class=" " style="display:block;">	
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Category name</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">What is the name of new service category?</span> 
													 </div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Domain name</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Which domain category belongs to?</span> 
													 </div>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<select name="available_at_domain" id="available_at_domain" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " fdprocessedid="lyd8d"> 
												<?php 
												foreach($professionalMarketplaceDomainDetail as $category => $value) 
												{
													
													
												?> 
												<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($value['id']==$professionalMarketplaceSelectedCategory['available_at_domain']) echo 'selected'; ?>><?php echo html_entity_decode($value['marketplace_domain_type']); ?></option>
												<?php } ?>
												</select>
											 <label for="available_at_domain" class="floating__label tall nobold padl10  " data-content="Domain name">
											<span class="hidden--visually ">
											  First name</span></label>
											</div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Design</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Which design category services belongs to?</span> 
													 </div>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<select name="design_template" id="design_template" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " fdprocessedid="lyd8d"> 
												 
												<option value="1" class="lgtgrey2_bg" <?php if($professionalMarketplaceSelectedCategory['design_template']==1) echo 'selected'; ?>>Template with images</option>
												<option value="2" class="lgtgrey2_bg" <?php if($professionalMarketplaceSelectedCategory['design_template']==2) echo 'selected'; ?>>Template without images</option>
												 
												</select>
											 <label for="design_template" class="floating__label tall nobold padl10  " data-content="Design template">
											<span class="hidden--visually ">
											  First name</span></label>
											</div>
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Available</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">If category belong to properties?</span> 
													 </div>
									 ...
									 <div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<select name="is_property_category" id="is_property_category" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " fdprocessedid="lyd8d"> 
												 
												<option value="1" class="lgtgrey2_bg" <?php if($professionalMarketplaceSelectedCategory['is_property_category']==1) echo 'selected'; ?>>Yes</option>
												<option value="2" class="lgtgrey2_bg" <?php if($professionalMarketplaceSelectedCategory['is_property_category']==2) echo 'selected'; ?>>No</option>
												 
												</select>
											 <label for="is_property_category" class="floating__label tall nobold padl10  " data-content="Property category">
											<span class="hidden--visually ">
											  First name</span></label>
											</div>
									...
									<div class="clear"></div>
									 	<?php 
											$i='';	foreach($professionalServiceCategoryLocation as $category => $value) 
												{
