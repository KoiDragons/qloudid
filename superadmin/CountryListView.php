	...
	<head>
		...
		<script>
			function updateVisible(id,link)
			{
				...
				$.ajax({
					url: 'CountryList/updateVisibleStatus',
					type: 'POST',
					//dataType: 'text/xml',
					data: send_data
					//async:false
									...
									<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75">
										...
										<div class="padl10">
											<div class="sidebar_prdt_bx marr20 brdb_b padb20">
												...
												<div class="pad20 wi_100 xs-wi_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz95 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey2_bg black_txt" style="
													...
													" id="aa_1227620">A</div><a href="#" class="black_txt fsz45 xs-fsz30 sm-fsz30 ">
														<!-- Meta -->
														<div class="padtr10 fsz15"> <span>Appmarket</span>  </div>
													</a></div>
											</div>		
											<div class="clear"></div>
										</div>
											...
											<a href="#" class="hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												...
												<span class="valm trn">Country</span>
								...
								<div class="padb20 xxs-padb0 ">
									...
									<div class="wrap maxwi_100 dflex alit_fe justc_sb pos_rel padb10 brdb_new">
										<div class="white_bg tall">
											...
											<!-- Logo -->
											<h1 class="fsz25 bold">Appmarket by country</h1>
											<!-- Logo -->
											<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text jain_drop_company">View and adminstrate appmarket for each country </a></div>
											<!-- Meta -->
												...
												<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable">
													<thead class="fsz14">
														<tr class="lgtgrey2_bg hei_40p">
															...
															<th class="padl10 padr10  grey_txt nobold hidden-xs tall">Active</th>
													...
													<tbody id="total_data">
														<?php 
															...
															foreach($countryDetail as $category => $value) 
															...
															<tr class="style_base bg_fffbcc_a ">
																...
																<td class="pad10 brdb_new hidden-xs">
																	...
																	background-position: 50%;
																	border-radius: 10%;" id="<?php echo 'aa_'.$value['id']; ?>"> <?php echo substr($value['country_name'],0,1);  ?> </div> 
																</td>
																<td class="pad10 brdb_new">
																	<div class="wi_100">
																		<div class="dflex alit_c">
																			<h3 class="mar0 pad0 fsz16 xs-fsz16">
																				<a href="CountryList/appMarket/<?php echo $value['enc']; ?>" class=" dark_grey_txt txt_0070e0_sbh" data-id="<?php echo 'a_'.$value['id']; ?>" id="<?php echo 'a_'.$value['id']; ?>"><?php echo $value['country_name']; ?></a>
																			</h3>
														...
														<div class="padtb5">
															<div class="boolean-control boolean-control-small boolean-control-green fright <?php if($value['is_visible']==1) echo 'checked'; else echo ''; ?>" onclick="updateVisible(<?php echo $value['id']; ?>,this);" style=" pointer-events: <?php if($value['id']==201) echo 'none'; ?>;">
