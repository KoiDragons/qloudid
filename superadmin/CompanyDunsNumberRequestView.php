			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<li class="dblock padrb10 ">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space">Duns Number</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>	
											
						<li class="dblock padrb10 padt5">
						<a href="PartnerCompany" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space">Partner Company</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
						<li class="dblock padrb10 ">
						...
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						 ...
						 <li class="dblock padrb10">
						<a href="PremiumQualifiedCleaningCompany/requestReceived" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space">Premium</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li> 
						  <li class="dblock padrb10 hidden">
						<a href="PremiumQualifiedCleaningCompany/jobsPosted" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space">Posted jobs</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
											</ul>
					...
					<!-- Center content -->
					<div class="wi_500p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl20 xs-pad0 mart40 xs-mart20 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
							
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn nobold"  >Request</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn nobold" >This is a list of companies request received for DUNS Number verification.
</a></div>
										...
										<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
											   ...
											   <a href="CompanyDunsNumberRequest/approvedRequest" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Approved</a>
                                               <a href="CompanyDunsNumberRequest/rejectedRequest" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Rejected</a>
                                        </div>
										 
															
											<?php $i=0;
												
												foreach($developerDetail as $category => $value) 
												{
											 ...
											 <div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz14 bold  black_txt"><?php echo  substr(html_entity_decode($value['company_name']),0,18); ?></span>
																	
																	 <span class="edit-text  fsz18  jain2 dblock  lgn_hight_18 "><?php echo  $value['duns_number']; ?></span>  
																	</div>
																	
																	
																		<div class="fright wi_10 padl0 xs-wi_20  marl15 fsz40  xs-marl0 xxs-marr20  padb0 ">
														<a href="CompanyDunsNumberRequest/approveCompanyDunsNumberRequest/<?php echo $value['enc']; ?>"><span class="fas fa-check-circle green_txt" aria-hidden="true"></span></a>
													</div>
																			<div class="fright wi_10 padl0 xs-wi_20  marl15 fsz40  xs-marl0 xxs-marr20  padb0 ">
														<a href="CompanyDunsNumberRequest/rejectCompanyDunsNumberRequest/<?php echo $value['enc']; ?>"><span class="fas fa-times-circle red_txt" aria-hidden="true"></span></a>
													</div> 
												...
												<div  id="pendingUnsent">
										</div>	
										<div class="clear"></div>
														
														<div class="padtb20 talc <?php if($developerCount['num']<=5) echo 'hidden'; ?> ">
																<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width" onclick="add_more_rows_unsent(this);" value="1">View more</a>

															</div>				
									
										<script>
										
										function add_more_rows_unsent(link) {
																...
																$.ajax({
																type:"POST",
																url:"CompanyDunsNumberRequest/moreCompanyDunsNumberRequest",
																data:send_data,
																dataType:"text",
																contentType: "application/x-www-form-urlencoded;charset=utf-8",
																success: function(data1){
																html1=data1;
																var $tbody = $("#pendingUnsent"),
																html=html1;
