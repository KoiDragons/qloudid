...
<div class="column_m header xs-header bs_bb lgtgrey2_bg">
		...
		<div class="logo  marr15 wi_170p xs-wi_80p">
			...
			<div class="search padtb5 hidden-xs ">
			<form action="https://www.qloudid.com/superadmin/index.php/PrivateSearchResult" method="POST" id="save_indexingcs" name="save_indexingcs" accept-charset="ISO-8859-1">
      <div class="fleft">
