				...
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
								...
								<li class="dblock padr10 padb15">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space" >TXP Sign up</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
					...
					<!-- Center content -->
						...
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc tall fsz55 xxs-fsz65 bold lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Landlord sign ups
</h1>
									</div>
									<div class="mart10 marb5 xxs-talc tall  xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Here is a list on sign ups by landlords</a></div>
									<div class="tab-header martb10 padb10   brdb2_ffde00 nobrdt nobrdl nobrdr tall">
                                            
                                            
											 
                                             <a href="#" class="dinlblck mar5 padrl30  nobrd  bg_ffde00_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h black_txt_a white_txt_ah ffamily_avenir active">Sign up</a>
							...
							<?php 
															...
															foreach($TXPSignupDetail as $category => $value) 
								...
								<div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0  bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18  bold  black_txt"><?php echo substr($value['company_name'],0,17); ?></span>
																	
																	  <span class="edit-text  fsz14  jain2 dblock  lgn_hight_18 "><?php echo $value['created_date']; ?>/<?php echo substr($value['company_email'],0,9); ?></span>  
																	</div>
