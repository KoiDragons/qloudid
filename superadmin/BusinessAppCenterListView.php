...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select an app to add/update services for the app
</div>
...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Select app</h2> 
                  </div>
 

<?php 
foreach($BusinessAppCenterInformation as $category => $value) 
{
?> 
...
<div class="checkout__label changedText"><?php echo $value['app_name']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['num']; ?> Services available</div>
 
<div class="checkout__controls">
 
<a href="BusinessAppCenter/updateServices/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
