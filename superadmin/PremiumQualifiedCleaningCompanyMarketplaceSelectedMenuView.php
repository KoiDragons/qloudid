...
function changeDisplay1()
	   ...
	   function updateAvailableDomain(id)
	   {
		   var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateAvailableMenu/<?php echo $data['mid']; ?>",
							data:send_data,
							dataType:"text",
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  >Menus</h1>
									</div>
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Please select menu your marketplace support</a></div>
					 ...
					 <div class="clear"></div>
								...
								<a href="#profile1" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active" ><span class="changedText">Menus</span>
								...
								<div id="profile1" class=" " style="display:block;">	
										...
										<div class="container padt20 padb5 brdrad1 fsz14 dark_grey_txt padrl0">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Menu</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt changedText">Which menu your marketplace work/support with?</span> 
													 </div>
									...
									<div class="clear"></div>
									<?php 
												foreach($professionalMarketplaceSelectedMenu as $category => $value) 
												{
										...
										<div class="css-nj7s2c lgtgrey_bg" style="justify-content: left !important;"> 
											...
											<label for="oven" class="css-14q70q1 changedText"><?php echo html_entity_decode($value['marketplace_menu_name']); ?></label></div>
