...
<body class="white_bg" style="width:1320px;">
	...
	<div class="column_m container zi5" onclick="checkFlag();">
						...
						<div class="flex_1 marrl-10">
								...
								<form>
									...
									<div class="mart20 talc">
										<a href="#" class="add_more_rows " onclick="add_more_rows(this)">View more</a>
									</div>
								</form>
					...
					<div class="wi_100 dflex">
						...
						<div class="flex_1 marrl-10">
								...
								<form>
									...
									<div class="mart20 talc">
										<a href="#" class="add_more_rows " value="1" onclick="add_more_rows(this)">View more</a>
									</div>
								</form>
		...
		$.ajax({
            type:"POST",
            url:"CompanySearchResult/companyListNew",
            data:send_data,
            dataType:"text",
