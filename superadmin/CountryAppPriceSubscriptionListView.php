               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../CountryList/productInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left header_arrow_blue_1e96c3" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10  xs-white_bg">
					...
					<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu  fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="../../../CountryList/productInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
								</li>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart0 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brd_width_2 brd_fcaf17 tb_67cff7_bg  nobrdt nobrdl nobrdr black_txt  padb10"> <span class="valm trn" style="letter-spacing: 2px;">Subscription</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
												<li class="dblock padrb10   last">
							...
							<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 t_67cff7_bg     brdrad0" onclick="checkFlag();">
								...
								<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
										...
										<div class="padb0 xxs-padb0 ">		
																...
																<h1 class="marb0  xxs-talc talc fsz50 xs-fsz35 xs-bold  padb10 white_txt trn ffamily_avenir">Price</h1>
																</div>
																<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="white_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Here is a list of price detail available for app</a></div>
																</div>
								...
								<div class="column_m   talc lgn_hight_22 fsz16 lgtgrey_bg  ">
													<div class="wrap maxwi_100 xs-padr25 xs-padl10   lgtgrey_bg    tall  ">
													   <div class="wi_auto  hei_65p maxwi_100   pos_rel zi5 marrla    brdrad5  padrl30">
														  <div class="martb15  xxs-talc talc ffamily_avenir"> <a href="../../productSubscriptionInfo/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" class="black_txt fsz18 xs-fsz16  xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Add price</a></div>
													   </div>
													</div>
												 </div>
									 ...
									 <div class="tab-header mart35  padb10 xs-talc  talc  brd_fcaf17 tb_67cff7_bg  nobrdt nobrdl nobrdr ">
                                              <a href="#" class="dinlblck mar5 padrl10 padrl30_a nobrd   t_67cff7_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir active" >Subscriptions</a>
									...
									<div class="tab_content active" id="utab_Popular" style="display: block;">
											...
											<?php $i=0;
												...
												foreach($priceDetail as $category => $value) 
												{
													
													
												?> 
											
												 <a href="../../updateSubscription/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>/<?php echo $value['enc']; ?>"><div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	background-position: 50%;
																	border-radius: 10%;"><?php echo substr(html_entity_decode($value['app_price']),0,1); ?></div>
																	</div>
																	
																	<div class="fleft wi_70 xxs-wi_75   xs-mar0 ">
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz14 bold  black_txt"><?php if($value['billing_type']==1) { echo 'One time'; } else { echo 'Recuring: '; if($value['billing_period']==1) echo 'Daily'; else if($value['billing_period']==2) echo 'Weekly'; else if($value['billing_period']==3) echo 'Monthly';  else if($value['billing_period']==4) echo 'Every 3 month'; else if($value['billing_period']==5) echo 'Every 6 month'; else if($value['billing_period']==6) echo 'Yearly'; } ?></span>
																	
																	 <span class="edit-text  fsz18  jain2 dblock  lgn_hight_18 ">Plan price(<?php echo $value['currency']; ?>): <?php echo $value['app_price']; ?></span>  
																	</div>
										...
										<div class="clear"></div>
										<div class="padt20 padb10 talc <?php if($freeDependentDetailCount['num']<=5) echo 'hidden'; ?>">
										...
										$.ajax({
											type:"POST",
											url:"../../moreFreeDependentDetail/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>",
											data:send_data,
											dataType:"text",
