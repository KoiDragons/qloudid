							...
							<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 t_67cff7_bg     brdrad0" onclick="checkFlag();">
								...
								<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
										...
										<div class="padb0 xxs-padb0 ">		
																...
																<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="white_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">Here is a list of free & paid companies</a></div>
																</div>
								...
								<div class="column_m   talc lgn_hight_22 fsz16 lgtgrey_bg  ">
									 ...
									 <div class="tab-header mart35  padb10 xs-talc  talc  brd_fcaf17 tb_67cff7_bg  nobrdt nobrdl nobrdr ">
                                              <a href="#" class="dinlblck mar5 padrl10 padrl30_a nobrd   t_67cff7_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir active" >Free users</a>
                                            <a href="../../paidAppsAccount/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>" class="dinlblck mar5 padrl10  padrl30_a    t_67cff7_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir"  >Paid</a>
									...
									<div class="tab_content active" id="utab_Popular" style="display: block;">
											...
											<?php $i=0;
												...
												foreach($companyAppsDetail as $category => $value) 
												{
										...
										<div class="clear"></div>
										<div class="padt20 padb10 talc <?php if($companyAppsDetailCount['num']<=5) echo 'hidden'; ?>">
										...
										$.ajax({
											type:"POST",
											url:"../../moreCompanyAppsDetail/<?php echo $data['cid']; ?>/<?php echo $data['appid']; ?>",
											data:send_data,
											dataType:"text",
