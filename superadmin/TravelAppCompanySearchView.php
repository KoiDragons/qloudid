				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc xs-padb15  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn nobold" > Search and connect with  <?php echo $countryInfo['country_name']."'s ".$emergencyDetail['emergency_name']; ?>.</a></div>	
							
								 
					 
						<form action="../../searchCompany/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" method="POST" id="save_indexingcs" name="save_indexingcs" accept-charset="ISO-8859-1">
							...
							<div class="padtb20 talc  <?php if(isset($_POST['message'])) { if($companyListSearchCount['num']<20) echo 'hidden'; } else echo 'hidden'; ?>">
					...
					function add_more_rows(link,id) {
								...
								$.ajax({
									type:"POST",
									url:"../../companyListNew/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>",
									data:send_data,
									dataType:"text",
