<html><head>
	<meta charset="utf-8">
		...
		<link href="../../../../../html/kincss/css/style.css" rel="stylesheet">
...
function changeDisplay1()
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../listEmployers/<?php echo $data['domain_id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
		 	...
		 	<div class="column_m header hei_60p bs_bb lgtgrey2_bg visible-xs">
				...
				<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../listEmployers/<?php echo $data['domain_id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left txt_c12219" aria-hidden="true"></i></a>
                     </li>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40" id="loginBank">
				<div class="wrap maxwi_100 padrl15 xs-padrl25">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Select a profile you want to update for your company</a></div>
					 ...
					 <div class="clear"></div>
									 ...
									 <a href="https://www.qloudid.com/public/index.php/UserCompanySignUp/updateServiceInformation/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">	
 ...
 <div class="clear"></div>
											<a href="https://www.qloudid.com/public/index.php/UserCompanySignUp/listSelectedCategories/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
								  ...
								  <div class="clear"></div>
											...
											<a href="https://www.qloudid.com/public/index.php/UserCompanySignUp/languageList/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">	<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
								  ...
								  <div class="clear"></div>
											...
											<a href="https://www.qloudid.com/public/index.php/UserCompanySignUp/updateAreaInformation/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">	<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
											...
											<a href="https://www.qloudid.com/public/index.php/UserCompanySignUp/addBookingRules/<?php echo $data['cid']; ?>/<?php echo $employeeDetail['enc']; ?>/<?php echo $data['domain_id']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
									...
									<div class="clear"></div>
												<a href="../../serviceRequestReceived/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
										...
										<a href="../../serviceRequestBidApproved/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
											...
											<a href="../../peopleForhire/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>">	
											<div class="column_m container  marb5 mart5   fsz14 dark_grey_txt">
												<div class="lgtgrey_bg  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
	...
	<script type="text/javascript" src="../../../../../html/usercontent/js/jquery.translate.js"></script>
	<script type="text/javascript" src="../../../../../html/usercontent/js/tinymce/tinymce.min.js"></script>
