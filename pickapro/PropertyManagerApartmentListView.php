<html><head>
	<meta charset="utf-8">
		...
		<!--<script type="text/javascript" src="<?php echo $path;?>html/usercontent/js/translateCombine.js"></script>-->
		 ...
		 {
			 window.location.href ="https://www.qloudid.com/company/index.php/VitechProperties/propertyInformation/<?php echo $data['cid']; ?>";
		 }
		 </script>
					...
					<div class="padb0 xxs-padb0 ">		
					 ...
					 <div class="column_m container fsz14 dark_grey_txt brdb marb5">
								...
								foreach($propertyList as $category => $value) 
												{
												?> 
								<a href="javascript:void(0);"> <div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
