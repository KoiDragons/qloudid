...
<link rel="stylesheet" media="all" href="<?php echo $path; ?>html/fleet/css/app.min.css">
	<script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script type="text/javascript" src="<?php echo $path; ?>html/usercontent/js/jquery.js"></script>
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class=" header__item_language js-header-item " style="border-left: 0px solid !important;">
			 ...
			 <a href='https://www.pickapro.net/vacantposition.html' class="header__item "> <div class=" header__item_language js-header-item " style="border-left: 0px solid !important;">
              <button class="header__head js-header-head fsz16 hidden-xs changedText">
                  Vacant position 
              </button>
              
            </div></a>
			<a href='https://www.pickapro.net/becomeprosupplier.html' class="  "> <div class=" header__item_language js-header-item " style="border-left: 0px solid !important;">
              <button class="header__head js-header-head fsz16 hidden-xs changedText">
                 Become a supplier
              </button>
...
<a class="button button-stroke button-small header__button    fsz16 visible-xs  changedText" href="https://www.pickapro.net/vacantposition.html" style="border:2px solid #333;  ">Vacant position</a>
          
			<a class="button button-stroke button-small header__button fsz16 xxs-mart10 visible-xs  changedText" href="https://www.pickapro.net/becomeprosupplier.html" style=" border:2px solid #333; margin-top:10px !important;">Become a supplier</a>
			<a class="button button-stroke button-small header__button fsz16 xxs-mart10 changedText" href="#" style=" border:2px solid #333; margin-top:10px !important;">Login</a>
...
<button class="header__head js-header-head" style="color:#000000; font-size:20px;">This is a demo for how to login using Qloud ID
	...
	<div class="outer__inner">
	 <form action="../loginAppAccount/<?php echo $data['domain_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
...
<div class="main__info info margin-bottom16 lgtgrey_txt">Then type your security code for verification.</div>
</div>
</div>
</div>
</div>
<div class="section description mart80 xxs-mart40  xs-padb0" style="" id="loginBank">
...
<button class="button-stroke button-small description__button" style="display: none;">Show more</button>
		...
		<div class="receipt xs-margin0 marl60 maxwi_100 wi_375p xs-pad20" style="border: 1px solid #f5f5f5;
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=<?php echo $verifyIP; ?>" class="white_brd brdrad5" style="width: 150px;height: 150px;"></div>
</div>

</div>
<div class="receipt__foot">
<div class="receipt__free" style="margin-bottom: 5px;font-size: 25px;color: black;">
                  Scan QR code</div>
...
<div class="receipt__free" style="font-size: 15px;">
				...
				<a class="button receipt__button    hidden" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro1_xxxx" ><span>Shop online</span>
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro1_xxxx" id="android">
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="QloudidUrl://<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro1_xxxx" id="iOS">
<div class="receipt__description talc marrla " style="
    background: #101010;
    border-radius: 50px;
    width: 230px;
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button hidden" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/<?php echo $data['domain_id']; ?>/pickapro1_xxxx" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
...
<div class="section faq hidden" id="loginBankFaq">
