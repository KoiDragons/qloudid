...
<button class="header__head js-header-head" style="color:#000000; font-size:20px;">This is a demo for how to login using Qloud ID
	...
	<div class="outer__inner">
	 <form action="../loginAppAccount" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
			<input type="hidden" name="domain_id" id="domain_id" value="<?php echo  $data['domain_id']; ?>" />
...
<button class="button-stroke button-small description__button" style="display: none;">Show more</button>
		...
		<div class="receipt xs-margin0 marl60 xxs-wi_325p wi_375p xs-pad20" style="border: 1px solid #f5f5f5;
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/pickapro" id="android">
...
<a class="hidden visible-xs " style="text-decoration:none !important;" href="QloudidUrl://<?php echo $verifyIP; ?>" id="iOS">
<div class="receipt__description talc marrla " style="
    background: #101010;
    border-radius: 50px;
    width: 230px;
...
<use xlink:href="#icon-bag"></use>
				...
				<a class="button receipt__button hidden" href="https://qloudid.com/ip/<?php echo $verifyIP; ?>/pickapro" id="android"><span>Shop online</span>
<svg class="icon icon-bag">
<use xlink:href="#icon-bag"></use>
</svg></a>
