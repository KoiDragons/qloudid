...
<a class="header__logo xs-fsz20 changedText " href="../selectMethod/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select and upload the CSV file containing your employees data.</div>
...
<div class="checkout__box">
 ...
 <div class="upload__item">
                      <div class="upload__category" style="margin-bottom: 24px;">Upload csv</div>
