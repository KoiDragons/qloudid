<head>
	...
	function addType3(id)
	{
		...
		function submitform()
		{
			var total_pic=parseInt($('#total_pic').val())+parseInt($('#indexing_save').val());
			...
			if($("#room_name").val()==null || $("#room_name").val()=="")
			{
			 ...
			 if(isNaN($("#room_name").val()))
			{
				
				$("#errorMsg1").html('Please enter  numeric value for room name');
				return false;
			}
			...
			if($("#room_type_price").val()=='' ||  $("#room_type_price").val()==null )
			{
				
				$("#errorMsg1").html('Please enter room price');
				return false;
			}
			if(isNaN($("#room_type_price").val()))
			{
				
				$("#errorMsg1").html('Please enter numeric value for room price');
				return false;
			}
			if($("#room_type_number").val()=='' ||  $("#room_type_number").val()==null )
			{
				
				$("#errorMsg1").html('Please enter total number of rooms');
				return false;
			}
			if(isNaN($("#room_type_number").val()))
			{
				
				$("#errorMsg1").html('Please enter numeric value for total number of rooms');
				return false;
			}
			if($("#room_class").val()==0 )
			{
...
if($("#room_size").val()=='' || $("#room_size").val()==null )
			...
			if($("#general_amenities").val()=='' ||  $("#general_amenities").val()==null )
			{
				
				$("#errorMsg1").html('Please select atleast one general amenities');
				return false;
			}	
			if($("#connectivity_amenities").val()=='' ||  $("#connectivity_amenities").val()==null )
			{
				
				$("#errorMsg1").html('Please select atleast one connectivity amenities');
				return false;
			}	
			
			if($("#bathroom_amenities").val()=='' ||  $("#bathroom_amenities").val()==null )
			{
				
				$("#errorMsg1").html('Please select atleast one bathroom amenities');
				return false;
			}	
			
			if($("#kitchen_amenities").val()=='' ||  $("#kitchen_amenities").val()==null )
			{
				
				$("#errorMsg1").html('Please select atleast one kitchen amenities');
				return false;
			}	
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.safeqloud.com/company/index.php/HotelStay/roomsTypeList/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
	...
	$('#more_data').append(mData);
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
					 ...
					 <div class="clear"></div>
							...
							<form action="../../../editRoomTypeDetail/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div id="more_data"></div>
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_name" id="room_name" placeholder="Room name" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $roomTypeDetail['room_type_name']; ?>" /> 
											...
											<div class="pos_rel">
											 ...
											 <option value="0">Room type</option> 
													<?php  foreach($hotelRoomType as $category => $value) 
														...
														<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($value['id']==$roomTypeDetail['room_type']) echo 'selected'; ?>><?php echo $value['room_type']; ?></option>
													<?php 	}	?>
											</select>
								 ...
								 <div class="on_clmn mart20  ">
											...
											<div class="pos_rel">
												...
												<select name="is_available" id="is_available"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl brdb_red_ff2828  fsz18  minhei_65p xxs-minhei_60p trans_bg dropdown-bg red_f5a0a5_txt tall padl0 ffamily_avenir" style="text-align-last:center;"> 
														...
														<option value="1" class="lgtgrey2_bg" <?php if($roomTypeDetail['is_available']==1) echo 'selected';  ?>>Available</option>
														<option value="2" class="lgtgrey2_bg" <?php if($roomTypeDetail['is_available']==2) echo 'selected';  ?>>Unavailable</option>
								 ...
								 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_type_price" id="room_type_price" placeholder="Room price" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $roomTypeDetail['room_price']; ?>"/> 
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_type_number" id="room_type_number" placeholder="Number of rooms" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $roomTypeDetail['number_of_rooms']; ?>"/> 
								 ...
								 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<select name="room_class" id="room_class"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl brdb_red_ff2828  fsz18  minhei_65p xxs-minhei_60p trans_bg dropdown-bg red_f5a0a5_txt tall padl0 ffamily_avenir" style="text-align-last:center;"> 
											 <option value="0">Room class</option> 
													<?php  foreach($hotelRoomClass as $category => $value) 
														...
														<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($value['id']==$roomTypeDetail['room_class']) echo 'selected'; ?>><?php echo $value['hotel_room_class']; ?></option>
													<?php 	}	?>
											</select>
								 ...
								 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="text" name="hierarchy" id="hierarchy" placeholder="Hierarchy" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $roomTypeDetail['hierarchy']; ?>"/> 
								...
								<div class="thr_clmn  wi_30 padr10">
											<div class="pos_rel">
											 ...
											 <option value="0">Unit</option> 
														...
														<option value="Square meters" class="lgtgrey2_bg" <?php if('Square meters'==$roomTypeDetail['size_unit']) echo 'selected'; ?>>Square meters</option>
													 <option value="Square feet" class="lgtgrey2_bg" <?php if('Square feet'==$roomTypeDetail['size_unit']) echo 'selected'; ?>>Square feet</option>
											</select>
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_size" id="room_size" placeholder="Room size" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $roomTypeDetail['room_size']; ?>" /> 
			...
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['general_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd <?php if($value['is_selected']==0) echo 'red_ff2828_bg'; else echo 'green_bg'; ?> fsz18 white_txt curp" onclick="addType(<?php echo $value['id']; ?>);" id="<?php echo $value['id']; ?>">
												...
												<input type="hidden" id="general_amenities" name="general_amenities" value="<?php echo $roomTypeDetail['general_amenities_available']; ?>" />
										  <div class="on_clmn  mart20  brdb">	
									<div class="thr_clmn  wi_75 ">
										...
										<input type="hidden" id="connectivity_amenities" name="connectivity_amenities" value="<?php echo $roomTypeDetail['connectivity_amenities_available']; ?>" />
										<div class="dflex fxwrap_w alit_s padt0 talc padrl5 mart10">
			...
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['connectivity_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd <?php if($value['is_selected']==0) echo 'red_ff2828_bg'; else echo 'green_bg'; ?> fsz18 white_txt curp" onclick="addType1(<?php echo $value['id']; ?>);" id="c<?php echo $value['id']; ?>">
									...
									<div class="thr_clmn  wi_75 ">
										...
										<input type="hidden" id="bathroom_amenities" name="bathroom_amenities" value="<?php echo $roomTypeDetail['bathroom_amenities_available']; ?>" />
												<div class="dflex fxwrap_w alit_s padt0 talc padrl5 mart10">
			...
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['bathroom_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd <?php if($value['is_selected']==0) echo 'red_ff2828_bg'; else echo 'green_bg'; ?> fsz18 white_txt curp" onclick="addType2(<?php echo $value['id']; ?>);" id="b<?php echo $value['id']; ?>">
									...
									<div class="thr_clmn  wi_75 ">
										...
										<input type="hidden" id="kitchen_amenities" name="kitchen_amenities" value="<?php echo $roomTypeDetail['kitchen_amenities_available']; ?>" />
												<div class="dflex fxwrap_w alit_s padt0 talc padrl5 mart10">
			...
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['kitchen_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd <?php if($value['is_selected']==0) echo 'red_ff2828_bg'; else echo 'green_bg'; ?> fsz18 white_txt curp" onclick="addType3(<?php echo $value['id']; ?>);" id="k<?php echo $value['id']; ?>">
										 ...
										 <input type="hidden" id="indexing_save" name="indexing_save" value="0" />
										  ...
										  <input type="hidden" id="total_pic" name="total_pic" value="<?php echo $roomTypeDetailImagesCount['num']; ?>" />
								<div class="red_txt fsz20 talc" id="errorMsg1"> </div>
								
							</form>
							
						 	 
							 <div class="on_clmn mart10 xxs-mart10 marb30 marrl30 xs-marrl0" >
