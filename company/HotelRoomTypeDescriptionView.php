<head>
	...
	function addType3(id)
	{
		...
		function submitform()
		{
			...
			$("#errorMsg1").html('');
			if($('#indexing_save').val()<5)
			{
			$("#errorMsg1").html('Please add minimum 5 images');
			return false;	
			}
...
function moreImages()
{
	...
	$('#more_data').append(mData);
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
					 ...
					 <div class="clear"></div>
							...
							<form action="../../addRoomTypeDetail/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div id="more_data"></div>
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_name" id="room_name" placeholder="Room name" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir"/> 
											...
											<div class="pos_rel">
											 ...
											 <option value="0">Room type</option> 
													<?php  foreach($hotelRoomType as $category => $value) 
														...
														<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" ><?php echo $value['room_type']; ?></option>
													<?php 	}	?>
											</select>
								 ...
								 <div class="on_clmn mart20  ">
											...
											<div class="pos_rel">
												...
												<select name="is_available" id="is_available"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl brdb_red_ff2828  fsz18  minhei_65p xxs-minhei_60p trans_bg dropdown-bg red_f5a0a5_txt tall padl0 ffamily_avenir" style="text-align-last:center;"> 
														...
														<option value="1" class="lgtgrey2_bg" >Available</option>
														<option value="2" class="lgtgrey2_bg" >Unavailable</option>
								 ...
								 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_type_price" id="room_type_price" placeholder="Room price" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir"/> 
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_type_number" id="room_type_number" placeholder="Number of rooms" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir"/> 
											...
											<div class="pos_rel">
											 ...
											 <option value="0">Room class</option> 
													<?php  foreach($hotelRoomClass as $category => $value) 
														...
														<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" ><?php echo $value['hotel_room_class']; ?></option>
													<?php 	}	?>
											</select>
								 ...
								 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="text" name="hierarchy" id="hierarchy" placeholder="Hierarchy" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir"/> 
								...
								<div class="thr_clmn  wi_30 padr10">
											<div class="pos_rel">
											 ...
											 <option value="0">Unit</option> 
														...
														<option value="Square meters" class="lgtgrey2_bg" >Square meters</option>
													 <option value="Square feet" class="lgtgrey2_bg" >Square feet</option>
											</select>
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_size" id="room_size" placeholder="Room size" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir"/> 
			...
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['general_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd red_ff2828_bg fsz18 white_txt curp" onclick="addType(<?php echo $value['id']; ?>);" id="<?php echo $value['id']; ?>">
			</div>
														<?php } ?>

			
												</div>	
												<input type="hidden" id="general_amenities" name="general_amenities" />
										  <div class="on_clmn  mart20  brdb">	
									<div class="thr_clmn  wi_75 ">
										...
										<input type="hidden" id="connectivity_amenities" name="connectivity_amenities" />
										<div class="dflex fxwrap_w alit_s padt0 talc padrl5 mart10">
										<?php  foreach($hotelConnectivityAmenities as $category => $value) 
														...
														?>
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['connectivity_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd red_ff2828_bg fsz18 white_txt curp" onclick="addType1(<?php echo $value['id']; ?>);" id="c<?php echo $value['id']; ?>">
			</div>
														<?php } ?>
									...
									<div class="thr_clmn  wi_75 ">
										...
										<input type="hidden" id="bathroom_amenities" name="bathroom_amenities" />
												<div class="dflex fxwrap_w alit_s padt0 talc padrl5 mart10">
										<?php  foreach($hotelBathroomAmenities as $category => $value) 
														...
														?>
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['bathroom_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd red_ff2828_bg fsz18 white_txt curp" onclick="addType2(<?php echo $value['id']; ?>);" id="b<?php echo $value['id']; ?>">
			</div>
														<?php } ?>
									...
									<div class="thr_clmn  wi_75 ">
										...
										<input type="hidden" id="kitchen_amenities" name="kitchen_amenities" />
												<div class="dflex fxwrap_w alit_s padt0 talc padrl5 mart10">
										<?php  foreach($hotelKitchenAmenities as $category => $value) 
														...
														?>
			<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
				<input type="button" value="<?php echo substr($value['kitchen_amenities'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd red_ff2828_bg fsz18 white_txt curp" onclick="addType3(<?php echo $value['id']; ?>);" id="k<?php echo $value['id']; ?>">
			</div>
														<?php } ?>
