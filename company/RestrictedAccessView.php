...
<html>
	...
	<div class="column_m   talc lgn_hight_22 fsz16 xs-marb0 xs-mart20  mart40  padb30">
				 ...
				 <span class="fas fa-minus-circle fsz256 red_txt"></span>
			</div>
									<h3 class="marb0  xxs-talc fsz35 xs-fsz25 bold padb5 black_txt talc ffamily_avenir"  >Only admins </h3>
									
									<div class="mart20 marb35  xxs-talc talc "> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc edit-text jain_drop_company black_txt talc ffamily_avenir" ><span class="trn">This page is restricted to company admins.</span>
												</a></div>

						<div class="padtb20 xxs-talc talc">
								
								<a href="../sendAdminRequest/<?php echo $data['cid']; ?>"><button type="button"  class="padrl20 forword hei_55p fsz18 trn t_67cff7_bg  ffamily_avenir">I am company admin</button></a>
		...
		<div class="popup_modal wi_350p maxwi_90 pos_fix pos_cen zi50 bs_bb white_bg fsz14 brdrad5 <?php if(isset($_GET['sent'])) echo 'active'; ?> " id="gratis_alert1" style="display:<?php if(isset($_GET['sent'])) echo 'block'; else echo 'none'; ?>">
		<div class="modal-content pad25  nobrdb talc brdrad5 ">
			
			
			
			<h2 class="marb10 pad0 bold fsz24 black_txt">Request Sent</h2>
