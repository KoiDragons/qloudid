...
<script>
		...
		function checkEmail(id) {
			...
			function submitform()
			{
				...
				if($("#email").val()=='')
				{
				$("#errorMsg1").html('Please enter work email');	
				return false;
				}
				...
				$("#errorMsg1").html("please select card for the employee");
					return false;	
				}	
				}
				...
				$("#errorMsg1").html("please enter correct work email format");
					return false;
				}	
				}
				var send_data={};
				...
				$.ajax({
					...
					success: function(data1){
						...
						$("#errorMsg1").html("Another user is already registered with given work email  !!!");
						return false;
						}
						else if(data1==2)
						{
						 
						$("#errorMsg1").html("Another user is already invited to become a employee with given work email  !!!");
						return false;
						}
						else if(data1==3)
						{
						 
						$("#errorMsg1").html("Another employee is already assigned given work email  !!!");
						return false;
						}
						else
						{
...
<div class="outer" >
<!-- header-->
<?php if($employeeVerificationInfo['num']==0) { if($isVerificator==1) {   ?>
...
<div class="setting__menu"><a class="setting__link js-tabs-link active" href="#">
				...
				<a class="setting__link js-tabs-link" href="../../employeePersonalAccount/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>">
                <svg class="icon icon-lock">
                  <use xlink:href="#icon-lock"></use>
                </svg>Personal details</a><a class="setting__link js-tabs-link" href="../../employeeServiceAccount/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>">
...
<div class="setting__container"  >
 <div class="setting__head">
                    <h2 class="setting__title h2">Work details</h2> <a class="button-stroke button-small setting__button" href="#">Employee list</a>
                  </div>
				  
				 <div class="upload__item" style="margin-bottom:0px;">
                      <div class="upload__category" style="margin-bottom:0px;">Digital ID</div>
                      <div class="upload__note">This box represent the digital ID</div>
...
<div class="checkout__list  " style="margin-top:16px;">
 <a class="card card_row  " style="border:none;  margin-bottom: 20px;" href="jaavscript:void(0);">
	  <div class="card__preview" style="width: 161px;padding: 30px; background: #23262F;"><img srcset="<?php echo '../../'.$imgs; ?>" src="<?php echo '../../'.$imgs; ?>" alt="London - Kings Cross" style="
												padding: 20px;
												border-radius: 30px;
											">
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $resultOrg['name']; ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo html_entity_decode($resultOrg1['address']); ?> <?php echo html_entity_decode($resultOrg1['port_number']); ?> ,<?php echo html_entity_decode($resultOrg1['country']); ?>,<?php echo html_entity_decode($resultOrg1['zipcode']); ?>
</div>
...
">
                <div class="description__parameter" style="margin-right:16px;">
                  ...
                  </svg>+<?php echo html_entity_decode($resultOrg1['country_code']); ?><?php echo html_entity_decode($resultOrg1['phone_number']); ?></div>
                <div class="description__parameter" style="margin-left:0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo html_entity_decode($resultOrg1['email']); ?></div>
                 
              </div></div></a>
<div class="checkout__section xsi-nobrdt padt32 xsi-padt0" style="margin-top:10px;   padding-bottom:136px; ">
<form action="../../updateEmployeeInformation/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>/<?php echo $workInfo['enc']; ?>" method="POST" id="save_indexing1" name="save_indexing1" accept-charset="ISO-8859-1">
 
<div class="checkout__fieldset">


<div class="upload__row">
                          <div class="upload__col upload__col_w33">
                            <div class="field">
<div class="field__label changedText" style="color:#787f91;">Employee ID</div>
<div class="field__wrap">
<input class="field__input" name="e_number" id="e_number" value="<?php echo $workInfo['e_number']; ?>"   type="text"   style=" color:grey;">
</div>
</div>
                          </div>
                          <div class="upload__col upload__col_w33">
                           <div class="field">
<div class="field__label changedText" style="color:#787f91;">Department</div>
<div class="field__wrap">
 
<select  class="   "  name="department" id="department" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52"  >
				 
                         	<?php foreach($addedDepartments as $category => $value ) {
										?>
										<option value="<?php echo $value['id']; ?>" <?php if($workInfo['department']==$value['id']) echo 'selected'; ?>><?php echo $value['department_name']; ?></option>
										<?php } ?>
                          ...
                          <div class="upload__col upload__col_w33">
                            <div class="field">
<div class="field__label changedText" style="color:#787f91;">Location</div>
<div class="field__wrap">
 
<select  class="   "  name="location_id" id="location_id" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52" onchange="changeDepartment(this.value)">
				 
                         	<?php foreach($locationDetail as $category => $value ) {
										?>
										<option value="<?php echo $value['id']; ?>" <?php if($data['lid']==$value['id']) echo 'selected'; ?>><?php echo $value['visiting_address']; ?></option>
										<?php } ?>
...
<div class="field  ">
<div class="field__label changedText" style="color:#787f91;">permission to make payment</div>
<div class="field__wrap">
 
<select    style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52" name="permission" id="permission" onchange="updateCard(this.value);">
				 
                         <option value="1" <?php if($workInfo['company_permission']==1) echo 'selected'; ?>>Yes</option>
										<option value="2" <?php if($workInfo['company_permission']==2) echo 'selected'; ?>>No</option>
...
<div class="field    <?php if($workInfo['company_permission']==1) echo ''; else echo 'hidden'; ?>"  id="selectCard">
<div class="field__label changedText" style="color:#787f91;">Card</div>
<div class="field__wrap">
 
<select    style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52" name="card_id" id="card_id"  >
				 <option value="0" >Select card</option>
                       <?php foreach($listCardDetails as $category => $value ) {
										?>
										<option value="<?php echo $value['id']; ?>" <?php if($workInfo['card_id']==$value['id']) echo 'selected'; ?>><?php echo $value['card_number']; ?></option>
										<?php } ?>
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52">
                         	...
                         	<?php foreach($userCountryList as $category => $value ) {
										?>
										<option value="<?php echo $value['country_name']; ?>" <?php if($workInfo['c_id']==$value['country_name']) echo 'selected'; ?>>+<?php echo $value['country_code']; ?></option>
										<?php } ?>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Work phone</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo $workInfo['phone']; ?>"    type="text"   style=" color:grey;"  >
</div>
</div>
...
<select  class="   "  name="d_country" id="d_country" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52">
                         	...
                         	<?php foreach($userCountryList as $category => $value ) {
										?>
										<option value="<?php echo $value['country_name']; ?>" <?php if($workInfo['d_country']==$value['country_name']) echo 'selected'; ?>>+<?php echo $value['country_code']; ?></option>
										<?php } ?>
...
<div class="upload__col upload__col_w70">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Work mobile</div>
<div class="field__wrap">
<input class="field__input"  name="mobile" id="mobile" value="<?php echo $workInfo['mobile']; ?>"    type="text"   style=" color:grey;"  >
</div>
</div>
</div>
...
<div class="field__label changedText" style="color:#787f91;">Work email</div>
<div class="field__wrap">
<input class="field__input" name="email" id="email" value="<?php echo $workInfo['email']; ?>"   type="text"   style=" color:grey;">
</div>
</div>
...
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="submitform();" >Update</a>
</form>

<?php if($relievingCount['num']==0) { if($data['user_id']!=43) { ?>			
<a class="button checkout__button changedText" href="../../terminationInfo/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" >Relieve</a>
<?php } } ?>
 </div>
</div>
</div>
