...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Simple steps to start sending beautiful proposals</div>
...
<div class="checkout__box">
 ...
 <div class="checkout__data  hidden">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText" style="font-size: 14px;">Step 1</div>
<div class="changedText" style="font-size: 18px;
    line-height: 1.5;
    font-weight: 500;">Add users</div>
 
<div class="checkout__controls">
 
<a href="https://www.safeqloud.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText" style="font-size: 14px;">Step 2</div>
<div class="changedText" style="font-size: 18px;
    line-height: 1.5;
    font-weight: 500;">Add properties</div>
 
<div class="checkout__controls">
 
<a href="https://www.safeqloud.com/company/index.php/VitechProperties/searchPropertyInformation/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
...
<use xlink:href="#icon-edit"></use>
 ...
 <div class="checkout__data  <?php if($contentDetail>0) echo 'hidden'; ?>">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText" style="font-size: 14px;">Step 1</div>
<div class="changedText" style="font-size: 18px;
    line-height: 1.5;
    font-weight: 500;">About your company</div>
 
<div class="checkout__controls">
 
<a href="https://www.safeqloud.com/company/index.php/VitechProperties/companyInformation/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
...
<use xlink:href="#icon-edit"></use>
 ...
 <div class="checkout__data <?php if($employeeSkillCount>0) echo 'hidden'; ?>">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText" style="font-size: 14px;">Step 2</div>
<div class="changedText" style="font-size: 18px;
    line-height: 1.5;
    font-weight: 500;">Invite users</div>
 
<div class="checkout__controls">
 
<a href="https://www.safeqloud.com/company/index.php/InviteEmployee/inviteEmployees/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText" style="font-size: 14px;">Step 3</div>
<div class="changedText" style="font-size: 18px;
    line-height: 1.5;
    font-weight: 500;">Your Employee access</div>
 
<div class="checkout__controls">
 
<a href="https://www.safeqloud.com/company/index.php/VitechProperties/selectAppAccess/<?php echo $data['cid']; ?>/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
