  ...
  <body class="dark" style="background: #131922">
    ...
    <div class="outer">
	  ...
	  <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg visible-xs" style="padding:0px;">
			...
			<a href="../listAddedProperties/<?php echo $data['cid']; ?>"> <div class=" talc   padt10 padb0 hei_45p black_txt" style="font-size:16px;">
					*** Create New Proposal ***
				</div></a>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			       ...
			       <a class="categories__item    " href="../../LandloardBroker/listSocietyProposal/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Turnkey Sale</div>
                                      </a>
			  ...
			  <div class="sorting__foot">
               ...
               <a href="../listAddedProperties/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button">
