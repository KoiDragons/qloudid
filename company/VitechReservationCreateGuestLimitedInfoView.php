...
<div class="travel__center center   padb136 xs-padrl25" style="border-bottom:2px solid #23262F;  max-width: 1132px;
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list xs-marb0 marb475" style="
            max-width: 425px;
            ">
...
<div class="changedText categories__subtitle  txt_f67f00 ">Phone</div>
  </a>
  
   <a class="categories__item  trans_bg " href="javascript:void(0);" onclick="faceUser();" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent;  border:none;">
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Face</div>
                                      </a>
									  </div>
</div>
</div>
...
<div class="checkout__category changedText">Personal email and phone only. No work details</div>
 ...
 <form class="checkout__item js-tabs-item" action="../../../addUserDetailForReservation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing1" name="save_indexing1" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="checkout__line  hidden" style="margin-bottom:0px; padding-top:20px; padding-bottom-10px; border:none;">
					   <div class="checkout__subtitle">Personal email and phone only. No work details</div>
                       
                      </div>
<div class="checkout__section xsi-nobrdt padt32 xsi-padt0" style="margin-top:10px;   padding-bottom:136px; border:none;">
<form class="checkout__item js-tabs-item" action="../../../addNewGuestAndSendBookingInfo/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<input class="field__input xs-fieldData" name="first_name" id="first_name"  placeholder="e. g. xyz"  type="text"   style=" color:grey;">
</div>
</div>
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Last name</div>
<div class="field__wrap">
<input class="field__input xs-fieldData"  name="last_name" id="last_name"    type="text" placeholder="e. g. xyz" style=" color:grey;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input xs-fieldData"  type="text" name="owner_email" id="owner_email"  placeholder="e. g. xyz@gmail.com"  style=" color:grey;">
</div>
</div>
<input type="hidden" name="uphno" id="uphno" value="<?php echo $_POST['uphno']; ?>"/>
<input type="hidden" name="country_id" id="country_id" value="<?php echo $_POST['country_id']; ?>"/>
