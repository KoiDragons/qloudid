...
<script>
		...
		function checkEmail(id) {
			...
			function submitform()
			{
				...
				$("#errorMsg1").html('');
				 if(parseInt($("#reservation_fee").val())>parseInt($("#total_paid").val()))
				{
				$("#errorMsg1").html('Paid amount can not be less then reservation fee required');	
				return false;
				}
...
<a class="header__logo xs-fsz25 changedText" href="../../guestReservationTimelineInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" style="
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
				...
				<a class="header__link" href="https://www.safeqloud.com/company/index.php/Company/companyAccount/<?php echo $data['cid']; ?>">
					...
					<a class="header__link" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyProfileServices/<?php echo $data['cid']; ?>">
...
<div class="outer__inner mart100" >
  <div class="section work xs-padrl25 marb80i xs-marb25i hidde hidden-xs" style=" ">
    ...
    padding-right: 0px;
    padding-left: 0px;
    border-bottom: 3px solid #282D34 !important;
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Approve or reject this reservation request
</div>
...
<div class=" "  >
 <div class="setting__head hidden">
                    <h2 class="setting__title h2">Reservation details</h2>  
                  </div>
				  
				 <div class="upload__item hidden" style="margin-bottom:0px;">
				 <div class="setting__stage"  >Before approval <?php if($guestReservationDetail['is_accepted']==1) echo date('Y-m-d',strtotime($guestReservationDetail['reservation_detail']['created_on'])); ?></div>
                      <div class="upload__category" style="margin-bottom:0px;">Apartment</div>
                      <div class="upload__note">This box represent the reserved apartment</div>
                      
                    </div>
<div class="checkout__list  " style="margin-top:16px;">
 <a class="card card_row  " style="border:none;  margin-bottom: 20px; border-radius:6px;" href="jaavscript:void(0);">
	  <div class="card__preview" style="width: 161px;padding: 30px; background: #23262F;"><img srcset="<?php echo $path.'estorecss/tmp'.$guestReservationDetail['imageId'].'.jpg'; ?>" src="<?php echo $path.'estorecss/tmp'.$guestReservationDetail['imageId'].'.jpg'; ?>" alt="London - Kings Cross" style="
												padding: 20px;
												border-radius: 50%;
											">
											 
											</div><div class="card__body pad24i xs-pad24" style="background: #23262F;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $guestReservationDetail['apartment_details']['bedroom_count']; ?> Bedrooms</div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;">Floor - <?php echo $guestReservationDetail['apartment_details']['floor_number']; ?> , Apartment - <?php echo $guestReservationDetail['apartment_details']['office_apartment_number']; ?>
</div>
...
<div class="description__parameters" style="
    ...
    margin-top: 0px;
">
                <div class="description__parameter" style="margin-right:16px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $guestReservationDetail['apartment_details']['apartment_size']; ?> M2</div>
                <div class="description__parameter" style="margin-left:0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>$<?php echo $guestReservationDetail['apartment_details']['sale_price']; ?></div>
...
<div class="checkout__section xsi-nobrdt padt32 xsi-padt0" style="margin-top:10px;   padding-bottom:136px; ">
<form action="../../updateReservationFeePayment/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" method="POST" id="save_indexing1" name="save_indexing1" accept-charset="ISO-8859-1">
 
<div class="checkout__fieldset">

 
 <div class="setting__box"  style=" background: #131922;
    padding: 24px;
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Buyer first name</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo $guestReservationDetail['user_details']['first_name']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Buyer last name</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo $guestReservationDetail['user_details']['last_name']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Country code</div>
<div class="field__wrap">
 
<select  class="   "  name="c_id" id="c_id" style="height: 48px;
    padding: 0 14px;
    border-color: #353945;
    color: grey;
    border-radius: 12px;
    ...
    border-radius: 0px;" fdprocessedid="8mc52" disabled>
				 
                         	<?php foreach($userCountryList as $category => $value ) {
										?>
										<option value="<?php echo $value['id']; ?>" <?php if($guestReservationDetail['user_details']['country_of_residence']==$value['id']) echo 'selected'; ?>>+<?php echo $value['country_code']; ?></option>
										<?php } ?>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Mobile</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo $guestReservationDetail['user_details']['phone_number']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<div class="field__label changedText" style="color:#787f91;">Email</div>
<div class="field__wrap">
<input class="field__input" name="email" id="email" value="<?php echo $guestReservationDetail['user_details']['email']; ?>"   type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
<?php if($guestReservationDetail['is_accepted']==1 && $guestReservationDetail['reservation_detail']['paid_method']==0) { ?>
<div class="setting__stage"  >After approval</div>
<div style=" background: #131922;
    padding: 24px;
    margin: 0px 0px 64px 0px;
    border-radius: 6px 6px 6px 6px;
    border: 1px solid #23262f;">
...
<div class="upload__col upload__col_w50">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Reservation fee</div>
<div class="field__wrap">
<input class="field__input"  name="reservation_fee" id="reservation_fee" value="<?php echo $guestReservationDetail['reservation_detail']['total_amount']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Finale payment on key receving</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo abs(($guestReservationDetail['apartment_details']['sale_price']*$guestReservationDetail['fee_detail']['possetion_time_fee'])/100); ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
</div>
...
<div class="upload__col upload__col_w50">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Reservation fee to paid before</div>
<div class="field__wrap">
<input class="field__input"  name="reservation_fee" id="reservation_fee" value="<?php echo $guestReservationDetail['fee_to_be_paid']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Total installment allowed</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo $guestReservationDetail['fee_detail']['total_installment_allowed']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
</div>
...
<div class="upload__col upload__col_w50">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Payment method</div>
<div class="field__wrap">
<select  class="   "  name="payment_method" id="payment_method" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52"  >
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Transection date</div>
<div class="field__wrap">
<input class="field__input"  name="transection_date" id="transection_date" value="<?php echo date('Y-m-d'); ?>"    type="date"   style=" color:grey;"  >
</div>
</div>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Total paid</div>
<div class="field__wrap">
<input class="field__input"  name="total_paid" id="total_paid" value="0"    type="number"   style=" color:grey;"  >
</div>
</div>
...
<div class="setting__stage"  >After approval <?php echo date('Y-m-d',strtotime($guestReservationDetail['reservation_detail']['modified_on'])); ?></div>
<div class="setting__box"  style=" background: #131922;
    padding: 24px;
    margin: 0px 0px 64px 0px;
    border-radius: 6px 6px 6px 6px;
...
<div class="setting__stage"  >Paid <?php echo date('Y-m-d',strtotime($guestReservationDetail['reservation_detail']['modified_on'])); ?></div>
<div style="background: #131922;
    padding: 24px;
    margin: 0px 0px 64px 0px;
    border-radius: 6px 6px 6px 6px;
...
<select  class="   "  name="payment_method" id="payment_method" style="height: 48px;
    ...
    border-radius: 0px;" fdprocessedid="8mc52"  disabled>
                         	...
                         	<option value="1" <?php if($guestReservationDetail['reservation_detail']['paid_method']==1) echo 'selected'; ?>>Cash</option>
							<option value="2" <?php if($guestReservationDetail['reservation_detail']['paid_method']==2) echo 'selected'; ?>>Card</option>
							<option value="3" <?php if($guestReservationDetail['reservation_detail']['paid_method']==3) echo 'selected'; ?>>Bank transfer</option>
...
<div class="field__label changedText" style="color:#787f91;">Transection date</div>
<div class="field__wrap">
<input class="field__input"  name="transection_date" id="transection_date" value="<?php echo date('Y-m-d',$guestReservationDetail['reservation_detail']['paid_on']); ?>"    type="date"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly>
</div>
</div>
</div>
</div>
...
<div class="field__label changedText" style="color:#787f91;">Total paid</div>
<div class="field__wrap">
<input class="field__input"  name="total_paid" id="total_paid" value="<?php echo $guestReservationDetail['reservation_detail']['amount_paid']; ?>"    type="number"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
<?php } ?>
...
<?php if($guestReservationDetail['is_accepted']==1 && $guestReservationDetail['reservation_detail']['paid_method']>0 && $guestReservationDetail['agreement_count']==0) { ?>
<a class="button checkout__button changedText" href="../../guestReservationAgreementInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>">Add agreement</a>
<?php } else if($guestReservationDetail['is_accepted']==1 && $guestReservationDetail['reservation_detail']['paid_method']>0 && $guestReservationDetail['agreement_count']>0) { ?>
<div class="setting__stage"  >Agreement <?php echo $guestReservationDetail['agreement_detail']['agreement_accept_on']; ?> </div>
<div style="background: #131922;
    padding: 24px;
    margin: 0px 0px 64px 0px;
    border-radius: 6px 6px 6px 6px;
	...
	<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Monthly fee</div>
<div class="field__wrap">
<input class="field__input"  name="monthly_fee" id="monthly_fee" value="<?php if($guestReservationDetail['agreement_detail']['monthly_fee_applicable']==0) echo 0; else echo $guestReservationDetail['agreement_detail']['monthly_fee']; ?>"    type="number"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly>
</div>
</div>
<div class="upload__row">
<div class="upload__col upload__col_w50">
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Payment terms</div>
<div class="field__wrap">
<input class="field__input"  name="monthly_fee" id="monthly_fee" value="<?php if($guestReservationDetail['agreement_detail']['full_payment']==1) echo 'Payment is to be paid in full in advance'; else echo 'Payment is to be paid in '.$guestReservationDetail['fee_detail']['total_installment_allowed'].' installments'; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly>
</div>
</div>
</div>
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Agreement to be accepted till</div>
<div class="field__wrap">
<input class="field__input"  name="transection_date" id="transection_date" value="<?php echo $guestReservationDetail['agreement_to_be_accepted']; ?>"    type="date"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly>
</div>
</div>
</div>
</div>
...
<?php if(count($guestReservationDetail['emi_payment_information'])>0) { ?>
<div class="setting__stage"  >Invoices </div>
<div style="background: #131922;
    padding: 24px;
    margin: 0px 0px 64px 0px;
    border-radius: 6px 6px 6px 6px;
    border: 1px solid #23262f;">
	<?php $i=1; foreach($guestReservationDetail['emi_payment_information'] as $category => $value ) {
										?>
 <div class="card card_row" style="margin-bottom:24px; border:none; ">
	 
					 
										 
                  <div class="card__body" style="background: #10161d;">
                    <div class="card__line" style="
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">Installment <?php echo $i; ?></div>
				   
				    <div class="description__parameters hidden-xxs" style="
					border-top:none;
    margin-bottom: 0px;
    margin-top: 0px;
    padding-bottom: 0px;
    padding-top: 0px;
">
                <div class="description__parameter" style="margin-left:26px; margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $value['payment_amount']; ?></div>
                <div class="description__parameter" style="margin-left:26px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php if($value['is_paid']==0) echo 'Invoice generated'; else if($value['is_paid']==1 && $value['fully_paid']==0) echo 'Partially paid'; else if($value['is_paid']==1 && $value['fully_paid']==1) echo 'Paid'; ?></div>
				  
				  <div class="description__parameter" style="margin-left:26px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo date('Y-m-d',$value['invoice_date']); ?></div>
...
{
	$('#errorMsg1').html('please add reservation conditions before confirming reservation request');
	return false;
}
</script>
...
<div class="checkout__fieldset">
  ...
  <?php if($guestReservationDetail['is_accepted']==0) { if($guestReservationDetail['fee_count']==0) { ?>
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="stopApprove();">Approve</a>
  <?php } else { ?>
  <a class="button checkout__button changedText" href="../../approveGuestReservationRequest/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" >Approve</a>
  <?php } ?>
<a class="button checkout__button changedText" href="../../rejectGuestReservationRequest/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>">Reject</a>
<?php }  ?>
</form>

 <?php if($guestReservationDetail['is_accepted']==1 && $guestReservationDetail['reservation_detail']['paid_method']==0) { ?>
<a class="button checkout__button changedText  " href="javascript:void(0);" onclick="submitform();">Confirm reservation</a>
  <?php  } ?>
 </div>
</div>
</div>
