			...
			function submitForm()
			 {
				 ...
				 if($('#holder_name').val()=='')
				 {
					 $('#error_msg_form').html('please enter account holder name');
					 return false;
					 
				 }
				 if($('#bname').val()=='')
				 {
					 $('#error_msg_form').html('please enter bank name');
					 return false;
					 
				 }
				 if($('#account_number').val()=='')
				 {
					 $('#error_msg_form').html('please enter account number');
					 return false;
					 
				 }
				  if($('#bic').val()=='')
				 {
					 $('#error_msg_form').html('please enter BIC/SWIFT detail');
					 return false;
					 
				 }
				  if($('#iban').val()=='')
				 {
					 $('#error_msg_form').html('please enter IBAN detail');
					 return false;
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Please complete form below to add bank account</div>
...
<div class="setting__head hidden">
                    <h2 class="setting__title h2">Bank details</h2>   
                  </div>
<div class="checkout__list">
 <form method="POST" action="../addBankAccount/<?php echo $data['cid']; ?>" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
...
<div class="field__label changedText" style="color:#787f91;">Account holder name</div>
<div class="field__wrap">
<input class="field__input"  name="holder_name" id="holder_name" value=""    type="text" placeholder="xyz"   style=" color:grey;">
</div>
</div>

<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Bank name</div>
<div class="field__wrap">
<input class="field__input"  name="bname" id="bname" value=""    type="text" placeholder="Bank of Stockholam"   style=" color:grey;">
</div>
</div>

 
<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Bank Account Number</div>
<div class="field__wrap">
<input class="field__input"  name="account_number" id="account_number" value=""   placeholder="12345678"  type="text"   style=" color:grey;">
</div>
</div>

<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Bank Identifier Code(BIC/SWIFT)</div>
<div class="field__wrap">
<input class="field__input"  name="bic" id="bic" value=""  type="text"   placeholder="12345678" style=" color:grey;">
</div>
</div>
 
 <div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">International Bank Account Number (IBAN)</div>
<div class="field__wrap">
<input class="field__input"  name="iban" id="iban" value=""  type="text" placeholder="12345678"  style=" color:grey;">
</div>
</div>
