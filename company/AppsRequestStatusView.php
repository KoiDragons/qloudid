					...
					<div class="marb50 padt0   ">
						 ...
						 <?php } ?>
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" ><?php if($developerCount==0) echo 'Your request for developer account is pending for verification'; else if($developerCount==2) echo 'Your request for developer account has been rejected by support team'; ?></a></br>
