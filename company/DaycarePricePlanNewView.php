...
<h2 class="places__title h2 xs-tall   ">Price plan</h2>
<h2 class="product__title h2 talc  xs-padrl0 fsz35 xs-fsz25 xs-tall talc" style="font-family: 'Poppins', sans-serif;font-weight: 100;color: #787f91;max-width: 100%;font-size: 24px;line-height: 1.33333;">Select your pricing plan</h2>
...
<div class="receipt__actual">Free plan</div>
<div class="receipt__note hidden">$0/licence</div>
</div>
...
<div class="checkout__box" style="margin-bottom:0px;">
...
<div class="checkout__box" style="background: #23262F; padding-top:40px;">

<div class="talc  " style="padding-bottom:40px; "><a class="header__logo xs-fsz20 hidden-xs changedText" href="../../lockFreePlan/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>" style="
...
<div class="receipt__box">
					...
					<div class="price__subtitle" style="
    font-size: 25px;
">$<?php echo $value['app_price']; ?> <?php if($value['billing_type']==1) { echo 'One time'; } else {  if($value['billing_period']==1) echo 'Daily'; else if($value['billing_period']==2) echo 'Weekly'; else if($value['billing_period']==3) echo 'Monthly';  else if($value['billing_period']==4) echo 'Every 3 month'; else if($value['billing_period']==5) echo 'Every 6 month'; else if($value['billing_period']==6) echo 'Yearly'; } ?></div>
...
<div class="talc  " style="padding-bottom:40px; "><a class="header__logo xs-fsz20 hidden-xs changedText" href="../../addPaymentInformation/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>/<?php echo $value['enc']; ?>" style="
    background-color: #3B71FE;
    padding: 15px;
    color: white;
    border-radius: 5px;
