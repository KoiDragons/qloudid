	...
	<div class="column_m header   bs_bb lgtgrey2_bg hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg"  >
			...
			<div class="fright   padtbz10  hidden ">
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="../serviceInformation/<?php echo $data['cid']; ?>" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
					...
					<li class="last first marr10i">
						<a href="../serviceInformation/<?php echo $data['cid']; ?>" class="lgn_hight_s1 fsz25"><span class="fas fa-plus black_txt" aria-hidden="true"></span></a>
					 </li>
				</ul>
			</div>
</div> 
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<a href="../dishesInformation/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space"  >Articles </span> 
						...
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											...
											<li class="dblock padrb10">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space">Pickapro Services</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>		
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
							<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Services</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc   xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >List of the services you are selling on pickapro</a></div>
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft  wi_55 xxs-wi_80    xs-mar0  ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php   echo $value['dish_name']; ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php echo substr($value['dish_detail'],0,23).'-'.$value['dish_price']; ?></span>  </div>
													  
												 <?php if($value['list_on_pickapro']==1)
															{ ?>
													<a href="../removePickaproListing/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"   >  <div class="fright wi_25  padl10 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Hotel" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi" fdprocessedid="138tmt">Remove?</button>
																			</div> 
																			
																			</a>
															<?php } else { ?>
													   
													<a href="../relistPickaproListing/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"   >  <div class="fright wi_25  padl10 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Hotel" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi" fdprocessedid="138tmt">Relist?</button>
																			</div> 
