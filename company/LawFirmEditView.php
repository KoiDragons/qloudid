               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../moreInformation/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
			 ...
			 <div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
							...
							<form action="../updateRequest/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div class="marb0 padtrl0">		 
											...
											<?php 
												...
												?> 													
															<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($lawCompanyInfo['bar_association_id']==$value['id']) echo 'selected'; ?>><?php echo $value['bar_associations']; ?></option>
												<?php } ?>												
											...
											<div class="pos_rel">
												...
												<input type="number" name="office_count" id="office_count" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_55p fsz18 black_txt ffamily_avenir floating__input padt25" value="<?php echo $lawCompanyInfo['how_many_offices']; ?>" /> 
										 ...
										 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="number" name="lawer_count" id="lawer_count" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_55p fsz18 black_txt ffamily_avenir floating__input padt25" value="<?php echo $lawCompanyInfo['how_many_lawers']; ?>"/> 
									...
									<div class="thr_clmn  wi_75 ">
										...
										<?php  foreach($mainPracticeAreas as $category => $value) 
														...
														<div class=" wi_33 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
															<input type="button" value="<?php echo substr($value['main_practice_areas'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd <?php if($value['is_selected']==0) echo 'red_ff2828_bg'; else echo 'green_bg'; ?> fsz18 white_txt curp ffamily_avenir" onclick="addType(<?php echo $value['id']; ?>);" id="<?php echo $value['id']; ?>">
														</div>
														<?php } ?>
								...
								<input type="hidden" name="service_name" id="service_name" value="<?php echo $lawCompanyInfo['service_area_detail']; ?>" />		
								 <input type="hidden" name="practice_area" id="practice_area" value="<?php echo $lawCompanyInfo['practice_area_detail']; ?>" />
								 <input type="hidden" name="main_practice_areas" id="main_practice_areas" value="<?php echo $lawCompanyInfo['main_practice_areas_detail']; ?>" />
								 <input type="hidden" name="type_of_lawer" id="type_of_lawer" value="<?php echo $lawCompanyInfo['type_of_lawer_info']; ?>" />
									...
									<div class="thr_clmn  wi_75 ">
										...
										<?php  foreach($typeOfLawer as $category => $value) 
														...
														?>
														<div class=" wi_33 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
															<input type="button" value="<?php echo substr($value['type_of_lawer'],0,13); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd <?php if($value['is_selected']==0) echo 'red_ff2828_bg'; else echo 'green_bg'; ?> fsz18 white_txt curp ffamily_avenir" onclick="addType2(<?php echo $value['id']; ?>);" id="l<?php echo $value['id']; ?>">
														</div>
														<?php } ?>
									...
									<div class="thr_clmn  wi_75 ">
										...
										<?php  foreach($serviceArea as $category => $value) 
														...
														<div class=" wi_50 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
															<input type="button" value="<?php echo substr($value['service_name'],0,22); ?>" class="wi_100 mart5 maxwi_100 brdrad3 hei_40p diblock nobrd <?php if($value['is_selected']==0) echo 'red_ff2828_bg'; else echo 'green_bg'; ?> fsz18 white_txt curp ffamily_avenir" onclick="addType4(<?php echo $value['id']; ?>);" id="s<?php echo $value['id']; ?>">
														</div>
														<?php } ?>
