...
function updateBasement(id,link)
{
	...
	basementUpdate=1;
 		...
 		function updateFloorParkingDetail(id,id1)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 send_data.id=id;
				 send_data.id1=id1;
				 send_data.port_id=<?php echo $data['port_id']; ?>;
				  $.ajax({
							type:"POST",
							url:"../../../updateFloorParkingDetail/<?php echo $data['fid']; ?>",
							data:send_data,
							dataType:"text",
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please update information regarding total available parking area for this floor</a></div>
						...
						<div class="on_clmn brdb marb5">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Parkings</span> 
													 </div>
									...
									<?php echo $buildingAvailableParkingForFloor; ?>
								  </div>
