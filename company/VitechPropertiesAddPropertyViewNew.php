						...
						success: function(data1){
							 ...
							 if(data1==0)
								...
								else
								{
									...
									$.ajax({
										type:"POST",
										url:"../checkApartmentNumberValididty",
										data:send_data,
										dataType:"text",
										contentType: "application/x-www-form-urlencoded;charset=utf-8",
										success: function(data1){
											 ...
											 if(data1>0)
											 {
												$("#error_msg_form").html('Please enter another apartment number');
												return false;
											 }
											 else
											 {
...
<a class="header__logo xs-fsz20 changedText " href="../searchPropertyInformation/<?php echo $data['cid']; ?>" style="
...
<form class="checkout__item js-tabs-item" action="../addVitechAdddress/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 ...
 <div class="upload__item hidden">
					 ...
					 <div class="checkout__row" style="margin-top:40px; margin-bottom:24px;">
                          <div class="field"  >
 ...
 <div class="hidden" id="propertyDetailStatusInfo">
                            ...
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="number" name="sell_price" id="sell_price" value=0 placeholder="e. g. &quot;180&quot;" required>
                                  </div>
                                </div>
                              </div>
                              <div class="upload__cell">
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								   <option value="House" class="changedText">House</option>
											<option value="Apartment" selected="" class="changedText">Apartment</option>
											<option value="Lodge" class="changedText">Lodge</option>
											<option value="Cottage" class="changedText">Cottage</option>
											<option value="Cabin" class="changedText">Cabin</option>
											<option value="Chalet" class="changedText">Chalet</option>
											<option value="Wigwam" class="changedText">Wigwam</option>
											<option value="Barn" class="changedText">Barn</option>
								  </select>
                            </div>
                          </div>
						  ...
						  <div class="checkout__row">
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="apartment_number" id="apartment_number"  placeholder="e. g. 1234" style=" color:grey;"  >
                            </div>
                          </div>
						   <div class="field">
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
						   ...
						   <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 24px 8px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="total_area" id="total_area" placeholder="e. g. 120" style=" color:grey;"  >
                            </div>
                          </div>
                        </div>
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
							    <option value="Not available" >Select</option>
								  <option value="Full furnishing" class="changedText">Full furnishing</option>
								<option value="Kitchen" class="changedText">Kitchen</option>
								<option value="Built-in wardrobes" class="changedText">Built-in wardrobes</option>
					  ...
					  <div class="checkout__line  "  style="margin-bottom:24px;">
					   ...
					   <div class="upload__row">
                        ...
                        <div class="field  ">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="addrs" id="addrs" value="<?php echo  $_POST['address']; ?>" placeholder="e. g. Queenstown, Otago, New Zealand" style=" color:grey;"  readonly>
                            </div>
                          </div>
						  </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dzip" id="dzip" placeholder="e. g. 120001"  style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w70">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dcity" id="dcity"  placeholder="e. g. Stockholam"  style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						   </div>
