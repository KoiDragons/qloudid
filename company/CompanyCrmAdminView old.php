...
<html lang="en">
  ...
  <body class="dark" style="background: #131922">
    ...
    <div class="outer">
	  ...
	  <?php } else if($developerCount==0 || $developerCount==2) { ?>
	  <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg " style="padding:0px;">
...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">Get Started
</span> </h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Start your journey by adding your objects and employees
</div>
</div></div>
               ...
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
			       ...
			       <a class="categories__item  bg_E7E7E7 " href="https://www.safeqloud.com/company/index.php/VitechProperties/listProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
									  ...
									  <a class="categories__item bg_E7E7E7 " href="../../CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Setup</div>
                                      </a> 

										<a class="categories__item bg_E7E7E7 " href="../../CompanySuppliers/companyProfileIntegration/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
...
<!--<div class="card__preview" style="width: 161px;padding: 30px;"><img srcset="https://qualeefy.com/html/usercontent/images/team/12.jpg" src="https://qualeefy.com/html/usercontent/images/team/12.jpg" alt="London - Kings Cross" style="
    padding: 20px;
    border-radius: 30px;
">
 
</div>--> <?php echo $value['img']; ?>
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo  substr(html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']),0,18); ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;">Verified
</div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php if(empty($value['work_email'])) echo '-'; else echo $value['work_email']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php if(empty($value['wmobile'])) echo '-'; else echo $value['mobile']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>€13 million</div>
			   ...
			   <div class="card__foot">
                      ...
                      <div class="card__flex">
                        <div class="card__cost fsz14" style="
    padding-top: 10px; font-weight:100;
"> </div>
 <div class="card__cost fsz14" style="
    padding-top: 10px; font-weight:100;
">
<?php if($value['location_verified']==1) { ?>
   <a class="header__logo  changedText fright" href="../../EmployeeDetail/employeeAccount/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>" style="
   ...
   ">Review</a>
<?php } else { ?>
<a class="header__logo  changedText fright" href="../../CompanyCustomers/companyCustomersLocation/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #ffe500;
   border-radius: 5px;
...
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;">Not verified
</div>
...
">
   ...
   <div class="header__logo  changedText fright" href="#" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #ffe500;
   border-radius: 5px;
