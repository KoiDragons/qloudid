...
<button class="header__burger js-header-burger"></button>
  ...
  <!-- outer content-->
       <div class="outer__inner xs-mart65 mart80">
		...
		<div class="card card_row" href="javascript:void(0);" style="margin-bottom:24px;">
                    ...
                    <div class="card__foot">
                      ...
                      <div class="card__flex">
						...
						<?php if($value1['is_reserved']==1) { ?>
                         <div class="button receipt__button" style="background: #0142eb;" ><span>Reserved</span>
                  <svg class="icon icon-bag">
                    <use xlink:href="#icon-bag"></use>
                  </svg></div>
						<?php } else { ?>
						<a href='../../reserveLandloardApartment/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $value1['enc']; ?>'> <div class="button receipt__button" style="background: #0142eb;" ><span>Reserve</span>
                  <svg class="icon icon-bag">
                    <use xlink:href="#icon-bag"></use>
                  </svg></div></a>
						<?php } ?>
