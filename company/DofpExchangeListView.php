 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);" style="color:white;">Trading objects</a></li>
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.safeqloud.com/company/index.php/LandloardBroker/guestReservationRequestList/<?php echo $data['cid']; ?>">Buyer reservations</a></li>
                </ul>
              </div>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">OFP Exchange For Developers</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">List your off-plan properties and connect with thousands of brokers ready to trade</div>
...
">
      ...
      <div class="section flights">
		...
		<div class="flights__center " style="padding-bottom:0px;">
		<div class="browse__head wi_50  xs-wi_100 " style="margin-bottom:0px;">
		<div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Buildings</div>
                            <div class="field__wrap">
							 <select class="" style="height: 48px;
								...
								color: grey; border-radius: 12px;
								  ...
								  <?php 
											 	foreach($buildingList as $category => $value) 
													{
													 
														 															
													?>
								  	<option value="<?php echo $value['id']; ?>"><?php echo $value['building_name']; ?></option>
													<?php } ?>							 
		  ...
		  <div class="wi_100 xs-wi_100" style="border-bottom: 1px solid #282b34;margin-bottom: 10px;">
									<div class="wi_100   padt0">
										
										
										<div class=" ">
									<?php 
											 	foreach($apartmentList as $category => $value) 
													{
													 
														if($value['listed_on_exchange']==0)
														{															
													?>
													
												 <div class="card card_row"   style="margin-bottom:24px; border:1px solid #282b34; ">
				...
				margin-bottom: 0px;
			">
							   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">Apartment <?php echo $value['office_apartment_number']; ?></div>
			...
			">
							<div class="description__parameter" style="margin-top: 0px;">
							  <svg class="icon icon-home">
								<use xlink:href="#icon-home"></use>
							  </svg>Floor <?php echo $value['floor_number']; ?></div>
							<div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
							  <svg class="icon icon-flag">
								<use xlink:href="#icon-flag"></use>
							  </svg><?php echo $value['bedroom_count']; ?> Bedrooms</div>
							  ...
							  <svg class="icon icon-flag">
								<use xlink:href="#icon-flag"></use>
									 ...
									 <a class="header__logo  changedText fright ButtonWhite" href="../addToExchangeList/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" id="120" style="
							  ...
							  <div class="card__body" style="background: white;">
								<div class="card__line" style="
				margin-bottom: 0px;
			">
							   <div class="flight__title" style="font-size:20px; color:black; margin-bottom: 0px;">Apartment <?php echo $value['office_apartment_number']; ?></div>
							...
							<div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
							  ...
							  <svg class="icon icon-flag">
								<use xlink:href="#icon-flag"></use>
									 ...
									 <a class="header__logo  changedText fright " href="../removeFromExchangeList/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" id="120" style="
									   background-color: #131922; margin-right:0px;
									   padding: 5px;
									   color:white;
									   border-radius: 5px;
									   font-family: Avenir;
