 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.qloudid.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  ...
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.qloudid.com/company/index.php/LandloardBroker/guestReservationRequestList/<?php echo $data['cid']; ?>">Buyer reservations</a></li>
                </ul>
              </div>
