...
<a class="header__logo xs-fsz25 changedText" href="../listBuildings/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Start Project. Add Building</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Input your building details to proceed with listing apartments in the next step.</div>
...
<form class="checkout__item js-tabs-item" action="../addBuilding/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 ...
 <div class="  "  >
				  <div class="upload__item">
				   <div class="receipt__stage">Building details</div>
                            ...
                            <div class="field__wrap">
							 <select class=""   style="height: 48px;
								...
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" name="building_type_info" id="building_type_info">
								<option value="1">House</option>
								<option value="2">Apartment</option>
								<option value="3" selected="">Lodge</option>
								<option value="4">Cottage</option>
								<option value="5">Cabin</option>
								<option value="6">Chalet</option>
								<option value="7">Wigwam</option>
								<option value="8">Barn</option>
								</select>
				  ...
				  <div class="upload__row">
                          <div class="upload__col upload__col_w50">
                            <div class="field ">
                            <div class="field__label  changedText" style="color:#787f91;">Building format</div>
                            <div class="field__wrap">
							 <select class=""   style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" name="building_type" id="building_type">
                          ...
                          <div class="upload__col upload__col_w50">
                            <div class="field  ">
                            <div class="field__label  changedText" style="color:#787f91;">Building status</div>
                            <div class="field__wrap">
							  <select class=""   style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" name="building_completed" id="building_completed" onchange="undpateBuildingCompleted(this.value);">
								  <option value="0">Select</option>
				  ...
				  <div class="upload__row hidden" id="buildingNotDone">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							  <div class="field__label  changedText" style="color:#787f91;">Start date</div>
                              <div class="field__wrap">
                                <input class="field__input" type="date" id="s_date" name="s_date" value="<?php echo date('Y-m-d'); ?>"  style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">End date</div>
                              <div class="field__wrap">
                                <input class="field__input" type="date" id="e_date" name="e_date" min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
						 ...
						 <div class="field margin-bottom24 hidden" id="buildingDone">
                            <div class="field__label  changedText" style="color:#787f91;">Completion date</div>
                            <div class="field__wrap">
							   <input class="field__input" type="date" id="complete_date" name="complete_date" max="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" style=" color:grey;">
						   ...
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Who can sale the building</div>
                            <div class="field__wrap">
							 <select class=""   style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" name="building_seller" id="building_seller"onchange="undpateBuildingCommission(this.value);">
								 <option value="0">Select</option>
						   ...
						   <div class="field margin-bottom24 hidden" id="buildingCommision">
                            <div class="field__label  changedText" style="color:#787f91;">Broker commission</div>
                            <div class="field__wrap">
							 <select class=""   style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" name="broker_commission" id="broker_commission">
								 <option value="0">Select</option>
										<?php for($i=1;$i<=20;$i++){ ?>
						  	...
						  	<input type="hidden" value="1"  name="vitech_region_id" id="vitech_region_id" />
							<input type="hidden" value="1"  name="vitech_city_id" id="vitech_city_id" />
							<input type="hidden" value="1"  name="vitech_area_id" id="vitech_area_id" />
							
							
							<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							  <div class="field__label  changedText" style="color:#787f91;">Building name</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="building_name" name="building_name" placeholder="e.g. tip top"  style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							<div class="field__label  changedText" style="color:#787f91;">Block number</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="block_name" name="block_name"  placeholder="e.g. 1B" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
						
						<div class="setting__notification" style="
    margin-bottom: 48px;
    padding-bottom: 24px;
    ...
    ">
                    ...
                    </div><div class="receipt__stage">Location</div>
						...
						<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              ...
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="street_address" name="street_address" placeholder="e.g. tip top"  style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">City</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="address_city" name="address_city"  placeholder="e.g. stockholam" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
						...
						<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              ...
                              <div class="field__wrap">
								...
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" name="country_id" id="country_id">
								<?php  
                          ...
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">Zipcode</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="zip_address" name="zip_address"   placeholder="e.g. 111111" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
							...
							<div class="upload__row " id="locationDetail" style="display:none">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							  <div class="field__label  changedText" style="color:#787f91;">Latitude</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="latit" id="latit"  placeholder="e.g. 78.123456"  style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							<div class="field__label  changedText" style="color:#787f91;">Longitude</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="longi" id="longi"  placeholder="e.g. 29.112345" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
					    <script>
									function updateBasement(link)
										   {
											  body = $('body');
											   if($('#basement_available').val()==1)
											   {
...
function getValue()
		 {
			  ports=ports+1;
			var counter_value=parseInt($('.js-counter-babies').val())+1;
			 
			if(counter_value==1)
			{
				$('.js-counter-minus').addClass('disabled');
			}
			var newEmployee='<div style="margin-top:24px; padding-top:24px; border-top:1px solid #23262f;" id="'+counter_value+'"><div class="upload__item margin-bottom24"><div class="field"> <div class="field__label  changedText" style="color:#787f91;">Add port number</div><div class="field__wrap"><input class="field__input" type="text" name="port_number'+counter_value+'" id="port_number'+counter_value+'" placeholder="e. g. 1A"  style=" color:grey;"  > </div></div>  </div><input type="hidden" value="1" id="elevator'+counter_value+'" name="elevator'+counter_value+'" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" /><div class="checkout__box"><div class="receipt" style="border: none;    background: transparent; padding:0; margin:0; width:100%;"><div class="receipt__stage hidden">Number of floors</div><div class="receipt__settings"><div class="receipt__setting"><div class="receipt__wrap"><div class="receipt__content" style="font-size: 14px;">How many floors does this port have?</div></div><div class="counter js-counter" data-min="1"> <button class="counter__button js-counter-button js-counter-minus disabled" type="button" onclick="getValueLowerFloor('+counter_value+');"><svg class="icon icon-minus"><use xlink:href="#icon-minus"></use></svg></button> <div class="counter__value js-counter-value counterFloor'+counter_value+'">1</div> <button class="counter__button js-counter-button js-counter-plus" type="button" onclick="getValueFloor('+counter_value+');"><svg class="icon icon-plus"> <use xlink:href="#icon-plus"></use></svg></button> <input class="js-counter-input js-counter-result js-counter-babies'+counter_value+'" type="hidden" name="total_floors'+counter_value+'" value="1"></div></div></div></div> </div><div class="setting__notification" style="margin-bottom: 0px; padding-bottom: 0px;border-color: #131922;"><div class="setting__main"><div class="setting__subtitle" style="font-size: 14px;color: #787f91;">Does this port have an elevator?</div><label class="switch"><input class="switch__input" type="checkbox" onclick="updateElevator(this,'+counter_value+');"  checked /><span class="switch__inner"><span class="switch__box"></span></span></label></div> <div class="setting__content hidden">If this port have elevator available?</div></div></div>';
			 
			$('#propertyDetailStatusInfo').append(newEmployee);
		 }
		 
 function getValueLower()
		 {
			 if(ports==1)
			{
				return false;
			...
			ports=ports-1;
			  var newEmployee=$('#propertyDetailStatusInfo').html(); 
			var counter_value=parseInt($('.js-counter-babies').val());
			if(counter_value==1)
			{
				$('.js-counter-minus').addClass('disabled');
				return false
			}
			 document.getElementById(""+counter_value).remove();
		 ...
		 function getValueFloor(id)
		 {
			   
			var counter_value=parseInt($('.js-counter-babies'+id).val());
			  counter_value=counter_value+1;
			$('.js-counter-babies'+id).val(counter_value);
			$('.counterFloor'+id).html(counter_value);
		 }
		 function getValueLowerFloor(id)
		 {
    ...
    ">
					...
					<div class="" id="moreEmployees" style="padding: 15px; background: #10161d;">
			<div class="checkout__box">
					<div class="receipt" style="border: none;    background: transparent; padding:0; margin:0; width:100%;">
					<div class="receipt__stage">Stairs</div>
					<div class="receipt__settings">
                <div class="receipt__setting">
                  <div class="receipt__wrap">
                    
                    <div class="receipt__content" style="font-size: 14px;">How many stairs does your property have?</div>
                  </div>
                  <div class="counter js-counter" data-min="1">
                    <button class="counter__button js-counter-button js-counter-minus disabled" type="button" onclick="getValueLower();">
                      <svg class="icon icon-minus">
                        <use xlink:href="#icon-minus"></use>
                      </svg>
                    </button>
                    <div class="counter__value js-counter-value counterFloor1">1</div>
                    <button class="counter__button js-counter-button js-counter-plus" type="button" onclick="getValue();">
                      <svg class="icon icon-plus">
                        <use xlink:href="#icon-plus"></use>
                      </svg>
                    </button>
                    <input class="js-counter-input js-counter-result js-counter-babies" type="hidden" name="total_stairs" value="1">
                  </div>
                </div>
                 </div>		 
					</div>
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
						<div class="upload__item margin-bottom24">
							
                     
					       <div class="field ">
                            <div class="field__label  changedText" style="color:#787f91;">Add port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="port_number1" id="port_number1" placeholder="e. g. xyz@gmail.com" style=" color:grey;">
                            </div>
                          </div>
						  ...
						  <script>
									function updateElevator(link,id)
										   {
											  body = $('body');
											   if($('#elevator'+id).val()==1)
											   {
												    $('#bodyData').addClass('dark');
 ...
 <input type="hidden" value="1" id="elevator1" name="elevator1" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
					...
					<div class="checkout__box">
					<div class="receipt" style="border: none;    background: transparent; padding:0; margin:0; width:100%;">
					<div class="receipt__stage hidden">Number of floors</div>
					<div class="receipt__settings">
                <div class="receipt__setting">
                  <div class="receipt__wrap">
                    
                    <div class="receipt__content" style="font-size: 14px;">How many floors does this port have?</div>
                  </div>
                  <div class="counter js-counter" data-min="1">
                    <button class="counter__button js-counter-button js-counter-minus disabled" type="button" onclick="getValueLowerFloor(1);">
                      <svg class="icon icon-minus">
                        <use xlink:href="#icon-minus"></use>
                      </svg>
                    </button>
                    <div class="counter__value js-counter-value">1</div>
                    <button class="counter__button js-counter-button js-counter-plus" type="button" onclick="getValueFloor(1);">
                      <svg class="icon icon-plus">
                        <use xlink:href="#icon-plus"></use>
                      </svg>
                    </button>
                    <input class="js-counter-input js-counter-result js-counter-babies1" type="hidden" name="total_floors1" value="1">
                  </div>
                </div>
                 </div>		 
					</div>
					 ...
					 <div class="setting__notification" style="margin-bottom: 0px;
    padding-bottom: 0px;
    border-color:#131922;">
                      <div class="setting__main">
                        <div class="setting__subtitle" style="font-size: 14px;color: #787f91;">Does this port have an elevator?</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateElevator(this,1);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content hidden">If this port have elevator available?</div>
                    </div>
 ...
 <div class="receipt__stage">Additionals</div>
				   <div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        <div class="setting__subtitle">Basement</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateBasement(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you have basement available?</div>
                    </div>
						  
		 <script>
									function updatePenthouse(link)
										   {
											  body = $('body');
											   if($('#penthouse_available').val()==1)
											   {
												    $('#bodyData').addClass('dark');
 ...
 <input type="hidden" value="1" id="penthouse_available" name="penthouse_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
				   <div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        <div class="setting__subtitle">Penthouse</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updatePenthouse(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you have penthouse available?</div>
                    </div>

 <script>
									function updateGarage(link)
										   {
											  body = $('body');
											   if($('#garage_available').val()==1)
											   {
												    $('#bodyData').addClass('dark');
...
<input type="hidden" value="1" id="garage_available" name="garage_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
				   <div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        <div class="setting__subtitle">Garage</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateGarage(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">if they garage in the same building?</div>
                    </div>

 <script>
									function updateAmenities(link)
										   {
											  body = $('body');
											   if($('#amenities_available').val()==1)
											   {
												    $('#bodyData').addClass('dark');
 ...
 <input type="hidden" value="1" id="amenities_available" name="amenities_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
				   <div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        <div class="setting__subtitle">Amenities</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateAmenities(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">If they have amenities available?</div>
                    </div>

 <script>
									function updateTenant(link)
										   {
											  body = $('body');
											   if($('#tenant_available').val()==1)
											   {
												    $('#bodyData').addClass('dark');
 ...
 <input type="hidden" value="1" id="tenant_available" name="tenant_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
				   <div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        <div class="setting__subtitle">Tenant</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateTenant(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you want to add tenant information?</div>
                    </div>

 <script>
									function updatePricing(link)
										   {
											  body = $('body');
											   if($('#pricing_available').val()==1)
											   {
												    $('#bodyData').addClass('dark');
 ...
 <input type="hidden" value="1" id="pricing_available" name="pricing_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
				   <div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        <div class="setting__subtitle">Pricing</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updatePricing(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">if they have different pricing?</div>
                    </div>

 <script>
									function updateInvoice(link)
										   {
											  body = $('body');
											   if($('#invoice_available').val()==1)
											   {
												    $('#bodyData').addClass('dark');
 ...
 <input type="hidden" value="1" id="invoice_available" name="invoice_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Invoice</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateInvoice(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">if they generate invoice in timely order?</div>
                    </div>
...
<script src="<?php echo $path;?>html/fleet/js/appIncrement.js"></script>
<!-- svg sprite-->
