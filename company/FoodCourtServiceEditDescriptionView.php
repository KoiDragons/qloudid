...
<?php
	...
	function upadtePickaproSubcategory(id)
{
 var send_data={};
 
		 send_data.catg_id=id;
		 $.ajax({
					type:"POST",
					url:"../../selectedProfessionalCategoryServicesDetail/<?php echo $data['cid'];?>",
					data:send_data,
					dataType:"text",
				...
				$.ajax({
					type:"POST",
					url:"../../selectedProfessionalCategoryAvailableLocation/<?php echo $data['cid'];?>",
					data:send_data,
					dataType:"text",
					contentType: "application/x-www-form-urlencoded;charset=utf-8",
					success: function(data1){
						$('#location_info').html('');
						$('#location_info').html(data1); 
					}
				});	 
...
moreEventOnRequestExtraFee=1;
	...
	function selectWarning(id)
	{
		...
		function submitform()
		{
			...
			var is_physical=<?php echo $data['is_physical']; ?>;
			if(is_physical==2)
			{
			if($("#subcategory_id").val()==0)
			{
				
				$("#errorMsg1").html('Please select subcategory');
				return false;
			}

			if($("#location_info").val()==null || $("#location_info").val()=="")
			{
				
				$("#errorMsg1").html('Please select where service is available');
				return false;
			}
			}
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../servicesInformation/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20" id="loginBank" onclick="checkFlag();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
							...
							<form action="../../editServiceDetail/<?php echo $data['cid']; ?>/<?php echo $data['fid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
						...
						<div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
									...
									<div class="thr_clmn  wi_50 padr10"  >
										...
										<?php if($data['is_physical']==2) { ?>
										
										<div class="on_clmn mart20 ">
											<div class="pos_rel">
												 
												<select name="category_id" id="category_id" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " onchange="upadtePickaproSubcategory(this.value);"> 
											  
											 
											 <?php $i=1;
												
												foreach($selectedProfessionalCategoryDetail as $category => $value) 
												{
													
													
												?> 
												<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($selectedDish['professional_category_id']==$value['id']) echo 'selected'; ?>><?php echo $value['category_name']; ?></option>
												<?php } ?>
											 		 
											 	 
											</select>
											 	<label for="category_id" class="floating__label tall nobold padl10" data-content="Pickapro category">
											...
											<div class="pos_rel">
												...
												<select name="subcategory_id" id="subcategory_id" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " > 
											  
											 <?php $i=1;
												
												foreach($selectedCategoryServicesDetail as $category => $value) 
												{
													
													
												?> 
												<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($selectedDish['professional_subcategory_id']==$value['id']) echo 'selected'; ?>><?php echo $value['subcategory_name']; ?></option>
												<?php } ?>
											 
											 		 
											 	 
											</select>
											 	<label for="subcategory_id" class="floating__label tall nobold padl10" data-content="Pickapro subcategory">
											<span class="hidden--visually">
											 Bookable</span></label>
											</div>
										 	</div>
											...
											<div class="pos_rel">
												...
												<select name="location_info" id="location_info" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select dropdown-bg" style="appearance: none " > 
											  
											<option value="0" class="lgtgrey2_bg">Select</option>
											<?php foreach($selectedProfessionalCategoryLocation as $category1 => $value1) 
												{
												?> 
											<option value="<?php echo $value1['id']; ?>" <?php if($value1['id']==$selectedDish['inclusion_detail']) echo 'selected'; ?>><?php echo $value1['location_name']; ?></option> 
												<?php } ?>
											 		 
											 	 
											</select>
											 	<label for="location_info" class="floating__label tall nobold padl10" data-content="Publish location">
											<span class="hidden--visually">
											 Bookable</span></label>
											</div>
										 	</div>
											 ...
											 <div class="clear"></div>
										<?php } ?>
										<input type="hidden"   name="pickapro_listing" id="pickapro_listing" value="<?php echo $selectedDish['pickapro_listing']; ?>" />
										<div id="inclusionInfo" class="padt10 <?php if($selectedDish['num']<=1) echo 'hidden'; ?>">
										<?php if($selectedDish['pickapro_listing']==1) 
											
										echo $selectedDish['available_for'];  
										?>
										</div>		
								...
								<div class="pos_rel">											
									...
									<div class="thr_clmn  wi_75 ">
										...
										<div class="on_clmn  mart20  <?php if($selectedDish['event_at_customer_place']==0) echo 'hidden'; ?>" id="customerPlaceTour">	
									...
									<div class="thr_clmn  wi_75 ">
										...
										<div class="thr_clmn  wi_25"  >
											<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  <?php if($selectedDish['more_event_extra_fee']==1) echo 'checked'; ?> " id="extraFeeChe" onclick="updateExtraFee();">
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
										...
										<div class="on_clmn mart20 <?php if($selectedDish['more_event_extra_fee']==0) echo 'hidden'; ?>" id="extraFee">
											...
											<div class="pos_rel">
												...
												<input type="text" name="dish_name" id="dish_name" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php echo $selectedDish['dish_name']; ?>" <?php if($data['cid']=='RFJYSGdaY3JZZWZScXFYQzh6TndiUT09') echo 'readonly'; ?>/> 
										...
										<div class="on_clmn mart20 hidden">
											...
											<div class="pos_rel">
												...
												<input type="text" name="dish_detail" id="dish_detail" placeholder="Description" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php echo $selectedDish['dish_detail']; ?>" /> 
								 ...
								 <div class="on_clmn mart20 <?php if($selectedDish['variation_type']==1) echo 'hidden'; if($selectedDish['one_shared']==2) echo 'hidden';  ?>">
											...
											<div class="pos_rel">
												...
												<input type="number" name="dish_price" id="dish_price" placeholder="Price" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php echo $selectedDish['dish_price']; ?>" <?php if($selectedDish['variation_type']==1) echo 'readonly'; ?> /> 
								...
								<div class="pos_rel">											
										...
										<div class=" wi_33 xxs-wi_50 maxwi_100  dflex alit_s mart10   padrl5 ">
											...
											<input type="number"  id="total_time" name="total_time" value="<?php echo $selectedDish['custom_time']; ?>" min=1 class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 " /> 
