				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Notify the recipient that there is a post or parcels to pick up by typing the person's name.</a></div>
						...
						<div class="collaborator-row dflex alit_c pos_rel">
							...
							<form action="../packetInfo/<?php echo $data['cid']; ?>" method="POST" name="collaborators-form" id="collaborators-form">
							<!-- Leave for security protection, read docs for details -->
							 
									<div class="on_clmn mart10 marb35">
											
										<div class="pos_rel">
										<input type="text" name="empname"  placeholder="Full name" id="collaborators-lookup" class=" wi_100 nobrdt nobrdl nobrdr pad10  red_f5a0a5_txt brdb_red_ff2828 talc  minhei_65p fsz18  fsz16 ffamily_avenir"    onkeyup="updateForm();">
									</div>
									</div>
