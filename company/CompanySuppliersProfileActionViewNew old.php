...
<div class="checkout__label changedText">Employees</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Click here to view the list of employees</div>
 
<div class="checkout__controls">
 
<a href="../../CompanyCrm/adminAccount/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">List object</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Click here to list objects</div>
 
<div class="checkout__controls">
 
<a href="../../VitechProperties/listEmployeesProperties/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
