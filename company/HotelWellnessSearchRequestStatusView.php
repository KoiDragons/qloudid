               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../searchWellness/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
					...
					<div class="marb50 padt0   ">
						 ...
						 <?php } ?>
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir"><?php if($requestInfo==0) echo 'Pending'; else if($requestInfo==1) echo 'Approved'; ?></h1>
									</div>
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" ><?php if($requestInfo==0) echo 'Your request for health service at wellness is pending for verification'; else if($requestInfo==1) echo 'Your request for  health service at wellness has been approved by wellness support team'; ?></a></br>
							 ...
							 <?php if($requestInfo==0) { ?>
									<div class="padtb20 xxs-talc talc">
								
							<a href="../../../sendReminder/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['id']; ?>">	<button type="button" name="forward" class="forword minhei_55p t_67cff7_bg fsz18">Send Reminder</button></a>
