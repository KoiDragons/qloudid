...
<button class="header__burger js-header-burger"></button>
      ...
      <div class="outer__inner " style="margin-top:40px;">
	  
	  
	  <div class="travel__center   center xxs-padrl25" style="margin-bottom:0px;">

<div class="travel__row">
 
 <div class="travel__col tall   xs-padl0 xsi-mart40 wi_700pi xs-marb0 xs-wi_400pi"  >

<div class="travel__list xs-marb0" style=" max-width: 700px; margin-bottom:0px;">


<div class="travel__item" style=" margin-bottom: 0px;">
 
 

<div class="travel__subtitle changedText xs-padb10 fsz80 xs-fsz60" style=" margin-bottom: 0px;
                  line-height: 1.1;   color:white;
                  "><?php echo $getAppsPermissionDetail['app_name']; ?>
</div>
</div>
<div class="travel__item">
 <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 25px;
                  ">Company apps info.</div>
				  
				  
				  <div class="description__parameters hidden" style="margin:0px; border:none; padding:0px;">
                <div class="description__parameter">
                  <span class="changedText">TXP Family</span>
                </div>
                 <div class="description__parameter">
                   <span class="changedText">#4 in PropTech</span>
                </div>
				
				<div class="description__parameter">
                   <span class="changedText">4.8 (31.6 <span class="changedText">Ratings</span>)</span>
                </div>
              </div>
 ...
 <div class="section destinations xxs-padrl25  hidden-xxs" style="margin-bottom:50px;">
          <div class="destinations__center center "  style="border-bottom:1px solid #23262F; padding-bottom:50px;  max-width: 1132px;">
              </div>
        </div>
<div class="section main main_stays" style="margin-bottom:0px;">
<div class="main__center center hidden-xs" style="max-width: 1280px;
">
...
<div class="  visible-xs padrl25 padt30">
      ...
      <div class="section destinations xxs-padrl25  " style="margin-bottom:50px;">
          <div class="destinations__center center "  style="border-bottom:1px solid #23262F; padding-bottom:50px;  max-width: 1132px;">
              </div>
        </div>
		...
		<div class="  description" style="border:none;">
          ...
          <div class="description__center center xxs-padrl25">
            <div class="description__wrapper xs-marb0">
			
              <h4 class="description__title h4 changedText" style="
                  line-height: 1.1; font-size: 40px; color:white;
                  ">Presentation</h4>
              <div class="description__profile product__rating" style=" margin-bottom:40px;"><svg class="icon icon-star">
                      <use xlink:href="#icon-star"></use>
                    </svg><span class="changedText fsz20i" style="line-height: 1.71429;">4.8 (256 reviews)</span>
                <div class="description__avatar hidden"><img src="https://dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar"></div>
                
              </div>
              <div class="description__parameters hidden">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText">Responsive Web</span>
                </div>
                 
              </div>
              <div class="description__content">
                <p class="changedText fsz20i" style="line-height: 1.71429;"><?php echo html_entity_decode($getAppsPermissionDetail['presentation']); ?></p>
              ...
              <div class="description__info changedText">Features</div>
              <div class="description__options xs-marb0">
			                  <div class="description__option">
                  <svg class="icon icon-burger">
                    <use xlink:href="#icon-burger"></use>
                  </svg><span class="changedText">Property CRM</span>
                </div> 
				                <div class="description__option">
                  <svg class="icon icon-medical-case">
                    <use xlink:href="#icon-medical-case"></use>
                  </svg><span class="changedText">Search & Select</span>
                </div>
				
				<div class="description__option">
                  <svg class="icon icon-burger">
                    <use xlink:href="#icon-burger"></use>
                  </svg><span class="changedText">Bookings</span>
                </div> 
				
				<div class="description__option">
                  <svg class="icon icon-burger">
                    <use xlink:href="#icon-burger"></use>
                  </svg><span class="changedText">Check-in & Out</span>
                </div> 
				
				<div class="description__option">
                  <svg class="icon icon-burger">
                    <use xlink:href="#icon-burger"></use>
                  </svg><span class="changedText">Cleaning</span>
                </div> 
				
				<div class="description__option">
                  <svg class="icon icon-burger">
                    <use xlink:href="#icon-burger"></use>
                  </svg><span class="changedText">Inspection</span>
                </div> 
			...
			<div class="section destinations visible-xs " style="margin-bottom:50px;">
          <div class="destinations__center center xs-padrl25"  style="border-bottom:1px solid #23262F; padding-bottom:50px;  max-width: 1132px;">
              </div>
        </div>
			<div class="receiptCss"  >
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    <div class="receipt__old hidden">$100</div>
                    <div class="receipt__actual">$<?php echo $appFeeDetail['licence_fee']; ?></div>
                    <div class="receipt__note">/<span class="changedText">licence</span></div>
                  </div>
                ...
                <div class="receipt__avatar hidden"><img src="<?php echo $path; ?>html/usercontent/images/dstricts/logo1.jpeg" alt="Avatar">
              ...
              <div class="receipt__description receipt__description_flex" style="background:#23262F;">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Trial</div>
                    <div class="receipt__subtitle changedText"><?php if($appFeeDetail['trial_period']==0) echo 'Not available'; else echo 'Available'; ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Start fee</div>
                    <div class="receipt__subtitle changedText"><?php echo $appFeeDetail['start_fee']; ?></div>
                  </div>
                </div>
                
              </div>
              <div class="receipt__btns">
                <button class="button-stroke receipt__button" fdprocessedid="ebxsyj"><span class="changedText">Save</span><span>
					...
					<?php if($getAppsPermissionDetail['is_downloaded']==0) { ?>
					<a class="button receipt__button" href="../../downloadApp/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>" style="background:#F67F00; color:#000000;"><span class="changedText">Download app</span>
              ...
              <div class="receipt__foot hidden">
			  
			  <div class="description__parameters">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText">deposit fee - €15</span>
                </div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText">If late - €20</span>
                </div>
		...
		<div class="travel__center center   padb136 xxs-padrl25" style=" max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
   ...
   <div class="travel__row ">
      ...
      <div class="travel__col" style="padding-right: 0px; max-width:525px; width:auto;">
         <div class="travel__list" style="margin-bottom:0px;
            max-width: 100%; 
            ">
            <div class="travel__item">
               ...
               <div class="travel__content changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  "> <p class="changedText"><?php echo html_entity_decode($getAppsPermissionDetail['nyheter']); ?></p></div>
    ...
    padding-left: 0px;">
              ...
              <div class="catalog__list">
               ...
               <a class="card" href="#" style="background:transparent; border-radius: 12px;">
				...
				<a class="card" href="#" style="background:transparent; border-radius: 12px;">
                  ...
                  <div class="card__foot" style="border:none;" >
                      ...
                      <div class="card__comment" >
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText">A must for any agency to have in order to work effeciently</div>
                      </div><div class="card__flex">
		...
		<div class="setting__box">
                    ...
                    <div class="setting__line">
                      <div class="setting__element" style="display:block">
                        <div class="setting__details"> 
                          <div class="setting__label changedText" style="
                  line-height: 1.1; font-size: 40px; color:white;  margin-bottom:40px;
                  ">Policy</div>
                          <div class="setting__text changedText" style="
                  color: #787f91;
                  font-size: 20px;
                  ">Services to boost international sales, optimize communication with agencies, enhance market presence, streamline project showcases, support community interactions, and more.</div>
                      ...
                      <a href="#"> <button class="button-stroke button-small settings__button mart30 changedText" fdprocessedid="phpzet">View</button></a>
                      </div>
                      <div class="setting__element xsi-padt50" style="display:block">
                        <div class="setting__details"> 
                          <div class="setting__label changedText" style="
                  line-height: 1.1; font-size: 40px; color:white; margin-bottom:40px;
                  ">Privacy</div>
                  ...
                  ">Services to boost international sales, optimize communication with agencies, enhance market presence, streamline project showcases, support community interactions, and more.</div>
                       ...
                       <a href="#"> <button class="button-stroke button-small settings__button mart30 changedText" fdprocessedid="1x8fe">View</button></a>
                      </div>
...
<footer class="footer" style="background: #131922;">
   ...
   ">Qloud ID</a>
            ...
            <div class="footer__col">
              <div class="footer__menu tall"><a class="footer__link changedText" href="#">Paseo de la Castellana 77 Madrid, M 28046</a><a class="footer__link" href="#">+34 603 14 72 90</a><a class="footer__link changedText" href="#">hello@gettxp.com</a><a class="footer__link changedText" href="#">Privacy</a><a class="footer__link changedText" href="#">About us</a><a class="footer__link changedText" href="#">Career</a> </div>
            </div>
