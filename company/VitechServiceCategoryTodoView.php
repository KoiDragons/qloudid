...
<html>
	...
	<head>
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateCategoryServiceTodo/<?php echo $data['cid']; ?>",
							data:send_data,
							dataType:"text",
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../updateCategoryServiceAllTodos/<?php echo $data['cid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir changedText"  >Property types</h1>
									</div>
