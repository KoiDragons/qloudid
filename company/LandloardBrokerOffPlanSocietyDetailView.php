...
<a class="header__logo changedText" href="../../listBrokerOffPlanProperties/<?php echo $data['cid']; ?>" style="
...
"><?php echo substr($getLandloardSocietyDetails['company_name'],0,10); ?></button>

</div></a>
<?php if($getLandloardSocietyDetails['sale_phone_number']!=''){ ?>
...
"><?php echo $getLandloardSocietyDetails['country_code'].' '.$getLandloardSocietyDetails['sale_phone_number']; ?></button>
...
<button class="header__burger js-header-burger"></button>
	  ...
	  <div class="product  hidden-xxs">
		 ...
		 <h4 class="description__title h4 changedText  padb20 center visible-xs" style="margin-top:48px;">Project</h4>
          ...
          <div class="product__center center">
			 ...
			 <div class="gallery "  >
              <div class="xs-maxheight390">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view xs-maxheight254" href="javascript:void(0);" data-caption="Spectacular views of Queenstown"><img src="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardSocietyDetails['imageId']; ?>.jpg" alt="Gallery"></a><a class="button-white button-small gallery__button" href="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardSocietyDetails['imageId']; ?>.jpg"  class="xs-brdrad10" data-fancybox="gallery" >
                ...
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
					 ...
					 <a href="../../brokerOffPlanApartmentDetail/<?php echo $data['cid']; ?>/<?php echo $data['sid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value1['enc']; ?>" style="text-decoration:none;">
