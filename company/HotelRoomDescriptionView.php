               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.qloudid.com/company/index.php/HotelStay/roomsList/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['id']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
					 ...
					 <div class="clear"></div>
							...
							<form action="../../../addRoomDetail/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								
								  	 <div class="on_clmn mart10 ">
											<div class="thr_clmn  wi_50 padr10">
											<div class="pos_rel">
												
												<input type="text" name="room_name" id="room_name" placeholder="Room name" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $roomTypeDetail['room_type_name'].''.($roomTypeDetail['number_of_rooms']+1); ?>" /> 
											...
											<div class="pos_rel">
											 ...
											 <option value="0" disabled >Room type</option> 
													<?php  foreach($hotelRoomType as $category => $value) 
														...
														<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($roomTypeDetail['room_type']==$value['id']) echo 'selected';  ?>><?php echo $value['room_type']; ?></option>
													<?php 	}	?>
											</select>
										...
										<div class="on_clmn mart20  ">
											...
											<div class="pos_rel">
												...
												<input type="number" name="room_price" id="room_price" placeholder="Room price" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb_red_ff2828 talc xxs-minhei_60p minhei_65p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $roomTypeDetail['room_price']; ?>"/> 
									 ...
									 <input type="hidden" name="room_class" id="room_class" value="<?php  echo $roomTypeDetail['room_class']; ?>" />
											...
											<div class="pos_rel">
											 ...
											 <option value="0">Room class</option> 
													<?php  foreach($hotelRoomClass as $category => $value) 
														...
														<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" <?php if($roomTypeDetail['room_class']==$value['id']) echo 'selected';  ?>><?php echo $value['hotel_room_class']; ?></option>
													<?php 	}	?>
											</select>
								 ...
								 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="text" name="custom_name" id="custom_name" placeholder="Custom name" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb  talc xxs-minhei_60p minhei_65p fsz18 llgrey_txt ffamily_avenir" value="<?php echo $roomTypeDetail['room_type_name'].''.($roomTypeDetail['number_of_rooms']+1); ?>"/> 
								...
								<div class="thr_clmn  wi_30 padr10">
										...
										<div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="text" name="room_view" id="room_view" placeholder="Room view" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb  talc xxs-minhei_60p minhei_65p fsz18 llgrey_txt ffamily_avenir" /> 
											...
											<div class="pos_rel">
												...
												<input type="text" name="description" id="description" placeholder="Room description" class="wi_100 nobrdt nobrdr nobrdl   trans_bg brdb talc xxs-minhei_60p minhei_65p fsz18 llgrey_txt ffamily_avenir" /> 
										...
										<div class="on_clmn mart20  ">
											...
											<div class="pos_rel">
												...
												<?php  foreach($hotelRoomBeddingType as $category => $value) 
														...
														<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg" ><?php echo $value['bedding_type']; ?></option>
													<?php 	} ?>
