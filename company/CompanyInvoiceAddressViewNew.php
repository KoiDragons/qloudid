...
<div class="setting__container" style="padding:0px;">
 <div class="setting__head hidden">
                    <h2 class="setting__title h2 white_txt">Invoice address</h2> <a class="button-stroke button-small setting__button white_txt" href="https://www.qloudid.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>">View profile</a>
                  </div>
