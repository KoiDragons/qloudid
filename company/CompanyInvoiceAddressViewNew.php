...
<a class="header__logo xs-fsz25 changedText" href="../../CompanySuppliers/companyProfileServices/<?php echo $data['cid']; ?>" style="
...
<div class="setting__container" style="padding:0px;">
 <div class="setting__head hidden">
                    <h2 class="setting__title h2 white_txt">Invoice address</h2> <a class="button-stroke button-small setting__button white_txt" href="https://www.safeqloud.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>">View profile</a>
                  </div>
<div class="checkout__list">
 <form method="POST" action="../companyAccount/<?php echo $data['cid']; ?>" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
  			<div class="checkout__section xsi-nobrdt " style="margin-top:0px;   padding-bottom:136px; ">
 ...
 <div class="upload__row">
                        ...
                        <div class="field  ">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="daddress" id="daddress"  value="<?php   echo $propertyInfo['street_name_v']; ?>" placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="d_port_number" id="d_port_number"  value="<?php   echo $propertyInfo['d_port_number'];  ?>"  placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<div class="field__wrap">
<input class="field__input" name="dzip" id="dzip"    type="text" placeholder="e. g. 111111"  value="<?php  echo $propertyInfo['postal_code_v']; ?>" style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
 <div class="upload__col upload__col_w70">
...
<div class="field__wrap">
<input class="field__input"  name="dcity" id="dcity"    type="text" placeholder="e. g. Stockholam" value="<?php  echo $propertyInfo['city_v']; ?>"  style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
</div>
 ...
 <script>
				...
				<div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        ...
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick="updateRent(this);" <?php  if($propertyInfo['is_invoice_same']==1) echo 'checked'; ?>><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
						  	...
						  	<input type="hidden" id="same_invoice" name="same_invoice" value="<?php  echo $propertyInfo['is_invoice_same']; ?>" />
							
							<div id="ShowInvoice" class="<?php  if($propertyInfo['is_invoice_same']==1) echo 'hidden'; ?>">
							<div class="upload__row">
                          <div class="upload__col upload__col_w70">
                        <div class="field  ">
                            <div class="field__label  changedText" style="color:#787f91;">Invoice address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="iaddress" id="iaddress"   placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq" value="<?php   echo $propertyInfo['street_name_i'];  ?>">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="i_port_number" id="i_port_number" placeholder="e. g. 121" value="<?php   echo $propertyInfo['i_port_number'];  ?>" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<div class="field__label changedText" style="color:#787f91;">Zipcode</div>
<div class="field__wrap">
<input class="field__input" name="izip" id="izip"    type="text" placeholder="e. g. 111111"  value="<?php   echo $propertyInfo['postal_code_i'];  ?>" style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
 <div class="upload__col upload__col_w70">
...
<div class="field__label changedText" style="color:#787f91;">City</div>
<div class="field__wrap">
<input class="field__input"  name="icity" id="icity"    type="text" placeholder="e. g. Stockholam" value="<?php   echo $propertyInfo['city_i'];  ?>"   style=" border-color:#353945; color:grey;">
</div>
</div>
</div>
</div>
							</div>
							<input type="hidden" id="is_headquarter" name="is_headquarter" value="1" />
								<input type="hidden" id="invoice_address" name="invoice_address" value="1" />
								<input type="hidden" id="delivery_address" name="delivery_address" value="1" />
								
								<input type="hidden" id="indexing_save" name="indexing_save" />
							<div id="errorMsg" class="fsz20 red_txt padtb20">	 </div>
