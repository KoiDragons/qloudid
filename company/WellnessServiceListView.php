<head>
   ...
   function updateMenu(id)
   {
	   ...
	   menuCategory=0;
		...
		{
			window.location.href ="https://www.safeqloud.com/company/index.php/Wellness/servicesDescription/<?php echo $data['cid']; ?>/<?php echo $data['wid']; ?>";
		}		
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
													...
													<div class="sidebar_prdt_bx marr20 brdb padb20">
														<div class="white_bg tall">
															...
															<!-- Logo -->
																...
																<!-- Meta -->
																<div class="padt20 fsz30"> <span>Wellness</span>  </div>
															</a>																	
																	</div> 																</div>
													</div>		
													<div class="clear"></div>
						...
						<a href="#" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space" >Mobile menu </span> 
					...
					<div class="wi_500p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl0 xs-pad0">
						...
						<div class="tab-header martb0 padb10 xs-talc  nobrd talc">
							  ...
							  <?php  foreach($completeServiceInfo as $category => $value) 
										 ...
										 <?php $i=0; foreach($value['dishes'] as $category => $value2) 
														{
															 
														?>	
														
										<a href="../../deleteMenuItem/<?php echo $data['cid']; ?>/<?php echo $data['wid']; ?>/<?php echo $value2['enc']; ?>">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php   echo $value['category_name']; ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php   echo $value2['dish_name']; ?>(<?php   echo ($value2['time_required']*15).' minutes'; ?>)</span>  </div>
