 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Unrefined</div>
                                      </a>
									       <a class="categories__item    " href="../../listRefinedProperties/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Refined</div>
                                      </a>
...
<input class="upload__input" type="hidden" name="bid" id="bid"  value="<?php echo $data['bid']; ?>"/>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">Aparment <?php echo $value['apartment_number']; ?></div>
                ...
                <div class="description__parameter" style="margin-top: 0px;">
                  ...
                  </svg>$<?php  echo $value['sale_price']; ?> Sale price</div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>$<?php  echo $value['price_m2']; ?> Price per m2</div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  if($value['orientation']==1) echo 'East'; else if($value['orientation']==2) echo 'West'; else if($value['orientation']==3) echo 'North'; else if($value['orientation']==4) echo 'South'; ?> orientation</div>
              </div>
				   
				   
				   <a href="../../refineApartment/<?php echo $data['cid'];?>/<?php echo $data['bid'];?>/<?php echo $value['enc'];?>" style="text-decoration:none;" >
