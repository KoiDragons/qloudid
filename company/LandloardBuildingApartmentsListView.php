 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			      <a class="categories__item    " href="../../listImportedProperties/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 " style="color:black;">Refined</div>
                                      </a>
									  
									  
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_f67f00 ">Published</div>
                                      </a>
...
<input class="upload__input" type="hidden" name="bid" id="bid"  value="<?php echo $data['bid']; ?>"/>
                ...
                <div class="nav"><a class="nav__link  changedText" href="javascript:void(0);"  >Prepare</a> <a class="nav__link changedText active" href="#"  >Published</a> <a class="nav__link changedText" href="#"  >Reserved</a><a class="nav__link changedText" href="#"  >Occupied</a></div>
		  ...
		  <div class="flights__sorting  hidden-xxs" style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
								foreach($getLandloardApartmentPropertyList as $category => $value) 
										{
											
										 foreach($value['apartment_details'] as $category2 => $value1) { 
										 ?> 
    ...
    margin-bottom: 0px;
">       <?php if($value1['is_reserved']==1) { ?>
                   <a href="javascript:void(0);" style="text-decoration:none;">
			<?php } else { ?>
  <a href="../../reserveLandloardApartment/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $value1['enc']; ?>" style="text-decoration:none;">
			<?php } ?>
				   <div class="flight__title changedText fsz30 xsi-fsz23" style="color:white;">Apartment <?php echo $value1['office_apartment_number']; ?></div></a>
...
">
                <div class="description__parameter" style="">
                  ...
                  </svg><span class="changedText"><?php echo $value['bedroom_count']; ?> bedroom and kitchen</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText">Floor <?php echo $value1['floor_number']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
