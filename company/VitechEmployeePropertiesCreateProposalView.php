...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 changedText" href="../wishlistDetail/<?php echo $data['cid']; ?>" style="
         ...
         <div class="travel__list xs-marb0 " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Add guest personal phone number to send the proposal.
</div>
...
<form class="checkout__item js-tabs-item" action="../sendProposal/<?php echo $data['cid']; ?> " method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="field__wrap">
<input class="field__input xs-fieldData"  name="pnumber" id="pnumber"    type="text"  placeholder="e. g. xxxxxx1234" style="color:grey;">
</div>
</div>
</div>
 </div>
