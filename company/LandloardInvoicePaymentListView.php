 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Payments</a></li>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Payment received</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link " href="#">Payments</a> </div>
		  ...
		  <div class="flights__sorting hidden-xxs " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
               ...
               <div class="flights__container" style="padding-left:0px;">
				...
				<?php $i=1; 
								foreach($landloardPaymentReceived as $category => $value) 
										{
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title wi_30" style="font-size:20px; color:white; margin-bottom: 0px;"><?php if($value['payment_method']==1) echo 'Cash'; else if($value['payment_method']==2) echo 'Card';  else if($value['payment_method']==3) echo 'Bank transfer';?></div>
...
">
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php if($value['invoice_matched']==0) echo 'Pending'; else echo 'Completed'; ?></div>
                <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo date('Y-m-d',$value['payment_date']); ?></div>
				  
				  <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>$<?php echo $value['total_payment']; ?></div>
                
              </div>
			  <?php if($value['invoice_matched']==0) { ?>
                         <a href="../matchInvoice/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;" >
