...
function changeBG(link,id)
		{
		 $('.black_brd').addClass('brd_1');
		$('.black_brd').removeClass('black_brd');
		
		if(id==1)
		{
			$('.prsnt').removeClass('brd_1');
			$('.prsnt').addClass('black_brd');
		$('#present').attr('style','display:block;');
		$('#absent').attr('style','display:none;');		
		}
		else
		{
		$('.absnt').removeClass('brd_1');
		$('.absnt').addClass('black_brd');
		$('#present').attr('style','display:none;');
		$('#absent').attr('style','display:block;');	
		}
		}
		...
		<div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 visible-xs xs-white_bg">
			...
			<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="../employeeAtendence/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
								</li>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45   padb10 blue_67cff7 trn ffamily_avenir"  >Status</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" > Pls select what you would like to report/request.</a></div>
							
										<div class="column_m container  marb10   fsz14 dark_grey_txt">	
											<a href="#" onclick="changeBG(this,1);">	
											<div class=" white_bg  mart5 brdrad3 brd_1 bg_fffbcc_a marb0 prsnt" style="">
										<div class="container pad20 xs-pad10 xs-padt10 xs-padb10  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_10 xxs-wi_20 sm-wi_10 xsip-wi_10 marr15 xs-mar0 "> <div class="wi_40p xs-wi_50p hei_40p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz36   brdrad1000 yellow_bg_a lgtgrey2_bg" style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%; border-radius: 10%;"> <span class="fas fa-exclamation-triangle  red_txt"></span> </div>
																	</div>
													
													<div class="fleft wi_60 xxs-wi_80 sm-wi_60 xsip-wi_60 xs-mar0 ">
													
													
													 <span class="edit-text padt10 jain2 dblock brdb brdclr_lgtgrey2 fsz16 ffamily_avenir">Sick (Not available)</span>  </div>
								...
								<div class="column_m container  marb10   fsz14 dark_grey_txt">	
											<a href="#" onclick="changeBG(this,2);">	<div class=" white_bg  mart5 brdrad3 brd_1 bg_fffbcc_a marb0 absnt" style="">
										<div class="container pad20 xs-pad10 xs-padt10 xs-padb10  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_60 xxs-wi_80 sm-wi_60 xsip-wi_60 xs-mar0 ">
													 ...
													 <span class="edit-text padt10 jain2 dblock brdb brdclr_lgtgrey2 fsz16 ffamily_avenir">Vacation (For specific period)</span>  </div>
											...
											<div class="padt5 xxs-talc talc" id="present" style="display:none;">
								
								<a href="../reportEmployeeSickLeave/<?php echo $data['cid']; ?>"><button type="button" name="forward" class="forword minhei_55p bgclr_seggreen_47E2A1 fsz18 trn ffamily_avenir" >Submit</button></a>
								
							</div>	
												
							<div class="padt5 xxs-talc talc" id="absent" style="display:none;">
								
								<a href="../reportEmployeeVacation/<?php echo $data['cid']; ?>"><button type="button" name="forward" class="forword minhei_55p bgclr_seggreen_47E2A1 fsz18 trn ffamily_avenir"  >Submit</button></a>
