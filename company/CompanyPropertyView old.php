			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20" id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  >Offices</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" > Offices with same company identification number.</a></div>
									<div class="on_clmn padb10 padb10 brdb_new brd_width_2 red_ff2828_brdclr">
											 
											 
												<a href="../locationInformation/<?php echo $data['cid']; ?>"><input type="button" value="Click here to Add" class="wi_100 mart5 maxwi_100 brdrad3 hei_50p diblock nobrd red_ff2828_bg fsz18 white_txt curp"></a>
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="column_m container  marb0   fsz14 dark_grey_txt">
											...
											<div class=" white_bg  bg_fffbcc_a marb5 brdb" style="">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3   fsz12">
													...
													<div class="fleft wi_50p marr15 hidden "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	...
																	border-radius: 10%;"><?php echo substr(html_entity_decode($headquarterDetail['property_name']),0,1); ?></div>
																	</div>
													
													<div class="fleft wi_85 xxs-wi_100"> <span class="trn fsz18 bold" data-trn-key="Huvudkontor">Huvudkontor</span>
													
													
													 <a href="../editProperty/<?php echo $data['cid'].'/'.$headquarterDetail['enc']; ?>" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text jain2 dblock   brdclr_lgtgrey2 fsz14"><?php echo $headquarterDetail['visiting_address']; ?></span></a> </div>
													<?php if($headquarterDetail['count']==0 || $headquarterDetail['rent_permises']==0 || $headquarterDetail['offer_education']==0 || $headquarterDetail['add_employee']==0) { ?>
													 <div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl10 fsz40  padb0  hidden-xs">
														<a href="../../CompanyProperty/todoInfo/<?php echo $headquarterDetail['enc']; ?>"><span class="fas fa-arrow-alt-circle-right txt_cfdbea"></span></a>
													</div>
													 <?php } else { ?>
													 <div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl10 fsz40  padb0  hidden-xs">
														<a href="../../CompanySuppliers/companyAccount/<?php echo $headquarterDetail['enc']; ?>"><span class="fas fa-arrow-alt-circle-right txt_cfdbea"></span></a>
													</div>
													 <?php } ?>
													<div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz35 grey_txt  padb0 hidden ">
														<a href="../editProperty/<?php echo $data['cid'].'/'.$headquarterDetail['enc']; ?>"><span class="far fa-edit grey_txt  "></span></a>
													</div>
												</div>
							...
							<div class="column_m container  mart0 fsz14 dark_grey_txt">
									...
									<div id="pending">
												...
												<div class=" white_bg marb5 bg_fffbcc_a brdb" style="">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3   fsz12">
													...
													<div class="fleft wi_50p marr15   hidden"> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg " style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"><?php echo substr(html_entity_decode($value['property_name']),0,1); ?></div>
																	</div>
													
													<div class="fleft wi_85 xxs-wi_100"> <span class="trn fsz18 bold" data-trn-key="Kontor">Kontor</span>
													
													
													 <a href="../editProperty/<?php echo $data['cid'].'/'.$value['enc']; ?>" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text jain2 dblock   brdclr_lgtgrey2 fsz14"><?php echo $value['visiting_address']; ?></span></a> </div>
													 	<?php if($value['count']==0 || ($headquarterDetail['rent_permises']==1 && $value['rent_permises']==0)) { ?>
														 <div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl10 fsz40  padb0 hidden-xs">
														<a href="../../CompanyProperty/officesTodo/<?php echo $value['enc']; ?>"><span class="fas fa-arrow-alt-circle-right txt_cfdbea"></span></a>
													</div>
														<?php } else { ?>
													 <div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl10 fsz40  padb0  hidden-xs">
														<a href="../../CompanyOffices/companyAccount/<?php echo $value['enc']; ?>"><span class="fas fa-arrow-alt-circle-right txt_cfdbea"></span></a>
													</div>
														<?php } ?>
													<div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz35  padb0  hidden">
														<a href="../editProperty/<?php echo $data['cid'].'/'.$value['enc']; ?>"><span class="far fa-edit grey_txt  "></span></a>
													</div>
												</div>
											...
											<div class="clear"></div>
									<div class="padtb20 talc <?php if($locationCount['num']<=5) echo 'hidden'; ?>">
