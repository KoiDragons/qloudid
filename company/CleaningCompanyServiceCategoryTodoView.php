...
<html>
	...
	<head>
		...
		<script>
		function updateServiceCategoryAvailable(id,id1) 
		{
			company_id="<?php echo $data['cid']; ?>";
			service_id="<?php echo $data['sid']; ?>";
			categ_id="<?php echo $data['catg_id']; ?>";
			serviceCategoryAvailable=1;
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updateCategoryServiceTodo/<?php echo $data['cid']; ?>/<?php echo $data['sid']; ?>/<?php echo $data['catg_id']; ?>",
							data:send_data,
							dataType:"text",
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updateCategoryServiceAllTodos/<?php echo $data['cid']; ?>/<?php echo $data['sid']; ?>/<?php echo $data['catg_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir"  ><?php echo substr($serviceTypeInfo['service_type_name'],0,10); ?></h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Please check/uncheck available service todos for <?php echo  $categoryTypeInfo['category_name']; ?></a></div>
					 ...
					 <div class="clear"></div>
								 <div class="on_clmn    brdb">
									...
									<div class="thr_clmn  wi_75 ">
										...
										<input type="text" value="If <?php echo  $categoryTypeInfo['category_name']; ?> is available?" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" readonly="">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  <?php if($categoryTypeInfo['is_available']==1) echo 'checked'; else echo ''; ?>" onclick="updateServiceCategoryAvailable(1,this);">
						 ...
						 <div class="<?php if($categoryTypeInfo['is_available']==0) echo 'hidden'; ?>" id="todoInfo">
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Select todos" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Service todos</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Update service todos available for customers</span> 
													 </div>
