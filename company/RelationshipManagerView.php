...
<html class="white_bg">
	...
	<body class="fsz14 white_bg">
		...
		<div class="fright xs-dnone visible_si padt10">
					<ul class="mar0 pad0">
						<li class="dblock hidden-xs visible_si fright pos_rel brdl "> <a href="../../../CompanyProperty/locationAccount/<?php echo $data['cid']; ?>" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Stäng sidan" data-sw="Stäng sidan">Stäng sidan</a> </li>
					</ul>
				</div>
			...
			<div class="visible-xs visible-xxs fright marr0 xs-padt5 "> <a href="../../../CompanyProperty/locationAccount/<?php echo $data['cid']; ?>" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Close</a> </div>
			<div class="clear"></div>
		</div>
	</div>
		...
		<div class="column_m container zi5 mart40 xs-mart20 white_bg" onclick="checkFlag();">
								...
								<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03  brdr_new fsz14" id="scroll_menu">
									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock  padl8 ">
											<a href="../../../SecurityLevel/companyAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class="dblock pos_rel padtb10 brdclr_hgrey hidden">
										...
										<li class=" dblock pos_rel padtb10   brdclr_hgrey brdclr_pblue2_a">
										 ...
										 <li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="../../../CompanyTenant/landloardRequest/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Min hyresvärd</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<?php 
												...
												<?php if($getAppsPermissionDetail['id']==$value['id']) { ?>
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey   greyblue_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn"><?php echo $value['app_name']; ?></span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p greyblue_bg rotate45"></div>
													</a>
												</li>
												<?php } else { ?>
												<li class="dblock padrb10">
													<a href="../../productPage/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn"><?php echo $value['app_name']; ?></span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<?php } } ?>
				...
				<div class="column_m container zi1 padb5">
								...
								<div class="white_bg tall">
									...
									<?php if($getAppsPermissionDetail['app_id']==29) {  if($apartmentInfo['num']==1) { ?>
									<div class="hidden-xs hidden-sm padrl10">
									<a href="<?php echo $getAppsPermissionDetail['app_link'].''.$data['cid']; ?>" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt" >
										
										<span class="valm"> Besök </span>
									</a> 
								</div>
									<?php } else { ?>
									<div class="hidden-xs hidden-sm padrl10">
									<a href="../../../CompanyApartments/apartmentInfo/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt" >
										
										<span class="valm"> Get started </span>
									</a> 
								</div>
									<?php } }  else { ?>
								<div class="hidden-xs hidden-sm padrl10">
		...
		<div class="column_m pos_rel">
								...
								<div class="column_m pos_rel  padtb0 yellow_bg_crm  xs-padrl0">
