...
<div class="column_m header xs-header bs_bb lgtgrey2_bg">
		...
		<div class="fright xs-dnone visible_si padt10">
					<ul class="mar0 pad0 fsz14">
						...
						<li class="dblock hidden-xs visible_si fright pos_rel brdl "> <a href="https://www.qloudid.com/user/index.php/Arbetsplats/minArbetsplats" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Stäng sidan" data-sw="Stäng sidan">Stäng sidan</a> </li>
			...
			<div class="visible-xs visible-xxs fright marr0 xs-padt5 "> <a href="https://www.qloudid.com/user/index.php/Arbetsplats/minArbetsplats" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Close</a> </div>
			<div class="clear"></div>
		</div>
	</div>
