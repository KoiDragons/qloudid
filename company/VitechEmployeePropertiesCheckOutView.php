         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Here is a list of guest checked-out</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Checked-out</div>
                                      </a>
			  ...
			  <div class="sorting__foot">
                <div class="nav"><a class="nav__link  changedText" href="../guestReservationList/<?php echo $data['cid']; ?>">Reservation</a>  <a class="nav__link changedText" href="../reservationCheckedInList/<?php echo $data['cid']; ?>">Checked in</a><a class="nav__link changedText active" href="#">Checked out</a></div>
