...
<html lang="en">
	...
	<head>
		...
		<div class="fright xs-dnone visible_si padt10">
			...
			<div class="visible-xs visible-xxs fright marr0 xs-padt10 "> <a href="https://www.safeqloud.com/company/index.php/ChilldCare/childCareNews/<?php echo $data['cid']; ?>" class="diblock padrl20 brdrad3  lgn_hight_29 fsz14 black_txt">Close</a> </div>
			<div class="clear"></div>
		</div>
	</div>
				...
				<div class="padrl10 white_bg xs-padrl25">
					<div class="wrap maxwi_100   xs-nobrdb xs-padt15 xs-padb0 mart40 xs-mart0">
							...
							<div class="wi_500p maxwi_100  pos_rel zi5 marrla pad10  xs-pad0  ">
								...
								<h3 class="marb0  xxs-talc talc fsz35 xs-fsz25 bold marb5 black_txt trn" >Registrera ett nytt barn</h3>
															<div class="padb20 padt10 xxs-talc talc"> <a href="#" class="black_txt fsz20 xs-fsz20 xxs-talc talc edit-text jain_drop_company trn " >Fyll i uppgifter nedan och lägg till en bild.</a></div>
