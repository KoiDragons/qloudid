...
<html lang="en">
	...
	<head>
		...
		<div class="fright xs-dnone visible_si padt10">
			...
			<div class="visible-xs visible-xxs fright marr0 xs-padt10 "> <a href="https://www.qloudid.com/company/index.php/ChilldCare/childCareNews/<?php echo $data['cid']; ?>" class="diblock padrl20 brdrad3  lgn_hight_29 fsz14 black_txt">Close</a> </div>
			<div class="clear"></div>
		</div>
	</div>
