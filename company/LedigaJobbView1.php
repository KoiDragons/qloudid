...
<?php 
	...
	function togglePopup()
	{
		...
		<div class="clear" id=""></div>
							...
							<p class="pad0 xs-padb10 talc fsz22 xs-fsz20 padb0 wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 ">Karriärsida för er företagskultur</p>
								...
								<div class="bsa_bb txt_0_87" id="keep">
									<form>
										<?php $i=0;  foreach($appsDetail as $category => $value)  { ?> 
											<!-- keep block -->
											<form action="#" method="post" name="save_indexing<?php echo $value['id'];?>" id="save_indexing<?php echo $value['id'];?>" accept-charset="ISO-8859-1">
								<div class="column_m  marb10 white_bg fsz14 dark_grey_txt" id="scroll-section-<?php echo $value['id'];?>">
									<div class="container padb30 fsz25">
										<div class="padb10 brdb_new"><?php echo html_entity_decode($value['heading']);?></div>
										<div class="padt10"><textarea class="texteditor "  id="a<?php echo $value['id'];?>" name="a<?php echo $value['id'];?>">
										</textarea></div>
			...
			<script type="text/javascript" src="<?php echo $path; ?>html/keepcss/js/ledigajobb_keep.js"></script>
			<script src="<?php echo $path; ?>html/usercontent/js/tinymce/tinymce.min.js"></script>
	<script>
		var tinyMCE_options = {
			selector: '.texteditor',
