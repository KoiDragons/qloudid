...
<h2 class="product__title h2   tall        xs-tall uppercase changedText" style="font-size:60px; line-height: 70px !important; font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Reservation
</h2>

<h2 class="main__info info  tall  padb20 xs-padt20 changedText" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Add guest information below to complete the reservation
</h2>
...
<div class="checkout__category changedText">Company address and card details only</div>
...
<div class="checkout__section xsi-nobrdt padt32 xsi-padt0" style="margin-top:0px; padding-top24px;  padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../../../../updateUserCompanyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['aid']; ?>/<?php echo $data['booking_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
<div class="checkout__fieldset">
 
 <div class="checkout__fieldset" style="border-top: 2px solid #353945; padding-top:24px;">
...
<input class="field__input" name="company_name" id="company_name"    type="text"  placeholder="e. g. Demo"  style=" color:grey;">
</div>
</div>
</div>
<div class="upload__col upload__col_w30">
<div class="field">
<div class="field__label" style="color:#787f91;">Company identification number</div>
<div class="field__wrap">
<input class="field__input"  name="cid_number" id="cid_number"  placeholder="e. g. 12345678"   type="text"   style=" color:grey;">
</div>
</div>
</div>
 </div>
...
<div class="field__wrap">
<input class="field__input" name="d_address" id="d_address"    type="text"  placeholder="e. g. Mjorbekan"  style=" color:grey;">
</div>
</div>
</div>
<div class="upload__col upload__col_w30">
...
<div class="field__wrap">
<input class="field__input"  name="dpo_number" id="dpo_number"  placeholder="e. g. 121"   type="text"   style=" color:grey;">
</div>
</div>
</div>
 </div>
...
<div class="field__label changedText" style="color:#787f91;">Name on card</div>
<div class="field__wrap">
<input class="field__input" name="name_on_card" id="name_on_card"  placeholder="e. g. Name of the cardholder"   type="text"    >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="cvv_number" id="cvv_number"    type="text" placeholder="e. g. 121"   >
</div>
</div>
