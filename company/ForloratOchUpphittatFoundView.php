				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb25">
								...
								<div class="padb0 xxs-padb0 hidden">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn">Förlorad</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Vill du ange ditt objekt som borttappad och förlorad</a></div>
								 								
									<form action="../../updateLostValue/<?php echo $data['cid']; ?>/<?php echo $data['id']; ?>" method="POST" name="save_indexing" id="save_indexing"  accept-charset="ISO-8859-1">
								...
								<div class="pos_rel">											
									...
									<div class="talc marb40 "> <a href="#" onclick="sendInformation();"><input type="button" value="Lägg till" class="forword minhei_55p red_ff2828_bg fsz18 trn ffamily_avenir"  ></a>
