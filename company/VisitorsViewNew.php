...
var dict = {
	...
	function changeClass(link)
			...
			{
				$("#error_msg_form").html('');
				if($("#collaborators-lookup").val()=='' || $("#collaborators-lookup").val()==null) 
				{
					$("#error_msg_form").html('Please fill in a name.');
					
					return false;
				}
				if($("#ind").val()=="" || $("#ind").val()==0 || $("#ind").val()==null)
				{
					$("#error_msg_form").html('The person you are looking for is not registered.');
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../visitorsIp/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100   xxs-fsz45 padb10 trn ffamily_avenir" style="color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000000"; else echo $corporateColor['bg_color']; ?>">Notify</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Enter the name of the person to visit…</a></div>
						...
						<div class="collaborator-row dflex alit_c pos_rel">
							...
							<form action="../../visitorsInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" method="POST" name="collaborators-form" id="collaborators-form">
							 
									 
									<div class="on_clmn mart10 xxs-mart10 marb35">
											 
										<div class="pos_rel">
										<input type="text" name="empname"  placeholder="Full name" id="collaborators-lookup" class=" wi_100 nobrdt nobrdl nobrdr pad10  red_f5a0a5_txt brdb_red_ff2828 talc  minhei_65p fsz18  xxs-minhei_60p ffamily_avenir"   onkeyup="updateForm();">
									</div>
									</div>
							...
							<div class="padtb20 xxs-talc talc">
								...
								<button type="button" name="forward" class="forward hei_55p fsz18 trn ffamily_avenir" onclick="informEmployee();" style="background:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000000"; else echo $corporateColor['bg_color']; ?>">Next</button>
	...
	<div class="popup_modal wi_300p maxwi_90 pos_fix pos_cen zi50 bs_bb  fsz14 brdrad10 popup_shadow lgtgrey2_bg" id="person_informed">
		<div class="modal-content nobrdb talc box_shadox brdrad10 lgtgrey2_bg">
			...
			<div class="pad25 lgtgrey2_bg brdradtr10">
				<img src="<?php echo $path; ?>html/usercontent/images/no_result_found.png" class="maxwi_100 hei_150p">
			</div>
			<h2 class="marb0 padrl10 padt25 bold fsz24 black_txt ffamily_avenir">Du måste....</h2>
			...
			<div class="wi_100 dflex fxwrap_w marrla marb20 tall padrl20">
				...
				<div class="wi_100 marb0 talc">
					...
					<span class="valm fsz16 black_txt ffamily_avenir"> Skriva i namnet på den du ska träffa så vi kan meddela din ankomst till rätt person.
								mark as todo.. </span>
				</div>
	...
	<div class="popup_modal wi_300p maxwi_90 pos_fix pos_cen zi50 bs_bb lgtgrey_bg fsz14 brdrad10 popup_shadow" id="gratis_popup_nouser">
		<div class="modal-content nobrdb talc box_shadox brdrad10 lgtgrey_bg">
			...
			<div class="pad25 lgtgrey_bg brdradtr10">
				<img src="<?php echo $path; ?>html/usercontent/images/netcliparteyes.png" class="maxwi_100 hei_150p">
			</div>
			<h2 class="marb0 padrl10 padt25 bold fsz24 black_txt trn ffamily_avenir">Oh no...</h2>
			...
			<div class="wi_100 dflex fxwrap_w marrla marb20 tall padrl20">
				...
				<div class="wi_100 marb0 talc">
					...
					<span class="valm fsz16 black_txt trn ffamily_avenir">The person you are looking for is not registered. Try a new name or contact the staff.</span>
				</div>
				
				
			</div>
			<div class="on_clmn padt20">
				<a href="#"  class="padt15 trn close_popup_modal wi_300p maxwi_100 brdradbl10 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp bold ffamily_avenir">Close</a>
