  ...
  function submitform()
		{
		 ...
		 if(isNaN($("#cvv").val()))
				...
				var cvalue=$('#card_number2').val();
				var exp=$('#expiry_month').val()+''+($('#expiry_year').val()/100);
				var ccv=$('#cvv').val();
...
<a class="header__logo xs-fsz20 changedText " href="../../../Brand/brandAccount/<?php echo $data['cid']; ?>" style="
...
<div class="travel__center center   padb136 xs-padrl25" style="border-bottom:2px solid #23262F;  max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px; margin-bottom:100px; padding-bottom:80px;">
   
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:180px;">
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Fill in below details to complete the payment
</div>
...
<form class="checkout__item js-tabs-item" action="../../../chargeCard/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
  
  
					 
						 <input type="hidden" id="subscription_id" name='subscription_id' value='<?php echo $data['sub_id'];?>' />
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
                        ...
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Licence required</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="licence_required" id="licence_required" placeholder="e. g. 120" value="1" min=1 style=" color:grey;"  >
                            </div>
                          </div>
						  ...
						  <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="discount_coupon" id="discount_coupon" placeholder="e. g. 120" value="" style=" color:grey;"  >
                            </div>
                          </div>
...
<div class="field__wrap">
<input class="field__input" name="card_number2" id="card_number2"  placeholder="e. g. xxxxxxxxxxxxxxxx"   type="text"    >
</div>
</div>
...
<div class="hidden">
  <script src="https://checkout.stripe.com/checkout.js" class="stripe-button button checkout__button  "
