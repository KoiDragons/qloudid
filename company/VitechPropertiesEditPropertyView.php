...
<a class="header__logo xs-fsz20 changedText " href="../../../<?php if($fetchPropertyContacTInfo['property_status']==3) { echo 'listEmployeesCreatedProperties'; } else echo 'listEmployeesProperties';  ?>/<?php echo $data['cid']; ?>" style="
...
<!-- outer content-->
<div class="outer__inner xs-mart65 mart100" >
<div class="section setting js-tabs" style="padding-top:0px;">
         <div class="setting__center center xs-padrl25" >

 <div class="setting__head visible-xs">
                    <h2 class="setting__title h2 uppercase" style="font-size:45px;">Property info</h2> 
                  </div>
 
 <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;">
              <select class=" " style="height: 48px;
    padding: 0 10px; border-color: #353945;
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
                <option value="#" selected>Basic details</option>
				<option value="../../../editPropertyContractInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" >Exclusive</option>
                <option value="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">Photos</option>
				<?php if($fetchPropertyContacTInfo['property_status']==3) { ?>
				  <option value="../../../perNightPricingList/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">Night price</option>
                <option value="../../../foreignPropertyHouseRule/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">House rules</option>
              
					<option value="../../../arrivalInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" >Arrival details</option>
					<option value="../../../brokerFeeDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" >Broker fee</option>
				<option value="../../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">Broker to Broker</option>
				<?php } ?>
				<option value="../../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">Publish</option>
					<?php if($fetchPropertyContacTInfo['property_status']==2 && $fetchPropertiesAddress['is_reserved']==1) { ?>
				<option value="../../../updateSoldInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>Sell property</option>
				 
				<?php } else if($fetchPropertyContacTInfo['property_status']==2 && $fetchPropertiesAddress['is_reserved']==0) { ?>
					<option value="../../../updateSellInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>Reserve property</option>
...
<div class="upload__wrap  " style="background:transparent;  padding-right:128px;">
                 <div class="setting__menu" style="background:transparent; border:1px solid #353945;">
				 
			
				<a class="setting__link  active" href="#">
                <svg class="icon icon-bell">
                  <use xlink:href="#icon-bell" style="fill:#f67f00;"></use>
                </svg><span style="color:#f67f00">Basic details </span></a>
				<a class="setting__link " href="../../../editPropertyContractInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../editPropertyContractInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-lock">
                  <use xlink:href="#icon-lock"></use>
                </svg>Exclusive</a>
			 
				<a class="setting__link " href="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-lock">
                  <use xlink:href="#icon-lock"></use>
                </svg>Photos</a>
				<?php if($fetchPropertyContacTInfo['property_status']==3) { ?>
				<a class="setting__link " href="../../../perNightPricingList/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../perNightPricingList/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card"></use>
                </svg>Night price</a>
				 <a class="setting__link  " href="../../../foreignPropertyHouseRule/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../foreignPropertyHouseRule/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-lock">
                  <use xlink:href="#icon-lock"></use>
                </svg>House rules</a>
				
				<a class="setting__link  " href="../../../arrivalInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../arrivalInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card"></use>
                </svg>Arrival Details</a>
				<a class="setting__link  " href="../../../brokerFeeDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../brokerFeeDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card"></use>
                </svg>Broker fee</a>
				<a class="setting__link  " href="../../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card"></use>
                </svg>Broker to Broker</a>
				<?php } ?>
				
			<a class="setting__link  " href="../../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>"  onclick="updateHeader('../../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card"></use>
                </svg>Publish</a>
				<?php if($fetchPropertyContacTInfo['property_status']==2 && $fetchPropertiesAddress['is_reserved']==1) { ?>
			<a class="setting__link  " href="../../../updateSoldInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../updateSoldInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card"></use>
                </svg>Sell property</a>
				 
				<?php } else if($fetchPropertyContacTInfo['property_status']==2 && $fetchPropertiesAddress['is_reserved']==0) { ?>
				<a class="setting__link  " href="../../../updateSellInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../updateSellInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                <svg class="icon icon-credit-card">
                  <use xlink:href="#icon-credit-card"></use>
                </svg>Reserve property</a>
				<?php } ?>
				 </div>

				</div>
      
<div class="upload__wrapper  "  style="padding-right:0px;" >
<div class="checkout__list">
 
<div class="setting__head">
                    <h2 class="setting__title h2" style="font-size:25px;">Basic details</h2><a class="button-stroke button-small setting__button" href="../../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" style="background:#f67f00; color:#000000;">View</a>
                  </div>
<form class="checkout__item js-tabs-item" action="../../../updateVitechAdddressinforamtion/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
						<div class="upload__item">
							
                     
					   <input class="" type="hidden" name="property_status" id="property_status" value="<?php echo $fetchPropertiesAddress['property_status']; ?>" />
                             
						   <div class="upload__row hidden">
                          <div class="upload__col upload__col_w70">
                            <div class="upload__label">price</div>
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="number" name="sell_price" id="sell_price" placeholder="e. g. &quot;180&quot;" value="<?php echo $fetchPropertyTaskInfo['owner_sell_price']; ?>" required>
                                  </div>
                                </div>
                              </div>
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <select class=" " id="currency_type" name="currency_type" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: white; width:100%;">
                                      <option value="1" <?php if($fetchPropertyTaskInfo['currency_type']==1) echo 'selected'; ?>>$ USD</option>
                                      <option value="2" <?php if($fetchPropertyTaskInfo['currency_type']==2) echo 'selected'; ?>>� EUR</option>
                                    </select>
                                  </div>
                                </div>
                              </div>
						  ...
						  <?php if($fetchPropertyTaskInfo['property_status']==1){ ?>
						  <div class="upload__col upload__col_w30 " id="status_info">
                            <div class="upload__label">Selling date</div>
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="date" name="sold_on" id="sold_on" value="<?php echo date('Y-m-d',strtotime($fetchPropertyTaskInfo['owner_sell_date'])); ?>" style=" color:grey;"  >
                                  </div>
                                </div>
                              </div>
					   ...
					   <div class="checkout__subtitle">Property type</div>
                       
                      </div>
                      <div class="upload__fieldset ">
					   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Property heading</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="sell_phrase" id="sell_phrase" value="<?php echo $fetchPropertyTaskInfo['shortSaleDescription']; ?>" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" style=" color:grey;"  >
                            </div>
                          </div>
					    <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Object type</div>
                            <div class="field__wrap">
                               <select class=" "   id="property_type" name="property_type" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								   <option value="House" <?php if($fetchPropertiesAddress['propertyType']=='House') echo 'selected'; ?>>House</option>
											<option value="Apartment" <?php if($fetchPropertiesAddress['propertyType']=='Apartment') echo 'selected'; ?>>Apartment</option>
											<option value="Lodge" <?php if($fetchPropertiesAddress['propertyType']=='Lodge') echo 'selected'; ?>>Lodge</option>
											<option value="Cottage" <?php if($fetchPropertiesAddress['propertyType']=='Cottage') echo 'selected'; ?>>Cottage</option>
											<option value="Cabin" <?php if($fetchPropertiesAddress['propertyType']=='Cabin') echo 'selected'; ?>>Cabin</option>
											<option value="Chalet" <?php if($fetchPropertiesAddress['propertyType']=='Chalet') echo 'selected'; ?>>Chalet</option>
											<option value="Wigwam" <?php if($fetchPropertiesAddress['propertyType']=='Wigwam') echo 'selected'; ?>>Wigwam</option>
											<option value="Barn" <?php if($fetchPropertiesAddress['propertyType']=='Barn') echo 'selected'; ?>>Barn</option>
								  </select>
                            </div>
                          </div>
                        ...
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Area(m2)</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="total_area" id="total_area" placeholder="e. g. 120" value="<?php echo $fetchPropertyTaskInfo['livingSpace']; ?>" style=" color:grey;"  >
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">#Floor</div>
                            <div class="field__wrap">
							<select class=" "    name="total_floor" id="total_floor" style="height: 48px;
							padding: 0 14px;  border-color: #353945;
							color: grey; border-radius: 12px;
							background: transparent; width:100%;">
								   <?php for($i=1; $i<=20; $i++) { ?>
											<option value="<?php echo $i; ?>"  <?php if($fetchPropertiesBuilding['totalNumberFloors']==$i) echo 'selected'; ?>><?php echo $i; ?></option>
								   <?php } ?>
								  </select>
						   ...
						   <div class="checkout__row">
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 24px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">#Rooms</div>
                            <div class="field__wrap">
                               <select class=" "    name="rooms_count" id="rooms_count" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								   
											<?php for($i=1; $i<=10; $i++) { ?>
											<option value="<?php echo $i; ?>"  <?php if($fetchPropertiesInterior['numberOfRooms']==$i) echo 'selected'; ?> ><?php echo $i; ?></option>
								   <?php } ?>
								  </select>
                            </div>
                          </div>
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 24px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">#Bathrooms</div>
                            <div class="field__wrap">
                              <select class=" "    name="bathrooms_count" id="bathrooms_count" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								<?php for($i=1; $i<=10; $i++) { ?>
											<option value="<?php echo $i; ?>"  <?php if($fetchPropertiesInterior['numberOfBathrooms']==$i) echo 'selected'; ?> ><?php echo $i; ?></option>
								   <?php } ?>
								  </select>
                            </div>
                          </div>
						  ...
						  <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 24px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">#Bedrooms</div>
                            <div class="field__wrap">
                              <select class=" "   name="bedrooms_count" id="bedrooms_count"  style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								 <?php for($i=1; $i<=10; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php if($fetchPropertiesInterior['numberOfBedrooms']==$i) echo 'selected'; ?>><?php echo $i; ?></option>
								   <?php } ?>
								  </select>
                            </div>
                          </div>
						    ...
						    <div class="checkout__row">
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 24px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">View</div>
                            <div class="field__wrap">
                               <select class=" "    name="property_view" id="property_view" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
									background: transparent; width:100%;">
								   
										 <option value="Not available" <?php if($fetchPropertyTaskInfo['property_view']=='Not available') echo 'selected'; ?>>Select</option>
											<option value="Sea view" <?php if($fetchPropertyTaskInfo['property_view']=='Sea view') echo 'selected'; ?>>Sea view</option>
											<option value="Garden view" <?php if($fetchPropertyTaskInfo['property_view']=='Garden view') echo 'selected'; ?>>Garden view</option>
											<option value="No view" <?php if($fetchPropertyTaskInfo['property_view']=='No view') echo 'selected'; ?>>No view</option>
											<option value="City view" <?php if($fetchPropertyTaskInfo['property_view']=='City view') echo 'selected'; ?>>City view</option>
											<option value="Mountain view" <?php if($fetchPropertyTaskInfo['property_view']=='Mountain view') echo 'selected'; ?>>Mountain view</option>
											<option value="Pool view" <?php if($fetchPropertyTaskInfo['property_view']=='Pool view') echo 'selected'; ?>>Pool view</option>
											<option value="Other" <?php if($fetchPropertyTaskInfo['property_view']=='Other') echo 'selected'; ?>>Other</option>
								   
								  </select>
                            </div>
                          </div>
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 24px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Condition</div>
                            <div class="field__wrap">
                              <select class=" "    name="property_condition" id="property_condition" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								 <option value="Not available" <?php if($fetchPropertyTaskInfo['property_condition']=='Not available') echo 'selected'; ?>>Select</option>
											<option value="Recently renovated" <?php if($fetchPropertyTaskInfo['property_condition']=='Recently renovated') echo 'selected'; ?>>Recently renovated</option>
											<option value="Needs renovation" <?php if($fetchPropertyTaskInfo['property_condition']=='Needs renovation') echo 'selected'; ?>>Needs renovation</option>
											<option value="Well-maintained" <?php if($fetchPropertyTaskInfo['property_condition']=='Well-maintained') echo 'selected'; ?>>Well-maintained</option>
											<option value="Newly built" <?php if($fetchPropertyTaskInfo['property_condition']=='Newly built') echo 'selected'; ?>>Newly built</option>
											<option value="Fair condition" <?php if($fetchPropertyTaskInfo['property_condition']=='Fair condition') echo 'selected'; ?>>Fair condition</option>
						  ...
						  <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 24px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Availability</div>
                            <div class="field__wrap">
                              <select class=" "   name="property_availability" id="property_availability"  style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								 <option value="Not available" <?php if($fetchPropertyTaskInfo['property_availability']=='Not available') echo 'selected'; ?>>Select</option>
											<option value="Ready for immediate move-in" <?php if($fetchPropertyTaskInfo['property_availability']=='Ready for immediate move-in') echo 'selected'; ?>>Ready for immediate move-in</option>
											<option value="Available soon" <?php if($fetchPropertyTaskInfo['property_availability']=='Available soon') echo 'selected'; ?>>Available soon</option>
											<option value="Currently occupied" <?php if($fetchPropertyTaskInfo['property_availability']=='Currently occupied') echo 'selected'; ?>>Currently occupied</option>
											<option value="Under maintenance" <?php if($fetchPropertyTaskInfo['property_availability']=='Under maintenance') echo 'selected'; ?>>Under maintenance</option>
											<option value="Available from" <?php if($fetchPropertyTaskInfo['property_availability']=='Available from') echo 'selected'; ?>>Available from</option>
											<option value="Other" <?php if($fetchPropertyTaskInfo['property_availability']=='Other') echo 'selected'; ?>>Other</option>
								  </select>
                            </div>
                          </div>
                        </div>
						     
					<div class="checkout__row  " style="margin-bottom:24px;">
                          <div class="field" style="margin-bottom:0px;">
                            <div class="field__label  changedText" style="color:#787f91;">Building Class</div>
                            <div class="field__wrap">
                               <select class=" "   id="building_class" name="building_class"   style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
							   <option value="Not available" <?php if($fetchPropertyTaskInfo['building_class']=='Not available') echo 'selected'; ?>>Select</option>
								   <option value="Luxury" <?php if($fetchPropertyTaskInfo['building_class']=='Luxury') echo 'selected'; ?>>Luxury</option>
									<option value="Mid-range" <?php if($fetchPropertyTaskInfo['building_class']=='Mid-range') echo 'selected'; ?>>Mid-range</option>
									<option value="Budget" <?php if($fetchPropertyTaskInfo['building_class']=='Budget') echo 'selected'; ?>>Budget</option>
									<option value="Premium" <?php if($fetchPropertyTaskInfo['building_class']=='Premium') echo 'selected'; ?>>Premium</option>
									<option value="Standard" <?php if($fetchPropertyTaskInfo['building_class']=='Standard') echo 'selected'; ?>>Standard</option>
									<option value="Economy" <?php if($fetchPropertyTaskInfo['building_class']=='Economy') echo 'selected'; ?>>Economy</option>
								  </select>
                            </div>
                          </div>
                          <div class="field" style="margin-bottom:0px;">
                            <div class="field__label  changedText" style="color:#787f91;">Property Furnishings</div>
                            <div class="field__wrap">
                              <select class=" "   id="property_furnishings" name="property_furnishings" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
							    <option value="Not available" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Not available') echo 'selected'; ?>>Select</option>
								  <option value="Full furnishing" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Full furnishing') echo 'selected'; ?>>Full furnishing</option>
								<option value="Kitchen" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Kitchen') echo 'selected'; ?>>Kitchen</option>
								<option value="Built-in wardrobes" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Built-in wardrobes') echo 'selected'; ?>>Built-in wardrobes</option>
									<option value="Bathrooms" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Bathrooms') echo 'selected'; ?>>Bathrooms</option>
									<option value="Partially furnished" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Partially furnished') echo 'selected'; ?>>Partially furnished</option>
									<option value="Unfurnished" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Unfurnished') echo 'selected'; ?> >Unfurnished</option>
									<option value="Custom cabinetry" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Custom cabinetry') echo 'selected'; ?>>Custom cabinetry</option>
									<option value="Conditioner" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Conditioner') echo 'selected'; ?>>Conditioner</option>
									<option value="Heating" <?php if($fetchPropertyTaskInfo['property_furnishings']=='Heating') echo 'selected'; ?>>Heating</option>
								  </select>
                            </div>
                          </div>
                        </div>  
						   ...
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Annual community fee</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="annual_community_fee" id="annual_community_fee" placeholder="<?php echo $fetchPropertyTaskInfo['annual_community_fee']; ?>" style=" color:grey;"  >
                            </div>
                          </div>
						  	...
						  	<script>
									function updateShortTermRentalInfo(link)
										   {
											  body = $('body');
											   if($('#short_term_rental').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												    $('#commissionInfo').addClass('hidden');
												     $(link).attr('checked',''); 
													$('#short_term_rental').val(0);	
													$('#short_term_commision_fee').val(0);	
											   }
											   else
												   {
												   $('#commissionInfo').removeClass('hidden');
												     $('#bodyData').addClass('dark');
												     $(link).attr('checked','checked');  
													 $('#short_term_rental').val(1);
													$('#short_term_commision_fee').val(0);														 
												   }
 ...
 <input type="hidden" id="short_term_rental" name="short_term_rental" value="<?php echo $fetchPropertyTaskInfo['short_term_rental']; ?>"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Short-term Rental Yield</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateShortTermRentalInfo(this);'  <?php if($fetchPropertyTaskInfo['short_term_rental']==1) echo 'checked'; ?>/><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you want to allow shot term rental</div>
                    </div>
                  
				   <div class="field margin-bottom24 <?php if($fetchPropertyTaskInfo['short_term_rental']==0) echo 'hidden'; ?>" id="commissionInfo">
                            <div class="field__label  changedText" style="color:#787f91;">Percentage and figures for short-term rental yield</div>
                            <div class="field__wrap">
							 <select class="" id="short_term_commision_fee" name="short_term_commision_fee" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun">
								  <?php for($i=0; $i<=30; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php if($fetchPropertyTaskInfo['short_term_commision_fee']==$i) echo 'selected'; ?>><?php echo $i; ?>%</option>
								  <?php } ?>	 
								  </select>
						  ...
						  <script>
									function updateLongTermRentalInfo(link)
										   {
											  body = $('body');
											   if($('#long_term_rental').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												    $('#commissionInfo1').addClass('hidden');
												     $(link).attr('checked',''); 
													$('#long_term_rental').val(0);	
													$('#long_term_commision_fee').val(0);	
											   }
											   else
												   {
												   $('#commissionInfo1').removeClass('hidden');
												     $('#bodyData').addClass('dark');
												     $(link).attr('checked','checked');  
													 $('#long_term_rental').val(1);
													$('#long_term_commision_fee').val(0);														 
												   }
 ...
 <input type="hidden" id="long_term_rental" name="long_term_rental" value="<?php echo $fetchPropertyTaskInfo['long_term_rental']; ?>"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Long-term Rental Yield</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateLongTermRentalInfo(this);' <?php if($fetchPropertyTaskInfo['long_term_rental']==1) echo 'checked'; ?>  /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you want to allow long term rental</div>
                    </div>
                  
				   <div class="field margin-bottom24 <?php if($fetchPropertyTaskInfo['long_term_rental']==0) echo 'hidden'; ?>" id="commissionInfo1">
                            <div class="field__label  changedText" style="color:#787f91;">Percentage and figures for long-term rental yield</div>
                            <div class="field__wrap">
							 <select class="" id="long_term_commision_fee" name="long_term_commision_fee" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun">
								  <?php for($i=0; $i<=30; $i++) { ?>
											<option value="<?php echo $i; ?>" <?php if($fetchPropertyTaskInfo['long_term_commision_fee']==$i) echo 'selected'; ?>><?php echo $i; ?>%</option>
								  <?php } ?>	 
								  </select>
						  ...
						  <div class="field">
                          <div class="field__label">Detailed Description of the Location</div>
                          <div class="field__wrap">
                            <textarea class="field__textarea" name="detailed_description" id="detailed_description" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" required=""><?php echo $fetchPropertyTaskInfo['detailed_description']; ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="checkout__row  hidden">
                          <div class="field" style="margin-bottom:0px;">
                            <div class="field__label  changedText" style="color:#787f91;">Private entrance</div>
                            <div class="field__wrap">
                               <select class="select"   id="private_entrance" name="private_entrance"   >
								   <option value="Yes" <?php if($fetchPropertiesAddress['private_entrance']=='Yes') echo 'selected'; ?>>Yes</option>
									<option value="No" <?php if($fetchPropertiesAddress['private_entrance']=='No') echo 'selected'; ?>>No</option>
								  </select>
                            </div>
                          </div>
                          <div class="field" style="margin-bottom:0px;">
                            <div class="field__label  changedText" style="color:#787f91;">Elevator</div>
                            <div class="field__wrap">
                              <select class="select"   id="elevater" name="elevater"  >
								  <option value="Yes" <?php if($fetchPropertiesBuilding['elevator']=='Yes') echo 'selected'; ?>>Yes</option>
											<option value="No" <?php if($fetchPropertiesBuilding['elevator']=='No') echo 'selected'; ?>>No</option>
								  </select>
                            </div>
                          </div>
                        </div>
					...
					<div class="upload__item">
					  <div class="checkout__line  "  style="margin-bottom:24px;">
					   <div class="checkout__subtitle">Location</div>
                       
                      </div>
					   <div class="upload__row">
                          <div class="upload__col upload__col_w70">
                        <div class="field  ">
                            <div class="field__label  changedText" style="color:#787f91;">Address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="addrs" id="addrs"  value="<?php echo $fetchPropertiesAddress['streetAddress']; ?>" placeholder="e. g. Queenstown, Otago, New Zealand" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w30">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Port number</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" id="pnumber" placeholder="e. g. 121" value="<?php echo $fetchPropertiesAddress['areaId']; ?>" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						  </div>
						...
						<div class="upload__row">
                          <div class="upload__col upload__col_w30">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Zip code</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dzip" id="dzip" placeholder="e. g. 120001" value="<?php echo $fetchPropertiesAddress['zipCode']; ?>" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						   <div class="upload__col upload__col_w70">
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">City</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dcity" id="dcity"  placeholder="e. g. Stockholam" value="<?php echo $fetchPropertiesAddress['postTown']; ?>" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						   </div>
						   ...
						   <div class="field" style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                               <select class=" "   id="country" name="country"  style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								  <?php foreach($countryList as $category => $value) { ?>
											<option value="<?php echo $value['country_name']; ?>" <?php if($fetchPropertiesAddress['country']==$value['country_name']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
											 <?php } ?>
								  </select>
                            </div>
                          </div>
...
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="informEmployee();">Submit</a>
</form>
