...
<script>
 ...
 function selectService(id)
					...
					$.ajax({
						type:"POST",
						url:"../../selectAddedService/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
							
							$('.serviceList').html(data1);
 ...
 function informEmployee()
			{
				$("#error_msg_form").html('');
				if($("#responsible_for_property").val()=='' || $("#responsible_for_property").val()==null)
				{
...
<a class="header__logo xs-fsz25 changedText" href="../../viewPropertyServices/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" style="
         ...
         <div class="travel__list xs-marb0 marb250" style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Add services you want to offer on this property</div>
<div class="visible-xs">
 <div class=" xs-product__rating  xs-padb10  visible-xs " style="border-bottom: 3px solid #282D34 !important; display: flex !important;
        align-items: center !important;
...
<div class="checkout__category changedText">Your request detail</div>
...
<div class="checkout__section " style="border:none; margin:0px; padding-top:0px;   padding-bottom:136px; ">
<form class="checkout__item js-tabs-item" action="../../sendRequestToOwner/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
<div class="checkout__fieldset">
 <div class="field"  >
                            <div class="field__label  changedText" style="color:#787f91;">Who is responsible for property management?</div>
                            <div class="field__wrap">
                               <select class=" "   id="responsible_for_property" name="responsible_for_property" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"    >
								  <?php  $i=1; foreach($listEmployees  as $category => $value) 
												{ ?>
  ...
  <div class="field"  >
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"  onchange='selectService(this.value);' >
		...
		<input type="hidden" id="subcategory_id" name="subcategory_id" value="0" onchange="updatePropertyStatus(this.value);" />
...
<div class="checkout__box serviceList">
 ...
 <a class="button checkout__button changedText hidden" href="javascript:void(0);"  onclick="informEmployee();">Submit</a>
 </form>
</div>
</div>
</div>
