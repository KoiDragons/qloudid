...
<a class="header__logo " href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyProfileMarketplaceServices/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>" style="
...
<button class="header__head js-header-head fsz16 hidden-xs changedText">Employee view</button>
		...
		<div class="header__item header__item_notification js-header-item" >
		  ...
		  <div class="header__item header__item_user js-header-item" style="display:block;">
            ...
            <div class="header__body js-header-body" style="background:#23262F;">
...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">Posted jobs
</span> </h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Here are jobs that match your services. Select and bid on available.
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Projects</div>
                                      </a>
			       <a class="categories__item  bg_E7E7E7 " href="https://www.safeqloud.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Employee</div>
                                      </a>
									  ...
									  <a class="categories__item bg_E7E7E7 " href="../../companyProfileAction/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Setup</div>
                                      </a> 

										<a class="categories__item bg_E7E7E7 " href="../../companyProfileIntegration/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active" href="#">For sale</a><a class="nav__link" href="#">Sold</a><a class="nav__link" href="#">Manage</a> <a class="nav__link" href="#">Rent</a></div>
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
				  ...
				  <div class="card card_row"   style="margin-bottom:24px; <?php if($value['is_accepted']==0) {  } else if($value['is_accepted']==1) echo 'border:2px solid #ffe500'; else { echo 'border:2px solid #FB757C'; }; ?>">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:30px; color:white;"><?php echo $value['subcategory_name']; ?></div>
                         <a href="#" style="text-decoration:none;">
						 <div class="card__price" style="color:#f67f00; box-shadow: inset 0 0 0 2px #f67f00;">
...
">
                ...
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['first_name'].' '.$value['last_name']; ?></div>
				  <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['email']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['company_name']; ?></div>
              </div>
			  <?php if($value['request_type']==2) { ?>
			  <div class="description__parameters" style="
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $value['city_location']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo date('Y-m-d',$value['check_in_date']); ?></div>
				  <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo date('Y-m-d',$value['check_out_date']); ?></div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>Adults - <?php echo $value['guest_adult']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>Children - <?php  echo $value['guest_children']; ?></div>
				  <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>Infants - <?php  echo $value['guest_infant']; ?></div>
