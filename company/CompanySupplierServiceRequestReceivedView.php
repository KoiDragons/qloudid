...
<a class="header__logo " href="https://www.qloudid.com/company/index.php/CompanySuppliers/companyProfileMarketplaceServices/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>" style="
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
			       ...
			       <a class="categories__item  bg_E7E7E7 " href="https://www.qloudid.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
