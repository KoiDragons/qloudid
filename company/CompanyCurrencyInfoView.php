				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir">Company</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please select the currency you want to use for payment </a></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Currency" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										 
									</div>
									 </div>
									 <form action="../updateCurrency/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Currency</span> 
													 </div>
								 ...
								 <Select  name="currency_id" id="currency_id" class="css-bnguuq dropdown-bg">
								 
											<?php  
										foreach($currencyOption as $category => $value) 
												{
													
													
												?> 
												<option value="<?php echo $value['id']; ?>" <?php if($companyDetail['currency_id']==$value['id']) echo 'selected'; ?>><?php echo $value['currency_iso_code']; ?></option>
												<?php } ?>
											</Select>
								 </div>
