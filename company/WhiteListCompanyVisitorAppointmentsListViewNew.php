...
<a class="header__logo xs-fsz20 " href="../visitorsContactInformation/<?php echo $data['cid']; ?>" style="
...
<h2 class="browse__title h2" style="
    ...
    line-height: 90px;
">Your Treatments</h2>
<div class="browse__info info">Select one treatment for registration.</div>
</div>
...
<?php $i=1;
foreach($visitorsDetailRegularAppointmentToday as $category => $value) 
{
?> 
<div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label"><?php echo $value['full_name']; ?> </div>
<?php if($value['meeting_type']==1) { ?>
<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="Business meeting - <?php echo date('h:i',strtotime($value['visiting_time'])); ?>">
 <?php } else { ?>
 <input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="Treatment - <?php echo date('h:i',strtotime($value['visiting_time'])); ?>">
  <?php } ?>
<div class="checkout__controls">
<a href="../verifyAppointmentDetails/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value['enc1']; ?>"><button class="checkout__edit" >
