				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Employees working at the <?php echo $queueDetail['queue_name']; ?></a></div>
						...
						<div class="on_clmn brdb">
										...
										<input type="text" value="Employee/Operator list" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_70 xxs-wi_70  xs-mar0 ">
													...
													<a href="../../<?php if($value['is_operator']==1) echo 'removeOperator'; else echo 'addOperator'; ?>/<?php echo $data['cid']; ?>/<?php echo $data['id']; ?>/<?php echo $value['enc']; ?>">	 
													<div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 ">
														  <span class="<?php if($value['is_operator']==0) echo 'fas fa-check-circle green_txt'; else echo 'fas fa-times-circle red_txt'; ?>" aria-hidden="true"></span> 
													</div>
													</a>
