...
<div class="main__center center">
            <div class="main__preview">
              <!--<picture>
                <source media="(max-width: 767px)" srcset="<?php echo $path; ?>html/usercontent/images/bg/meeting.jpg"><img src="<?php echo $path; ?>html/usercontent/images/bg/meeting.jpg" alt="Main">
              </picture>-->
              <div class="main__wrap">
              <h1 class="main__title hero" style="color:white;">Meeting</h1>
            ...
            <div class="panel panel_stays">
              ...
              <div class="panel__nav"><a class="panel__link " href="../visitorsContactInformation/<?php echo $data['cid']; ?>">Treatment</a><a class="panel__link active" href="Javascript:void(0);" style="color:#f67f00">Meeting</a><a class="panel__link" href="Javascript:void(0);">Delivery</a> </div>
