...
{
	$('#error_msg').html('');
	if($('#indexing_save').val()=="")
	{
		$('#error_msg').html('please select atleast one value');
		return false;
	}
...
function changeBg(link,id)
		{
		if($('.Qselect'+id).hasClass('brdclr_seggreen_47E2A1'))
		{
		$('.Qselect'+id).removeClass('brdclr_seggreen_47E2A1 brd_width_2');	
		 id1=id+',';
		 tval=$('#indexing_save').val();
		 $('#indexing_save').val(tval.replace(id1,''));
...
function checkFlag()
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz60 xs-bold padb10 blue_67cff7 trn" id="txt" ></h1>
									</div>
						 
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Klicka på knappen ifall du är klar för dagen.</a></div>
										 
							<?php if($checkOpenStatus==0) { ?>
							
										<a href="#" onclick="changeBg(this,1);">
										<div class=" white_bg mart5  brdrad3 brd_1 bg_fffbcc_a marb15  Qselect1" style="">
										<div class="container pad20 xs-pad10 xs-padt10 xs-padb10  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_10 xxs-wi_20 sm-wi_10 xsip-wi_10 marr15 xs-mar0 "> <div class="wi_40p xs-wi_50p hei_40p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	...
																	border-radius: 10%;"> <img src="../../../../html/usercontent/images/random/visitor.jpg" width="45px;" height="45px;" alt="Profile " style="background-repeat: no-repeat;
																		background-position: 50%;
													...
													<div class="fleft wi_60 xxs-wi_80 sm-wi_60 xsip-wi_60 xs-mar0 ">
													  ...
													  <span class="edit-text padt10 jain2 dblock brdb brdclr_lgtgrey2 fsz16">Visitor</span> </div>
											...
											<div class=" wi_33 xxs-wi_50 fleft bs_bb padrb20 talc xs-padr10 xs-padl10 hidden" id="1">
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p xxs-hei_160p dblock bs_bb pad25  brdclr_seggreen_h brdrad5  lgtgrey2_bg    trans_all2  " onclick="changeBg(this,1);">
																<div class=" ">
																	<div class="wi_100 hei_90p dflex bs_bb">
																		<img src="../../../../html/usercontent/images/random/visitor.jpg" height="90" width="90" class="brdrad5 padb0">
																	</div>
																	
																	<div class="  padrb15 padt20 ">
																		<h3 class=" tall pad0 txtovfl_el  lgn_hight_24 bold fsz18 segdblue_txt padt0">Visitor</h3>
												...
												<?php } if($checkOpenStatusParkering==0) { ?>
												
												<a href="#" onclick="changeBg(this,2);">	
												<div class=" white_bg mart5  brdrad3 brd_1 bg_fffbcc_a marb15  Qselect2" style="">
										<div class="container pad20 xs-pad10 xs-padt10 xs-padb10  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_10 xxs-wi_20 sm-wi_10 xsip-wi_10 marr15 xs-mar0 "> <div class="wi_40p xs-wi_50p hei_40p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"> <img src="../../../../html/usercontent/images/random/undraw_Vehicle_sale_a645.png" width="45px;" height="45px;" alt="Profile " style="background-repeat: no-repeat;
																		background-position: 50%;
																	border-radius: 10%;"></div>
																	</div>
													...
													<div class="fleft wi_60 xxs-wi_80 sm-wi_60 xsip-wi_60 xs-mar0 ">
													  ...
													  <span class="edit-text padt10 jain2 dblock brdb brdclr_lgtgrey2 fsz16">Parkering</span> </div>
											...
											<div class="clear"></div>
												...
												<div class=" wi_33 xxs-wi_50 fleft bs_bb padrb20 talc xs-padr0 xs-padl10 hidden" id="2">
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_190p xxs-hei_160p dblock bs_bb pad25  brdclr_seggreen_h brdrad5  lgtgrey2_bg    trans_all2  " onclick="changeBg(this,2);">
																<div class=" ">
																	<div class="wi_100 hei_90p dflex bs_bb">
																		<img src="../../../../html/usercontent/images/random/undraw_Vehicle_sale_a645.png" height="90" width="90" class="brdrad5 padb0">
																	</div>
																	
																	<div class="  padrb15 padt20 ">
																		<h3 class=" tall pad0 txtovfl_el  lgn_hight_24 bold fsz18 segdblue_txt padt0">Parkering</h3>
												...
												<?php } if($checkOpenStatusDelivery==0) { ?>
												
												<a href="#" onclick="changeBg(this,3);">
												<div class=" white_bg mart5  brdrad3 brd_1 bg_fffbcc_a marb15  Qselect3" style="">
										<div class="container pad20 xs-pad10 xs-padt10 xs-padb10  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_10 xxs-wi_20 sm-wi_10 xsip-wi_10 marr15 xs-mar0 "> <div class="wi_40p xs-wi_50p hei_40p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"> <img src="../../../../html/usercontent/images/random/undraw_delivery_address_03n0.png" width="45px;" height="45px;" alt="Profile " style="background-repeat: no-repeat;
																		background-position: 50%;
																	border-radius: 10%;"></div>
																	</div>
													...
													<div class="fleft wi_60 xxs-wi_80 sm-wi_60 xsip-wi_60 xs-mar0 ">
													  ...
													  <span class="edit-text padt10 jain2 dblock brdb brdclr_lgtgrey2 fsz16">Delivery</span> </div>
											...
											<div class="clear"></div>
												...
												<?php } if($checkOpenStatusSafeqid==0) { ?>
												
												<a href="#" onclick="changeBg(this,4);">
												<div class=" white_bg mart5  brdrad3 brd_1 bg_fffbcc_a marb15  Qselect4" style="">
										<div class="container pad20 xs-pad10 xs-padt10 xs-padb10  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_60 xxs-wi_80 sm-wi_60 xsip-wi_60 xs-mar0 ">
													  ...
													  <span class="edit-text padt10 jain2 dblock brdb brdclr_lgtgrey2 fsz16">SafeQid</span> </div>
											...
											<div class="clear"></div>
												...
												<?php } ?>
												<form action="../reportStartDay/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" >
	...
	<div class="clear"></div>
												...
												<div id="error_msg" class="red_txt"></div>
	<div class="padt5 xxs-talc talc">
								
								<a href="#"><button type="button" name="forward" class="forword minhei_55p bgclr_seggreen_47E2A1 fsz18 trn" onclick="submitForm();">Submit</button></a>
