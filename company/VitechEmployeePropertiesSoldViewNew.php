...
<a class="header__logo changedText" href="../../CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>" style="
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			       ...
			       <a class="categories__item    " href="../listImportedProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">For Sale</div>
                                      </a>
									   <a class="categories__item    " href="../listEmployeesCreatedProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
...
{
	window.location.href='https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesProperties/<?php echo $data['cid']; ?>';
}
</script>
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link  changedText" href="#" onclick="changeHeader();">Not completed</a> <a class="nav__link changedText" href="#">Published</a> <a class="nav__link changedText" href="#">Reserved</a><a class="nav__link changedText active" href="#" >Sold</a></div>
