				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<form action="../../../updateRoomServiceMenu/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['hid']; ?>" method="POST" id="save_indexing" name="save_indexing" >				 
							...
							<input type="hidden" id="available_dishes" name="available_dishes" value="<?php if($roomServiceRequestDetail['available_dishes']!='' || $roomServiceRequestDetail['available_dishes']!=null) echo $roomServiceRequestDetail['available_dishes'].','; ?>" />
							</form>
							 <div class="clear">
