...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>/html/fleet/css/app.minbox25.css">
   ...
   function informEmployee()
			{
				...
				if($("#seller_price_per_night").val()>$("#broker_price_per_night").val())
				{
					 
					$("#error_msg_form").html('Please enter price per night greater then or equal to seller price');
					return false;
				}
				if($("#seller_deposit_fee").val()>$("#broker_deposit_fee").val())
				{
					 
					$("#error_msg_form").html('Please enter price per night greater then or equal to seller deposit price');
					return false;
				}
				
				if($("#seller_cleaning_fee").val()>$("#broker_cleaning_fee").val())
				{
					 
					$("#error_msg_form").html('Please enter price per night greater then or equal to seller cleaning fee');
					return false;
				}
				
				if($("#late_arrival_fee").val()>$("#broker_late_arrival_fee").val())
				{
					 
					$("#error_msg_form").html('Please enter price per night greater then or equal to seller late arrrival fee');
					return false;
				}
				
			/*if($("#guest_email").val()==null || $("#guest_email").val()=="")
			{
				$("#error_msg_form").html('Please enter email of the guest');
                 submitFlag = 0;
                 return false;
			}
			
			if(!checkEmail("guest_email"))
				{
					submitForm = false;
					return false;
				}*/
...
<a class="header__logo xs-fsz25 changedText" href="#" style="
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
                ...
                <div class="header__menu">
					...
					<a class="header__link" href="../companyProfileAction/<?php echo $data['cid']; ?>">
...
<div class="travel__center center   padb136 xs-padrl25" style="border-bottom:2px solid #23262F;  max-width: 1132px;
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list xs-marb0 marb837" style="
            max-width: 425px;
            ">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Make profit by adding your markup to the broker's price</div>
...
">
	  ...
	  <script>
		function changeTotalDiff()
		{
			var price_diff=$("#broker_price_per_night").val()-$("#seller_price_per_night").val();
			$("#diff_price_per_night").html(price_diff);
			var diposit_diff=$("#broker_deposit_fee").val()-$("#seller_deposit_fee").val();
			$("#diff_deposit_fee").html(diposit_diff);
			var cleaning_diff=$("#broker_cleaning_fee").val()-$("#seller_cleaning_fee").val();
			 
			$("#diff_cleaning_fee").html(cleaning_diff);
			var arrival_diff=$("#broker_late_arrival_fee").val()-$("#late_arrival_fee").val();
			$("#diff_late_arrival_fee").html(arrival_diff);
			var tdays=<?php echo $totalDays; ?>;
			var total_diff=(price_diff*tdays)+cleaning_diff+arrival_diff;
			$('#diff_total_fee').html(total_diff);
		}
		</script>
...
<div class="checkout__list">
 ...
 <form class="checkout__item js-tabs-item" action="../../addPropertyWishlist/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"> 
 
<div class="  brands  " style="    /* margin-top: 60px; */">
   <div class="brands__center  " style="padding: 0px 0px;">
      <div class="brands__wrap">
         <div class="checkout__inner js-tabs" style="padding-right:0px;/* padding-left: 200px; */">
            <div class="receipt__description receipt__description_flex mart0 " style="  margin-bottom: 20px; background: transparent; border:1px solid #23262f; border-radius:6px;">
               <div class="receipt__item" style="flex: 0 0 33%;">
                  ...
                  <div class="receipt__box">
                     ...
                     <div class="receipt__subtitle" style="font-size:16px;"><?php echo date('M d',strtotime($_POST['checkin_date'])); ?> </div>
                  </div>
               </div>
               <div class="receipt__item" style="flex: 0 0 33%;">
                  <div class="receipt__icon  hidden-xxs">
                  ...
                  <div class="receipt__box">
                     ...
                     <div class="receipt__subtitle" style="font-size:16px;"><?php echo date('M d',strtotime($_POST['checkout_date'])); ?> </div>
                  </div>
               </div>
               <div class="receipt__item" style="flex: 0 0 33%;">
                  <div class="receipt__icon  hidden-xxs">
                  ...
                  <div class="receipt__box">
                     ...
                     <div class="receipt__subtitle changedText" style="font-size:16px;"><?php echo $_POST['guest_adults']+$_POST['guest_children']; ?> guests</div>
                  </div>
               </div>
            </div>
            <div class="section brands xxs-mart30" style="
               /* margin-top: 60px; */
               ">
               <div class="brands__center" style="padding: 0px 0px;">
                  <div class="brands__wrap">
                     <div class="brands__list" style="display:flex;">
                        <div class="brands__item" style="
                           border-color: #10161d;
                           height: 95px;
                           background: #10161d;
                        ...
                        <div class="brands__item" style="
                           ...
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Brokers Price</div>
                           </a>
                        </div>
                        <div class="brands__item" style="
                           color: black;
                           ...
                           ">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: Avenir;color: #ffffff;font-size: 15px;font-weight: bold;line-height: 1.1;">Set Your Price</div>
                           </a>
                        </div>
                        <div class="brands__item" style="
                           background: #10161d;
                           ...
                           ">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Profit All Nights</div>
                           </a>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Night price</div>
                           </a>
                        </div>
                        <div class="brands__item  " style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<?php echo $fetchPropertiesPricing['seller_price_per_night']; ?></div>
                           </a>
                        </div>
						
						<input type="hidden" id="seller_price_per_night" name="seller_price_per_night" value="<?php echo $fetchPropertiesPricing['seller_price_per_night']; ?>" />
						 
                        <div class="brands__item" style="
                           background: #23262f !important;
                           border: #23262f;
                           ">
                           <div class=" field__wrap" style="
                              margin-left: 10px;
                              margin-right: 10px;
                              ">
                              <input class="field__input xs-fieldData" type="number" name="broker_price_per_night" id="broker_price_per_night" style="color: black;background: #ffffff !important;border-color: #ffffff;text-align: center;font-size: 15px;" fdprocessedid="fu8qmc" min="0" value="0" onkeyup="changeTotalDiff();" >
                           </div>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<span id="diff_price_per_night">0</span></div>
                           </a>
                        </div>
						
						 <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Deposit Fee</div>
                           </a>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<?php echo $fetchPropertiesPricing['seller_deposit_fee']; ?></div>
                           </a>
                        </div>
						
						<input type="hidden" id="seller_deposit_fee" name="seller_deposit_fee" value="<?php echo $fetchPropertiesPricing['seller_deposit_fee']; ?>" />
                        <div class="brands__item" style="
                           background: #23262f !important;
                           border-color: #23262f;
                           ">
                           <div class=" field__wrap" style="
                              ...
                              margin-right: 10px;
                              ">
                              <input class="field__input xs-fieldData" type="number" name="broker_deposit_fee" id="broker_deposit_fee" style="color: black;background: #ffffff !important;border-color: #ffffff;font-size: 15px;text-align: center;" fdprocessedid="fu8qmc" min="0" value="0" onkeyup="changeTotalDiff();" >
                           </div>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<span id="diff_deposit_fee">0</span></div>
                           </a>
                        </div>
						
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Cleaning fee</div>
                           </a>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<?php echo $fetchPropertiesPricing['seller_cleaning_fee']; ?></div>
                           </a>
                        </div>
						
						<input type="hidden" id="seller_cleaning_fee" name="seller_cleaning_fee" value="<?php echo $fetchPropertiesPricing['seller_cleaning_fee']; ?>" />
                        <div class="brands__item" style="
                           background: #23262f !important;
                           border-color: #23262f;
                           ">
                           <div class=" field__wrap" style="
                              ...
                              margin-right: 10px;
                              ">
                              <input class="field__input xs-fieldData" type="number" name="broker_cleaning_fee" id="broker_cleaning_fee" style="color: black;background: #ffffff !important;border-color: #ffffff;font-size: 15px;text-align: center;" fdprocessedid="fu8qmc" min="0" value="0" onkeyup="changeTotalDiff();" >
                           </div>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<span id="diff_cleaning_fee">0</span></div>
                           </a>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Late Arrival Fee</div>
                           </a>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<?php echo $fetchPropertiesPricing['late_arrival_fee']; ?></div>
                           </a>
                        </div>
						
						<input type="hidden" id="late_arrival_fee" name="late_arrival_fee" value="<?php echo $fetchPropertiesPricing['late_arrival_fee']; ?>" />
                        <div class="brands__item" style="
                           background: #23262f !important;
                           border-color: #23262f;
                           ">
                           <div class=" field__wrap" style="
                              ...
                              margin-right: 10px;
                              ">
                              <input class="field__input xs-fieldData" type="number" name="broker_late_arrival_fee" id="broker_late_arrival_fee" style="color: black;background: #ffffff !important;border-color: #ffffff;font-size: 15px;text-align: center;" fdprocessedid="fu8qmc" min="0" value="0"  onkeyup="changeTotalDiff();">
                           </div>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">€<span id="diff_late_arrival_fee">0</span></div>
                           </a>
                        </div>
                        <div class="brands__item" style="
                           border-color: #131922;
                           ">
                           <a href=" https: //www.https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesRentProperties/eStBdzlZQStEM3lYOFFRd2xzc3paQT09">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #131922;font-size: 15px;">€15</div>
                           </a>
                        </div>
                        <div class="brands__item" style="
                           border-color: #131922;
                        ...
                        <div class="brands__item" style="
                           ...
                           ">
                           <a href=" https: //www.https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesRentProperties/eStBdzlZQStEM3lYOFFRd2xzc3paQT09">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 25px;">Profit</div>
                           </a>
                        </div>
                        <div class="brands__item" style="">
                           <a href="javascript:void(0);">
                              <div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 25px;/* font-weight: bold; */">€<span id="diff_total_fee">0</span></div>
                           </a>
                        </div>
						<div class="brands__item  hidden-xxs" style=" border-color: transparent;">
                            
                        </div>
						<div class="brands__item  " style="border-color: transparent;">
...
<a class="button checkout__button changedText" href="javascript:void(0);" onclick="informEmployee();">Submit</a>
	...
	<div class=" mart40" id="propertyDetailStatusInfo">
                        ...
                        <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Checkin-date</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="checkin_date" id="checkin_date" value="<?php echo $_POST['checkin_date']; ?> " placeholder="e. g. Kowaken" style=" color:grey;"  readonly>
                            </div>
                          </div>
						  
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Check-out date</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="checkout_date" id="checkout_date" value="<?php echo $_POST['checkout_date']; ?> " placeholder="e. g. Ghirmai" style=" color:grey;"  readonly>
                            </div>
                          </div>
						  </div>
						  ...
						  <div class="checkout__row  " style="margin-bottom:24px;">
                        <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Adults</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="guest_adults" id="guest_adults" value="<?php echo $_POST['guest_adults']; ?> "  placeholder="e. g. Kowaken" style=" color:grey;"  readonly>
                            </div>
                          </div>
						  
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Children</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="guest_children" id="guest_children" value="<?php echo $_POST['guest_children']; ?> " placeholder="e. g. Ghirmai" style=" color:grey;"  readonly>
                            </div>
                          </div>
						  </div>
						  </div>
						 
						  <input   type="hidden" name="owner_property_id" id="owner_property_id" value='<?php echo $_POST['owner_property_id']; ?>' placeholder="Check in" />
						 
						  
					<div class="upload__item " style="margin-bottom:24px; display:none;">
					  <div class="checkout__line  "  style="margin-bottom:24px;">
					   <div class="checkout__subtitle">Guest information</div>
                       
                      </div>
					     
                        <div class="field" style="margin-bottom:24px;">
                            <div class="field__label  changedText" style="color:#787f91;">Guest email</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="guest_email" id="guest_email" style=" color:grey;" fdprocessedid="fu8qmc" >
                            </div>
                          </div>
