			...
			function submitform()
		{
		 ...
		 if($("#first_name").val()==null || $("#first_name").val()=="")
			...
			$('#image-data3').val(bg_url1);
			 ...
			 var send_data={};
			send_data.email=$("#owner_email").val();	  
				 $.ajax({
							type:"POST",
...
<div class="travel__center center   padb136 xs-padrl25" style="border-bottom:2px solid #23262F;  max-width: 1132px;
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list xs-marb0 marb1550" style="
            max-width: 425px;
            ">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Add guest information below to complete the reservation
</div>
...
<div class="section categories  marl6 " style="margin-bottom: 0px; border-bottom: 1px solid #23262F;">
<div class="categories__center center1 xsi-nobrdb   padb20"  >
...
<div class="changedText categories__subtitle  txt_f67f00 ">Face</div>
  </a>
  
   <a class="categories__item  trans_bg " href="javascript:void(0);" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent;  border:none;" onclick="phoneUser();">
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Phone</div>
                                      </a>
									  </div>
</div>
</div>
...
<form class="checkout__item js-tabs-item" action="../../../addUserForReservation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing1" name="save_indexing1" accept-charset="ISO-8859-1"  style="display: block;">
<input type="hidden" name="uphno" id="uphno" value="<?php echo $_POST['uphno']; ?>"/>
<input type="hidden" name="country_id" id="country_id" value="<?php echo $_POST['country_id']; ?>"/>
 <input type="hidden" name="pcountry" id="pcountry" value="<?php echo $_POST['country_id']; ?>"/>
		<input type="hidden" name="p_number" id="p_number" value="<?php echo $_POST['uphno']; ?>"/>
...
<div class="checkout__section xsi-nobrdt padt32 xsi-padt0" style="margin-top:10px;   padding-bottom:136px; border:none;">
<form class="checkout__item js-tabs-item" action="../../../addGuestAndSendBookingInfo/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="uphno" id="uphno" value="<?php echo $_POST['uphno']; ?>"/>
<input type="hidden" name="country_id" id="country_id" value="<?php echo $_POST['country_id']; ?>"/>
 <input type="hidden" name="pcountry" id="pcountry" value="<?php echo $_POST['country_id']; ?>"/>
		<input type="hidden" name="p_number" id="p_number" value="<?php echo $_POST['uphno']; ?>"/>
<input type="hidden" name="checkin_date" id="checkin_date" value="<?php echo $_POST['checkin_date']; ?>"/>
                      ...
                      <div class="checkout__fieldset">
                        ...
                        <div class="checkout__row margin-bottom24">
                          <div class="field">
                            <div class="field__label changedText" style="color:#787f91;">Name</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="first_name" id="first_name"  placeholder="e. g. xyz"   style=" color:grey;" />
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label changedText" style="color:#787f91;">Last name</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="last_name" id="last_name" placeholder="e. g. xyz" style=" color:grey;"   />
                            </div>
                          </div>
                        </div>
						
						<div class="field margin-bottom24">
                          <div class="field__label changedText" style="color:#787f91;">Email address</div>
                          <div class="field__wrap">
                            <input class="field__input xs-fieldData" type="text" name="owner_email" id="owner_email" placeholder="e. g. xyz@gmail.com" style=" color:grey;" fdprocessedid="b3ewp"    >
                          </div>
                        </div>
						...
						<div class="checkout__row margin-bottom24">
                           ...
                           <div class="field__wrap">
                          <select class="xs-fieldData" disabled style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52">
	    ...
	    <?php foreach($countryOptions as $category => $value) { ?>
											<option value="<?php echo $value['id']; ?>" class="changedText" <?php if($_POST['country_id']==$value['id']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
											 <?php } ?>
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                             <input class="field__input xs-fieldData" value="<?php echo $_POST['uphno']; ?>" readonly placeholder="e. g. 763930303" type="text" style=" color:grey; " fdprocessedid="idn11" onfocusout='checkPhoneNumber(this.value);'>
                            </div>
                          </div>
                        </div>
					    ...
					    <div class="checkout__line  padt32 xsi-padt45 mart10" style="border-top: 1px solid #23262F;">
					   <div class="checkout__subtitle changedText">Passport</div>
                       
                      </div>
                      <div class="checkout__fieldset">
                        <div class="field margin-bottom24">
                            <div class="field__label changedText" style="color:#787f91;">Passport number</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="id_number" placeholder="e. g. xyz930303" id="id_number" style=" color:grey;"  >
                            </div>
                          </div>
                        <div class="checkout__row margin-bottom24">
                          <div class="field">
                            <div class="field__label changedText" style="color:#787f91;">Issue year</div>
                            <div class="field__wrap">
                               <select class="xs-fieldData"   id="issue_year" name="issue_year" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" onchange='updateMonth(this.value);' >
                          ...
                          <div class="field">
                            <div class="field__label changedText" style="color:#787f91;">Issue month</div>
                            <div class="field__wrap">
                              <select class="xs-fieldData"   id="issue_month" name="issue_month" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
								    <?php $dateM=date('m');  for($i=1; $i<=$dateM;$i++) { ?>
                                 <option value="<?php echo $i; ?>" class="lgtgrey2_bg" ><?php echo $i; ?></option>
								  <?php }  ?>
								  </select>
                            </div>
                       ...
                       <div class="checkout__row margin-bottom24">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                               <select class="xs-fieldData"   id="expiry_year" name="expiry_year" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" onchange='updateExpiryMonth(this.value);' >
                          ...
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <select class="xs-fieldData"   id="expiry_month" name="expiry_month" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
                      ...
                      <div class="upload__category changedText">Upload front photo</div>
                      <div class="upload__note changedText">Drag or choose your file to upload</div>
                      <div class="upload__file upload__filer"  style="  background-image: ../../usercontent/images/default-profile-pic.jpg;" >
 ...
 <div class="on_clmn mart20 marb35 hidden">
						...
						<div class="upload__item">
                      <div class="upload__category changedText">Upload back photo</div>
                      <div class="upload__note changedText">Drag or choose your file to upload</div>
                      <div class="upload__file upload__filet"  style="  background-image: ../../usercontent/images/default-profile-pic.jpg;" >
                        <input class="upload__input" type="file" name="file2" id="file2" onchange="readURL2(this);">
                        <div class="upload__icon">
                          <svg class="icon icon-upload-file">
                            <use xlink:href="#icon-upload-file"></use>
                          </svg>
 ...
 <div class="on_clmn mart20 marb35 hidden">
						<div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
									...
									<div class="wp_columns_upload wp_columns_upload_custom marb20 brd brdclr_white ">
										<input type="hidden" name="image-data4" id="image-data4" value="" class="hidden-image-data">
										
										
										<div class="imgwrap nobrd  "  >
											<div class="cropped_image   grey_brd5  " style="object-fit: cover;  background-image: ../../usercontent/images/default-profile-pic.jpg;" id="image-data3" name="image-data3"></div>
