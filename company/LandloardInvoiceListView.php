 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Invoices</a></li>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Invoices</div>
									   ...
									   <a class="categories__item    " href="../paymentList/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle    txt_787f91" >Payment received</div>
                                      </a>
									  
									  <a class="categories__item    " href="../listComissionInvoice/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle    txt_787f91" >Commission invoice</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link " href="#">Invoices</a> </div>
                 
                   <div class="sorting__select hidden-xxs">
               <a href="../paymentInformation/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button">
		  ...
		  <div class="flights__sorting hidden-xxs " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
               ...
               <div class="flights__container" style="padding-left:0px;">
				...
				<?php $i=1; 
								foreach($landloardInvoices as $category => $value) 
										{
											 if($value['fee_type']==1) {
										 ?> 
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title wi_30" style="font-size:20px; color:white; margin-bottom: 0px;">Reservation fee</div>
...
">
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php if($value['is_paid']==1) echo 'Paid'; else echo 'Not paid' ?></div>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title wi_30" style="font-size:20px; color:white; margin-bottom: 0px;"><?php if($value['is_deposit']==0) echo 'Invoice fee';  else echo 'Deposit fee'; ?></div>
