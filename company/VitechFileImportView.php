			...
			var inps = document.getElementsByName('maped[]');
				...
				for (var i = 0; i < recipientsArray.length - 1; i++) {
					if (recipientsArray[i + 1] == recipientsArray[i]) {
						...
						$("#errorMsg1").html("please select unique header values");
						return false;
					}
				}
				...
				for (var i = 0; i < recipientsArray.length - 1; i++) {
					if (recipientsArray[i + 1] == recipientsArray[i]) {
						...
						$("#errorMsg1").html("please select unique mapping values");
						return false;
					}
				}
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Define how the columns in your CSV file correspond to the fields in the system.</div>
...
<div class="checkout__box">
                ...
                <h2 class="setting__title h2 changedText " style="font-size:32px; font-weight:normal;">Match the fields</h2>
                <div class="setting__list">
				<?php if($data['bid']=='0'){ ?>
				<form action="../importPropertiesFromFile/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing">
				<?php } else if($data['bid']=='1'){ ?>
				<form action="../importBrokersFromFile/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing">
				<?php } else { ?>
				<form action="../importLandloardPropertiesFromFile/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" method="POST" name="save_indexing" id="save_indexing">
				<?php } ?>
  ...
  <div class="setting__box ">
                    <div class="setting__stage hidden" style="font-size:32px;">Mapping</div>
                    <div class="setting__line">
                       <div class="setting__element">
                        <div class="setting__details"> 
                          <div class="setting__label  marb0i xs-mart15" >Match</div>
                          <!--<div class="setting__text"><?php echo $file[$i]; ?></div>-->
                        </div>
                        <div class="field " style="width:70%">
                             
                            <div class="field__wrap">
                               <select class="" id="mapping[]" name="mapping[]" style="height: 48px;
								...
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="zc7mun" onchange="updateParkingType(this.value);">
											...
											<option value="<?php echo $i; ?>"><?php echo $file[$i]; ?></option>
                 ...
                 <div class="setting__element">
                        <div class="setting__details"> 
                          <div class="setting__label marb0i xs-mart15" >With this</div>
                         <!-- <div class="setting__text"><?php echo $file[$i]; ?></div>-->
                        </div>
                       <div class="field xs-wi_70">
                             
                            <div class="field__wrap">
                               <select class="" id="maped[]" name="maped[]" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: black; border-radius: 12px;
								  background: white; width:100%;" fdprocessedid="zc7mun" onchange="updateParkingType(this.value);">
											...
											<option value="">Select</option>
																<?php 
																	...
																	{
																	?>
																	<option value="<?php echo $f; ?>" <?php if($i==$f) echo 'selected'; ?>><?php echo $sep_value; ?></option>
											...
											<a class="button checkout__button changedText" href="javascript:void(0);" onclick="submitform1();">Submit</a>
</div>
</form>
