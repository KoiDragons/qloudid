...
<html>
	...
	<head>
		...
		{
			window.location.href ="https://www.safeqloud.com/company/index.php/Wellness/wellnessInformation/<?php echo $data['cid']; ?>";
		}	
		</script>
	 ...
	 <div class="column_m header   bs_bb lgtgrey2_bg hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg">
			...
			<div class="fright   padtbz10   "  >
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="../wellnessInformation/<?php echo $data['cid']; ?>" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
			 ...
			 <div class="visible-xs visible-sm fright marr0 ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
					...
					<li class="last first marr10i">
						<a href="../wellnessInformation/<?php echo $data['cid']; ?>" class="lgn_hight_s1 fsz25"><span class="fa fa-plus black_txt" aria-hidden="true"></span></a>
					 </li>
				</ul>
			</div>
				</div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Wellness</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc   xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Your Spa & Fitness places</a></div>
					 ...
					 <div class="tab-header martb0 padb30 xs-talc  nobrd talc">
						...
						<div class="on_clmn brdb">
										...
										<input type="text" value="Business type" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
					 		...
					 		<?php $i=1;
												...
												<a href="../editWellnessInformation/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><div class="column_m container  marb5   fsz14 dark_grey_txt">
								...
								<script>
									function add_more_rows(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreWellnessDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
