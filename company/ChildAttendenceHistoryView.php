							  ...
							  <li class="dblock padrb10 padt5">
												...
												<div class="padb20 xxs-padb0 ">
													...
													<div class="wrap maxwi_100 dflex xxs-dfex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 brdb_blue1">
														<div class="white_bg tall xs-talc">
															...
															<!-- Logo -->
															<h1 class="black_txt fsz30 xs-fsz45 xs-talc ffamily_avenir">History</h1>
															<!-- Logo -->
															<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz20  edit-text jain_drop_company ffamily_avenir xs-talc">Here is a list of all check in and check outs.</a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
																<!-- Meta -->
													...
													<div class="column_m container  marb0   fsz14 dark_grey_txt">
															<div class=" white_bg marb5  brdb bg_fffbcc_a" style="">
								...
								<div class="clear"></div>
													<div class="padt20 talc">
														<a href="javascript:void(0);" value="1" id="temp" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width ffamily_avenir" onclick="show_more_data(this,this.value);">Visa fler</a>
