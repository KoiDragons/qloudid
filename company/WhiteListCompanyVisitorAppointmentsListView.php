               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../visitorsContactInformation/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
		 	...
		 	<div class="column_m header hei_60p bs_bb lgtgrey2_bg visible-xs">
				...
				<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../visitorsContactInformation/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left txt_c12219" aria-hidden="true"></i></a>
                     </li>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 " id="loginBank">
				<div class="wrap maxwi_100 padrl25 md-padrl0 lg-padrl0">
					...
					<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-tall talc fsz65 xxs-fsz45 lgn_hight_65 xxs-lgn_hight_50 padb0 black_txt trn ffamily_avenir changedText"  >Appointments</h1>
									</div>
									<div class="mart10 marb5 xxs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Here is a list of appointments you have today</a></div>
								...
								<div class="white_bg tall xs-talc">
									...
									<div class="marb0">
									<a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text ffamily_avenir">Appointment</a>
									</div>
									</div>
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText"><?php echo $value['full_name']; ?>  </span>
													 <?php if($value['meeting_type']==1) { ?>
													   <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt">Business meeting - <?php echo date('h:i',strtotime($value['visiting_time'])); ?></span>
													 
													 <?php } else { ?>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt">Treatment - <?php echo date('h:i',strtotime($value['visiting_time'])); ?></span>
													 
													 <?php } ?>
													  </div>
													<a href="../verifyAppointmentDetails/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value['enc']; ?>">	<div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 ">
