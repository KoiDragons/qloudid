...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
									   ...
									   <a class="categories__item    " href="../adminAccount/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Employeed</div>
                                      </a>
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Resigned</div>
                                      </a>
...
<div class="sorting__foot">
                <div class="nav">  <a class="nav__link changedText active" href="#"  >Resigned</a></div>
                                  ...
                                  <div class="travels__body">
                                    <div class="travels__line"  style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        ...
                                        <div class="travels__location" style="color: black;">Relieved</div>
                                      </div>
                                  
                        <a class="header__logo  changedText fright Button10161d" href="javascript:void(0);" style="
   ...
   " >Employee</a>
                                    ...
                                    <div class="travels__line hidden">
                                      ...
                                      <div class="travels__rating">
										...
										<?php $i=1; 
								foreach($unsentRequestDetail as $category => $value) 
										{
