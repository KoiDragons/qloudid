...
<html>
	...
	<body class="white_bg">
		...
		<div class="column_m header xs-header xsip-header xsi-header bs_bb white_bg">
				...
				<a href="https://www.qloudid.com"> <h3 class="brdr_new marb0 pad0 fsz27 xs-fsz16 xs-bold xs-padt10 black_txt padt10 padb10" style="font-family: 'Audiowide', sans-serif;">QiD</h3> </a>
					...
					<div class="visible-xs visible-sm fleft">
							<div class="flag_top_menu flefti  padb10 " style="width: 50px; padding : 15px 0 0 0;">
		...
		<div class="column_m pos_rel" onclick="checkFlag();">
			...
			<div class="column_m container zi5 mart40">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb10 ">
						<h1 class="padb5 talc fsz50 xs-fsz40"><span class="fa fa-user"> </span><?php echo $userSummary['name']; ?></h1>
						<p class="lgtgrey2_bg padt10 talc fsz18 padb20 brdb wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb15">Jag skriver under hos </br> <span class="bold">Qloud ID Sverige</span></p>
					</div>
					
					<!-- Center content -->
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10 white_bg brdrad3">
						<div class="padtb0 brdrad3 white_bg">
							
								
								<div class="result-item padtb20 ">
										...
										<div class="fxshrink_0 dflex alit_c">
											...
											<div class="wi_100p talr">
												<a href="#" class="expander-toggler grey_txt" data-base=".result-item" data-target=".sources-content">
													<span><?php echo $getUserCount['num']; ?></span>
									...
									<div class="sources-content dnone" style="display: none;">
										...
										<?php if($getUserCount['num']>0){  if($_POST['stype']==1) { ?>
											<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#"  class="black_txt"><?php if($_POST['stype']==1) echo 'Social Security Number'; else echo 'Debit/Credit Card'; ?></a>
												</div>
												<span class="fxshrink_0 marl10"><?php echo $_POST['search_key']; ?> </span>
											</li>
											<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#" class="black_txt">Name</a>
												</div>
												<span class="fxshrink_0 marl10"><?php echo $getUserInfo['first_name']; ?> </span>
											</li>
											<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#"  class="black_txt">Last name</a>
												</div>
												<span class="fxshrink_0 marl10"><?php echo $getUserInfo['last_name']; ?> </span>
											</li>
											<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#"  class="black_txt">Status</a>
												</div>
												<span class="fxshrink_0 marl10"><?php if($getUserInfo['num']==0) echo 'Normal'; else echo 'Hijacked'; ?></span>
											</li>
											
										<?php } else { foreach($getUserInfo as $category => $value) { ?>
										<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#"  class="black_txt"><?php if($_POST['stype']==1) echo 'Social Security Number'; else echo 'Debit/Credit Card'; ?></a>
												</div>
											...
											<li class="dflex mart10  padb5">
												...
												<span class="fxshrink_0 marl10"><?php echo $value['first_name']; ?> </span>
											</li>
											<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#"  class="black_txt">Last name</a>
												</div>
												<span class="fxshrink_0 marl10"><?php echo $value['last_name']; ?> </span>
											</li>
											<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#"  class="black_txt">Status</a>
												</div>
												<span class="fxshrink_0 marl10"><?php if($value['num']==0) echo 'Normal'; else echo 'Hijacked'; ?></span>
											</li>
										...
										<li class="dflex mart10  padb5">
											...
											<li class="dflex mart10  padb5">
												<div class="wi_50 ovfl_hid ws_now txtovfl_el">
													<a href="#"  class="black_txt">No User has been found</a>
												</div>
					...
					<div class="talc  "> <a href="#"  ><input type="button" value="Signerar med säkerhetskod" class="forword minhei_55p"  ></a>
