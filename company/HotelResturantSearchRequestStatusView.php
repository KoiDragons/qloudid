               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../../searchResturant/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['sid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
						 <?php if($requestInfo['is_roomservice']==1) { ?>
								<img src="https://media.giphy.com/media/LpGDCmF87M24T6Sn6p/giphy.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
						 ...
						 <?php } ?>
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir"><?php if($requestInfo['is_roomservice']==0) echo 'Pending'; else if($requestInfo['is_roomservice']==1) echo 'Approved'; ?></h1>
									</div>
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" ><?php if($requestInfo['is_roomservice']==0) echo 'Your request for room service resturant is pending for verification'; else if($requestInfo['is_roomservice']==1) echo 'Your request for room service resturant has been approved by support team'; ?></a></br>
							 ...
							 <?php if($requestInfo['is_roomservice']==0) { ?>
									<div class="padtb20 xxs-talc talc">
								
							<a href="../../../../sendReminder/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['id']; ?>/<?php echo $data['sid']; ?>">	<button type="button" name="forward" class="forword minhei_55p t_67cff7_bg fsz18">Send Reminder</button></a>
