...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Employee</h2>

<h2 class="main__info info  tall  padb20 xs-padt20" style="font-weight: 100;color: #777E90; max-width: 100%; font-size: 24px;">Welcome <?php echo $userSummary['first_name']; ?>, this is the employee view of the company</h2></div>
