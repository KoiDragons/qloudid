								...
								<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03  brdr_new fsz14" id="scroll_menu">
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											<h4 class="padb5 uppercase ff-sans black_txt trn">Mina delningar</h4>
											<ul class="marr20 pad0">
												
												
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Hyresgäster</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												
												<li class="dblock padrb10">
													<a href="#" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Portar</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
													<a href="../../ManageLandloard/managePermission/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Landlord admin</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											</ul>
															...
															<a href="https://www.qloudid.com/user/index.php/PersonalRequests/sentRequests" class="style_base hei_180p dblock bs_bb pad20  lgtgrey2_bg_h  box_shadow">
																<div class=" ">
																	...
																	<div class="  padb15 padt20 talc">
																		<h3 class="ovfl_hid talc pad0 txtovfl_el ws_now lgn_hight_24 bold fsz18 segdblue_txt padt0">Hyresgäster</h3>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey   greyblue_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Hyresgäster</span>
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex alit_fe justc_sb  pos_rel padb10 brdb_new">
								...
								<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text jain_drop_company">Alla profiler som har godkänt att dela sin data med ert bolag.</a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
									...
									<a href="#" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt " >
										...
										<span class="valm"> Add a tenant </span>
									</a>
								</div>
							...
							<div class="container tab-header  talc dark_grey_txt ">
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey_bg">
									<li>
										<a href="#" class="dblock brdradt5 active" data-id="tab_total1">
											<span class="count black_txt"><?php echo $approvedCount['num']; ?></span>
											<span class="black_txt fsz16"> Anslutna </span>
										</a>
									</li>
								...
								<select class="tab-header wi_200p maxwi_100 dnone xs-dblock hei_30p pad0 nobrd brdb_new">
									<option value="tab_total1" selected><?php echo $approvedCount['num']; ?></option>
									<option value="tab_total2">Mottagna</option>
									<option value="tab_total"> Avböjda</option>
							...
							<div class="container  white_bg fsz14 dark_grey_txt">
								...
								<div class="tab-content padb25 padt5 " id="tab_total2">
										...
										<?php $i=0;
													...
													<tr class="fsz16">
														...
														<td class="pad5 brdb_new hidden-xs tall cd">
															<div class="padtb5 "><?php echo $value['visiting_address']; ?></div>
														</td>
														<td class="pad5 brdb_new tall ap" >
														<div class="padtb5 black_txt"><a href="../approveRequest/<?php echo $value['enc']; ?>/<?php echo $data['cid']; ?>" >Godkänn</a></div>
													</td>
													<td class="pad5 brdb_new tall rj">
														<div class="padtb5 black_txt"><a href="../rejectRequest/<?php echo $value['enc']; ?>/<?php echo $data['cid']; ?>">Avböj</a></div>
													</td>
									...
									<div class="padt20 padb10 talc">
										<a href="javascript:void(0);" class="load_more_results  marrl5" value="1" onclick="add_more_all(this);">Visa fler</a>
								...
								<div class="tab-content padt5 active" id="tab_total1">
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="myCustomera">
										...
										<tbody id="myRequest">
											<?php  foreach($requestApprovedDetail as $category => $value) 
													{
								...
								<script>
									function add_more_my(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreRequestApprovedDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
								...
								<div class="tab-content padt5" id="tab_total">
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable2">
										...
										<tbody id="myRejected">
											<?php  foreach($requestRejectedDetail as $category => $value) 
													{
									...
									<div class="padt20 talc">
										<a href="javascript:void(0);" class="load_more_results  marrl5" value="1" onclick="add_more_reject(this);">Visa fler</a>
									...
									function add_more_reject(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreRequestRejectedDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
