...
<div class="browse__info info changedText">Here are employees available to fix the home repair requests</div>
</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
	foreach($employeesList as $category => $value) 
	{
	?> 	
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['email']; ?></div>
 
<div class="checkout__controls">
<a href="../../../assignEmployee/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
