         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Manage your reservation fee information</div>
...
">
		...
		<div class="section flights" style="margin-bottom:0px;">
          <div class="flights__center center xxs-padrl25 marb40">
	...
	<div class="section destinations xs-padrl25  " style="margin-bottom:20px; border-bottom:1px solid #353945;">
		...
		<div class="sorting__foot ">
                 ...
                 <div class="nav hidden-xs"><a class="nav__link active" href="#">Fee information</a> </div>
                   <div class="sorting__select">
				   
               <a href="../../buildingReservationCondition/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>">  <button class="button-stroke catalog__button" fdprocessedid="qf2gj">
                  <span>Add fee</span>
                </button></a>
                </div>
              </div>
		  ...
		  <div class="flights__sorting hidden-xxs " style="margin-top:0px; border-top:0px !important; margin-bottom:0px;  padding:0 !important;">
            ...
            <div class="flights__row">
               ...
               <div class="flights__container" style="padding-left:0px;">
				...
				<?php $i=1; 
								foreach($buildingReservationPriceInfo as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">Reservation fee <?php echo  $value['random_reservation_fee']; ?>%</div>
...
">
			 <div class="description__parameter" style="margin-top: 0px;">
                  ...
                  </svg>Reserved <?php echo  $value['total_weeks']; ?> Weeks</div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>Maximum <?php echo  $value['total_installment_allowed']; ?> installment allowed</div>
                
				<div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>Resale <?php if($value['resale_allowed']==0) echo 'not'; ?> allowed</div>
