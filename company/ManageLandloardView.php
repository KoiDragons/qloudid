										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="../../UserTenantCompany/monitorAccount/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Hyresgäster</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Landlord admin</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											</ul>
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="column_m container tab-header  talc dark_grey_txt mart5">
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey_bg">
									<li>
										<a href="#" class="dblock brdradt5 active" data-id="tab_total">
											...
											<span class="black_txt trn fsz16" >Admin </span>
										</a>
									</li>
								...
								<select class="tab-header xs-wi_100 maxwi_100 dnone xs-dblock hei_70p pad0 nobrd brdb_new xs-fsz30 pblue2_bg">
									<option value="tab_total" selected class="xs-fsz20"><?php echo $employeesCount['num']; ?></option>
							...
							<div class="column_m container   fsz14 dark_grey_txt">
										...
										<thead class="fsz14" >
											<tr class="lgtgrey2_bg">
												...
												<th class="pad5 brdb_new nobold  tall" >
													<div class="padtb5 black_txt">Admin Name</div>
												</th>
												
												<th class="pad5 brdb_new nobold hidden-xs talr" >
								...
								<script>
									function add_more_all(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreLandloardDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
