            ...
            <div class="visible-xs visible-sm fleft padrl0">
			 ...
			 <div class="visible-xs visible-sm fright marr0 ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
                  ...
                  <li><a href="../childInformation/<?php echo $data['child_id']; ?>" class="fsz16i"><span class="fas fa-drafting-compass padr15"> </span> Details</a></li>
				  <li>
                    <div class="line martb10"></div>
                  </li>
                  <li><a href="javascript:void(0);" class="fsz16i"><span class="fas fa-users padr15"> </span>Parents</a></li>
				   <li>
                    <div class="line martb10"></div>
                  </li>
						 ...
						 <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
                                <div class="container ">
                                        ...
                                        <div class="tab-header mart10 padb10 xs-talc brdb_blue1">
                                            ...
                                            <a href="../parentRequestDetail/<?php echo $data['child_id']; ?>" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 blue_67cff7_brd_a t_67cff7_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Skickade</a>
											...
											<div class="wi_100 xs-wi_100 xs-order_3   fsz12 ffamily_avenir">
																			<div class="fleft wi_30 xs-wi_60 sm-wi_100 marl15 xxs-marl15 "> <span class="trn fsz14 ffamily_avenir" data-trn-key="Drop in & Pick up"> Drop in & Pick up</span> <span class=" edit-text jain1 dblock  brdclr_lgtgrey2 fsz18 black_txt"><?php echo $value['name']; ?></span> </div>
														...
														<a href="../parentPassport/<?php echo $data['child_id']; ?>/<?php echo $value['enc']; ?>"><span class="fas fa-arrow-alt-circle-right"></span></a>
													</div>	
