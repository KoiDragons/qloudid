   ...
   function informEmployee()
			{
				...
				if($("#end_date").val()=="" || $("#end_date").val()==null)
				{
					...
					$.ajax({
						type:"POST",
						url:"../../../checkExclusiveDates/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>",
						data:send_data,
						dataType:"text",
							 ...
							 if(data1==-1)
								{
									...
									$("#error_msg_form").html('Contract end date cant be before then start date');
									return false;
								}
							else if(data1==0)
								{
									 
									$("#error_msg_form").html('Selected dates are not available please select different dates');
									return false;
								}
								else
								{
 ...
 <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;">
    ...
    color: #f67f00; border-radius: 12px;
		...
		<option value="../../../editPropertyInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" >Basic details</option>
                <option value="#" selected>Exclusive</option>
...
<div class="upload__wrap  " style="background:transparent;  padding-right:128px;">
			...
			<a class="setting__link " href="../../../editPropertyInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../editPropertyInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                ...
                </svg><span style="color:#f67f00">Exclusive </span></a>
...
<div class="setting__head">
                    <h2 class="setting__title h2" style="font-size:25px;">Update Your Property Contract</h2> 
                  </div>
<form class="checkout__item js-tabs-item" action="../../../updateVitechAdddressContractInforamtion/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" onchange="updateContractStatus(this.value);" >
								   ...
								   <option value="1" class="changedText" <?php if($fetchPropertyContacTInfo['contract_type_info']==1) echo 'selected'; ?>>Exclusive</option>
											<option value="2" class="changedText" <?php if($fetchPropertyContacTInfo['contract_type_info']==2) echo 'selected'; ?>>Not exclusive</option>
                                    </select>
                            </div>
                          </div>
						...
						<div class="upload__item <?php if($fetchPropertyContacTInfo['contract_type_info']==2) echo 'hidden'; ?> " id="homeOwner">
					   ...
					   <div class="checkout__subtitle changedText">Home owner details</div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="first_name" id="first_name" value="<?php echo $fetchPropertyTaskInfo['first_name']; ?>" placeholder="e. g. Kowaken" style=" color:grey;"  <?php if($fetchPropertyTaskInfo['owner_email']!=null || $fetchPropertyTaskInfo['owner_email']!='') echo 'readonly'; ?>>
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="last_name" id="last_name" value="<?php echo $fetchPropertyTaskInfo['last_name']; ?>" placeholder="e. g. Ghirmai" style=" color:grey;" <?php if($fetchPropertyTaskInfo['owner_email']!=null || $fetchPropertyTaskInfo['owner_email']!='') echo 'readonly'; ?> >
                            </div>
                          </div>
						  </div>
						  ...
						  <div class="field" style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="owner_email" id="owner_email" value="<?php echo $fetchPropertyTaskInfo['owner_email']; ?>" placeholder="e. g. xyz@gmail.com" style=" color:grey;"  >
                            </div>
                          </div>
  ...
  <div class="upload__col upload__col_w30">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <select class=" "   id="country_id" name="country_id"  <?php if($fetchPropertyTaskInfo['owner_phone']!=null || $fetchPropertyTaskInfo['owner_phone']!='') echo 'disabled'; ?> style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
							<?php foreach($countryList as $category => $value) { ?>
											<option value="<?php echo $value['id']; ?>" <?php if($fetchPropertyTaskInfo['owner_country_phone']==$value['id']) echo 'selected'; ?> class="changedText"><?php echo $value['country_name']; ?></option>
											 <?php } ?>
								  </select>
                            </div>
                          </div>
						  ...
						  <div class="upload__col upload__col_w70">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="uphno" id="uphno" value="<?php echo $fetchPropertyTaskInfo['owner_phone']; ?>" placeholder="e. g. xxxxx12342" style=" color:grey;" <?php if($fetchPropertyTaskInfo['owner_phone']!=null || $fetchPropertyTaskInfo['owner_phone']!='') echo 'readonly'; ?> >
                            </div>
                          </div>
						  </div>
						  </div >
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="start_date" id="start_date" min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d',$fetchPropertyContacTInfo['contract_start_date']); ?>" placeholder="e. g. Kowaken" style=" color:grey;"  >
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="end_date" id="end_date" min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d',$fetchPropertyContacTInfo['contract_end_date']); ?>" placeholder="e. g. Ghirmai" style=" color:grey;" >
                            </div>
                          </div>
						  </div>
