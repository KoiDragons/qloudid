		...
		<div class="column_m header   bs_bb lgtgrey2_bg hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg"  >
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.safeqloud.com/company/index.php/CompanySuppliers/resourceAccount/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
			<div class="fright   padtbz10   "  >
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="https://www.safeqloud.com/company/index.php/InviteEmployee/selectMethod/<?php echo $data['cid']; ?>" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
									
									<span class="valm ffamily_avenir">Add employees</span>
								</a>
							</div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart20 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35 xxs-talc talc  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn nobold" >This is a list of employees added by admin manually, by file or integration.</a></div>
					 
										<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
                                             <a href="../adminAccount/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Employees</a>
											 <a href="../uninvitedEmployeesAccount/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Uninvited employees</a>
											   <a href="#" class="dinlblck mar5 padrl30     bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir">Old employees</a>
                                             
                                        </div>
										<div class="pad10 fsz16 xxs-talc talc lgtgrey2_bg">The employees from this list are no longer employed by the company. They don’t have a valid ID and connection.
										</div>
										 <?php 
												...
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<a href="#" class="black_txt"  > <span class="edit-text  fsz18  jain2 dblock  lgn_hight_18 "><?php echo  substr(html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']),0,18); ?></span>  </a>
																	</div>
												...
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz14 bold  black_txt">Sent employee request</span>
																	 ...
																	 <span class="edit-text  fsz18  jain2 dblock  lgn_hight_18 "><?php echo  substr(html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']),0,18); ?></span>  
																	</div>
											 ...
											 <div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<div class="fleft wi_75 xxs-wi_80   xs-mar0 ">
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz14 bold  black_txt">Uninvited employees</span>
										...
										<div class="clear"></div>
														...
														<div class="padtb20 talc <?php if($unsentRequestCount['num']<=5) echo 'hidden'; ?> ">
										...
										function add_more_rows_approved_location(link) {
															...
															$.ajax({
															type:"POST",
															url:"../moreActiveEmployeesOld/<?php echo $data['cid']; ?>",
															data:send_data,
															dataType:"text",
										...
										function add_more_rows_sent(link) {
																...
																$.ajax({
																type:"POST",
																url:"../moreSentRequestRelievedDetail/<?php echo $data['cid']; ?>",
																data:send_data,
																dataType:"text",
																contentType: "application/x-www-form-urlencoded;charset=utf-8",
																success: function(data1){
										...
										function add_more_rows_unsent(link) {
																...
																$.ajax({
																type:"POST",
																url:"../moreUnsentRequestRelievedDetail/<?php echo $data['cid']; ?>",
																data:send_data,
																dataType:"text",
																contentType: "application/x-www-form-urlencoded;charset=utf-8",
																success: function(data1){
