...
<a class="header__logo xs-fsz20 " href="../companyAccount/<?php echo $data['cid']; ?>" style="
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle  txt_f67f00 ">Integration</div>
                                      </a>
									...
									<a class="categories__item bg_E7E7E7 " href="../companyProfileAction/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_787f91">Setup</div>
										...
										<a class="categories__item bg_E7E7E7 " href="../companyProfileServices/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
           ...
           <div class="catalog__body">
            <div class="catalog__center center">
              <div class="catalog__cards"  style="margin:0px;">
						...
						<a class="card  " href="https://dstricts.com/public/index.php/BookingInformation/checkedInDetail/bGRHSW1rdXMxRVFkVHl4WUhhdkVtdz09" style="margin-left:0px;">
                  <div class="card__preview"><img srcset="https://www.qloudid.com/html/usercontent/images/notavailable.jpg" src="https://www.qloudid.com/html/usercontent/images/notavailable.jpg" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category changedText" style="background: white; color:black;  ">Home Guest</div>
                  </div>
                  </a>
			  <a class="card  " href="https://dstricts.com/public/index.php/BookingInformation/checkedInDetail/bHRpWWxsb1pSa2dyR0ZWeHdST3plZz09">
                  <div class="card__preview"><img srcset="https://www.qloudid.com/html/usercontent/images/notavailable.jpg" src="https://www.qloudid.com/html/usercontent/images/notavailable.jpg" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category changedText" style="background: white; color:black;  ">Home Owner Box</div>
                  </div>
                  </a>
					<a class="card  " href="https://dstricts.com/public/index.php/BookingInformation/sellPropertyInformation/bHRpWWxsb1pSa2dyR0ZWeHdST3plZz09">
                  <div class="card__preview"><img srcset="https://www.qloudid.com/html/usercontent/images/notavailable.jpg" src="https://www.qloudid.com/html/usercontent/images/notavailable.jpg" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category changedText" style="background: white; color:black;  "> Find broker</div>
                  </div>
                  </a>	
