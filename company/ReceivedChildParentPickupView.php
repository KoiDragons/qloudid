               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../childrenPickupList/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">	
									...
									<h1 class="marb0  xxs-talc talc fsz100   xxs-fsz45 xs-bold padb10 blue_67cff7 trn ffamily_avenir">Pick up</h1>
									</div>
									<!-- Logo -->
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz25 xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Select the person making the request to pick up. Make sure you identity who he is before approving.</a></div>
							...
							<div class="container   fsz14 dark_grey_txt">
								...
								<div class="tab-content padt5 active" id="tab_total1" style="display:block;">
									...
									<div class=" wi_50 xxs-wi_50 fleft bs_bb padrb20 talc  " >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_210p xxs-hei_150p dblock bs_bb pad25 xs-pad10   brdclr_seggreen_h brdrad5 <?php if(!empty($childSignInDetail)) { if($a[0]=='p' && $a[1]==$value['id'] ) echo 'lgtgrey2_bg black_brd'; else echo 'lgtgrey2_bg'; } else echo 'lgtgrey2_bg'; ?>  box_shadow trans_all2 " onclick="changeBG(this,<?php echo $value['id']; ?>);">
																<div class=" ">
																	...
																	<div class="padrb15 padt20 xs-padt15 xs-padr0">
																		<h3 class="ovfl_hid tall pad0 txtovfl_el ws_now lgn_hight_24 bold fsz18 segdblue_txt padt0 xs-fsz15 ffamily_avenir"><?php echo html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']); ?></h3>
																		<span class="dblock tall marb5 padt10 midgrey_txt fsz16 hidden-xs ffamily_avenir"><?php echo $value['parent_ssn']; ?></span>
									...
									<div class=" wi_50 xxs-wi_50 fleft bs_bb padrb20 talc  " >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_210p xxs-hei_150p dblock bs_bb pad25 xs-pad10  brdclr_seggreen_h brdrad5  <?php if(!empty($childSignInDetail)) { if($a[0]=='r' && $a[1]==$value['id'] ) echo 'lgtgrey2_bg black_brd'; else echo 'lgtgrey2_bg'; } else echo 'lgtgrey2_bg'; ?>  box_shadow trans_all2 "  onclick="changeBGR(this,<?php echo $value['id']; ?>);">
																<div class=" ">
																	<div class="wi_100 hei_90p dflex bs_bb">
																		<img src="../../../<?php echo $value['image_path']; ?>" height="90" width="90" class="brdrad5 padb0">
																	</div>
																	...
																	<div class="padrb15 padt20 xs-padt15 xs-padr0">
																		<h3 class="ovfl_hid tall pad0 txtovfl_el ws_now lgn_hight_24 bold fsz18 segdblue_txt padt0 xs-fsz15 ffamily_avenir"><?php echo html_entity_decode($value['relative_first_name']).' '.html_entity_decode($value['relative_last_name']); ?></h3>
																		<span class="dblock tall marb5 padt10 midgrey_txt fsz16 hidden-xs ffamily_avenir"><?php echo $value['relative_ssn']; ?></span>
								...
								<form action="../confirmPickupInfo/<?php echo $data['child_id']; ?>" method="POST" name="save_indexing" id="save_indexing">	
						...
						<div class="padt5 xxs-talc talc">
								...
								<button type="button" name="forward" class="forword minhei_55p bgclr_seggreen_47E2A1 fsz18 trn ffamily_avenir" onclick="submitForm();">Next</button>
