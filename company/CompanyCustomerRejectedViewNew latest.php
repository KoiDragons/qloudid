...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Data Protection Compliance</h2>
...
">
 ...
 <div class="sorting__details" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Manage your GDPR regulations with ease and professionalism
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Trash</div>
                                      </a>
			           <a class="categories__item  bg_E7E7E7 " href="../receivedRequests/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_787f91">Request</div>
									   ...
									   <a class="categories__item  bg_E7E7E7 " href="../companyAccount/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Active</div>
                                      </a>
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo  $value['email']; ?></div>
...
">
   ...
   ">Review</a>
												...
												<?php  } foreach($requestRejectedDetailparent as $category => $value) 
												{
												?> 
...
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo  html_entity_decode($value['name']); ?>
</div>
