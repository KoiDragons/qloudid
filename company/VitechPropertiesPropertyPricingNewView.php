...
<a class="header__logo xs-fsz20 changedText " href="../../../listEmployeesCreatedProperties/<?php echo $data['cid']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
 ...
 <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;">
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
				...
				<option value="../../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>Broker to Broker</option>
			...
			<a class="setting__link  " href="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                ...
                </svg><span style="color:#f67f00">Broker to Broker</span></a>
			...
			<form class="checkout__item js-tabs-item" action="../../../updatePropertyPricing/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <script>
                ...
                <div class="setting__item  " style="display:block;">
                <h2 class="setting__title h2">Pricing Rules</h2>
                <div class="setting__list">
                  <div class="setting__box">
                     
                    <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Short term rental</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"   onclick='updateRent(this);' <?php if($fetchPropertiesPricing['rent_info']==1) echo 'checked'; ?>/><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Is this property available for short term rentals</div>
                    </div>
                    ...
                    <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Markup</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" <?php if($fetchPropertiesPricing['markup_info']==1) echo 'checked'; ?>/><span class="switch__inner" onclick='updateMarkupInfo(this);' ><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Is this property available for price markup</div>
                    </div>
 ...
 <input type="hidden" id="share_commission_info" name="share_commission_info" value="<?php echo $fetchPropertiesPricing['share_commission_info']; ?>"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        <div class="setting__subtitle">Share commission </div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateShareCommisionInfo(this);' <?php if($fetchPropertiesPricing['share_commission_info']==1) echo 'checked'; ?>/><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you want to share your commission with other broker</div>
                    </div>
