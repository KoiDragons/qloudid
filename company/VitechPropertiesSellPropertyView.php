   ...
   function informEmployee()
			{
				...
				if($("#first_name").val()=="" || $("#first_name").val()==null)
				{
					...
					$("#error_msg_form").html('Please enter first name of buyer');
					return false;
				}
				...
				if($("#last_name").val()=="" || $("#last_name").val()==null)
				{
					...
					$("#error_msg_form").html('Please enter last name  of buyer');
					return false;
				}
				...
				if($("#owner_email").val()=="" || $("#owner_email").val()==null)
				{
					...
					$("#error_msg_form").html('Please enter email  of buyer');
					return false;
				}
				...
				if($("#uphno").val()=="" || $("#uphno").val()==null)
				{
					...
					$("#error_msg_form").html('Please enter buyer phone number');
					return false;
				}
				...
				if($("#sold_on").val()=="" || $("#sold_on").val()==null)
				{
					...
					$("#error_msg_form").html('Please enter date  till when the property is reserved for buyer');
					return false;
				}
				 ...
				 if($("#reservation_fee").val()=="" || $("#reservation_fee").val()==null)
				{
					...
					$("#error_msg_form").html('Please enter reservation fee');
					return false;
				}
				 ...
				 if($("#reservation_fee").val()>$("#sell_price").val())
				{
					...
					$("#error_msg_form").html('Please enter reservation fee less then or equal to sell price');
					return false;
				}
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
			 ...
			 <div class="upload__wrap  " style="background:transparent; padding-right:128px;">
                 <div class="setting__menu" style="background:transparent; border-right:4px solid #353945; border-radius:0px; border-image: linear-gradient(45deg, rgb(255, 172, 84) 0%, rgb(255, 77, 60) 100%) 1 / 1 / 0 stretch !important;
...
<div class="checkout__list">
 ...
 <div class="upload__head" style="margin-bottom:0px;">
                  <h2 class="upload__title h2">Reserve This Property Now</h2>   
				  
                </div>
				<div class="browse__info info changedText padb40 hidden" style="border-bottom: 2px solid #353945;">Fill in the form and begin the selling process today
</div>
<form class="checkout__item js-tabs-item" action="../../../reserveVitechAdddress/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
                              ...
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="number" name="sell_price" id="sell_price" placeholder="e. g. 180" required>
                                  </div>
                                </div>
                              </div>
                              <div class="upload__cell">
						  ...
						  <div class="upload__col upload__col_w30" id="status_info">
                            ...
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="date" name="sold_on" id="sold_on" min='<?php echo date('Y-m-d');?>' value='<?php echo date('Y-m-d');?>' style=" color:grey;"  >
                                  </div>
                                </div>
                              </div>
