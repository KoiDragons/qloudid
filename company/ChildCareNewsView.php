...
<html>
	...
	if($row_summary ['passport_image']!=null) { $filename="../estorecss/".$row_summary ['passport_image'].".txt"; if (file_exists($filename)) { $value_p=file_get_contents("../estorecss/".$row_summary ['passport_image'].".txt"); $value_p=str_replace('"','',$value_p); $value_p = base64_to_jpegencode( $value_p, '../estorecss/tmp'.$row_summary['passport_image'].'.jpg' ); } else { $value_p="../html/usercontent/images/person-male.png"; } }  else $value_p="../html/usercontent/images/person-male.png";
		
	if($companyDetail ['profile_pic']!=null) { $filename="../estorecss/".$companyDetail ['profile_pic'].".txt"; if (file_exists($filename)) { $value_a=file_get_contents("../estorecss/".$companyDetail ['profile_pic'].".txt"); $value_a=str_replace('"','',$value_a);  $imgs = base64_to_jpegencode( $value_a, '../estorecss/tmp.jpg' );  $imgs='../../../'.$imgs; } else { $value_a="../../../../html/usercontent/images/default-profile-pic.jpg";  $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; } }  else {  $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; $value_a="../../../../html/usercontent/images/default-profile-pic.jpg"; } ?>
	<head>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo $path;?>html/usercontent/css/trans-banner.css"/>
		...
		<script>
			...
			function sendRequest(){
				...
				$.ajax({
															type:"POST",
															url:"../moreInformation/<?php echo $data['cid']; ?>",
															data:send_data,
															dataType:"text",
               ...
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
                    ...
                    <div class=" mart10"></div>
									...
									<li class="first"><a href="javascript:void(0);" class="fsz16i" ><span class="fas fa-gift padr15"> </span>Newsfeed</a>
										</li>
									<li>
                  ...
                  <li><a href="../helpCenter/<?php echo $data['cid']; ?>" class="fsz16i"><span class="fas fa-list-ol padr15"> </span> Children</a></li>
				   <li>
                    <div class="line martb10"></div>
                  </li>
                  <li><a href="../../ReceivedChild/attendenceDetail/<?php echo $data['cid']; ?>" class="fsz16i"><span class="fas fa-drafting-compass padr15"> </span> Presence</a></li>
				  <li>
                    <div class="line martb10"></div>
                  </li>
      ...
      <div class="clear" id=""></div>
		...
		<div class="column_m pos_rel" onclick="checkFlag();">
			...
			<div class="column_m container zi5 mart40 xs-mart0" >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0 xs-padrl0">
					<div class="wi_240p fleft pos_rel zi50">
								<div class="padrl10">
                                 ...
                                 <a href="../helpCenter/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
				...
				<div class="right_container  xxxs-wi_100 maxwi_100 ">
						
						<!-- News -->
					<div class="column_m scroll_menu_header wi_480p  xxxs-wi_100 maxwi_100  brdrad3"  data-li-params="class|dblock padb5" data-params="class|dblock padb3 brdb_new brdclr_trans brdclr_white_a lgtgrey2_bg_a dark_grey_txt blue3_txt_a">
						...
						<div class="padtb0 brdrad3 ">
							...
							<div class="padb10  talc padt20">
								...
								<h1 class="lgn_hight_36 padt10 padb20 xs-padb10 talc fsz35 white_txt"><?php echo $companyDetail['company_name']; ?></h1>
						</div>
						...
						<div class="tab-header mart10 padb10 xs-talc   nobrdt nobrdl nobrdr talc visible-xs">
							...
							<!-- post article form -->
							<div class="container brd_e3e2e2    xxs-brdrad0 xxs-nobrdrl white_bg fsz14 dark_grey_txt ">
								...
								<form action="../postChildNews/<?php echo $data['cid']; ?>" method="POST" id="post_comment" name="post_comment" accept-charset="ISO-8859-1">
									...
									<div class="padb10 talc hidden-xxxs" id="post_comment_mid">
										<div class="padrl25">
										<button type="button" class="hei_34p padrl15  brdrad2 white_bg blue_txt blue_brd curp" onclick="checkPost();">Post it</button>					
										</div>
									</div>
							...
							<div id="discussions">
								...
								<div class="discussion mart25 brd_e3e2e2 brdrad5  xxs-brdrad0 xxs-nobrdrl white_bg fsz14 dark_grey_txt brd_e3e2e2  nobrdt nobrdb xs-nobrd">
									...
									<div class="padt15 blue_67cff7_brd brd_width_2 nobrdb nobrdl nobrdr ">
										<div class="padrl20">
											<div class="fleft">
									...
									<div class="  ">
										<div class="padrl0">
											<form action="../postReply/<?php echo $data['cid']; ?>" method="POST" id="reply_comment<?php echo $value['id']; ?>" name="reply_comment<?php echo $value['id']; ?>" accept-charset="ISO-8859-1">
						...
						<!-- News -->
						<div class="column_m wi_220p bs_bb padl20 talc hidden-xxxs">
							<div class="padtb30 brd white_bg talc">
								<div class="marb10 lnkdblue_txt fsz32"><?php echo $parentCount['num']; ?></div>
								<div class="marb5 fsz14">Connected parents</div>
								<div class="fsz14">
									<a href="#">See all</a>
								</div>
								<div class="padt20">
								<?php foreach($parentImages as $category => $valueImage) { ?>
									<a href="#"><img src="../../../<?php echo $valueImage['image_path']; ?>" width="36" height="36" class="marl-15 brdrad40"></a>
									<?php } ?>
								</div>
							</div>
