				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Here is the list of request received from tenants</a></div>
					 
					 
						<div class="tab-header martb0 padb30 xs-talc  nobrd talc">
                                            
                                              <a href="../addTenantInfo/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10     bg_98cf44 brdrad50  lgn_hight_60 fsz60  white_txt white_txt_ah ffamily_avenir">+</a>
						...
						<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
                                               ...
                                               <a href="../monitorAccount/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir">Approved</a>
											     <a href="../sentAccount/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir">Sent</a>
												 <a href="../rejectedAccount/<?php echo $data['cid']; ?>" class="padrl30_a padrl10 fsz18 midgrey_txt lgn_hight_36 "><i class="fas fa-trash-alt" aria-hidden="true"></i></a>
                                        </div>
					 		<?php $i=1;
									...
									<div class="padtb20 mart20 talc <?php if($pendingCount['num']<=20) echo 'hidden'; ?>">
