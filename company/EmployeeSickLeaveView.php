...
<script>
			...
			{
				$("#error_msg_form").html('');
				if($("#day_leave").val()=="" ||  $("#day_leave").val()==null)
				{
				$("#error_msg_form").html('Please enter number of days.');
					return false;
				}
				else if(isNaN($("#day_leave").val()))
				{
				$("#error_msg_form").html('Please enter numeric value.');
					return false;
				}
				else
				{
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45 padb10 blue_67cff7 trn ffamily_avenir"  >Attendance</h1>
									</div>
									<div class="martb20 xs-marb20   xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Please add number of days for sick leave.</a></div>
							
								 
									
									<form action="../updateLeave/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing">
									
									<div class="on_clmn mart10 xxs-mart10 marb35">
										
										<div class="pos_rel">
										<input type="number" name="day_leave"  placeholder="Toral days " id="day_leave"  class="wi_100  pad10 talc  minhei_65p fsz18 nobrdt nobrdr nobrdl brdb_red_ff2828 red_f5a0a5_txt xxs-minhei_60p ffamily_avenir">
									</div>
									</div>
