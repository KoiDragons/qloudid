			...
			<div class="column_m lgtblue2_bg" >
				<div class="wrap sub_header_brdclr_dblue bs_bb">
					...
					<li class="dflex alself_fs marrl10 padrl5" style="height:93px;">
						...
						<li class="dflex alit_s marrl10 padrl5" style="height:93px;">
							<a href="#" class="active minwi_100p dblock  brdb brdwi_3 brdclr_trans brdclr_pblue2_h brdclr_pblue2_a talc fsz14 fsz15_a black_txt  popup_false pad10" data-target="#gratis_popup">
								<span class="mar10 fa fa-briefcase hei_35p dflex alit_c justc_c talc fsz28 black_txt pred2_txt_ph "></span>
        ...
        <div class="hidden-sm hidden-md hidden-lg">
         <span class="fa fa-filter fsz20"></span>
				...
				<div class="tab-content" id="tab-business">
					<div class="wi_100-240p container tab-header padb10 talc dark_grey_txt">
									...
									<ul class="tab-header tab-header-custom  tab-header-custom5 xs-dnone lgtblue2_bg">
										<li class="">
											<a href="#" class="dblock tab_header_custom_a brdradt5 active header_color brdclr_pblue2_a brdwi_3 brdbb brdb_a " data-id="tab_inhouse_total" > <span class="count"><?php echo $requestCount['num']; ?></span> </a>
										</li>
										<li class="active">
											<a href="#" data-id="tab_inhouse_property" class="brdclr_pblue2_a brdwi_3 brdbb brdb_a fsz14"  > <span class="count"><?php echo $approveCount['num']; ?></span> <span>Approved Request</span> </a>
										</li>
										<li class="">
											<a href="#" data-id="tab_inhouse_visiting_address" class="brdclr_pblue2_a brdwi_3 brdbb brdb_a fsz14" > <span class="count"><?php echo $rejectCount['num']; ?></span> <span>Rejected Request</span> </a>
										</li>
										<li class="">
											<a href="#" data-id="tab_inhouse_invoicing_address" class="brdclr_pblue2_a brdwi_3 brdbb brdb_a fsz14" > <span class="count"></span> <span></span> </a>
										</li>
										<!--<li class="">
											<a href="#" data-id="tab_inhouse_contact_details" class="" > <span class="count">0</span> <span>Corporate</span> </a>
										</li>-->
										<li class="">
											<a href="#" data-id="tab_inhouse_closed_details" class="brdclr_pblue2_a brdwi_3 brdbb brdb_a fsz14" > <span class="count"></span> <span></span> </a>
										</li>
				...
				After years AS a multiple awarded sales agent and project leader I was encouraged by the CEO of ThomsonFakta - a Thomson Reuters company to start my own company with them as my first customer. I served Thomsonfakta 2002-2004.
				   ...
				   <div class="tab-content" id="tab_inhouse_total">
											...
											<div class="xs-wi_100vw-90p xs-ovfl_auto">
												<table class="wi_100 brdsptb_0" cellpadding="0" cellspacing="0">
													<thead>
														<tr>
															...
															<th class="wi_300 padr10 brdb grey_txt nobold tall" style="text-align:left;">First Name</th>
															<th class="wi_300 padr10 brdb grey_txt nobold tall" style="text-align:left;">Last Name</th>
															<th class="wi_300 padr10 brdb grey_txt nobold tall" style="text-align:left;">Email</th>
															<th class="padr10 brdb grey_txt nobold" style="text-align:left;">Approve</th>
															<th class="padr10 brdb grey_txt nobold" style="text-align:left;">Reject</th>
												...
												?>
														<tr class="style_base bg_fffbcc_a">
																...
																<div class="wi_100">
																	<div class="dflex alit_c">
																		<h3 class="mar0 pad0 fsz16 xs-fsz16">
																			<a href="#" class="get-company-info1 dark_grey_txt txt_0070e0_sbh" data-id="<?php echo $value['id']; ?>" id="<?php echo 'a_'.$value['id']; ?>"><?php echo $value['first_name']; ?></a>
																		</h3>
															...
															<td class="brdb ws_now fsz14">
															<a href="#" class="dark_grey_txt txt_0070e0_sbh fsz14"><?php echo $value['last_name'];?></a>
																
															</td>
															<td class="brdb ws_now fsz14">
															<a href="#" class="dark_grey_txt txt_0070e0_sbh fsz14"><?php echo $value['email'];?></a>
																
															</td>
															<td class="brdb ws_now fsz14">
															<a href="../approveRequest/<?php echo $value['enc']; ?>/<?php echo $data['cid']; ?>" class="dark_grey_txt txt_0070e0_sbh fsz14">Approve</a>
																
															</td>
															<td class="brdb ws_now fsz14">
															<a href="../rejectRequest/<?php echo $value['enc']; ?>/<?php echo $data['cid']; ?>" class="dark_grey_txt txt_0070e0_sbh fsz14">Reject</a>
				 ...
				 <div class="tab-content" id="tab_inhouse_property">
					<div class="wi_100 dflex alit_fs">
						...
						<div class="flex_1 padl10">
							...
							<div class="tab-content" id="tab-total-all1" style="display:block">
							
								<div class="dflex alit_fs">
									
									<!-- Center content -->
									<div class="flex_1 dflex fleft padrbl15">
										<form data-count-target="#total-all-selected-count1">
											<div class="xs-wi_100vw-90p xs-ovfl_auto">
												<table class="wi_100 brdsptb_0" cellpadding="0" cellspacing="0">
													<thead>
														<tr>
															...
															<th class="padr10 brdb grey_txt nobold" style="text-align:left;">Transffer</th>
														<th class="wi_130p padtb5 brdb"></th>
														</tr>
													</thead>
													<tbody id="total_data">
												...
												?>
														<tr class="style_base bg_fffbcc_a">
															<td class="xs-dnone sm-dnone padr5 padb10">
																<input type="checkbox" class="check toggle-visited toggle-class" data-target="#total-all-actions1" data-closest="form" data-check-all="true" data-classes="active" data-class-closest=".style_base" data-class-check-all="true" />
															</td>
															...
															<td class="padrb10 brdb">
																<div class="wi_100">
																	<div class="dflex alit_c">
																		<h3 class="mar0 pad0 fsz16 xs-fsz16">
																			<a href="#" class="dark_grey_txt txt_0070e0_sbh" data-id="<?php echo $value['id']; ?>" id="<?php echo 'a_'.$value['id']; ?>"><?php echo $value['first_name']; ?></a>
																		</h3>
																		<a href="#" class="dnone dblock_sbh padl5"><span class="fa fa-star-o"></span></a>
																	</div>
																	<div class="mart5"><a href="mailto:kowaken.ghirmai@qmatchup.com" class="txt_4a"><?php echo $value['email']; ?></a></div>
															...
															<td class="brdb ws_now fsz14">
															<a href="../sendQloudEmployee/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" class="dark_grey_txt txt_0070e0_sbh fsz14">Transffer</a>
									...
									<!-- Right content -->
									<div class="wi_240p shrink_0 xs-dnone sm-dnone pos_rel zi5 mart-278 padl20">
										<div class="marb50 vis_hid vis_vis_v" id="total-all-actions1">
											<p class="padb10"><span id="total-all-selected-count1"></span> items selected</p>
											<p class="padb5"><a href="#" class="dblock padtb3 padrl20 brdrad3 bg_0070e0 ws_now talc lgn_hight_29 fsz14 white_txt">Download</a></p>
											<div>
												<a href="#" class="dblock fsz14 txt_0070e0">
													<img src="<?php echo $path; ?>html/usercontent/images/dropbox icons/move.svg" width="32" height="32" class="valm" />
				...
				<div class="tab-content" id="tab_inhouse_visiting_address">
					<div class="wi_100 dflex alit_fs">
						...
						<div class="flex_1 padl10">
							...
							<div class="tab-content" id="tab-total-all2" style="display:block">
							
								<div class="dflex alit_fs">
									
									<!-- Center content -->
									<div class="flex_1 dflex fleft padrbl15">
										<form data-count-target="#total-all-selected-count2">
											<div class="xs-wi_100vw-90p xs-ovfl_auto">
												<table class="wi_100 brdsptb_0" cellpadding="0" cellspacing="0">
													<thead>
														<tr>
															...
															<th class="wi_300 padr10 brdb grey_txt nobold tall" style="text-align:left;">Last Name</th>
															<th class="wi_300 padr10 brdb grey_txt nobold tall" style="text-align:left;">Email</th>
															<th class="padr10 brdb grey_txt nobold" style="text-align:left;">Status</th>
												...
												?>
														<tr class="style_base bg_fffbcc_a">
															<td class="xs-dnone sm-dnone padr5 padb10">
																<input type="checkbox" class="check toggle-visited toggle-class" data-target="#total-all-actions2" data-closest="form" data-check-all="true" data-classes="active" data-class-closest=".style_base" data-class-check-all="true" />
															</td>
															...
															<td class="brdb ws_now fsz14">
															<a href="#" class="dark_grey_txt txt_0070e0_sbh fsz14">Rejected</a>
									...
									<!-- Right content -->
									<div class="wi_240p shrink_0 xs-dnone sm-dnone pos_rel zi5 mart-278 padl20">
										<div class="marb50 vis_hid vis_vis_v" id="total-all-actions2">
											<p class="padb10"><span id="total-all-selected-count2"></span> items selected</p>
											<p class="padb5"><a href="#" class="dblock padtb3 padrl20 brdrad3 bg_0070e0 ws_now talc lgn_hight_29 fsz14 white_txt">Download</a></p>
											<div>
												<a href="#" class="dblock fsz14 txt_0070e0">
													<img src="<?php echo $path; ?>html/usercontent/images/dropbox icons/move.svg" width="32" height="32" class="valm" />
