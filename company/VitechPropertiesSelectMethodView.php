...
<a class="header__logo xs-fsz25 changedText" href="../listEmployeesProperties/<?php echo $data['cid']; ?>" style="
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Add property one by one</div>
 
<div class="checkout__controls">
 
<a href="../searchPropertyInformation/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Add multiple properties at once.</div>
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Sync with your existing PMS.</div>
