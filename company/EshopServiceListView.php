<head>
   ...
   function updateMenu(id)
   {
	   ...
	   menuCategory=0;
		...
		{
			window.location.href ="https://www.safeqloud.com/company/index.php/Eshop/servicesDescription/<?php echo $data['cid']; ?>";
		}		
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
                <div class="visible-xs visible-xsi visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu  fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="../categories/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
								</li>
				...
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
													...
													<div class="sidebar_prdt_bx marr20 brdb padb20">
														<div class="white_bg tall">
															...
															<!-- Logo -->
																...
																<!-- Meta -->
																<div class="padt20 fsz30"> <span>Eshop</span>  </div>
															</a>																	
																	</div> 																</div>
													</div>		
													<div class="clear"></div>
					...
					<div class="wi_500p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl0 xs-pad0">
								 ...
								 <div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Digital menu</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc     xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Here is a list of all your services</a></div>
						...
						<div class="tab-header martb0 padb10 xs-talc  nobrd talc">
							  ...
							  <?php $i=0; foreach($completeServiceInfo as $category => $value) 
														{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php   echo $value['category_name']; ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php   echo $value2['dish_name']; ?></span>  </div>
													  
												<a href="../deleteMenuItem/<?php echo $data['cid']; ?>/<?php echo $value2['enc']; ?>"> <div class="fright wi_20  padl20 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0 hidden-xs">
