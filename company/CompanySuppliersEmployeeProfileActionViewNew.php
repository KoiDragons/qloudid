...
<div class="outer" >
<!-- header-->
<?php if($employeeVerificationInfo['num']==0) {     ?>
...
<a class="button button-small header__button   xxs-mart10 changedText hidden-xxs   " href="../../CompanyCrm/adminAccount/<?php echo $data['cid']; ?>" style="margin-left:35px;  background:transparent; color:#777E90; font-size: 16px; padding-right:0px;">Admin view</a>
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
				...
				<a class="header__link" href="https://www.qloudid.com/company/index.php/Company/companyAccount/<?php echo $data['cid']; ?>">
					...
					<a class="header__link" href="../companyProfileServices/<?php echo $data['cid']; ?>">
 ...
 <form action="../companyEmployeeProfileAction/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">

<input type="hidden" id="marketplace_id" name="marketplace_id" value="<?php echo $data['marketplace_id']; ?>" />
								...
								foreach($marketplaceList as $category => $value) 
												{
												 ...
												 ?>											
				<a class="categories__item black_bg " href="javascript:void(0);" style="padding: 26px; padding-right:20px; padding-left:20px; font-size:14px; border-radius:6px; " onclick="submitForm(<?php echo $value['id']; ?>);" >
                                       
                                      <div class="changedText categories__subtitle  txt_f67f00  "><?php echo $value['marketplace_name']; ?></div>
                                      </a>
												<?php $i++; } else { ?>
												  <a class="categories__item  bg_E7E7E7 " href="javascript:void(0);" style="padding: 26px; padding-right:20px; padding-left:20px; font-size:14px; border-radius:6px; "  onclick="submitForm(<?php echo $value['id']; ?>);">
                                       
                                      <div class="changedText categories__subtitle txt_787f91 "><?php echo $value['marketplace_name']; ?></div>
                                      </a>

												<?php } }  if($appdownloadStatus==0)
												{ ?>
												<a class="categories__item  bg_E7E7E7 " href="../../Brand/productPage/<?php echo $data['cid'];?>/<?php echo $getPermissionDetail; ?>" style="padding: 26px; padding-right:20px; padding-left:20px; font-size:14px; border-radius:6px; "  >
...
<div class="brands__list" style="display:flex;">
			<?php  	foreach($selectedMarketplaceSortedServiceDetail as $category => $value) 
												{
													 
												if($value['flow_url']=='' || $value['flow_url']==null || $value['flow_url']=='#')		
												{ 
												 ?>		
<div class="brands__item" style=""><a href="#"><div class="browse_info info fsz24 talc xxs-pad5 changedText" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;"><?php echo $value['subcategory_name']; ?></div></a></div>
 	<?php } else { ?>
