               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../../../../Landloard/floorApartmentAddins/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 white_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../../../Landloard/floorApartmentAddins/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir"  >Tenants</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Here is the list of rejected tenant requests</a></div>
						...
						<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
											   ...
											   <a href="#" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir">Received</a>
                                               <a href="../../../../monitorAccount/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir">Approved</a>
											     <a href="../../../../sentAccount/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir">Sent</a>
												 <a href="#" class="padrl30_a padrl10 fsz18 red_ff2828_txt lgn_hight_36 active"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>
                                        </div>
					 		<?php $i=1;
												
												foreach($requestDetailRejected as $category => $value) 
												{
											...
											<div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0  bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz18  bold  black_txt"><?php echo  $value['first_name'].' '.$value['last_name']; ?></span>
																	
																	  <span class="edit-text  fsz14  jain2 dblock  lgn_hight_18 "><?php echo  $value['email']; ?></span>  
																	</div>
