         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Your Broker Connections</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Respond to broker requests or send new connection requests.</div>
...
<div class="categories__inner">
               ...
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Received requests</div>
									    ...
									    <a class="categories__item    " href="../sentBrokerRequest/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91" >Sent requests</div>
                                      </a>
 ...
 <!-- outer content-->
		...
		<div class="section flights">
          <div class="flights__center  xs-padrl25">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;"><?php echo  substr(html_entity_decode($value['company_name']),0,25); ?></div>
...
">
                <div class="description__parameter" style="margin-top: 0px;">
                 ...
                 <?php if($value['application_type']==2) { ?>
				   <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $value['licence_number']; ?></div>
				 <?php } ?>
              </div>
   ...
   ">Approved</a>
			   ...
			   <?php } else if($value['is_approved']==2) { ?>
                        <a class="header__logo xs-fsz20 changedText fright" href="javascript:void(0);" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   ...
   ">Rejected</a>
			   ...
			   <div>
                    ...
                    <a class="header__logo xs-fsz20 changedText fright marl20" href="../rejectRequest/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
   ...
   border: 2px solid #f67f00;
   ">Reject</a>
    <a class="header__logo xs-fsz20 changedText fright " href="../approveRequest/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
