         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 white_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../listParking/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>../../..listParking/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Please select availble option below to update parking information</a></div>
								...
								<a href="javascript:void(0);" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5" onclick="expandThis(1);">Block - <?php echo $buildingDetailInfo['block_number']; ?>
								...
								<div id="profile1" class="" style="display: block;">		 
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Parkings</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Edit parking details</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
													
													<a href="../../../editParkingDetail/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['pid']; ?>" class="xs-padr20">  
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											...
											<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Photos</span>
													...
													<a href="../../../parkingPhotoInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['pid']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
								 ...
								 <div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											...
											<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Rules</span>
													<span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Add/update parking rules</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
...
<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											...
											<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Tenant</span>
													<span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Add/list parking tenants</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
													
													<a href="../../../parkingTenantDetail/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['pid']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi">Review</button>
																			</div> 
																			</a>
