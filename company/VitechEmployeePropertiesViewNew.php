...
<script style="    background: #212B3B;">
...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="../propertyInformation/<?php echo $data['cid']; ?>" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Add property</button>
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" >FOR SALE PROPERTIES</h2>
<div class="browse__info info changedText">Properties added by <?php echo $userSummary['first_name'].' '.substr($userSummary['last_name'],0,1); ?></div>
</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">All sale</div>
                                      </a>
									  
									    
									  <a class="categories__item  bg_E7E7E7 " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Connected</div>
                                      </a>
				<a class="categories__item bg_E7E7E7  " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Pending</div>
                                      </a>
...
<a class="card card_row " style="border: 2px solid #353945;border-radius: 20px;margin-bottom: 20px;" href="../viewPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">
  
 <div class="card__preview" style="width: 161px;padding: 30px;"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="London - Kings Cross" style="
    padding: 20px;
    border-radius: 30px;
">
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $value['shortSaleDescription']; ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;">Is to be sold
</div>
...
">
                ...
                <div class="description__parameter">
                  ...
                  </svg><?php echo $value['area'].' kvm'; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>€<?php echo $value['startingPrice']; ?></div>
              </div></div></a>
