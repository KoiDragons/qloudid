			...
			<div class="col-lg-6 content-right" id="start">
				<div id="wizard_container">
						...
						<div class="collaborator-row dflex alit_c pos_rel">
							...
							<div class="hei_160p">
								<div class=" step">
									<h3 class="main_question">MEDDELA ANKOMST</h3>
									<p>Om du fyller i namnet på den som du vill/ska besöka så meddelar vi din ankomst...</p>
									
									
									<input type="hidden" name="booked" id="booked" value="<?php if($getBookId==2) echo 'Bokat besök'; else echo 'Drop in'; ?>" />
									<div class="form-group">
										<input type="text" name="empname"  placeholder="Namn på den du ska träffa..." id="collaborators-lookup"  class="form-control required" onkeyup="updateForm();">
									</div>
