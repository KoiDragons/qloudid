	...
	if (input.files && input.files[i]) {
		...
		reader.onload = function (e) {
			...
			var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updatePhotos/<?php echo $data['cid']; ?>/<?php echo $data['vid']; ?>",
							data:send_data,
							dataType:"text",
...
function getImageInfo(id)
{
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../getImageInfo/<?php echo $data['cid']; ?>/<?php echo $data['vid']; ?>",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function getPhoto()
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../getPhoto/<?php echo $data['cid']; ?>/<?php echo $data['vid']; ?>",
...
function updatePhotoDecrement(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updatePhotoOrder/<?php echo $data['cid']; ?>/<?php echo $data['vid']; ?>",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function deletePhoto(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../deletePhoto/<?php echo $data['cid']; ?>/<?php echo $data['vid']; ?>",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function drop(ev) {
  ...
  //ev.target.appendChild(document.getElementById(data));
   ...
   var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updatePhotoDragging/<?php echo $data['cid']; ?>/<?php echo $data['vid']; ?>",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20" id="loginBank" onclick="checkFlag();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir black_txt fsz25  xs-fsz20"> <?php echo $venueInformationDetail['venue_name'].','.$venueInformationDetail['visiting_address']; ?></div>
