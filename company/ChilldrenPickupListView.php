...
<html>
	...
	<body class="white_bg ffamily_avenir">
		...
		<div class="column_m header xs-header xsip-header xsi-header bs_bb white_bg visible-xs">
		...
		<div class="column_m pos_rel">
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40" id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						...
						<div class="padb20 xxs-padb0 ">	
									...
									<h1 class="marb0  xxs-talc talc fsz100   xxs-fsz45  padb10  blue_67cff7 trn ffamily_avenir" >Pick up</h1>
									</div>
									<!-- Logo -->
									<div class="martb20  xxs-talc talc"> <a href="#" class="black_txt fsz25 xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Approve or reject a pick up request made by a person by selecting the child.</a></div>
									...
									<div class=" wi_50 xxs-wi_50 fleft bs_bb padrb20 talc  " >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="../pickupConfirmation/<?php echo $value['enc']; ?>" class="style_base hei_210p xxs-hei_150p dblock bs_bb pad25 xs-pad10  brdclr_seggreen_h brdrad5 <?php echo $value['signin']; ?>  box_shadow trans_all2 ">
																<div class=" ">
																	...
																	<div class="  padrb15 padt20 xs-padt15 xs-padr0">
																		...
																		<span class="dblock tall marb5 padt10 midgrey_txt fsz16 hidden-xs ffamily_avenir"><?php echo $value['social_number']; ?></span>
				...
				$.ajax({
					type:"POST",
					url:"../moreChildrenPickupDetailAll/<?php echo $data['cid']; ?>",
					data:send_data,
					dataType:"text",
				...
				return false;
						...
						<div class="clear"></div>
						<div class="wi_100  talc marb40">
										<a href="javascript:void(0);" class="blue_67cff7_brd  trans_bg  blue_btn black_txt ffamily_avenir   trn xxs-brd_width brd_width_2" value="1" id="temp" onclick="show_more_data(this,this.value);">Visa fler</a>
