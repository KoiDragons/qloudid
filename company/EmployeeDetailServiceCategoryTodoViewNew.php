 ...
 <body class="dark" style="background-color:#131922">
  ...
  function updateAminity(id,id1)
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateCategoryServiceTodo/<?php echo $data['cid']; ?>/<?php echo $data['objectType']; ?>/<?php echo $data['eid']; ?>",
							data:send_data,
							dataType:"text",
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateCategoryServiceAllTodos/<?php echo $data['cid']; ?>/<?php echo $data['objectType']; ?>/<?php echo $data['eid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
<a class="header__logo xs-fsz25 changedText" href="../../employeeAccount/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select and assign services for this employee</div>
