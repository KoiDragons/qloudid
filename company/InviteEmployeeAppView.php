...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo $path;?>tml/usercontent/constructor.css" />
...
<a class="header__logo xs-fsz25 changedText" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Add your employees to get them started with our services.
</div>
...
<div class="checkout__list marb20">
 

 
<form class="checkout__item js-tabs-item" action="../sendEmailInvitationToEmployee/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
  <div class="setting__item  " style="display:block;">
          <script>       function updateHeading(id)
			{
				if($("#moreEmployees").hasClass('hidden'))
				{
					$("#more_employee_available").val(1);
					$("#moreEmployees").removeClass('hidden');
				}
				else
				{
					$("#more_employee_available").val(0);
  ...
  <div class="setting__box marb40">
                    <div class="setting__notification" style="border:none; margin-bottom:0px;">
                      <div class="setting__main">
                        <div class="setting__subtitle changedText">Do you have more employees</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"  onclick="updateHeading(<?php echo $companyDetail['id'];?>);" <?php if($companyDetail['more_employee_available']==1) echo 'checked'; else echo ''; ?> /><span class="switch__inner"><span class="switch__box" ></span></span>
                        </label>
                      </div>
					...
					<input class="field__input" type="hidden" name="more_employee_available" id="more_employee_available" placeholder="e. g. xyz@gmail.com"  style=" color:grey;" value="<?php echo $companyDetail['more_employee_available']; ?>" >
					<div class="<?php if($companyDetail['more_employee_available']==0) echo 'hidden'; ?>" id="moreEmployees">
			<div class="checkout__box">
					<div class="receipt" style="border: none;    background: transparent; padding:0; margin:0; width:100%;">
					<div class="receipt__stage">How many</div>
					<div class="receipt__settings">
                <div class="receipt__setting">
                  <div class="receipt__wrap">
                    
                    <div class="receipt__content" style="font-size: 14px;">Click on plus to add more employees.</div>
                  </div>
                  <div class="counter js-counter" data-min="1">
                    ...
                    <input class="js-counter-input js-counter-result js-counter-babies" type="hidden" name='total_employee' value="1">
                  </div>
                </div>
                 </div>		 
					</div>
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
						<div class="upload__item">
					       ...
					       <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Employee email</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="employee_email1" id="employee_email1" placeholder="e. g. xyz@gmail.com"  style=" color:grey;"  >
                            </div>
                          </div>
