...
<div class="browse__info info changedText">A list of active and rejected consents</div>
</div>
...
<?php   if(!empty($approveDetail)) {   $i=1; 
...
<div class="checkout__label changedText">Employee</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo  substr(html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']),0,18); ?></div>
 
<div class="checkout__controls">
  
<a href="../companyCustomersLocation/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
...
<a href="../../EmployeeDetail/employeeAccount/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText"><?php echo  $value['child_name'].' - Parent'; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo  $value['name']; ?></div>
