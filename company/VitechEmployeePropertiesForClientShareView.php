...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" media="all" href="<?php echo $path; ?>/html/fleet/css/app.min.css">
		<link rel="stylesheet" href="<?php echo $path; ?>html/usercontent/constructor.css">
	<link rel="stylesheet" href="<?php echo $path; ?>html/usercontent/responsive.css">
	...
	function submitBroker()
	{
	 if($('#city').val()!='')
		...
		if($('#guest_adults').val()==0)
		{
			alert('please enter minimum one adult'); return false;
		}	 
		}
		$('#save_indexing').attr('action','../listEmployeesRentBrokerShare/'+cid);
	...
	function submitMarkup()
	{
	 if($('#city').val()!='')
		...
		$('#save_indexing').attr('action','../searchRentProperties/'+cid);
		document.getElementById('save_indexing').submit();	
	}
	...
	function submitForm()
	{
	  ...
	  function setInitial()
	  {
		 $('.js-range-start').html(1);
		 $('.js-range-finish').html(5); 
	  }
...
<a class="header__logo xs-fsz25 changedText" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>" style="
...
<a class="header__box active" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="en">English</div>
<div class="header__country dropdown-item changedText" tolang="en">United States</div></a>
...
<div class="header__country dropdown-item changedText" tolang="ru">Russian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="ar">Arabic</div>
<div class="header__country dropdown-item changedText" tolang="ar">Arabic</div></a>


<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="bg">Bulgarian</div>
<div class="header__country dropdown-item changedText" tolang="bg">Bulgarian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="zh">Chinese</div>
<div class="header__country dropdown-item changedText" tolang="zh">Chinese</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="cs">Czech</div>
<div class="header__country dropdown-item changedText" tolang="cs">Czech</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="da">Danish</div>
<div class="header__country dropdown-item changedText" tolang="da">Danish</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="nl">Dutch</div>
<div class="header__country dropdown-item changedText" tolang="nl">Dutch</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="et">Estonian</div>
<div class="header__country dropdown-item changedText" tolang="et">Estonian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="fi">Finnish</div>
<div class="header__country dropdown-item changedText" tolang="fi">Finnish</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="fr">French</div>
<div class="header__country dropdown-item changedText" tolang="fr">French</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="de">German</div>
<div class="header__country dropdown-item changedText" tolang="de">German</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="el">Greek</div>
<div class="header__country dropdown-item changedText" tolang="el">Greek</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="hu">Hungarian</div>
<div class="header__country dropdown-item changedText" tolang="hu">Hungarian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="id">Indonesian</div>
<div class="header__country dropdown-item changedText" tolang="id">Indonesian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="it">Italian</div>
<div class="header__country dropdown-item changedText" tolang="it">Italian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="ja">Japanese</div>
<div class="header__country dropdown-item changedText" tolang="ja">Japanese</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="ko">Korean</div>
<div class="header__country dropdown-item changedText" tolang="ko">Korean</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="lv">Latvian</div>
<div class="header__country dropdown-item changedText" tolang="lv">Latvian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="lt">Lithuanian</div>
<div class="header__country dropdown-item changedText" tolang="lt">Lithuanian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="nb">Norwegian</div>
<div class="header__country dropdown-item changedText" tolang="nb">Norwegian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="pl">Polish</div>
<div class="header__country dropdown-item changedText" tolang="pl">Polish</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="pt">Portuguese</div>
<div class="header__country dropdown-item changedText" tolang="pt">Portuguese</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="ro">Romanian</div>
<div class="header__country dropdown-item changedText" tolang="ro">Romanian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="sk">Slovak</div>
<div class="header__country dropdown-item changedText" tolang="sk">Slovak</div></a>


<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="sl">Slovenian</div>
<div class="header__country dropdown-item changedText" tolang="sl">Slovenian</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="es">Spanish</div>
<div class="header__country dropdown-item changedText" tolang="es">Spanish</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="tr">Turkish</div>
<div class="header__country dropdown-item changedText" tolang="tr">Turkish</div></a>

<a class="header__box" href="javascript:void(0);">
<div class="header__category dropdown-item changedText" tolang="uk">Ukrainian</div>
<div class="header__country dropdown-item changedText" tolang="uk">Ukrainian</div></a>
</div>
</div>
</div>
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
				...
				<a class="header__link" href="https://www.safeqloud.com/company/index.php/Company/companyAccount/<?php echo $data['cid']; ?>">
					...
					<a class="header__link" href="../../CompanySuppliers/companyProfileServices/<?php echo $data['cid']; ?>">
...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg><span>Go home</span></a>
                <ul class="breadcrumbs" style="list-style-type: none;">
                  
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.safeqloud.com/company/index.php/VitechProperties/searchRentProperties/<?php echo $data['cid']; ?>">Markup</a></li>
                  <li class="breadcrumbs__item" style="list-style-type: none;"><a class="breadcrumbs__link" href="https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesRentBrokerShare/<?php echo $data['cid']; ?>">Broker share</a></li>
				  <li class="breadcrumbs__item" ><a class="breadcrumbs__link" href="javascript:void(0);" style="color:white !important;">Client share</a></li>
                </ul>
              </div>
    ...
    padding-right: 0px;
    padding-left: 0px;
    border-bottom: 1px solid #282D34 !important;
    ...
    ">
		 ...
		 <div class="travel__center center   padb136 xs-padrl25" style="
    max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;
   ...
   <div class="travel__row " style="margin-bottom: 0px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="margin-bottom: 0px;
            max-width: 433px;
            ">
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Welcome To Rent Exchange</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Find rental properties, set your price and earn money</div>
...
">
 ...
 <!-- outer content-->
		...
		<div class="section flights" style="margin-bottom:0px;">
          <div class="flights__center center xs-padrl25">
		  <div class="section destinations xs-padrl25  " style="margin-bottom:40px;">
          <div class="destinations__center center" style=" padding-bottom:40px;  max-width: 1132px;">
              </div>
        </div>
		 	<div class="section categories  marl6 " style="margin-bottom: 40px; margin-top: 20px;">
<div class="categories__center center1 xsi-nobrdb xsi-padb0"  style="padding-bottom:40px;border-bottom:1px solid #353945;">
<div class="categories__inner">

 <form action="../listEmployeesRentClientShare/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">
<div class="panel panel_stays  " style="margin: 0px 0px 0px 0px; padding:20px;">
<div class="panel__background"></div>
 <div class="panel__nav hidden"><a class="panel__link active" href="#">Apartments</a><a class="panel__link" href="#">Villas</a> </div>

<div class="panel__body">
<div class="panel__row">
<div class="location js-location" style="flex:0 0 250px;">
<div class="location__head js-location-head">
<div class="location__icon">
<svg class="icon icon-location" style="fill:#52d4f4;">
<use xlink:href="#icon-location"></use>
</svg>
</div>
<input class="location__input js-location-input" type="text" name="city" id="city" autocomplete="off" placeholder="Location" value="<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo $_POST['city']; } ?>">
...
<?php $i=1; 
								foreach($locationList as $category => $value) 
										{
										 ?> 
										<a class="location__item js-location-item" href="#"><?php echo $value['city']; ?></a> <?php } ?></div>
</div>
</div>
<div class="datepicker js-date-range" data-format="MMM DD, YYYY" data-container=".datepicker">
<div class="datepicker__list">
<div class="datepicker__item">
<input class="datepicker__input js-date-from" type="text" name="rz_booking_dates[]" value='<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo date('M d, Y',strtotime($_POST['rz_booking_dates'][0])); } ?>' placeholder="Check in" readonly="readonly">
<div class="datepicker__icon">
<svg class="icon icon-calendar" style="fill:#52d4f4;">
...
<div class="datepicker__item">
<input class="datepicker__input js-date-to" type="text" name="rz_booking_dates[]" placeholder="Check out" value='<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo date('M d, Y',strtotime($_POST['rz_booking_dates'][1])); } ?>' readonly="readonly">
<div class="datepicker__icon">
<svg class="icon icon-calendar" style="fill:#52d4f4;">
<use xlink:href="#icon-calendar"></use>
</svg>
...
<div class="date-picker-wrapper no-shortcuts  no-topbar no-gap two-months" unselectable="on" style="display: none; top: 99.9961px; left: 0px; user-select: none;">
<div class="month-wrapper" style="width: 35px;"><table class="month1" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th><span class="prev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M14.207 7.793a1 1 0 0 1 0 1.414L11.414 12l2.793 2.793a1 1 0 0 1-1.414 1.414l-3.5-3.5a1 1 0 0 1 0-1.414l3.5-3.5a1 1 0 0 1 1.414 0z" fill="#777e91"></path></svg></span></th><th colspan="5" class="month-name"><div class="month-element">october</div><div class="month-element">2023</div></th><th></th></tr><tr class="week-name"><th>su</th><th>mo</th><th>tu</th><th>we</th><th>th</th><th>fr</th><th>sa</th></tr></thead><tbody><tr><td><div time="1696134472926" data-tooltip="" class="day toMonth  valid ">1</div></td><td><div time="1696220872926" data-tooltip="" class="day toMonth  valid real-today">2</div></td><td><div time="1696307272926" data-tooltip="" class="day toMonth  valid ">3</div></td><td><div time="1696393672926" data-tooltip="" class="day toMonth  valid ">4</div></td><td><div time="1696480072926" data-tooltip="" class="day toMonth  valid ">5</div></td><td><div time="1696566472926" data-tooltip="" class="day toMonth  valid ">6</div></td><td><div time="1696652872926" data-tooltip="" class="day toMonth  valid ">7</div></td></tr><tr><td><div time="1696739272926" data-tooltip="" class="day toMonth  valid ">8</div></td><td><div time="1696825672926" data-tooltip="" class="day toMonth  valid ">9</div></td><td><div time="1696912072926" data-tooltip="" class="day toMonth  valid ">10</div></td><td><div time="1696998472926" data-tooltip="" class="day toMonth  valid ">11</div></td><td><div time="1697084872926" data-tooltip="" class="day toMonth  valid ">12</div></td><td><div time="1697171272926" data-tooltip="" class="day toMonth  valid ">13</div></td><td><div time="1697257672926" data-tooltip="" class="day toMonth  valid ">14</div></td></tr><tr><td><div time="1697344072926" data-tooltip="" class="day toMonth  valid ">15</div></td><td><div time="1697430472926" data-tooltip="" class="day toMonth  valid ">16</div></td><td><div time="1697516872926" data-tooltip="" class="day toMonth  valid ">17</div></td><td><div time="1697603272926" data-tooltip="" class="day toMonth  valid ">18</div></td><td><div time="1697689672926" data-tooltip="" class="day toMonth  valid ">19</div></td><td><div time="1697776072926" data-tooltip="" class="day toMonth  valid ">20</div></td><td><div time="1697862472926" data-tooltip="" class="day toMonth  valid ">21</div></td></tr><tr><td><div time="1697948872926" data-tooltip="" class="day toMonth  valid ">22</div></td><td><div time="1698035272926" data-tooltip="" class="day toMonth  valid ">23</div></td><td><div time="1698121672926" data-tooltip="" class="day toMonth  valid ">24</div></td><td><div time="1698208072926" data-tooltip="" class="day toMonth  valid ">25</div></td><td><div time="1698294472926" data-tooltip="" class="day toMonth  valid ">26</div></td><td><div time="1698380872926" data-tooltip="" class="day toMonth  valid ">27</div></td><td><div time="1698467272926" data-tooltip="" class="day toMonth  valid ">28</div></td></tr><tr><td><div time="1698557272926" data-tooltip="" class="day toMonth  valid ">29</div></td><td><div time="1698643672926" data-tooltip="" class="day toMonth  valid ">30</div></td><td><div time="1698730072926" data-tooltip="" class="day toMonth  valid ">31</div></td><td><div time="1698816472926" data-tooltip="" class="day nextMonth  valid ">1</div></td><td><div time="1698902872926" data-tooltip="" class="day nextMonth  valid ">2</div></td><td><div time="1698989272926" data-tooltip="" class="day nextMonth  valid ">3</div></td><td><div time="1699075672926" data-tooltip="" class="day nextMonth  valid ">4</div></td></tr></tbody></table><div class="gap" style="visibility: hidden; height: 10px;"><div class="gap-top-mask"></div><div class="gap-bottom-mask"></div><div class="gap-lines"><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div></div></div><table class="month2" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th></th><th colspan="5" class="month-name"><div class="month-element">november</div><div class="month-element">2023</div></th><th><span class="next"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.793 7.793a1 1 0 0 0 0 1.414L12.586 12l-2.793 2.793a1 1 0 0 0 1.414 1.414l3.5-3.5a1 1 0 0 0 0-1.414l-3.5-3.5a1 1 0 0 0-1.414 0z" fill="#777e91"></path></svg></span></th></tr><tr class="week-name"><th>su</th><th>mo</th><th>tu</th><th>we</th><th>th</th><th>fr</th><th>sa</th></tr></thead><tbody><tr><td><div time="1698557272926" data-tooltip="" class="day lastMonth  valid ">29</div></td><td><div time="1698643672926" data-tooltip="" class="day lastMonth  valid ">30</div></td><td><div time="1698730072926" data-tooltip="" class="day lastMonth  valid ">31</div></td><td><div time="1698816472926" data-tooltip="" class="day toMonth  valid ">1</div></td><td><div time="1698902872926" data-tooltip="" class="day toMonth  valid ">2</div></td><td><div time="1698989272926" data-tooltip="" class="day toMonth  valid ">3</div></td><td><div time="1699075672926" data-tooltip="" class="day toMonth  valid ">4</div></td></tr><tr><td><div time="1699162072926" data-tooltip="" class="day toMonth  valid ">5</div></td><td><div time="1699248472926" data-tooltip="" class="day toMonth  valid ">6</div></td><td><div time="1699334872926" data-tooltip="" class="day toMonth  valid ">7</div></td><td><div time="1699421272926" data-tooltip="" class="day toMonth  valid ">8</div></td><td><div time="1699507672926" data-tooltip="" class="day toMonth  valid ">9</div></td><td><div time="1699594072926" data-tooltip="" class="day toMonth  valid ">10</div></td><td><div time="1699680472926" data-tooltip="" class="day toMonth  valid ">11</div></td></tr><tr><td><div time="1699766872926" data-tooltip="" class="day toMonth  valid ">12</div></td><td><div time="1699853272926" data-tooltip="" class="day toMonth  valid ">13</div></td><td><div time="1699939672926" data-tooltip="" class="day toMonth  valid ">14</div></td><td><div time="1700026072926" data-tooltip="" class="day toMonth  valid ">15</div></td><td><div time="1700112472926" data-tooltip="" class="day toMonth  valid ">16</div></td><td><div time="1700198872926" data-tooltip="" class="day toMonth  valid ">17</div></td><td><div time="1700285272926" data-tooltip="" class="day toMonth  valid ">18</div></td></tr><tr><td><div time="1700371672926" data-tooltip="" class="day toMonth  valid ">19</div></td><td><div time="1700458072926" data-tooltip="" class="day toMonth  valid ">20</div></td><td><div time="1700544472926" data-tooltip="" class="day toMonth  valid ">21</div></td><td><div time="1700630872926" data-tooltip="" class="day toMonth  valid ">22</div></td><td><div time="1700717272926" data-tooltip="" class="day toMonth  valid ">23</div></td><td><div time="1700803672926" data-tooltip="" class="day toMonth  valid ">24</div></td><td><div time="1700890072926" data-tooltip="" class="day toMonth  valid ">25</div></td></tr><tr><td><div time="1700976472926" data-tooltip="" class="day toMonth  valid ">26</div></td><td><div time="1701062872926" data-tooltip="" class="day toMonth  valid ">27</div></td><td><div time="1701149272926" data-tooltip="" class="day toMonth  valid ">28</div></td><td><div time="1701235672926" data-tooltip="" class="day toMonth  valid ">29</div></td><td><div time="1701322072926" data-tooltip="" class="day toMonth  valid ">30</div></td><td><div time="1701408472926" data-tooltip="" class="day nextMonth  valid ">1</div></td><td><div time="1701494872926" data-tooltip="" class="day nextMonth  valid ">2</div></td></tr></tbody></table><div class="dp-clearfix"></div><div class="time"><div class="time1"></div><div class="time2"></div></div><div class="dp-clearfix"></div></div><div class="footer"></div><div class="date-range-length-tip"></div></div><div class="date-picker-wrapper no-shortcuts  no-topbar no-gap two-months" unselectable="on" style="display: none; top: 100px; left: 0px; user-select: none;"><div class="month-wrapper" style="width: 35px;">   <table class="month1" cellspacing="0" border="0" cellpadding="0">       <thead>           <tr class="caption">               <th>                   <span class="prev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M14.207 7.793a1 1 0 0 1 0 1.414L11.414 12l2.793 2.793a1 1 0 0 1-1.414 1.414l-3.5-3.5a1 1 0 0 1 0-1.414l3.5-3.5a1 1 0 0 1 1.414 0z" fill="#777e91"></path></svg>                   </span>               </th>               <th colspan="5" class="month-name"><div class="month-element">may</div> <div class="month-element">2024</div></th>               <th>               </th>           </tr>           <tr class="week-name"><th>su</th><th>mo</th><th>tu</th><th>we</th><th>th</th><th>fr</th><th>sa</th>       </tr></thead>       <tbody><tr><td><div time="1714285642257" data-tooltip="" class="day lastMonth  valid ">28</div></td><td><div time="1714372042257" data-tooltip="" class="day lastMonth  valid ">29</div></td><td><div time="1714458442257" data-tooltip="" class="day lastMonth  valid ">30</div></td><td><div time="1714544842257" data-tooltip="" class="day toMonth  valid ">1</div></td><td><div time="1714631242257" data-tooltip="" class="day toMonth  valid ">2</div></td><td><div time="1714717642257" data-tooltip="" class="day toMonth  valid ">3</div></td><td><div time="1714804042257" data-tooltip="" class="day toMonth  valid ">4</div></td></tr><tr><td><div time="1714890442257" data-tooltip="" class="day toMonth  valid ">5</div></td><td><div time="1714976842257" data-tooltip="" class="day toMonth  valid ">6</div></td><td><div time="1715063242257" data-tooltip="" class="day toMonth  valid real-today">7</div></td><td><div time="1715149642257" data-tooltip="" class="day toMonth  valid ">8</div></td><td><div time="1715236042257" data-tooltip="" class="day toMonth  valid ">9</div></td><td><div time="1715322442257" data-tooltip="" class="day toMonth  valid ">10</div></td><td><div time="1715408842257" data-tooltip="" class="day toMonth  valid ">11</div></td></tr><tr><td><div time="1715495242257" data-tooltip="" class="day toMonth  valid ">12</div></td><td><div time="1715581642257" data-tooltip="" class="day toMonth  valid ">13</div></td><td><div time="1715668042257" data-tooltip="" class="day toMonth  valid ">14</div></td><td><div time="1715754442257" data-tooltip="" class="day toMonth  valid ">15</div></td><td><div time="1715840842257" data-tooltip="" class="day toMonth  valid ">16</div></td><td><div time="1715927242257" data-tooltip="" class="day toMonth  valid ">17</div></td><td><div time="1716013642257" data-tooltip="" class="day toMonth  valid ">18</div></td></tr><tr><td><div time="1716100042257" data-tooltip="" class="day toMonth  valid ">19</div></td><td><div time="1716186442257" data-tooltip="" class="day toMonth  valid ">20</div></td><td><div time="1716272842257" data-tooltip="" class="day toMonth  valid ">21</div></td><td><div time="1716359242257" data-tooltip="" class="day toMonth  valid ">22</div></td><td><div time="1716445642257" data-tooltip="" class="day toMonth  valid ">23</div></td><td><div time="1716532042257" data-tooltip="" class="day toMonth  valid ">24</div></td><td><div time="1716618442257" data-tooltip="" class="day toMonth  valid ">25</div></td></tr><tr><td><div time="1716704842257" data-tooltip="" class="day toMonth  valid ">26</div></td><td><div time="1716791242257" data-tooltip="" class="day toMonth  valid ">27</div></td><td><div time="1716877642257" data-tooltip="" class="day toMonth  valid ">28</div></td><td><div time="1716964042257" data-tooltip="" class="day toMonth  valid ">29</div></td><td><div time="1717050442257" data-tooltip="" class="day toMonth  valid ">30</div></td><td><div time="1717136842257" data-tooltip="" class="day toMonth  valid ">31</div></td><td><div time="1717223242257" data-tooltip="" class="day nextMonth  valid ">1</div></td></tr></tbody>   </table><div class="gap" style="visibility: hidden; height: 10px;"><div class="gap-top-mask"></div><div class="gap-bottom-mask"></div><div class="gap-lines"><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div><div class="gap-line"><div class="gap-1"></div><div class="gap-2"></div><div class="gap-3"></div></div></div></div><table class="month2" cellspacing="0" border="0" cellpadding="0">   <thead>   <tr class="caption">       <th>       </th>       <th colspan="5" class="month-name"><div class="month-element">june</div> <div class="month-element">2024</div></th>       <th>           <span class="next"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.793 7.793a1 1 0 0 0 0 1.414L12.586 12l-2.793 2.793a1 1 0 0 0 1.414 1.414l3.5-3.5a1 1 0 0 0 0-1.414l-3.5-3.5a1 1 0 0 0-1.414 0z" fill="#777e91"></path></svg></span>       </th>   </tr>   <tr class="week-name"><th>su</th><th>mo</th><th>tu</th><th>we</th><th>th</th><th>fr</th><th>sa</th>   </tr></thead>   <tbody><tr><td><div time="1716704842257" data-tooltip="" class="day lastMonth  valid ">26</div></td><td><div time="1716791242257" data-tooltip="" class="day lastMonth  valid ">27</div></td><td><div time="1716877642257" data-tooltip="" class="day lastMonth  valid ">28</div></td><td><div time="1716964042257" data-tooltip="" class="day lastMonth  valid ">29</div></td><td><div time="1717050442257" data-tooltip="" class="day lastMonth  valid ">30</div></td><td><div time="1717136842257" data-tooltip="" class="day lastMonth  valid ">31</div></td><td><div time="1717223242257" data-tooltip="" class="day toMonth  valid ">1</div></td></tr><tr><td><div time="1717309642257" data-tooltip="" class="day toMonth  valid ">2</div></td><td><div time="1717396042257" data-tooltip="" class="day toMonth  valid ">3</div></td><td><div time="1717482442257" data-tooltip="" class="day toMonth  valid ">4</div></td><td><div time="1717568842257" data-tooltip="" class="day toMonth  valid ">5</div></td><td><div time="1717655242257" data-tooltip="" class="day toMonth  valid ">6</div></td><td><div time="1717741642257" data-tooltip="" class="day toMonth  valid ">7</div></td><td><div time="1717828042257" data-tooltip="" class="day toMonth  valid ">8</div></td></tr><tr><td><div time="1717914442257" data-tooltip="" class="day toMonth  valid ">9</div></td><td><div time="1718000842257" data-tooltip="" class="day toMonth  valid ">10</div></td><td><div time="1718087242257" data-tooltip="" class="day toMonth  valid ">11</div></td><td><div time="1718173642257" data-tooltip="" class="day toMonth  valid ">12</div></td><td><div time="1718260042257" data-tooltip="" class="day toMonth  valid ">13</div></td><td><div time="1718346442257" data-tooltip="" class="day toMonth  valid ">14</div></td><td><div time="1718432842257" data-tooltip="" class="day toMonth  valid ">15</div></td></tr><tr><td><div time="1718519242257" data-tooltip="" class="day toMonth  valid ">16</div></td><td><div time="1718605642257" data-tooltip="" class="day toMonth  valid ">17</div></td><td><div time="1718692042257" data-tooltip="" class="day toMonth  valid ">18</div></td><td><div time="1718778442257" data-tooltip="" class="day toMonth  valid ">19</div></td><td><div time="1718864842257" data-tooltip="" class="day toMonth  valid ">20</div></td><td><div time="1718951242257" data-tooltip="" class="day toMonth  valid ">21</div></td><td><div time="1719037642257" data-tooltip="" class="day toMonth  valid ">22</div></td></tr><tr><td><div time="1719124042257" data-tooltip="" class="day toMonth  valid ">23</div></td><td><div time="1719210442257" data-tooltip="" class="day toMonth  valid ">24</div></td><td><div time="1719296842257" data-tooltip="" class="day toMonth  valid ">25</div></td><td><div time="1719383242257" data-tooltip="" class="day toMonth  valid ">26</div></td><td><div time="1719469642257" data-tooltip="" class="day toMonth  valid ">27</div></td><td><div time="1719556042257" data-tooltip="" class="day toMonth  valid ">28</div></td><td><div time="1719642442257" data-tooltip="" class="day toMonth  valid ">29</div></td></tr><tr><td><div time="1719728842257" data-tooltip="" class="day toMonth  valid ">30</div></td><td><div time="1719815242257" data-tooltip="" class="day nextMonth  valid ">1</div></td><td><div time="1719901642257" data-tooltip="" class="day nextMonth  valid ">2</div></td><td><div time="1719988042257" data-tooltip="" class="day nextMonth  valid ">3</div></td><td><div time="1720074442257" data-tooltip="" class="day nextMonth  valid ">4</div></td><td><div time="1720160842257" data-tooltip="" class="day nextMonth  valid ">5</div></td><td><div time="1720247242257" data-tooltip="" class="day nextMonth  valid ">6</div></td></tr></tbody></table><div class="dp-clearfix"></div><div class="time"><div class="time1"></div><div class="time2"></div></div><div class="dp-clearfix"></div></div><div class="footer"></div><div class="date-range-length-tip"></div></div></div>
<div class="travelers js-travelers">
<div class="travelers__head js-travelers-head">
<div class="travelers__icon">
<svg class="icon icon-user" style="fill:#52d4f4;">
<use xlink:href="#icon-user"></use>
</svg>
</div>
<div class="travelers__content js-travelers-content"><?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo $_POST['guest_adults']+$_POST['guest_children']+$_POST['guest_infants']; } else echo 0; ?> Guests</div>
...
<div class="counter js-counter" data-min="<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_adults'];  } else echo 0; ?>">
...
<div class="counter__value js-counter-value"><?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_adults'];  } else echo 0; ?></div>
<button class="counter__button js-counter-button js-counter-plus" type="button">
<svg class="icon icon-plus-circle">
<use xlink:href="#icon-plus-circle"></use>
</svg>
</button>
<input class="js-counter-input js-counter-result js-counter-adults" name="guest_adults" id="guest_adults"  type="hidden" value="<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_adults']; } else echo 0; ?>">
</div>
</div>
<div class="travelers__item">
...
<div class="counter js-counter" data-min="<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_children']; } else echo 0; ?>">
<button class="counter__button js-counter-button js-counter-minus disabled" type="button">
<svg class="icon icon-minus-circle">
<use xlink:href="#icon-minus-circle"></use>
</svg>
...
<div class="counter__value js-counter-value"><?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_children']; } else echo 0; ?></div>
<button class="counter__button js-counter-button js-counter-plus" type="button">
<svg class="icon icon-plus-circle">
<use xlink:href="#icon-plus-circle"></use>
</svg>
</button>
<input class="js-counter-input js-counter-result js-counter-children" name="guest_children" value="<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_children']; } else echo 0;?>" type="hidden" value="0">
</div>
</div>
<div class="travelers__item">
<div class="travelers__details">
<div class="travelers__category">Infants</div>
<div class="travelers__text">Under 2</div>
</div>
<div class="counter js-counter" data-min="<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_infants']; } else echo 0; ?>">
<button class="counter__button js-counter-button js-counter-minus disabled" type="button">
<svg class="icon icon-minus-circle">
<use xlink:href="#icon-minus-circle"></use>
</svg>
...
<div class="counter__value js-counter-value"><?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_infants']; } else echo 0; ?></div>
<button class="counter__button js-counter-button js-counter-plus" type="button">
<svg class="icon icon-plus-circle">
<use xlink:href="#icon-plus-circle"></use>
</svg>
</button>
<input class="js-counter-input js-counter-result js-counter-babies" name="guest_infants" value="<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo  $_POST['guest_infants']; } else echo 0; ?>" type="hidden" value="0">
</div>
</div>
</div>
</div>

<a class="panel__search" href="#" onclick="submitForm();" style="background:#52d4f4  !important;">
<svg class="icon icon-search">
<use xlink:href="#icon-search" style="fill:black;"></use>
</svg></a>
</div>
</div>
</div></form>
			 ...
			 <div class="sorting__foot <?php  if(!isset($_POST['city']) || $_POST['city']=='') echo 'hidden'; ?>">
                <div class="nav"><a class="nav__link  changedText" href="#" onclick="submitMarkup();">Mark up</a> <a class="nav__link changedText " href="#" onclick="submitBroker();">Broker share</a> <a class="nav__link changedText active" href="#">Client share</a></div>
                 
                   <div class="sorting__select">
               <a href="../propertyInformation/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button">
                  <span class="changedText">Add properties</span>
                </button></a>
                </div>
              </div>
		...
		<div class="section flights <?php  if(!isset($_POST['city']) || $_POST['city']=='') echo 'hidden'; ?>">
          <div class="flights__center center xs-padrl25">
		   
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
               
              <button class="button-stroke flights__button active changedText">Advanced filter</button>
            </div>
            ...
            <div class="flights__row">
              ...
              <div class="flights__filters">
				...
				<div class="flights__box" style="display:none;">
                <select    class="select" >
				
                  <option value='Villa' class="changedText">Villas</option>
				   <option value='Apartment' class="changedText">Apartment</option>
                   
                </select>
              </div>
                  <div class="flights__box" style="display:none;">
                    <div class="range">
                      <div class="range__label changedText">Price range</div>
                      <div class="range__slider js-slider" data-min="100000" data-max="5000000" data-start="100000" data-step="10000" data-tooltips="true"  ></div>
                      <div class="range__indicators">
                        <div class="range__text changedText">$100000</div>
                        <div class="range__text changedText">$5000000</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="flights__box">
                    <div class="range range_time js-range-time" >
                      ...
                      <div class="range__note changedText">Bedrooms</div>
                      <div class="range__slider js-range-slider" data-from="1" data-to="5" ></div>
                      <div class="range__indicators">
                        <div class="range__text"> <span class="js-range-start">1</span></div>
                        <div class="range__text"><span class="js-range-finish">5</span> </div>
                      </div>
                    </div>
                    <div class="range range_time js-range-time" >
                     
                      <div class="range__note changedText ">Bathrooms</div>
                      <div class="range__slider js-range-slider" data-from="1" data-to="5"></div>
                      <div class="range__indicators">
                        <div class="range__text"> <span class="js-range-start">1</span></div>
                        <div class="range__text"><span class="js-range-finish">5</span> </div>
                  ...
                  <div class="flights__box">
                    <div class="flights__variants">
					 <label class="checkbox">
                        <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text changedText">Air condition</span></span></span>
                      </label>
					   <label class="checkbox">
                        <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text changedText">Fitted wardrobes</span></span></span>
                      </label>
					   <label class="checkbox">
                        <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text changedText">Lift</span></span></span>
                      </label>
					   <label class="checkbox">
                        <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text changedText">Exterior</span></span></span>
                      </label>
					   <label class="checkbox">
                        <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text changedText">Parking</span></span></span>
                      </label>
					  <label class="checkbox">
                        <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text changedText">Garden</span></span></span>
                      </label>
			...
			<form action="../guestReservationInformation/<?php echo $data['cid']; ?>" method="POST" name="save_indexing1" id="save_indexing1" accept-charset="ISO-8859-1">	
			<input   type="hidden" name="checkin_date" id="checkin_date" value='<?php if(isset($_POST['city']))
			 { echo date('Y-m-d',strtotime($_POST['rz_booking_dates'][0])); } ?>' placeholder="Check in" readonly="readonly">
		 <input   type="hidden" name="checkout_date" id="checkout_date" value='<?php if(isset($_POST['city']))
			 { echo date('Y-m-d',strtotime($_POST['rz_booking_dates'][1])); } ?>' placeholder="Check in" readonly="readonly">
		 
		  <input   type="hidden" name="guest_adults" id="guest_adults" value='<?php if(isset($_POST['city']))
			 { echo $_POST['guest_adults']; } ?>' placeholder="Check in" readonly="readonly">
		 
		  <input   type="hidden" name="guest_children" id="guest_children" value='<?php if(isset($_POST['city']))
			 { echo $_POST['guest_children']; } ?>' placeholder="Check in" readonly="readonly">
		 <input   type="hidden" name="broker_property_id" id="broker_property_id" value='' placeholder="Check in" />
		  <input   type="hidden" name="owner_property_id" id="owner_property_id" value='' placeholder="Check in" />
		   <input   type="hidden" name="searched_from" id="searched_from" value='3' placeholder="Check in" />
		    <input   type="hidden" name="city1" id="city1" value='<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo $_POST['city']; } ?>' placeholder="Check in" readonly="readonly">
			</form>	
			
			<script>
			function updatePropertyId(id,id1)
			{
				$("#broker_property_id").val(id);
				$("#owner_property_id").val(id1);
				document.getElementById('save_indexing1').submit();
			}
			
			function updatePropertyAction(id,id1)
			{
				var cid='<?php echo $data['cid']; ?>';
				$("#broker_property_id").val(id);
				$("#owner_property_id").val(id1);
				$('#save_indexing1').attr('action','../wishlistClientShareProperty/'+cid+'/'+id);
				...
				<?php $i=1; 
								foreach($displayproperties as $category => $value) 
										...
										if($value['broker_company_id']==$company_id)	{
										 ?> 
               
				  <div class="card card_row"   style="margin-bottom:24px; <?php if($value['type_of_contract']==2) echo 'border:2px solid #ffe500 '; ?>">
	 
					 
										<div class="card__preview"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="Premium milford sound tour ex Queenstown">
                      <div class="category card__category"><?php if($value['type_of_contract']==1) echo 'Exclusive'; else echo 'Non-exclusive'; ?></div>
                  </div>
                  <div class="card__body" style="background: #131922;">
                    <div class="card__line" style="
    margin-bottom: 0px;
">
                   <a href="../guestReservationList/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value['enc_id']; ?>" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px; color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                       <div class="card__price" style="color:#52d4f4; box-shadow: inset 0 0 0 2px #52d4f4;">
                        <div class="card__old">$<?php echo $value['owner_sell_price']; ?></div>
                        <div class="card__actual">$<?php echo $value['owner_sell_price']; ?></div>
                      </div>
                    </div>
					 
                    <div class="description__parameters" style="
					border-top:none;
    margin-bottom: 0px;
    margin-top: 0px;
    padding-bottom: 15px;
    padding-top: 0px;
">
                <div class="description__parameter" style="">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><span class="changedText"><?php  echo $value['numberOfBedrooms']; ?> Bedrooms</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['numberOfBathrooms']; ?> Bathrooms</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['area']; ?> sqm</span></div>
              </div>
                    <div class="card__foot">
					
                      <div class="card__comment" style=" border-bottom: 1px solid #23262f;    padding-bottom: 20px;">
                        
                        <div class="card__text changedText" style="
    font-size: 14px;
    line-height: 20px;
">
 <?php  echo $value['longSellingDescription']; ?> </div>
                      </div>
                      ...
                      <div class="card__flex brdt mart10 padt10 " style="border-color: #353945;">
                        <div class="card__cost fsz14 changedText" style="
...
">Update status</div>
  ...
  <a class="header__logo  changedText fright" href="javascript:void(0);" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
   font-family: Avenir;
   ...
   " onclick="updatePropertyId('<?php echo $value['enc']; ?>','<?php echo $value['enc_id']; ?>');">Reserve for guest</a>
    ...
    margin-bottom: 0px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px; color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                       <div class="card__price" style="color:#52d4f4; box-shadow: inset 0 0 0 2px #52d4f4;">
                        <div class="card__old">$<?php echo $value['owner_sell_price']; ?></div>
                        <div class="card__actual">$<?php echo $value['owner_sell_price']; ?></div>
                      </div>
...
">
 <?php  echo $value['longSellingDescription']; ?> </div>
                      ...
                      <div class="card__flex brdt mart10 padt10 <?php  if(!isset($_POST['city']) || $_POST['city']==''){ echo 'hidden'; } ?>" style="border-color: #353945;">
                        <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">Update status</div>
...
<?php  if(isset($_POST['city']) && $_POST['city']!='')
  ...
  <a class="header__logo  changedText fright" href="javascript:void(0);" style="
   ...
   line-height:20px !important;
   border: 2px solid #FFEB3B;
   "  onclick="updatePropertyAction('<?php echo $value['enc']; ?>','<?php echo $value['enc_id']; ?>');" >Wishlist</a>
   <?php }  ?>    
