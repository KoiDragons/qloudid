...
<html>
	...
	<head>
		...
		function updateSubcategory(id,id1)
		{
			$('#errorMsg').html('');
		var send_data={};
				 send_data.id=id;
		...
		function updateAminity(id,id1)
		{
			$('#errorMsg').html('');
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateAminity/<?php echo $data['bid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateMultiSubcategory/<?php echo $data['bid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
									...
									<div id="amenities_info">
									   ...
									   <?php echo $buildingAmenitiesInfo; ?>
