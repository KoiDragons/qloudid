	...
	<head>
		...
		<script>
			function submitDepartment()
			{
				...
				if($("#c_discription").val()=="" || $("#c_discription").val()==null)
				{
				$("#errorMsg").html('please enter category discription');	
				return false;
				}
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p  " style="padding: 10px 0px 0px 0px;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../categories/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
					 ...
					 <div class="padb0 xxs-padb0 ">		
						...
						<div class="padb0 xxs-padb0 marb5">
							...
							<div class="marrla xs-wi_100">
								...
								<form action="../../editCategory/<?php echo $data['cid']; ?>/<?php echo $data['cateid']; ?>" name="save_indexing" id="save_indexing" method="POST" accept-charset="ISO-8859-1">
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn ">
											...
											<div class="pos_rel">
													<input type="text" name="c_name" id="c_name" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir" value="<?php echo $EshopCategoriesDetail['category_name']; ?>" placeholder="Write category name ">
										...
										<input type="text" value="Category discription" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="on_clmn ">
											...
											<div class="pos_rel">
													<input type="text" name="c_discription" id="c_discription" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir" placeholder="Category discription " value="<?php echo $EshopCategoriesDetail['category_discription']; ?>">
									...
									<div class="on_clmn">
											...
											<div class="pos_rel">
												...
												<select name="location_id" id="location_id"  class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir " > 
											  
											<option value="1" class="lgtgrey2_bg" selected>Before</option>
										...
										<input type="text" value="Category info" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
											...
											<div class="pos_rel">
												...
												<select name="category_id" id="category_id"  class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir" > 
												...
												{
												?>
												<option value="<?php echo $value['id']; ?>" <?php if($value['place_of_display']==$EshopCategoriesDetail['place_of_display']+1) echo 'selected'; ?>><?php echo $value['category_name']; ?> </option>
												<?php } ?>
													</select>
