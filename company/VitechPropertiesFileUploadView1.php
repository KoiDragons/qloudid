...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Upload Your CSV File</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select and upload the CSV file containing your data.</div>
...
<div class="checkout__box">
 ...
 <input class="upload__input" type="hidden" name="bid" id="bid"  value="<?php if(isset($_POST['bid'])){	echo $_POST['bid'];	} else echo 0; ?>"/>
 <div class="upload__item">
                      <div class="upload__category">Upload csv</div>
                      <div class="upload__note">Drag or choose your file to upload</div>
                      <div class="upload__file upload__filer"  s  >
                        <input class="upload__input" type="file" name="email_file" id="email_file"  onchange="submitForm();">
                        <div class="upload__icon">
                          <svg class="icon icon-upload-file">
                            <use xlink:href="#icon-upload-file"></use>
                          </svg>
                        </div>
                        <div class="upload__format">CSV. Max 10Mb.</div>
                      </div>
                    </div>
...
<a class="button checkout__button changedText hidden" href="javascript:void(0);"  onclick="submitForm();" >Upload</a>
</form>
