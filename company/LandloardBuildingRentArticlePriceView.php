...
<html class="home">
	 ...
	 function addType(id,id1)
	{
		...
		function submitform()
		{
			...
			if($("#deposit_amount0").val()=='' || $("#deposit_amount0").val()==null || $("#deposit_amount0").val()==0)
			{
				
				$("#errorMsg1").html('Please enter deposit amount');
				return false;
			}
			if(isNaN($("#deposit_amount0").val()))
			{
				$("#errorMsg1").html('Please enter numeric value for deposit amount');
				return false;	
			}
			
			if($("#price0").val()=='' || $("#price0").val()==null || $("#price0").val()==0)
			{
			 ...
			 <div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
							...
							<form action="../../addPricePlan/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								 ...
								 <div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-mart0 xs-marb20 marb35  xxs-tall talc xs-padb15  "> <a href="#" class="black_txt fsz25 xxs-tall xxs-lgn_hight_20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn">Please add price for your apartments.</a></div>
								<div class="marb0 padtrl0">		 
										 ...
										 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												<select class="wi_100 white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl padt25 tall minhei_55p fsz20 padl10 black_txt ffamily_avenir" name="invoice_date" id="invoice_date">
											  				...
											  				<?php for($i=1;$i<=28;$i++)
															{ ?>
															<option value="<?php echo $i; ?>" class="lgtgrey2_bg" <?php if($i==25) echo 'selected'; ?>><?php echo $i; ?></option>
															<?php } ?> 
											...
											<div class="pos_rel">
												<select class="wi_100 white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl padt25 tall minhei_55p fsz20 padl10 black_txt ffamily_avenir" name="payment_tax" id="payment_tax">
															...
															<?php for($i=1;$i<=25;$i++)
															{ ?>
															<option value="<?php echo $i; ?>" class="lgtgrey2_bg" <?php if($i==20) echo 'selected'; ?>><?php echo $i; ?></option>
															<?php } ?> 
										 ...
										 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<input type="number" name="deposit_amount0" id="deposit_amount0" value="200" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_55p fsz18 black_txt ffamily_avenir floating__input padt25" min=200 /> 
												<label for="deposit_amount0" class="floating__label tall nobold" data-content="Deposit amount" >
											<span class="hidden--visually">
										 ...
										 <div class="on_clmn mart20 ">
											...
											<div class="pos_rel">
												...
												<label for="price0" class="floating__label tall nobold" data-content="Price/m2" >
											<span class="hidden--visually">
											Price</span></label>
											</div>
