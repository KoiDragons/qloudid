...
<div class="column_m header xs-header bs_bb lgtgrey2_bg">
		...
		<div class="fright xs-dnone visible_si padt10">
					<ul class="mar0 pad0 fsz14">
						...
						<li class="dblock hidden-xs visible_si fright pos_rel  circle_bg_apps3 brdrad5 marr10 box_shadow" > <a href="#" id="usermenu_singin" class="translate hei_30pi dblock padrl25   lgn_hight_30 black_txt " data-en="Min arbetsprofil" data-sw="Min arbetsprofil">Min Bosted</a> </li>
					</ul>
				</div>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class="dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a ">
											...
											<li class="dblock padrb10">
												...
												<li class="dblock padrb10">
													...
													<li class="dblock padrb10">
													<a href="#" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Fråga styrelsen</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>												
										...
										<li class="dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a ">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="../neighboursAccount/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Grannar</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												<li class="dblock padrb10">
								...
								<form id="post_comment">
									...
									<div class="padtb15 brdb_new panlyellow_bg " >
										<div class="padrl25">
											...
											<span class="valm fsz25 bold"> Start discussion</span>
										</div>
									</div>
