...
<a class="header__logo xs-fsz20 changedText" href="../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" style="
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Night pricing</h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Pricing managed by <?php echo $userSummary['first_name'].' '.substr($userSummary['last_name'],0,1); ?>
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">Pricing</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
               ...
               <a href="../../addPricing/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>">  <button class="button-stroke catalog__button">
                  <span class="changedText">Add pricing</span>
                </button></a>
                </div>
              </div>
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
								foreach($listPricing as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 15px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px;color:white;padding-top: 8px;"><?php echo $value['pricing_title']; ?></div></a>
<button class="button-stroke flight__button" style="
    width: 150px;
"><span class="flight_price">$<?php echo $value['minimum_price']; ?></span> </button>
...
">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category">Start date</div>
                    <div class="receipt__subtitle"><?php echo date('F jS Y',$value['pricing_start_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category">End date</div>
                    <div class="receipt__subtitle"><?php echo date('D M d Y', $value['pricing_end_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category">Maximum price</div>
                    <div class="receipt__subtitle">$<?php echo $value['maximum_price']; ?></div>
                  </div>
                </div>
              </div>
...
">Update pricing</div>
   ...
   <a class="header__logo  changedText fright" href="../../editPropertyPerNightPrice/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $value['enc']; ?>" style="
