				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Your health service wellness requests</a></div>
						...
						<div class="on_clmn brdb">
					 		...
					 		<?php $i=1;
												...
												foreach($healthServiceRequests as $category => $value) 
												{
											...
											<a href="../../healthServiceMenuInformation/<?php echo $data['cid'].'/'.$data['wid'].'/'.$value['enc']; ?>">	<div class="column_m container  marb5   fsz14 dark_grey_txt">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											...
											<div class="clear"></div>
												...
												<?php } else { ?>
												<a href="../../approveHealthServiceRequest/<?php echo $data['cid'].'/'.$data['wid'].'/'.$value['enc']; ?>">	<div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class="<?php if($i%2==0) echo 'lgtgrey_bg'; else echo 'white_bg'; ?>  bg_fffbcc_a ">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
