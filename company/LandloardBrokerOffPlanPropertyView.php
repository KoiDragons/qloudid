         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Connect With Developers</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Get access to available Off Plan listings in real time for sale</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			          ...
			          <a class="categories__item    " href="../availableLandloard/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Off plan</div>
                                      </a>
...
function changeUrl(id)
{
	...
	document.getElementById("save_indexing").submit();
		 ...
		 <form action="../listBrokerOffPlanProperties/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
		 <input type="hidden" id="pid" name='pid' value="" />
				  ...
				  <div class="flights__box">
								...
								foreach($displayproperties as $category => $value) 
										{
										 ...
										 ?> 
                     <a href="javascript:void();" style="text-decoration:none;" onclick="changeUrl('<?php echo $value['enc']; ?>');"> <label class="checkbox">
                        <input class="checkbox__input" type="checkbox" <?php if($value['enc']==$data['bid']) echo 'checked="checked"';?>><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text"><?php echo $value['company_name']; ?></span><span class="checkbox__counter hidden">$2,568</span></span></span>
                      </label></a>
                      <?php } ?> 
                    </div>
                  </div>
                    ...
                    <div class="range range_time js-range-time">
                      ...
                      <div class="range__slider js-range-slider noUi-target noUi-ltr noUi-horizontal" data-from="4.5" data-to="15"><div class="noUi-base"><div class="noUi-connects"><div class="noUi-connect" style="transform: translate(18.75%, 0px) scale(0.4375, 1);"></div></div><div class="noUi-origin" style="transform: translate(-81.25%, 0px); z-index: 5;"><div class="noUi-handle noUi-handle-lower" data-handle="0" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="0.0" aria-valuemax="62.5" aria-valuenow="18.8" aria-valuetext="4.50"></div></div><div class="noUi-origin" style="transform: translate(-37.5%, 0px); z-index: 4;"><div class="noUi-handle noUi-handle-upper" data-handle="1" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="18.8" aria-valuemax="100.0" aria-valuenow="62.5" aria-valuetext="15.00"></div></div></div></div>
                      <div class="range__indicators">
                        <div class="range__text">Fri <span class="js-range-start">4:30</span></div>
                        <div class="range__text"><span class="js-range-finish">15.00</span> PM</div>
                      </div>
                    </div>
                    <div class="range range_time js-range-time">
                      <div class="range__info">Landing</div>
                      <div class="range__note">South Island (SIZ)</div>
                      <div class="range__slider js-range-slider noUi-target noUi-ltr noUi-horizontal" data-from="6.5" data-to="18"><div class="noUi-base"><div class="noUi-connects"><div class="noUi-connect" style="transform: translate(27.0833%, 0px) scale(0.479167, 1);"></div></div><div class="noUi-origin" style="transform: translate(-72.9167%, 0px); z-index: 5;"><div class="noUi-handle noUi-handle-lower" data-handle="0" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="0.0" aria-valuemax="75.0" aria-valuenow="27.1" aria-valuetext="6.50"></div></div><div class="noUi-origin" style="transform: translate(-25%, 0px); z-index: 4;"><div class="noUi-handle noUi-handle-upper" data-handle="1" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="27.1" aria-valuemax="100.0" aria-valuenow="75.0" aria-valuetext="18.00"></div></div></div></div>
                      <div class="range__indicators">
                        <div class="range__text">Fri <span class="js-range-start">6:30</span></div>
                        <div class="range__text"><span class="js-range-finish">18.00</span> PM</div>
                      </div>
                    </div>
                    <div class="range range_time js-range-time">
                      <div class="range__info">Take-off</div>
...
<div class="setting__container">
 <div class="setting__head hidden">
                    <h2 class="setting__title h2">Mjölnerbacken 61</h2> <a class="button-stroke button-small setting__button" href="#">Employee list</a>
                  </div>
				  
				 
<div class="checkout__list  " style="/* margin-top:16px; */">
 <a class="card card_row  " style="border:none;  margin-bottom: 20px;" href="jaavscript:void(0);">
	  <div class="card__preview" style="width: 161px;padding: 30px; background: #23262F;"><img   src="<?php echo $getLandloardCompanyDetail['photo_info']; ?>" alt="London - Kings Cross" style="
												padding: 20px;
												border-radius: 88px;
											">
											 
											</div><div class="card__body pad24i xs-pad24" style="background: #23262F;padding-left: 0px;">
<div class="card__line wi_70" style="
    border-bottom: 1px solid #353945;
    padding-bottom: 10px;
    margin-bottom: 10px;
">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $getLandloardCompanyDetail['company_name']; ?></div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php  if($getLandloardCompanyDetail['sale_email']=='') echo '-'; else echo $getLandloardCompanyDetail['sale_email']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo '+'.$getLandloardCompanyDetail['country_code'].' '.$getLandloardCompanyDetail['sale_phone_number']; ?></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $getLandloardCompanyDetail['country_name']; ?></div>
              </div>
...
<div class="checkout__box">
   <?php $i=1; 
								foreach($getLandloardBuildingDetails as $category => $value) 
										{
 ...
 <div class="card card_row" style="margin-bottom:24px;  border:none; ">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px; min-width:200px;"><?php echo $value['society_name']; ?>  </div>
				   
                        
					 <a href="../brokerOffPlanSocietyDetail/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;">
