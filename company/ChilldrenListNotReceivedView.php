	...
	<body class="white_bg ffamily_avenir">
		...
		<div class="column_m pos_rel">
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">	
									...
									<h1 class="marb0  xxs-talc talc fsz100   xxs-fsz45 xs-bold padb10 blue_67cff7 trn">Presence</h1>
									</div>
									<!-- Logo -->
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz25 xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" > Confirm presence by selecting a child. This is a list of children that has not checked-in. </a></div>
							...
							<div class="container   fsz14 dark_grey_txt">
								...
								<div class="tab-content padt5 active" id="tab_total1" style="display:block;">
									...
									<?php $i=0;
													...
													?> 
													<div class="wi_50 fleft bs_bb padb20 padrl10 xs-padrl5 talc">
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="../receivedConfirmation/<?php echo $value['enc']; ?>" class="style_base hei_210p xxs-hei_150p dblock bs_bb pad25 xs-pad10   brdclr_seggreen_h brdrad5  lgtgrey2_bg_h lgtgrey2_bg  box_shadow trans_all2 ">
																<div class=" ">
																	...
																	<span class="dblock tall  marb5 padt10 midgrey_txt fsz14  ffamily_avenir"><?php echo html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']); ?></span>
																		<h3 class="ovfl_hid tall pad0 txtovfl_el ws_now lgn_hight_24 bold fsz16 segdblue_txt padt0 ffamily_avenir hidden-xs"><?php echo $value['social_number']; ?></h3>
				...
				$.ajax({
					type:"POST",
					url:"../moreChildrenDetailNotReceived/<?php echo $data['cid']; ?>",
					data:send_data,
					dataType:"text",
				...
				return false;
						...
						<div class="wi_100  talc mart20 marb40">
										<a href="javascript:void(0);" class="blue_67cff7_brd  trans_bg  blue_btn black_txt trn xxs-brd_width brd_width_2 ffamily_avenir" value="1" id="temp" onclick="show_more_data(this,this.value);">Visa fler</a>
