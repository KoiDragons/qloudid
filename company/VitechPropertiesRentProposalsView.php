...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				 ...
				 <a class="categories__item    " href="../../LandloardBroker/listSocietyProposal/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle   txt_787f91" >Off Plan Sale</div>
									    ...
									    <a class="categories__item    " href="../listPropertyProposal/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Turnkey Rental</div>
                                      </a>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">+<?php echo $value['country_code'].' '.$value['phone_number']; ?></div>
                ...
                <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  ...
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                         ...
                         <a href="../../../../public/index.php/VitechProperties/proposalInformation/<?php echo $value['enc']; ?>" style="text-decoration:none;" target="blank">
