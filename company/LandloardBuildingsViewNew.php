 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Started</div>
                                      </a>
									  
									   <a class="categories__item    " href="../listCompletedBuildings/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle    txt_787f91">Completed</div>
                                      </a>
                ...
                <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  ...
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                         ...
                         <a href="../buildingAddinsInfo/<?php echo $data['cid']; ?>/<?php echo  $value['enc']; ?>" style="text-decoration:none;" target="blank">
						 <div class="card__price" style="color:#52d4f4; box-shadow: none; padding:0px;">
                    ...
                    <use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
					    ...
					    <a href="../editBuildingInfo/<?php echo $data['cid']; ?>/<?php echo  $value['enc']; ?>" style="text-decoration:none;" target="blank">
						 <div class="card__price" style="color:#52d4f4; box-shadow: none; padding:0px;">
                         
                        <div class="card__actual"><svg class="icon icon-home" style="width:24px; height:24px">
                    <use xlink:href="#icon-edit" style="fill:#52d4f4;"></use>
                  </svg></div>
                      </div></a>
                    </div>
