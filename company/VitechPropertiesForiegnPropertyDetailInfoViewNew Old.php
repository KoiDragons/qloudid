...
<div class="outer">
<!-- header--> 
   <div class="column_m     bs_bb trans_bg " style="height:93px;  padding: 22px 0 22px !important;">
<header class="  js-header authorization  " style="background: transparent; height:49px;">
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../listEmployeesProperties/<?php echo $data['cid']; ?>" style="
   ...
   "  >Back</a>
		...
		<div class="header__wrapper js-header-wrapper" style="/* background: #282828; */">
...
<h2 class="browse__title h2 changedText" style="
    font-size: 80px;
    line-height: 90px;
"><?php echo $fetchPropertiesDescription ['sellPhrase']; ?></h2>
<div class="browse__info info changedText"><?php echo $fetchPropertiesAddress['streetAddress'].', '.$fetchPropertiesAddress['postTown'].', '.$fetchPropertiesAddress['country'].', '.$fetchPropertiesAddress['zipCode']; ?></div>
</div>
  
<div class="checkout__inner js-tabs wi_50 xs-wi_100" style="padding-right:0px;">

<div class="section categories  marl6 margin-bottom32" style="margin-bottom: 0px; ">
<div class="categories__center center1 xsi-nobrdb xsi-padb0"  >
<div class="categories__inner">

 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			    
			    <a class="categories__item   black_bg" href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_f67f00">Property</div>
                                      </a>
				<a class="categories__item bg_E7E7E7  " href="../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Photos</div>
                                      </a>
			     
									  
									  <a class="categories__item  bg_E7E7E7 " href="../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Mission</div>
                                      </a>
									  <?php if($vitechRequestCount['num']==0){ if($fetchPropertiesPricing['pricing_updated']==1 && count($fetchPropertiesImages)>=10 && $fetchPropertyStatus==1) { ?>
									  <a class="categories__item  bg_E7E7E7 " href="../../sendPublishRequest/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Publish</div>
                                      </a>
									  <?php } } ?>
</div>
</div>
...
<div class="gallery">
              <div class="gallery__list gallery__list_stays">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view" href="../../../../<?php echo $fetchPropertiesImages[0]['image_info']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="../../../../<?php echo $fetchPropertiesImages[0]['image_info']; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#" class="xs-brdrad10">
                    <svg class="icon icon-image">
                      <use xlink:href="#icon-image"></use>
                    </svg><span>Show all photos</span></a></div>
					<?php  $i=1; foreach($fetchPropertiesImages as $category => $value)
												{
													if($i==1){ $i++; continue;}
												if($i>4) { break; } ?>
					<a class="gallery__preview xs-brdrad10" href="../../../../<?php echo $value['image_info']; ?>" data-fancybox="gallery"><img src="../../../../<?php echo $value['image_info']; ?>" alt="Gallery" class="xs-brdrad10"></a> 
												<?php $i++; } ?>
              </div>
            </div>
 <?php } ?>
 
 <div class="checkout__line  mart30">
					   <div class="checkout__subtitle changedText">Description</div>
                       
                      </div>
 
 <div class="field mart30">
                            <div class="field__label  changedText" style="color:#787f91;">Sell phrase</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="vmdbg5" value="<?php echo $fetchPropertiesDescription ['sellPhrase']; ?>" readonly>
                            </div>
                          </div>
						 <div class="field mart30">
                            <div class="field__label  changedText" style="color:#787f91;">Selling heading</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="vmdbg5" value="<?php echo $fetchPropertiesDescription ['sellingHeading']; ?>" readonly>
                            </div>
                          </div>
						  
						  <div class="field mart30">
                            <div class="field__label  changedText" style="color:#787f91;">Short selling description</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="vmdbg5" value="<?php echo $fetchPropertiesDescription ['shortSellingDescription']; ?>" readonly>
                            </div>
                          </div>
						  
						  <div class="field mart30">
                            <div class="field__label  changedText" style="color:#787f91;">Long selling description</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="vmdbg5" value="<?php echo $fetchPropertiesDescription ['longSellingDescription']; ?>" readonly>
                            </div>
                          </div>
						  
						  
						  <div class="checkout__line  mart30">
					   <div class="checkout__subtitle changedText">Property address</div>
                       
                      </div>
						  
						  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Area</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="addrs" id="addrs" value="<?php   echo $fetchPropertiesAddress['area']; ?>"  readonly style="background:#23262F; color:grey;" fdprocessedid="0myzvs">
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Street address</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pnumber" id="pnumber" style="background:#23262F; color:grey;" fdprocessedid="p0tyog" value="<?php   echo $fetchPropertiesAddress['streetAddress']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  ...
						  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Zipcode</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dzip" id="dzip" style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesAddress['zipCode']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">City, State</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="dcity" id="dcity" style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesAddress['postTown']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesAddress['country']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Province</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesAddress['province']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						   ...
						   <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Longitud</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesAddress['longitud']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Latitud</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesAddress['latitud']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesAddress['city']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Property type</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesAddress['propertyType']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  <div class="checkout__line  ">
					   <div class="checkout__subtitle changedText">Property price</div>
                       
                      </div>
						   <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Starting price</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesAddress['startingPrice']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Currency</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesAddress['currency']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  
						  <div class="checkout__line  ">
					   <div class="checkout__subtitle changedText">Property interior</div>
                       
                      </div>
						  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Total bedrooms</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesInterior['numberOfBedrooms']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Total rooms</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesInterior['numberOfRooms']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						   ...
						   <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Maximum bedrooms</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesInterior['maxNumberOfBedrooms']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Total bathrooms</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesInterior['numberOfBathrooms']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  
						  <div class="checkout__line  ">
					   <div class="checkout__subtitle changedText">Building detail</div>
                       
                      </div>
						  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Building type</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesBuilding['buildingType']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Building year</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesBuilding['buildingYear']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesBuilding['elevator']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Total floors</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesBuilding['totalNumberFloors']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesBuilding['floor']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Energy class</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesBuilding['energyClass']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  
						  <div class="checkout__line  ">
					   <div class="checkout__subtitle changedText">Plot detail</div>
                        ...
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Area</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesPlot['area']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">plot type</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesPlot['plotType']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  
						   
                        <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Other plot</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesPlot['otherPlot']; ?>"  readonly>
                            </div>
                          </div>
						  <div class="checkout__line  ">
					   <div class="checkout__subtitle changedText">Property distance</div>
                       
                      </div>
						    <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Shopping centre</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesDistance['shoppingCentre']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Centre</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesDistance['centre']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						   ...
						   <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Airport</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesDistance['airport']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Golf cource</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesDistance['golfCource']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  ...
						  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Sea</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesDistance['sea']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Supermarket</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesDistance['supermarket']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  ...
						  <div class="checkout__row margin-bottom32">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Pool</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" value="<?php   echo $fetchPropertiesDistance['pool']; ?>"  readonly>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Hospital</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesDistance['hospital']; ?>"  readonly>
                            </div>
                          </div>
						  </div>
						  
						  <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Beach</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php   echo $fetchPropertiesDistance['beach']; ?>"  readonly>
                            </div>
                          </div>
						  
						  <div class="checkout__line  ">
					   <div class="checkout__subtitle changedText">Property exterior</div>
                       
                      </div>
						  <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Pool</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php if($fetchPropertiesExterior ['pool']==1) echo 'Available'; else echo 'Not available'; ?>" readonly>
                            </div>
                          </div>
						  
						  <?php if($fetchPropertiesExterior ['pool']==1) { ?> 
						   <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Description of pool</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php echo $fetchPropertiesExterior ['descriptionOfPool']; ?>" readonly>
                            </div>
                          </div>
						  <?php } ?>
						    ...
						    <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Terrace</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php if($fetchPropertiesExterior ['terrace']==1) echo 'Available'; else echo 'Not available'; ?>" readonly>
                            </div>
                          </div>
						  
						  <?php if($fetchPropertiesExterior ['terrace']==1) { ?> 
						   <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Surface of terrace</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php echo $fetchPropertiesExterior ['terraceSurface']; ?>" readonly>
                            </div>
                          </div>
						  <?php } ?>
						   ...
						   <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Balcony</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php if($fetchPropertiesExterior ['balcony']==1) echo 'Available'; else echo 'Not available'; ?>" readonly>
                            </div>
                          </div>
						  
						  <?php if($fetchPropertiesExterior ['balcony']==1) { ?> 
						   <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Surface of balcony</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php echo $fetchPropertiesExterior ['balconySurface']; ?>" readonly>
                            </div>
                          </div>
						  
						  <div class="field margin-bottom32">
                            <div class="field__label  changedText" style="color:#787f91;">Description terrace nnd balcony</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"   style="background:#23262F; color:grey;" fdprocessedid="tqjibs" value="<?php echo $fetchPropertiesExterior ['descriptionTerraceAndBalcony']; ?>" readonly>
                            </div>
                          </div>
						  <?php } ?>
...
<div class="checkout__row margin-bottom32">
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Region</div>
                            <div class="field__wrap">
                               <select class="" id="vitech_region_id" name="vitech_region_id" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange="selectCity(this.value);" fdprocessedid="zc7mun">
                          ...
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">City</div>
                            <div class="field__wrap">
                              <select class="" id="vitech_city_id" name="vitech_city_id" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange="selectArea(this.value);" fdprocessedid="knpjzs">
						  ...
						  <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Area</div>
                            <div class="field__wrap">
                              <select class="" id="vitech_area_id" name="vitech_area_id" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" fdprocessedid="54p5r">
						...
						<a class="button checkout__button changedText" href="javascript:void(0);" onclick="submitForm();"><?php if($fetchPropertyStatus==0) { echo 'Activate';  } else { echo 'Deactivate'; } ?></a>
</div>
<div class="receipt" style="border: 1px solid #353945 !important; display:none;">
...
<div class="receipt__subtitle">Oct 20,2023 - Oct 25,2023</div>
</div>
</div>
</div>
...
<div class="receipt__subtitle">GPS</div>
<div class="receipt__content">$0</div>
</div>
...
<svg class="icon icon-minus"  style="fill:#F67F00;">
...
<svg class="icon icon-plus" style="fill:#F67F00;">
<use xlink:href="#icon-plus"></use>
</svg>
</button>
<input class="js-counter-input js-counter-result js-counter-babies" type="hidden" name="extra_inclusions" id="extra_inclusions" value="0">
</div>
</div>
...
<div class="receipt__setting"  >
<div class="receipt__wrap">
<div class="receipt__subtitle">Additional driver</div>
<div class="receipt__content">$0</div>
</div>
...
<input class="js-counter-input js-counter-result js-counter-babies" type="hidden" name="extra_driver" id="extra_driver" value="0">
</div>
</div>
...
<input class="js-counter-input js-counter-result js-counter-babies" type="hidden" name="child_seats" id="child_seats" value="0">
</div>
</div>
</div>
...
<div class="receipt__cell">$0 x 0 days</div>
<div class="receipt__cell">$0</div>
</div>
...
<div class="receipt__cell total_fee">$0</div>
</div>
</div>
...
</svg>You can cancle this booking anytime for free 
</div><a class="button receipt__button" href="javascript:void(0);"   style="background:#F67F00;"><span>Rent this car</span>
