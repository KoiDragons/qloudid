...
<html>
	...
	if($childrenDetail ['child_image_path']!=null) { $filename="../estorecss/".$childrenDetail ['child_image_path'].".txt"; if (file_exists($filename)) { $value_a=file_get_contents("../estorecss/".$childrenDetail ['child_image_path'].".txt"); $value_a=str_replace('"','',$value_a); $value_a = base64_to_jpegp( $value_a, '../estorecss/tmp'.$childrenDetail['child_image_path'].'.jpg' ); } else { $value_a="../html/usercontent/images/person-male.png"; } }  else $value_a="../html/usercontent/images/person-male.png"; ?>
	<head>
		<meta charset="utf-8">
		...
		<script>
			...
			function sendRequest(){
				...
				$.ajax({
															type:"POST",
															url:"../moreInformation/<?php echo $data['child_id']; ?>",
															data:send_data,
															dataType:"text",
         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 bg_ececec"  >
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../ChilldCare/helpCenter/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul" style="color:#b5c2c9;"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
		...
		<div class="right_container  xxxs-wi_100 maxwi_100 ">
					...
					<div class="column_m scroll_menu_header wi_480p  xxxs-wi_100 maxwi_100  brdrad3"  data-li-params="class|dblock padb5" data-params="class|dblock padb3 brdb_new brdclr_trans brdclr_white_a lgtgrey2_bg_a dark_grey_txt blue3_txt_a">
						...
						<div class="container brd_e3e2e2 xs-nobrd   xxs-brdrad0 xxs-nobrdrl white_bg fsz14 dark_grey_txt ">
								...
								<form action="../postChildNews/<?php echo $data['child_id']; ?>" method="POST" id="post_comment" name="post_comment" accept-charset="ISO-8859-1">
							...
							<div id="discussions">
								...
								<div class="  ">
										<div class="padrl0">
											<form action="../postReply/<?php echo $data['child_id']; ?>" method="POST" id="reply_comment<?php echo $value['id']; ?>" name="reply_comment<?php echo $value['id']; ?>" accept-charset="ISO-8859-1">
								...
								foreach($value['comments'] as $category => $value1) 
												...
												<div class="padt15 padb15 padrl20 mart15 lgtgrey_bg">
													<table class="wi_100" cellpadding="0" cellspacing="0">
														<tbody><tr>
															...
															<td class="wi_100 valm">
																<textarea name="user_comment<?php echo $value['id']; ?>" id="user_comment<?php echo $value['id']; ?>" rows="1" class="wi_100 dblock bs_bb padrl10 padtb9 brd brdclr_lnkdblue_f brdrad2 lgn_hight_14 fsz14 " placeholder="Kommentera här..." required="required"></textarea>
															</td>
															<td class="reply_btn padl15 valm">
											...
											<div class="clear"></div>
													...
													<div id="moreInformation">
															...
															$.ajax({
															type:"POST",
															url:"../moreComments/<?php echo $data['child_id']; ?>",
															data:send_data,
															dataType:"text",
															contentType: "application/x-www-form-urlencoded;charset=utf-8",
															success: function(data1){
						...
						<div class="column_m wi_220p bs_bb padl20 talc hidden-xxxs">
							<div class="padtb30 brd white_bg talc">
								<div class="marb10 lnkdblue_txt fsz32">1</div>
								<div class="marb5 fsz14">Antal föräldrar</div>
								<div class="fsz14">
									<a href="#">Anhöriga</a>
								</div>
								<div class="padt20">
