...
<button class="header__burger js-header-burger"></button>
  ...
  <!-- outer content-->
       <div class="outer__inner xs-mart65 mart80">
          ...
          <div class="product__center center">
            ...
            <div class="product__head">
              <div class="product__box">
                <h2 class="product__title h2"><?php echo $getLandloardBuildingDetails['building_name']; ?></h2>
                <div class="product__line">
                  <div class="product__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar-1.jpg" alt="Avatar"></div>
                  ...
                  <div class="product__options">
                    ...
                    <div class="product__option">
                      ...
                      </svg><?php if($getLandloardBuildingDetails['street_address']!=null || $getLandloardBuildingDetails['street_address']!='') echo $getLandloardBuildingDetails['street_address'].','; if($getLandloardBuildingDetails['city']!=null || $getLandloardBuildingDetails['city']!='') echo $getLandloardBuildingDetails['city']; ?>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="gallery">
              <div class="gallery__list gallery__list_stays">
                <div class="gallery__preview"><a class="gallery__view" href="https://www.safeqloud.com/estorecss/tmp<?php echo $getLandloardBuildingImages[0]['building_photo_path']; ?>.jpg" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="https://www.safeqloud.com/estorecss/tmp<?php echo $getLandloardBuildingImages[0]['building_photo_path']; ?>.jpg" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#">
					...
					<?php $i=1; foreach($getLandloardBuildingImages as $category => $value) 
												{
													if($i==1){ $i++; continue;} 
												if($i>4) { break; } ?>
		...
		<div class="description" style="padding-bottom: 30px; margin-bottom:60px;">
          <div class="description__center center">
            <div class="description__wrapper">
              <h4 class="description__title h4 xs-fsz32 fsz48 margin-bottom16"><?php echo $getLandloardBuildingDetails['building_name']; ?></h4>
              <div class="actions js-actions borderBottom paddingBottom16 margin-bottom20">
                <div class="actions__list " style="justify-content: left;">
              ...
              <div class="description__content ">
                <p>The best 16 passenger small group, intimate and unique, Milford Sound tour. Travel in unparalleled style and comfort in a premium Mercedes van equipped with large panoramic windows, leather reclining seats, quirky on board videos, free wifi and complimentary bottled water. From your accommodation enjoy the stunning scenic drive</p>
			...
			<div class="sorting__location hidden" style="margin-left: 0px !important;">
             <div class="sorting__map_update js-sorting-map" style="visibility: visible; opacity:1; width:448px; border-radius: 24px 24px 24px 24px !important;">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63817.0803287881!2d168.63234961382247!3d-45.04173987887954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa9d51df1d7a8de5f%3A0x500ef868479a600!2z0JrRg9C40L3RgdGC0LDRg9C9LCDQndC-0LLQsNGPINCX0LXQu9Cw0L3QtNC40Y8!5e0!3m2!1sru!2sua!4v1624887132616!5m2!1sru!2sua" width="438" height="290" style="border-radius:24px;" loading="lazy"></iframe>
                  </div>
				   </div>
		...
		<?php foreach($getLandloardApartmentPropertyList as $category => $value) { ?>
        <div class="flights__center center " style="padding-bottom: 0px; border-bottom:none; margin-bottom: 45px;">
		<div class="panel__controls ">
                <button class="button-stroke button-small panel__button active"><?php echo $value['bedroom_count']; ?> bedroom and kitchen</button>
		...
		<a class="card card_row" href="javascript:void(0);" style="margin-bottom:24px;">
                  ...
                  <div class="card__body">
                    <div class="card__line">
                      <div class="flight__title" style="font-size:30px;"><?php echo $value1['office_apartment_number']; ?></div>
                      <div class="card__price">
                        <div class="card__old"><?php echo $value1['sale_price']; ?> kr</div>
                        <div class="card__actual"><?php echo $value1['sale_price']; ?> kr</div>
                      </div>
                    </div>
                    <div class="card__options">
                      <div class="card__option">
                        ...
                        </svg><?php echo $value1['apartment_size']; ?>m2
                      </div>
                      <div class="card__option">
                        <svg class="icon icon-user">
                          <use xlink:href="#icon-user"></use>
                        </svg>Floor <?php echo $value1['floor_number']; ?>
                      </div>
                    </div>
                    <div class="card__foot">
                      
                      <div class="card__flex">
                        <div class="card__cost fsz16"><?php echo $value1['sale_price']; ?> kr</div>
                        <div class="card__rating">
                         <div class="button receipt__button" style="background: #0142eb;" ><span>Reserve</span>
          ...
          <div class="description__center center">
            <div class="description__wrapper">
              ...
              <div class="description__list">
                <div class="description__item" style="margin:0px 20px 32px !important;">
		...
		<?php $i=1; foreach($getLandloardApartmentPropertyList  as $category => $value) 
												{ ?>
          <div class="description__section">
                  <h4 class="description__title h4"><?php echo $value['bedroom_count']; ?> bedroom and kitchen</h4>
                  <div class="description__inner">
                    <div class="description__slider js-slider-description">
					<?php  foreach($value['apartment_details']  as $category => $value1) 
												{ ?>
                     <a href="../landloardApartmentDetail/<?php echo $data['bid']; ?>/<?php echo $value1['enc']; ?>"> <div class="description__slide" style="background-color: #E0EEF7;">
                        ...
                        <div class="description__subtitle"><?php echo $value1['sale_price']; ?> kr </div>
						<div class="description__text">Floor <?php echo $value1['floor_number']; ?></div>
                        <div class="description__text"><?php echo $value1['apartment_size']; ?>m2</div>
						<div class="description__text"><?php if($value1['terrace_available']==1) echo 'Terrace'; else echo '-'; ?></div>
						<div class="description__text"><?php if($value1['balcony_available']==1) echo 'Balcony'; else echo '-'; ?></div>
                      </div></a>
												<?php } ?>
              ...
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    ...
                    <div class="receipt__actual">$102</div>
                    <div class="receipt__note">/person</div>
                  </div>
                ...
                <div class="receipt__avatar"><img src="<?php echo $path; ?>html/soligahem/img/content/avatar.jpg" alt="Avatar">
              ...
              <div class="receipt__offers">
                <div class="receipt__offer">
                  <div class="receipt__wrap">
                    <div class="receipt__date">Wed, June 23</div>
                    <div class="receipt__time">7:30 AM - 7:30PM</div>
                  </div><a class="button-stroke receipt__button" href="#"><span class="receipt__cost"><span class="receipt__money">$256</span> / person</span>
                    <svg class="icon icon-bag">
                      <use xlink:href="#icon-bag"></use>
                    </svg></a>
                </div>
                <div class="receipt__offer">
                  <div class="receipt__wrap">
                    <div class="receipt__date">Wed, June 24</div>
                    <div class="receipt__time">7:30 AM - 7:30PM</div>
                  </div><a class="button-stroke receipt__button" href="#"><span class="receipt__cost"><span class="receipt__money">$102</span> / person</span>
                    <svg class="icon icon-bag">
                      <use xlink:href="#icon-bag"></use>
                    </svg></a>
                </div>
                <div class="receipt__offer">
                  <div class="receipt__wrap">
                    <div class="receipt__date">Wed, June 25</div>
                    <div class="receipt__time">7:30 AM - 7:30PM</div>
                  </div><a class="button-stroke receipt__button" href="#"><span class="receipt__cost"><span class="receipt__money">$45</span> / person</span>
                    <svg class="icon icon-bag">
                      <use xlink:href="#icon-bag"></use>
                    </svg></a>
                </div>
                <div class="receipt__offer">
                  <div class="receipt__wrap">
                    <div class="receipt__date">Wed, June 26</div>
                    <div class="receipt__time">7:30 AM - 7:30PM</div>
                  </div><a class="button-stroke receipt__button" href="#"><span class="receipt__cost"><span class="receipt__money">$231</span> / person</span>
                    <svg class="icon icon-bag">
                      <use xlink:href="#icon-bag"></use>
                    </svg></a>
                </div>
              </div>
              <div class="receipt__foot"><a class="receipt__more" href="#">See more dates</a></div>
            </div>-->
				</div> 
</div>  				
				</div>
     ...
     <!-- scripts-->
    <script src="<?php echo $path; ?>html/soligahem/js/lib/jquery.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/slick.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/jquery.nice-select.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/share-buttons.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/jquery.fancybox.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/jquery.rateyo.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/nouislider.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/wNumb.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/moment.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/jquery.daterangepicker.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/lib/simpleParallax.min.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/demo.js"></script>
    <script src="<?php echo $path; ?>html/soligahem/js/app.js"></script>
    <!-- svg sprite-->
