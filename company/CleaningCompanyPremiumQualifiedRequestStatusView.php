					...
					<div class="marb50 padt0   ">
						 ...
						 <?php } ?>
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir"><?php if($premiumQualifiedCount==0) echo 'Pending'; else if($premiumQualifiedCount==2) echo 'Rejected'; else if($premiumQualifiedCount==1) echo 'Approved'; ?></h1>
									</div>
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" ><?php if($premiumQualifiedCount==0) echo 'Your request for Premium Qualified account is pending for verification'; else if($premiumQualifiedCount==2) echo 'Your request for Premium Qualified account has been rejected by support team'; else if($premiumQualifiedCount==1) echo 'Your request for Premium Qualified account has been approved by support team'; ?></a></br>
