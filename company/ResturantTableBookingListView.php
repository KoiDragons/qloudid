				...
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<!-- Center content -->
						...
						<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr tall">
						                                            <a href="#" class="dinlblck mar5 padrl30     bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active">Received</a>
                                         
                                          <a href="../../tableReservationConfirmedList/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir">Confirmed</a>    
					 		...
					 		<?php $i=1;
												...
												?> 
											<a href="../../selectTables/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $value['enc']; ?>"> <div class="column_m container  marb5  fsz14 dark_grey_txt brd">
								...
								<script>
									function add_more_rows(link) {
										...
										$.ajax({
											type:"POST",
											url:"../../moreReservationList/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>",
											data:send_data,
											dataType:"text",
