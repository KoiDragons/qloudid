...
<a class="header__logo xs-fsz20 " href="../../CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>" style="
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Action</h2>
<div class="browse__info info changedText"><?php echo $companyDetail['address'].' | '.$companyDetail['si_city'].' | '.$companyDetail['si_zip'].' | '.$companyDetail['country']; ?></div>
</div>
...
<div class="checkout__label changedText">This property</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Already sold</div>
 
<div class="checkout__controls">
 
<a href="../propertyInformation/<?php echo $data['cid']; ?>/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09"><button class="checkout__edit"  >
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Is to be sold</div>
 
<div class="checkout__controls">
 
<a href="../propertyInformation/<?php echo $data['cid']; ?>/QkhHaWQzcnBweFU5MDRIMllxY3IzQT09"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
