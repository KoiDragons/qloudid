					...
					<div class="marb50 padt0   ">
						 ...
						 <img src="https://media.giphy.com/media/xULW8hNotUdPTMaQBG/giphy.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Do you want to be a verifier? Please click the button below to submit a request for Verify ID account.</a></br>
									
									</div>
									<div class="talc padt20 ffamily_avenir mart35"> <a href="../sendVerifyIdRequest/<?php echo $data['cid']; ?>"><input type="button" value="Send request" class="forword minhei_55p  fsz18 red_ff2828_bg   ffamily_avenir"  ></a> </div>
