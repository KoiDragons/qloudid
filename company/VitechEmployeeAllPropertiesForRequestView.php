...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" >PROPERTIES</h2>
...
<a class="card card_row " style="border: 2px solid #353945;border-radius: 20px;margin-bottom: 20px;" href="../../../addConnectRequestInfo/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['service_id']; ?>/<?php echo $value['enc']; ?>">
