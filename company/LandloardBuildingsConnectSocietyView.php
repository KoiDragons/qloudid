...
<a class="header__logo xs-fsz25 changedText" href="../../listCompletedBuildings/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select society to which building is connected
</div>
...
<form action="../../updateBuildingSociety/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" method="POST" id="save_indexing1" name="save_indexing1" accept-charset="ISO-8859-1">
 
<div class="checkout__fieldset">
  
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Society</div>
<div class="field__wrap">
<select  class="   "  name="society_id" id="society_id" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52"  >
				 <?php $i=1; 
								foreach($societyList as $category => $value) 
										{
											 
										 ?> 
                         	<option value="<?php echo $value['id']; ?>"><?php echo $value['society_name']; ?></option>
...
<a class="button checkout__button changedText  " href="javascript:void(0);" onclick="submitform();">Connect</a>
