...
<html>
	...
	<head>
		...
		<script>
			function submitApp()
			{
				...
				if($("#app_name").val() == '' || $("#app_name").val() == null)
				{
					
					$('#errorMsg').html("Please enter app name !!!");
					return false;
					
				}
				if($("#app_url").val() == '' || $("#app_url").val() == null)
				{
					
						$('#errorMsg').html("Please enter app url !!!");
						return false;
					
				}
				 if($("#app_type").val() ==  '' || $("#app_type").val() == null)
				{
					
						$('#errorMsg').html("Please select app type !!!");
						return false;
										...
										<li class="dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													...
													<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Company Devs App</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											</ul>
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 brdb_new">
								<div class="white_bg tall">
									...
									<!-- Logo -->
									<h1 class="fsz25 bold">App listing</h1>
									<!-- Logo -->
									...
									<a href="#" class="show_popup_modal diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt " data-target="#add_apps">
							...
							<div class="container tab-header  talc dark_grey_txt mart5">
								<ul class="tab-header tab-header-custom tab-header-custom5 xs-dnone lgtgrey_bg">
									<li>
										<a href="#" class="dblock brdradt5 active" data-id="tab_total">
											<span class="count black_txt"><?php echo $appsCount['num']; ?></span>
											<span class="black_txt trn fsz16" >Apps </span>
										</a>
									</li>
								...
								<select class="tab-header xs-wi_100 maxwi_100 dnone xs-dblock hei_70p pad0 nobrd brdb_new xs-fsz30 pblue2_bg">
									<option value="tab_total" selected class="xs-fsz20"><?php echo $appsCount['num']; ?></option>
							...
							<div class="container   fsz14 dark_grey_txt">
									...
									<table class="wi_100 " cellpadding="0" cellspacing="0" id="mytableleft">
										<thead class="fsz14" >
											<tr class="lgtgrey2_bg">
												...
												<th class="pad5 brdb_new nobold  tall" >
													<div class="padtb5 black_txt">App name</div>
												</th>
											...
											<?php $i=0;
												...
												<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16">
													...
													<td class="pad5 brdb_new tall cn">
														<div class="padtb5 " ><a href="#"><?php echo $value['app_name']; ?></a></div>
													</td>
													<td class="pad5 brdb_new tall nm hidden-xs ">
														<div class="padtb5 "><?php if($value['app_type']==1) echo 'For Employee'; else echo 'For all users'; ?></div>
													</td>
								...
								<div class="padt20 talc">
									...
									function add_more_my(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreAppsDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
	...
	<div class="popup_modal wi_350p maxwi_90 pos_fix pos_cen zi50 bs_bb white_bg fsz14 brdrad5 " id="add_apps">
		<div class="modal-content pad25  nobrdb talc brdrad5 ">
			...
			<form action="../addAppName/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">
			
			<div class="on_clmn padb10">
				
				<div class="pos_rel ">
					
					<input type="text" id="app_name" name="app_name" class="wi_100 default_view  rbrdr pad10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" placeholder="Add app name">
				</div>
			</div>
			<div class="on_clmn padb10">
				...
				<div class="pos_rel ">
					...
					<input type="text" id="app_url" name="app_url" class="wi_100 default_view  rbrdr pad10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" placeholder="Add app url">
				</div>
			</div>
				...
				<div class="pos_rel ">
					...
					<select id="app_type" name="app_type" class="wi_100 default_view  rbrdr pad10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" >
					<option value="1">For Employees</option>
					<option value="2">For All users</option>
					</select>
				</div>
			</div>
			...
			<div class="on_clmn mart10 marb20">
				<input type="button" value="Prova gratis" class="wi_320p maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" onclick="submitApp();">
