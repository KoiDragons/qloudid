			...
			<div class=" fright marr0 ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
					...
					<li class="last first marr10i">
						<a href="../../vehicleTypeInfo/<?php echo $data['cid']; ?>/<?php echo $data['location_id']; ?>" class="lgn_hight_s1 fsz25"><span class="fas fa-plus black_txt" aria-hidden="true"></span></a>
					 </li>
				</ul>
			</div>
				</div>  
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Here is the list of cars available for rent</a></div>
						...
						<div class="on_clmn brdb">
										...
										<input type="text" value="Car type" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										 
									</div>
									 </div> 
					 		<?php $i=1;
												
												foreach($vehicleTypeList as $category => $value) 
												{
													
													
												?> 

											<a href="../../vehicleTypeCarList/<?php echo $data['cid']; ?>/<?php echo $data['location_id']; ?>/<?php echo $value['enc']; ?>">	<div class="column_m container  marb5   fsz14 dark_grey_txt">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $value['car_model']; ?>  </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt"><?php echo $value['model_series']; ?></span>  </div>
