...
<a class="header__logo " href="../listPropertyProposal/<?php echo $data['cid']; ?>" style="
 ...
 <!-- outer content-->
      <div class="outer__inner">
		...
		<div class="section flights" style="margin-bottom:0px;">
          <div class="outer__inner xs-mart65 mart80" style="
">
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select the properties you wish to present in the proposal.
</div>
...
">
 ...
 <script>
										 function selectWishlist(id)
										 {
											...
											if($('#'+id).hasClass('ButtonWhite'))
											{
												$('#'+id).removeClass('ButtonWhite');
												$('#'+id).addClass('Button10161d');		
												...
												if($('#p'+id).hasClass('demoP'))
												{
													$('#p'+id).removeClass('bgFFF59E');
													$('#p'+id).addClass('bgFFFFFF');
													
													
												}
												else
												{
													$('#p'+id).removeClass('bg10161d');
													$('#p'+id).addClass('bgFFFFFF');
												}
											}
											else
											{
												$('#'+id).addClass('ButtonWhite');
												$('#'+id).removeClass('Button10161d');		
												...
												if($('#p'+id).hasClass('demoP'))
												{
													$('#p'+id).removeClass('bgFFFFFF');
													$('#p'+id).addClass('bgFFF59E');
												}
												else
												{
													$('#p'+id).removeClass('bgFFFFFF');
													$('#p'+id).addClass('bg10161d');
 ...
 <div class="section destinations xs-padrl25  hidden-xxs" style="margin-bottom:60px;">
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Properties</div>
                                      </a>
									  
									   <a class="categories__item    " href="javascript:void(0);" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Services</div>
                                      </a>
 ...
 <div class="section travels">
          <div class="travels__center center xs-pad0" style="">
...
box-shadow:none;">
			   ...
			   <?php $i=1; 
								foreach($displayproperties as $category => $value) 
										{
											 if($value['company_property_id']==112 || $value['company_property_id']==114  || $value['company_property_id']==120  || $value['company_property_id']==121 || $value['company_property_id']==122) {
											 }
											 else
											 {
												 if($value['completed']<100) {continue;} 
											 }
												
										 ?> 
			   <div class="travels__card <?php if($value['company_property_id']==112 || $value['company_property_id']==114  || $value['company_property_id']==120  || $value['company_property_id']==121 || $value['company_property_id']==122) echo 'bgFFF59E demoP'; else echo 'bg10161d' ?>" id="p<?php echo $value['id']; ?>">
                     <div class="travels__preview"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="Card" style="border-radius: 50%; padding: 20px 40px;">
								   <?php if($value['company_property_id']==112 || $value['company_property_id']==114  || $value['company_property_id']==120  || $value['company_property_id']==121 || $value['company_property_id']==122) { ?>
								  <div class="status-black browse__category">Demo only</div>
								   <?php }  ?>
								  </div>
                                  <div class="travels__body">
                                    <div class="travels__line" style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: #777E90;"><?php echo $value['sellPhrase']; ?></div>
                                        <div class="travels__location" style="color: #777E90;"><?php echo $value['streetAddress'].' '.$value['areaName']; ?></div>
                                      </div>
                                       
                        <a class="header__logo  changedText fright ButtonWhite" href="javascript:void(0);" id="<?php echo $value['id']; ?>" style="
   ...
   " onclick="selectWishlist(<?php echo $value['id']; ?>);">Select</a>
                                    ...
                                    <div class="travels__line hidden">
                                      <div class="travels__date"><?php  echo $value['numberOfBedrooms']; ?> Bedrooms & <?php  echo $value['numberOfBathrooms']; ?> WC</div>
                                      <div class="travels__rating" style="color: #777E90;">
                ...
                <form class="checkout__item js-tabs-item talc" action="../teamVailable/<?php echo $data['cid']; ?>" method="POST" id="save_indexing_proposal" name="save_indexing_proposal" accept-charset="ISO-8859-1" style="display: block;">		
					 				<input type="hidden" id="proposal_data"	name="proposal_data" value="" />
									<input type="hidden" id="proposal_type"	name="proposal_type" value="1" />
 ...
 <div class="popup popup_login mfp-hide" id="popup-login" style="    max-width: 1132px;">
<div class="login">
