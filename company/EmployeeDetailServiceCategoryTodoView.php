               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../employeeAccount/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left white_txt" aria-hidden="true"></i></a>
		 	...
		 	<div class="column_m header hei_60p bs_bb lgtgrey2_bg visible-xs">
				...
				<div class="visible-xs visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../employeeAccount/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left txt_c12219" aria-hidden="true"></i></a>
                     </li>
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl25 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xs-tall talc  xs-padb0 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20 changedText" >Please select the services your employee provides</a></div>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt changedText">Service </span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs changedText">Update service skills that the employee have</span> 
													 </div>
