...
<?php include 'CompanyHeaderClosed.php'; ?>
	...
	<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 xs-marb0 xs-mart30  mart40  padb30" id="loginBank" onclick="checkFlag();">
				...
				<img src="../../../../html/usercontent/images/394180.png" class="maxwi_100 hei_250p">
									...
									<h3 class="marb0  xxs-talc fsz35 xs-fsz25 bold padb5 black_txt talc "  >It´s done...</span></h3>
									
									<div class="martb20  xxs-talc talc "> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc edit-text jain_drop_company black_txt talc" ><span class="trn">Your company is now registered under our global directory listings.</span>
												</a></div>

						<div class="padt5 xxs-talc talc">
								
								<a href="../../CompanyProperty/locationAccount/<?php echo $data['cid']; ?>"><button type="button"  class="white_bg black_txt padrl20 grey_brd hei_55p fsz18 trn">Close</button></a>
