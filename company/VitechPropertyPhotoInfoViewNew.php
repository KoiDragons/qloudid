	...
	if (input.files && input.files[i]) {
		...
		reader.onload = function (e) {
			...
			var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updatePhotos/<?php echo $data['rid']; ?>/<?php echo $data['request_id']; ?> ",
							data:send_data,
							dataType:"text",
...
function getImageInfo(id)
{
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../getImageInfo/<?php echo $data['rid']; ?>/<?php echo $data['request_id']; ?> ",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function getPhoto()
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../getPhoto/<?php echo $data['rid']; ?>/<?php echo $data['request_id']; ?> ",
...
function updatePhotoDecrement(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updatePhotoOrder/<?php echo $data['rid']; ?>/<?php echo $data['request_id']; ?> ",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function deletePhoto(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../deletePhoto/<?php echo $data['rid']; ?>/<?php echo $data['request_id']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function drop(ev) {
  ...
  //ev.target.appendChild(document.getElementById(data));
   ...
   var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updatePhotoDragging/<?php echo $data['rid']; ?>/<?php echo $data['request_id']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
 ...
 <body class="dark" style="background: #131922;" onload="getPhoto();">
    <!-- outer-->
 ...
 <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;">
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
                ...
                <option value="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>Photos</option>
			...
			<a class="setting__link " href="../../../editPropertyContractInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../editPropertyContractInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                ...
                </svg><span style="color:#f67f00">Photos </span></a>
				<?php if($fetchPropertyContacTInfo['property_status']==3) { ?>
...
<div class="setting__head">
                    <h2 class="setting__title h2" style="font-size:25px;">Photos</h2><a class="button-stroke button-small setting__button" href="#" style="background:#f67f00; color:#000000;"><label class="black_txt" >
												Add photos<input type="file" name="file1[]" id="file1" style="display: none;" multiple="" onchange="readURL(this);">
											</label></a>
                  </div>

 
			 
   <div class="flights__container mart30" style="padding-left:0px;">
