 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">iPropose</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Here is a list of all your proposals paid invoices </div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
									  ...
									  <a class="categories__item    " href="../listSocietyProposal/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Off Plan Sale</div>
                                      </a>
									  
									  
									    <a class="categories__item    " href="../../VitechProperties/listProposalSociety/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Turnkey Sale</div>
                                      </a>
									  
			        <a class="categories__item    " href="../../VitechProperties/listRentProposals/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Turnkey Rental</div>
                                      </a>
									  
									  
									  <a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Invoices</div>
                                      </a>
		...
		<div class="section flights">
		  ...
		  <div class="flights__sorting hidden-xxs " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
              ...
              <button class="button-stroke flights__button active changedText hidden-xxs">Advanced filter</button>
            </div>
          
            <div class="flights__row">
			
			
              <div class="flights__filters hidden">
              ...
              <div class="flights__container" style="padding-left:0px;">
				...
				<?php $i=1; 
								foreach($brokerInvoicePaidList as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">Invoice <?php echo $value['id']; ?></div>
...
">
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $value['payment_amount_received']; ?></div>
                <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php if($value['payment_mode']==1) echo 'Cash'; else if($value['payment_mode']==2) echo 'Card'; else if($value['payment_mode']==3) echo 'Bank transfer';?></div>
				  
				  <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo date('Y-m-d',$value['payment_made_on_by_user']); ?></div>
                
              </div>
                         <a href="../proposalInvoiceComissionInfo/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;" target="blank">
