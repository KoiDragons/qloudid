...
<script>
			...
			function sendInformation()
			{
				...
				if($("#ind").val()=="" || $("#ind").val()==0 || $("#ind").val()==null)
				{
					...
					$('#sbutton').attr('style','display:none');
					var send_data={};
					
					send_data.ind=$("#ind").val();
					send_data.item_name=$("#item_name").val();
					send_data.serial=$("#serial").val();
					$.ajax({
						type:"POST",
...
<body class="white_bg ffamily_avenir">
		<div class="column_m header xs-header xsip-header xsi-header bs_bb white_bg hidden-xs"  >
				<div class="wi_100 hei_65p xs-pos_fix padtb5 padrl10 white_bg"  >
								<div class="logo marr15 wi_60p hidden-xs">
			...
			<div class="flag_top_menu flefti padt10 padb10 hidden-xs" style="width: 50px; ">
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows">
					...
					<li class="hidden-xs" style="margin: 0 30px 0 0;">
						<a href="javascript:void(0);" class="lgn_hight_s1 padl10 fsz30" style="color:#ff8b1e;"><i class="fas fa-globe" onclick="togglePopup();"></i></a>
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20" id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
								...
								<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45  padb10 red_ff2828_txt trn">Lägg till</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Registrera företagets värdesaker och värdehandlingar i vårt alarm system för företag...</a></div>
						...
						<div class="collaborator-row dflex alit_c pos_rel">
							...
							<!-- Leave for security protection, read docs for details -->
									...
									<div class="on_clmn mart10 ">
												...
												<div class="pos_rel">
											<select class="input1 default_view wi_100 mart0 nobrdr nobrdt nobrdl brdb  fsz18 xxs-minhei_60p minhei_65p  llgrey_txt tall padl0 dropdown-bg ffamily_avenir nobold" name="item_name" id="item_name"  style="text-align-last:center;">
												<option value="1">Mobiltelefon</option>
											<option value="2">Nycklar</option>
											<option value="3">Bärbar dator</option>                       
											</select>
										</div>
									</div>
									...
									<div class="on_clmn mart20 marb35">
												...
												<div class="pos_rel">
										<input type="text" name="empname"  placeholder="Artikelnamn" id="collaborators-lookup"  class="txtind10 fsz18  brdb_red_ff2828 red_f5a0a5_txt  wi_100  required xxs-minhei_60p minhei_65p nobrdt nobrdr nobrdl talc  ffamily_avenir" onkeyup="updateForm();">
									</div>
									</div>
							...
							<div class="padt5 xxs-talc talc" id="sbutton">
								
								<button type="button" name="forward" class="forword minhei_55p red_ff2828_bg  fsz18 trn" onclick="sendInformation();">Registrera</button>
