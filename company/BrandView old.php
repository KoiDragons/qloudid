							...
							<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75">
								<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03  brdr_new fsz14" id="scroll_menu">
									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock padb10 padl8 ">
											<a href="https://www.safeqloud.com/company/index.php/CompanyCustomers/companyAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
										...
										<div class="tab_container mart5">
											...
											<?php 
												foreach($getPermissionDetail as $category => $value) 
													{
													?>
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($value['is_permission']==0) echo  '  hidden'; if($value['is_downloaded']==0) echo  '  hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="<?php if($value['app_link']==null) echo '#'; else echo $value['app_link'].''.$data['cid']; ?>" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																	...
																	<div class="trf_y-10p_ph trans_all2 padrbl15 padt10">
																		...
																		<div class="opa0 opa1  lgn_hight_15 fsz14 black_txt trans_all2 pfgreen_bgnew pad10 mart10 marrl10">Besök</div>
																	</div>
																</div>
															</a>
														</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[0]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[0]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[1]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[1]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[10]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[10]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[2]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[2]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[3]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[3]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[4]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[4]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[5]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[5]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[6]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[6]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[7]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[7]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[8]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[8]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
														...
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[9]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[9]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
											...
											<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[11]['is_permission']==0) echo  '  hidden'; if($getPermissionDetail[11]['is_downloaded']==1) echo  '  hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[11]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[11]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
																	
																	<div class="trf_y-10p_ph trans_all2 padrbl15 padt10">
																		<h3 class="ovfl_hid pad0 txtovfl_el ws_now lgn_hight_24 bold fsz16 segdblue_txt padt10">Parkering</h3>
																		<span class="dblock marb5 midgrey_txt">Sales</span>
																		<div class="opa0 opa1_ph lgn_hight_15 fsz14 black_txt trans_all2 panlyellow_bg pad10 mart10 marrl10">View</div>
																	</div>
																</div>
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[11]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
												
												<div class="xs-wi_100 wi_33 fleft bs_bb pad8 talc <?php if(isset($getPermissionDetail)) { if($getPermissionDetail[12]['is_permission']==0) echo  '  hidden'; if($getPermissionDetail[12]['is_downloaded']==1) echo  '  hidden'; } ?>" >
													<div class="toggle-parent wi_100 dflex alit_s" onclick="addActive(this);">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_240p dblock bs_bb pad25 brd brdclr_seggreen_h brdrad20 lgtgrey2_bg_h trans_all2 ">
																<div class="trf_y-12p_ph trans_all2">
																	<div class="wi_100 hei_90p dflex justc_c alit_c bs_bb">
																		<span class="dblock wi_100 maxwi_120p fsz50  maxhei_100p padtb5"><span class="fa-stack ">
																				  <i class="far fa-circle fa-stack-2x <?php echo $getPermissionDetail[12]['app_bg']; ?>"></i>
																				  <i class="black_txt <?php echo $getPermissionDetail[12]['app_icon']; ?>" ></i>
																				</span></span>
																	</div>
																	
																	<div class="trf_y-10p_ph trans_all2 padrbl15 padt10">
																		<h3 class="ovfl_hid pad0 txtovfl_el ws_now lgn_hight_24 bold fsz16 segdblue_txt padt10">Bud och leverans</h3>
																		<span class="dblock marb5 midgrey_txt">Sales</span>
																		<div class="opa0 opa1_ph lgn_hight_15 fsz14 black_txt trans_all2 panlyellow_bg pad10 mart10 marrl10">View</div>
																	</div>
																</div>
														...
														<div class="wi_100 hide dblock_pa style_base hei_190p  bs_bb pad25 brd brdclr_seggreen_h brdrad4 trans_all2">
															...
															<div class="padrl20">
																<a href="../productPage/<?php echo $data['cid']; ?>/<?php echo $getPermissionDetail[12]['enc']; ?>" class="dblock pfgreen_bg talc lgn_hight_40 white_txt">Besök sidan</a>
															</div>
														</div>
													</div>
												</div>
