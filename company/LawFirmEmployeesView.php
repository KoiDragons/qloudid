				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  >Lawers</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" > Please update your firm's  lawer information</a></div>
                                ...
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_new tb_67cff7_bg xs-talc">
                                            <a href="#" class="dinlblck mar5 padrl30_a  padrl10   blue_67cff7_brd_h blue_67cff7_brd_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_Popular">Lawers</a>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fright wi_10 padt10 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz25  padb0  ">
														<div class="boolean-control boolean-control-small boolean-control-green fright <?php if($value['is_lawer']==1) echo 'checked'; else echo ''; ?>" onclick="updateAdmin(<?php echo $value['id']; ?>,this);">
																<input type="checkbox" name="data_request" id="data_request" class="default" data-true="Yes" data-false="No" >
															</div>
													</div>
													
													<a href="../resourceInformation/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><div class="fleft wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 <?php if($value['is_lawer']==0) echo 'hidden'; else echo ''; ?>" id="<?php echo $value['id']; ?>">
