	 ...
	 function updateDescription()
		{
			...
			$('#wordCount').html(id.length);
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updateParkingDescription/<?php echo $data['bid']; ?>",
							data:send_data,
							dataType:"text",
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../../parkingAddInInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['bid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
	...
	if (input.files && input.files[i]) {
		...
		reader.onload = function (e) {
			...
			var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updateParkingPhotos/<?php echo $data['bid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function getImageInfo(id)
{
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../getParkingImageInfo/<?php echo $data['bid']; ?> ",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function getPhoto()
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../getParkingPhoto/<?php echo $data['bid']; ?> ",
...
function updatePhotoDecrement(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updateParkingPhotoOrder/<?php echo $data['bid']; ?> ",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function deletePhoto(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../deleteParkingPhoto/<?php echo $data['bid']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function drop(ev) {
  ...
  //ev.target.appendChild(document.getElementById(data));
   ...
   var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updateParkingPhotoDragging/<?php echo $data['bid']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
			...
			<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 mart40 xs-mart20" id="loginBank" onclick="checkFlag();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45  padb10   trn ffamily_avenir" >Parking</h1>
									</div>
					 ...
					 <div class="on_clmn marb5">
									  ...
									  <div data-testid="description-page">
										 <div class="css-zp5g9l marrl0">
											...
											<div data-testid="description-textarea-wrapper" class="css-16i74gt">
												<textarea id="description-textarea" data-testid="description-textarea" name="description" minlength="400" maxlength="9000" class="css-13k0qhz" onkeyup="updateDescription();"><?php echo $selectedParkingInfo['parking_description']; ?></textarea></div>
											<div id="spacer" spacing="smaller" class="css-ihl6nu"></div>
								...
								<div class="clear"></div>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Opening hours</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">Opening hours are a specific time when the parking is available to use for all the owners/guest of the society.</span> 
													 </div>
									...
									<div class="clear"></div>
									 <form action="../../../updateParkingHrs/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['pid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									...
									<div class="thr_clmn  wi_50">
										...
										<input type="text" value="Open during" class="wi_100 rbrdr pad10    tall  minhei_55p padl0 padr5 fsz18 black_txt ffamily_avenir hidden-xs" readonly="">
											...
											<div class="pos_rel">
												...
												<select name="parking_open_month" id="parking_open_month"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl   nobrdb fsz16  minhei_55p  trans_bg   black_txt tall padl0 ffamily_avenir" style="text-align-last:right;"> 
												<?php 
												for($n=1;$n<=12;$n++) 
												{
												?> 
											<option value="<?php echo $n; ?>" <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_open_month']==$n) echo 'selected'; } ?> ><?php echo  date("F", mktime(0, 0, 0, $n, 10)); ?></option> 
												<?php } ?>
											...
											<div class="pos_rel">
													...
													<select name="parking_close_month" id="parking_close_month"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl   nobrdb fsz16  minhei_55p  trans_bg   black_txt tall padl0 ffamily_avenir" style="text-align-last:right;"> 
												<?php 
												for($n=1;$n<=12;$n++) 
												{
												?> 
											<option value="<?php echo $n; ?>" <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_close_month']==$n) echo 'selected'; } ?> ><?php echo  date("F", mktime(0, 0, 0, $n, 10)); ?></option> 
												<?php } ?>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt13 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_mon_fri']==1) echo 'checked'; else echo ''; } ?> " onclick="updateDayopen(1,this);">
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
											</div>
											<div class="<?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_mon_fri']==0) echo 'hidden'; else echo ''; } else echo 'hidden'; ?>" id="day_1">
											<div class="thr_clmn  wi_25  padl30  xxs-padl40 "> 
											<div class="pos_rel">
												
												<select name="parking_hrs_mon_fri_open" id="parking_hrs_mon_fri_open"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl   nobrdb fsz16  minhei_55p  trans_bg   black_txt tall padl0 ffamily_avenir" style="text-align-last:right;"> 
												<?php 
												foreach($workingHrs as $category => $value) 
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_mon_fri_open']==$value['work_time']) echo 'selected'; } ?> ><?php echo $value['work_time']; ?></option> 
												<?php } ?>
											...
											<div class="pos_rel">
												...
												<select name="parking_hrs_mon_fri_close" id="parking_hrs_mon_fri_close"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl nobrdb   fsz16  minhei_55p  trans_bg  black_txt tall padl0 ffamily_avenir" style="text-align-last:right;"> 
											<?php 
												foreach($workingHrs as $category => $value) 
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_mon_fri_close']==$value['work_time']) echo 'selected'; } ?>><?php echo $value['work_time']; ?></option> 
												<?php } ?>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt13 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_sat_sun']==1) echo 'checked'; else echo ''; } ?> " onclick="updateDayopen(2,this);">
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
											</div>
											<div class="<?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_sat_sun']==0) echo 'hidden'; else echo ''; } else echo 'hidden'; ?>" id="day_2">
											<div class="thr_clmn  wi_25  padl30  xxs-padl40 "> 
											<div class="pos_rel">
												
												<select name="parking_hrs_sat_sun_open" id="parking_hrs_sat_sun_open"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl   nobrdb fsz16  minhei_55p  trans_bg  black_txt tall padl0 ffamily_avenir" style="text-align-last:right;"> 
											<?php 
												foreach($workingHrs as $category => $value) 
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_sat_sun_open']==$value['work_time']) echo 'selected'; } ?>><?php echo $value['work_time']; ?></option> 
												<?php } ?>
											...
											<div class="pos_rel">
												...
												<select name="parking_hrs_sat_sun_close" id="parking_hrs_sat_sun_close"  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl nobrdb   fsz16  minhei_55p  trans_bg  black_txt tall padl0 ffamily_avenir" style="text-align-last:right;"> 
											<?php 
												foreach($workingHrs as $category => $value) 
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_sat_sun_close']==$value['work_time']) echo 'selected'; } ?>><?php echo $value['work_time']; ?></option> 
												<?php } ?>
								 	...
								 	<input type="hidden" id="day1" name="day1" value='<?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_mon_fri']==1) echo '1'; else echo '0'; } else echo '0'; ?>' />
										 <input type="hidden" id="day2" name="day2" value='<?php if(!empty($selectedParkingInfo)){if($selectedParkingInfo['parking_hrs_sat_sun']==1) echo '1'; else echo '0'; } else echo '0'; ?>' />
										</div>
										</form>
