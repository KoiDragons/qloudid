...
<script>
   ...
   function updatebuilding(id1,id)
   {
	   ...
	   if($("#"+id).hasClass('lgtgrey_bg'))
	   {
		   ...
		   $('#'+id).removeClass('lgtgrey_bg');
			$('#'+id).addClass('green_bg_00ff9996');		
			var send_data={};
			send_data.id=id;
				 
				 $.ajax({
							type:"POST",
							url:"../../addBuildingtoSociety/<?php echo $data['sid']; ?>",
							data:send_data,
							dataType:"text",
	   ...
	   {
		   $('#'+id).removeClass('green_bg_00ff9996');
			...
			send_data.id=id;
				 ...
				 $.ajax({
							type:"POST",
							url:"../../removeBuildingFromSociety/<?php echo $data['sid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Add your building to community" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										foreach($buildingsSocietyList as $category => $value) 
											...
											<a href="javascript:void(0);" onclick="updatebuilding(this,<?php echo $value['id']; ?>);">	<div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class="<?php if($value['selected']==1) echo 'green_bg_00ff9996'; else echo 'lgtgrey_bg'; ?>  bg_fffbcc_a " id="<?php echo $value['id']; ?>">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt"><?php echo $value['street_address'].','.$value['city'].','.$value['state']; ?></span>
													     </div>
