               ...
               <div class="flag_top_menu flefti  padb10 wi_80p  " style="padding: 10px 0px 0px 0px;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../../packagesItemList/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['pid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
                <div class="visible-xs visible-xsi visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu  fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="../../../../packagesItemList/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['pid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
								</li>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Add dish to the package menu</a></div>
								...
								<div class="marb0 padtrl0">		 
									 ...
									 <div class="on_clmn  marb5  xs-brdb brdb ">
								 
									<div class="thr_clmn  wi_75 ">
											 
										<div class="pos_rel talc">
									
										<input type="text" value="<?php if($packageCategoryInfo['serve_type']==1) echo 'Breakfast'; else if($packageCategoryInfo['serve_type']==2) echo 'Brunch'; else if($packageCategoryInfo['serve_type']==3) echo 'Lunch'; else if($packageCategoryInfo['serve_type']==4) echo 'Dinner'; else if($packageCategoryInfo['serve_type']==5) echo 'Beverage'; ?>" class="wi_100 rbrdr pad10  padl0 nobold padb0 tall  minhei_55p fsz18 black_txt ffamily_avenir" readonly="">
										 ...
										 <?php $i=1; foreach($packageCategoryItemList as $category => $value2) 
														{
										...
										<a href="javascript:void(0);" onclick="updateAvailable(<?php echo $value2['id']; ?>);">
												...
												<div class=" lgtgrey_bg  bg_fffbcc_a " id="<?php echo $value2['id']; ?>">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php   echo $packageCategoryInfo['food_category']; ?> </span>
						...
						<form action="../../../../updateFoodCategoryPackageMenu/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['pcid']; ?>" method="POST" id="save_indexing" name="save_indexing" >				 
									 
							<input type="hidden" id="available_dishes" name="available_dishes" value="" />
							</form>
							 <div class="clear">
