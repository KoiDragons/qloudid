...
<html>
	...
	<head>
      ...
      <div class="clear" id=""></div>
							  ...
							  <li class="dblock padrb10 ">
                                 <a href="../childInformation/<?php echo $data['child_id']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex xxs-dfex alit_fe justc_sb  pos_rel padb10 ">
                                <div class="white_bg tall xs-talc">
                                    ...
                                    <div class="marb0 xs-talc"> <a href="#" class="blacka1_txt fsz16  xs-fsz20  talc edit-text jain_drop_company ffamily_avenir">Here is a list of parents and your connection to them</a></div>
                                    <a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
                                        <!-- Meta -->

                                    </a>
                                </div>
								<div class="hidden-xs hidden-sm padrl10 <?php if($childrenDetail['dependent_id']!=null) echo 'hidden'; ?>">
									<a href="../parentDetail/<?php echo $data['child_id']; ?>" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt " >
										
										<span class="valm ffamily_avenir"> Lägg till föräldrar </span>
									</a> 
						 ...
						 <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
                                <div class="container ">
                                        ...
                                        <div class="tab-header mart10 padb10 xs-talc brdb_blue1">
                                            <a href="../parentRelativeDetail/<?php echo $data['child_id']; ?>" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 blue_67cff7_brd_a t_67cff7_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir"  >Anslutna</a>
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 blue_67cff7_brd_a t_67cff7_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir active" data-id="utab_Analytics">Skickade</a>
                                            <a href="../parentRejectDetail/<?php echo $data['child_id']; ?>" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 blue_67cff7_brd_a t_67cff7_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Avböjda</a>
												 ...
												 <div class="tab_container mart10">
													...
													foreach($parentsRequestDetail as $category => $value) 
													{
											...
											<div class="wi_100 xs-wi_100 xs-order_3   fsz12 ffamily_avenir">
																			<div class="fleft wi_30 xs-wi_60 sm-wi_100 marl15 xxs-marl15 "> <span class="trn fsz14 ffamily_avenir" data-trn-key="Drop in & Pick up"> Drop in & Pick up</span> <span class=" edit-text jain1 dblock  brdclr_lgtgrey2 fsz18 black_txt "><?php echo $value['parent_email']; ?></span> </div>
																			<div class="fleft wi_30 xs-wi_100 sm-wi_100 marl15 xs-mar0  hidden"> <span class="trn fsz16" data-trn-key="Phone number">Phone number</span> <span class=" edit-text jain1 dblock  brdclr_lgtgrey2 fsz18"><?php echo html_entity_decode($value['parent_phone']); ?></span> </div>
