...
<h2 class="browse__title h2 changedText xs-fsz60 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" >A match</h2>
<div class="browse__info info changedText">We have found <?php echo $result['first_name'].' '.$result['last_name']; ?></div>


	<div class="padtb20 mart35 xxs-talc talc">
								
								<a href="#" ><button type="button" onclick="submitForm();" class="padrl20 forword hei_55p fsz18 trn t_67cff7_bg  ffamily_avenir">Send booking</button></a>
								
							</div>
</div>
  <form action="../../../sendReservationDeail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
...
<div class="checkout__section">
 <a class="card hidden" href="#" style="background:transparent;">
                    <div class="card__preview"><img srcset="../../../../../../html/usercontent/images/bg/matchFound.png" src="../../../../../../html/usercontent/images/bg/matchFound.png" alt="Entire serviced classy moutain house">
                      <div class="category card__category changedText hidden">Sold</div>
                    </div>
                    </a>
					
					 <div class="travel__slider js-slider-travel">
                    <div class="travel__gallery">
                      <div class="travel__bg"><img srcSet="../../../../../../html/usercontent/images/bg/matchFound.png" src="../../../../../../html/usercontent/images/bg/matchFound.png" alt="Travel"></div>
