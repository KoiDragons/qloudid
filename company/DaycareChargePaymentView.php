...
<a class="header__logo xs-fsz25 changedText" href="../../../Brand/brandAccount/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Fill in below details to complete the payment</div>
...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Select workplace</h2> 
                  </div>
 <form class=" " action="../../../chargeCard/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>/<?php echo $data['plan_id']; ?>" method="POST"  >
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
                        ...
                        <div class="field">
						  ...
						  <div id="errorMsg1" class="fsz20 red_txt padtb20 tall mart20"></div>
