...
<li> As soon as access tokan is received on qmatchup side they need to send the same to https://www.qloudid.com/walk/resource_signin.php?signin=1 using curl request</li>
