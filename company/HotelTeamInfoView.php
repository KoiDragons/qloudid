	...
	<head>
		...
		<script>
			function submitform()
			{
				...
				{
				$("#errorMsg").html('please enter team name');	
				return false;
				}
				
				if($("#emp_info").val()=="" || $("#emp_info").val()==null)
				{
				$("#errorMsg").html('please select atleast one employee for the team');	
				return false;
				}
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.qloudid.com/company/index.php/HotelStay/roomsList/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  >Stay</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Please provide team info</a></div>
						...
						<div class="padb0 xxs-padb0">
							...
							<div class="marrla xs-wi_100">
								...
								<form action="../../addTeam/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" name="save_indexing" id="save_indexing" method="POST" >
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn padb10">
											...
											<div class="pos_rel">
													<input type="text" name="team_name" id="team_name" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl10 hei_50p fsz18 llgrey_txt" placeholder="Team name ">
									...
									<input type="hidden" name="emp_info" id="emp_info" value="" />
									
								<?php $i=0;
												
												foreach($hotelEmployees as $category => $value) 
												{
													
													
												?> 

											<a href="javacript:void();" onclick="selectEmployee(<?php echo $value['id']; ?>);">
											<div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg brdb bg_fffbcc_a " id="<?php echo $value['id']; ?>">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz14 xs-padt0 black_txt">Employee name</span>
											...
											<div class="clear"></div>
												...
												<?php } ?>
												<div class="clear"></div>
												<div id="errorMsg" class="mart35 red_txt fsz18"></div>	
									</div>
