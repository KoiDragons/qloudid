...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select and assign a broker to manage and market this property.</div>
...
<div class="upload__head hidden">
                  <h2 class="upload__title h2 white_txt changedText" style="font-size:32px;">Assign task</h2>
                </div>
 <form action="../../../updateTaskAssignment/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="UTF-8">
						  ...
						  <div class="field  margin-bottom24" >
                            ...
                            <div class="field__wrap">
                               <select class="xs-fieldData" id="responsible_for_property" name="responsible_for_property" style="height: 48px;
