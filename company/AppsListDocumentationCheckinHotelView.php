				...
				<div class="wrap maxwi_100 xs-padrl15 ">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
							 			...
							 			<li class="dblock padrb10 ">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10    brdb_black black_txt  padb10"> <span class="valm trn ltr_space" >Checkin hotel</span> 
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $appsDetailSelected['api_interface_url']; ?>  </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">Checkin hotel</span>  </div>
...
<li>Here he can select which API URL he wants to generate. App name here must be unique i.e. not used by other user or company. Redirect URL is the one where developer wants to redirect after checkin hotel that he have selected will be completed.</li>
<li>After submitting the data a new Client id and password will be generated for developer and a tiny URL will be provided to him that he can use on their domain to checkin hotel with Qloudid.</li>
<li>When a user want to checkin hotel on their web using Qloud ID they click on instant checkin button. Here user need to provide the API generated for the checkin he want to work on</li>
<li>https://www.safeqloud.com/user/index.php/LoginAccount/checkinHotel/"Booking ID on Qloudid"?response_type=code&client_id="ClientID"&state=xyz&checkin=1</li>
...
<li>User need to scan the QR code by api on this page and provide his consent for the checkin hotel</li>
 
<li>After successful submission of consent user is redirected to checkin page</li>
 
<li>On dstricts for now we are redirecting on : http://www.dstricts.com/public/index.php/Hotel/thanksCheckin </li>
...
<li> As soon as access tokan is received on qmatchup side they need to send the same to https://www.safeqloud.com/walk/resource_hotel_checkin.php?hotel=1 using curl request</li>
...
{"qloud_checkout_id":"0","user_id":1}</li>
  
<li>Qloud ID checkout id is used to check on dstricts side that user have to be checkin to exact same hotel that he had tried to. And user id is used for making user logged in so he can continue using his profile on hotel booking and checkin site  </li>
