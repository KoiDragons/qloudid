<!doctype html>
		...
		<div class="column_m header   bs_bb   hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10  header_blue_67cff738">
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../amenitiesLogInfo/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left header_arrow_blue_1e96c3" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
			<div class="fright   padtbz10   "  >
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="../../roomDetailInformation/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 white_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../amenitiesLogInfo/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
	...
	<div class="clear"></div>
		...
		<div class="column_m pos_rel">
		  ...
		  <div class="column_m container zi5  mart40 xs-mart0"  >
                <div class="wrap maxwi_100   md-padrl0 lg-padrl0  ">
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<li class="dblock padrb10   last first">
						<a href="../../bookingListForRoomAllocation/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Today's booking</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li> 
											
						<li class="dblock padrb10   last first">
						<a href="../../instaBoxes/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Instaboxes</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li> 
												<li class="dblock padrb10   last first">
						...
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
							...
							<?php if($hotelDetailInfo['room_service']==1) { ?>				 
						<li class="dblock padrb10  padt5">
						<a href="../../../HotelResturantSearch/searchResturant/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Room service </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>
							<?php } ?>	
							
									<?php if($hotelDetailInfo['dry_cleaning']==1) { ?>				 
						<li class="dblock padrb10  padt5">
						<a href="../../../HotelDryCleaningSearch/searchLaundary/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Laundry service </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>
							<?php } ?>	
						<li class="dblock padrb10  padt5">
						<a href="../../../HotelWellnessSearch/searchWellness/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn" style="letter-spacing: 2px;">Wellness service </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
						</a></li>							
								<li class="dblock padrb10  padt5">
	...
	<div class="wi_auto  hei_350p xs-hei_280p maxwi_100   pos_rel zi5 marrla padt100  xs-padt80   brdrad5  ">
			...
			<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="txt_0b5673 fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">A list of all rooms type at this hotel</a></div>
									</div>
	...
	<div class="column_m   talc lgn_hight_22 fsz16 bg_ffde00  ">
                        <div class="wrap maxwi_100 xs-padr25 xs-padl10   bg_ffde00    tall  ">
                           <div class="wi_auto  hei_65p maxwi_100   pos_rel zi5 marrla    brdrad5  padrl30">
                              <div class="martb15  xxs-talc talc ffamily_avenir"> <a href="../../roomTypeInformation/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="black_txt fsz18 xs-fsz16  xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">+Add room type</a></div>
                           </div>
                        </div>
                     </div>
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_50p marr15  "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz25   brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	background-position: 50%;
																	border-radius: 10%;"><?php echo substr($value['room_type_name'],0,1); ?> </div>
																	</div>
													
													<div class="fleft wi_60   xs-mar0  ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php  echo $value['room_type_name']; ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php echo $value['room_type']." - ";   if($value['is_available']==1) echo 'Available'; else echo 'Unavailable'; ?></span>  </div>
													 
													  
													<a href="../../editRoomTypeInformation/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $value['enc']; ?>">  <div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 hidden-xs">
														  <span class="fas fa-edit txt_cfdbea" aria-hidden="true"></span> 
													</div></a>
													  
													 <a href="../../roomsList/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $value['enc']; ?>">  <div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 hidden-xs">
