...
<html lang="en">
 ...
 <body class="dark" style="background: #131922;" id="bodyData">
<script>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Mission</div>
                                      </a>
									  <a class="categories__item  bg_E7E7E7 " href="../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Property</div>
                                      </a>
  ...
  <script>
						...
						<div class="footer__theme mart30 padb20 uppercase" style="display:block; border-bottom:1px solid #353945; color:white;" >
                DO YOU WANT TO RENT OUT<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateRent(this);' <?php if($fetchPropertiesPricing['rent_info']==1) echo 'checked'; ?>><span class="theme__inner"><span class="theme__box"></span></span>
						  ...
						  <div class="checkout__row margin-bottom32 mart30">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Checkin time</div>
                            <div class="field__wrap">
                              <input class="field__input" type="time" name="arrival_time" id="arrival_time"  style="background:#23262F; color:grey;" fdprocessedid="0myzvs" value="<?php echo $fetchPropertiesPricing['arrival_time']; ?>">
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="time" name="departure_time" id="departure_time" style="background:#23262F; color:grey;" fdprocessedid="p0tyog" value="<?php echo $fetchPropertiesPricing['departure_time']; ?>">
                            </div>
                          </div>
						  </div>
                            ...
                            <div class="field__wrap">
                               <select class="" id="pets_info_detail" name="pets_info_detail" style="height: 48px;
								...
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;"  fdprocessedid="zc7mun">
                        ...
                        <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="price_per_night" id="price_per_night" style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" min=0 value="<?php echo $fetchPropertiesPricing['owner_price_per_night']; ?>">
                            </div>
                          </div>
						   ...
						   <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="deposit_fee" id="deposit_fee" style="background:#23262F; color:grey;" fdprocessedid="tqjibs" min=0 value="<?php echo $fetchPropertiesPricing['owner_deposit_fee']; ?>">
                            </div>
                          </div>
						   ...
						   <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="cleaning_fee" id="cleaning_fee" style="background:#23262F; color:grey;" fdprocessedid="tqjibs" min=0 value="<?php echo $fetchPropertiesPricing['owner_cleaning_fee']; ?>">
                            </div>
                          </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="seller_price_per_night" id="seller_price_per_night" style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" min=0 value="<?php echo $fetchPropertiesPricing['seller_price_per_night']; ?>">
                            </div>
                          </div>
						   ...
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Deposit fee</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="seller_deposit_fee" id="seller_deposit_fee" style="background:#23262F; color:grey;" fdprocessedid="tqjibs" min=0 value="<?php echo $fetchPropertiesPricing['seller_deposit_fee']; ?>">
                            </div>
                          </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="seller_cleaning_fee" id="seller_cleaning_fee" style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" min=0 value="<?php echo $fetchPropertiesPricing['seller_cleaning_fee']; ?>">
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="late_arrival_fee" id="late_arrival_fee" style="background:#23262F; color:grey;" fdprocessedid="tqjibs" min=0 value="<?php echo $fetchPropertiesPricing['late_arrival_fee']; ?>">
                            </div>
                          </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="seller_security_fee" id="seller_security_fee" style="background:#23262F; color:grey;" fdprocessedid="fu8qmc" min=0 value="<?php echo $fetchPropertiesPricing['seller_security_fee']; ?>">
                            </div>
                          </div>
						   ...
						   <div class="field" >
                            ...
                            <div class="field__wrap">
                               <select class="" id="tourist_tax" name="tourist_tax" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: #23262F; width:100%;" onchange="updateSell(this.value);" fdprocessedid="zc7mun">
								 <?php for($i=0;$i<=20;$i++) { ?>	
						  ...
						  <div class="field mart30 <?php if($fetchPropertiesPricing['parking_info_detail']==0) echo 'hidden'; ?>" id="parkingInfo">
                            <div class="field__label  changedText" style="color:#787f91;">How much do you charge for parking.</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" id="parking_fee" name="parking_fee" min=0 style="background:#23262F; color:grey;" fdprocessedid="vmdbg5" min=0 value="<?php echo $fetchPropertiesPricing['parking_fee']; ?>">
                            </div>
                          </div>
	  ...
	  <input type="hidden" id="sell_info" name="sell_info" value="<?php echo $fetchPropertiesPricing['sell_info']; ?>"/>
						<div class="footer__theme mart45 padb20 uppercase" style="display:block; border-bottom:1px solid #353945; color:white;" >
                Do you want to sell<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateSell(this);' <?php if($fetchPropertiesPricing['sell_info']==1) echo 'checked'; ?>><span class="theme__inner"><span class="theme__box"></span></span>
						...
						<div class="field mart30 <?php if($fetchPropertiesPricing['sell_info']==0) echo 'hidden'; ?>" id="sellInfo">
                            <div class="field__label  changedText" style="color:#787f91;">Selling price</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" id="selling_price" name="selling_price" min=0 style="background:#23262F; color:grey;" fdprocessedid="vmdbg5" value="<?php echo $fetchPropertiesPricing['selling_price']; ?>">
                            </div>
                          </div>
	  ...
	  <input type="hidden" id="manage_info" name="manage_info" value="<?php echo $fetchPropertiesPricing['manage_info']; ?>"/>
                ...
                Do you want to manage<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateManage(this);' <?php if($fetchPropertiesPricing['manage_info']==1) echo 'checked'; ?>><span class="theme__inner"><span class="theme__box"></span></span>
						...
						<div class="red_txt fsz20 talc padt20 mart45" id="errorMsg1"> </div>
						
						
						<a class="button checkout__button changedText" href="javascript:void(0);" onclick="submitForm();" style="background: #3B71FE;">Submit</a>
</div>
...
<script src="<?php echo $path; ?>/html/fleet/js/app1.js"></script>
<!-- svg sprite-->
