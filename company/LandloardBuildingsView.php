	 ...
	 <div class="column_m header   bs_bb lgtgrey2_bg hidden-xs">
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg">
			...
			<div class="fright   padtbz10   "  >
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="../../Community/listSociety/<?php echo $data['cid']; ?>" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
									
									<span class="valm ffamily_avenir">Society<i class="fas fa-long-arrow-alt-right fsz18 padl10" aria-hidden="true"></i></span>
								</a>
							</div>
			 ...
			 <div class="visible-xs visible-sm fright marr0 ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
					...
					<li class="last first marr10i">
						<a href="../../Community/listSociety/<?php echo $data['cid']; ?>" class="lgn_hight_s1 fsz25"><span class="fa fa-bars black_txt" aria-hidden="true"></span></a>
					 </li>
				</ul>
			</div>
				</div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir"  >Buildings</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Your buildings detail</a></div>
					 
					 
						<div class="tab-header martb0 padb30 xs-talc  nobrd talc">
                                            
                                              <a href="../buildingInformation/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10     bg_98cf44 brdrad50  lgn_hight_60 fsz60  white_txt white_txt_ah ffamily_avenir" onclick="changeHeader();">+</a>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Building detail" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
					 		...
					 		<?php $i=0;
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_50p marr15 hidden-xs "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz25   brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	...
																	border-radius: 10%;"><?php echo substr($value['building_name'],0,1); ?> </div>
																	</div>
													
													<div class="fleft wi_60  xs-mar0 ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $value['building_name']; ?>  </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt">Block - <?php echo $value['block_number']; ?></span>  </div>
													 
													<a href="../editBuildingInfo/<?php echo $data['cid']; ?>/<?php echo  $value['enc']; ?>"><div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 ">
														  <span class="fas fa-edit txt_cfdbea" aria-hidden="true"></span> 
													</div></a>
													<a href="../buildingAddinsInfo/<?php echo $data['cid']; ?>/<?php echo  $value['enc']; ?>"><div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 ">
									...
									<div class="padtb20 mart20 talc <?php if($buildingsCount['num']<=10) echo 'hidden'; ?>">
								...
								<script>
									function add_more_rows(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreBuildingDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
