               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../../buildingAmenityAddInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['aid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 white_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../buildingAmenityAddInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['aid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
					...
					<div class="padb20 xxs-padb0 ">		
					 ...
					 <div class="on_clmn marb5">
									  ...
									  <div data-testid="description-page">
										 <div class="css-zp5g9l marrl0">
											...
											<div data-testid="description-textarea-wrapper" class="css-16i74gt">
												<textarea id="description-textarea" data-testid="description-textarea" name="description" minlength="400" maxlength="9000" class="css-13k0qhz" onkeyup="updateDescription();"><?php echo $selectedAmenitiesInfo['amenity_description']; ?></textarea></div>
											<div id="spacer" spacing="smaller" class="css-ihl6nu"></div>
								...
								<div class="clear"></div>
									...
									<div class="clear"></div>
									 <form action="../../../updateAmenityHrs/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									...
									<div class="thr_clmn  wi_50">
										...
										<input type="text" value="Open during" class="wi_100 rbrdr pad10    tall  minhei_55p padl0 padr5 fsz18 black_txt ffamily_avenir hidden-xs" readonly="">
											...
											<div class="pos_rel">
												...
												{
												?> 
											<option value="<?php echo $n; ?>" <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_open_month']==$n) echo 'selected'; } ?> ><?php echo  date("F", mktime(0, 0, 0, $n, 10)); ?></option> 
												<?php } ?>
											...
											<div class="pos_rel">
												...
												{
												?> 
											<option value="<?php echo $n; ?>" <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_close_month']==$n) echo 'selected'; } ?> ><?php echo  date("F", mktime(0, 0, 0, $n, 10)); ?></option> 
												<?php } ?>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt13 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_mon_fri']==1) echo 'checked'; else echo ''; } ?> " onclick="updateDayopen(1,this);">
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
											</div>
											<div class="<?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_mon_fri']==0) echo 'hidden'; else echo ''; } else echo 'hidden'; ?>" id="day_1">
											<div class="thr_clmn  wi_25  padl30  xxs-padl40 "> 
											<div class="pos_rel">
												...
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_mon_fri_open']==$value['work_time']) echo 'selected'; } ?> ><?php echo $value['work_time']; ?></option> 
												<?php } ?>
											...
											<?php 
												...
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_mon_fri_close']==$value['work_time']) echo 'selected'; } ?>><?php echo $value['work_time']; ?></option> 
												<?php } ?>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt13 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_sat_sun']==1) echo 'checked'; else echo ''; } ?> " onclick="updateDayopen(2,this);">
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
											</div>
											<div class="<?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_sat_sun']==0) echo 'hidden'; else echo ''; } else echo 'hidden'; ?>" id="day_2">
											<div class="thr_clmn  wi_25  padl30  xxs-padl40 "> 
											<div class="pos_rel">
											...
											<?php 
												...
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_sat_sun_open']==$value['work_time']) echo 'selected'; } ?>><?php echo $value['work_time']; ?></option> 
												<?php } ?>
											...
											<?php 
												...
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>" <?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_sat_sun_close']==$value['work_time']) echo 'selected'; } ?>><?php echo $value['work_time']; ?></option> 
												<?php } ?>
								 	...
								 	<input type="hidden" id="day1" name="day1" value='<?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_mon_fri']==1) echo '1'; else echo '0'; } else echo '0'; ?>' />
										 <input type="hidden" id="day2" name="day2" value='<?php if(!empty($selectedAmenitiesInfo)){if($selectedAmenitiesInfo['amenity_hrs_sat_sun']==1) echo '1'; else echo '0'; } else echo '0'; ?>' />
										</div>
										</form>
