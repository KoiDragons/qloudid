...
<div class="sorting__foot">
                <div class="nav"><a class="nav__link changedText active" href="#" >Invited</a> <a class="nav__link changedText " href="#"  onclick="changeHeader(1);">Registered</a> <a class="nav__link changedText" href="#"  onclick="changeHeader(2);">Connected</a> </div>
...
box-shadow:none;">
               <div class="travels__list"  >
										  ...
										  <?php $i=1; 
								foreach($invitedEmployeeRequestDetail as $category => $value) 
										{
                                  ...
                                  <div class="travels__body">
                                    <div class="travels__line"  style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: black;"><?php echo  substr($value['employee_email'],0,20); ?></div>
                                        <div class="travels__location" style="color: black;">Not verified</div>
                                      </div>
                                  
                        <a class="header__logo  changedText fright Button10161d hidden" href="javascript:void(0);" style="
