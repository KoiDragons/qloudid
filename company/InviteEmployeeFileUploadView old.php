				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45 padb10 black_txt trn ffamily_avenir"  >Invite</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Please upload csv file to invite employees </a></div>
							...
							<!-- Leave for security protection, read docs for details -->
								<div class="on_clmn mart10 xxs-mart10 marb35">
										...
										<div class="pos_rel">
										<input type="file" name="email_file"  placeholder="Social security number " id="email_file"  class="wi_100 default_view  rbrdr pad10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5  ffamily_avenir">
									</div>
