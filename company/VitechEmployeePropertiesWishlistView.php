...
<a class="header__logo xs-fsz25 changedText" href="../listEmployeesRentProperties/<?php echo $data['cid']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="../listEmployeesRentProperties/<?php echo $data['cid']; ?>">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg><span>Go home</span></a>
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Wishlist</a></li>
...
">
 ...
 <div class="section destinations xs-padrl25  hidden-xxs" style="margin-bottom:40px;">
...
box-shadow:none;">
			   ...
			   <div class="travels__card  bg10161d " id="p<?php echo $value['id']; ?>">
                                  <div class="travels__preview"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="Card">
   ...
   " onclick="selectWishlist(<?php echo $value['id']; ?>);">Select</a>
                                    ...
                                    <div class="travels__line">
                                      <div class="travels__date"><?php echo date('M d, Y',$value['checkin_date']); ?> to <?php echo date('M d, Y',$value['checkout_date']); ?>,<?php echo ($value['adult_guest']+$value['adult_child']); ?> guests </div>
                ...
                <form class="checkout__item js-tabs-item talc" action="../teamVailable/<?php echo $data['cid']; ?>" method="POST" id="save_indexing_proposal" name="save_indexing_proposal" accept-charset="ISO-8859-1" style="display: block;">		
									...
									<input type="hidden" id="proposal_type"	name="proposal_type" value="2" />
