<html lang="en" style="--vh: 8.02px;"><head>
<meta charset="utf-8">
...
">
<div class="header__center center"><a class="header__logo xs-fsz20 " href="https://dstricts.com/public/index.php/VisitorSelectSearch/selectYourRole/<?php echo $data['id']; ?>" style="
...
<div class="price__preview "><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=verify_checkin/2/<?php echo $data['id']; ?>" class="" style="width: 150px;height: 150px;"></div>
</div>

</div>
<div class="receipt__foot">
<div class="receipt__free" style="margin-bottom: 5px;font-size: 25px;color: black;">Scan QR code</div>
				
				
				
</div><div class="receipt__foot">
<div class="receipt__free" style="font-size: 15px;color: grey;"> Start Worq-app on your phone. Click on Scan icon on the app and then scan the QR code on this page.
</div>
...
<p class="fsz35 lgn_hight_45 fsz35 xs-lgn_hight_25 xs-fsz20 xs-talc" style="
    font-size: 18px;
    line-height: 24px;
">You can download worq app for free on Appstore or Android marketplace</p>
