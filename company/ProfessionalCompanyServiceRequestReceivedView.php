				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir">Request</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Here is the list of service request received</a></div>
						...
						<div class="on_clmn brdb marb5">
								...
								foreach($serviceRequestReceived as $category => $value) 
								 ...
								 <div class="column_m container  marb5  mart5 fsz14 dark_grey_txt brd">
												<div class=" <?php if($value['is_accepted']==0) { echo 'lgtgrey_bg'; } else if($value['is_accepted']==1) { echo 'green_bg_00ff9996'; } else { echo 'red_bg_FB757C'; } ?>  bg_fffbcc_a ">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $value['subcategory_name']; ?></span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Area - <?php echo $value['floor_area']; ?> m2</span> 
													<span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">City - <?php echo $value['city']; ?></span>
													 </div>
													 <?php if($value['is_accepted']==0) { ?>
													<div class="xxxs-wi_25 fleft wi_25  marr30 xs-mar0 ">
													
													<a href="../projectPriceInfo/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" class="xs-padr20">  
