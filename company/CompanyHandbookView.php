	...
	<body>
		...
		<div id="section-content" onclick="checkFlag();">
			<div class="wrap maxwi_100 dflex fxwrap_w md-fxwrap_nw alit_fs justc_sb mart40" >
										...
										<li class="dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a ">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey   greyblue_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Handbok</span>
				...
				<!-- CENTER CONTENT -->
				<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5  xs-white_bg sm-white_bg padl10 xsi-padrl15">
					<div class=" maxwi_100 dflex alit_fe justc_sb  pos_rel marb20 brdb_new  ">
				<div class="column_m pos_rel">
								...
								<div class="hidden-xs hidden-sm padrl10">
											 <a href="#"><span class="fas fa-cog fsz22 padl10 lgn_hight_29 valm" aria-hidden="true"></span></a>
										</div>
											...
											<div>
												...
												<div class="dflex xs-dblock fxwrap_w padb0 xs-padt0 xs-padb0">
													...
													<div class="wi_100 xs-wi_100 padtb0  padr20 txt_708198">
														<h2 class="bold marb10 pad0 tall xs-talc fntwei_300 fsz55 sm-fsz32 md-fsz36 lg-fsz40 black_txt xs-fsz30">Personalhandbok<div class="wi_50p maxwi_100 xs-wi_100 hei_4p mart5 xs-marrla black_bg"></div>
														</h2>
					...
					<div class="white_bg fsz14 dark_grey_txt">
						<div class="container  xs-padrl15">
							...
							<div class="sticky_spacer">
								<div class="sticky zi100 padtb5 brdb_new lgtgrey2_bg xs-maxwi_400p"  data-offset="40" >
									<select class="jui-select selectmenu-scroll-to selectmenu-scroll-detect" data-button-classes="wi_autoi maxwi_100i pad0 nobrdi bg_transi fsz25 xs-fsz28 txt_2d3e52i " data-icon-classes="pos_abs pos_cenY right0" data-offset="60">
