...
function goBack()
{
	 document.getElementById('save_indexingback').submit();
}
...
<div class="outer">
<!-- header-->
<form action="../<?php if($_POST['searched_from']==1) echo 'searchRentProperties';  else if($_POST['searched_from']==2) echo 'listEmployeesRentBrokerShare'; else if($_POST['searched_from']==3) echo 'listEmployeesRentClientShare'; ?>/<?php echo $data['cid']; ?>" method="POST" name="save_indexingback" id="save_indexingback" accept-charset="ISO-8859-1">	
			<input   type="hidden" name="rz_booking_dates[]" id="rz_booking_dates[]" value='<?php  echo date('Y-m-d',strtotime($_POST['checkin_date']));  ?>' placeholder="Check in" readonly="readonly">
			<input   type="hidden" name="rz_booking_dates[]" id="rz_booking_dates[]" value='<?php  echo date('Y-m-d',strtotime($_POST['checkout_date']));  ?>' placeholder="Check in" readonly="readonly">
		  
		 
		  <input   type="hidden" name="guest_adults" id="guest_adults" value='<?php   echo $_POST['guest_adults']; ?>' placeholder="Check in" readonly="readonly">
		 
		  <input   type="hidden" name="guest_children" id="guest_children" value='<?php  echo $_POST['guest_children']; ?>' placeholder="Check in" readonly="readonly">
		 <input   type="hidden" name="city" id="city" value='<?php  echo $_POST['city1']; ?>' placeholder="Check in" readonly="readonly">
			</form>	
...
<a class="header__logo xs-fsz25 changedText" href="javascript:void(0);" onclick="goBack();" style="
...
<div class="travel__center center   padb136 xs-padrl25" style="/*border-bottom:2px solid #23262F;*/  max-width: 1132px;
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list xs-marb0 marb250" style="
            max-width: 425px;
            ">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Complete the form below to add reservation for guest
</div>
...
<form class="checkout__item js-tabs-item" action="../guestInformationVerification/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['owner_property_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
  
  
						
						
						<div class="upload__item mart40" id="homeOwner">
						 <div class="checkout__line  "  style="margin-bottom:24px;">
					   <div class="receipt__stage changedText">Reservation details</div>
                        ...
                        <div class="field">
						   ...
						   <div class="checkout__row  " style="margin-bottom:24px;">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Payment information</div>
                            <div class="field__wrap">
                               <select class=" xs-fieldData"   id="is_paid" name="is_paid"   style="height: 48px;
							padding: 0 14px;  border-color: #353945;
							color: grey; border-radius: 12px;
							  background: transparent; width:100%;">
							<option value="1" class="lgtgrey2_bg">Paid-cash</option>
											<option value="2" class="lgtgrey2_bg">Paid-Other plateform</option>
											<option value="3" class="lgtgrey2_bg">Not paid</option>		
								  </select>
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Price per night</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number" name="room_price" id="room_price"  placeholder="e. g. 100" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
					...
					<div class="upload__col upload__col_w30">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <select class=" xs-fieldData"   id="country_id" name="country_id"   style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
						  ...
						  <div class="upload__col upload__col_w70">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="uphno" id="uphno"  placeholder="e. g. xxxxx12342" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						  </div >
