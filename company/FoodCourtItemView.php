<!doctype html>
	...
	<head>
		...
		function checkHotel(id,id1)
		{
			...
			{
			window.location.href='https://www.safeqloud.com/company/index.php/FoodCourt/foodDetailInformation/<?php echo $data['cid']; ?>';
			}
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
					...
					<li class="last first marr10i">
						<a href="../foodDetailInformation/<?php echo $data['cid']; ?>" class="lgn_hight_s1 fsz25"><span class="fas fa-plus black_txt" aria-hidden="true"></span></a>
					 </li>
				</ul>
			</div>
</div> 
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space">Food</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
							<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Food</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc   xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >List of the food you are selling</a></div>
								...
								<?php $i=1;
												...
												<a href="../editFoodDishInformation/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"   > 	<div class="column_m container  marb5   fsz14 dark_grey_txt" >
									...
									<div class="clear"></div>
									 ...
									 <div  id="LocationDetailInfo">
										...
										$.ajax({
											type:"POST",
											url:"../moreDishesFoodDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
