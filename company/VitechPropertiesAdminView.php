         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Manage and update your secondary market properties</div>
...
">
   ...
   <div class="section destinations xs-padrl25  " style="margin-bottom:20px; border-bottom:1px solid #353945;">
          <div class="destinations__center center" style="padding-bottom:60px; max-width: 1132px;">
              </div>
        </div>
			 <div class="sorting__foot ">
                <div class="nav hidden-xs"><a class="nav__link active" href="#">For sale</a><a class="nav__link" href="#">Sold</a><a class="nav__link" href="#">Manage</a> <a class="nav__link" href="#">Rent</a></div>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px; min-width:200px;"><?php echo substr($value['streetAddress'],0,25).' '.$value['areaName']; ?></div>
				   <div class="description__parameters hidden-xs" style="border-top:none;   margin-bottom: 0px;    margin-top: 0px;    padding-bottom: 0px;  padding-top: 0px;">
                ...
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
					 ...
					 <a href="../viewPropertyServices/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;"  >
