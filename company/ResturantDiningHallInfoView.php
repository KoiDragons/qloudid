	...
	<head>
		...
		function addDiningHall()
		{
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../addDiningHall/<?php echo $data['rid']; ?> ",
							data:send_data,
							dataType:"text",
							...
							success: function(data1){
								 ...
								 $('#bedroom_info').html('');
								  ...
								  resturantDiningCount();
							}
						});	
		}
		
		function deleteDiningHallTableInfo(id)
		{
		 var send_data={};
				 send_data.id=id;
				 $.ajax({
							type:"POST",
							url:"../../deleteDiningHallTableInfo/<?php echo $data['rid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								...
								if(data1==0)
								{
								alert('you cant delete all tables from dining hall. you need to add atleast one table!!!');
								return false;	
								}
								 else
								 {
		...
		function resturantDiningCount()
		{
		 
				 $.ajax({
							type:"POST",
							url:"../../resturantDiningCount/<?php echo $data['rid']; ?> ",
							...
							success: function(data1){
								 ...
								 $('#bedRoomCount').html('');
								 $('#bedRoomCount').html(data1+' dinings');
		...
		function deleteDiningHall()
		{
		 var send_data={};
				 
				 $.ajax({
							type:"POST",
							url:"../../deleteDiningHall/<?php echo $data['rid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function addTableToHall(id)
		{
		 var send_data={};
			send_data.id=id;	 
				 $.ajax({
							type:"POST",
							url:"../../addTableToHall/<?php echo $data['rid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateTableTypeInfo(id,id1)
		{
		var send_data={};
				 send_data.bed_id=id;
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateTableTypeInfo/<?php echo $data['rid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateDiningHallName(id,id1)
		{
			if(id1==null || id1=="")
			{
				alert('Please enter a valid name/location for dining hall!!!');
				return false;
			}
			if(id1.length<5)
			{
				alert('Please enter minimum 5 charachter for name/location of dining hall!!!');
				return false;
			}
				var send_data={};
				 send_data.id=id;
				 send_data.hall_name=id1;
				 $.ajax({
							type:"POST",
							url:"../../updateDiningHallName/<?php echo $data['rid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../serveBookingInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 white_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../serveBookingInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space" >Table info</span> 
					...
					<!-- Center content -->
						...
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc tall  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Manage dining hall info</a></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Number of dining hall(s)</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">How many dining hall(s) does your resturant have?</span> 
													 </div>
										...
										<a href="javascript:void(0);" onclick="deleteDiningHall();"><button color="#444444" data-testid="icon-button--minus" class="merlin-button merlin-button--disabled css-ig30wo" aria-label="" disabled="">
										...
										<span class="value" id="bedRoomCount"><?php echo $resturantDiningCount; ?> dinings</span>
									<a href="javascript:void(0);" onclick="addDiningHall();">	
					...
					<div id="bedroom_info">
					<?php echo $resturantDiningDetail; ?>
					</div>
