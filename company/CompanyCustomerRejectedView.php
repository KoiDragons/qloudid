			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
                                            <a href="../receivedRequests/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10 brd_fcaf17_a t_fcaf17_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir" >Request</a>
                                            <a href="../companyAccount/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd brd_fcaf17_a t_fcaf17_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Active</a>
                                             <a href="../sentRequests/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd brd_fcaf17_a t_fcaf17_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Sent</a>
										...
										<div class="clear"></div>
														...
														<div class="padtb20 talc <?php if($rejectCount['num']<=5) echo 'hidden'; ?> ">
																<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width" onclick="add_more_rows_rejected(this);" value="1">View more</a>
										...
										function add_more_rows_rejected(link) {
											...
											<?php $i=0;
												...
												<div  id="rejectedParent">
										</div>	
										<div class="clear"></div>
														
														<div class="padtb20 talc <?php if($requestRejectedCountparent['num']<=5) echo 'hidden'; ?> ">
										...
										function add_more_rows_parent(link) {
															...
															$.ajax({
															type:"POST",
															url:"../moreRejectedDetailParent/<?php echo $data['cid']; ?>",
															data:send_data,
															dataType:"text",
															contentType: "application/x-www-form-urlencoded;charset=utf-8",
															success: function(data1){
															html1=data1;
															var $tbody = $("#rejectedParent"),
															html=html1;
															//alert(data1); 
															$tbody
															.append($(html))
