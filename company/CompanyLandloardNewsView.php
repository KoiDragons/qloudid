								...
								<div class="column_m padb10 hidden">
									...
									<ul class="marr20 pad0">
										...
										<li class=" dblock  padl8 <?php if($checkPermission==0) echo 'hidden'; else echo 'padb10'; ?>">
											<a href="../../CompanyProperty/locationAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a lgtgrey_bg">
												<span class="fa fa-address-card-o wi_20p dnone_pa"></span>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class="dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a ">
											<h4 class="padb5 uppercase ff-sans black_txt trn bold ">FÖR HYREGÄST...</h4>
											<ul class="marr20 pad0">
