					...
					success: function(data2){
						...
						if(data2!=2)
						{
							...
							else if(data2==4)
							{
								...
								$("#errorMsg").html("Please select profile to continue payment.");
								return false;
							}
...
<!-- header-->
	...
	<form action="../../../updatePaymentInfo/<?php echo $data['cid']; ?>/<?php echo $data['meeting_id']; ?>/<?php echo $data['invoice_id']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user" accept-charset="ISO-8859-1" autocomplete="off">
...
<div class="main__info info margin-bottom16 white_txt" id="errorMsg">Then type your security code for verification.</div>
</div>
</div>
</div>
</div>
<div class="section description mart100 xxs-mart40  xs-padb0" style="background: #ffffff;border-color: white;margin-top: 70px;" id="loginBank">
<div class="checkout__list marrla" style="
    max-width: 375px;
">
<div class="checkout__section hidden-xs">
<div class="checkout__box">
<div class="checkout__category" style="
    font-size: 30px;
">To pay</div>
...
<div class="checkout__section xsi-nobrdt padt32 xsi-padt45 nobrdt" style="margin-top: 0px;border-top: 1px solid white;padding-top: 10px;">
...
<option value="<?php echo $visitorsDetailServiceAppointmentDetail['price'];?>" class="lgtgrey2_bg"><?php echo $visitorsDetailServiceAppointmentDetail['price'];?></option>
...
<div class="header__center center" style="
    padding: 0 0px;
"><a class="header__logo xs-fsz20 " href="https://www.safeqloud.com/user/index.php/LoginAccount" style="
...
<div class="receipt__free" style="margin-bottom: 5px;font-size: 22px;color: black;">Scan With Qloud ID</div>
				
				
				
</div> 
 <div class="receipt__foot" style="
">
<div class="receipt__free" style="font-size: 15px;color: grey;margin-bottom: 20px;">If you dont have one then create an account for free.
</div>
				 
	<a href="../../../paymentCardInfo/<?php echo $data['cid']; ?>/<?php echo $data['meeting_id']; ?>/<?php echo $data['invoice_id']; ?>"><div class="receipt__free" style="font-size: 15px;color: grey;margin-bottom: 20px;">Pay manually
</div>			</a>
</div>
...
<div class="description__wrapper xs-pad0 padrt50 visible-xs marrla" style="
    /* max-width: 375px; */
">
...
<bugherd-sidebar></bugherd-sidebar>
