 ...
 else
 {
	 $('#inclusionInfo').removeClass('hidden');
		 ...
		 $.ajax({
				...
				$.ajax({
					type:"POST",
					url:"../countSelectedProfessionalCategoryAvailableLocation/<?php echo $data['cid'];?>",
					data:send_data,
					dataType:"text",
					contentType: "application/x-www-form-urlencoded;charset=utf-8",
					success: function(data1){
...
moreEventOnRequestExtraFee=1;
	...
	function updatePickapro()
	{
		pickaproListingInfo=1;
	}
	...
	function selectWarning(id)
	{
		...
		function submitform()
		{
			...
			if($("#category_id").val()==0)
			{
				...
				$("#errorMsg1").html('Please select professional category');
				return false;
			}	
			...
			if($("#subcategory_id").val()==0)
			{
				...
				$("#errorMsg1").html('Please select professional subcategory');
				return false;
			}
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						...
						<div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
									...
									<div class="thr_clmn  wi_75 ">
										...
										<input type="text" value="List on pickapro" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" readonly="">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  " onclick="updatePickapro();">
											...
											<input type="hidden" name="pickapro_listing" id="pickapro_listing" value="0">
								...
								<div class="pos_rel">											
									...
									<div class="thr_clmn  wi_75 ">
										...
										<div class="on_clmn mart20 hidden" id="extraFee">
											...
											<label for="dish_type" class="floating__label tall nobold padl10" data-content="Dish type">
											<span class="hidden--visually">
											...
											<div class="pos_rel">
												...
												<input type="text" name="dish_name" id="dish_name" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"> 
												<label for="dish_name" class="floating__label tall nobold padl10" data-content="Title">
											<span class="hidden--visually">
											 Title</span></label>
											</div>
