				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
								 ...
								 <?php foreach($buildingsAvailableAmenitiesInfo as $category1 => $value1) 
														{
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 xxs-minhei_60p minhei_65p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright <?php if($value1['apartment_app_display']==1) echo 'checked'; ?> " onclick="updateBuildingAminityDisplay(<?php echo $value1['id']; ?>);">
