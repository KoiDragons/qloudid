...
<div class="browse__info info changedText">Here are home repair requests</div>
</div>
...
<div class="checkout__box">
 ...
 <?php $i=0;
	foreach($repairRequest as $category => $value) 
	{
	?> 	
...
<a href="../repairRequestInfo/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
<?php } else { if($value['accepting_company_id']==null || $value['accepting_company_id']=='') { ?>

<a class="button-stroke receipt__button" href="../getEmployeeListing/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><span class="receipt__cost"><span class="receipt__money" style="color: #e11936 ;">Assign</span></span>
</a>
