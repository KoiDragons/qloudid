...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			          ...
			          <a class="categories__item    " href="../listProposals/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Proposals</div>
                                      </a>
									   
									     <a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Properties</div>
                                      </a>
...
box-shadow:none;">
   ...
   " onclick="selectWishlist(<?php echo $value['id']; ?>);">Select</a>
                ...
                <form class="checkout__item js-tabs-item talc" action="../../VitechProperties/teamVailable/<?php echo $data['cid']; ?>" method="POST" id="save_indexing_proposal" name="save_indexing_proposal" accept-charset="ISO-8859-1" style="display: block;">		
									...
									<input type="hidden" id="proposal_type"	name="proposal_type" value="4" />
