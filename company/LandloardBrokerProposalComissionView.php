...
<a class="header__logo xs-fsz25 changedText" href="../../listSocietyProposalPaidInvoices/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Complete the form below to generate the commission invoice
</div>
...
<form class="checkout__item js-tabs-item" action="../../generateInvoiceCommision/<?php echo $data['cid']; ?>/<?php echo $data['invoice_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">

 <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Received payment</div>
                            <div class="field__wrap">
							 	<input class="field__input"  name="payment_amount" id="payment_amount" value="<?php echo $brokerInvoicePaidDetail['payment_amount']; ?>"    type="number"    style=" color:grey;"  readonly>
                               
                            </div>
                          </div>

						  <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Broker comission</div>
                            <div class="field__wrap">
							 	<input class="field__input"  name="total_commission" id="total_commission" value="<?php echo abs(($brokerInvoicePaidDetail['payment_amount']*$brokerComissionFeeDetail['broker_fee_payment'])/100); ?>"    type="number"    style=" color:grey;"  >
                               
                            </div>
                          </div>
						  
						  <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">VAT</div>
                            <div class="field__wrap">
							 <select class="" name="total_vat" id="total_vat"  style="height: 48px;
...
<div class="checkout__fieldset">
  ...
  <a class="button checkout__button changedText" href="../../approveGuestReservationRequest/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" >Generate</a>
