...
<a class="header__logo xs-fsz20 changedText" href="../../CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>" style="
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">BOOKINGS</h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Here is a list of past, current and upcoming reservations
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">Reservations</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
               ...
               <a href="../searchRentProperties/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button">
