		...
		<div class="column_m header xs-header xsip-header xsi-header bs_bb " style="background-color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#f9f9f9"; else echo $corporateColor['bg_color']; ?>">
			...
			<div class="fright xs-dnone sm-dnone padt10 padb10">
					<ul class="mar0 pad0 sf-menu fsz14">
						...
						<li class="dblock hidden-xs hidden-sm fleft pos_rel brd2 brdclr_black brdrad5 marl20"> <a href="../visitorsQrScan/<?php echo $data['cid']; ?>" id="usermenu_singin" class="translate hei_30pi dblock padrl20  uppercase lgn_hight_25  black_txt_h" data-en="I´m expected" data-sw="I´m expected" style="color:<?php if($corporateColor['f_color']=="" || $corporateColor['f_color']==null) echo "#f5f5f5"; else echo $corporateColor['f_color']; ?>">I´m expected</a> </li>
				...
				<div class="padrl10 xs-padrl15">
					...
					<div class="wi_400p xsi-wi_360p maxwi_100   pos_rel zi5 marrla pad30  xs-pad0   brdrad5  " >
							...
							<div class="marb30 padt10 xsi-marb30">
									<h1 class="padb5 talc fsz35 xs-fsz25 xsi-fsz45 bold  lgn_hight_48 black_txt trn" style="color:<?php if($corporateColor['f_color']=="" || $corporateColor['f_color']==null) echo "#f5f5f5"; else echo $corporateColor['f_color']; ?>">Welcome</h1>
						...
						<?php if($checkOpenStatus==1) { ?>
						<div class="padb10 xs-padrl10 hidden"> <a href="../visitors/<?php echo $data['cid']; ?>/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn ">I am here for a meeting</a> </div>
						<div class="padb10 xs-padrl10"> <a href="../visitorsContactInformation/<?php echo $data['cid']; ?>" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn ">I am here for a Treatment</a> </div>
						<?php } if($checkOpenStatusParkering==1) { ?>
						<div class="padb10 xs-padrl10"> <a href="https://www.safeqloud.com/company/index.php/Parkering/plateInfo/<?php echo $data['cid']; ?>" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn"  >I want free parking</a> </div>
						<?php } if($checkOpenStatusDelivery==1) { ?>
						<div class="padb10 xs-padrl10"> <a href="https://www.safeqloud.com/company/index.php/Leveranser/pickupInfo/<?php echo $data['cid']; ?>" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn"  >I want to pick up a package</a> </div>
						<?php } ?>
						<?php if($data['comp_id']!=0) { ?>
						<p class="padt20 xs-padt10 xs-padb20 talc fsz18 xs-fsz16 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 " style="color:<?php if($corporateColor['f_color']=="" || $corporateColor['f_color']==null) echo "#f5f5f5"; else echo $corporateColor['f_color']; ?>">This front desk is managed by <?php echo $data['comp_name']; ?></p>
						<?php } ?>
