...
<html>
	...
	<head>
		...
		<!-- Scripts
		<script defer src='https://www.clocktab.com/sf/_.js'></script> -->
...
function checkFlag()
	...
	<body class="white_bg" id="isPm" onload="startTime();">
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="padb20 xxs-padb0 ">		
						...
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0   xxs-talc talc fsz40 xxs-fsz30 bold padb10 black_txt trn xs-marb20 marb35 lgn_hight_38 hidden"  style="font-family: Work Sans,Arial,sans-serif;" ><?php echo day_s(date('D')).'-',month_s(date('m'))." ".date('d'); ?></h1>
									</div>
									...
									<div class=" wi_50 xxs-wi_50 fleft bs_bb padrb20 talc  hidden" >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_210p dblock bs_bb pad25  brdclr_seggreen_h brdrad5 lgtgrey2_bg trans_all2 " onclick="changeBG(this,1);">
																<div class=" ">
																	<div class="wi_100 hei_90p dflex bs_bb">
																		<img src="../../../../estorecss/tmpnew0.04292400 1568313716.jpg" height="90" width="90" class="brdrad5 padb0">
																	</div>
																	
																	<div class="  padrb15 padt20">
																		<h3 class="ovfl_hid tall pad0 txtovfl_el ws_now lgn_hight_24 bold fsz18 segdblue_txt padt0">I am here right now</h3>
																		<span class="dblock tall marb5 padt10 midgrey_txt fsz16">Present on duty</span>
									...
									<div class=" wi_50 xxs-wi_50 fleft bs_bb padrb20 talc  hidden" >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="#" class="style_base hei_210p dblock bs_bb pad25  brdclr_seggreen_h brdrad5 lgtgrey2_bg trans_all2 " onclick="changeBG(this,2);">
																<div class=" ">
																	<div class="wi_100 hei_90p dflex bs_bb">
																		<img src="../../../../estorecss/tmpnew0.04292400 1568313716.jpg" height="90" width="90" class="brdrad5 padb0">
																	</div>
																	...
																	<div class="  padrb15 padt20">
																		<h3 class="ovfl_hid tall pad0 txtovfl_el ws_now lgn_hight_24 bold fsz18 segdblue_txt padt0">I will not come</h3>
																		<span class="dblock tall marb5 padt10 midgrey_txt fsz16">On Leave/Vacation</span>
											...
											<div class="padt5 xxs-talc talc mart30 xxs-mart70" id="present" >
											<a href="../reportEmployeePresence/<?php echo $data['cid']; ?>"><i class="far fa-play-circle green_txt fsz80"></i></a>
								<div class="on_clmn mart10 xxs-mart30 marb25 hidden">
											<div class="thr_clmn wi_40 padl120 padt5"  >
											<i class="fas fa-pause-circle grey_txt fsz30"></i>
											</div>
											
											<div class="thr_clmn wi_20 padr0"  >
											
								<a href="../reportEmployeePresence/<?php echo $data['cid']; ?>"><i class="far fa-play-circle green_txt fsz80"></i></a>
								</div>
								
								<div class="thr_clmn wi_40 padr120"  >
								<i class="far fa-stop-circle grey_txt fsz30 padt5"></i>
											</div>
								
							</div>	
							</div>
												
							<div class="padt5 xxs-talc talc mart10 xxs-mart30" id="absent" >
								
								<a href="../reportAbsent/<?php echo $data['cid']; ?>"><span class=" hei_55p fsz18 trn"  >I can´t come in today</span></a>
