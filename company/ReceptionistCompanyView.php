	...
	<head>
		...
		<script>
			...
			function sendInformation()
			{
				...
				else if($("#zip_code").val()=="" || $("#zip_code").val()==null)
				{
					document.getElementById("popup_fade").style.display='block';
					$("#popup_fade").addClass('active');
					document.getElementById("person_informed").style.display='block';
				...
				else if($("#cid").val()=="" || $("#cid").val()==null)
				{
					document.getElementById("popup_fade").style.display='block';
					$("#popup_fade").addClass('active');
					document.getElementById("person_informed").style.display='block';
					$(".person_informed").addClass('active');
					$("#error_msg_form").html('Please enter CID');
					return false;
				}
				else if($("#employee_name").val()=="" || $("#employee_name").val()==null)
				{
					document.getElementById("popup_fade").style.display='block';
					$("#popup_fade").addClass('active');
					document.getElementById("person_informed").style.display='block';
					$(".person_informed").addClass('active');
					$("#error_msg_form").html('Please enter employee name');
					return false;
				}
				
				else if($("#employee_email").val()=="" || $("#employee_email").val()==null)
				{
					document.getElementById("popup_fade").style.display='block';
					$("#popup_fade").addClass('active');
					document.getElementById("person_informed").style.display='block';
					$(".person_informed").addClass('active');
					$("#error_msg_form").html('Please enter employee email');
					return false;
				}
				else if($("#phone").val()=="" || $("#phone").val()==null)
				{
					...
					var send_data={};
					send_data.company_name=$("#company_name").val();
					send_data.ccountry=$("#ccountry").val();
					send_data.address=$("#address").val();
					send_data.zip_code=$("#zip_code").val();
					send_data.city=$("#city").val();
					send_data.cid=$("#cid").val();
					send_data.employee_email=$("#employee_email").val();
					send_data.employee_name=$("#employee_name").val();
								...
								<div class="on_clmn padtb0">
									<div class="on_clmn martb10">
										...
										<div class="pos_rel">
											...
											<input type="text" name="company_name"  id="company_name" placeholder="Company name" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" >
											
										</div>
									</div>
									<div class="on_clmn marb10">
										
										<div class="pos_rel">
											
											<input type="text" name="address"  id="address" placeholder="Street address" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" >
									...
									<div class="on_clmn marb10">
										...
										<div class="pos_rel">
											...
											<input type="text" name="zip_code"  id="zip_code" placeholder="Zipcode" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" >
									...
									<div class="on_clmn marb10">
										...
										<div class="pos_rel">
											...
											<input type="text" name="city"  id="city" placeholder="City" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" >
									...
									<div class="on_clmn marb10">
										...
										<div class="pos_rel">
											...
											<select name="ccountry" id="ccountry" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5">
									...
									<div class="on_clmn marb10">
										...
										<div class="pos_rel">
											...
											<input type="text" name="cid"  id="cid" placeholder="Company Identification Number" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5" >
									...
									<div class="on_clmn marb10">
										...
										<div class="pos_rel">
											...
											<input type="text" name="employee_name" id="employee_name" placeholder="Namn på den du ska träffa..." class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5"  >
									...
									<div class="on_clmn marb10">
										...
										<div class="pos_rel">
											...
											<input type="text" name="employee_email" id="employee_email" placeholder="Employee email" class="wi_100 rbrdr padrl10 mart5 hei_50p llgrey_txt fsz18 lgtgrey2_bg brdrad5"  >
									...
									<div class="padb10 xs-padrl0" id="submit_button_in_popup"> <a href="#" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 blue_bgn   fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0" onclick="sendInformation();">Meddela</a> </div>
