	...
	<head>
		...
		<script>
			function submitDepartment()
			{
				...
				$("#errorMsg").html('');
				if($("#d_name").val()=="" || $("#d_name").val()==null)
				{
				$("#errorMsg").html('please enter department name');	
				return false;
				}
			...
			function editDepartment()
			{
				...
				$("#errorMsg1").html('');
				if($("#d_name1").val()=="" || $("#d_name1").val()==null)
				{
				...
				else
				{
					...
					var send_data={};
					send_data.dname=$("#d_name1").val();
				
					send_data.id=$("#did").val();
					$.ajax({
						type:"POST",
						url:"../editDepartment/<?php echo $data['cid']; ?>",
						data:send_data,
						dataType:"text",
						...
						success: function(data1){
							...
							else
							{
								...
								window.location.href="https://www.safeqloud.com/company/index.php/CompanyDepartment/departmentInfo/<?php echo $data['lid']; ?>";
							}
						}
					});
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  >Dept.</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Add and list all departments</a></div>
						...
						<div class="padb0 xxs-padb0 brdb_new red_ff2828_brdclr brd_width_2">
							...
							<div class="marrla xs-wi_100">
								...
								<form action="../addCompanyDepartment/<?php echo $data['lid']; ?>" name="save_indexing" id="save_indexing" method="POST" >
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn padb10">
											...
											<div class="thr_clmn padl5 wi_70">
													<input type="text" name="d_name" id="d_name" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl10 hei_50p fsz18 llgrey_txt" placeholder="Write department name ">
												
											</div>
											
											
											<div class="thr_clmn padl5 wi_30">
												<input type="button" value="Add" class="wi_100 mart5 maxwi_100 brdrad3 hei_50p diblock nobrd red_ff2828_bg fsz18 white_txt curp" onclick="submitDepartment();">
							...
							<div class="clear"></div>
								...
								<?php $i=0;
												...
												foreach($addedDepartments as $category => $value) 
												{
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_50p marr15  "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz25   brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	...
																	border-radius: 10%;"><?php echo substr($value['department_name'],0,1); ?> </div>
																	</div>
													
													<div class="fleft wi_75   xs-mar0 ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz14 xs-padt0 black_txt">Department</span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz18  black_txt"><?php echo $value['department_name']; ?></span>  </div>
													 
													<div class="fright wi_10 padt10 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz25  padb0 xxs-marr20 hidden-xs">
														<a href="#" class="show_popup_modal xs-padr20" data-target="#edit_department" onclick="updatePopup(<?php echo $value['id']; ?>,'<?php echo $value['department_name']; ?>');"><span class="far fa-edit grey_txt"></span> </a>
													</div>
								...
								<script>
									function add_more_rows_approved_Connections(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreCompanyDepartments/<?php echo $data['lid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
