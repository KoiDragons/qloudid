...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Objects</h2>
<div class="browse__info info changedText">Please select action to update property detail</div>
</div>
...
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px; border: 1px solid <?php if($fetchPropertyStatus==1) echo '#00ff9996'; else echo '#ff00574a'; ?>">
<div class="checkout__label changedText">Property information</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">View property detail here </div>
 
<div class="checkout__controls">
<a href="../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" > <button class="checkout__edit" >
...
<use xlink:href="#icon-edit"></use>
 ...
 <div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px; border: 1px solid <?php if(count($fetchPropertiesImages)>=10) echo '#00ff9996'; else echo '#ff00574a'; ?> ">
<div class="checkout__label changedText">Photo</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Add/update photo information here</div>
 
<div class="checkout__controls">
<a href="../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" > <button class="checkout__edit" >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<use xlink:href="#icon-edit"></use>
 ...
 <div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px; border: 1px solid <?php if($fetchPropertiesPricing['pricing_updated']==1) echo '#00ff9996'; else echo '#ff00574a'; ?>">
<div class="checkout__label changedText">Pricing</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Add/update pricing information here</div>
 
<div class="checkout__controls">
<a href="../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" > <button class="checkout__edit" >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
...
<div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px; border: 1px solid #00ff9996;">
<div class="checkout__label changedText">Publish</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Send publish request to owner</div>
 
<div class="checkout__controls">
<a href="../../sendPublishRequest/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" > <button class="checkout__edit" >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
</svg>
</button></a>
