...
<div class="setting__container" style="padding:0px;">
 <div class="setting__head hidden">
                    <h2 class="setting__title h2">Visiting address</h2> <a class="button-stroke button-small setting__button" href="https://www.safeqloud.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>">View profile</a>
                  </div>
...
<div class="upload__row">
                        ...
                        <div class="field  " style="border-color:#353945;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="addrs" id="addrs" value="<?php if($addressDetail['visiting_address']!="" || $addressDetail['visiting_address']!= null) echo $addressDetail['visiting_address']; else echo "-"; ?>"    placeholder="e. g. Queenstown, Otago, New Zealand" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="port_number" id="port_number" value="<?php echo $addressDetail['port_number'];?>" placeholder="e. g. 121" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
<div id="addressone" class="hidden">
 ...
 <div class="upload__row">
                        ...
                        <div class="field  " style="border-color:#353945;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="latit" id="latit"  placeholder="e. g. 29.123456" style=" border-color:#353945; color:grey;" fdprocessedid="hqixjq">
                            </div>
                          </div>
						  </div>
						   <div class="upload__col  upload__col_w50">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="longi" id="longi"  placeholder="e. g. 71.222222" style=" border-color:#353945; color:grey;" fdprocessedid="zw5lf">
                            </div>
                          </div>
						  </div>
						  </div>
...
<a class="button checkout__button changedText" href="javascript:void(0);"  onclick="informEmployee();" >Update</a>
</form>
