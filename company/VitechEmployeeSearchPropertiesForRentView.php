  ...
  <meta charset="utf-8">
	...
	function submitClient()
	{
	 if($('#city').val()!='')
		...
		$('#save_indexing').attr('action','../listEmployeesRentClientShare/'+cid);
		document.getElementById('save_indexing').submit();	
	}
	function submitForm()
	{
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item" style=""><a class="breadcrumbs__link" href="javascript:void(0);" style="color:white !important;">Markup</a></li>
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesRentBrokerShare/<?php echo $data['cid']; ?>">Broker share</a></li>
				  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesRentClientShare/<?php echo $data['cid']; ?>">Client share</a></li>
                </ul>
              </div>
...
<div class="categories__center center1 xsi-nobrdb xsi-padb0"  style="padding-bottom:40px; padding-bottom:40px; border-bottom:1px solid #353945; ">
<div class="categories__inner">

 <form action="../searchRentProperties/<?php echo $data['cid']; ?>" method="POST" name="save_indexing" id="save_indexing" accept-charset="ISO-8859-1">
...
<use xlink:href="#icon-search" style="fill:black;"></use>
			 ...
			 <div class="sorting__foot <?php  if(!isset($_POST['city']) || $_POST['city']=='') echo 'hidden'; ?>">
                <div class="nav"><a class="nav__link active changedText" href="#" >Mark up</a> <a class="nav__link changedText" href="#" onclick="submitBroker();">Broker share</a> <a class="nav__link changedText" href="#" onclick="submitClient();">Client share</a></div>
		...
		<div class="section flights <?php  if(!isset($_POST['city']) || $_POST['city']=='') echo 'hidden'; ?>">
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
			...
			<input   type="hidden" name="checkin_date" id="checkin_date" value='<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo date('Y-m-d',strtotime($_POST['rz_booking_dates'][0])); } ?>' placeholder="Check in" readonly="readonly">
		 <input   type="hidden" name="checkout_date" id="checkout_date" value='<?php if(isset($_POST['city']) && $_POST['city']!='')
			 { echo date('Y-m-d',strtotime($_POST['rz_booking_dates'][1])); } ?>' placeholder="Check in" readonly="readonly">
		 
		  <input   type="hidden" name="guest_adults" id="guest_adults" value='<?php if(isset($_POST['city']) && $_POST['city']!='')
		  ...
		  <input   type="hidden" name="guest_children" id="guest_children" value='<?php if(isset($_POST['city']) && $_POST['city']!='')
		 ...
		 <input   type="hidden" name="broker_property_id" id="broker_property_id" value='' placeholder="Check in" />
		  ...
		  <input   type="hidden" name="searched_from" id="searched_from" value='1' placeholder="Check in" />
			</form>	
			...
			function updatePropertyAction(id,id1)
			{
				...
				$("#broker_property_id").val(id);
				$("#owner_property_id").val(id1);
				$('#save_indexing1').attr('action','../brokerPricingDetail/'+cid+'/'+id);
...
">
                   <a href="../guestReservationList/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value['enc_id']; ?>" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px; color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                       <div class="card__price" style="color:#52d4f4; box-shadow: inset 0 0 0 2px #52d4f4;">
                        <div class="card__old">$<?php echo $value['night_price']; ?></div>
                        <div class="card__actual">$<?php echo $value['night_price']; ?></div>
                      </div>
                    </div>
                ...
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    ...
                    <div class="card__foot">
                      ...
                      <div class="card__comment" style="      padding-bottom: 20px;">
...
">
 <?php  echo $value['longSellingDescription']; ?> </div>
                      ...
                      <div class="card__flex brdt mart10 padt10 <?php  if(!isset($_POST['city'])){ echo 'hidden'; } ?>" style="border-color: #353945;">
                        <div class="card__cost fsz14 changedText" style="
    padding-top: 10px; font-weight:100;
">Update status</div>
