 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  ...
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.qloudid.com/company/index.php/VitechProperties/listEmployeesRentBrokerShare/<?php echo $data['cid']; ?>">Broker share</a></li>
				  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.qloudid.com/company/index.php/VitechProperties/listEmployeesRentClientShare/<?php echo $data['cid']; ?>">Client share</a></li>
                </ul>
              </div>
