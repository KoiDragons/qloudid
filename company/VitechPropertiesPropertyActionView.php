				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please select action below</a></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Update your property details" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="" fdprocessedid="pi50xo">
										 
									</div>
									 </div> 
									  
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="green_bg_00ff9996  bg_fffbcc_a " style="background-color:<?php if($fetchPropertyStatus==1) echo '#00ff9996'; else echo '#ff00574a'; ?>">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Property information</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">View property detail here</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
													
													<a href="../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi" fdprocessedid="rrp4c">Review</button>
																			</div> 
																			</a>
													   </div>
									...
									<div class="clear"></div>
									<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class=" bg_fffbcc_a " style="background-color:<?php if(count($fetchPropertiesImages)>=10) echo '#00ff9996'; else echo '#ff00574a'; ?>">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Photo</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Add/update photo information here</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
													
													<a href="../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi" fdprocessedid="zuudqp">Review</button>
																			</div> 
																			</a>
													   </div>
						...
						<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="bg_fffbcc_a " style="background-color:<?php if($fetchPropertiesPricing['pricing_updated']==1) echo '#00ff9996'; else echo '#ff00574a'; ?>">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Pricing</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Add/update pricing information here</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
													
													<a href="../../foreignPropertyPricingDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi" fdprocessedid="zuudqp">Review</button>
																			</div> 
																			</a>
							...
							<div class="column_m container  marb5  mart10 fsz14 dark_grey_txt brd">
												<div class="bg_fffbcc_a " style="background-color: #00ff9996;">
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Publish</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Send publish request to owner</span> 
													 </div>
													<div class="xxxs-wi_25 fleft wi_30  marr30 xs-mar0 ">
													
													<a href="../../sendPublishRequest/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi" fdprocessedid="zuudqp">Send</button>
																			</div> 
																			</a>
													   </div>
													</div>
