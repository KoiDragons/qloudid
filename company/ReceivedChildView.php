...
//print_r($data); die;
	...
	if($companyDetail ['profile_pic']!=null) { $filename="../estorecss/".$companyDetail ['profile_pic'].".txt"; if (file_exists($filename)) { $value_a=file_get_contents("../estorecss/".$companyDetail ['profile_pic'].".txt"); $value_a=str_replace('"','',$value_a);  $imgs = base64_to_jpeg1( $value_a, '../estorecss/tmp.jpg' );  $imgs='../../../'.$imgs; } else { $value_a="../../../../html/usercontent/images/default-profile-pic.jpg";  $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; } }  else {  $imgs="../../../../html/usercontent/images/default-profile-pic.jpg"; $value_a="../../../../html/usercontent/images/default-profile-pic.jpg"; } ?>
					...
					<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.1/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
						...
						<link href="https://fonts.googleapis.com/css?family=Audiowide" rel="stylesheet">
							<link href="https://fonts.googleapis.com/css?family=Allerta+Stencil" rel="stylesheet">
								<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Avenir" />
								<!-- Scripts -->
            ...
            <div class="visible-xs visible-sm fleft padrl0">
			  ...
			  <div class="visible-xs visible-sm fright marr0 ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
                 ...
                 <li><a href="javascript:void(0);" class="fsz16i"><span class="fas fa-list-ol padr15"> </span> Presence</a></li>
				  <li>
                    <div class="line martb10"></div>
                  </li>
      ...
      <div class="clear" id=""></div>
								...
								<div class="column_m pos_rel" onclick="checkFlag();">
									...
									<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
											...
											<ul class="dblock mar0 padl10 fsz16 ffamily_avenir">
                        ...
                        <div class="padb20 xxs-padb0 ">
                            ...
                            <div class="wrap maxwi_100 dflex alit_fe justc_sb  pos_rel padb10 ">
                                <div class="white_bg tall">
                                    ...
                                    <!-- Logo -->
                                    <h1 class="fsz30 xs-fsz45 xs-talc black_txt ffamily_avenir">Presence</h1>

                                    <div class="marb0 xs-talc"> <a href="#" class="blacka1_txt fsz16  xs-fsz20  talc edit-text jain_drop_company ffamily_avenir">Here is a list of children present at the daycare in realtime</a></div>
                                    <a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
                                        <!-- Meta -->
                                ...
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_new xs-talc">
                                            <a href="#" class="dinlblck mar5 padrl30_a  padrl10  blue_67cff7_brd_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_Popular">Expected</a>
                                            <a href="#" class="dinlblck mar5 padrl30_a  padrl10    blue_67cff7_brd_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" data-id="utab_Analytics">Absent</a>
                                            <a href="#" class="dinlblck mar5 padrl30_a  padrl10    blue_67cff7_brd_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" data-id="utab_Advertising">Arrived</a>
                                        ...
                                        <div class="tab_container mart10">
														...
														<table class="wi_100 marb10" cellpadding="0" cellspacing="0" id="mytablesent">

																	<thead class="fsz16 brdb_blue1" >
																		<tr class="fsz16">
																		
																			<th class="pad5  nobold  tall xs-wi_100 brdb_blue1" >
																				<div class="padtb5 black_txt ffamily_avenir">Checked in but not confirmed</div>
																			</th>

																			<th class="pad5  nobold   tall brdb_blue1" >
													...
													foreach($childrenDroppedDetail as $category => $value) 
													{
											...
											<div class=" white_bg marb0  xs-marb5 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
																		...
																		<div class="fleft wi_10 xxs-wi_20 sm-wi_10 xsip-wi_10  xxs-padr20 hidden-xs"> 
																			 <div class="wi_50p xs-wi_100 hei_50p xs-hei_45p fxshrink_0 dflex alit_c justc_c uppercase fsz26 xs-fsz20 yellow_bg_a" ><img src="../../../<?php echo $value['image_path']; ?>" width="45px;" height="45px;" alt="Profile " style="background-repeat: no-repeat;
																		background-position: 50%;
																	border-radius: 10%;"> </div>
																	</div>
																			<div class="fleft wi_40 xs-wi_50 marl15 xs-mar0 padb10 xs-padb0 "> <span class="trn" data-trn-key="Child name"><?php if($value['person_dropped_child']=="" || $value['person_dropped_child']==null) echo 'No name'; else echo $value['person_dropped_child']; ?></span> <span class=" edit-text jain1 dblock  brdclr_lgtgrey2  fsz18"><?php echo html_entity_decode($value['name']); ?></span> </div>
																			<div class="xxs-fleft fright wi_20 marr10 fsz40  xxs-marl15 xs-marr0  padb0 padl40">
														<a href="../receivedConfirmation/<?php echo $value['child_id']; ?>"  ><button type="button" name="Confirm" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi">Confirm</button> </a>
													</div>
															...
															<div class="padt20 talc">
																<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width" value="1" id="temp" onclick="show_more_data(this,this.value);">View more</a>
															...
															<script>
																...
																$.ajax({
																type:"POST",
																url:"../moreChildrenDroppedDetail/<?php echo $data['cid']; ?>",
																data:send_data,
																dataType:"text",
															...
															<table class="wi_100 marb10" cellpadding="0" cellspacing="0" id="mytablesent">
																	...
																	<thead class="fsz16 brdb_blue1" >
																		<tr class="fsz16">
																			...
																			<th class="pad5  nobold  tall xs-wi_100 brdb_blue1" >
																				<div class="padtb5 black_txt ffamily_avenir">Confirmed presence</div>
																			</th>
													...
													foreach($childrenPresentDetail as $category => $value) 
													{
														
														
													?> 
									<div class="xs-wi_50 wi_25 fleft bs_bb padb20 padr20 xs-padr10 xxs-padl10 talc  " >
															...
															<a href="#" class="style_base hei_180p xxs-hei_150p dblock bs_bb pad25 xs-pad10   brdclr_seggreen_h brdrad5 lgtgrey2_bg_h  box_shadow trans_all2 ">
																<div class=" ">
																	...
																	<div class="padrb15 padt20 xs-padt15 xs-padr0">
																		<h3 class="ovfl_hid tall pad0 txtovfl_el ws_now lgn_hight_24 xs-bold fsz18 segdblue_txt padt0 xs-fsz15 ffamily_avenir"><?php echo html_entity_decode($value['name']); ?></h3>
																		<span class="dblock tall marb5 padt10 midgrey_txt fsz16 hidden ffamily_avenir"><?php echo $value['social_number']; ?></span>
									...
									<div id="totalPresent">
															...
															<div class="clear"></div>
															<div class=" padt20 talc <?php if(round($childPresentCount['num']/20,0)==0) echo 'hidden'; ?>">
																<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width ffamily_avenir" value="1" id="temp" onclick="show_more_data_approved(this,this.value);">Visa fler</a>

															</div>

															<script>
																function show_more_data_approved(link,id) {
																...
																$.ajax({
																type:"POST",
																url:"../moreChildrenPresentDetail/<?php echo $data['cid']; ?>",
																data:send_data,
																dataType:"text",
																contentType: "application/x-www-form-urlencoded;charset=utf-8",
																success: function(data1){
													...
													foreach($childrenAbsentDetail as $category => $value) 
													{
											...
											<div class=" white_bg marb0 xs-marb5 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	border-radius: 10%;"> </div>
																			...
																			<div class="fleft wi_60 xs-wi_60 sm-wi_100 marl15 xs-mar0 padb10 xs-padb0 "> <span class="trn" data-trn-key="Child name"><?php echo $value['person_dropped_child']; ?></span> <span class=" edit-text jain1 dblock  brdclr_lgtgrey2  fsz18"><?php echo html_entity_decode($value['name']); ?></span> </div>
															...
															<div class="clear"></div>
															<div class="padt20 talc">
																<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width ffamily_avenir" value="1" id="temp" onclick="show_more_data_rejected(this,this.value);">View more</a>

															</div>

															<script>
																function show_more_data_rejected(link,id) {
																...
																$.ajax({
																type:"POST",
																url:"../moreChildrenAbsentDetail/<?php echo $data['cid']; ?>",
																data:send_data,
																dataType:"text",
																contentType: "application/x-www-form-urlencoded;charset=utf-8",
																success: function(data1){
													...
													foreach($childrenLeftDetail as $category => $value) 
													{
											...
											<div class=" white_bg marb0 xs-marb5 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
																		...
																		<div class="wi_100 xs-wi_100 xs-order_3 fsz12 ffamily_avenir">
																			...
																			<div class="fleft wi_60 xs-wi_60 sm-wi_100 marl15 xs-mar0 padb10 xs-padb0 "> <span class="trn" data-trn-key="Child name"><?php echo $value['picked_up_person_name']; ?></span> <span class=" edit-text jain1 dblock   brdclr_lgtgrey2 fsz18"><?php echo html_entity_decode($value['name']); ?></span> </div>
															...
															<div class="clear"></div>
															<div class="padt20 talc">
																<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt ffamily_avenir   trn xxs-brd_width" value="1" id="temp" onclick="show_more_data_left(this,this.value);">View more</a>

															</div>

															<script>
																function show_more_data_left(link,id) {
																...
																$.ajax({
																type:"POST",
																url:"../moreChildrenLeftDetail/<?php echo $data['cid']; ?>",
																data:send_data,
																dataType:"text",
																contentType: "application/x-www-form-urlencoded;charset=utf-8",
																success: function(data1){
