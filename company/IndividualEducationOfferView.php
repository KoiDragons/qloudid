				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					<div class="dflex xs-fxwrap_w alit_c">
							<div class="wi_50 xs-wi_100 flex_1 order_1 xs-order_1 xs-tall tall mart10 brdrad5 marr30 xs-marr0">
								...
								<form action="../addOfferInfo/<?php echo $data['lid']; ?>" method="POST" name="save_info" id="save_info" accept-charset="ISO-8859-1">
						...
						<div class="marb0 padrl0 first">
								...
								<div class="on_clmn mart10 padb10  ">
									...
									<div class="pos_rel">
										...
										<select name="offer_id" id="offer_id" class="default_view wi_100 mart5 rbrdr padrl10  lgtgrey2_bg hei_50p fsz18 llgrey_txt">
											
											 
											<option value="1">Förskola</option>
											<option value="2"> Grundskola</option>
											<option value="3"> Gymnasium</option>	
											<option value="4"> Högskola/Unviersitet</option>												
										</select>													
								...
								<div class="on_clmn martb10 padb10  ">
									...
									<div class="pos_rel">
										<label class="fsz14">Även i denna kontor?</label>
										<select name="offer_education" id="offer_education" class="default_view wi_100 mart5 rbrdr padrl10  lgtgrey2_bg hei_50p fsz18 llgrey_txt">
