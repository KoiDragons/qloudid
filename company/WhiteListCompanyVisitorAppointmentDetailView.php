...
<div class="checkout__center center" style="
    max-width: 375px;
    padding: 0 0px;
">
...
<div class="checkout__inner js-tabs" style="
    padding-right: 0px;
">
...
<h2 class="browse__title h2" style="
    font-size: 60px;
    line-height: 70px;
"><?php echo substr($visitorsDetailServiceAppointmentDetail['full_name'],0,10); ?>.</h2>
<div class="browse__info info" style="
    margin-top: 6px;
">+<?php echo $visitorsDetailServiceAppointmentDetail['country_code'].' '.$visitorsDetailServiceAppointmentDetail['phone_number']; ?></div>
</div>
...
<input  type="hidden" name="country_name" id="country_name" value="<?php echo $visitorsDetailRegularAppointmentDetail['country_name']; ?>">
<input  type="hidden"  name="phone_number" id="phone_number" value="<?php echo $visitorsDetailRegularAppointmentDetail['phone_number']; ?>">
</form>
												...
												foreach($visitorsDetailServiceAppointmentDetail['services'] as $category => $value) 
												{
												...
												?> 
													...
													<div class="checkout__label"><?php echo $value['dish_name']; ?></div>
													<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $value['total_time_required']; ?> minutes">
...
<div class="checkout__box">
												...
												<div class="receipt__foot " style="padding-top: 60px;">
												<a class="button receipt__button" href="../../../checkinServiceVisitor/<?php echo $data['cid']; ?>/<?php echo $data['meeting_id']; ?>/<?php echo $data['meeting_type']; ?>"   style="background: #ea1e63;height: 60px;width: 375px;border-radius: 10px;"><span>Check-in</span>
												</a>
												</div>
<div class="checkout__box">
...
</div><bugherd-sidebar></bugherd-sidebar></body>
