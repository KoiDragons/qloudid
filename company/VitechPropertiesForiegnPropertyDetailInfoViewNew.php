...
<div class="outer">
<!-- header--> 
 <?php   if($fetchPropertyTaskInfo['is_reserved']==0 &&  $fetchPropertyTaskInfo['is_activated']==1)
				{ ?>
				
				 <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg " style="padding:0px;">
		...
		<?php } else if($fetchPropertyTaskInfo['is_reserved']==1 &&  $fetchPropertyTaskInfo['is_activated']==1)
				{ ?>
			 <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg " style="padding:0px;">
				<div class="wi_100 hei_45p xs-pos_fix padt0 padrl10 black_bg" style="background:#ffe500 !important">
...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../<?php if($fetchPropertyContacTInfo['property_status']==3) { echo 'listEmployeesCreatedProperties'; } else echo 'listEmployeesProperties';  ?>/<?php echo $data['cid']; ?>" style="
 ...
 <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;">
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
                <option value="../../../editPropertyInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">Basic details</option>
				...
				<?php } ?>
				<option value="../../../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>Publish</option>
			 ...
			 <div class="upload__wrap  " style="background:transparent; padding-right:128px;">
				 ...
				 <a class="setting__link " href="../../../editPropertyInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../editPropertyInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
			...
			<a class="setting__link  " href="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                ...
                </svg><span style="color:#f67f00">Publish</span></a>
...
<div class="setting__head">
                    <h2 class="setting__title h2" style="font-size:25px;">Publish Your Property</h2> 
                  </div>

<div class="upload__head hidden" style="margin-bottom:0px;">
                  <h2 class="upload__title h2">Publish Your Property</h2>
				   
                </div>
 
 <div class="browse__info info changedText padb40 hidden" style="border-bottom: 2px solid #353945;">Fill Out the Form Below to Add Your Property to Our Marketplace
</div>
 
 <div class="upload__item  xs-padrl25 mart40">
 
 <?php if(count($fetchPropertiesImages)>0)
 { ?>
<div class="gallery">
              <div class="gallery__list gallery__list_stays">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view" href="<?php echo $fetchPropertiesImages[0]['image_path1']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="<?php echo $fetchPropertiesImages[0]['image_path1']; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#" class="xs-brdrad10">
                    <svg class="icon icon-image">
                      <use xlink:href="#icon-image"></use>
                    </svg><span>Show more photos</span></a></div>
					<?php  $i=1; foreach($fetchPropertiesImages as $category => $value)
												{
													if($i==1){ $i++; continue;}
												if($i>4) { break; } ?>
					<a class="gallery__preview xs-brdrad10" href="<?php echo $value['image_path1']; ?>" data-fancybox="gallery"><img src="<?php echo $value['image_path1']; ?>" alt="Gallery" class="xs-brdrad10"></a> 
												<?php $i++; } ?>
              </div>
            </div>
 <?php } else { ?>
                      ...
                      <a href="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">
 ...
 <?php } ?>
					...
					<form action="../../../<?php if($fetchPropertyStatus==0) { echo 'activateProperty';  } else { echo 'deactivateProperty'; } ?>/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">	

						<div class="field margin-bottom24">
                          <div class="field__label">description</div>
                          <div class="field__wrap">
                            <textarea class="field__textarea" name="longSellingDescription" id="longSellingDescription" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" required=""><?php if($fetchPropertyContacTInfo['property_status']==3) echo $fetchPropertiesDescription ['longSellingDescription']; else echo $fetchPropertyContacTInfo['property_description_sell']; ?></textarea>
                          </div>
                        </div>
						...
						<div class="checkout__row  margin-bottom32">
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            ...
                            <div class="field__wrap">
                               <select class=" " id="vitech_region_id" name="vitech_region_id"   onchange="selectCity(this.value);" style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="zc7mun">
                          ...
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            ...
                            <div class="field__wrap">
                              <select class=" " id="vitech_city_id" name="vitech_city_id"  onchange="selectArea(this.value);" fdprocessedid="knpjzs"  style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
						  ...
						  <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;" >
                            ...
                            <div class="field__wrap">
                              <select class=" " id="vitech_area_id" name="vitech_area_id"  fdprocessedid="54p5r"  style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
						...
						<?php if($fetchPropertyContacTInfo['property_status']==3) { ?>
						<div class="red_txt fsz20 talc padt20" id="errorMsg1"><?php if($rentalPropertyPublishInfo['image_count']!=1 || $rentalPropertyPublishInfo['night_pricing_updated']!=1 || $rentalPropertyPublishInfo['house_rule_updated']!=1 || $rentalPropertyPublishInfo['arrival_updated']!=1 || $rentalPropertyPublishInfo['markup_info_updated']!=1 || $rentalPropertyPublishInfo['pricing_updated']!=1){ echo 'Please complete the rental information(s) before publishing'; } ?> </div>
						
						<?php if($rentalPropertyPublishInfo['image_count']==1 && $rentalPropertyPublishInfo['night_pricing_updated']==1 && $rentalPropertyPublishInfo['house_rule_updated']==1 && $rentalPropertyPublishInfo['arrival_updated']==1 && $rentalPropertyPublishInfo['markup_info_updated']==1 && $rentalPropertyPublishInfo['pricing_updated']==1){ ?>
						...
						<?php } } else { ?>
						<div class="red_txt fsz20 talc padt20" id="errorMsg1"><?php if($countPhoto['num']<10){ echo 'Please complete the photos before publishing'; }?> </div>
						
						<?php if($countPhoto['num']>=10){ ?>
						<a class="button checkout__button changedText" href="javascript:void(0);" onclick="submitForm();"><?php if($fetchPropertyStatus==0) { echo 'Activate';  } else { echo 'Deactivate'; } ?></a>
						<?php } } ?>
					</div>
					</div>
