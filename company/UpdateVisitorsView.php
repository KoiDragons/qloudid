...
<html>
	...
	<body class="lgtgrey2_bg">
		...
		<div class="column_m pos_rel" onclick="checkFlag();">
			...
			<div class="column_m container zi5  mart40 xs-mart20 <?php if($companyVisitor==0) echo 'hidden'; ?>">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0  ">
						...
						<div class="marb30 ">
							<h1 class="padb5 talc fsz50 xs-fsz40 bold " style="color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000"; else echo $corporateColor['bg_color']; ?>">  Its done</h1>
							<p class="padt20 xs-padt10 xs-padb20 talc fsz25 xs-fsz20 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10">You have already been signed ou</p>
						</div>
			...
			<!-- CONTENT -->
			<div class="column_m container zi5  mart40 xs-mart20 <?php if($companyVisitor==1) echo 'hidden'; ?>">
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_400p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10  xs-pad0  ">
						...
						<div class="marb30 padt10 ">
									<h1 class="padb5 talc fsz50 xs-fsz40 bold "  style="color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000"; else echo $corporateColor['bg_color']; ?>"> Hej <?php echo $visitorOnPage['name']; ?>...</h1>
							<p class="padt20 xs-padt10 xs-padb20 talc fsz25 xs-fsz20 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10">Pågår mötet än? Vi frågar för att kunna ha en evakueringslista vid eventuell fara, brand eller olycka</p>
						</div>
						<div class="padb10 xs-padrl0"> <a href="#" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 lgtgrey2_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0">Yes</a> </div>
						<div class="padb10 xs-padrl0"> <a href="../updateEmployeeVisitors/<?php echo $data['vid']; ?>/<?php echo $data['visitor']; ?>" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 lgtgrey2_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0">No</a> </div>
						<?php if($data['comp_id']!=0) { ?>
						<p class="brdt_new padt20 xs-padt10 xs-padb20 talc fsz18 xs-fsz16 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10">Bemannad av <?php echo $data['comp_name']; ?></p>
						<?php } ?>
