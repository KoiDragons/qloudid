...
<script>
	function submitForm()
{
	 if($('#country_name').val()=='' || $('#country_name').val()==null)
	{
	 ...
	 if($("#phone_number").val()==null || $("#phone_number").val()=="")
			{
			  ...
			  if($("#phone_number").val().charAt(0)==0) 
				{
					alert('Phone number cant start with Zero');
					return false;
				}
				...
				{
					alert('Phone number must be minimum five digit');
					return false;
				}
				 if($("#phone_number").val()==0) 
				{
					alert('Phone number can not be Zero');
					return false;
				}
...
<div class="header__menu"><a class="header__link active" href="javascript:void(0);">
<svg class="icon icon-comment">
<use xlink:href="#icon-comment"></use>
</svg>DIY Booking</a>
<a class="header__link  " href="StartExploring/membership/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Exclusive Concierge</a><a class="header__link" href="StartExploring/selectBrand/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09">
<svg class="icon icon-home">
<use xlink:href="#icon-home"></use>
</svg>Business</a>
<a class="header__link  " href="StartExploring/aboutUs/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>About us</a>

<a class="header__link  " href="StartExploring/career/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09" style=" box-shadow: none;">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Career</a>

<a class="header__link" href="StartExploring/signIn/bFhCcE1Cc0tqRnhiL0VLdHNzU2VSQT09">
<svg class="icon icon-email">
<use xlink:href="#icon-email"></use>
</svg>Sign in</a></div>
</div>
...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	 <form action="../listAppointments/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  >
...
<div class="main__center center">
            <div class="main__preview">
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo $path; ?>html/usercontent/images/bg/treatment.jpg"><img src="<?php echo $path; ?>html/usercontent/images/bg/treatment.jpg" alt="Main">
              </picture>
              <div class="main__wrap">
                <h1 class="main__title hero" style="color:white;">Treatment </h1>
                <div class="main__info info" style="color: #777E90; font-size:25px;">Please register and announce your arrival here</div> 
              </div>
            </div>
            <div class="panel panel_stays">
              <div class="panel__background"></div>
              <div class="panel__nav"><a class="panel__link active" href="Javascript:void(0);" style="color:#f67f00">Treatment</a><a class="panel__link" href="../visitorsContactRegularInformation/<?php echo $data['cid']; ?>">Meeting</a><a class="panel__link" href="Javascript:void(0);">Delivery</a> </div>
                ...
                <div class="panel__row">
                  <div class="location js-location">
                    <div class="location__head js-location-head">
                      ...
                      <input class="location__input js-location-input" type="text" name="country_name" id="country_name" autocomplete="off" placeholder="Location">
                      <div class="location__description">Where are you from?</div>
                    ...
                    <div class="location__body js-location-body">
					  ...
					  <?php $i=0;
												...
												foreach($userCountryList as $category => $value) 
												{
													
													
												?> 
												<a class="location__item js-location-item" href="#"><?php echo $value['country_name'];?></a><?php } ?></div>
                    </div>
                  </div>
                   ...
                   <div class="location js-location xs-wi_80">
                    <div class="location__head js-location-head">
                      ...
                      <input class="location__input js-location-input" type="text" name="phone_number" id="phone_number" autocomplete="off" placeholder="Phone number">
                      <div class="location__description">Your contact number?</div>
                      <button class="location__clear js-location-clear">
                        <svg class="icon icon-close-circle">
                          <use xlink:href="#icon-close-circle"></use>
                        </svg>
