...
<html>
	...
	<head>
		...
		<script>
		function updateCommunityPost(id,id1)
		   {
			    var send_data={};
				 send_data.tenant_id=id;
				 send_data.post_id=id1;
				 $.ajax({
							type:"POST",
							url:"../../updateCommunityPost",
							data:send_data,
							dataType:"text",
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../societyAddinsInfo/<?php echo $data['cid']; ?>/<?php echo $data['sid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 white_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../societyAddinsInfo/<?php echo $data['cid']; ?>/<?php echo $data['sid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Update Board members position</a></div>
								...
								<div id="profile1" class="" style="display: block;">		 
								 ...
								 <?php  foreach($communityAvailableTenantsInfo as $category => $value) 
														{
									...
									<div class="thr_clmn  wi_70   xs-padl20">
										...
										<input type="text" value="<?php echo $value['first_name'].' '.$value['last_name']; ?>(<?php echo $value['connected']; ?>)" class="wi_100 rbrdr pad10    tall  xxs-minhei_60p minhei_65p fsz18 black_txt ffamily_avenir  " readonly="">
										 
									</div>
									</div>
										<div class="thr_clmn  wi_30"  >
								<div class="pos_rel">											
											<select  class="default_view wi_100 mart0  trans_bg nobrdr nobrdt nobrdl   nobrdb fsz18 xxs-minhei_60p minhei_65p  trans_bg   black_txt tall padl0 ffamily_avenir" style="text-align-last:center;" onchange="updateCommunityPost(<?php echo $value['id']; ?>,this.value);"> 
											<?php  foreach($communityPostsInfo as $category1 => $value1) 
														{
															 
														?>	 
											<option value="<?php echo $value1['id']; ?>" <?php if($value['post_id']==$value1['id']) echo 'selected'; ?>><?php echo $value1['community_post']; ?></option> 
														<?php } ?>
