...
<div class="outer">
<!-- header--> 
 <?php if(count($getPropertyDetailInfo['images_info'])==0) { ?>
...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../listProperties/<?php echo $data['cid']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
      ...
      <div class="outer__inner " style="margin-top:65px;">
        <div class="section-mb64 product">
          <div class="product__center center">
           ...
           <div class="gallery imageBorder">
              <div class="gallery__list gallery__list_stays xs-maxheight390">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view xs-maxheight254" href="<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#" class="xs-brdrad10">
                    ...
                    </svg><span class="changedText">Show all photos</span></a></div>
					<?php  $i=1; foreach($getPropertyDetailInfo['images_info'] as $category => $value) 
												{
													if($i==1){ $i++; continue;}
												if($i>4) { break; } ?>
					<a class="gallery__preview xs-brdrad10 xs-maxheight136" href="<?php echo $value['image_path']; ?>" data-fancybox="gallery"><img src="<?php echo $value['image_path']; ?>" alt="Gallery" class="xs-brdrad10"></a> 
												<?php $i++; } ?>
              </div>
            </div>
				 <?php } else { ?>
              ...
              <div class="receipt__head">
                <div class="receipt__details">
                  <div class="receipt__cost">
                    ...
                    <div class="receipt__actual changedText">$<?php echo $getPropertyDetailInfo['startingPrice']; ?></div>
              ...
              <div class="receipt__description receipt__description_flex">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Bedroom</div>
                    <div class="receipt__subtitle changedText"><?php echo $getPropertyDetailInfo['numberOfBedrooms']; ?> bedrooms</div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category changedText">Bathroom</div>
                    <div class="receipt__subtitle changedText"><?php echo $getPropertyDetailInfo['numberOfBathrooms']; ?> bathrooms</div>
                  </div>
                </div>
              </div>
              
			   <?php if($checkPermission>0)
						{ ?>
			<div class="receipt__foot  hidden"><a class="receipt__more changedText" href="../../propertyTaskAssignment/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>">Assign property task</a></div> <?php } ?>
            </div>
  </div>
        </div>
            ...
            <div class="profile">
              <div class="profile__head">
                <div class="profile__line">
                  <div class="profile__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar.jpg" alt="Avatar">
              ...
              <div class="profile__body">
                ...
                <div class="profile__control"><a class="button-stroke button-small profile__button" href="message-center.html">Contact</a>
                  <div class="actions js-actions">
                    <div class="actions__item actions__item_share js-actions-item">
                      <button class="button-circle-stroke button-small actions__button js-actions-button" fdprocessedid="pf7pa4">
                ...
                <button class="profile__report" fdprocessedid="19ozb7">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
            ...
            <div class="comment">
              <form class="comment__form">
                ...
                <div class="comment__field">
                  ...
                  <button class="button-small comment__button" fdprocessedid="nm5ofe"><span>Post it!</span>
              ...
              <div class="comment__list">
                                <div class="comment__item">
                                  <div class="comment__avatar"><img src="https://dstricts.com/html/usercontent/images/review/1.jpg" alt="Avatar"></div>
                                  <div class="comment__details">
                                    ...
                                    <div class="comment__foot">
                                      ...
                                      <div class="comment__actions">
                                        <button class="comment__action" fdprocessedid="wqs3i8">Like</button>
                                        <button class="comment__action" fdprocessedid="b42jlh">Reply</button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="comment__item">
                                  <div class="comment__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar-2.jpg" alt="Avatar"></div>
                                  <div class="comment__details">
                                    <div class="comment__top">
                                    ...
                                    <div class="comment__foot">
                                      ...
                                      <div class="comment__actions">
                                        <button class="comment__action" fdprocessedid="6mlykm">Like</button>
                                        <button class="comment__action" fdprocessedid="210vg">Reply</button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="comment__item">
                                  <div class="comment__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar-3.jpg" alt="Avatar"></div>
                                  <div class="comment__details">
                                    <div class="comment__top">
                                    ...
                                    <div class="comment__foot">
                                      ...
                                      <div class="comment__actions">
                                        <button class="comment__action" fdprocessedid="nw6dno">Like</button>
                                        <button class="comment__action" fdprocessedid="ca4c43">Reply</button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
              ...
              <div class="comment__btns">
                <button class="button-stroke button-small comment__button" fdprocessedid="k1df0d">
