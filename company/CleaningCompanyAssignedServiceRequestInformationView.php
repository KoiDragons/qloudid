                            ...
                            <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_new tb_67cff7_bg xs-talc">
                                           ...
                                           <a href="../receivedCleaningRequest/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir " onclick="changeHeader();">Received</a>
											<a href="#" class="dinlblck mar5 padrl30_a  padrl10   blue_67cff7_brd_h blue_67cff7_brd_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_Popular">Assigned</a>
                                        </div>
							 ...
							 <div class="tab_content active" id="utab_Popular" style="display: block;">
									 ...
									 <?php  
												...
												foreach($assignedCleaningRequest as $category => $value) 
												{
									...
									<a href="../teamLeaderInfo/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">	<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
