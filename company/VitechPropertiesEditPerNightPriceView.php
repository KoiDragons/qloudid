		...
		function decrementNight()
		{
		 ...
		 if(shortest_duration==0)
		 {
			 ...
			 return false;
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateMinimumNight/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							...
							success: function(data1){
								...
								$('#totalNights1').val(shortest_duration);
		...
		function decrementDiscount()
		{
		 ...
		 if(discount_for_seven<0)
		 {
			 ...
			 return false;
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateDiscount/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateTitle(id)
		{
			...
			$('#wordCount').html(id.length);
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateTitle/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateEndDate(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateEndDate/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateMonday(id)
		{
			...
			return false;	
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateMonday/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateTuesday(id)
		{
			...
			return false;	
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateTuesday/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateWednesday(id)
		{
			...
			return false;	
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateWednesday/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateThursday(id)
		{
			...
			return false;	
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateThursday/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateFriday(id)
		{
			...
			return false;	
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateFriday/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateSaturday(id)
		{
			...
			return false;	
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateSaturday/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateSunday(id)
		{
			...
			return false;	
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateSunday/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateSundayOpen(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateSundayOpen/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateSaturdayOpen(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../updateSaturdayOpen/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateFridayOpen(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateFridayOpen/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateThursdayOpen(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateThursdayOpen/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateWednesdayOpen(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateWednesdayOpen/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateTuesdayOpen(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateTuesdayOpen/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateMondayOpen(id)
		{
			$('#errorMsg').html('');
				...
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateMondayOpen/<?php echo $data['pid']; ?>/<?php echo $data['price_id']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
<a class="header__logo xs-fsz20 changedText " href="../../../../perNightPricingList/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" style="
...
<div class="travel__center center   padb136 xs-padrl25" style="border-bottom:2px solid #23262F;  max-width: 1132px;
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list xs-marb0 marb957" style="
            max-width: 425px;
            ">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Update your current set pricing period</div>
...
<div class="checkout__list">
 ...
 <div class="upload__item">
					   ...
					   <div class="checkout__subtitle changedText hidden">Pricing period</div>
                       <h4 class="changedText" style="font-size:32px;">Pricing period</h4>
                      </div>
                      <div class="upload__fieldset ">
					   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Pricing period title</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="period_name" id="period_name" minlength="1" maxlength="100" class="css-xt766" value="<?php echo $pricing['pricing_title']; ?>" onkeyup="updateTitle(this.value);"  style=" color:grey;">
                            </div>
                          </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="date" value="<?php echo date('Y-m-d',$pricing['pricing_start_date']); ?>" readonly placeholder="e. g. 120" style=" color:grey;">
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="date" name="block-range-end-date" id="block-range-end-date" min="<?php echo date('Y-m-d',$pricing['pricing_start_date']); ?>" value="<?php echo date('Y-m-d',$pricing['pricing_end_date']); ?>" onchange="updateEndDate(this.value);" placeholder="e. g. 120" style=" color:grey;">
                            </div>
                          </div>
						  </div>
...
<div class="description__content">
 ...
 <div class="checkout__subtitle changedText">Which days can guests arrive?</div>
<p class="changedText">Orange marked are booking available days. </p>
<div class="css-1jzh2co">
<div class="chip-container">
			<?php echo $dayAvailable; ?>
</div>
</div>
</div>
</div>
...
<div class="upload__item">
					    ...
					    <div class="checkout__line  " style="margin-bottom:24px;">
					   <div class="checkout__subtitle changedText">What is the price for each night?</div>
                      ...
                      <div class="upload__fieldset ">
						  ...
						  <div class="checkout__row">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Manday</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number" name="monday_price" id="monday_price"   value="<?php echo $pricing['monday_price']; ?>" onkeyup="updateMonday(this.value);" placeholder="e. g. 120" style=" color:grey;">
                            </div>
                          </div>
						  <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Tuesday</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number" id="tuesday_price" value="<?php echo $pricing['tuesday_price']; ?>" onkeyup="updateTuesday(this.value);" style=" color:grey;">
                            </div>
                          </div>
						  ...
						  <div class="checkout__row">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Wednesday</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number" name="wednesday_price" id="wednesday_price"  value="<?php echo $pricing['wednesday_price']; ?>" onkeyup="updateWednesday(this.value);" placeholder="e. g. 120" style=" color:grey;">
                            </div>
                          </div>
						  <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Thursday</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number" id="thursday_price"   value="<?php echo $pricing['thursday_price']; ?>" onkeyup="updateThursday(this.value);" style=" color:grey;">
                            </div>
                          </div>
						  ...
						  <div class="checkout__row">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Friday</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number"  id="friday_price"   value="<?php echo $pricing['friday_price']; ?>" onkeyup="updateFriday(this.value);" placeholder="e. g. 120" style=" color:grey;">
                            </div>
                          </div>
						  <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Saturday</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number" id="saturday_price"   value="<?php echo $pricing['saturday_price']; ?>" onkeyup="updateSaturday(this.value);" style=" color:grey;">
                            </div>
                          </div>
						 ...
						 <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Sunday</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="number" id="sunday_price" value="<?php echo $pricing['sunday_price']; ?>" onkeyup="updateSunday(this.value);" style=" color:grey;">
                            </div>
                          </div>
 ...
 <div class="receipt" style="width: 100%; padding: 0px; border: none;  background: transparent;">
<div class="receipt__settings">
                <div class="receipt__setting">
                  <div class="receipt__wrap">
                    <div class="receipt__subtitle">Shortest duration</div>
                    <div class="receipt__content">What is the shortest duration a guest can stay for?</div>
                  </div>
                  <div class="counter js-counter" data-min="<?php echo $pricing['shortest_duration']; ?>" style="box-shadow: inset 0 0 0 1px #353945;">
                    <button class="counter__button js-counter-button js-counter-minus disabled" type="button" fdprocessedid="fzcwr" onclick="decrementNight();">
                      <svg class="icon icon-minus">
                        <use xlink:href="#icon-minus"></use>
                      </svg>
                    </button>
                    <div class="counter__value js-counter-value" id="totalNights"><?php echo $pricing['shortest_duration']; ?></div>
                    <button class="counter__button js-counter-button js-counter-plus" type="button" fdprocessedid="y2zrzu" onclick="incrementNight();">
                      <svg class="icon icon-plus">
                        <use xlink:href="#icon-plus"></use>
                      </svg>
                    </button>
                    <input class="js-counter-input js-counter-result js-counter-babies" id="totalNights1" type="hidden" value="<?php echo $pricing['shortest_duration']; ?>">
                  </div>
                </div>
                <div class="receipt__setting">
                  <div class="receipt__wrap">
                    <div class="receipt__subtitle">Discount(%)</div>
                    <div class="receipt__content">What discount do you offer for each 7 night stay?</div>
                  </div>
                  <div class="counter js-counter" data-min="<?php echo $pricing['discount_for_seven']; ?>"  style="box-shadow: inset 0 0 0 1px #353945;">
                    <button class="counter__button js-counter-button js-counter-minus disabled" type="button" fdprocessedid="s8xg2e" onclick="decrementDiscount();">
                      <svg class="icon icon-minus">
                        <use xlink:href="#icon-minus"></use>
                      </svg>
                    </button>
                    <div class="counter__value js-counter-value"><?php echo $pricing['discount_for_seven']; ?></div>
                    <button class="counter__button js-counter-button js-counter-plus" type="button" fdprocessedid="77my8" onclick="incrementDiscount();">
                      <svg class="icon icon-plus">
                        <use xlink:href="#icon-plus"></use>
                      </svg>
                    </button>
                    <input class="js-counter-input js-counter-result js-counter-babies" type="hidden" value="<?php echo $pricing['discount_for_seven']; ?>">
                  </div>
                </div>
              </div>
</div>
