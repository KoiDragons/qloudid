...
<div class="setting__container" style="padding:0px;">
 <div class="setting__head">
                    <h2 class="setting__title h2 hidden">Bank details</h2>  <a class="button-stroke button-small setting__button" href="../bankAccountDetail/<?php echo $data['cid']; ?>">Add account</a>
                  </div>
...
<div class="checkout__label changedText"><?php echo $value['account_holder_name']; ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['account_number']; ?></div>
 
<div class="checkout__controls">
 
<a href="javascript:void(0);"><button class="checkout__edit" fdprocessedid="22bs9r">
