		...
		<!-- HEADER -->
			...
			<div class="wi_100 hei_40p xs-pos_fix padtb5 padrl10 grey_header_bg" >
				...
				<div class="fright xs-dnone sm-dnone">
					<ul class="mar0 pad0">
						<li class="dblock hidden-xs hidden-sm fright pos_rel brdl brdclr_dblue"> <a href="https://www.safeqloud.com/user/index.php/NewsfeedDetail" id="usermenu_singin" class="translate hei_30pi dblock padrl25 red_bg uppercase lgn_hight_30 white_txt white_txt_h" data-en="Close" data-sw="Close">Close</a> </li>
					</ul>
				</div>
		...
		<div class="column_m pos_rel">
			...
			<div class="column_m container zi5 mart40" onclick="removeActive();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<!-- Center content -->
					<div class="wi_720p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla pad10 xs-pad0  white_bg">
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="container tab-header  talc dark_grey_txt mart20">
								...
								<select class="tab-header xs-wi_100 maxwi_100 dnone xs-dblock hei_30p pad0 nobrd brdb pblue2_bg">
							...
							<div class="container  white_bg fsz14 dark_grey_txt">
								...
								<div class="tab-content padb25 padt5 active" id="tab_total2">
									...
									<div class="padt20 padb10 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" >View More Employees</a>
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="myCustomer">
										<thead class="fsz16" style="color: #c6c8ca;">
												<tr class="lgtgrey2_bg">
													...
													<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5">Customer Name</div>
													</th>
									...
									<div class="padt20 padb10 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" onclick="add_more_all(this);">View More Customers</a>
										
									</div>
									
									<table class="wi_100" cellpadding="0" cellspacing="0" id="myLadlord">
										<thead class="fsz16" style="color: #c6c8ca;">
												<tr class="lgtgrey2_bg">
													<!--<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
													...
													<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5">Ladlord Name</div>
													</th>
									...
									<div class="padt20 padb10 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" >View More Ladlords</a>
										
									</div>
									
									
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mySchool">
										<thead class="fsz16" style="color: #c6c8ca;">
												<tr class="lgtgrey2_bg">
													<!--<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
													...
													<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5">School Name</div>
													</th>
									...
									<div class="padt20 padb10 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" >View More Schools</a>
										
									</div>
									
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mySuppliers">
										<thead class="fsz16" style="color: #c6c8ca;">
												<tr class="lgtgrey2_bg">
													<!--<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
													...
													<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5">Suppliers Name</div>
													</th>
									...
									<div class="padt20 padb10 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" >View More Suppliers</a>
								...
								<div class="tab-content " id="tab_total1">
									<table class="wi_100" cellpadding="0" cellspacing="0" id="myEmp">
										<thead class="fsz16" style="color: #c6c8ca;">
											<tr class="lgtgrey2_bg">
													<!--<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
									...
									<div class="padt20 padb10 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" >View More Customers</a>
										
									</div>
									
									<table class="wi_100" cellpadding="0" cellspacing="0" id="myLandlorda">
										<thead class="fsz16" style="color: #c6c8ca;">
											<tr class="lgtgrey2_bg">
													<!--<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
													...
													<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5">Landlord Name</div>
													</th>
									...
									<div class="padt20 padb10 talc">
										<a href="#" class="load_more_results dblue_btn marrl5" value="1" >View More Landlords</a>
										
									</div>
									
										<table class="wi_100" cellpadding="0" cellspacing="0" id="mySchoola">
										<thead class="fsz16" style="color: #c6c8ca;">
											<tr class="lgtgrey2_bg">
													<!--<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mySuppliersa">
										<thead class="fsz16" style="color: #c6c8ca;">
											<tr class="lgtgrey2_bg">
													<!--<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5"><input type="checkbox" name="check_all" class="check_all" /></div>
													...
													<th class="pad5 brdb nobold  tall" style="color:#c6c8ca;">
														<div class="padtb5">Supplier Name</div>
													</th>
