...
<a class="header__logo xs-fsz20 " href="../../repairRequest/<?php echo $data['cid']; ?>" style="
...
<h2 class="browse__title h2 changedText" style="
    font-size: 80px;
    line-height: 90px;
"><?php echo $repairRequest['ticket_title'];?></h2>
<div class="browse__info info changedText"><?php echo $repairRequest['ticket_subtitle'];?></div>
</div>
...
<div class=" ">
 ...
 <?php if(count($repairRequestDetailImages)>0)
 { ?>
<div class="gallery">
              <div class="gallery__list gallery__list_stays">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view" href="<?php echo $repairRequestDetailImages[0]['image_path']; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="<?php echo $repairRequestDetailImages[0]['image_path']; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#" class="xs-brdrad10">
                    <svg class="icon icon-image">
                      <use xlink:href="#icon-image"></use>
                    </svg><span>Show all photos</span></a></div>
					<?php  $i=1; foreach($repairRequestDetailImages as $category => $value)
												{
													if($i==1){ $i++; continue;}
												if($i>4) { break; } ?>
					<a class="gallery__preview xs-brdrad10" href="<?php echo $value['image_path']; ?>" data-fancybox="gallery"><img src="<?php echo $value['image_path']; ?>" alt="Gallery" class="xs-brdrad10"></a> 
												<?php $i++; } ?>
              </div>
            </div>
 <?php } ?>
...
<h4 class="changedText <?php if($repairRequest['problem_description']==null || $repairRequest['problem_description']=='') echo 'hidden';?>">Description</h4>
<p class="changedText"><?php if($repairRequest['problem_description']==null || $repairRequest['problem_description']=='') echo 'Description is not available. Please ask the admin to add the description on back end'; else echo $repairRequest['problem_description']; ?></p>
...
<div class="description__section" style="border-color:#E8681F; ">
<div class="description__content">
<h4 class="changedText">Address</h4>
 
				<div class="upload__row">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              <div class="field__wrap">
                                <div class="field__input changedText padtb10" type="text" name="service1" value="" readonly ><?php echo $repairRequest['address']; ?></div>
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              <div class="field__wrap">
							  <div class="field__input changedText padtb10" type="text" name="service2" value="" readonly ><?php echo $repairRequest['port_number']; ?></div>
					...
					<div class="upload__row">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              <div class="field__wrap">
                                <div class="field__input changedText padtb10" type="text" name="service3" value="" readonly ><?php echo $repairRequest['city']; ?></div>
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              <div class="field__wrap">
							  <div class="field__input changedText padtb10" type="text" name="service4" value="" readonly ><?php echo $repairRequest['zipcode']; ?></div>
...
<div class="upload__row">
                          <div class="upload__col upload__col_w50">
                           <a class="button checkout__button changedText" style="background: #3B71FE;" href="../../acceptRequest/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" >Accept</a>
                          </div>
                          <div class="upload__col upload__col_w50">
                            <a class="button checkout__button changedText" href="../../rejectRequest/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" >Reject</a>
                          </div>
                        </div>	
