...
<a class="header__logo xs-fsz25 changedText" href="../../guestReservationRequestList/<?php echo $data['cid']; ?>" style="
...
<div class="outer__inner mart25">
 ...
 <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item" style="background: none !important;"><a class="breadcrumbs__link" href="#" style="color:white;">Timeline</a></li>
      ...
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText xxs-mart50 " style="
                  line-height: 1.2;
                  font-size: 55px;
                  
				  font-weight:100
                  ">Property Transaction</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  "><?php echo  $guestReservationDetail['apartment_details']['bedroom_count']; ?> bedrooms, <?php echo  $guestReservationDetail['apartment_details']['bathroom_count']; ?> bathrooms, <?php echo  $guestReservationDetail['society_details']['society_name']; ?>, <?php echo  $guestReservationDetail['apartment_details']['floor_number']; ?>, <?php echo  $guestReservationDetail['apartment_details']['office_apartment_number']; ?> </div>
...
<div class="checkout__inner js-tabs wi_50 xs-wi_100 padl25 xs-padrl25" style="padding-right: 0px;">

<div class="section brands xsi-mart60" style="
    /* margin-top: 60px; */
    margin-bottom: 50px;
">
<div class="panel__nav hidden-xs"><a class="panel__link active" href="javascript:void(0);">Fast track</a></div>
<div class="brands__center center  xs-pad0" style="padding: 0px 0px;border-bottom: 1px solid #23262f;border-radius: none;">
<div class="brands__wrap">
<div class="brands__list" style="display:flex;">
 
			<div class="brands__item" style=""><a href="#"><div class="xxs-mart5 browse_info info fsz40 xsip-fsz20" style="font-family: 'Poppins', sans-serif;color: #ffffff;text-align: center;">$<?php echo  $guestReservationDetail['apartment_details']['sale_price']; ?></div><div class="xxs-mart5 browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Price</div></a>
</div>
...
<div class="brands__item" style="
    ...
    color: black;
	"><a href="#"><div class="xxs-mart5 browse_info info fsz40 xsip-fsz20" style="font-family: 'Poppins', sans-serif;color: #ffffff;text-align: center;">$0</div><div class="xxs-mart5 browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Paid</div></a></div>
...
<div class="brands__item" style=""><a href="#"><div class="xxs-mart5 browse_info info fsz40 xsip-fsz20" style="font-family: 'Poppins', sans-serif;color: #ffffff;text-align: center;">$0</div><div class="xxs-mart5 browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Remaining</div></a></div>
...
<div class="categories__center center1 xsi-nobrdb xsi-padb0" style="padding-bottom:40px; border-bottom:1px solid #353945;">
		 ...
		 <div class="card card_row" style="margin-bottom:24px; border:none; border-bottom: 1px solid #23262f !important;">
	 
					 
										 
                  <div class="card__body xxs-padtb24" style="background: #131922;">
                    <div class="card__line" style="
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#787f91; margin-bottom: 0px;">1. Request received</div>
...
">
			 <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo  $guestReservationDetail['society_details']['society_name']; ?></div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo  $guestReservationDetail['apartment_details']['bedroom_count']; ?> bedrooms</div>
                
				<div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>Floor no <?php echo  $guestReservationDetail['apartment_details']['floor_number']; ?></div>
				   <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>Apartment no <?php echo  $guestReservationDetail['apartment_details']['office_apartment_number']; ?></div>
				  
              </div>
			    
                       
                    
    <a   href="../../guestReservationDetailInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" style="
    
   "><button class="checkout__edit" fdprocessedid="y5dipkr">
...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
				  ...
				  <?php if($guestReservationDetail['is_accepted']==1) { ?>
				  <div class="card card_row" style="margin-bottom:24px; border:none; border-bottom: 1px solid #23262f !important;">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#787f91; margin-bottom: 0px;">2. Request approved</div>
...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#787f91; margin-bottom: 0px;">3. Reservation fee sent</div>
...
">
    ...
    <a   href="../../guestReservationFeeInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" style="
...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#787f91; margin-bottom: 0px;">4. Reservation fee paid</div>
...
">
    ...
    <a   href="../../guestReservationFeePaidInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" style="
...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#787f91; margin-bottom: 0px;">5. Add contract</div>
...
">
    ...
    <a   href="../../guestReservationAgreementInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" style="
...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
				  ...
				  <?php } ?>
				    ...
				    <?php if($guestReservationDetail['is_accepted']==1 && $guestReservationDetail['reservation_detail']['paid_method']>0 && $guestReservationDetail['agreement_count']==1) { ?>
				  <div class="card card_row" style="margin-bottom:24px; border:none; border-bottom: 1px solid #23262f !important;">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#787f91; margin-bottom: 0px;">5. Contract sent</div>
...
">
    ...
    <a   href="../../guestReservationAgreementSent/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" style="
...
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
				  ...
				  <?php } ?>
				   ...
				   <?php if($guestReservationDetail['is_accepted']==1 && $guestReservationDetail['reservation_detail']['paid_method']>0 && $guestReservationDetail['agreement_detail']['agreement_accept_on']!=null) { ?>
				  <div class="card card_row" style="margin-bottom:24px; border:none; border-bottom: 1px solid #23262f !important;">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:#787f91; margin-bottom: 0px;">6. Contract approved</div>
...
">
    ...
    <a   href="../../guestReservationInvoicesInfo/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" style="
