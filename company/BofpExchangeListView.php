         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Welcome To OFP Exchange</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Access a live list of Off Plan properties to trade for your clients today</div>
...
">
		...
		<div class="flights__center center xs-padrl25" style="padding-bottom:0px;">
		 ...
		 <div class="section destinations xs-padrl25  " style="margin-bottom:40px; border-bottom:1px solid #353945;">
		...
		<div class="sorting__foot">
                <div class="nav"><a class="nav__link " href="#">Active</a><a class="nav__link " href="#">Not-active</a><a class="nav__link active" href="#">Completed</a></div>
		...
		<div class="flights__center center xs-padrl25" style="padding-bottom:0px;">
		 ...
		 <div class="section destinations xs-padrl25  " style="margin-bottom:20px; ">
          <div class="destinations__center center" style="padding-bottom:20px; max-width: 1132px;">
              </div>
        </div>
		
		 
		  <div class="wi_100 xs-wi_100" style="border-bottom: none;margin-bottom: 10px;">
							...
							<div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
							  ...
							  <svg class="icon icon-flag">
								<use xlink:href="#icon-flag"></use>
									 ...
									 <a class="header__logo  changedText fright ButtonWhite" href="#" id="120" style="
