<head>
   ...
   {
	   var getValue=$('#available_services').val();
	   if($("#"+id).hasClass('lgtgrey_bg'))
	   {
		   ...
		   $('#'+id).removeClass('lgtgrey_bg');
			...
			$("#available_services").val(getValue);
	   }
	   else
	   {
		...
		{
			$('#error_msg_form').html('');
			if($("#available_services").val()=="" || $("#available_services").val()==null)
			{
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p  " style="padding: 10px 0px 0px 0px;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../approveHealthServiceRequest/<?php echo $data['cid']; ?>/<?php echo $data['wid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
                <div class="visible-xs visible-xsi visible-sm fleft padrl0">
							...
							<ul class="menulist sf-menu  fsz14">
								...
								<li class="first last" style="margin: 0 30px 0 0;">
									<a href="../../../approveHealthServiceRequest/<?php echo $data['cid']; ?>/<?php echo $data['wid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
								</li>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Here is a list of all your services please select which one are available for health service</a></div>
							  ...
							  <?php  foreach($completeMenu as $category => $value) 
									...
									<div class="thr_clmn  wi_75 ">
										...
										<div class="container column_m " >
										 <?php $i=1; foreach($value['dishes'] as $category => $value2) 
														{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php   echo $value2['dish_name']; ?> (<?php   echo ($value2['time_required']*15).' minutes'; ?>) </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php   echo $value2['dish_detail']; ?></span>  </div>
						...
						<form action="../../../updateHealthServiceMenu/<?php echo $data['cid']; ?>/<?php echo $data['wid']; ?>/<?php echo $data['hid']; ?>" method="POST" id="save_indexing" name="save_indexing" >				 
									 
							<input type="hidden" id="available_services" name="available_services" value="<?php if($healthServiceRequestDetail['available_services']!='' || $healthServiceRequestDetail['available_services']!=null) echo $healthServiceRequestDetail['available_services'].','; ?>" />
							</form>
							 <div class="clear">
