			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<li class="dblock padrb10  padt5 ">
						<a href="../pickaproServicesInformation/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space"  >Pickapro Services </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>						 
											</ul>
								...
								<?php $i=1;
									...
									<div class="clear"></div>
									 ...
									 <div  id="LocationDetailInfo">
										...
										$.ajax({
											type:"POST",
											url:"../moreServicesDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
