...
<!-- header-->
 <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg visible-xs" style="padding:0px;">
			...
			<a href="javascript:void(0);" onclick="submitForm();"> <div class=" talc   padt10 padb0 hei_45p black_txt" style="font-size:16px;">
					*** Add New Property ***
				</div></a>
...
<div class="header__country dropdown-item changedText" tolang="uk">Ukrainian</div></a>
 ...
 <a href="javascript:void(0);" class="header__item "  onclick="submitForm();"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText" fdprocessedid="gm7x7" onclick="submitForm();">Add object</button>
...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Select object</h2> 
                  </div>
...
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:<?php if($value['your_property']==1) echo 'white'; else echo '#10161d'; ?>;">
<div class="checkout__label changedText"><div class="description__parameters" style="
					border-top:none;
    margin-bottom: 0px;
    margin-top: 0px;
    padding-bottom: 0px;
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500; <?php if($value['your_property']==1) echo 'color:black'; ?>"><?php echo $value['streetAddress'].' '.$value['areaName']; ?></div>
 
<div class="checkout__controls">
 
<a href="../selectRequestType/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
