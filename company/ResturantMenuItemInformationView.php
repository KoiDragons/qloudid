					...
					<div class="wi_500p maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla  brdrad3 white_bg">
						<div class="padtb0 brdrad3 ">
							...
							<div class="padb20  talc padt20">
										<div class="padrl0 ">
											<img src="<?php echo $menuItemDetailInformation['dish_image']; ?>" width="160" height="160" class="white_brd borderr">
											
										</div>
									</div>

						<p class="lgn_hight_16 padt20 talc fsz20   padb0 marb0 xs-padb5 blue_67cff7 bold">Item <?php if($menuItemDetailInformation['temp_available_item']==1) echo 'Available'; else echo 'temporarily unavailable'; ?></p>
<h1 class="lgn_hight_35 padt10 marb15 talc fsz35 black_txt"><?php echo $menuItemDetailInformation['dish_name'].'('.$menuItemDetailInformation['dish_price'].')'; ?>  </h1>
						
						 <p class="fsz16 talc marb35"><?php echo $menuItemDetailInformation['dish_detail']; ?></p>

  
 						<div class="clear"></div>
	 		 <div class="on_clmn  mart20 talc padrl50">
			 	
						<div class="tw_clmn  wi_30 padr10 ">				
						 <a href="../../../deleteMenuItem/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['mid']; ?>"><input type="button" value="Delete item" class="forword minhei_55p ffamily_avenir red_bg"></a>	
							</div>	
						 	
							<div class="tw_clmn  wi_50 padl10 ">				
						 <a href="../../../updateMenuItem/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['mid']; ?>"><input type="button" value="Update status" class="forword minhei_55p ffamily_avenir green_bg"></a>	
							</div>		
