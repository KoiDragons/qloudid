...
<html>
	...
	<head>
		...
		function updateTicketSubcategory(id,id1)
		{
			$('#errorMsg').html('');
		var send_data={};
				 send_data.user_amenity_id=id;
				 send_data.subcategory_info=id1;
				 $.ajax({
							type:"POST",
							url:"../../../../../updateTicketSubcategory/<?php echo $data['aid']; ?>/<?php echo $data['category_id']; ?>",
							data:send_data,
							dataType:"text",
		...
		function updateAminitySubcategory(id,id1)
		{
			$('#errorMsg').html('');
				var send_data={};
				 send_data.user_amenity_id=id;
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../../updateAminitySubcategory/<?php echo $data['aid']; ?>/<?php echo $data['category_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateTicketCategoryAmenities(id,id1)
		{
			$('#errorMsg').html('');
		var send_data={};
				 send_data.user_amenity_category_id=id;
				 send_data.user_amenity_category_type=id1;
				 
				 $.ajax({
							type:"POST",
							url:"../../../../../updateTicketCategoryAmenities/<?php echo $data['aid']; ?>/<?php echo $data['category_id']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../../../../apartmentAmenityCategoryInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
         ...
         <div class="wi_100 hei_55p xs-pos_fix padtb5 padrl10 white_bg">
            <div class="visible-xs visible-sm fleft padrl0">
               <div class="flag_top_menu flefti  padb10 wi_70p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../../../../apartmentAmenityCategoryInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Amenities and features</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Update amenities available at your place</span> 
													 </div>
								 	...
								 	<div id="amenities_info">
										<?php echo $amenitiesSubcategoryDetail; ?>
										</div>
