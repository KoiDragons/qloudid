         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Centralize employee information and interactions.</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">Employeed</div>
                                      </a>
									  
									   <a class="categories__item    " href="javascript:void(0);" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Resigned</div>
                                      </a>
                ...
                <div class="nav"><a class="nav__link changedText" href="#" >Invited</a> <a class="nav__link changedText" href="#"  onclick="changeHeader();">Connected</a> <a class="nav__link changedText active" href="#"  >Registered</a></div>
 ...
 <div class="section destinations xs-padrl25  " style="margin-bottom:60px;">
  ...
  <div class="sorting__foot center padb40 hidden" style="">
                  <div class="nav"><a class="nav__link " href="#">All</a><a class="nav__link" href="#">Connected</a><a class="nav__link active" href="#">Pending</a> </div>
...
box-shadow:none;">
			   ...
			   <div class="travels__card bgFFFFFF"  >
                                  <div class="travels__preview"><img srcset="https://www.safeqloud.com/html/usercontent/images/notavailable.jpg" src="https://www.safeqloud.com/html/usercontent/images/notavailable.jpg"  alt="Card"></div>
                                  <div class="travels__body">
                                    <div class="travels__line">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: black;"><?php echo  substr(html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']),0,18); ?></div>
                                        <div class="travels__location" style="color: black;">Not verified</div>
                                      </div>
                                  
                        <a class="header__logo  changedText fright Button10161d" href="../../EmployeeDetail/sentAccount/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
