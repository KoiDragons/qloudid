         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Created Proposals</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Here is a list of all your created and sent proposals</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Off Plan Sale</div>
                                      </a>
			        ...
			        <a class="categories__item    " href="../../VitechProperties/listRentProposals/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle   txt_787f91">Turnkey Rental</div>
									     ...
									     <a class="categories__item    " href="../listSocietyProposalPaidInvoices/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Invoices</div>
                                      </a>
			  ...
			  <div class="sorting__foot">
                <div class="nav"><a class="nav__link " href="#">Active</a><a class="nav__link " href="#">Pending</a><a class="nav__link active" href="#">Completed</a></div>
                 
                   <div class="sorting__select hidden-xxs">
               <a href="../listBrokerProposalSociety/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button">
		  ...
		  <div class="flights__sorting hidden-xxs " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container" style="padding-left:0px;">
				...
				<?php $i=1; 
								foreach($listProposals as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;"><?php echo $value['first_name'].' '.$value['last_name']; ?></div>
