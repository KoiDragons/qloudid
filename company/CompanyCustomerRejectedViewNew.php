...
<div class="checkout__label changedText"><?php echo  $value['email']; ?></div>
...
<use xlink:href="#icon-arrow-next" style="fill:#E91E63;"></use>
   ...
   <?php $i=1; 
								foreach($requestRejectedDetailparent as $category => $value) 
												{
												?> 
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo  html_entity_decode($value['name']); ?></div>
