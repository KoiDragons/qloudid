   ...
   function submitForm()
		{
			...
			$("#error_msg_form").html('');
			if($("#port_number").val()==0)
			{
				
				$("#error_msg_form").html('Please select port number');
				return false;
			}
			if($("#floor_number").val()==0)
			{
				
				$("#error_msg_form").html('Please select floor number');
				return false;
			}
			if($("#apartment_number").val()==0 || $("#apartment_number").val()=="" || $("#apartment_number").val()==null)
			{
			 ...
			 if(isNaN($("#apartment_number").val())) 
				{
					$("#error_msg_form").html('Apartment number must be a numeric value');
					return false;
				}
			...
			if($("#apartment_size").val()==0 || $("#apartment_size").val()=="" || $("#apartment_size").val()==null)
			{
				...
				$("#error_msg_form").html('Please enter apartment size');
				return false;
			}
			
			 if(isNaN($("#apartment_size").val())) 
				{
					$("#error_msg_form").html('Apartment size must be a numeric value');
					return false;
				}
				
			if($("#apartment_price").val()==0 || $("#apartment_price").val()=="" || $("#apartment_price").val()==null)
			{
				
				$("#error_msg_form").html('Please enter sale price');
				return false;
			}
			
			 if(isNaN($("#apartment_price").val())) 
				{
					$("#error_msg_form").html('Apartment price must be a numeric value');
					return false;
				}
				
				
				if($("#apartment_price_m2").val()==0 || $("#apartment_price_m2").val()=="" || $("#apartment_price_m2").val()==null)
				{
					
					$("#error_msg_form").html('Please enter per m2 price');
					return false;
				}
			
			 if(isNaN($("#apartment_price_m2").val())) 
				{
					$("#error_msg_form").html('Apartment price must be a numeric value');
					return false;
				}
				...
				var send_data={};
				  send_data.apartment_number=$("#apartment_number").val();
				    send_data.floor_number=$("#floor_number").val();
				 $.ajax({
							type:"POST",
							url:"../../../checkFloorApartmentNumber/<?php echo $data['bid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								if(data1!=0)
								{
								$("#error_msg_form").html('Apartment apready exist! Please enter unique apartment number');	  	
								return false;
								}
								else {  
...
<a class="header__logo xs-fsz20 changedText " href="../../../listLandloardBuildingApartment/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Match Apartment to Port & Floor
</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Connect apartment with its corresponding port and floor before adding more details and publishing for sale.
</div>
...
<form class="checkout__item js-tabs-item" action="../../../updateUnrefineApartment/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
					 ...
					 <div class="checkout__row" style="margin-top:40px; margin-bottom:24px;">
                          <div class="field"  >
                            <div class="field__label  changedText" style="color:#787f91;">Select port <?php echo $unrefinedApartmentDetail['port_number']; ?></div>
                            <div class="field__wrap">
                               <select class=" "   id="port_number" name="port_number" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"   onchange="getFloors(this.value);">
	    <option value="0">Select</option>
	  <?php $i=1; foreach($portList as $category => $value) 
												{ ?>
													
								  <option value="<?php echo $value['id']; ?>"><?php echo $value['port_number']; ?></option>
												<?php } ?>
								  </select>
                            </div>
                          </div>
                          <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Select floor <?php echo $unrefinedApartmentDetail['floor_number']; ?></div>
                            <div class="field__wrap">
                               <select class=" "   id="floor_number" name="floor_number" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"   >
	    <option value="0">Select</option>
		  ...
		  function updateHeading()
			{
				if($("#filledInformation").hasClass('hidden'))
				{
					  
					 $('.travel__list').removeClass('marb100');
					 $('.travel__list').addClass('marb340');
					$("#filledInformation").removeClass('hidden');
				}
				else
				{
						  
					 $('.travel__list').addClass('marb100');
					 $('.travel__list').removeClass('marb340'); 
					$("#filledInformation").addClass('hidden');
				}
				 
					}
					 </script>
                <div class="setting__list">
  <div class="setting__box marb40">
                    <div class="setting__notification" style="border:none; margin-bottom:0px;">
                      <div class="setting__main">
                        <div class="setting__subtitle changedText">Do you want to verify file import information</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"  onclick="updateHeading();"   /><span class="switch__inner"><span class="switch__box" ></span></span>
                        </label>
                      </div>
						...
						<div class="hidden" id="filledInformation">
				...
				<div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="apartment_number" id="apartment_number" value="<?php echo $unrefinedApartmentDetail['apartment_number']; ?>" placeholder="e. g. 1000" style=" color:grey;" readonly >
                            </div>
                          </div>
						  
						  <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Total internal floor space </div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="apartment_size" id="apartment_size" value="<?php echo $unrefinedApartmentDetail['apartment_size']; ?>" placeholder="e. g. 1000" style=" color:grey;"  >
                            </div>
                          </div>
					 ...
					 <div class="checkout__row" style=" margin-bottom:24px;">
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 0px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Private entrance door</div>
                            <div class="field__wrap">
                               <select class=" " name="private_door_info" id="private_door_info" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
									background: transparent; width:100%;">
								   
										 
											<option value="1" <?php if($unrefinedApartmentDetail['private_door_info']==1) echo 'selected'; ?>>Yes</option>
											<option value="0" <?php if($unrefinedApartmentDetail['private_door_info']==0) echo 'selected'; ?>>No</option>
                          ...
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 0px 8px;">
                            ...
                            <div class="field__wrap">
                              <select class=" " name="elevator_info" id="elevator_info" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								<option value="1" <?php if($unrefinedApartmentDetail['elevator_info']==1) echo 'selected'; ?>>Yes</option>
											<option value="0" <?php if($unrefinedApartmentDetail['elevator_info']==0) echo 'selected'; ?>>No</option>
						  ...
						  <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px 0px 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Orientation</div>
                            <div class="field__wrap">
                              <select class=" " name="apartment_orientation" id="apartment_orientation" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								<option value="1" <?php if($unrefinedApartmentDetail['orientation']==1) echo 'selected'; ?>>East</option>
											  <option value="2" <?php if($unrefinedApartmentDetail['orientation']==2) echo 'selected'; ?>>West</option> 
											  <option value="3" <?php if($unrefinedApartmentDetail['orientation']==3) echo 'selected'; ?>>North</option>
											   <option value="4" <?php if($unrefinedApartmentDetail['orientation']==4) echo 'selected'; ?>>South</option>
								  </select>
                            </div>
                          </div>
                        </div>
						 ...
						 <div class="checkout__row" style=" margin-bottom:24px;">		
				<div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Apartment sale price</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="apartment_price" id="apartment_price" value="<?php echo $unrefinedApartmentDetail['sale_price']; ?>" placeholder="e. g. 1000" style=" color:grey;"  >
                            </div>
                          </div>
						  
						  <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Apartment price/m2</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="apartment_price_m2" id="apartment_price_m2" value="<?php echo $unrefinedApartmentDetail['price_m2']; ?>" placeholder="e. g. 1000" style=" color:grey;"  >
                            </div>
                          </div>
  	  				 
                     </div>
                       <input type="hidden" id="apartment_tenant" name="apartment_tenant" class="css-xt766" value="Vacant">
