						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex alit_fe justc_sb  pos_rel padb10 ">
                                <div class="white_bg tall">
									...
									</a> <a href="#"><span class="fas fa-cog fsz22 padl10 lgn_hight_29 valm"></span></a><a href="https://www.qloudid.com/company/index.php/Company/visitorsIP/<?php echo $data['cid']; ?>"><span class="fas fa-sign-in-alt fsz22 padl10 lgn_hight_29 valm"></span></a>
								</div>
			...
			<div class="tab-content active" id="mob-primary-menu" style="display: block;">
				<div class="wi_100 dflex alit_s justc_sb talc fsz16 xxs-fsz12">
					...
					<div class="tab-header">
						<a href="https://www.qloudid.com/company/index.php/DeliveryPickup/pickupInfo/<?php echo $data['cid']; ?>" class="dark_grey_txt dblue_txt_h">
