						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex alit_fe justc_sb  pos_rel padb10 ">
                                <div class="white_bg tall">
                                    ...
                                    <!-- Logo -->
                                    <h1 class="xs-bold green_91e9d5_txt fsz30 xs-fsz45 xs-talc">Inkommande brev och paket</h1>

                                    <div class="marb0 xs-talc"> <a href="#" class="blacka1_txt fsz16  xs-fsz20  talc edit-text jain_drop_company">Här kan du hantera inkommande brev och meddelandet till en anställd.</a></div>
									...
									<a href="https://www.safeqloud.com/company/index.php/DeliveryPickup/pickupInfo/<?php echo $data['cid']; ?>" class=" diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt ">
										
										<span class="valm">Registrera  </span>
									</a> <a href="#"><span class="fas fa-cog fsz22 padl10 lgn_hight_29 valm"></span></a><a href="https://www.safeqloud.com/company/index.php/Company/visitorsIP/<?php echo $data['cid']; ?>"><span class="fas fa-sign-in-alt fsz22 padl10 lgn_hight_29 valm"></span></a>
								</div>
						  ...
						  <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
                                <div class="container ">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_new xs-talc">
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 green_91e9d5_brdclr_a green_91e9d5_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active" data-id="utab_Popular">Har parkerat... </a>
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 green_91e9d5_brdclr_a green_91e9d5_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah" data-id="utab_Analytics">Uthämtad</a>
							  ...
							  <div class="tab_container mart10">
									...
									<table class="wi_100 " cellpadding="0" cellspacing="0" id="mytableleft">
										...
										<tbody id="allPickup">
											<?php $i=0;
												...
												foreach($pickUpDetail as $category => $value) 
												{
									...
									function add_more_my(link) {
										...
										$.ajax({
											type:"POST",
											url:"../morePickUpDetail/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
			...
			<div class="tab-content active" id="mob-primary-menu" style="display: block;">
				<div class="wi_100 dflex alit_s justc_sb talc fsz16 xxs-fsz12">
					...
					<div class="tab-header">
						<a href="https://www.safeqloud.com/company/index.php/DeliveryPickup/pickupInfo/<?php echo $data['cid']; ?>" class="dark_grey_txt dblue_txt_h">
