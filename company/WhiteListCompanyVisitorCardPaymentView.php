...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Pay</h2>

<h2 class="main__info info  tall  padb20 xs-padt20" style="font-weight: 100;color: #777E90; max-width: 100%; font-size:25px;">Add your card details to complete payment
</h2>
...
<div class="checkout__category">Your card detail</div>
...
<form class="checkout__item js-tabs-item" action="../../../updatePaymentDetail/<?php echo $data['cid']; ?>/<?php echo $data['meeting_id']; ?>/<?php echo $data['invoice_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 
<div class="checkout__fieldset">
 
<div class="field">
<div class="field__label" style="color:#525252;">Card number</div>
<div class="field__wrap">
<input class="field__input" name="card_number" id="card_number"    type="text"   style="background:#F4F5F6; height:60px; border:none; color:black;">
</div>
</div>
...
<div class="checkout__row" style="margin-bottom:32px;">
 <div class="field">
<div class="field__label" style="color:#525252;">Cvv</div>
<div class="field__wrap">
<input class="field__input"  name="cvv" id="cvv"    type="text"   style="background:#F4F5F6; height:60px; border:none; color:black;">
</div>
</div>
<div class="field">
<div class="field__label" style="color:#525252;">Expiry date</div>
<div class="field__wrap">
<input class="field__input"  name="exp_date" id="exp_date"  min="<?php echo date('Y-m-d'); ?>"  type="date"   style="background:#F4F5F6; height:60px; border:none; color:black;"  >
</div>
</div>
