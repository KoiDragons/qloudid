...
var dict = {
	...
	function changeClass(link)
			...
			function sendInformation()
			{
				...
				if($("#car_res_num").val()=="" || $("#car_res_num").val()==null)
				{
					$("#error_msg_form").html('Please enter License plate number');
					return false;
				}
					...
					$.ajax({
						type:"POST",
						url: "../enterInParking/<?php echo $data['cid']; ?>",
						data:send_data,
						dataType:"text",
						...
						success: function(data1){
							if(data1==0)
							{
							$("#error_msg_form").html('Car is already in parkering. You cant register same car twice !!!');
							return false;	
							}
							else
							{
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100   xxs-fsz45 padb10 trn ffamily_avenir" style="color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000000"; else echo $corporateColor['bg_color']; ?>">Register</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Register your car here for 3 hours of free parking. Enter your car registration number below to start your parking.</a></div>
					...
					<!-- Center content -->
						...
						<div class="collaborator-row dflex alit_c pos_rel">
							...
							<form action="#" method="POST" name="save_indexing" id="save_indexing">
							 
									<div class="on_clmn mart10 xxs-mart10 marb35">
											
										<div class="pos_rel">
										<input type="text"  name="car_res_num" id="car_res_num" placeholder="xxxxxxxx"  class=" wi_100 nobrdt nobrdl nobrdr pad10  red_f5a0a5_txt brdb_red_ff2828 talc  minhei_65p fsz18  fsz16 ffamily_avenir"  onkeyup="updateForm();">
									</div>
									</div>
								...
								<button type="button" name="forward" class="forward hei_55p fsz18 trn ffamily_avenir" onclick="sendInformation();" style="background:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000000"; else echo $corporateColor['bg_color']; ?>">Next</button>
...
<script type="text/javascript" src="<?php echo $path; ?>html/vacancycontent/js/jquery-ui.min.js"></script>
		...
		<script type="text/javascript" src="<?php echo $path; ?>html/usercontent/js/parkering.js"></script>
</body>
</html>