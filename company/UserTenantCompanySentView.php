				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Here is the list of request sent to tenants</a></div>
						...
						<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
											  ...
											  <a href="#" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir">Received</a>
                                               <a href="../../../../monitorAccount/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir">Approved</a>
											     <a href="#" class="dinlblck mar5 padrl30     bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir">Sent</a>
												<a href="../../../../rejectedAccount/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" class="padrl30_a padrl10 fsz18 midgrey_txt lgn_hight_36 "><i class="fas fa-trash-alt" aria-hidden="true"></i></a>
                                        </div>
					 		<?php $i=1;
												
												foreach($requestDetailSent as $category => $value) 
												{
