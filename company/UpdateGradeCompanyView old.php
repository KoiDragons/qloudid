	...
	<body class="white_bg">
		...
		<div class="logo marr15 wi_140p xs-wi_80p xxxs-wi_140p">
			...
			<div class="flag_top_menu flefti padt20 padb10 hidden-xs" style="width: 50px; ">
				...
				<div class="visible-xs visible-sm fright marr0 padr0 xsi-padt10 xs-padt5"> <a href="zoho_hr_portal7_subscription.html" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Erbjudande</a> </div>
				<div class="clear"></div>
			</div>
		</div>
		...
		<div class="column_m pos_rel" onclick="checkFlag();">
					...
					<div class="wrap maxwi_100   xs-nobrdb xs-padt15 xs-padb0 mart40 xs-mart0">
						<div class="dflex xs-fxwrap_w alit_c">
							<div class="wi_50 xs-wi_100 flex_1 order_1 xs-order_1 xs-tall tall mart10 brdrad5 marr30 xs-marr0">
								...
								<h4 class="bold fsz45 xs-fsz40 padb10 tall  ">Du är snart klar...</h4>
								<!--<h3 class="fsz25 padb10 brdb_red_new tall hidden-xs lgn_hight_30"></h3>-->
									...
									<div class="talc padtb10 "> <a href="#"  onclick="submit_value();"><input type="button" value="Signera med Mobilt BankId" class="nobrd wi_100 maxwi_500p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 panlyellow_bg fsz18 xs-fsz16 darkgrey_txt trans_all2"  ></a>
			...
			<div class="result-item padtb0  lgtgrey2_bg">
				...
				<span class="marr5 valm">Genera</span>
				...
				<div class="sources-content  dnone padb0 " >
				<ul class="mar0 pad0  fsz14">
				<li class="dflex mart10  padb5">
				<div class="wi_50 ovfl_hid ws_now txtovfl_el">
				<a href="#" class="black_txt">Grade :</a>
				</div>
				<span class="fxshrink_0 marrl50"><?php if($verificationId==1) echo "A"; else if($verificationId==2) echo "AA"; else if($verificationId==3) echo "AAA"; ?></span>
				</li>
