...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
									  ...
									  <a class="categories__item    " href="../listInvoice/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
					...
					<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">To pay</div>
                                      </a>
									  
									  <a class="categories__item    " href="../listComissionhandledInvoice/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle    txt_787f91" >Paid</div>
                                      </a>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title wi_30" style="font-size:20px; color:white; margin-bottom: 0px;">Broker commission</div>
                ...
                <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  ...
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>$<?php echo $value['payment_amount']+abs(($value['payment_amount']*$value['vat'])100); ?></div>
                
              </div>
                         <a href="../handleCommissionInvoice/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;" >
