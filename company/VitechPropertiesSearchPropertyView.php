...
<!-- outer-->
<div class="outer"  style="background: #00000069;">
<!-- header-->
...
<a class="header__logo changedText" href="../listEmployeesCreatedProperties/<?php echo $data['cid']; ?>" style="
...
<div class="section description   xs-padb0" style=" border:none;" id="loginBank">
<div class="description__center  ">
<div class="browse__head" style="padding-right:0px;">
<h2 class="browse__title h2 xs-tall changedText" style="
    font-size: 80px;
    line-height: 90px;
">Property</h2>
<div class="browse__info info xs-tall changedText">Enter address to check and register your property.</div>
 
<form action="../listAvailableProperties/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" class="subscription subscription_big" style="margin-top: 65px;" accept-charset="ISO-8859-1" >
<input class="subscription__input" type="text"   name="address" id="address" placeholder="Add street address" required="required">
  
<a href="javascript:void(0);"  onclick="submitform();"><div class="subscription__btn" style="background:#f67f00; vertical-align: baseline;">
<svg class="icon icon-search" style="margin-top:10px;">
<use xlink:href="#icon-search" style="fill:black" ></use>
</svg>
</div> </a>
</form>

<div class="red_txt fsz20 talc padt20" id="error_msg_form"> </div>
</div>
