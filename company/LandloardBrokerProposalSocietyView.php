...
<a class="header__logo xs-fsz25 changedText" href="../../VitechProperties/listPropertyProposal/<?php echo $data['cid']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="../../VitechProperties/listPropertyProposal/<?php echo $data['cid']; ?>">
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			          ...
			          <a class="categories__item    " href="../../VitechProperties/listAddedProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Turnkey</div>
                                      </a>
		 ...
		 <div class="section travels">
          <div class="travels__center " style="">
...
box-shadow:none;">
			   ...
			   <?php $i=1; 
								foreach($getLandloardProposalCommunityList as $category => $value) 
										{
											 
												
										 ?> 
			   <div class="travels__card  bg10161d" id="p<?php echo $value['id']; ?>">
                     <div class="travels__preview"><img srcset="<?php echo $path; ?>estorecss/tmp<?php echo $value['imageId']; ?>.jpg" src="<?php echo $path; ?>estorecss/tmp<?php echo $value['imageId']; ?>.jpg"  alt="Card" style="border-radius: 50%; padding: 20px 40px;">
								   
								  </div>
                                  <div class="travels__body">
                                    <div class="travels__line" style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: #777E90;"><?php echo $value['society_name']; ?></div>
                                        <div class="travels__location" style="color: #777E90;"><?php echo substr($value['company_name'],0,15); ?></div>
                                      </div>
   ...
   " onclick="selectWishlist(<?php echo $value['id']; ?>);">Select</a>
                ...
                <form class="checkout__item js-tabs-item talc" action="../../VitechProperties/teamVailable/<?php echo $data['cid']; ?>" method="POST" id="save_indexing_proposal" name="save_indexing_proposal" accept-charset="ISO-8859-1" style="display: block;">		
					 				<input type="hidden" id="proposal_data"	name="proposal_data" value="" />
									<input type="hidden" id="proposal_type"	name="proposal_type" value="3" />
