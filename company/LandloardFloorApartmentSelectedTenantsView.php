...
<html>
	...
	<head>
	 ...
	 function submitForm()
	 {
		 ...
		 if($('#tenant_id').val()==0)
			{
				$('#error_msg_form').html('please select tenant whom you want to invite.');
				return false;
			}
		...
		function updateTenantSelect(id)
		{
		 $('#errorMsg').html('');
		 $("#tenant_id").val(id);
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateTenantInvite/<?php echo $data['aid']; ?>/<?php echo $data['bid']; ?>",
							data:send_data, 
							dataType:"text",
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Please select the tenant for invitation" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
								 	...
								 	<div id="bathroom_info">
										<?php echo $buildingtenantSelectedInfo; ?>
										</div>
						<form action="../../../../invitetenatToConnect/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
						<input type="hidden" id="tenant_id" name="tenant_id" value="0" />
						</div>
