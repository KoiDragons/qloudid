...
<html>
	...
	<body class="white_bg">
		...
		<div class="column_m header hei_55p  bs_bb white_bg visible-xs" id="dHeader" >
			 ...
			 <div class="visible-xs visible-sm fright marr0 padt5 "> <a href="../../VerifiyID/verifiyIDAccount/<?php echo $data['cid']; ?>" class=" diblock padl7 padr7 brdrad3 fsz30 seggreen_47E2A1_txt"><i class="fas fa-plus " aria-hidden="true"></i></a> </div>
										...
										<li class=" dblock pos_rel padb10 padt0 brdclr_hgrey ">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  <?php echo $selectIcon['app_bg']; ?> black_txt white_txt_h black_txt_a" style="border-radius:0%;"> <span class="valm trn" >Verify ID </span> 
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="https://www.qloudid.com/company/index.php/BudandLeverans/packageInfo/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn"> Brev & Leverans</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											...
											<li class="dblock padrb10">
													<a href="../../WhitelistIP/messageInfo/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Partner</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											</ul>
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex xxs-dfex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 ">
								<div class="white_bg tall xs-talc">
									 ...
									 <h1 class="fsz30 xs-fsz45 blue_67cff7 xs-talc">Tidsbegränsade samtycken</h1>

                                    <div class="marb0 xs-talc"> <a href="#" class="blacka1_txt fsz16  xs-fsz20  talc edit-text jain_drop_company">Alla profiler som godkänt för att dela sin data med ert bolag i 24 timmar.</a></div>
									 
										
									 </div>
									 <div class="hidden-xs hidden-sm padrl10">
											<a href="../../VerifiyID/verifiyIDAccount/<?php echo $data['cid']; ?>" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt " >
							...
							<div class="tab-header mart10 padb10 brdb_new xs-talc">
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd brdclr_seggreen_47E2A1_h brdclr_seggreen_47E2A1_a brdrad40 seggreen_bg_a lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active" data-id="utab_Popular">Anslutna</a>
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd brdclr_seggreen_47E2A1_h brdclr_seggreen_47E2A1_a brdrad40 seggreen_bg_a lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah" data-id="utab_Analytics">Verifiera</a>
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd brdclr_seggreen_47E2A1_h brdclr_seggreen_47E2A1_a brdrad40 seggreen_bg_a lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah" data-id="utab_Advertising">Skickade</a>
                                            <a href="#" class="xs-padrl10 padrl30 fsz18 dark_grey_txt seggreen_47E2A1_txt_a lgn_hight_36" data-id="utab_AB_Testing"><i class="fas fa-trash-alt"></i></a>
						  ...
						  <div class="tab_container mart10">
								...
								<div class="tab_content hide" id="utab_Analytics" style="display: none;">
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable1">
										<thead class="fsz16" >
											<tr class="fsz16 blue_67cff7_brd nobrdt nobrdl nobrdr">
												<!--<th class="pad5 brdb_new nobold  tall" >
													<div class="padtb5 black_txt"><input type="checkbox" name="check_all" class="check_all" /></div>
												</th>-->
												<th class="pad5 blue_67cff7_brd nobold nobrdt nobrdl nobrdr tall" >
													<div class="padtb5 black_txt">Verified by</div>
												</th>
												
												<th class="pad5 blue_67cff7_brd  nobrdt nobrdl nobrdr nobold hidden-xs tall" >
													<div class="padtb5 black_txt">Personal number</div>
												</th>
												<th class="pad5 blue_67cff7_brd nobrdt nobrdl nobrdr nobold  tall" >
								...
								<script>
								 ...
								 <div class="tab_content active" id="utab_Popular" style="display: block;">
									...
									<table class="wi_100" cellpadding="0" cellspacing="0" id="mytable">
										<thead class="fsz16" >
											<tr class="fsz16 blue_67cff7_brd nobrdt nobrdl nobrdr">
												...
												<th class="pad5 blue_67cff7_brd nobrdt nobrdl nobrdr nobold  tall hidden-xs" >
									...
									<div class="clear" ></div>
									<div class="padt20 talc">
										<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width  ffamily_avenir" value="1" onclick="add_more_rows_approved_Connections(this);">Visa fler</a>
								...
								<script>
								  ...
								  <div class="tab_content hide" id="utab_AB_Testing" style="display: none;">
									...
									<div class="clear" ></div>
									<div class="padt20 talc">
										<a href="#" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width  ffamily_avenir" value="1" onclick="add_more_rows_rejected_Connectionss(this);">Visa fler</a>
