...
<a class="header__logo xs-fsz20 " href="../../CompanySuppliers/companyAccount/<?php echo $data['cid']; ?>" style="
...
<a href="../../ProfessionalCompany/listUnconnectedMarketplaces/<?php echo $data['cid']; ?>" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Add marketplace</button>

</div></a>
		
<a href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>" class="header__item " style="margin-left:0px;"><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">ADMIN VIEW</h2>
...
<div class="sorting__line" style="
    ...
    margin-bottom: 24px;
">
                    <div class="sorting__sale hidden" style="
    font-size: 20px;
    font-weight: 100;
    background: #131922;
    color: grey;
...
"><?php echo $companyDetail['country']; ?></div>
                    <div class="sorting__details" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Welcome, this is the admin view of the company
</div>
</div></div></div>
            ...
            <div class="catalog__center center">
              <div class="catalog__cards"  style="margin:0px;">
			   ...
			   <?php $i=0;
						...
						<a class="card  " href="../companyProfileMarketplaceServices/<?php echo $data['cid'];?>/<?php echo $value['enc']; ?>" style="<?php if($i%3==0) echo 'margin-left:0px !important;'; ?>">
                  <div class="card__preview"><img srcset="<?php echo $value['background_image']; ?>" src="<?php echo $value['background_image']; ?>" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category changedText" style="background: white; color:black;  "><?php echo str_ireplace('&','and',html_entity_decode($value['marketplace_name'])); ?> </div>
                  </div>
                  </a>
