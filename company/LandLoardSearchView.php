				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc xs-padb15  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn nobold" > Search and connect with your landlord.</a></div>	
							
								 
									 
					 
						<form action="../../landLoardSearch/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" method="POST" id="save_indexingcs" name="save_indexingcs" accept-charset="ISO-8859-1">
						<div class="dflex alit_s marb15">
								<input type="message" name="message" class="minhei_65p flex_1 padrl15 lgtgrey_bg nobrd fsz15" placeholder="Company name" value="">
							...
							<div class="padtb20 talc  <?php if(isset($_POST['message'])) echo ''; else echo 'hidden'; ?>">
										...
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width"  value="1" onclick="add_more_rows(this,this.value);">View more</a>
									</div>
					...
					function add_more_rows(link,id) {
								...
								$.ajax({
									type:"POST",
									url:"../../companyListNew/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>",
									data:send_data,
									dataType:"text",
