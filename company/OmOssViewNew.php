                ...
                <div class="setting__list">
                    ...
                    <div class="setting__notification" style="border:none; margin-bottom:0px;">
                      <div class="setting__main">
                        ...
                        <label class="switch">
                          <input class="switch__input" type="checkbox"  onclick="updateHeading(<?php echo $value['id'];?>);" <?php if($value['is_active']==1) echo 'checked'; else echo ''; ?> /><span class="switch__inner"><span class="switch__box" style="background: #f67f00;"></span></span>
                        </label>
                      </div>
