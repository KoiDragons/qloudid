...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Data Protection Compliance</h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Manage your GDPR regulations with ease and professionalism
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Active</div>
                                      </a>
			           <a class="categories__item  bg_E7E7E7 " href="../receivedRequests/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Request</div>
                                      </a>
									   <a class="categories__item  bg_E7E7E7 " href="../sentRequests/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Sent</div>
                                      </a>
									   <a class="categories__item  bg_E7E7E7 " href="../rejectedList/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Trash</div>
                                      </a>
</div>
</div>
</div>
			   ...
			   <div class="sorting__foot center">
                  <div class="nav"><a class="nav__link active changedText" href="#">Employee without location</a><a class="nav__link changedText" href="#">Employees with location</a><a class="nav__link changedText" href="#">Parents</a> </div>
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php     foreach($approveDetailLocation as $category => $value) 
										{
...
<div class="card__preview card__preview1" style="width: 161px;padding: 30px;"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="London - Kings Cross" style="
												padding: 20px;
												border-radius: 30px;
											">
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667">Employee</div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo  substr(html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']),0,18); ?>
</div>
...
"> </div>
 <div class="card__cost fsz14" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="../../EmployeeDetail/employeeAccount/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>" style="
   ...
   <?php   }   foreach($requestApprovedDetailparent as $category => $value) 
										{
...
<div class="card__body pad2435 xs-pad24" style="background: #131922;padding-left: 0px;">
<div class="card__line wi_70">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo  $value['child_name'].' - Parent'; ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php echo  $value['name']; ?>
</div>
...
"> </div>
 <div class="card__cost fsz14" style="
    padding-top: 10px; font-weight:100;
">
   <a class="header__logo xs-fsz20 changedText fright" href="#" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
