   ...
   function informEmployee()
			{
				...
				{
				$("#error_msg_form").html('Please select payment date');
					return false;	
				}
				
				
				if($("#total_payment").val()=='' || $("#total_payment").val()==null)
				{
				$("#error_msg_form").html('Please enter total payment');
					return false;	
				}
...
<div class="travel__center center   padb136 xs-padrl25" style="border-bottom:2px solid #23262F;  padding-bottom:80px; max-width: 1132px;
    padding-right: 0px;
    padding-left: 0px;">
   ...
   <div class="travel__row " style="margin-bottom: 15px;">
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list xs-marb0  marb100" style="
            max-width: 425px;
            ">
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Simple steps to reserve a apartment
</div>
...
<form class="checkout__item js-tabs-item" action="../../../updateReservationApartment/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
					 ...
					 <div class="checkout__row" style="margin-top:40px; margin-bottom:24px;">
                          <div class="field"  >
                            <div class="field__label  changedText" style="color:#787f91;">Payment mode</div>
                            <div class="field__wrap">
                               <select class=" "   id="payment_mode" name="payment_mode" style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;"   >
                          ...
                          <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Payment date</div>
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="payment_date" id="payment_date" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" style=" color:grey;"  >
                            </div>
                          </div>
  ...
  <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Total payment</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="total_payment" id="total_payment" placeholder="e. g. 1000" style=" color:grey;"  >
                            </div>
                          </div>
