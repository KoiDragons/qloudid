...
<html>
	...
	<head>
		...
		function updateOpentime(id,id1)
		{
			$('#errorMsg').html('');
			var send_data={};
				 send_data.id=id;
		...
		function updateCloseTime(id,id1)
		{
			$('#errorMsg').html('');
			var send_data={};
				 send_data.id=id;
		...
		function updateAminity(id,id1)
		{
			$('#errorMsg').html('');
				var send_data={};
				 send_data.id=id;
				 send_data.update_info=id1;
				 $.ajax({
							type:"POST",
							url:"../../updateAminity/<?php echo $data['sid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateMultiSubcategory(id,id1,id2)
		{
			$('#errorMsg').html('');
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updateMultiSubcategory/<?php echo $data['sid']; ?>",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir"  >Amenities</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Please update amenities available at - <?php echo $societyDetailInfo['society_name']; ?></a></div>
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Complete your community" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Amenities and features</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Update amenities available at your community</span> 
													 </div>
									...
									<div id="amenities_info">
									   ...
									   <?php echo $communityAmenitiesInfo; ?>
