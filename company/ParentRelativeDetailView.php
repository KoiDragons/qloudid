			  ...
			  <div class="visible-xs visible-sm fright marr0 ">
				...
				<ul class="menulist sf-menu  fsz14  sf-js-enabled sf-arrows mart10 marb0">
                  ...
                  <li><a href="../parentRelativeDetail/<?php echo $data['child_id']; ?>" class="fsz16i"><span class="fas fa-users padr15"> </span>Parents</a></li>
				   ...
				   <li><a href="javascript:void(0);" class="fsz16i"><span class="fas fa-users padr15"> </span>Drop & Pick up</a></li>
				   <li>
                    <div class="line martb10"></div>
                  </li>
                    </ol>
                                 ...
                                 <a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brdb tb_67cff7_bg brd_width_2 black_txt  padb10">
                                    ...
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
												...
												<div class="padb20 xxs-padb0 ">
													...
													<div class="wrap maxwi_100 dflex xxs-dfex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 brdb_blue1">
														<div class="white_bg tall xs-talc">
															...
															<!-- Logo -->
															<h1 class="black_txt fsz30 xs-fsz45 xs-talc ffamily_avenir">Approved</h1>
															<!-- Logo -->
															<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz20  edit-text jain_drop_company ffamily_avenir">Här ser du en lista på personer tillagda av föräldrarna</a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
																<!-- Meta -->
													...
													<div class="container mart10 column_m fsz14 dark_grey_txt">
											...
											<div class="wi_100 xs-wi_100 xs-order_3   fsz12 ffamily_avenir">
																			<div class="fleft wi_50 xs-wi_100 sm-wi_100 marl15 xxs-marl15 "> <span class="trn fsz14 ffamily_avenir" data-trn-key="<?php if($value['permission_type']==1) echo 'Drop in'; else if($value['permission_type']==2) echo 'Pick up'; else if($value['permission_type']==3) echo 'Both'; ?>"> <?php if($value['permission_type']==1) echo 'Drop in'; else if($value['permission_type']==2) echo 'Pick up'; else if($value['permission_type']==3) echo 'Both'; ?></span> <span class=" edit-text jain1 dblock  brdclr_lgtgrey2 fsz18 black_txt"><?php echo $value['name']; ?></span> </div>
