			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40" id="loginBank">
				<div class="wrap maxwi_100 padrl15 xs-padrl25">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Update your community amenity rules here</a></div>
									
								 
								 	
								<?php 
												foreach($communitySelectedAmenitiesRulesInfo as $category => $value) 
												{
												?> 	
								...
								<a href="#profile<?php echo $value['id']; ?>" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active"><?php echo $value['rule_heading']; ?>
								...
								<div id="profile<?php echo $value['id']; ?>" >	
									<?php 
												foreach($value['rules'] as $category => $value1) 
												{
												?> 
								   <div class="on_clmn    brdb">
									...
									<div class="thr_clmn  wi_75 ">
										...
										<?php echo $value1['community_rule']; ?>
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  <?php if($value1['is_available']==1) echo 'checked'; else echo ''; ?>" onclick="updateRules(<?php echo $value1['id']; ?>);">
