...
<html>
	...
	<head>
		...
		function updatePublishInfo(id)
		{
		 var send_data={};
				send_data.id=id; 
				 $.ajax({
							type:"POST",
							url:"../../../../updatePublishInfo/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Minimum five photos of apartment need to be added before you publish the apartment</a></div>
					 ...
					 <div class="clear"></div>
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Apartment publish status" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										 
									</div>
									 </div>
									
							 	 <form action="../../../../updateApartmentStatusInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">	
									...
									<div class="thr_clmn  wi_75 ">
										...
										<input type="text" value="Do you want to publish apartment?" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" readonly="">
										 
									</div>
									</div>
										<div class="thr_clmn  wi_25 <?php if($objectPhotoCount<5 || $apartmentDescriptionDetail['is_completed']==0)echo 'hidden'; ?>"  >
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt20 xs-padt15 marl0 fsz25  padb0  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright  <?php if($objectDetail['is_published']==1) echo 'checked'; ?>" onclick="updateFood(1,this);">
									 ...
									 <input type="hidden" id="food1" name="food1" value='<?php echo $objectDetail['is_published']; ?>'   />

										</div>
									 <?php if($objectPhotoCount>=5 && $apartmentDescriptionDetail['is_completed']==1) { ?> 
									<div id="food_1" class="<?php if($objectDetail['is_published']==0) echo 'hidden'; ?>">
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Apartment status</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">What is the current status of the apartment?</span> 
													 </div>
													 
													
												
												<div class="css-11e5cyp padt10">
											 <select id="apartment_status" name="apartment_status" class="css-bnguuq dropdown-bg">
											 <option value="0">Published</option>
											 <option value="1" <?php if($objectDetail['bidding_status']==1) echo 'selected'; ?>>Bidding started</option>
											 <option value="2" <?php if($objectDetail['bidding_status']==2) echo 'selected'; ?>>Bidding closed</option> 
											 <option value="3" <?php if($objectDetail['bidding_status']==3) echo 'selected'; ?>>Sold</option>
					 ...
					 <div class="talc padtb20 ffamily_avenir mart35 "> <a href="javascript:void(0);" onclick="submitForm();"><button type="button" value="Update" class="forword minhei_55p  fsz18    ffamily_avenir">Update</button></a> </div>
									...
									<div class="clear"></div>
									<?php if($objectPhotoCount<5 || $apartmentDescriptionDetail['is_completed']==0) { ?>
								<div class="red_txt fsz20 tall" ><ul><?php if($objectPhotoCount<5) { ?><li>Please complete photo info </li> <?php } ?> <?php if($apartmentDescriptionDetail['is_completed']==0) { ?><li>Please complete apartment description info </li> <?php } ?> </ul></div>			
									<?php } ?>
