 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Booking</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Your Guest Reservations</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Manage all bookings from one place, with real-time updates.</div>
...
">
	...
	<div class="section destinations xs-padrl25  " style="margin-bottom:60px;">
          <div class="destinations__center center" style="b max-width: 1132px;">
              </div>
        </div>
		<div class="section flights" style="margin-bottom:0px;">
          <div class="flights__center center xxs-padrl25">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			    <a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Reservations</div>
                                      </a>
			    <!--<a class="categories__item    " href="../reservationCheckedInList/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Checked-in</div>
                                      </a>
				
									  
									   <a class="categories__item    " href="../reservationCheckedOutList/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Checked-out</div>
                                      </a>
									  
									  <a class="categories__item    " href="../cleaningPendingList/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Clean now</div>
                                      </a>-->
			   ...
			   <div class="sorting__foot">
                 <div class="nav"><a class="nav__link active changedText" href="#">Reservation</a> <a class="nav__link changedText" href="../reservationCheckedInList/<?php echo $data['cid']; ?>">Checked in</a> <a class="nav__link changedText " href="../reservationCheckedOutList/<?php echo $data['cid']; ?>">Checked out</a></div>
                 
                   <div class="sorting__select">
               <a href="#">  <button class="button-stroke catalog__button">
                  <span class="changedText">Add reservation</span>
                </button></a>
                </div>
              </div>
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
								foreach($apartmentBookingList as $category => $value) 
										{
										 ?> 
										 
										 
					<div class="card card_row" style="margin-bottom:24px; ">
    ...
    margin-bottom: 15px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px;color:white;padding-top: 8px;"><?php echo $value['name']; ?></div></a>
<button class="button-stroke flight__button" style="
    width: 150px;
"><span class="flight_price">$<?php echo $value['price']; ?></span> </button>
                       
                    </div>
					 
                    <div class="receipt_description receipt_description_flex" style="
    margin-bottom: 20px; background: #23262F; border-radius:16px;
">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('M d, Y',strtotime($value['checkin_date'])); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('M d, Y',strtotime($value['checkout_date'])); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo $value['guest_adult']+$value['guest_children']; ?> guests</div>
                  </div>
                </div>
              </div>
    ...
    padding-top: 10px;
    font-weight:100;
">Reservation confirmed</div>

   <a class="header__logo  changedText fright" href="javascript:void(0);" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #<?php if($value['reservation_confirmed']==1) echo '0f842b'; else echo 'ff2828'; ?>;
   border-radius: 5px;
   font-family: Avenir;
   font-size: 14PX;
   line-height:20px !important;
   border: 2px solid #<?php if($value['reservation_confirmed']==1) echo '0f842b'; else echo 'ff2828'; ?>;
   "><?php if($value['reservation_confirmed']==1) echo 'Yes'; else echo 'No'; ?></a>
   </div>
...
">Prechecked-in</div>
   ...
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #<?php if($value['precheckin_status']==1) echo '0f842b'; else echo 'ff2828'; ?>;
   border-radius: 5px;
   font-family: Avenir;
   font-size: 14PX;
   line-height:20px !important;
   border: 2px solid #<?php if($value['precheckin_status']==1) echo '0f842b'; else echo 'ff2828'; ?>;
   "><?php if($value['precheckin_status']==1) echo 'Yes'; else echo 'No'; ?></a>
   </div>
...
">Checked-in</div>
   ...
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #<?php if($value['checked_in']==0) echo 'ff2828'; else echo '0f842b'; ?>;
   border-radius: 5px;
   font-family: Avenir;
   font-size: 14PX;
   line-height:20px !important;
   border: 2px solid #<?php if($value['checked_in']==0) echo 'ff2828'; else echo '0f842b'; ?>;
   "><?php if($value['checked_in']==0) echo 'No'; else  echo 'Yes'; ?></a>
   </div>
...
">Checked-out</div>
   ...
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #<?php if($value['checked_in']==2) echo '0f842b'; else echo 'ff2828'; ?>;
   border-radius: 5px;
   font-family: Avenir;
   font-size: 14PX;
   line-height:20px !important;
   border: 2px solid #<?php if($value['checked_in']==2) echo '0f842b'; else echo 'ff2828'; ?>;
   "><?php if($value['checked_in']==2) echo 'Yes'; else echo 'No'; ?></a>
   </div>
