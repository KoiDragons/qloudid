...
<a class="header__logo xs-fsz25 changedText" href="../listPropertyProposal/<?php echo $data['cid']; ?>" style="
...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="../listPropertyProposal/<?php echo $data['cid']; ?>">
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Select Properties</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select the properties you wish to present in the proposal.</div>
      ...
      <div class="section destinations xs-padrl25  " style="margin-bottom:60px;">
		...
		<div class="section flights" style="margin-bottom:0px;">
          <div class="flights__center center xs-padrl25">
		 	...
		 	<div class="section categories  marl6 " style="margin-bottom: 40px; margin-top: 20px; padding-bottom:40px; border-bottom:1px solid #353945;">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			    ...
			    <a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Turnkey</div>
                                      </a>
				
			          <a class="categories__item    " href="../../LandloardBroker/listBrokerProposalSociety/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Off plan</div>
                                      </a>
		 ...
		 <div class="section travels">
          <div class="travels__center xs-pad0" style="">
