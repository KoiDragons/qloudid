...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../viewPropertyServices/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>" style="
...
<div class="checkout__inner js-tabs wi_50 xs-wi_100" style="padding-right:0px;">
  ...
  <form action="../../../updateTaskAssignment/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="UTF-8">
   					  
						  <div class="checkout__line  margin-bottom24">
					   <div class="checkout__subtitle uppercase changedText">Assign task</div>
                               ...
                               <select class="" id="responsible_for_property" name="responsible_for_property" style="height: 48px;
								...
								color: grey; border-radius: 12px;
								  ...
								  <?php  $i=1; foreach($listEmployees  as $category => $value) 
												{ ?>
											<option value="<?php echo $value['id']; ?>"  <?php if($value['id']==$servicesRequestManager['responsible_for_property']) echo 'selected'; ?>><?php echo $value['first_name'].' '.$value['last_name']; ?></option>
												<?php } ?>	 
								  </select>
                            </div>
                          </div> 	
						...
						<a class="button checkout__button changedText pad15" href="javascript:void(0);" onclick="submitForm();" style="background: #3B71FE;">Submit</a>
</div>
