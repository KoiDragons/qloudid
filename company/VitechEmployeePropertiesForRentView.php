...
<html lang="en">
  ...
  <body class="dark" style="background: #131922">
    ...
    <div class="outer">
      <!-- header-->
  <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg visible-xs" style="padding:0px;">
				<div class="wi_100 hei_45p xs-pos_fix padt0 padrl10 black_bg" style="background:#52D4F4 !important">
				
				 
			<a href="../selectMethod/<?php echo $data['cid']; ?>"> <div class=" talc   padt10 padb0 hei_45p black_txt" style="font-size:16px;">
					*** Add New Property ***
				</div></a>
...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg><span>Go home</span></a>
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Properties</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Turnkey Property CRM</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Manage and update your property listings</div>
...
">
       ...
       <div class="section destinations xs-padrl25  " style="margin-bottom:60px;">
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			      <a class="categories__item    " href="../listImportedProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Not completed</div>
                                      </a>
									  
			    <a class="categories__item    " href="../listEmployeesProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">For Sale</div>
                                      </a>
									    
				<a class="categories__item    " href="#" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">For Rent</div>
                                      </a>
...
{
	window.location.href='https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesCreatedProperties/<?php echo $data['cid']; ?>';
}
</script>
</div> <div class="sorting__foot">
                <div class="nav"><a class="nav__link  changedText" href="../listEmployeesCreatedRentProperties/<?php echo $data['cid']; ?>" onclick="changeHeader();">Prepare</a> <a class="nav__link changedText active" href="#"  >Published</a> <a class="nav__link changedText" href="#"  >Reserved</a><a class="nav__link changedText" href="#"  >Occupied</a></div>
                 
                   <div class="sorting__select hidden-xxs">
                <a href="../selectMethod/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button">
                  <span class="changedText">Add property</span>
                </button></a>
                </div>
              </div>
		...
		<div class="section flights">
		  ...
		  <div class="flights__sorting  hidden-xxs" style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
    ...
    margin-bottom: 0px;
">
                   <a href="../viewPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;"> <div class="flight__title changedText fsz30 xsi-fsz23" style="color:white;"><?php echo $value['sellPhrase']; ?></div></a>
                        <div class="card__price" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099;">
                        <div class="card__old">$<?php echo $value['night_price']; ?></div>
                        <div class="card__actual">$<?php echo $value['night_price']; ?></div>
                      </div>
                    </div>
					<div class="card__options hidden">
                      <div class="card__option">
                        <svg class="icon icon-clock">
                          <use xlink:href="#icon-clock"></use>
                        </svg>Mjölnerbacken                      </div>
                      <div class="card__option">
                        <svg class="icon icon-user">
                          <use xlink:href="#icon-user"></use>
                        </svg>Bookable service
                      </div>
					  <div class="card__option">
                        <svg class="icon icon-user">
                          <use xlink:href="#icon-user"></use>
...
">
                ...
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['numberOfBathrooms']; ?> WC</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                    ...
                    <div class="card__foot">
                      ...
                      <div class="card__comment <?php  if($value['longSellingDescription']=="" || $value['longSellingDescription']==null) echo 'hidden'; ?>" style=" <?php if($value['completed']<100) echo 'border-bottom: 1px solid #23262f;    padding-bottom: 20px;'; else echo 'margin-bottom:0px;' ?> ">
