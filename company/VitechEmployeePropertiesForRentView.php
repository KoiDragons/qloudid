...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.qloudid.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
...
{
	window.location.href='https://www.qloudid.com/company/index.php/VitechProperties/listEmployeesCreatedProperties/<?php echo $data['cid']; ?>';
}
</script>
