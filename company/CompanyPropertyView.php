...
<div class="header__country dropdown-item changedText" tolang="uk">Ukrainian</div></a>
	 	...
	 	<a href="../locationInformation/<?php echo $data['cid']; ?>" class="header_item " style="margin-left:0px;"><div class="header_item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz14 hidden-xs changedText bold" style="color:#777E90">Add office</button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.qloudid.com/company/index.php/CompanySuppliers/companyProfileServices/<?php echo $data['cid']; ?>">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Offices</a></li>
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Offices with same company identification number.
</div>
...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Select office</h2> 
                  </div>
...
<div class="checkout__label changedText">Head office</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $headquarterDetail['visiting_address']; ?></div>
 
<div class="checkout__controls">
 
<a href="../editProperty/<?php echo $data['cid'].'/'.$headquarterDetail['enc']; ?>"><button class="checkout__edit"  >
...
<a href="../../CompanyProperty/todoInfo/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
  ...
  <a href="../../CompanySuppliers/companyAccount/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">Office</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['visiting_address']; ?></div>
 
<div class="checkout__controls">
 
<a href="../editProperty/<?php echo $data['cid'].'/'.$value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-edit" style="fill:#52d4f4;"></use>
</svg>
</button></a>
<?php if($value['count']==0 || $headquarterDetail['rent_permises']==0 || $headquarterDetail['offer_education']==0 || $headquarterDetail['add_employee']==0) { ?>
<a href="../../CompanyProperty/todoInfo/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
