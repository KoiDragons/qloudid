...
<head>
    ...
    <script>
		...
		{
		$("#amount").val(id);
		document.getElementById("save_50").submit();
		}
    </script>
</head>
...
<body class="bsa_bb white_bg lgn_hight_s1375 fsz14 txt_2d3e50">
 <!-- HEADER -->
		<div class="column_m header header_small bs_bb grey_header_bg" >
			<div class="wi_100 hei_40p xs-pos_fix padtb5 padrl10 grey_header_bg" >
				...
				<div class="fright xs-dnone sm-dnone">
					<ul class="mar0 pad0">
						<li class="dblock hidden-xs hidden-sm fright pos_rel "> <a href="https://www.safeqloud.com/user/index.php/CompanyNews/companyNewsAccount/<?php echo $data['cid']; ?>" id="usermenu_singin" class="translate hei_30pi dblock padrl25 red_bg uppercase lgn_hight_30 white_txt white_txt_h brdrad3" data-en="Close" data-sw="Close">Close</a> </li>
					</ul>
				</div>
	...
	<!-- TAB HEADER -->
	<div class="column_m pos_rel zi1 lgtblue2_bg">
	...
	<div class="mart40 padt30 maxwi_960p dflex xs-dblock alit_fs marrla marb100 xs-marb50 padr15 xs-padrl15">
		...
		<div class="flex_1">
			...
			<div class="tab-content" id="tab-Free">
				<form class="calculation-form">
					...
					<div class="dflex fxwrap_w alit_c justc_sb">
						...
						<a href="#" class="hei_40p dflex alit_c justc_c marb15 padtb5 padrl15 brd brdclr_ff7a59 brdrad3 bg_ff7a59 bg_fff8f6_h talc bold txt_f txt_ed6748_h hidden">Get started free</a>
					</div>
					<p>
			...
			<div class="tab-content" id="tab-Starter">
				<form class="calculation-form" id="save_50" name="save_50" method="POST" action="../../ChargePayment/paymentAccount/<?php echo $data['cid']; ?>">
				<input type="hidden" name="amount" id="amount" value="" />
					...
					<div class="dflex fxwrap_w alit_c justc_sb">
						...
						<a href="#" class="hei_40p dflex alit_c justc_c marb15 padtb5 padrl15 brd brdclr_ff7a59 brdrad3 bg_ff7a59 bg_fff8f6_h talc bold txt_f txt_ed6748_h" onclick="submitForm(50);">Talk to Sales</a>
					</div>
					<p>
			...
			<div class="tab-content" id="tab-Basic">
				<form class="calculation-form">
					...
					<div class="dflex fxwrap_w alit_c justc_sb">
						...
						<a href="#" class="hei_40p dflex alit_c justc_c marb15 padtb5 padrl15 brd brdclr_ff7a59 brdrad3 bg_ff7a59 bg_fff8f6_h talc bold txt_f txt_ed6748_h" onclick="submitForm(200);">Talk to Sales</a>
					</div>
					<p>
			...
			<div class="tab-content" id="tab-Professional">
				<form class="calculation-form">
					...
					<div class="dflex fxwrap_w alit_c justc_sb">
						...
						<a href="#" class="hei_40p dflex alit_c justc_c marb15 padtb5 padrl15 brd brdclr_ff7a59 brdrad3 bg_ff7a59 bg_fff8f6_h talc bold txt_f txt_ed6748_h" onclick="submitForm(800);">Talk to Sales</a>
					</div>
					<p>
						For solo marketers and small marketing teams. Run complete inbound marketing campaigns.
					</p>
			...
			<div class="tab-content" id="tab-Enterprise">
				<form class="calculation-form">
					...
					<div class="dflex fxwrap_w alit_c justc_sb">
						...
						<a href="#" class="hei_40p dflex alit_c justc_c marb15 padtb5 padrl15 brd brdclr_ff7a59 brdrad3 bg_ff7a59 bg_fff8f6_h talc bold txt_f txt_ed6748_h" onclick="submitForm(2400);">Talk to Sales</a>
					</div>
					<p>
