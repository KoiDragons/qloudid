                  ...
                  <li>
				   ...
				   <li>
					...
					<div class="fright xs-dnone sm-dnone padt10">
						<ul class="mar0 pad0">
							<li class="dblock hidden-xs hidden-sm fright pos_rel brdl "> <a href="../../Brand/brandAccount/<?php echo $data['cid']; ?>" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Stäng sidan" data-sw="Stäng sidan">Stäng sidan</a> </li>
						</ul>
					</div>
					...
					<div class="visible-xs visible-sm fright marr0 padr0 xsi-padt10"> <a href="../../Brand/brandAccount/<?php echo $data['cid']; ?>" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Close</a> </div>
					<div class="clear"></div>
				</div>
			</div>
									...
									<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75">
										...
										<li class=" dblock pos_rel padb10 padt0 brdclr_hgrey ">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  <?php echo $selectIcon['app_bg']; ?> black_txt white_txt_h black_txt_a" style="border-radius:0%;"> <span class="valm trn" >Om oss</span> 
											...
											<li class="dblock padrb10">
												...
												<li class="dblock padrb10">
													<a href="../../FooterInformation/completeInfo/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn" >Footer</span> 
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											</ul>
							...
							<div class="column_m container zi1 padb30">
									<div class="wrap maxwi_100 dflex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 brdb_new">
										<div class="white_bg tall">
											...
											<!-- Logo -->
											<h1 class="fsz25 bold">Om bolaget...</h1>
											<!-- Logo -->
											<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text jain_drop_company">Berätta om ditt företag här nedan...</a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
												<!-- Meta -->
							...
							<div class="bsa_bb txt_0_87" id="keep">
								...
								<div class="column_m  marb10 white_bg fsz14 dark_grey_txt" id="scroll-section-<?php echo $value['id'];?>">
									<div class="container padb30 fsz25">
										<div class="padb0 fsz20 hidden"><?php echo html_entity_decode($value['heading']);?></div>
