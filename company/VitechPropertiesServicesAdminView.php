...
<a class="header__logo " href="../../listProperties/<?php echo $data['cid']; ?>" style="
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Manage and update your property listings as admin</div>
				  ...
				  <div class="flights__box">
					...
					<?php $i=1; 
								foreach($displayproperties as $category => $value) 
										{
											$url='https://www.safeqloud.com/company/index.php/VitechProperties/viewPropertyServices/'.$data['cid'].'/'.$value['enc'];
										 ?> 
                     <a href="javascript:void();" style="text-decoration:none;" onclick="changeUrl('<?php echo $url; ?>');"> <label class="checkbox">
                        <input class="checkbox__input" type="checkbox" <?php if($value['enc']==$data['pid']) echo 'checked="checked"';?>><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__flex"><span class="checkbox__text"><?php echo $value['streetAddress'].' '.$value['areaName']; ?></span><span class="checkbox__counter hidden">$2,568</span></span></span>
                      </label></a>
                      <?php } ?> 
                    </div>
                  </div>
...
<div class="checkout__list  " style="/* margin-top:16px; */">
 <a class="card card_row  " style="border:none;  margin-bottom: 20px;" href="jaavscript:void(0);">
	  <div class="card__preview" style="width: 161px;padding: 30px; background: #23262F;"><img   src="<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" alt="London - Kings Cross" style="
												padding: 20px;
												border-radius: 88px;
											">
...
<div class="card__line wi_70" style="
    ...
    margin-bottom: 10px;
">
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $getPropertyDetailInfo['streetAddress'].' '.$getPropertyDetailInfo['areaName']; ?></div>
...
">
                <div class="description__parameter">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php  echo $getPropertyDetailInfo['numberOfBedrooms']; ?> Bedrooms</div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $getPropertyDetailInfo['numberOfBathrooms']; ?> Bathrooms</div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $getPropertyDetailInfo['area']; ?> sqm</div>
              </div>
...
">
                ...
                <div class="description__parameter" style="margin-left:0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>qloudsuperagent2@qualeefy.com</div>
...
<div class="checkout__box">
   <?php $i=1; 
								foreach($propertyServicesRequest as $category => $value) 
										{
										 ?> 
...
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $value['subcategory_name']; ?></div>
 
<div class="checkout__controls">
 
<a href="../../propertyTaskAssignment/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit">
<svg class="icon icon-arrow-next" style="
    width: 24px;
    height: 24px;
">
<use xlink:href="#icon-arrow-next" style="fill:#ff8d4c;width: 24px;height: 24px;"></use>
</svg>
</button></a>
 
<button class="checkout__edit js-date-close" style="display: none;">
...
<use xlink:href="#icon-edit"></use>
 ...
 <div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;background: #ffffff;">
<div class="checkout__label changedText">Want to add more</div>
<div class="changedText" style="
    font-size: 16px;
    line-height: 1.5;
    font-weight: 500;
    color: black;
...
<a href="../../selectRequestType/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>"><button class="checkout__edit">
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-plus" style="fill: #000000;"></use>
</svg>
</button></a>
