...
{
	window.location.href='https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesRentProperties/<?php echo $data['cid']; ?>';
}
</script>
</div> <div class="sorting__foot">
                <div class="nav"><a class="nav__link active changedText" href="#" >Prepare</a> <a class="nav__link changedText" href="../listEmployeesRentProperties/<?php echo $data['cid']; ?>"  onclick="changeHeader();">Published</a> <a class="nav__link changedText" href="#"  >Reserved</a><a class="nav__link changedText" href="#"  >Occupied</a></div>
...
">
 <?php  echo $value['longSellingDescription']; ?> </div>
					  ...
					  <div class="card__flex <?php if($value['completed']==100) echo 'hidden'; ?>" style="background-color:#52D4F5; padding:10px; border-radius:5px;">
                        <div class="card__cost fsz14 changedText" style="
    padding-top: 0px;  font-weight:100; color:black;
"><?php echo $value['completed']; ?>% Completed </div>

<a href="../<?php echo $value['nextUrl']; ?>/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value['row_request_id']; ?>" style="text-decoration:none;">
						 <div class="card__price" style="color:black; box-shadow: none; padding:0px;">
                         
                        <div class="card__actual"><svg class="icon icon-home" style="width:24px; height:24px">
                    <use xlink:href="#icon-arrow-next" style="fill:black;"></use>
                  </svg></div>
                      </div></a>
				...
				<?php if($value['is_activated']==1 && $value['completed']==100){  ?>
...
<a class="header__logo  changedText fright" href="../publishPropertyForRent/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
