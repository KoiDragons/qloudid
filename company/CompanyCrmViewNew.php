...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="https://www.safeqloud.com/company/index.php/InviteEmployee/selectMethod/<?php echo $data['cid']; ?>" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
<button class="header__head js-header-head fsz16 hidden-xs changedText">Add employees</button>
...
<h2 class="browse__title h2 changedText xs-fsz60 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" >Employees</h2>
<div class="browse__info info changedText">This is a list of employees added by admin manually, by file or integration.</div>
</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
			     ...
			     <a class="categories__item  bg_E7E7E7 " href="../uninvitedEmployeesAccount/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Uninvited</div>
                                      </a>
									  
									  <a class="categories__item  bg_E7E7E7 " href="../oldEmployeesAccount/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Old</div>
                                      </a>
...
<div class="checkout__box">
 <?php $i=1; 
								foreach($approveDetailLocation as $category => $value) 
												{
												 if($value['verify_emp']==0)
	{?>											
	<a class="card card_row " style="border:none; border-radius: 20px;margin-bottom: 20px;" href="../../EmployeeDetail/getIdentificator/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>">
	<?php } else { ?>
	<a class="card card_row " style="border:none; border-radius: 20px;margin-bottom: 20px;" href="../../EmployeeDetail/employeeAccount/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>">
 <?php } ?>
...
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;">Agent
</div>
...
<?php $i=1; 
  ...
  <a class="card card_row " style="border: 2px solid #353945;border-radius: 20px;margin-bottom: 20px;" href="../../EmployeeDetail/sentAccount/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">
...
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;">Sent employee request
</div>
