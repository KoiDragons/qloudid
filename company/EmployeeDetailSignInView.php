   ...
   $('#android').removeClass('hidden');
	...
	<div class="clear" id=""></div>
		...
		<div class="column_m pos_rel">
			...
			<form action="../../verifyIdentificatorDetail/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
			<input type="hidden" name="total_value" id="total_value" value='<?php echo json_encode($_POST,true); ?>' />
