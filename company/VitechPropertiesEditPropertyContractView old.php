...
<script>
 ...
 <div class="upload__head" style="margin-bottom:0px;">
                  <h2 class="upload__title h2">Update Your Property</h2>  
				  
                </div>
				<div class="browse__info info changedText padb40" style="border-bottom: 2px solid #353945;">Complete the form below to update your property contract
</div>
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
  ...
  <div class="upload__col upload__col_w30">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <select class=" "   id="country_id" name="country_id"  <?php if($fetchPropertyTaskInfo['owner_email']!=null || $fetchPropertyTaskInfo['owner_email']!='') echo 'disabled'; ?> style="height: 48px;
      ...
      background: transparent; width:100%;">
						  ...
						  <div class="upload__col upload__col_w70">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="uphno" id="uphno" value="<?php echo $fetchPropertyTaskInfo['owner_phone']; ?>" placeholder="e. g. xxxxx12342" style=" color:grey;" <?php if($fetchPropertyTaskInfo['owner_email']!=null || $fetchPropertyTaskInfo['owner_email']!='') echo 'readonly'; ?> >
                            </div>
                          </div>
						  </div>
						  </div >
