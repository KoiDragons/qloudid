...
<html lang="en">
 ...
 <body class="dark" style="background-color:#131922">
  <script>
					...
					$.ajax({
						type:"POST",
						url:"../updateServiceCategory/<?php echo $data['cid']; ?>",
						data:send_data,
						dataType:"text",
...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Select Your Services</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Tailor the apps you need by choosing the services your business offers.</div>
...
<div class="setting__container" style="padding:0px;">
		<h2 class="setting__title h2 hidden" style="margin-bottom: 64px;">Services</h2>
			<div class="description__group">
			<?php echo $selectedCompanyServices; ?>
		</div>
    </div>
        </div>
      </div>
