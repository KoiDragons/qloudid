...
<html>
	...
	<head>
		...
		function updateTenantSelect(id,id1)
		{
		 $('#errorMsg').html('');
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateTenantSelect/<?php echo $data['aid']; ?>/<?php echo $data['bid']; ?>",
							data:send_data, 
							dataType:"text",
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Please select the tenant for the apartment" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
