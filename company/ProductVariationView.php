...
<html>
	...
	<head>
		...
		{
			window.location.href ="https://www.safeqloud.com/company/index.php/ProductVariation/detailInfo/<?php echo $data['cid']; ?>";
		}
			var currentLang = 'sv';
		</script>
	</head>
         ...
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg"  >
            <div class="fleft padrl0 bg_babdbc padtbz10" >
			 ...
			 <div class="fright   padtbz10   ">
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="../detailInfo/<?php echo $data['cid']; ?>" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
			...
			<!-- CONTENT -->
			 <div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
						...
						<a href="../../FoodCourt/dishesInformation/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space"  >Articles</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li> 
											<li class="dblock padrb10 ">
											<a href="../../FoodCourt/foodInformation/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space"  >Food </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
											<li class="dblock padrb10 first">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space">Variants </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>		
												<li class="dblock padrb10 padt5">
											<a href="../../FoodCourt/servicesInformation/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space"  >Services </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>	 
											</ul>
					...
					<div class="wi_500p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xsi-padrl20 xs-pad0">
					 ...
					 <div class="padb0 xxs-padb0 ">		
						...
						<div class="tab-header martb0 padb10 xs-talc  nobrd talc">
										...
										<input type="text" value="Variations" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
									 ...
									 <?php $i=0;
												...
												foreach($variationInfo as $category => $value) 
												{
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_50p marr15  "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz25   brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	...
																	border-radius: 10%;"><?php echo substr($value['variation_name'],0,1); ?> </div>
																	</div>
													
													<div class="fleft  wi_60 xs-wi_70    xs-mar0  ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo substr($companyDetail['company_name'],0,20); ?></span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt"><?php echo $value['variation_name']; ?></span>  </div>
								...
								<div  id="moreCategory">
										...
										<div class="clear"></div>
														...
														<div class="padtb20 talc <?php if($productVariationCount['num']<=10) echo 'hidden'; ?> ">
								...
								<script>
										function add_more_rows_category(link) {
															...
															$.ajax({
															type:"POST",
															url:"../moreVariationInfo/<?php echo $data['cid']; ?>",
															data:send_data,
															dataType:"text",
