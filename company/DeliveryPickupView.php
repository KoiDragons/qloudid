...
<script>
			...
			function sendInformation()
			{
				...
				else if($("#desc").val()=="" || $("#desc").val()==null)
				{
					...
					$("#error_msg_form").html('Please enter item description');
					return false;
				}
...
<body class="white_bg">
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz45  padb10 xs-bold green_91e9d5_txt trn">Paket...</h1>
									</div>
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Registrera att du har tagit emot ett brev eller paket och meddelat anställd för upphämtning.</a></div>
						...
						<div class="collaborator-row dflex alit_c pos_rel">
							...
							<form action="" method="POST" name="collaborators-form" id="collaborators-form">
							 ...
							 <div class="on_clmn mart10 xxs-mart10 ">
										...
										<div class="pos_rel">
										<input type="text"  name="empname" placeholder="Namn på den du ska träffa..." id="collaborators-lookup" class="wi_100 rbrdr pad10  brdb talc  minhei_65p fsz18 pink_bg llgrey_txt fsz16"  onkeyup="updateForm();">
									</div>
									</div>
									  ...
									  <div class="on_clmn mart10 xxs-mart10 marb35">
										...
										<div class="pos_rel">
										<input type="text"  name="desc" id="desc" placeholder="Beskrivning" class="wi_100 rbrdr pad10  brdb talc  minhei_65p fsz18 pink_bg llgrey_txt fsz16"  >
									</div>
									</div>
								...
								<div class="fsz16 red_txt" id="error_msg_form"></div>
									
							 <div class="padt5 xxs-talc talc">
								<button type="button" name="forward" class="forword minhei_65p green_91e9d5_bg  fsz18 trn " onclick="sendInformation();">Registrera</button>
	...
	<div class="popup_modal wi_350p maxwi_90 pos_fix pos_cen zi50 bs_bb white_bg fsz14 brdrad5" id="person_informed">
			<div class="modal-content pad25  nobrdb talc brdrad5 ">
				...
				<div id="error_msg_form1" class="fsz20"> </div>
