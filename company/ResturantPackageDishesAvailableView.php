				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn ffamily_avenir"  >Thali</h1>
									</div>
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Add dishes to below categories. If you dont add any dish then that category will not be seen on the thali menu</a></div>
					 		...
					 		<?php $i=1;
												...
												foreach($resturantPackageItemDetail as $category => $value) 
												{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $value['food_category']; ?></span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">Available dishes under this category</span> 
													 </div>
											...
											<div class="clear"></div>
												...
												foreach($value['dishes'] as $category => $value1) 
												{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $value1['dish_name']; ?></span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs "><?php echo $value1['dish_detail']; ?></span> 
													 </div>
													<a href='../../../removeItemFromPackage/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['pid']; ?>/<?php echo $value['enc']; ?>/<?php echo $value1['enc']; ?>'><div class="fright wi_10 padl0 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz40  padb0 xxs-marr20 ">
														  <span class="fas fa-minus txt_cfdbea" aria-hidden="true"></span> 
													</div></a>
											...
											<div class="clear"></div>
												...
												<a href="../../../SelectPackagesItems/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>/<?php echo $data['pid']; ?>/<?php echo $value['enc']; ?>"><button color="#444444" class="merlin-button css-7wfern fleft t_67cff7_bg  mart10" aria-label="">
