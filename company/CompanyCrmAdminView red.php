               ...
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			    <a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">Employeed</div>
									   ...
									   <a class="categories__item    " href="../oldEmployeesAccount/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
...
function changeHeader(id)
{
	...
	{
		window.location.href='https://www.safeqloud.com/company/index.php/CompanyCrm/registeredAccount/<?php echo $data['cid']; ?>';
	}
}
</script>
                ...
                <div class="nav"><a class="nav__link changedText" href="#" onclick="changeHeader(1);">Invited</a>  <a class="nav__link changedText " href="#"  onclick="changeHeader(2);">Registered</a> <a class="nav__link changedText active" href="#"  >Connected</a></div>
...
box-shadow:none;">
			   ...
			   <div class="travels__card bgFFFFFF"  >
                                  <div class="travels__preview"><img srcset="<?php echo $value['img']; ?>" src="<?php echo $value['img']; ?>"  alt="Card" style="border-radius: 50%;
                                  ...
                                  <div class="travels__body">
                                    <div class="travels__line"  style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        ...
                                        <div class="travels__location" style="color: black;">Verified</div>
                                      </div>
                             <?php if($value['location_verified']==1) { ?>          
                        <a class="header__logo  changedText fright Button10161d" href="../../EmployeeDetail/employeeAccount/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>" id="<?php echo $value['id']; ?>" style="
   ...
   <?php } else { ?>
   <a class="header__logo  changedText fright Button10161d" href="../../CompanyCustomers/companyCustomersLocation/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" id="<?php echo $value['id']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
