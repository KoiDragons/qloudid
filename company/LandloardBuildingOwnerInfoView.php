		...
		function submitform()
		{
		 ...
		 if($("#first_name").val()==null || $("#first_name").val()=="")
			...
			send_data.email=$("#email").val();	 
				 $.ajax({
							type:"POST",
							url:"../../checkOwnerEmailInfo/<?php echo $data['bid']; ?>",
							data:send_data,
							dataType:"text",
								 ...
								 else
								 {
									  var send_data={};
										...
										send_data.pass_country=$("#pass_country").val();	 
											 $.ajax({
														type:"POST",
														url:"../../checkOwnerPassportInfo/<?php echo $data['bid']; ?>",
														data:send_data,
														dataType:"text",
														contentType: "application/x-www-form-urlencoded;charset=utf-8",
														success: function(data1){
			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40" id="loginBank">
				<div class="wrap maxwi_100 padrl15 xs-padrl25">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please add your object owner here.</a></div>
							...
							<form action="../../addOwner/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								
								 
								<div class="marb0   padtrl0 white_bg">
								<div class="marrl0 padb15 brdb fsz16 white_bg tall padt20">
								<a href="#profile5" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active">Owner type 
								...
								<div id="profile5" class=" " style="display:block;">	
										...
										<div class="pos_rel">
										<select id="owner_type" name="owner_type" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select"     />
												 ...
												 <label for="owner_type" class="floating__label tall nobold padl10" data-content="Owner type">
								...
								<div id="profile" class=" " style="display:block;">	
										...
										<select id="fcountry" name="fcountry" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select"     />
											...
											<div class="pos_rel">
												...
												<input type="text" name="f_number" id="f_number" placeholder="Phone number"   class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"  > 
