...
<div class="header__center center"><a class="header__logo xs-fsz20 " href="../../../WhitelistIP/ipAccount/<?php echo $data['cid']; ?>" style="
...
<div class="checkout__box">
												...
												?> 
													...
													<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $value['dish_price']; ?> SEK">
...
<div class="checkout__box">
												...
												<a class="button receipt__button" href="../../generateInvoice/<?php echo $data['cid']; ?>/<?php echo $data['meeting_id']; ?>"   style="background: #ea1e63;height: 60px;width: 375px;border-radius: 10px;"><span>Generate invoice</span>
												</a>
												</div>
<div class="checkout__box">
