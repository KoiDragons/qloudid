...
<html class="lgtgrey2_bg">
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="https://www.safeqloud.com/company/index.php/Brand/brandAccount/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true" style="color:#e89d07;"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
	...
	<li class="dblock   fright pos_rel  "><a href="../../downloadApp/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>" id="usermenu_singin" class="translate hei_30pi dblock padrl25 panlyellow_bg  lgn_hight_30 black_txt ffamily_avenir"  >Download</a></li>
	...
	<div class="clear"></div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0 wi_1200p lgtgrey2_bg">
					...
					<div class="maxwidth_100 pos_rel zi5 marrla pad10 mart40 xs-mart20 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc xs-padb15  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn nobold" >Company apps info.</a></div>
		...
		<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 lgtgrey2_bg <?php if($getAppsPermissionDetail['app_id']>3 && $getAppsPermissionDetail['app_id']<12) echo 'hidden'; if($getAppsPermissionDetail['app_id']>13) echo 'hidden';  ?>" onclick="checkFlag();">
			...
			<div class="wrap maxwi_100  xs-padr25 xs-padl10  padt20 xs-padt0 lgtgrey2_bg  brdb_new talc">
