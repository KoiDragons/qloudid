...
<div class="checkout__box">
  <div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Select plan</h2> 
                  </div>
...
<div class="checkout__label changedText">Free plan</div>
...
<a href="../../lockFreePlan/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>"><button class="checkout__edit"  >
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText"><?php if($value['billing_type']==1) { echo 'One time'; } else { echo 'Recuring: '; if($value['billing_period']==1) echo 'Daily'; else if($value['billing_period']==2) echo 'Weekly'; else if($value['billing_period']==3) echo 'Monthly';  else if($value['billing_period']==4) echo 'Every 3 month'; else if($value['billing_period']==5) echo 'Every 6 month'; else if($value['billing_period']==6) echo 'Yearly'; } ?></div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">$<?php echo $value['app_price']; ?> </div>
 
<div class="checkout__controls">
 
<a href="../../addPaymentInformation/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>/<?php echo $value['enc']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#52d4f4;"></use>
</svg>
</button></a>
