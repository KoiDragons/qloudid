...
<body class="white_bg">
 ...
 <div class="column_m header xs-hei_55p bs_bb lgtgrey2_bg hidden-xs"  >
			...
			<div class="fright xs-dnone visible_si padt10">
					<ul class="mar0 pad0">
						<li class="dblock hidden-xs visible_si fright pos_rel brdl "> <a href="../dependentDetails" id="usermenu_singin" class="translate hei_30pi dblock padrl25 blue_bg_h uppercase lgn_hight_30 black_txt white_txt_h" data-en="Stäng sidan" data-sw="Stäng sidan">Stäng sidan</a> </li>
					</ul>
				</div>
	...
	<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 xs-marb0 xs-mart30  mart40  padb30" id="loginBank" onclick="checkFlag();">
				...
				<img src="../../../../html/usercontent/images/394180.png" class="maxwi_100 hei_250p">
									...
									<h3 class="marb0  xxs-talc fsz35 xs-fsz25 bold padb5 black_txt talc ffamily_avenir" style="color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000"; else echo $corporateColor['bg_color']; ?>">Success!!</span></h3>
									
									<div class="martb20  xxs-talc talc "> <a href="#" class="blacka1_txt fsz20 xs-fsz20 xxs-talc edit-text jain_drop_company black_txt talc ffamily_avenir" ><span class="trn">Please move on to attend the meeting</span>
												</a></div>

						<div class="padt5 xxs-talc talc">
								
								<a href="../visitorsExpressInfo/<?php echo $data['cid']; ?>"><button type="button"  class="forword minhei_55p t_67cff7_bg ffamily_avenir marr30">Close</button></a>
