				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  >Assign</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Here is the list of cleaners in your company.Please assign the job</a></div>
                        ...
                        <div class="padb20 xxs-padb0 ">
                            ...
                            <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
							 ...
							 <div class="tab_content active" id="utab_Popular" style="display: block;">
									...
									<a href="#" onclick="updateAvailable(<?php echo $value['id']; ?>);">	<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
							 ...
							 <form action="../../assignJobToEmployees/<?php echo $data['cid']; ?>/<?php echo $data['jid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
