...
<html>
	...
	<body class="white_bg ffamily_avenir">
		...
		<!-- HEADER -->
         ...
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr0  header_blue_67cff738"  >
			...
			<div class="fright   padtbz10   " style="background-color:#67cff7a3;">
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="../../DaycarePricePlan/upgradePlanAccount/<?php echo $data['cid']; ?>/dFJHdit4c3R6VlhXelY0bXdXTUtxUT09" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
									
									<span class="valm ffamily_avenir">Upgrade<i class="fas fa-long-arrow-alt-right fsz18 padl10" aria-hidden="true"></i></span>
								</a>
							</div>
      ...
      <div class="clear" id=""></div>
		...
		<div class="column_m pos_rel" onclick="checkFlag();">
			...
			<div class="column_m container zi5  mart40 xs-mart0" >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xs-padl0">
						...
						<div class="padb20 xxs-padb0 ">
							 ...
							 <div class="wrap maxwi_100 dflex xxs-dfex alit_fe justc_sb  pos_rel padb10 brdb_blue1 hidden">
                                <div class="white_bg tall">

                                    <!-- Logo -->
                                    <h1 class="fsz30 xs-fsz45 xs-talc black_txt ffamily_avenir">Children</h1>

                                    <div class="marb0 xs-talc"> <a href="#" class="blacka1_txt fsz16  xs-fsz20  talc edit-text jain_drop_company ffamily_avenir">Registered children at daycare</a></div>
                                    <a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
                                        <!-- Meta -->
								 ...
								 <div class="hidden-xs hidden-sm padrl10">
											<a href="../careInfo/<?php echo $data['cid']; ?>" class="diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt " >
												
												<span class="valm ffamily_avenir">Lägg till barn</span>
											</a> 
										</div>
                        ...
                        <div class="wrap maxwi_100 xs-padr25 xs-padl10   lgtgrey_bg    tall  ">
                           <div class="wi_auto  hei_65p maxwi_100   pos_rel zi5 marrla    brdrad5  padrl30">
							...
							<div class="column_m container   fsz14 dark_grey_txt mart20">
								<div class="tab-header mart10 padb10 xs-talc brd_fcaf17 tb_67cff7_bg tb_67cff7_bg nobrdt nobrdl nobrdr talc">
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 t_67cff7_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir active" >Connected</a>
                                            <a href="../pendingChildren/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl30 xs-padrl10  tb_67cff7_bg t_67cff7_bg_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir " >Not connected</a>
								...
								<div class="tab-content padt5 active" id="tab_total1" style="display:block;">
									...
									<?php $i=0;
													...
													foreach($childrenDetail as $category => $value) 
													{
														
														
													?> 
									<div class=" wi_25 xxs-wi_50 fleft bs_bb padrb20 talc  " >
													<div class="toggle-parent wi_100 dflex alit_s">
														<div class="wi_100 dnone_pa ">
															<a href="../../ParentInfo/childNewsDetail/<?php echo $value['enc']; ?>" class="style_base hei_180p  xxs-hei_150p dblock bs_bb pad25 xs-pad10  brdclr_seggreen_h brdrad5 lgtgrey2_bg_h  box_shadow trans_all2 ">
																<div class=" ">
																	...
																	<div class="padrb15 padt20 xs-padt15 xs-padr0">
																		<h3 class="ovfl_hid tall pad0 txtovfl_el ws_now lgn_hight_24  fsz18 black_txt padt0 xs-fsz15 ffamily_avenir"><?php echo html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']); ?></h3>
				...
				$.ajax({
					type:"POST",
					url:"../moreChildrenDetail/<?php echo $data['cid']; ?>",
					data:send_data,
					dataType:"text",
