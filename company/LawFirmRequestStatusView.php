		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
						 <?php if($lawCompanyInfo['is_approved']==2) { ?>
						 ...
						 <?php } ?>
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir"><?php if($lawCompanyInfo['is_approved']==0) echo 'Pending'; else if($lawCompanyInfo['is_approved']==2) echo 'Rejected'; ?></h1>
									</div>
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" ><?php if($lawCompanyInfo['is_approved']==0) echo 'Your request for law firm account is pending for verification'; else if($lawCompanyInfo['is_approved']==2) echo 'Your request for law firm has been rejected by support team'; ?></a></br>
