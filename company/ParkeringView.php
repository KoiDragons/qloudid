													...
													<div class="sidebar_prdt_bx marr20 brdb padb20">
														<div class="white_bg tall">
															...
															<!-- Logo -->
																...
																<!-- Meta -->
																<div class="padt20 black_txt fsz25 ffamily_avenir"> <span><?php echo $selectIcon['app_name']; ?></span>  </div>
															</a>																
																	</div> 																</div>
													</div>		
													<div class="clear"></div>
										...
										<li class=" dblock pos_rel padb10 padt0 brdclr_hgrey ">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  red_ff2828_bg black_txt white_txt_h white_txt_a ffamily_avenir" style="border-radius:0%;"> <span class="valm trn" >Parkering</span> 
						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="wrap maxwi_100 dflex alit_fe justc_sb  pos_rel padb10 ">
                                <div class="white_bg tall">
                                    ...
                                    <!-- Logo -->
                                    <h1 class="red_ff2828_txt fsz30 xs-fsz45 xs-talc ffamily_avenir">Parkering</h1>

                                    <div class="marb0 xs-talc"> <a href="#" class="blacka1_txt fsz16  xs-fsz20  talc edit-text jain_drop_company ffamily_avenir">Här kan du administrera företagets parkeringsplatser.</a></div>
                                    <a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
                                        <!-- Meta -->
									...
									<a href="https://www.safeqloud.com/company/index.php/Parkering/plateInfo/<?php echo $data['cid']; ?>" class=" diblock padrl20 brd brdrad3 lgtgrey_bg ws_now lgn_hight_29 fsz14 black_txt ">
										
										<span class="valm ffamily_avenir">Parkera </span>
									</a> <a href="https://www.safeqloud.com/user/index.php/WhitelistIP/ipSetting/<?php echo $data['cid']; ?>"><span class="fas fa-cog fsz22 padl10 lgn_hight_29 valm"></span></a> <a href="https://www.safeqloud.com/company/index.php/Company/visitorsIP/<?php echo $data['cid']; ?>"><span class="fas fa-sign-in-alt fsz22 padl10 lgn_hight_29 valm"></span></a>
								</div>
						  ...
						  <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
                                <div class="container ">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_new xs-talc">
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 red_ff2828_brdclr_h red_ff2828_brdclr_a red_ff2828_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_Popular">Incheckade bilar...</a>
                                            <a href="#" class="dinlblck mar5 padrl30 xs-padrl10 brd_b7b7b7 red_ff2828_brdclr_h red_ff2828_brdclr_a red_ff2828_bg_a brdrad40  lgn_hight_36 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" data-id="utab_Analytics">Har lämnat...</a>
							 ...
							 <div class="tab_content active" id="utab_Popular" style="display: block;">
									...
									<table class="wi_100 " cellpadding="0" cellspacing="0" id="mytableleft">
										<thead class="fsz16" >
											<tr class="white_bg ffamily_avenir">
												...
												<th class="pad5 brdb_red_ff2828 nobold  tall" >
													<div class="padtb5 black_txt ffamily_avenir">License plate</div>
												</th>
												
												<th class="pad5 brdb_red_ff2828 nobold hidden-xs tall" >
													<div class="padtb5 black_txt">Parkerad datum</div>
												</th>
												<th class="pad5 brdb_red_ff2828 nobold hidden-xs tall" >
													<div class="padtb5 black_txt">Parkerad tidpunkt</div>
												</th>
												
												<th class="pad5 brdb_red_ff2828 nobold tall xs-talr xs-marr10" >
													<div class="padtb5 black_txt">Lämnat</div>
												</th>
											</tr>
										...
										<tbody id="plateInfo">
											<?php $i=0;
												...
												foreach($licensePlateInfo as $category => $value) 
												{
												...
												<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16 ffamily_avenir">
													...
													<td class="pad5 brdb_new tall cn">
														<div class="padtb5 " ><?php echo $value['car_res_num']; ?></div>
													</td>
													...
													<a href="#" onclick="updateId(<?php echo $value['id']; ?>);">	<div class="padtb5 ">Lämnat</div></a>
													</td>
									...
									function add_more_my(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreLicensePlateInfo/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
								...
								<div class="tab_content hide" id="utab_Analytics" style="display: none;">
									...
									<table class="wi_100 " cellpadding="0" cellspacing="0" id="mytableleft">
										<thead class="fsz16" >
											<tr class="white_bg ffamily_avenir">
												...
												<th class="pad5 brdb_red_ff2828 nobold  tall" >
													<div class="padtb5 black_txt">License plate</div>
												</th>
												
												<th class="pad5 brdb_red_ff2828 nobold hidden-xs tall" >
													<div class="padtb5 black_txt">Lämnat datum</div>
												</th>
												<th class="pad5 brdb_red_ff2828 nobold tall xs-talr xs-marr10" >
													<div class="padtb5 black_txt">Lämnat tidpunkt</div>
												</th>
										...
										<tbody id="plateInfoLeft">
											<?php $i=0;
												
												foreach($licensePlateLeftInfo as $category => $value) 
												{
												...
												<tr id="<?php echo $i; ?>" class="fsz16 xs-fsz16 ffamily_avenir">
													...
													<td class="pad5 brdb_new tall nm hidden-xs ">
														<div class="padtb5 "><?php echo date('Y-m-d',strtotime($value['modified_on'])); ?></div>
													</td>
													<td class="pad5 brdb_new tall nm tall xs-talr xs-marr10">
														<div class="padtb5 "><?php echo date('h:i:s',strtotime($value['modified_on'])); ?></div>
													</td>
									...
									<div class="padt20 talc">
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt    trn xxs-brd_width" value="1" onclick="add_more_my_left(this);">Visa fler</a>
										
									</div>
									<script>
									function add_more_my_left(link) {
										//var $tbody = $("#rejected");
										//alert($tbody.html); return false;
										var id_val=parseInt($(link).attr('value'))+1;
										var html1="";
										...
										$.ajax({
											type:"POST",
											url:"../moreLicensePlateLeftInfo/<?php echo $data['cid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
												html1=data1;
												var $tbody = $("#plateInfoLeft"),
												html=html1;
												//alert(data1); 
												$tbody
												.append($(html))
			...
			<div class="tab-content active" id="mob-primary-menu" style="display: block;">
				<div class="wi_100 dflex alit_s justc_sb talc fsz16 xxs-fsz12">
					...
					<div class="tab-header">
						<a href="https://www.safeqloud.com/company/index.php/Parkering/plateInfo/<?php echo $data['cid']; ?>" class="dark_grey_txt dblue_txt_h">
