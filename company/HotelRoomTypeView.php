	...
	<div class="column_m   talc lgn_hight_22 fsz16 bg_ffde00  ">
                        <div class="wrap maxwi_100 xs-padr25 xs-padl10   bg_ffde00    tall  ">
                           <div class="wi_auto  hei_65p maxwi_100   pos_rel zi5 marrla    brdrad5  padrl30">
                              <div class="martb15  xxs-talc talc ffamily_avenir"> <a href="../../roomDetailInformation/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" class="black_txt fsz18 xs-fsz16  xxs-talc talc edit-text jain_drop_company trn ffamily_avenir">+Add room</a></div>
                           </div>
                        </div>
                     </div>
						...
						<div class="column_m  fsz14 lgn_hight_22 dark_grey_txt brdt_ff5bad tb_67cff7_bg marb5 mart20">
								...
								<?php $i=0;
												...
												?> 
												<a href="<?php if($value['is_free']==0) echo '#'; else { echo '../../alotRoom/'.$data['cid'].'/'.$data['lid'].'/'.$value['enc']; } ?>">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt "><?php  echo $value['room_name']; ?> </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt "><?php echo $value['room_type']; ?></span>  </div>
