         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Developer Connect</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Get access to off-plan listings in real time</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			      <a class="categories__item    " href="../availableLandloard/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Apply</div>
                                      </a>
									  <a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_f67f00 ">Off plan</div>
                                      </a>
                ...
                <div class="nav"><a class="nav__link active changedText" href="#" >All</a> <a class="nav__link changedText" href="#"  onclick="changeHeader();">Published</a> <a class="nav__link changedText" href="#"  >Reserved</a><a class="nav__link changedText" href="#"  >Occupied</a></div>
			  ...
			  <div class="section travels mart40">
          <div class="travels__center center" style="">
            <div class="travels__wrapper" style="
    padding-top:0px;
    background: #131922;  
    border-radius: 0px;
box-shadow:none;">
			   ...
			   <div class="travels__card bgFFFFFF"  >
                                  <div class="travels__preview"><img srcset="https://www.safeqloud.com/estorecss/tmp<?php echo $value['imageId']; ?>.jpg" src="https://www.safeqloud.com/estorecss/tmp<?php echo $value['imageId']; ?>.jpg"  alt="Card"  style="border-radius: 50%;
                                  ...
                                  <div class="travels__body">
                                    <div class="travels__line"  style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: black;"><?php echo $value['building_name']; ?></div>
                                        <div class="travels__location" style="color: black;"><?php echo substr($value['company_name'],0,15); ?></div>
                                      </div>
                                  
                        <a class="header__logo  changedText fright Button10161d" href="../listBrokerOffPlanBuildingApartment/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
   ...
   " >View</a>
                                    ...
                                    <div class="travels__line hidden">
                                      <div class="travels__date">135 units & 53 likes</div>
		...
		<div class="section flights hidden">
          <div class="flights__center center xs-padrl25">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
			   ...
			   <div class="card card_row"   style="margin-bottom:24px; border:1px solid #23262F ;">
										...
										<div class="card__preview"><img srcset="https://www.safeqloud.com/estorecss/tmp<?php echo $value['imageId']; ?>.jpg" src="https://www.safeqloud.com/estorecss/tmp<?php echo $value['imageId']; ?>.jpg" alt="Premium milford sound tour ex Queenstown">
                     <div class="category card__category">Exclusive</div>
                  </div>
                  <div class="card__body" style="background: #131922;">
                    <div class="card__line" style="
    margin-bottom: 0px;
">
                   <a href="../listBrokerOffPlanBuildingApartment/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;"> <div class="flight__title changedText fsz30 xsi-fsz23" style="color:white;"><?php echo $value['building_name']; ?></div></a>
                        <div class="card__price" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099;">
                        <div class="card__old">$<?php echo $value['startingPrice']; ?></div>
                        <div class="card__actual">$<?php echo $value['startingPrice']; ?></div>
                      </div>
                    </div>
...
">
                ...
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php  echo $value['size']; ?> sqm</span></div>
              </div>
                    <div class="card__foot">
					
                      <div class="card__comment <?php  if($value['shortSellingDescription']=="" || $value['shortSellingDescription']==null) echo 'hidden'; ?>" style="margin-bottom:0px;">
                        
                        <div class="card__text changedText" style="
    font-size: 14px;
    line-height: 20px;
">
 <?php  echo $value['shortSellingDescription']; ?> </div>
                      </div>
