...
<div class="setting__container" style="padding:0px;">
 <div class="setting__head hidden">
                    <h2 class="setting__title h2">Company details</h2> <a class="button-stroke button-small setting__button" href="https://www.safeqloud.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>">View profile</a>
                  </div>
<div class="checkout__list">
 ...
 <div class="upload__item">
                      <div class="upload__category">Upload photo</div>
                      <div class="upload__note">Drag or choose your file to upload</div>
                      <div class="upload__file upload__filer"  style="  background-image: <?php echo $value_a; ?>;" >
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Company identification number</div>
<div class="field__wrap">
<input class="field__input" name="ssn" id="ssn" value="<?php if($companyDetail['cid']!="" || $companyDetail['cid']!= null) echo $companyDetail['cid']; else echo "-"; ?>"    type="text"   style=" color:grey;"  >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="cname" id="cname" value="<?php  echo $companyDetail['company_name'];  ?>"    type="text"   style=" color:grey;">
</div>
</div>
...
<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Industry</div>
<div class="field__wrap">
 
<select    style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52" id="industry" name="industry">
...
<select  class="   " name="country_phone" id="country_phone"  style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
...
<div class="field__wrap">
<input class="field__input" name="phone" id="phone" value="<?php if($companyDetail['phone']!="" || $companyDetail['phone']!= null) echo $companyDetail['phone']; else echo "-"; ?>"   type="text"   style=" color:grey;"  >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="email" id="email" value="<?php  echo $companyDetail['company_email']; ?>" readonly   type="text"   style=" color:grey;">
</div>
</div>

<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Website</div>
<div class="field__wrap">
<input class="field__input"  name="web" id="web" value="<?php  echo $companyDetail['website']; ?>"  type="text"   style=" color:grey;">
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="vat" id="vat" value="<?php if($companyDetail['vat']!="" || $companyDetail['vat']!= null) echo $companyDetail['vat']; else echo "-"; ?>"  type="text"   style=" color:grey;">
</div>
</div>
 
											<input type="hidden"  name="addrs" id="addrs" value="<?php  if(isset($_POST['visit_addrs'])){ echo htmlentities($_POST['addrs'],ENT_NOQUOTES, 'ISO-8859-1'); } else { if($addressDetail['visiting_address']!="" || $addressDetail['visiting_address']!= null) echo $addressDetail['visiting_address']; else echo "-"; } ?>" class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz22 nobrd ffamily_avenir" readonly>
...
<input type="hidden" name="dzip"    id="dzip" value="<?php if(isset($_POST['delivery_address'])){ echo $_POST['dzip']; } else { if($companyDetail['sd_zip']!="" || $companyDetail['sd_zip']!= null) echo $companyDetail['sd_zip']; else echo "-"; } ?>"  />
											...
											<input type="hidden" id="daddress" name="daddress" value="<?php if(isset($_POST['delivery_address'])){ echo $_POST['daddress']; } else { $companyDetail['sd_address']; } ?> " />
