						...
						<div class="padb20 xxs-padb0 ">
							...
							<div class="container tab-header  talc dark_grey_txt ">
								...
								<select class="tab-header wi_200p maxwi_100 dnone xs-dblock hei_30p pad0 nobrd brdb_new">
									...
									<option value="tab_total2">Skickade</option>
							...
							<div class="container  white_bg fsz14 dark_grey_txt">
								...
								<div class="tab-content padb25 padt5 " id="tab_total2">
									<?php  foreach($requestDetail as $category => $value) 
													{
										...
										<div class="container pad25 padb20 xs-pad10 xs-padt20 xs-padb20  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt10 fsz12">
													...
													<div class="fleft wi_30 xs-wi_100 sm-wi_100 marl15 xs-mar0 padb10 "> <span class="trn bold" data-trn-key="Mina hyresgäster">Mina hyresgäster</span> <span class=" edit-text jain1 dblock brdb brdclr_lgtgrey2 fsz16"><?php echo html_entity_decode($value['company_name']); ?></span> </div>
													<div class="fleft wi_45 xs-wi_100 sm-wi_100 marl15 xs-mar0 padb10 "> <span class="trn bold" data-trn-key="<?php if($value['is_headquarter']==1) echo 'Huvudkontor'; else echo 'Arbetställe / Kontor'; ?>"><?php if($value['is_headquarter']==1) echo 'Huvudkontor'; else echo 'Arbetställe / Kontor'; ?></span> <span class=" edit-text jain2 dblock brdb brdclr_lgtgrey2 fsz16"><?php echo $value['visiting_address']; ?></span> </div>
													<div class="fright wi_10 padl0 xs-wi_100 sm-wi_100 marl15 fsz40  xs-mar0 padb0">
														<a href="../../CompanyLandloardNews/tenantAccount/<?php echo $value['enc']; ?>" ><span class="fas fa-arrow-alt-circle-right"></span></a>
													</div>
