 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Brokers</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Your Reseller Brokers</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Oversee and pptimize your broker partnerships for better sales</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			    ...
			    <a class="categories__item    " href="../brokersList/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   " >Received requests</div>
                                      </a>
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91" style="color:#52d4f4 !important;">Sent requests</div>
                                      </a>
...
<input class="upload__input" type="hidden" name="bid" id="bid"  value="1"/>
</form>


			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active" href="#">Sent requests</a> 
               ...
               <a href="javascript:void(0);" onclick="addFileInformaion();">  <button class="button-stroke catalog__button">
                  <span class="changedText">Add brokers</span>
                </button></a>
                </div>
              </div>
		...
		<div class="section flights">
		  ...
		  <div class="flights__sorting  hidden-xxs" style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
               ...
               <div class="flights__container " style="padding:0px;">
				...
				<?php $i=1;  
								foreach($brokerRequestList as $category => $value) 
										{
										 ?> 
				...
				<div class="card__body" style="background: #10161d;">
                    <div class="card__line" style="margin-bottom: 0px;">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;"><?php echo $value['first_name'].' '.$value['last_name']; ?></div>
				   
				    <div class="description__parameters hidden-xxs" style="border-top:none; margin-bottom: 0px; margin-top: 0px;
    padding-bottom: 0px;
    padding-top: 0px;
">
   ...
   "><?php if($value['is_approved']==0) echo 'Sent'; else echo 'Approved'; ?></a>
				  ...
				  <div class="card card_row hidden"   style="margin-bottom:24px;  ">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:30px; color:white;"> <?php echo $value['first_name'].' '.$value['last_name']; ?></div>
...
">
                ...
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['phone_number']; ?></div>
              </div>
                    </div></div>
