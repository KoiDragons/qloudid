...
<div class="setting__menu"><a class="setting__link js-tabs-link " href="../../employeeAccount/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>">
                <svg class="icon icon-user">
                  <use xlink:href="#icon-user"></use>
                </svg>Work details</a>
				<a class="setting__link js-tabs-link active" href="#">
...
<div class="setting__head">
                    <h2 class="setting__title h2">Personal details</h2> <a class="button-stroke button-small setting__button" href="#">Employee list</a>
                  </div>
...
<input class="field__input"    value="<?php echo $row_summary ['country_name']; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>

<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Social security number</div>
<div class="field__wrap">
<input class="field__input"    value="<?php if($resultOrg['ssn']!="" || $resultOrg['ssn']!= null) echo $resultOrg['ssn']; else echo "-"; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"    value="<?php if($resultOrg['name']!="" || $resultOrg['name']!= null) echo $resultOrg['name']; else echo "-"; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"    value="<?php echo $resultOrg['email']; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>


<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Phone</div>
<div class="field__wrap">
<input class="field__input"    value="<?php if($resultOrg['phone_number']!="" || $resultOrg['phone_number']!= null) echo '+'.$resultOrg1['country_code'].'-'.$resultOrg['phone_number']; else echo "-"; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>

<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Date of birth</div>
<div class="field__wrap">
<input class="field__input"    value="<?php  echo $resultOrg['dob_day'].'-'.$resultOrg['dob_month'].'-'.$resultOrg['dob_year']; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"    value="<?php if($resultOrg['sex']==1) echo 'Male'; else echo "Female"; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"    value="<?php if($resultOrg['address']!="" || $resultOrg['address']!= null) echo $resultOrg['address']; else echo "-"; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>


<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Bank</div>
<div class="field__wrap">
<input class="field__input"    value="<?php if($resultOrg['language']!="" || $resultOrg['language']!= null) echo  $resultOrg['language']; else echo "-"; ?>" readonly   type="text"   style=" color:grey;"  >
</div>
</div>

</div>

<div class="checkout__box hidden">
  
  
<div class="checkout__data  ">
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Country</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $row_summary ['country_name']; ?></div>
 
<div class="checkout__controls hidden">
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Social security number</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg['ssn']!="" || $resultOrg['ssn']!= null) echo $resultOrg['ssn']; else echo "-"; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Name</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg['name']!="" || $resultOrg['name']!= null) echo $resultOrg['name']; else echo "-"; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Email</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php echo $resultOrg['email']; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Phone</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg['phone_number']!="" || $resultOrg['phone_number']!= null) echo '+'.$resultOrg1['country_code'].'-'.$resultOrg['phone_number']; else echo "-"; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Date of birth </div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php  echo $resultOrg['dob_day'].'-'.$resultOrg['dob_month'].'-'.$resultOrg['dob_year']; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Gender </div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg['sex']==1) echo 'Male'; else echo "Female"; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Address </div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg['address']!="" || $resultOrg['address']!= null) echo $resultOrg['address']; else echo "-"; ?></div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px">
<div class="checkout__label changedText">Bank</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;"><?php if($resultOrg['language']!="" || $resultOrg['language']!= null) echo  $resultOrg['language']; else echo "-"; ?></div>
