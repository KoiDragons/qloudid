...
<a class="header__logo xs-fsz20 " href="../../CompanyCrm/adminAccount/<?php echo $data['cid']; ?>" style="
...
<div class="section work xs-padrl25 marb80i xs-marb25i hidde hidden-xs" style=" ">
          <div class="work__center center xxs-padrl25" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Choose the method that works best for you</div>
...
<div class="checkout__label changedText">Invite</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Invite employees to self register</div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">Manually</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Add employees one by one</div>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">File import</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Add multiple employees at once.</div>
 
<div class="checkout__controls">
 
<a href="../addFile/<?php echo $data['cid']; ?>"><button class="checkout__edit"  >
<svg class="icon icon-arrow-next">
<use xlink:href="#icon-arrow-next" style="fill:#ff8d4c;"></use>
</svg>
</button></a>
...
<div class="checkout__el">
<div class="checkout__datepicker" style="padding: 16px 56px 16px 16px;  background:#10161d;">
<div class="checkout__label changedText">API Integration</div>
<div class="changedText" style="font-size: 16px;
    line-height: 1.5;
    font-weight: 500;">Sync with your existing HR systems.</div>
