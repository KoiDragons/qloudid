...
function updateElevatorValue(id,link)
{
	 
	elevatorValueUpdate=1;
...
var stairCount=<?php echo count($buildingPortList); ?>;
var ports=0;
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
									 ...
									 <form action="../../updateBuilding/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									 <input type="hidden" id="total_stairs" name="total_stairs" value="0" />
								 ...
								 <Select  name="building_type" id="building_type" class="css-bnguuq dropdown-bg" disabled>
								 
												<option value="1" <?php if($buildingDetailInfo['building_type']==1) echo 'selected'; ?>>Purchase</option>
												<option value="2" <?php if($buildingDetailInfo['building_type']==2) echo 'selected'; ?>>Rental</option>
												<option value="3" <?php if($buildingDetailInfo['building_type']==3) echo 'selected'; ?>>Shared</option>
									...
									<div class="wi_100 pos_rel">
								 <Select  name="building_completed" id="building_completed" class="css-bnguuq dropdown-bg" onchange="undpateBuildingCompleted(this.value);" <?php if($buildingDetailInfo['building_completed']==1) echo 'disabled'; ?>>
								 <option value="0">Select</option>
												<option value="1" <?php if($buildingDetailInfo['building_completed']==1) echo 'selected'; ?>>Yes</option>
												<option value="2" <?php if($buildingDetailInfo['building_completed']==2) echo 'selected'; ?>>No</option>
									 ...
									 <div class="on_clmn <?php if($buildingDetailInfo['building_completed']==1) echo 'hidden'; ?>" id="buildingNotDone">
								 <div class="thr_clmn  wi_50 padr10"> 
									...
									<div class="wi_100 pos_rel">
								 <input type="date" id="s_date" name="s_date" class="css-xt766" value="<?php echo date('Y-m-d',$buildingDetailInfo['start_date']); ?>"    fdprocessedid="39tflg">
								 </div>
									...
									<div class="wi_100 pos_rel">
								  <input type="date" id="e_date" name="e_date" class="css-xt766" min="<?php echo date('Y-m-d'); ?>"  value="<?php echo date('Y-m-d',$buildingDetailInfo['expected_end_date']); ?>" fdprocessedid="hiyev">
								 </div>
									  ...
									  <div class="on_clmn <?php if($buildingDetailInfo['building_completed']==2) echo 'hidden'; ?>" id="buildingDone">
									...
									<div class="wi_100 pos_rel">
								  <input type="date" id="complete_date" name="complete_date" class="css-xt766" value="<?php echo date('Y-m-d',$buildingDetailInfo['completion_date']); ?>" max="<?php echo date('Y-m-d'); ?>" fdprocessedid="hiyev" <?php if($buildingDetailInfo['building_completed']==1) echo 'readonly'; ?>>
								 </div>
								 ...
								 <option value="0">Select</option>
												<option value="1" <?php if($buildingDetailInfo['building_seller']==1) echo 'selected'; ?>>Inhouse</option>
												<option value="2" <?php if($buildingDetailInfo['building_seller']==2) echo 'selected'; ?>>Broker</option>
												<option value="3" <?php if($buildingDetailInfo['building_seller']==3) echo 'selected'; ?>>Inhouse and broker</option> 
									  ...
									  function undpateBuildingCommission(id)
									  {
									   ...
									   <div class="on_clmn padt10 <?php if($buildingDetailInfo['building_seller']<2) echo 'hidden'; ?>" id="buildingCommision">
								 ...
								 <option value="0" <?php if($buildingDetailInfo['broker_commission']==0) echo 'selected'; ?>>Select</option>
										<?php for($i=1;$i<=20;$i++){ ?>
										<option value="<?php echo $i; ?>" <?php if($buildingDetailInfo['broker_commission']==$i) echo 'selected'; ?>><?php echo $i; ?></option>
										<?php } ?>										
								 ...
								 <?php if($companyDetail['country_id']==67) { ?>
												<option value="1" <?php if($buildingDetailInfo['vitech_region']==1) echo 'selected'; ?>>Costa Blanca North</option>
											<option value="2" <?php if($buildingDetailInfo['vitech_region']==2) echo 'selected'; ?>>Costa Blanca South</option>
												<?php } ?>
								 ...
								 <Select  name="vitech_city_id" id="vitech_city_id" class="css-bnguuq dropdown-bg"   onchange='selectArea(this.value);'>
								  <option value="0">Select</option>
											 <?php if($companyDetail['country_id']==67) {  echo $selectCity; } ?>
											</Select>
								 </div>
								 ...
								 <Select  name="vitech_area_id" id="vitech_area_id" class="css-bnguuq dropdown-bg" >
								  <option value="0">Select</option>
								 <?php if($companyDetail['country_id']==67) {  echo $selectArea; } ?>
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="building_name" name="building_name" class="css-xt766" value="<?php echo $buildingDetailInfo['building_name']; ?>">
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="block_name" name="block_name" class="css-xt766" value="<?php echo $buildingDetailInfo['block_number']; ?>">
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="street_address" name="street_address" class="css-xt766" value="<?php echo $buildingDetailInfo['street_address']; ?>">
								 ...
								 <div class="thr_clmn  wi_50 padr10"> 
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="address_city" name="address_city" class="css-xt766" value="<?php echo $buildingDetailInfo['city']; ?>">
								 </div>
									...
									<div class="wi_100 pos_rel">
								  <input type="text" id="zip_address" name="zip_address" class="css-xt766" value="<?php echo $buildingDetailInfo['zipcode']; ?>">
								 </div>
									 ...
									 <div id="locationDetail" style="display:none">
												...
												<div class="pos_rel">
													...
													<input type="text" name="latit" id="latit" placeholder="Latitude" class="wi_100  pad10   talc  minhei_65p fsz18 nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828 xxs-minhei_60p ffamily_avenir" value="<?php echo $buildingDetailInfo['latitude']; ?>">
												</div>
												...
												<div class="pos_rel">
													...
													<input type="text" name="longi" id="longi" placeholder="Longitude" class="wi_100  pad10   talc  minhei_65p fsz18 nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828 xxs-minhei_60p ffamily_avenir" value="<?php echo $buildingDetailInfo['longitude']; ?>">
												</div>
										...
										<span class="value" id="portCount"><?php echo count($buildingPortList); ?> Stair</span>
							...
							<?php $i=1; $ids=''; foreach($buildingPortList as $category => $value) 
												{
												$ids=$ids.$value['id'].','; 
													
												?> 
												
									<input type="hidden" id="port_floor_ids" name="port_floor_ids" value="<?php echo $ids; ?>">
					 <div class="padb10 xs-padrl0 xs-padb0   mart10  ">
									 <div class="clear"></div>
								<div class="marrl0 padb10   fsz16 white_bg tall padt20">
								<a href="#profile<?php echo $i; ?>" class="expander-toggler dark_grey_txt xs-fsz16 tall bold">Port number <?php echo $i; ?>
								...
								<div class="pos_rel">											
											 <input type="text" id="port_number_<?php echo $value['id']; ?>" name="port_number_<?php echo $value['id']; ?>" class="css-xt766" value="<?php echo $value['port_number']; ?>">
											</div>
											</div>
									...
									<input type="hidden" value="<?php echo $value['elevator_available']; ?>" id="elevator_<?php echo $value['id']; ?>" name="elevator_<?php echo $value['id']; ?>" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   checked" onclick="updateElevatorValue(<?php echo $value['id']; ?>,this);" >
										...
										<span class="value"  ><?php echo $value['total_floors']; ?> floor</span>
									<a href="javascript:void(0);"  >	
									<div color="#444444" data-testid="icon-button--plus" class="merlin-button css-mgojn5" aria-label="">
										<div class="merlin-button__content">
										<div class="css-ibdtyj">
					...
					<input type="hidden" value="<?php echo $buildingDetailInfo['basement_available']; ?>" id="basement_available" name="basement_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
									<div class="on_clmn  mart10  brdb">	
									<div class="thr_clmn  wi_75 ">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($buildingDetailInfo['basement_available']==1) echo 'checked'; ?>" onclick="updateBasement(1,this);" >
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
									...
									<input type="hidden" value="<?php echo $buildingDetailInfo['penthouse_available']; ?>" id="penthouse_available" name="penthouse_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
									<div class="on_clmn  mart10  brdb">	
									<div class="thr_clmn  wi_75 ">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($buildingDetailInfo['penthouse_available']==1) echo 'checked'; ?>" onclick="updatePenthouse(1,this);" >
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
											...
											<input type="hidden" value="<?php echo $buildingDetailInfo['garage_available']; ?>" id="garage_available" name="garage_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
									<div class="on_clmn  mart10  brdb">	
									<div class="thr_clmn  wi_75 ">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($buildingDetailInfo['garage_available']==1) echo 'checked'; ?>" onclick="updateGarage(1,this);" >
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
										...
										<input type="hidden" value="<?php echo $buildingDetailInfo['amenities_available']; ?>" id="amenities_available" name="amenities_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
									<div class="on_clmn  mart10  brdb">	
									<div class="thr_clmn  wi_75 ">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($buildingDetailInfo['amenities_available']==1) echo 'checked'; ?>" onclick="updateAmenities(1,this);" >
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
									...
									<input type="hidden" value="<?php echo $buildingDetailInfo['tenant_available']; ?>" id="tenant_available" name="tenant_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
									<?php if($buildingDetailInfo['building_type']!=1) { ?>
									<div class="on_clmn  mart10  brdb">	
									<div class="thr_clmn  wi_75 ">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($buildingDetailInfo['tenant_available']==1) echo 'checked'; ?>" onclick="updateTenant(1,this);" >
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
									...
									<?php } ?>	
											<input type="hidden" value="<?php echo $buildingDetailInfo['pricing_available']; ?>" id="pricing_available" name="pricing_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
									<div class="on_clmn  mart10  brdb">	
									<div class="thr_clmn  wi_75 ">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($buildingDetailInfo['pricing_available']==1) echo 'checked'; ?>" onclick="updatePricing(1,this);" >
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
										...
										<input type="hidden" value="<?php echo $buildingDetailInfo['invoice_available']; ?>" id="invoice_available" name="invoice_available" class="wi_100 rbrdr pad10 padb0   tall  minhei_55p fsz18 black_txt ffamily_avenir" />
									<div class="on_clmn  mart10  brdb <?php if($buildingDetailInfo['pricing_available']==0) echo 'hidden'; ?>" id="InvoiceInfo">	
									<div class="thr_clmn  wi_75 ">
								...
								<div class="pos_rel">											
											<div class="fright   wi_100 minhei_55p  padt10 xs-padt15 marl0 fsz25  padb10  " >
														<div class="boolean-control boolean-control-small boolean-control-green fright   <?php if($buildingDetailInfo['invoice_available']==1) echo 'checked'; ?>" onclick="updateInvoice(1,this);" >
																<input type="checkbox"  class="default" data-true="" data-false="" />
															</div>
													</div>
											</div>
