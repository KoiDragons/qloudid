...
<div class="column_m header xs-header bs_bb lgtblue2_bg">
		...
		<div class="fright xs-dnone visible_si padt10">
			...
			<div class="visible-xs visible-xxs fright marr0 xs-padt5 "> <a href="https://www.qloudid.com/company/index.php/ChilldCare/helpCenter/<?php echo $data['cid']; ?>" class="diblock padrl20 brdrad3 pred2_bg lgn_hight_29 fsz14 black_txt">Close</a> </div>
			<div class="clear"></div>
		</div>
	</div>
