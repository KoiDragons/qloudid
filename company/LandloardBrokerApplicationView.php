   ...
   function informEmployee()
			{
				...
				if($("#licence_number").val()=="" ||  $("#licence_number").val()==null ||  $("#licence_number").val()=='-')
				{
					 
					$("#error_msg_form").html('Please enter correct licence number');
					return false;
				}
				
				
				var send_data={};
					send_data.cid=$("#licence_number").val();
					 
					$.ajax({
						type:"POST",
						url:"../../verifyLicence/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>",
						data:send_data,
						dataType:"text",
						...
						success: function(data1){
							...
							if(data1>0)
							{
								$("#error_msg_form").html('Licence number alrady used. Please enter another licence number');
								return false;
							}
							else
							{
...
<a class="header__logo xs-fsz25 changedText" href="../../availableLandloard/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Inform developer if you're already a registered reseller or applying for the first time.
</div>
...
<div class="setting__head hidden">
                    <h2 class="setting__title h2" style="font-size:25px;">Licence details</h2> 
                  </div>
<form class="checkout__item js-tabs-item" action="../../sendRequest/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
					   ...
					   <div class="checkout__subtitle">Licence type</div>
                       
                      </div>
                      <div class="upload__fieldset ">
					    
					    <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Application type</div>
                            <div class="field__wrap">
                               <select class=" xs-fieldData"   id="application_type" name="application_type" style="height: 48px;
    padding: 0 14px;  border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" onchange="updateApplication(this.value);">
								   <option value="1">Apply for a new licence</option>
											<option value="2">Already have a active licence</option>
						  ...
						  function updateApplication(id)
						  {
							  if(id==1)
							  {
								 $('#licenceNumber').addClass('hidden');
								 $('#licence_number').val();
							  }
							  else
								  {
								 $('#licenceNumber').removeClass('hidden');
								 $('#licence_number').val();
							  }
						  }
						  </script>
						  
						  <div id="licenceNumber" class="hidden">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Licence number</div>
                            <div class="field__wrap">
                              <input class="field__input xs-fieldData" type="text" name="licence_number" id="licence_number" placeholder="e. g. 120"   style=" color:grey;"  >
                            </div>
                          </div>
