...
<html>
	...
	<body class="white_bg">
		...
		<!-- HEADER -->
			<?php include 'CompanyHeaderClosed.php'; ?>	<div class="clear"></div>
													...
													<div class="sidebar_prdt_bx marr20 brdb_b padb20">
														<div class="white_bg tall">
															...
															<!-- Logo -->
																...
																<div class="padtr10 fsz15"> <span><?php echo $requestDetailOffice['visiting_address']; ?></span>  </div>
															</a></div>
													</div>		
													<div class="clear"></div>
												</div>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="../../Company/locationAccount/<?php echo $data['lid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Kontaktuppgifter</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
												...
												<li class="dblock padrb10">
													<a href="../../CompanyDepartment/departmentInfo/<?php echo $data['lid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn"> Avdelning</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
											</ul>
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey   greyblue_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Min hyresvärd</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p greyblue_bg rotate45"></div>
													</a>
												</li>
												
												<li class="dblock padrb10">
													<a href="#" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn"> Mina anställda (lista)</span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
					...
					<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5  xs-padrl10 padl20 xs-padl0">
						<div class="column_m container zi1 padb5">
								...
								<div class="white_bg tall">
									...
									<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text jain_drop_company"> Din lista på hyresvärd</a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
										<!-- Meta -->
											...
											<div>
												...
												<div class="dflex xs-dblock fxwrap_w padb0 xs-padt0 xs-padb0">
													...
													<div class="wi_100 xs-wi_100 padtb0  padr20 txt_708198">
														<h2 class="bold marb10 pad0 tall xs-talc fntwei_300 fsz55 sm-fsz32 md-fsz36 lg-fsz40 black_txt xs-fsz30">Besök din hyresvärd<div class="wi_50p maxwi_100 hei_4p mart5 xs-marrla black_bg"></div>
														</h2>
										...
										<div class="container pad25 padb20 xs-pad10 xs-padt20 xs-padb20  brdrad1 fsz14 dark_grey_txt">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt10 fsz12">
													...
													<div class="fleft wi_30 xs-wi_100 sm-wi_100 marl15 xs-mar0 padb10"> <span class="trn bold" data-trn-key="Mina hyresgäster">Mina hyresgäster</span> <span class=" edit-text jain1 dblock brdb brdclr_lgtgrey2 fsz16"><?php echo html_entity_decode($requestDetailOffice['company_name']); ?></span> </div>
													<div class="fleft wi_35 xs-wi_100 sm-wi_100 marl15 xs-mar0 padb10"> <span class="trn bold" data-trn-key="Arbetställe / Kontor">Arbetställe / Kontor</span> <span class=" edit-text jain2 dblock brdb brdclr_lgtgrey2 fsz16"><?php echo $requestDetailOffice['visiting_address']; ?></span> </div>
													
													<div class="fleft wi_10 xs-wi_100 sm-wi_100 marl15 xs-mar0 padb10"> <span class="trn bold" data-trn-key="Status">Status</span> <span class=" edit-text jain2 dblock brdb brdclr_lgtgrey2 fsz16"><?php if($requestDetailOffice['is_approved']==1) echo 'Approved'; else if($requestDetailOffice['is_approved']==2) echo 'Rejected'; else if($requestDetailOffice['is_approved']==0) echo 'Pending'; ?></span> </div>
