...
function updatePort(id)
{
	...
	else
	{
		...
		send_data.building_id=id;	 
		 ...
		 $.ajax({
		type:"POST",
		url:"../../getPorts/<?php echo $data['rid']; ?>/<?php echo $data['cid']; ?>",
		data:send_data,
		dataType:"text",
...
function updateFloor(id)
{
	...
	else
	{
		...
		send_data.port_id=id;	 
		 ...
		 $.ajax({
		type:"POST",
		url:"../../getFloors/<?php echo $data['rid']; ?>/<?php echo $data['cid']; ?>",
		data:send_data,
		dataType:"text",
		contentType: "application/x-www-form-urlencoded;charset=utf-8",
		success: function(data1){
...
function updateApartment(id)
{
	...
	else
	{
		...
		send_data.floor_id=id;	 
		 ...
		 $.ajax({
		type:"POST",
		url:"../../getApartment/<?php echo $data['rid']; ?>/<?php echo $data['cid']; ?>",
		data:send_data,
		dataType:"text",
		contentType: "application/x-www-form-urlencoded;charset=utf-8",
		success: function(data1){
               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        ...
                        <a href="../../apartmentConnectRequest/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></a>
		...
		<div class="column_m header xs-hei_55p  bs_bb white_bg visible-xs">
            <div class="wi_100 xs-hei_55p hei_65p pos_fix padtb5 padrl10 white_bg ">
                <div class="visible-xs visible-sm fleft padrl0">
						 ...
						 <a href="../../apartmentConnectRequest/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left black_txt" aria-hidden="true"></i></a>
			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40" id="loginBank">
				<div class="wrap maxwi_100 padrl15 xs-padrl25">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Please select apartment details here to approve connect request</a></div>
							...
							<form action="../../approveConnectApartmentRequest/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<a href="#profile6A" class="expander-toggler white_txt xs-fsz16 tall tabblueBGcolor padrl30 padtb10 brdrad5 active">Apartment detail
								...
								<div class="pos_rel">											
									 ...
									 <input type="hidden" id="apartment_available" name="apartment_available" value="0" />
										...
										<select id="apartment_id" name="apartment_id" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select"   >
										   ...
										   <?php echo $getApartmentForSeelctedFloor; ?>
