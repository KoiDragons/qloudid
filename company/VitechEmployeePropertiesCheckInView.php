         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Here is a list of guest check-in</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Checked-in</div>
                                      </a>
			  ...
			  <div class="sorting__foot">
                <div class="nav"><a class="nav__link  changedText" href="../guestReservationList/<?php echo $data['cid']; ?>">Reservation</a> <a class="nav__link changedText active" href="#">Checked in</a> <a class="nav__link changedText" href="../reservationCheckedOutList/<?php echo $data['cid']; ?>">Checked out</a></div>
...
">Update</div>
   ...
   <a class="header__logo  changedText fright" href="../checkOutGuest/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #ff2828;
   border-radius: 5px;
