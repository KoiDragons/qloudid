...
<html>
	...
	<head>
		...
		function checkEmail(id) {
			...
			function submitform()
			{
				...
				if($("#email").val()=='')
				{
				$("#errorMsgUser").html('Please enter work email');	
				return false;
				}
				if($('#card_id').val()==0)
				{
				...
				$("#errorMsg").html("please select card for the employee");
					return false;	
				}
				if($("#email").val()!="")
				{
	...
	<body class="white_bg ffamily_avenir" >
		...
		<!-- HEADER -->
         ...
         <div class="wi_100 hei_65p xs-pos_fix padtb0 padr10 lgtgrey2_bg"  >
            <div class="fleft padrl0 bg_babdbc padtbz10" >
			 ...
			 <?php if($employeeIdVerificationCount['num']==0) { ?>
			 <div class="fright   padtbz10   ">
						<ul class="mar0 pad0">
							<div class="  padtrl10">
								<a href="../../getIdentificator/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" class=" diblock padrl20  ws_now lgn_hight_29 fsz16 black_txt">
									
									<span class="valm ffamily_avenir">Verify id</span>
								</a>
							</div>
		...
		<div class="clear" id=""></div>
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart20 xs-mart20 " id="loginBank"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						...
						<p class="lgn_hight_16 padt10 talc fsz20   padb10 marb20 xs-padb5 grey_new_txt"><?php echo html_entity_decode($resultOrg1['address']); ?> </p>
	...
	<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
                                            ...
                                            <a href="../../employeePersonalAccount/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" onclick="changeHeader();" >Personal</a>
							...
							<div class="white_bg mart0 brdb bg_fffbcc_a marb0" style=""> 
										...
										<a href="#" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Work phone </span></a> 
										<div class="fleft wi_15  xs-mar0  "> 
										    
									 
											<select class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir" name="c_id" id="c_id">
										...
										<div class="fleft wi_80  xs-mar0  "> 
											...
											<input type="text" name="phone" id="phone" value="<?php echo $workInfo['phone']; ?>" class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir">
							...
							<div class="white_bg mart0 brdb bg_fffbcc_a marb0" style=""> 
										...
										<div class="fleft wi_80 ">
										<a href="#" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Work mobile </span></a> 
										<div class="fleft wi_15  xs-mar0  "> 
										    
									 
											<select class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir" name="d_country" id="d_country">
										<?php foreach($userCountryList as $category => $value ) {
										?>
										...
										<div class="fleft wi_80  xs-mar0  "> 
											...
											<input type="text" name="mobile" id="mobile" value="<?php echo $workInfo['mobile']; ?>" class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir">
							...
							<div class="white_bg mart0 brdb bg_fffbcc_a marb0" style=""> 
										...
										<div class="fleft wi_80   xs-mar0 ">
										<a href="#" class="dark_grey_txt txt_0070e0_sbh ffamily_avenir"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Work email</span></a> 
							...
							<div class="white_bg mart0 brdb bg_fffbcc_a marb0" style=""> 
										...
										<div class="fleft wi_80 ">
										<a href="#" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Location</span></a> 
										<div class="fleft wi_100  xs-mar0  "> 
										    
									 
											<select class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir" name="location_id" id="location_id" onchange="changeDepartment(this.value)">
							...
							<div class="white_bg mart0 brdb bg_fffbcc_a marb0" style=""> 
										...
										<div class="fleft wi_80 ">
										<a href="#" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Department</span></a> 
										<div class="fleft wi_100  xs-mar0  "> 
										    
									 
											<select class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir" name="department" id="department">
										...
										<div class="fleft wi_80   xs-mar0 ">
										<a href="#" class="dark_grey_txt txt_0070e0_sbh ffamily_avenir"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Employee ID</span></a> 
										
										<div class="fleft wi_100  sm-wi_60 xsip-wi_60 xs-mar0 "> 
										    
													 
									 
											<input type="text" name="e_number" id="e_number" value="<?php echo $workInfo['e_number']; ?>" class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir">
							...
							<div class="white_bg mart0 brdb bg_fffbcc_a marb0" style=""> 
										...
										<div class="fleft wi_80 ">
										<a href="#" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Permission</span></a> 
										<div class="fleft wi_100  xs-mar0  "> 
										    
									 
											<select class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir" name="permission" id="permission" onchange="updateCard(this.value);">
										...
										<option value="2" <?php if($workInfo['company_permission']==2) echo 'selected'; ?>>No</option>
											...
											<div class="white_bg mart0 brdb bg_fffbcc_a marb0 <?php if($workInfo['company_permission']==1) echo ''; else echo 'hidden'; ?>" style="" id="selectCard"> 
										<div class="container padtb15 padrl10  brdrad1 fsz14 dark_grey_txt"> 
										<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall"> 
										<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12"> 
										...
										<div class="fleft wi_80 ">
										<a href="#" class="dark_grey_txt txt_0070e0_sbh"><span class="edit-text padt0 jain2 dblock brdclr_lgtgrey2 bold fsz14">Cards</span></a> 
										<div class="fleft wi_100  xs-mar0  "> 
										    
									 
											<select class="edit-text padt0 jain2 dblock  brdclr_lgtgrey2 fsz18 nobrd ffamily_avenir" name="card_id" id="card_id" >
	...
	<div class="clear" id=""></div>
							...
							<div class="red_txt fsz16" id="errorMsgUser"></div>
							
							 	<div class=" padtb20 talc fsz16  mart35" onclick="submitform();"> <a href="#" class="forword minhei_55p red_ff2828_bg fsz18 ffamily_avenir">Update </a> </div>
							
							
						<?php if($relievingCount['num']==0) { if($data['user_id']!=43) { ?>			
						<div class=" padb20 talc fsz16  mart35"> <a href="../../terminationInfo/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" class="forword minhei_55p red_ff2828_bg fsz18 ffamily_avenir">Relieve </a> </div>
						<?php } } ?>
