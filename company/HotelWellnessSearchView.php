				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc xs-padb15  "> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn nobold" > Search and connect with your wellness for health service.</a></div>	
							
								 
					 
						<form action="../../searchWellness/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>" method="POST" id="save_indexingcs" name="save_indexingcs" accept-charset="ISO-8859-1">
							<div class="dflex alit_s marb15">
								<input type="message" name="message" id="message" class="minhei_65p flex_1 padrl15 lgtgrey_bg nobrd fsz15 ffamily_avenir" placeholder="Wellness name" value="">
								<button type="submit" class="minhei_65p padrl30 forword button_bg_color nobrd fsz14 bold ffamily_avenir">Search</button>
							</div>
							</form>
							 <?php echo $wellnessRequestSent; ?>
