   ...
   function informEmployee()
			{
				$("#error_msg_form").html('');
				 ...
				 if($("#reservation_fee").val()=="" || $("#reservation_fee").val()==null)
				{
					 
					$("#error_msg_form").html('Please enter total paid');
					return false;
				}
				 
				
				 if($("#reservation_fee").val()!=$("#sell_price").val())
				{
					 
					$("#error_msg_form").html('Total paid must be equal to balance amount');
					return false;
				}
					...
					var send_data={};
					send_data.move_out_date=$("#move_out_date").val();
					send_data.move_in_date=$("#move_in_date").val(); 
					$.ajax({
						type:"POST",
						url:"../../../checkDates",
						data:send_data,
						...
						if(data1==0)
						{
						$("#error_msg_form").html('Move out date must be before move in date');
					return false;	
						}
						else
						{
...
<a class="header__logo xs-fsz20 changedText " href="../../../listEmployeesProperties/<?php echo $data['cid']; ?>" style="
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
			...
			<a class="setting__link  active" href="#">
                ...
                </svg><span style="color:#f67f00">Sell property</span></a>
				 
				<?php } else if($fetchPropertyContacTInfo['property_status']==2 && $fetchPropertiesAddress['is_reserved']==0) { ?>
				<a class="setting__link  active" href="#">
                <svg class="icon icon-bell">
                  <use xlink:href="#icon-bell" style="fill:#f67f00;"></use>
                </svg><span style="color:#f67f00">Reserve property</span></a>
				<?php } ?>
...
<div class="checkout__list">
 ...
 <div class="upload__head" style="margin-bottom:0px;">
                  <h2 class="upload__title h2">Sell Your Property</h2>  
				  
                </div>
				<div class="browse__info info changedText padb40" style="border-bottom: 2px solid #353945;">Complete the form below to update the sold information
</div>
<form class="checkout__item js-tabs-item" action="../../../updateVitechAdddressSold/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
  ...
  <div class=" mart40" id="propertyDetailStatusInfo">
						<div class="upload__item">
                          ...
                          <div class="upload__col upload__col_w70">
                            <div class="upload__label">Selling price</div>
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="number" name="sell_price1" id="sell_price1" placeholder="e. g. 180" value="<?php echo $propertyReservationDetail['selling_price']; ?>" readonly >
                                  </div>
                                </div>
                              </div>
                              <div class="upload__cell">
    ...
    color: grey; border-radius: 12px;
      background: white; width:100%;" disabled>
                                      <option value="1" <?php if($propertyReservationDetail['currency_id']==1) echo 'selected'; ?>>$ USD</option>
                                      <option value="2" <?php if($propertyReservationDetail['currency_id']==2) echo 'selected'; ?>>� EUR</option>
                                    </select>
                                  </div>
                                </div>
                              </div>
						  ...
						  <div class="upload__col upload__col_w30" id="status_info">
                            <div class="upload__label">Reserved till date</div>
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="date" name="sold_on" id="sold_on" min='<?php echo date('Y-m-d');?>' value="<?php echo $propertyReservationDetail['reserved_till_date']; ?>" style=" color:grey;"  readonly>
                                  </div>
                                </div>
                              </div>
						  ...
						  <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="reservation_fee1" id="reservation_fee1" value="<?php echo $propertyReservationDetail['reservation_fee']; ?>" placeholder="e. g. 100" style=" color:grey;"  readonly>
                            </div>
                          </div>
					   ...
					   <div class="checkout__subtitle">Home buyer details</div>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="first_name" id="first_name" value="<?php echo $propertyReservationDetail['buyer_first_name']; ?>" placeholder="e. g. Kowaken" style=" color:grey;"  readonly>
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="last_name" id="last_name" value="<?php echo $propertyReservationDetail['buyer_last_name']; ?>" placeholder="e. g. Ghirmai" style=" color:grey;"  readonly>
                            </div>
                          </div>
						  </div>
						  ...
						  <div class="field" style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="owner_email" id="owner_email" value="<?php echo $propertyReservationDetail['buyer_email']; ?>" placeholder="e. g. xyz@gmail.com" style=" color:grey;" readonly >
                            </div>
                          </div>
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" disabled>
							<?php foreach($countryList as $category => $value) { ?>
											<option value="<?php echo $value['id']; ?>" <?php if($propertyReservationDetail['buyer_country_id']==$value['id']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
											 <?php } ?>
								  </select>
                            </div>
                          </div>
						  ...
						  <div class="upload__col upload__col_w70">
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="uphno" id="uphno" value="<?php echo $propertyReservationDetail['buyer_phone_number']; ?>" placeholder="e. g. xxxxx12342" style=" color:grey;"  readonly>
                            </div>
                          </div>
						  </div>
						  </div >
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
						<div class="upload__item">
						   ...
						   <div class="upload__row">
                          <div class="upload__col upload__col_w70">
                            <div class="upload__label">Balance/Total amount to be paid</div>
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="number" name="sell_price" id="sell_price" value="<?php echo $propertyReservationDetail['selling_price']-$propertyReservationDetail['reservation_fee']; ?>" placeholder="e. g. 180" readonly>
                                  </div>
                                </div>
                              </div>
                              <div class="upload__cell">
    ...
    color: grey; border-radius: 12px;
      background: white; width:100%;" disabled>
						  ...
						  <div class="upload__col upload__col_w30" id="status_info">
                            <div class="upload__label">Payment date</div>
                            <div class="upload__line">
                              <div class="upload__cell">
                                <div class="field field_empty">
                                  <div class="field__wrap">
                                    <input class="field__input" type="date" name="sold_on" id="sold_on" min='<?php echo date('Y-m-d');?>'  max='<?php echo date('Y-m-d');?>' value='<?php echo date('Y-m-d');?>' style=" color:grey;"  readonly>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="upload__col upload__col_w50">
						   <div class="field" style="margin-bottom:24px;">
							<div class="field__label changedText" style="color:#787f91;">Payment option</div>
							<div class="field__wrap">
							 
							<select  class="   "  name="payment_option" id="payment_option" style="height: 48px;
								padding: 0 14px;  border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52" >
											   
											   <option value="1" class="lgtgrey2_bg changedText">Cash</option>
												<option value="2" class="lgtgrey2_bg changedText">Credit/Debit Card</option>	
												<option value="3" class="lgtgrey2_bg changedText">Netbanking</option>
                        ...
                        <div class="upload__col upload__col_w50">
						  <div class="field"  style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="reservation_fee" id="reservation_fee"  placeholder="e. g. 100" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						  </div>
						  <div class="checkout__row  " style="margin-bottom:24px;">
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Move out date for seller</div>
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="move_out_date" id="move_out_date" min='<?php echo date('Y-m-d');?>'  value='<?php echo date('Y-m-d');?>' placeholder="2024-10-10" style=" color:grey;"  >
                            </div>
                          </div>
						  
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Move in date for buyer</div>
                            <div class="field__wrap">
                              <input class="field__input" type="date" name="move_in_date" id="move_in_date" min='<?php echo date('Y-m-d');?>'  value='<?php echo date('Y-m-d');?>' placeholder="2024-10-10" placeholder="2024-10-10" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
