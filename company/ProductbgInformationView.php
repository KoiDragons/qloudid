...
<html>
	...
	$value_a=$path."html/usercontent/images/default-profile-pic.jpg"; ?>
	<head>
		<meta charset="utf-8">
	...
	function togglePopup()
	{
		...
		else
		{
			...
			function imageUpdateParkering()
			{
				
				
				var bg_url = $('#image-dataParkering').css('background-image');
				//alert(bg_url);
				if(bg_url=="" || bg_url==null || bg_url=="none")
				{
					alert("please select image");
				...
				{
					$('#image-dataParkering1').val(bg_url);
					//alert($('#image-data1').val());
				}
				document.getElementById("save_image_parkering").submit();
			}
			function imageUpdateBuds()
			{
				
				
				var bg_url = $('#image-dataBuds').css('background-image');
				//alert(bg_url);
				if(bg_url=="" || bg_url==null || bg_url=="none")
				{
					alert("please select image");
				...
				{
					$('#image-dataBuds1').val(bg_url);
					//alert($('#image-data1').val());
				}
				document.getElementById("save_image_buds").submit();
			}
		</script>
	</head>
	...
	<body class="white_bg" id="bodyBg">
		...
		<!-- HEADER -->
		<div class="column_m header xs-header bs_bb white_bg" id="headerData">
		...
		<div class="column_m pos_rel" onclick="checkFlag();" id="loginBank">
			...
			<div class="column_m container zi5 mart40 xs-mart20 " onclick="removeActive();">
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
								...
								<div class="scroll-fix-wrap column_m xs-maxhei_100-90p sm-maxhei_100-90p xs-ovfl_auto sm-ovfl_auto hidden-xs hidden-sm xs-pos_fixi xs-top40pi sm-pos_fixi sm-top40pi xs-bxsh_2220_03 sm-bxsh_2220_03  brdr_new fsz14" id="scroll_menu">
										...
										<div class="padl10">
											<div class="sidebar_prdt_bx marr20 brdb_b padb20">
												...
												<div class="pad20 wi_100 xs-wi_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz95 xs-fsz20 brdrad1000 yellow_bg_a lgtgrey2_bg black_txt" style="
													...
													border-radius: 2%;
													" id="aa_1227620">I</div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
														<!-- Meta -->
														<div class="padtr10 fsz15"> <span>Inställningar</span>  </div>
													</a></div>
											</div>		
											<div class="clear"></div>
										</div>
									...
									<ul class="dblock mar0 padl10 fsz14">
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											<h4 class="padb5 uppercase ff-sans black_txt trn">Background image</h4>
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Bud & Leverans </span>
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
													<li class="dblock padrb10">
						...
						<div class="column_m container tab-header  talc dark_grey_txt mart5">
							<div class="wrap maxwi_100 dflex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 brdb_new">
								<div class="white_bg tall">
									...
									<!-- Logo -->
									<h1 class="fsz25 bold">Bakgrundsbild</h1>
									<!-- Logo -->
									<div class="marb0"> <a href="#" class="blacka1_txt fsz15 xs-fsz16 sm-fsz16  edit-text jain_drop_company"> Här kan du välja en bakgrundsbild till dina appar.</a></div><a href="#" class="blacka1_txt fsz45 xs-fsz30 sm-fsz30 ">
										<!-- Meta -->
								...
								<div class="wi_30 xs-wi_100 flex_1 order_1 xs-order_1 xs-tall tall mart10 brdrad5 pad20 xs-padrl25 and xs-padtb10 ">
									...
									<ul class="mart10 pad0 tall xs-mart0">
										...
										<li class="dblock mar0 marb10 pad0">
											...
											<div class=" dblock_siba pad15 padb2 lgtgrey2_bg">
												...
												<div class="imgwrap nobrd">
													<div class="cropped_image" style="background-image: <?php echo $value_a; ?>;" id="image-data" name="image-data"></div>
													<div class="subimg_load">
														<a href="#" class="load_button" style="background: #FFF;color: #999; display:none;">Change</a>
													</div>
												</div>
											</div>
										<input type="hidden" id="p_name" name="p_name" value="1" />
											</div>
										</li>
										...
										<li class="dblock mar0 marb10 pad0">
											...
											<div class=" dblock_siba  padb0 ">
												<div class="mart0 talc">
													<input type="button" value="Save" class="wi_100 maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" onclick="imageUpdate();">
					...
					<form method="POST" action="../updateImageParkering/<?php echo $data['cid']; ?>" id="save_image_parkering" name="save_image_parkering" >
						<div class="column_m marb10  talc lgn_hight_22 fsz16 xs-marb0 " onclick="checkFlag();">
					...
					<div class="padrl10 white_bg xs-padrl0">
								...
								<div class="wi_30 xs-wi_100 flex_1 order_1 xs-order_1 xs-tall tall mart10 brdrad5 pad20 xs-padrl25 and xs-padtb10 ">
									...
									<ul class="mart10 pad0 tall xs-mart0">
										...
										<li class="dblock mar0 marb10 pad0">
											...
											<div class=" dblock_siba pad15 padb2 lgtgrey2_bg">
												<div class="wp_columns_upload wp_columns_upload_custom marb20 brd brdclr_white">
												<input type="hidden" name="image-dataParkering1" id="image-dataParkering1" value="<?php //echo $value_a; ?>" class="hidden-image-data" />
												
												
												<div class="imgwrap nobrd">
													<div class="cropped_image" style="background-image: <?php echo $value_a; ?>;" id="image-dataParkering" name="image-dataParkering"></div>
													<div class="subimg_load">
														<a href="#" class="load_button" style="background: #FFF;color: #999; display:none;">Change</a>
													</div>
												</div>
											</div>
										<input type="hidden" id="p_nameParkering" name="p_nameParkering" value="2" />
											</div>
										</li>
								...
								<div class="wi_30 xs-wi_100 fxshrink_0 order_3 xs-order_3 martb20  xs-marr0 talc   xs-mart0 xs-marb0 pad20 xs-padrl25 and xs-padtb10 ">
									...
									<ul class="mart10 pad0 tall">
										...
										<li class="dblock mar0 marb10 pad0">
											...
											<div class=" dblock_siba  padb0 ">
												<div class="mart0 talc">
													<input type="button" value="Save" class="wi_100 maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" onclick="imageUpdateParkering();">
						...
						<form method="POST" action="../updateImageBuds/<?php echo $data['cid']; ?>" id="save_image_buds" name="save_image_buds" >
						<div class="column_m marb10  talc lgn_hight_22 fsz16 xs-marb0 " onclick="checkFlag();">
					...
					<div class="padrl10 white_bg xs-padrl0">
								...
								<div class="wi_30 xs-wi_100 flex_1 order_1 xs-order_1 xs-tall tall mart10 brdrad5 pad20 xs-padrl25 and xs-padtb10 ">
									...
									<ul class="mart10 pad0 tall xs-mart0">
										...
										<li class="dblock mar0 marb10 pad0">
											...
											<div class=" dblock_siba pad15 padb2 lgtgrey2_bg">
												<div class="wp_columns_upload wp_columns_upload_custom marb20 brd brdclr_white">
												<input type="hidden" name="image-dataBuds1" id="image-dataBuds1" value="<?php //echo $value_a; ?>" class="hidden-image-data" />
												
												
												<div class="imgwrap nobrd">
													<div class="cropped_image" style="background-image: <?php echo $value_a; ?>;" id="image-dataBuds" name="image-dataBuds"></div>
													<div class="subimg_load">
														<a href="#" class="load_button" style="background: #FFF;color: #999; display:none;">Change</a>
													</div>
												</div>
											</div>
										<input type="hidden" id="p_nameBuds" name="p_nameBuds" value="3" />
											</div>
										</li>
								...
								<div class="wi_30 xs-wi_100 fxshrink_0 order_3 xs-order_3 martb20  xs-marr0 talc   xs-mart0 xs-marb0 pad20 xs-padrl25 and xs-padtb10 ">
									...
									<ul class="mart10 pad0 tall">
										...
										<li class="dblock mar0 marb10 pad0">
											...
											<div class=" dblock_siba  padb0 ">
												<div class="mart0 talc">
													<input type="button" value="Save" class="wi_100 maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" >
						...
						<div class=" white_bg   brdrad3  xs-nobrd hidden" style="">
							<div class="column_m container pad25 padb20 xs-pad10 xs-padt20 xs-padb20  white_bg  fsz14 dark_grey_txt  ">
								
									<form method="POST" action="../updateImage/<?php echo $data['cid']; ?>" id="save_image" name="save_image" >
									<div class="wi_100 xs-order_1 xs-wi_100">
									...
									<div class="wi_100 xs-wi_100 xs-order_3 xs-padt10 fsz12">
											...
											<div class="fleft wi_100  xs-wi_50 sm-wi_50 bs_bb padrl2 padb20"> <span class="trn" >Product name</span> <select class="wi_100 dblock brdb brdclr_lgtgrey2 curt lgtgrey2_bg pad10 mart5 fsz20 hei_50p p_name" id="p_name" name="p_name">
												
												<option value="1">Visitor</option>
												<option value="2">Parkering</option>
											</select> </div>
											<div class="hidden-xs mart10 talc fsz16  "> <a href="#" class="dblue_btn trn brdrad3" onclick="imageUpdate();">Add/update BG</a> </div>
										</div>
