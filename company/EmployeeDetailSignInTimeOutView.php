		...
		<div class="column_m pos_rel">
			...
			<div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_400p maxwi_100 pos_rel zi5 marrla pad35   xxsi-box_shadow_00000070  box_shadow_00000070 xxs-box_shadow_00000070">
						...
						<form action="../../verifySignature/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" method="POST" name="save_indexing_user" id="save_indexing_user"  accept-charset="ISO-8859-1" autocomplete="off" >
			...
			<input type="hidden" name="ip" id="ip" value="<?php echo $_POST['ip']; ?>" />
							...
							<div class="padt20 xxs-talc talc">
								<a href="#" onclick="submitForm();"><input type="button" value="Try again" class="forword button_bg_color minhei_55p"></a>
				...
				<div class="tw_clmn padl10 talr lgn_hight_18 fsz16 wi_70"> <a href="https://www.safeqloud.com/public/index.php/QloudidPersonalEng">Cancel</a> </div>
				</div>
						</div>
