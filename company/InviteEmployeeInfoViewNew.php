 	...
 	function changeClass(link)
			...
			function submitform()
			{
				 ...
				 if($("#p_country").val()==0 || $("#p_country").val()=="")
				{
					...
					$("#errorMsg").html('Please select employee country');
					return false;
				}
				
				if($("#professional_category_id").val()==0)
				{
				...
				if($("#professional_subcategory_id").val()==0)
				{
					
					$("#errorMsg").html('Please select service skill');
					return false;
				}
			
			if($("#pmobile").val()==0 || $("#pmobile").val()=="")
			{
				
				$("#errorMsg").html('Please enter personal phone number');
				return false;
			}
			
				var send_data={};
				send_data.p_country=$("#p_country").val();
				send_data.pmobile=$("#pmobile").val();
				send_data.email=$("#email").val();
				$.ajax({
					type:"POST",
					url:"../verifyEmployeeExistance/<?php echo $data['lid']; ?>/<?php echo $data['cid']; ?>",
					data:send_data,
					dataType:"text",
					...
					success: function(data1){
						...
						$("#errorMsg").html("Personal phone number already registered with other user !!!");
						return false;
						}
						else
						{  
				...
				send_data.professional_category_id=$("#professional_category_id").val();
				send_data.professional_subcategory_id=$("#professional_subcategory_id").val();
				 if(send_data.title=="")
				 {
			...
			function updateServices(id)
			{
				...
				$.ajax({
						...
						if(data1)
					{
						...
						document.getElementById("professional_subcategory_id").innerHTML=data1;
					}
				}
				});
...
<div class="upload__head" style="margin-bottom:0px;">
                  <h2 class="upload__title h2">Register Your Employee</h2>
				  
                </div>
				<div class="browse__info info changedText padb40" style="border-bottom: 2px solid #353945;">Fill out the form below to enroll your employee in our system
</div>
 
 
 
<form class="checkout__item js-tabs-item" action="#" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 <input type="hidden" name="came_from" id="came_from" value="8"/> 
 
   
                     
					 <div class="upload__item mart40">
					    <div class="checkout__line  margin-bottom24">
					   <div class="checkout__subtitle">Personal details of employee</div>
					   ...
					   <div class="checkout__row margin-bottom32">
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="fname" id="fname" placeholder="e. g. Kowaken" style=" color:grey;"  >
                            </div>
                          </div>
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="lname" id="lname" placeholder="e. g. Ghirmai" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						  
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Personal email</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="email" id="email" placeholder="e. g. xyz@gmail.com" style=" color:grey;"  >
                            </div>
                          </div>
    ...
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
						   ...
						   <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Personal mobile</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="pmobile" id="pmobile" placeholder="e. g. xxxx12345" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						  ...
						  <div class="upload__item">
						     <div class="checkout__line   margin-bottom24">
					   <div class="checkout__subtitle">Work details of employee</div>
						  ...
						  <div class="field  margin-bottom24">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="wemail" id="wemail" placeholder="e. g. xyz@gmail.com" style=" color:grey;"  >
                            </div>
                          </div>
						   ...
						   <div class="field  margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Which office</div>
                            <div class="field__wrap">
                               <select class=" "   id="location_id" name="location_id"    style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
                        ...
                        <div class="field">
                            <div class="field__label  changedText" style="color:#787f91;">Country</div>
                            <div class="field__wrap">
                              <select class=" "   id="d_country" name="d_country"  style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" >
								 <?php  foreach($userCountryList as $category => $value) 
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text" name="wmobile" id="wmobile" placeholder="e. g. xxxxx12345" style=" color:grey;"  >
                            </div>
                          </div>
						  </div>
						 ...
						 <div class="checkout__row margin-bottom24">
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Position</div>
                            <div class="field__wrap">
                               <select class=" "   id="job_family" name="job_family"  style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" onchange="job_function1(this.value);" >
                          ...
                          <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">Job function</div>
                            <div class="field__wrap">
                              <select class=" "   id="job_function" name="job_function"  style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" onchange='job_position1(this.value);'>
								 <option value="">Select</option>
								  </select>
                            </div>
                          </div>
						  ...
						  <div class="field" style="flex: 0 0 calc(33% - 16px);    width: calc(33% - 16px);    margin: 0 8px;">
                            <div class="field__label  changedText" style="color:#787f91;">JOb title</div>
                            <div class="field__wrap">
                              <select class=" "   id="title" name="title"  style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;">
								 <option value="">Select</option>
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                              <select class=" "   id="professional_category_id" name="professional_category_id" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" onchange="updateServices(this.value);">
	  <option value="0"  class="lgtgrey2_bg">Select</option>
								 <?php  foreach($listCategories as $category => $value) 
															{
						   ...
						   <div class="field">
                            ...
                            <div class="field__wrap">
                               <select class=" "   id="professional_subcategory_id" name="professional_subcategory_id" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" >
					   ...
					   <input type="hidden" name="wphone" id="wphone"  value='' />
...
<div class="profile" style="background: transparent;">
                <div class="profile__main">
                  <div class="profile__avatar"><img src="<?php echo $path; ?>html/fleet/img/content/avatar-girl.jpg" alt="Avatar"></div><a class="profile__update js-popup-open" href="#popup-avatars" data-effect="mfp-zoom-in">
