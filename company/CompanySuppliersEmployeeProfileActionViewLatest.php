...
<a class="header__logo xs-fsz25 changedText" href="https://www.safeqloud.com/user/index.php/LoginAccount/selectEmployer" style="
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Welcome To <?php echo $companyDetail['company_name']; ?></div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Everything's set. Ready for a productive day ahead!</div>
...
<div class="section brands xsi-mart60  " style="
    ...
    margin-bottom: 50px;
">
<div class="panel__nav"><a class="panel__link active" href="javascript:void(0);">To do</a></div>
...
<div class="brands__list" style="display:flex;">
			...
			<div class="brands__item" style="flex: 0 0 100% !important;"><a href="#"><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 40px;text-align: center;">5</div><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Things to do</div></a>
</div>
		...
		<div class="flights__center center xs-padrl25" style="padding-bottom:0px;">
		 <div class="panel__nav"><a class="panel__link active" href="javascript:void(0);">Appstore</a><a class="panel__link" href="javascript:void(0);">Marketplaces</a></div>
		  <div class="wi_100 xs-wi_100" style="">
								...
								<div href="#" class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz25" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;   border-radius: 6px; color:white;"><?php echo $value['app_name']; ?><br>
									   ...
									   border:1px solid #282b34 !important;
													...
													<?php } $i++; } ?>
													 ...
													 <?php 
												foreach($marketplaceList as $category => $value) 
													{
													if($i==1)	{	 
													?>
													
													<div class="wi_50 xxs-wi_33 dblock fleft  padt30  dark_grey_txt fsz50 xs-fsz12 crm featured-app talc" style="height:560px; padding-top:200px; border:1px solid #282b34; margin:10px 10px 10px 0px;  border-radius: 6px; color:white;"><?php echo $value['marketplace_name']; ?><br>
										 
											<a class="header__logo  changedText  ButtonWhite" href="#" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									  ...
									  border:1px solid #282b34 !important; 
													...
													<?php } else if($i>1 && $i<=5) { ?>
								<div href="#" class="talc wi_24-4p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz25" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;   border-radius: 6px; color:white;"><?php echo $value['marketplace_name']; ?><br> 
											<a class="header__logo  changedText  ButtonWhite" href="#" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
								...
								<div href="#" class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz25" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;"><?php echo $value['marketplace_name']; ?><br>
											<a class="header__logo  changedText  ButtonWhite" href="#" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
