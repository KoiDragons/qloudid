...
<a class="header__logo changedText" href="../searchPropertyInformation/<?php echo $data['cid']; ?>" style="
...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">Added objects
</span> </h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Select property below to request access
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Objects</div>
                                      </a>
...
<form action="../propertyInformation/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
<input type="hidden" id="address" name="address" value="<?php echo $_POST['address']; ?>" />
</form>
			 <div class="sorting__foot">
               ...
               <a href="javascript:void(0);" onclick="submitForm();">  <button class="button-stroke catalog__button">
    ...
    margin-bottom: 0px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title" style="font-size:30px; color:white;"><?php echo $value['streetAddress'].' '.$value['areaName']; ?></div></a>
...
">
                ...
                <div class="description__parameter">
                  ...
                  </svg><?php  echo $value['floor']; ?> floor</div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>Apart no <?php  echo $value['apartment_number']; ?></div>
				  
				   <div class="description__parameter">
                 <a href="../selectRequestType/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" > <svg class="icon icon-arrow-next">
