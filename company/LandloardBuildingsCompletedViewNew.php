  ...
  <body class="dark" style="background: #131922">
    ...
    <div class="outer">
	  ...
	  <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg visible-xs" style="padding:0px;">
			...
			<a href="../../Community/listSociety/<?php echo $data['cid']; ?>"> <div class=" talc   padt10 padb0 hei_45p black_txt" style="font-size:16px;">
					*** Add New society ***
				</div></a>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Buildings</a></li>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			    ...
			    <a class="categories__item    " href="javascript:void(0);" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle   " style="color:#f67f00 !important;">Not started</div>
                                      </a>
									  
									  <a class="categories__item    " href="../listBuildings/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle    txt_787f91" >Started</div>
                                      </a>
									  
									  
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Completed</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link " href="#">Buildings</a> </div>
                 
                   <div class="sorting__select hidden-xxs">
               <a href="../buildingInformation/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button">
		  ...
		  <div class="flights__sorting hidden-xxs " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
               ...
               <div class="flights__container" style="padding-left:0px;">
				...
				<?php $i=1; 
								foreach($buildingsList as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title wi_30" style="font-size:20px; color:white; margin-bottom: 0px;"><?php echo $value['building_name']; ?></div>
...
">
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $value['street_address']; ?></div>
                <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php echo $value['city']; ?></div>
				  
				  <div class="description__parameter" style="margin-left:96px;  margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg>Block - <?php echo $value['block_number']; ?></div>
                
              </div>
			  <?php if($value['society_connected']==0) { ?>
                        <a href="../selectSociety/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><div class="card__price" style="color:#52d4f4 ; padding:10px; box-shadow: inset 0 0 0 2px #52d4f4 ;">
                        
                        <div class="card__actual">Connect society</div>
                      </div></a>
			  <?php } else { ?>
			   <a href="javascript:void(0);"><div class="card__price" style="color:#52d4f4 ; padding:10px; box-shadow: inset 0 0 0 2px #52d4f4 ;">
                        
                        <div class="card__actual"><?php echo $value['society_name']; ?></div>
                      </div></a>
			  <?php } ?>
                    </div>
