 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Not completed</div>
                                      </a>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px; min-width:200px;"><?php echo substr($value['address'],0,28); ?></div>
...
">
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php  echo $value['bedrooms']; ?> Bedrooms</div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['bathrooms']; ?> Bathrooms</div>
                <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['square_footage']; ?> sqm</div>
              </div>
                          
					  
					  
					  <a href="../refineImportedProperties/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;"  >
