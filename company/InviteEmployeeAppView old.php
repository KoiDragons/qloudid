...
<div class="section work xs-padrl25   xs-marb25i hidde hidden-xs" style="margin-bottom:55px; ">
...
<div class="travel__center center   padb136 xxs-padrl25 " style="border-bottom:2px solid #23262F;  max-width: 1132px;
     margin-bottom:100px; padding-bottom:80px;  padding-left:0px; padding-right:0px;">
         ...
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Add numbers of employees and their email address to send an invitation</div>
