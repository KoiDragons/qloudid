										...
										<div class="tab-header martb10 padb10 xs-talc brdb_94cffd nobrdt nobrdl nobrdr talc">
                                            <a href="#" class="dinlblck mar5 padrl30     bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir">Employees</a>
											 <a href="../uninvitedEmployeesAccount/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Uninvited employees</a>
											     <a href="../oldEmployeesAccount/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  nobrd   bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah ffamily_avenir" >Old employees</a>
                                             
                                        </div>
										
										<div class="pad10 fsz16 xxs-talc talc lgtgrey2_bg">The employees from this list has received an invitation by email to their personal email address to connect.
										</div>
										 <?php 
												...
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	...
																	<span class="padt0 edit-text jain1 dblock brdclr_lgtgrey2  fsz14 bold  black_txt">Employee</span>
																	 ...
																	 <a href="../../EmployeeDetail/employeeAccount/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>"> <span class="edit-text  fsz18  jain2 dblock  lgn_hight_18 black_txt"><?php echo  substr(html_entity_decode($value['first_name']).' '.html_entity_decode($value['last_name']),0,18); ?></span>  </a>
																	</div>
																	
																	
																		 <a href="../../EmployeeDetail/employeeAccount/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>"><div class="fright wi_10 padl0   fsz40  padb0 ">
														 <span class="fas fa-arrow-alt-circle-right grey_txt"></span> 
													</div>	 	 </a>
													<?php if($value['verify_emp']==0)
													{?>
													<div class="fright wi_10 padl0 xs-wi_20  marl15 fsz40  xs-marl0 xxs-marr20  padb0 hidden">
														<a href="../../EmployeeDetail/getIdentificator/<?php echo $data['cid']; ?>/<?php echo $value['employee_id']; ?>"><span class="fas fa-check-circle green_txt"></span></a>
													</div>	
													<?php } ?>
																		</div>
											...
											<?php $i=0;
												...
												?> 
											<a href="../../EmployeeDetail/sentAccount/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>"><div class="column_m container  marb5   fsz14 dark_grey_txt">
												<div class=" white_bg marb0 brdb bg_fffbcc_a" style="">
																<div class="container padrl10 padtb15    brdrad1 fsz18 dark_grey_txt">
																	<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
