               ...
               <div class="flag_top_menu flefti  padb10 wi_80p " style=" padding : 10px 0 0 0;">
                  <ul class="menulist sf-menu fsz14 sf-js-enabled sf-arrows">
                     <li class="first last" style="margin: 0 30px 0 0;">
                        <a href="../../appsLocationInfo/<?php echo $data['cid']; ?>" class="lgn_hight_s1  padl10 fsz30 sf-with-ul"><i class="fas fa-long-arrow-alt-left header_arrow_blue_1e96c3" aria-hidden="true"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
							...
							<!-- Leave for security protection, read docs for details -->
									...
									<form action="../../updateLocationInfoData/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>" method="POST" name="save_indexing" id="save_indexing">
									
									<input type="hidden"  name="app_location" id="app_location" value="<?php echo $assignedAppInfo['location_id']; ?>" />
									<input type="hidden"  name="app" id="app" value="<?php echo $assignedAppInfo['app_id']; ?>" />
									<div class="on_clmn mart10 xxs-mart10 " id="app_mar">
										
										<div class="pos_rel">
										<select class="default_view wi_100 mart0 trans_bg nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828 ffamily_avenir dropdown-bg  fsz18 xxs-minhei_60p  minhei_65p tall padl0"  style="text-align-last:center;"  disabled>
												...
												<?php  foreach($downloadedApps as $category => $value) 
															...
															<option value="<?php echo $value['id']; ?>"   class="lgtgrey2_bg lgt_grey_txt fsz16 tall" <?php if($assignedAppInfo['app_id']==$value['id']) echo 'selected'; ?> disabled><?php echo $value['app_name']; ?></option>
														<?php 	}	?>                            
											</select>
									</div>
									</div>
									 <div class="on_clmn mart20 " id="ttlTime">
										
										<div class="pos_rel">
										<input type="number" name="totl_time" id="totl_time" min="0" value="<?php echo $assignedAppInfo['total_desk']; ?>" class="wi_100  pad10   talc  minhei_65p fsz18 nobrdt nobrdl nobrdr red_f5a0a5_txt xxs-minhei_60p brdb_red_ff2828 ffamily_avenir "  >
									</div>
									</div>
									<div class="on_clmn mart20 marb35" id="get_location" >
										...
										<select class="default_view wi_100 mart0 trans_bg nobrdt nobrdl nobrdr red_f5a0a5_txt brdb_red_ff2828 ffamily_avenir dropdown-bg  fsz18 xxs-minhei_60p  minhei_65p tall padl0" name="location" id="location"  style="text-align-last:center;">
												...
												<?php  foreach($locationAll as $category => $value) 
															{
																$category = htmlspecialchars($category); 
															?>
															
															<option value="<?php echo $value['id']; ?>"   class="lgtgrey2_bg lgt_grey_txt fsz16 tall" <?php if($assignedAppInfo['location_id']==$value['id']) echo 'selected'; ?> ><?php echo $value['visiting_address']; ?></option>
														<?php 	}	?>                            
											</select>                             
											</select>
									</div>
							...
							<div class="padtb20 xxs-talc talc ">
								...
								<button type="button" name="forward" class="forword hei_55p fsz18  t_67cff7_bg ffamily_avenir" onclick="assignApp();">Registrera</button>
