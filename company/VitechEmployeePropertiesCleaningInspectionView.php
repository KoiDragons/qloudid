 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
			       ...
			       <a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Inspection</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link   changedText" href="../guestReservationList/<?php echo $data['cid']; ?>">Reservation</a> <a class="nav__link changedText" href="../reservationCheckedInList/<?php echo $data['cid']; ?>">Checked in</a> <a class="nav__link changedText  " href="#">Checked out</a><a class="nav__link changedText " href="#">Clean now</a><a class="nav__link changedText active" href="#">Inspection</a></div>
    ...
    margin-bottom: 15px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px;color:white;padding-top: 8px;"><?php echo $value['shortSaleDescription']; ?></div></a>
...
">
                ...
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    <div class="receipt__category">Cleaning date</div>
                    <div class="receipt__subtitle"><?php echo date('Y-m-d',$value['room_cleaning_date']); ?></div>
                  </div>
                </div>
              </div>
