			 ...
			 <div class="column_m talc lgn_hight_22 fsz16 mart40 xs-mart20 ">
				<div class="wrap maxwi_100 padrl75 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
							...
							<form action="../../addResource/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								 ...
								 <div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-mart0 xs-marb20 marb35  xxs-tall talc xs-padb15  "> <a href="#" class="black_txt fsz25 xxs-tall xxs-lgn_hight_20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn">Please provide your employee's practice details here.</a></div>
						...
						<div class="wi_100 xxs-wi_100 xxs-padrl85 padrl140">
									...
									<div class="wp_columns_upload wp_columns_upload_custom marb20 brd brdclr_white " data-width="300" data-height="300">
										...
										<div class="imgwrap nobrd  ">
											<div class="cropped_image   grey_brd5  "  id="image-data1" name="image-data1"></div>
											...
											<?php 
												...
												?> 													
															<option value="<?php echo $value['id']; ?>" class="lgtgrey2_bg"><?php echo $value['type_of_lawer']; ?></option>
												<?php } ?>												
											...
											<div class="pos_rel">
												...
												<input type="number" name="price" id="price" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_55p fsz18 black_txt ffamily_avenir floating__input padt25"/> 
								 ...
								 <input type="hidden" name="practice_area" id="practice_area" value="" />
								   <div class="on_clmn  mart20   ">	
									...
									<div class="on_clmn   ">
										...
										<input type="hidden" id="ind1" name="ind1" value="" />
									
									 <div class="on_clmn mart20 ">
										 
											<div class="pos_rel">
												
												<input type="text" name="description" id="description"  class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_55p fsz18 black_txt ffamily_avenir floating__input padt25"/> 
