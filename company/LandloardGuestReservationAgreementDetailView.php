   ...
   function submitForm()
			{
				...
				if($('#full_payment').val()==0)
				{
				if($('#total_installment').val()>1)
				{
				for(i=2;i<=$('#total_installment').val();i++)
				{
					j=i-1;
					if($('#emi_date'+i).val()<=$('#emi_date'+j).val())
						{
...
<form class="checkout__item js-tabs-item" action="../../addAgreementInformation/<?php echo $data['cid']; ?>/<?php echo $data['rid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
 ...
 <div class=" mart40" id="propertyDetailStatusInfo">
				  <div class="upload__item">
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Account number</div>
                            <div class="field__wrap">
							 <select class=""   style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" name="bank_account_id" id="bank_account_id">
								  <?php  
					    ...
					    <script>
									function updateMonthlyFee(link)
										   {
											  body = $('body');
											   if($('#monthly_fee_applicable').val()==1)
											   {
												    $('#bodyData').addClass('dark');
												     ...
												     $(link).attr('checked',''); 
													$('#monthly_fee_applicable').val(0);	
													 $('#monthlyFeeInfo').addClass('hidden');
													 $('#monthly_fee').val(0);	
											   }
											   else
												   {
													 ...
													 $('#monthly_fee_applicable').val(1);
													 $('#monthlyFeeInfo').removeClass('hidden');
													  $('#monthly_fee').val(0);	
 ...
 <input type="hidden" id="monthly_fee_applicable" name="monthly_fee_applicable" value="1"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        ...
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateMonthlyFee(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you charge monthly fee?</div>
                    </div>
						  
						   <div class="field margin-bottom24 " id="monthlyFeeInfo">
                            <div class="field__label  changedText" style="color:#787f91;">Total monthly fee</div>
                            <div class="field__wrap">
                              <input class="field__input" type="number" name="monthly_fee" id="monthly_fee" value="0" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" style=" color:grey;"  >
                            </div>
                          </div>
						   ...
						   <script>
									function updateFullPaymentFee(link)
										   {
											  body = $('body');
											   if($('#full_payment').val()==1)
											   {
												    $('#bodyData').addClass('dark');
													 
												     $(link).attr('checked',''); 
													$('#full_payment').val(0);	
													 $('#installmentInfo').removeClass('hidden');
											   ...
											   else
												   {
												     ...
												     $(link).attr('checked','checked');  
													 $('#full_payment').val(1);
													 $('#installmentInfo').addClass('hidden');
 ...
 <input type="hidden" id="full_payment" name="full_payment" value="1"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        ...
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateFullPaymentFee(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">If the payment will be made in full?</div>
                    </div>
						  
						  
						  
						  
						  <div class="hidden" id="installmentInfo">
						  ...
						  <div class="field margin-bottom24">
                            ...
                            <div class="field__wrap">
							 	<input class="field__input"  name="emi_date<?php echo $i; ?>" id="emi_date<?php echo $i; ?>" value="<?php echo date('Y-m-d'); ?>"    type="date"   min="<?php echo date('Y-m-d'); ?>" style=" color:grey;"  >
 ...
 <input type="hidden" id="discount_allowed" name="discount_allowed" value="1"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        ...
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateDiscountInfo(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">If there is a discunt on early payment?</div>
                    </div>
                  
				   <div class="field margin-bottom24 " id="discountInfo">
						    ...
						    <script>
									function updateLatefeeInfo(link)
										   {
											  body = $('body');
											   if($('#late_fee_applicable').val()==1)
											   {
												    $('#bodyData').addClass('dark');
													 
												    $('#lateFeeInfo').addClass('hidden');
												     $(link).attr('checked',''); 
													$('#late_fee_applicable').val(0);	
													 
											   }
											   else
												   {
													 
												   $('#lateFeeInfo').removeClass('hidden');
												     $('#bodyData').addClass('dark');
												     $(link).attr('checked','checked');  
													 $('#late_fee_applicable').val(1);
 ...
 <input type="hidden" id="late_fee_applicable" name="late_fee_applicable" value="1"/>
				   <div class="setting__notification">
                      <div class="setting__main">
                        ...
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateLatefeeInfo(this);'  checked /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">If there is a late fee on late payment?</div>
                    </div>
                  
				   <div class="field margin-bottom24 " id="lateFeeInfo">
                            <div class="field__label  changedText" style="color:#787f91;">How much</div>
                            <div class="field__wrap">
						   ...
						   <div class="field margin-bottom24">
                            <div class="field__label  changedText" style="color:#787f91;">Agreement to be accepted in</div>
                            <div class="field__wrap">
							 <select class="" id="agreement_accept_term" name="agreement_accept_term" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun">
								  <?php for($i=1; $i<=10; $i++) { ?>
