	...
	<script>
		...
		function submitform()
		{
			 ...
			 if($("#queue_name").val()==null || $("#queue_name").val()=="")
			{
				...
				$("#errorMsg1").html('Please enter queue name');
				return false;
			}
			
			 if($("#t_operators").val()==null || $("#t_operators").val()=="")
			{
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
							...
							<form action="../addQueue/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									...
									<div class="on_clmn   mart10  ">
										...
										<input type="text" value="Queue name" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
											...
											<div class="pos_rel">
												...
												<input type="text" name="queue_name" id="queue_name" placeholder="Name" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir"/> 
								...
								<div class="on_clmn   mart20  ">
										...
										<input type="text" value="Total operators" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
											...
											<div class="pos_rel">
												...
												<input type="number" name="t_operators" id="t_operators" placeholder="Operators" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir"/> 
									...
									<input type="text" value="Opening hrs" class="wi_100 nobrd   pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="" />
										<select class="wi_100    lgtgrey_bg txtind10 brd tall minhei_55p fsz18 llgrey_txt ffamily_avenir  "   name="open_hrs" id="open_hrs" >
												...
												{
												?> 
											<option value="<?php echo $value['work_time']; ?>"  ><?php echo $value['work_time']; ?></option> 
												<?php } ?>               
											</select>
									</div>
									</div>
