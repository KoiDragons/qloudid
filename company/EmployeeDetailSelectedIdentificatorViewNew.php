...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../../CompanyCrm/adminAccount/<?php echo $data['cid']; ?>" style="
...
<div class="gallery xs-padrl15" style="margin-bottom:24px;">
              <div class="gallery__list  " style="margin-right:0px;">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view" href="<?php echo $imgs1; ?>" data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img src="<?php echo $imgs1; ?>" alt="Gallery"></a><a class="button-white button-small gallery__button" href="#">
                    <svg class="icon icon-image">
                      <use xlink:href="#icon-image"></use>
                    </svg><span class="changedText">Show all photos</span></a></div>
										<a class="gallery__preview xs-brdrad10 hidden" href="<?php echo $imgs; ?>" data-fancybox="gallery"><img src="<?php echo $imgs; ?>" alt="Gallery" class="xs-brdrad10"></a> 
 ...
 <div class="field" style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="0myzvs" value="<?php echo $row_summary ['country_name']; ?>" readonly >
                            </div>
                          </div>
						  
			<div class="field" style="margin-bottom:24px;">
                            <div class="field__label  changedText" style="color:#787f91;"><?php echo $userSelectedIdentificatorDetail['id_detail']; ?></div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="0myzvs" value="<?php echo $userSelectedIdentificatorDetail ['identity_number']; ?>" readonly >
                            </div>
                          </div>
						  ...
						  <div class="field" style="margin-bottom:24px;">
                            ...
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="0myzvs" value="<?php if($resultOrg['name']!="" || $resultOrg['name']!= null) echo $resultOrg['name']; else echo "-"; ?>" readonly >
                            </div>
                          </div>
						  
						    <div class="field" style="margin-bottom:24px;">
                            <div class="field__label  changedText" style="color:#787f91;">Expity date</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="0myzvs" value="<?php echo $userSelectedIdentificatorDetail['expiry_month'].'/'.$userSelectedIdentificatorDetail['expiry_year']; ?>" readonly >
                            </div>
                          </div>
						  
						  <div class="field" style="margin-bottom:24px;">
                            <div class="field__label  changedText" style="color:#787f91;">Issue date</div>
                            <div class="field__wrap">
                              <input class="field__input" type="text"  style="background:#23262F; color:grey;" fdprocessedid="0myzvs" value="<?php echo $userSelectedIdentificatorDetail['issue_month'].'/'.$userSelectedIdentificatorDetail['issue_year']; ?>" readonly >
                            </div>
                          </div>
</div>
...
<div class="checkout__inner js-tabs wi_50 xs-wi_100" style="padding-right:0px;">
  ...
  <form action="../../../verifySignature/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="UTF-8">
  <script>
                ...
                If picture are clearly visible?<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateRent(this);'  ><span class="theme__inner"><span class="theme__box"></span></span>
						  ...
						  <script>
									function updateSell(link)
										   ...
										   function updateNumber(link)
										   {
											  body = $('body');
											   if($('#idnumber_visible').val()==1)
											   {
												    $('#bodyData').addClass('dark');
										    ...
										    function updateIssueDateVisible(link)
										   {
											  body = $('body');
											   if($('#issue_date_visible').val()==1)
											   {
												    $('#bodyData').addClass('dark');
										     ...
										     function updateExpiryDateVisible(link)
										   {
											  body = $('body');
											   if($('#expiry_date_visible').val()==1)
											   {
												    $('#bodyData').addClass('dark');
               ...
               If name is clearly visible?<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateSell(this);' ><span class="theme__inner"><span class="theme__box"></span></span>
                </label>
              </div>
						    <input type="hidden" id="idnumber_visible" name="idnumber_visible" value="2"/>
						<div class="footer__theme mart45 padb20 uppercase" style="display:block; border-bottom:1px solid #353945; color:white;" >
                If number is clearly visible?<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateNumber(this);' ><span class="theme__inner"><span class="theme__box"></span></span>
                </label>
              </div>
			  
			    <input type="hidden" id="issue_date_visible" name="issue_date_visible" value="2"/>
						<div class="footer__theme mart45 padb20 uppercase" style="display:block; border-bottom:1px solid #353945; color:white;" >
               If issue date is clearly visible?<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateIssueDateVisible(this);' ><span class="theme__inner"><span class="theme__box"></span></span>
                </label>
              </div>
			  
			   <input type="hidden" id="expiry_date_visible" name="expiry_date_visible" value="2"/>
						<div class="footer__theme mart45 padb20 uppercase" style="display:block; border-bottom:1px solid #353945; color:white;" >
               If expiry date is clearly visible?<label class="theme js-theme fright">
                  <input class="theme__input" type="checkbox" onclick='updateExpiryDateVisible(this);' ><span class="theme__inner"><span class="theme__box"></span></span>
                </label>
              </div>
						...
						<a class="button checkout__button changedText" href="javascript:void(0);" onclick="submitform();" style="background: #3B71FE; padding:15px;">Get Details</a>
</div>
