...
<a class="header__logo xs-fsz20 changedText" href="../listEmployeesRentProperties/<?php echo $data['cid']; ?>" style="
...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase changedText" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; ">Broker wishlist</h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Wishlist managed by <?php echo $userSummary['first_name'].' '.substr($userSummary['last_name'],0,1); ?>
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00 ">Wishlist</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active changedText" href="#">Reservation</a> <a class="nav__link changedText" href="#">History</a> <a class="nav__link changedText" href="#">Pending</a></div>
		  ...
		  <div class="flights__sorting  " style="margin-top:20px; border-top:0px !important; margin-bottom:20px;  padding:0 !important;">
            ...
            <div class="flights__row">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
								foreach($propertyWishList as $category => $value) 
										{
										 ?> 
    ...
    margin-bottom: 15px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText" style="font-size:30px;color:white;padding-top: 8px;"><?php echo $value['sellPhrase']; ?></div></a>
<button class="button-stroke flight__button" style="
    width: 150px;
"><span class="flight_price">$<?php echo $value['broker_price_per_night']; ?></span> </button>
                       
                    </div>
					 
                    <div class="receipt_description receipt_description_flex" style="  margin-bottom: 20px; background: #23262F; border-radius:16px;">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('M d, Y',$value['checkin_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('M d, Y',$value['checkout_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo ($value['adult_guest']+$value['adult_child']); ?> guests</div>
                  </div>
                </div>
              </div>
					...
					<div class="card__foot">
                      ...
                      <div class="card__comment" style=" border-bottom: none;    padding-bottom: 20px;">
...
">
 <?php  echo $value['longSellingDescription']; ?> </div>
    ...
    padding-top: 10px;
    font-weight:100;
"><?php echo $value['sellPhrase']; ?></div>

   <a class="header__logo  changedText fright greenButton" href="javascript:void(0);" id="<?php echo $value['id']; ?>"style="
   ...
   " onclick="selectWishlist(<?php echo $value['id']; ?>);">Select</a>
   </div>
										 ...
										 {
											 var getValue=$('#proposal_data').val();
											if($('#'+id).hasClass('greenButton'))
											{
												$('#'+id).removeClass('greenButton');
												$('#'+id).addClass('redButton');		
												getValue=getValue+id+','; 
												$("#proposal_data").val(getValue);
												$('#'+id).html('Remove');
												$('.checkout__button').removeClass('hidden');
											}
											else
											{
												$('#'+id).addClass('greenButton');
												$('#'+id).removeClass('redButton');		
												getValue = getValue.replace(id+",", "");
												$("#proposal_data").val(getValue);
												$('#'+id).html('Select');
												 
												if(getValue=='')
												$('.checkout__button').addClass('hidden');
											}
											}
										...
										{
											$('error_msg_form').html('');	
											if($('#proposal_data').val()=='')
											{
											$('error_msg_form').html('Please select atleast one item for the proposal');	
											return false;
											}
											document.getElementById('save_indexing_proposal').submit();
										}
										 </script>
										...
										<form class="checkout__item js-tabs-item" action="../createProposal/<?php echo $data['cid']; ?>" method="POST" id="save_indexing_proposal" name="save_indexing_proposal" accept-charset="ISO-8859-1" style="display: block;">		
					 				<input type="hidden" id="proposal_data"	name="proposal_data" value="" />
									
									<div id="error_msg_form" class="fsz20 red_txt padtb20 tall"></div>
									<a class="button checkout__button changedText hidden" href="javascript:void(0);" style="padding: 16px; 24px;
    background: #3B71FE;" onclick="submitProposalForm();">Submit</a>
										</form>		
				  </div>
