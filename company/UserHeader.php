...
<div class="column_m header header_small bs_bb bg_colorn_new">
      ...
      <div class="fleft">
        <input type="button" value="" class="search_btn hi26" style="height:26px;" onclick="submitFormCom();">
			...
			<div class="top_menu frighti padt5">
				<ul class="menulist sf-menu">
					<li>
						<a href="javascript:void(0);" ><span class="white_txt pred_txt_h">+<?php echo $row_summary['company_name']; ?>...</span></a>
					</li>
					<li>
						...
						<ul>
							...
							<li>
								<div class="setting_menu pad15">
									...
									<ol class="">
									<li><a href="javascript:void(0);"><?php echo $row_summary['company_name']; ?></a>
										</li>
									<li>
