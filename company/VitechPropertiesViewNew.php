...
<a class="header__logo xs-fsz20 changedText" href="../../CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>" style="
...
<h2 class="browse__title h2 changedText xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall" ><?php echo $companyDetail['company_name']; ?></h2>
<div class="browse__info info changedText">List of all registered properties by the employees</div>
</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item bg_E7E7E7  " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_787f91">Manage</div>
                                      </a>
...
<div class="checkout__box">
 ...
 <a class="card card_row " style="border: 2px solid #353945;border-radius: 20px;margin-bottom: 20px;" href="../foreignPropertyDetail/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">
...
<div class="card__title changedText" style="font-size: 18px;line-height: 1.2667"><?php echo $value['objectNumber']; ?></div>
 
</div>
<div class="card__options wi_70">
 
<div class="card__option changedText" style="font-size: 14px;line-height:1.26667;"><?php if($value['property_status']==1) echo 'Already sold'; else echo 'Is to be sold'; ?>
</div>
