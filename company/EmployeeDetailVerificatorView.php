		...
		<div class="column_m   talc lgn_hight_22 fsz16 mart40 xs-mart20 " id="loginBank" onclick="checkFlag();"  >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="marb50 padt0   ">
								...
								<img src="https://media.giphy.com/media/3orifeSGD9fkfc9qLu/giphy.gif" class="maxwi_100 hei_auto  brdrad5" width="400">
							...
							<div class="padb20 xxs-padb0  ">		
									...
									<h1 class="marb0  xxs-talc talc fsz60 xxs-fsz45  padb10 black_txt trn ffamily_avenir">Restricted</h1>
									</div>
									<div class="mart20  marb20 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >You are not allowed to verify the identification of any person.</a></br>
									
									</div>
									<div class="lgtgrey_bg pad15 xs-marb20 marb20  xxs-talc talc ffamily_avenir"> <a href="#" class="black_txt fsz16  xs-fsz16 xxs-talc talc edit-text jain_drop_company trn" > For more information please contact support team</a></div>
								  <div class="talc padt20 ffamily_avenir mart35"> <a href="../../CompanyCrm/adminAccount/<?php echo $data['cid']; ?>"><input type="button" value="Close" class="forword minhei_55p  fsz18 red_ff2828_bg   ffamily_avenir"  ></a> </div>
