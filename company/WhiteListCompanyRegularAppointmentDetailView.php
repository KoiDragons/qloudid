...
<h2 class="browse__title h2" style="
    font-size: 60px;
    line-height: 70px;
"><?php echo substr($visitorsDetailRegularAppointmentDetail['full_name'],0,10); ?>.</h2>
<div class="browse__info info" style="
    margin-top: 6px;
">+<?php echo $visitorsDetailRegularAppointmentDetail['country_code'].' '.$visitorsDetailRegularAppointmentDetail['phone_number']; ?></div>
</div>
...
<input  type="hidden"  name="phone_number" id="phone_number" value="<?php echo $visitorsDetailRegularAppointmentDetail['phone_number']; ?>">
													...
													<div class="checkout__label">Business meeting</div>
													<input class="checkout__input js-date-single" data-format="MMM DD" data-single="false" data-container=".checkout__datepicker" type="text" readonly="" value="<?php echo $visitorsDetailRegularAppointmentDetail['emp_name']; ?> minutes">
