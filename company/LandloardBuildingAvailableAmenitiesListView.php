				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >Available amenities for your building</a></div>
						...
						<div class="on_clmn brdb">
					 		...
					 		<?php $i=1;
												...
												foreach($buildingsAvailableAmenitiesInfo as $category => $value) 
												{
													
													
												?> 

											<a href="../../buildingAmenityAddInfo/<?php echo $data['cid'].'/'.$data['bid'].'/'.$value['enc']; ?>">	<div class="column_m container  marb5   fsz14 dark_grey_txt">
