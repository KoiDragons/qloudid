   ...
   function submitForm()
		{
			$("#errorMsg1").html('');
			 ...
			 if($("#seller_deposit_fee").val()==null || $("#seller_deposit_fee").val()=="")
			{
				
				$("#errorMsg1").html('Please enter deposit fee');
				return false;
			}
			
			 if($("#seller_cleaning_fee").val()==null || $("#seller_cleaning_fee").val()=="")
			{
			...
			if($("#late_arrival_fee").val()==null || $("#late_arrival_fee").val()=="")
			{
				
				$("#errorMsg1").html('Please enter late arrival fee');
				return false;
			}
			
			if($("#seller_security_fee").val()==null || $("#seller_security_fee").val()=="")
			{
				
				$("#errorMsg1").html('Please enter security fee');
				return false;
			}
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
                ...
                <option value="../../../foreignPropertyHouseRule/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>">House rules</option>
					...
					<option value="../../../brokerFeeDetail/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>Broker fee</option>
			...
			<a class="setting__link  " href="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                ...
                </svg><span style="color:#f67f00">Broker fee</span></a>
			...
			<form class="checkout__item js-tabs-item" action="../../../updatePropertyBrokerFee/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
  
     
						  
						 
                <div class="setting__item  " style="display:block;">
                <h2 class="setting__title h2">Broker pricing</h2>
                  ...
                  <div class="setting__box">
                        ...
                        <div class="field">
                            ...
                            <div class="field__wrap">
                               <select class="" id="broker_commision" name="broker_commision" style="height: 48px;
								...
								color: grey; border-radius: 12px;
								 ...
								 <?php for($i=1;$i<=50;$i++) { ?>	
													 <option value="<?php echo $i; ?>" <?php if($fetchPropertiesPricing['broker_commision']==$i) echo 'selected'; ?>><?php echo $i; ?></option><?php } ?> 
								  </select>
                            </div>
                          </div>
