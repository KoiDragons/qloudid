...
<div class="field margin-bottom24">
<div class="field__label changedText" style="color:#787f91;">Broker</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo html_entity_decode($guestReservationDetail['broker_info']['company_name']); ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<select  class="   "  name="c_id" id="c_id" style="height: 48px;
    ...
    border-radius: 0px;" fdprocessedid="8mc52" disabled>
                         	...
                         	<?php foreach($userCountryList as $category => $value ) {
										?>
										<option value="<?php echo $value['id']; ?>" <?php if($guestReservationDetail['broker_info']['country_id']==$value['id']) echo 'selected'; ?>>+<?php echo $value['country_code']; ?></option>
										<?php } ?>
...
<div class="field__label changedText" style="color:#787f91;">Mobile</div>
<div class="field__wrap">
<input class="field__input"  name="phone" id="phone" value="<?php echo $guestReservationDetail['broker_contact_details']['sale_phone_number']; ?>"    type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
...
<div class="field__label changedText" style="color:#787f91;">Email</div>
<div class="field__wrap">
<input class="field__input" name="email" id="email" value="<?php echo $guestReservationDetail['broker_contact_details']['sale_email']; ?>"   type="text"   style="color:grey;background: #131922;border-bottom: 1px solid #ffffff;border-radius: 0px;/* border: none; */" readonly >
</div>
</div>
</div>
