				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40   xs-mart0 xs-pad0">
								<div class="padb20 xxs-padb0 ">		
									...
									<div class="mart20 xs-marb20 marb35  xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Please add your invoice address here</a></div>
									...
									<div class="on_clmn mart10">
										...
										<div class="pos_rel">
										<input type="text" name="si_address"  placeholder="Invoice address" id="si_address" value="<?php if($companyDetail['si_address']!="" || $companyDetail['si_address']!= null) echo $companyDetail['si_address']; else echo "-"; ?> " class="ffamily_avenir txtind10 fsz18   wi_100 trans_bg required minhei_65p xxs-minhei_60p nobrdt nobrdr nobrdl talc lgt_grey_txt brdb"    />
									...
									<div class="on_clmn mart20">
										...
										<div class="pos_rel">
										<input type="text" name="si_zip"  placeholder="Zip code" id="si_zip" value="<?php if($companyDetail['si_zip']!="" || $companyDetail['si_zip']!= null) echo $companyDetail['si_zip']; else echo "-"; ?>" class="ffamily_avenir txtind10 fsz18   wi_100 trans_bg required minhei_65p xxs-minhei_60p nobrdt nobrdr nobrdl talc lgt_grey_txt brdb"    />
									...
									<div class="on_clmn mart20">
										...
										<div class="pos_rel">
										<input type="text" name="si_city"  placeholder="City" id="si_city"  value="<?php if($companyDetail['si_city']!="" || $companyDetail['si_city']!= null) echo $companyDetail['si_city']; else echo "-"; ?>" class="ffamily_avenir txtind10 fsz18   wi_100 trans_bg required minhei_65p xxs-minhei_60p nobrdt nobrdr nobrdl talc lgt_grey_txt brdb"    />
									...
									<div class="on_clmn mart20 marb35">
										<div class="pos_rel">
													<select id="si_country" name="si_country"  class="wi_100 minhei_65p fsz18 fsz18 nobrdt nobrdl nobrdr llgrey_txt brdb  xxs-minhei_60p dropdown-bg nobold tall padl0 ffamily_avenir"  style="text-align-last:center;" >
