...
<a class="header__logo changedText" href="../../../../brokerOffPlanSocietyDetail/<?php echo $data['cid']; ?>/<?php echo $data['sid']; ?>" style="
...
<a href="#" class="header__item " style="box-shadow:none;  "><div class="header__item_language js-header-item" style="border-left: 0px solid !important; margin-left:0px;">
<button class="header__head js-header-head   hidden-xs changedText" style="
    color: #f67f00; font-size:16px;
"><?php echo substr($getLandloardBuildingDetails['company_name'],0,10); ?></button>

</div></a>
<?php if($getLandloardBuildingDetails['sale_phone_number']!=''){ ?>
 <a href="#" class="header_item  " style="box-shadow:none; margin-left:20px;"><div class="header_item_language js-header-item" style="border-left: 0px solid !important;  margin-left:20px;">
<button class="header__head js-header-head   hidden-xxs changedText" style="
 color:#777E90;     font-size:16px; font-weight: 700;
"><?php echo $getLandloardBuildingDetails['country_code'].' '.$getLandloardBuildingDetails['sale_phone_number']; ?></button>
          ...
          <div class="product__center center">
            <div class="control" style="margin-bottom:0px;"><a class="button-stroke button-small control__button" href="#">
              ...
              <ul class="breadcrumbs" style="list-style-type: none;">
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="#">Landloard</a></li>   
							 
                <li class="breadcrumbs__item"><a class="breadcrumbs__link changedText" href="#">Apartment</a></li>
          ...
          <div class="product__center center">
			 ...
			 <div class="gallery  " >
              <div class="xs-maxheight390">
                <div class="gallery__preview xs-brdrad10"><a class="gallery__view xs-maxheight254" href="javascript:void(0);"   data-caption="Spectacular views of Queenstown"><img src="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardApartmentDetailInfo['imageId']; ?>.jpg" alt="Gallery"></a><a class="button-white button-small gallery__button" href="<?php echo $path; ?>estorecss/tmp<?php echo $getLandloardApartmentDetailInfo['imageId']; ?>.jpg" data-fancybox="gallery" class="xs-brdrad10">
 ...
 <div class="profile__parameters xs-padrl0" style="background: #1b2739;">
			 ...
			 <div class="receipt__btns">
                <button class="button-stroke receipt__button changedText" fdprocessedid="ebxsyj"><span>Save</span><span>
                    ...
                    <svg class="icon icon-check">
                      <use xlink:href="#icon-check"></use>
                    </svg></span></button><a class="button receipt__button changedText" href="#" style="background:#F67F00; color:#000000;"><span>Reserve</span>
