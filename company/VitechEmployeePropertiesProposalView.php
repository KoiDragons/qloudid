      ...
      <div class="travel__col " style="padding-right: 0px;  max-width:595px; margin-bottom:0px;">
         <div class="travel__list" style="
            ...
            <div class="travel__content changedText " style="
                  ...
                  font-size: 27px;">Enter the client's information to create and send a tailored proposal.</div> 
...
<form class="checkout__item js-tabs-item" action="../<?php if($_POST['proposal_type']==3) { echo '../LandloardBroker/sendPropertyProposal/'; } else if($_POST['proposal_type']==4) { echo '../LandloardInhouse/sendPropertyProposal/'; } else echo 'sendPropertyProposal/'; ?><?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
 <input type="hidden" id="proposal_data" name="proposal_data"  value="<?php echo substr($_POST['proposal_data'],0,-1); ?>" />
  <input type="hidden" id="team_member" name="team_member"  value="<?php echo substr($_POST['team_member'],0,-1); ?>" />
   <input type="hidden" id="proposal_type" name="proposal_type"  value="<?php echo $_POST['proposal_type']; ?>" />
   <input type="hidden" id="team_available" name="team_available"  value="<?php echo $_POST['team_available']; ?>" />
...
<div class="field" style="flex: 0 0 calc(20% - 16px);
    width: calc(50% - 16px);
    margin: 0 8px;">
<div class="field__label changedText" style="color:#787f91;">Title</div>
<div class="field__wrap">
<select  class="  xs-fieldData "  name="title" id="title" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
				 
                         	  
											<option value="Mr" class="changedText">Mr</option>
											 	<option value="Mrs" class="changedText">Mrs</option>
								 
																											 	 
                          </select>
</div>
</div>
<div class="field" style="flex: 0 0 calc(40% - 16px);
    width: calc(50% - 16px);
    margin: 0 8px;">
<div class="field__label changedText" style="color:#787f91;">First name</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="fname" id="fname"    type="text"   placeholder="e. g. Kowaken"  style=" color:grey;">
</div>
</div>
<div class="field" style="flex: 0 0 calc(40% - 16px);
    width: calc(50% - 16px);
...
<div class="field__wrap">
<input class="field__input xs-fieldData"  name="lname" id="lname"    type="text"  placeholder="e. g. Ghirmai" style=" color:grey;">
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input xs-fieldData"  name="email" id="email"    type="text"  placeholder="e. g. xyz@gmail.com" style=" color:grey;">
</div>
</div>
...
<select  class=" xs-fieldData  "  name="country" id="country" style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;" fdprocessedid="8mc52">
...
<div class="field__wrap">
<input class="field__input xs-fieldData"  name="pnumber" id="pnumber"    type="text"  placeholder="e. g. 724637890"  style=" color:grey;"  >
</div>
</div>
</div>
</div>
