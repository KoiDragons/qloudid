 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Access</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Select employee below who have access to the selected app</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Access</div>
                                      </a>
...
box-shadow:none;">
               <div class="travels__list"  >
				...
				<?php     foreach($listAppAccessEmployees as $category => $value) 
										{
										
												?> 
               
				  
			 							  <div class="travels__card <?php if($value['is_access']==1) { echo 'white_bg'; } else echo 'bg10161d'; ?>  " <?php if($value['is_access']==1) echo 'style="background:white !important;"'; ?>>
                                  ...
                                  <div class="travels__body">
                                    <div class="travels__line" style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: #777E90;"><?php echo  substr(html_entity_decode($value['first_name']),0,15); ?></div>
                                        <div class="travels__location" style="color: #777E90;"><?php echo  $value['last_name']; ?></div>
                                      </div>
                                    <?php if($value['is_access']==0) { ?>   
                        <a class="header__logo  changedText fright ButtonWhite" href="../../provideAccess/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>/<?php echo $value['enc']; ?>"   style="
   ...
   " >Select</a>
				   ...
				   <?php } if($value['is_access']==1 && $value['is_admin']==0) { ?>
				    <a class="header__logo  changedText fright ButtonWhite" href="../../removeAccess/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>/<?php echo $value['enc']; ?>"   style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
