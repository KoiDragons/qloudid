...
<a href="https://www.pickapro.net/vacantposition.html" class="header__item "><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
			...
			<a href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>" class="header__item "s ><div class="header__item_language js-header-item" style="border-left: 0px solid !important;">
		  ...
		  <div class="header__item header__item_user js-header-item" style="display:block;">
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
                <div class="header__menu"><a class="header__link" href="../../CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>">
                    <svg class="icon icon-comment">
                      <use xlink:href="#icon-comment"></use>
                    </svg><span class="changedText">Setup</span></a><a class="header__link" href="../../CompanySuppliers/companyProfileIntegration/<?php echo $data['cid']; ?>">
                    <svg class="icon icon-home">
                      <use xlink:href="#icon-home"></use>
                    </svg><span class="changedText">Integration</span></a>
					<a class="header__link" href="https://www.safeqloud.com/user/index.php/AddCompany">
				...
				<a class="header__link" href="https://www.safeqloud.com/company/index.php/Company/companyAccount/<?php echo $data['cid']; ?>">
					...
					<a class="header__link" href="../companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">WELCOME TO TXP
</h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Where you will find your next client, buyer, seller, or guest.
</div>
</div></div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:40px; border-bottom:1px solid #353945;">
				...
				<a class="categories__item black_bg " href="javascript:void(0);" style="padding: 26px; padding-right:20px; padding-left:20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle  txt_f67f00  ">Marketplaces</div>
                                      </a>
