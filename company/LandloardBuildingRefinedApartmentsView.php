...
<html lang="en">
  ...
  <body class="dark" style="background: #131922">
    ...
    <div class="column_m header hei_45p xs-header xsip-header xsi-header bs_bb white_bg visible-xs" style="padding:0px;">
			...
			<a href="javascript:void(0);" onclick="addFileInformaion();"> <div class=" talc   padt10 padb0 hei_45p black_txt" style="font-size:16px;">
					*** Add New Property ***
				</div></a>
...
<a class="header__logo changedText" href="../../buildingAddinsInfo/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" style="
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Manage Apartments</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">View and manage tasks for all units in your building efficiently.</div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item    " href="../../listImportedProperties/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Unrefined</div>
                                      </a>
									     
									  <a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_f67f00">Refined</div>
                                      </a>
									  
									   <a class="categories__item    " href="../../listLandloardBuildingApartment/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Published</div>
                                      </a>
				 
									  
									  <a class="categories__item  " href="../../listLandloardReservedApartment/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91 "  >Reserved</div>
                                      </a>
									  <a class="categories__item  " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background: rgb(255, 229, 0) !important;"  >
                                       
                                      <div class="changedText categories__subtitle txt_f67f00 " style="color:black;">Sold</div>
                                      </a>
...
<input class="upload__input" type="hidden" name="bid" id="bid"  value="<?php echo $data['bid']; ?>"/>
			 ...
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active" href="#">Import</a> 
                </div> <div class="sorting__select">
               <a href="javascript:void(0);" onclick="addFileInformaion();">  <button class="button-stroke catalog__button">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
				  ...
				  <div class="card card_row" style="margin-bottom:24px; border:1px solid #23262F ;">
										...
										<div class="card__preview"><img srcset="<?php echo $value['imageId']; ?>" src="<?php echo $value['imageId']; ?>" alt="Premium milford sound tour ex Queenstown">
    ...
    margin-bottom: 0px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title changedText fsz30 xsi-fsz23" style="color:white;">Apartment <?php echo $value['office_apartment_number']; ?></div></a>
                        <div class="card__price" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099;">
                        <div class="card__old">$<?php echo $value['sale_price']; ?></div>
                        <div class="card__actual">$<?php echo $value['sale_price']; ?></div>
                      </div>
                    </div>
...
">
                <div class="description__parameter" style="">
                  ...
                  </svg><span class="changedText"><?php echo $value['bathroom_count']; ?> Bedrooms</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php echo $value['bedroom_count']; ?> WC</span></div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><span class="changedText"><?php echo $value['apartment_size']; ?> sqm</span></div>
              </div>
                    <div class="card__foot">
					  ...
					  <div class="card__flex " style="background-color:#52D4F5; padding:10px; border-radius:5px;">
                        <div class="card__cost fsz14 changedText" style="padding-top: 0px;  font-weight:100; color:black;"><?php echo $value['apartment_completed']; ?>% Completed </div>

						<a href="../../<?php if($value['apartment_completed']==40) echo 'floorApartmentBedroomInfo'; else if($value['apartment_completed']==50) echo 'floorApartmentBathroomInfo'; else if($value['apartment_completed']==60) echo 'floorApartmentOtherRoomInfo'; else if($value['apartment_completed']==70) echo 'floorObjectImageInfo';  else if($value['apartment_completed']==80) echo 'apartmentDescriptionInfo'; else if($value['apartment_completed']==90) echo 'apartmentPoolInfo'; else echo 'floorApartmentpublishInfo'; ?>/<?php echo $data['cid']; ?>/<?php echo $value['buildingid']; ?>/<?php echo $value['floor_id']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;">
