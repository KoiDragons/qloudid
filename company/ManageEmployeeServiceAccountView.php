						...
						<div class="padrl10">
							...
							<div class="scroll-fix xs-hei_autoi sm-hei_autoi" data-offset-top="75" >
								...
								<ul class="dblock marr20 padt250 padl10 fsz18">
											...
											<a href="../../updateWorkingHrs/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt"> <span class="valm trn ltr_space"  >Working hrs </span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>
								  
											<li class="dblock padrb10 first">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10   brdb_black black_txt  padb10"> <span class="valm trn ltr_space">Services</span> 
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
											</a></li>		
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
							<h1 class="marb0  xxs-talc talc fsz65 xxs-fsz65 lgn_hight_65 xxs-lgn_hight_65 padb0 black_txt trn"  >Services</h1>
									...
									<div class="mart10 marb5 xxs-talc talc   xs-nobrd xsi-nobrd xs-padb20 padb35"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20" >List of the services available</a></div>
								...
								<?php $i=1;
												...
												<div class=" <?php if($value['is_selected']==1) echo 'green_bg'; else echo 'lgtgrey_bg'; ?> bg_fffbcc_a " id="<?php echo $value['id']; ?>">
									...
									<div class="clear"></div>
									 ...
									 <form action="../../updateServicesInfo/<?php echo $data['cid']; ?>/<?php echo $data['eid']; ?>" method="POST" id="save_indexing" name="save_indexing" >				 
									 
							<input type="hidden" id="available_dishes" name="available_dishes" value="<?php  if($data['warnings']==null || $data['warnings']=='')echo ''; else echo $data['warnings'].','; ?>" />
							</form>
							 <div class="clear">
