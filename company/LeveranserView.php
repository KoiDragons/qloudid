...
<body class="lgtgrey2_bg">
	...
	<div class="column_m xs-padtb10 talc lgn_hight_22 fsz16 xs-marb0 xs-mart30  mart40  padb30" id="loginBank" onclick="checkFlag();">
				<div class="padrl10 xs-padrl15">
					...
					<!-- Center content -->
					<div class="wi_400p xsi-wi_360p maxwi_100   pos_rel zi5 marrla pad30  xs-pad0 mart40  brdrad5 " >
						
						<div class="padb20 xxs-padb0 ">	
							
									<h1 class="marb0  xxs-talc talc fsz100 xs-fsz25 bold padb10 black_txt trn" style="color:<?php if($corporateColor['bg_color']=="" || $corporateColor['bg_color']==null) echo "#000"; else echo $corporateColor['bg_color']; ?>">Parcels</h1>
									</div>
									<!-- Logo -->
									<div class="martb20  xxs-talc talc"> <a href="#" class="black_txt fsz20  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn"  >Register or pick up incoming post or parcels.</a></div>
							 
						
						<div class="padb10 xs-padrl10"> <a href="../pickupRegister/<?php echo $data['cid']; ?>" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn" >Register post and parcels</a> </div>
						
						<div class="padb10 xs-padrl10"> <a href="../pickupVerify/<?php echo $data['cid']; ?>" class="wi_100 maxwi_500p xs-maxwi_250p minhei_50p dflex justc_c alit_c opa90_h marrla brdrad3 white_bg panlyellow_bg_h  xs-panlyellow_bg_a xs-panlyellow_bg_h fsz18 xs-fsz16 black_txt trans_all2 xs-marrl0 brd trn"  >Pick up post and parcels</a> </div>
						
						
						
						<?php if($data['comp_id']!=0) { ?>
						<p class="padt20 xs-padt10 xs-padb20 talc fsz18 xs-fsz16 padb0  maxwi_100 col-xs-12 col-sm-12 pos_rel zi5 marrla xs-marb10 black_txt" style="color:<?php if($corporateColor['f_color']=="" || $corporateColor['f_color']==null) echo "#000"; else echo $corporateColor['f_color']; ?>">This front desk is managed by <?php echo $data['comp_name']; ?></p>
						<?php } ?>
