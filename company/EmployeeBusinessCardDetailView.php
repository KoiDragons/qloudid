			...
			<div class="column_m container zi5  mart40 xs-mart20" >
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					<div class="wi_240p fleft pos_rel zi50">
													...
													<div class="sidebar_prdt_bx marr20 brdb padb20">
														<div class="white_bg tall">
															...
															<!-- Logo -->
																...
																<!-- Meta -->
																<div class="fsz20 ffamily_avenir black_txt"> <span><?php echo  html_entity_decode($companyDetail['company_name']); ?> </span>  </div>
															</a>																
																	</div> 																</div>
													</div>		
													<div class="clear"></div>
                              ...
                              <li class="dblock padr10  padl8 fsz16  first last">
							...
							<ul class="dblock marr20  padl10 fsz16">
                              ...
                              <li class="dblock padrb10 ">
                                 <a href="../../EmployeeVisitors/invitationInfo/<?php echo $data['eid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
                                    <span class="valm trn" style="letter-spacing: 2px;">Besök</span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>
							  ...
							  <li class="dblock padrb10   ">
                                 <a href="../../Leveranser/employeeReceivedInfo/<?php echo $data['eid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
                                    <span class="valm trn" style="letter-spacing: 2px;">Brev eller Paket</span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>
							   <li class="dblock padrb10  ">
                                 <a href="#" class="hei_26p dflex alit_c padb10  pos_rel padr10 brdb_blue black_txt  padb10">
                                    <span class="valm trn" style="letter-spacing: 2px;">Mitt visitkort   </span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>
							     <li class="dblock padrb10 padt5">
                                 <a href="../../ManageEmployee/magazineAccount/<?php echo $data['cid']; ?>" class="hei_26p dflex alit_c padb10 pos_rel padr10  brdwi_3 grey_txt">
                                    <span class="valm trn" style="letter-spacing: 2px;">Anställda</span> 
                                    <div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
                                 </a>
                              </li>
                           </ul>		
					...
					<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xs-padl0">
						...
						<div class="tab-header mart10 brdb_new">
											<a href="#" class="dinlblck mar5 padrl15 brd brdclr_seggreen_h brdclr_segblue_a brdrad40 segblue_bg_a lgn_hight_26 fsz14 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active" >Mina appar</a>
