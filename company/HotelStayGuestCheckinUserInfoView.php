			...
			<div class="column_m   talc lgn_hight_22 fsz16 mart40" id="loginBank">
				<div class="wrap maxwi_100 padrl15 xs-padrl25">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10  xs-pad0">
							...
							<form action="../../../addGuestPassport/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['booking_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
								...
								<div id="profile" class=" " style="display:block;">	
											...
											<div class="pos_rel">
												...
												<input type="text" name="first_name" id="first_name" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['first_name']; ?>" readonly> 
											...
											<div class="pos_rel">
												...
												<input type="text" name="last_name" id="last_name" placeholder="Last name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['last_name']; ?>" readonly> 
											...
											<div class="pos_rel">
												...
												<input type="text" name="email" id="email" placeholder="Email address" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['email']; ?>" readonly> 
										...
										<select id="pcountry" name="pcountry" class="wi_100 white_bg padt25 brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25 custom-select"     />
														...
														<?php foreach($countryCode as $category =>$value){ ?>													
															<option value="<?php echo $value['id']; ?>"   <?php if(isset($purchaserInfo)) { if($purchaserInfo['country_of_residence']==$value['id']) echo 'selected';   } else { if($value['id']==201) echo 'selected'; } ?>>+<?php echo $value['country_code']; ?></option>
														<?php } ?>
											...
											<div class="pos_rel">
												...
												<input type="text" name="p_number" id="p_number" placeholder="Phone number"   class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['phone_number']; ?>" readonly > 
								...
								<div id="profile1" class=" " style="display:none;">	
										...
										<div class="on_clmn padt10 hidden">
											...
											<div class="pos_rel">
												...
												<input type="text" name="name_on_house" id="name_on_house" placeholder="First name" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl  tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['name']; ?>"  readonly> 
											...
											<div class="thr_clmn  wi_70  padr5">   
											 <div class="pos_rel">
												...
												<input type="text" name="d_address" id="d_address" placeholder="Street address" class="white_bg brd_width_2  brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['address']; ?>"  readonly> 
											...
											<div class="pos_rel">
												...
												<input type="text" name="dpo_number" id="dpo_number" placeholder="Port  " class="white_bg  brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['port_number']; ?>"  readonly> 
								 ...
								 <div class="thr_clmn  wi_40 padr5"> 
										...
										<input type="text" name="dzip" id="dzip" placeholder="Zip code" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir  light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['zipcode']; ?>"  readonly> 
									...
									<div class="thr_clmn  wi_60 padl5"> 
											...
											<input type="text" name="dcity" id="dcity" placeholder="City, State" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir  light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['city']; ?>"  readonly> 
												...
												<select class="wi_100 light_grey_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl padt25 tall minhei_65p fsz20 padl10 black_txt ffamily_avenir"   name="dcountry" id="dcountry" >
											       <option value="0" class="lgtgrey2_bg">country</option>
														<?php foreach($countryOptions as $category =>$value){ ?>													
															<option value="<?php echo $value['id']; ?>"   <?php  if($value['id']==$purchaserInfo['country_of_residence']) echo 'selected'; ?>><?php echo $value['country_name']; ?></option>
														<?php } ?>         
											</select>
							 ...
							 <div class="clear"></div>
								...
								<div id="profile2" class=" " style="display:none;">	
										...
										<div class="on_clmn padt10">
										<input type="text" name="card_number" id="card_number" placeholder="Your card number" class=" white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir  light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['card_number']; ?>"  readonly>
									...
									<div class="on_clmn padt10">
									 <div class="thr_clmn  wi_50 padr5"> 
										<input type="number" name="exp_month" id="exp_month" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['exp_month']; ?>"  readonly placeholder="Your card number" class=" white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir  light_grey_bg floating__input padt25" >
									  ...
									  <div class="thr_clmn  wi_50 padl5"> 
										<input type="number" name="exp_year" id="exp_year"  placeholder="Your card number" class=" white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir  light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['exp_year']; ?>"  readonly>
								 ...
								 <div class="on_clmn padt10">
												...
												<div class="pos_rel">
										<input type="number" name="cvv" id="cvv" placeholder="CVV" class=" white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir  light_grey_bg floating__input padt25" value="<?php if(isset($purchaserInfo)) echo $purchaserInfo['card_cvv']; ?>"  readonly>
								...
								<div id="profile3" class=" " style="display:none;">	
											...
											<div class="pos_rel">
												...
												<input type="text" name="id_number" id="id_number" placeholder=" Passport number" class="white_bg brd_width_2 brdb_new nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25" value="<?php echo $identificatorDetail['identity_number']; ?>" /> 
