		...
		<div class="column_m pos_rel">
			...
			<!-- CONTENT -->
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  ><?php echo substr($companyDetail['company_name'],0,10); ?></h1>
									</div>
                        ...
                        <div class="padb20 xxs-padb0 ">
                            ...
                            <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
							 ...
							 <div class="tab_content active" id="utab_Popular" style="display: block;">
									...
									<a href="../serviceCategoryTodo/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">	<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
