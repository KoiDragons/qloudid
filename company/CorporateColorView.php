...
<html>
	...
	<div class="column_m header xs-header xsip-header xsi-header bs_bb lgtgrey2_bg">
		...
		<div class="column_m pos_rel" onclick="checkFlag();">
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0 ">
								...
								<ul class="marr20 pad0">
										...
										<li class=" dblock pos_rel padb10 padt0 brdclr_hgrey ">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  <?php echo $selectIcon['app_bg']; ?> black_txt white_txt_h black_txt_a" style="border-radius:0%;"> <span class="valm trn" >Företagets färger</span> 
												...
												<li class="dblock padrb10">
													<a href="../../LedigaJobb/companyAccount/<?php echo $data['cid']; ?>" class=" hei_26p dflex alit_c pos_rel padrl10 brdl brdwi_3 brdclr_hgrey brdclr_pblue2_h brdclr_pblue2_a pblue2_bg_h pblue2_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn" >Karriärsida</span> 
														<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
													</a>
												</li>
					...
					<div class="wi_720p col-xs-12 col-sm-12 fleft pos_rel zi5   padl20 xs-padl0">
						...
						<div class="wrap maxwi_100 dflex alit_fe justc_sb col-xs-12 col-sm-12 pos_rel padb10 ">
								<div class="white_bg tall">
								<h1 class="fsz25 bold">Corporate Color</h1>
						...
						<div class="padb0 xxs-padb0 brdb_new ">
							...
							<div class="marrla xs-wi_100">
								...
								<form action="../addCorporateColor/<?php echo $data['cid']; ?>" name="save_indexing" id="save_indexing" method="POST" >
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn padb10">
											<div class="thr_clmn ">
												<input type="color" name="bg_color" id="bg_color" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl0 hei_50p fsz18 llgrey_txt" value="<?php if(!empty($coporateColorDetail)) echo $coporateColorDetail['bg_color']; ?>" placeholder="Add bg color">
												
																	
																	
												
											</div>
											<div class="thr_clmn padl5">
												<input type="color" name="f_color" id="f_color" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl0 hei_50p fsz18 llgrey_txt"  value="<?php if(!empty($coporateColorDetail)) echo $coporateColorDetail['f_color']; ?>" placeholder="Add font color">
											...
											<div class="thr_clmn padl5">
												<input type="button" value="Submit" class="wi_100 mart5 maxwi_100 brdrad3 hei_50p diblock nobrd panlyellow_bg fsz18 black_txt curp" onclick="checkColor();">
			...
			<div class="wi_100 maxwi_100  xs-padr25 xs-padl10  padt20 xs-padt0   brd tall" style="height:700px; width:700px; border-width:5px; background-color:<?php if(empty($coporateColorDetail)) echo "#F5F5F5"; else echo $coporateColorDetail['bg_color']; ?>">
				
				<h1 class="talc padt200" style="color:<?php if(empty($coporateColorDetail)) echo "#000000"; else echo $coporateColorDetail['f_color']; ?>"><?php echo $companyDetail['company_name']; ?></h1>
