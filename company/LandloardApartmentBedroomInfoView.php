...
<html>
	...
	<head>
		...
		function updateBedSizeInfo(id,id1)
		{
		var send_data={};
				 send_data.bed_id=id;
				 send_data.bed_info=id1;
				 $.ajax({
							type:"POST",
							url:"../../../../updateBedSizeInfo/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Number of bedrooms</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">How many bedrooms does your apartment have?</span> 
													 </div>
										...
										<a href="javascript:void(0);" onclick="deleteBedroom();">	
