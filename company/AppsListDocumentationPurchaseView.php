				...
				<div class="wrap maxwi_100 xs-padrl15 ">
					...
					<div class="wi_240p fleft pos_rel zi50 ">
						...
						<div class="wi_20p hei_20p hide dblock_pa xs-dnone_i sm-dnone_i pos_abs top3p right-8p pblue2_bg rotate45"></div>
							...
							<li class="dblock padrb10 ">
						<a href="#" class="hei_26p dflex alit_c  pos_rel padr10    brdb_black black_txt  padb10"> <span class="valm trn ltr_space" >Purchase </span> 
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt"><?php echo $appsDetailSelected['api_interface_url']; ?>  </span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt ">Purchase</span>  </div>
...
<li>This is two way handshaking process used on Qmatchup and Qloudid domain. So they can verify user login securely. Other domains using our API can work as per their requirement they can use two way handshaking or can make user logged in directly after receiving data from Qloudid.</li>
 ...
 {"user":"0","card_number":"414....","card_cvv":"111","exp_month":"10","exp_year":"20**","name_on_card":"XYZ","company":"0","name_on_house":"XYZ","address":"abc","city":"abc","zipcode":"12****","port_number":"1**","customer_id":"cu****","transection_id":"tran****"}</li>
 ...
 <li>Here if company is 0 then this provide info that invoice will be sent to user and card is also used from user for purchase, Here if company is 1 then this provide info that invoice will be sent to company and card is also used from company for purchase.  </li>
