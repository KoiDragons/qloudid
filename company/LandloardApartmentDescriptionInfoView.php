...
<script>
		...
		{
			$('#error_msg_form').html('');
			if($('#sell_phrase').val()==null || $('#sell_phrase').val()=='')
			{
				$('#error_msg_form').html('please enter sell phrase');
				return false;
			}
			if($('#generally').val()==null || $('#generally').val()=='')
			{
				$('#error_msg_form').html('please enter general information');
				return false;
			}
			if($('#selling_heading').val()==null || $('#selling_heading').val()=='')
			{
				$('#error_msg_form').html('please enter selling heading');
				return false;
			}
			if($('#short_selling_description').val()==null || $('#short_selling_description').val()=='')
			{
				$('#error_msg_form').html('please enter short description');
				return false;
			}
				...
				<div class="wrap maxwi_100 padrl0 xs-padrl15 xsi-padrl134">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
										...
										<input type="text" value="Apartment description" class="wi_100 rbrdr pad10 padb0 padl0  tall  minhei_45p fsz16 black_txt ffamily_avenir" readonly="">
										 
									</div>
									 </div>
									 <form action="../../../../updateApartmentDescription/<?php echo $data['cid']; ?>/<?php echo $data['bid']; ?>/<?php echo $data['fid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Sell phrase</span> 
													 </div>
								 ...
								 <input type="text" id="sell_phrase" name="sell_phrase" class="css-xt766" value="<?php echo $apartmentDescriptionDetail['sell_phrase']; ?>">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Generally</span> 
													 </div>
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="generally" name="generally" class="css-xt766" value="<?php echo $apartmentDescriptionDetail['generally']; ?>">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Selling heading</span> 
													 </div>
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="selling_heading" name="selling_heading" class="css-xt766" value="<?php echo $apartmentDescriptionDetail['selling_heading']; ?>">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Short selling description</span> 
													 </div>
									...
									<div class="wi_100 pos_rel">
								 <input type="text" id="short_selling_description" name="short_selling_description" class="css-xt766" value="<?php echo $apartmentDescriptionDetail['short_selling_description']; ?>">
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_100  xs-mar0 xs-padt10">
													 ...
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt  ">Long selling description</span> 
													 </div>
									...
									<div class="wi_100 pos_rel">
								 <textarea id="long_selling_description" name="long_selling_description" row="15" class="css-xt766"><?php echo $apartmentDescriptionDetail['long_selling_description']; ?> </textarea>
