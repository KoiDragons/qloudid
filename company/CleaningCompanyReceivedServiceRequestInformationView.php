...
<html>
	...
	<meta charset="utf-8">
		...
		{
			window.location.href ="https://www.safeqloud.com/company/index.php/CleaningCompany/assignedCleaningRequest/<?php echo $data['cid']; ?>";
		}
		</script>
	 </head>
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn"  >Request</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn" >Here is the list of cleaning request received from customers</a></div>
                            ...
                            <div class="column_m  fsz14 lgn_hight_22 dark_grey_txt">
                                <div class="container ">
                                    <div class="">
                                        ...
                                        <div class="tab-header mart10 padb10 brdb_new tb_67cff7_bg xs-talc">
                                            <a href="#" class="dinlblck mar5 padrl30_a  padrl10   blue_67cff7_brd_h blue_67cff7_brd_a brdrad40 t_67cff7_bg_a lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah active ffamily_avenir" data-id="utab_Popular">Received</a>
                                             
                                           <a href="../assignedCleaningRequest/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir " onclick='changeHeader();'>Assigned</a>
							 ...
							 <div class="tab_content active" id="utab_Popular" style="display: block;">
									 ...
									 <?php  
												...
												foreach($receivedCleaningRequest as $category => $value) 
												{
									...
									<a href="../assignCleaningRequest/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>">	<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
