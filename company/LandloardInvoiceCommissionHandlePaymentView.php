...
<a class="header__logo xs-fsz25 changedText" href="../../listComissionInvoice/<?php echo $data['cid']; ?>" style="
...
<form action="../../updateInvoiceHandlePayment/<?php echo $data['cid']; ?>/<?php echo $data['invoice_id']; ?>" method="POST" id="save_indexing1" name="save_indexing1" accept-charset="ISO-8859-1">
...
<input class="field__input"  name="broker_commission" id="broker_commission" value="<?php echo $landloardInvoice['payment_amount']; ?>"    type="number"   style=" color:grey;" readonly >
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="vat" id="vat" value="<?php abs(($landloardInvoice['payment_amount']*$landloardInvoice['vat'])100); ?>"    type="number"   style=" color:grey;"  readonly>
</div>
</div>
</div>
</div>
...
<div class="field__wrap">
<input class="field__input"  name="total_paid" id="total_paid" value="<?php echo $landloardInvoice['payment_amount']+abs(($landloardInvoice['payment_amount']*$landloardInvoice['vat'])100); ?>"    type="number"   style=" color:grey;"  readonly>
</div>
</div>
</div>
 <div class="upload__col upload__col_w50">
...
<div class="field">
<div class="field__label changedText" style="color:#787f91;">Paid from bank</div>
<div class="field__wrap">
<select  class="   "  name="banck_account" id="banck_account" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52"  >
				 <?php $i=1; 
								foreach($bankDetails as $category => $value) 
										{
