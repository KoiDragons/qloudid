...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../../listEmployeesRequestProperties/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['service_id']; ?>" style="
...
<div class="browse__info info xs-fsz25 changedText">Send property connect request</div>
</div>
<div class="checkout__inner js-tabs wi_50">
...
<div class="checkout__category changedText">Add tenant information</div>
...
<form class="checkout__item js-tabs-item" action="../../../../sendConnectRequest/<?php echo $data['cid']; ?>/<?php echo $data['domain_id']; ?>/<?php echo $data['service_id']; ?>/<?php echo $data['property_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
