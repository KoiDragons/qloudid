				...
				var send_data={};
					...
					$.ajax({
						...
						success: function(data1){
							...
							if(data1==0)
							{
								$("#errorMsg1").html('Your phone number is not registered with us. Please create a account first');
								return false;
							}
							else
							{
...
<a class="header__logo xs-fsz25 changedText" href="../companyAccount/<?php echo $data['cid']; ?>" style="
		  ...
		  <div class="header__item header__item_user js-header-item" style="display:block;">
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
				...
				<a class="header__link" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
                    <svg class="icon icon-building">
                      <use xlink:href="#icon-building"></use>
                    </svg><span class="changedText">Employee view</span></a>
					</div>
              </div>
...
<div class="outer__inner mart25">
 ...
 <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item" style="background: none !important;"><a class="breadcrumbs__link" href="../companyProfileAction/<?php echo $data['cid']; ?>">Company details</a></li>
                  <li class="breadcrumbs__item" style="background: none !important;"><a class="breadcrumbs__link" href="#" style="color:white;">Marketplaces</a></li>
				  <!--<li class="breadcrumbs__item"><a class="breadcrumbs__link" href="../companyProfileIntegration/<?php echo $data['cid']; ?>">Integration</a></li>-->
                </ul>
 </div>
...
<div class="checkout__wrapper xs-flexD">
 <div class="travel__center center   maxwi_50 xs-wi_100 xxs-maxwi_100 padb136 xs-padrl25" style="
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Manage Your Admins</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Assign employees permission rights to become an admin</div>
...
<div class="checkout__inner js-tabs wi_50  xs-wi_100 padl25 xs-padl0 " style="padding-right: 0px;">

<div class="section brands xsi-mart60 hidden" style="
    /* margin-top: 60px; */
    margin-bottom: 50px;
">
<div class="brands__center center  xs-pad0" style="padding: 0px 0px;border: 1px solid #23262f;border-radius: 12px;">
<div class="brands__wrap">
<div class="brands__list" style="display:flex;">
 
			<div class="brands__item" style=""><a href="https://www.safeqloud.com/company/index.php/CompanyProperty/locationAccount/<?php echo $data['cid']; ?>"><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 40px;text-align: center;"><?php echo count($propertyLocation); ?></div><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Offices</div></a>
</div>
...
<div class="brands__item" style="
    ...
    color: black;
	"><a href="https://www.safeqloud.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>"><div class="browse__info info fsz24" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 40px;text-align: center;"><?php echo count($employeesList); ?></div><div class="browse__info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Employees</div></a></div>
...
<div class="brands__item" style=""><a href="https://www.safeqloud.com/company/index.php/VitechProperties/listProperties/<?php echo $data['cid']; ?>"><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 40px;text-align: center;"><?php echo count($productServices); ?></div><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Products & services</div></a></div>
 ...
 <div class="outer__inner xs-mart65 mart100">
		...
		<div class="flights__center center xs-padrl25" style="padding-bottom:0px;">
		 <div class="panel__nav"><a class="panel__link active" href="javascript:void(0);">Appstore</a><a class="panel__link" href="javascript:void(0);">Marketplaces</a></div>
		  <div class="wi_100 xs-wi_100" style="">
									<div class="wi_100   padt0">
										
										
										<div class=" ">
									<?php 
											$i=1;	foreach($getAppsDetail as $category => $value) 
													{
													if($i==1)	{
														 
													?>
											<div class="wi_50 xxs-wi_33 dblock fleft  padt30  dark_grey_txt fsz50 xs-fsz12 crm featured-app talc" style="height:560px; padding-top:200px; border:1px solid #282b34; margin:10px 10px 10px 0px;  border-radius: 6px; color:white;"><?php echo $value['app_name']; ?><br>
											<?php  if($value['is_downloaded']==1)
														{ ?>
											<a class="header__logo  changedText  ButtonWhite" href="<?php if($value['app_link']==null) echo '#'; else echo $value['app_link'].''.$data['cid']; ?>" style="
											background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									   font-family: Avenir;
									   font-size: 14PX;
									   line-height:20px !important;
									   border:1px solid #282b34 !important;
														vertical-align:bottom;">Visit</a> <?php } else { ?>
														
													<a class="header__logo  changedText  ButtonWhite" href="../../Brand/productPage/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
									background:white !important; margin-right:0px;
									border:2px solid #52D4F5 !important;
									   padding: 5px;
									   ...
									   line-height:20px !important;
									   border:1px solid #282b34 !important;
														vertical-align:bottom;">Download</a>

														<?php } ?>														
														</div>
														
													<?php } else if($i>1 && $i<=5) { ?>
								<div href="#" class="talc wi_24-4p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz25" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;"><?php echo $value['app_name']; ?><br><?php  if($value['is_downloaded']==1)
														{ ?>
											<a class="header__logo  changedText  ButtonWhite" href="<?php if($value['app_link']==null) echo '#'; else echo $value['app_link'].''.$data['cid']; ?>" style="
											background:transparent !important;
										 margin-right:0px;
								...
								<div href="#" class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz25" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;"><?php echo $value['app_name']; ?><br><?php  if($value['is_downloaded']==1)
														{ ?>
											<a class="header__logo  changedText  ButtonWhite" href="<?php if($value['app_link']==null) echo '#'; else echo $value['app_link'].''.$data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									...
									border:2px solid #52D4F5 !important;
									   ...
									   line-height:20px !important;
									  border:1px solid #282b34 !important; 
														vertical-align:bottom;">Visit</a>  													
														</div>
														
													<?php } else if($i>1 && $i<=5) { ?>
								<div href="#" class="talc wi_24-4p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz25" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;"><?php echo $value['app_name']; ?><br> 
											<a class="header__logo  changedText  ButtonWhite" href="<?php if($value['app_link']==null) echo '#'; else echo $value['app_link'].''.$data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   ...
									   line-height:20px !important;
									   border:1px solid #282b34 !important;
														vertical-align:bottom;">Visit</a>  </div>
									   
													<?php }  else { ?>
											 
											
								 		
								<div href="#" class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz25" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;   border-radius: 6px; color:white;"><?php echo $value['app_name']; ?><br>
											<a class="header__logo  changedText  ButtonWhite" href="<?php if($value['app_link']==null) echo '#'; else echo $value['app_link'].''.$data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:40px; border-bottom:1px solid #353945;">
			     <a class="categories__item    " href="../companyProfileAction/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Company details</div>
                                      </a>
			   										
				 
											 <a class="categories__item    " href="javascript:void(0);" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Marketplaces</div>
                                      </a>	 
												 
 <a class="categories__item    " href="../companyProfileIntegration/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">Integration</div>
                                      </a>
  ...
  <div class="sorting__foot">
                <div class="nav"><a class="nav__link active changedText" href="#">Connected</a><a class="nav__link changedText" href="#">Pending</a><a class="nav__link changedText" href="#">Manage</a> </div>
                 
                   <div class="sorting__select">
               <a href="../../ProfessionalCompany/listUnconnectedMarketplaces/<?php echo $data['cid']; ?>">  <button class="button-stroke catalog__button" fdprocessedid="h6a3b9">
                  <span class="changedText">Add marketplace</span>
                </button></a>
                </div>
              </div>
</div>
...
<div class="catalog__body">
            <div class="catalog__center center" style="padding:0px; ">
              
              <div class="catalog__list">
			  
			  	<?php  	foreach($marketplaceList as $category => $value) 
												{
													 
												 ?>
			  <a class="card" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyProfileMarketplaceServices/<?php echo $data['cid'];?>/<?php echo $value['enc'];?>" style="background:transparent; border-radius: 12px;">
                   
                  <div class="card__body">
                    <div class="card__line">
                      <div class="card__title" style="font-size:30px; "><?php echo str_ireplace('&','and',html_entity_decode($value['marketplace_name'])); ?></div>
                    ...
                    <div class="card__options">
                      <div class="card__option">
                        ...
                        </svg><span class="changedText">24 hours</span>
                      </div>
                      <div class="card__option">
                        <svg class="icon icon-burger">
                          <use xlink:href="#icon-user"></use>
                        </svg><span class="changedText">Up to 12 people</span>
                      </div>
                    </div>
                  <div class="card__foot" style="border-color:#<?php echo $value['bg_color_info']; ?>">
                      <div class="card__comment">
                        
                        <div class="card__text changedText"><?php if($value['marketplace_description']!='') echo html_entity_decode($value['marketplace_description']); else echo 'No description available'; ?></div>
                      </div>
                      <div class="card__comment" style="
    border-top: 1px solid #23262F;
    padding-top: 20px;
">
                        <div class="card__avatar"><img src="https://ui8-fleet-html.herokuapp.com/img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="card__text changedText"><?php echo html_entity_decode($value['marketplace_review']); ?></div>
                      </div><div class="card__flex">
                        
                        <div class="card__rating">
                          <svg class="icon icon-star" style=" fill: #<?php echo $value['bg_color_info']; ?>;">
                            <use xlink:href="#icon-star"  style=" fill: #<?php echo $value['bg_color_info']; ?>;"></use>
                          </svg>
