		  ...
		  <div class="header__item header__item_user js-header-item" style="display:block;">
            ...
            <div class="header__body js-header-body">
              <div class="header__group">
				...
				<a class="header__link" href="https://www.qloudid.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
...
<div class="brands__item" style="
    ...
    color: black;
	"><a href="https://www.qloudid.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>"><div class="browse__info info fsz24" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 40px;text-align: center;"><?php echo count($employeesList); ?></div><div class="browse__info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Employees</div></a></div>
...
<div class="brands__item" style=""><a href="https://www.qloudid.com/company/index.php/VitechProperties/listProperties/<?php echo $data['cid']; ?>"><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 40px;text-align: center;"><?php echo count($productServices); ?></div><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Products & services</div></a></div>
			  	...
			  	<?php  	foreach($marketplaceList as $category => $value) 
												{
												 ...
												 ?>
			  <a class="card" href="https://www.qloudid.com/company/index.php/CompanySuppliers/companyProfileMarketplaceServices/<?php echo $data['cid'];?>/<?php echo $value['enc'];?>" style="background:transparent; border-radius: 12px;">
