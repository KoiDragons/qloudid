...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">PROPOSAL
</span> </h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Create and list proposals for sale & rent
</div>
</div></div>
...
<div class="categories__inner">
 ...
 <div class="categories__wrapper">
			 ...
			 <div class="sorting__foot hidden">
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
				  ...
				  <div class="card card_row"   style="margin-bottom:24px; ">
                     ...
                     <div class="category card__category hidden"><?php if($value['type_of_contract']==1) echo 'Exclusive'; else echo 'Non-exclusive'; ?></div>
                  </div>
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:30px; color:white;"><?php echo $value['sellPhrase']; ?></div>
				   
				   <?php if($value['completed']==100){ ?>
...
">
                <div class="description__parameter">
                  ...
                  </svg><?php  echo $value['numberOfBedrooms']; ?> Bedrooms</div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['numberOfBathrooms']; ?> Bathrooms</div>
                <div class="description__parameter">
                  <svg class="icon icon-flag">
                    <use xlink:href="#icon-flag"></use>
                  </svg><?php  echo $value['area']; ?> sqm</div>
              </div>
    ...
    font-size: 14px;
    line-height: 20px; color: #777E90;
">
 <?php echo $value['streetAddress'].' '.$value['areaName']; ?></div>
...
">
 <?php  echo $value['longSellingDescription']; ?> </div>
                ...
                <form class="checkout__item js-tabs-item" action="../createPropertyProposal/<?php echo $data['cid']; ?>" method="POST" id="save_indexing_proposal" name="save_indexing_proposal" accept-charset="ISO-8859-1" style="display: block;">		
