...
<h2 class="product__title h2 xs-fsz70 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><?php echo $selectedMarketplaceDetail['marketplace_name']; ?></h2>
...
">
                    ...
                    <div class="sorting__details" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Here are available options and services under this marketplace</div>
</div></div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle  txt_f67f00 ">Pricing plan</div>
                                      </a>
			     
									<a class="categories__item bg_E7E7E7 " href="../../../ProfessionalCompany/serviceCategoryTodo/<?php echo $data['cid']; ?>/<?php echo $data['mid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Update services</div>
                                      </a> 

										<a class="categories__item bg_E7E7E7 " href="../../../ProfessionalCompany/listAvailableServices/<?php echo $data['cid']; ?>/<?php echo $data['mid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">List services</div>
                                      </a>
									  
									  <a class="categories__item bg_E7E7E7 " href="../../../ProfessionalCompany/listAvailableSubscription/<?php echo $data['cid']; ?>/<?php echo $data['mid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91">Subscription</div>
                                      </a>
                                      ...
                                      <div class="changedText categories__subtitle txt_787f91" style="color:black;">Rule</div>
									   ...
									   <a class="categories__item bg_E7E7E7 " href="../../serviceRequestReceived/<?php echo $data['cid']; ?>/<?php echo $data['mid']; ?>" style="background:#f67f00 !important; padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91" style="color:black;">Project</div>
                                      </a>
									  
									   <a class="categories__item bg_E7E7E7 " href="javascript:void();" style="background:#f67f00 !important; padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91"  style="color:black  !important;">Proposals</div>
                                      </a>
									  
									   <a class="categories__item bg_E7E7E7 " href="javascript:void();" style="background:#f67f00 !important; padding: 20px; font-size:14px; border-radius:6px; "  >
                                       
                                      <div class="changedText categories__subtitle txt_787f91"  style="color:black !important;">Hire people</div>
                                      </a>
</div> 
</div>
</div>
            ...
            <div class="catalog__center center">
              <div class="catalog__cards"  style="margin:0px;">
			   ...
			   <?php $i=0;
												...
												foreach($selectedMarketplaceServiceDetail as $category => $value) 
												{
													
													
												?> 
						<?php if($value['flow_url']=='' || $value['flow_url']==null || $value['flow_url']=='#') { ?>
						<a class="card  " href="#" style="<?php if($i%3==0) echo 'margin-left:0px !important;'; ?>">
						<?php } else {  ?>
						<a class="card  " href="<?php echo $value['flow_url']; ?>/<?php echo $data['cid'];?>/<?php echo $value['enc']; ?>" style="<?php if($i%3==0) echo 'margin-left:0px !important;'; ?>">
						<?php }  ?>
                  <div class="card__preview"><img srcset="<?php echo $value['img']; ?>" src="<?php echo $value['img']; ?>" alt="Premium milford sound tour ex Queenstown">
                    <div class="category-blue card__category changedText" style="background: white; color:black;  "><?php echo str_ireplace('&','and',html_entity_decode($value['subcategory_name'])); ?> </div>
                  </div>
                  </a>
