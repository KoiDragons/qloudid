					 ...
					 <div class="padb0 xxs-padb0 ">		
						...
						<div class="padb0 xxs-padb0 marb5">
							...
							<div class="marrla xs-wi_100">
								...
								<form action="../addCategory/<?php echo $data['cid']; ?>" name="save_indexing" id="save_indexing" method="POST" accept-charset="ISO-8859-1">
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn ">
											...
											<div class="pos_rel">
													<input type="text" name="c_name" id="c_name" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir" placeholder="Write category name ">
										...
										<div class="on_clmn ">
											...
											<div class="pos_rel">
													<input type="text" name="c_discription" id="c_discription" class="wi_100   lgtgrey_bg txtind10 brd_2px_rgb tall minhei_55p fsz18 red_f5a0a5_txt ffamily_avenir" placeholder="Category discription ">
