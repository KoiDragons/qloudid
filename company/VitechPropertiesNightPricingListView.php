	...
	if (input.files && input.files[i]) {
		...
		reader.onload = function (e) {
			...
			var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updatePhotos/<?php echo $data['rid']; ?> ",
							data:send_data,
							dataType:"text",
...
function getImageInfo(id)
{
				var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../getImageInfo/<?php echo $data['rid']; ?> ",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function getPhoto()
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../getPhoto/<?php echo $data['rid']; ?> ",
...
function updatePhotoDecrement(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updatePhotoOrder/<?php echo $data['rid']; ?> ",
							 data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function deletePhoto(id)
{
				 ...
				 $.ajax({
							type:"POST",
							url:"../../deletePhoto/<?php echo $data['rid']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
function drop(ev) {
  ...
  //ev.target.appendChild(document.getElementById(data));
   ...
   var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../updatePhotoDragging/<?php echo $data['rid']; ?> ",
							data:send_data, 
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
...
<div class="header__center center  xs-padrl25"><a class="header__logo xs-fsz20 " href="../../../listEmployeesCreatedProperties/<?php echo $data['cid']; ?>" style="
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
                ...
                <option value="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" >Photos</option>
				 <option value="../../../perNightPricingList/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>Night price</option>
			...
			<a class="setting__link  " href="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                ...
                </svg><span style="color:#f67f00">Night price</span></a>
...
<div class="setting__head">
                    <h2 class="setting__title h2" style="font-size:25px;">Pricing</h2><a class="button-stroke button-small setting__button" href="../../../addPricing/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" style="background:#f67f00; color:#000000;">Add</a>
                  </div>
...
"><span class="flight_price">$<?php echo $value['minimum_price']; ?></span> </button>
					 ...
					 <div class="receipt__description receipt__description_flex" style="
...
">
                <div class="receipt__item">
                  ...
                  <div class="receipt__box">
                    ...
                    <div class="receipt__subtitle"><?php echo date('D M d Y',$value['pricing_start_date']); ?></div>
                  </div>
                </div>
                <div class="receipt__item">
                  <div class="receipt__icon">
...
">Update pricing</div>
   ...
   <a class="header__logo  changedText fright" href="../../../editPropertyPerNightPrice/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>/<?php echo $value['enc']; ?>" style="
