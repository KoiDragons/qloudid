				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
								...
								<a href="#profile" class="expander-toggler dark_grey_txt xs-fsz16 tall bold active"><?php echo $bookingDetailInfo['room_type']; ?>
								...
								<div id="profile" class=" " style="display:block;">	
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi"><?php if($value['is_approved_cleaning']==1) echo 'Cleaned'; else echo 'Dirty'; ?></button>
																			</div> 
																			</a>
													   </div>
									...
									foreach($availableAllocationRoomsDetail as $category => $value) 
												{
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<a href="../../../updateRoomInfo/<?php echo $data['cid']; ?>/<?php echo $data['lid']; ?>/<?php echo $data['booking_id']; ?>/<?php echo $value['enc']; ?>" class="xs-padr20">  
													<div class="fright wi_25  padl30 xs-padl0 xs-wi_20  fsz40    padb0 xs-marrl0">
																				<button type="button" name="Edit" class="forword2 minhei_45p blue_67cff7_brd2 ffamily_avenir black_txt trans_bgi">Occupied</button>
																			</div> 
																			</a>
													   </div>
