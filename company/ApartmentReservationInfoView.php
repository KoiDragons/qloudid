							...
							<form action="../addDishDetail/<?php echo $data['cid']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
									...
									<div class="thr_clmn  wi_50 padr10">
										...
										<div class="pos_rel talc">
												...
												<input type="date" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" name="checkin_date" id="checkin_date" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"> 
										...
										<div class="pos_rel talc">
												...
												<input type="date" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" name="checkout_date" id="checkout_date" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"> 
									...
									<div class="thr_clmn  wi_50 padr10">
										...
										<div class="pos_rel talc">
												...
												<input type="text"   name="guest_email" id="guest_email" placeholder="Title" class="white_bg  brdb_new brd_width_2 nobrdt nobrdr nobrdl tall minhei_65p fsz20 padl10 black_txt ffamily_avenir light_grey_bg floating__input padt25"> 
												<label for="guest_email" class="floating__label tall nobold padl10" data-content="Email">
											<span class="hidden--visually">
											 A</span></label> 
