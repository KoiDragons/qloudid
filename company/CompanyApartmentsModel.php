...
class CompanyApartmentsModel extends AppModel
{
	...
	function updateApartment($data)
		{
			...
			$stmt = $dbCon->prepare("insert into company_apartments(company_id,app_id,number_of_apartments,number_of_entrance,created_on)values(?, ?, ?, ?,now())");
			$stmt->bind_param("iiii",$company_id,$row['app_id'],$_POST['numberofApart'],$_POST['numberofent']);
