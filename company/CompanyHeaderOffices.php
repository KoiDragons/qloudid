...
<div class="column_m header xs-header bs_bb lgtgrey2_bg">
		...
		<div class="logo marr15 wi_180p xxs-wi_auto">
				<a href="https://www.safeqloud.com/user/index.php/NewsfeedDetail"> <h3 class="brdr_new marb0 pad0 fsz27 xs-fsz16 xs-bold xs-padt10 black_txt padt10 padb10" style="font-family: 'Audiowide', sans-serif;">Arbetställe</h3> </a>
			</div>
			<div class="visible-xs visible-sm fleft padl10 padr10">
