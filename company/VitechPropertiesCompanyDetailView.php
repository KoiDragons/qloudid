...
<div class="travel__subtitle changedText " style="
				  ...
				  font-weight:100
                  ">Present Your Company</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Tell us about your company that you wish your customers to know.</div>
...
<div class="checkout__box">
                ...
                <h2 class="setting__title h2 changedText hidden">About us</h2>
                <div class="setting__list">
                    ...
                    <div class="setting__notification" style="border:none; margin-bottom:0px;">
                      <div class="setting__main">
                        <div class="setting__subtitle changedText"><?php echo html_entity_decode($value['heading']);?></div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox"  onclick="updateHeading(<?php echo $value['id'];?>);" <?php if($value['is_active']==1) echo 'checked'; else echo ''; ?> /><span class="switch__inner"><span class="switch__box" ></span></span>
                        </label>
                      </div>
                      
                    </div>
					 <div class="<?php if($value['is_active']==0) echo 'hidden'; else echo ''; ?>" id="<?php echo $value['id'];?>">
					<div class="field ">
                          <div class="field__label hidden">description</div>
                          <div class="field__wrap">
                            <textarea class="field__textarea changedText" id="a<?php echo $value['id'];?>" name="a<?php echo $value['id'];?>" placeholder="e. g. &quot;Spectacular views of Queenstown&quot;" required="" style="background:#282D34; border-color:#282D34; height:180px;"><?php echo strip_tags(html_entity_decode($value['content']));?></textarea>
                          </div>
                        </div>
					
					 
					<a class="button checkout__button changedText mart20 changedText" href="javascript:void(0);"  onclick="submit_save(<?php echo $value['id'];?>);" style="border: 1px solid #23262F; background:transparent; font-size:14px;">Update</a>
					</div>
					</div>
					</form>
					 <?php } ?>
                   <a class="button checkout__button changedText mart20 changedText" href="../../CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>"  onclick="submit_save(<?php echo $value['id'];?>);" style="border: 1px solid #23262F; background:transparent; font-size:14px;">Close and go back</a>
				 </div>
              </div>
