...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg><span>Go home</span></a>
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.safeqloud.com/company/index.php/DofpExchange/listProperties/<?php echo $data['cid']; ?>">Trading objects</a></li>
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);" style="color:white;">Buyer reservations</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Buyer Request Reservations</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Manage all buyers request reservations from one place.</div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle " style="color:#52d4f4 !important;">Received requests</div>
                                      </a>
		...
		<div class="section flights">
          <div class="flights__center  ">
		   
		  <div class="flights__sorting hidden-xxs " style="margin-top:0px; border-top:0px !important; margin-bottom:0px;  padding:0 !important;">
    ...
    margin-bottom: 0px;
">
                   <div class="flight__title" style="font-size:20px; color:white; margin-bottom: 0px;">Apartment <?php echo  $value['apartment_details']['office_apartment_number']; ?></div>
    ...
    padding-top: 0px;
">
			 <div class="description__parameter hidden" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo  $value['society_details']['society_name']; ?></div>
              
                
				<div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg>Floor no <?php echo  $value['apartment_details']['floor_number']; ?></div>
				    <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo  $value['apartment_details']['bedroom_count']; ?> bedrooms</div>
				   <div class="description__parameter" style="margin-top: 0px;">
                  <svg class="icon icon-home">
                    <use xlink:href="#icon-home"></use>
                  </svg><?php echo $value['bathroom_count']; ?> Bathrooms</div>
				  
              </div>
			    
                       
   <?php if($value['is_accepted']==0){ ?>                 
    <a class="header__logo xs-fsz20 changedText fright " href="../guestReservationDetailInfo/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
   ...
   "><?php if($value['is_accepted']==0) echo 'Pending'; else echo 'Approved'; ?></a>
   <?php } else { ?>
   
         <a class="header__logo xs-fsz20 changedText fright " href="../guestReservationTimelineInfo/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/ margin-right:0px;
   padding: 5px;
   color: #f67f00;
   border-radius: 5px;
