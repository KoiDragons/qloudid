...
<button class="header__burger js-header-burger"></button>
 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.qloudid.com/company/index.php/CompanySuppliers/companyProfileAction/<?php echo $data['cid']; ?>">
                  <svg class="icon icon-arrow-left">
                    <use xlink:href="#icon-arrow-left"></use>
                  </svg><span>Go home</span></a>
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="https://www.qloudid.com/company/index.php/DofpExchange/listProperties/<?php echo $data['cid']; ?>">Trading objects</a></li>
