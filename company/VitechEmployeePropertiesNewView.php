 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item    " href="#" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle" style="color:#52d4f4 !important;">For Sale</div>
                                      </a>
									    
									   <a class="categories__item    " href="../listEmployeesCreatedProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px;  background:transparent !important;"  >
                                       
                                      <div class="changedText categories__subtitle   txt_787f91">For Rent</div>
                                      </a>
...
{
	window.location.href='https://www.safeqloud.com/company/index.php/VitechProperties/listEmployeesSoldProperties/<?php echo $data['cid']; ?>';
}
</script>
			 <div class="sorting__foot">
                <div class="nav"><a class="nav__link active changedText" href="#">Prepare</a> <a class="nav__link changedText" href="#">Published</a> <a class="nav__link changedText" href="#">Reserved</a><a class="nav__link changedText" href="#" onclick="changeHeader();">Sold</a></div>
