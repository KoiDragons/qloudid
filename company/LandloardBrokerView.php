 ...
 <!-- outer content-->
	  ...
	  <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="https://www.safeqloud.com/company/index.php/CompanySuppliers/companyEmployeeProfileAction/<?php echo $data['cid']; ?>">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="javascript:void(0);">Developers</a></li>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item   " href="#" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
                                      ...
                                      <div class="changedText categories__subtitle  " style="color:#52d4f4 !important;">Apply</div>
                                      </a>
									   
			          <a class="categories__item    " href="../listBrokerOffPlanProperties/<?php echo $data['cid']; ?>" style="padding: 20px; font-size:14px; border-radius:6px; background:transparent !important;"  >
...
function changeUrl(id)
{
	...
	document.getElementById("save_indexing").submit();
		 ...
		 <input type="hidden" id="pid" name='pid' value="" />
				...
				<?php     foreach($brokerRequestInfo as $category => $value) 
										{
										
												?> 
               
				  
			 							  <div class="travels__card <?php if($value['is_approved']==1) { echo 'white_bg'; } else echo 'bg10161d'; ?>  " <?php if($value['is_approved']==1) echo 'style="background:white !important;"'; ?>>
                                  <div class="travels__preview"><img srcset="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" src="<?php echo $value['photo_info']; ?>" alt="Card" style="border-radius: 50%; padding: 20px 40px;">
								    ...
								    <div class="category card__category"><?php echo $value['apartment_left']; ?> left</div>
								 
								  </div>
                                  <div class="travels__body">
                                    <div class="travels__line" style="border:none; margin:0px; padding:0px;">
                                      <div class="travels__details">
                                        <div class="travels__subtitle" style="color: #777E90;"><?php echo  substr(html_entity_decode($value['company_name']),0,15); ?></div>
                                        <div class="travels__location" style="color: #777E90;">Your ID: <?php echo  $value['licence_number']; ?></div>
                                      </div>
                                    <?php if($value['is_approved']==-2) { ?>   
                        <a class="header__logo  changedText fright ButtonWhite" href="../applyLicence/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" id="<?php echo $value['id']; ?>" style="
   ...
   <?php } if($value['is_approved']==1) { ?>
				    <a class="header__logo  changedText fright ButtonWhite" href="javascript:void(0);"   style="
   background-color: black !important; margin-right:0px;
   padding: 5px;
