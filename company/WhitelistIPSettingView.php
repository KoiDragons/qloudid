	...
	<head>
		...
		<script>
			function searchIP()
			{
				...
				if($('#type_c').val()==0)
				{
				$("#errorMsg").html('Please select app name');
				return false;	
				...
				else
				{
					...
					$.ajax({
						...
						success: function(data1){
							...
							if(data1==2)
							{
								$("#errorMsg1").html('This ip address is already in use by the company');
								return false;
							}
							else
							{
								window.location.href="https://www.safeqloud.com/company/index.php/WhitelistIP/ipSetting/<?php echo $data['lid']; ?>";
							}
						}
					});
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10 mart40 xs-mart0 xs-pad0">
						<div class="padb20 xxs-padb0 ">		
									...
									<h1 class="marb0  xxs-talc talc fsz100 xxs-fsz65 padb10 black_txt trn ffamily_avenir"  >IP</h1>
									</div>
									<div class="mart20 xs-marb20 marb35 xxs-talc talc"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn ffamily_avenir" >Add IP to your apps to get the app started</a></div>
						...
						<div class="padb0 xxs-padb0 brdb_new red_ff2828_brdclr brd_width_2">
							...
							<div class="marrla xs-wi_100">
								...
								<form action="../addCompanyIp/<?php echo $data['lid']; ?>" name="save_indexing" id="save_indexing" method="POST" >
									<div class="marb0 padb10 ">
										...
										<div class="on_clmn padb10">
											...
											<div class="for_clmn padl5 wi_33">
												<select name="type_c" id="type_c" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl10 hei_50p fsz18 llgrey_txt" >
												
																	<option value="0"> Select app</option>
																	<option value="1" class="lgtgrey2_bg">Besökare</option>
																	<option value="2" class="lgtgrey2_bg">Parkering</option>
																	<option value="3" class="lgtgrey2_bg">Leverans</option>
																	<?php if($appsSafeqidCount==0) { ?>
																	<option value="4" class="lgtgrey2_bg">Daycare</option>
																	<?php } if($appsLocationCount==0) { ?>
																	<option value="5" class="lgtgrey2_bg">Remote visitor</option>
																	<?php } ?>
												</select>
												
											</div>
											<div class="for_clmn padl5 wi_33">
												<input type="text" name="ipadd" id="ipadd" class="lgtgrey2_bg default_view nobrd wi_100 mart5 padl10 hei_50p fsz18 llgrey_txt" placeholder="IP">
											...
											<div class="for_clmn padl5 wi_33">
												<input type="button" value="Add" class="wi_100 mart5 maxwi_100 brdrad3 hei_50p diblock nobrd red_ff2828_bg fsz18 white_txt curp ffamily_avenir" onclick="searchIP();">
												
											</div>
											<div class="clear"></div>
										</div>
									<div id="errorMsg" class="red_txt ffamily_avenir"></div>	
									</div>
							...
							<div class="clear"></div>
								...
								<?php $i=0;
											...
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<div class="fleft wi_50p marr15  "> <div class="wi_50p xs-wi_50p hei_50p xs-hei_50p fxshrink_0 dflex alit_c justc_c uppercase fsz25   brdrad1000 yellow_bg_a lgtgrey_bg  " style="background-repeat: no-repeat;
																	...
																	border-radius: 10%;">	<?php if($value['ip_type']==1) { ?>
													<a href="../../../../company/index.php/Company/visitorsIP/<?php echo $data['cid']; ?>">V</a>
													<?php } else if($value['ip_type']==2) {	?>
													<a href="../../../../company/index.php/Parkering/plateInfo/<?php echo $data['cid']; ?>">V </a>
													<?php }  else if($value['ip_type']==3) {	?>
													<a href="../../../../company/index.php/Leveranser/pickupInfo/<?php echo $data['cid']; ?>">V </a>
													<?php } else if($value['ip_type']==4) {	?>
													<a href="../../../../public/index.php/PublicDaycareSelect/daycareAction/<?php echo $data['cid']; ?>">V </a>
													<?php }  else if($value['ip_type']==5) {	?>
													<a href="../../../../company/index.php/RemoteVisitor/visitorInfo/<?php echo $data['cid']; ?>">R</a>
													<?php } ?></div>
																	</div>
													
													<div class="fleft wi_75   xs-mar0 ">
													
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz14 xs-padt0 black_txt"><?php if($value['ip_type']==1) echo 'Besökare'; else if($value['ip_type']==2) echo 'Parkering'; else if($value['ip_type']==3) echo 'Leverans'; else if($value['ip_type']==4)  echo 'Daycare'; else if($value['ip_type']==5)  echo 'Visitor lite'; ?></span>
													  <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz18  dark_grey_txt"><?php echo $value['ip_address']; ?></span>  </div>
													 
													<div class="fright wi_10 padt10 xxs-wi_10 xsip-wi_10 sm-wi_10 marl0 fsz25  padb0 xxs-marr20 hidden-xs">
														<a href="#" class="show_popup_modal" data-target="#edit_ip" onclick="updatePopup(<?php echo $value['id']; ?>,'<?php echo $value['ip_address']; ?>');"> <span class="far fa-edit grey_txt"></span> </a>
													</div>
									...
									<div id="approvedConnections">	
										...
										<div class="clear"></div>
									<div class="padtb20 talc <?php if($approveCountConnections['num']<=5) echo 'hidden'; ?>">
										<a href="javascript:void(0);" class="tb_67cff7_bg trans_bg brd blue_btn black_txt  ffamily_avenir  trn xxs-brd_width" value="1" onclick="add_more_rows_approved_Connections(this);">View more</a>
								...
								<script>
									function add_more_rows_approved_Connections(link) {
										...
										$.ajax({
											type:"POST",
											url:"../moreCompanyIps/<?php echo $data['lid']; ?>",
											data:send_data,
											dataType:"text",
											contentType: "application/x-www-form-urlencoded;charset=utf-8",
											success: function(data1){
