...
<div class="checkout__category changedText">Personal address and card details only</div>
...
<form class="checkout__item js-tabs-item" action="../../../../updateUserPersonalAddress/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['aid']; ?>/<?php echo $data['booking_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1"  style="display: block;">
...
<div class="field "  >
<div class="field__label changedText" style="color:#787f91;">If invoice is on company name?</div>
 <div class="field__wrap">
<select class=" " id="food1" name="food1" style="height: 48px;
    padding: 0 14px; border-color: #353945;
    color: grey; border-radius: 12px;
      background: transparent; width:100%;" fdprocessedid="8mc52" >
				 	 
							 <option value="1" class="lgtgrey2_bg changedText">Yes</option>
                           <option value="0" class="lgtgrey2_bg changedText" selected>No</option>
