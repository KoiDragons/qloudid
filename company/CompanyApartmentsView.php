...
<head>
	...
	function submitForm()
	{
		$("#error_msg_form").html('');
							...
							if($('#numberofApart').val()== "")
							{
								$("#error_msg_form").html('please enter number of apartments!!');
								
								return false;
							}
							else if(isNaN($('#numberofApart').val()))
							{
								$("#error_msg_form").html('please enter numeric value for apartments!!');
								
								return false;
							}
							
							else if($('#numberofent').val()== "")
							{
								$("#error_msg_form").html('please enter number of entrance!!');
								
								return false;
							}
							else if(isNaN($('#numberofent').val()))
							{
								$("#error_msg_form").html('please enter numeric value for entrance!!');
				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					<div class="dflex xs-fxwrap_w alit_c">
							<div class="wi_50 xs-wi_100 flex_1 order_1 xs-order_1 xs-tall tall mart10 brdrad5 marr30 xs-marr0">
								...
								<h4 class="bold fsz45 xs-fsz40 padb10 tall  ">Kom ig&aring;ng</h4>
								<h3 class="fsz25 padb10  tall hidden-xs lgn_hight_30">Kom igång med att hantera din fastighet och dina hyresgäster (Person).</h3>
								
								<form action="../../updateApartment/<?php echo $data['cid']; ?>/<?php echo $data['aid']; ?>" method="POST" id="updateform" id="updateform" accept-charset="ISO-8859-1">
									<div class="marb0 padtrl0">
										...
										<div class="on_clmn mart10 xxs-mart10 ">
											...
											<div class="pos_rel">
												<label class="fsz14">Number of apartments</label>
												<input type="number" name="numberofApart" id="numberofApart" min="1" placeholder="Number of apartments" class=" wi_100 rbrdr pad10 mart5 lgtgrey2_bg fsz18 hei_50p llgrey_txt">
										...
										<div class="on_clmn martb10 xxs-mart10 ">
											...
											<div class="pos_rel">
												<label class="fsz14">Number of entrance</label>
												<input type="number" name="numberofent" id="numberofent" min="1" placeholder="Number of entrance" class=" wi_100 rbrdr pad10 mart5 lgtgrey2_bg fsz18 hei_50p llgrey_txt">
