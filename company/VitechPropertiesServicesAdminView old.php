...
<h2 class="product__title h2 xs-fsz50 tall   fsz80 lgn_hight_90 xs-lgn_hight_75 xs-tall uppercase" style="font-weight: 100;max-width: 100%;margin-bottom: 0px; "><span class="changedText">Get access
</span> </h2>
...
">
 ...
 <div class="sorting__details changedText" style="color: #787f91;line-height: 1.3333;font-size: 24px;font-weight: 100;">Start your journey by adding new services to your object
</div>
</div></div>
 ...
 <div class="categories__wrapper">
               <div class="categories__slider js-slider-categories" style="padding-bottom:0px;">
				...
				<a class="categories__item  black_bg " href="#" style="padding: 20px; font-size:14px; border-radius:6px; "  >
                                      ...
                                      <div class="changedText categories__subtitle txt_f67f00">Services</div>
                                      </a>
			 ...
			 <div class="sorting__foot">
               ...
               <a href="../../selectRequestType/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>">  <button class="button-stroke catalog__button">
            ...
            <div class="flights__row">
              ...
              <div class="flights__filters">
                <div class="flights__group">
                  ...
                  <div class="flights__box" style="border-bottom:none;">
                    <div class="flights__variants">
					<?php $i=1; 
								foreach($displayproperties as $category => $value) 
										{
										 ?> 
					 <a href="../../viewPropertyServices/<?php echo $data['cid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;"><label class="checkbox">
                         <span class="checkbox__text changedText" style="<?php if($value['enc']==$data['pid']) echo 'color:#f67f00';?>"><?php echo $value['streetAddress'].' '.$value['areaName']; ?></span></span></span>
                      </label></a>
										<?php } ?> 
              ...
              <div class="flights__container">
				...
				<?php $i=1; 
				  ...
				  <div class="card card_row"   style="margin-bottom:24px; <?php if($value['is_approved']==0) echo 'border:2px solid #ffe500 '; ?>"">
	 
					 
										<div class="card__preview"><img srcset="<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" src="<?php echo $getPropertyDetailInfo['images_info'][0]['image_path']; ?>" alt="Premium milford sound tour ex Queenstown">
                      <div class="category card__category hidden"><?php if($value['is_approved']==1) echo 'Exclusive'; else echo 'Non-exclusive'; ?></div>
                  </div>
                  <div class="card__body" style="background: #131922;">
                    <div class="card__line" style="
    margin-bottom: 0px;
">
                   <a href="#" style="text-decoration:none;"> <div class="flight__title" style="font-size:30px; color:white;"><?php echo $getPropertyDetailInfo['sellPhrase']; ?></div></a>
                        <div class="card__price" style="color:#f67f0099; box-shadow: inset 0 0 0 2px #f67f0099;">
                        <div class="card__old">$<?php echo $getPropertyDetailInfo['owner_sell_price']; ?></div>
                        <div class="card__actual">$<?php echo $getPropertyDetailInfo['owner_sell_price']; ?></div>
                      </div>
                    </div>
...
">
    ...
    line-height: 20px;
">
 <?php  echo $getPropertyDetailInfo['longSellingDescription']; ?> </div>
                      </div>
...
">Service available</div>
                        <a class="header__logo  changedText marr0 fright" href="javascript:void(0);" style="
   /* background-color: #E91E63;*/
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
   ...
   "><?php if($value['request_type']==1) echo 'Sold'; else if($value['request_type']==2) echo 'Sell'; else if($value['request_type']==3) echo 'Rent'; else echo 'Others'; ?> </a>
                      </div>
					  
					  <div class="card__flex brdt mart10 padt10 padb10" style="border-color: #353945;">
                        <div class="card__cost fsz14" style="
    padding-top: 10px; font-weight:100;
">Assign to an agent</div>
                        <a class="header__logo  changedText marr0 fright" href="../../propertyTaskAssignment/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $value['enc']; ?>" style="
   /* background-color: #E91E63;*/
   padding: 5px;
   color: #FFEB3B;
   border-radius: 5px;
   ...
   ">Assign</a>
					  ...
					  <div class="card__foot" style="">
					
                      
				<a href="../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $value['enc']; ?>" style="text-decoration:none;">  <button class="button-stroke button-small faq__button changedText fright" fdprocessedid="w46jts" style="margin-top:0px; padding:0px 20px;">View</button></a>
		  </div>
