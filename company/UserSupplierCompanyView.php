															...
															<a href="https://www.safeqloud.com/user/index.php/PersonalRequests/sentRequests" class="style_base hei_180p dblock bs_bb pad20  lgtgrey2_bg_h  box_shadow">
																<div class=" ">
																	...
																	<div class="  padb15 padt20 talc">
																		<h3 class="ovfl_hid talc pad0 txtovfl_el ws_now lgn_hight_24 bold fsz18 segdblue_txt padt0">Kunder (Privat)</h3>
										...
										<li class=" dblock pos_rel padb10   brdclr_hgrey brdclr_pblue2_a">
											...
											<ul class="marr20 pad0">
												...
												<li class="dblock padrb10">
													<a href="#" class="active hei_26p dflex alit_c pos_rel padrl10  brdwi_3 brdclr_hgrey   greyblue_bg_a black_txt white_txt_h black_txt_a"> <span class="valm trn">Kunder (Privat)</span>
