            ...
            <div class="header__body js-header-body">
              <div class="header__group">
				...
				<a class="header__link" href="https://www.safeqloud.com/company/index.php/Company/companyAccount/<?php echo $data['cid']; ?>">
                    ...
                    </svg><span class="changedText">Employee view</span></a></div>
              </div>
...
<div class="outer__inner mart25">
 ...
 <div class="control center" style="margin-bottom:0px;  max-width: 1132px;"><a class="button-stroke button-small control__button" href="javascript:void(0);">
                ...
                <ul class="breadcrumbs" style="list-style-type: none;">
                  <li class="breadcrumbs__item" style="background: none !important;"><a class="breadcrumbs__link" href="#" style="color:white;">Company details</a></li>
                 <!-- <li class="breadcrumbs__item" style="background: none !important;"><a class="breadcrumbs__link" href="../companyProfileServices/<?php echo $data['cid']; ?>">Marketplaces</a></li>
         ...
         <div class="travel__list" style="margin-bottom: 0px;
            ...
            <div class="travel__item xs-marb40">
                ...
                <div class="travel__subtitle changedText  " style="
				  ...
				  font-weight:100
                  ">Your Company Details</div>
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Keep company details updated to fully utilize Club TXP services.</div>
...
<div class="section brands xsi-mart60" style="
    ...
    margin-bottom: 50px;
">
<div class="panel__nav"><a class="panel__link active" href="javascript:void(0);">Fast track</a></div>
...
<div class="brands__item" style=""><a href="https://www.safeqloud.com/company/index.php/VitechProperties/listProperties/<?php echo $data['cid']; ?>"><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #ffffff;font-size: 40px;text-align: center;"><?php echo count($productServices); ?></div><div class="browse_info info fsz24" style="font-family: 'Poppins', sans-serif;color: #787f91;font-size: 15px;">Products & services</div></a></div>
 ...
 <div class="outer__inner xs-mart65 mart100">
		...
		<div class="flights__center center xs-padrl25" style="padding-bottom:0px;">
		 	 <div class="panel__nav"><a class="panel__link active" href="javascript:void(0);">Company details</a></div>
 </div>
		...
		<div class="flights__center center xs-padrl25" style="padding-bottom:0px;">
		  ...
		  <div class="wi_100 xs-wi_100" style="">
              ...
              <div  class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz20" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;">Company details <br> 
											<a class="header__logo  changedText  ButtonWhite" href="../../Company/companyAccount/<?php echo $data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
									   ...
									   border:none !important;
														vertical-align:bottom;">Visit</a>  </div>
														 ...
														 <div  class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz20" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;">Visiting address <br> 
											<a class="header__logo  changedText  ButtonWhite" href="../../Company/visitingAddress/<?php echo $data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									   ...
									   border:none !important;
														vertical-align:bottom;">Visit</a>  </div>
														 ...
														 <div  class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz20" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;">Invoice address <br> 
											<a class="header__logo  changedText  ButtonWhite" href="../../Company/invoiceAddress/<?php echo $data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									   ...
									   border:none !important;
													  ...
													  <div  class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz20" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;">Contact details<br> 
											<a class="header__logo  changedText  ButtonWhite" href="../../Company/contactDetails/<?php echo $data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									   ...
									   border:none !important;
														vertical-align:bottom;">Visit</a>  </div>
														 ...
														 <div  class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz20" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;">About us<br> 
											<a class="header__logo  changedText  ButtonWhite" href="../../OmOss/companyAccount/<?php echo $data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									   ...
									   border:none !important;
														vertical-align:bottom;">Visit</a>  </div>
														 ...
														 <div   class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz20" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;">Services<br> 
											<a class="header__logo  changedText  ButtonWhite" href="../../ProfessionalCompany/selectedCompanyServices/<?php echo $data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
									   ...
									   border:none !important;
														vertical-align:bottom;">Visit</a>  </div>
														 ...
														 <div  class="talc wi_25-10p dblock fleft pos_rel zi3_h padt30 brdb brdb_blue_h brdr dark_grey_txt salesinbox fsz20" style="height:270px; border:1px solid #282b34; margin:10px 10px 10px 0px; padding-top:105px;  border-radius: 6px; color:white;">Bank details <br> 
											<a class="header__logo  changedText  ButtonWhite" href="../../Company/listBankAccount/<?php echo $data['cid']; ?>" style="background:transparent !important;
										 margin-right:0px;
									   padding: 10px 20px;
										color:#52d4f4 !important;
									   border-radius: 5px;
