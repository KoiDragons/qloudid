	...
	<head>
		...
		function addBathroom()
		{
		 ...
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../addbathroom/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
		...
		function bathroomCountInfo()
		{
		 $('#errorMsg').html('');
				 $.ajax({
							type:"POST",
							url:"../../../../bathroomCountInfo/<?php echo $data['aid']; ?> ",
							...
							success: function(data1){
								 ...
								 $('#bathRoomCount').html('');
								 $('#bathRoomCount').html(data1+' bathrooms');
		...
		function deleteBathroom()
		{
		 ...
		 var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../deleteBathroom/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								if(data1==0)
								{
								$('#errorMsg').html('you cant delete all bathrooms. you need to add atleast one bathroom!!!');
									 return false;	
								}
								 else
								 {
		...
		function updateWheelchair(id,id1)
		{
			$('#errorMsg').html('');
		var send_data={};
				 send_data.bathroom_id=id;
				 send_data.wheel_info=id1;
				 $.ajax({
							type:"POST",
							url:"../../../../updateWheelchair/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updatePrivate(id,id1)
		{
			$('#errorMsg').html('');
		var send_data={};
				 send_data.bathroom_id=id;
				 send_data.private_info=id1;
				 $.ajax({
							type:"POST",
							url:"../../../../updatePrivate/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateEnsuit(id,id1)
		{
			$('#errorMsg').html('');
		var send_data={};
				 send_data.bathroom_id=id;
				 send_data.ensuit_info=id1;
				 $.ajax({
							type:"POST",
							url:"../../../../updateEnsuit/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		function updateOverbath(id)
		{
			$('#errorMsg').html('');
		var send_data={};
				 send_data.bathroom_id=id;
				 send_data.standalone=0;
				 send_data.overbath=1;
				 $.ajax({
							type:"POST",
							url:"../../../../updateOverbath/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
		...
		var send_data={};
				 send_data.bathroom_id=id;
				 send_data.standalone=1;
				 send_data.overbath=0;
				 $.ajax({
							type:"POST",
							url:"../../../../updateOverbath/<?php echo $data['aid']; ?> ",
							data:send_data,
		...
		function updateShower(id,id1)
		{
			$('#errorMsg').html('');
			var send_data={};
				 send_data.bathroom_id=id;
				 send_data.standalone=id1;
				 send_data.overbath=0;
				 $.ajax({
							type:"POST",
							url:"../../../../updateShower/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								if(data1==0)
								{
								$('#errorMsg').html('Atleast one shower or bath is required per property');	
								}
								else
								{
								$('#bathroom_info').html('');
		...
		function countBathDetail(id)
		{
			...
			var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../countBathDetail/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								if(data1>0)
								{
								$('#halfBath').removeClass('hidden');	
								}
								else
								{
								$('#halfBath').addClass('hidden');	
								}
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateBath/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								if(data1==0)
								{
									$('#errorMsg').html('Atleast one bath or shower is required per property');
								}
								else
								{
								 $('#bathroom_info').html('');
		...
		var send_data={};
				 ...
				 $.ajax({
							type:"POST",
							url:"../../../../updateToilet/<?php echo $data['aid']; ?> ",
							data:send_data,
							dataType:"text",
							contentType: "application/x-www-form-urlencoded;charset=utf-8",
							success: function(data1){
								if(data1==0)
								{
									$('#errorMsg').html('Atleast one toilet and sink is required per property');
								}
								else
								{
								$('#bathroom_info').html('');
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						...
						<div class="on_clmn brdb marb5">
									 ...
									 <div id="errorMsg" class="fsz20 red_txt padtb20 tall"></div>
										...
										<div class="container padtb15  brdrad1 fsz14 dark_grey_txt padrl10">
											<div class="passport signin_bx dflex fxwrap_w xs-alit_c pos_rel tall">
												...
												<div class="wi_100 xs-wi_100 xs-order_3 xs-padt0 fsz12">
													...
													<span class="edit-text bold padt0 jain2 dblock   brdclr_lgtgrey2 fsz18 xs-padt0 black_txt">Number of bathrooms</span>
													 <span class="edit-text   jain2 dblock   brdclr_lgtgrey2 fsz14  black_txt hidden-xs ">How many bathrooms does this property have?</span> 
													 </div>
										...
										<a href="javascript:void(0);" onclick="deleteBathroom();">	
									<button color="#444444" data-testid="icon-button--minus" class="merlin-button css-mgojn5" aria-label="">
										...
										<span class="value" id="bathRoomCount"><?php echo $bathroomCount; ?> bathrooms</span>
									<a href="javascript:void(0);" onclick="addBathroom();">	
									<button color="#444444" data-testid="icon-button--plus" class="merlin-button css-mgojn5" aria-label="">
										...
										<div data-testid="icon-button--icon-div" class="css-r0ilrj">
										  ...
										  <div class="css-1jcail2 martb15 <?php if($result==0) echo 'hidden'; ?>" id="halfBath">
									 <div data-testid="did-you-know-half-bathrooms" class="css-1miy8fb">
									 <img role="presentation" src="https://www.safeqloud.com/html/usercontent/images/paintbrush-ladder.68ee.svg" class="css-1p436cn">
									 <div class="css-1ai2sgr tall">Any bathrooms that only have a toilet and sink are considered a half bath.</div>
									 </div>
									 </div>
