...
<a class="header__logo xs-fsz25 changedText" href="https://www.safeqloud.com/company/index.php/CompanyProperty/locationAccount/<?php echo $data['cid']; ?>" style="
...
<div class="travel__subtitle changedText " style="
            ...
            <div class="travel__content changedText xs-fsz27" style=" line-height: 1.4;
                  color: #787f91;
				   line-height: 1.4;
                  font-size: 27px;
                  ">Only register a workplace with same company identification number as headquarter.</div>
...
<?php if(isset($data['id'])) { ?>
 ...
 <div class="  "  >
				  <div class="upload__item">
                       ...
                       <div class="field <?php if(isset($data['id'])) {  echo '';  } else { echo 'hidden'; } ?>">
							  <div class="field__label  changedText" style="color:#787f91;">Property detail</div>
                              <div class="field__wrap">
                                <select class=""   style="height: 48px;
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" id="property_id" name="property_id">
								<?php $i=0;
					...
					<div class="receipt__stage">Visiting adress</div>
						...
						<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              ...
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="adrs1" id="autocomplete" placeholder="e.g. tip top"  value="<?php if(isset($data['id'])) {  echo $propertyInfo['visiting_address']; } ?>"  style=" color:grey;" onchange="changeLat();">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							<div class="field__label  changedText" style="color:#787f91;">Port no</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="port_number" name="port_number"  placeholder="e.g. 123" style=" color:grey;" value="<?php if(isset($data['id'])) {  echo $propertyInfo['port_number']; } ?>">
                              </div>
                            </div>
                          </div>
                        </div>
					...
					<div class="upload__row " id="locationDetail" style="display:none">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              ...
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="latit" id="latit" placeholder="e.g. 78.123345"  style=" color:grey;" value="<?php if(isset($data['id'])) {  echo $propertyInfo['latitude']; } ?>">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">Longitude</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="longi" id="longi"  placeholder="e.g. 29.1233456" style=" color:grey;" value="<?php if(isset($data['id'])) {  echo $propertyInfo['longitude']; } ?>">
                              </div>
                            </div>
                          </div>
                        </div>
					...
					<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
                              ...
                              <div class="field__wrap">
								...
								padding: 0 14px; border-color: #353945;
								color: grey; border-radius: 12px;
								  background: transparent; width:100%;"   fdprocessedid="zc7mun" id="country_v" name="country_v">
                          ...
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">Phone number</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="phone_number" id="phone_number" value="<?php if(isset($data['id'])) {  echo $propertyInfo['phone_number']; } ?>"   placeholder="e.g. 111111" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
					...
					<div class="receipt__stage">Delivery</div>
						...
						<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							  <div class="field__label  changedText" style="color:#787f91;">Address</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="daddress" id="daddress" placeholder="e.g. tip top" value="<?php if(isset($data['id'])) {  echo $propertyInfo['street_name_v']; } ?>" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							<div class="field__label  changedText" style="color:#787f91;">Port numeber</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="d_port_number" id="d_port_number"  value="<?php if(isset($data['id'])) {  echo $propertyInfo['d_port_number']; } ?>"  placeholder="e.g. 1234" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
						...
						<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">Zipcode</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="dzip" name="dzip"  value="<?php if(isset($data['id'])) {  echo $propertyInfo['postal_code_v']; } ?>" placeholder="e.g. 111111" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">City</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="dcity" name="dcity"  value="<?php if(isset($data['id'])) {  echo $propertyInfo['city_v']; } ?>"  placeholder="e.g. Stockholam" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
...
<input type="hidden" id="same_invoice" name="same_invoice" value="<?php if(isset($data['id'])) {  echo $propertyInfo['is_invoice_same']; } else echo 1; ?>" />
				   <div class="setting__notification" style="border-color:#23262f;">
                      <div class="setting__main">
                        <div class="setting__subtitle">Invoice address</div>
                        <label class="switch">
                          <input class="switch__input" type="checkbox" onclick='updateInvoice(this);'  <?php if(isset($data['id'])) {  if($propertyInfo['is_invoice_same']==1) echo 'checked'; } else echo 'checked'; ?> /><span class="switch__inner"><span class="switch__box"></span></span>
                        </label>
                      </div>
                      <div class="setting__content">Do you have invoice address same?</div>
                    </div>
 ...
 <div id="ShowInvoice" class="<?php if(isset($data['id'])) {  if($propertyInfo['is_invoice_same']==1) echo 'hidden'; } else echo 'hidden'; ?>">
						...
						<div class="receipt__stage">Invoice</div>
						...
						<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
                            <div class="field">
							  <div class="field__label  changedText" style="color:#787f91;">Address</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="iaddress" id="iaddress" placeholder="e.g. tip top" value="<?php if(isset($data['id'])) {  echo $propertyInfo['street_name_i']; } ?>" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">Port numeber</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" name="i_port_number" id="i_port_number"  value="<?php if(isset($data['id'])) {  echo $propertyInfo['i_port_number']; } ?>"  placeholder="e.g. 1234" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
						...
						<div class="upload__row ">
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">Zipcode</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="izip" name="izip"  value="<?php if(isset($data['id'])) {  echo $propertyInfo['postal_code_i']; } ?>" placeholder="e.g. 111111" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                          <div class="upload__col upload__col_w50">
							...
							<div class="field__label  changedText" style="color:#787f91;">City</div>
                              <div class="field__wrap">
                                <input class="field__input" type="text" id="icity" name="icity"  value="<?php if(isset($data['id'])) {  echo $propertyInfo['city_i']; } ?>"  placeholder="e.g. Stockholam" style=" color:grey;">
                              </div>
                            </div>
                          </div>
                        </div>
						...
						<div class="on_clmn  mart10 " id="isHeadquarter" style="display:none;">
											...
											<h1 class="mart10 tall fsz25 xs-fsz20 bold brdb_new ">�r detta huvudkontoret?</h1>
