...
<div class="setting__container" style="padding:0px;">
 <div class="setting__head hidden">
                    <h2 class="setting__title h2">Contact details</h2> <a class="button-stroke button-small setting__button" href="https://www.safeqloud.com/company/index.php/CompanyCrm/adminAccount/<?php echo $data['cid']; ?>">View profile</a>
                  </div>
<div class="checkout__list">
 <form method="POST" action="../updateLocationContactDetail/<?php echo $data['id']; ?>" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1">
  
				 
					<div class="checkout__section xsi-nobrdt " style="margin-top:0px;   padding-bottom:136px; ">
					<div class="setting__section">
                      <div class="setting__category">Sales</div>
                      <div class="setting__fieldset">
                        
                          <div class="field">
                            <div class="field__label">Email</div>
                            <div class="field__wrap">
                              <input class="field__input  xs-fieldData" type="text" id="sale_email" name="sale_email" placeholder="xyz@gmail.com" required="" style="color:grey; background:#282D34; border:none;" value="<?php echo $companyLocationContactInfo['sale_email']; ?>">
                            </div>
                          </div>
...
<select class="xs-fieldData"  style="height: 48px;
    ...
    color: grey; border-radius: 12px;
      background:#282D34; width:100%;  border:none;" fdprocessedid="8mc52" disabled>
				  															
	<?php foreach($countryOpt as $category => $value ) {
										?>
										
										<option value="<?php echo $value['country_name']; ?>" <?php if($companyDetail['country_id']==$value['id']) echo 'selected';?> >+<?php echo $value['country_code']; ?></option>
...
<div class="field__wrap">
<input class="field__input xs-fieldData" name="sale_phone_number" id="sale_phone_number" type="text" placeholder="e. g. xxxxxx1234" style="color:grey;  background:#282D34;  border:none;"  value="<?php echo $companyLocationContactInfo['sale_phone_number']; ?>">
</div>
</div>
</div>
 </div>
					...
					<div class="setting__section">
                      <div class="setting__category">Customer service</div>
                      <div class="setting__fieldset">
                        
                          <div class="field">
                            <div class="field__label">Email</div>
                            <div class="field__wrap">
                              <input class="field__input  xs-fieldData" type="text" id="cs_email" name="cs_email" placeholder="xyz@gmail.com" required="" style="color:grey; background:#282D34; border:none;"  value="<?php echo $companyLocationContactInfo['cs_email']; ?>">
                            </div>
                          </div>
...
<div class="field__label changedText" style="color:#787f91;">Mobile</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="cs_phone_number" id="cs_phone_number" type="text" placeholder="e. g. xxxxxx1234" style="color:grey;  background:#282D34;  border:none;"  value="<?php echo $companyLocationContactInfo['cs_phone_number']; ?>">
</div>
</div>
</div>
 </div>
...
<div class="setting__section">
                      <div class="setting__category">Finance</div>
                      <div class="setting__fieldset">
                        
                          <div class="field">
                            <div class="field__label">Email</div>
                            <div class="field__wrap">
                              <input class="field__input  xs-fieldData" type="text" id="finance_email" name="finance_email" placeholder="xyz@gmail.com" required="" style="color:grey; background:#282D34; border:none;"  value="<?php echo $companyLocationContactInfo['finance_email']; ?>">
                            </div>
                          </div>
...
<div class="field__label changedText" style="color:#787f91;">Mobile</div>
<div class="field__wrap">
<input class="field__input xs-fieldData" name="finance_phone_number" id="finance_phone_number" type="text" placeholder="e. g. xxxxxx1234" style="color:grey;  background:#282D34;  border:none;"  value="<?php echo $companyLocationContactInfo['finance_phone_number']; ?>">
</div>
</div>
</div>
 </div>
                      ...
                      <div class="setting__fieldset">
                        <div class="setting__row">
                          <div class="field">
                            ...
                            <div class="field__wrap">
                              <input class="field__input  xs-fieldData" type="text" id="facebook_url" name="facebook_url" placeholder="Your facebook account" required="" style="color:grey; background:#282D34; border:none;"  value="<?php echo $companyLocationContactInfo['facebook_url']; ?>">
                            </div>
                          </div>
                          <div class="field  ">
                            <div class="field__label">twitter</div>
                            <div class="field__wrap">
                              <input class="field__input  xs-fieldData" type="text" id="instagram_url" name="instagram_url" placeholder="Your instagram account" required="" style="color:grey; background:#282D34; border:none;"  value="<?php echo $companyLocationContactInfo['instagram_url']; ?>">
