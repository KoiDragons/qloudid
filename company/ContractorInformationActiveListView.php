				...
				<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
					...
					<div class="wi_500p maxwi_100 pos_rel zi5 marrla pad10   xs-pad0">
						<div class="padb0 xxs-padb0 ">		
									...
									<div class="mart10 marb5 xxs-talc talc  xs-padb20 padb35 ffamily_avenir"> <a href="#" class="black_txt fsz25  xs-fsz20 xxs-talc talc edit-text jain_drop_company trn lgn_hight_20">Here is the list of all active contractors </a></div>
					 ...
					 <div class="tab-header martb10 padb10 xs-talc brdb2_1e6cf8 nobrdt nobrdl nobrdr talc">
                                            <a href="../invitedContractorsList/<?php echo $data['cid']; ?>" class="dinlblck mar5 padrl10  bg_94cffd_a brdrad40  lgn_hight_36 fsz16 midgrey_txt seggreen_txt_h white_txt_a white_txt_ah  ffamily_avenir " >Invited</a>
                                            <a href="#" class="dinlblck mar5 padrl30  nobrd  bg_1e6cf8 brdrad40  lgn_hight_36 fsz16 white_txt seggreen_txt_h   white_txt_ah ffamily_avenir active">Active</a>
								...
								<?php  
								foreach($activeContractorList as $category => $value1) 
												{
												?> 	  
