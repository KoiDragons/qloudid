  ...
  <script>
   function updateHeader(id)
	    ...
	    function updateChildren(id)
					...
					$.ajax({
						type:"POST",
						url:"../../../updateChildren/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
							
							 $('#childrenInfo').html(data1);
					...
					$.ajax({
						type:"POST",
						url:"../../../updateInfant/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
					...
					$.ajax({
						type:"POST",
						url:"../../../updateSmoking/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
							
							 $('#eventsInfo').html(data1);
							 
						}
					});
					}
					
					function updateParties(id)
					{
					var send_data={};
					send_data.id=id;
					...
					$.ajax({
						type:"POST",
						url:"../../../updateParties/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
					...
					$.ajax({
						type:"POST",
						url:"../../../updatePets/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
					...
					$.ajax({
						type:"POST",
						url:"../../../updateDisabled/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>",
						data:send_data,
						dataType:"text",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						success: function(data1){
 ...
 <div class="setting__select tablet-show" style="border-bottom: 1px solid #f67f00; padding-bottom:30px;">
    ...
    color: #f67f00; border-radius: 12px;
        width:100%; background:#23262F; font-size:14px;" onchange="updateHeader(this.value);">
                ...
                <option value="../../../foreignPropertyHouseRule/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" selected>House rules</option>
...
<div class="upload__wrap  " style="background:transparent;  ">
			...
			<a class="setting__link  " href="../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>" onclick="updateHeader('../../../photoInformation/<?php echo $data['cid']; ?>/<?php echo $data['pid']; ?>/<?php echo $data['request_id']; ?>');">
                ...
                </svg><span style="color:#f67f00">House rules</span></a>
		   ...
		   <div class="setting__container">
			...
			<h2 class="setting__title h2" style="margin-bottom: 64px; font-size:25px;">Rules</h2>
			<div class="description__group">
<div class=" " style="border-color:#E8681F; ">
<div class="description__content">
<h4 class="changedText">Family rules</h4>
<p class="changedText">Orange marked are allowed to stay in your property. </p>
<div class="css-1jzh2co">	
										<div class="chip-container" id="childrenInfo">
											<?php echo $childrenHouseRules; ?>
											</div> 
									</div>	
</div>
</div>
<div class="description__section" style="border-color:#E8681F; ">
<div class="description__content">
<h4 class="changedText">Recreational rules</h4>
<p class="changedText">Orange marked are permitted inside your property.</p>
<div class="css-1jzh2co">	
										<div class="chip-container" id="eventsInfo">
											<?php echo $eventsHouseRules; ?> 
											</div> 
									</div>	
</div>
...
<div class="description__section hidden" style="border-color:#E8681F; ">
<div class="description__content">
<h4 class="changedText">Disabled rules</h4>
<p class="changedText">Orange marked are permitted inside your property.</p>
<div class="css-1jzh2co">	
										<div class="chip-container" id="disabledInfo">
											<?php echo $disabledHouseRules; ?> 
											</div> 
									</div>	
</div>
