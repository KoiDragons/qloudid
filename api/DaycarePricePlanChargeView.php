...
<html lang="en">
  ...
  <meta charset="utf-8">
	...
	<script src="https://www.qloudid.com/html/usercontent/js/Duplicate.js"></script>
	<script src="https://js.stripe.com/v3/"></script>
	<script src="js/checkout.js" STRIPE_PUBLISHABLE_KEY="pk_live_rHdBDQYVq7WDKdjJNcTVYDfJ" defer></script>
    <script>
...
<form class="checkout__item js-tabs-item" action="../../../selectedPlanInfo/<?php echo $data['cid']; ?>/<?php echo $data['app_id']; ?>/<?php echo $data['plan_id']; ?>" method="POST" id="save_indexing" name="save_indexing" accept-charset="ISO-8859-1" style="display: block;">
