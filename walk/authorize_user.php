...
if(!checkLogin())
{
	//echo "logout"; die;
	 if(isset($_GET['apply']))
  {
	  header('Location: ../user/index.php/LoginAccount/loginapp/?next='.$_GET['client_id'].'&apply=2&job_id='.$_GET['job_id']);
  }
  else
  {
...
$query="select first_name,concat_ws(' ', first_name, last_name) as name,last_name,email,passport_image,grading_status from user_logins where id =".$_SESSION['user_id'];
//echo $query; die;
