...
if (!$server->validateAuthorizeRequest($request, $response)) {
 ...
 if (empty($_POST)) {
 exit('<body class="white_bg hidden"  >
...
<div class="column_m pos_rel">
		<!-- CONTENT -->
			...
			<div class="wrap maxwi_100 padrl15 md-padrl0 lg-padrl0">
				...
				<input type="submit" value="Yes" name="authorized" id="modal" data-modal="modal" class="wi_100 maxwi_100 brdrad3 hei_50p diblock nobrd green_bg fsz18 white_txt curp" >
