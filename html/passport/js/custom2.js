		...
		if ($menu_header[0]) {
			...
			for (var i = 0, iL = $menu_header.length; i < iL; i++) {
				...
				if(i<=10)
						...
						{
							var a = "http://www.qmatchup.com/beta/user/index.php/UserToDo/userToDoAccount/"+email_id;
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==12)
						...
						{
							var a = "http://www.qmatchup.com/beta/user/index.php/SendRequest/sendRequestCompany/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==17)
						{
							var a = "http://www.qmatchup.com/beta/user/index.php/SendRequest/sendRequestCompany/QkhHaWQzcnBweFU5MDRIMllxY3IzQT09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==18)
						{
							var a = "http://www.qmatchup.com/beta/user/index.php/SendRequest/sendRequestCompany/cXZGMGwveWlTUUI4VDI5MFpNaEZrUT09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==19)
						{
							var a = "http://www.qmatchup.com/beta/user/index.php/SendRequest/sendRequestCompany/bi9rQnJTT2VZNmwwNVVBTWkvbzA5Zz09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
