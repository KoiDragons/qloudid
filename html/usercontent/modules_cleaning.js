/* SUPPLEMENTAL */
var serviceFeeAppalicable=0;
var inspectionFeeAppalicable=0;
var updateBedroomCleaningAvailable=0;
var bedroomId=0;
(function() {
	...
	if($boolean_controls[0]){
		var boolean_controls_select = function($option){
			...
			if($option.attr('data-value') === 'true'){
				...
				if(serviceFeeAppalicable==1)
				{
					$("#start_fee").val(0);
					$('#start_fee_applicable').val(1);
					$('#startFeeInfo').removeClass('hidden');
					serviceFeeAppalicable=0;
				}
				
				if(inspectionFeeAppalicable==1)
				{
					$("#inspection_fee").val(0);
					$('#inspection_fee_applicable').val(1);
					$('#inspectionFeeInfo').removeClass('hidden');
					inspectionFeeAppalicable=0;
				}
				
				
				if(updateBedroomCleaningAvailable==1)
				{
					$("#bedroom_apartment_cleaning_fee"+bedroomId).val(0);
					$("#bedroom_apartment_cleaning_max_area"+bedroomId).val(0);
					$("#bedroom_apartment_cleaning_extra_per_sqm"+bedroomId).val(0);
					$('#bedroom_apartment_cleaning_available'+bedroomId).val(1);
					$('#bedroomApartmentCleaningAvailable'+bedroomId).removeClass('hidden');
					updateBedroomCleaningAvailable=0;
				}
				...
				{
					$("#start_fee").val(0);
					$('#start_fee_applicable').val(0);
					$('#startFeeInfo').addClass('hidden');
					serviceFeeAppalicable=0;
				}
				...
				{
					$("#inspection_fee").val(0);
					$('#inspection_fee_applicable').val(0);
					$('#inspectionFeeInfo').addClass('hidden');
					inspectionFeeAppalicable=0;
				}
				if(updateBedroomCleaningAvailable==1)
				{
					...
					$("#bedroom_apartment_cleaning_max_area"+bedroomId).val(0);
					$("#bedroom_apartment_cleaning_extra_per_sqm"+bedroomId).val(0);
					$('#bedroom_apartment_cleaning_available'+bedroomId).val(0);
					$('#bedroomApartmentCleaningAvailable'+bedroomId).addClass('hidden');
					updateBedroomCleaningAvailable=0;
				}
				if($target[0]){
					$target
