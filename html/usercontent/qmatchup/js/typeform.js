var form_settings = {
	group: {
		class: 'trackable opa20 opa1_a pos_rel zi1 zi2_a padt30 padr20 padb40 trans_all2',
	},
	group_label: {
		class: 'dblock pos_rel zi5 mar0 marb25 pad0',
	},
	question: {
		class: 'pos_rel pad0 padl50 fsz24 txt_40a843',
		icon: {
			class : 'wi_40p hei_28p dflex justc_fe alit_c pos_abs top0 left0 talr nobold fsz16',
		},
		required: {
			html: '*',
			class: 'marl5',
	...
	description: {
		class: 'mart15 padr25 padl50 txt_40a843',
	},
	control: {
		class: 'pos_rel zi1 padr25 padb20 padl50',
		...
		fields: {
			text: {
				...
				field: {
					class: 'focusable wi_100 hei_40p dblock mar0 pad0 nooutl nobrd trans_bg font_helvetica fsz30 txt_428f8c trans_all2',
				},
			},
			textfield: {
				field: {
					class: 'focusable wi_100 dblock mar0 pad0 nooutl nobrd trans_bg font_helvetica fsz30 txt_428f8c trans_all2',
				}
			},
			select: {
				class: 'pos_rel',
				...
				field: {
					class: 'focusable wi_100 maxwi_200p hei_100 dblocki pos_abs top0 left0',
				},
			},
			dropdown: {
				class: '',
				...
				dropdown: {
					menu: {
						class: 'wi_100 maxwi_300p minhei_10p dblock vis_vis opa1 pos_abs mar0 pad0 nobrdi trans_bg',
					},
					item: {
						class: 'dblock mar0 pad0 padt5 lgtgrey_bg',
					},
					wrap: {
						class: 'mar0i pad0i nobrdi trans_bgi',
					},
					link: {
						class: 'dblock pos_rel padtb5 padrl15 brd brdclr_428f8c brdrad3 bg_ebf8f2 bg_d0e7e1_h lgn_hight_24 txt_428f8c curp',
					},
				},
			},
			tags: {
				...
				container: {
					...
					token: {
						class: 'diblock pos_rel marb5 marr5 padtb5 padr20 padl8 brd brdclr_428f8c brdrad2 bg_428f8c_05 bg_428f8c_2_h valm txt_428f8c',
						...
						dismiss: {
							class: 'dblock pos_abs pos_cenY right0 pad5 valm txt_a9b9d8 curp',
							html: 'x',
						},
					},
					token_search: {
						class: 'diblock marb5 pad0 valm',
						
						field: {
							class: 'focusable wi_100 hei_32p mar0 pad0 nobrd trans_bg',
						},
					}
				},
				dropdown: {
					class: 'maxwi_300p dblock pos_abs',
					
					menu: {
						class: 'wi_100 dblock minhei_10p vis_vis opa1 mar0 pad0 nobrd trans_bg',
					},
					item: {
						class: 'dblock mar0 pad0 padt5 lgtgrey_bg',
					},
					...
					empty: {
						class: 'dblock pos_rel padtb5 padrl15 brd brdclr_428f8c brdrad3 bg_ebf8f2 lgn_hight_24 txt_428f8c',
					}
				},
			},
			choices: {
				...
				choice: {
					class: 'dflex alit_s mar0 marb10 pad0 padrl5',
				},
				label: {
					class: 'wi_100 dflex alit_s pos_rel talc fsz20 txt_428f8c',
				},
				field: {
					class: 'wi_100 hei_100 dblock opa0 pos_abs zi5 top0 left0 mar0 pad0 curp',
				},
				text: {
					class: 'wi_100 dflex fxwrap_w alit_c justc_c pos_rel zi1 padtb10 padr40 padl10 bsh_i0001_428f8c_sibc brd brdclr_428f8c brdrad3 bg_428f8c_05 bg_428f8c_2_ph trans_all2',
					icon_after: {
						class: 'fa fa-check hei_100 dflex alit_c opa0 opa1_sibc pos_abs zi2 top0 right10p',
					},
				},
				text_has_image: {
					class: 'wi_100 dflex fxwrap_w alit_c justc_c pos_rel zi1 padt5 padrl5 padb10 bsh_i0001_428f8c_sibc brd brdclr_428f8c brdrad3 bg_428f8c_05 bg_428f8c_2_ph trans_all2',
					image: {
						class: 'wi_100 hei_auto dblock marrla marb10',
					},
					icon_after: {
						class: 'fa fa-check opa0 opa1_sibc pos_abs zi3 top5p right5p white_txt',
					},
					icon_after_bg: {
						class: 'opa0 opa60_sibc pos_abs top0 right0 zi2 brd brdwi_50 brdclr_428f8c nobrdt nobrdl brdbclr_transi',
					},
				},
			},
			rating: {
				class: 'wi_100 dflex fxdir_rowr alit_c pos_rel talc',
				
				field: {
					class: 'wi_0 hei_0 pos_abs top0 left0 opa0 mar0 pad0',
				},
				label: {
					class: 'txt_428f8c_sibc curp',
				},
			},
			scale: {
				class: '',
				...
				choices: {
					class: 'wi_100 dflex alit_s brdl brdclr_428f8c brdrad3 talc fsz22 txt_428f8c',
					
					label: {
						class: 'wi_100 dflex alit_s pos_rel brdt brdb brdr brdclr_428f8c brdradrb3_lchild curp',
					},
					field: {
						class: 'wi_0 hei_0 opa0 pos_abs mar0 pad0',
					},
					text: {
						class: 'wi_100 dflex alit_c justc_c padtb15 bg_428f8c_05 bg_428f8c_2_ph bg_428f8c_sibci white_txt_sibc',
					},
				},
				
				labels: {
					class: 'dflex alit_c justc_c marrl-5 talc txt_428f8c fsz13 md-fsz15 lg-fsz15',
					
					label: {
						class: 'wi_100 padtb15 padrl5 tall_fchild talr_lchild',
					},
				},
			},
		},
	...
	button_area: {
		class: 'hei_0 hei_40p_pac ovfl_hid opa0 opa1_pac pos_abs top100 left50p mart-40 trans_all2',
		button: {
			class: 'next hei_40p diblock marr10 padrl10 bxsh_03120_01 nobrd brdrad3 bg_7dc59a talc bold fsz18 txt_1d402b curp',
			html: '<span class="valm">OK</span> <span class="fa fa-check valm"></span>',
		},
		post_text: {
			class: 'valm txt_428f8c',
			html: 'press ENTER',
		},
	},
	notifications: {
		class: 'pos_rel padr20 padl50 fsz12',
		
		arrow: {
			class: 'wi_10p hei_10p pos_abs zi1 top-5p left70p rotate45',
		},
		
		error: {
			class: 'wi_400p maxwi_100 marb10 brdrad3 pos_rel zi2 pad5 red_bg white_txt',
			arrow: {
				class: 'red_bg',
			},
		},
		warning: {
			class: 'wi_400p maxwi_100 marb10 brdrad3 pos_rel zi2 pad5 orange_bg white_txt',
			arrow: {
				class: 'orange_bg',
			},
		},
		success: {
			class: 'wi_400p maxwi_100 marb10 brdrad3 pos_rel zi2 pad5 green_bg white_txt',
			arrow: {
				class: 'green_bg',
			},
		},
		...
		messages: {
			default: 'There is something wrong with the data you\'ve entered. Please check it again.',
			required: 'This field is required!',
			alpha: 'Only letters are allowed in this field',
			numeric: 'Only numbers are allowed in this field',
			alphanumeric: 'Only letters and numbers are allowed in this field',
			email: 'That doesn\'s looks like a valid email address',
			url: 'That doesn\'s looks like a valid website address',
			pattern: 'Your input doesn\t meet pattern requirements',
		},
	},
	form_notifications: {
		class: 'padtb10',
		html: ' answer(s) need comleting'
	},
};
...
$(document).ready(function(){
	...
	var methods = {
		...
		label_for : ['text', 'number', 'email', 'tel', 'url', 'textarea', 'select', 'dropdown'],
		...
		// - form init
		form_init : function(){
			var $form = $('.typeform form');
			
			$document.on('keydown', function(e){
				if($form.hasClass('inview') && e.keyCode === 13 && e.shiftKey != true){
					console.log(e);
			...
			$form
				...
				.on('click', '.form-group > label:not([for])', function(){
					var $this = $(this),
						$group = $this.closest('.form-group');
					console.log('click -> label:not([for])');
					$this.trigger('focus');
					methods.question_focus($this.closest('form'), undefined, $group);
					return false;
				})
				.on('click', '.form-group-cover', function(){
					...
					if($focusable[0]){
						console.log('click -> form-group-cover -> focusable');
						$focusable.trigger('focus');
					}
					else{
						console.log('click -> form-group-cover -> not focusable');
						$this.trigger('focus');
						methods.question_focus($this.closest('form'), undefined, $group);
					}
					return false;
				...
				.on('click', 'button[type=submit]', function(){
					console.log('click -> button[type=submit]');
					if(!methods.form_check($form, true)){
				...
				.on('keyup change', 'input, select, textarea', function(e){
					...
					if($choice[0]){
						if($this.attr('type') === 'radio'){
							console.log('keyup change -> radio');
							if(this.checked){
								methods.question_next($this.closest('form'), $group);
							}
						}
						else{
							console.log('keyup change -> checkbox');
						...
						if(this.tagName == 'SELECT'){
							...
							if($this.val().length > 0){
								console.log('keyup change -> else checked');
								$group.addClass('checked');
							}
							else{
								console.log('keyup change -> else un-checked');
								$group.removeClass('checked');
							}
						}
					}
		...
		build_field : function($form_groups, data, index){
			var $form_content = methods.$form_content,
				html = '<div class="form-group ' + ((data.attributes && data.attributes.required && data.attributes.required === 'required') ? 'form-group-required ' : '') + form_settings.group.class + '" id="form-group-' + data.id + '"><a href="#" class="form-group-cover wi_100 hei_100 dblock dnone_pa pos_abs zi2 top0 left0 curd"></a>',
				additional_classes = '',
				label_for = '',
			...
			if(data.question || data.description){
				...
				if(data.question){
					...
					html += '<div class="form-question-icon ' + form_settings.question.icon.class + '">' + (data.type === 'statement' ? '<span class="fsz40">&#8220;</span>' : index + '<span class="fa fa-arrow-right marl5 fsz10"></span>') + '</div>';
					html += data.question;
			...
			if(data.styles){
				styles = ' style="';
				for(var stl in data.styles){
					if(data.styles.hasOwnProperty(stl)){
						if(attr !== 'width'){
							styles += stl + ':' + data.styles[stl] + ';';
						}
					}
				}
				styles += '"';
			...
			if(data.type === 'statement'){
				...
				// - choices
					...
					if(data.choices){
						...
						for(var c = 0, cL = data.choices.length; c < cL; c++){
							var choice = data.choices[c];
							html += '<div class="form-choice ' + type_settings.choice.class + '"' + styles + '>';
							html += '<label class="' + type_settings.label.class + '">';
							html += '<input type="' + choice_type + '" value="' + (choice.value ? choice.value : choice.label) + '" class="prime-field ' + type_settings.field.class + '"' + attributes + (choice.selected ? ' checked="checked"' : '') + '/>';
							if(choice.image_url){
		...
		question_prev: function($form, $active, $prev){
			...
			if(!$prev){
				$prev = $active[0] ? $active.prev('.form-group') : [];
			}
