...
$(document).ready(function() {
	...
	$body.on('click', '.editable', function(){
		...
		if($this.hasClass('edit-text')){
			...
			$edit_input
				...
				.addClass(' wi_100 pad0 ff_inh nobrdt nobrdr nobrdl pink_bg')
		...
		if($this.hasClass('edit-address')){
			...
			if(options){
				...
				$select_input
					...
					.addClass(' default wi_auto minwi_100 pos_abs zind5 top0 left0 pad0 ff_inh nobrdt nobrdr nobrdl pink_bg curp')
		...
		init : function(){
			...
			if($wp_columns[0]){
				...
				$wp_columns.find('.imgwrap').on({
					'mouseenter' : function(){
						$(this).find('.load_button_image1').show();
						return false;
					},
					'mouseleave' : function(){
						$(this).find('.load_button_image1').hide();
						return false;
					}
				});
				
				$wp_columns.find('.load_button_image1').on('click', function(){
					//wd_upload_methods.show_cropit_upload($(this));
					$(this).closest('.subimg_load').find('.image-to-upload').trigger('click');
					return false;
				});
    ...
    if (filesSelected.length > 0) {
      ...
      fileReader.readAsDataURL(fileToLoad);
			...
			vex.open({
				unsafeContent: '<div><h3>Upload image</h3><div id="image-cropper" class="image-editor"><div class="cropit-image-preview" style="width: 120px; height: 120px;"></div><input class="cropit-image-zoom-input scrolling-element" type="range" min="0" max="1" step="0.01"><input class="cropit-image-input" type="file" accept="image/*"><button type="button" class="select-image-btn">Select new image</button><div class="button-area"><input id="vex-close-n-crop" type="button" class="btn-apply" style="width:100px;" value="OK" /></div></div></div>',
				...
				afterOpen: function() {
					...
					$vexContent.find('#vex-close-n-crop').on('click', function(){
						...
						return false;
							 ...
							 var filePath=$vexContent.find('.cropit-image-input').val();
		...
		if ($menu_header[0]) {
			...
			for (var i = 0, iL = $menu_header.length; i < iL; i++) {
				...
				if(i<=2)
						...
						{
							var a = "http://www.qmatchup.com/beta/NewPersonal/index.php/UserToDo/userToDoAccount/"+email_id;
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==4)
						{
							var a = "http://www.qmatchup.com/beta/edit_user_social.php?description=1";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==5)
						{
							var a = "http://www.qmatchup.com/beta/list_all_jobs.php";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==6)
						{
							var a = "http://www.qmatchup.com/beta/profile-user-cv2.php?id="+u_id;
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==7)
						{
							var a = "http://www.qmatchup.com/beta/view_user_social.php?description=1";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==8)
						{
							var a = "http://www.qmatchup.com/beta/NewPersonal/index.php/SendRequest/sendRequestCompany/T3E0MjFwcGhVNlhSYlRvL2t1ZXQ2Zz09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==9)
						{
							var a = "http://www.qmatchup.com/beta/NewPersonal/index.php/SendRequest/sendRequestCompany/QkhHaWQzcnBweFU5MDRIMllxY3IzQT09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==10)
						{
							var a = "http://www.qmatchup.com/beta/NewPersonal/index.php/SendRequest/sendRequestCompany/cXZGMGwveWlTUUI4VDI5MFpNaEZrUT09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
						else if(i==11)
						{
							var a = "http://www.qmatchup.com/beta/NewPersonal/index.php/SendRequest/sendRequestCompany/bi9rQnJTT2VZNmwwNVVBTWkvbzA5Zz09";
							var b= "dark_red_txt";
							var c= 'color: #e82323';
						}
