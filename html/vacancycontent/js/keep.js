		...
		templates: function(){
			...
			templates.modal = {
				...
				list_block: '<div class="keep-list-item pos_rel padtb5 padrl25 txt_21" id="{item-id}">\
								...
								<textarea name="{check-name}-text-modal" rows="1" cols="1" class="autosize wi_100 dblock pad0 nobrd bg_trans txtdec_lt_sibc ff_inh fsz_inh txt_21">{content}</textarea>\
